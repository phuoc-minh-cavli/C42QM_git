 ...
 *
 * Copyright (C) 2010,2016, 2018, 2020 Qualcomm Technologies, Inc. All rights reserved.
 ...
 * ==========================================================================================
 *   $Header: //components/rel/boot.xf/0.2/QcomPkg/Tools/storage/fh_loader/QSaharaServer/src/kickstart.c#6 $
...
int main (int argc, char *argv[])
{
    ...
    const char *const short_options = "hp:v:c:mis:g:w:r:lt:j:b:ku:xa:o:U";  // possible cmd line short options
