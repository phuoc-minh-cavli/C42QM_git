...
from sectools.features.isc.advanced_defines import AUTHORITY_QTI, MULTI_SERIAL_NUMBERS_TAG
...
from . import SECIMAGE_TOOL_NAME
            ...
            if value_to_set is not None:
                try:
                    if tag == MULTI_SERIAL_NUMBERS_TAG:
                        override.value =\
                            auto_gen_xml_config.complex_multi_serial_numbers(
                                value_to_set.split())
                    else:
