        ...
        for sign_id, chipset, image_src_path, image_dest_path, err_code in self.get_image_info_from_meta(meta_info):
            ...
            try:
                ...
                imageinfo = self._create_imageinfo(
                    img_config_parser, parsegen_config, sign_id, "", False, image_src_path, image_dest_path)
                ...
                if gen_multi_image:
                    ...
                    multi_image_imageinfo = self._create_imageinfo(
                        img_config_parser, parsegen_config, sign_id, None, gen_multi_image, dest_image=image_dest_path)
