...
#endif // defined in hal_mdp_interface.c
/*!
 ...
 *
 *  The \b HAL_MDP_FormatCompressedPlaneType holds the buffer information for the compressed plane
 *
 */
typedef struct _HAL_MDP_FormatCompressedPlaneType
{
   HAL_MDSS_DeviceAddressType sCompressedDataDeviceAddress;  /**< Device Accessible Address         */
   uint32                     uCompressedDataStrideInBytes;  /**< Stride in bytes                   */
   HAL_MDSS_DeviceAddressType sMetadataDeviceAddress;        /**< Device Accessible Address         */
   uint32                     uMetadataStrideInBytes;        /**< Stride in bytes                   */   
   bool32                     bChromaVerticalPacked;         /**< CbCr packed direction             */
...
typedef struct _HAL_MDP_Mixer_CursorConfigType
{
   ...
   HAL_MDP_BlendStageId                   eCursorBlendStageId;
 ...
 *
 */
typedef struct _HAL_MDP_PingPong_FBCConfigType
{
  bool32                  bFBCEnable;           /**< enable Frame Buffer Compression        */
  bool32                  bBflcEnable;          /**< enable Block Fixed Length Coding Mode  */
  bool32                  bVlcEnable;           /**< enable Variable Length Coding Mode     */
  bool32                  bPatEnable;           /**< enable Pattern Coding Mode             */
  bool32                  bQErrEnable;          /**< enable Quantization Error Calculation  */
  bool32                  bPlanar;              /**< Components are packed separately       */
  uint32                  uCdBias;              /**< Bias for CD,                           */
  uint32                  uScreenWidthInPixels; /**< Width of the Screen in pixel           */
  uint32                  uBlockBudget;         /**< Per block budget                       */
  uint32                  uBlockExtraBudget;    /**< Extra budget level                     */
  uint32                  uLineExtraBudget;     /**< Per line extra budget                  */
  uint32                  uLossyModeIdx;        /**< LUT index for lossy_y_bits vector      */
  uint32                  uLossyRGBThd;         /**< Lossy RGB Threshold                    */
  uint32                  uLossyModeThd;        /**< Lossy Mode Threshold                   */
  uint32                  uLosslessModeThd;     /**< Lossless Mode Threshold                */

} HAL_MDP_PingPong_FBCConfigType;
...
typedef struct _HAL_MDP_PingPongConfigType
{
   ...
   HAL_MDP_PingPong_FBCConfigType           *pFBCConfig;             /**< Frame Buffer Compression config */
...
{
   HAL_MDP_SourcePipeId eSourcePipe[HAL_MDP_BLEND_ORDER_STAGE_MAX];
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_TrafficCtrl_Init(uint32  uFlags);
