...
--------   ---     -----------------------------------------------------------
05/21/18   pbitra  Added support for SMB
02/01/18   mr      Added TypeC Role select API
...
typedef enum _EFI_USB_PWR_CTRL_PORTHW_HW_TYPE
{
  ...
  EFI_USB_PWR_CTRL_PORTHW_HW_PMSMBCHG,
...
typedef enum _EFI_USB_PWR_CTRL_PORTHW_EXT_DEP_STATE
{
  EFI_USB_PWR_CTRL_PORTHW_EXT_DEP_STATE_HIZ,       /* TODO: HiZ case is not supported for now */
...
typedef struct _EFI_USB_PWR_CTRL_HW_INFO
{
  ...
  EFI_USB_PWR_CTRL_PORTHW_INFO                        Ports[EFI_USB_PWR_CTRL_USBPORT_MAX];  /**< Data Array contains port information */
