...
typedef enum
{
  ...
  HAL_CLK_SOURCE_GPLL6_AUX        = 79,
  HAL_CLK_NUM_OF_CONFIG_SOURCES   = 80,

  /*
   * Raw
   */
  HAL_CLK_SOURCE_RAW0             = 81,
  HAL_CLK_SOURCE_RAW1             = 82,
  HAL_CLK_SOURCE_RAW2             = 83,
  HAL_CLK_SOURCE_RAW3             = 84,
  HAL_CLK_SOURCE_RAW4             = 85,
  HAL_CLK_SOURCE_RAW5             = 86,
  HAL_CLK_SOURCE_RAW6             = 87,
  HAL_CLK_SOURCE_RAW7             = 88,
