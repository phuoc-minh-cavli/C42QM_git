 ...
 * $Header: //components/rel/boot.xf/0.2/QcomPkg/Include/SpmiCfg.h#1 $
 * $Change: 16788488 $ 
 * 
 *                              Edit History
 * Date     Description
 ...
 */
static inline Spmi_Result SpmiCfg_GetChannelInfo(uint16 channel, uint8* slaveId, uint8* periphId, uint8* owner)
{
 ...
 */
static inline Spmi_Result SpmiCfg_GetPeripherialInfo(uint8 slaveId, uint8 periphId, uint16* channel, uint8* owner)
{
 ...
 */
static inline Spmi_Result SpmiCfg_ConfigurePeripherals(SpmiCfg_ChannelCfg* entries, uint32 numEntries,
 ...
 * @see SpmiCfg_ConfigurePeripherals
 */
static inline Spmi_Result SpmiCfg_CalculateRGConfig(SpmiCfg_ChannelCfg* entries, uint32 numEntries,
                                             SpmiCfg_RGConfig* rgCfg, uint32* rgCount)
{
 ...
 * @return  SPMI_SUCCESS on success, error code on failure
 */
static inline Spmi_Result SpmiCfg_SetPortPriorities(uint8* ports, uint32 numPorts)
{
