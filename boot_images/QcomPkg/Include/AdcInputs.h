...
/** PA_THERM2 - nPhysical units are in degrees C       */
#define ADC_INPUT_PA_THERM2        "PA_THERM2"
...
/** USB_IN_I_MV - nPhysical units are in millivolts    */
#define ADC_INPUT_USB_IN_I_MV      "USB_IN_I_MV"
