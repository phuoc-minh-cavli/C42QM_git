...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Include/api/boot/ddr_common.h#2 $ 
...
typedef enum
{
  ...
  DDR_TYPE_PCDDR3L = 6,
  DDR_TYPE_LPDDR4 = 7,           /**< Low power DDR4. */
  DDR_TYPE_LPDDR4X = 8,          /**< Low power DDR4X (with lower IO voltage). */
