...
12/13/17   rohik          Added SECBOOT_OEM_MISC_SW_TYPE and SECBOOT_QTI_MISC_SW_TYPE
...
typedef enum
{
  ...
  SECBOOT_OEM_MISC_SW_TYPE           = 0x22, /* OEM_MISC Image */
  SECBOOT_QTI_MISC_SW_TYPE           = 0x23, /* QTI_MISC Image */
  SECBOOT_SEC_SW_TYPE                = 0x2B, /* SEC Imagw */
