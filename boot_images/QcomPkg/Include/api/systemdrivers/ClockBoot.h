...
SVS - Highest frequency at svs voltage level.
NOMINAL - Highest frequency at nominal voltage level.
TURBO - Highest frequency at turbo voltage level.
...
/**
@brief List of UART clocks that the clock driver supports.
*/
typedef enum
{
   CLK_BLSP_UART_NONE,
   ...
   CLK_BLSP0_UART4_APPS,
   CLK_BLSP0_UART5_APPS,
   CLK_BLSP0_UART6_APPS,
   CLK_BLSP1_UART0_APPS,
...
typedef enum
{
   CLK_BLSP0_QUP0_I2C_APPS,
   CLK_BLSP0_QUP1_I2C_APPS,
   CLK_BLSP0_QUP2_I2C_APPS,
   CLK_BLSP0_QUP3_I2C_APPS,
   CLK_BLSP0_QUP4_I2C_APPS,
   CLK_BLSP0_QUP5_I2C_APPS,
   CLK_BLSP0_QUP6_I2C_APPS,
   CLK_BLSP1_QUP0_I2C_APPS,
...
typedef enum
{
   ...
   CLK_BLSP0_QUP2_SPI_APPS,
   CLK_BLSP0_QUP3_SPI_APPS,
   CLK_BLSP0_QUP4_SPI_APPS,
   CLK_BLSP0_QUP5_SPI_APPS,
   CLK_BLSP0_QUP6_SPI_APPS,
   CLK_BLSP1_QUP0_SPI_APPS,
 ...
 */
  ...
  /*
   Return the threshold BIMC freq in KHZ above which JCPLL_MODE will be used. 
   */
  CLOCK_RESOURCE_QUERY_THRESHOLD_FREQ_KHZ,

  /*
   Return DDR Clock Source. 
   */
