 ...
 *   
 *  \n &copy; Copyright 2011,2014-2018 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
/* ======================================================================= */
...
--------   ---     ---------------------------------------------------------- 
04/09/18   sv      Added pm_qsee_pre_init API
...
/**
 * @brief This function executes pre QSEE init
 * 
 * @details
 *  Configures PMIC Resource SPMI Channel access control
 *   PVC, VRM, MGPI and VIOCTL configuration     
 *   
 *
 ...
 *
 */
pm_err_flag_type pm_qsee_pre_init(void);

/**
 * @brief This function executes prior to pre QSEE init
 * 
 * @details
 *  updates the PMIC Resource SPMI Channel access control
 *   PVC, VRM, MGPI and VIOCTL configuration table based on the varient of this target.    
 *   
 *
 * @return pm_err_flag_type PM_ERR_FLAG_INVALID = ERROR. 
 *         PM_ERR_FLAG_SUCCESS = SUCCESS.
