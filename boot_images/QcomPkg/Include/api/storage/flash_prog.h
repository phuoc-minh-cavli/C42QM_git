 ...
 *
 * Copyright (c) 2008-2011,2013, 2015, 2018 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
...
typedef struct flash_prog_img_prg_table {
   ...
   * by the caller.
   */
  flash_prog_status_t (*program_img) (void *data, uint32 size, uintnt addr);
