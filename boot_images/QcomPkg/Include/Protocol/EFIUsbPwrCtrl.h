...
--------   ---     -----------------------------------------------------------
02/01/18   mr      Added TypeC Role select Protocol interface
...
Types of USB Ports
*/
typedef enum _EFI_USB_PWR_CTRL_USBPORT_TYPE
{
  EFI_USB_PWR_CTRL_USBPORT_CHARGER,                 /**< USB Charging Port - Primary Port */
  EFI_USB_PWR_CTRL_USBPORT_NORMAL,                  /**< USB Normal Port - Data Port */
  EFI_USB_PWR_CTRL_USBPORT_MAX,
}EFI_USB_PWR_CTRL_USBPORT_TYPE;
...
typedef enum _EFI_USB_PWR_CTRL_TYPEC_POWERROLE_TYPE
{
  ...
  EFI_USB_PWR_CTRL_TYPEC_POWERROLE_DUAL,
...
/* EFI_USB_PWR_CTRL_SET_TYPEC_PORT_ROLE */
/** @ingroup efi_usbpwrctrlSetTypeCPortRole
* @par Summary
* Set TypeC Port Role
*
* @param[IN]  PortIndex     Specify which port the request is for
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_USB_PWR_CTRL_SET_TYPEC_PORT_ROLE)(
  IN  UINT8   PortIndex,
  IN  EFI_USB_PWR_CTRL_TYPEC_POWERROLE_TYPE TypeCPortRole
);
...
struct _EFI_USB_PWR_CTRL_PROTOCOL
{
    ...
    EFI_USB_PWR_CTRL_SET_TYPEC_PORT_ROLE        SetTypeCPortRole;       /* Set TypeC Port Role */
};
