...
--------   ---     ----------------------------------------------------------
12/13/17   rohik   Changed parameter type of cache_mmu_init_page_table() to uintnt
...
* 
*/  
void mmu_relocate_page_table_base(uintnt *dst_l1_pagetable);
...
* 
*/
uintnt *mmu_get_page_table_base(void);
...
;                7- enables the mmu
;============================================================================*/
void cache_mmu_init_page_table(uintnt);
...
=============================================================================*/
void boot_init_page_table(uintnt*);
...
**  Function :  mmu_enable_i_and_d_cache
...
* 
*/
void mmu_enable_i_and_d_cache ( void );
