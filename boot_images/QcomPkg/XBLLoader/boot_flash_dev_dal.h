...
Copyright 2008-2009, 2015, 2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
...
struct fs_device_data {
 ...
 int (*start_read) (fs_device_t self, page_id page, void *data, page_id num_pages);
 int (*wait_for_read) (fs_device_t self);
