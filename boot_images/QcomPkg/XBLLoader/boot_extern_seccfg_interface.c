...
===========================================================================*/ 
/**
 * @brief This function will set the reset mode for XBL sec
 *
 * @param[in]
 *
 * @return
 ...
 *
 */
void boot_qsee_disable_edl(void)
{
    boot_tzt_result_regs_t result;

    boot_fastcall_tz(TZ_SEC_SET_RESET_MODE_CMD,
                     TZ_SEC_SET_RESET_MODE_PARAM_ID,
                     0,0,0,0, &result);	
  }
