...
/* Copyright 2010-2016, 2019 by Qualcomm Technologies, Inc.  All Rights Reserved. */
/*==========================================================================
                          ...
                          boot_configuration_table_entry * boot_config_entry)
{
  ...
  if(boot_config_entry->load == TRUE)
  {
    ...
    BL_VERIFY(boot_set_active_img_whitelist_table(boot_config_entry->whitelist_table),
    ...
    switch(boot_config_entry->target_img_type)
    {
      ...
      case CONFIG_IMG_ELF:
        ...
        /* Authenticate the image metadata (hashtable)*/ 
        uie_enabled = boot_auth_verify_uie((uint32)boot_config_entry->target_img_sec_type,
                                                    &sbl_elf_info,
                                                    &sbl_white_list_param
                                                    );
        ...
        boot_load_elf_image(NULL, 
							...
							(uint32)boot_config_entry->target_img_type,
							uie_enabled
                            );
      ...
      case CONFIG_IMG_ELF_SEG:
        ...
        */
		if(boot_config_entry->target_img_sec_type != SECBOOT_SBL1_SW_TYPE)
		{
			/* Initialize the hash data segment from the ELF image */
            boot_elf_load_init_hash_segment(boot_config_entry->
                                            target_img_partition_id,
