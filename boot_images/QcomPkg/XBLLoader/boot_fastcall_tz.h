...
Copyright 2010-2011, 2013-2016, 2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
=============================================================================*/
...
#define TZ_PIL_SEC_IMG_AUTH_VERIFY_HASH_IN_PARLLEL_ID  0x02000216
#define TZ_PIL_SEC_IMG_AUTH_VERIFY_HASH_IN_PARLLEL_ID_PARAM_ID 0x00000105

#define TZ_PIL_SEC_IMG_VERIFY_ENC_ID  0x82000218
#define TZ_PIL_SEC_IMG_VERIFY_ENC_ID_PARAM_ID  0x21048
...
/*
 Unlock the IMEM region for image loading
*/
#define TZ_INIT_CMD 0x82000115
#define TZ_INIT_PARAM_ID 0x00000000

/* 
 Set reset command for XBLsec
*/
#define TZ_SEC_SET_RESET_MODE_CMD  0x8200011A
#define TZ_SEC_SET_RESET_MODE_PARAM_ID  0x0
...
#define boot_sdi_fastcall_tz_no_rsp(smc_id, param_id, arg0, arg1, arg2, arg3) \
  boot_sdi_scm((uintnt)(smc_id), (uintnt)(param_id), (uintnt)(arg0), \
  (uintnt)(arg1), (uintnt)(arg2), (uintnt)(arg3), 0, NULL)
/*===========================================================================
