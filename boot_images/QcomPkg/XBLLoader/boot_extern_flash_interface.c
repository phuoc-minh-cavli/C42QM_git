...
Copyright 2011-2012, 2015, 2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
08/14/19   aus     Flash non-blocking read API
...
**  Function :  boot_flash_start_read_pages

** ==========================================================================
*/
/*!
 * Flash start read page API. This API starts the non-blocking page/multi-page 
 * reads
 *
 * @param handle [IN]
 *   DAL interface handle
 ...
 *
 */
int boot_flash_start_read_pages
(
  flash_handle_t handle,
  enum page_read_opcode read_type,
  dalsys_mem_desc_list *buffer_desc,
...
{
  return flash_start_page_read(handle, read_type, buffer_desc, page_iovec);
}

/*===========================================================================

**  Function :  boot_flash_wait_read_pages

** ==========================================================================
*/
/*!
 * Flash API to wait for completion of the previous read.
 *
 * @param handle [IN]
 *   DAL interface handle
 *
 ...
 *
 */
int boot_flash_wait_read_pages
(
  flash_handle_t handle
)
{
  return flash_wait_for_page_read(handle);
}
 ...
 *
 */
void boot_flash_boot_ops_get_parti_tbl(uintnt *buffer, uintnt *size_in_bytes)
{
