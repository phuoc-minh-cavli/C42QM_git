...
--------   ---        ---------------------------------------------------------
04/15/19   aus        Added log for SPI NAND flash
...
void boot_log_pbl_version(void)
{
  ...
  pbl_patch_ver = HWIO_FEATURE_CONFIG3_INM(HWIO_FEATURE_CONFIG3_APPS_PBL_PATCH_VERSION_BMSK)>>HWIO_FEATURE_CONFIG3_APPS_PBL_PATCH_VERSION_SHFT;
