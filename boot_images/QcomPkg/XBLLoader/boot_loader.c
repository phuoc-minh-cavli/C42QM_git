...
Copyright 2010-2016,2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
=============================================================================*/
...
--------   ---     ----------------------------------------------------------
11/09/19   rrawat  corrected boot_set_entry_as_img_whitelist to boot_set_entry_as_hdr_meta_whitelist
...
)
{
  ...
  if ( header_ptr != NULL )
  {
    ...
    boot_set_entry_as_hdr_meta_whitelist((uintnt)header_ptr , (uintnt)sizeof(*header_ptr));
...
)
{
   ...
   do
   {
    ...
    boot_set_entry_as_hdr_meta_whitelist((uintnt)&fota_mode , (uintnt)sizeof(fota_mode));
    
    while(rem_size < sizeof(fota_mode))
    {
