...
/*===========================================================================
**  Function :  boot_auth_verify_uie
** ==========================================================================
*/
/*!
* 
* @brief
*   This function checks whether UIE is enabled
*
* @par Dependencies
*   None 
* 
...
* 
*/
uint32 boot_auth_verify_uie (uint32 image_id,
                                                                    sec_img_auth_elf_info_type *sbl_elf_info, 
                                                                    sec_img_auth_whitelist_area_param_t *sbl_white_list_param)
{
  uint32 result = 0;
  
  result = boot_sec_img_auth_verify_uie(image_id,
                                                     sbl_elf_info,
                                                     sbl_white_list_param,
                                                     &sbl_sec_img_auth_verified_info);
