...
Copyright 2011-2012, 2014, 2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
/*===========================================================================
 ...
 *
 */
int boot_flash_start_read_pages(flash_handle_t handle,
                          enum page_read_opcode read_type, 
                          dalsys_mem_desc_list * buffer_desc,
                          struct flash_page_iovec * page_iovec);
 ...
 *
 */
int boot_flash_wait_read_pages(flash_handle_t handle);
 ...
 *
 */
void boot_flash_boot_ops_get_parti_tbl(uintnt * buffer,
                                       uintnt * size_in_bytes);
