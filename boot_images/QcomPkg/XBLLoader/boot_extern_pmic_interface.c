...
Copyright 2011-2015,2018 by Qualcomm Technologies, Incorporated.
                All Rights Reserved.
============================================================================*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
04/09/18    sv     Added boot_pm_qsee_pre_init API.
...
**  Function :  boot_pm_qsee_pre_init

** ==========================================================================
*/
/*! 
 * @brief This function executes the pmic pre QSEE initialization
 * @return Error flag.
 *
 */ 
pm_err_flag_type boot_pm_qsee_pre_init(void)
{
  return pm_qsee_pre_init();
}
