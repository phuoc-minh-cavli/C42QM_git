...
{
    return ICB_Remap(dev, info, remap);
}
...
*/
/*=======================================?=====================================*/
icbcfg_error_type boot_ICB_RemapEx( const char * dev, ddr_info * info, uint32 index, icbcfg_remap_info_type * remap )
{
    return ICB_RemapEx(dev, info, index, remap);
}
