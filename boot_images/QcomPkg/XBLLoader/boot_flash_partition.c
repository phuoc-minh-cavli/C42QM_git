...
)
{
  ...
  BL_VERIFY( parti_tbl_ptr != NULL, BL_ERR_NULL_PTR_PASSED|BL_ERROR_GROUP_BOOT );
  BL_VERIFY( parti_entry_name[0] == '0', BL_ERR_WRG_PARTI_ENTRY_NAME_FMT|BL_ERROR_GROUP_BOOT );
  BL_VERIFY( parti_entry_name[1] == ':', BL_ERR_WRG_PARTI_ENTRY_NAME_FMT|BL_ERROR_GROUP_BOOT );
