...
boot_shared_functions_register(void)
{
  ...
  function_table->boot_set_active_img_whitelist_table = &boot_set_active_img_whitelist_table;
  ...
  function_table->boot_auth_image_hashtable = &boot_auth_image_hashtable;
  ...
  function_table->qmemset = &qmemset;
  ...
  function_table->pmapp_chg_usb_get_vbus_presence = &pmapp_chg_usb_get_vbus_presence;
  
  function_table->pmapp_chg_usb_get_usb_connector_type = &pmapp_chg_usb_get_usb_connector_type;
  
  //function_table->boot_get_elf_entry_address = &boot_get_elf_entry_address;
  
  function_table->boot_mmu_page_table_map_single_mem_block_L1 = &boot_mmu_page_table_map_single_mem_block_L1;
