 ...
 *
 * Abstract underneath transport used from upper layers.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprg_transport.h#2 $
  $DateTime: 2020/01/28 12:49:31 $
  $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2020-07-01   as    Add enhancements in hsuart transport layer 
 ...
 *
 * Initializes HSUART and returns the function pointers for TX/RX. */
