...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprg_transport.c#1 $
...
#ifdef FEATURE_DEVPRG_TRANSPORT_UART
  transport = devprg_transport_hsuart_init();
#else
