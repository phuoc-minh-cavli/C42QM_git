...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprg_storage.h#2 $
  $DateTime: 2022/02/21 11:41:08 $
  $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2022-02-11   sk    Rename BAD_BLOCK_FILL to BAD_BLOCK_NO_SKIP in skip_bb
...
enum devprg_skip_bb
{
  ...
  and count bad blocks (but not touch them) while doing erase operations */
};
