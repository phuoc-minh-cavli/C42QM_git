...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprg_storage_sdcc.c#2 $
  $DateTime: 2018/12/31 01:19:00 $
  $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2018-12-28   as    fixed error correction for ffu_status check.
...
{
  struct sdcc_device *dev;
  SDCC_STATUS result = SDCC_ERR_FW_GENERAL_ERROR;
  int status = SDCC_ERR_FW_GENERAL_ERROR;
  int failed = 0;
