...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprgb_buffers_lite.c#2 $
...
2018-07-01   sb    Zero out ZI section in DDR
...
/*The length of below macros can be any value but not a multiple of 512
because of USB limitations*/
#define DEVPRG_LOG_SIZE       1000
#define DEVPRG_VIP_TABLE_SIZE 12288
...
extern uint32 Image$$SBL1_DDR_UNCACHED_ZI$$Base[];
extern uint32 Image$$SBL1_DDR_UNCACHED_ZI$$ZI$$Length;
...
#ifdef FEATURE_DEVPRG_DDR
  memset(Image$$SBL1_DDR_ZI$$Base, 0, (size_t)&Image$$SBL1_DDR_ZI$$ZI$$Length);
  memset(Image$$SBL1_DDR_UNCACHED_ZI$$Base, 0, (size_t)&Image$$SBL1_DDR_UNCACHED_ZI$$ZI$$Length);
