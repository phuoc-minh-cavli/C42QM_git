...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DevPrgLib/devprg_firehose.h#3 $
  $DateTime: 2022/02/21 11:41:08 $
  $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2022-02-17   sk    Add new member to devprg_status enum
...
enum devprg_status
{
  ...
  DEVPRG_ERROR_READONLY,/* accessing a readonly partition for non-read purpose*/
  DEVPRG_ERROR_NOT_READY,
  DEVPRG_ERROR_DO_NOT_SKIP_BAD_BLOCKS,
};
