...
/*
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/ICBLib/HALbimcHwioGeneric.h#2 $
  $DateTime: 2019/01/31 03:54:17 $
  $Author: pwbldsvc $
...
#define BIMC_M_MODE_RMSK                                                  0xf00f00df
 ...
 *--------------------------------------------------------------------------*/
 //Updating the offset as first sway starts at 3c000
#define BIMC_S_SWAY_REG_BASE(b)                                                 ((b)      + 0x0003c000)
...
#define BIMC_S_SWAY_CLOCK_CTRL_RMSK                                              0xff030003
 ...
 *--------------------------------------------------------------------------*/
//For MDM9205
//As ARB_SLAVES are not at the offset of 8000, changing multiple of arb slaves to 4000
//And the first ARB Slave starts at offset 0x31000

#define BIMC_S_ARB_REG_BASE(b)                                                  ((b)      + 0x00031000)

#define BIMC_S_ARB_COMPONENT_INFO_ADDR(b,n)                                (BIMC_S_ARB_REG_BASE(b) + (0x4000 * (n)) + 0x00000000)
...
#define BIMC_S_ARB_CONFIGURATION_INFO_0_ADDR(b,n)                          (BIMC_S_ARB_REG_BASE(b) + (0x4000 * (n)) + 0x00000020)
...
#define BIMC_S_ARB_CONFIGURATION_INFO_1_ADDR(b,n)                          (BIMC_S_ARB_REG_BASE(b) + (0x4000 * (n)) + 0x00000030)
...
#define BIMC_S_ARB_CLOCK_CTRL_ADDR(b,n)                                    (BIMC_S_ARB_REG_BASE(b) + (0x4000 * (n)) + 0x00000200)
...
#define BIMC_S_ARB_MODE_ADDR(b,n)                                          (BIMC_S_ARB_REG_BASE(b) + (0x4000 * (n)) + 0x00000210)
