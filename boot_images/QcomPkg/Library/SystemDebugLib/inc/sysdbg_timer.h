...
GENERAL DESCRIPTION
  ...
  Copyright 2012 - 2015, 2019 by Qualcomm Technologies, Inc. All Rights Reserved.
...
/*=============================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/SystemDebugLib/inc/sysdbg_timer.h#2 $
