...
/*
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/SPMILib/src/core/hal/bear/hw/v2_5/PmicArbCoreHwio.h#1 $
...
#define PMIC_ARB_CORE_REGISTERS_OBS_REG_BASE_OFFS             0x00c00000
