...
/**
  ...
  Reference chip release:
    QCS405 (Vipertooth) [vipertooth_prj_1.0_p3q1r94]
...
/*
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/SPMILib/src/core/hal/bear/hw/v2_5/SpmiCoreHwio.h#1 $
...
#define HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k)                                     ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00000400 + 0x4 * (k))
#define HWIO_SPMI_MAPPING_TABLE_REGk_OFFS(base,k)                                     (0x00000400 + 0x4 * (k))
...
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000900)
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_OFFS                                            (0x00000900)
...
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000904)
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_OFFS                                            (0x00000904)
...
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_ADDR(x)                                          ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000908)
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_OFFS                                             (0x00000908)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000090c)
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_OFFS                                            (0x0000090c)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_ADDR(x)                                       ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000910)
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_OFFS                                          (0x00000910)
...
#define HWIO_SPMI_DEBUG_REG_ADDR(x)                                                   ((x) + 0x00001928)
...
#define SPMI_PIC_REG_BASE_OFFS                                        0x01800000

#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_ADDR(base,m,n)               ((base) + SPMI_PIC_REG_BASE_OFFS + 0x00100000 + 0x1000 * (m) + 0x4 * (n))
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_OFFS(base,m,n)               (0x00100000 + 0x1000 * (m) + 0x4 * (n))
