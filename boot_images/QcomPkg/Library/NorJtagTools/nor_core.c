...
*   order.
*
*   $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/NorJtagTools/nor_core.c#2 $ 
*   $DateTime: 2018/09/10 07:42:11 $ 
*   $Author: pwbldsvc $
*
* when         who     what, where, why
* ----------   ---     ----------------------------------------------
* 08/24/18     svl     updated delay to avoid optimization
