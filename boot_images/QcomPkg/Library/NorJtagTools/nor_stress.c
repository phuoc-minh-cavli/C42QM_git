 ...
 *   order.
 *
 *   $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/NorJtagTools/nor_stress.c#1 $ $DateTime: 2018/08/01 23:51:05 $ $Author: pwbldsvc $
 *
...
int flash_dal_stress_test ()
{
  ...
  {    
    ...
    //Open 'test' device...
    if(DAL_SUCCESS == flash_open_partition(handle_flash2, (const unsigned char*)"0:EFS2"))
    {
      FLASHLOG(3, ("flash_open_partition successful\n"));
    }
    else
