...
*   order.
*
*   $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/NorJtagTools/nor_mem_init.c#1 $ $DateTime: 2018/08/01 23:51:05 $ $Author: pwbldsvc $
*
...
extern byte *Image$$NOR_JTAG_ZI$$Start;
extern byte *Image$$NOR_JTAG_ZI$$End;
...
memory_init (void)
{
  ...
  for (dst32 = (dword *) & Image$$NOR_JTAG_ZI$$Start; 
       dst32 < (dword *) & Image$$NOR_JTAG_ZI$$End; dst32++)
  {
    *dst32 = 0;
