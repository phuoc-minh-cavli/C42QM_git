...
#define MDP_FBC_PROFILEID_MAX                               0x04
...
typedef enum
{
  MDSS_DEVICE_VERSION_04_00 = 0,   /**< Device 4.0 */
  MDSS_DEVICE_VERSION_04_01,       /**< Device 4.1 */
  MDSS_DEVICE_VERSION_04_02,       /**< Device 4.2 */
  MDSS_DEVICE_VERSION_04_03,       /**< Device 4.3 */
  MDSS_DEVICE_VERSION_04_04,       /**< Device 4.4 */
  MDSS_DEVICE_VERSION_05_00,       /**< Device 5.0 */
  MDSS_DEVICE_VERSION_05_01,       /**< Device 5.1 */
  MDSS_DEVICE_VERSION_05_02,       /**< Device 5.2 */
  MDSS_DEVICE_VERSION_05_03,       /**< Device 5.3 */
  MDSS_DEVICE_VERSION_05_04,       /**< Device 5.4 */
  MDSS_DEVICE_VERSION_05_05,       /**< Device 5.5 */  
  MDSS_DEVICE_VERSION_05_06,       /**< Device 5.6 */  
  MDSS_DEVICE_VERSION_03_04,       /**< Device 3.4 */
  MDSS_DEVICE_VERSION_03_05,       /**< Device 3.5 */
  MDSS_DEVICE_VERSION_05_10,       /**< Device 5.10*/  
  MDSS_DEVICE_VERSION_05_12,       /**< Device 5.12*/
  MDSS_DEVICE_VERSION_05_16,       /**< Device 5.16*/
  MDSS_DEVICE_VERSION_05_17,       /**< Device 5.17*/
...
typedef struct
{
    ...
    /* DSI FBC Configuration */
    bool32 bFBCEnable;                 /**< Frame Buffer Compression Enabled on panel */
    uint32 uFBCProfileID;              /**< Frame Buffer Compression Profile ID supported by panel*/
    uint32 uFBCCompressionRatio;       /**< Frame Buffer Compression Ratio, This is ReadOnly, OEM should not change it*/
...
/* FBC Settings for different Profile ID
*/
typedef struct
{
  ...
  uint32 uLossyRgbThreadhold;         /* Lossy RGB Threshold                    */
  uint32 uCompressionRatio;           /* Compression Ratio at this Profile ID   */
}MDP_FbcProfileMode;
extern const MDP_FbcProfileMode gFbcProfileModes[MDP_FBC_PROFILEID_MAX];
