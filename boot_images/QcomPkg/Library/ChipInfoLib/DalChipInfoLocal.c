...
#define DALCHIPINFO_PARTNUM_QCS6200        0x0AF

#define DALCHIPINFO_PARTNUM_QCS401         0x0E3
#define DALCHIPINFO_PARTNUM_QCS403         0x0E4
...
DalChipInfoPartMapType amPartMap[] =
{
  ...
  { DALCHIPINFO_PARTNUM_QCS6200,    DALCHIPINFO_ID_QCS6200   },
  { DALCHIPINFO_PARTNUM_QCS401,     DALCHIPINFO_ID_QCS401    },
  { DALCHIPINFO_PARTNUM_QCS403,     DALCHIPINFO_ID_QCS403    },
...
DalChipInfoIdMapType chipIdMap[] =
{
  ...
  { DALCHIPINFO_ID_QCS6200,  20  },
  { DALCHIPINFO_ID_QCS401,   21  },
  { DALCHIPINFO_ID_QCS403,   22  },
  { DALCHIPINFO_ID_MDM9205,  23  },
...
static const DalChipInfoDataLUTType DalChipInfoDataLUT[DALCHIPINFO_CHIPID_MAP_SIZE] =
{
  ...
  { "QCS405",    "UNKNOWN",  DALCHIPINFO_FAMILY_QCS6200, 0 }, /* QCS6200 renamed to QCS405.*/
  { "QCS401",    "UNKNOWN",  DALCHIPINFO_FAMILY_QCS6200, 0 },
  { "QCS403",    "UNKNOWN",  DALCHIPINFO_FAMILY_QCS6200, 0 },
  { "MDM9205",   "UNKNOWN",  DALCHIPINFO_FAMILY_MDM9205, DALCHIPINFO_MODEM_WWAN | DALCHIPINFO_MODEM_CGPS | DALCHIPINFO_MODEM_LTE },
...
DalChipInfoFamilyType ChipFamilyArray2[] =
{
  ...
  DALCHIPINFO_FAMILY_MDM9x55,
  DALCHIPINFO_FAMILY_MDM9x07,
  DALCHIPINFO_FAMILY_MSM8937,
  DALCHIPINFO_FAMILY_MSM8953,
  DALCHIPINFO_FAMILY_MSM8917,
  DALCHIPINFO_FAMILY_IPQ807x,
  DALCHIPINFO_FAMILY_SDX20M,
  DALCHIPINFO_FAMILY_MSM8940,
  DALCHIPINFO_FAMILY_MSM8920,
  DALCHIPINFO_FAMILY_SDX50M,
  DALCHIPINFO_FAMILY_UNKNOWN, // As of now device-number-18 not mapped to any chip, So marking as UNKNOWN
  DALCHIPINFO_FAMILY_MDM9205, 
  DALCHIPINFO_FAMILY_QCS6200,
...
)
{
  ...
  ChipInfo_ReadQFPROMChipId(pCtxt,(DalChipInfoQFPROMChipIdType *)&pCtxt->nQFPROMChipId, *(uint32*)(nSerialNumRegAddr+0x4));
