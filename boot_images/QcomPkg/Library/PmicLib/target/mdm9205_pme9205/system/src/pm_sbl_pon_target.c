...
*  \n
*  \n &copy; Copyright 2015-2018 Qualcomm Technologies Inc, All Rights Reserved
*/
/* =======================================================================
Edit History
...
{  //  PME9205                                      
   {PON_WARM_RST, 0, 0, 0,0,0,0}, //Warm Reset
   {PON_HARD_RST,0, 0, 0,0,0,0}, //Hard Reset
   {PON_SHDN,0, 0, 0,0,0,0}, //Shutdown
   {PON_DVDD_HARD_RST,0, 0, 0,0,0,0}, //Dvdd hard reset
   {PON_DVDD_SHDN, 0, 0, 0,0,0,0}  //DVDD Shutdown
};
...
{  //   PME9205                 
   {PON_NO_CFG_NEEDED, 0, 0, 0,0,0,0}, //Warm Reset
   {PON_NO_CFG_NEEDED, 0, 0, 0,0,0,0}, //Hard Reset
   {PON_NO_CFG_NEEDED, 0, 0, 0,0,0,0}, //Shutdown
   {PON_NO_CFG_NEEDED, 0, 0, 0,0,0,0}, //DVDD Shutdown  
   {PON_NO_CFG_NEEDED, 0, 0, 0,0,0,0}  //Dvdd hard reset
};
...
{  //PME9205,  
   { 1,          0,      0,      0,     0,  0,  0},    //KPDPWR_N
   { 1,          0,      0,      0,     0,  0,  0},    //RESIN_N
   { 1,          0,      0,      0,     0,  0,  0},    //KPDPWR_AND_RESIN
   { 1,          0,      0,      0,     0,  0,  0}     //KPDPWR_OR_RESIN
};
