                                         ...
                                         DSI_DisplayConfigType  *psDisplayConfig)
{
  ...
  else
  {
    ...
    */
    ...
    {
      DSI_Log_Message(DSI_LOGLEVEL_WARNING, "DSI Phy configuration failed, PLL could be unstable.\n");
    }     
    ...
    {
      DSI_Log_Message(DSI_LOGLEVEL_WARNING, "DSI Phy timing setup failed.\n" );
    }
    ...
    {
      DSI_Log_Message(DSI_LOGLEVEL_WARNING, "Clock DSI_LOGLEVEL_WARNING for clock ID failed");     
    }
  }
