                                ...
                                uint32             *puErrorCode)
{
  ...
  else
  {
    *puErrorCode                      = 0;
    ...
    if (0 != HWIO_GETVAL(DSI_0_ACK_ERR_STATUS, uAckErrIntrStatusReg, ERROR))  
    {
                                ...
                                uint32                uErrorStatus)
{
  ...
  {
    uAckErrIntrStatusReg = HWIO_OUT_FLD(uAckErrIntrStatusReg, DSI_0_ACK_ERR_STATUS, ERROR_CLR,    1); 
  }
