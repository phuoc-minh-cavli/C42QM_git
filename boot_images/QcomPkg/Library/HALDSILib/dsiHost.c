    ...
    )
{
  ...
  do
  {
      ...
      {
         DSI_Log_Message(DSI_LOGLEVEL_WARNING, "Packet Timeout, Resending DSI Packet.");
      }
    ...
    DSI_PropertyParamsType   *pPropertyData)
{
  ...
  switch(eProperty)
  {
    ...
    {        
        ...
        DSI_OSAL_MemZero(&sDsiTimingParams, sizeof(HAL_DSI_TimingSettingType));
        ...
        {
           eStatus = DSI_STATUS_FAILED_NOT_SUPPORTED;
           DSI_Log_Message(DSI_LOGLEVEL_WARNING, "DSI Phy configuration failed in HAL_DSI_PhySetup() function at DSI_Display_SetProperty(DSI_DISPLAY_PROPERTYID_ACTIVE).\n");
        }
         
        if (HAL_MDSS_STATUS_SUCCESS != HAL_DSI_PhyPllSetup(&sDsiPhyConfig, &sDsiPhyConfigInfo))
        {
           eStatus = DSI_STATUS_FAILED_NOT_SUPPORTED;
           DSI_Log_Message(DSI_LOGLEVEL_WARNING, "DSI Pll configuration failed in HAL_DSI_PhyPllSetup()at DSI_Display_SetProperty(DSI_DISPLAY_PROPERTYID_ACTIVE), PLL could be unstable.\n");
        }

        /* Setup DSI Phy timing */
        sDsiTimingParams.eDeviceId          = eDeviceId;
        sDsiTimingParams.uBitclock          = sDsiPhyConfigInfo.uBitClkFreq;
        sDsiTimingParams.uEscapeFreq        = pPropertyData->sPhyParams.sDisplayInfo.uEscapeFreq;
        sDsiTimingParams.pPreDefinedTimings = &pPropertyData->sPhyParams.sTimingOverride;
        if (HAL_MDSS_STATUS_SUCCESS != HAL_DSI_PhySetupTimingParams(&sDsiTimingParams))
        {
           eStatus = DSI_STATUS_FAILED_NOT_SUPPORTED;
           DSI_Log_Message(DSI_LOGLEVEL_WARNING, "DSI Phy timing setup failed in HAL_DSI_PhySetupTimingParams() at DSI_Display_SetProperty(DSI_DISPLAY_PROPERTYID_ACTIVE).\n" );
        }
    }
    break;
    ...
    case DSI_DISPLAY_PROPERTYID_ENABLECORE:  
      ...
      break;
    case DSI_DISPLAY_PROPERTYID_ULPSCLAMP:
      {
        /* enable/disable DSI ULPS clamp control */
        HAL_DSI_ULPSClampConfig(eDeviceId, pPropertyData->bULPSClampEnable);
      }
      break;
    ...
    case DSI_DISPLAY_PROPERTYID_LANEMAP:
      {
        ...
        {
          psSharedData->eDevLane[uCount] = pPropertyData->aLaneMap[uCount];
        }
  ...
  case DSI_DISPLAY_PROPERTYID_LANESTATUS:
      {
        ...
        /* Retrieve the device lane status */
