...
--------   ---     ------------------------------------------------------------
04/01/19   KS      added interrupt support in Boot BAM driver
...
{
   RegisterInterruptSource (irq, (HARDWARE_INTERRUPT_HANDLER)isr, data);
   //edge only for QPIC BAM
   SetInterruptSourceConfig (irq,  INTERRUPT_SOURCE_CONFIG_TRIGGER_EDGE);
