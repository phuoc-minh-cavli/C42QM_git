...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Library/SmemLib/src/smem_target.c#1 $
...
void smem_targ_init(void)
{
  ...
  smem_targ_info_ptr = smem_os_map_memory_va((void *)(uintptr_t)smem_targ_info_addr,
