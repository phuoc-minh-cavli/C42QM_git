...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Library/SmemLib/src/smem_xbl_loader.c#1 $
...
void smem_boot_targ_info_set(void)
{
  ...
  *smem_targ_wonce_reg_addrs[0] = (uint32)((uint64)smem_targ_info_addr & 0xFFFFFFFF);
  *smem_targ_wonce_reg_addrs[1] = (uint32)((uint64)smem_targ_info_addr >> 32);
}
