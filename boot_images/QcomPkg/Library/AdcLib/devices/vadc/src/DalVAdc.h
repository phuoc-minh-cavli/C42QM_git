...
/*============================================================================
  ...
  Function and data structure declarations for VADC DAL
                ...
                Copyright (c) 2008-2016, 2018 Qualcomm Technologies, Inc.
                All Rights Reserved.
                Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
/* $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/AdcLib/devices/vadc/src/DalVAdc.h#1 $ */
...
DALResult VAdc_ProcessConversionResult(VAdcClientCtxt *, uint32, uint32, AdcDeviceResultType *);
DALResult VAdc_ProcessConversionResultInverse(VAdcClientCtxt *, uint32, int32, AdcDeviceResultType *);
