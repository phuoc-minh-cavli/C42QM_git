 ...
 *
 * Copyright (c) 2010-2014,2016, 2018, 2019 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 * ---------   ---     ----------------------------------------------
 * 01/22/19     sl     Update EEPROM dev id for 9205
 * 08/24/18     sl     Update EEPROM dev id for VT
 * 02/20/18     sl     Update to support VT
...
static struct flash_nor_params i2c_eeprom_devices[] =
{
  ...
  { //OEM custom EEPROM
    ...
    FLASH_WIDTH_UNKNOWN,		  /* Device Interface Width */
    FLASH_WRITES_SIMPLE,		  /* Write style specific to Flash */
    "CAT24C08", 			  /* Device name string */
    0,						  /* Num ids */
    {0, 0, 0, 0}, 			  /* Device ID */
    1,						  /* Number of total blocks in device */
    64,						  /* Number of pages in a block */
    16,						  /* Logical page size */
    0,						  /* Total density in Mega Bytes */
    16,						  /* Write Buffer size in bytes */
    I2C_DEVICE_FLAG_CUST_HDR, /* Device specific flags */
    400,					  /* Device operating frequency in KHz*/
    0x50, 					  /* Device base address */
    0,						  /* Total banks */
    0,						  /* Total erase regions */
