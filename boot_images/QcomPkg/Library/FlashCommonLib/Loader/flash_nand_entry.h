 ...
 *
 * Copyright (c) 2008-2013, 2019 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 * ----------   ---     ----------------------------------------------
 * 06/15/19     sl      Seperate R/W count to support pagescope/multipage.
...
struct nand_entry_data
{
  ...
  uint32 multi_read_support_count;       /* Number of pages/blocks
                                          operated between sync enter
                                          and sync release */
  uint32 multi_write_support_count;       /* Number of pages/blocks
                                          operated between sync enter
                                          and sync release */
