 ...
 *
 * Copyright (c) 2008-2010, 2012-2014,2016 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/FlashCommonLib/Loader/flash_dal.c#1 $ $DateTime: 2018/08/01 23:51:05 $ $Author: pwbldsvc $
 *
 *
...
int flash_dal_device_init(flash_client_ctxt *client_ctxt)
{
  ...
  {
    dev_id = dev_ctxt->dev_id;
    if ((dev_ctxt->dev_id == 0) && (dev_ctxt->str_dev_id != NULL))
    {
      dev_id = dev_ctxt->internal_dev_id;
    }
