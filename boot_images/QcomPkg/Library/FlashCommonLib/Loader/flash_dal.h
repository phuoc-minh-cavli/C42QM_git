 ...
 *   order.
 *
 *  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/FlashCommonLib/Loader/flash_dal.h#1 $ $DateTime: 2018/08/01 23:51:05 $ $Author: pwbldsvc $
 *
 *
...
struct flash_dev_ctxt
{
  ...
  uint32      internal_dev_id;         /* internal device id */
  const char  *str_dev_id;             /* string device id */
