 ...
 *
 * Copyright (c) 2011-2012, 2017, 2018 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 * ----------   ---     ----------------------------------------------
 * 06/15/19     sl      Removed RW count to support pagescope/multipage.
...
*/
  ...
  #define FLASH_XFER_BOOST_MODE_DISABLED  TRUE  /* Transfer Boost Mode: TRUE - Disabled, FALSE - Enabled */ 
      ...
      #define FLASH_HAL_WS_BUFF_SIZE_BYTES    10240  /* OTP Support needed */
    #endif
  #else
