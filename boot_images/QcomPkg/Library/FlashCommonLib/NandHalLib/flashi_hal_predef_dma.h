 ...
 *   order.
 *
 *  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/FlashCommonLib/NandHalLib/flashi_hal_predef_dma.h#1 $ $DateTime: 2018/08/01 23:51:05 $ $Author: pwbldsvc $
 *
 *
...
#define FLASH_DMA_CMD_WORD_LC_BMSK   ((uintnt)1 << FLASH_DMA_CMD_WORD_LC_SHFT)
...
#define FLASH_DMA_CMD_PTR_LIST_LP_BMSK               \
  ((uintnt)1 << FLASH_DMA_CMD_PTR_LIST_LP_SHFT)

#define FLASH_DMA_CMD_PTR_LIST_PT_SHFT               29
#define FLASH_DMA_CMD_PTR_LIST_PT_BMSK               \
  ((uintnt)3 << FLASH_DMA_CMD_PTR_LIST_PT_SHFT)

#define FLASH_DMA_CMD_PTR_LIST_ADDR_SHFT             0
#define FLASH_DMA_CMD_PTR_LIST_ADDR_BMSK             ((uintnt)0x1FFFFFFF)
...
#define SET_CMD_PTR(a)      (((uintnt)(a)) >> 3)

/* Sets the adddress of the last command list in command pointer list */
#define SET_LAST_CMD_PTR(a) ((((uintnt)(a)) >> 3) | FLASH_PREDEF_DMA_CP_LP)
