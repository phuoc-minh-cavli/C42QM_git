 ...
 *   order.
 *
 *  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/FlashCommonLib/NandHalLib/flash_hal_reg_list.h#2 $ $DateTime: 2019/04/23 17:39:55 $ $Author: pwbldsvc $
 *
 *
...
void flash_hal_gen_read_list(uintnt dst_addr, uintnt src_addr, uint32 dwOp,
  uint32 op_len);

/* Adds a register write command to the HAL register list */
void flash_hal_gen_write_list(uintnt dst_addr, uint32 dwVal, uint32 dwOp,
  uint32 op_len);
