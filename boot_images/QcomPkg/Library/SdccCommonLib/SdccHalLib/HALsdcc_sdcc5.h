...
#define HWIO_HC_VENDOR_SPECIFIC_FUNC3_HC_FIFO_ALT_ENABLE_BMSK           0x400
#define HWIO_HC_VENDOR_SPECIFIC_FUNC3_HC_FIFO_ALT_ENABLE_SHFT           0xa
 ...
 */
inline void
HAL_sdhci_FIFOALTDisable (const UINT32 nControllerId)
{
   UINT32 val = HWIO_SDC_REG_IN(HC_VENDOR_SPECIFIC_FUNC3, (UINTN)sdcc_reg_hc[nControllerId]);

   HWIO_SDC_REG_OUT (HC_VENDOR_SPECIFIC_FUNC3, (UINTN)sdcc_reg_hc[nControllerId], 
                    (val & ~HWIO_HC_VENDOR_SPECIFIC_FUNC3_HC_FIFO_ALT_ENABLE_BMSK) | 
                    ((UINT8)0x0 << HWIO_HC_VENDOR_SPECIFIC_FUNC3_HC_FIFO_ALT_ENABLE_SHFT));
}
