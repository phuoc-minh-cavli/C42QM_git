...
#define HAL_SDHCI_STATUS_VENDOR_SPECIFIC_BMSK                 0xF0000000
#define HAL_SDHCI_STATUS_TUNING_ERR_BMSK                      0x4000000
#define HAL_SDHCI_STATUS_ADMA_ERR_BMSK                        0x2000000
#define HAL_SDHCI_STATUS_AUTO_CMD_ERR_BMSK                    0x1000000
#define HAL_SDHCI_STATUS_CURRENT_LIMIT_ERR_BMSK               0x800000
#define HAL_SDHCI_STATUS_DATA_END_BIT_ERR_BMSK                0x400000
#define HAL_SDHCI_STATUS_DATA_CRC_ERR_BMSK                    0x200000
#define HAL_SDHCI_STATUS_DATA_TIMEOUT_ERR_BMSK                0x100000
#define HAL_SDHCI_STATUS_CMD_INDX_ERR_BMSK                    0x80000
#define HAL_SDHCI_STATUS_CMD_END_BIT_ERR_BMSK                 0x40000
#define HAL_SDHCI_STATUS_CMD_CRC_ERR_BMSK                     0x20000
#define HAL_SDHCI_STATUS_CMD_TIMEOUT_ERR_BMSK                 0x10000
#define HAL_SDHCI_STATUS_ERR_INT_BMSK                         0x8000
#define HAL_SDHCI_STATUS_RETUNING_EVENT_BMSK                  0x1000
#define HAL_SDHCI_STATUS_INT_C_BMSK                           0x800
#define HAL_SDHCI_STATUS_INT_B_BMSK                           0x400
#define HAL_SDHCI_STATUS_INT_A_BMSK                           0x200
#define HAL_SDHCI_STATUS_CARD_INT_BMSK                        0x100
#define HAL_SDHCI_STATUS_CARD_REMOVAL_BMSK                    0x80
#define HAL_SDHCI_STATUS_CARD_INSERTION_BMSK                  0x40
#define HAL_SDHCI_STATUS_BUF_RD_READY_BMSK                    0x20
#define HAL_SDHCI_STATUS_BUF_WR_READY_BMSK                    0x10
#define HAL_SDHCI_STATUS_DMA_INT_BMSK                         0x8
#define HAL_SDHCI_STATUS_BLK_GAP_EVENT_BMSK                   0x4
#define HAL_SDHCI_STATUS_TRANS_COMPLETE_BMSK                  0x2
#define HAL_SDHCI_STATUS_CMD_COMPLETE_BMSK                    0x1
...
/**
 * Register SDCC_HC_VENDOR_SPECIFIC_FUNC3 
 * Disable FIFO ALT MOME
 *
 * @param nControllerId
 *   SD controller number, as described in \ref nControllerId .
 *  
 */
void HAL_sdhci_FIFOALTDisable (const UINT32 nControllerId);
