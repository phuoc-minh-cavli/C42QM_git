...
/*=============================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DDRLib/common/HAL_DDR.h#2 $
...
/* IO width for x16 PHY */
#define IO_WIDTH_16BIT 16
...
*   @sa None
*/
void HAL_SDRAM_Enter_Self_Refresh(uint32 base, SDRAM_INTERFACE interface_name, SDRAM_CHIPSELECT chip_select, ddr_wait wait, uint32 ddr_type);
...
*   @sa None
*/
void HAL_SDRAM_Exit_Self_Refresh(uint32 base, SDRAM_INTERFACE interface_name, SDRAM_CHIPSELECT chip_select, ddr_wait wait, uint32 ddr_type);
