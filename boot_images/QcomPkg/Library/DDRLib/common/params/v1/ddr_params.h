...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DDRLib/common/params/v1/ddr_params.h#1 $
...
PACKED struct ddr_trained_params_lpddr3
{
...
//Gen1 Training Params structure.
struct ddr_trained_params_gen1
{
    uint8 nlevels;
    uint32 freq[DDR_FREQ_MAX_NUM_LEVELS];
    ...
    struct
    {
      uint16 ca_training;                          /* coarse*/
      uint16 dq_read_training[4];                  /* dq read coarse[delay]*/
      uint16 dq_write_training[4];              /* dq write coarse[delay] */
    } phy_cdc_params;
};
...
union ddr_trained_params
{
  ...
  struct ddr_trained_params_gen1 lpddr3_training;
};
...
*   None
*/
void ddr_params_set_shared_memory( ddr_size_info * ddr_size_info_ptr );
