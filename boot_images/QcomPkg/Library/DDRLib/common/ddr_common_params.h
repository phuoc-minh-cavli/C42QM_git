...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Library/DDRLib/common/ddr_common_params.h#1 $
$DateTime: 2018/08/01 23:51:05 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
06/05/15   sk      LDO2 headroom based on DDR size 
...
*   None
*/
void ddr_params_set_shared_memory(ddr_size_info *);
