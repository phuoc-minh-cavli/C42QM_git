 ...
 *   order.
 *
 *   $Header: //components/rel/boot.xf/0.2/QcomPkg/Library/NandJtagTools/config_v2/nand_core_v2.c#1 $
...
// #endif
ALIGN(ALIGN_VAL) unsigned char mibib_pg_buf[MAX_PAGE_SIZE] SECTION(".bss.FLASH_TOOLS_HEAP_ZONE");
// #if !defined(BUILD_EHOSTDL) && !defined(BUILD_HOSTDL)
