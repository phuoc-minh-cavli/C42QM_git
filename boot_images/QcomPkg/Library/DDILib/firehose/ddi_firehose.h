...
#define FIREHOSE_XML_BUFFER_SIZE 2048
#define FIREHOSE_LOG_BUFFER_SIZE 2048
#define FIREHOSE_TEMP_LOG_BUFFER_SIZE 256
#define FIREHOSE_TEMP_ATTRIBUTE_BUFFER_SIZE 512
...
#define DDI_FIREHOSE_SIZE_INFO_MAX    (18) //max number of ddi infomation supported
