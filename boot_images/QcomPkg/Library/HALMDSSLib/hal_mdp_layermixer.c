...
/****************************************************************************
*
** FUNCTION: HAL_MDP_LayerMixer_GammaCorrection_Config()
*/
/*!
* \brief
*     Initializes the layer mixer Gamma Correction Block (Area Reduced Gamma Correction)
...
*
****************************************************************************/
static void HAL_MDP_LayerMixer_GammaCorrection_Config(HAL_MDP_LayerMixerId                  eLayerMixerId,
                                                      HAL_MDP_Mixer_GammaCorrectConfigType *pGCConfig,
                                                      uint32                                uFlags)
{
#if 0 // TODO: Vipertooth , removed 
   uintPtr                        uMixerOffset                   = HAL_MDP_Get_LayerMixer_BaseOffset(eLayerMixerId);
                                             ...
                                             uint32                           uFlags)
{
   ...
   // Gamma Correction Table Configuration
   if(NULL != pLayerMixerConfig->psGammaCorrectConfig)
   {
      HAL_MDP_LayerMixer_GammaCorrection_Config(eLayerMixerId,
                                                pLayerMixerConfig->psGammaCorrectConfig,
                                                0x00);
   }
