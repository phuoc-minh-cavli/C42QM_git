...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright (c)2003-2004, 2006, 2008, 2013-2014 Qualcomm Technologies Inc. All Rights Reserved.
==========================================================================*/
...
--------   ---     ----------------------------------------------------------
12/26/14   hw      Added changes for 64-bit support
...
( ( ((uintptr_t)(p) + (uintptr_t)(len)) >= (uintptr_t)(p) ) &&       \
  ( ((uintptr_t)(p) + (uintptr_t)(len)) <= (uintptr_t)(bound) ) )    \
