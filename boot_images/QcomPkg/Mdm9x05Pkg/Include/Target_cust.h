...
12/21/18   as           Move DevPrgN section in Deviceprogrammer image to RPM CODE RAM.
12/27/18   rohik        Added support for Tiny modem boot
12/28/17   rohik        L2 TCM changed to BOOTIMEM and other memory map changes for Vipertooth
12/13/17   rohik        Added SCL_SBL_SEC_BASE and SCL_SBL_SEC_SIZE
...
#define SIZE_364KB  0x0005B000
#define SIZE_370KB  0x0005C800
#define SIZE_372KB  0x0005D000
#define SIZE_376KB  0x0005E000
...
#define SCL_BOOTIMEM_BASE_ADDR    0x08C00000
#define SCL_BOOTIMEM_SIZE         SIZE_512KB

#define SCL_SBL1_IMEM_PAGE_TABLE_BASE  (SCL_BOOTIMEM_BASE_ADDR)
#define SCL_SBL1_IMEM_PAGE_TABLE_SIZE   SIZE_28KB

/* HW-memory-map for initial pagetable L1/L2 mapping to access
   hw blocks like clock, crypto, usb, tlmm, NOC etc.
   first hw-block base in CNOC, CNOC size */
#define SBL_PHYSICAL_MAP1_L1_BASE   (PCNOC_0_BUS_TIMEOUT_BASE)
#define SBL_PHYSICAL_MAP1_L1_SIZE   SIZE_128MB

/* A7SS Region */
#define A7SS_REGION_BASE       0x0B000000
#define A7SS_REGION_SIZE       SIZE_2MB

#define SCL_RPM_CODE_RAM_BASE   0x00200000
#define SCL_RPM_CODE_RAM_SIZE   SIZE_144KB
#define SCL_RPM_CODE_SIZE       0x20000

#define BUILD_ASIC "405"

/* XBL rpm code ram buffer to span across [0x0021E000 to 0x00224000] */
#define SCL_RPM_CODE_RAM_XBL_BASE  (SCL_RPM_CODE_RAM_BASE + 0x20000)
#define SCL_RPM_CODE_RAM_XBL_SIZE  SIZE_16KB

/* SBL_SEC memory-map, 108KB at end of 1MB BOOT_IMEM. */
#define SCL_SBL_SEC_BASE                   0x08CE3000
#define SCL_SBL_SEC_SIZE                   0x1B000

#define SCL_DCC_SRAM_BASE       0x000BF800
#define SCL_DCC_SRAM_SIZE       SIZE_2KB
#define SCL_RPM_DATA_RAM_BASE   0x00290000 
#define SCL_RPM_DATA_RAM_SIZE   SIZE_64KB
#define SCL_RPM_MSG_RAM_BASE    0x00060000
#define SCL_RPM_MSG_RAM_SIZE    SIZE_12KB
#define SCL_IMEM_BASE           0x08600000
#define SCL_IMEM_SIZE           SIZE_164KB
#define SCL_SECURE_IMEM_BASE    0x08605000
#define SCL_SECURE_IMEM_SIZE    0x1000 //4KB for  OEM_MISC
#define SCL_SECURE_QTI_MISC_BASE    0x86400000
#define SCL_SECURE_QTI_MISC_SIZE    0x1000 //4KB for QTI MISC 
...
#define SCL_BOOTROM_MEMORY_REGION     SIZE_52KB
#define SCL_PRE_DDR_PAGE_TABLE_SIZE   SIZE_36KB
#define SCL_SBL1_IMAGE_BASE           (SCL_BOOTIMEM_BASE_ADDR + SCL_BOOTROM_MEMORY_REGION + SCL_PRE_DDR_PAGE_TABLE_SIZE)
#define SCL_SBL1_IMAGE_SIZE           SIZE_424KB
...
#define SCL_DDR_TRAINING_DATA_BUF_SIZE SIZE_1KB

/* XBL Loader L2 TCM memory map defines */
#define SCL_SBL1_CODE_BASE            SCL_SBL1_IMAGE_BASE
#define SCL_SBL1_CODE_SIZE            SIZE_304KB
...
#define SCL_SBL1_STACK_SIZE           SIZE_6KB

#define SCL_SBL1_CODE_STACK_BASE      SCL_SBL1_STACK_BASE
#define SCL_SBL1_CODE_STACK_SIZE      SIZE_4KB
#define SCL_SBL1_IRQ_STACK_BASE       (SCL_SBL1_CODE_STACK_BASE + SCL_SBL1_CODE_STACK_SIZE)
#define SCL_SBL1_IRQ_STACK_SIZE       (SCL_SBL1_STACK_SIZE - SCL_SBL1_CODE_STACK_SIZE)
...
#define SCL_SBL1_DATA_SIZE            SIZE_24KB
#define SCL_SBL1_DATA_ZI_BASE         (SCL_SBL1_DATA_BASE + SCL_SBL1_DATA_SIZE)
#define SCL_SBL1_DATA_ZI_SIZE         SIZE_68KB
#define SCL_SBL1_SHARED_FUNCTIONS_TABLE_BASE (SCL_SBL1_DATA_ZI_BASE + SCL_SBL1_DATA_ZI_SIZE)
...
#define SCL_SYSTEM_DEBUG_BASE           SCL_RPM_CODE_RAM_XBL_BASE
...
#define SHARED_IMEM_BASE 0x08628000
...
#define DDR_RANK1_L2_REDIRECT_BASE (DDR_MEM_RANK1_BASE + SCL_BOOTIMEM_BASE_ADDR)
...
#define SCL_SBL1_DDR_BASE 0x81E22000
#define SCL_SBL1_DDR_SIZE SIZE_192KB

#define SCL_SBL1_DDR_DATA_BASE SCL_SBL1_DDR_BASE
#define SCL_SBL1_DDR_DATA_SIZE SCL_SBL1_DDR_SIZE
#define SCL_SBL1_DDR_ZI_BASE SCL_SBL1_DDR_DATA_BASE
#define SCL_SBL1_DDR_ZI_SIZE SIZE_152KB
#define SCL_SBL1_DDR_PAGE_TABLE_BASE (SCL_SBL1_DDR_ZI_BASE + SCL_SBL1_DDR_ZI_SIZE)
#define SCL_SBL1_DDR_PAGE_TABLE_SIZE SIZE_32KB
#define SCL_SBL1_DDR_UNCACHED_ZI_BASE (SCL_SBL1_DDR_PAGE_TABLE_BASE + SCL_SBL1_DDR_PAGE_TABLE_SIZE)
#define SCL_SBL1_DDR_UNCACHED_ZI_SIZE (SCL_SBL1_DDR_DATA_SIZE - SCL_SBL1_DDR_PAGE_TABLE_SIZE - SCL_SBL1_DDR_ZI_SIZE)
...
#define SCL_SBL1_DDR_BOOT_LOG_BUF_SIZE SIZE_6KB
#define SCL_SBL1_DDR_BOOT_TIME_MARKER_BUF_SIZE SIZE_256B

#define SCL_SHARED_RAM_BASE 0x81E52000
#define SCL_SHARED_RAM_SIZE SIZE_440KB
#define SCL_QSEE_CODE_BASE 0x81EC0000
#define SCL_QSEE_TOTAL_SIZE 0x140000

/* In 9205, boot IMEM is reduced to 512KB(it was 1 MB in previous targets)
   With this XBL will be using most of the boot IMEM.So device programmer ZI section
   is moved to RPM_CODE_RAM memory.*/
#define SCL_DEVICEPROG_ZI_SIZE SIZE_120KB
#define SCL_DEVICEPROG_ZI_BASE (SCL_RPM_CODE_RAM_BASE)

/*Below define are for running device programmer image in SBL*/
#define SCL_DEVPRG_IMAGE_BASE                        DDR_MEM_BASE
#define SCL_DEVPRG_SBL1_CODE_BASE                    SCL_DEVPRG_IMAGE_BASE
#define SCL_DEVPRG_SBL1_CODE_SIZE                    SIZE_300KB
#define SCL_DEVPRG_SBL1_STACK_BASE                   (SCL_DEVPRG_SBL1_CODE_BASE + SCL_DEVPRG_SBL1_CODE_SIZE)
#define SCL_DEVPRG_SBL1_STACK_SIZE                   SIZE_4KB
#define SCL_DEVPRG_SBL1_DATA_BASE                    (SCL_DEVPRG_SBL1_STACK_BASE + SCL_DEVPRG_SBL1_STACK_SIZE)
#define SCL_DEVPRG_SBL1_DATA_SIZE                    SIZE_24KB
#define SCL_DEVPRG_SBL1_DATA_ZI_BASE                 (SCL_DEVPRG_SBL1_DATA_BASE + SCL_DEVPRG_SBL1_DATA_SIZE)
#define SCL_DEVPRG_SBL1_DATA_ZI_SIZE                 SIZE_68KB
#define SCL_DEVPRG_SBL1_SHARED_FUNCTIONS_TABLE_BASE  (SCL_DEVPRG_SBL1_DATA_ZI_BASE + SCL_DEVPRG_SBL1_DATA_ZI_SIZE)
#define SCL_DEVPRG_SBL1_SHARED_FUNCTIONS_TABLE_SIZE  SIZE_1KB
#define SCL_DEVPRG_SBL1_PAGE_TABLE_BASE              (SCL_DEVPRG_SBL1_DATA_ZI_BASE + SCL_DEVPRG_SBL1_DATA_ZI_SIZE)
#define SCL_DEVPRG_SBL1_PAGE_TABLE_SIZE              SIZE_4KB

#define SCL_DEVPRG_SBL1_DDR_DATA_SIZE                (SIZE_2MB+SIZE_192KB)
#define SCL_DEVPRG_SBL1_DDR_ZI_BASE                  (SCL_DEVPRG_SBL1_PAGE_TABLE_BASE + SCL_DEVPRG_SBL1_PAGE_TABLE_SIZE)
#define SCL_DEVPRG_SBL1_DDR_ZI_SIZE                  (SIZE_2MB+SIZE_152KB)
#define SCL_DEVPRG_SBL1_DDR_PAGE_TABLE_BASE          (SCL_DEVPRG_SBL1_DDR_ZI_BASE + SCL_DEVPRG_SBL1_DDR_ZI_SIZE)
#define SCL_DEVPRG_SBL1_DDR_PAGE_TABLE_SIZE          SIZE_32KB
#define SCL_DEVPRG_SBL1_DDR_UNCACHED_ZI_BASE         (SCL_DEVPRG_SBL1_DDR_PAGE_TABLE_BASE +\
                                                     SCL_DEVPRG_SBL1_DDR_PAGE_TABLE_SIZE)
#define SCL_DEVPRG_SBL1_DDR_UNCACHED_ZI_SIZE         (SCL_DEVPRG_SBL1_DDR_DATA_SIZE - SCL_DEVPRG_SBL1_DDR_PAGE_TABLE_SIZE -\
                                                     SCL_DEVPRG_SBL1_DDR_ZI_SIZE)

#define SCL_DEVPRG_SYSTEM_DEBUG_BASE                 (SCL_DEVPRG_SBL1_DDR_UNCACHED_ZI_BASE +\
                                                     SCL_DEVPRG_SBL1_DDR_UNCACHED_ZI_SIZE)
#define SCL_DEVPRG_SYSTEM_DEBUG_SIZE                 SIZE_16KB
#define SCL_DEVPRG_SYSTEM_DEBUG_CO_RO_BASE           (SCL_DEVPRG_SYSTEM_DEBUG_BASE)
#define SCL_DEVPRG_SYSTEM_DEBUG_CO_RO_SIZE           SIZE_12KB
#define SCL_DEVPRG_SYSTEM_DEBUG_DATA_BASE            (SCL_DEVPRG_SYSTEM_DEBUG_BASE + SCL_DEVPRG_SYSTEM_DEBUG_CO_RO_SIZE)
#define SCL_DEVPRG_SYSTEM_DEBUG_QSEE_INFO_SIZE       SIZE_1KB
#define SCL_DEVPRG_SYSTEM_DEBUG_DATA_SIZE            (SCL_DEVPRG_SYSTEM_DEBUG_SIZE - SCL_DEVPRG_SYSTEM_DEBUG_CO_RO_SIZE -\
                                                     SCL_DEVPRG_SYSTEM_DEBUG_QSEE_INFO_SIZE)
#define SCL_DEVPRG_SYSTEM_DEBUG_QSEE_INFO_BASE       (SCL_DEVPRG_SYSTEM_DEBUG_DATA_BASE + SCL_DEVPRG_SYSTEM_DEBUG_DATA_SIZE)

#define SCL_SBL_DEVPRG_ZI_BASE                       (SCL_DEVPRG_SYSTEM_DEBUG_QSEE_INFO_BASE +\
                                                      SCL_DEVPRG_SYSTEM_DEBUG_QSEE_INFO_SIZE)
#define SCL_SBL_DEVPRG_ZI_SIZE                        SIZE_1MB

#define SCL_DDI_ZI_BASE SCL_QSEE_CODE_BASE
#define SCL_DDI_ZI_SIZE SCL_QSEE_TOTAL_SIZE

#define SCL_APPSBL_CODE_BASE 0x81300000
#define SCL_APPSBL_TOTAL_SIZE 0x00922000
...
#define SCL_RAMDUMP_TOTAL_SIZE SIZE_512KB
#define SCL_RAMDUMP_CODE_BASE SCL_APPSBL_CODE_BASE
#define SCL_RAMDUMP_CODE_SIZE SIZE_144KB
...
#define SCL_LOADERTEST_CODE_BASE   SCL_APPSBL_CODE_BASE
#define SCL_LOADERTEST_CODE_SIZE   SIZE_2MB
#define SCL_LOADERTEST_DATA_BASE   (SCL_APPSBL_CODE_BASE + SCL_LOADERTEST_CODE_SIZE)
...
#define SCL_MODEM_COMMON_BASE 0x80000000
#define SCL_MODEM_COMMON_SIZE SIZE_2MB
#define SCL_MODEM_NB1_BASE (SCL_MODEM_COMMON_BASE + SCL_MODEM_COMMON_SIZE)
#define SCL_MODEM_NB1_SIZE SIZE_2MB
#define SCL_MODEM_CATM1_BASE (SCL_MODEM_NB1_BASE + SCL_MODEM_NB1_SIZE)
#define SCL_MODEM_CATM1_SIZE SIZE_2MB
...
#define SCL_PMIC_CONFIG_BUF_BASE_DDI  SCL_RPM_CODE_RAM_BASE
#define SCL_PMIC_CONFIG_BUF_DDI_SIZE SIZE_12KB

/*  DDI VMEM base addresses and sizes */
#define SCL_BOOTIMEM_DDI_BASE_ADDR SCL_PMIC_CONFIG_BUF_BASE_DDI+SCL_PMIC_CONFIG_BUF_DDI_SIZE
#define SCL_BOOTIMEM_DDI_TCM_SIZE SIZE_48KB
#define SCL_VMEM_DDI_DATA_BASE (SCL_BOOTIMEM_DDI_BASE_ADDR + SCL_BOOTIMEM_DDI_TCM_SIZE)
#define SCL_VMEM_DDI_DATA_SIZE SIZE_44KB
#define SCL_BOOTIMEM_DDI_ZI_BASE_ADDR SCL_VMEM_DDI_DATA_BASE + SCL_VMEM_DDI_DATA_SIZE
#define SCL_BOOTIMEM_DDI_ZI_SIZE SIZE_16KB
