...
XML_DEPS = $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/ICB/$(MACRO_NAME)/icbcfg_boot.xml \
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/PMIC/$(MACRO_NAME)/pm_config_target_loader.xml \
           ...
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/ADC/internal/loader/adc_props.xml \
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/ADC/internal/loader/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/BAM/bam_config.xml \
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/TLMM/loader/TLMMChipset.xml \
           $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/SMEM/smem_xbl_loader.xml \
	         $(WORKSPACE)/QcomPkg/Mdm9x05Pkg/Settings/NAND/nand_config.xml \
