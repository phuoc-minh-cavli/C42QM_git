...
sdcc_set_mclk_frequency (UINT32 driveno, sdcc_bsp_clk_type sdcc_mclk)
{
   ...
   ClockFrequency = CLOCK_BOOT_PERF_SVS;
...
sdcc_reset_mclk( UINT32 driveno )
{
   ...
   case SDCC_BSP_SLOT_0:
     ...
     HWIO_GCC_SDCC1_BCR_OUT(1); 
     busywait(500);
     HWIO_GCC_SDCC1_BCR_OUT(0);		 
     break;
   
   case SDCC_BSP_SLOT_1:
     HWIO_GCC_SDCC2_BCR_OUT(1); 
     busywait(500);
     HWIO_GCC_SDCC2_BCR_OUT(0);	 
     break;
...
sdcc_ahb_clk_init ( UINT32 driveno )
{
   ...
   {
   case SDCC_BSP_SLOT_0:
      reg_value = HWIO_GCC_SDCC1_AHB_CBCR_IN;
      reg_value |= HWIO_GCC_SDCC1_AHB_CBCR_CLK_ENABLE_BMSK;
      HWIO_GCC_SDCC1_AHB_CBCR_OUT(reg_value); 
      break;
   case SDCC_BSP_SLOT_1:
      reg_value = HWIO_GCC_SDCC2_AHB_CBCR_IN;
      reg_value |= HWIO_GCC_SDCC2_AHB_CBCR_CLK_ENABLE_BMSK;
      HWIO_GCC_SDCC2_AHB_CBCR_OUT(reg_value); 
      break;
   default:
      BspStatus = SDCC_BSP_ERR_INVALID_PARAM;
      break;
