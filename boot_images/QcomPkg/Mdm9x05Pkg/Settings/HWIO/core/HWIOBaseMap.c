...
/*
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Settings/HWIO/core/HWIOBaseMap.c#3 $
...
static HWIOModuleType HWIOModules_PCNOC_0_BUS_TIMEOUT[] =
{
  { "PCNOC_0_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_1_BUS_TIMEOUT[] =
{
  { "PCNOC_1_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_2_BUS_TIMEOUT[] =
{
  { "PCNOC_2_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_3_BUS_TIMEOUT[] =
{
  { "PCNOC_3_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_5_BUS_TIMEOUT[] =
{
  { "PCNOC_5_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_6_BUS_TIMEOUT[] =
{
  { "PCNOC_6_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_7_BUS_TIMEOUT[] =
{
  { "PCNOC_7_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_RBCPR_WRAPPER[] =
{
  { "RBCPR_WRAPPER",                               0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
{
  { "RPM_MSG_RAM",                                 0x00000000, 0x00003000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_USB2_PHY_CM_DWC_USB2_SW[] =
{
  { "USB2_PHY_CM_DWC_USB2_SW",                     0x00000000, 0x00000200 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_MPU_MSS_NAV_CE_CFG_MPU1132A_10_M31L12_AXI[] =
{
  { "MPU_MSS_NAV_CE_CFG_MPU1132A_10_M31L12_AXI",   0x00000000, 0x00000700 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_VMIDMT_MSS_NAV_CE_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8[] =
{
  { "VMIDMT_MSS_NAV_CE_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8", 0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_VMIDMT_MSS_Q6_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8[] =
{
  { "VMIDMT_MSS_Q6_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8", 0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_VMIDMT_PCNOC_SNOC_1_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128[] =
{
  { "VMIDMT_PCNOC_SNOC_1_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128", 0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_VMIDMT_PCNOC_SNOC_3_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128[] =
{
  { "VMIDMT_PCNOC_SNOC_3_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128", 0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_VMIDMT_PCNOC_SNOC_4_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128[] =
{
  { "VMIDMT_PCNOC_SNOC_4_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128", 0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_EBI1_PHY_CFG[] =
{
  { "DIM_C00_DDRPHY_CA",                           0x00000000, 0x00000134 },
  { "DIM_D00_DDRPHY_DQ",                           0x00000800, 0x00000134 },
  { "DIM_D01_DDRPHY_DQ",                           0x00001000, 0x00000134 },
  { "EBI1_AHB2PHY_SWMAN",                          0x0001f000, 0x00000400 },
  { "EBI1_AHB2PHY_BROADCAST_SWMAN",                0x0001f800, 0x00000400 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_USB20S[] =
{
...
static HWIOModuleType HWIOModules_MSS_TCM[] =
{
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_A7SS_L2[] =
{
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_IMEM[] =
{
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_PCNOC_4_BUS_TIMEOUT[] =
{
  { "PCNOC_4_BUS_TIMEOUT",                         0x00000000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_A7SS[] =
{
  { "APCS_QGIC2",                                  0x00000000, 0x00006000 },
  { "APCS_ACC",                                    0x00008000, 0x00001000 },
  { "APCS_SAW2",                                   0x00009000, 0x00001000 },
  { "QTMR_AC",                                     0x00020000, 0x00001000 },
  { "APCS_F0_QTMR_V1",                             0x00021000, 0x00001000 },
  { "APCS_F0_QTMR_V2",                             0x00022000, 0x00001000 },
  { "APCS_F1_QTMR_V1",                             0x00023000, 0x00001000 },
  { "APCS_F2_QTMR_V1",                             0x00024000, 0x00001000 },
  { "APCS_F3_QTMR_V1",                             0x00025000, 0x00001000 },
  { "APCS_F4_QTMR_V1",                             0x00026000, 0x00001000 },
  { "APCS_F5_QTMR_V1",                             0x00027000, 0x00001000 },
  { "APCS_F6_QTMR_V1",                             0x00028000, 0x00001000 },
  { "APCS_F7_QTMR_V1",                             0x00029000, 0x00001000 },
  { "APCS_WDT",                                    0x00017000, 0x00001000 },
  { "APCS_GLB",                                    0x00010000, 0x00001000 },
  { "APCS_GCC",                                    0x00011000, 0x00001000 },
  { NULL, 0, 0 }
};

static HWIOModuleType HWIOModules_DDR[] =
{
  { NULL, 0, 0 }
};
...
{
  {
    ...
    0x00001000,
    (DALSYSMemAddr)0x00023000,
    HWIOModules_PCNOC_0_BUS_TIMEOUT
  },
  {
    "PCNOC_1_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x00024000,
    HWIOModules_PCNOC_1_BUS_TIMEOUT
  },
  {
    "PCNOC_2_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x00025000,
    HWIOModules_PCNOC_2_BUS_TIMEOUT
  },
  {
    "PCNOC_3_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x00026000,
    HWIOModules_PCNOC_3_BUS_TIMEOUT
  },
  {
    "PCNOC_5_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x00028000,
    HWIOModules_PCNOC_5_BUS_TIMEOUT
  },
  {
    "PCNOC_6_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x00029000,
    HWIOModules_PCNOC_6_BUS_TIMEOUT
  },
  {
    "PCNOC_7_BUS_TIMEOUT",
    ...
    0x00001000,
    (DALSYSMemAddr)0x0002a000,
    HWIOModules_PCNOC_7_BUS_TIMEOUT
  },
  {
  ...
  },
  {
    ...
    (DALSYSMemAddr)0x0006c000,
    0x00000200,
    (DALSYSMemAddr)0x0006c000,
    HWIOModules_USB2_PHY_CM_DWC_USB2_SW
  },
  {
  ...
  {
    "MPU_MSS_NAV_CE_CFG_MPU1132A_10_M31L12_AXI",
    (DALSYSMemAddr)0x0008a000,
    0x00000700,
    (DALSYSMemAddr)0x0008a000,
    HWIOModules_MPU_MSS_NAV_CE_CFG_MPU1132A_10_M31L12_AXI
  },
  {
    "VMIDMT_MSS_NAV_CE_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8",
    (DALSYSMemAddr)0x0008c000,
    0x00001000,
    (DALSYSMemAddr)0x0008c000,
    HWIOModules_VMIDMT_MSS_NAV_CE_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8
  },
  {
  ...
  {
    "VMIDMT_MSS_Q6_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8",
    (DALSYSMemAddr)0x00090000,
    0x00001000,
    (DALSYSMemAddr)0x00090000,
    HWIOModules_VMIDMT_MSS_Q6_CFG_VMIDMT_SMR_4_SSD3_SID3_MA8
  },
  {
  ...
  {
    "VMIDMT_PCNOC_SNOC_1_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128",
    (DALSYSMemAddr)0x00094000,
    0x00001000,
    (DALSYSMemAddr)0x00094000,
    HWIOModules_VMIDMT_PCNOC_SNOC_1_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128
  },
  {
  ...
  {
    "VMIDMT_PCNOC_SNOC_3_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128",
    (DALSYSMemAddr)0x00098000,
    0x00001000,
    (DALSYSMemAddr)0x00098000,
    HWIOModules_VMIDMT_PCNOC_SNOC_3_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128
  },
  {
    "VMIDMT_PCNOC_SNOC_4_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128",
    (DALSYSMemAddr)0x0009a000,
    0x00001000,
    (DALSYSMemAddr)0x0009a000,
    HWIOModules_VMIDMT_PCNOC_SNOC_4_CFG_VMIDMT_SMR_128_SSD7_SID7_MA128
  },
  {
    "SECURITY_CONTROL",
  ...
  {
    "PCNOC_4_BUS_TIMEOUT",
    (DALSYSMemAddr)0x08801000,
    0x00001000,
    (DALSYSMemAddr)0x08801000,
    HWIOModules_PCNOC_4_BUS_TIMEOUT
  },
  {
    "BOOT_IMEM",
    (DALSYSMemAddr)0x08c00000,
    0x008c0000,
    (DALSYSMemAddr)0x08c00000,
