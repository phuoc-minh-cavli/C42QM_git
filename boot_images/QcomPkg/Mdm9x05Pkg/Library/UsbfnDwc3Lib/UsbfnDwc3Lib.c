...
static void dci_enable_external_vbus_config(UINTN QscratchBase)
{
 /*
    ...
    */
    ...
    HWIO_USB2_HS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_HS_PHY_CTRL_UTMI_OTG_VBUS_VALID_BMSK, (0x1 << HWIO_USB2_HS_PHY_CTRL_UTMI_OTG_VBUS_VALID_SHFT));
    
    //2.    Software updates HS_PHY_CTRL.SW_SESSVLD_SEL to 1 indicating that the value is driven by UTMI_OTG_VBUS_VALID.
    HWIO_USB2_HS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_HS_PHY_CTRL_SW_SESSVLD_SEL_BMSK, (0x1 << HWIO_USB2_HS_PHY_CTRL_SW_SESSVLD_SEL_SHFT));
    
    //3.    Software set lane0_power_present
    HWIO_USB2_SS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_SS_PHY_CTRL_LANE0_PWR_PRESENT_BMSK, (0x1 << HWIO_USB2_SS_PHY_CTRL_LANE0_PWR_PRESENT_SHFT)); 
}
...
static void dci_disable_external_vbus_config(UINTN QscratchBase)
{
 /*
    ...
    */
    ...
    //1.    Software updates HS_PHY_CTRL.UTMI_OTG_VBUS_VALID. 
    HWIO_USB2_HS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_HS_PHY_CTRL_UTMI_OTG_VBUS_VALID_BMSK, (0x0 << HWIO_USB2_HS_PHY_CTRL_UTMI_OTG_VBUS_VALID_SHFT));
    
    //2.    Software updates HS_PHY_CTRL.SW_SESSVLD_SEL to 1 indicating that the value is driven by UTMI_OTG_VBUS_VALID.
    HWIO_USB2_HS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_HS_PHY_CTRL_SW_SESSVLD_SEL_BMSK, (0x0 << HWIO_USB2_HS_PHY_CTRL_SW_SESSVLD_SEL_SHFT));
    
    //3.    Software clear lane0_power_present
    HWIO_USB2_SS_PHY_CTRL_OUTM(QscratchBase, HWIO_USB2_SS_PHY_CTRL_LANE0_PWR_PRESENT_BMSK, (0x0 << HWIO_USB2_SS_PHY_CTRL_LANE0_PWR_PRESENT_SHFT)); 
}
  ...
  OUT USB_CHARGER_PORT_TYPE *ChargerPortType) 
{
  ...
  DEBUG((EFI_D_ERROR, "Status for Charger (0x%x)\r\n", Status));

  if (EFI_ERROR(Status))
  {
    DEBUG((EFI_D_ERROR, "Either SMB not present or Failed to call PMIC ChargerPort Status =  (0x%x)\r\n", Status));
