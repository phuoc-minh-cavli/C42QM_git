...
#define CLOCK_DDR_TYPE_MASK                        (0xF)
#define CLOCK_DDR_TYPE_SHIFT                       (0x0)
#define CLOCK_DDR_SRCP_IDX_MASK                    (0xF0)
#define CLOCK_DDR_SRCP_IDX_SHIFT                   (0x4)
#define CLOCK_DDR_TYPE(ddr_type)                   ((ddr_type & CLOCK_DDR_TYPE_MASK) << CLOCK_DDR_TYPE_SHIFT)
#define CLOCK_DDR_SRCP_IDX(ddr_type)               ((ddr_type & CLOCK_DDR_SRCP_IDX_MASK) << CLOCK_DDR_SRCP_IDX_SHIFT)
...
typedef struct
{
  ...
  uint8  nDDRInfo;     /* first 3bits used for DDR Type and rest used for DDR Self-Refresh freq, i.e Index to the clock plan table */
...
void Clock_UpdatePreDDRInitSourceData(ClockConfigMuxType *pDDRCfg, ClockConfigMuxType *pBIMCGPUCfg);
