...
typedef enum {
  ...
  SRC_BIMCPLL = HAL_CLK_SOURCE_BIMCPLL,
  ...
  SRC_A53PLL,     /* No HAL definition for A53PLL */
  SRC_A53PWRPLL,  /* No HAL definition for A53PWRPLL */
  SRC_A53PERFPLL, /* No HAL definition for A53PERFPLL */
  SRC_A53CCIPLL,  /* No HAL definition for A53CCIPLL */
  SRC_RAW = HAL_CLK_SOURCE_RAW0,
  SRC_EXT1,
  SRC_EXT2,
  SRC_GPLL1_DIV2
} ClockSourceType;
