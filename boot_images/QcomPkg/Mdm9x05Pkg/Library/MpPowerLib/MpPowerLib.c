/** @file MpPowerLib.c
  ...
  Copyright (c) 2015-18, Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/MpPowerLib/MpPowerLib.c#1 $
...
EFI_STATUS MpPower (UINTN  CoreNum)
{
  ...
  Status = PmicVRegProtocol->VregSetLevel(0, pmicVregID, 1224);
  if (EFI_ERROR(Status))
  {
    return Status;
  }
