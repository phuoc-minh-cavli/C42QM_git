...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/DSFTargetLib/controller/BIMC.h#2 $
 ...
 *   @sa None
 */
void HAL_SDRAM_DPE_Pre_Clock_Switch(uint32 base, SDRAM_INTERFACE interface,  uint32 old_clk, uint32 new_clk, uint32 ddr_type);
 ...
 *   @sa None
 */
void HAL_SDRAM_DPE_Post_Clock_Switch(uint32 base, SDRAM_INTERFACE interface,  uint32 old_clk, uint32 new_clk, uint32 ddr_type);
