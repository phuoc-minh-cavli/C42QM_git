...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/DSFTargetLib/controller/BIMC_SHKE_v1.c#3 $
...
void HAL_SDRAM_SHKE_Init(uint32 base, SDRAM_INTERFACE interface)
{
  ...
  */
  ...
  /*
    ...
    is selected.
  */
  tREFI = ddr_divide_func((ddr_divide_func(ddr_params_lpddr->tREFI,1000) * XO_SPEED_IN_KHZ), 10000) - 1;
