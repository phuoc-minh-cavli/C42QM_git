//============================================================================
/**
 * @file        qusb_dci__twizy_hw_apis_sbl1.c
 * @date        1-21-2019
 *
...
void qusb_timer_start(uint32 timer_value)
{
      ...
      )
  {
    ...
    //Mask the interrupt 
    HWIO_APCS_F0_QTMR_V1_CNTP_CTL_OUTM(HWIO_APCS_F0_QTMR_V1_CNTP_CTL_IMSK_BMSK, 
      (0x1 << HWIO_APCS_F0_QTMR_V1_CNTP_CTL_IMSK_SHFT)); 
  }
  ...
  //start the timer 
  HWIO_APCS_F0_QTMR_V1_CNTP_CTL_OUTM(HWIO_APCS_F0_QTMR_V1_CNTP_CTL_EN_BMSK,
    (0x1 << HWIO_APCS_F0_QTMR_V1_CNTP_CTL_EN_SHFT));
  return; 
}
...
void qusb_timer_stop(void)
{
  ...
  //stop the timer 
  HWIO_APCS_F0_QTMR_V1_CNTP_CTL_OUTM(
    HWIO_APCS_F0_QTMR_V1_CNTP_CTL_EN_BMSK,
    (0x0 << HWIO_APCS_F0_QTMR_V1_CNTP_CTL_EN_SHFT));
}
//============================================================================
/**
...
boolean qusb_timer_check_for_expiry(void)
{
  ...
  if(0x0 == HWIO_APCS_F0_QTMR_V1_CNTP_TVAL_INM(HWIO_APCS_F0_QTMR_V1_CNTP_TVAL_CNTP_TVAL_BMSK))
  {
    ...
    //Mask the interrupt 
    HWIO_APCS_F0_QTMR_V1_CNTP_CTL_OUTM(
      HWIO_APCS_F0_QTMR_V1_CNTP_CTL_IMSK_BMSK, 
      (0x1 << HWIO_APCS_F0_QTMR_V1_CNTP_CTL_IMSK_SHFT));
