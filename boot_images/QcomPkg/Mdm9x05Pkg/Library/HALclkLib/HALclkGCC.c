...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/HALclkLib/HALclkGCC.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mGCCSLEEPClkDomainClks[] =
{
  ...
  {
    /* .szClockName      = */ "lpass_sleep_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_LPASS_SLEEP_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_LPASS_SLEEP_CLK
  },
#endif
...
static HAL_clk_ClockDescType HAL_clk_mGCCXOClkDomainClks[] =
{
  ...
  {
    /* .szClockName      = */ "gcc_geni_ir_s_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_GENI_IR_S_CBCR), HWIO_OFFS(GCC_GENI_IR_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_GENI_IR_S_CLK
  },
  {
  ...
  {
    /* .szClockName      = */ "gcc_pwm1_xo512_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_PWM1_XO512_CBCR), HWIO_OFFS(GCC_PWM1_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_PWM1_XO512_CLK
  },
  {
    /* .szClockName      = */ "gcc_pwm2_xo512_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_PWM2_XO512_CBCR), HWIO_OFFS(GCC_PWM2_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_PWM2_XO512_CLK
  },
#if 0 /* not present on apcs */
