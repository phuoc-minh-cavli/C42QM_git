  ...
  *pnFreqHz = 0;
  ...
  switch (nTestClockType)
  {
    ...
    case HAL_CLK_APCS_TEST:
      ...
      {
        nPreMultiplier = 1;
        HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, CDIV, 0);

        HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL1_SEL, 2);
        HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL2_SEL, 0);
        HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL3_SEL, 0);
    ...
    case HAL_CLK_APCS0_TEST_CORE:
      ...
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL1_SEL, 0);
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL2_SEL, 0);
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL3_SEL, 0);
    ...
    case HAL_CLK_APCS1_TEST_CORE:
      ...
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL1_SEL, 1);
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL2_SEL, 0);
      HWIO_OUTF(APCS_ALIAS1_GLB_CLK_DIAG, DBG_CLK_LVL3_SEL, 0);
