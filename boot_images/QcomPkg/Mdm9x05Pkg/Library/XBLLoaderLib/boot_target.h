...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/XBLLoaderLib/boot_target.h#5 $
  $DateTime: 2019/07/03 01:35:43 $ 
  $Author: pwbldsvc $

when       who          what, where, why
--------   --------     ----------------------------------------------------------
06/24/19   aus          Updated define for tiny image support
12/27/18   rohik        Added support for Tiny modem boot
12/28/17   rohik        Added DEFAULT_WHITELIST_REGION_TABLE for whitelist protection 
...
#define MODEM_LOAD_BIT_SHFT 0x0
#define TINY_TYPE_BIT_SHFT 0x1
#define APPS_LOAD_BIT_SHFT 0x4
...
#define WHITELIST_REGION6   {DDR_MEM_BASE, SCL_SBL1_DDR_BASE - DDR_MEM_BASE}
#define WHITELIST_REGION7   {SCL_QSEE_CODE_BASE, SCL_QSEE_TOTAL_SIZE}
#define WHITELIST_REGION8   {SCL_RPM_CODE_RAM_BASE, SCL_RPM_CODE_RAM_SIZE}
#define WHITELIST_REGION9   {SCL_RPM_DATA_RAM_BASE, SCL_RPM_DATA_RAM_SIZE}
#define WHITELIST_REGION10   {TZBSP_SECDAT_BUFFER_BASE, TZBSP_SECDAT_BUFFER_SIZE}
#define WHITELIST_REGION11   {SCL_IMEM_BASE, SCL_IMEM_SIZE}
#define WHITELIST_REGION12   {SCL_SECURE_IMEM_BASE , SCL_SECURE_IMEM_SIZE }
#define WHITELIST_REGION13   {SCL_SECURE_QTI_MISC_BASE , SCL_SECURE_QTI_MISC_SIZE }
#define WHITELIST_REGION14   {SCL_MODEM_COMMON_BASE , SCL_MODEM_COMMON_SIZE }
#define WHITELIST_REGION15   {SCL_MODEM_NB1_BASE , SCL_MODEM_NB1_SIZE }
#define WHITELIST_REGION16   {SCL_MODEM_CATM1_BASE , SCL_MODEM_CATM1_SIZE }
#define WHITELIST_REGION_LAST {0, 0}

/* Whitelist Table note: Must be on one line as '\' operator not defined in .builds environment */
#define XBL_CORE_WHITELIST_REGION_TABLE WHITELIST_REGION1,WHITELIST_REGION_LAST
...
#define DEFAULT_WHITELIST_REGION_TABLE WHITELIST_REGION6,WHITELIST_REGION7,WHITELIST_REGION8,WHITELIST_REGION9,WHITELIST_REGION11,WHITELIST_REGION12,WHITELIST_REGION13,WHITELIST_REGION_LAST
#define SEC_DAT_WHITELIST_REGION WHITELIST_REGION10,WHITELIST_REGION_LAST
#define NB1_WHITELIST_REGION WHITELIST_REGION14,WHITELIST_REGION15,WHITELIST_REGION_LAST
#define CATM1_WHITELIST_REGION WHITELIST_REGION14,WHITELIST_REGION16,WHITELIST_REGION_LAST
...
===========================================================================*/
#define CALCULATE_TIMESTAMP_MPM(COUNT) \
