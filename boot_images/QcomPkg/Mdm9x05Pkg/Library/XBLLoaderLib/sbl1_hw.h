...
$Header: //components/rel/boot.xf/0.2/QcomPkg/Mdm9x05Pkg/Library/XBLLoaderLib/sbl1_hw.h#1 $
...
**  Function :  sbl1_pm_qsee_pre_init_wrapper
...
*
* @par Dependencies
*   Must be called before loading QSEE
*
* @retval
*   None
*
