...
whitelst_tbl_entry_type ddr_training_table[] =
...
void ddr_training_entry ()
{
	if(ddr_training_config_entry.load == TRUE)
	{
	  ...
	  ddr_training_mem_block.access = MMU_L2_PAGETABLE_MEM_READ_WRITE;
	  ddr_training_mem_block.executable = MMU_L2_PAGETABLE_NON_EXECUTABLE_REGION;
