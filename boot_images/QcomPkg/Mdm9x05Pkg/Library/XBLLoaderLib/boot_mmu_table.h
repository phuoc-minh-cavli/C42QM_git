...
static struct mem_block sbl_initial_memory_map[] =
{
 ...
 /* CNOC map, to access device-shared hw blocks like clock, crypto, usb, tlmm, NOC etc */
  { SBL_PHYSICAL_MAP1_L1_BASE,
    SBL_PHYSICAL_MAP1_L1_BASE,
    SBL_PHYSICAL_MAP1_L1_SIZE >> 10,
 ...
 /* Bootimem Region */
  { SCL_BOOTIMEM_BASE_ADDR,
    SCL_BOOTIMEM_BASE_ADDR,
    SCL_BOOTIMEM_SIZE >> 10,
    MMU_L1_SECTION_MAPPING,
    MMU_L1_PAGETABLE_MEM_READ_WRITE,
    MMU_L1_PAGETABLE_DEVICE_SHARED,
    MMU_L1_PAGETABLE_NON_EXECUTABLE_REGION, },	
 ...
 /* SBL1 Code and Vectors.  Reusable L3. */
  ...
  { SCL_SBL1_STACK_BASE,
    SCL_SBL1_STACK_BASE,
    (SCL_SBL1_STACK_SIZE + SCL_SBL1_DATA_SIZE + SCL_SBL1_DATA_ZI_SIZE + SCL_SBL1_SHARED_FUNCTIONS_TABLE_SIZE) >> 10,
    MMU_L2_SECTION_MAPPING,
  ...
  */
  ...
  { 
    ...
    SCL_SYSTEM_DEBUG_DATA_BASE, 
    (SCL_SYSTEM_DEBUG_DATA_SIZE + SCL_SYSTEM_DEBUG_QSEE_INFO_SIZE) >> 10,
    MMU_L2_SECTION_MAPPING,
    MMU_L2_PAGETABLE_MEM_READ_WRITE,
    MMU_L2_PAGETABLE_MEM_WRITE_BACK_CACHE,
    MMU_L2_PAGETABLE_NON_EXECUTABLE_REGION, },
  ...
  { DDR_MEM_BASE,
    ...
    MMU_L1_SECTION_MAPPING,
    MMU_L1_PAGETABLE_MEM_READ_WRITE, 
    MMU_L1_PAGETABLE_MEM_WRITE_BACK_CACHE,
    MMU_L1_PAGETABLE_NON_EXECUTABLE_REGION, },
...
{ 
  ...
  { SCL_SHARED_RAM_BASE,
    ...
    MMU_L2_SECTION_MAPPING,
    MMU_L2_PAGETABLE_MEM_READ_WRITE, 
    MMU_L2_PAGETABLE_MEM_NON_CACHEABLE_SHARED,
    MMU_L2_PAGETABLE_NON_EXECUTABLE_REGION, },
...
{
  { SCL_BOOTIMEM_DDI_ZI_BASE_ADDR,
    SCL_BOOTIMEM_DDI_ZI_BASE_ADDR,
    SCL_BOOTIMEM_DDI_ZI_SIZE >> 10,
    MMU_L2_SECTION_MAPPING,
    MMU_L2_PAGETABLE_MEM_READ_WRITE,
    MMU_L2_PAGETABLE_MEM_NON_CACHEABLE,
    MMU_L2_PAGETABLE_NON_EXECUTABLE_REGION, },

  { SCL_BOOTIMEM_DDI_BASE_ADDR,
    SCL_BOOTIMEM_DDI_BASE_ADDR,
    SCL_BOOTIMEM_DDI_TCM_SIZE >> 10,
    MMU_L2_SECTION_MAPPING,
    MMU_L2_PAGETABLE_MEM_READ_ONLY,
    MMU_L2_PAGETABLE_MEM_NON_CACHEABLE,
    MMU_L2_PAGETABLE_EXECUTABLE_REGION, },
...
struct mem_block sbl1_ddr_mem_block = 
{
  ...
  MMU_L1_PAGETABLE_MEM_WRITE_BACK_CACHE, MMU_L1_PAGETABLE_NON_EXECUTABLE_REGION
};
