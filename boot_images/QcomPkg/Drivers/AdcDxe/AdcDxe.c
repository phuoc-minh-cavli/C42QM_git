...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2018-03-07  KS   Added an entry for Suzuka pmic (smb2351) in gaDALModDriverList.
...
static StringDevice gaDALModDriverList[] =
{
   ...
   {"/vadc/pme9205", 0, 0, &DALVAdc_DriverInfo, 0, NULL},
   {"/vadc/pm9655", 0, 0, &DALVAdc_DriverInfo, 0, NULL},
   {"/vadc/smb2351", 0, 0, &DALVAdc_DriverInfo, 0, NULL},
