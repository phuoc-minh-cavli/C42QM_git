...
util_list_node_data_type* util_list_find_data_in_list_with_param(util_list_info_type *list_info, int (*find_evaluator)(const util_list_node_data_type *to_be_found_data, void *compare_data), void* compare_data)
{
    util_list_node_type *iter;
    util_list_node_type *found_node;
