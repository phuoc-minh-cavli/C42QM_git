# 1 "Z:\\b\\apps_proc\\ril\\psm\\dam_psmtest\\src\\txm_module_preamble_llvm.S"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 333 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Z:\\b\\apps_proc\\ril\\psm\\dam_psmtest\\src\\txm_module_preamble_llvm.S" 2
...
_txm_module_preamble:
  ...
  .p2align 2
  .word psm_damtest_task_entry - . + . @ Module Start Thread Entry Point
  .p2align 2
...
# 78 "Z:\\b\\apps_proc\\ril\\psm\\dam_psmtest\\src\\txm_module_preamble_llvm.S"
  .p2align 2
  .word 0 @ Reserved 2
  .p2align 2
  .word 0 @ Reserved 3
