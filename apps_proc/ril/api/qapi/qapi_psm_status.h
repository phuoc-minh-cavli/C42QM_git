...
*/
/*=======================================================================
 Copyright (c) 2017-2018, 2020-2021 Qualcomm Technologies, Inc. and/or its
...
#define QAPI_ERR_PSM_INVALID_INTERVAL        __QAPI_PSM_ERROR(7)
/**< An invalid Time Interval was sent. */
