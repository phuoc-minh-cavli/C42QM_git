...
typedef enum {
    ...
    PSM_REJECT_REASON_INCORRECT_USAGE,     /**< PSM usage is wrong. Incorrect voting,
                                                ...
                                                will be rejected with this message. @newpage */
...
typedef enum {
    ...
    PSM_ERR_INVALID_ACTIVE_TIME,   /**< Invalid active time value passed.
                                        Refer to Table 10.5.172 and Table 10.5.163a of
                                        <i>Mobile radio interface Layer 3 specification; 
                                        Core network protocols; Stage 3</i> (3GPP TS 24.008)
...
/** PSM version of the Julian time structure.
*/
typedef struct
{
