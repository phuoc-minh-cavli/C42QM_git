...
/*===========================================================================
  ...
  $Header: //components/rel/audio.tx/2.0/audio/api/cvd/vss_iavsync_public_if.h#1 $
  $Author: pwbldsvc $
...
/**
  RX voice path audio-video synchronization event class. The events that
...
/** @brief Type definition for #vss_iavsync_evt_rx_path_delay_t.
*/
