#ifndef _CSD_DEV_MANAGER_TX_H_
#define _CSD_DEV_MANAGER_TX_H_
/*==============================================================================
...
static csd_dev_manager csd_dev_manager_tx_setup[CSD_DEV_STAGE_MAX] =
{
  ...
  { CSD_DEV_PATH,         csd_dev_codec_procure_path },      //TODO: Combine, Slimbus on create portid/afeportid
  { CSD_DEV_DSP_AFE,      csd_dev_afe_start },
  { CSD_DEV_CODEC,        csd_dev_codec_enable },
};

/* manager for device tear down */
static csd_dev_manager csd_dev_manager_tx_teardown[CSD_DEV_STAGE_MAX] =
{
