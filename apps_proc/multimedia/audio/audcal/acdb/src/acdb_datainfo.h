...
========================================================================== */
/* $Header: //components/rel/audio.tx/2.0/audio/audcal/acdb/src/acdb_datainfo.h#1 $ */
...
typedef struct _AcdbAfeTopInfo{
	uint32_t nTopoId;
}AcdbAfeTopInfo;

typedef struct _AcdbLsmTopInfo{
	uint32_t nLsmAppId;
	uint32_t nTopoId;
}AcdbLsmTopInfo;
...
typedef struct _VocProcStatic2CmdAllIndicesType {
	...
	uint32_t nMid;
	uint32_t nPid;
} VocProcStatic2CmdAllIndicesType;
