 ...
 * Qualcomm Technologies, Inc. Confidential and Proprietary. 
  ...
  $Header: //components/rel/audio.tx/2.0/apr/core/src/aprv2_drv.c#3 $
  $Author: pwbldsvc $
*/
...
)
{
  ...
  if (!(((char *)packet < (char *)aprv2_drv_packet_heap ||
        (char *)packet > (((char *)aprv2_drv_packet_heap) + ((APRV2_DRV_NUM_PACKETS_V * APRV2_DRV_BYTES_PER_MEMQ_ITEM_V))-1)) &&
          ((char *)packet < (char *)aprv2_4k_drv_packet_heap ||
         (char *)packet > (((char *)aprv2_4k_drv_packet_heap) + ((APRV2_4K_NUM_PACKETS_V * APRV2_4K_MEMQ_SIZE)-1)))))
  {
...
)
{
  ...
  if (((char *)params->packet < (char *)aprv2_drv_packet_heap ||
        (char *)params->packet > (((char *)aprv2_drv_packet_heap) + ((APRV2_DRV_NUM_PACKETS_V * APRV2_DRV_BYTES_PER_MEMQ_ITEM_V)-1))) &&
      ((char *)params->packet < (char *)aprv2_4k_drv_packet_heap ||
         (char *)params->packet > (((char *)aprv2_4k_drv_packet_heap) + ((APRV2_4K_NUM_PACKETS_V * APRV2_4K_MEMQ_SIZE)-1))))
  {
