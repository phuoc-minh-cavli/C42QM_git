...
/*
  ...
  $Header: //components/rel/audio.tx/2.0/apr/custom/inc/aprv2_pl_config.h#1 $
  $Author: pwbldsvc $
*/
...
#define APRV2_PL_DEFAULT_DOMAIN_ID_V ( APRV2_IDS_DOMAIN_ID_APPS_V )
...
#define APRV2_PL_ROUTING_TABLE_SIZE_ARRAY_V \
  ...
  APRV2_RTABLE_DISPATCH_TABLE_SIZE( APRV2_IDS_SERVICE_ID_RESERVED_V,  0 ),  /* MODEM */ \
  APRV2_RTABLE_DISPATCH_TABLE_SIZE( APRV2_IDS_SERVICE_ID_RESERVED_V,  0 ),  /* ADSP */ \
  APRV2_RTABLE_DISPATCH_TABLE_SIZE( APRV2_IDS_SERVICE_ID_APPS_OEM4_V, 10 ), /* APPS */ \
...
#define APRV2_PL_LOCAL_DNS_ARRAY_V \
  /* Supported entries. */ \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_APPS_V,  APRV2_IDS_SERVICE_ID_RESERVED_V ),     "local.default" }, \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_APPS_V,  APRV2_IDS_SERVICE_ID_ROUTER_V ),       "local.router" }, \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_APPS_V,  APRV2_IDS_SERVICE_ID_TESTCLIENT_V ),   "local.testclient" }, \
  ...
  /* Deprecated entries. */ \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_MODEM_V, APRV2_IDS_SERVICE_ID_MODEM_MVS_V ),  "qcom.modem.mvs" }, \
  ...
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_ADSP_V,  APRV2_IDS_SERVICE_ID_ADSP_MVM_V ),   "qcom.adsp.mvm" }, \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_ADSP_V,  APRV2_IDS_SERVICE_ID_ADSP_CVS_V ),   "qcom.adsp.cvs" }, \
  { APRV2_RTABLE_MAKE_ADDR( APRV2_IDS_DOMAIN_ID_ADSP_V,  APRV2_IDS_SERVICE_ID_ADSP_CVP_V ),   "qcom.adsp.cvp" }, \
