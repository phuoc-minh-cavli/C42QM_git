...
goto END
:PACKBUILD
build_llvm.cmd llvm_dam BUILD_ID=ACFNAADZ USES_FLAGS=USES_NO_STRIP_NO_ODM && python build.py BUILD_ID=ACFNAABZ,ACFNAAGZ,ACFNAAMZ,ACFNAANZ,ACFNAAFZ,ACFNAAIZ,ACENAAKZ USES_FLAGS=USES_NO_STRIP_NO_ODM
goto END
:TRACKER
python build.py BUILD_ID=ACFNAABZ,ACENAAKZ USES_FLAGS=USES_NO_STRIP_NO_ODM && build_llvm.cmd llvm_dam BUILD_ID=ACENAADZ USES_FLAGS=USES_NO_STRIP_NO_ODM
goto END
:INTERNALCLEANBUILD
