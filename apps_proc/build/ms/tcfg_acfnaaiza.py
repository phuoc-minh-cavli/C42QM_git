...
def exists(env):
   return env.Detect('tcfg_ACFNAAIZA_data')
...
def generate(env):
   ...
   env.AddUsesFlags('USES_APPS_ONLY_BOOT', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_SENSORS_DISABLE', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_WIFI_POSITIONING_DISABLE', from_builds_file = True)
