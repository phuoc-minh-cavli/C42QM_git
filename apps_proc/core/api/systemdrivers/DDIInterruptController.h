...
$Header: //components/rel/core.tx/6.0/api/systemdrivers/DDIInterruptController.h#1 $
...
/** Highest priority interrupt that can be set.
*/
#define DALINTRCTRL_PRIO_HIGHEST   1 

/** High priority interrupt that can be set.
*/
#define DALINTRCTRL_PRIO_HIGH      16 

/** Median priority interrupt that can be set.
*/
#define DALINTRCTRL_PRIO_MEDIAN    32
