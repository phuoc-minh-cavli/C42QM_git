...
/*
  ...
  $Header: //components/rel/core.tx/6.0/api/systemdrivers/ClockDefs.h#1 $
...
/**
 Processor Sleep mode flag masks:
  ...
  RPM_ASSISTED_PC
   Forwards information regarding whether it is a standalone power collapse or
   RPM assisted power collapse to kernel. If this mask is set, non-zero value
  (0x10) is passed to the kernel API, else 0 is passed
 */
...
#define CLOCK_SLEEP_FLAG_RPM_ASSISTED_PC        0x00000010
