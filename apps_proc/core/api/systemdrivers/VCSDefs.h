...
/*
  ...
  $Header: //components/rel/core.tx/6.0/api/systemdrivers/VCSDefs.h#1 $
 ...
 *
 * APCS
 *   Resource for VDD_APCS votes.
 *   Votes correspond to VCSCornerType enum values defined above.
 *
 * APCS_UV
 *  Broadcasts the uV changes of VDD_APCS.
 *  This resource doesn't accept votes.
 *
 * MX
 ...
 *
 */
#define VCS_NPA_RESOURCE_CPU                   "/vdd/cpu"
...
#define VCS_NPA_RESOURCE_VDD_APCS              "/vdd/apcs"
#define VCS_NPA_RESOURCE_VDD_APCS_UV           "/vdd/apcs/uv"
