...
/*
  ...
  $Header: //components/rel/core.tx/6.0/api/systemdrivers/PlatformInfoDefs.h#1 $
...
typedef enum
{
  ...
  DALPLATFORMINFO_NUM_TYPES         = 0x23,  /**< Number of known targets
                                               (including unknown). */
  /** @cond */
...
/**
  ...
  structure change.
 */
#define DALPLATFORMINFO_SMEM_FORMAT 9
