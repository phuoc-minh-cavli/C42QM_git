...
/* =======================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/systemdrivers/pmic/pm_err_flags.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
10/11/17   kcs     Added PM_ERR_FLAG__BATTERY_MISSING (CR -2110414).
05/29/17   kcs     Added PM_ERR_FLAG__ADC_VBATT_READ_ERR
12/06/16   kcs     Added PM_ERR_FLAG__PAR_OUT_OF_RANGE (CR - 1079165)
10/05/16   kc	   Added DAL Error codes (CR-1079022)
09/15/16   kc	   Added PM_ERR_FLAG__DSR_SERVICE_FAIL (CR-1067741)
...
typedef enum
{
    ...
    PM_ERR_FLAG__INPUT_INVALID,     /**< Generic input parameters out of range>*/
    ...
    PM_ERR_FLAG__EXTERNAL_MANAGE_MODE, /**< MSS Rail managed externally */
	
	PM_ERR_FLAG__DSR_SERVICE_FAIL,   /**<DSR Functionality Fail */
	
	PM_ERR_FLAG__DAL_DEVICE_ATTACH_FAIL, /**< DAL_device_attach_fail */
	
	PM_ERR_FLAG__DAL_PLATFORM_ERROR, /**< DAL_platform_info_fail */
	
	PM_ERR_FLAG__PAR_OUT_OF_RANGE,  /** < Input Parameter one is out of range */
	
	PM_ERR_FLAG__ADC_VBATT_READ_ERR, /** < Battery Voltage Read Error through ADC Channel */
   
    PM_ERR_FLAG__BATTERY_MISSING, /** < Battery Missing*/
