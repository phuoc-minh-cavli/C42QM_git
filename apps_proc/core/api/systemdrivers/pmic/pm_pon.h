...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/systemdrivers/pmic/pm_pon.h#1 $
  $DateTime: 2020/01/30 22:49:35 $ 

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/06/16   kcs     Added pm_pon_trigger_enable (CR - 1079165) 
07/16/15   aab     Updated to support PMD9655 PON 
...
typedef struct
{
  ...
  unsigned pon : 1;         /* KPDPWR_N trigger */
}pm_pon_gen2_on_reason_type;
...
typedef struct
{
  unsigned reserved1 : 5;     /* Reserved bits */
 ...
 * @param[in] pmic_device_index. Primary PMIC: 0 Secondary PMIC: 1
 * @param[in] time_delay:  
 *                Select time delay in micro seconds. Supported
 *                time in us, rounds up to the next largest
 *                number in us if value passed is in between the
 *                permitted values:
 *                PON GEN1: {15600, 31200, 62500, 125000, 250000, 500000, 1000000, 2000000};
 *                PON GEN2: {60, 120, 240, 490, 980, 2000,3900 7800, 15600, 31200, 62500, 125000, 25000};
 *
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG__PAR1_OUT_OF_RANGE = Device Index out of
