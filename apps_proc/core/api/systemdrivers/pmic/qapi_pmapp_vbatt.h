...
// Handler Prototype
qapi_Status_t qapi_PM_Vbatt_handler(
	UINT id,
	UINT a,
	UINT b,
	UINT c,
...
#define  TXM_QAPI_PMIC_VBATT_GET_BATTERY_VOLT_STATUS        TXM_QAPI_PM_VBATT_BASE + 7
#define  TXM_QAPI_PMIC_VBATT_GET_CHARGE_REG                 TXM_QAPI_PM_VBATT_BASE + 8
#define  TXM_QAPI_PMIC_VBATT_SET_CHARGE_REG                 TXM_QAPI_PM_VBATT_BASE + 9
#define  TXM_QAPI_PMIC_VBATT_CONFIG_SYSOK_OPTION               TXM_QAPI_PM_VBATT_BASE + 10
#endif
...
#ifdef FEATURE_PMIC_CHARGER
#define qapi_Pmapp_Vbatt_Get_Battery_Volt_Status(batt_stat)\
    ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_PMIC_VBATT_GET_BATTERY_VOLT_STATUS,\
    (ULONG) batt_stat,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define qapi_Pmapp_Vbatt_get_charge_reg(get_offset,get_data)\
    ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_PMIC_VBATT_GET_CHARGE_REG,\
    (ULONG) get_offset,(ULONG) get_data, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define qapi_Pmapp_Vbatt_set_charge_reg(set_offset,set_data)\
    ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_PMIC_VBATT_SET_CHARGE_REG,\
    (ULONG) set_offset,(ULONG) set_data, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))

#define qapi_Pmapp_Vbatt_config_sysok_option(sysok_option)\
    ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_PMIC_VBATT_CONFIG_SYSOK_OPTION,\
    (ULONG) sysok_option,(ULONG) 0, (ULONG) 0, (ULONG) 0,(ULONG) 0,\
    (ULONG) 0,(ULONG) 0,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, \
    (ULONG) 0))
#endif
...
*/
qapi_Status_t
qapi_Pmapp_Vbatt_Get_Battery_Status(uint8 *qapi_batt_status);
/*~ FUNCTION qapi_Pmapp_Vbatt_Get_Battery_Status */
...
/**
  ...
  @deprecated in version 2.0 Due to SMB limitation
  @see NONE
...
#ifdef FEATURE_PMIC_CHARGER
/*===========================================================================
FUNCTION   qapi_Pmapp_Vbatt_get_charge_reg
===========================================================================*/

/**
   Gets charger register value
...
/*===========================================================================
FUNCTION   qapi_Pmapp_Vbatt_set_charge_reg
===========================================================================*/
...
/*===========================================================================
FUNCTION   qapi_Pmapp_Vbatt_Get_Battery_Volt_Status                            
===========================================================================*/

/**
   Gets the battery charge voltage.

  @param[out] qapi_batt_status Buffer from which to get the battery charge voltage.
...
*/
qapi_Status_t
qapi_Pmapp_Vbatt_Get_Battery_Volt_Status(uint32 *qapi_batt_status);

/*===========================================================================
FUNCTION   qapi_Pmapp_Vbatt_config_sysok_option                            
===========================================================================*/

/**
  Configure sysok option

  @param[in] option  sysok option
...
*/
qapi_Status_t
qapi_Pmapp_Vbatt_config_sysok_option(uint8 option);
