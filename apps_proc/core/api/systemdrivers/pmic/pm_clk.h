...
$Header: //components/rel/core.tx/6.0/api/systemdrivers/pmic/pm_clk.h#1 $
...
typedef enum
{
    PM_CLK_RF_1,       /**< RF Clock 1. */
    PM_CLK_RF_2,       /**< RF Clock 2. */
    PM_CLK_RF_3,       /**< RF Clock 3. */
    PM_CLK_SLEEP,    /**< Sleep Clock 1. */ 
