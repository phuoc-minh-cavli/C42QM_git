...
===========================================================================
    ...
    Copyright (c) 1990-2012 by Qualcomm Technologies, Incorporated.
    All Rights Reserved.
...
$Header: //components/rel/core.tx/6.0/api/services/diagi.h#1 $
...
#define DIAG_HS_CMD_SIG           0x00000000   /*!< 
                                                   This signal is specified when
                                                   issuing commands to the
...
#define DIAG_MC_CMD_SIG           0x00000000    /*!<
                                                   This signal is specified when
                                                   issuing commands to the 
