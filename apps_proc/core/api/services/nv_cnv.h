...
$Header: //components/rel/core.tx/6.0/api/services/nv_cnv.h#1 $
...
/* Timer definitions */
extern timer_type cnv_rpt_timer;  /* Watchdog timer */
...
#define  CNV_DOG_RPT() \
  ...
  (void) timer_set( &cnv_rpt_timer, DOG_CNV_RPT_TIME, 0, T_MSEC )
