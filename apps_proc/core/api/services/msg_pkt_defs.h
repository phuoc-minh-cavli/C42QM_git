...
*/
/*
Copyright (c) 2002, 2007, 2010, 2020 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/services/msg_pkt_defs.h#2 $
