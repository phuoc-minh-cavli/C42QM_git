...
GENERAL DESCRIPTION
  Implements memory manager functions for default heap 
...
INITIALIZATION AND SEQUENCING REQUIREMENTS
    ...
    malloc_init() must be called once before any other malloc.
...
.$Header: //components/rel/core.tx/6.0/api/services/malloc.h#1 $
...
DESCRIPTION
 Initializes data structures and memory for correct malloc/free operations
...
FUNCTION MALLOC_DEINIT

DESCRIPTION
 Deinitializes data structures and memory for correct malloc/free operations
