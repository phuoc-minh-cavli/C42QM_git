...
/*
Copyright (c) 2008-2010, 2013-2014, 2016, 2020 Qualcomm Technologies Incorporated. 
All Rights Reserved.
...
$Header: //components/rel/core.tx/6.0/api/services/msg_diag_service.h#2 $
...
msg_multi_client_store_type;

/*Both store and send format of message are same */
typedef msg_multi_client_store_type msg_send_multi_client_type;
...
/*!
   ...
   @param[in] *xx_msg_const static constant constructed using 
   the different XX_MSG_CONST macros
   @param[in] version                  Specifies the version - currently, there are two versions 
                                       0 - same as msg_send() (for backwards compatibility)
   ...
   msg_send_1, msg_send_2, msg_send_3, msg_send_var
*/
  void msg_send_ext ( const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter);
...
/*!
   ...
   the different XX_MSG_CONST macros
   @param[in] version                  Specifies the version - currently, there are two versions 
                                       0 - same as msg_send_1() (for backwards compatibility)
                                       1 - The outgoing msg header will have the support to
                                           include ID field to differentiate messages
                                           coming from different instances of the processor.
   ...
   msg_send, msg_send_2, msg_send_3, msg_send_var
*/
  void msg_send_1_ext (const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter, uint32 xx_arg1);
...
/*!
   ...
   the different XX_MSG_CONST macros
   @param[in] version                  Specifies the version - currently, there are two versions 
                                       0 - same as msg_send_2() (for backwards compatibility)
                                       1 - The outgoing msg header will have the support to
                                           include ID field to differentiate messages
                                           coming from different instances of the processor.
   ...
   msg_send, msg_send_1, msg_send_3, msg_send_var
*/
  void msg_send_2_ext ( const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter,
...
@ingroup diag_message_service
   ...
   the different XX_MSG_CONST macros
   @param[in] version                  Specifies the version - currently, there are two versions 
                                       0 - same as msg_send_3() (for backwards compatibility)
                                       1 - The outgoing msg header will have the support to
                                           include ID field to differentiate messages
                                           coming from different instances of the processor.
...
*/
  ...
  void msg_send_3_ext ( const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter,
...
@ingroup diag_message_service
  @brief
   ...
   the different XX_MSG_CONST macros
   @param[in] version                  Specifies the version - currently, there are two versions 
                                       0 - same as msg_send_var() (for backwards compatibility)
                                       1 - The outgoing msg header will have the support to
                                           include ID field to differentiate messages
                                           coming from different instances of the processor.
...
*/
  ...
  void msg_send_var_ext ( const msg_const_type * xx_msg_const_ptr, uint32 version, void* parameter,
                              uint32 num_args, ...);
...
@ingroup diag_message_service
   @brief
     This function is similar to msg_errlog_3 function, expect that it takes
     additional parameters : version and void *. 
   ...
   @param[in] *const_blk          static constant constructed using 
   the different xx_err_msg_const macros
   Based on the version value, void* can be interpreted as follows-
    Version      Pointer
       0          NULL
       1          uint32*
   ...
   None
*/
void msg_errlog_3_ext (const msg_const_type* const_blk, uint32 version, void* parameter, uint32 code1, uint32 code2, uint32 code3);
...
@ingroup diag_message_service
   @brief
     This function is similar to msg_errlog_2 function, expect that it takes
     additional parameters : version and void *. 
...
void msg_errlog_2_ext (const msg_const_type* const_blk, uint32 version, void* parameter, uint32 code1, uint32 code2);
...
@ingroup diag_message_service
   @brief
     This function is similar to msg_errlog_1 function, expect that it takes
     additional parameters : version and void *. 
...
void msg_errlog_1_ext (const msg_const_type* const_blk, uint32 version, void* parameter, uint32 code1);
...
@ingroup diag_message_service
   @brief
     This function is similar to msg_errlog_0 function, expect that it takes
     additional parameters : version and void *. 
...
void msg_errlog_0_ext (const msg_const_type* const_blk, uint32 version, void* parameter);
...
*/
/*!
This constructs the msg_const_type and calls the correct msg_v4_err_log_* functions,
...
{                                                              \
 ...
 {                                                             \
   ...
   {                                                      \
     case 3:                                               \
       msg_v4_errlog_3 (&xx_msg_v4_const,(uint32)(xx_arg1), (uint32)(xx_arg2),(uint32)(xx_arg3),msgfile,line); \
       break;                                                \
     case 2:                                               \
       msg_v4_errlog_2 (&xx_msg_v4_const,(uint32)(xx_arg1), (uint32)(xx_arg2),msgfile,line);                       \
       break;                                                \
     case 1:                                               \
       msg_v4_errlog_1 (&xx_msg_v4_const,(uint32)(xx_arg1),msgfile,line);                \
       break;                                                \
     case 0:                                               \
       msg_v4_errlog_0 (&xx_msg_v4_const,msgfile,line);                                   \
       break;                                                \
     default:                                               \
	 break;                                                 \
   }   \
