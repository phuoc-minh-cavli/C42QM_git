...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/services/diagdsm.h#1 $
...
/*SIO pool for RX data from fusion dci channel*/
#define DSM_DIAG_SIO_FUSION_RX_ITEM_POOL ((dsm_mempool_id_type)(&dsm_diag_sio_fusion_rx_item_pool))
extern dsm_pool_mgmt_table_type dsm_diag_sio_fusion_rx_item_pool;
...
/*SMD pool for RX DCI data from peripherals*/
#define DSM_DIAG_SMD_DCI_TX_ITEM_POOL ((dsm_mempool_id_type)(&dsm_diag_smd_dci_tx_item_pool))
extern dsm_pool_mgmt_table_type dsm_diag_smd_dci_tx_item_pool;
