...
$Header: //components/rel/core.tx/6.0/api/services/cmd.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
typedef struct {
  ...
  qurt_signal_t     *sig_ptr;    /**< Pointer to the requesting task's 
                                        signal object. */
  uint32             sig_mask;         /**< Signal to set upon the command 
                                        completion. */
