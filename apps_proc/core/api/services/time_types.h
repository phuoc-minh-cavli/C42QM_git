...
$Header: //components/rel/core.tx/6.0/api/services/time_types.h#1 $
...
#else /* for ARM9 */
#ifndef FEATURE_QDSP6 /*for products like 8960, T_MDM9X00 is defined and therefore, TIME_IPC was getting undef for Q6*/
