...
Copyright (c) 1991-2017,2019 by QUALCOMM Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.tx/6.0/api/services/log_codes.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/30/19   vg      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.125
02/10/17   as      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.99
09/22/16   as      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.89
11/19/15   as      Added new log codes
...
/* The last defined DMSS log code */
 #define LOG_1X_LAST_C                                        ((0xC8A) + LOG_1X_BASE_C)
