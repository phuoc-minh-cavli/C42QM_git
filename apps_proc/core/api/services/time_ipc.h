...
$Header: //components/rel/core.tx/6.0/api/services/time_ipc.h#1 $
...
#define TIME_IPC_QMI_CLIENT_INIT 0x2000


/** Task control block for the time_ipc task. */
extern qurt_signal_t * time_ipc_qurt_sig_ptr;                   
...
/**
Initalizes the time_ipc signal object.
...
None.
*/
void  time_ipc_initialize_signal_object
(
  void
);
