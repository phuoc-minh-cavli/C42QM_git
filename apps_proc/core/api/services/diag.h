...
Copyright (c) 1991-2014, 2019 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
      ...
      $Header: //components/rel/core.tx/6.0/api/services/diag.h#1 $
...
PARAMETERS
  value - High watermark value as percentage compressed buffer full.
  
RETURN VALUE
  The current high water mark as percentage buffer full
...
PARAMETERS
  value - Low watermark value as percentage compressed buffer full.
  
RETURN VALUE
  The current low water mark as percentage buffer full.
...
RETURN VALUE
  The current high watermark value as percentage buffer full..
...
RETURN VALUE
  The current low watermark value as percentage buffer full.
