...
/*==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/uw_device_cdc.h#1 $
...
enum cdc_init_flags_t
{
    ...
    /* HSU addition: API to identify MBIM instance of ECM */
    CDC_INIT_MBIM_ECM             = 0x000000080L,  /**< &nbsp; */
    /* HSU addition: API to identify standard ECM instance */
    CDC_INIT_STD_ECM              = 0x000000100L,  /**< &nbsp; */
    /* HSU addition: API to identify INTR only pipe of an ECM instance */
    CDC_INIT_INTR_ONLY_ECM_PIPE   = 0x000000200L,  /**< &nbsp; */
    /* HSU addition: API to identify QDSS instance of OBEX */
    CDC_INIT_OBEX_BULK_IN_ONLY    = 0x000000400L,  /**< &nbsp; */
    /* HSU addition: API to use the SW path instead of using BAM2BAM acceleration */
    CDC_INIT_SSUSB_UL_BAM_BYPASS  = 0x000000800L,  /**< &nbsp; */
    /* HSU addition: API to identify DPL configruation overrides 2nd RMNET instance */
    CDC_INIT_DPL                  = 0x000001000L,  /**< &nbsp; */
};
...
/** HSU ADDITION: Device-to-host if there is pending notifications */
