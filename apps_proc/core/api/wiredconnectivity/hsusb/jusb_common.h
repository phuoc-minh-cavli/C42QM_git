...
/*==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/jusb_common.h#1 $
...
typedef struct request_t  {
    ...
    boolean      requires_zlp;      // For accounting of hw_trb_ptr moving forward
...
/* HSU addition: SPS. */
    ...
    juint32_t padding_size;   /**< Size of padding for the request buffer 
						       in bytes. */
    boolean   is_control_ep; // Re-use memory for control endpoint
/* End of HSU addition */
} request_t;
...
typedef struct pipe_desc_t {
    ...
    struct {
      ...
      juint16_t bytes_per_interval; /* For SuperSpeed periodic pipes */
    } ss_attributes;
    ...
    boolean is_pipe_hw_accelerated;
    juint16_t xfer_rsc_idx_hw_accelerated; // This transfer resource index is exclusively used by hardware accelerated endpoints where stream is not defined
} pipe_desc_t; 
