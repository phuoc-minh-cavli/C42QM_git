...
#define ___QAPI_USB_ERROR(x)  ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BSP_USB,  x)))

/* The action is already done. */
#define QAPI_ERR_ALREADY_DONE     ___QAPI_USB_ERROR(1)

/* No data is available. */
#define QAPI_ERR_NO_DATA          ___QAPI_USB_ERROR(2)
