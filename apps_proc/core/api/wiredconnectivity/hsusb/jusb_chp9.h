...
/*==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/jusb_chp9.h#1 $
...
// SuperSpeed device feature selector. USB 3.0 spec table 9-6
#define USB_FEATURE_SELECTOR_U1_ENABLE  0x30
#define USB_FEATURE_SELECTOR_U2_ENABLE  0x31
#define USB_FEATURE_SELECTOR_LTM_ENABLE 0x32
...
#define USB_DT_SUPERSPEED_ISOCH_MAX_MULT 2

#define USB_BM_ATTRIBUTES_SYNCH_TYPE_OFFSET 2
#define USB_SYNCH_TYPE_NO_SYNCHRONIZATION   0
#define USB_SYNCH_TYPE_ASYNCHRONOUS         1
#define USB_SYNCH_TYPE_ADAPTIVE             2
#define USB_SYNCH_TYPE_SYNCHONOUS           3

#define USB_BM_ATTRIBUTES_USAGE_TYPE_OFFSET            4
#define USB_USAGE_TYPE_DATA_ENDPOINT                   0
#define USB_USAGE_TYPE_FEEDBACK_ENDPOINT               1
#define USB_USAGE_TYPE_IMPLICIT_FEEDBACK_DATA_ENDPOINT 2
