...
/*=============================================================================
	...
	$Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/hsu_bus_mode_notifier.h#1 $
...
{
  uint32 core_index;
  /**< Core index of the associated function driver. */
...
} hsu_bus_mode_multi_core_cb_info_struct;
...
=============================================================================*/
/**
Registers a callback function that is associated with a core index
to be invoked when the suspend/resume state of the HS-USB stack is changed.
...
@param hal_core_index [IN] -- HS-USB HAL core index.
