...
$Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/hsu_conf_sel_stack_utils.h#1 $
...
#define HSU_SS_DEVICE_MAX_POWER            0x70
...
/** The callback to be called on completing _core_restart
*/
typedef void (*hsu_conf_sel_stack_utils_restart_core_cb_type)(uint32 logical_core_index);
...
DESCRIPTION
Wrapper function for restarting core
