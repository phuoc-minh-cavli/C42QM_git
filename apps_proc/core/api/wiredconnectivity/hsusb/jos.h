...
/*==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/jos.h#1 $
...
/* HSU Addition:  
** From MDM9x25, this has conflict with L4 kernel's 
** dev_t definition.  Removing per request*/
/* typedef void *dev_t; */
