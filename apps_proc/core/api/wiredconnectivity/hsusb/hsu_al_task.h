...
/*=============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/hsu_al_task.h#1 $
...
enum
{
  AL_TASK_STACK_SIZE_IN_BYTES = 4096
};

/** HS-USB AL task stack TCB.
*/
extern qurt_thread_t hsu_al_task_tcb;
...
/**
  ...
  This function is NOT re-entrant. Invoking this function twice simultaneously
  might yield unpredictable results.

  This function is intended to be invoked only by a High-Speed USB interrupt
  (it is assumed that HS-USB interrupts do not interrupt each other)
  or by a testing API.
