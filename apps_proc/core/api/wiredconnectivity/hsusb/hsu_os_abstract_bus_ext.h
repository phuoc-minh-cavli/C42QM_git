...
$Header: //components/rel/core.tx/6.0/api/wiredconnectivity/hsusb/hsu_os_abstract_bus_ext.h#1 $
...
FALSE -- The PHY read operation was not successful.
*/
boolean hsu_os_bus_read_from_phy_no_reset( uint8 phy_register, uint8* read_value, uint32 core_index);
...
FALSE -- The PHY write operation was not successful.
*/
boolean hsu_os_bus_write_to_phy_no_reset(uint8 phy_register, uint8 written_value, uint32 core_index);
