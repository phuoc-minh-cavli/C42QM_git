...
$Header: //components/rel/core.tx/6.0/api/kernel/arch/arm11/cache_mmu.h#1 $
...

/*===========================================================================
  FUNCTION  MMU_ENABLE_BRANCH_PREDICTION
  ...
  SIDE EFFECTS
    The ARM1136EJ-S branch prediction will be enabled.

===========================================================================*/
void mmu_enable_branch_prediction( void );
...
;
; PROTOTYPE
;   void mmu_enable_peripheral_remap(void);
;
; ARGS
;
; DESCRIPTION
;   Sets up Peripheral Port Memory Remap Register to open up
...
;
; PROTOTYPE
;   void mmu_disable_peripheral_remap(void);
;
; ARGS
;
; DESCRIPTION
