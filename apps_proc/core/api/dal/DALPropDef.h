...
// DAL Global Context definitions

// The processor Ids below are used specifically to lock
// a HW mutex register, and must be non-zero 4-bit values.
// Zero is used to unlock a HW mutex.
#define DAL_CONFIG_PROC_NONE     0x00 // do not use
#define DAL_CONFIG_PROC_APSS     0x01
#define DAL_CONFIG_PROC_MPSS     0x02
#define DAL_CONFIG_PROC_ADSP     0x03
#define DAL_CONFIG_PROC_WCNSS    0x04
#define DAL_CONFIG_PROC_RPM      0x05
#define DAL_CONFIG_PROC_VENUS    0x06
#define DAL_CONFIG_PROC_GSS      0x07
#define DAL_CONFIG_PROC_TZ       0x08
#define DAL_CONFIG_PROC_VPU      0x09 
