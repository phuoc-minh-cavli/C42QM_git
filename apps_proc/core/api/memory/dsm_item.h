...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/memory/dsm_item.h#1 $
...
#define DSM_TOUCH_ITEM(dsm_item_ptr)                                        \
    dsmi_touch_item(dsm_item_ptr,dsm_file,__LINE__)
...
#define dsm_trim_packet(pkt_head_ptr,length) \
       dsmi_trim_packet(pkt_head_ptr,length,dsm_file,__LINE__)
...
#define dsm_pushdown(pkt_head_ptr,buf,size,pool_id) \
       dsmi_pushdown(pkt_head_ptr,buf,size,pool_id,dsm_file,__LINE__)
...
#define dsm_pushdown_packed(pkt_head_ptr,buf,size,pool_id) \
       dsmi_pushdown_packed(pkt_head_ptr,buf,size,pool_id,dsm_file,__LINE__)
...
#define dsm_pushdown_tail(pkt_head_ptr,buf,size,pool_id) \
       dsmi_pushdown_tail(pkt_head_ptr,buf,size,pool_id,dsm_file,__LINE__)
...
#define dsm_pullup(pkt_head_ptr,buf,cnt) \
        dsmi_pullup(pkt_head_ptr,buf,cnt,dsm_file,__LINE__)
uint16 dsmi_pullup
(
  dsm_item_type **pkt_head_ptr,
  void *buf,
...
#define dsm_pullup_tail(pkt_head_ptr,buf,cnt) \
        dsmi_pullup_tail(pkt_head_ptr,buf,cnt,dsm_file,__LINE__)
...
#define dsm_insert(packet_ptr,pool_id,offset,buf,len) \
        dsmi_insert(packet_ptr,pool_id,offset,buf,len,dsm_file,__LINE__)
uint16 dsmi_insert
(
  dsm_item_type **packet_ptr,
  dsm_mempool_id_type pool_id,
