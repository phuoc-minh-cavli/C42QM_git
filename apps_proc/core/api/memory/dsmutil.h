...
Copyright (c) 2000, 2004, 2008 - 2010 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/memory/dsmutil.h#1 $  $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
#define dsm_new_buffer_w_thresh(pool_id, dsm_size_requested, fall_back, dsm_threshold, sub_system_id) \
  dsmutili_new_buffer_w_thresh(dsm_size_requested, fall_back, dsm_threshold, dsm_file,__LINE__)
