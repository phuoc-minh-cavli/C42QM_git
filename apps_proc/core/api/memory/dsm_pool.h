...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/memory/dsm_pool.h#1 $
...
/* CR 843455  - Enable DSm tracing by default in DSm for Apps builds*/
...
#endif /* __arm et. al. */
#endif /* ifndef DSM_ALIGNED_ALLOC */
...
typedef enum
{
  ...
  DSM_MEM_LEVEL_MHI_FEW         = 23,
  DSM_MEM_LEVEL_MHI_MANY        = 24,
  DSM_MEM_LEVEL_MAX 
