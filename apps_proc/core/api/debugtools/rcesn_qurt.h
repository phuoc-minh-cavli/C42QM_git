...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/api/debugtools/rcesn_qurt.h#1 $
...
DLL_API_STATIC_INLINE RCESN_HANDLE rcesn_register_handle_qurt(RCESN_HANDLE const handle, RCESN_FNSIG_COMPARE const compare, qurt_signal_t* const signal, unsigned int mask)
{
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2, 3))
DLL_API_STATIC_INLINE RCESN_HANDLE rcesn_register_name_qurt(RCESN_NAME const name, RCESN_FNSIG_COMPARE compare, qurt_signal_t* signal, unsigned int mask)
{
   RCESN_HANDLE rc = RCESN_NULL;
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2, 3))
DLL_API_STATIC_INLINE RCESN_HANDLE rcesn_unregister_handle_qurt(RCESN_HANDLE const handle, RCESN_FNSIG_COMPARE compare, qurt_signal_t* signal, unsigned int mask)
{
   RCESN_HANDLE rc = RCESN_NULL;
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2, 3))
DLL_API_STATIC_INLINE RCESN_HANDLE rcesn_unregister_name_qurt(RCESN_NAME const name, RCESN_FNSIG_COMPARE compare, qurt_signal_t* signal, unsigned int mask)
{
   RCESN_HANDLE rc = RCESN_NULL;
