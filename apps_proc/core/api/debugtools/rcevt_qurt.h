...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/api/debugtools/rcevt_qurt.h#1 $
...
#include "qurt.h"
#ifdef RCEVT_QDI_SUPPORTED
	#include "qurt_qdi_driver.h"
#endif /* RCEVT_QDI_SUPPORTED */
...
// qurt_signal_t client_qurt_signal;
// qurt_signal_init(&client_qurt_signal);
//
...
// unsigned int recv = qurt_signal_wait(&qurt_signal, CLIENT_QURT_SIGNAL_MASK);
...
// }
//
// qurt_signal_destroy(&qurt_signal);
...
DLL_API_STATIC_INLINE RCEVT_HANDLE rcevt_register_handle_qurt(RCEVT_HANDLE const handle, qurt_signal_t* const signal, unsigned int const mask)
{
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2))
DLL_API_STATIC_INLINE RCEVT_HANDLE rcevt_register_name_qurt(RCEVT_NAME const name, qurt_signal_t* const signal, unsigned int const mask)
{
   RCEVT_SIGEX_SIGQURT sigex;
   sigex.signal = signal;
   sigex.mask = mask;
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2))
DLL_API_STATIC_INLINE RCEVT_HANDLE rcevt_unregister_handle_qurt(RCEVT_HANDLE const handle, qurt_signal_t* const signal, unsigned int const mask)
{
   RCEVT_SIGEX_SIGQURT sigex;
   sigex.signal = signal;
   sigex.mask = mask;
...
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2))
DLL_API_STATIC_INLINE RCEVT_HANDLE rcevt_unregister_name_qurt(RCEVT_NAME const name, qurt_signal_t* const signal, unsigned int const mask)
{
   RCEVT_SIGEX_SIGQURT sigex;
   sigex.signal = signal;
   sigex.mask = mask;
...
@param[in] qurt_signal_t** NULL
@param[in] unsigned int ZERO or qurt_signal_t mask
@param[out] qurt_signal_t** allocated qurt_signal_t* from qurt_qdi_user_malloc()
@return
RCEVT_DEVICE_HANDLE -- Opaque Device Handle
*/
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2))
DLL_API_STATIC_INLINE RCEVT_DEVICE_HANDLE rcevt_device_register_name(RCEVT_NAME name, qurt_signal_t** signal, unsigned int mask)
{
