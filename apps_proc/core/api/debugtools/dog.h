...
=============================================================================*/
/*=============================================================================
  Copyright (c) 1990, 1992-1995, 1998-2016 Qualcomm Technologies Incorporated.
  All rights reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/api/debugtools/dog.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
/** Temporary define to indicate the length of task name

*/
#define DOG_QURT_TASK_NAME        QURT_THREAD_ATTR_NAME_MAXLEN
...
/*================================================*/ 
extern const dword   dog_sbcenc_rpt_time;               /* time_decl */ 
extern const dword   dog_qvp_ae_rpt_time;               /* time_decl */ 
extern const dword   dog_qvpio_rpt_time;                /* time_decl */ 
extern const dword   dog_qvppl_rpt_time;                /* time_decl */ 
extern const dword   dog_qvp_mpeg4_rpt_time;            /* time_decl */ 
extern const dword   dog_qvp_app_rpt_time;              /* time_decl */ 
extern const dword   dog_qvp_vfe_rpt_time;              /* time_decl */ 
extern const dword   dog_qvp_rtp_rpt_time;              /* time_decl */ 
extern const dword   dog_sipt_rpt_time;                 /* time_decl */ 
extern const dword   dog_gsdi_rpt_time;                 /* time_decl */ 
extern const dword   dog_graphics_rpt_time;             /* time_decl */ 
extern const dword   dog_graph_rpt_time;                /* time_decl */ 
extern const dword   dog_gfx_rpt_time;                  /* time_decl */ 
extern const dword   dog_camera_drv_rpt_time;           /* time_decl */ 
extern const dword   dog_hdrmc_rpt_time;                /* time_decl */ 
extern const dword   dog_hdrrx_rpt_time;                /* time_decl */ 
extern const dword   dog_hdrtx_rpt_time;                /* time_decl */ 
extern const dword   dog_hdrsrch_rpt_time;              /* time_decl */ 
extern const dword   dog_mmoc_rpt_time;                 /* time_decl */ 
extern const dword   dog_tmc_rpt_time;                  /* time_decl */ 
extern const dword   dog_uim_rpt_time;                  /* time_decl */ 
extern const dword   dog_sec_rpt_time;                  /* time_decl */ 
extern const dword   dog_secrnd_rpt_time;               /* time_decl */ 
extern const dword   dog_sfs_rpt_time;                  /* time_decl */ 
extern const dword   dog_seccryptarm_rpt_time;          /* time_decl */ 
extern const dword   dog_secips_rpt_time;               /* time_decl */ 
extern const dword   dog_secssl_rpt_time;               /* time_decl */ 
extern const dword   dog_secdrm_rpt_time;               /* time_decl */ 
extern const dword   dog_sfat_rpt_time;                 /* time_decl */ 
extern const dword   dog_bt_rpt_time;                   /* time_decl */ 
extern const dword   dog_bt_pf_rpt_time;                /* time_decl */ 
extern const dword   dog_qdsp_rpt_time;                 /* time_decl */ 
extern const dword   dog_cm_rpt_time;                   /* time_decl */ 
extern const dword   dog_wms_rpt_time;                  /* time_decl */ 
extern const dword   dog_usbdc_rpt_time;                /* time_decl */ 
extern const dword   dog_usbhc_urb_rpt_time;            /* time_decl */ 
extern const dword   dog_usbhc_dev_rpt_time;            /* time_decl */ 
extern const dword   dog_usbhc_test_rpt_time;           /* time_decl */ 
extern const dword   dog_hwtc_rpt_time;                 /* time_decl */ 
extern const dword   dog_pdsm_rpt_time;                 /* time_decl */ 
extern const dword   dog_pdsmsclient_rpt_time;          /* time_decl */ 
extern const dword   dog_cd_rpt_time;                   /* time_decl */ 
extern const dword   dog_pb_rpt_time;                   /* time_decl */ 
extern const dword   dog_gpssrch_rpt_time;              /* time_decl */ 
extern const dword   dog_gpssrch_demod_rpt_time;        /* time_decl */ 
extern const dword   dog_pdsm_comm_rpt_time;            /* time_decl */ 
extern const dword   dog_fs_rpt_time;                   /* time_decl */ 
extern const dword   dog_voc_rpt_time;                  /* time_decl */ 
extern const dword   dog_tcptest_rpt_time;              /* time_decl */ 
extern const dword   dog_dh_rpt_time;                   /* time_decl */ 
extern const dword   dog_vs_rpt_time;                   /* time_decl */ 
extern const dword   dog_qmip_rpt_time;                 /* time_decl */ 
extern const dword   dog_pd_rpt_time;                   /* time_decl */ 
extern const dword   dog_ps_rpt_time;                   /* time_decl */ 
extern const dword   dog_dcc_rpt_time;                  /* time_decl */ 
extern const dword   dog_wlan_cp_rpt_time;              /* time_decl */ 
extern const dword   dog_wlan_trp_rpt_time;             /* time_decl */ 
extern const dword   dog_wlan_sec_rpt_time;             /* time_decl */ 
extern const dword   dog_auth_rpt_time;                 /* time_decl */ 
extern const dword   dog_ds_rpt_time;                   /* time_decl */ 
extern const dword   dog_comp_rpt_time;                 /* time_decl */ 
extern const dword   dog_diag_rpt_time;                 /* time_decl */ 
extern const dword   dog_hs_rpt_time;                   /* time_decl */ 
extern const dword   dog_mc_rpt_time;                   /* time_decl */ 
extern const dword   dog_nv_rpt_time;                   /* time_decl */ 
extern const dword   dog_rx_rpt_time;                   /* time_decl */ 
extern const dword   dog_rxtx_rpt_time;                 /* time_decl */ 
extern const dword   dog_snd_rpt_time;                  /* time_decl */ 
extern const dword   dog_srch_rpt_time;                 /* time_decl */ 
extern const dword   dog_tx_rpt_time;                   /* time_decl */ 
extern const dword   dog_ui_rpt_time;                   /* time_decl */ 
extern const dword   dog_sleep_rpt_time;                /* time_decl */ 
extern const dword   dog_tdso_rpt_time;                 /* time_decl */ 
extern const dword   dog_mdsp_rpt_time;                 /* time_decl */ 
extern const dword   dog_gcsd_rpt_time;                 /* time_decl */ 
extern const dword   dog_gsm_l1_rpt_time;               /* time_decl */ 
extern const dword   dog_gsm_l2_rpt_time;               /* time_decl */ 
extern const dword   dog_l1_rpt_time;                   /* time_decl */ 
extern const dword   dog_l2dl_rpt_time;                 /* time_decl */ 
extern const dword   dog_l2ul_rpt_time;                 /* time_decl */ 
extern const dword   dog_lsm_rpt_time;                  /* time_decl */ 
extern const dword   dog_mm_rpt_time;                   /* time_decl */ 
extern const dword   dog_mn_cnm_rpt_time;               /* time_decl */ 
extern const dword   dog_plt_rpt_time;                  /* time_decl */ 
extern const dword   dog_reg_rpt_time;                  /* time_decl */ 
extern const dword   dog_rr_rpt_time;                   /* time_decl */ 
extern const dword   dog_rrc_rpt_time;                  /* time_decl */ 
extern const dword   dog_sm_rpt_time;                   /* time_decl */ 
extern const dword   dog_tc_rpt_time;                   /* time_decl */ 
extern const dword   dog_test_rpt_time;                 /* time_decl */ 
extern const dword   dog_gllc_rpt_time;                 /* time_decl */ 
extern const dword   dog_grlc_ul_rpt_time;              /* time_decl */ 
extern const dword   dog_grlc_dl_rpt_time;              /* time_decl */ 
extern const dword   dog_gmac_rpt_time;                 /* time_decl */ 
extern const dword   dog_ftm_rpt_time;                  /* time_decl */ 
extern const dword   dog_gstk_rpt_time;                 /* time_decl */ 
extern const dword   dog_virtsat_rpt_time;              /* time_decl */ 
extern const dword   dog_mgpmc_rpt_time;                /* time_decl */ 
extern const dword   dog_mgpnf_rpt_time;                /* time_decl */ 
extern const dword   dog_mgpcd_rpt_time;                /* time_decl */ 
extern const dword   dog_mgpai_rpt_time;                /* time_decl */ 
extern const dword   dog_mgpcc_rpt_time;                /* time_decl */ 
extern const dword   dog_mgpmc_rpt_time;                /* time_decl */ 
extern const dword   dog_pp_rpt_time;                   /* time_decl */ 
extern const dword   dog_cc_rpt_time;                   /* time_decl */ 
extern const dword   dog_pgi_rpt_time;                  /* time_decl */  
extern const dword   dog_nf_rpt_time;                   /* time_decl */ 
extern const dword   dog_lm_rpt_time;                   /* time_decl */ 
extern const dword   dog_pdcommtcp_rpt_time;            /* time_decl */ 
extern const dword   dog_pdcommwms_rpt_time;            /* time_decl */ 
extern const dword   dog_sm_tm_rpt_time;                /* time_decl */ 
extern const dword   dog_gpsfft_rpt_time;               /* time_decl */ 
extern const dword   dog_loc_middleware_rpt_time;       /* time_decl */ 
extern const dword   dog_cb_rpt_time;                   /* time_decl */ 
extern const dword   dog_hdrbc_rpt_time;                /* time_decl */ 
extern const dword   dog_bcdb_rpt_time;                 /* time_decl */ 
extern const dword   dog_dtv_rpt_time;                  /* time_decl */ 
extern const dword   dog_joyst_rpt_time;                /* time_decl */ 
extern const dword   dog_mac_hs_dl_rpt_time;            /* time_decl */ 
extern const dword   dog_interrupt_rpt_time;            /* time_decl */ 
extern const dword   dog_pbm_rpt_time;                  /* time_decl */ 
extern const dword   dog_irda_rpt_time;                 /* time_decl */ 
extern const dword   dog_sirius_test_rpt_time;          /* time_decl */ 
extern const dword   dog_aam_rpt_time;                  /* time_decl */ 
extern const dword   dog_bm_rpt_time;                   /* time_decl */ 
extern const dword   dog_qdiag_rpt_time;                /* time_decl */ 
extern const dword   dog_aps_rpt_time;                  /* time_decl */ 
extern const dword   dog_ats_rpt_time;                  /* time_decl */ 
extern const dword   dog_efs_srvr_rpt_time;             /* time_decl */ 
extern const dword   dog_pms_rpt_time;                  /* time_decl */ 
extern const dword   dog_cnv_rpt_time;                  /* time_decl */ 
extern const dword   dog_dmtask_rpt_time;               /* time_decl */ 
extern const dword   dog_qipcall_rpt_time;              /* time_decl */ 
extern const dword   dog_disp_rpt_time;                 /* time_decl */ 
extern const dword   dog_mfmc_rpt_time;                 /* time_decl */ 
extern const dword   dog_mfpt_rpt_time;                 /* time_decl */ 
extern const dword   dog_mfrxd_rpt_time;                /* time_decl */ 
extern const dword   dog_fc_rpt_time;                   /* time_decl */ 
extern const dword   dog_adsp_rtos_rpt_time;            /* time_decl */ 
extern const dword   dog_ixhttpsvc_rpt_time;            /* time_decl */ 
extern const dword   dog_ubm_l1_rpt_time;               /* time_decl */ 
extern const dword   dog_qdjtest_rpt_time;              /* time_decl */ 
extern const dword   dog_usbebi2_rpt_time;              /* time_decl */ 
extern const dword   dog_usbapi_rpt_time;               /* time_decl */ 
extern const dword   dog_usbd_rpt_time;                 /* time_decl */ 
extern const dword   dog_qtv_video_renderer_rpt_time;   /* time_decl */ 
extern const dword   dog_qtv_audio_rpt_time;            /* time_decl */ 
extern const dword   dog_qtv_task10_rpt_time;           /* time_decl */ 
extern const dword   dog_tcxomgr_rpt_time;              /* time_decl */ 
extern const dword   dog_hsu_al_ms_rpt_time;            /* time_decl */ 
extern const dword   dog_hsu_al_task_rpt_time;          /* time_decl */ 
extern const dword   dog_qtv_dlagenttask_rpt_time;      /* time_decl */ 
extern const dword   dog_sns_rpt_time;                  /* time_decl */ 
extern const dword   dog_ukcc_rpt_time;                 /* time_decl */ 
extern const dword   dog_ipa_main_rpt_time;             /* time_decl */ 
extern const dword   dog_ipa_schan_rpt_time;            /* time_decl */ 
extern const dword   dog_ipa_pdchan_rpt_time;           /* time_decl */ 
extern const dword   dog_ipaukcc_ipc_rpt_time;          /* time_decl */ 
extern const dword   dog_rtp_manager_rpt_time;          /* time_decl */ 
extern const dword   dog_chg_rpt_time;                  /* time_decl */ 
extern const dword   dog_vbatt_rpt_time;                /* time_decl */ 
extern const dword   dog_ftm_camera_rpt_time;           /* time_decl */ 
extern const dword   dog_um_rpt_time;                   /* time_decl */ 
extern const dword   dog_wlan_ds_rpt_time;              /* time_decl */ 
extern const dword   dog_auddrv_rpt_time;               /* time_decl */ 
extern const dword   dog_gpsfs_rpt_time;                /* time_decl */ 
extern const dword   dog_flute_rpt_time;                /* time_decl */
extern const dword   fmrds_dog_rpt_time;                    /* HACK */
extern const dword   dog_lsm_app_proc_rpt_time;         /* time_decl */ 
extern const dword   dog_hitapp_rpt_time;               /* time_decl */ 
extern const dword   dog_flash_ig_srvr_rpt_time;        /* time_decl */ 
extern const dword   dog_bt_fs_rpt_time;                /* time_decl */ 
extern const dword   dog_ims_rpt_time;                  /* time_decl */ 
extern const dword   dog_ims_cb_rpt_time;               /* time_decl */  
extern const dword   dog_mvssmms_rpt_time;              /* time_decl */ 
extern const dword   dog_qtv_dldspsvctask_rpt_time;     /* time_decl */ 
extern const dword   dog_videoshare_rpt_time;           /* time_decl */ 
extern const dword   dog_imshom_rpt_time;               /* time_decl */
extern const dword   dog_rf_rpt_time;                   /* time_decl */ 
extern const dword   dog_hdrdec_rpt_time;               /* time_decl */
...
/**
  Sets up a timer to monitor whether the watchdog task has been running. 
  This timer is reset everytime the watchdog task runs. When the watchdog task 
  does not run for a fixed period of time, the macro for fatal errors is 
  called. 

  @note1hang
  Use dog bark when possible instead of this function. Dog bark is the 
  interrupt that fires when dog_register() reaches a configurable value.

  @param[in] state    State to which the monitor is set. The possible states 
                      are described in the dog_monitor_state() enumerator.
...
#ifdef DOG_REX_API_IS_AVAILABLE
/**
...
#endif /* DOG_REX_API_IS_AVAILABLE */

/**
  Dynamically registers tasks for watchdog services. A replacement for hard coded 
  timeouts in dog.c for common modem interface (CMI) compliance.

  @param[in] thread_id            Thread ID of the client registering for DOG.
  @param[in] timeout              Desired timeout in milliseconds
  @param[in] deadlockcheck_flag   Deadlock check. This argument is currently ignored.
  ...
  None.
*/
extern dog_report_type dog_register_qurt(
