...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/api/debugtools/dll_api.h#1 $
...
DLL_API_WARN_UNUSED_RESULT DLL_API_NONNULL((1, 2)) DLL_API_WARN_DEPRECATED
...
#define DLL_API_NONNULL(x)                   DLL_API_NONNULL_ATTR(x)
#elif defined(__ARMCC_VERSION)
