...
===============================================================================
 ...
 $Header: //components/rel/core.tx/6.0/api/hwengines/bam.h#1 $
 ...
 *
 * Note: For polling mode, the caller should make sure cb_mode \see bam_cb_mode_type
 *       field is set to the appropriate callback mode.
 *
 *       cb_mode : CB_INVOKE_CB_IN_POLL - registered pipe callback is called when polling
 *       cb_mode : CB_INVOKE_CB_DEFAULT - no callbacks are called
 */
 ...
 *
 * @param[in]  pipehandle   Pointer to client's handle to the BAM Pipe
...
/**	  	
* @brief bam_pipe_submit_all	  	
*	  	
* Updates the write pointer of the pipe that is maintained in software in	  	
* hw register, in effect submitting all the descritprs as a batch.	  	
*	  	
* @param[in]  pipe_handle  Pointer to client's handle to the BAM Pipe	  	
*	  	
* @return                   Status of the operation.	  	
