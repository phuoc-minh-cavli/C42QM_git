/*===========================================================================
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2007-2013,2019 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/core.tx/6.0/mproc/ipc_router/ipc_router_database.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
===========================================================================*/
#define IPC_ROUTER_PROC_TABLE_SIZE         1
#define IPC_ROUTER_SERVER_TABLE_SIZE       4
#define IPC_ROUTER_CLIENT_TABLE_SIZE       4
