...
$Header: //components/rel/core.tx/6.0/mproc/smd/src/smd_os_common.h#1 $
...
/*===========================================================================
FUNCTION      smd_copy_from_smd_chnl_cached
===========================================================================*/
/**
  Copies the data from cached SMD channel FIFO. 

  @return   Destination pointer.
===========================================================================*/
void *smd_copy_from_smd_chnl_cached
(
  void         *dest, 
  const void   *src, 
  unsigned int size
