...
$Header: //components/rel/core.tx/6.0/mproc/smd/src/smd_loopback_n_way.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/15/13   bt      Correct value of SMDL_EVENT_LOOPBACK_MAX for number of 
                   events, as opposed to the max event index (size - 1).
...
#define SMDL_EVENT_LOOPBACK_MAX   (SMDL_EVENT_LOOPBACK_CLOSE+1)
