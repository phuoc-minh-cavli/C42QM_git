...
/*===========================================================================
 ...
 Copyright (c) 2011-2014,2018-2019 by Qualcomm Technologies, Incorporated.  All Rights
 Reserved.
...
#define GLINK_SIO_STREAM_TX_MAX_SIZE  (4*1024)
              ...
              glink_sio_host_name[GLINK_SIO_NUM_PROCS + 1] = 
{
  ...
  {SIO_MAJOR_SMD_TO_MODEM,  GLINK_SIO_REMOTE_HOST},
  {SIO_MAJOR_SMD_TO_APPS,   GLINK_SIO_INVALID_HOST} /* invalid entry should always 
						                                           be last  in array */
};
