/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2010-2015, 2021 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/core.tx/6.0/mproc/qmi/qcci/qmi_cci_common.c#3 $
