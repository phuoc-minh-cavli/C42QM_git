...
#endif
static qurt_signal_t       qmi_ping_client_sig;
...
)
{
  ...
  if(pending_inds == 0)
  {
    qurt_signal_set(&qmi_ping_client_sig, QMI_CLNT_IND_DONE_SIG);
  }
}
 ...
 )
{
  ...
  if(pending_async == 0)
  {
    qurt_signal_set(&qmi_ping_client_sig,  QMI_CLNT_ASYNC_DONE_SIG);
  }
}
 ...
 )
{
  ...
  qurt_signal_clear(&qmi_ping_client_sig, QMI_CLNT_ASYNC_DONE_SIG);
  ...
  {
    qurt_signal_wait(&qmi_ping_client_sig, QMI_CLNT_ASYNC_DONE_SIG, QURT_SIGNAL_ATTR_WAIT_ANY);
    qurt_signal_clear(&qmi_ping_client_sig, QMI_CLNT_ASYNC_DONE_SIG);
  }
  return 0;
}
 ...
 )
{
  ...
  qurt_signal_clear(&qmi_ping_client_sig, QMI_CLNT_IND_DONE_SIG);
  ...
  {
    qurt_signal_wait(&qmi_ping_client_sig, QMI_CLNT_IND_DONE_SIG, QURT_SIGNAL_ATTR_WAIT_ANY);
    qurt_signal_clear(&qmi_ping_client_sig, QMI_CLNT_IND_DONE_SIG);
  }
  return 0;
}

int volatile qmi_ping_test_passed[] = {
