...
$Header: //components/rel/core.tx/6.0/services/utils/src/intconv.c#1 $
...
{
  if ( (((float)((int8)f)) - (float)f) > (float)1.0 ) {
    MSG_SPRINTF_4
      ( MSG_SSID_DFLT, MSG_LEGACY_ERROR,
...
{
  if ( (((float)((int16)f)) - (float)f) > (float)1.0 ) {
    MSG_SPRINTF_4
      ( MSG_SSID_DFLT, MSG_LEGACY_ERROR,
        "Value truncated from %f to %i (%s, %u)\n", f, (int16)f, file, line);
  }
...
{
  if ( (((float)((int32)f)) - (float)f) > (float)1.0 ) {
    MSG_SPRINTF_4
      ( MSG_SSID_DFLT, MSG_LEGACY_ERROR,
        "Value truncated from %f to %i (%s, %u)\n", f, (int32)f, file, line);
  }
