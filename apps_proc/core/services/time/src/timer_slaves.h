...
$Header: //components/rel/core.tx/6.0/services/time/src/timer_slaves.h#1 $
...

{
  ...
  time_osal_notify_obj_ptr        sig_obj;

  time_osal_notify_data           sig_mask;
