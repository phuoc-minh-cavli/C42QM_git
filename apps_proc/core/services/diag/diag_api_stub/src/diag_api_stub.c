...
Copyright (c) 2010,2013-2014,2016, 2019 by Qualcomm Technologies,Incorporated. 
All Rights Reserved.
...
$Header: //components/rel/core.tx/6.0/services/diag/diag_api_stub/src/diag_api_stub.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
01/10/19   kdey    Porting of Qsockets
07/20/16   nk      Changes to support ThreadX
03/30/16   ph      DIAG over Qsockets.
