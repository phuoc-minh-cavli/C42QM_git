...
$Header: //components/rel/core.tx/6.0/services/diag/f3_trace/src/diag_f3_trace_cmd.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
11/19/13   rh      Added tracking for current source of F3 Trace settings
05/28/13   sm      Added NULL pointer checks to resolve Klockwork issues
03/20/13   rh      Added Apps registration
