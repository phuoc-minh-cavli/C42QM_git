...
Copyright (c) 2004 - 2009, 2013, 2018, 2020 by QUALCOMM Technologies Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/*==========================================================================

                        EDIT HISTORY FOR MODULE
$Header: //components/rel/core.tx/6.0/services/diag/f3_trace/src/diag_f3_tracei.h#2 $
...
/* Format of err_f3_trace_hdr_type:
...
DESCRIPTION
  ...
  This is a single operation, but the most recent call will set the
  values of the variables, so the highest priority operation needs to
  be done last.
...
/* These variables are set by the above function.
   They should not be directly accessed except to check their values. */
extern uint8 diag_f3_trace_control_mask;
extern uint8 diag_f3_trace_detail_mask;
