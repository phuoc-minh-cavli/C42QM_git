...
Copyright (c) 2010-2016,2019,2022,2023 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/services/diag/diag_mask_tbl/src/msg_arrays_i.c#5 $
...
static const uint32 msg_bld_masks_apps[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_APPS_QUEST,
};
