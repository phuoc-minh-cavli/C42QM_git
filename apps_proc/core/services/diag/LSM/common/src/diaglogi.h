...
--------   ---     ---------------------------------------------------------- 
12/19/14   sr      Added a macro to calculate log mask array index correctly
 ...
 *
 * 'LOG_MASK_INDEX()' calculates the index into the mask correctly unlike
 * LOG_MASK_ARRAY_INDEX()
 * ------------------------------------------------------------------------- */
...
#define LOG_MASK_INDEX(xx_item) ((xx_item + 7) >> 3)
