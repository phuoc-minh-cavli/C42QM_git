...
Copyright (c) 2001-2006,2009-2012,2014, 2019 by Qualcomm Technologies, Incorporated.
All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.tx/6.0/services/diag/LSM/common/src/diagtune.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
06/19/14   sa      Added support to send an event to debug diag drops
12/06/13   sr      Added drain timer on fwd channel  
...
10/12/12   rh      Changed NRT values for Diag draining. 
...
/*Forward drain timer value in ms*/
#define DIAG_FWD_DRAIN_TIMER_LEN_RT 200
#define DIAG_FWD_DRAIN_TIMER_LEN_NRT 0
