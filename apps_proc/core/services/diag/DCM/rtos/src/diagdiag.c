...
Copyright (c) 2000-2013, 2019-2020 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.tx/6.0/services/diag/DCM/rtos/src/diagdiag.c#2 $
...
void diagdiag_tbl_init()
{
    ...
    #endif /* DIAG_LISTENERS_SUPPORT */
  #endif /* DIAG_IMAGE_MODEM_PROC */
#endif /* DIAG_IMAGE_APPS_PROC */
}
