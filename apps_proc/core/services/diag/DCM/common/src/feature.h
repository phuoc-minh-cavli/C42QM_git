...
Notice that changes are listed in reverse chronological order.
      ...
      $Header: //components/rel/core.tx/6.0/services/diag/DCM/common/src/feature.h#1 $
...
01/22/14   rs      Added support for build mask centralization.
...
typedef enum { 
  ...
  F_DIAG_PRESET_MASKS = 5,
   /*HDLC encoding is now handled by APPS on fwd channel*/
