...
Copyright (c) 1999-2014, 2019 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
      ...
      $Header: //components/rel/core.tx/6.0/services/diag/DCM/common/src/diagbuf_v.h#1 $
...
10/05/12   rh      Moved DIAGBUF_SIO_TX_ITEM_SIZ here from diagbuf.c
...
typedef enum
{
  ...
  DIAGBUF_NOT_READY_S     /* Ring/event buffer has data to be queued to 
                          ...
                          /* OR diagbuf_drain is called from context
                            other than diag */
}
...
typedef struct
{
  ...
  boolean terminate;                 /* True if this fragment terminates the packet */
  boolean priority;   
  boolean is_cmd_rsp_type;           /* True if this is a command/response packet */
}
diag_send_desc_type;
...
typedef struct
{
  ...
  /* Below: internal use only
   crc value should be updated only by diag_hdlc_encode()*/
  uint16 crc;
} diag_hdlc_dest_type;
...
@param[in] is_cmd_rsp_type    A boolean value which tells if the send descriptor is for cmd response
...
===========================================================================*/
void 
diagbuf_ctrl_tx_sleep_parameters (unsigned int threshold_val, unsigned int sleep_val);
...
===========================================================================*/
void 
diagbuf_ctrl_commit_threshold(unsigned int val);
...
===========================================================================*/
void 
diagbuf_tx_sleep_parameters_set (void);
/*===========================================================================
...
===========================================================================*/
void 
diagbuf_reset_dsm_chained_count( void );
...
===========================================================================*/
uint32 
diagbuf_get_dsm_chained_count( void );
...
===========================================================================*/
void 
diagbuf_incr_dsm_chained_count( void );
...
===========================================================================*/
void 
diagbuf_write_stream_id (PACK(void *)ptr,byte stream_id);
...
===========================================================================*/
byte 
diagbuf_read_stream_id (const PACK(void *)ptr);
...
===========================================================================*/
void 
diagbuf_flush_timeout(unsigned int timeoutVal);

/*===========================================================================
FUNCTION DIAG_HDLC_ENCODE

DESCRIPTION
    HDLC encodes the data in src_desc->pkt to src_desc->last.
    If the field src_desc->terminate is TRUE, then 7E and CRC will be
    appended
    else, the value of CRC is carried over for the next fragment.
    
===========================================================================*/
void 
diag_hdlc_encode (diag_send_desc_type *src_desc, diag_hdlc_dest_type *enc);

/*===========================================================================
FUNCTION DIAG_NON_HDLC_ENCODE
DESCRIPTION
   frames a packet without hdlc encoding the data. Every packet starts with 7E 
   and ends with 7E
    
===========================================================================*/
void 
diag_non_hdlc_encode (diag_send_desc_type *src_desc, diag_hdlc_dest_type *enc);
#ifdef __cplusplus
  }
#endif
#endif /*DIAGBUF_V_H*/
