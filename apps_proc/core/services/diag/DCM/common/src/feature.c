...
Copyright (c) 1998-2014,2016, 2019 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
Notice that changes are listed in reverse chronological order.
 ...
 $Header: //components/rel/core.tx/6.0/services/diag/DCM/common/src/feature.c#1 $
...
//MARTHAM
byte diag_int_feature_mask[DIAG_INT_FEATURE_MASK_LEN] __attribute__ ((aligned(32)));
...
void diag_init_feature_mask( void )
{
  ...
  /* Supports command/response separation */
  DIAG_INT_FEATURE_MASK_SET(F_DIAG_REQ_RSP_CHANNEL);
  
  /*HDLC encoding is supported on fwd channel*/
  #ifdef FEATURE_DIAG_FWD_HDLC
