// ============================================================================
// Copyright (c) 2018, 2021 Qualcomm Technologies, Inc. and/or its
...
/** Releases an object in the ARM@reg TrustZone@reg that was opened via qapi_IOpener_open().
...
/** Opens a TrustZone object to be used for execution.
    ...
    @detdesc
    This API allows the user to open a specific class ID or a TA service ID
    to ask TrustZone to execute on the user's behalf.
