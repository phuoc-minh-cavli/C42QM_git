 ...
 */
/*
 * Copyright (c) 2010-2021 Qualcomm Technologies, Inc. and/or its
...
/**
 ...
 @see        Refer to qapi_QTEEInvoke_GetOpener documentation for 
             loading a TA.
...
/**
 ...
 Starts a TA from a HLOS provided buffer.
...
/**
 @deprecated API is deprecated in version 2.0.
 @see        Please use QXDM to view TA logs instead.

 Dumps QSEE logs to a file on target EFS.
