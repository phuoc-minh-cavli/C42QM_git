...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/securemsm/unifiedcrypto/environment/inc/uc_comdef.h#1 $
...
#if SYSTEM_32
typedef  unsigned long long uuint64;      /* Unsigned 64 bit value */
typedef  unsigned long int  uuint32;      /* Unsigned 32 bit value */
typedef  unsigned short     uuint16;      /* Unsigned 16 bit value */
typedef  unsigned char      uuint8;       /* Unsigned 8  bit value */

typedef  signed long int    iint32;       /* Signed 32 bit value */
typedef  signed short       iint16;       /* Signed 16 bit value */
typedef  signed char        iint8;        /* Signed 8  bit value */

#elif SYSTEM_64
typedef  unsigned long      uuint64;      /* Unsigned 64 bit value */
typedef  unsigned int       uuint32;      /* Unsigned 32 bit value */
typedef  unsigned short     uuint16;      /* Unsigned 16 bit value */
typedef  unsigned char      uuint8;       /* Unsigned 8  bit value */

typedef  signed int         iint32;       /* Signed 32 bit value */
typedef  signed short       iint16;       /* Signed 16 bit value */
typedef  signed char        iint8;        /* Signed 8  bit value */
#endif
...
#define htonll(x) \
((uuint64)((((uuint64)(x) & 0x00000000000000ffll) << 56) | \
  (((uuint64)(x) & 0x000000000000ff00ll) << 40) | \
  (((uuint64)(x) & 0x0000000000ff0000ll) << 24) | \
                  (((uuint64)(x) & 0x00000000ff000000ll) <<  8) | \
                  (((uuint64)(x) & 0x000000ff00000000ll) >>  8) | \
                  (((uuint64)(x) & 0x0000ff0000000000ll) >> 24) | \
  (((uuint64)(x) & 0x00ff000000000000ll) >> 40) | \
  (((uuint64)(x) & 0xff00000000000000ull) >> 56) ))

#define htonl(x) \
        ((uuint32)((((uuint32)(x) & 0x000000ffU) << 24) | \
                  (((uuint32)(x) & 0x0000ff00U) <<  8) | \
                  (((uuint32)(x) & 0x00ff0000U) >>  8) | \
                  (((uuint32)(x) & 0xff000000U) >> 24)))

#define htons(x) \
        ((uuint16)((((uuint16)(x) & 0x00ff) << 8) | \
                  (((uuint16)(x) & 0xff00) >> 8)))
