...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/securemsm/unifiedcrypto/core/sha/inc/sha_core.h#1 $
...
{
   uuint32  iv[16];  // is 64 byte for SHA2-512
   uuint32  counter[2];
...
void sechsharm_sha256_update( struct __sechsh_ctx_s*, uuint8*, uuint32*, uuint8*, uuint32 );
void sechsharm_sha256_final(  struct __sechsh_ctx_s*, uuint8*, uuint32*, uuint8* );
static void sechsharm_sha256_transform( uuint32 state[8], const uuint8 data[SHA256_BLOCK_LENGTH]);
...
static const uuint32 sha256_initial_hash_value[8] = {
   0x6a09e667UL,
   0xbb67ae85UL,
   0x3c6ef372UL,
   0xa54ff53aUL,
