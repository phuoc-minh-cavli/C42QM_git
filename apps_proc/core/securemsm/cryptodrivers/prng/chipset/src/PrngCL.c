...
/*===========================================================================
 ...
 $Header: //components/rel/core.tx/6.0/securemsm/cryptodrivers/prng/chipset/src/PrngCL.c#1 $
...
/**Disable this flag if clocks arent emulated on RUMI */ 
uint32 g_prng_clk_exist = 1;
