...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/securemsm/cryptodrivers/prng/shared/inc/PrngML.h#1 $
 ...
 *        DAL framework are not yet initialised. Function to be
 *        used by <b>Stack protection</b> only.
 *
