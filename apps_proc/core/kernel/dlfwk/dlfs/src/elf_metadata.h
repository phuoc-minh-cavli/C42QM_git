...
==============================================================================*/
#ifndef __ELF_METADAT_H__
#define __ELF_METADAT_H__
...
typedef struct
{
  uint8 image_id;       /* Identifies the type of image this header
