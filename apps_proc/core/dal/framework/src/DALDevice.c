...
static qurt_mutex_t Lock;  
static qurt_mutex_t *hLock = NULL;  
...
#define _DALSYSCMN_MOD_LIST_SYNC_LOCK()       qurt_mutex_lock(hLock);
#define _DALSYSCMN_MOD_LIST_SYNC_UN_LOCK()    qurt_mutex_unlock(hLock);
