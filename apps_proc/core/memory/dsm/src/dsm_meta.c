...
$Header: //components/rel/core.tx/6.0/memory/dsm/src/dsm_meta.c#1 $
...
)
{
  ...
  memscpy_i( meta_ptr,size, (uint8*)(item_ptr) - size, size);
...
)
{
  ...
  memscpy_i( (uint8*)(item_ptr) - size,size,  meta_ptr, size );
