...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/memory/dsm/src/dsm_lock.c#1 $
...
#elif defined FEATURE_DSM_QURT
  qurt_mutex_lock((qurt_mutex_t *)*lock_ptr);
...
#elif defined FEATURE_DSM_QURT
  qurt_mutex_unlock((qurt_mutex_t *)*lock_ptr);
...
)
{
  ...
  *lock_ptr = (dword)malloc(sizeof (rex_crit_sect_type));
  ...
  /* Allocate memory for the lock */
  *lock_ptr = (dword)malloc(sizeof (qurt_mutex_t));

  /* Initialize the critical section */
  qurt_mutex_init((qurt_mutex_t *)(*lock_ptr));  
#else
  *lock_ptr = 0;
...
#elif defined FEATURE_DSM_QURT
  /* Free the space allocated for lock */
   qurt_mutex_destroy((qurt_mutex_t *)(*lock_ptr));
  (void) free((void *)(qurt_mutex_t *)(*lock_ptr));
  *lock_ptr = 0;
#else
  *lock_ptr = 0;
