...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/memory/dsm/src/dsm_pool.c#1 $
...
)
{
  ...
  */
#ifdef FEATURE_DSM_ALIGN_64
 /* align table to even-66 + (cookie size + pad) */
  table->item_array =
    (uint8*)( ( ( (uint32)item_array + 63 ) & ~63 ))	+ 
     DSM_TAIL_COOKIE_LEN								+
     table->pad_size ;
#else
