...
=============================================================================*/
/*=============================================================================
 $Header: //components/rel/core.tx/6.0/debugtrace/tracer/src/tracer_throttle.c#1 $
=============================================================================*/
...
int tracer_throttle_check(uint32 data_bytes)
{
   ...
   // given time window.
   if (TRACER_ATOMIC_ADD_RETURN(&(tracer_throttle.running_sum), data_bytes) >
       tracer_throttle.threshold_bytes)
   {
      ...
      else
      {
         ...
         TRACER_ATOMIC64_SET(&(tracer_throttle.start_time), time_now);
         TRACER_ATOMIC_SET(&(tracer_throttle.running_sum), data_bytes);
      }
   }
