...
================================================================================
  $Header: //components/rel/core.tx/6.0/debugtrace/csr/hal/src/halqdss_csr.c#1 $
==============================================================================*/
...
void HAL_qdss_csr_SetETRByteCounter(uint32 val)
{
   HWIO_OUT(QDSS_CS_QDSSCSR_ETRIRQCTRL,(val>>3));
}

uint32 HAL_qdss_csr_GetETRByteCounter(void)
{
   return (HWIO_IN(QDSS_CS_QDSSCSR_ETRIRQCTRL) << 3);
}
