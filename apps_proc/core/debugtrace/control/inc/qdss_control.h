...
==============================================================================*/
/*=============================================================================
  $Header: //components/rel/core.tx/6.0/debugtrace/control/inc/qdss_control.h#1 $
=============================================================================*/

#include <stdio.h>
#include "DALStdDef.h"
#include "qdss_tfunnel.h"  // Trace funnel name
#include "DDITMC.h"        // Sink IDs
...
/**
  @brief Trigger a trigger to a channel.

  @param [in] block      : CTI block name. Must be null terminated.
  @param [in] channel    : Channel number.
  @param [in] trigger_type : 1 set, 2 clear, 3 trigger
