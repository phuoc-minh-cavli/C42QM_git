...
#define QDSS_CORRELATE_GPIO            0x38
#define QDSS_TRIGGER_CTI               0x39
...
typedef PACK(struct)
{
  qdss_diag_pkt_hdr hdr;
  uint8 gpio_option;
} qdss_correlate_gpio_req;

typedef qdss_diag_pkt_rsp qdss_correlate_gpio_rsp;
...
typedef PACK(struct)
{
  ...
  uint8 channel;
  uint8 trigger_type;
} qdss_trigger_cti_req;

typedef qdss_diag_pkt_rsp qdss_trigger_cti_rsp;
