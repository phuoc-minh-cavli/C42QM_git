...
//                             Edit History
//
// $Header: //components/rel/core.tx/6.0/debugtrace/tpda/dal/src/DDITPDA.h#1 $
//
//========================================================================
...
struct DalTPDA
{
   ...
   DALResult (*TPDA_EnableDisable)(DalDeviceHandle *phandle,const char *pTPDAStr,const char *pTPDMStr,DALBOOL bEnable);
   DALResult (*TPDA_SetParam)(DalDeviceHandle* h,const char *pTPDAStr,uint8 param_id,uint32 val);
   DALResult (*TPDA_GetParam)(DalDeviceHandle* h,const char *pTPDAStr,uint8 param_id,uint32 val);
...
{
   return ((DalTPDAHandle *)phandle)->pVtbl->TPDA_EnableDisable(phandle,pTPDAStr,pTPDMStr,bEnable);
}
...
{
   return ((DalTPDAHandle *)phandle)->pVtbl->TPDA_SetParam(phandle,pTPDAStr,param_id,val);
}
