...
/*==========================================================================
 $Header: //components/rel/core.tx/6.0/debugtrace/tpda/hal/src/hal_qdss_tpda.c#1 $
==========================================================================*/
...
void HAL_qdss_tpda_set_cmbchanmode(uint32 mode)
{
   HWIO_OUTF(QDSS_TPDA_CR,CMBCHANMODE,mode);
   return;
}
