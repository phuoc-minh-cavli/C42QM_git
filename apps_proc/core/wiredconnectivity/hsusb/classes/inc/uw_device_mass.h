...
==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/classes/inc/uw_device_mass.h#1 $
...
typedef struct {
    ...
    /* HSU addition: Interface string */
     char *interface_string;    /* Interface string descriptor */
    /* End of HSU addition */
} msfd_init_info_t;
 ...
 * Scope:        Global
 **/
void update_sps_info( void *handler, juint8_t lun, jbool_t sps_mode,juint8_t in_sps_pipe_id,
	juint8_t out_sps_pipe_id, completion_callback* lun_completion_cb);
