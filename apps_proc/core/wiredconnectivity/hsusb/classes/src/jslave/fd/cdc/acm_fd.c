...
==============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/classes/src/jslave/fd/cdc/acm_fd.c#1 $
...
static void set_comm_feature_complete(request_t *req)
{
    ...
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, app_failed_handle_req");
        goto Error;
    }
    ...
    if (rc)
    {
        HSU_ULOG_1(ERROR_MSG, DBG_E_LOG, "CDC_ACM, failed_to_send_status_packet, rc %d", rc);
        goto Error;
    }
    ...
    struct usb_ctrlrequest *req)
{
    ...
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, unsuitable_request_for_device_capab");
        goto Error;
    }

    if (le16toh(req->wLength) != 2)
    {
        HSU_ULOG_1(ERROR_MSG, DBG_E_LOG, "CDC_ACM, unrecognized_format, wLength != %u",
          le16toh(req->wLength));
        goto Error;
    }
    ...
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, no_handler_defined");
        goto Error;
    }
    ...
    if (!reply)
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, failed_to_setup_reply");
        goto Error;
    }
...
static void set_line_coding_complete(request_t *req)
{
    ...
    if (rc)
    {
        HSU_ULOG_1(ERROR_MSG, DBG_E_LOG, "CDC_ACM, failed_send_status_packet, rc %u", rc);
        goto Error;
    }
...
jresult_t acm_handle_request(void *context, void *buffer)
{
    ...
    hsu_trace_msg2_set(ACM_HANDLE_REQUEST__TRC);
    hsu_trace_inf_set(req->bRequest);

    /* removed due to flooding of bus log */
    // HSU_ULOG_1(NO_MSG, BUS_LOG, "bReq %u", (uint32) req->bRequest);
    ...
    default:
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, unsupported_acm_req");
        break;
    }
...
jresult_t cdc_init_acm(void *core_ctx)
{
    ...
    if (!ctx)
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, failed_to_allocate_ctx");
        rc = JENOMEM;
        goto Error;
    }
    ...
    if (rc)
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, app_failed_to_init");        
        goto Error;
    }
    ...
    if (rc)
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, fail_to_allocate_descriptor");
        goto Error;
    }
    ...
    if (rc)
    {
        HSU_ULOG(ERROR_MSG, DBG_E_LOG, "CDC_ACM, failed, cdc_init()");
        goto Error;
    }
