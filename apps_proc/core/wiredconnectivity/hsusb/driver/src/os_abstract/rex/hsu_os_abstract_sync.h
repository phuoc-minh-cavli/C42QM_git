...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/driver/src/os_abstract/rex/hsu_os_abstract_sync.h#1 $
...
#define HSU_OS_SYNC_MSLEEP_STOP_SLEEP_SIGNAL   0x00000001 /*=REX_SLEEP_SIG*/
