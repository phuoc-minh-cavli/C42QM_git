...
GENERAL DESCRIPTION
    Contains the core configuration for HS-USB for MDM9x06.
...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/driver/src/core_config/9x06/hsu_core_config_target.c#1 $
...
hsu_core_config_type* hsu_core_config_table[]=
{
  /* High-Speed USB core. */
    ...
    &cores_details[HSU_USB2_CI_CORE],
  #else 
    NULL,   /* No HS-OTG core */
