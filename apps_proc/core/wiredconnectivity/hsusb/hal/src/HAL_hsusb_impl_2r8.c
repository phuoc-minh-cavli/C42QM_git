...
$Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/hal/src/HAL_hsusb_impl_2r8.c#1 $
...
static HAL_HSUSB_TestBusSelectorType HAL_hsusb_GetTestBusSelectorImpl2r8(uint8 instance)
{
  return (HAL_HSUSB_TestBusSelectorType)
    ...
    >> HAL_HSUSB_GEN_CONFIG_USB_OTG_HS_TESTMUX_SEL_SHFT)+1);
}
