...
FILE:         HAL_hsusb_MDM9x07.c

DESCRIPTION:  
This is the HAL implementation of the run-time initialization for MDM9x07.

$Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/hal/src/HAL_hsusb_MDM9x07.c#1 $
...
*/
void HAL_hsusb_ConstructImplInstanceMDM9x07
(
