...
$Header: //components/rel/core.tx/6.0/wiredconnectivity/hsusb/hal/inc/HAL_hsusb.h#1 $
...
typedef enum
{
  ...
  HAL_HSUSB_WrongPhyInterface,
  /**< -- PHY interface is not supported by the HS-USB core. */
  HAL_HSUSB_TimeoutExpired,
...
/*=============================================================================
FUNCTION      HAL_hsusb_GetPeDpTxFifoIdleForce
=============================================================================*/
/**
This function reports the PE_DP_TXFIO_IDLE_FORCE bit status in GEN_CONFIG 
register.

@note This function is valid for HS-USB hardware version 5 and above.

@param instance [IN] -- Determines which HS-USB core to use. 
...
/*=============================================================================
FUNCTION      HAL_hsusb_SetPeDpTxFifoIdleForce
=============================================================================*/
/**
This function sets the PE_DP_TXFIO_IDLE_FORCE bit status in GEN_CONFIG register.  
Clear this bit to 0 to prevent TX data corruption.
...
@param instance [IN] -- Determines which HS-USB core to use. 
                        This value should be one less than reported by 
                        the HAL_hsusb_SupportedCoresQty().
@param state    [IN] -- Determines the PE_DP_TXFIO_IDLE_FORCE status
                        - TRUE  - PE_DP_TXFIO_IDLE_FORCE bit to set to 1 
                                  (default)
...
=============================================================================*/
/**
Sets ULPI Low Power Mode to L1 state
