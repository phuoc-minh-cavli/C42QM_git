...
//These are the static margin tweaks that get applied when quoenties are calculated.
typedef enum
{
    CPR_MARGIN_ADJUSTMENT_STATIC,
    CPR_MARGIN_ADJUSTMENT_AGING,
    CPR_MARGIN_ADJUSTMENT_THERMO,
    CPR_ADJUSTMENT_COUNT,
} cpr_adjustment_t;
