...
#if defined(WINSIM) || defined(APSS_CPR_BUILD)
#include "ULogFront.h"
...
#define CPR_ULOG_STATIC_NUM_SLOTS                 10
...
#define CPR_ULOG_STATIC_LOG_THERM_INFO            8
#define CPR_ULOG_STATIC_LOG_FUSING_VERSION        9
