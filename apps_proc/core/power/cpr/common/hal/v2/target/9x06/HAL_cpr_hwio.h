...
/*
  ...
  $Header: //components/rel/core.tx/6.0/power/cpr/common/hal/v2/target/9x06/HAL_cpr_hwio.h#1 $
...
/*----------------------------------------------------------------------------
 * MODULE: APCS_RBCPR_WRAPPER
 *--------------------------------------------------------------------------*/

#define APCS_RBCPR_WRAPPER_REG_BASE                                          (A7SS_BASE      + 0x00018000)
...
#define HWIO_APCS_GLBSECURE_ADDR(x)                                        ((x) + 0x00000000)
#define HWIO_APCS_GLBSECURE_RMSK                                                  0x3
#define HWIO_APCS_GLBSECURE_IN(x)      \
        in_dword_masked(HWIO_APCS_GLBSECURE_ADDR(x), HWIO_APCS_GLBSECURE_RMSK)
#define HWIO_APCS_GLBSECURE_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLBSECURE_ADDR(x), m)
#define HWIO_APCS_GLBSECURE_OUT(x, v)      \
        out_dword(HWIO_APCS_GLBSECURE_ADDR(x),v)
#define HWIO_APCS_GLBSECURE_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLBSECURE_ADDR(x),m,v,HWIO_APCS_GLBSECURE_IN(x))
...
#define HWIO_APCS_START_ADDR_ADDR(x)                                       ((x) + 0x00000004)
#define HWIO_APCS_START_ADDR_RMSK                                          0xffff0000
#define HWIO_APCS_START_ADDR_IN(x)      \
        in_dword_masked(HWIO_APCS_START_ADDR_ADDR(x), HWIO_APCS_START_ADDR_RMSK)
#define HWIO_APCS_START_ADDR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_START_ADDR_ADDR(x), m)
#define HWIO_APCS_START_ADDR_OUT(x, v)      \
        out_dword(HWIO_APCS_START_ADDR_ADDR(x),v)
#define HWIO_APCS_START_ADDR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_START_ADDR_ADDR(x),m,v,HWIO_APCS_START_ADDR_IN(x))
#define HWIO_APCS_START_ADDR_ADDR_BMSK                                     0xffff0000
#define HWIO_APCS_START_ADDR_ADDR_SHFT                                           0x10

#define HWIO_APCS_CMD_RCGR_ADDR(x)                                         ((x) + 0x00000008)
#define HWIO_APCS_CMD_RCGR_RMSK                                            0x80000013
#define HWIO_APCS_CMD_RCGR_IN(x)      \
        in_dword_masked(HWIO_APCS_CMD_RCGR_ADDR(x), HWIO_APCS_CMD_RCGR_RMSK)
#define HWIO_APCS_CMD_RCGR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_CMD_RCGR_ADDR(x), m)
#define HWIO_APCS_CMD_RCGR_OUT(x, v)      \
        out_dword(HWIO_APCS_CMD_RCGR_ADDR(x),v)
#define HWIO_APCS_CMD_RCGR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_CMD_RCGR_ADDR(x),m,v,HWIO_APCS_CMD_RCGR_IN(x))
...
#define HWIO_APCS_CFG_RCGR_ADDR(x)                                         ((x) + 0x0000000c)
#define HWIO_APCS_CFG_RCGR_RMSK                                                 0x71f
#define HWIO_APCS_CFG_RCGR_IN(x)      \
        in_dword_masked(HWIO_APCS_CFG_RCGR_ADDR(x), HWIO_APCS_CFG_RCGR_RMSK)
#define HWIO_APCS_CFG_RCGR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_CFG_RCGR_ADDR(x), m)
#define HWIO_APCS_CFG_RCGR_OUT(x, v)      \
        out_dword(HWIO_APCS_CFG_RCGR_ADDR(x),v)
#define HWIO_APCS_CFG_RCGR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_CFG_RCGR_ADDR(x),m,v,HWIO_APCS_CFG_RCGR_IN(x))
...
#define HWIO_APCS_CBCR_ADDR(x)                                             ((x) + 0x00000010)
#define HWIO_APCS_CBCR_RMSK                                                0x80007ff3
#define HWIO_APCS_CBCR_IN(x)      \
        in_dword_masked(HWIO_APCS_CBCR_ADDR(x), HWIO_APCS_CBCR_RMSK)
#define HWIO_APCS_CBCR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_CBCR_ADDR(x), m)
#define HWIO_APCS_CBCR_OUT(x, v)      \
        out_dword(HWIO_APCS_CBCR_ADDR(x),v)
#define HWIO_APCS_CBCR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_CBCR_ADDR(x),m,v,HWIO_APCS_CBCR_IN(x))
...
#define HWIO_APCS_GLB_CFG_ADDR(x)                                          ((x) + 0x00000014)
#define HWIO_APCS_GLB_CFG_RMSK                                                 0x1fff
#define HWIO_APCS_GLB_CFG_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_CFG_ADDR(x), HWIO_APCS_GLB_CFG_RMSK)
#define HWIO_APCS_GLB_CFG_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_CFG_ADDR(x), m)
#define HWIO_APCS_GLB_CFG_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_CFG_ADDR(x),v)
#define HWIO_APCS_GLB_CFG_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_CFG_ADDR(x),m,v,HWIO_APCS_GLB_CFG_IN(x))
...
#define HWIO_APCS_GLB_BOOT_REMAP_ADDR(x)                                   ((x) + 0x00000018)
#define HWIO_APCS_GLB_BOOT_REMAP_RMSK                                      0xffff0007
#define HWIO_APCS_GLB_BOOT_REMAP_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_BOOT_REMAP_ADDR(x), HWIO_APCS_GLB_BOOT_REMAP_RMSK)
#define HWIO_APCS_GLB_BOOT_REMAP_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_BOOT_REMAP_ADDR(x), m)
#define HWIO_APCS_GLB_BOOT_REMAP_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_BOOT_REMAP_ADDR(x),v)
#define HWIO_APCS_GLB_BOOT_REMAP_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_BOOT_REMAP_ADDR(x),m,v,HWIO_APCS_GLB_BOOT_REMAP_IN(x))
...
#define HWIO_APCS_GLB_TEST_BUSSEL_ADDR(x)                                  ((x) + 0x0000001c)
#define HWIO_APCS_GLB_TEST_BUSSEL_RMSK                                     0xf000001f
#define HWIO_APCS_GLB_TEST_BUSSEL_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_TEST_BUSSEL_ADDR(x), HWIO_APCS_GLB_TEST_BUSSEL_RMSK)
#define HWIO_APCS_GLB_TEST_BUSSEL_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_TEST_BUSSEL_ADDR(x), m)
#define HWIO_APCS_GLB_TEST_BUSSEL_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_TEST_BUSSEL_ADDR(x),v)
#define HWIO_APCS_GLB_TEST_BUSSEL_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_TEST_BUSSEL_ADDR(x),m,v,HWIO_APCS_GLB_TEST_BUSSEL_IN(x))
...
#define HWIO_APCS_GLB_EN_PWR_ST_ADDR(x)                                    ((x) + 0x00000020)
#define HWIO_APCS_GLB_EN_PWR_ST_RMSK                                              0x3
#define HWIO_APCS_GLB_EN_PWR_ST_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_EN_PWR_ST_ADDR(x), HWIO_APCS_GLB_EN_PWR_ST_RMSK)
#define HWIO_APCS_GLB_EN_PWR_ST_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_EN_PWR_ST_ADDR(x), m)
#define HWIO_APCS_GLB_EN_PWR_ST_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_EN_PWR_ST_ADDR(x),v)
#define HWIO_APCS_GLB_EN_PWR_ST_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_EN_PWR_ST_ADDR(x),m,v,HWIO_APCS_GLB_EN_PWR_ST_IN(x))
...
#define HWIO_APCS_GLB_QSB_LP_ADDR(x)                                       ((x) + 0x00000024)
#define HWIO_APCS_GLB_QSB_LP_RMSK                                                0x7f
#define HWIO_APCS_GLB_QSB_LP_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_QSB_LP_ADDR(x), HWIO_APCS_GLB_QSB_LP_RMSK)
#define HWIO_APCS_GLB_QSB_LP_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_QSB_LP_ADDR(x), m)
#define HWIO_APCS_GLB_QSB_LP_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_QSB_LP_ADDR(x),v)
#define HWIO_APCS_GLB_QSB_LP_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_QSB_LP_ADDR(x),m,v,HWIO_APCS_GLB_QSB_LP_IN(x))
...
#define HWIO_APCS_GLB_AHB_CLKON_ADDR(x)                                    ((x) + 0x00000028)
#define HWIO_APCS_GLB_AHB_CLKON_RMSK                                           0xffff
#define HWIO_APCS_GLB_AHB_CLKON_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_AHB_CLKON_ADDR(x), HWIO_APCS_GLB_AHB_CLKON_RMSK)
#define HWIO_APCS_GLB_AHB_CLKON_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_AHB_CLKON_ADDR(x), m)
#define HWIO_APCS_GLB_AHB_CLKON_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_AHB_CLKON_ADDR(x),v)
#define HWIO_APCS_GLB_AHB_CLKON_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_AHB_CLKON_ADDR(x),m,v,HWIO_APCS_GLB_AHB_CLKON_IN(x))
...
#define HWIO_APCS_GLB_QGIC_CFG_ADDR(x)                                     ((x) + 0x0000002c)
#define HWIO_APCS_GLB_QGIC_CFG_RMSK                                            0x7f87
#define HWIO_APCS_GLB_QGIC_CFG_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_QGIC_CFG_ADDR(x), HWIO_APCS_GLB_QGIC_CFG_RMSK)
#define HWIO_APCS_GLB_QGIC_CFG_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_QGIC_CFG_ADDR(x), m)
#define HWIO_APCS_GLB_QGIC_CFG_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_QGIC_CFG_ADDR(x),v)
#define HWIO_APCS_GLB_QGIC_CFG_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_QGIC_CFG_ADDR(x),m,v,HWIO_APCS_GLB_QGIC_CFG_IN(x))
...
#define HWIO_APCS_GLB_GHDS_CNTR_ADDR(x)                                    ((x) + 0x00000030)
#define HWIO_APCS_GLB_GHDS_CNTR_RMSK                                            0x3ff
#define HWIO_APCS_GLB_GHDS_CNTR_IN(x)      \
        in_dword_masked(HWIO_APCS_GLB_GHDS_CNTR_ADDR(x), HWIO_APCS_GLB_GHDS_CNTR_RMSK)
#define HWIO_APCS_GLB_GHDS_CNTR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_GLB_GHDS_CNTR_ADDR(x), m)
#define HWIO_APCS_GLB_GHDS_CNTR_OUT(x, v)      \
        out_dword(HWIO_APCS_GLB_GHDS_CNTR_ADDR(x),v)
#define HWIO_APCS_GLB_GHDS_CNTR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_GLB_GHDS_CNTR_ADDR(x),m,v,HWIO_APCS_GLB_GHDS_CNTR_IN(x))
#define HWIO_APCS_GLB_GHDS_CNTR_GHDS_CNTR_VALUE_BMSK                            0x3ff
#define HWIO_APCS_GLB_GHDS_CNTR_GHDS_CNTR_VALUE_SHFT                              0x0

#define HWIO_APCS_TCM_REDIRECT_ADDR_ADDR(x)                                ((x) + 0x00000034)
#define HWIO_APCS_TCM_REDIRECT_ADDR_RMSK                                   0xfffc0001
#define HWIO_APCS_TCM_REDIRECT_ADDR_IN(x)      \
        in_dword_masked(HWIO_APCS_TCM_REDIRECT_ADDR_ADDR(x), HWIO_APCS_TCM_REDIRECT_ADDR_RMSK)
#define HWIO_APCS_TCM_REDIRECT_ADDR_INM(x, m)      \
        in_dword_masked(HWIO_APCS_TCM_REDIRECT_ADDR_ADDR(x), m)
#define HWIO_APCS_TCM_REDIRECT_ADDR_OUT(x, v)      \
        out_dword(HWIO_APCS_TCM_REDIRECT_ADDR_ADDR(x),v)
#define HWIO_APCS_TCM_REDIRECT_ADDR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_TCM_REDIRECT_ADDR_ADDR(x),m,v,HWIO_APCS_TCM_REDIRECT_ADDR_IN(x))
...
#define HWIO_APCS_A7_GLB_CFG_ADDR(x)                                       ((x) + 0x00000038)
#define HWIO_APCS_A7_GLB_CFG_RMSK                                               0x1f1
#define HWIO_APCS_A7_GLB_CFG_IN(x)      \
        in_dword_masked(HWIO_APCS_A7_GLB_CFG_ADDR(x), HWIO_APCS_A7_GLB_CFG_RMSK)
#define HWIO_APCS_A7_GLB_CFG_INM(x, m)      \
        in_dword_masked(HWIO_APCS_A7_GLB_CFG_ADDR(x), m)
#define HWIO_APCS_A7_GLB_CFG_OUT(x, v)      \
        out_dword(HWIO_APCS_A7_GLB_CFG_ADDR(x),v)
#define HWIO_APCS_A7_GLB_CFG_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APCS_A7_GLB_CFG_ADDR(x),m,v,HWIO_APCS_A7_GLB_CFG_IN(x))
...
#define HWIO_SPM_VOTE_TZ_ADDR(x)                                           ((x) + 0x0000003c)
#define HWIO_SPM_VOTE_TZ_RMSK                                              0xc000003f
#define HWIO_SPM_VOTE_TZ_IN(x)      \
        in_dword_masked(HWIO_SPM_VOTE_TZ_ADDR(x), HWIO_SPM_VOTE_TZ_RMSK)
#define HWIO_SPM_VOTE_TZ_INM(x, m)      \
        in_dword_masked(HWIO_SPM_VOTE_TZ_ADDR(x), m)
#define HWIO_SPM_VOTE_TZ_OUT(x, v)      \
        out_dword(HWIO_SPM_VOTE_TZ_ADDR(x),v)
#define HWIO_SPM_VOTE_TZ_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPM_VOTE_TZ_ADDR(x),m,v,HWIO_SPM_VOTE_TZ_IN(x))
...
#define HWIO_SPM_VOTE_HLOS_ADDR(x)                                         ((x) + 0x00000040)
#define HWIO_SPM_VOTE_HLOS_RMSK                                            0xc000003f
#define HWIO_SPM_VOTE_HLOS_IN(x)      \
        in_dword_masked(HWIO_SPM_VOTE_HLOS_ADDR(x), HWIO_SPM_VOTE_HLOS_RMSK)
#define HWIO_SPM_VOTE_HLOS_INM(x, m)      \
        in_dword_masked(HWIO_SPM_VOTE_HLOS_ADDR(x), m)
#define HWIO_SPM_VOTE_HLOS_OUT(x, v)      \
        out_dword(HWIO_SPM_VOTE_HLOS_ADDR(x),v)
#define HWIO_SPM_VOTE_HLOS_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPM_VOTE_HLOS_ADDR(x),m,v,HWIO_SPM_VOTE_HLOS_IN(x))
...
#define HWIO_SPM_VOTE_HYP_ADDR(x)                                          ((x) + 0x00000044)
#define HWIO_SPM_VOTE_HYP_RMSK                                             0xc000003f
#define HWIO_SPM_VOTE_HYP_IN(x)      \
        in_dword_masked(HWIO_SPM_VOTE_HYP_ADDR(x), HWIO_SPM_VOTE_HYP_RMSK)
#define HWIO_SPM_VOTE_HYP_INM(x, m)      \
        in_dword_masked(HWIO_SPM_VOTE_HYP_ADDR(x), m)
#define HWIO_SPM_VOTE_HYP_OUT(x, v)      \
        out_dword(HWIO_SPM_VOTE_HYP_ADDR(x),v)
#define HWIO_SPM_VOTE_HYP_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPM_VOTE_HYP_ADDR(x),m,v,HWIO_SPM_VOTE_HYP_IN(x))
...
#define HWIO_SPM_VOTE_INT_STS_ADDR(x)                                      ((x) + 0x00000048)
#define HWIO_SPM_VOTE_INT_STS_RMSK                                         0xc000003f
#define HWIO_SPM_VOTE_INT_STS_IN(x)      \
        in_dword_masked(HWIO_SPM_VOTE_INT_STS_ADDR(x), HWIO_SPM_VOTE_INT_STS_RMSK)
#define HWIO_SPM_VOTE_INT_STS_INM(x, m)      \
        in_dword_masked(HWIO_SPM_VOTE_INT_STS_ADDR(x), m)
...
#define HWIO_SPM_VOTE_INT_CLR_ADDR(x)                                      ((x) + 0x0000004c)
#define HWIO_SPM_VOTE_INT_CLR_RMSK                                         0xc000003f
#define HWIO_SPM_VOTE_INT_CLR_OUT(x, v)      \
        out_dword(HWIO_SPM_VOTE_INT_CLR_ADDR(x),v)
...
#define HWIO_APPS_BOOTFSM_CTL_ADDR(x)                                      ((x) + 0x00000050)
#define HWIO_APPS_BOOTFSM_CTL_RMSK                                               0xf3
#define HWIO_APPS_BOOTFSM_CTL_IN(x)      \
        in_dword_masked(HWIO_APPS_BOOTFSM_CTL_ADDR(x), HWIO_APPS_BOOTFSM_CTL_RMSK)
#define HWIO_APPS_BOOTFSM_CTL_INM(x, m)      \
        in_dword_masked(HWIO_APPS_BOOTFSM_CTL_ADDR(x), m)
#define HWIO_APPS_BOOTFSM_CTL_OUT(x, v)      \
        out_dword(HWIO_APPS_BOOTFSM_CTL_ADDR(x),v)
#define HWIO_APPS_BOOTFSM_CTL_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_APPS_BOOTFSM_CTL_ADDR(x),m,v,HWIO_APPS_BOOTFSM_CTL_IN(x))
...
#define HWIO_APPS_BOOTFSM_STATUS_ADDR(x)                                   ((x) + 0x00000054)
#define HWIO_APPS_BOOTFSM_STATUS_RMSK                                      0xffffffff
#define HWIO_APPS_BOOTFSM_STATUS_IN(x)      \
        in_dword_masked(HWIO_APPS_BOOTFSM_STATUS_ADDR(x), HWIO_APPS_BOOTFSM_STATUS_RMSK)
#define HWIO_APPS_BOOTFSM_STATUS_INM(x, m)      \
        in_dword_masked(HWIO_APPS_BOOTFSM_STATUS_ADDR(x), m)
#define HWIO_APPS_BOOTFSM_STATUS_BOOTFSM_STATUS_BMSK                       0xffffffff
#define HWIO_APPS_BOOTFSM_STATUS_BOOTFSM_STATUS_SHFT                              0x0

#define HWIO_RBCPR_CLK_SEL_ADDR(x)                                         ((x) + 0x00000058)
#define HWIO_RBCPR_CLK_SEL_RMSK                                                   0x1
#define HWIO_RBCPR_CLK_SEL_IN(x)      \
        in_dword_masked(HWIO_RBCPR_CLK_SEL_ADDR(x), HWIO_RBCPR_CLK_SEL_RMSK)
#define HWIO_RBCPR_CLK_SEL_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_CLK_SEL_ADDR(x), m)
#define HWIO_RBCPR_CLK_SEL_OUT(x, v)      \
        out_dword(HWIO_RBCPR_CLK_SEL_ADDR(x),v)
#define HWIO_RBCPR_CLK_SEL_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBCPR_CLK_SEL_ADDR(x),m,v,HWIO_RBCPR_CLK_SEL_IN(x))
#define HWIO_RBCPR_CLK_SEL_CLK_SEL_BMSK                                           0x1
#define HWIO_RBCPR_CLK_SEL_CLK_SEL_SHFT                                           0x0

#define HWIO_RBCPR_BCR_ADDR(x)                                             ((x) + 0x0000005c)
#define HWIO_RBCPR_BCR_RMSK                                                       0x1
#define HWIO_RBCPR_BCR_IN(x)      \
        in_dword_masked(HWIO_RBCPR_BCR_ADDR(x), HWIO_RBCPR_BCR_RMSK)
#define HWIO_RBCPR_BCR_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_BCR_ADDR(x), m)
#define HWIO_RBCPR_BCR_OUT(x, v)      \
        out_dword(HWIO_RBCPR_BCR_ADDR(x),v)
#define HWIO_RBCPR_BCR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBCPR_BCR_ADDR(x),m,v,HWIO_RBCPR_BCR_IN(x))
#define HWIO_RBCPR_BCR_RBCPR_ARES_BMSK                                            0x1
#define HWIO_RBCPR_BCR_RBCPR_ARES_SHFT                                            0x0

#define HWIO_RBCPR_PMIC_ADDR(x)                                            ((x) + 0x00000060)
#define HWIO_RBCPR_PMIC_RMSK                                                      0x3
#define HWIO_RBCPR_PMIC_IN(x)      \
        in_dword_masked(HWIO_RBCPR_PMIC_ADDR(x), HWIO_RBCPR_PMIC_RMSK)
#define HWIO_RBCPR_PMIC_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_PMIC_ADDR(x), m)
#define HWIO_RBCPR_PMIC_OUT(x, v)      \
        out_dword(HWIO_RBCPR_PMIC_ADDR(x),v)
#define HWIO_RBCPR_PMIC_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBCPR_PMIC_ADDR(x),m,v,HWIO_RBCPR_PMIC_IN(x))
