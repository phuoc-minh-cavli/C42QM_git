...
static int add_tgt_sensor(struct sensor_info *sensor)
{
  ...
  if (DALSYS_Malloc(sizeof(struct sensors_mgr_sensor_info),
                    (void **)&sensor_mgr) != DAL_SUCCESS)
  {
