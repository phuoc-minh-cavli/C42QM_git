/*============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/power/sleep/src/npa_nodes/sleep_lpr.c#1 $
============================================================================*/
 ...
 * registered.
 */
static CLprRegistry *gLprRegistry = NULL;
...
int sleep_define_lpr_str(const char *name, npa_client_handle client_handle)
{
  ...
  if(name != NULL)
  {
    ...
    {
      if ( strcmp(name, SleepLPR_LookupTable[i].pName) == 0 )
      {
