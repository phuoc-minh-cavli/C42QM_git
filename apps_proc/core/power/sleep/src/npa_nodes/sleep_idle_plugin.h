...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.tx/6.0/power/sleep/src/npa_nodes/sleep_idle_plugin.h#1 $
 ...
 *
 * @brief Enumeration to indicate the state corresponding to /sleep/idle/plugin
 *        resource.
 */
typedef enum
{
