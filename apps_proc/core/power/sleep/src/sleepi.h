...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.tx/6.0/power/sleep/src/sleepi.h#1 $
 ...
 * 
 * Returns the amount of time until the next timer expiration.  Also
 * defers the timer interrupt until the next non-deferrable timer
 * expiration.  This function is called by the wakeup node when the
 * hard wakeup deadline is requested.
 * 
