...
/*=============================================================================================
                        Edit History
$Header: //components/rel/core.tx/6.0/power/dcvs/src/common/algorithms/requests.c#1 $ 
...
uint32 DCVSCoreAlgoRequestsInitialize(void* context)
{
  ...
  coreContext->algoDataContext = (DCVS_ALGO_REQUESTS*)Core_Malloc(sizeof(DCVS_ALGO_REQUESTS));
