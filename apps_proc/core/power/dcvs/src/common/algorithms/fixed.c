...
/*=======================================================================
                        Edit History
$Header: //components/rel/core.tx/6.0/power/dcvs/src/common/algorithms/fixed.c#1 $ 
...
uint32 DCVSCoreAlgoFixedInitialize(void* context)
{
  ...
  coreContext->algoDataContext = (DCVS_ALGO_FIXED*)Core_Malloc( sizeof(DCVS_ALGO_FIXED) );
