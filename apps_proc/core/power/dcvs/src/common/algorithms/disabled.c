...
/*=======================================================================
                        Edit History
$Header: //components/rel/core.tx/6.0/power/dcvs/src/common/algorithms/disabled.c#1 $ 
...
{  
  ...
  coreContext->algoDataContext = (DCVS_ALGO_DISABLED*)Core_Malloc( sizeof(DCVS_ALGO_DISABLED) );
  if( NULL == coreContext->algoDataContext ) 
  {
    /* Error fatal */
    CORE_VERIFY(NULL);   
  }
