...
============================================================================*/
/* $Header: //components/rel/core.tx/6.0/power/dcvs/inc/dcvs_target.h#1 $ */
...
typedef struct 
{
  ...
  /* This value is used to save the state of the resource before 
     the system gets into a particular sleep mode */
  uint32 stateBeforeSleep;
