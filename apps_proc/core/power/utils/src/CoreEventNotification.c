...
$Header: //components/rel/core.tx/6.0/power/utils/src/CoreEventNotification.c#1 $
============================================================================*/
                                  ...
                                  uint32 e_num)
{
   ...
   if((pe->cb_data = Core_Malloc(pool_block_size)) == NULL)
   {
      return FALSE;
   }
                                      ...
                                      uint32 num_events)
{
   ...
   if((pe->e_list = Core_Malloc(n_elem * sizeof(CBList*))) == NULL)
   {
      return NULL;
   }
