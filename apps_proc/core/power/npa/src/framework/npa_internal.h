...
$Header: //components/rel/core.tx/6.0/power/npa/src/framework/npa_internal.h#1 $
============================================================================*/
...
/* Other framework internal resource attributes (in _internal->other_attr) */
enum
{
 ...
 * Depends on the number of resources and lookups that happen... */
 ...
 Core_Object_List *event_queue ;//CoreWorkContainerHandle event_queue;    /*TODO*/

  /* Queue for async npa request processing */
  Core_Object_List *async_request_queue; //CoreWorkContainerHandle async_request_queue;     /*TODO*/
