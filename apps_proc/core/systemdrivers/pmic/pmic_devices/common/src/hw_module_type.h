...
$Header: //components/rel/core.tx/6.0/systemdrivers/pmic/pmic_devices/common/src/hw_module_type.h#1 $
$Author: pwbldsvc $
...
typedef enum
{
    ...
    PM_HW_MODULE_PON_LV_PON_GEN2_NO_XVDD_RB = 7,
...
typedef enum
{
    ...
    PM_HW_MODULE_MISC_ECM_QPOET = 22,
    PM_HW_MODULE_MISC_VBUS_DET = 25,
