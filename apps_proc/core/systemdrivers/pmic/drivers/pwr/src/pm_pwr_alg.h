...
/* =======================================================================
  ...
  $Header: //components/rel/core.tx/6.0/systemdrivers/pmic/drivers/pwr/src/pm_pwr_alg.h#1 $
...
// These fields are mapped to registers that are needed
// by power algorithms
typedef struct
{
    ...
    pm_register_address_type    STATUS4;      // STATUS 0x08
    pm_register_address_type    ECM_EN_CTL;   // STATUS 0x80
    ...
    pm_register_address_type    VOLTAGE_CTRL3; // VOLTAGE_CTL1 0x44 (CTRL)
    ...
    pm_register_address_type    STEPPER_VS_CTL; //STEPPER_VS_CTL 0x61
//New Added for 9x55
    ...
    pm_register_address_type    PMIC4_ULS_VSET_UB; // ULS_VSET_LB 0x69
    //PMIC5 offsets
    pm_register_address_type	QM_PS_EXIT ;       //QM_PS_EXIT 0x6B
	pm_register_address_type    ULS_VSET_LB;   //ULS_VSET_LB 0x39
	pm_register_address_type    PMIC5_PD_CTL;        // PD_CTL  0xA0 for PMIC5
...
typedef struct
{
    ...
    boolean                       is_periph_unified_reg;  // New added for 9x55 support 
    boolean                       pmic4_flag;
