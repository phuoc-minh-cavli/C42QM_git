...
$Header: //components/rel/core.tx/6.0/systemdrivers/pmic/drivers/clk/src/pm_clk.c#1 $
...
pm_err_flag_type pm_clk_drv_strength(uint8 pmic_chip, pm_clk_type periph, pm_clk_drv_strength_type drive_strength)
{
    ...
    if ((clk_ptr == NULL) || (periph >= PM_ALL_CLKS) || (drive_strength >= PM_CLK_DRV_STRENGTH_INVALID))
    {
