...
$Header: //components/rel/core.tx/6.0/systemdrivers/pmic/drivers/mpp/src/pm_mpp.c#1 $
...
pm_err_flag_type pm_dev_mpp_config_digital_input(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_dlogic_lvl_type  level, pm_mpp_dlogic_in_dbus_type  dbus)
{
    ...
    dig_in_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->dig_in_ctl;
...
pm_err_flag_type pm_dev_mpp_config_digital_output(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_dlogic_lvl_type  level, pm_mpp_dlogic_out_ctrl_type  output_ctrl)
{
    ...
    mode_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->mode_ctl;
...
pm_err_flag_type pm_dev_mpp_config_digital_inout(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_dlogic_lvl_type  level, pm_mpp_dlogic_inout_pup_type  pull_up)
{
    ...
    dig_pull_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->dig_pull_ctl;
...
pm_err_flag_type pm_dev_mpp_config_analog_input(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_ain_ch_type  ch_select)
{
    ...
    ana_in_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->ana_in_ctl;
    mode_ctl   = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->mode_ctl;
...
pm_err_flag_type pm_dev_mpp_config_analog_output(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_aout_level_type  level, pm_mpp_aout_switch_type  OnOff)
{
    ...
    mode_ctl    = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->mode_ctl;
    ana_out_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->ana_out_ctl;
...
pm_err_flag_type pm_dev_mpp_config_i_sink(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_i_sink_level_type  level, pm_mpp_i_sink_switch_type  OnOff)
{
    ...
    sink_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->sink_ctl;
    mode_ctl = mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index) + mpp_ptr->mpp_register->mode_ctl;
...
pm_err_flag_type pm_dev_mpp_status_get(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_status_type  *mpp_status)
{
    ...
    base_address =    mpp_ptr->mpp_register->base_address + (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*(uint8)perph_index);
    mode_ctl     =    base_address + mpp_ptr->mpp_register->mode_ctl;
    dig_pull_ctl =    base_address + mpp_ptr->mpp_register->dig_pull_ctl;
    dig_in_ctl   =    base_address + mpp_ptr->mpp_register->dig_in_ctl;
    dig_vin_ctl  =    base_address + mpp_ptr->mpp_register->dig_vin_ctl;
    sink_ctl     =    base_address + mpp_ptr->mpp_register->sink_ctl;
    ana_in_ctl   =    base_address + mpp_ptr->mpp_register->ana_in_ctl;
    ana_out_ctl  =    base_address + mpp_ptr->mpp_register->ana_out_ctl;
...
pm_err_flag_type pm_mpp_configure_type(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_drv_mpp_config_type type)
{
    ...
    mode_ctl = mpp_ptr->mpp_register->base_address +
...
pm_err_flag_type pm_mpp_enable(uint8 pmic_chip, pm_mpp_which_type perph_index, boolean enable)
{
    ...
    en_ctl = mpp_ptr->mpp_register->base_address +
                                      (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset * perph_index) +
...
pm_err_flag_type pm_mpp_config_dvin(uint8 pmic_chip, pm_mpp_which_type perph_index, pm_mpp_dlogic_lvl_type level)
{
    ...
    dig_vin_ctl = mpp_ptr->mpp_register->base_address +
                                           (pm_register_address_type)(mpp_ptr->mpp_register->peripheral_offset*perph_index) +
