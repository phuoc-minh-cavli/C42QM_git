...
/* =======================================================================
  ...
  $Header: //components/rel/core.tx/6.0/systemdrivers/pmic/comm/spmi_lite/src/spmi_1_0_lite.h#1 $
...
pm_err_flag_type  pm_spmi_lite_read_byte(uint32 uSlaveId , 
                                         uint16 addr, 
                                         uint8* data, 
                                         uint8 priority);

pm_err_flag_type  pm_spmi_lite_write_byte(uint32 uSlaveId , 
                                          uint16 addr, 
                                          uint8 data, 
                                          uint8 priority);

pm_err_flag_type  pm_spmi_lite_write_byte_mask(uint32 uSlaveId , 
                                               uint16 addr, 
                                               uint8 mask, 
                                               uint8 value, 
                                               uint8 priority);

pm_err_flag_type  pm_spmi_lite_write_byte_array(uint32 uSlaveId ,
                                                uint16 addr , 
                                                uint32 numBytes , 
                                                uint8* data, 
                                                uint8 priority) ;
