#ifndef PM_APPS_PROC_NPA_H
#define PM_APPS_PROC_NPA_H

/*! \file
 *  
 *  \brief  pm_apps_proc_npa.h ----This file contains prototype definitions processor npa layer
...
$Header: //components/rel/core.tx/6.0/systemdrivers/pmic/npa/inc/pm_apps_proc_npa.h#1 $ 
...
FUNCTION pm_apps_proc_npa_init

DESCRIPTION
    This function initializes the NPA for apps.
...
===========================================================================*/
void pm_apps_proc_npa_init(void);

void pm_apps_proc_core_vol_init(void);


#endif //PM_APPS_PROC_NPA_H
