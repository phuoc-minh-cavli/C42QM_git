...
$Header: //components/rel/core.tx/6.0/systemdrivers/hal/clk/hw/v1/HALclkStromerPLL.h#1 $
...
static boolean HAL_clk_StromerAPCSPLLConfigPLL    ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
