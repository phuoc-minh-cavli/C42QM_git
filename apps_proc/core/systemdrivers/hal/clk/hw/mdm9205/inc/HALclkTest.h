...
$Header: //components/rel/core.tx/6.0/systemdrivers/hal/clk/hw/mdm9205/inc/HALclkTest.h#1 $
 ...
 * APCS debug clocks
 */
#define HAL_CLK_APCS_TEST                                            (2 << 0x10)
 ...
 * APCS debug clocks.
 */
#define HAL_CLK_APCS_TEST_SYS_APCSQSB_CLK                             (HAL_CLK_APCS_TEST | 0x0)
#define HAL_CLK_APCS_TEST_SYS_APCSAHB_CLK                             (HAL_CLK_APCS_TEST | 0x1)
#define HAL_CLK_APCS_TEST_L2_DATARAM_CLK                              (HAL_CLK_APCS_TEST | 0x2)
#define HAL_CLK_APCS_TEST_APC0_SYSLEAF_CLK                            (HAL_CLK_APCS_TEST | 0x3)
