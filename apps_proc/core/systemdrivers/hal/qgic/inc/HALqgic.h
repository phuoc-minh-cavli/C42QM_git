...
$Header: //components/rel/core.tx/6.0/systemdrivers/hal/qgic/inc/HALqgic.h#1 $
...
void HAL_qgic_ClearInterrupts     ( void );
void HAL_qgic_MaskInterrupts      ( void );
...
Description:
   This function enables the CPU interface to clear pending interrupts to the
   current core.  It must be invoked on init before enabling QGICC.
...
Description:
   This function enables the CPU interface to disable all interrupts to the
   current core.  It must be invoked on init before enabling QGICC.
