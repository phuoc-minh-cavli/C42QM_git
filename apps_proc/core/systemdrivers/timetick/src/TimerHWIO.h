...
/*
  ...
  $Header: //components/rel/core.tx/6.0/systemdrivers/timetick/src/TimerHWIO.h#1 $
...
#define HWIO_QTMR_CNTCT_LO_ADDR(BASE)                          (BASE      + 0x00000000)
#define HWIO_QTMR_CNTCT_LO_RMSK                          0xffffffff
#define HWIO_QTMR_CNTCT_LO_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNTCT_LO_ADDR(BASE), HWIO_QTMR_CNTCT_LO_RMSK)
#define HWIO_QTMR_CNTCT_LO_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNTCT_LO_ADDR(BASE), m)
#define HWIO_QTMR_CNTCT_LO_CNTCT_LO_BMSK                0xffffffff
#define HWIO_QTMR_CNTCT_LO_CNTCT_LO_SHFT                       0x0

#define HWIO_QTMR_CNTCT_HI_ADDR(BASE)                          (BASE      + 0x00000004)
#define HWIO_QTMR_CNTCT_HI_RMSK                          0xffffffff
#define HWIO_QTMR_CNTCT_HI_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNTCT_HI_ADDR(BASE), HWIO_QTMR_CNTCT_HI_RMSK)
#define HWIO_QTMR_CNTCT_HI_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNTCT_HI_ADDR(BASE), m)
#define HWIO_QTMR_CNTCT_HI_CNTCT_HI_BMSK                0xffffffff
#define HWIO_QTMR_CNTCT_HI_CNTCT_HI_SHFT                       0x0
...
#define HWIO_QTMR_CNT_CVAL_LO_ADDR(BASE)                       (BASE      + 0x00000020)
#define HWIO_QTMR_CNT_CVAL_LO_RMSK                       0xffffffff
#define HWIO_QTMR_CNT_CVAL_LO_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNT_CVAL_LO_ADDR(BASE), HWIO_QTMR_CNT_CVAL_LO_RMSK)
#define HWIO_QTMR_CNT_CVAL_LO_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNT_CVAL_LO_ADDR(BASE), m)
#define HWIO_QTMR_CNT_CVAL_LO_OUT(BASE,v)      \
        out_dword(HWIO_QTMR_CNT_CVAL_LO_ADDR(BASE),v)
#define HWIO_QTMR_CNT_CVAL_LO_OUTM(BASE,m,v) \
        out_dword_masked_ns(HWIO_QTMR_CNT_CVAL_LO_ADDR(BASE),m,v,HWIO_QTMR_CNT_CVAL_LO_IN)
#define HWIO_QTMR_CNT_CVAL_LO_CNT_CVAL_L0_BMSK          0xffffffff
#define HWIO_QTMR_CNT_CVAL_LO_CNT_CVAL_L0_SHFT                 0x0

#define HWIO_QTMR_CNT_CVAL_HI_ADDR(BASE)                       (BASE      + 0x00000024)
#define HWIO_QTMR_CNT_CVAL_HI_RMSK                       0xffffffff
#define HWIO_QTMR_CNT_CVAL_HI_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNT_CVAL_HI_ADDR(BASE), HWIO_QTMR_CNT_CVAL_HI_RMSK)
#define HWIO_QTMR_CNT_CVAL_HI_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNT_CVAL_HI_ADDR(BASE), m)
#define HWIO_QTMR_CNT_CVAL_HI_OUT(BASE,v)      \
        out_dword(HWIO_QTMR_CNT_CVAL_HI_ADDR(BASE),v)
#define HWIO_QTMR_CNT_CVAL_HI_OUTM(BASE,m,v) \
        out_dword_masked_ns(HWIO_QTMR_CNT_CVAL_HI_ADDR(BASE),m,v,HWIO_QTMR_CNT_CVAL_HI_IN(BASE))
#define HWIO_QTMR_CNT_CVAL_HI_CNT_CVAL_HI_BMSK          0xffffffff
#define HWIO_QTMR_CNT_CVAL_HI_CNT_CVAL_HI_SHFT                 0x0

#define HWIO_QTMR_CNT_TVAL_ADDR(BASE)                          (BASE      + 0x00000028)
#define HWIO_QTMR_CNT_TVAL_RMSK                          0xffffffff
#define HWIO_QTMR_CNT_TVAL_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNT_TVAL_ADDR(BASE), HWIO_QTMR_CNT_TVAL_RMSK)
#define HWIO_QTMR_CNT_TVAL_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNT_TVAL_ADDR(BASE), m)
#define HWIO_QTMR_CNT_TVAL_OUT(BASE,v)      \
        out_dword(HWIO_QTMR_CNT_TVAL_ADDR(BASE),v)
#define HWIO_QTMR_CNT_TVAL_OUTM(BASE,m,v) \
        out_dword_masked_ns(HWIO_QTMR_CNT_TVAL_ADDR(BASE),m,v,HWIO_QTMR_CNT_TVAL_IN(BASE))
#define HWIO_QTMR_CNT_TVAL_CNT_TVAL_BMSK                0xffffffff
#define HWIO_QTMR_CNT_TVAL_CNT_TVAL_SHFT                       0x0

#define HWIO_QTMR_CNT_CTL_ADDR(BASE)                           (BASE      + 0x0000002c)
#define HWIO_QTMR_CNT_CTL_RMSK                                  0x7
#define HWIO_QTMR_CNT_CTL_IN(BASE)          \
        in_dword_masked(HWIO_QTMR_CNT_CTL_ADDR(BASE), HWIO_QTMR_CNT_CTL_RMSK)
#define HWIO_QTMR_CNT_CTL_INM(BASE,m)      \
        in_dword_masked(HWIO_QTMR_CNT_CTL_ADDR(BASE), m)
#define HWIO_QTMR_CNT_CTL_OUT(BASE,v)      \
        out_dword(HWIO_QTMR_CNT_CTL_ADDR(BASE),v)
#define HWIO_QTMR_CNT_CTL_OUTM(BASE,m,v) \
        out_dword_masked_ns(HWIO_QTMR_CNT_CTL_ADDR(BASE),m,v,HWIO_QTMR_CNT_CTL_IN(BASE))
#define HWIO_QTMR_CNT_CTL_ISTAT_BMSK                            0x4
#define HWIO_QTMR_CNT_CTL_ISTAT_SHFT                            0x2
#define HWIO_QTMR_CNT_CTL_IMSK_BMSK                             0x2
#define HWIO_QTMR_CNT_CTL_IMSK_SHFT                             0x1
#define HWIO_QTMR_CNT_CTL_EN_BMSK                               0x1
#define HWIO_QTMR_CNT_CTL_EN_SHFT                               0x0
