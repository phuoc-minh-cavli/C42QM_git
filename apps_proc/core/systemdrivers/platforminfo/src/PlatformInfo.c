...
/*
 ...
 Copyright (c) 2016 Qualcomm Technologies Incorporated.
  ...
  $Header: //components/rel/core.tx/6.0/systemdrivers/platforminfo/src/PlatformInfo.c#1 $
...
)
{
  ...
  if (pDrvCtxt->nNumKVPS > 0)
  {
    ...
    pDrvCtxt->aKVPS = (PlatformInfoKVPSType*)malloc(nSize);
    if (pDrvCtxt->aKVPS == NULL)
    {
      return DAL_ERROR;
    }
