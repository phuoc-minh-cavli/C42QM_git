...
/*
  ...
  $Header: //components/rel/core.tx/6.0/systemdrivers/clock/src/ClockDriver.h#1 $
 ...
 */
#define DALCLOCK_LOCK(drvCtxt) qurt_mutex_lock(drvCtxt->LockObj)


/**
 * Macro try-lock the driver mutex.
 */
#define DALCLOCK_TRYLOCK(drvCtxt) qurt_mutex_try_lock(drvCtxt->LockObj)


/**
 * Macro to free the driver mutex.
 */
#define DALCLOCK_FREE(drvCtxt) qurt_mutex_unlock(drvCtxt->LockObj)
...
typedef struct
{
  qurt_mutex_t*                  LockObj;            /**< Mutex Object */
...
#ifdef CLOCK_STUB_FWK_ENABLE
/* =========================================================================
**  Function : ClockStub_InitDCVS
** =========================================================================*/
/**
  Stubbed NPA nodes are created
*/

DALResult ClockStub_InitDCVS
(
  ClockDrvCtxt *pDrvCtxt
);
#endif
...
DALResult __weak Clock_LoadNV(ClockDrvCtxt *pDrvCtxt);
