...
/*
  ...
  ==================================================================== 
  $Header: //components/rel/core.tx/6.0/systemdrivers/clock/hw/mdm9205/apps/src/ClockAppsXO.c#1 $
...
)
{
  ...
  {
    ERR_FATAL(
      "Unable to create NPA client to cxo lpr",0,0,0);
