...
$Header: //components/rel/core.tx/6.0/systemdrivers/icb/src/common/icb_soc_data.h#1 $
...
typedef struct
{
  ...
  ClockIdType        *    aEnCfgClkIds;   /**< Array enable/disable config clock ids */
  icb_agg_info_type       aggInfo;        /**< Aggregation scheme */
  uint32_t                uNumPwrDomains; /**< Number of power domain */
  const char * const *    aPwrDomainNames;/**< Array of power domain names */
  ClockPowerDomainIdType* aPwrDomainIds;  /**< Array of power domains ids */
} icb_bus_def_type;
