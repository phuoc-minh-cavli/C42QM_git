...
$Header: //components/rel/core.tx/6.0/systemdrivers/icb/src/common/HALbimcImpl.c#1 $
...
)
{
    ...
    */
    ...
    int64_t uThresholdHighOffs;
    int64_t uThresholdMediumOffs;
    int64_t uThresholdLowOffs;
    ...
    uThresholdHighOffs   = pBandwidth->uThresholdHigh - pBandwidth->uBandwidth;
    uThresholdMediumOffs = pBandwidth->uThresholdMedium - pBandwidth->uBandwidth;
    uThresholdLowOffs    = pBandwidth->uThresholdLow - pBandwidth->uBandwidth;
