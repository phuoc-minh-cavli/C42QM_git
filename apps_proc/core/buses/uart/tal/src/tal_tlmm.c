...
$Header: //components/rel/core.tx/6.0/buses/uart/tal/src/tal_tlmm.c#1 $
...
TAL_RESULT tal_tlmm_open(TAL_TLMM_HANDLE *phandle, void *device_id)
{
   ...
   tlmm_ctxt = malloc(sizeof(TAL_TLMM_CONTEXT));
   if (tlmm_ctxt == NULL) { goto error; }
   ...
   tlmm_ctxt->client_id = (DALDEVICEID)device_id;
