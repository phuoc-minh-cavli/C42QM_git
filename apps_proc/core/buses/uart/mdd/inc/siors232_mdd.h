...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/buses/uart/mdd/inc/siors232_mdd.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
typedef struct sio_mdd_port_data_type
{
  ...
  qurt_mutex_t                *lock_handle;   
  void                        *dal_device_handle;
...
typedef struct              
{
  ...
  dsr_obj_t                  *dsr[UART_WORKLOOP_MAX_EVENTS];
  boolean                    line_dsr_queued;
