...
$Header: //components/rel/core.tx/6.0/buses/uart/hal/inc/HALuart.h#1 $
...
struct HALUartFcnTable
{
   ...
   uint32 (*CxmTxDirectChar)            (HALUartObject *uart, uint16 character);
   ...
   void   (*SetCxmRatIdEnable)          (HALUartObject *uart, uint32 rat_msg_type, 
                                                              uint32 enable_rat_msg_to_fifo,
                                                              uint32 enable_tcm_resend, uint32 sam,
                                                              uint32 enabled);
   uint32    (*GetCxmRatEventStatus)      (HALUartObject *uart);
};
...
==================================================================================================*/
static __inline
uint32 HALuart_CxmTxDirectChar(HALUartObject *uart, uint16 character)
{
...
static __inline
void HALuart_SetCxmRatIdEnable(HALUartObject *uart, uint32 rat_msg_type, 
                               uint32 enable_rat_msg_to_fifo, uint32 enable_tcm_resend, 
                               uint32 sam, uint32 enabled)
{
   uart->fcn_table->SetCxmRatIdEnable(uart, rat_msg_type, enable_rat_msg_to_fifo, enable_tcm_resend,
                                      sam,enabled);
}

static __inline
uint32 HALuart_GetCxmRatEventStatus(HALUartObject *uart)
{
   return uart->fcn_table->GetCxmRatEventStatus(uart);
}
/*==================================================================================================
