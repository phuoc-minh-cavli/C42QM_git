...
Copyright (c) 2007-2008,2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/buses/sio/src/common/sio_priv.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

MM/DD/YY   who     what, where, why
--------   ---     ----------------------------------------------------------
5/24/19    ss      Memory optimisation on Threadx
08/21/13   vv      Increased the  SIO_MAX_MAJOR_NUM to 27 to add new MHI driver.
...
#define SIO_MAX_MAJOR_NUM 16                /**< Maximum major numbers supported in SIO */
#define SIO_MAX_MINOR_NUM 64                /**< Maximum minor numbers supported in SIO */
