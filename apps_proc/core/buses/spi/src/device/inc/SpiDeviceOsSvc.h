...
02/29/16  dpk  Added error code for ISR un-registering API
...
#define SPI_EVENT0_MASK 0x00000001
#define SPI_EVENT1_MASK 0x00000002
...
typedef enum
{
   ...
   IBUSOS_ERROR_REGISTER_ISR,
   IBUSOS_ERROR_REGISTER_DSR,
   IBUSOS_ERROR_UNREGISTER_ISR,
   IBUSOS_ERROR_UNREGISTER_DSR,
   IBUSOS_ERROR_INT_CTRL_ATTACH,
   IBUSOS_ERROR_DAL_PROPERTY_FAILED,
   IBUSOS_ERROR_DAL_PROPERTY_CHIP_IRQ_ID_FAILED,
   IBUSOS_ERROR_DAL_PROPERTY_CHIP_IRQ_TRIG_CFG_FAILED,
   IBUSOS_ERROR_MEM_COPYS_FAILED,
   IBUSOS_ERROR_PHYS_MEM_ALLOC_FAILED,
   IBUSOS_ERROR_PHYS_MEM_INFO_FAILED,
   IBUSOS_ERROR_MEM_REGION_DEL_FAILED,
} IBUSOS_ERROR;
