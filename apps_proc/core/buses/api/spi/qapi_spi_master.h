...
$Header: //components/rel/core.tx/6.0/buses/api/spi/qapi_spi_master.h#6 $
...
#define SPI_CLIENTS_PER_DEVICE      16
...
#define QAPI_SPIM_ERROR_COPY_FAILURE            __QAPI_ERROR(QAPI_MOD_BSP_SPI_MASTER, 11)
#define QAPI_SPIM_ERROR_MEM_MAP_FAILURE         __QAPI_ERROR(QAPI_MOD_BSP_SPI_MASTER, 12)
#define QAPI_SPIM_ERROR_NO_MEM_FAILURE          __QAPI_ERROR(QAPI_MOD_BSP_SPI_MASTER, 13)
