...
Copyright (c) 2000-2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/buses/api/rdevmap/rdevmap.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
5/24/19    ss      Memory optimisation on Threadx
03/08/18   rc      Added USB_SER6 port.
12/13/17   pr      Added USBSER5 device.
03/21/17   rc      Added MDM2 device.
10/06/16   ska	   Ported for TN 
10/06/14   vv      Added DCI service and device
07/25/14   vv      Added DPL device.
10/18/13   sb      Added RMTS and SYS_M services.
...
typedef enum
{
  ...
  RDM_DATA_MUX_SRVC,
  RDM_CSVT_SRVC,             /**< -- CSVT Task                               */
  RDM_DUN_SRVC,              /**< --  DUN Task                               */
  RDM_SYSM_SRVC,
  RDM_RMTS_SRVC,             /**< -- Remote Storage service                  */
  RDM_LAST_KNOWN_SRVC = RDM_RMTS_SRVC,
  RDM_BREW_SRVC,
  RDM_BREW_EXTENDED_SRVC,    /**< -- BREW extended device service            */
  RDM_STRIDE_SRVC,           /**< -- Stride service                          */
  RDM_DIAG_DCI_SRVC,         /**< -- DIAG DCI service                        */
  
  RDM_ALT_DIAG_SRVC,         /**< -- ALT DIAG Service                        */
  RDM_ALT_DUN_SRVC,          /**< -- ALT DUN Service                         */
  RDM_RSP_SRVC,              /**< -- GDB/LLDB RSP Service                    */
...
typedef enum
{
  ...
  RDM_USB_MDM2_DEV,           /**< -- USB MDM2 device                        */
  ...
  */
  ...
  RDM_USB_AUDIO_DEV,         /**< -- RDM USB AUDIO device                   */
  RDM_USB_SER4_DEV,          /**< -- RDM USB SER4 device                     */
  RDM_USB_SER5_DEV,          /**< -- RDM USB SER5 device                     */
  RDM_USB_SER6_DEV,          /**< -- RDM USB SER6 device                     */
  ...
  RDM_USB_DCI_DEV,           /**< -- USB DCI device                          */
  RDM_USB_IPCR_DEV,          /**< -- USB IPC Router device                   */
  RDM_USB_LWIP_DEV,           /**< -- USB LWIP device                        */
  RDM_USB_DPL_DEV,           /**< -- USB DPL device                        */
