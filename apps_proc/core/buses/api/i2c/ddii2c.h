...
===========================================================================*/
/*
Copyright (c) 2008-2011,2019 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.tx/6.0/buses/api/i2c/ddii2c.h#1 $
...
typedef void (*DDIDRV_ASYNC_CB)(uint32 status,void * pArg);
