...
$Header: //components/rel/core.tx/6.0/buses/api/i2c/qapi_i2c_master.h#5 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------------- 
03/26/2020   ss     Moved API definition to respective source file.
...
#define I2C_CLIENTS_PER_DEVICE      16
...
#define QAPI_I2CM_ERROR_COPY_FAILURE               __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 44)
#define QAPI_I2CM_ERROR_MEM_MAP_FAILURE            __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 45)
#define QAPI_I2CM_ERROR_NO_MEM_FAILURE             __QAPI_ERROR(QAPI_MOD_BSP_I2C_MASTER, 45)
