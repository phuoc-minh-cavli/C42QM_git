...
$Header: //components/rel/core.tx/6.0/buses/api/i2c/I2cDevice.h#1 $

When     Who    What, where, why
-------- ---    -----------------------------------------------------------
03/04/19 SS     Added I2C client callback issue fix.
09/15/16 PR		Added I2CDEV_Ispollingmode to query I2CDriver running mode 
09/26/11 LK     Created
...
typedef void (*DEV_ASYNC_CB)(uint32 status,void * pArg);
