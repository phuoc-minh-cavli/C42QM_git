...
/*=============================================================================
  ...
  ===========================================================================*/
/* $Header: //components/rel/core.tx/6.0/buses/i2c/src/dev/I2cPlatSvc.h#1 $ */
...
typedef void (*DEV_ASYNC_CB_DISP)(uint32 status,void * pArg);
typedef void* QUPRES_HANDLE;
typedef void* I2CPLATDEV_HANDLE;

typedef void (*IST_HOOK)(dsr_obj_t *dsr_obj, void *ctxt, void *payload);
