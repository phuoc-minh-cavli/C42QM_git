...
$Header: //components/rel/core.tx/6.0/buses/i2c/src/logs/I2cUlog.c#1 $

When     Who    What, where, why
-------- ---    -----------------------------------------------------------
12/04/18 SS     Optimisation for Twizy   
09/30/16 PR     change Buffer size to 2K from 16K
...
)
{
   ...
   res = (int32)I2CSYS_Malloc((void **)&pLog , sizeof(I2CLOG_DevType));
   ...
   do {
      ...
      /* Size of I2c Log - Defaults to 1024 so that logging is enabled */
      pLog->I2cDynLogBufSize = 1024;
