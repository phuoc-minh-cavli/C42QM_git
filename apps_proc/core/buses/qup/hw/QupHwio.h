...
/*
  ...
  $Header: //components/rel/core.tx/6.0/buses/qup/hw/QupHwio.h#1 $
...
#define QUP0_REG_BASE                                                                      (BLSP1_BLSP_BASE      + 0x00035000)
#define QUP0_REG_BASE_SIZE                                                                 0x600
#define QUP0_REG_BASE_USED                                                                 0x414
#define QUP0_REG_BASE_PHYS                                                                 (BLSP1_BLSP_BASE_PHYS + 0x00035000)
#define QUP0_REG_BASE_OFFS                                                                 0x00035000
...
#define HWIO_QUP_CONFIG_POR                                                                0x00000000
#define HWIO_QUP_CONFIG_POR_RMSK                                                           0xffffffff
#define HWIO_QUP_CONFIG_ATTR                                                                      0x3
...
#define HWIO_QUP_STATE_RMSK                                                                     0x17f
#define HWIO_QUP_STATE_POR                                                                 0x0000001c
#define HWIO_QUP_STATE_POR_RMSK                                                            0xffffffff
#define HWIO_QUP_STATE_ATTR                                                                       0x3
...
#define HWIO_QUP_STATE_SPI_S_GEN_BMSK                                                           0x100
#define HWIO_QUP_STATE_SPI_S_GEN_SHFT                                                             0x8
...
#define HWIO_QUP_IO_MODES_POR                                                              0x000000a5
#define HWIO_QUP_IO_MODES_POR_RMSK                                                         0xffffffff
#define HWIO_QUP_IO_MODES_ATTR                                                                    0x3
...
#define HWIO_QUP_SW_RESET_RMSK                                                                    0x3
#define HWIO_QUP_SW_RESET_POR                                                              0x00000000
#define HWIO_QUP_SW_RESET_POR_RMSK                                                         0xffffffff
#define HWIO_QUP_SW_RESET_ATTR                                                                    0x2
#define HWIO_QUP_SW_RESET_OUT(x, v)      \
        out_dword(HWIO_QUP_SW_RESET_ADDR(x),v)
#define HWIO_QUP_SW_RESET_QUP_SW_RESET_BMSK                                                       0x3
#define HWIO_QUP_SW_RESET_QUP_SW_RESET_SHFT                                                       0x0

#define HWIO_QUP_TRANSFER_CANCEL_ADDR(x)                                                   ((x) + 0x00000014)
#define HWIO_QUP_TRANSFER_CANCEL_PHYS(x)                                                   ((x) + 0x00000014)
#define HWIO_QUP_TRANSFER_CANCEL_OFFS                                                      (0x00000014)
#define HWIO_QUP_TRANSFER_CANCEL_RMSK                                                          0xff80
#define HWIO_QUP_TRANSFER_CANCEL_POR                                                       0x00000000
#define HWIO_QUP_TRANSFER_CANCEL_POR_RMSK                                                  0xffffffff
#define HWIO_QUP_TRANSFER_CANCEL_ATTR                                                             0x3
#define HWIO_QUP_TRANSFER_CANCEL_IN(x)      \
        in_dword_masked(HWIO_QUP_TRANSFER_CANCEL_ADDR(x), HWIO_QUP_TRANSFER_CANCEL_RMSK)
#define HWIO_QUP_TRANSFER_CANCEL_INM(x, m)      \
        in_dword_masked(HWIO_QUP_TRANSFER_CANCEL_ADDR(x), m)
#define HWIO_QUP_TRANSFER_CANCEL_OUT(x, v)      \
        out_dword(HWIO_QUP_TRANSFER_CANCEL_ADDR(x),v)
#define HWIO_QUP_TRANSFER_CANCEL_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_QUP_TRANSFER_CANCEL_ADDR(x),m,v,HWIO_QUP_TRANSFER_CANCEL_IN(x))
...
#define HWIO_QUP_OPERATIONAL_POR                                                           0x000000c0
#define HWIO_QUP_OPERATIONAL_POR_RMSK                                                      0xffffffff
#define HWIO_QUP_OPERATIONAL_ATTR                                                                 0x3
...
#define HWIO_QUP_ERROR_FLAGS_POR                                                           0x00000000
#define HWIO_QUP_ERROR_FLAGS_POR_RMSK                                                      0xffffffff
#define HWIO_QUP_ERROR_FLAGS_ATTR                                                                 0x3
...
#define HWIO_QUP_ERROR_FLAGS_EN_POR                                                        0x0000003c
#define HWIO_QUP_ERROR_FLAGS_EN_POR_RMSK                                                   0xffffffff
#define HWIO_QUP_ERROR_FLAGS_EN_ATTR                                                              0x3
...
#define HWIO_QUP_TEST_CTRL_POR                                                             0x00000000
#define HWIO_QUP_TEST_CTRL_POR_RMSK                                                        0xffffffff
#define HWIO_QUP_TEST_CTRL_ATTR                                                                   0x3
...
#define HWIO_QUP_OPERATIONAL_MASK_POR                                                      0x00000000
#define HWIO_QUP_OPERATIONAL_MASK_POR_RMSK                                                 0xffffffff
#define HWIO_QUP_OPERATIONAL_MASK_ATTR                                                            0x3
...
#define HWIO_QUP_HW_VERSION_POR                                                            0x20070000
#define HWIO_QUP_HW_VERSION_POR_RMSK                                                       0xffffffff
#define HWIO_QUP_HW_VERSION_ATTR                                                                  0x1
...
#define HWIO_QUP_MX_OUTPUT_COUNT_POR                                                       0x00000000
#define HWIO_QUP_MX_OUTPUT_COUNT_POR_RMSK                                                  0xffffffff
#define HWIO_QUP_MX_OUTPUT_COUNT_ATTR                                                             0x3
...
#define HWIO_QUP_MX_OUTPUT_CNT_CURRENT_POR                                                 0x00000000
#define HWIO_QUP_MX_OUTPUT_CNT_CURRENT_POR_RMSK                                            0xffffffff
#define HWIO_QUP_MX_OUTPUT_CNT_CURRENT_ATTR                                                       0x1
...
#define HWIO_QUP_OUTPUT_DEBUG_POR                                                          0x00000000
#define HWIO_QUP_OUTPUT_DEBUG_POR_RMSK                                                     0x00000000
#define HWIO_QUP_OUTPUT_DEBUG_ATTR                                                                0x1
...
#define HWIO_QUP_OUTPUT_FIFO_WORD_CNT_POR                                                  0x00000000
#define HWIO_QUP_OUTPUT_FIFO_WORD_CNT_POR_RMSK                                             0xffffffff
#define HWIO_QUP_OUTPUT_FIFO_WORD_CNT_ATTR                                                        0x1
...
#define HWIO_QUP_OUTPUT_FIFOc_POR                                                          0x00000000
#define HWIO_QUP_OUTPUT_FIFOc_POR_RMSK                                                     0xffffffff
#define HWIO_QUP_OUTPUT_FIFOc_ATTR                                                                0x2
...
#define HWIO_QUP_MX_WRITE_COUNT_POR                                                        0x00000000
#define HWIO_QUP_MX_WRITE_COUNT_POR_RMSK                                                   0xffffffff
#define HWIO_QUP_MX_WRITE_COUNT_ATTR                                                              0x3
...
#define HWIO_QUP_MX_WRITE_CNT_CURRENT_POR                                                  0x00000000
#define HWIO_QUP_MX_WRITE_CNT_CURRENT_POR_RMSK                                             0xffffffff
#define HWIO_QUP_MX_WRITE_CNT_CURRENT_ATTR                                                        0x1
...
#define HWIO_QUP_MX_INPUT_COUNT_POR                                                        0x00000000
#define HWIO_QUP_MX_INPUT_COUNT_POR_RMSK                                                   0xffffffff
#define HWIO_QUP_MX_INPUT_COUNT_ATTR                                                              0x3
...
#define HWIO_QUP_MX_INPUT_CNT_CURRENT_POR                                                  0x00000000
#define HWIO_QUP_MX_INPUT_CNT_CURRENT_POR_RMSK                                             0xffffffff
#define HWIO_QUP_MX_INPUT_CNT_CURRENT_ATTR                                                        0x1
...
#define HWIO_QUP_MX_READ_COUNT_POR                                                         0x00000000
#define HWIO_QUP_MX_READ_COUNT_POR_RMSK                                                    0xffffffff
#define HWIO_QUP_MX_READ_COUNT_ATTR                                                               0x3
...
#define HWIO_QUP_MX_READ_CNT_CURRENT_POR                                                   0x00000000
#define HWIO_QUP_MX_READ_CNT_CURRENT_POR_RMSK                                              0xffffffff
#define HWIO_QUP_MX_READ_CNT_CURRENT_ATTR                                                         0x1
...
#define HWIO_QUP_INPUT_DEBUG_POR                                                           0x00000000
#define HWIO_QUP_INPUT_DEBUG_POR_RMSK                                                      0xffffffff
#define HWIO_QUP_INPUT_DEBUG_ATTR                                                                 0x1
...
#define HWIO_QUP_INPUT_FIFO_WORD_CNT_POR                                                   0x00000000
#define HWIO_QUP_INPUT_FIFO_WORD_CNT_POR_RMSK                                              0xffffffff
#define HWIO_QUP_INPUT_FIFO_WORD_CNT_ATTR                                                         0x1
...
#define HWIO_QUP_INPUT_FIFOc_POR                                                           0x00000000
#define HWIO_QUP_INPUT_FIFOc_POR_RMSK                                                      0x00000000
#define HWIO_QUP_INPUT_FIFOc_ATTR                                                                 0x1
...
#define HWIO_SPI_CONFIG_POR                                                                0x00000000
#define HWIO_SPI_CONFIG_POR_RMSK                                                           0xffffffff
#define HWIO_SPI_CONFIG_ATTR                                                                      0x3
...
#define HWIO_SPI_IO_CONTROL_POR                                                            0x00000000
#define HWIO_SPI_IO_CONTROL_POR_RMSK                                                       0xffffffff
#define HWIO_SPI_IO_CONTROL_ATTR                                                                  0x3
...
#define HWIO_SPI_ERROR_FLAGS_POR                                                           0x00000000
#define HWIO_SPI_ERROR_FLAGS_POR_RMSK                                                      0xffffffff
#define HWIO_SPI_ERROR_FLAGS_ATTR                                                                 0x3
...
#define HWIO_SPI_ERROR_FLAGS_EN_POR                                                        0x0000000c
#define HWIO_SPI_ERROR_FLAGS_EN_POR_RMSK                                                   0xffffffff
#define HWIO_SPI_ERROR_FLAGS_EN_ATTR                                                              0x3
...
#define HWIO_SPI_DEASSERT_WAIT_POR                                                         0x00000000
#define HWIO_SPI_DEASSERT_WAIT_POR_RMSK                                                    0xffffffff
#define HWIO_SPI_DEASSERT_WAIT_ATTR                                                               0x3
...
#define HWIO_SPI_MASTER_LOCAL_ID_ADDR(x)                                                   ((x) + 0x00000314)
#define HWIO_SPI_MASTER_LOCAL_ID_PHYS(x)                                                   ((x) + 0x00000314)
#define HWIO_SPI_MASTER_LOCAL_ID_OFFS                                                      (0x00000314)
#define HWIO_SPI_MASTER_LOCAL_ID_RMSK                                                          0xffff
#define HWIO_SPI_MASTER_LOCAL_ID_POR                                                       0x00000000
#define HWIO_SPI_MASTER_LOCAL_ID_POR_RMSK                                                  0xffffffff
#define HWIO_SPI_MASTER_LOCAL_ID_ATTR                                                             0x3
#define HWIO_SPI_MASTER_LOCAL_ID_IN(x)      \
        in_dword_masked(HWIO_SPI_MASTER_LOCAL_ID_ADDR(x), HWIO_SPI_MASTER_LOCAL_ID_RMSK)
#define HWIO_SPI_MASTER_LOCAL_ID_INM(x, m)      \
        in_dword_masked(HWIO_SPI_MASTER_LOCAL_ID_ADDR(x), m)
#define HWIO_SPI_MASTER_LOCAL_ID_OUT(x, v)      \
        out_dword(HWIO_SPI_MASTER_LOCAL_ID_ADDR(x),v)
#define HWIO_SPI_MASTER_LOCAL_ID_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_SPI_MASTER_LOCAL_ID_ADDR(x),m,v,HWIO_SPI_MASTER_LOCAL_ID_IN(x))
#define HWIO_SPI_MASTER_LOCAL_ID_EXTENDED_ID_BMSK                                              0xff00
#define HWIO_SPI_MASTER_LOCAL_ID_EXTENDED_ID_SHFT                                                 0x8
#define HWIO_SPI_MASTER_LOCAL_ID_LOCAL_ID_BMSK                                                   0xff
#define HWIO_SPI_MASTER_LOCAL_ID_LOCAL_ID_SHFT                                                    0x0

#define HWIO_SPI_MASTER_COMMAND_ADDR(x)                                                    ((x) + 0x00000318)
#define HWIO_SPI_MASTER_COMMAND_PHYS(x)                                                    ((x) + 0x00000318)
#define HWIO_SPI_MASTER_COMMAND_OFFS                                                       (0x00000318)
#define HWIO_SPI_MASTER_COMMAND_RMSK                                                              0x1
#define HWIO_SPI_MASTER_COMMAND_POR                                                        0x00000000
#define HWIO_SPI_MASTER_COMMAND_POR_RMSK                                                   0xffffffff
#define HWIO_SPI_MASTER_COMMAND_ATTR                                                              0x2
#define HWIO_SPI_MASTER_COMMAND_OUT(x, v)      \
        out_dword(HWIO_SPI_MASTER_COMMAND_ADDR(x),v)
#define HWIO_SPI_MASTER_COMMAND_RESET_CANCEL_FSM_BMSK                                             0x1
#define HWIO_SPI_MASTER_COMMAND_RESET_CANCEL_FSM_SHFT                                             0x0

#define HWIO_SPI_MASTER_STATUS_ADDR(x)                                                     ((x) + 0x0000031c)
#define HWIO_SPI_MASTER_STATUS_PHYS(x)                                                     ((x) + 0x0000031c)
#define HWIO_SPI_MASTER_STATUS_OFFS                                                        (0x0000031c)
#define HWIO_SPI_MASTER_STATUS_RMSK                                                               0x7
#define HWIO_SPI_MASTER_STATUS_POR                                                         0x00000000
#define HWIO_SPI_MASTER_STATUS_POR_RMSK                                                    0xffffffff
#define HWIO_SPI_MASTER_STATUS_ATTR                                                               0x1
#define HWIO_SPI_MASTER_STATUS_IN(x)      \
        in_dword_masked(HWIO_SPI_MASTER_STATUS_ADDR(x), HWIO_SPI_MASTER_STATUS_RMSK)
#define HWIO_SPI_MASTER_STATUS_INM(x, m)      \
        in_dword_masked(HWIO_SPI_MASTER_STATUS_ADDR(x), m)
#define HWIO_SPI_MASTER_STATUS_CANCEL_FSM_STATE_BMSK                                              0x7
#define HWIO_SPI_MASTER_STATUS_CANCEL_FSM_STATE_SHFT                                              0x0
...
#define HWIO_SPI_CHAR_CFG_RMSK                                                                  0x1f1
#define HWIO_SPI_CHAR_CFG_POR                                                              0x00000000
#define HWIO_SPI_CHAR_CFG_POR_RMSK                                                         0xffffffff
#define HWIO_SPI_CHAR_CFG_ATTR                                                                    0x3
...
#define HWIO_SPI_CHAR_CFG_CHAR_STATUS_BMSK                                                      0x1e0
#define HWIO_SPI_CHAR_CFG_CHAR_STATUS_SHFT                                                        0x5
...
#define HWIO_SPI_CHAR_DATA_SPI_CS_POR                                                      0x00000000
#define HWIO_SPI_CHAR_DATA_SPI_CS_POR_RMSK                                                 0xffffffff
#define HWIO_SPI_CHAR_DATA_SPI_CS_ATTR                                                            0x3
...
#define HWIO_SPI_CHAR_DATA_SPI_MOSI_POR                                                    0x00000000
#define HWIO_SPI_CHAR_DATA_SPI_MOSI_POR_RMSK                                               0xffffffff
#define HWIO_SPI_CHAR_DATA_SPI_MOSI_ATTR                                                          0x3
...
#define HWIO_SPI_CHAR_DATA_SPI_MISO_POR                                                    0x00000000
#define HWIO_SPI_CHAR_DATA_SPI_MISO_POR_RMSK                                               0xffffffff
#define HWIO_SPI_CHAR_DATA_SPI_MISO_ATTR                                                          0x3
...
#define HWIO_SPI_SLAVE_IRQ_STATUS_ADDR(x)                                                  ((x) + 0x00000330)
#define HWIO_SPI_SLAVE_IRQ_STATUS_PHYS(x)                                                  ((x) + 0x00000330)
#define HWIO_SPI_SLAVE_IRQ_STATUS_OFFS                                                     (0x00000330)
#define HWIO_SPI_SLAVE_IRQ_STATUS_RMSK                                                           0x7f
#define HWIO_SPI_SLAVE_IRQ_STATUS_POR                                                      0x00000000
#define HWIO_SPI_SLAVE_IRQ_STATUS_POR_RMSK                                                 0xffffffff
#define HWIO_SPI_SLAVE_IRQ_STATUS_ATTR                                                            0x1
#define HWIO_SPI_SLAVE_IRQ_STATUS_IN(x)      \
        in_dword_masked(HWIO_SPI_SLAVE_IRQ_STATUS_ADDR(x), HWIO_SPI_SLAVE_IRQ_STATUS_RMSK)
#define HWIO_SPI_SLAVE_IRQ_STATUS_INM(x, m)      \
        in_dword_masked(HWIO_SPI_SLAVE_IRQ_STATUS_ADDR(x), m)
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ERXT_BMSK                                                 0x40
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ERXT_SHFT                                                  0x6
#define HWIO_SPI_SLAVE_IRQ_STATUS_RX_OVERFLOW_NO_EOT_BMSK                                        0x20
#define HWIO_SPI_SLAVE_IRQ_STATUS_RX_OVERFLOW_NO_EOT_SHFT                                         0x5
#define HWIO_SPI_SLAVE_IRQ_STATUS_RX_OVERFLOW_WAIT_EOT_BMSK                                      0x10
#define HWIO_SPI_SLAVE_IRQ_STATUS_RX_OVERFLOW_WAIT_EOT_SHFT                                       0x4
#define HWIO_SPI_SLAVE_IRQ_STATUS_TX_UNDERFLOW_BMSK                                               0x8
#define HWIO_SPI_SLAVE_IRQ_STATUS_TX_UNDERFLOW_SHFT                                               0x3
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ETXT_BMSK                                                  0x4
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ETXT_SHFT                                                  0x2
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_DEASSERT_BMSK                                              0x2
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_DEASSERT_SHFT                                              0x1
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ASSERT_BMSK                                                0x1
#define HWIO_SPI_SLAVE_IRQ_STATUS_CS_N_ASSERT_SHFT                                                0x0

#define HWIO_SPI_SLAVE_IRQ_EN_ADDR(x)                                                      ((x) + 0x00000334)
#define HWIO_SPI_SLAVE_IRQ_EN_PHYS(x)                                                      ((x) + 0x00000334)
#define HWIO_SPI_SLAVE_IRQ_EN_OFFS                                                         (0x00000334)
#define HWIO_SPI_SLAVE_IRQ_EN_RMSK                                                               0x7f
#define HWIO_SPI_SLAVE_IRQ_EN_POR                                                          0x00000000
#define HWIO_SPI_SLAVE_IRQ_EN_POR_RMSK                                                     0xffffffff
#define HWIO_SPI_SLAVE_IRQ_EN_ATTR                                                                0x1
#define HWIO_SPI_SLAVE_IRQ_EN_IN(x)      \
        in_dword_masked(HWIO_SPI_SLAVE_IRQ_EN_ADDR(x), HWIO_SPI_SLAVE_IRQ_EN_RMSK)
#define HWIO_SPI_SLAVE_IRQ_EN_INM(x, m)      \
        in_dword_masked(HWIO_SPI_SLAVE_IRQ_EN_ADDR(x), m)
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ERXT_EN_BMSK                                                  0x40
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ERXT_EN_SHFT                                                   0x6
#define HWIO_SPI_SLAVE_IRQ_EN_RX_OVERFLOW_NO_EOT_EN_BMSK                                         0x20
#define HWIO_SPI_SLAVE_IRQ_EN_RX_OVERFLOW_NO_EOT_EN_SHFT                                          0x5
#define HWIO_SPI_SLAVE_IRQ_EN_RX_OVERFLOW_WAIT_EOT_EN_BMSK                                       0x10
#define HWIO_SPI_SLAVE_IRQ_EN_RX_OVERFLOW_WAIT_EOT_EN_SHFT                                        0x4
#define HWIO_SPI_SLAVE_IRQ_EN_TX_UNDERFLOW_EN_BMSK                                                0x8
#define HWIO_SPI_SLAVE_IRQ_EN_TX_UNDERFLOW_EN_SHFT                                                0x3
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ETXT_EN_BMSK                                                   0x4
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ETXT_EN_SHFT                                                   0x2
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_DEASSERT_EN_BMSK                                               0x2
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_DEASSERT_EN_SHFT                                               0x1
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ASSERT_EN_BMSK                                                 0x1
#define HWIO_SPI_SLAVE_IRQ_EN_CS_N_ASSERT_EN_SHFT                                                 0x0

#define HWIO_SPI_SLAVE_CFG_ADDR(x)                                                         ((x) + 0x00000338)
#define HWIO_SPI_SLAVE_CFG_PHYS(x)                                                         ((x) + 0x00000338)
#define HWIO_SPI_SLAVE_CFG_OFFS                                                            (0x00000338)
#define HWIO_SPI_SLAVE_CFG_RMSK                                                            0xffffffff
#define HWIO_SPI_SLAVE_CFG_POR                                                             0x00000000
#define HWIO_SPI_SLAVE_CFG_POR_RMSK                                                        0xffffffff
#define HWIO_SPI_SLAVE_CFG_ATTR                                                                   0x1
#define HWIO_SPI_SLAVE_CFG_IN(x)      \
        in_dword_masked(HWIO_SPI_SLAVE_CFG_ADDR(x), HWIO_SPI_SLAVE_CFG_RMSK)
#define HWIO_SPI_SLAVE_CFG_INM(x, m)      \
        in_dword_masked(HWIO_SPI_SLAVE_CFG_ADDR(x), m)
#define HWIO_SPI_SLAVE_CFG_NOT_INUSE_BMSK                                                  0xffffff00
#define HWIO_SPI_SLAVE_CFG_NOT_INUSE_SHFT                                                         0x8
#define HWIO_SPI_SLAVE_CFG_SLAVE_AUTO_PAUSE_EOT_BMSK                                             0x80
#define HWIO_SPI_SLAVE_CFG_SLAVE_AUTO_PAUSE_EOT_SHFT                                              0x7
#define HWIO_SPI_SLAVE_CFG_SLAVE_TEST_BUS_CFG_BMSK                                               0x60
#define HWIO_SPI_SLAVE_CFG_SLAVE_TEST_BUS_CFG_SHFT                                                0x5
#define HWIO_SPI_SLAVE_CFG_SLAVE_DIS_RESET_ST_BMSK                                               0x10
#define HWIO_SPI_SLAVE_CFG_SLAVE_DIS_RESET_ST_SHFT                                                0x4
#define HWIO_SPI_SLAVE_CFG_RX_UNBALANCED_MASK_BMSK                                                0x8
#define HWIO_SPI_SLAVE_CFG_RX_UNBALANCED_MASK_SHFT                                                0x3
#define HWIO_SPI_SLAVE_CFG_SPI_S_CGC_EN_BMSK                                                      0x4
#define HWIO_SPI_SLAVE_CFG_SPI_S_CGC_EN_SHFT                                                      0x2
#define HWIO_SPI_SLAVE_CFG_PAUSE_ON_ERR_DIS_BMSK                                                  0x2
#define HWIO_SPI_SLAVE_CFG_PAUSE_ON_ERR_DIS_SHFT                                                  0x1
#define HWIO_SPI_SLAVE_CFG_RX_N_SHIFT_BMSK                                                        0x1
#define HWIO_SPI_SLAVE_CFG_RX_N_SHIFT_SHFT                                                        0x0

#define HWIO_SPI_SLAVE_DEBUG_ADDR(x)                                                       ((x) + 0x0000033c)
#define HWIO_SPI_SLAVE_DEBUG_PHYS(x)                                                       ((x) + 0x0000033c)
#define HWIO_SPI_SLAVE_DEBUG_OFFS                                                          (0x0000033c)
#define HWIO_SPI_SLAVE_DEBUG_RMSK                                                          0xffffffff
#define HWIO_SPI_SLAVE_DEBUG_POR                                                           0x00000000
#define HWIO_SPI_SLAVE_DEBUG_POR_RMSK                                                      0xffffffff
#define HWIO_SPI_SLAVE_DEBUG_ATTR                                                                 0x1
#define HWIO_SPI_SLAVE_DEBUG_IN(x)      \
        in_dword_masked(HWIO_SPI_SLAVE_DEBUG_ADDR(x), HWIO_SPI_SLAVE_DEBUG_RMSK)
#define HWIO_SPI_SLAVE_DEBUG_INM(x, m)      \
        in_dword_masked(HWIO_SPI_SLAVE_DEBUG_ADDR(x), m)
#define HWIO_SPI_SLAVE_DEBUG_NOT_INUSE_BMSK                                                0xff000000
#define HWIO_SPI_SLAVE_DEBUG_NOT_INUSE_SHFT                                                      0x18
#define HWIO_SPI_SLAVE_DEBUG_SPI_S_SM_CS_BMSK                                                0xc00000
#define HWIO_SPI_SLAVE_DEBUG_SPI_S_SM_CS_SHFT                                                    0x16
#define HWIO_SPI_SLAVE_DEBUG_CS_N_STATUS_BMSK                                                0x200000
#define HWIO_SPI_SLAVE_DEBUG_CS_N_STATUS_SHFT                                                    0x15
#define HWIO_SPI_SLAVE_DEBUG_SPI_IN_CLK_CNT_BMSK                                             0x1fffff
#define HWIO_SPI_SLAVE_DEBUG_SPI_IN_CLK_CNT_SHFT                                                  0x0
...
#define HWIO_I2C_MASTER_CLK_CTL_POR                                                        0x00000000
#define HWIO_I2C_MASTER_CLK_CTL_POR_RMSK                                                   0xffffffff
#define HWIO_I2C_MASTER_CLK_CTL_ATTR                                                              0x3
...
#define HWIO_I2C_MASTER_STATUS_RMSK                                                        0x7fffffff
#define HWIO_I2C_MASTER_STATUS_POR                                                         0x0c000000
#define HWIO_I2C_MASTER_STATUS_POR_RMSK                                                    0xffffffff
#define HWIO_I2C_MASTER_STATUS_ATTR                                                               0x3
...
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_BMSK                                       0x70000000
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_SHFT                                             0x1c
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_IDLE_STATE_FVAL                                   0x0
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_CANCEL_PENDING_STATE_FVAL                         0x1
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_PAUSE_STATE_FVAL                                  0x2
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_PAUSE_WAIT_STATE_FVAL                             0x3
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_SEND_STOP_STATE_FVAL                              0x4
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_FLUSH_STATE_FVAL                                  0x5
#define HWIO_I2C_MASTER_STATUS_CANCEL_FSM_STATE_SEND_IRQ_STATE_FVAL                               0x6
...
#define HWIO_I2C_MASTER_STATUS_TRANSFER_CANCEL_DONE_BMSK                                          0x2
#define HWIO_I2C_MASTER_STATUS_TRANSFER_CANCEL_DONE_SHFT                                          0x1
#define HWIO_I2C_MASTER_STATUS_TRANSFER_CANCEL_ID_MATCH_BMSK                                      0x1
#define HWIO_I2C_MASTER_STATUS_TRANSFER_CANCEL_ID_MATCH_SHFT                                      0x0
...
#define HWIO_I2C_MASTER_CONFIG_RMSK                                                               0xf
#define HWIO_I2C_MASTER_CONFIG_POR                                                         0x00000000
#define HWIO_I2C_MASTER_CONFIG_POR_RMSK                                                    0xffffffff
#define HWIO_I2C_MASTER_CONFIG_ATTR                                                               0x3
...
#define HWIO_I2C_MASTER_CONFIG_BUSY_INDICATION_SELECT_BMSK                                        0x8
#define HWIO_I2C_MASTER_CONFIG_BUSY_INDICATION_SELECT_SHFT                                        0x3
#define HWIO_I2C_MASTER_CONFIG_SDA_DELAYED_DETECTION_BMSK                                         0x4
#define HWIO_I2C_MASTER_CONFIG_SDA_DELAYED_DETECTION_SHFT                                         0x2
#define HWIO_I2C_MASTER_CONFIG_LOW_PERIOD_NOISE_REJECT_EN_BMSK                                    0x2
#define HWIO_I2C_MASTER_CONFIG_LOW_PERIOD_NOISE_REJECT_EN_SHFT                                    0x1
...
#define HWIO_I2C_MASTER_BUS_CLEAR_POR                                                      0x00000000
#define HWIO_I2C_MASTER_BUS_CLEAR_POR_RMSK                                                 0xffffffff
#define HWIO_I2C_MASTER_BUS_CLEAR_ATTR                                                            0x3
#define HWIO_I2C_MASTER_BUS_CLEAR_IN(x)      \
        in_dword_masked(HWIO_I2C_MASTER_BUS_CLEAR_ADDR(x), HWIO_I2C_MASTER_BUS_CLEAR_RMSK)
#define HWIO_I2C_MASTER_BUS_CLEAR_INM(x, m)      \
        in_dword_masked(HWIO_I2C_MASTER_BUS_CLEAR_ADDR(x), m)
#define HWIO_I2C_MASTER_BUS_CLEAR_OUT(x, v)      \
        out_dword(HWIO_I2C_MASTER_BUS_CLEAR_ADDR(x),v)
#define HWIO_I2C_MASTER_BUS_CLEAR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_I2C_MASTER_BUS_CLEAR_ADDR(x),m,v,HWIO_I2C_MASTER_BUS_CLEAR_IN(x))
...
#define HWIO_I2C_MASTER_LOCAL_ID_POR                                                       0x00000000
#define HWIO_I2C_MASTER_LOCAL_ID_POR_RMSK                                                  0xffffffff
#define HWIO_I2C_MASTER_LOCAL_ID_ATTR                                                             0x1
...
#define HWIO_I2C_MASTER_COMMAND_ADDR(x)                                                    ((x) + 0x00000414)
#define HWIO_I2C_MASTER_COMMAND_PHYS(x)                                                    ((x) + 0x00000414)
#define HWIO_I2C_MASTER_COMMAND_OFFS                                                       (0x00000414)
#define HWIO_I2C_MASTER_COMMAND_RMSK                                                              0x1
#define HWIO_I2C_MASTER_COMMAND_POR                                                        0x00000000
#define HWIO_I2C_MASTER_COMMAND_POR_RMSK                                                   0xffffffff
#define HWIO_I2C_MASTER_COMMAND_ATTR                                                              0x3
#define HWIO_I2C_MASTER_COMMAND_IN(x)      \
        in_dword_masked(HWIO_I2C_MASTER_COMMAND_ADDR(x), HWIO_I2C_MASTER_COMMAND_RMSK)
#define HWIO_I2C_MASTER_COMMAND_INM(x, m)      \
        in_dword_masked(HWIO_I2C_MASTER_COMMAND_ADDR(x), m)
#define HWIO_I2C_MASTER_COMMAND_OUT(x, v)      \
        out_dword(HWIO_I2C_MASTER_COMMAND_ADDR(x),v)
#define HWIO_I2C_MASTER_COMMAND_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_I2C_MASTER_COMMAND_ADDR(x),m,v,HWIO_I2C_MASTER_COMMAND_IN(x))
#define HWIO_I2C_MASTER_COMMAND_RESET_CANCEL_FSM_BMSK                                             0x1
#define HWIO_I2C_MASTER_COMMAND_RESET_CANCEL_FSM_SHFT                                             0x0
