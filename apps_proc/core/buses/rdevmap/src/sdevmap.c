...
Copyright (c) 1999, 2000-09 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/buses/rdevmap/src/sdevmap.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/29/09   amv     Moved sdevmap public headers to RDM
07/17/09   amv     remove ds3gsiolib.h inclusion for CMI#2
...
#if 0     // REMOVING FOR 9x25 APPS BRINGUP
