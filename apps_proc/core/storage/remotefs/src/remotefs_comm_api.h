...
Copyright (c) 2009-2011,2014 by Qualcomm Technologies Incorporated.
All Rights Reserved.
...
/*=======================================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/remotefs/src/remotefs_comm_api.h#1 $ 
...
typedef enum
{
   ...
   RMFS_RX_TIMEOUT,              /**< Error - Receive timedout           */
   RMFS_FLUSH_TIMEOUT,           /**< Error - Flush timedout             */
   RMFS_ERROR_NO_MEM,            /**< Error - Ran out of Memory          */
   RMFS_ERROR_MAX_CLIENTS,       /**< Error - Max clients allocated      */
   RMFS_ERROR_PROTOCOL,          /**< Error - Protocol Error             */
   RMFS_ERROR_OP_NOT_SUPPORTED,  /**< Error - OPeration not supported    */
   RMFS_ERROR_NAMETOOLONG,       /**< Error - Input path too long        */
   RMFS_ERROR_BAD_STATE,         /**< Error - Server in unrecoverable state */
