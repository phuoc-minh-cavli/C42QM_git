...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_rmts_guid.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
/* GPT GUID type for standalone modem OEM -1partition.
 * {4CDC71DE-9F4B-4A66-BD5E-1CD2CEF71721} */
const struct fs_guid_type fs_rmts_oem_1_guid =
{0x4CDC71DE, 0x9F4B, 0x4A66, {0xBD, 0x5E, 0x1C, 0xD2, 0xCE, 0xF7, 0x17, 0x21}};

/* GPT GUID type for standalone modem OEM-2 partition.
 * {9FC1482D-D780-4677-8CA4-CC7F5BC10065} */
const struct fs_guid_type fs_rmts_oem_2_guid =
{0x9FC1482D, 0xD780, 0x4677, {0x8C, 0xA4, 0xCC, 0x7F, 0x5B, 0xC1, 0x00, 0x65}};
...
/* GPT GUID type for Fusion OEM-1 partition.
 * {697945C4-1097-4F3F-B0A3-A74D9B37AB13} */
const struct fs_guid_type fs_rmts_oem_1_fusion_guid =
{0x697945C4, 0x1097, 0x4F3F, {0xB0, 0xA3, 0xA7, 0x4D, 0x9B, 0x37, 0xAB, 0x13}};

/* GPT GUID type for Fusion OEM-2 partition.
 * {3AED2CBC-834D-4DD7-87E1-832B8DB26E8F} */
const struct fs_guid_type fs_rmts_oem_2_fusion_guid =
{0x3AED2CBC, 0x834D, 0x4DD7, {0x87, 0xE1, 0x83, 0x2B, 0x8D, 0xB2, 0x6E, 0x8F}};
       ...
       fs_rmts_guid_map[FS_RMTS_MODEM_TYPE_MAX][FS_RMTS_PARTITION_ID_MAX] =
{
  { /* Standalone GUID List */
    ...
    },
    {
      ...
      &fs_rmts_oem_1_guid,
      FS_RMTS_MBR_PARTITION_ID_OEM_1_STANDLONE,
    },
    {
      FS_RMTS_MODEM_TYPE_STANDALONE,
      FS_RMTS_PARTITION_ID_OEM_2,
      &fs_rmts_oem_2_guid,
      FS_RMTS_MBR_PARTITION_ID_OEM_2_STANDLONE,
    },
  },
  ...
  { /* Fusion GUID List */
    ...
    },
    {
      FS_RMTS_MODEM_TYPE_FUSION,
      FS_RMTS_PARTITION_ID_OEM_1,
      &fs_rmts_oem_1_fusion_guid,
      FS_RMTS_MBR_PARTITION_ID_OEM_1_FUSION,
    },
    {
      FS_RMTS_MODEM_TYPE_FUSION,
      FS_RMTS_PARTITION_ID_OEM_2,
      &fs_rmts_oem_2_fusion_guid,
      FS_RMTS_MBR_PARTITION_ID_OEM_2_FUSION,
    },
  }
};
