...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_rmts_image_header.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
                             ...
                             uint32 image_size)
{
  ...
  image_header->meta_hdr.shutdown_sync_count = 0;
                                          ...
                                          uint8 is_shutdown_sync)
{
  ...
  img_hdr->boot_hdr.image_size = image_size;
  img_hdr->boot_hdr.code_size = image_size;
  ...
  if (is_shutdown_sync == 1)
    ++img_hdr->meta_hdr.shutdown_sync_count;
}
