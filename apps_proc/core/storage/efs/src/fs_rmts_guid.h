...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_rmts_guid.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
#define FS_RMTS_MBR_PARTITION_ID_OEM_1_STANDLONE   0x5F
#define FS_RMTS_MBR_PARTITION_ID_OEM_2_STANDLONE   0x60
...
#define FS_RMTS_MBR_PARTITION_ID_OEM_1_FUSION      0x61
#define FS_RMTS_MBR_PARTITION_ID_OEM_2_FUSION      0x62
...
extern const struct fs_guid_type fs_rmts_oem_1_guid;
extern const struct fs_guid_type fs_rmts_oem_2_guid;
...
extern const struct fs_guid_type fs_rmts_oem_1_fusion_guid;
extern const struct fs_guid_type fs_rmts_oem_2_fusion_guid;
