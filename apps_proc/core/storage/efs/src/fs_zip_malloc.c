...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_zip_malloc.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
uint32
fs_zip_malloc_get_allocated_heap (fs_zip_malloc_handle malloc_handle)
{
  ASSERT (malloc_handle != NULL);
  ASSERT (malloc_handle->in_use == 1);
  return malloc_handle->total_allocated;
}
