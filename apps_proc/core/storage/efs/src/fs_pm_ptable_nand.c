 ...
 * fs_pm_ptable_nand.c
 *
 * Copyright (C) 2002-2013,2016 QUALCOMM Technologies, Inc.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_pm_ptable_nand.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2016-04-06    rp      Fix compiler errors seen in target builds.
