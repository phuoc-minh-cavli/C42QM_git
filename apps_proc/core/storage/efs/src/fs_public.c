 ...
 * Copyright (C) 2002-2016, 2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_public.c#2 $ $DateTime: 2020/02/25 23:38:09 $ $Author: pwbldsvc $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2019-09-23    eo      fix signed and unsigned arithmetic diag read/write.
2019-12-26    as      Add FS API debug info support
2016-11-17    as   	  Call efs_qmi_scrub_init in efs initialisation. 
2016-11-08    as   	  Call efs_errno_init in efs initialisation. 
...
#include "fs_otp.h"
  ...
  *
  */
#define FS_CONFIG_FILE    "/.efs/config/efs_force_shutdown_sync"
...
fs_os_tcb_type *fs_task_tcb = NULL;
fs_os_signal_handle_type *fs_task_signal = NULL;
static fs_os_signal_handle_type fs_task_signal_inst;
...
efs_boot_init_romfs (void)
{
  ...
  fs_task_tcb = fs_os_self();
  fs_task_signal = &fs_task_signal_inst;
  fs_os_signal_init(fs_task_signal);
...
void
efs_initialize_release_locks (void)
{
  fs_global_unlock ();
  FS_PATH_BUFF_UNLOCK ();
  fs_sync_unlock ();
...
/*lint -restore */
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_OPEN, result, fd, path, oflag);
...
efs_read (int filedes, void *buf, fs_size_t nbyte)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_READ, result, filedes, NULL, nbyte);
...
efs_write (int filedes, const void *buf, fs_size_t nbyte)
{
  ...
  fs_profile_close (&profile_handle);
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_WRITE, result, filedes, NULL, nbyte);
...
clean_up:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_MKDIR, result, -1, path, 0);
...
efs_creat (const char *path, fs_mode_t mode)
{
  ...
  result = efs_open (path, O_CREAT | O_WRONLY | O_TRUNC, mode);
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_CREAT, result, -1, path, (uint32)mode);
  return result;
}
...
efs_close (int filedes)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_CLOSE, result, filedes, NULL, 0);
...
efs_lseek (int filedes, fs_off_t offset, int whence)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_LSEEK, result, filedes, NULL, offset);
...
efs_lseek64 (int filedes, fs_off64_t offset, int whence)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_LSEEK64, (uint32)result,
                    filedes, NULL, (uint32)offset);
...
efs_truncate (const char *path, fs_off_t length)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_TRUNCATE, result, -1, path, length);
...
efs_truncate64 (const char *path, fs_off64_t length)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_TRUNCATE64, (int)result, -1,
                    path, (uint32)length);
...
efs_ftruncate (int fd, fs_off_t length)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_FTRUNCATE, result, fd,
                    NULL, (uint32)length);
...
efs_ftruncate64 (int fd, fs_off64_t length)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_FTRUNCATE64, (int)result, fd,
                    NULL, (uint32)length);
...
efs_stat (const char *path, struct fs_stat *buf)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_STAT, result, -1, path, 0);
  fs_global_unlock ();
...
efs_fstat (int fd, struct fs_stat *buf)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_FSTAT, result, fd, NULL, 0);
  fs_global_unlock ();
  return result;
}
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_LSTAT, result, -1, path, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_STATVFS, result, -1, path, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_FSTATVFS, result, fd, NULL, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_UNLINK, result, -1, path, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_OPENDIR, result, -1, dirname, 0);
...
efs_readdir_core (EFSDIR *dirp)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_READDIR, result, -1, NULL, 0);
...
efs_closedir_core (EFSDIR *dirp)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_CLOSEDIR, result, -1, NULL, 0);
...
efs_rename (const char *oldpath, const char *newpath)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_RENAME, result, -1, oldpath, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_RMDIR, result, -1, path, 0);
  fs_global_unlock ();
...
efs_chmod (const char *path, fs_mode_t mode)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_CHMOD, result, (int)mode, path, 0);
  fs_global_unlock ();
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_SYMLINK, result, -1, newpath, 0);
  fs_global_unlock ();
...
efs_readlink (const char *path, char *buf, fs_size_t bufsiz)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_READLINK, result, -1, path, bufsiz);
  fs_global_unlock ();
                      ...
                      int oflag, int mode)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_PUT, result, -1, path, length);
...
efs_pure_get (const char *path, void *data, fs_size_t length)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_GET, result, -1, path, length);
...
efs_image_prepare (const char *path)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_IMAGE_PREPARE, result, -1, path, 0);
...
error_case:
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_SHRED, result, -1, path, 0);
...
efs_utime (const char *path, const struct fs_utimbuf *times)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_UTIME, result, -1, path, 0);
  fs_global_unlock ();
...
typedef enum
{
  FS_SHUTDOWN_NOT_A_SHUTDOWN = 1,
  FS_SHUTDOWN_FROM_RCINIT    = 2,
  FS_SHUTDOWN_FROM_CM        = 3,
...
int
efs_sync_helper (const char *path, int do_force_sync,
                   fs_shutdown_mechanism shutdown_hint)
{
  int result;
  struct nameidata *ndp = &nameidata_buffer;
  ...
  enum fs_api_debug_save_data_to_efs_context save_context;
  int is_shutdown_sync = 0;
  ...
  fs_os_get_cur_task_name (task_name,
                       sizeof (task_name));
  switch (shutdown_hint)
  {
    case FS_SHUTDOWN_FROM_RCINIT:
      is_shutdown_sync = 1;
      save_context = FS_API_DEBUG_SAVE_DATA_TO_EFS_CONTEXT_RCINIT_SHUTDOWN;
      break;

    case FS_SHUTDOWN_FROM_CM:
      is_shutdown_sync = 1;
      save_context = FS_API_DEBUG_SAVE_DATA_TO_EFS_CONTEXT_CM_SHUTDOWN;
      break;

    case FS_SHUTDOWN_NOT_A_SHUTDOWN:
    default:
      is_shutdown_sync = 0;
      save_context = FS_API_DEBUG_SAVE_DATA_TO_EFS_CONTEXT_SYNC;
      break;
  }

  fs_api_debug_add (FS_API_DEBUG_ID_EFS_SYNC, result, 0, task_name, 0);
  fs_api_debug_save_data_to_efs (save_context, do_force_sync);
...
{
  return efs_sync_helper (path, 0, FS_SHUTDOWN_NOT_A_SHUTDOWN);
}
...
efs_sync_no_wait (const char *path, fs_sync_token_t *sync_token)
{
  ...
  struct fs_profile_handle profile_handle;
  char task_name[FS_API_DEBUG_MAX_TASK_NAME_LEN];
 // fs_os_tcb_type *curr_task_tcb = NULL;
  ...
  //curr_task_tcb = fs_os_self ();
  memset(task_name, 0, sizeof(task_name));
  fs_os_get_cur_task_name (task_name,
                       sizeof (task_name));

  FS_MSG_STRING_MED_1("EFS: EFS-Sync caller task: %s", task_name);

  fs_api_debug_add (FS_API_DEBUG_ID_EFS_SYNC_NO_WAIT,result,-1,task_name,0);
...
cleanup:
  ...
  EFS_BAB_END (EFS_BAB_SYNC);
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_SYNC_GET_STATUS, result, -1, path, 0);
...
efs_log_shutdown_mechanism (fs_shutdown_mechanism shutdown_hint)
{
  ...
  result = efs_read_file_helper (log_file, &shutdown_count, shutdown_log_size);
  if (result != 0)
  {
    shutdown_count = 1;
  }
  ...
  (void) efs_write_file_helper (log_file, &shutdown_count, shutdown_log_size);
}
...
/* Check if the sync needs to be forced before shutdown */
  ...
  efs_errno = ENOERR;
  result = efs_read_file_helper (FS_CONFIG_FILE,
           &force_sync_flag, force_sync_flag_size);
  error = efs_errno;
  ...
  result = efs_sync_helper ("/", (int)force_sync_flag, shutdown_hint);
...
efs_prepare_shutdown (void)
{
  ...
  fs_global_lock ();
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_PREPARE_SHUTDOWN, result, -1, NULL, 0);
  fs_global_unlock ();
...
efs_rcinit_shutdown_callback (void)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_RCINIT_SHUTDOWN_CB, 0, -1, NULL, 0);
  fs_global_unlock();
...
efs_rcinit_group7_shutdown_callback (void)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_RCINIT_GROUP7_SHUTDOWN_CB, 0, -1,
                    NULL, 0);
  fs_global_unlock();
}
...
efs_lock_filesystem (const char *path)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_LOCK_FS, result, -1, path, 0);
...
efs_unlock_filesystem (const char *path)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_UNLOCK_FS, result, -1, path, 0);
  return result;
}
                           ...
                           enum fs_filesystem_image_type image_type)
{
  ...
  fs_api_debug_add (FS_API_DEBUG_ID_EFS_FILESYSTEM_IMAGE_OPEN,
      0, 0, path, 0);
...
struct fs_golden_copy_info_type
{
  ...
  fs_os_signal_handle_type    *fs_task_signal;
                              ...
                              enum fs_golden_copy_type golden_copy_type)
{
  ...
  ASSERT (fs_golden_copy_info.fs_task_signal != NULL);
  fs_os_set_sigs (fs_golden_copy_info.fs_task_tcb,
                  fs_golden_copy_info.fs_task_signal,
                  FS_EFS_GOLDEN_COPY_SIG);
  result = 0;

  fs_api_debug_add (FS_API_DEBUG_ID_EFS_MAKE_GOLDEN_COPY_NO_WAIT, result, -1,
                    path, (uint32)golden_copy_type);
...
efs_golden_copy_init (void)
{
  ...
  fs_golden_copy_info.fs_task_tcb = fs_task_tcb;
  ASSERT(fs_golden_copy_info.fs_task_tcb != NULL);
  fs_golden_copy_info.fs_task_signal = fs_task_signal;
  ASSERT(fs_golden_copy_info.fs_task_signal != NULL);
...
{
  int result, oflag, mode, fd = -1;
  uint32 cur_posn, rem_size;
  uint8 *buf_i;

  oflag = O_CREAT | O_WRONLY | O_TRUNC;
  mode = 0644;

  result = efs_open (path, oflag, mode);
  if (result < 0 && efs_errno == ENOENT)
  {
    (void) efs_auto_mkdir (path);
    result = efs_open (path, oflag, mode);
  }
  if (result < 0)
  {
  ...
  cur_posn = rem_size = 0;
  while (cur_posn < buf_size)
  {
    rem_size = buf_size - cur_posn;
    result = efs_write (fd, &buf_i[cur_posn], rem_size);
    if (result == 0)
      break;
    if (result < 0)
    {
      result = efs_errno;
      FS_MSG_ERROR_1("efs_write failed [%d]", result);
      goto cleanup;
    }

    cur_posn += (uint32)result;
  }

  if (cur_posn == buf_size)
    result = 0;
  else
    result = -1;
...
int efs_read_file_helper (const char *path, void *buf, uint32 buf_size)
{
  ...
  {
    rem_size = buf_size - cur_posn;
    result = efs_read (fd, &buf_i[cur_posn], rem_size);
    if (result == 0)
      break;
    if (result < 0)
    {
