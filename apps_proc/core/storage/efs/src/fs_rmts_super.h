 ...
 * Copyright (C) 2009-2010,2012-2013,2015 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_rmts_super.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
/*************************************************************************//**
 * Check if the image is a compressed image.
 *
 * @param sb
 *    Pointer to the superblock of the image to check.
 *
 * @return
 *    None.
*****************************************************************************/
uint8 fs_rmts_super_get_img_compression_state (struct fs_rmts_superblock *sb);
