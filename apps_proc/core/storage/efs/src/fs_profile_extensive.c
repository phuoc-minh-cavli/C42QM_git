...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_profile_extensive.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
{
  fs_os_get_cur_task_name(buffer, buffer_size);
