 ...
 * folder.
 *
 * Copyright (C) 2006-2007,2012,2016 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_privatedir.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
efs_privatedir_init (void)
{
  ...
  result = efs_is_dir_exists (FS_EFS_PRIVATE_DIR_PATH);
  if (result != 1)
  {
  ...
  result = efs_is_dir_exists (FS_EFS_DIAG_SAFE_DIR_PATH);
  if (result != 1)
  {
