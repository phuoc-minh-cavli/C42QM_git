...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_device_efs_rmts.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
uint32 fs_rmts_efs_size = SCL_MODEM_EFS_RAM_SIZE;
  ...
  uint32 fs_rmts_efs_shared_ram_size = SCL_SHARED_EFS_RAM_SIZE;
#else
  uint32 fs_rmts_efs_shared_ram_size = SCL_MODEM_EFS_RAM_SIZE;
#endif
...
fs_device_efs_rmts_open (uint32 which_device)
{
  ...
  uint32 shared_ram_size = fs_rmts_efs_shared_ram_size;
...
#ifdef FS_UNIT_TEST
  {
    ...
    shared_ram_size = sim_dev->priv.rmts_dev.shared_ram_size;
    page_size = sim_dev->priv.rmts_dev.dev_page_size;
  }
#endif

/* Initialize all values */
  fs_device_efs_rmts_init_dev (base_dev, ram_size, shared_ram_size);
                             ...
                             uint32 shared_ram_size)
{
  ...
  rmts_dev->shared_ram_size = shared_ram_size;
