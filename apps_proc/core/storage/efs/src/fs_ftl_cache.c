 ...
 *   FS + FTL layer.
 *
 * Copyright (C) 2006-2013,2016 QUALCOMM Technologies, Inc.  All Rights Reserved
 *
 *****************************************************************************/
...
/*=============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_ftl_cache.c#1 $
...
{
  fs_os_def_timer (&fs_ftl_sync_timer, fs_task_tcb, fs_task_signal,
                   FS_FTL_SYNC_SIG);
...
{
  fs_os_set_timer (&fs_ftl_sync_timer, FS_FTL_SYNC_TIME);
}
