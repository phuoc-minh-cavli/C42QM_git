...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_otp.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
int
v_otp_sync_start (struct fs_vnode *vp, int do_force_sync,
...
v_otp_sync_no_wait (struct fs_vnode *vp, fs_sync_token_t *sync_token)
{
  ...
  result = v_otp_sync_start (vp, 0, 0);
