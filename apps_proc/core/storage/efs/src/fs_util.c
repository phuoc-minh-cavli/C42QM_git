 ...
 * Copyright (C) 2003-2014,2016,2019 QUALCOMM Technologies, Inc.
 *
 ***********************************************************************/
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_util.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 ...
 **********************************************************************/
void
fs_util_wait (fs_os_signal_handle_type *sigh,  int msec)
{
  fs_os_timer_type  fs_dev_tout_timer;
  fs_os_tcb_type    *my_tcb;

  my_tcb = fs_os_self ();
  fs_os_clr_sigs(my_tcb, sigh, FS_OP_COMPLETE_SIG);
  fs_os_def_timer (&fs_dev_tout_timer, my_tcb, sigh, FS_OP_COMPLETE_SIG);
  fs_os_timed_wait (sigh, FS_OP_COMPLETE_SIG, &fs_dev_tout_timer, msec);
}
