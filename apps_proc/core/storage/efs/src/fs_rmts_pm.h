...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/src/fs_rmts_pm.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
{
  uint64                     compress_time;
  uint64                     enc_time;
  uint64                     write_iovec_time;
...
struct fs_rmts_pm
{
  ...
  uint32                ram_size; /**< How big is the modem RAM. */
  uint32                shared_ram_size; /**< How big is shared RAM. */
  uint32                shared_data_region_size_bytes; /**< How big is data
                                                     region in shared RAM. */
  ...
  int                   is_shutdown_sync; /**< Is this an efs sync happening
  ...
  int is_golden_copy_from_files_list_supported;  /**< Support golden-copy
                                          to have custom files-list. */
  int  erase_efs_image_on_efs_reset_api;  /**< Erase EFS-images when the
                                          efs_reset API is invoked */
  ...
  uint8           is_compression_enabled;
  uint64          decompress_time_us; /**< usecs it took for decompression */
  uint32          decompressed_data_bytes; /**<Output len from decompression */
  uint32          compressed_data_bytes; /**<Output len from last compression*/
  ...
  uint8* data_region;
  uint32 modem_data_region_size_bytes;
