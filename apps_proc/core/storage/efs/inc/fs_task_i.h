...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/inc/fs_task_i.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2016-11-29   as    Add macro for scrub signal.
...
#define FS_EFS_GOLDEN_COPY_SIG     0x0010      /* Golden copy signal */
#define FS_EFS_GOLDEN_COPY_RESTORE_SIG 0x0020  /* Golden copy signal */
#define FS_FTL_SYNC_SIG            0x0040      /* FTL sync timer signal */
#define FS_EFS_SCRUB_SIG           0x0080      /*signal to fs_task to takeover scrub control */

/* Compatibility defines to map RCINIT functions.
 */
#define FS_TASK_PRIV_START()      rcinit_handshake_startup()
#define FS_TASK_REGISTER_SHUTDOWN(group, x)  \
                                 rcinit_register_termfn_group(group, x)
