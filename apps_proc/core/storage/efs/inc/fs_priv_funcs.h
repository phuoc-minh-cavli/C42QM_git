 ...
 * Copyright (C) 2009-2013, 2015-2016, 2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/inc/fs_priv_funcs.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-12-26   as    Add FS API debug info support
2016-09-21   as    Added errno to check if the given directory exists or not.
...
extern fs_os_signal_handle_type *fs_task_signal;
