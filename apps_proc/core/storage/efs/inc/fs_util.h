 ...
 * Copyright (C) 2003-2005, 2007-2009, 2011, 2013, 2019 QUALCOMM Technologies, Inc.
 *
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/storage/efs/inc/fs_util.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
struct fs_string_iter
{
  ...
  char str_seperator1;
  char str_seperator2;
  char new_str_seperator;
};

char* fs_string_iter_get_next (struct fs_string_iter *str_iter);
