 ...
 * targets.
 *
 * Copyright (c) 2008-2010, 2012, 2016 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //components/rel/core.tx/6.0/storage/flash/inc/flash.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 *
 *
...
#define FLASH_MEM_INVALID_ADDR             0xFFFFFFFF
...
#define INHERIT_FLASH_VTBL(type) \
  ...
  int (*write_pages)(type* handle, enum page_write_opcode write_type, \
    struct flash_mem_desc_buf *buffer_desc, struct flash_page_iovec *page_iovec); \
  \
