 ...
 *   order.
 *
 *  $Header: //components/rel/core.tx/6.0/storage/flash/src/hal/qpic/flashi_hal_nandc_predef_bam.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 10/03/18     sa      Added new struct for locate register.
