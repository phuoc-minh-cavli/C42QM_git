 ...
 * 01/09/19     sl      Corrected read cfg list initialization
 * 12/21/18     sl      added support for SPI NAND
 * 10/03/18     sa      Added QPIC_NAND_READ_LOCATION_LAST_CW_n register.
 * 10/03/18     eo      Set correct BBM value in BB marker read 
 ...
 * 10/11/14     sb      Fix the XPU violation
 ...
 */
static __inline void nandc_set_cmd(uint32 cmd, uint32 operation, 
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *status = FLASH_HAL_SUCCESS;
  ...
  nandc_set_cmd(FLASH_NAND_RESET_FLASH_CMD, NANDC_NON_PAGE_CMD, priv_data);
  ...
  if(priv_data->dev_type == FLASH_HAL_DEVICE_NAND_SPI)
  {
    op_cmd->data |= SPI_MODE_ENABLE_FOR_NON_RW_CMD;
  }
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *addr1 = addr1_val;
  ...
  /*---- Set Command registers -----*/
  nandc_set_cmd(FLASH_NAND_ID_FETCH_CMD, NANDC_NON_PAGE_CMD, priv_data);
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *addr1 = addr1_val;
  ...
  /* Set command registers */
  nandc_set_cmd(FLASH_NAND_PARAMETER_PAGE_READ_CMD, NANDC_NON_PAGE_CMD, priv_data);
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *status = FLASH_HAL_SUCCESS;
  ...
  nandc_set_cmd(cmd, NANDC_PAGE_READ_CMD, priv_data);
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *status = FLASH_HAL_SUCCESS;
  ...
  nandc_set_cmd(cmd, NANDC_PAGE_WRITE_CMD, priv_data);
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *status = FLASH_HAL_SUCCESS;
  ...
  /* Set erase command */
  nandc_set_cmd(FLASH_NAND_BLOCK_ERASE_CMD, NANDC_NON_PAGE_CMD, priv_data);
  ...
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status)
{
  ...
  *addr1 = addr1_val;
  ...
  /* Set command registers */
  nandc_set_cmd(FLASH_NAND_PAGE_READ_CMD, NANDC_NON_PAGE_CMD, priv_data);
