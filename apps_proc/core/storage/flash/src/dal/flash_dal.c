 ...
 *   order.
 *
 *  $Header: //components/rel/core.tx/6.0/storage/flash/src/dal/flash_dal.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 *
 *
...
int flash_dal_device_init(flash_client_ctxt *client_ctxt)
{
  ...
  --------------------------------------------------------------------------*/
  qurt_mutex_init(&(dev_ctxt->handle_dev_sync));
...
int flash_dal_device_deinit(flash_client_ctxt *client_ctxt)
{
  ...
  {
    qurt_mutex_destroy(&(dev_ctxt->handle_dev_sync));
  }
