 ...
 *   order.
 *
 *  $Header: //components/rel/core.tx/6.0/storage/flash/src/dal/flash_dal.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 *
 *
...
#endif
#define FLASH_ALLOC_PHYS_MEMDESC_OP_READ   0
#define FLASH_ALLOC_PHYS_MEMDESC_OP_WRITE  1
