 ...
 *   order.
 *
 *  $Header: //components/rel/core.tx/6.0/storage/flash/src/dal/flash_decode_nandids.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
 *
 *
  ...
  *device_params = (struct flash_nand_params *)(malloc(sizeof(struct flash_nand_params)));
  ...
  if (NULL != *device_params)
  {
    ...
    else
    {
      ...
      memscpy(param->device_name, sizeof(FLASH_DEV_NAME_TOSHIBA), FLASH_DEV_NAME_TOSHIBA, sizeof(FLASH_DEV_NAME_TOSHIBA));
