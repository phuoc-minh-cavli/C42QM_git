...
--------   ---     ------------------------------------------------------------
03/04/16   SS      Optimized and added few more BAM register.
09/03/14   SS      Created. 

===============================================================================
                   Copyright (c) 2014-2016 QQUALCOMM Technologies Inc.
                          All Rights Reserved.
...
typedef struct
{
    ...
    uint32 bam_test_bus_reg[BAM_TESTBUS_INDEX];  /**< -- BAM test bus regsiter */
}bamdebug_registers;
...
{
    uint32 offset_val;
    for(offset_val = 0; offset_val < BAM_TESTBUS_INDEX; offset_val++)
    {
