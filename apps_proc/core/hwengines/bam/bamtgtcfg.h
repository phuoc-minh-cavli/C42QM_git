...
===============================================================================
 ...
 $Header: //components/rel/core.tx/6.0/hwengines/bam/bamtgtcfg.h#1 $
...
#define BAM_TGT_CFG_USE_DSR            0x100 /**< Use DSR for client callbacks */
#define BAM_TGT_CFG_USE_NO_SYNC_LOCK   0x200 /**< To Disable Sync locks usage for Pipe transfers */
...
typedef struct _bamtgtcfg{
  ...
  //uint32 cfg_bits2;                /**< -- BAM chicken bits 2 */
