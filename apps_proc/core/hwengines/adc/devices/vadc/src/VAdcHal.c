...
/*============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/hwengines/adc/devices/vadc/src/VAdcHal.c#1 $$DateTime: 2020/01/30 22:49:35 $$Author: pwbldsvc $

  when        who  what, where, why
  ----------  ---  -----------------------------------------------------------
  2018-12-28  ay   updated for MDM9205
  2015-01-15  jjo  Add functions to get num averages and settling delay
  2014-09-15  jjo  Reduce number of SPMI transactions
  2014-04-08  jjo  Fix warning
