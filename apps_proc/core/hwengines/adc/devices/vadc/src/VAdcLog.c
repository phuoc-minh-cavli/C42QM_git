...
/*============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/hwengines/adc/devices/vadc/src/VAdcLog.c#1 $$DateTime: 2020/01/30 22:49:35 $$Author: pwbldsvc $
   ...
   )
{
   ...
   pVAdcDebugInfo->aLog[pVAdcDebugInfo->uCurIdx].pszErrorMsg = NULL;
...
{
   memcpy(&pVAdcDebugInfo->aLog[pVAdcDebugInfo->uCurIdx].result, pResult, sizeof(AdcDeviceResultType));
...
#endif /* #ifndef VADC_LOG_DISABLED */
