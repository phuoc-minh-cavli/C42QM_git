...
--------   ---     ------------------------------------------------------------
05/27/14   am      Add flag to track HW ACC pm state
05/20/14   am      Pass M state to suspend API
08/15/13   am      Created
===============================================================================
...
typedef struct _mhi_hw_acc_info
{
  ...
  boolean is_hw_acc_pm_enabled; /**< Track whether HW ACC is in power saving mode */

  boolean hw_acc_started;       /**< Track whether HW ACC was started */
} mhi_hw_acc_info_t;
