...
/*============================================================================
  ...
  $Header: //components/rel/core.tx/6.0/hwengines/tsens/dal/v1/TsensiConversion.c#1 $$DateTime: 2020/01/30 22:49:35 $$Author: pwbldsvc $


  when        who  what, where, why
  ----------  ---  -----------------------------------------------------------
  2015-02-04  jjo  Removed old cal methods.
  2014-07-02  jjo  Ported to 9x45.
...
void Tsensi_CalibrationInit(uint32 uNumTsensSensors, const int32 *panX1_default, const int32 *panM_default, int32 nY1, int32 nY2)
{
   ...
   switch (tsensCalibration)
   {
      ...
      case HAL_TSENS_TWO_POINT:
         ...
         //nTsensMFactor = Tsensi_InterpolateCalcSlope(TSENS_FACTOR, nTsensBaseX1, nY1, nTsensBaseX2, nY2);
