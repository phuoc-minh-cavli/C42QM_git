...
#
# Copyright 2011,2020 by QUALCOMM Technologies, Incorporated.
# All Rights Reserved.
# QUALCOMM Proprietary/GTDR
#
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/core.tx/6.0/bsp/build/scripts/mbn_builder.py#2 $
#  $DateTime: 2020/06/19 03:31:53 $
#  $Author: pwbldsvc $
#  $Change: 24451054 $
...
def generate(env):
   ...
   toolpath = env['BUILD_ROOT'] + '/sectools/sectools' 
   if (env.PathExists(toolpath)):
