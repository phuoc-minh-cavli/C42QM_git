...
GENERAL DESCRIPTION
  This module provides a shim layer for err specific image versioning 
  incase build doesn't support image versioning.
...
$Header: //components/rel/core.tx/6.0/debugtools/err/src/err_image_version_void.c#1 $
