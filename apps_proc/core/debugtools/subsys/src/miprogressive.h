...
$Header: //components/rel/core.tx/6.0/debugtools/subsys/src/miprogressive.h#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $

   
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/03/17   aus     Support for hibernation boot
...
#define MI_PBT_PERM_NONE          0x0
#define MI_PBT_PERM_X             0x1
#define MI_PBT_PERM_W             0x2
#define MI_PBT_PERM_WX            0x3
#define MI_PBT_PERM_R             0x4
#define MI_PBT_PERM_RX            0x5
#define MI_PBT_PERM_RW            0x6
#define MI_PBT_PERM_RWX           0x7
...
#define MI_PBT_FLAG_PERM_MASK             0xF
...
#define MI_PBT_FLAG_PERM_SHIFT             0x0
...
#define MI_PBT_FLAG_PERM_VALUE(x) \
         ( ((x) & MI_PBT_FLAG_PERM_MASK) >> \
            MI_PBT_FLAG_PERM_SHIFT )			
