...
$Header: //components/rel/core.tx/6.0/debugtools/subsys/src/9205/pil_config.h#2 $
...
/* Partition names will vary from target to target.
   partition_nand.xml file at meta location should be checked
   to know the correct name of the partitions. */
#define MBA_PARTITION_NAME      "0:MBA"
#define MODEM_PARTITION_NAME    "qdsp"

#define PIL_RMB_WAIT_TIMEOUT_MS 100
#define PIL_SMP2P_WAIT_TIMEOUT_MS 10000  //10 secs

/* In case of TZ authentication, all segments will be loaded at once */
#define PIL_LOAD_SEGMENT_WISE_CONFIG FALSE
