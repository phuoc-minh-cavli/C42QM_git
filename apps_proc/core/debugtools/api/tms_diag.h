...
Copyright (c) 2014-17 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/*==========================================================================

                        EDIT HISTORY FOR MODULE
$Header: //components/rel/core.tx/6.0/debugtools/api/tms_diag.h#1 $
...
typedef enum
{
  ...
  TMS_DIAGPKT_RPM_CRASH,
  TMS_DIAGPKT_SYS_M_HIBERNATION   /* Put system into hibernation */
}CMD;
...
diagpkt_user_table_entry_type tms_diag_build_table_entry(CMD cmd, PACK(void*)(*cb)());
