...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/debugtools/api/tms_rcinit.h#1 $
...
#define RCINIT_TASK_MAX                               50    // maximum number of tasks tracked for compile time sized tables
...
struct rcinit_internal_s
{
   ...
   qurt_signal_t worker_sigobj;                                              // worker loop

   qurt_signal_t init_fn_spawn_sigobj;                                       // worker event
