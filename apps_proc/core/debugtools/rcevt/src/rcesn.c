...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/debugtools/rcevt/src/rcesn.c#1 $
...
static boolean rcesn_timer_init = 0;
...
RCESN_HANDLE rcesn_wait_handle(RCESN_HANDLE const handle, RCESN_FNSIG_COMPARE const compare)
{
   ...
   {
      sig.compare = compare;
      timetick = RCESN_CALLBACK_MAX_TIME;
