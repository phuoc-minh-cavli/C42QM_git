...
/*=============================================================================
Edit History
$Header: //components/rel/core.tx/6.0/debugtools/rcevt/src/rcecb.c#1 $
...
static boolean rcecb_timer_init = 0;
...
{
   ERR_FATAL("RCECB client callback runtime exceeded", 0, 0, 0);
