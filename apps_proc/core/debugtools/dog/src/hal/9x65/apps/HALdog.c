...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/6.0/debugtools/dog/src/hal/9x65/apps/HALdog.c#1 $ $DateTime: 2020/01/30 22:49:35 $ $Author: pwbldsvc $
...
volatile static int dog_enable_hw_wdog = 1;
