...
$Header: //components/rel/core.tx/6.0/debugtools/sys_m/src/lib/9x45/apps/sys_m.c#1 $
...
void sys_m_err_notify_peripherals(void)
{
    ...
    //sys_m_smp2p_set(SYS_M_AP2SUBSYS_SMP2P_ERRFATAL, SMEM_ADSP); /*no ADSP on 9x45*/
}
