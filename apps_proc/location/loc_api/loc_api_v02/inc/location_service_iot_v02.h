...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/location.tx/3.0/loc_api/loc_api_v02/inc/location_service_iot_v02.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define LOC_IOT_V02_IDL_MINOR_VERS 0x08
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define LOC_IOT_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define LOC_IOT_V02_MAX_MESSAGE_ID 0x0064
/**
    @}
  */
...
/**  Maximum GNSS measurement dngine firmware version string length.  */
...
/** @addtogroup loc_iot_qmi_messages
    @{
  */
/** Request Message; Generic response definition; tells
...
/** @addtogroup loc_iot_qmi_messages
    @{
  */
/** Response Message; Generic response definition; tells
                    clients whether their message was accepted for further 
                    processing or rejected. */
typedef struct {
...
/** @addtogroup loc_iot_qmi_messages
    @{
  */
/** Indication Message; Generic response definition; tells
                    clients whether their message was accepted for further 
                    processing or rejected. */
typedef struct {
...
#define QMI_LOC_EVENT_MASK_INJECT_POSITION_REQ_V02 ((qmiLocEventRegMaskT_v02)0x00000020ull) /**<  The control point must enable this mask to receive position injection request
       event indications.  */
...
#define QMI_LOC_EVENT_MASK_GEOFENCE_GEN_ALERT_V02 ((qmiLocEventRegMaskT_v02)0x00000100ull) /**<  Geofence alerts.
       ...
       unavailable.  */
#define QMI_LOC_EVENT_MASK_GEOFENCE_BREACH_NOTIFICATION_V02 ((qmiLocEventRegMaskT_v02)0x00000200ull) /**<  Notifications when a geofence is breached. These events are generated when UE enters
       or leaves the perimeter of a geofence. This breach report is for a single
       geofence.  */
#define QMI_LOC_EVENT_MASK_BATCH_FULL_NOTIFICATION_V02 ((qmiLocEventRegMaskT_v02)0x00000400ull) /**<  Notification when a batch is full. The location engine sends this event to notify of Batch Full
...
#define QMI_LOC_EVENT_MASK_LIVE_BATCHED_POSITION_REPORT_V02 ((qmiLocEventRegMaskT_v02)0x00000800ull) /**<  Position report indications along with an ongoing batching session. The location engine sends
       ...
       is ongoing.  */
#define QMI_LOC_EVENT_MASK_GEOFENCE_BATCH_BREACH_NOTIFICATION_V02 ((qmiLocEventRegMaskT_v02)0x00001000ull) /**<  Notifications when a geofence is breached. These events are generated when UE enters
...
#define QMI_LOC_EVENT_MASK_GEOFENCE_BATCH_DWELL_NOTIFICATION_V02 ((qmiLocEventRegMaskT_v02)0x00002000ull) /**<  Notifications when a geofence is dwelled. These events are generated when a UE enters
       ...
       sent in the same notification.  */
#define QMI_LOC_EVENT_MASK_BATCHING_STATUS_V02 ((qmiLocEventRegMaskT_v02)0x00004000ull) /**<  Asynchronous events related
       to batching.  */
#define QMI_LOC_EVENT_MASK_GNSS_ONLY_POSITION_REPORT_V02 ((qmiLocEventRegMaskT_v02)0x000008000ull) /**<  The position report
...
#define QMI_LOC_EVENT_MASK_BS_OBS_DATA_SERVICE_REQ_V02 ((qmiLocEventRegMaskT_v02)0x0000020000ull) /**<  The base station
...
typedef struct {
 ...
 Valid bitmasks: \n
      ...
      - QMI_LOC_EVENT_MASK_INJECT_POSITION_REQ (0x00000020) --  The control point must enable this mask to receive position injection request
       event indications. 
      ...
      - QMI_LOC_EVENT_MASK_GEOFENCE_GEN_ALERT (0x00000100) --  Geofence alerts.
       These alerts are generated to inform the client of the changes that may
       affect a geofence, e.g., if GPS is turned off or if the network is
       unavailable. 
      - QMI_LOC_EVENT_MASK_GEOFENCE_BREACH_NOTIFICATION (0x00000200) --  Notifications when a geofence is breached. These events are generated when UE enters
       or leaves the perimeter of a geofence. This breach report is for a single
       geofence. 
      - QMI_LOC_EVENT_MASK_BATCH_FULL_NOTIFICATION (0x00000400) --  Notification when a batch is full. The location engine sends this event to notify of Batch Full
       for ongoing batching session. 
      - QMI_LOC_EVENT_MASK_LIVE_BATCHED_POSITION_REPORT (0x00000800) --  Position report indications along with an ongoing batching session. The location engine sends
       this event to notify the batched position report while a batching session
       is ongoing. 
      - QMI_LOC_EVENT_MASK_GEOFENCE_BATCH_BREACH_NOTIFICATION (0x00001000) --  Notifications when a geofence is breached. These events are generated when UE enters
       or leaves the perimeter of a geofence. This breach notification is for
       multiple geofences. Breaches from multiple geofences are all batched and
       sent in the same notification.   
      - QMI_LOC_EVENT_MASK_GEOFENCE_BATCH_DWELL_NOTIFICATION (0x00002000) --  Notifications when a geofence is dwelled. These events are generated when a UE enters
       or leaves the perimeter of a geofence and dwells inside or outside for a specified time.
       This dwell notification is for multiple geofences. Dwells from multiple geofences are all batched and
       sent in the same notification. 
      - QMI_LOC_EVENT_MASK_BATCHING_STATUS (0x00004000) --  Asynchronous events related
       to batching. 
      - QMI_LOC_EVENT_MASK_GNSS_ONLY_POSITION_REPORT (0x000008000) --  The position report
       event indications that contain a GNSS only position. 
      - QMI_LOC_EVENT_MASK_FDCL_SERVICE_REQ (0x000010000) --  FDCL service request. 
      - QMI_LOC_EVENT_MASK_BS_OBS_DATA_SERVICE_REQ (0x0000020000) --  The base station
       observed data service request. 

 Multiple events can be registered by OR'ing the individual masks and
 ...
 */
  ...
  */
  ...
  /**<   \n If the power mode is not set by the client,
       ...
       There can be other clients with different powerMode settings.
       In such cases, the GNSS receiver is configured with powerMode with the highest
  ...
  */
  ...
  /**<   Specifies the horizontal accuracy required by the control point. \n
        - Range : 0 to 65535 
        - Units: Meters */
...
typedef struct {
  ...
  /**<   The time server is skipped if a one-way delay to the server
  ...
  /**<   List of Time Server URLs that are recommended by the service for time
...
typedef enum {
  ...
  eQMI_LOC_GEOFENCE_GEN_ALERT_MGP_UNAVAILABLE_V02 = 5, /**<  MGP is unloaded/unavailable  */
...
typedef struct {
 ...
 Valid values: \n
      ...
      - eQMI_LOC_GEOFENCE_GEN_ALERT_MGP_UNAVAILABLE (5) --  MGP is unloaded/unavailable 
 */
...
typedef struct {
  ...
  */
  ...
  /**<   Controls whether assistance data is store in
       persistent memory.
...
typedef struct {
  ...
  /*  Geofence ID */
  uint32_t geofenceId;
  /**<   Identifier for the geofence that to delete. */
...
typedef struct {
  ...
  /**<    Motion state speed in milliseconds.
           ...
           - Stationary speed -- 0 meters/secpnd
           - Fiddle speed -- 0 meters/second \n
           - Walk speed -- 3 meters/second    \n
           - Run speed -- 8 meters/second \n
           - Drive speed -- 56 meters/second
  */
...
typedef struct {
  ...
  /**<   Identifies the sources that the geofence enginer can enable for motion detection.
...
typedef struct {
 ...
 Valid values: \n
  ...
  uint8_t transactionId_valid;  /**< Must be set to true if transactionId is being passed */
  uint32_t transactionId;
  /**<   Transaction ID specified in theQMI_LOC_GET_BEST_AVAILABLE_POSITION_REQ request. This parameter is
       always present if the status field is set to
       SUCCESS. */
 ...
 */
  ...
  */
  ...
  /**<   Specifies the minimum distance (in meters) that should be traversed before a 
...
typedef struct {
  ...
  qmiLocStatusEnumT_v02 status;
  /**<   Status of theQMI_LOC_READ_FROM_BATCH_REQ request.
...
#define QMI_LOC_GTP_BASIC_MASK_V02 ((qmiLocGtpLocationTypeMaskT_v02)0x00000001ull) /**<  If this mask is set, indicates basic GTP 
	   is requested  */
#define QMI_LOC_GTP_ENHANCED_MASK_V02 ((qmiLocGtpLocationTypeMaskT_v02)0x00000002ull) /**<  If this mask is set, indicates enhanced GTP 
	   is requested  */
/** @addtogroup loc_iot_qmi_messages
    @{
  */
...
typedef struct {
 ...
 Valid bitmasks: \n
      - QMI_LOC_GTP_BASIC_MASK (0x00000001) --  If this mask is set, indicates basic GTP 
	   is requested 
      - QMI_LOC_GTP_ENHANCED_MASK (0x00000002) --  If this mask is set, indicates enhanced GTP 
	   is requested 
 */
...
typedef struct {
  ...
  /*  Request ID */
  uint8_t reqId;
  /**<   ID of the request that was specified in the QMI_LOC_START_DBT_REQ 
        request.\n
       - Range: 0 to 255 */
...
#define QMI_LOC_MASK_DELETE_CLOCK_INFO_GALTOBDS_TB_V02 ((qmiLocDeleteClockInfoMaskT_v02)0x00200000) /**<  Mask to delete GAL-to-BDS time bias-related information from the
      clock information  */
#define QMI_LOC_MASK_DELETE_CLOCK_INFO_GALWEEK_NUMBER_V02 ((qmiLocDeleteClockInfoMaskT_v02)0x00400000) /**<  Mask to delete the GAL week number from the clock information  */
#define QMI_LOC_MASK_DELETE_CLOCK_INFO_GAL_RF_GRP_DELAY_V02 ((qmiLocDeleteClockInfoMaskT_v02)0x00800000) /**<  Mask to delete the GAL RF GRP delay from the clock information  */
/** @addtogroup loc_iot_qmi_messages
    @{
  */
...
typedef struct {
 ...
 Valid values: \n
      ...
      clock information 
      - QMI_LOC_MASK_DELETE_CLOCK_INFO_GALWEEK_NUMBER (0x00400000) --  Mask to delete the GAL week number from the clock information 
      - QMI_LOC_MASK_DELETE_CLOCK_INFO_GAL_RF_GRP_DELAY (0x00800000) --  Mask to delete the GAL RF GRP delay from the clock information 
 */
 ...
 */
  ...
  /*  Accumulated OTB Distance */
  uint32_t accumulatedDistance;
  /**<   The accumulated distance from the last QMI_LOC_START_OUTDOOR_TRIP_BATCHING_REQ request. \n
       - Units: Meters
  */
...
#define QMI_LOC_CAP_MASK_GTP_V02 ((qmiLocCapabilitiesMaskT_v02)0x00000001ull) /**<  GTP capability enabled of this device  */
#define QMI_LOC_CAP_MASK_WIFI_V02 ((qmiLocCapabilitiesMaskT_v02)0x00000002ull) /**<  GNSS capability enabled of this device  */
#define QMI_LOC_CAP_MASK_GNSS_V02 ((qmiLocCapabilitiesMaskT_v02)0x00000004ull) /**<  GNSS capability enabled of this device  */
#define QMI_LOC_CAP_MASK_GTP_CACHE_V02 ((qmiLocCapabilitiesMaskT_v02)0x00000008ull) /**<  GTP cache fix enabled of this device  */
typedef uint64_t qmiLTEBandMaskT_v02;
#define QMI_LOC_EVENT_MASK_LTE_BANDS_1_16_V02 ((qmiLTEBandMaskT_v02)0x00000001ull) /**< Indicates if any LTE bands from 1 to 16 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_17_32_V02 ((qmiLTEBandMaskT_v02)0x00000002ull) /**< Indicates if any LTE bands from 17 to 32 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_33_48_V02 ((qmiLTEBandMaskT_v02)0x00000004ull) /**< Indicates if any LTE bands from 33 to 48 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_49_64_V02 ((qmiLTEBandMaskT_v02)0x00000008ull) /**< Indicates if any LTE bands from 49 to 64 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_65_80_V02 ((qmiLTEBandMaskT_v02)0x00000010ull) /**< Indicates if any LTE bands from 65 to 80 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_81_96_V02 ((qmiLTEBandMaskT_v02)0x00000020ull) /**< Indicates if any LTE bands from 81 to 96 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_97_112_V02 ((qmiLTEBandMaskT_v02)0x00000040ull) /**< Indicates if any LTE bands from 97 to 112 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_113_128_V02 ((qmiLTEBandMaskT_v02)0x00000080ull) /**< Indicates if any LTE bands from 113 to 128 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_129_144_V02 ((qmiLTEBandMaskT_v02)0x00000100ull) /**< Indicates if any LTE bands from 129 to 144 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_145_160_V02 ((qmiLTEBandMaskT_v02)0x00000200ull) /**< Indicates if any LTE bands from 145 to 160 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_161_176_V02 ((qmiLTEBandMaskT_v02)0x00000400ull) /**< Indicates if any LTE bands from 161 to 176 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_177_192_V02 ((qmiLTEBandMaskT_v02)0x00000800ull) /**< Indicates if any LTE bands from 177 to 192 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_193_208_V02 ((qmiLTEBandMaskT_v02)0x00001000ull) /**< Indicates if any LTE bands from 193 to 208 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_209_224_V02 ((qmiLTEBandMaskT_v02)0x00002000ull) /**< Indicates if any LTE bands from 209 to 224 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_225_240_V02 ((qmiLTEBandMaskT_v02)0x00004000ull) /**< Indicates if any LTE bands from 225 to 240 are supported */
#define QMI_LOC_EVENT_MASK_LTE_BANDS_241_256_V02 ((qmiLTEBandMaskT_v02)0x00008000ull) /**< Indicates if any LTE bands from 241 to 256 are supported */
/** @addtogroup loc_iot_qmi_aggregates
    @{
  */
typedef struct {
  ...
  /**<   Specifies which sub-band fields 
 Valid bitmasks: \n
      - QMI_LOC_EVENT_MASK_LTE_BANDS_1_16 (0x00000001) -- Indicates if any LTE bands from 1 to 16 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_17_32 (0x00000002) -- Indicates if any LTE bands from 17 to 32 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_33_48 (0x00000004) -- Indicates if any LTE bands from 33 to 48 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_49_64 (0x00000008) -- Indicates if any LTE bands from 49 to 64 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_65_80 (0x00000010) -- Indicates if any LTE bands from 65 to 80 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_81_96 (0x00000020) -- Indicates if any LTE bands from 81 to 96 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_97_112 (0x00000040) -- Indicates if any LTE bands from 97 to 112 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_113_128 (0x00000080) -- Indicates if any LTE bands from 113 to 128 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_129_144 (0x00000100) -- Indicates if any LTE bands from 129 to 144 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_145_160 (0x00000200) -- Indicates if any LTE bands from 145 to 160 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_161_176 (0x00000400) -- Indicates if any LTE bands from 161 to 176 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_177_192 (0x00000800) -- Indicates if any LTE bands from 177 to 192 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_193_208 (0x00001000) -- Indicates if any LTE bands from 193 to 208 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_209_224 (0x00002000) -- Indicates if any LTE bands from 209 to 224 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_225_240 (0x00004000) -- Indicates if any LTE bands from 225 to 240 are supported
      - QMI_LOC_EVENT_MASK_LTE_BANDS_241_256 (0x00008000) -- Indicates if any LTE bands from 241 to 256 are supported */
...
typedef struct {
  ...
  /**<   Mask indicates capabilities 
 Valid bitmasks: \n
      - QMI_LOC_CAP_MASK_GTP (0x00000001) --  GTP capability enabled of this device 
      - QMI_LOC_CAP_MASK_WIFI (0x00000002) --  GNSS capability enabled of this device 
      - QMI_LOC_CAP_MASK_GNSS (0x00000004) --  GNSS capability enabled of this device 
      - QMI_LOC_CAP_MASK_GTP_CACHE (0x00000008) --  GTP cache fix enabled of this device  */
...
typedef struct {
  ...
  uint16_t maxNumBs;
  /**<   Specifies the maximum number of BS to send by the TLE. 
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Maximum Value of Delta Time in Seconds to Crowd Source Data.   */
 ...
 */
  ...
  /**<     Uncertainty of GPS time in milli seconds  \n
          
		 This field can be considered to be the part of qmiLocNextLeapSecondInfoStructT
		 structure that can't be modified.*/
...
/** Request Message; Obtains the GNSS location request backoff period.  
                    Back-to-back location requests in modem shall be spaced 
...
typedef struct {
  ...
  uint32_t transactionId;
  /**<   Identifies the transaction. The transaction ID
       is returned in the get location backoff period
       indication. */
...
typedef struct {
 ...
 Valid values: \n
  ...
  /**<   Back to back location request in the modem shall be spaced at 
  ...
  /**<   The distance (in meters) of the UE from the nearest geofence (if present).
       If there are no geofences in the system, this field shall not be populated.
       */
