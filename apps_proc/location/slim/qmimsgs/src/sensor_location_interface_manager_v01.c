...
static const uint8_t qmiSlimSensorDataBatchAlignReqStructT_data_v01[] = {
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmiSlimSensorDataBatchAlignReqStructT_v01, batchStartTime),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiSlimSensorDataBatchAlignReqStructT_v01, timeSource),
...
static const uint8_t qmiSlimEnableSensorDataReqMsgT_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, reportRate) - QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, reportRate_valid)),
  0x12,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, reportRate),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, batchAlignReq) - QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, batchAlignReq_valid)),
  0x13,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmiSlimEnableSensorDataReqMsgT_v01, batchAlignReq),
  QMI_IDL_TYPE88(0, 1)
};
...
static const uint8_t qmiSlimVehicleMotionDataIndMsgT_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmiSlimVehicleMotionDataIndMsgT_v01, header),
  QMI_IDL_TYPE88(0, 0),

  0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiSlimVehicleMotionDataIndMsgT_v01, sampleTimeOffset),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET8(qmiSlimVehicleMotionDataIndMsgT_v01, sampleTimeOffset) - QMI_IDL_OFFSET8(qmiSlimVehicleMotionDataIndMsgT_v01, sampleTimeOffset_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, speed) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, speed_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, speed),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, speed) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, speed_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFL) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFL_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFL),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFL) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFL_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFR) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFR_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFR),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFR) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsFR_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRL) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRL_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRL),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRL) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRL_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRR) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRR_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRR),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRR) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, dwsRR_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiSlimVehicleMotionDataIndMsgT_v01, gear),
  QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01,
  QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear) - QMI_IDL_OFFSET16RELATIVE(qmiSlimVehicleMotionDataIndMsgT_v01, gear_len)
};
...
static const qmi_idl_type_table_entry  slim_type_table_v01[] = {
  ...
  {sizeof(qmiSlimSensorDataBatchAlignReqStructT_v01), qmiSlimSensorDataBatchAlignReqStructT_data_v01}
};
...
static const qmi_idl_message_table_entry slim_message_table_v01[] = {
  ...
  {sizeof(qmiSlimVehicleMotionDataIndMsgT_v01), qmiSlimVehicleMotionDataIndMsgT_data_v01}
};
...
static const qmi_idl_service_message_table_entry slim_service_command_messages_v01[] = {
  ...
  {QMI_SLIM_ENABLE_SENSOR_DATA_REQ_V01, QMI_IDL_TYPE16(0, 8), 43},
...
static const qmi_idl_service_message_table_entry slim_service_indication_messages_v01[] = {
  ...
  {QMI_SLIM_VEHICLE_MOTION_DATA_IND_V01, QMI_IDL_TYPE16(0, 17), 1309}
};
