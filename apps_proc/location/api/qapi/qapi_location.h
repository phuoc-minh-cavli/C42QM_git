...
typedef enum {
    ...
    QAPI_LOCATION_ERROR_TIMEOUT_ACC_CHECK_FAILED, /**< Timeout when asking for a single shot. Added in Location 1.5.0. */
    QAPI_LOCATION_ERROR_THRESHOLD_REACHED,        /**< GTP 2.0 threshold reached. Added in Location 1.5.0. */
