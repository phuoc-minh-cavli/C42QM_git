...
export DAM_INC_BASE="../MDM_LTE_IOT_SW.SDK_2.0/meta_51/SDK/common/include"
export DAM_LIB_PATH="../MDM_LTE_IOT_SW.SDK_2.0/meta_51/SDK/common/libs"
export DAM_SRC_PATH="./src"

export DEMO_APP_SRC_PATH="./src"
export DEMO_APP_INC_PATH="./inc"
...
export DAM_ELF_NAME="concurrency_demo.elf"
export DAM_TARGET_BIN="concurrency_demo.bin"
export DAM_MAP_NAME="concurrency_demo.map"
...
export DAM_CPPFLAGS="-DQAPI_TXM_MODULE -DTXM_MODULE -DTX_DAM_QC_CUSTOMIZATIONS -DTX_ENABLE_PROFILING -DTX_ENABLE_EVENT_TRACE -DTX_DISABLE_NOTIFY_CALLBACKS  -DFX_FILEX_PRESENT -DTX_ENABLE_IRQ_NESTING  -DTX3_CHANGES  -DENABLE_DM_LOG_INFO  -DENABLE_DM_LOG_ERR  -DENABLE_TRACKER_INFO  -DTRACKER_REF_APP"
...
export DAM_APP_INCPATHS="-I $DEMO_APP_INC_PATH -I $DEMO_APP_SRC_PATH $DAM_INCPATHS"
