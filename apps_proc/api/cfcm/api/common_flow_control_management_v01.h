...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/cfcm/api/common_flow_control_management_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
typedef enum {
  ...
  QMI_CFCM_BUS_BW_NO_THROTTLE_V01 = 0, /**<  NO_THROTTLING_LEVEL.  */
  QMI_CFCM_BUS_BW_MED_THROTTLE_V01 = 1, /**<  MEDIUM_THROTTLING_LEVEL. \n  */
  QMI_CFCM_BUS_BW_HIGH_THROTTLE_V01 = 2, /**<  HIGH_THROTTLING_LEVEL. \n  */
  QMI_CFCM_BUS_BW_CRITICAL_THROTTLE_V01 = 3, /**<  CRITICAL_THROTTLING_LEVEL. \n  */
...
/** @addtogroup cfcm_qmi_messages
    @{
  */
/** Request Message; Set the specified bus BW throttling level. */
typedef struct {

  /* Mandatory */
  /*  BW Throttling Level */
  qmi_cfcm_bus_bw_throttle_level_enum_type_v01 bus_bw_throttling_level;
  /**<   BW throttling level. Values: 
       @ENUM
  */
...
/** @addtogroup cfcm_qmi_messages
    @{
  */
/** Response Message; Set the specified bus BW throttling level. */
typedef struct {
...
/** @addtogroup cfcm_qmi_messages
    @{
  */
/** Response Message; Gets the specified bus BW throttling level. */
typedef struct {
  ...
  qmi_cfcm_bus_bw_throttle_level_enum_type_v01 bus_bw_throttling_level;
  /**<   Bus BW throttling level.  Values: 
       @ENUM
  */
