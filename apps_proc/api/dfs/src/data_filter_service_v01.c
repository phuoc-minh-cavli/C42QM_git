...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/dfs/src/data_filter_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const qmi_idl_service_message_table_entry dfs_service_command_messages_v01[] = {
  ...
  {QMI_DFS_REMOVE_MO_EXCEPTIONAL_FILTERS_REQ_V01, QMI_IDL_TYPE16(0, 42), 1024},
  {QMI_DFS_ADD_MO_EXCEPTIONAL_FILTERS_REQ_V01, QMI_IDL_TYPE16(0, 44), 36979}
};
...
static const qmi_idl_service_message_table_entry dfs_service_response_messages_v01[] = {
  ...
  {QMI_DFS_REMOVE_MO_EXCEPTIONAL_FILTERS_RESP_V01, QMI_IDL_TYPE16(0, 43), 7},
  {QMI_DFS_ADD_MO_EXCEPTIONAL_FILTERS_RESP_V01, QMI_IDL_TYPE16(0, 45), 3075}
};
