...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/loc_iot/src/location_service_iot_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t qmiLocQueryXtraInfoIndMsgT_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiLocQueryXtraInfoIndMsgT_v02, xtraFileDurationHrs) - QMI_IDL_OFFSET16RELATIVE(qmiLocQueryXtraInfoIndMsgT_v02, xtraFileDurationHrs_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiLocQueryXtraInfoIndMsgT_v02, xtraFileDurationHrs)
};
...
static const uint8_t qmiLocGetWwanDataReqMsgT_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetWwanDataReqMsgT_v02, reqType) - QMI_IDL_OFFSET8(qmiLocGetWwanDataReqMsgT_v02, reqType_valid)),
  0x10,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetWwanDataReqMsgT_v02, reqType)
};
...
static const uint8_t qmiLocGetWwanDataIndMsgT_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetWwanDataIndMsgT_v02, dataBuffer) - QMI_IDL_OFFSET8(qmiLocGetWwanDataIndMsgT_v02, dataBuffer_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiLocGetWwanDataIndMsgT_v02, reqType) - QMI_IDL_OFFSET16RELATIVE(qmiLocGetWwanDataIndMsgT_v02, reqType_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiLocGetWwanDataIndMsgT_v02, reqType),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qmiLocGetWwanDataIndMsgT_v02, reqStatus) - QMI_IDL_OFFSET16RELATIVE(qmiLocGetWwanDataIndMsgT_v02, reqStatus_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(qmiLocGetWwanDataIndMsgT_v02, reqStatus)
};
...
static const uint8_t qmiLocEventInitiatePosReqIndMsgT_data_v02[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, posRequester) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, posRequester_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, posRequester),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, requestedPosType) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, requestedPosType_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, requestedPosType),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracyLevel) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracyLevel_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracyLevel),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, positionReportTimeout) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, positionReportTimeout_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, positionReportTimeout),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, minInterval) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, minInterval_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, minInterval),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracy) - QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracy_valid)),
  0x15,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiLocEventInitiatePosReqIndMsgT_v02, horizontalAccuracy)
};

static const uint8_t qmiLocGetApsDataReqMsgT_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, requestType),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, timeOut) - QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, timeOut_valid)),
  0x10,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, timeOut),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, maxNumOfCells) - QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, maxNumOfCells_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, maxNumOfCells),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, channelEstimateBW) - QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, channelEstimateBW_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, channelEstimateBW),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, numCrsSubframes) - QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, numCrsSubframes_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataReqMsgT_v02, numCrsSubframes)
};

static const uint8_t qmiLocGetApsDataIndMsgT_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataIndMsgT_v02, status),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataIndMsgT_v02, moreData),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiLocGetApsDataIndMsgT_v02, bufferData),
  ((QMI_LOC_APS_BUFFER_DATA_MAX_LENGTH_V02) & 0xFF), ((QMI_LOC_APS_BUFFER_DATA_MAX_LENGTH_V02) >> 8),
  QMI_IDL_OFFSET8(qmiLocGetApsDataIndMsgT_v02, bufferData) - QMI_IDL_OFFSET8(qmiLocGetApsDataIndMsgT_v02, bufferData_len)
};

static const uint8_t qmiLocCancelApsDataReqMsgT_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmiLocCancelApsDataReqMsgT_v02, requester)
};
...
static const qmi_idl_message_table_entry loc_iot_message_table_v02[] = {
  ...
  {sizeof(qmiLocEventInitiatePosReqIndMsgT_v02), qmiLocEventInitiatePosReqIndMsgT_data_v02},
  {sizeof(qmiLocGetApsDataReqMsgT_v02), qmiLocGetApsDataReqMsgT_data_v02},
  {sizeof(qmiLocGetApsDataIndMsgT_v02), qmiLocGetApsDataIndMsgT_data_v02},
  {sizeof(qmiLocCancelApsDataReqMsgT_v02), qmiLocCancelApsDataReqMsgT_data_v02}
};
...
static const qmi_idl_service_message_table_entry loc_iot_service_command_messages_v02[] = {
  ...
  {QMI_LOC_START_REQ_V02, QMI_IDL_TYPE16(0, 5), 77},
  {QMI_LOC_STOP_REQ_V02, QMI_IDL_TYPE16(0, 6), 4},
  {QMI_LOC_GET_SERVICE_REVISION_REQ_V02, QMI_IDL_TYPE16(0, 14), 0},
  {QMI_LOC_GET_FIX_CRITERIA_REQ_V02, QMI_IDL_TYPE16(0, 16), 0},
  {QMI_LOC_GET_PREDICTED_ORBITS_DATA_SOURCE_REQ_V02, QMI_IDL_TYPE16(0, 18), 0},
  {QMI_LOC_GET_PREDICTED_ORBITS_DATA_VALIDITY_REQ_V02, QMI_IDL_TYPE16(0, 20), 0},
  {QMI_LOC_INJECT_UTC_TIME_REQ_V02, QMI_IDL_TYPE16(0, 22), 18},
  {QMI_LOC_INJECT_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 24), 540},
  {QMI_LOC_SET_XTRA_T_SESSION_CONTROL_REQ_V02, QMI_IDL_TYPE16(0, 26), 4},
  {QMI_LOC_GET_XTRA_T_SESSION_CONTROL_REQ_V02, QMI_IDL_TYPE16(0, 28), 0},
  {QMI_LOC_GET_REGISTERED_EVENTS_REQ_V02, QMI_IDL_TYPE16(0, 30), 0},
  {QMI_LOC_SET_POSITION_ENGINE_CONFIG_PARAMETERS_REQ_V02, QMI_IDL_TYPE16(0, 32), 16},
  {QMI_LOC_GET_POSITION_ENGINE_CONFIG_PARAMETERS_REQ_V02, QMI_IDL_TYPE16(0, 34), 7},
  {QMI_LOC_ADD_CIRCULAR_GEOFENCE_REQ_V02, QMI_IDL_TYPE16(0, 36), 70},
  {QMI_LOC_DELETE_GEOFENCE_REQ_V02, QMI_IDL_TYPE16(0, 38), 14},
  {QMI_LOC_GET_BEST_AVAILABLE_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 44), 7},
  {QMI_LOC_INJECT_GSM_CELL_INFO_REQ_V02, QMI_IDL_TYPE16(0, 46), 30},
  {QMI_LOC_SET_GEOFENCE_ENGINE_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 40), 224},
  {QMI_LOC_GET_GEOFENCE_ENGINE_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 42), 7},
  {QMI_LOC_GET_BATCH_SIZE_REQ_V02, QMI_IDL_TYPE16(0, 48), 21},
  {QMI_LOC_START_BATCHING_REQ_V02, QMI_IDL_TYPE16(0, 50), 39},
  {QMI_LOC_READ_FROM_BATCH_REQ_V02, QMI_IDL_TYPE16(0, 53), 21},
  {QMI_LOC_STOP_BATCHING_REQ_V02, QMI_IDL_TYPE16(0, 55), 21},
  {QMI_LOC_RELEASE_BATCH_REQ_V02, QMI_IDL_TYPE16(0, 57), 14},
  {QMI_LOC_GET_AVAILABLE_WWAN_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 59), 22},
  {QMI_LOC_SET_PREMIUM_SERVICES_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 61), 14},
  {QMI_LOC_SET_XTRA_VERSION_CHECK_REQ_V02, QMI_IDL_TYPE16(0, 63), 7},
  {QMI_LOC_SET_GNSS_CONSTELL_REPORT_CONFIG_V02, QMI_IDL_TYPE16(0, 65), 30},
  {QMI_LOC_INJECT_GTP_CLIENT_DOWNLOADED_DATA_REQ_V02, QMI_IDL_TYPE16(0, 67), 517},
  {QMI_LOC_START_DBT_REQ_V02, QMI_IDL_TYPE16(0, 69), 36},
  {QMI_LOC_STOP_DBT_REQ_V02, QMI_IDL_TYPE16(0, 71), 4},
  {QMI_LOC_QUERY_AON_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 76), 7},
  {QMI_LOC_DELETE_GNSS_SERVICE_DATA_REQ_V02, QMI_IDL_TYPE16(0, 78), 36},
  {QMI_LOC_INJECT_XTRA_DATA_REQ_V02, QMI_IDL_TYPE16(0, 80), 1053},
  {QMI_LOC_INJECT_XTRA_PCID_REQ_V02, QMI_IDL_TYPE16(0, 82), 11},
  {QMI_LOC_GET_SUPPORTED_FEATURE_REQ_V02, QMI_IDL_TYPE16(0, 84), 0},
  {QMI_LOC_QUERY_XTRA_INFO_REQ_V02, QMI_IDL_TYPE16(0, 86), 7},
  {QMI_LOC_START_OUTDOOR_TRIP_BATCHING_REQ_V02, QMI_IDL_TYPE16(0, 88), 25},
  {QMI_LOC_QUERY_OTB_ACCUMULATED_DISTANCE_REQ_V02, QMI_IDL_TYPE16(0, 90), 0},
  {QMI_LOC_GET_FDCL_BS_LIST_REQ_V02, QMI_IDL_TYPE16(0, 93), 5},
  {QMI_LOC_INJECT_FDCL_DATA_REQ_V02, QMI_IDL_TYPE16(0, 95), 4467},
  {QMI_LOC_START_LISTEN_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 97), 0},
  {QMI_LOC_STOP_LISTEN_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 98), 0},
  {QMI_LOC_SYSTEM_INFO_REQ_V02, QMI_IDL_TYPE16(0, 99), 7},
  {QMI_LOC_GET_CONSTELLATION_CONTROL_REQ_V02, QMI_IDL_TYPE16(0, 0), 0},
  {QMI_LOC_ENABLE_POSITION_INJECTION_TEST_MODE_REQ_V02, QMI_IDL_TYPE16(0, 102), 4},
  {QMI_LOC_INJECT_TEST_POSITION_REQ_V02, QMI_IDL_TYPE16(0, 104), 47},
  {QMI_LOC_GET_BS_OBS_DATA_REQ_V02, QMI_IDL_TYPE16(0, 107), 5},
  {QMI_LOC_GET_LOCATION_BACKOFF_PERIOD_REQ_V02, QMI_IDL_TYPE16(0, 111), 7},
  {QMI_LOC_QUERY_GNSS_ENERGY_CONSUMED_REQ_V02, QMI_IDL_TYPE16(0, 113), 0},
  {QMI_LOC_GET_WWAN_DATA_REQ_V02, QMI_IDL_TYPE16(0, 116), 21},
  {QMI_LOC_SET_CONSTELLATION_CONTROL_REQ_V02, QMI_IDL_TYPE16(0, 119), 26},
  {QMI_LOC_SET_ROBUST_LOCATION_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 118), 8},
  {QMI_LOC_GET_ROBUST_LOCATION_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 0), 0},
  {QMI_LOC_GET_APS_DATA_REQ_V02, QMI_IDL_TYPE16(0, 122), 27},
  {QMI_LOC_CANCEL_APS_DATA_REQ_V02, QMI_IDL_TYPE16(0, 124), 4}
};
...
static const qmi_idl_service_message_table_entry loc_iot_service_response_messages_v02[] = {
  ...
  {QMI_LOC_GET_APS_DATA_RESP_V02, QMI_IDL_TYPE16(0, 1), 7},
  {QMI_LOC_CANCEL_APS_DATA_RESP_V02, QMI_IDL_TYPE16(0, 1), 7}
};

static const qmi_idl_service_message_table_entry loc_iot_service_indication_messages_v02[] = {
  {QMI_LOC_EVENT_POSITION_REPORT_IND_V02, QMI_IDL_TYPE16(0, 7), 2419},
  {QMI_LOC_EVENT_INJECT_TIME_REQ_IND_V02, QMI_IDL_TYPE16(0, 8), 776},
  {QMI_LOC_EVENT_INJECT_PREDICTED_ORBITS_REQ_IND_V02, QMI_IDL_TYPE16(0, 9), 783},
  {QMI_LOC_EVENT_ENGINE_STATE_IND_V02, QMI_IDL_TYPE16(0, 10), 7},
  {QMI_LOC_EVENT_FIX_SESSION_STATE_IND_V02, QMI_IDL_TYPE16(0, 11), 11},
  {QMI_LOC_GET_SERVICE_REVISION_IND_V02, QMI_IDL_TYPE16(0, 15), 532},
  {QMI_LOC_GET_FIX_CRITERIA_IND_V02, QMI_IDL_TYPE16(0, 17), 64},
  {QMI_LOC_GET_PREDICTED_ORBITS_DATA_SOURCE_IND_V02, QMI_IDL_TYPE16(0, 19), 790},
  {QMI_LOC_GET_PREDICTED_ORBITS_DATA_VALIDITY_IND_V02, QMI_IDL_TYPE16(0, 21), 20},
  {QMI_LOC_INJECT_UTC_TIME_IND_V02, QMI_IDL_TYPE16(0, 23), 7},
  {QMI_LOC_INJECT_POSITION_IND_V02, QMI_IDL_TYPE16(0, 25), 7},
  {QMI_LOC_SET_XTRA_T_SESSION_CONTROL_IND_V02, QMI_IDL_TYPE16(0, 27), 7},
  {QMI_LOC_GET_XTRA_T_SESSION_CONTROL_IND_V02, QMI_IDL_TYPE16(0, 29), 11},
  {QMI_LOC_GET_REGISTERED_EVENTS_IND_V02, QMI_IDL_TYPE16(0, 31), 18},
  {QMI_LOC_SET_POSITION_ENGINE_CONFIG_PARAMETERS_IND_V02, QMI_IDL_TYPE16(0, 33), 14},
  {QMI_LOC_GET_POSITION_ENGINE_CONFIG_PARAMETERS_IND_V02, QMI_IDL_TYPE16(0, 35), 23},
  {QMI_LOC_EVENT_GEOFENCE_GEN_ALERT_IND_V02, QMI_IDL_TYPE16(0, 12), 7},
  {QMI_LOC_EVENT_GEOFENCE_BREACH_NOTIFICATION_IND_V02, QMI_IDL_TYPE16(0, 13), 85},
  {QMI_LOC_ADD_CIRCULAR_GEOFENCE_IND_V02, QMI_IDL_TYPE16(0, 37), 21},
  {QMI_LOC_DELETE_GEOFENCE_IND_V02, QMI_IDL_TYPE16(0, 39), 21},
  {QMI_LOC_GET_BEST_AVAILABLE_POSITION_IND_V02, QMI_IDL_TYPE16(0, 45), 2200},
  {QMI_LOC_INJECT_GSM_CELL_INFO_IND_V02, QMI_IDL_TYPE16(0, 47), 7},
  {QMI_LOC_SET_GEOFENCE_ENGINE_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 41), 14},
  {QMI_LOC_GET_GEOFENCE_ENGINE_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 43), 39},
  {QMI_LOC_GET_BATCH_SIZE_IND_V02, QMI_IDL_TYPE16(0, 49), 21},
  {QMI_LOC_START_BATCHING_IND_V02, QMI_IDL_TYPE16(0, 51), 14},
  {QMI_LOC_EVENT_BATCH_FULL_NOTIFICATION_IND_V02, QMI_IDL_TYPE16(0, 52), 28},
  {QMI_LOC_READ_FROM_BATCH_IND_V02, QMI_IDL_TYPE16(0, 54), 460},
  {QMI_LOC_STOP_BATCHING_IND_V02, QMI_IDL_TYPE16(0, 56), 21},
  {QMI_LOC_RELEASE_BATCH_IND_V02, QMI_IDL_TYPE16(0, 58), 14},
  {QMI_LOC_GET_AVAILABLE_WWAN_POSITION_IND_V02, QMI_IDL_TYPE16(0, 60), 145},
  {QMI_LOC_SET_PREMIUM_SERVICES_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 62), 7},
  {QMI_LOC_SET_XTRA_VERSION_CHECK_IND_V02, QMI_IDL_TYPE16(0, 64), 7},
  {QMI_LOC_SET_GNSS_CONSTELL_REPORT_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 66), 7},
  {QMI_LOC_INJECT_GTP_CLIENT_DOWNLOADED_DATA_IND_V02, QMI_IDL_TYPE16(0, 68), 7},
  {QMI_LOC_START_DBT_IND_V02, QMI_IDL_TYPE16(0, 70), 11},
  {QMI_LOC_EVENT_DBT_POSITION_REPORT_IND_V02, QMI_IDL_TYPE16(0, 73), 2074},
  {QMI_LOC_EVENT_DBT_SESSION_STATUS_IND_V02, QMI_IDL_TYPE16(0, 74), 11},
  {QMI_LOC_STOP_DBT_IND_V02, QMI_IDL_TYPE16(0, 72), 11},
  {QMI_LOC_EVENT_BATCHING_STATUS_IND_V02, QMI_IDL_TYPE16(0, 75), 7},
  {QMI_LOC_QUERY_AON_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 77), 21},
  {QMI_LOC_DELETE_GNSS_SERVICE_DATA_IND_V02, QMI_IDL_TYPE16(0, 79), 7},
  {QMI_LOC_INJECT_XTRA_DATA_IND_V02, QMI_IDL_TYPE16(0, 81), 23},
  {QMI_LOC_INJECT_XTRA_PCID_IND_V02, QMI_IDL_TYPE16(0, 83), 7},
  {QMI_LOC_GET_SUPPORTED_FEATURE_IND_V02, QMI_IDL_TYPE16(0, 85), 111},
  {QMI_LOC_QUERY_XTRA_INFO_IND_V02, QMI_IDL_TYPE16(0, 87), 1587},
  {QMI_LOC_START_OUTDOOR_TRIP_BATCHING_IND_V02, QMI_IDL_TYPE16(0, 89), 7},
  {QMI_LOC_QUERY_OTB_ACCUMULATED_DISTANCE_IND_V02, QMI_IDL_TYPE16(0, 91), 21},
  {QMI_LOC_EVENT_FDCL_SERVICE_REQ_IND_V02, QMI_IDL_TYPE16(0, 92), 692},
  {QMI_LOC_GET_FDCL_BS_LIST_IND_V02, QMI_IDL_TYPE16(0, 94), 4296},
  {QMI_LOC_INJECT_FDCL_DATA_IND_V02, QMI_IDL_TYPE16(0, 96), 272},
  {QMI_LOC_SYSTEM_INFO_IND_V02, QMI_IDL_TYPE16(0, 100), 35},
  {QMI_LOC_GET_CONSTELLATION_CONTROL_IND_V02, QMI_IDL_TYPE16(0, 101), 42},
  {QMI_LOC_ENABLE_POSITION_INJECTION_TEST_MODE_IND_V02, QMI_IDL_TYPE16(0, 103), 14},
  {QMI_LOC_INJECT_TEST_POSITION_IND_V02, QMI_IDL_TYPE16(0, 105), 7},
  {QMI_LOC_EVENT_BS_OBS_DATA_SERVICE_REQ_IND_V02, QMI_IDL_TYPE16(0, 106), 5},
  {QMI_LOC_GET_BS_OBS_DATA_IND_V02, QMI_IDL_TYPE16(0, 108), 775},
  {QMI_LOC_EVENT_REPORT_IND_V02, QMI_IDL_TYPE16(0, 109), 11},
  {QMI_LOC_EVENT_NMEA_IND_V02, QMI_IDL_TYPE16(0, 110), 4301},
  {QMI_LOC_GET_LOCATION_BACKOFF_PERIOD_IND_V02, QMI_IDL_TYPE16(0, 112), 28},
  {QMI_LOC_QUERY_GNSS_ENERGY_CONSUMED_IND_V02, QMI_IDL_TYPE16(0, 114), 22},
  {QMI_LOC_EVENT_GNSS_SV_INFO_IND_V02, QMI_IDL_TYPE16(0, 115), 3768},
  {QMI_LOC_GET_WWAN_DATA_IND_V02, QMI_IDL_TYPE16(0, 117), 4026},
  ...
  {QMI_LOC_GET_ROBUST_LOCATION_CONFIG_IND_V02, QMI_IDL_TYPE16(0, 120), 21},
  {QMI_LOC_EVENT_INITIATE_POS_REQ_IND_V02, QMI_IDL_TYPE16(0, 121), 40},
  {QMI_LOC_GET_APS_DATA_IND_V02, QMI_IDL_TYPE16(0, 123), 1040},
  {QMI_LOC_CANCEL_APS_DATA_IND_V02, QMI_IDL_TYPE16(0, 2), 7}
};
