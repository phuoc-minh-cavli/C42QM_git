...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/wds_ext/src/wireless_data_service_ext_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t wds_ext_route_look_up_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_ext_route_look_up_req_msg_v01, mo_exceptional_data_capability) - QMI_IDL_OFFSET8(wds_ext_route_look_up_req_msg_v01, mo_exceptional_data_capability_valid)),
  0x35,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry wds_ext_service_command_messages_v01[] = {
  ...
  {QMI_WDS_EXT_ROUTE_LOOK_UP_REQ_V01, QMI_IDL_TYPE16(0, 0), 178}
};
