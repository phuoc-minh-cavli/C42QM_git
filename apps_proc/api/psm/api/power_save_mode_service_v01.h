 ...
 */
  ...
  /* Optional */
  /*  High Shock Duration  */
  uint8_t high_shock_duration_valid;  /**< Must be set to true if high_shock_duration is being passed */
  float high_shock_duration;

  /* Optional */
  /*  Free Fall Height  */
  uint8_t free_fall_height_valid;  /**< Must be set to true if free_fall_height is being passed */
  float free_fall_height;

  /* Optional */
  /*  Sensor Flight Status Timestamp */
  uint8_t fmd_data_timestamp_valid;  /**< Must be set to true if fmd_data_timestamp is being passed */
  uint64_t fmd_data_timestamp;

  /* Optional */
  /*  Sensor Tilt Angle Timestamp */
  uint8_t tilt_data_timestamp_valid;  /**< Must be set to true if tilt_data_timestamp is being passed */
  uint64_t tilt_data_timestamp;

  /* Optional */
  /*  Sensor Motion Change Detector Timestamp */
  uint8_t mcd_data_timestamp_valid;  /**< Must be set to true if mcd_data_timestamp is being passed */
  uint64_t mcd_data_timestamp;

  /* Optional */
  /*  Free Fall Height Timestamp */
  uint8_t free_fall_data_timestamp_valid;  /**< Must be set to true if free_fall_data_timestamp is being passed */
  uint64_t free_fall_data_timestamp;
 ...
 */
  ...
  /* Optional */
  /*  Data Ready  */
  uint8_t data_ready_valid;  /**< Must be set to true if data_ready is being passed */
  uint8_t data_ready;
  /**<   Indicates that the sensor data is ready.
       - 0x00 -- TRUE \n
       - 0x01 -- FALSE
  */
