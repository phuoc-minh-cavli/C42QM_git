...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/ssreq/api/subsystem_request_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.7 
   It was generated on: Tue Apr  1 2014 (Spin 0)
...
#define SSREQ_V01_IDL_MINOR_VERS 0x00
...
typedef enum {
  ...
  SSREQ_QMI_CLIENT_INSTANCE_APSS_0_V01 = 0, 
  SSREQ_QMI_CLIENT_INSTANCE_MPSS_0_V01 = 1, 
  SSREQ_QMI_CLIENT_INSTANCE_WCNSS_0_V01 = 2, 
  SSREQ_QMI_CLIENT_INSTANCE_ADSP_0_V01 = 3, 
  SSREQ_QMI_CLIENT_INSTANCE_VPU_0_V01 = 4, 
  SSREQ_QMI_CLIENT_INSTANCE_MDM_0_V01 = 5, 
  SSREQ_QMI_CLIENT_INSTANCE_MDM_1_V01 = 6, 
  SSREQ_QMI_CLIENT_INSTANCE_QSC_0_V01 = 7, 
