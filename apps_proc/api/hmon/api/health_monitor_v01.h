...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/hmon/api/health_monitor_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.10 
   It was generated on: Wed Jul 23 2014 (Spin 0)
...
typedef struct {
  ...
  uint32_t timeout;
  /**<   Timeout the Health Monitor Service should use before restarting
       this subsystem in milliseconds */
...
/** @addtogroup hmon_qmi_messages
    @{
  */
/** Request Message; Sent once a requested health check has been completed. */
typedef struct {
  ...
  /**<   Optional result to let the Health Monitor Service know
       if it needs to take any action on this subsystem. If
       this TLV is not present the Health Monitor Service will
       assume success. */
...
/** @addtogroup hmon_qmi_messages
    @{
  */
/** Response Message; Sent once a requested health check has been completed. */
typedef struct {
