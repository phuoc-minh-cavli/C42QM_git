...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.tx/1.0/dsd/src/data_system_determination_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t dsd_set_wqe_profile_quality_status_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, quality_status) - QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, quality_status_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry dsd_service_command_messages_v01[] = {
  ...
  {QMI_DSD_SET_WQE_PROFILE_QUALITY_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 63), 14},
