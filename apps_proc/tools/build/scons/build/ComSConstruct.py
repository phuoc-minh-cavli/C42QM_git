...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.qc/1.1/build/ComSConstruct.py#10 $
#  $DateTime: 2019/01/07 23:26:02 $
#  $Author: pwbldsvc $
#  $Change: 17992710 $
...
def generate(env):
    ...
    actionLogTimeObj = env.GetLogTimeObj("Action-Phase")

    env["ACTION_LOG_START"] = True
    def capture_action_log(node):
