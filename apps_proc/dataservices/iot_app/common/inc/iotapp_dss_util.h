...
/**
 * Skip retrying data call based on configured CE reason 
 */
enum iot_dss_skip_call_retry_ce_reason 
{
  IOT_DSS_SKIP_CALL_RETRY_CE_REASON_NONE, 
  IOT_DSS_SKIP_CALL_RETRY_CE_REASON_V4_0R_V6_CALL_DISALLOWED,
};
...
iot_dss_call_hndl_t iot_dss_register(iot_dss_regparams_t *params);
 ...
 /**
 * @brief Deregister IOT DSS handleer
...
/**
 * @brief This function is used to get mtu for a particular datacall
 * @param callhdl IOT DSS handle
 * @param[out] mtu MTU
 * @return On success 0, on failure -1
 */
int iot_dss_get_mtu_by_hndl(iot_dss_call_hndl_t callhdl,  uint32_t* mtu_size);
...
int iot_dss_get_event_by_hndl(iot_dss_call_hndl_t callhdl,  qapi_DSS_Net_Evt_t* event);
#endif
