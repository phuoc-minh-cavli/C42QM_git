...
2019-06-26 baohan (Tech Comm) Edited/added Doxygen comments and markup.
===========================================================================*/
 ...
 *
 * This function is invoked to start or restart the HTTP client after it is
 *          stopped via a call to qapi_Net_HTTPc_Stop().
 *
 * @return On success, 0 is returned. Other value on error. @newpage
 */
 ...
 *
 * This function is invoked to stop the HTTP client after it was started via 
 ...
 *
 * To create a client session, the caller must invoke this function 
 ...
 *
 * @return On success, qapi_Net_HTTPc_handle_t is returned. NULL otherwise. @newpage
 */
 ...
 *
 * An HTTP client session that is connected to the HTTP server is disconnected 
 ...
 *
 * The HTTP client session that is connected to the HTTP server is disconnected 
 ...
 *
 * Multiple invocations of this function will result in overwriting the 
 ...
 *
 * Multiple invocations of this function will result in appending the 
 ...
 *
 * Invocation of this function clears the entire content associated 
