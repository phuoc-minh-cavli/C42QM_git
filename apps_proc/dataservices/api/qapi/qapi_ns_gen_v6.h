...
#define  TXM_QAPI_NET_PING6_3                           TXM_QAPI_NET_BASE + 24
...
typedef struct
{
    ...
    /**< Array of type #qapi_Net_IPv6_Route_t. @newpagetable */
...
#define qapi_Net_Ping6_3(a,b)                                ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_NET_PING6_3                     , (ULONG) a, (ULONG) b, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
...
* @param [in]      ping6_buf    Pointer to IPv6 ping structure. The structure will
                               ...
                               to send the ping via this source, the number of data bytes to send, 
                               the Ping request timeout value (in ms), and when pinging an IPv6 
                               link local address interface, a name is required.
