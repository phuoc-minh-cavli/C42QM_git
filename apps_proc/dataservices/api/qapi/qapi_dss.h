...
#define  TXM_QAPI_DSS_SET_DATA_TRANSFER_STATUS     TXM_QAPI_DSS_BASE + 22
#define  TXM_QAPI_DSS_GET_LINK_MTU_PER_FAMILY      TXM_QAPI_DSS_BASE + 23
#define  TXM_QAPI_DSS_SET_DATA_TRANSFER_STATUS_v2  TXM_QAPI_DSS_BASE + 24
...
#define QAPI_DSS_RADIO_TECH_DO      0x00000008                 /**< Data optimized. */
...
/** Subsequent uplink and downlink data transfer information. */
#define QAPI_DSS_TRANSFER_STATUS_NO_INFO_AVAIL             0x00 /**< No information available. */
#define QAPI_DSS_TRANSFER_STATUS_NO_UPLINK_DOWNLINK_DATA   0x01 /**< No further uplink or downlink data transmission. */
#define QAPI_DSS_TRANSFER_STATUS_SINGLE_DOWNLINK_DATA      0x02 /**< Only a single downlink transmission and no further uplink data. */
...
/** @name Transfer status related 
@{ */

#define QAPI_WDS_SET_TRANSFER_STATUS_BUF_SIZE 128            /**< Transfers status buffer size. */
#define QAPI_WDS_STATUS_TRANSFER_MAX_ID 0x7fffffff           /**< Transfers status maximum ID. */
...
typedef enum qapi_DSS_IP_Family_e
{
  ...
  QAPI_DSS_NUM_IP_FAMILIES_E	  /**< @newpage */
...
typedef enum qapi_DSS_Call_Tech_Type_e
{
  ...
  QAPI_DSS_CALL_TECH_UMTS_E           /**< UMTS. @newpage */
...
typedef struct qapi_DSS_Addr_Info_s
{
  ...
  qapi_DSS_Addr_t   dnss_addr_s;  /**< Secondary DNS server address. @newpagetable*/
...
typedef struct qapi_DSS_IPv4_Filter_TOS_Type_s
{
  ...
  uint8_t mask; /**< Type of service mask. @newpagetable */
...
typedef struct qapi_DSS_IPv6_Filter_Traffic_Type_s
{
  ...
  uint8_t mask; /**< Traffic class mask. @newpagetable */
...
typedef struct qapi_DSS_IP_Header_Filters_s
{
  ...
  qapi_DSS_IPv6_Filter_Info_t v6_info; /**< Filter parameters for IPv6. @newpagetable */
...
typedef struct qapi_DSS_IPSec_Info_Filter_Type_s
{
  ...
  uint32_t spi;   /**< Security parameter index for IPSec. @newpagetable */
...
typedef struct qapi_DSS_Filter_Rule_Type_s 
{
  ...
  qapi_DSS_Xport_Header_Filters_t xport_info; /**< Transport level protocol filter parameters. @newpagetable */
} /** @cond */qapi_DSS_Filter_Rule_Type_t/** @endcond */; 


/** Transfer status information types. */
typedef enum {
 QAPI_SET_STATUS_INFO_TYPE_BOOLEAN_E,
 /**< Request type is Boolean. */
 QAPI_SET_STATUS_TYPE_INTEGER_E,
 /**< Request type is integer. */
 QAPI_SET_STATUS_INFO_TYPE_BUFFER_E,
 /**< Request type is buffer. */
 QAPI_SET_STATUS_INFO_TYPE_DOUBLE_E,
 /**< Request type is array. */
} /** @cond */QAPI_Set_Transfer_Status_Info_Type_t/** @endcond */;

/** Transfer status ID. */
typedef enum {
  QAPI_SET_TRANSFER_STATUS_INVALID = 0x00,        /**< Invalid ID. */
  QAPI_SET_TRANSFER_STATUS_RAI = 0x01 ,           /**< Status ID for RAI Indication. */
  QAPI_SET_NEXT_ACTIVITY_TIMER = 0x02,            /**< Status ID for Next Activity Timer. */
  QAPI_SET_TRANSFER_STATUS_MAX_ID = QAPI_WDS_STATUS_TRANSFER_MAX_ID,
} /** @cond */qapi_Set_Transfer_Status_ID_t/** @endcond */;

/** Transfer status information. */
typedef struct {
  qapi_Set_Transfer_Status_ID_t id; /**< Set_Transfer_Status_ID. */ 
  QAPI_Set_Transfer_Status_Info_Type_t info_type; /**< Set_Transfer_Status_Info_Type. */ 
/** Union of values. */
  union {
/** Union of buffer values. */
    struct {
      char buf[QAPI_WDS_SET_TRANSFER_STATUS_BUF_SIZE]; /**< Request buffer. */
      uint32_t len; /**< Length of the request string. */
    }valuebuf;    
    int64_t valueint; /**< Requests integer value. */
    bool valuebool; /**< Requests Boolean value.*/
	double valuedouble; /**<Requests double values . @newpagetable */
  }u; /**< Union of DSS transfer status values. */
} /** @cond */qapi_Set_transfer_Status_Info_t/** @endcond */;
...
{
  uint8_t filter_handles_valid;  /**< Set to TRUE if filter handles are being passed.Filter handles will be passed if atleast one of the filter rules got added. */
  uint32_t filter_handles_len;   /**< Set to the number of filter rules that got added. */
  uint32_t filter_handles[QAPI_DSS_MAX_EXCEPTION_FILTERS]; /**< List of handles that uniquely identify added filter rules.Filter handles will be present at indices corresponding to filter rules. */
  uint8_t filter_rule_error_valid;  /**< Set to TRUE if any filter rule errors are being passed.Filter errors will be passed if any of the filter rules didn't got added. */
  uint32_t filter_rule_error_len;  /**< Set to the number of filter rules that didn't got added. */
  qapi_DSS_MO_Filter_Error_Mask_t filter_rule_error[QAPI_DSS_MAX_EXCEPTION_FILTERS]; /**< Error mask list for filter rule errors.Filter errors will be present at indices corresponding to filter rules.  */ 
}/** @cond */qapi_DSS_Add_MO_Exception_Filters_Rsp_t/** @endcond */;

/** APN rate control information. */
typedef struct qapi_DSS_Apn_Rate_Control_Info_s
{
  uint32_t uplink_time_unit;          /**< Represents the time unit that the uplink
  										   data is restricted. */
  uint32_t max_uplink_rate;        /**<   Maximum number of the uplink packets that 
  										  can be sent within the uplink time limit. @newpagetable */
} /** @cond */qapi_DSS_Apn_Rate_Control_Info_t/** @endcond */;
 ...
 * 
 * @note1hang This Macro is only used in DAM Space.
 */
...
#define qapi_DSS_Rel_Data_Srvc_Hndl(a)                    dss_destroy_indirection(a, TXM_QAPI_DSS_REL_DATA_SRVC_HNDL)
...
#define qapi_DSS_Set_Transfer_Status(a,b)                 ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_DSS_SET_DATA_TRANSFER_STATUS     , (ULONG) a, (ULONG) b, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
#define qapi_DSS_Get_Link_Mtu_per_family(a,b,c)           ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_DSS_GET_LINK_MTU_PER_FAMILY      , (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
#define qapi_DSS_Set_Transfer_Status_v2(a,b,c)           ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_DSS_SET_DATA_TRANSFER_STATUS_v2   , (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
...
/** @ingroup qapi_DSS_Get_Data_Srvc_Hndl
    ...
    Any events to the application are forwarded to through the registered 
    application callback. When the application is running in Kernel mode,
    the resources allocated for the event payload need to be released by 
    the application. On the other hand, if the application is running in 
    user space the resources are automatically released when the callback 
    returns. 
...
/** @ingroup qapi_DSS_Get_Link_Mtu
    ...
    Data\_Services 1.3.0  &  Update behavior. @tblendline
    }
    ...
    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] mtu Buffer containing the MTU information. For an IPv4v6 call, if IPv4 and IPv6 have different MTU sizes, the smaller one will be returned.
    ...
    @dependencies
    qapi_DSS_Init() must have been called first. \n
    A valid handle must be obtained by qapi_DSS_Get_Data_Srvc_Hndl(). @newpage
*/
/*=========================================================================*/
...
/*===========================================================================
  FUNCTION:  qapi_DSS_Get_Link_Mtu_per_family
===========================================================================*/
/** 
    @versiontable{2.0,2.45,
    ...
    @ingroup qapi_DSS_Get_Link_Mtu_per_family

    Queries the MTU information associated with the link per_family.

    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[in] ip_family Value defined by qapi_DSS_IP_Family_t.
...
qapi_Status_t qapi_DSS_Get_Link_Mtu_per_family(qapi_DSS_Hndl_t netmgr_hndl,  unsigned int ip_family, unsigned int *mtu);
...
/** @ingroup qapi_DSS_Add_MO_Exception_IPdata_Filters
    ...
    @return
    #QAPI_OK -- Adding filter rules will be successful if atleast one of the filter
               requests get added. 
               \n
    #QAPI_ERROR -- Adding filter rules was unsuccessful.None of the filter request
                  got added.
...
/*===========================================================================
  FUNCTION:  qapi_DSS_Set_Transfer_Status
===========================================================================*/
/** @ingroup qapi_DSS_Set_Transfer_Status

    @versiontable{2.0,2.45,
    Data\_Services 1.2.0  &  Introduced. @tblendline
    }

    Sets the data transmission status

    @param[in] netmgr_hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[in] status data transmission status
...
qapi_Status_t qapi_DSS_Set_Transfer_Status(qapi_DSS_Hndl_t netmgr_hndl,int status);


/*===========================================================================
  FUNCTION:  qapi_DSS_Set_Transfer_Status_v2
===========================================================================*/
/**  @ingroup qapi_DSS_Set_Transfer_Status
    ...
    @param[in] netmgr_hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[in] status_info Contains information to set RAI or NAT.
    @param[in] num_of_elements Total RAI or NAT elements for status information to set .
    ...
    A valid handle must be obtained by qapi_DSS_Get_Data_Srvc_Hndl(). \n 
    QAPI_Information: If user sets NAT,  it is mandatory to set RAI .
                       Only setting NAT will return error .
*/
/*=========================================================================*/


qapi_Status_t qapi_DSS_Set_Transfer_Status_v2(qapi_DSS_Hndl_t netmgr_hndl , qapi_Set_transfer_Status_Info_t * status_info , int num_of_elements);


/*===========================================================================
  FUNCTION:  qapi_DSS_Get_Apn_Rate_Control
===========================================================================*/
/** @ingroup qapi_DSS_Get_Rate_Control

    @versiontable{2.0,2.45,
    Data\_Services 1.5.1  &  Introduced. @tblendline
    }

    Gets APN rate control information.

    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] apn_rate_control APN rate control information.
...
qapi_Status_t qapi_DSS_Get_Apn_Rate_Control(qapi_DSS_Hndl_t hndl, qapi_DSS_Apn_Rate_Control_Info_t *apn_rate_control);


/*===========================================================================
  FUNCTION:  qapi_DSS_Get_Splmn_Rate_Control
===========================================================================*/
/** @ingroup qapi_DSS_Get_Rate_Control
    ...
    @param[in] hndl Handle received from qapi_DSS_Get_Data_Srvc_Hndl().
    @param[out] splmn_rate_control SPLMN rate control information.
...
qapi_Status_t qapi_DSS_Get_Splmn_Rate_Control(qapi_DSS_Hndl_t hndl, uint32_t *splmn_rate_control);
