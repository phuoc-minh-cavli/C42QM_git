...
#define QAPI_ERR_SSL_SOCK __QAPI_ERROR(QAPI_MOD_NETWORKING, 12) /**< Socket error; use qapi_errno() to check the reason code. */
/** @} */
...
/** MQTT subscription failed due to Outstanding request */
...
/** MQTT subscription failed due to bad parameter in Subscription */
...
/** Invalid parameters passed to the CoAP API. */
...
/** Memory Allocation failed in CoAP. */
 ...
 #define QAPI_NET_COAP_BLOCK_SESSION_IN_PROGRESS  ((qapi_Status_t)__QAPI_ERROR(QAPI_MOD_NETWORKING, 107))
