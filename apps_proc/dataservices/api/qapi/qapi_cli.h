...
/**
   ...
   @param parameter_count  Number of parameters that were specified to the CLI for the function.
   @param parameter_list   List of parameters specified to the CLI for the function.
...
* @param [in] command_group  Command group to be registered. \n 
                             Note: This function assumes the command group information will be
