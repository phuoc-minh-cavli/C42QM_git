...
/******************************************************************************
 * Copyright © 2018-2023 Qualcomm Technologies, Inc. and/or its subsidiaries.
 *All rights reserved.
 * \file    qapi_coap.h
...
#define  TXM_QAPI_COAP_SEND_MESSAGE_V2                TXM_QAPI_COAP_BASE2 + 1
#define  TXM_QAPI_COAP_GET_BLOCKWISE_INFO             TXM_QAPI_COAP_BASE2 + 2
#define  TXM_QAPI_COAP_REGISTER_EVENT                 TXM_QAPI_COAP_BASE2 + 3
#define TXM_QAPI_COAP_GET_EXTENDED_CONFIG			  TXM_QAPI_COAP_BASE2 + 4
...
typedef enum {
  ...
  QAPI_COAP_TYPE_RST  /**< Reset. @newpage */
...
typedef enum {
  ...
  QAPI_MEMORY_ALLOCATION_ERROR = 192,        /**< Erbium error. */
  QAPI_PACKET_SERIALIZATION_ERROR,           /**< Erbium error. */

  QAPI_MANUAL_RESPONSE                       /**< Erbium hooks. @newpage */

} qapi_Coap_Status_t;

/*CoAP generic error codes*/
typedef enum{
  QAPI_ERR_COAP_EINVALID_PARAM = 28,						/** Invalid parameters passed to the CoAP API. */
  QAPI_ERR_COAP_ENOMEM = 100, 								/** Memory Allocation failed in CoAP. */
  QAPI_ERR_COAP_HANDLE_NOT_FOUND = 101,						/** Incorrect session handle passed to the CoAP API. */
  QAPI_ERR_COAP_CONNECTION_CREATION_FAILED = 102,  			/** CoAP Create Connection API Failed. */
  QAPI_ERR_COAP_DTLS_RESUMPTION_FAILED_IN_COAP_SEND = 105, 	/** CoAP Message Send API Failed because of failure in DTLS Resumption. */
  QAPI_ERR_COAP_TRANSACTION_CALLBACK_NOT_SET = 106, 		/** CoAP Transaction Callback not set. */
  QAPI_ERR_COAP_BLOCK_SESSION_IN_PROGRESS = 107,
}qapi_Coap_Error_t;
/** CoAP content types. */
typedef enum {
  ...
  QAPI_M2M_JSON = 11543,                    /**< M2M JSON. @newpage */
...
typedef enum {
  QAPI_COAP_BLOCK_OPTION_NONE  = 1,  /**< Without blockwise option. */
...
typedef enum {
   ...
   QAPI_COAP_EXTENDED_CONFIG_BLOCKWISE_HANDLE_DL_BY_COAP,     /**< Extended configuration option that enables 
                                                                   handling of downlink blockwise packets by CoAP.
                                                                   Default value False, i.e., CoAP will not handle. */
   QAPI_COAP_EXTENDED_CONFIG_BLOCKWISE_SESSION_MAX_AGE,       /**< Extended configuration option that sets wait 
                                                                   time before cleanup of an inactive blockwise session. */
   QAPI_COAP_EXTENDED_CONFIG_DTLS_HANDLE_ALERT_WITH_EPOCH_0,  /**< Extended configuration option to accept or discard an alert when epoch=0
                                                                   after handshake process is complete. Per RFC spec, SSL should discard packets
                                                                   with epoch=0 after a handshake. In some special network environments, a
                                                                   DTLS session may be lost and  the server cannot fill the correct epoch and sequence number.
                                                                   In this case, the server sends an alert message with epoch=0 to indicate the session is down
																   and the client must redo the handshake.\n 
                                                                   For this option, the "val" field of qapi_Coap_Set_Extended_Config_Option() is
                                                                   boolean, and the range is [0, 1]:\n
                                                                   - 1: SSL layer will accept the alert packet as a normal alert with epoch=0.
...
/** COAP extended configuration options. */

typedef enum{
 	QAPI_NET_COAP_GET_EXTENDED_CONFIG_LAST_ERR_CODE = 1,	/**< Enable getting last error for COAP.
 																Used in qapi_Net_COAP_Get_Extended_Config_Option()
 																Response type is qapi_Net_Module_Last_Error_t. */
 	QAPI_NET_COAP_GET_EXTENDED_CONFIG_MAX 			= 128,	/**< Maximum value of extended configurations. */
}qapi_Net_Coap_Get_Extended_Config_Options_t;
...
typedef struct _qapi_Multi_Option_t {
  ...
  uint8_t *data;                       /**< Pointer to option value. @newpagetable */
}qapi_Multi_Option_t;

/** CoAP extended option information. */
typedef struct qapi_Coap_Ext_Msg_Option_s
{
  struct qapi_Coap_Ext_Msg_Option_s *next; /**< Pointer to next option in extended option list. */
  uint16_t option_num;                     /**< Option number.  */
  uint16_t len;                            /**< Option length. */
  uint8_t  *val;                           /**< Pointer to option value. @newpagetable */
...
typedef struct {
  ...
  uint16_t buffer_len;                    /**< Length of the buffer. @newpagetable */
...
typedef struct qapi_Coap_Sec_Info_s {
   ...
   qapi_Net_SSL_DICERT_t di_cert;        /**< IN PARAM: DI_CERY location. @newpagetable */
...
typedef struct qapi_Coap_Session_Info_s {
  ...
  qapi_Coap_Client_Session_Cb cb;         /**< IN PARAM: Callback to be called as a part of any DL Requests, such as, GET/PUT/POST/DELETE. */

}qapi_Coap_Session_Info_t;


/** CoAP block data transfer information.
   Application gets information from qapi_Coap_Get_Block_Transfer_Info(). 
*/
typedef struct qapi_Coap_Block_Transfer_Info_s
{
   boolean                                  valid_blockwise_session;                 /**< Uplink blockwise transfer is active or not active.  */
   ...
   uint32_t                                 numBlockPending;                         /**< Total number of pending blocks. @newpagetable */
...
typedef enum {
  ...
  QAPI_COAP_EVENT_RESUMPTION,         /**< Resumption success. */
  QAPI_COAP_EVENT_SSL_ALERT_FATAL,    /**< SSL Alert Fatal event.*/
  QAPI_COAP_EVENT_MAX = 100           /**< Maximum event. @newpage */
}qapi_Coap_Event_t;


/**  
* This callback is called in response to any CoAP event from CoAP Peers. 
* The application must set this callback in qapi_Coap_Register_Event(). 
*/
                                                                  ...
                                                                  UINT cb_param8)
{
  ...
  void (*pfn_app_cb3) (qapi_Coap_Session_Hdl_t  ,qapi_Coap_Transaction_t *, qapi_Coap_Packet_t *);
  void (*pfn_app_cb4) (qapi_Coap_Session_Hdl_t , qapi_Coap_Event_Callback_t );
  ...
  {
	qapi_Coap_Transaction_t *transaction = (qapi_Coap_Transaction_t *) cb_param2;
	...
	if(transaction)
      tx_byte_release((void *)transaction);
  }
  if (cb_id == DATA_CUSTOM_CB_COAP_TRANSACTION_V2)
  {
    qapi_Coap_Transaction_t *transaction = (qapi_Coap_Transaction_t *) cb_param2;
    pfn_app_cb3 = (void (*)(qapi_Coap_Session_Hdl_t ,qapi_Coap_Transaction_t *, qapi_Coap_Packet_t *))app_cb;
    (pfn_app_cb3)((qapi_Coap_Session_Hdl_t)cb_param1, (qapi_Coap_Transaction_t *) cb_param2,(qapi_Coap_Packet_t *)cb_param3);
  ...
  {
    pfn_app_cb4 = (void (*)(qapi_Coap_Session_Hdl_t ,qapi_Coap_Event_Callback_t))app_cb;
    (pfn_app_cb4)((qapi_Coap_Session_Hdl_t)cb_param1, (qapi_Coap_Event_Callback_t) cb_param2);
  }
}
   ...
   */
   ...
   /** @} */
    ...
    #define qapi_Coap_Send_Message_v2(a,b,c,d,e)             ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_SEND_MESSAGE_V2, (ULONG) a, (ULONG) b, (ULONG) c,  (ULONG) d, (ULONG) e, (ULONG) qapi_Coap_Client_Session_uspace_dispatcher,(ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
    #define qapi_Coap_Get_Block_Transfer_Info(a,b)           ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_GET_BLOCKWISE_INFO, (ULONG) a, (ULONG) b, (ULONG) 0 , (ULONG) 0, (ULONG) 0, (ULONG)0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
    ...
    #define qapi_Net_COAP_Get_Extended_Config_Option(a,b,c,d)  ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_COAP_GET_EXTENDED_CONFIG, (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) d, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
 ...
 * }
 *   Creates a client CoAP Session.
 *  
 * @param [out] session            Pointer to a QAPI CoAP client session context that 
 *                                 will be returned and be used for all other
 *                                 additional CoAP QAPIs associated with this session.
 ...
 * Data\_Services 1.2.0  &  Introduced. @tblendline
 * }
 * Creates a COAP connection with the remote server.
 *  
 * @param  sessionHandle     CoAP session handle returned by Create Session.
 ...
 * Data\_Services 1.2.0  &  Introduced. @tblendline
 * }
 * Closes a CoAP connection associated with the session.
 *  
 * @param  sessionHandle  CoAP session handle returned by Create Session.
 ...
 * Data\_Services 1.2.0  &  Introduced. @tblendline
 * }
 *   Sends message to CoAP. Failures internally release the allocated resources.
 *  
 * @param sessionHandle  CoAP session handle returned by create session.
 ...
 * }
 *   Sends a message to CoAP in blocks. Failures internally release the allocated resources.

 * If block type and block size are both set to zero, the message will be sent without blockwise.
 *  
 * @param sessionHandle    CoAP session handle returned by Create Session .
 * @param pkt            Pointer to QAPI CoAP pkt.
 * @param msg_conf         Pointer to CoAP modified message config structure.
 * @param blocktype      Blockwise option.
 * @param blocksize      Size of each block.

 * @return
 * 0 on success; -1 on error. @newpage
 */
 ...
 *                     This function must be called if Option number is present 
 *                     in #qapi_Coap_Header_type.
 * @param header_val   Pointer to header value.
 * @param val_len      Length of header value.

 * @return
   Integer value. @newpage
 */
 ...
 * @versiontable{2.0,2.45,
 * Data\_Services 1.2.0  &  Introduced. @tblendline
 * Data\_Services 1.4.0  &  Updated behavior. @tblendline
 * }
 ...
 * For header types such as QAPI_COAP_URI_PATH | QAPI_COAP_URI_QUERY |QAPI_COAP_LOCATION_PATH: 
 * The API caller (whether in DAM or Kernel) must explicitly free the memory allocated to the string header value.
 *
 */
 ...
 * @return
 * -1 on success, 0 on error. @newpage
 */
 ...
 *
 * @param sessionhandle  CoAP session handle returned by Create Session.
 * @param packet         Pointer to CoAP message. Pointer must allocate size of 
 *                       #qapi_Coap_Packet_t before calling the function.
 * @param data           Pointer to buffer that is parsed.
 ...
 * Data\_Services 1.6.0  &  Introduced. @tblendline
 * }
 *    Sets extended header parameters.
 *  
 * @param sessionhandle  CoAP session handle returned by Create Session.
 * @param message      Pointer to CoAP message header to be filled.
 * @param header_type  Option number of header field to be filled.
 *                     This function must be called if Option number is not present 
 *                       in #qapi_Coap_Header_type.
 * @param header_val   Pointer to header value.
 * @param val_len      Length of header value.
 *
 * @return
 * See Section @xref{hdr:QAPIStatust}. \n
 * On success: \n
 * #QAPI_OK (0) is returned. Other value on error: \n
 * - #QAPI_NET_COAP_EINVALID_PARAM: Invalid parameters. \n
 * - #QAPI_NET_COAP_HANDLE_NOT_FOUND: CoAP session handle not found. \n
 * - #QAPI_ERROR: For generic failures. @newpage
 */
 ...
 * Gets extended header parameters.
 *
 *
 * @param sessionhandle  CoAP session handle returned by Create Session.
 * @param message      Pointer to CoAP message header.
 ...
 * Data\_Services 1.6.0  &  Introduced. @tblendline
 * }
 *         Queries the current snapshot for ongoing uplink blockwise transfer.
 *
 * @param sessionhandle    CoAP session handle returned by Create Session.
 ...
 * }
 * Gets extended configuration parameters.
 *
 * @param[in] hndl    CoAP session handle returned by Create Session.
 * @param[in] ext_option Option Type which we need to get.
 * @param[out] val values to be get. User Should allocate memory for val.
 * @param[in] val_len value's length.
 * 
 * @return  
 * Success - #QAPI_OK.
 * Error -  #QAPI_ERR_NO_ENTRY on failure in retrieving the handle.
...
qapi_Status_t  qapi_Net_COAP_Get_Extended_Config_Option(qapi_Coap_Session_Hdl_t hndl , qapi_Net_Coap_Get_Extended_Config_Options_t ext_option, void* val, uint32_t val_len);
