/**
 Copyright (c) 2018-2022  by Qualcomm Technologies, Inc. and/or its
...
#define TXM_LOC_SSL_BASE                          TXM_QAPI_COAP_BASE2 + TXM_DATA_COAP_NUM_IDS_2
#define TXM_LOC_SSL_NUM_IDS_2                     10
