...
#define  TXM_QAPI_LWM2M_SET_EXTENDED_CONFIG        TXM_QAPI_NET_LWM2M_BASE_V2 + 7
...
typedef enum qapi_Net_LWM2M_Security_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_SECURITY_RES_O_HOLDOFF_TIME_E      = 11, /**< Client Hold Off Time (integer). @newpage */
...
typedef enum qapi_Net_LWM2M_Server_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_SERVER_RES_O_APN_LINK_E             = 10, /**< APN Link (object link). */
...
typedef enum qapi_Net_LWM2M_Acl_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_ACL_RES_M_ACL_OWNER            = 3,  /**< Access control owner (integer). @newpage */
...
typedef enum  qapi_Net_LWM2M_Fota_Result_t_e 
{
  ...
  QAPI_NET_LWM2M_FOTA_RESULT_UNSUPPORTED_PROTOCOL_E     = 9,  /**< Unsupported protocol. @newpage */
...
typedef enum  qapi_Net_LWM2M_NW_Conn_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_NW_CONN_M_ACTIVATED_PROF_NAME_E        = 11,  /**< Activated profile names. @newpage*/
...
typedef enum  qapi_Net_LWM2M_APN_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_APN_O_APN_CONTROL_E             = 25,  /**< APN control. @newpage*/
...
typedef enum qapi_Net_LWM2M_SW_Mgnt_Resource_Id_e 
{
  ...
  QAPI_NET_LWM2M_SW_MGNT_RES_M_ACTIVATION_STATE_E  = 12, /**< Resource ID for Activation State. @newpage*/
...
typedef enum qapi_Net_LWM2M_Write_Attr_e
{
  ...
  QAPI_NET_LWM2M_DIM_E          = 32,  /**< Dimension. @newpage */
...
typedef enum qapi_Net_LWM2M_UL_Msg_e
{
  ...
  QAPI_NET_LWM2M_CREATE_RESPONSE_MSG_E       = 3,  /**< Create response message. @newpage */
...
typedef enum qapi_Net_LWM2M_Response_Code_e
{
  ...
  QAPI_NET_LWM2M_500_INTERNAL_SERVER_E         = 0xA0,  /**< 500 - Internal server. @newpage*/
...
typedef enum qapi_Net_LWM2M_Config_Type_t
{
  ...
  QAPI_NET_LWM2M_FACTORY_RESET          = 7,  /**< Factory Reset LwM2M. @newpage*/
...
typedef enum {
  QAPI_LWM2M_EXTENDED_CONFIG_NONE,      /**< */
}qapi_LWM2M_Extended_Config_Options_t;



/**
* @deprecated Structure is deprecated in v2.0.
...
/**
*   Structure to indicate the object/instance/resource ID for which the 
*   application is interested in monitoring or getting the value (v2.0).
*/
...
typedef struct qapi_Net_LWM2M_Flat_Data_s
{
  ...
  union
  {
    ...
    struct
    {
      ...
      uint32_t  size1;         /**< Size indication. @newpagetable */ 
...
typedef struct qapi_Net_LWM2M_Resource_Info_s
{
  ...
  union
  {
    ...
    } asChildren;  /**< Value as a multi-resource instance. @newpagetable */
  } value;  
...
typedef struct qapi_Net_LWM2M_Instance_Info_s
{
  ...
  qapi_Net_LWM2M_Resource_Info_t * resource_info;  /**< Pointer to the resource information. @newpagetable */
} qapi_Net_LWM2M_Instance_Info_t;

/**
*   Structure to indicate the instance information that is to be created (v2.0).
*/
...
typedef struct qapi_Net_LWM2M_Data_s
{
  ...
  qapi_Net_LWM2M_Instance_Info_t *instance_info;  /**< Pointer to the instance information. @newpagetable*/
} qapi_Net_LWM2M_Data_t;

/**
*   Structure that is populated by the application and provided to an LWM2M client
*   when the application wants to create an instance of the LWM2M object to perform 
*   set and get operations (v2.0).
*/
...
/**
*   LWM2M object or URI-related information.
*/
typedef struct qapi_Net_LWM2M_Obj_Info_s
{
  ...
  uint16_t               res_inst_id;      /**< Resource instance ID. @newpagetable */
...
typedef struct qapi_Net_LWM2M_Attributes_s
{
  ...
  double                        step;           /**< Step. */
  struct qapi_Net_LWM2M_Attributes_s *next;     /**< Pointer to the next attributes information. @newpagetable*/
...
/**
*   LWM2M configuration message data.
*/
typedef struct qapi_Net_LWM2M_Config_Data_s
{
  ...
  union
  {
    ...
    struct
    {
      ...
      uint8_t  *buffer;	  /**< Pointer to the buffer. @newpagetable */
...
static __inline int lwm2m_update_byte_pool(qapi_Net_LWM2M_App_Handler_t hndl, void *lwm2m_byte_pool_ptr)
{
  ...
  if (NULL == uspace_memory_lwm2m || NULL == lwm2m_byte_pool_ptr)
    return QAPI_ERROR;
 ...
 * @note1hang This macro is only used in DAM Space. @newpage
 */
...
#define qapi_Net_LWM2M_Set_Extended_Config_Option(a,b,c,d) ((qapi_Status_t) (_txm_module_system_call12)(TXM_QAPI_LWM2M_SET_EXTENDED_CONFIG, (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) d, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
...
/**
*   Callback registered from the application, which is used by the LWM2M 
*   client to indicate the resource value change to the application (v2.0).
*
* @param[in] handle  Handle received from qapi_Net_LWM2M_Register_App_Extended().
* @param[in] lwm2m_data  Pointer to the LWM2M data.
...
*
* @return See Section @xref{hdr:QAPIStatust}. \n
* On success, #QAPI_OK (0) is returned. Other value on error. @newpage
*/
...
*   the application before the callback returns (v2.0).
*
*
...
/**
*   Used by the application to cancel the observation (v2.0).
*
* @param[in] handle  Handle received after successful application registration.
...
*   an object instance is allowed at a time (v2.0).
*
* @param[in] handle  Handle received after successful application registration.
...
* @return
* See Section @xref{hdr:QAPIStatust}. \n
* On success, #QAPI_OK(0). \n
* Other value on error:
* - #QAPI_ERR_NOT_SUPPORTED(-8) -- LwM2M not in BOOTSTRAP_BYAPP mode, or unsupported configuration type. \n
* - #QAPI_ERR_INVALID_STATE(-13) -- Client trigger start but Lwm2m already started. \n
* - #QAPI_ERR_NO_ENTRY(-7) -- Client trigger start but no bootstrap information configured. \n
* - #QAPI_ERR_EXISTS(-12) -- Client trigger configuration bootstrap-info but bootstrap-info was present in lwm2m already (was configured before). \n
* - #QAPI_ERR_INVALID_PARAM(-2) -- bootstrap-info provided is invalid or mandatory item is not provided in bootstrap-info. @newpage
*/
...
* }
* @brief    This function sets extended configuration parameters.
*           The user is expected to call this function before these parameters
*           are used in another function.
*
* @param[in] handle  Handle received after successful application registration.
* @param[in]   option  Option type to be set.
