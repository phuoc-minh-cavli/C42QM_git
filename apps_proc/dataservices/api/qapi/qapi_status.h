/* Copyright (c) 2011-2017, 2020-2021 Qualcomm Technologies, Inc. and/or its subsidiaries.
All rights reserved.
 ...
 *          values. It also defines the module IDs that can be used to add
...
/** @name QAPI Modules
   ...
   The following definitions represent the IDs for the various QAPI modules.

   @notehang1
   If OEMs wish to added their own module IDs, it is recommended
...
/** @name Common QAPI Status Codes
    ...
    The following definitions represent the status codes common to all QAPI modules.
 */
...
/**< Unintialized. */
#define QAPI_ERR_API_DEPRACATED              ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 14)))
/**< QAPI function is deprecated. */
#define QAPI_ERR_INVALID_STATE               ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BASE, 15)))
/**< Invalid state. */
