...
enum QAPI_VERSION_CATEGORY {
  ...
  QAPI_VERSION_CATEGORY_CAT_MAX, /**< Total number of categories. @newpage */
};
 ...
 * }
 *
 * Gets application compiled QAPI version.
 *
...
#else
#ifndef MOB_TX
qapi_Status_t qapi_Version_Handler(UINT id,UINT a1,UINT a2,UINT a3,UINT a4,UINT a5,UINT a6,UINT a7,UINT a8,UINT a9,UINT a10,UINT a11,UINT a12);
#endif
/**
 * @versiontable{2.0,2.45,
 * Data\_Services 1.2.0  &  Introduced. @tblendline
