...
#define DATA_CUSTOM_CB_SENSOR_MGR_IND        CUSTOM_CB_QAPI_DATA_SERVICES_BASE+15
#endif

#define DATA_CUSTOM_CB_COAP_TRANSACTION_V2   CUSTOM_CB_QAPI_DATA_SERVICES_BASE+16
#define DATA_CUSTOM_CB_COAP_REGISTER_EVENT   CUSTOM_CB_QAPI_DATA_SERVICES_BASE+17

#ifdef TRACKER_REF_APP
#define DATA_CUSTOM_CB_SENSOR_MGR_IND_V2        CUSTOM_CB_QAPI_DATA_SERVICES_BASE+18
#endif
...
/**
 * Application type to be used for MMU Translation.
*/
typedef enum{
...
/**
 *  Utility API to map a user space address to the handle (must only be used in DAM Application space).
 *
 ...
 *  the handle (must only be used in DAM Application space).
 *
 * @param [in] handle    Networking stack module handle.
 * @param [in] app_type  Identifies the networking stack module. 
