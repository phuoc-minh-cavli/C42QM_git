/*===========================================================================
  Copyright (c) 2017-2022  Qualcomm Technologies, Inc.  and/or its subsidiaries.
  All rights reserved.
...
#define QAPI_MAX_DNS_ADDRS    5
/** Maximum length of DNS hostname. */
#define QAPI_MAX_DNS_NAME     256
/** Maximum length of individual h_addr_list ipaddress string of #qapi_hostent_s.*/
#define QAPI_MAX_IPADDR_LEN   16

/** Maximum length of individual h_addr_list ipaddress string of qapi_hostent_s structure*/
#define QAPI_MAX_IPV4V6ADDR_LEN   48
...
typedef enum {
    ...
    QAPI_NET_DNS_STOP_E     /**< Stop sending DNS requests and processing DNS responses;
                                 ...
                                 only when the ref count reaches 0. @newpage*/
...
qapi_Status_t qapi_Net_DNSc_Handler(UINT id, UINT a1, UINT a2, UINT a3, UINT a4, UINT a5, UINT a6, UINT a7, UINT a8, UINT a9, UINT a10, UINT a11, UINT a12);
 ...
 *  The DNS response parsing will accept any answer record and add them to the cache. \n
 *  The upstream DNS server is expected to filter and match answers
 *  to questions (and authority fields), per DNS protocol.
 *
 ...
 *  The DNS response parsing will accept any answer record and add them to the cache.
 *  The upstream DNS server is expected to provide filtering to match answers
 *  to questions (and authority fields) according to DNS protocol.
 *
 * @param [in] hostname  Pointer to an IP address string or host name string.
