# 1 "Z:\\b\\apps_proc\\dataservices\\demo\\QCLI_DAM_demo\\src\\txm_module_preamble_llvm.S"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 333 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Z:\\b\\apps_proc\\dataservices\\demo\\QCLI_DAM_demo\\src\\txm_module_preamble_llvm.S" 2
...
_txm_module_preamble:
  ...
  .p2align 2
        .word qcli_dam_app_start - . + . @ Module Start Thread Entry Point
  .p2align 2
...
# 79 "Z:\\b\\apps_proc\\dataservices\\demo\\QCLI_DAM_demo\\src\\txm_module_preamble_llvm.S"
        .p2align 2
        .word 0 @ Reserved 2
  .p2align 2
        .word 0 @ Reserved 3
