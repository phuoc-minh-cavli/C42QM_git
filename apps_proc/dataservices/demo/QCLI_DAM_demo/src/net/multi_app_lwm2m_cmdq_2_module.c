...
==============================================================================*/
void multi_app_set_signal_dam_t2(void)
{

 LOG_INFO("multi_app_set_signal_dam_t2 \n");

  tx_mutex_get(multi_app_param_t2.multi_app_mutex, TX_WAIT_FOREVER);

  MULTI_APP_TASK_SET_SIG(multi_app_param_t2.multi_app_signal,MULTI_APP_SIGNAL_MASK);

  tx_mutex_put(multi_app_param_t2.multi_app_mutex);
...
==============================================================================*/
static void multi_app_mutex_init_dam_t2(void)
{
  LOG_INFO("multi_app_mutex_init_dam_t2 \n");

/* allocate mutex required for thread*/ 
  txm_module_object_allocate((void **)(&multi_app_param_t2.multi_app_mutex), sizeof(TX_MUTEX));
  tx_mutex_create(multi_app_param_t2.multi_app_mutex, "multi_app_mutex_t2", TX_NO_INHERIT);
  return;
}
...
==============================================================================*/
static void multi_app_signal_init_dam_t2(void)
{
  LOG_INFO("multi_app_signal_init_dam_t2 \n");


/* allocate signal required for thread*/ 
  txm_module_object_allocate((void **)(&multi_app_param_t2.multi_app_signal), sizeof(TX_EVENT_FLAGS_GROUP));
  tx_event_flags_create(multi_app_param_t2.multi_app_signal, "multi_app_sig_t2");
  return;
}
...
==============================================================================*/
static void multi_app_signal_wait_dam_t2(void)
{
  uint32_t received_sigs = 0;

  LOG_INFO("multi_app_signal_wait_dam_t2 \n");
...
=============================================================================*/
    tx_event_flags_get(multi_app_param_t2.multi_app_signal, MULTI_APP_SIGNAL_MASK,
...
==================================================================*/
void multi_app_task_init_dam_t2(void)
{

  LOG_INFO("multi_app_task_init_dam_t2 \n");
...
==============================================================================*/
void multi_app_task_entry_dam_t2(ULONG thread_ctxt)
{

  LOG_INFO("multi_app_task_entry_dam_t2 \n");

  multi_app_task_init_dam_t2();

/*=============================================================================
Initialize Mutex Object
==============================================================================*/

  multi_app_mutex_init_dam_t2();

/*=============================================================================
Initialize Signal 
==============================================================================*/

  multi_app_signal_init_dam_t2 ();

/*=============================================================================
Wait on the Signal
==============================================================================*/
  multi_app_signal_wait_dam_t2();
...
/* allocate queue required for thread*/ 
  txm_module_object_allocate((void **)&multi_app_cmdq_t2, sizeof(TX_QUEUE));
  tx_queue_create(multi_app_cmdq_t2, "multi_app_cmdq_t2", MULTI_APP_Q_MESSAGE_SIZE,cmdq_ptr, MULTI_APP_QUEUE_SIZE);
...
void multi_app_enqueue_cmd_t2(multi_app_cmd_t* cmd_ptr)
{
   ...
   tx_queue_send(multi_app_cmdq_t2, &cmd_ptr, TX_WAIT_FOREVER);
...
static multi_app_cmd_t* multi_app_dequeue_cmd_t2( void )
{
  ...
  tx_queue_receive(multi_app_cmdq_t2, &cmd_ptr, TX_WAIT_FOREVER);
        ...
        if(obj_buffer != NULL)
        {
          switch(obj_buffer->app_data.ul_op.msg_type)
          {
            ...
            case QAPI_NET_LWM2M_EXT_NOTIFY_E:
            {
              ...
              ext_object_notify(1,current_time.time_secs, &timeout);
            }
            break;
        ...
        if(obj_buffer_v2 != NULL)
        {
          switch(obj_buffer_v2->app_data.ul_op.msg_type)
          {
            ...
            case QAPI_NET_LWM2M_EXT_NOTIFY_v2_E:
            {
              ...
              ext_object_notify_v2(1,current_time.time_secs, &timeout);
            }
            break;
