...
/*------------------------------------------------------------------------------
  ...
  external entities
------------------------------------------------------------------------------*/
typedef TX_QUEUE* multi_app_task_cmd_q;
...
typedef struct
{
  TX_EVENT_FLAGS_GROUP*         multi_app_signal;
  TX_MUTEX*                     multi_app_mutex;
  TX_QUEUE*                     cmd_q_ptr;
}multi_app_info_t;
...
void multi_app_mutex_init_dam_t1(void);

void multi_app_signal_init_dam_t1(void);

void multi_app_signal_wait_dam_t1(void);
...
void multi_app_mutex_init_dam_t2(void);

void multi_app_signal_init_dam_t2(void);

void multi_app_signal_wait_dam_t2(void);
