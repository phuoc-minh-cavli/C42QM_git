...
#ifdef VENKAT
static qapi_Net_LWM2M_Resource_Info_Get_t* resource_list_add(qapi_Net_LWM2M_Resource_Info_Get_t* head,
                                                             qapi_Net_LWM2M_Resource_Info_Get_t* node)
{
  qapi_Net_LWM2M_Resource_Info_Get_t* target = NULL;
...
static qapi_Net_LWM2M_Instance_Info_Get_t* instance_list_add(qapi_Net_LWM2M_Instance_Info_Get_t* head,
                                                             qapi_Net_LWM2M_Instance_Info_Get_t* node)
{
  qapi_Net_LWM2M_Instance_Info_Get_t* target = NULL;
...
qapi_Status_t software_mgnt_app_callback( qapi_Net_LWM2M_App_Handler_t handler, qapi_Net_LWM2M_Data_t * lwm2m_data)
{
  ...
  if (lwm2m_data->instance_info->resource_info->resource_ID == QAPI_NET_LWM2M_SW_MGNT_RES_O_PACKAGE_E)
  {
    ...
    {
       result = qapi_FS_Open(SOFTWARE_MGNT_APP_FILE_PATH, (O_CREAT | O_RDWR), &sw_mgnt_file_fd);
    }
    ...
    if (lwm2m_data->instance_info->resource_info->value.asBuffer.length) 
    {
      ...
      if(rc < 0 || written_bytes < lwm2m_data->instance_info->resource_info->value.asBuffer.length)
      {
		...
		tx_byte_allocate(byte_pool_qcli, (VOID **)&lwm2m_dataP, sizeof (qapi_Net_LWM2M_Data_t), TX_NO_WAIT);		  		
        if (lwm2m_dataP == NULL)
        {
		...
		tx_byte_allocate(byte_pool_qcli, (VOID **)&(lwm2m_dataP->instance_info), sizeof (qapi_Net_LWM2M_Instance_Info_t), TX_NO_WAIT);		  		
		...
		tx_byte_allocate(byte_pool_qcli, (VOID **)&dataP, sizeof (qapi_Net_LWM2M_Data_t), TX_NO_WAIT);		  		
        if (dataP == NULL)
        {
          LOG_INFO ("memory allocation falied \n");  
          return QAPI_ERROR;
        ...
        dataP->no_instances++;
		tx_byte_allocate(byte_pool_qcli, (VOID **)&(dataP->instance_info), sizeof (qapi_Net_LWM2M_Instance_Info_t), TX_NO_WAIT);		  		
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&(lwm2m_info_req.id_info), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			  
...
void software_mngt_init()
{
  ...
  {
    qapi_Net_LWM2M_Pass_Pool_Ptr(gsoftware_mgnt_Handler,byte_pool_qcli);
	...
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info1), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info2), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info2)
    {
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info3), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info3)
    {
      app_free_id_info (id_info1);
      return;        
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info4), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info4)
    {
      app_free_id_info (id_info1);
      return;        
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info5), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info5)
    {
      app_free_id_info (id_info1);
      return;        
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info6), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info6)
    {
      app_free_id_info (id_info1);
      return;        
    ...
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info7), sizeof (qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);			
    if(NULL == id_info7)
    {
      app_free_id_info (id_info1);
      return;        
...
void sw_mgnt_handle_update_state_input(int32_t option) 
{
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&(lwm2m_data), sizeof (qapi_Net_LWM2M_Data_t), TX_NO_WAIT);		  
  if (lwm2m_data == NULL) 
  {
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&(lwm2m_data->instance_info), sizeof (qapi_Net_LWM2M_Instance_Info_t), TX_NO_WAIT);		  
...
int32_t sw_mgnt_handle_delete_instance(uint8_t instance_id ) 
{
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&(id_info), sizeof (qapi_Net_LWM2M_Id_Info_t ), TX_NO_WAIT);		    
  if (id_info == NULL)
  {
...
int software_mngt_get(qapi_Net_LWM2M_Id_Info_t *id_info)
{
  qapi_Net_LWM2M_Data_t *lwm2m_dataP = NULL;
