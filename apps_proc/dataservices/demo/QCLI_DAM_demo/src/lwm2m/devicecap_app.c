...
void devicecap_init()
{
  ...
  if(QAPI_OK == qapi_Net_LWM2M_Register_App(&handler_dev))
  {
    ...
    qapi_Net_LWM2M_Pass_Pool_Ptr(handler_dev,byte_pool_qcli);
...
int32_t devicecap_handle_observe(uint8_t instance_id)
{
  ...
  {
    if(instance_created[instance_id] == 0)
    {
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&id_info8, sizeof(qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);        
  if(NULL == id_info8)
  {
    app_free_id_info(id_info1);
    return QAPI_ERROR;
...
int32_t devicecap_handle_cancel_observe(uint8_t instance_id)
{
  ...
  if( (instance_id < MAX_INSTANCE_ID) && (instance_created[instance_id] == 1) && (observe_mode[instance_id] == 1))
  {
    memset (&observe_info , 0 ,sizeof (qapi_Net_LWM2M_Object_Info_t));
    observe_info.no_object_info++;
	tx_byte_allocate(byte_pool_qcli, (VOID **)&id_info1, sizeof(qapi_Net_LWM2M_Id_Info_t), TX_NO_WAIT);		
...
int set_notify_en_value(uint8_t instance_id,bool notifyen)
{
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&devicecap_resource_data, sizeof (qapi_Net_LWM2M_Data_t), TX_NO_WAIT); 				  
  ...
  tx_byte_allocate(byte_pool_qcli, (VOID **)&(devicecap_resource_data->instance_info), sizeof (qapi_Net_LWM2M_Instance_Info_t), TX_NO_WAIT); 				  
