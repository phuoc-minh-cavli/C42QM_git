...
bool app1_registerd_v2 = false;

bool app2_registerd_v2 = false;

static timer_type obs_notify_Timer1_v2;
static timer_type obs_notify_Timer2_v2;
timer_group_type extLwm2mTimerGroup_v2;
...
extern uint16_t lwm2m_list_count(lwm2m_list_t * head);

static void* utility_malloc(size_t size)
{ 
  void* memory_ret = 0;
  memory_ret = malloc(size);
  if(memory_ret == NULL)
  {
  ...
  int i = 0;
    if (cmd_data->Parameter_List != NULL)
    {
      for (i = 0; i< cmd_data->Parameter_Count; i++)
      {
        ...
        {
          free(cmd_data->Parameter_List[i].String_Value);
...
{ 
   ...
   ext_param1 = malloc(sizeof(qapi_Net_LWM2M_Ext_v2_t));
   if(ext_param1 == NULL)
   {
...
static void notify_signal_cb_1(int32 time_ms, timer_cb_data_type userData)
{
  int id = 0;
  ...
  ext_param = (qapi_Net_LWM2M_Ext_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Ext_v2_t));
...
static void notify_signal_cb_2(int32 time_ms, timer_cb_data_type userData)
{
  int id = 1;
  multi_app_cmd_t* cmd_ptr = NULL;
...
void qapi_Net_LWM2M_Free_FlatData_array(qapi_Net_LWM2M_Flat_Data_t ** array, unsigned int count)
{
  ...
  for(i = 0; i < count; i++)
  {
    ...
    {
      free((*array)[i].value.asBuffer.buffer);
    }
  ...
  while(dataP != NULL)
  {
    if(dataP->instance_info != NULL)
    {
      if(dataP->instance_info->resource_info != NULL)
      {
        ...
        {
          free(dataP->instance_info->resource_info->value.asBuffer.buffer);
        }
        free(dataP->instance_info->resource_info);
      }
      free(dataP->instance_info);
    }
	tmp = dataP->next;
    free(dataP);
	dataP = tmp;
        ...
        if(obj_inst_created_generic_v2[i] == 1)
        {
          ...
          if(instance != NULL)
          {
            ...
            if(!qapi_Net_LWM2M_Free_Single_Instance_Info_v2(instance))
            {
              ...
              instance_info.id_info = (qapi_Net_LWM2M_Id_Info_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
                                   ...
                                   qapi_Net_LWM2M_Server_Data_t op_data)
{
  ...
  if(op_data.event == QAPI_NET_LWM2M_REGISTER_UPDATE_E)
  {
    ...
    if(op_data.msg_id_len >= 2 && op_data.msg_id_len <= 10)
    {
      ...
      flush_pending_notifications(handler,short_id, current_time);
    }
  }
...
qapi_Status_t ext_object_register_v2(int id)
{
  ...
  if(result == QAPI_OK)
  {
    if (id == 0)
    {
      app1_registerd_v2 = true;
    }
    else if (id == 1)
    {
      app2_registerd_v2 = true;
    }
...
qapi_Status_t create_object_v2(int id)
{
  ...
  if(id == 0)
  {
    ...
    {
      object = (qapi_Net_LWM2M_Data_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Data_v2_t));
      if(object == NULL)
      {
                                 ...
                                 uint16_t resId, uint16_t resValue)
{
  ...
  resInst = (ext_resource_instance_int_list_v2_t *)malloc(sizeof(ext_resource_instance_int_list_v2_t));
  if (resInst==NULL)
  {
    return ret;
  }
                                        ...
                                        uint16_t resId, char* resValue)
{
  ...
  resInst = (ext_resource_instance_string_list_v2_t *)malloc(sizeof(ext_resource_instance_string_list_v2_t));
  if (resInst==NULL)
  {
    return ret;
  }
...
qapi_Net_LWM2M_Instance_Info_v2_t* obj_create_generic_sensor_v2(qapi_Net_LWM2M_Data_v2_t *lwm2m_data)
{
  ...
  instance = (qapi_Net_LWM2M_Instance_Info_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Instance_Info_v2_t));
  ...
  mult_inst = (gen_multi_res_v2_t *)malloc(sizeof(gen_multi_res_v2_t ));
  if(mult_inst == NULL)
  {
    LOG_INFO("Memory allocation failure.\n");
    return NULL;
...
qapi_Net_LWM2M_Instance_Info_v2_t* obj_create_presence_sensor_v2(qapi_Net_LWM2M_Data_v2_t *lwm2m_data)
{
  ...
  mult_inst = (pre_multi_res_v2_t *)malloc(sizeof(pre_multi_res_v2_t ));
  if(mult_inst == NULL)
  {
    LOG_INFO("Memory allocation failure.\n");
    return NULL;
...
qapi_Status_t set_obj_link_app_v2(qapi_Net_LWM2M_Ext_v2_t *obj_buffer)
{
  ...
  objlink_set.instance_info = malloc(sizeof(qapi_Net_LWM2M_Instance_Info_v2_t));
...
qapi_Status_t get_obj_link_app_v2(qapi_Net_LWM2M_Ext_v2_t *obj_buffer)
{
  ...
  lwm2m_info_req.id_info = malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
...
void start_ext_obs_notify_timer_v2()
{
  ...
  {
    timer_def_osal(&obs_notify_Timer1_v2, &extLwm2mTimerGroup_v2, TIMER_FUNC1_CB_TYPE, notify_signal_cb_1,NULL);
  }

  if(ext_multi_observed_list_v2 == NULL)
  {
    timer_def_osal(&obs_notify_Timer2_v2, &extLwm2mTimerGroup_v2, TIMER_FUNC1_CB_TYPE, notify_signal_cb_2,NULL);
  }
}
...
void stop_ext_obs_notify_timer_v2(qapi_Net_LWM2M_App_Handler_t handler)
{
  if(handler == ext_object_handler_app1_v2)
  {
    timer_clr(&obs_notify_Timer1_v2, T_SEC);
    timer_undef(&obs_notify_Timer1_v2);
  }

  else if(handler == ext_object_handler_app2_v2)
  {
    timer_clr(&obs_notify_Timer2_v2, T_SEC);
    timer_undef(&obs_notify_Timer2_v2);
  }
}
                                                      ...
                                                      uint8_t msg_id_len)
{
  ...
  if(observed == NULL)
  {
    observed = (qapi_Net_LWM2M_Observed_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Observed_v2_t));
    if(observed == NULL)
    {
      return NULL;
    }
  ...
  {
    observe_info = (qapi_Net_LWM2M_Observe_info_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Observe_info_v2_t));
    if(observe_info == NULL)
    {
      if(alloc == true)
      {
                                     ...
                                     int size, qapi_Net_LWM2M_Flat_Data_t *data)
{
  ...
  if(handler == ext_object_handler_app1_v2)
  {
    timer_set(&obs_notify_Timer1_v2, 1, TRUE, T_SEC);
  }

  else if(handler == ext_object_handler_app2_v2)
  {
    timer_set(&obs_notify_Timer2_v2, 1, TRUE, T_SEC);
  }
                                                      ...
                                                      uint8_t *buffer, size_t length)
{
  ...
  notify = (qapi_Net_LWM2M_Pending_Observed_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Pending_Observed_v2_t));
  if(notify == NULL)
  {
  ...
  else
  {
   ...
   else if(value_type == QAPI_NET_LWM2M_TYPE_STRING_E)
   {
     ...
     if(resource->value.asBuffer.buffer != NULL)
	   	 free(resource->value.asBuffer.buffer);
                                   ...
                                   QCLI_Parameter_t *Parameter_List)
{
  ...
  if (cmd_parser_temp->app_data1.app_id != 0)
  {
    ...
    ext_param1 = (qapi_Net_LWM2M_Ext_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Ext_v2_t));
  ...
  if (cmd_parser_temp->app_data2.app_id != 0)
  {
    ...
    ext_param2 = (qapi_Net_LWM2M_Ext_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Ext_v2_t));
