...
int32_t devicecap_handle_observe_v2(uint16_t instance_id)
{
  ...
  if(instance_created_v2[instance_id] == 0 || instance_id >= MAX_INSTANCE_ID)
  {
  ...
  id_info4 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
  if(NULL == id_info4)
  {
    app_free_id_info_v2(id_info1);
    return QAPI_ERROR;
  ...
  id_info5 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
  if(NULL == id_info5)
  {
    app_free_id_info_v2(id_info1);
    return QAPI_ERROR;
  ...
  id_info6 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
  if(NULL == id_info6)
  {
    app_free_id_info_v2(id_info1);
    return QAPI_ERROR;
  ...
  id_info7 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
  if(NULL == id_info7)
  {
    app_free_id_info_v2(id_info1);
    return QAPI_ERROR;
  ...
  id_info8 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
  if(NULL == id_info8)
  {
    app_free_id_info_v2(id_info1);
    return QAPI_ERROR;
...
int32_t devicecap_handle_cancel_observe_v2(uint16_t instance_id)
{
  ...
  if(instance_created_v2[instance_id] == 1 && instance_id < MAX_INSTANCE_ID && observe_mode_v2[instance_id] == 1)
  {
    memset (&observe_info , 0 ,sizeof (qapi_Net_LWM2M_Object_Info_v2_t));
    observe_info.no_object_info++;
    id_info1 = (qapi_Net_LWM2M_Id_Info_v2_t *) malloc(sizeof(qapi_Net_LWM2M_Id_Info_v2_t));
...
int32_t device_cap_get_v2(qapi_Net_LWM2M_Id_Info_v2_t *id_info)
{
  qapi_Net_LWM2M_Data_v2_t *lwm2m_dataP = NULL;
...
int set_notify_en_value_v2(uint16_t instance_id,bool notifyen)
{
  ...
  devicecap_resource_data = (qapi_Net_LWM2M_Data_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Data_v2_t));
  ...
  devicecap_resource_data->instance_info = (qapi_Net_LWM2M_Instance_Info_v2_t *)malloc(sizeof (qapi_Net_LWM2M_Instance_Info_v2_t));
