...
int set_device_resource_value_v2(uint16_t resource_id, char* buf, int len)
{
  ...
  device_resource_data = (qapi_Net_LWM2M_Data_v2_t *)malloc(sizeof(qapi_Net_LWM2M_Data_v2_t));
  ...
  device_resource_data->instance_info = (qapi_Net_LWM2M_Instance_Info_v2_t *)malloc(sizeof (qapi_Net_LWM2M_Instance_Info_v2_t));
