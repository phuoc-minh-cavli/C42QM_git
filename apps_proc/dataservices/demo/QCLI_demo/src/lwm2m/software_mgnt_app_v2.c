...
/*
 * @fn      software_mgnt_app_callback_v2()
 ...
 void software_mgnt_app_callback_v2( qapi_Net_LWM2M_App_Handler_t handler, qapi_Net_LWM2M_Data_v2_t * lwm2m_data, qapi_Status_t *result)
{
  ...
  if (lwm2m_data->instance_info->resource_info->resource_ID == QAPI_NET_LWM2M_SW_MGNT_RES_O_PACKAGE_E)
  {
    ...
    if (lwm2m_data->instance_info->resource_info->value.asBuffer.length) 
    {
      ...
      if(rc < lwm2m_data->instance_info->resource_info->value.asBuffer.length)
      {
        ...
        dataP = (qapi_Net_LWM2M_Data_v2_t *)malloc (sizeof (qapi_Net_LWM2M_Data_v2_t));
        if (dataP == NULL)
        {
          LOG_INFO ("memory allocation falied \n");  
          *result = QAPI_ERROR;
        ...
        dataP->no_instances++;
        dataP->instance_info = (qapi_Net_LWM2M_Instance_Info_v2_t *)malloc (sizeof (qapi_Net_LWM2M_Instance_Info_v2_t));
  ...
  { 
    ...
    res = qapi_Net_LWM2M_Get_v2 (gsoftware_mgnt_Handler_v2, &lwm2m_info_req , &lwm2m_dataP);
    if (res == QAPI_ERROR)
    {
