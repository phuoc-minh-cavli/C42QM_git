...
const QCLI_Command_t m2m_stub_cmd_list_v2[] = {
  {fw_app_start_v2, false, "fw_app_start", "usage: fw application [-app <app id: 0/1>] start", "Start firmware application"},
  {fw_update_result_v2, false , "fw_set" , "usage : update result [-app <app id: 0/1>] [1 - 9 ] \n " , "update  result  with proper value \n"} ,
  {fw_set_protocol_v2, false , "fw_set_protocol" , "usage : update result [-app <app id: 0/1>] [0 - 15]\n " , "set supported download protocol \n"} ,
  {fw_set_delivery_method_v2, false , "fw_set_delivery_method" , "usage : update result [-app <app id: 0/1>] [0 -  2]\n " , "set push/pull/both delivery method \n"} ,
  {fw_set_pkg_version_v2, false , "fw_set_pkg_version" , "usage : Pkg version [-app <app id: 0/1>] <resource value>\n " , "Update package version of firmware object.\n"} ,
  ...
  {cell_nw_set_resource_v2, false, "cell_nw_set", "usage: cell_nw_set [-app <app id: 0/1>] <resource_id> [0,1,4,5] <resource value>", 
    "Set resource value for any apn conn object instance"},
#ifdef LWM2M_ENABLE_APN_OBJ
  ...
  {apninfo_set_resource_v2, false, "apninfo_set", "usage: apninfo_set [-app <app id: 0/1>] <instance id> <resource_id> [0,1,2,4,5,6,7,22,24] <resource value>", 
    "Set resource value for any apn conn object instance"},
...
void Initialize_LWM2M_Stub_Demo_v2(void)
{
  ...
  {
    QCLI_Printf(qcli_m2m_stub_handle_v2, "LWM2m_Stub_v2 registered\n");
  }
    ...
    QCLI_Parameter_t* Parameter_List, int app_id)
{
  ...
  if (glwm2m_context == false) {
    QCLI_Printf (qcli_m2m_stub_handle_v2 , "start the client first \n");
...
QCLI_Command_Status_t fw_set_pkg_version_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_FW_SET_PKG_VERSION_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_fw_set_pkg_version_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List, int app_id)
{
  char *res_value = NULL;
  int res_len = -1;
  ...
  result = handle_fw_set_pkg_version_v2(res_value, res_len);
...
QCLI_Command_Status_t fw_update_result_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t* Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_FW_UPDATE_RESULT_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_fw_update_result_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t* Parameter_List, int app_id)
{
  int i;
  QCLI_Command_Status_t result = QCLI_STATUS_SUCCESS_E;
  ...
  handle_update_state_input_v2(Parameter_List[0].Integer_Value);
...
QCLI_Command_Status_t fw_set_protocol_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_FW_SET_PROTOCOL_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_fw_set_protocol_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List, int app_id)
{
  int i;
  QCLI_Command_Status_t result = QCLI_STATUS_SUCCESS_E;
  ...
  handle_fw_set_protocol_support_v2(Parameter_List[0].Integer_Value);
...
QCLI_Command_Status_t fw_set_delivery_method_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_FW_SET_DELIVERY_METHOD_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_fw_set_delivery_method_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t *Parameter_List, int app_id)
{
  int i;
  QCLI_Command_Status_t result = QCLI_STATUS_SUCCESS_E;
  ...
  handle_fw_set_delivery_method_v2(Parameter_List[0].Integer_Value);
...
QCLI_Command_Status_t fw_app_start_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t* Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_FW_APP_START_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_fw_app_start_v2(uint32_t Parameter_Count,
    QCLI_Parameter_t* Parameter_List, int app_id)
{
  int i;
  QCLI_Command_Status_t result = QCLI_STATUS_SUCCESS_E;
...
proc_devicecap_set_notify_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List, int app_id)
{
  int result = 0;
  int i;
  QCLI_Command_Status_t status = QCLI_STATUS_SUCCESS_E;
    ...
    QCLI_Parameter_t* Parameter_List, int app_id)
{
  ...
  if (glwm2m_context == false) 
  {
    QCLI_Printf (qcli_m2m_stub_handle_v2 , "Start LWM2M  client \n");
    result = QCLI_STATUS_SUCCESS_E;
	goto end;
  }
...
QCLI_Command_Status_t cell_nw_set_resource_v2(uint32_t Parameter_Count, QCLI_Parameter_t* Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_CELL_CON_SET_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
...
QCLI_Command_Status_t proc_cell_nw_set_resource_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List, int app_id)
{
  ...
  res_len = MIN(MAX_RES_LEN, strlen((char *)Parameter_List[1].String_Value));
  ...
  result = cell_con_set_v2(resource_id, res_value, res_len);
    ...
    QCLI_Parameter_t* Parameter_List)
{
  ...
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 29;
    ...
    QCLI_Parameter_t* Parameter_List)
{
  ...
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 34;
                                    ...
                                    QCLI_Parameter_t* Parameter_List)
{
  ...
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 33;
    ...
    QCLI_Parameter_t* Parameter_List)
{
  ...
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 30;
    ...
    QCLI_Parameter_t* Parameter_List)
{
  ...
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 31;
...
QCLI_Command_Status_t apninfo_set_resource_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List)
{
  multi_app_cmd_parser_t *cmd_parser_temp = NULL;
  QCLI_Command_Status_t result =  QCLI_STATUS_SUCCESS_E;
  ...
  cmd_parser_temp->cmd_id = LWM2M_APN_INFO_SET_EVT_v2;
  cmd_parser_temp->Command = (QCLI_Command_t *)&m2m_stub_cmd_list_v2[0];
  cmd_parser_temp->Command_Index = 32;
...
QCLI_Command_Status_t 
proc_apninfo_set_resource_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List, int app_id)
{
  int resource_id = -1;
  int instance_id = -1;
  char *res_value = NULL;
  ...
  if(Parameter_List[0].Integer_Is_Valid)
  {
    instance_id = Parameter_List[0].Integer_Value;
  }
  if(Parameter_List[1].Integer_Is_Valid)
  {
    resource_id = Parameter_List[1].Integer_Value;
  }
  ...
  if (MAX_RES_LEN < strlen((char *)Parameter_List[2].String_Value))
    res_len = MAX_RES_LEN;
  else
    res_len = strlen((char *)Parameter_List[2].String_Value);
  ...
  memcpy(res_value, (char*)Parameter_List[2].String_Value, res_len);

  QCLI_Printf(qcli_m2m_stub_handle_v2, "Setting resource value for %d \n", resource_id);

  result = apn_info_set_v2(instance_id, resource_id, res_value, res_len);
