...
QCLI_Command_Status_t fw_update_result_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List);

QCLI_Command_Status_t fw_set_protocol_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List);

QCLI_Command_Status_t fw_set_delivery_method_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List);

QCLI_Command_Status_t fw_app_start_v2(uint32_t Parameter_Count,QCLI_Parameter_t* Parameter_List);	
...
QCLI_Command_Status_t fw_set_pkg_version_v2(uint32_t Parameter_Count, QCLI_Parameter_t *Parameter_List);
