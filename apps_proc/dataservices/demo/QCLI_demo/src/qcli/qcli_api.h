...
void*
qcli_memcpy(void *d, const void *s, size_t n);


/*-------------------------------------------------------------------------
 * Preprocessor Definitions and Constants
 *-----------------------------------------------------------------------*/
#define QCLI_MEMCPY(d, s, l)    qcli_memcpy((void *)(d), (void *)(s), (int32_t)(l))
#define QCLI_IP6CPY(a,b)         QCLI_MEMCPY((a),(b),sizeof(struct in6_addr))
