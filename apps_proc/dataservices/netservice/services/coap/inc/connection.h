...
extern int  inet_pton(int af, const char *src, void *dst); /* string to Binary addr */
extern const char *inet_ntop(int af, const void *src, char *dst, size_t size); /* Binary addr to string */
