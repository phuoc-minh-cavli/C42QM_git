...
qapi_Net_LWM2M_Instance_Info_v2_t *find_object_instance(uint16_t object_id, uint8_t instance_id);
...
qapi_Net_LWM2M_Data_v2_t* lwm2m_object_add(qapi_Net_LWM2M_Data_v2_t* head,
                                            qapi_Net_LWM2M_Data_v2_t* node);


qapi_Net_LWM2M_Instance_Info_v2_t* lwm2m_instance_add(qapi_Net_LWM2M_Instance_Info_v2_t* head,
...
qapi_Net_LWM2M_Data_v2_t* lwm2m_object_remove(qapi_Net_LWM2M_Data_v2_t *head,
                                           qapi_Net_LWM2M_Data_v2_t ** nodeP,
                                           uint8_t id);


qapi_Net_LWM2M_Instance_Info_v2_t* lwm2m_instance_remove(qapi_Net_LWM2M_Instance_Info_v2_t *head,
                                                      qapi_Net_LWM2M_Instance_Info_v2_t ** nodeP,
                                                      uint8_t id);

qapi_Net_LWM2M_Data_v2_t* lwm2m_object_find(qapi_Net_LWM2M_Data_v2_t* head,
                                         uint16_t id);

qapi_Net_LWM2M_Instance_Info_v2_t* lwm2m_instance_find(qapi_Net_LWM2M_Instance_Info_v2_t* head,
                                                    uint16_t id);
...
void test_obj_task_entry(ULONG thrd);
