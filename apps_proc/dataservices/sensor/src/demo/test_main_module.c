...
static void sen_obj_mutex_init(void)
{
  ...
  txm_module_object_allocate((void **)(&sen_obj_param.sen_obj_mutex), sizeof(TX_MUTEX));
...
static void sen_obj_signal_init(void)
{
  ...
  txm_module_object_allocate((void **)(&sen_obj_param.sen_obj_signal), sizeof(TX_EVENT_FLAGS_GROUP));
...
==============================================================================*/
void test_obj_task_entry(ULONG thread_ctxt)
{
...
void sen_obj_cmdq_init (sen_obj_info_t * sen_obj_state)
{
  ...
  txm_module_object_allocate((void **)(&sen_obj_cmdq), sizeof(TX_QUEUE));
