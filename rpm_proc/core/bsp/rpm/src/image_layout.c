...
#elif defined(MDM9x07_IMAGE_LAYOUT) || defined(MDM9x05_IMAGE_LAYOUT)
...
#define RPM_LOG_RESERVED_SPACE          0x2000
...
#else
RPM_COMPILE_ASSERT(RPM_LOG_START==0x9E000);     //Required since RPM clients already expect this
#endif
...
#else
RPM_COMPILE_ASSERT(RPM_SLEEP_STATS_START==0x9DFA0);     //Required since RPM clients already expect this
#endif
