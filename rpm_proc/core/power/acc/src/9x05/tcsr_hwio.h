...
#define HWIO_TCSR_SPARE_REG8_IN          \
        in_dword_masked(HWIO_TCSR_SPARE_REG8_ADDR, HWIO_TCSR_SPARE_REG8_RMSK)
...
#define HWIO_TCSR_SPARE_REG6_IN          \
        in_dword_masked(HWIO_TCSR_SPARE_REG6_ADDR, HWIO_TCSR_SPARE_REG6_RMSK)
...
#define HWIO_TCSR_SPARE_REG7_IN          \
        in_dword_masked(HWIO_TCSR_SPARE_REG7_ADDR, HWIO_TCSR_SPARE_REG7_RMSK)
...
#define HWIO_TCSR_SPDM_WRP_RT_CTI_CTL_IN          \
        in_dword_masked(HWIO_TCSR_SPDM_WRP_RT_CTI_CTL_ADDR, HWIO_TCSR_SPDM_WRP_RT_CTI_CTL_RMSK)
...
#define HWIO_TCSR_BOOT_IMEM_ENABLE_IN          \
        in_dword_masked(HWIO_TCSR_BOOT_IMEM_ENABLE_ADDR, HWIO_TCSR_BOOT_IMEM_ENABLE_RMSK)
...
#define HWIO_TCSR_QTIC_CTL_ST_IN          \
        in_dword_masked(HWIO_TCSR_QTIC_CTL_ST_ADDR, HWIO_TCSR_QTIC_CTL_ST_RMSK)
