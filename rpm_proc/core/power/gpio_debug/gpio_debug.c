...
int                      bob_bank                         = GPIO_BOB_ID/32; // math for the bank
...
void gpio_bob_toggle_high(void)
{
    HWIO_TLMM_GPIO_CFGn_OUTI(GPIO_BOB_ID,0x203); 
	HWIO_TLMM_GPIO_IN_OUTn_OUTI(GPIO_BOB_ID, 0x2);
}
...
void gpio_bob_toggle_low(void)
{
    HWIO_TLMM_GPIO_CFGn_OUTI(GPIO_BOB_ID,0x203); 
    HWIO_TLMM_GPIO_IN_OUTn_OUTI(GPIO_BOB_ID, 0x0);
}
