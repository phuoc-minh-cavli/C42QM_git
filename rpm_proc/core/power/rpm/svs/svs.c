...
#elif (DAL_CONFIG_TARGET_ID == 0x9205)
{
  ...
  { .clock_freq_khz = 177000, .voltage_requirement = RAILWAY_NOMINAL }, // standard RPM "fast" mode
  { .clock_freq_khz = 200000, .voltage_requirement = RAILWAY_SUPER_TURBO }, // standard RPM "faster" mode
};
#else
{
  { .clock_freq_khz = 100000, .voltage_requirement = RAILWAY_SVS_SOC }, // standard RPM "slow" mode
