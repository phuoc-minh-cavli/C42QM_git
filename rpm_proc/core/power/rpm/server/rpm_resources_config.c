...
$Header: //components/rel/rpm.bf/2.1.3/core/power/rpm/server/rpm_resources_config.c#2 $
$Date: 2019/02/08 $
...
static const rpm_resource_config_t temp_config_data[] =
{
    { RPM_LDO_A_REQ,        1 },  // VDDMX
    { RPM_LDO_A_REQ,       4 },  // VDDCX
    { (rpm_resource_type)0, 0 }
};
// Active->Sleep
static const rpm_resource_config_t bimc_preprocess_dep[] = 
{
//TODO: 9x05 update once we get list
#if 0
    { RPM_BUS_SLAVE_REQ,          0 },
	{ RPM_BUS_SLAVE_REQ,        202 },
	{ RPM_BUS_MASTER_REQ,         0 },
