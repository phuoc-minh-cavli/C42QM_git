...
{
  /* APSS */
  { (uint32 *) 0x600601C8, /* enable request */
    (uint32 *) 0x600601D0, /* detect ctl request */
    (uint32 *) 0x600601D8, /* detect ctl request 3*/
    (uint32 *) 0x600601E0, /* polarity request */
    (uint32 *) 0x600601E8, /* status */
    0x4,
  ...
  /* MSS */
  { (uint32 *) 0x600611C8, /* enable request */
    (uint32 *) 0x600611D0, /* detect ctl request */
    (uint32 *) 0x600611D8, /* detect ctl request 3 */
    (uint32 *) 0x600611E0, /* polarity request */
    (uint32 *) 0x600611E8, /* status */
    0x5,
