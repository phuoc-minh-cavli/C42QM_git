...
$Header: //components/rel/rpm.bf/2.1.3/core/systemdrivers/pmic/framework/inc/pm_rpm_target.h#1 $
...
/**
* @brief This function is to stub PMIC driver based on PMIC detected
*
* @return  BOOLEAN TRUE if PMIC is unknown
*                  FALSE if pmic is not unknown
*
*/
boolean  
pm_target_is_stub_enabled(void);
