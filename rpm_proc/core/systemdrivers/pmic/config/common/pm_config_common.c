...
$Header: //components/rel/rpm.bf/2.1.3/core/systemdrivers/pmic/config/common/pm_config_common.c#2 $ 
...
pm_pwr_register_info_type smps_reg[1] = 
{
    {0x1400, 0x300, 0x008, 0x045, 0x048, 0x046, 0x040, 0x041, 
     ...
     0x011, 0x012, 0x013, 0x014, 0x015, 0x016, 0x06C , 0x0B , 
     0x039 ,0x042 ,0x043 ,0x47 ,0x00,0x068 ,0x06B ,0x06E ,0x0A0 ,0x088}
};
...
pm_pwr_register_info_type ldo_reg[1] = 
{
    {0x4000, 0x100, 0x008, 0x045, 0x048, 0x046, 0x040, 0x041, 
     ...
     0x011, 0x012, 0x013, 0x014, 0x015, 0x016, 0x000 , 0x0B , 
     0x039 ,0x042 ,0x043 ,0x047 ,0x000, 0x068 ,0x000 ,0x06E,0x0A0 ,0x088} 
};
