...
/*
  ...
  $Header: //components/rel/rpm.bf/2.1.3/core/systemdrivers/platforminfo/src/PlatformInfo.c#2 $
  $DateTime: 2019/01/28 03:45:11 $
  $Author: pwbldsvc $
 ...
 */
#define PLATFORMINFO_RPM_MSG_RAM_OFFS 0x00002F80
