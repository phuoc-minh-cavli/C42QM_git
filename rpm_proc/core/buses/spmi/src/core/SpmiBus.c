 ...
 * $Header: //components/rel/rpm.bf/2.1.3/core/buses/spmi/src/core/SpmiBus.c#1 $
 * $Change: 17934472 $ 
 * 
 *                              Edit History
 * Date     Description
 * -------  -------------------------------------------------------------------
 * 01/03/17 KW warnings Clean up (CR - 105446)
                                ...
                                SpmiToken* token)
{
	...
	{
        SPMI_LOG_ERROR( " Memory Allacation Failed for Adding new ISR node" );
		return SPMI_FAILURE_MEMORY_NOT_AVAILABLE;
    }
