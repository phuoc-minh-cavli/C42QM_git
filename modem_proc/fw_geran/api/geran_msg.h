...
$Header: //source/qcom/qct/modem/fw/components/fw_geran.mpss/rel/15.2/api/geran_msg.h#1 $
...
/*! @brief Asynchronous FSK TX enter mode Command/Response messages */
typedef struct
{
  msgr_hdr_s   hdr;         //!< MSGR header
  uint32 fsktxBufIndex;			
  uint8  deviceID;  
} GfwHostFskEnterModeCmd;

typedef struct
{
  msgr_hdr_s   hdr;         //!< MSGR header
} GfwHostFskEnterModeRsp;

/*! @brief Asynchronous FSK TX Command/Response messages */ 
typedef struct
{
  msgr_hdr_s   hdr;       		//!< MSGR header
  uint32 fskTxBufIndex; 	  	/*FSK TX buf idx*/
  GfwBaudRateEnum baudRate;		/* FSK baud rate  */
  uint32 freq_dl;		  		/*carrier freq */
  uint32 delta_f;         		/* f1,f2*/
  uint16 hwFrameNo;
  uint16 startOffset;
  int32 f_hz_q6;
  uint32 inv_f_dl_lo;
...
/*! @brief Asynchronous FSK TX EXIT Command/Response messages */ 
typedef struct
{
  msgr_hdr_s   hdr;         //!< MSGR header
}GfwHostFskTxExitModeCmd;

typedef struct
{
  msgr_hdr_s   hdr;         //!< MSGR header
}GfwHostFskTxExitModeRsp;

typedef struct
{
	msgr_hdr_s   hdr;         //!< MSGR header

} GfwHostFskSetTxBandCmd;

typedef struct
{
	msgr_hdr_s   hdr;         //!< MSGR header

} GfwHostFskSetTxBandRsp;
...
enum
{
  ...
  MSGR_DEFINE_UMID( GERAN, FW, CMD, FSK_ENTER_MODE,  0x19, GfwHostFskEnterModeCmd ),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, FSK_ENTER_MODE,  0x1A, GfwHostFskEnterModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW, CMD, FSK_TX,  0x1B, GfwHostFskTxCmd   ),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, FSK_TX,  0x1C, GfwHostFskTxRsp   ),
  MSGR_DEFINE_UMID( GERAN, FW, CMD, FSK_TX_EXIT_MODE,  0x1D, GfwHostFskTxExitModeCmd),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, FSK_TX_EXIT_MODE,  0x1E, GfwHostFskTxExitModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW, CMD, FSK_SET_TX_BAND,  0x1F, GfwHostFskSetTxBandCmd),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, FSK_SET_TX_BAND,  0x20, GfwHostFskSetTxBandRsp),
  MSGR_DEFINE_UMID( GERAN, FW, RSP, FSK_TX_DONE,  0x21, GfwHostFskTxDoneRsp),
  ...
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, FSK_ENTER_MODE,  0x19, GfwHostFskEnterModeCmd ),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, FSK_ENTER_MODE,  0x1A, GfwHostFskEnterModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, FSK_TX,  0x1B, GfwHostFskTxCmd   ),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, FSK_TX,  0x1C, GfwHostFskTxRsp   ),
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, FSK_TX_EXIT_MODE,  0x1D, GfwHostFskTxExitModeCmd),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, FSK_TX_EXIT_MODE,  0x1E, GfwHostFskTxExitModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW2, CMD, FSK_SET_TX_BAND,  0x1F, GfwHostFskSetTxBandCmd),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, FSK_SET_TX_BAND,  0x20, GfwHostFskSetTxBandRsp),
  MSGR_DEFINE_UMID( GERAN, FW2, RSP, FSK_TX_DONE,  0x21, GfwHostFskTxDoneRsp),
  ...
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, FSK_ENTER_MODE,  0x19, GfwHostFskEnterModeCmd ),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, FSK_ENTER_MODE,  0x1A, GfwHostFskEnterModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, FSK_TX,  0x1B, GfwHostFskTxCmd   ),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, FSK_TX,  0x1C, GfwHostFskTxRsp   ),
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, FSK_TX_EXIT_MODE,  0x1D, GfwHostFskTxExitModeCmd),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, FSK_TX_EXIT_MODE,  0x1E, GfwHostFskTxExitModeRsp),
  MSGR_DEFINE_UMID( GERAN, FW3, CMD, FSK_SET_TX_BAND,  0x1F, GfwHostFskSetTxBandCmd),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, FSK_SET_TX_BAND,  0x20, GfwHostFskSetTxBandRsp),
  MSGR_DEFINE_UMID( GERAN, FW3, RSP, FSK_TX_DONE,  0x21, GfwHostFskTxDoneRsp)
