...
$Header: //components/rel/geran.mpss/5.2.0/api/public/log_codes_umts.h#2 $
...
/*  UMTS new log id request for GPS search */
#define LOG_WWAN_ADVANCE_SCAN_PARAM_LOG_C               (0x168 + LOG_UMTS_BASE_C)
#define LOG_LOC_WWAN_SCAN_RESULT_LOG_C                  (0x169 + LOG_UMTS_BASE_C)
#define LOG_WWAN_SCAN_RESULT_GSM_LOG_C                  (0x16A + LOG_UMTS_BASE_C)
