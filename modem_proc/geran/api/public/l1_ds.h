...
$Header: //components/rel/geran.mpss/5.2.0/api/public/l1_ds.h#3 $

when       who      what, where, why
--------   -------- ---------------------------------------------
09/12/19   ktg      CR2574067 FR 59617: Interface change with DS for CATM1 enhancement in power scan
...
/*Jamming status made uint32 to accomodate additional state for CATM & NB1*/
typedef void (*gl1_ds_jammer_detect_cb_type)(sys_radio_access_tech_e_type rat,uint32 jamming_status,boolean soft_jamming_status);

typedef struct
{
  gl1_ds_jammer_detect_cb_type jammer_cb;
  boolean         jammer_status;
  boolean         prev_jammer_status;
}gl1_jammer_data_t;
extern gl1_jammer_data_t gl1_jammer_data;

/*===========================================================================

FUNCTION ds_gl1_jammer_detect_cb_register
...
SIDE EFFECTS
  None
===========================================================================*/
boolean ds_gl1_jammer_detect_cb_register(gl1_ds_jammer_detect_cb_type cb);
#endif /* L1_DS_H */
