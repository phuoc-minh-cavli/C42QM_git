...
/* $Header: //components/rel/geran.mpss/5.2.0/api/geran_grr_api.h#3 $ */
...
extern void geran_grr_dtx_override_on_per_subs(void);
...
extern void geran_grr_dtx_override_off_per_subs(void);
