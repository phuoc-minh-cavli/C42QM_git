...
***
*** $Header: //components/rel/geran.mpss/5.2.0/api/gsmsnif.h#1 $
***
...
typedef enum
{
  ...
  GSNSM_ENTER_PSM_IND   = 0x04                 /* gsnsm_enter_psm_ind_type */
} gsnsm_prim_type;
...
typedef struct
{
  ...
  boolean                    psm_restore;    /* XID restore required upon PSM exit */
...
/* ===================================================================== */
/* SNSM-ENTER-PSM-IND message type definition. */

typedef struct
{
  gsnsm_prim_type           prim;       /* GSNSM_ENTER_PSM_IND                    */

  sys_modem_as_id_e_type    as_id;      /* Access stratum identity                */
} gsnsm_enter_psm_ind_type;
