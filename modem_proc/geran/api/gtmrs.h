...
$Header: //components/rel/geran.mpss/5.2.0/api/gtmrs.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     -------------------------------------------------------- 
02/03/17    hd      CR2013388 Make gstmr_adjust_terminal_count() independent of FEATURE_DUAL_SIM flag
...
void gstmr_register_handler_geran( gstmr_handler_type handler_ptr);
void gstmr_deregister_handler_geran( gstmr_handler_type handler_ptr);

boolean gstmr_is_handler_registered_geran(gstmr_handler_type handler_ptr);
...
uint32 gstmr_rd_qsymbol_count_geran( void );
...
extern uint32 get_gstmr_FN_mod4( );

/*check if GSTMR HW is ON to be able to read Qsym count*/
extern boolean gstmr_hw_on (void );
