...
$Header: //components/rel/geran.mpss/5.2.0/api/rr_l1.h#6 $ $DateTime: 2020/05/05 01:09:40 $ $Author: pwbldsvc $
...
/*,MPH_EXT_MEASUREMENT_IND               = 0xb2 */
  ...
  ,MPH_SERVING_MEAS_REQ                  = 0xe8
  ,MPH_SIMULATE_R13_PARAM_FROM_DIAG_IND  = 0xe9
  ,MPH_BSIC_CHANGE_IND                   = 0xf0
#ifdef FEATURE_EXTERNAL_PAGING_GERAN
  ,MPH_PROC_CNF                          = 0xf1
  ,MPH_PROC_IND                          = 0xf2
#endif /* FEATURE_EXTERNAL_PAGING_GERAN */
