...
***
*** $Header: //components/rel/geran.mpss/5.2.0/api/gsndcp.h#4 $
***
...
typedef union
{
  ...
  gsnsm_enter_psm_ind_type      snsm_enter_psm_ind;
} gsmsn_mes_u_type;
...
extern void gsndcp_to_sndcp_each_enqueue_cb(dsm_watermark_type* wm, void* callback_data);
extern void gsndcp_to_sndcp_gone_empty_cb(dsm_watermark_type* wm, void* callback_data);
extern boolean gsndcp_to_sndcp_sig_hdlr(comp_sig_enum_type sig, void* user_data_ptr);

/* Dynamically loaded APIs */
extern void geran_gsn_init();
extern void geran_gsn_deinit();

#ifdef FEATURE_EXTERNAL_PAGING_GERAN
extern void geran_gsn_start_post_resumption_activity(void);
extern void geran_gsn_resume();
extern void geran_gsn_suspend();
#endif
