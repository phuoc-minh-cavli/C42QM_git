...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/api/geran_test_mode_api.h#4 $
...
typedef void (*g2w_post_cb_fn)();
typedef void (*g2w_pre_cb_fn)();
...
FUNCTION  geran_test_mode_api_start_fsk_geran
...
===========================================================================*/
void geran_test_mode_api_start_fsk_geran(
                                          void (*tdma_isr_ptr)(sys_modem_as_id_e_type),
                                          rex_tcb_type  *task_ptr,
                                          void          (*task_wait_handler)(rex_sigs_type, sys_modem_as_id_e_type),
                                          rex_sigs_type task_wait_sig_1,
...
void geran_test_mode_api_stop_fsk_geran(void);
/*===========================================================================

FUNCTION geran_test_mode_api_fsk_tx
...
void geran_test_mode_api_fsk_tx
(
