...
***
*** $Header: //components/rel/geran.mpss/5.2.0/api/gmacsigl1.h#2 $
***
...
#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION
/*************************************************************************
* "MAC_L1_EXT_TBF_START_IND " MAC to l1 message structure
*************************************************************************/
typedef struct
{
  IMH_T      message_header;
  uint32     FN;
}mac_l1_ext_tbf_start_ind_t;
#endif /* FEATURE_GERAN_POWER_EFFICIENT_OPERATION */
