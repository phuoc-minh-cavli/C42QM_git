...
/* $Header: //components/rel/geran.mpss/5.2.0/api/geran_multi_sim_api.h#2 $ */
...
extern void    geran_api_set_tuneaway_blocked(const geran_api_client_id_t, const boolean);
