...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/src/grlculproc.h#5 $
***
...
**----------------------------------------------------------------------------
*/
extern q_type  grlc_ul_old_llc_q;

extern gprs_grr_ul_mes_t   *cur_pdu_ptr, *next_pdu_ptr;

/* Main structure containing the majority of data related to RLC uplink operations
*/
extern grlc_ul_t    ul;
extern grlc_static_ul_t ul_static;
...
*/
extern boolean b_block_timers_service_active;

/* Rachet counter to detect "rlc no data" condition
*/
extern uint16 grlc_ul_no_data_ctr;

#ifndef FEATURE_GERAN_REDUCED_DEBUG
/* GRLC UL Diagnostic Data
*/
extern grlc_diag_ul_statistics_t              ul_diag_stats_st;
extern grlc_diag_ul_abnormal_release_counts_t ul_diag_abn_rel_cnts_st;
extern grlc_diag_ul_event_counts_t            ul_diag_evt_cnts_st;
...
===
===========================================================================*/
void handle_contention_resolution_success (const mac_rlc_msg_t  *mac_msg_ptr);
