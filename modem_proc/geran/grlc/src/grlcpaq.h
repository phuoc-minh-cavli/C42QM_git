...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/src/grlcpaq.h#2 $
***
...
===
===========================================================================*/
extern void grlc_ul_init_paq (void);
...
===
===========================================================================*/
extern void grlc_ul_put_paq (gprs_grr_ul_mes_t *msg_ptr);
...
===
===========================================================================*/
extern void grlc_ul_paq_make_psn_current (uint16 psn, uint16 offset);
...
===
===========================================================================*/
extern void grlc_ul_unput_paq (void);
...
===
===========================================================================*/
extern boolean grlc_ul_paq_does_psn_exist (uint16 psn);
...
===
===========================================================================*/
extern void grlc_ul_del_free_paq_upto_psn (uint16 psn,boolean b_ul_psn_txed);
...
===
===========================================================================*/
extern uint16 grlc_ul_paq_seek_psn_cv0 (uint16 bsn);
