...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/src/grlcx.c#4 $
***
  ...
  */
  switch(mac_hdr->payload)
  {
    ...
    case MAC_PAYLOAD_RESERVED:
      MSG_GERAN_LOW_0("Payload is RLC_PAYLOAD_RESERVED");
      break;

    default:
      MSG_GERAN_ERROR_0("xlate_ext_mac_hdr_dyn: bad payload type");
      break;
  }
} /* xlate_ext_mac_hdr */
  ...
  */
  switch(mac_hdr->payload)
  {
    ...
    */
    ...
    case MAC_PAYLOAD_RESERVED:
      MSG_GERAN_LOW_0("xlate_int_mac_hdr: RLC_PAYLOAD_RESERVED");
      break;

    default:
      MSG_GERAN_LOW_0("xlate_int_mac_hdr: bad payload type");
      break;
  }
} /* xlate_int_mac_hdr */
...
)
{
  ...
  */
  ...
  dl.time_slot            = pl1_hdr_ptr->time_slot;

  dl.frame_number         = pl1_hdr_ptr->frame_number;
  ...
  */
  ...
  )
  {
    ...
    */
    ...
    #error code not present
#else
    xlate_ext_mac_hdr_dyn(buf, &cur_mac_hdr);
    ...
    */
    ...
    dl.tfi = gunpackb(buf, &msg_pos, GSIZE(grlc_dl_data_block_t, tfi));
      ...
      */
      do
      {
        ...
        */
        ...
        {
          MSG_GERAN_ERROR_0_G("xlate_ext_dl_data() Error stripping extension octet");
          break;
        }
    ...
    */
    ...
    rlc_log_dl_header( (byte)GPRS_HEADER_TYPE,
                      buf,
  ...
  {
    MSG_GERAN_ERROR_0_G("xlate_e_d Failed to strip MAC/RLC headers");
  }
...
)
{
  ...
  */
  is_padding_removed =
    e_grlc_dl_is_padding_removal_required_dyn(pl1_blk_ptr->hdr_arr, pl1_blk_ptr->mcs);
  ...
  */
  ...
  dl.time_slot            = pl1_blk_ptr->time_slot;
  dl.frame_number         = pl1_blk_ptr->frame_number;
  ...
  */
  ...
  e_cur_hdr.usf   = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, usf));
  e_cur_hdr.esp   = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, esp));
  e_cur_hdr.rrbp  = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, rrbp));
  e_cur_hdr.tfi   = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, tfi));
  e_cur_hdr.pr    = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, pr));
  e_cur_hdr.bsn1  = (uint16)eunpackw(pl1_blk_ptr->hdr_arr,
                                            &msg_pos,
                                            GSIZE(e_grlc_dl_hdr, bsn1));
  dl_blk1_ptr->bsn       = e_cur_hdr.bsn1;
  ...
  */
  switch (pl1_blk_ptr->mcs)
  {
    ...
    case RM_MCS_4:
    {
      ...
      rlc_log_dl_header( (byte)EGPRS_HEADER_TYPE_3,
                        pl1_blk_ptr->hdr_arr,
                        log_crc_status,
      ...
      */
      e_cur_hdr.cps   = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                                &msg_pos,
                                                GSIZE(e_grlc_dl_hdr_t3, cps));
      e_cur_hdr.spb   = (uint8)eunpackw( pl1_blk_ptr->hdr_arr,
                                                &msg_pos,
                                                GSIZE(e_grlc_dl_hdr_t3, spb));
      dl_blk1_ptr->spb = e_cur_hdr.spb;

      if (e_cur_hdr.spb == SPB_RETX_PART_2)
      {
      ...
      */
     if( EGPRS_IS_VQ_LE_BSN_LT_VQ_PLUS_WS(dl.vq, dl_blk1_ptr->bsn, dl.ws))
     {
        if(E_RX_ARR( dl_blk1_ptr->bsn).b_extra_depadding &&
           dl_blk1_ptr->cs == RM_MCS_3                  &&
           e_cur_hdr.spb == SPB_RETX_PART_1
          )
        {
         ...
         */
         if(dl_blk1_ptr->failed_crc == FALSE)
         {
           ...
           if(e_cur_hdr.cps == 3 || e_cur_hdr.cps == 4 || e_cur_hdr.cps == 5)
           {
             ...
             */
             ...
             {
               MSG_GERAN_ERROR_0_G("e_xlate_ext_dl_data Failed to strip payload");
             }

             MSG_GERAN_MED_2_G("ERLD DL_CORRECT_DEPADDING bsn=%u mcs=%u",
                      dl_blk1_ptr->bsn,
                      dl_blk1_ptr->cs);
           }
           E_RX_ARR( dl_blk1_ptr->bsn).b_extra_depadding = FALSE;
           dl_blk1_ptr->b_extra_depadding = FALSE;
         }
         else
         {
           ...
           MSG_GERAN_MED_2_G("ERLD DL_CORRECT_DEPADDING MCS_3 CRC bsn=%u mcs=%u",
                        dl_blk1_ptr->bsn,
                        dl_blk1_ptr->cs);
         }
        }
    ...
    case RM_MCS_6:
    {
      ...
      rlc_log_dl_header( (byte)EGPRS_HEADER_TYPE_2,
                        pl1_blk_ptr->hdr_arr,
                        log_crc_status,
                        pl1_blk_ptr->time_slot,
                        pl1_blk_ptr->frame_number,
      ...
      if( EGPRS_IS_VQ_LE_BSN_LT_VQ_PLUS_WS(dl.vq, dl_blk1_ptr->bsn, dl.ws))
      {
          ...
          )
        {
          ...
          */
          ...
          {
            is_padding_removed = TRUE;
            if(e_cur_hdr.cps == 0 || e_cur_hdr.cps == 1)
            {
          ...
          else
          {
            ...
            */
            dl_blk1_ptr->b_extra_depadding = TRUE;
            MSG_GERAN_MED_2_G("ERLD DL_CORRECT_DEPADDING MCS_6 CRC bsn=%u mcs=%u",
                        dl_blk1_ptr->bsn,
                        dl_blk1_ptr->cs);
          }
        }
    ...
    case RM_MCS_9:
    {
      ...
      */
      e_cur_hdr.bsn2  = (uint16)eunpackw(pl1_blk_ptr->hdr_arr,
                                                &msg_pos,
      ...
      */
      ...
      dl_blk2_ptr->bsn       = MOD_ESNS((e_cur_hdr.bsn1 + e_cur_hdr.bsn2));
      ...
      if (pl1_blk_ptr->crc_2 && pl1_blk_ptr->payload_2_ptr)
      {
         ...
         memscpy((void *)(&log_dl_pld[2*LOG_MAX_LI_E]), (sizeof(log_dl_pld) - (2*LOG_MAX_LI_E)),
      ...
      */
      if( EGPRS_IS_VQ_LE_BSN_LT_VQ_PLUS_WS(dl.vq, dl_blk1_ptr->bsn, dl.ws))
      {
        if((dl_blk1_ptr->failed_crc) && (dl_blk1_ptr->cs == RM_MCS_8) &&
           (E_RX_ARR( dl_blk1_ptr->bsn).vn == RXS_INVALID)
          )
        {
          dl_blk1_ptr->b_extra_depadding = TRUE;
          MSG_GERAN_MED_2_G("ERLD incoming BSN1 mcs 8 marked TRUE bsn=%u mcs=%u",
                      dl_blk1_ptr->bsn,
                      dl_blk1_ptr->cs);
        }
        else
      ...
      */
      ...
      rlc_log_dl_header( (byte)EGPRS_HEADER_TYPE_1,
                        pl1_blk_ptr->hdr_arr,
                        log_crc_status,
                        pl1_blk_ptr->time_slot,
                        pl1_blk_ptr->frame_number,
      ...
      if( MOD_ESNS( (dl_blk2_ptr->bsn + ESNS - dl_blk1_ptr->bsn) ) >= dl.ws )
      {
        MSG_GERAN_HIGH_3_G("GRLD 2nd BSN %d - 1st BSN %d >= WS %d ",
          dl_blk2_ptr->bsn,dl_blk1_ptr->bsn, dl.ws);
      }
        ...
        */
        do
        {
          ...
          */
          ...
          {
            MSG_GERAN_ERROR_0_G("GRLD xlate_ext_dl_data() Error stripping extension octet");
            break;
          }
      ...
      */
      if( (dl.dl_ass.rlc_mode == GRLC_MODE_ACK) && (pl1_blk_ptr->crc_2) )
      {
          ...
          for (b=0; b < dl_blk2_ptr->num_ext_octets; b++)
          {
            ...
            */
              ...
              )
            {
              ...
              MSG_GERAN_HIGH_3_G("ELRD Inconsistent LI and E-bit combination when CRC pass b=%u l1=%u ext=%u",
                               b,
            ...
            */
            ...
            {
              b_nack =  TRUE;
              MSG_GERAN_HIGH_0_G("ERLD Invalid LI sum for payload crc pass, nacking the block");
              break;
            }
          }
          ...
          */
          if (b_nack)
          {
            ...
            */
            ...
            MSG_GERAN_ERROR_3_G("ERLD incorrect crc pass block %u fn=%ld mcs=%u",
                                    dl_blk2_ptr->bsn,
                                    pl1_blk_ptr->frame_number,
                                    dl_blk2_ptr->cs);
          }
      ...
      */
      ...
      if(  dl_blk2_ptr->dsm_payload_ptr )
      {
        ...
        */
        ...
        {
            MSG_GERAN_ERROR_2_G("ERLD invalid blck length mcs_len=%d pl1_len=%d",
    ...
    default:
     MSG_GERAN_ERROR_1("Invalid Coding Scheme %d",pl1_blk_ptr->mcs);
    break;
  ...
  */
  ...
  /*  verify if the sum of LI do not exceed payload length
  */
  if( (dl.dl_ass.rlc_mode == GRLC_MODE_ACK) && (pl1_blk_ptr->crc_1) )
  {
    /* loop around to validate octet_cnt
    */
  ...
  if( dl_blk1_ptr->dsm_payload_ptr )
  {
    ...
    */
    ...
    if( is_padding_removed )
    {
      ...
      {
        MSG_GERAN_ERROR_2_G("ERLD invalid unpadded blck length mcs_len=%d pl1_len=%d",
                  E_GRLC_DATA_BLOCK_LEN[dl_blk1_ptr->cs],
  ...
  **--------------------------------------------------------------------------
  */
  if( e_cur_hdr.esp != pl1_blk_ptr->esp )
  {
    MSG_GERAN_ERROR_2_G("ERLD Conflicting ES/P values RLC %d vs PL1 %d",
              e_cur_hdr.esp,
              pl1_blk_ptr->esp
              );
  }

  if( e_cur_hdr.rrbp != pl1_blk_ptr->rrbp )
  {
    MSG_GERAN_ERROR_2_G("ERLD Conflicting RRBP values RLC %d vs PL1 %d",
              e_cur_hdr.rrbp,
              pl1_blk_ptr->rrbp
              );
  }
...
)
{
  ...
  ** We need this info to determine the actual payload length below.
  */
  is_padding_removed = e_grlc_dl_is_padding_removal_required_dyn(pl1_blk_ptr->hdr_arr,
                                                              pl1_blk_ptr->mcs);
  ...
  */
  switch (pl1_blk_ptr->mcs)
  {
    ...
    default:
     MSG_GERAN_ERROR_1_G("Invalid Coding Scheme %d",pl1_blk_ptr->mcs);
    break;
...
)
{
  ...
  **-----------------------------------------------------------------
  */
  if (ul_data->ti == RM_TLLI_PRESENT && ((msg_pos/8) < (GRLC_DATA_BLOCK_MAX_LEN-4)))
  {
  ...
  */
  ...
  {
    MSG_GERAN_ERROR_0("xlate_e_d Failed to strip payload");
  }
  ...
  */
  if (ul_data->dup_dsm_ptr != NULL)
  {
    ...
    MSG_GERAN_ERROR_1("GRLU xlate_int non-null payload post-strip l=%u", u);
...
)
{
  ...
  */
  ...
  switch (ul_data1->cs)
  {
    ...
    default:
      MSG_GERAN_ERROR_1("ERLU xlate_ext OOR MCS %u",ul_data1->cs);
      break;
  ...
  **-----------------------------------------------------------------------------------
  */
  if (ul_data1->ti == RM_TLLI_PRESENT && ((msg_pos/8) < (E_GRLC_DATA_BLOCK_MAX_LEN-4)))
  {
  ...
  */
    ...
    )
  {
    ...
    **----------------------------------------------------------------------------------
    */
    if (ul_data2->ti == RM_TLLI_PRESENT && ((msg_pos/8) < (E_GRLC_DATA_BLOCK_MAX_LEN-4)))
    {
