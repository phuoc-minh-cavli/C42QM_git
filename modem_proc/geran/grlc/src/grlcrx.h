...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/src/grlcrx.h#2 $   
***
...
**-------------------------------------------
*/
extern grlc_dl_data_block_t     cur_dl_blk;

extern e_grlc_dl_header_t       e_cur_hdr;

extern mac_hdr_t                cur_mac_hdr;
...
**-----------------------------------------------------------------------
*/
extern grlc_dl_data_block_t  (*(p_rx_arr))[];
...
**-----------------------------------------------------------------------
*/
extern pl1_radio_block_header_t *pl1_blk_hdr_ptr;
extern dsm_item_type            *pl1_blk_dsm_ptr;
...
**-----------------------------------------------------------------------
*/
extern e_pl1_radio_block_t e_pl1_dl_blk;
...
**-----------------------------------------------
*/
extern dl_radio_block_psho_t dl_psho_blind_arr[DL_BLIND_DATA_BLKS];
...
===
===========================================================================*/
extern void e_update_dl_unack_state_vars ( uint16 bsn );
...
===
===========================================================================*/
extern void grlc_dl_request_pkt_ack_nack_transmission(void);
...
===
===========================================================================*/
extern void ds_rx_ack_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_ack_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_ack_state_pl1_epdan_req_event_handler(void);
...
===
===========================================================================*/
extern void ds_rx_ack_pend_rel_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_ack_pend_rel_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void ds_rx_unack_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_unack_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_unack_state_pl1_epdan_req_event_handler(void);
...
===
===========================================================================*/
extern void ds_rx_unack_pend_rel_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern void e_ds_rx_unack_pend_rel_state_pl1_ph_data_ind_event_handler(void);
...
===
===========================================================================*/
extern boolean grlc_dl_schedule_pkt_ack_nack_transmission(void);
...
===
===========================================================================*/
extern void grlc_dl_delete_blind_data_blocks (void);
...
===
===========================================================================*/
extern void grlc_dl_store_blind_data_blocks (void);
