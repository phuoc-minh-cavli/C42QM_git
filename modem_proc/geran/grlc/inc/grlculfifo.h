...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/inc/grlculfifo.h#2 $
***
...
**------------------------------------------------------------------------------
*/
extern grlc_ul_pl1_fifo_t   grlc_ul_fifo;
...
===
===========================================================================*/
boolean grlc_ul_fifo_is_area_full (const tx_ack_state_t ack_state);
