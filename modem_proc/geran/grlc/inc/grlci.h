...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/inc/grlci.h#2 $
***
...
**-----------------------------------------------
*/
#define ULQ()  grlc_ul_llc_pdu_q		/* uplink LLC PDU queue */
#define ULTQ() grlc_ul_llc_tmp_pdu_q	/* uplink LLC TEMP PDU queue */
#define ULMQ() grlc_ul_llc_msg_q		/* uplink LLC MSG queue */
#define UMQ()  grlc_ul_mac_q			/* uplink MAC queue */
#define UTQ()  grlc_ul_tmr_q			/* uplink TIMER queue */
...
**-----------------------------------------------
*/
#define DMQ()  grlc_dl_mac_q		    /* downlink MAC queue */
#define DTQ()  grlc_dl_tmr_q		    /* downlink MAC queue */
#define DPQ()  grlc_dl_pl1_q		    /* downlink PL1 queue */
...
/* Macros to help convert to DUAL-SIM message, carrying a gas_id value
** eg.        MSG_HIGH("ERLU Sent NAK %d CV %d l %d",
**                  bsn,
**                  TX_ARR(bsn).blk.hdr.cv,
**                  TX_ARR(bsn).blk.data_len);
**
** becomes    MSG_GH3("ERLU Sent NAK %d CV %d l %d",
**                  bsn,
**                  TX_ARR(bsn).blk.hdr.cv,
**                  TX_ARR(bsn).blk.data_len);
**
** Where it becomes
**            MSG_3(MSG_SSID_DFLT, MSG_LEGACY_HIGH, txt,  arg1, arg2, arg3)
**
** So the appending text will show "ds:X ERLU Sent NAK %d CV %d l %d"
** where X is 0 or 1 which is the value of a local variable "gas_id"
**
** Note: where the MSG_GHx() is placed a local variable of the name "gas_id" MUST exist
*/

#define MSG_GL0(txt)                   MSG_GERAN_LOW_0_G(txt)
#define MSG_GL1(txt, arg1)             MSG_GERAN_LOW_1_G(txt, arg1)
#define MSG_GL2(txt, arg1, arg2)       MSG_GERAN_LOW_2_G(txt, arg1, arg2)
#define MSG_GL3(txt, arg1, arg2, arg3) MSG_GERAN_LOW_3_G(txt, arg1, arg2, arg3)

#define MSG_GM0(txt)                   MSG_GERAN_MED_0_G(txt)
#define MSG_GM1(txt, arg1)             MSG_GERAN_MED_1_G(txt, arg1)
#define MSG_GM2(txt, arg1, arg2)       MSG_GERAN_MED_2_G(txt, arg1, arg2)
#define MSG_GM3(txt, arg1, arg2, arg3) MSG_GERAN_MED_3_G(txt, arg1, arg2, arg3)

#define MSG_GH0(txt)                   MSG_GERAN_HIGH_0_G(txt)
#define MSG_GH1(txt, arg1)             MSG_GERAN_HIGH_1_G(txt, arg1)
#define MSG_GH2(txt, arg1, arg2)       MSG_GERAN_HIGH_2_G(txt, arg1, arg2)
#define MSG_GH3(txt, arg1, arg2, arg3) MSG_GERAN_HIGH_3_G(txt, arg1, arg2, arg3)

#define MSG_GE0(txt)                   MSG_GERAN_ERROR_0_G(txt)
#define MSG_GE1(txt, arg1)             MSG_GERAN_ERROR_1_G(txt, arg1)
#define MSG_GE2(txt, arg1, arg2)       MSG_GERAN_ERROR_2_G(txt, arg1, arg2)
#define MSG_GE3(txt, arg1, arg2, arg3) MSG_GERAN_ERROR_3_G(txt, arg1, arg2, arg3)

#define MSG_GF0(txt)                   MSG_GERAN_FATAL_0_G(txt)
#define MSG_GF1(txt, arg1)             MSG_GERAN_FATAL_1_G(txt, arg1)
#define MSG_GF2(txt, arg1, arg2)       MSG_GERAN_FATAL_2_G(txt, arg1, arg2)
#define MSG_GF3(txt, arg1, arg2, arg3) MSG_GERAN_FATAL_3_G(txt, arg1, arg2, arg3)

/* Non-gas-id versions
*/

#define MSG_L0(txt)                   MSG_GERAN_LOW_0(txt)
#define MSG_L1(txt, arg1)             MSG_GERAN_LOW_1(txt, arg1)
#define MSG_L2(txt, arg1, arg2)       MSG_GERAN_LOW_2(txt, arg1, arg2)
#define MSG_L3(txt, arg1, arg2, arg3) MSG_GERAN_LOW_3(txt, arg1, arg2, arg3)

#define MSG_M0(txt)                   MSG_GERAN_MED_0(txt)
#define MSG_M1(txt, arg1)             MSG_GERAN_MED_1(txt, arg1)
#define MSG_M2(txt, arg1, arg2)       MSG_GERAN_MED_2(txt, arg1, arg2)
#define MSG_M3(txt, arg1, arg2, arg3) MSG_GERAN_MED_3(txt, arg1, arg2, arg3)

#define MSG_H0(txt)                   MSG_GERAN_HIGH_0(txt)
#define MSG_H1(txt, arg1)             MSG_GERAN_HIGH_1(txt, arg1)
#define MSG_H2(txt, arg1, arg2)       MSG_GERAN_HIGH_2(txt, arg1, arg2)
#define MSG_H3(txt, arg1, arg2, arg3) MSG_GERAN_HIGH_3(txt, arg1, arg2, arg3)

#define MSG_E0(txt)                   MSG_GERAN_ERROR_0(txt)
#define MSG_E1(txt, arg1)             MSG_GERAN_ERROR_1(txt, arg1)
#define MSG_E2(txt, arg1, arg2)       MSG_GERAN_ERROR_2(txt, arg1, arg2)
#define MSG_E3(txt, arg1, arg2, arg3) MSG_GERAN_ERROR_3(txt, arg1, arg2, arg3)

#define MSG_F0(txt)                   MSG_GERAN_FATAL_0(txt)
#define MSG_F1(txt, arg1)             MSG_GERAN_FATAL_1(txt, arg1)
#define MSG_F2(txt, arg1, arg2)       MSG_GERAN_FATAL_2(txt, arg1, arg2)
#define MSG_F3(txt, arg1, arg2, arg3) MSG_GERAN_FATAL_3(txt, arg1, arg2, arg3)
