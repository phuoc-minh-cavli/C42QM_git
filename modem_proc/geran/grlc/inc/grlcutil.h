...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/inc/grlcutil.h#5 $
***
...
#define RLC_UL_SET_SIG(x)                                                                   \
  {                                                                                         \
    (void)rex_set_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_UL), ((x) & GRLC_UL_MASTER_SIG));  \
    grlc_ul_task_sigs = rex_get_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_UL));                \
  }

#define RLC_UL_CLR_SIG(x)                                                                   \
  {                                                                                         \
    (void)rex_clr_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_UL), ((x) & GRLC_UL_MASTER_SIG));  \
    grlc_ul_task_sigs = rex_get_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_UL));                \
  }

/* Macros to set and clear a RLC DL signal mask
*/
#define RLC_DL_SET_SIG(x)                                                                   \
      {                                                                                         \
        (void)rex_set_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_DL), ((x) & GRLC_DL_MASTER_SIG));  \
        grlc_dl_task_sigs = rex_get_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_DL));                \
      }

#define RLC_DL_CLR_SIG(x)                                                                   \
      {                                                                                         \
        (void)rex_clr_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_DL), ((x) & GRLC_DL_MASTER_SIG));  \
        grlc_dl_task_sigs = rex_get_sigs(geran_tcb_read(GERAN_TASK_ID_GRLC_DL));                \
      }

/* Macros to set and clear specific RLC UL signal mask
*/
#define RLC_UL_SET_LLC_TMP_PDU_SIG()  RLC_UL_SET_SIG(GRLC_UL_LLC_TMP_PDU_SIG)
#define RLC_UL_CLR_LLC_TMP_PDU_SIG()  RLC_UL_CLR_SIG(GRLC_UL_LLC_TMP_PDU_SIG)

#define RLC_UL_SET_LLC_PDU_SIG()      RLC_UL_SET_SIG(GRLC_UL_LLC_PDU_SIG)
#define RLC_UL_CLR_LLC_PDU_SIG()      RLC_UL_CLR_SIG(GRLC_UL_LLC_PDU_SIG)

#define RLC_UL_SET_LLC_MSG_SIG()      RLC_UL_SET_SIG(GRLC_UL_LLC_MSG_SIG)
#define RLC_UL_CLR_LLC_MSG_SIG()      RLC_UL_CLR_SIG(GRLC_UL_LLC_MSG_SIG)

#define RLC_UL_SET_PL1_SIG()          RLC_UL_SET_SIG(GRLC_UL_PL1_SIG)
#define RLC_UL_CLR_PL1_SIG()          RLC_UL_CLR_SIG(GRLC_UL_PL1_SIG)

#define RLC_UL_SET_MAC_SIG()          RLC_UL_SET_SIG(GRLC_UL_MAC_SIG)
#define RLC_UL_CLR_MAC_SIG()          RLC_UL_CLR_SIG(GRLC_UL_MAC_SIG)


#define RLC_UL_SET_TMR_SIG()          RLC_UL_SET_SIG(GRLC_UL_TMR_SIG)
#define RLC_UL_CLR_TMR_SIG()          RLC_UL_CLR_SIG(GRLC_UL_TMR_SIG)

#ifndef PERLUTF
#define RLC_UL_SET_ITN_SIG()          RLC_UL_SET_SIG(GRLC_UL_ITN_SIG)
#else
  #error code not present
#endif

#define RLC_UL_CLR_ITN_SIG()          RLC_UL_CLR_SIG(GRLC_UL_ITN_SIG)

#define RLC_UL_SET_DYN_RESUME_SIG()   RLC_UL_SET_SIG(GRLC_UL_DYN_RESUME_SIG)
#define RLC_UL_CLR_DYN_RESUME_SIG()   RLC_UL_CLR_SIG(GRLC_UL_DYN_RESUME_SIG)

/* Macros to test for a specific signal mask being set
*/
#define RLC_UL_IS_LLC_PDU_SIG_SET()     (grlc_ul_task_sigs & GRLC_UL_LLC_PDU_SIG)
#define RLC_UL_IS_LLC_TMP_PDU_SIG_SET() (grlc_ul_task_sigs & GRLC_UL_LLC_TMP_PDU_SIG)
#define RLC_UL_IS_LLC_MSG_SIG_SET()     (grlc_ul_task_sigs & GRLC_UL_LLC_MSG_SIG)
#define RLC_UL_IS_PL1_SIG_SET()         (grlc_ul_task_sigs & GRLC_UL_PL1_SIG)
#define RLC_UL_IS_MAC_SIG_SET()         (grlc_ul_task_sigs & GRLC_UL_MAC_SIG)


#define RLC_UL_IS_TMR_SIG_SET()         (grlc_ul_task_sigs & GRLC_UL_TMR_SIG)
#define RLC_UL_IS_ITN_SIG_SET()         (grlc_ul_task_sigs & GRLC_UL_ITN_SIG)

#define RLC_DL_IS_PL1_SIG_SET()           (grlc_dl_task_sigs & GRLC_DL_PL1_SIG)
#define RLC_DL_IS_PL1_EPDAN_REQ_SIG_SET() (grlc_dl_task_sigs & GRLC_DL_PL1_EPDAN_REQ_SIG)
#define RLC_DL_IS_MAC_SIG_SET()           (grlc_dl_task_sigs & GRLC_DL_MAC_SIG)
#define RLC_DL_IS_TMR_SIG_SET()           (grlc_dl_task_sigs & GRLC_DL_TMR_SIG)


/* Macros to set and clear specific RLC DL signal mask
*/
#define RLC_DL_SET_PL1_SIG()            RLC_DL_SET_SIG(GRLC_DL_PL1_SIG)
#define RLC_DL_CLR_PL1_SIG()            RLC_DL_CLR_SIG(GRLC_DL_PL1_SIG)

#define RLC_DL_SET_PL1_EPDAN_REQ_SIG()  RLC_DL_SET_SIG(GRLC_DL_PL1_EPDAN_REQ_SIG)
#define RLC_DL_CLR_PL1_EPDAN_REQ_SIG()  RLC_DL_CLR_SIG(GRLC_DL_PL1_EPDAN_REQ_SIG)

#define RLC_DL_SET_MAC_SIG()            RLC_DL_SET_SIG(GRLC_DL_MAC_SIG)
#define RLC_DL_CLR_MAC_SIG()            RLC_DL_CLR_SIG(GRLC_DL_MAC_SIG)

#define RLC_DL_SET_TMR_SIG()            RLC_DL_SET_SIG(GRLC_DL_TMR_SIG)
#define RLC_DL_CLR_TMR_SIG()            RLC_DL_CLR_SIG(GRLC_DL_TMR_SIG)
...
*/
#define TX_ARR(ind)  ((*p_tx_arr)[(ind)%E_TX_WORKSPACE])
...
*/
#define RX_ARR(ind)  ((*p_rx_arr)[(ind)%RM_RLC_RX_WORKSPACE])

/* This macro maps the virtual transmit array with value in the range of 0..2047
** to the physical transmit array of the range from 0..E_RX_WORKSPACE-1.
*/
#define E_RX_ARR(ind)  ((*p_rx_arr)[(ind)%E_RX_WORKSPACE])
...
#define CHECK_RANGE(v,min,max,def)                                          \
    if ((v) < (min) || (v) > (max))                                         \
    {                                                                       \
      MSG_ERROR("ERLU %u OOR MinMax: 0x%08x Force to %u",(v),               \
