...
***
*** $Header: //components/rel/geran.mpss/5.2.0/grlc/inc/grlctimer.h#3 $
***
...
/* Place the timer ID in the 1st byte
*/
#define TIMER_SET_PARAM(timer_param)  (timer_param & 0xff)

/* Extract the timer_id (in the 1st byte)
*/
