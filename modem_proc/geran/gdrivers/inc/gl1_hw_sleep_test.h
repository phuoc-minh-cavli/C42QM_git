...
void gl1_hw_inject_test_delay(gl1_hw_slp_delay_loc_enum delay_loc );

#define GL1_HW_INJECT_TEST_DELAY(arg1) gl1_hw_inject_test_delay(arg1)
...
#define GL1_HW_INJECT_TEST_DELAY(arg1)
