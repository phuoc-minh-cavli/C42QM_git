...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_sys_algo_gprs.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
SIDE EFFECTS
   None
============================================================================= */
void sys_algo_gprs_agc_reset (void);
