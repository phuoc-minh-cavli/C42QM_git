...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_hwi.h#4 $ $DateTime: 2018/12/20 10:06:26 $ $Author: pwbldsvc $

when        who     what, where, why
--------    ---     --------------------------------------------------------
11/12/18    akm     CR2319101 PSM related changes required in GERAN - GL1
...
extern void gl1_hw_sleep_set_rf_on( boolean rf_on   );
extern boolean gl1_hw_sleep_get_rf_on(  void );

void gl1_hw_turn_rx_on(boolean blocking  );
void gl1_hw_turn_rx_off( void  );
void gl1_hw_send_psm_entry_ind( void );
...
void gl1_hw_wcdma_init( void );
void gl1_hw_wcdma_inact( void );
...
============================================================================= */
void gl1_hw_schedule_frame_delay (int16 delay );
void gl1_hw_schedule_set_medium_access_mode (gl1_defs_access_mode_type mode );
void gl1_hw_schedule_dtm_rx (const mdsp_dtm_rx_params_type *params );
void gl1_hw_schedule_dtm_tx (const mdsp_dtm_tx_params_type *params );
...
void gl1_hw_schedule_async_rx (gl1_hw_channel_type chan_type, uint16 timing_offset );
void gl1_hw_schedule_start_acq (uint16 timing_offset );
void gl1_hw_schedule_stop_acq (uint16 timing_offset );
void gl1_hw_update_acq_in_progress(boolean status );

#if defined(FEATURE_INTERRAT_HANDOVER_GTOW) || defined(FEATURE_INTERRAT_CELL_RESELECTION_GTOW )
void gl1_hw_schedule_rf_sample_ram (uint16 timing_offset );
void gl1_hw_schedule_g2x_gap (uint32  timing_offset );
#endif
uint32 gl1_hw_schedule_get_num_slots( void );
