...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/g2wsrchwfwintf.h#2 $
...
typedef void (*g2w_mdsp_post_cb_fn)( void );
typedef void (*g2w_mdsp_pre_cb_fn)(void );

/* Generic Callback function type for FW-to-SW event done */
typedef void (*g2w_event_done_cb_fn) (g2w_mdsp_event_type);
...
===========================================================================*/
extern void g2w_mdsp_sync_init(void );
...
===========================================================================*/
extern void g2w_set_event_done_cb(g2w_event_done_cb_fn g2w_event_cb );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void g2w_mdsp_sync_event_handler(void );
...
SIDE EFFECTS   None.
===========================================================================*/
extern void g2w_mdsp_step1_dump(void );
...
SIDE EFFECTS  None.
===========================================================================*/
extern uint16 g2w_mdsp_nastt_dump(void );
...
SIDE EFFECTS None.
===========================================================================*/
extern void g2w_mdsp_pn_after_nastt_dump(void );
...
SIDE EFFECTS None.
===========================================================================*/
extern void g2w_mdsp_store_stage1_result(void );
...
SIDE EFFECTS None.
===========================================================================*/
extern void g2w_mdsp_store_reconf_result(void );
...
===========================================================================*/
extern int16 g2w_mdsp_get_rssi(void );
