...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/g2wsrchdrv.h#2 $
...
typedef void (*g2w_srch_list_srch_result_cb)(g2w_mdsp_list_srch_struct_type * );

typedef void (*g2w_srch_pn_after_nastt_srch_result_cb)
                (g2w_mdsp_pn_after_nastt_results_type *pn_after_nastt_ptr );

typedef void (*g2w_srch_srch_abort_cb)(void );

/* Callback functions for Dedicated mode */
typedef void (*g2w_srch_ded_mode_srch_result_cb)
             (gl1_wcdma_ded_mode_list_srch_struct_type *list_ptr);

/* Callback function type for returning WFW status */

typedef void (*g2w_wfw_status_cb_func_type) (g2w_wfw_status_enum_type );
...
SIDE EFFECTS
  None.
===========================================================================*/
extern void g2w_srch_wfw_sw_init( void );
...
===========================================================================*/
extern void gl1_wcdma_ded_mode_cfg_terminate( void );
#ifdef FEATURE_WCDMA
/*===========================================================================
...
===========================================================================*/
extern void g2w_srch_cleanup_wcdma_meas(void );
#endif
/*===========================================================================
...
extern void gl1_wcdmadrv_program_list_srch (
  ...
  g2w_srch_list_input_task_type *srchlist_ptr );
...
extern boolean gl1_wcdmadrv_program_ded_mode_search(
  ...
  g2w_srch_list_input_task_type *list_srch_ptr );
...
===========================================================================*/
extern void gl1_wcdmadrv_abort_search ( void );
...
===========================================================================*/
extern boolean g2w_srch_drv_validate_state(void );
...
===========================================================================*/
extern void gl1_wcdma_get_ecio_rscp_rssi(g2w_srch_eng_parm_struct_type *cell_eng_ptr);
