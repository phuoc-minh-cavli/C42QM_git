...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_hw_g.h#11 $
...
07/24/19    sal      CR2494014  If it's rude wake up then skip scheduling any command to FW in this frame.
14/02/17    mk      CR2004610 : FR 40251 (SeNS) - Add NV item to enable SeNS feature
15/10/18    ktg     CR2317283 : FR 46672: Jammer detection and mitigation in GSM 
27/08/18   sk       CR2256269 FR50457 GL1 changes for SPLL interface changes
...
trm_ant_switch_div_config_type gl1_trm_asdiv_idle_pingpong_thresh_check( int32 new_idle_config);
void gl1_trm_asdiv_traffic_denial_thresh_check( trm_set_ant_switch_return_type new_config_success);


boolean gl1_trm_asdiv_get_traffic_crisis_flag(void);
...
void gl1_trm_ant_switch_div_set_mode (trm_client_mode_type mode_setings );
void gl1_trm_ant_switch_div_set_config (  void );
void gl1_trm_asd_set_mode_and_config (trm_client_mode_type    mode , trm_ant_switch_div_config_type  config );
void gl1_hw_set_asdiv_mode_config( trm_client_mode_type mode);
void gl1_hw_set_asdiv_sleep_config(void);
void set_pending_asdiv_switch_request( boolean antenna_pos   );
void clear_pending_asdiv_switch_request( void );
boolean read_pending_asdiv_switch_request( void );
void gl1_hw_init_asdiv_preferred_antenna( trm_ant_switch_get_input_type ant_config_type);
...
void gl1_trm_asdiv_debug_test_mode_init_sm(void);
...
boolean gl1_trm_asdiv_debug_get_test_mode(void);
...
void gl1_trm_asdiv_debug_test_mode_switch_sm( trm_client_mode_type mode);
...
typedef void (* gl1_hw_panic_cb_type)();
...
extern boolean gl1_is_sleep_disabled( void );
extern boolean gl1_is_rf_sleep_disabled( void );
extern boolean gl1_is_fw_sleep_disabled( void );
extern boolean gl1_asynch_int_dbg( void );
extern boolean gl1_is_asynch_sleep_enabled( void );
extern boolean gl1_is_rf_sleep_disabled( void );
extern boolean gl1_is_fw_sleep_disabled( void );
extern boolean gl1_is_sleep_opt3_enabled( void );
extern boolean gl1_is_sbd_enabled(void  );
extern boolean gl1_is_epd_allowed( void );
extern boolean gl1_is_early_decode_disabled( void  );
extern boolean gl1_is_adaptive_timeline_disabled(  void );
extern boolean gl1_is_drx_debug_enabled(void );

#define GL1_HW_EFS_DEBUG_ENABLED( dEBUG_mASK ) \
  ( ( gl1_hw_efs_get_debug() & ( dEBUG_mASK ) ) == \
    ( dEBUG_mASK ) )
...
extern boolean gl1_hw_gcf_flag_enabled(void);
...
gl1_hw_ps_metrics_t   gl1_hw_ps_metrics;
  ...
  typedef struct
  {
    boolean  is_nb_jammer_detected;
    boolean  rescheduled;
    uint8  count;
    rf_gain_range_T gain_range;
  }gl1_hw_nb_jdet_table_t;

  typedef struct
  {
    gl1_hw_nb_jdet_table_t     gl1_hw_nb_jdet_table[RR_MAX_PSCAN_FREQ_SCAN];  
  } gl1_hw_nb_jdet_data_t;

  void gl1_hw_update_nb_jdet_table(uint32 index, boolean nb_jammer_detected);
  boolean gl1_hw_get_nb_jdet_status(uint32 index);
  rf_gain_range_T gl1_hw_get_rf_gsm_gainstate(uint32 index);
  boolean gl1_hw_check_if_nb_jammer_detected(GfwWbeeWbdcEst* wbeeWbdcEst, ARFCN_T arfcn, uint32 index);
  void gl1_hw_nb_jdet_data_init(void);
...
extern boolean  gl1_hw_schedule_x2g_gap_startup( uint16  timing_offset  );
extern boolean  gl1_hw_schedule_x2g_gap_cleanup( uint16  timing_offset, boolean  pre_tick  );
extern void     gl1_hw_schedule_remove_x2g_startup( void );
...
extern void gl1_hw_x2g_send_commands(void);
extern boolean tds_irat_build_rf_scripts_flag;
extern boolean gl1_tds_ready_to_build_rf_scripts;
...
#ifdef FEATURE_QTA
void gl1_hw_qta_empty_gap_cleanup( void );
#endif
...
extern int32 gl1_hw_tcxo_freq_read( void );


/* Are we in the reduced monitor state */
boolean gl1_hw_ncell_pch_low_monitor_active( void );
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_hw_dm_complete (void);
...
===========================================================================*/
void gl1_hw_set_ho_pwr( int16 agc_pwr);
...
boolean gl1_hw_get_idle_mode(void);
/*===========================================================================
...
===========================================================================*/
void gl1_hw_set_idle_mode(boolean state);
...
===========================================================================*/
void gl1_hw_set_dedicated( boolean dedicated );
...
===========================================================================*/
boolean gl1_hw_get_dedicated( void );
...
SIDE EFFECTS
  None
===========================================================================*/
tcxomgr_vco_type gl1_hw_get_afc_pdm_val( void );
...
SIDE EFFECTS
  None
===========================================================================*/
int32 gl1_hw_max_rotator_correction_in_hz( void );
...
extern boolean gl1_hw_sleep_ccch_deferred_wakeup_status(void);

#if defined ( FEATURE_DUAL_SIM ) || defined ( FEATURE_TRIPLE_SIM )
extern wmgr_client_enum_t gl1_hw_map_gas_id_to_wmgr_client( void );

extern gas_id_t gl1_hw_map_wmgr_client_to_gas_id( wmgr_client_enum_t wmgr_client );
extern boolean gl1_hw_check_granted_device_is_irat_compatabile(uint16 W_chn );
extern boolean gl1_hw_check_granted_device_is_LTE_irat_compatabile(lte_earfcn_t lte_dl_earfcn );
...
(
  void          (*tdma_isr_ptr)(sys_modem_as_id_e_type as_id),
  rex_tcb_type  *task_ptr,
  void          (*task_wait_handler)(rex_sigs_type_t),
  rex_sigs_type task_wait_sig_1,
  rex_sigs_type task_wait_sig_2
);
...
===========================================================================*/
void gl1_hw_set_multi_sim_sleep( boolean allowed );
...
===========================================================================*/
void gl1_hw_set_multi_sim_gonly_deact(  void );
...
===========================================================================*/
void gl1_hw_multi_sim_deact( void );
#ifdef FEATURE_G2X_TUNEAWAY
void gl1_hw_multi_sim_deact_g2x( void );
#endif
/* ----------------------------------------------------------------------- */
...
#ifdef FEATURE_WCDMA
boolean gl1_hw_gsm_client_requires_resource(void);
void    gl1_hw_sleep_wcdma_active(const boolean is_active );
#endif /* FEATURE_WCDMA */
...
void gl1_set_gfw_app_mode_status(GfwAppModeType gfw_app_mode );
GfwAppModeType gl1_get_gfw_app_mode(void);

#endif /* FEATURE_DUAL_SIM | FEATURE_TRIPLE_SIM */

#ifndef FEATURE_GSM_RFLM_FED
boolean gl1_get_vote_for_tx_on(void);
void    gl1_set_vote_for_tx_on(boolean tx_on );
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_hw_sleep_reset_mdsp_intf( void );
...
===========================================================================*/
boolean gl1_hw_inact_isr(boolean force_mdsp_inact );
...
===========================================================================*/
void gl1_hw_inact( boolean deep_sleep );
...
===========================================================================*/
void gl1_hw_sleep_gsm_panic_inact( void );
...
===========================================================================*/
void gl1_hw_sleep_gsm_init( void );
...
===========================================================================*/
void gl1_hw_sleep_gsm_shutdown( void );
...
===========================================================================*/
int32 gl1_hw_tone_detected_total_freq_offset(ARFCN_T arfcn, int32 afc_freq );
...
extern void gl1_hw_set_dl_acs_amr ( mdsp_amr_codec_mode_type *dl_acs);
...
===========================================================================*/
extern void gl1_hw_enable_ciphering ( uint8 *key, gl1_defs_cipher_mode mode );

extern void gl1_hw_disable_ciphering ( void );

extern void gl1_hw_update_ciphering_fn ( void );
...
===========================================================================*/
extern void gl1_hw_init_tch ( gl1_hw_channel_type chan);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_hw_align_vfr( void );
...
void gl1_hw_reset_cs_only( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_tch_loopback( gl1_defs_loopback_type loopback );
#endif /* #ifdef FEATURE_GERAN_CS_SUPPORT */
/****************************************************************************
...
============================================================================= */
void gl1_hw_abort_rx_decode (gl1_hw_rx_tags_type *tags);
...
===========================================================================*/
boolean gl1_hw_feature_disabled_ir (void );
...
============================================================================= */
boolean gl1_hw_schedule_tt_ok (int16 delay );
...
============================================================================= */
void gl1_hw_schedule_init (void );
...
============================================================================= */
void gl1_hw_schedule_reset_events (void );
...
============================================================================= */
boolean gl1_hw_pwr_meas_results_available(void);
...
============================================================================= */
void gl1_hw_pwr_meas_abort (void);
...
===========================================================================*/
void gl1_hw_terminate_tch ( void );
...
============================================================================= */
void gl1_hw_schedule_frame_tick (uint32 timestamp);
...
===========================================================================*/
void gl1_hw_dtm_frame_tick (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_delay_frame_tick(int16 offset);
...
============================================================================= */
void gl1_hw_set_num_assigned_tx_slots (uint8 num_assigned_tx_slots);
...
===========================================================================*/
boolean gl1_hw_get_saic_state(void);
#endif
...
===========================================================================*/
void gl1_hw_cfg_saic( boolean state);
...
===========================================================================*/
void gl1_hw_flush_esaic_iir_filter (boolean flush_esacch, boolean flush_ersacch);
...
void   gl1_hw_acq_afc_init(gl1_defs_acq_afc_type *data_t);
void   gl1_hw_acq_afc_on_vctcxo(boolean active);
...
int32 gl1_hw_get_vctcxo_pdm_val( void );
...
void  gl1_hw_store_vctcxo_pdm_val(int32 pdm_val);

int32 gl1_hw_calc_phase_increment(ARFCN_T arfcn);
void  gl1_hw_set_afc_band(sys_band_T band, boolean dedicated_mode);

void  gl1_hw_afc_locked(boolean is_idle);
...
int32 gl1_hw_get_rotator_val(void);
void  gl1_hw_set_rotator_val(int32 rot_val);
void  gl1_hw_store_rotator_val(int32 new_rot_val);

extern mdsp_rf_desense_chan_type gl1_hw_is_arfcn_xo_desense( ARFCN_T arfcn );

boolean gl1_hw_apply_afc_to_rotator( ARFCN_T arfcn);
extern void  gl1_hw_set_xo_acc_freq_err( int32 xo_value );
extern int32 gl1_hw_get_xo_acc_freq_err_in_ppm( void );
extern int32 gl1_hw_get_xo_acc_freq_err( void );
extern void  gl1_hw_update_xo_acc_freq_err( int32 xo_freq_err );
extern void gl1_msg_set_acq_xo_value( int32 xo_value );

extern int32 gl1_hw_normxofreqtofreq( ARFCN_T arfcn, int32 norm_xo_freq  );
extern int32 gl1_hw_freqtonormxofreq( ARFCN_T arfcn, int32 fine_freq  );

extern int32 gl1_hw_convert_normxofreq_to_rot( ARFCN_T arfcn, int32 xo_val );
extern int32 gl1_hw_convert_normcurrentxofreq_to_rot( ARFCN_T arfcn );

extern void  gl1_hw_set_active_cycle_swallower_adj( ARFCN_T arfcn );
extern void  gl1_hw_gfw_config_cycle_swallower( void );
void gl1_hw_set_gfw_config_cycle_valid_state( boolean isValid);
extern boolean gl1_hw_get_mdsp_freq_config_data ( gl1_hw_mdsp_freq_t *freq_config_data );

extern void gl1_hw_set_xo_rx_config( ARFCN_T arfcn );
...
int32 gl1_hw_pdmtohz(int32 pdm);
int32 gl1_hw_hztopdm(int32 hz);
...
void gl1_hw_store_mon_freq( ARFCN_T arfcn );
...
===========================================================================*/
extern void gl1_hw_log_async_rx_data( gl1_defs_metrics_rpt *rpt );

#ifdef FEATURE_GSM_LOG_MDSP_SCALING_FACTORS
#error code not present
#endif

void gl1_hw_log_reset (void);
void gl1_hw_log_mdsp_debug_buffer (uint8 TSC);

void gl1_hw_log_saic_metrics (void);
boolean gl1_hw_feature_disabled_saic (void);

#ifdef FEATURE_GSM_MDSP_ESAIC
void gl1_hw_log_gprs_esaic_metrics (uint16 timeslot);
boolean gl1_hw_feature_disabled_esaic (void);
#endif

void gl1_hw_log_aeq_metrics (uint16 timeslot, uint16 tag,boolean packet_mode);

#ifdef FEATURE_GSM_MDSP_AEQ_SCH
void gl1_hw_log_aeq_sch_metrics (GfwBurstMetricsStruct *metrics);
#endif


#ifdef FEATURE_AEQ_PHASE4
void gl1_hw_log_aeq4_metrics (GfwAeq4LogPacket *datarcvd);
#endif

boolean gl1_hw_feature_disabled_aeq (void);

#ifdef FEATURE_GSM_MDSP_AEQ_8PSK
boolean gl1_hw_feature_disabled_aeq_8psk (void);
#endif

#ifdef FEATURE_GSM_MDSP_AEQ_SCH
boolean gl1_hw_feature_disabled_aeq_sch (void);
#endif



void gl1_hw_log_cell_cmds_to_diag (gl1_hw_cmd_types cmd_type, boolean dump);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_cleanup_early_decode( gl1_hw_rx_tags_type *tags );
...
void gl1_hw_enter_idle (void);
void gl1_hw_leave_idle (void);


boolean gl1_hw_turn_tx_off(boolean rf_disable_tx);

typedef void (*gl1_hw_sleep_gsm_cb_type)( void );

void gl1_hw_sleep_gsm_enter_idle( void );
void gl1_hw_sleep_gsm_leave_idle( void );
boolean gl1_hw_sleep_gsm_start_sleep( uint32 frames_to_sleep, uint32 frames_awake, boolean check_too_early, uint32 wakeup_fn );
uint32 gl1_hw_sleep_gsm_force_wakeup( void );
void gl1_hw_sleep_gsm_register_start_cb( gl1_hw_sleep_gsm_cb_type cb );
void gl1_hw_sleep_gsm_register_warmup_cb( gl1_hw_sleep_gsm_cb_type cb );
void gl1_hw_sleep_set_terminal_count(void);
void gl1_hw_turn_tx_on( void );
void gl1_hw_sleep_start_from_drx( void );
boolean gl1_hw_wakeup_complete( void );
void gl1_hw_sleep_set_missed_frames( uint8 num_frames );
slpc_id_type gl1_hw_slpc_from_gas_id( void );
uint8 gl1_hw_sleep_get_missed_frames( void );
void  gl1_hw_sleep_clear_missed_frames( void  );
boolean gl1_hw_sleep_get_forcedwakeup(void);
void gl1_hw_set_rf_in_deep_sleep_whilst_forced_wakeup( boolean flagVal);
boolean gl1_hw_get_rf_in_deep_sleep_whilst_forced_wakeup(void);
uint32 gl1_get_time_next_vsmtr_us(void);
boolean gl1_hw_sleep_get_entered_recovery(void);
void gl1_hw_sleep_set_entered_recovery( boolean enteredRecovery);
boolean gl1_hw_calc_gsm_time_from_sclk (uint32 *fn, uint32 *qsym );
...
#ifdef FEATURE_SLPC_TRIPLE_SIM
void gl1_hw_sleep_maintain_ref_count(  gl1_hw_alt_id_T alt_id, boolean maintain_ref_count );
#else
void gl1_hw_sleep_maintain_ref_count( boolean maintain_ref_count );
#endif /* FEATURE_SLPC_TRIPLE_SIM */
#endif
...
===========================================================================*/
boolean gl1_hw_qta_fw_rf_init( boolean imm_start,uint32 offset, boolean in_qbta);

#ifndef FEATURE_GSM_RFLM_FED
void gl1_hw_qta_build_cm_cleanup_scripts( void );
#if defined ( FEATURE_QTA) && defined ( FEATURE_CXM_QTA)
boolean gl1_hw_get_qta_cm_cleanup_scripts_status ( void );
#endif
#endif

#if defined ( FEATURE_QTA) && defined ( FEATURE_CXM_QTA)
void gl1_hw_set_rx_cmd_issued_in_qta(boolean flag );
#endif
...
===========================================================================*/
void gl1_hw_qta_fw_rf_deinit( uint32 offset, boolean in_qbta);
...
#if defined FEATURE_QBTA
boolean gl1_hw_get_qbta_scripts_status(void);
void gl1_hw_set_qbta_scripts_status( boolean status);
#endif

boolean gl1_hw_cm_get_qta_wcdma_has_initialised(void);
void gl1_hw_cm_set_qta_wcdma_has_initialised(boolean val );
...
===========================================================================*/
boolean gl1_hw_qta_gap_active(void);
...
void gl1_hw_start_wcdma_rf_cmd( uint16 W_chn, uint16 start_time );
void gl1_hw_build_wcdma_rf_scripts (void * W_UARFCN );
void gl1_hw_rf_sample_ram_cmd( uint16 W_chn, uint16 start_time);
#endif
#if defined ( FEATURE_WCDMA )
void gl1_hw_setup_wcdma_rx(void);
void gl1_hw_reset_wcdma_rx(void );
void gl1_hw_get_rf_off_script_offsets(uint16 *sbi_addr, uint16 *non_sbi_addr);
...
void  gl1_hw_g2x_startup( uint16   time_offset );
#endif
#if defined ( FEATURE_WCDMA ) || defined ( FEATURE_GSM_TDS )|| defined ( FEATURE_GSM_TO_LTE )
void  gl1_hw_g2x_cleanup( boolean  tuneback_to_gsm );
#endif
#ifdef FEATURE_GSM_TDS
void  gl1_hw_g2t_startup( uint32   time_offset );

void gl1_hw_g2t_startup_decrement( void );
void gl1_hw_g2t_cleanup_decrement( void );

void  gl1_hw_g2t_cleanup(uint32   time_offset );

void gl1_hw_calc_gap_values( gsm_l1_tds_gap_info_type *gap_info_ptr );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_register_panic_cb(gl1_hw_panic_cb_type cb);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_handle_sleep_panic(void);
...
SIDE EFFECTS
  None
===========================================================================*/
void    gl1_hw_set_gsm_only_mode( boolean gl1_gsm_only_mode );
boolean gl1_hw_get_gsm_only_mode( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void    gl1_hw_set_sglte_mode( boolean gl1_sglte_mode );
boolean gl1_hw_get_sglte_mode( void );
boolean gl1_hw_get_sglte_plus_g_mode(void);
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
uint16 gl1_hw_acch_get_nv_flag (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_save_tx_arfcn (ARFCN_T *arfcn);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_get_current_tx_arfcn (ARFCN_T *arfcn);
...
===========================================================================*/
extern void gl1_msg_set_tcxo_reset_pending( boolean tcxo_reset_pending_value );
...
===========================================================================*/
void gl1_hw_acq_tcxo_and_rotator_init (void);
...
uint16 gl1_hw_sbd_get_null_pattern (void);
...
DESCRIPTION
  This function stores RSSI and Gain for use by FTM mode
===========================================================================*/
void gl1_hw_set_ftm_power_store_init(boolean ftm_power_store_init);
...
#define GL1_EFS_DEBUG_GAS_ID_N(   )    ( ( 0x1) \
...
/* F3's related to NBJDET FR46672, NV item 65770 */
#define GL1_EFS_DEBUG_NBJDET_FR                 0x10000000

/*===========================================================================
FUNCTION  gl1_hw_efs_get_debug
===========================================================================*/
uint32 gl1_hw_efs_get_debug (void);
...
#define GL1_HW_EFS_READ_SLP_DLY() gl1_hw_efs_read_slp_dly()
...
===========================================================================*/
void gl1_hw_delay (uint16 delay);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void    gl1_hw_set_mdsp_asynch_int( boolean asynch_int_enable );
extern boolean gl1_hw_get_mdsp_asynch_int( void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_hw_is_asynch_int_possible( void );
...
SIDE EFFECTS
  None
===========================================================================*/
uint32 gl1_hw_get_gsm_rxlm_buf_idx( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_deallocate_rxlm_buf_idx( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_hw_deallocate_txlm_buf_idx(void);
...
===========================================================================*/
int32 gl1_hw_get_dtm_expected_power(void);
...
===========================================================================*/
uint8 gl1_hw_get_dtm_band(void);
...
===========================================================================*/
gl1_hw_channel_type gl1_hw_dtm_get_tx_channel_type(uint8 tn);
...
===========================================================================*/
gl1_hw_channel_type gl1_hw_dtm_get_rx_channel_type(uint8 tn);
...
===========================================================================*/
uint16 gl1_hw_get_dtm_arfcn(void);
...
===========================================================================*/
int32 gl1_hw_get_rf_gsm_rx_setup_time( void );
/*===========================================================================
FUNCTION gl1_hw_get_rf_gsm_rx_pll_setup_time
DESCRIPTION
  Returns Rx pll setup time
===========================================================================*/
int32 gl1_hw_get_rf_gsm_rx_pll_setup_time( void );
/*===========================================================================
FUNCTION gl1_hw_get_rf_gsm_mon_setup_time
DESCRIPTION
  Returns Monitor Rf set-up time
===========================================================================*/
int32 gl1_hw_get_rf_gsm_mon_setup_time( void );

void gl1_hw_inact_deep_sleep( boolean rat_change_ind );
...
===========================================================================*/
int32 gl1_hw_get_rf_gsm_tx_setup_time( void );
uint16 gl1_hw_get_rf_info_rf_warmup_time( void );
...
===========================================================================*/
uint32 gl1_hw_get_rf_gsm_warmup_time( void );
...
===========================================================================*/
void gl1_hw_rf_update_freq_error(int32 freq_err);
...
===========================================================================*/
#if defined ( FEATURE_WCDMA ) || defined ( FEATURE_GSM_TDS )|| defined ( FEATURE_GSM_TO_LTE )
void gl1_hw_g2x_wait_rf_buffer_completion(void);
#endif
...
===========================================================================*/
extern void gl1_hw_stop_acquisition_geran(uint16 offset);
...
void gl1_hw_turn_tx_on(void );
void gl1_task_mutex_lock( void );
void gl1_task_mutex_unlock( void );

boolean gl1_hw_has_reset_occurred ( void  );
void gl1_ftm_reset_edge_core( void  );
...
===========================================================================*/
void gl1_hw_cleanup_async_rx_geran (void);
...
void gl1_hw_set_frame_slaming_flag(void );
...
void gl1_hw_clear_frame_slaming_flag(void );
...
boolean gl1_hw_get_frame_slaming_flag(void );
...
===========================================================================*/
rfm_device_enum_type gl1_hw_get_gsm_rf_id( void);
...
===========================================================================*/
rfm_device_enum_type gl1_hw_get_gsm_rxdiv_rf_id(void);
...
===========================================================================*/
void gl1_hw_deallocate_rxlm_buf_idx_DivRx( void );

#endif

#ifdef FEATURE_GSM_NB_JAMMER_DETECTION
/*===========================================================================
FUNCTION gl1_hw_get_band_idx

DESCRIPTION
  Get the band index for give band.
SIDE EFFECTS
  None
===========================================================================*/
uint8 gl1_hw_get_band_idx(sys_band_class_e_type band);
#endif /* FEATURE_GSM_NB_JAMMER_DETECTION */
...
===========================================================================*/
rfm_device_enum_type  gl1_hw_get_wcdma_rf_id(uint16 W_band  );
#endif
/*===========================================================================
...
===========================================================================*/
rfm_device_enum_type gl1_hw_cm_get_trm_rf_device(void  );

errno_enum_type gl1_hw_rf_init_rfa_task_msgr_mailbox(void);

void gl1_hw_deinit_rfa_task_msgr_mailbox(void);
...
===========================================================================*/
void gl1_hw_rf_idle_frame_processing(void);
...
===========================================================================*/
void gl1_hw_rf_get_timing_info(rfm_device_enum_type rf_device_id);
...
===========================================================================*/
void gl1_hw_rf_hal_vote( boolean hal_vote);
...
===========================================================================*/
void gl1_hw_rf_vreg_off(rfm_device_enum_type gsm_rf_id);
#endif
...
#ifdef FEATURE_FSK_SUPPORT
/*===========================================================================
FUNCTION  gl1_hw_rf_fsk_tx_burst
DESCRIPTION
  Send MSGR message to RF Task for FSK Tx Burst processing
===========================================================================*/
void gl1_hw_rf_fsk_tx_burst(uint32                   freq,
                        uint8                       delta,
                        int32                    freq_error,
                        uint16                   pa_index);

void gl1_hw_fsk_tcxo_read(  void );

void gl1_send_qmi_fsk_start_rsp(boolean status);
void gl1_send_qmi_fsk_stop_rsp(boolean status);

void geran_ftm_fsk_tx_start(
   GfwFskTxDataModeType              debug_mode,
   uint8                             pcl_fix,
   uint8                             baud_rate,
   uint8                             delta,
   uint32                            freq
...
void mdsp_fsk_tx(GfwFskTxDataModeType debugmode,uint32 freq,uint8 delta);
#endif
...
===========================================================================*/
int32 gl1_hw_rf_get_freq_error(void);
...
===========================================================================*/
void gl1_hw_rf_set_tx_band(rfgsm_band_type band );
...
===========================================================================*/
boolean gl1_hw_rf_check_active_buffers(void);

boolean gl1_hw_cm_get_status(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_hw_complete_cm_terminate( void );
...
===========================================================================*/
#if defined ( FEATURE_GSM_TO_LTE )
void gl1_hw_g2l_rf_meas_enter(lte_earfcn_t lte_earfcn, lte_bandwidth_e lte_bw );
...
uint16 gl1_hw_x2g_sch_burst_geran(ARFCN_T    ARFCN,
                                 ...
                                 sys_modem_as_id_e_type      as_id);
#endif
extern boolean l1_sc_sub_in_packet_trans(void);
...
void gl1_hw_reset_qta_flags_skipping_gap(void);

void gl1_hw_cm_build_startup_if_not_prebuilt (const gl1_hw_cm_rf_info_t*  cm_rf_info_ptr );
void gl1_hw_cm_build_startup_dpc(const gl1_hw_cm_rf_info_t*  cm_rf_info_ptr );

#ifdef FEATURE_GSM_TX_DIV_ANTNA_SWITCHING
void gl1_hw_switch_antenna_tx_div_pch_fail (void);
#endif /*  FEATURE_GSM_TX_DIV_ANTNA_SWITCHING*/
...
void gl1_hw_async_intf_dev_mode_cmd(sys_modem_device_mode_e_type devMode );
...
uint32 gl1_hw_get_rxlm_buff_index(void);

#ifdef FEATURE_GSM_RX_DIVERSITY
void gl1_hw_rxdiv_data_init(void);
boolean gl1_hw_trm_init_DivRx( boolean idle );
...
void gl1_enter_diversity_mode( gl1_init_rflm_type gsm_init_rflm_state );
boolean gl1_hw_rf_task_enter_mode_DivRx( uint32 rxlm_buf_idx, rfcom_device_enum_type device  );
...
void gl1_exit_diversity_mode(void);
void gl1_hw_set_enter_mode_divrx_sent(boolean is_sent);
boolean gl1_hw_get_enter_mode_divrx_sent(void);
boolean gl1_hw_gsm_band_supported(sys_band_T sys_band);
void gl1_set_rxd_control_flags(gl1_rxd_control_type gl1_rxd_control);
gl1_rxd_control_type gl1_get_rxd_control_flags(void);
void gl1_reset_rxd_control_flags(void);
void gl1_hw_fn_enter_mode_divrx_sent(void);
uint32 gl1_hw_get_fn_enter_mode_divrx_sent(void);
void  gl1_hw_set_check_toenable_rxdiv(boolean check_to_enable_rxd);
boolean gl1_hw_check_toenable_rxdiv(void);
dBx16_T gl1_get_bestof_PrxDrx_Power(dBx16_T pwr_dBm_x16, dBx16_T pwr_dBm_x16_divrx);
void gl1_start_rxdiv_agc(boolean is_agc_rxdiv);
boolean gl1_get_rxdiv_agc_start(void);
int32 gl1_hw_get_dtm_expected_power_divrx(void);
void gl1_hw_get_rxd_efs_item(void);
boolean gl1_get_is_rxd_enabled(void);
void gl1_set_enable_rxdiversity(boolean enable_rxdiversity);
boolean gl1_get_enable_rxdiversity(void);
void gl1_run_divrx_stream_sel_avg (boolean divrx_stream_selected );
boolean gl1_get_divrx_stream_sel_rate (void);
void gl1_reset_divrx_sel_avg (boolean clean_last_avg);
void gl1_set_is_rxd_enabled(boolean is_rxd_enabled );
rfm_device_enum_type gl1_get_prx_ftm_dev(void);

#ifdef FEATURE_GSM_RX_DIVERSITY_IDLE
void gl1_exit_idle_diversity_mode(void);
boolean gl1_get_IMRD_ctl_nv(void);
boolean gl1_get_rxd_ctl_nv(void);
boolean gl1_alloc_IMRD_rxdiv_rxlm_buff_idx(void);
uint32 gl1_get_imrd_rxdiv_rxlm_buff_idx(void);
void gl1_set_combined_rxd_enter_req(boolean value );
boolean gl1_get_comb_rxd_enter_req(void);
void gl1_hw_cleanup_divrx_rfdevice(void);
void gl1_hw_set_comb_exit_reqd(void);
boolean gl1_hw_get_comb_exit_reqd(void);
void gl1_hw_clear_comb_exit_reqd(void);
#endif /*FEATURE_GSM_RX_DIVERSITY_IDLE*/
#endif /*FEATURE_GSM_RX_DIVERSITY*/
#ifdef FEATURE_GSM_NB_JAMMER_DETECTION
boolean gl1_hw_is_ftm_cal_mode( void );
#endif /* FEATURE_GSM_NB_JAMMER_DETECTION */
GfwEnterModeType gl1_get_gfw_imrd_entermodetype(void);


#ifdef FEATURE_AEQ_PHASE4
void gl1_hw_efs_read_set_aeq4(void);
gl1_hw_dtm_rx_aeq4_type gl1_get_aeq4_info(void);
void gl1_set_aeq4_info (gl1_hw_dtm_rx_aeq4_type mdsp_aeq4_ctl_info, uint8 set_mask );
boolean gl1_get_enableAeq4_status(void);
void gl1_reset_aeq4_ctl (void);
...
===========================================================================*/
void gl1_hw_rf_enable_tx_device(uint32 txlm_buf_idx, rfm_device_enum_type device );
...
===========================================================================*/
void gl1_hw_rf_disable_tx(uint32 txlm_buf_idx, rfm_device_enum_type device);
...
===========================================================================*/
void gl1_hw_rf_set_tx_band_device(rfgsm_band_type band, rfcom_device_enum_type device );
...
===========================================================================*/
void gl1_hw_rf_task_enter_mode_req(uint32 rxlm_buf_idx, rfm_device_enum_type  device );
...
===========================================================================*/
void gl1_hw_rf_task_enter_mode_cnf(void);
...
===========================================================================*/
void gl1_hw_set_rxlm_buff_index(uint32 idx );
...
===========================================================================*/
void gl1_hw_set_txlm_buff_index(uint32 idx );
...
===========================================================================*/
uint32 gl1_hw_get_txlm_buff_index(void);
...
===========================================================================*/
rfgsm_band_type gl1_hw_get_rf_gsm_band(void);
...
===========================================================================*/
void gl1_hw_set_invalid_rf_gsm_band(void);
...
===========================================================================*/
#if defined ( FEATURE_GSM_TO_LTE )
rfm_device_enum_type gl1_hw_get_lte_irat_rf_device( trm_client_enum_t irat_client );
#endif
#ifdef FEATURE_WLAN_COEX_SW_CXM
boolean gl1_hw_async_intf_cxm_policy_cmd( cxm_active_config_v01_s policy);
#endif

int32 gl1_mon_set_up_with_sched_guard_period( void );
int32 gl1_hw_pwr_meas_req_time( void );
...
===========================================================================*/
void gl1_hw_wtr_hop_config_tx(uint32 buffer_index, rfm_device_enum_type device );
#endif

#ifdef FEATURE_GSM_QSC_TX_DIV
void gl1_trm_ant_switch_set_control ( trm_ant_switch_set_ctrl_enum control_req_type );
#endif /* FEATURE_GSM_QSC_TX_DIV */

#ifdef GERAN_L1_HLLL_LNASTATE
void gl1_hw_send_dtm_burst_metrics(uint32 fn);
boolean gl1_hw_get_sawless_HLLL_support(sys_band_T band);
void gl1_hw_rf_burst_metrics(gl1_defs_metrics_lnastate *gl1_metrics_lnastate);
void gl1_hw_log_HLin_LLin_metrics( gl1_defs_metrics_lnastate *gl1_metrics_lnastate,uint8 *SawlessHLLLState );
...
void gl1_hw_reset_sawless_support_flag(void);
#endif /*GERAN_L1_HLLL_LNASTATE*/

void gl1_log_gsm_dft_spur_metric (  GfwDftSpurAciMetricsStruct SpurAciMetrics,uint16 time_slot);


void gl1_log_epd_metrics(GfwEpdLogPacket *gfwEPDLogPacket);

#ifdef GERAN_L1_IP2CAL
void gl1_hw_send_ip2cal_cmd(uint8 num_of_ip2cal_steps,uint32 ip2Cal_StepSizeQS);
void gl1_hw_rf_ip2_cal(void);
void gl1_hw_deallocate_ip2cal_rxlm_buf_idx( void );
void gl1_hw_deallocate_ip2cal_txlm_buf_idx( void );
boolean gl1_hw_get_ip2cal_support(void);
uint32 gl1_hw_get_ip2cal_rxlm_buff_index(void);
uint32 gl1_hw_get_ip2cal_txlm_buff_index(void);
int32 gl1_hw_get_rf_gsm_ip2cal_setup_time( void );
#endif /*GERAN_L1_IP2CAL*/

rfm_device_enum_type gl1_hw_get_lte_rf_id(trm_client_enum_t lte_client, sys_sband_lte_e_type lte_band );

#endif /* GL1_HW_H */
boolean gl1_hw_rf_wakeup_req_msg_check(void );
void gl1_hw_set_rf_wakeup_req_msg( boolean rfWakeUpSent);


extern void gl1_hw_mcpm_call_config_cmd(void);
extern boolean g1l_hw_is_mcpm_tx_on (void);
extern boolean gl1_hw_check_metrics_done(void);

void gl1_hw_async_intf_app_mode_config(GfwAppModeType app_mode, sys_modem_as_id_e_type as_id);

void gl1_hw_async_intf_set_tx_band_cmd(void);
