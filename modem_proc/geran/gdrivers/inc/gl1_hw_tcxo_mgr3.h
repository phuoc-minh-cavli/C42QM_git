...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_hw_tcxo_mgr3.h#3 $
...
SIDE EFFECTS
  None.
===========================================================================*/
tcxomgr_as_id_enum_type gl1_hw_map_gas_id_to_tcxo_asid( void );
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_update_raw_fe_tcxo_mgr( int32 freq_err);
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_set_cgps_feu_state( boolean idle_mode );
...
SIDE EFFECTS
  None.
===========================================================================*/
boolean gl1_hw_get_cgps_feu_state( void );
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_cgps_feu_tick( void );
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_reset_cgps_feu( boolean reset_state );
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_set_cgps_feu_force_rpush( void );
...
SIDE EFFECTS
  None.
===========================================================================*/
void gl1_hw_set_cgps_feu_sample_threshold( int16 rpush_frame_thresh );
...
PARAMETERS
  Active current active XO value, GL1 state info
RETURN VALUE
  None.
...
SIDE EFFECTS
  None.
===========================================================================*/
tcxomgr_vco_info_type gl1_hw_get_initial_rgs( void );
