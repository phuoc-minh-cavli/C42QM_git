...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_msg_arbitration.h#2 $
...
typedef void ( *gl1_msg_arbitration_reg_t );
typedef void ( *gl1_msg_arbitration_notify_t )(gl1_msg_arbitrated_event_t);
...
gl1_msg_arbitration_t* gl1_msg_get_arbitration(void);

void gl1_msg_arbitration_init(void);

void gl1_msg_cfg_arbitration(gl1_msg_arbitration_reg_t registration, gl1_msg_arbitration_reg_t deregistration);
