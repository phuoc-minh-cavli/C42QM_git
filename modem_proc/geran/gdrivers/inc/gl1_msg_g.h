...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_msg_g.h#10 $
$DateTime: 2019/04/30 03:44:13 $ $Author: pwbldsvc $
...
22/10/18   kh       CR2336454 Support for disabling VAMOS II feature on CT.1.0.1
...
05/03/18   sk       CR2230579 : Portinng the Single Voice Session FR chages onto CT.1.0
14/09/17   hd       CR2109758 Properly featurize with FEATURE_GSM_AMR the AMR related code
13/02/17   nm       CR1110088 PEO RACH Changes from GL1
21/12/16   mk       CR1094331 : GL1 Improvements related to CS feature
01/12/16   km       CR1096139 Resolving Compiler errors for upbringing QTF on JO.3.0.2
...
/* VS interface */
 #define GAS_ID_IS_MULTIMODE_SUB()     (( (GERAN_ACCESS_STRATUM_ID_1 < GERAN_ACCESS_STRATUM_ID_2) ? TRUE:FALSE ) )
 #define GAS_ID_IS_GSM_ONLY_MODE_SUB() (( (GERAN_ACCESS_STRATUM_ID_1 >= GERAN_ACCESS_STRATUM_ID_2) ? TRUE:FALSE ) )
 #define OTHER_GSM_ONLY_SUB_INACTIVE() ((l1_tsk_buffer.l1_state == L1_INACTIVE_MODE)? TRUE:FALSE)
...
extern uint16 gl1_get_ncell_start_acq_offset( void);

/* Callback function definitions */

typedef void (*gl1_msg_tx_data_callback)(void);

typedef void (*gl1_msg_rx_data_callback)(gl1_msg_decode_rpt *rpt);

typedef void (*gl1_msg_rx_metrics_callback_tch)(gl1_defs_metrics_rpt *rpt[],
                                                uint16 chan);

typedef void (*gl1_msg_rx_metrics_callback)(gl1_defs_metrics_rpt *rpt[]);

typedef void (*gl1_msg_tx_rach_callback)(uint16 content);

typedef void (*gl1_msg_pwr_meas_cb_type)(gl1_msg_pwr_meas_result_type *rpt);

typedef void (*gl1_msg_pwr_meas_abort_cb_type)(void);

typedef void (*gl1_msg_rx_log_callback)(void);

typedef void (*gl1_msg_tx_abort_callback)(void);

typedef void (*gl1_msg_rx_abort_callback)(void);
...
============================================================================= */
void gl1_msg_set_num_assigned_tx_slots (uint8 num_assigned_tx_slots );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_acq_tcxo_and_rotator_init(void );
...
===========================================================================*/
boolean gl1_msg_bfi_mod_2( void );

extern mdsp_rf_desense_chan_type gl1_msg_is_arfcn_xo_desense( ARFCN_T arfcn);
...
===========================================================================*/
extern boolean gl1_msg_trigger_iq(void );
...
===========================================================================*/
extern void gl1_msg_set_iq_state( boolean state );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_tt_ho_adjust(void );
...
SIDE EFFECTS
  None
===========================================================================*/
int32 gl1_msg_tt_ho_bursts(void);
...
===========================================================================*/
void gl1_msg_set_ho_pwr( int16 agc_pwr );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_rx_tch_hr_sub_chan(uint8 hr_sub_chan );
...
============================================================================= */
extern boolean gl1_get_dtx_used_this_period( void );
...
SIDE EFFECTS
   None
============================================================================= */
extern void gl1_reset_dtx_used_flag( void );
extern void gl1_set_dtx_used_flag( void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern gl1_defs_loopback_type gl1_msg_get_tch_loopback( void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_store_ta ( uint8 ta);
...
extern void gl1_msg_cs_data_tx (uint8 **data);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_tx_sacch ( ARFCN_T ARFCN[4], int16  TXLEV[4], uint8  *data);

extern void gl1_msg_tx_sacch51 ( ARFCN_T ARFCN[4], int16  TXLEV[4], uint8  *data);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_tx_sdcch ( ARFCN_T ARFCN[4], int16  TXLEV[4], uint8  *data );

/*===========================================================================
...
#endif 
boolean gl1_msg_ccch_is_rx_on_next_frame(void );
...
===========================================================================*/
extern void gl1_msg_store_cbch_TSC ( uint8 TSC);
...
FUNCTION gl1_msg_cfg_async_ccch
...
===========================================================================*/
extern void gl1_msg_cfg_rx_async_ccch
(
   uint8 TSC,
   boolean DRX,
   gl1_msg_rx_cb_type *cb
...
extern void gl1_msg_rx_async_ccch
(
   ARFCN_T         ARFCN[GL1_DEFS_FRAMES_IN_BLK_PERIOD],
   sys_algo_agc_T *agc_ptr,
   uint16          timing_offset,
...
extern void gl1_msg_abort_rx_async_ccch(gl1_msg_ncell_abort_type type);
/*===========================================================================
...
===========================================================================*/
extern void gl1_msg_cfg_ncell_sch ( gl1_msg_rx_cb_type *cb );
...
===========================================================================*/
void gl1_msg_cfg_ncell_fcch ( gl1_msg_rx_cb_type *cb);
...
===========================================================================*/
extern void gl1_msg_init_tch (gl1_msg_chan_type chan, gl1_msg_voc_type voc_type);
...
===========================================================================*/
extern void gl1_msg_terminate_tch (void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_align_vfr( boolean real_vfr);
...
boolean gl1_msg_is_rach_tx_on_next_frame(void );
...
===========================================================================*/
void gl1_msg_inc_rach_frame_cnt ( void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_abort_rach (void );
extern boolean gl1_msg_abort_tx_tch_facch_fr(void );
extern boolean gl1_msg_abort_tx_tch_facch_hr(void );
extern boolean gl1_msg_abort_rx_tch_hr(void );
extern boolean gl1_msg_abort_tx_facch_fr(void );
extern void gl1_msg_abort_tx_sacch(void );
extern void gl1_msg_abort_tx_sacch51(void );
extern boolean gl1_msg_abort_tx_sdcch(void );

extern void gl1_msg_abort_rx_sacch(void );
extern void gl1_msg_abort_rx_sacch51(void );
extern void gl1_msg_abort_rx_ccch ( void);
extern void gl1_msg_abort_rx_cbch(void );

extern boolean gl1_msg_abort_rx_tch_fr(void );
extern void gl1_msg_abort_rx_sdcch( void);
...
===========================================================================*/
extern void gl1_msg_abort_rx_ncell_bcch(gl1_msg_ncell_abort_type type );
...
===========================================================================*/
extern void gl1_msg_abort_rx_ncell_fcch(gl1_msg_ncell_abort_type type );
...
===========================================================================*/
extern void gl1_msg_abort_rx_ncell_sch(gl1_msg_ncell_abort_type type );
...
===========================================================================*/
extern void gl1_msg_abort_rx_ncell_fcch_sch(gl1_msg_ncell_abort_type type );
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 gl1_msg_retrieve_ta ( void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_suspend_pwr_meas (void );
...
===========================================================================*/
void gl1_msg_resume_pwr_meas (void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_stop_pwr_meas( void);
...
===========================================================================*/
extern void gl1_msg_abort_pwr_meas(void );
...
===========================================================================*/
extern boolean gl1_msg_pwr_meas_aborted_while_retrieving(void );

extern void gl1_msg_pwr_reset_meas_aborted_while_retrieving(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_cfg_fcch_sch ( gl1_msg_rx_cb_type *cb  );

extern void gl1_msg_cfg_fcch_sch_list (gl1_msg_rx_cb_type *cb, uint32 list_pos );

/* This function is used to allow calling client write access to the
 * values of the rotator or PDM.
 */
extern void gl1_msg_set_afc_info( int32 afc_freq);

/* This function is used to allow calling client access to the
 * values of the rotator and PDM.
 */
extern void gl1_msg_get_afc_info( int32 *word1_ptr);
...
extern void gl1_msg_rx_fcch_sch(
                      ...
                      ,boolean            idle_mode /* Used to indicate idle mode or initial acquisition */
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_correct_timing( int32 timing_error);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_reset(void );

#ifdef  FEATURE_GSM_DTM
#ifdef  FEATURE_GSM_EDTM

void  gl1_msg_reset_cs_only(void );
...
============================================================================= */
void gl1_msg_set_cs_timeslot (gl1_defs_tn_type tn );
...
============================================================================= */
gl1_defs_tn_type gl1_msg_get_cs_timeslot (void);
...
void gl1_msg_disable_ciphering (void );
void gl1_msg_clear_ciphering_enabled (void );
boolean gl1_msg_is_ciphering_enabled( void);

void gl1_msg_acq_afc_init( ARFCN_T arfcn);
#ifdef FEATURE_GSM_DTM
void gl1_msg_set_afc_tt_mode( gl1_msg_afc_tt_mode mode);
#endif
...
void gl1_msg_dch_afc_tt_init( ARFCN_T arfcn);
...
void gl1_msg_dch_afc_update(int16 freq_err, uint16 snr, boolean saic_used );
void gl1_msg_dch_tt_adjust( void);
void gl1_msg_dch_afc_adjust(void );

void gl1_msg_pdch_afc_tt_init( ARFCN_T arfcn );
void gl1_msg_pdch_tt_update(int16 timing_offset, uint16 snr, gl1_defs_modulation_type mod );
void gl1_msg_pdch_afc_update( uint8                          num_timeslots,
                              gl1_defs_rx_pkt_metrics_type*  metrics_ptr[GL1_DEFS_MAX_DL_MSGS ]

                            );
void gl1_msg_pdch_tt_adjust( void);
void gl1_msg_pdch_afc_adjust(void );

void gl1_msg_cch_afc_tt_init( ARFCN_T arfcn );
void gl1_msg_cch_tt_update(int16 timing_offset, uint16 snr, boolean saic_used );
void gl1_msg_cch_tt_adjust( void);
void gl1_msg_cch_afc_adjust(void );
void gl1_msg_cch_afc_update(int16 freq_err, uint16 snr, boolean saic_used );

void gl1_msg_update_sacch_arfcns( ARFCN_T ARFCN[4]);
...
uint32 gl1_msg_get_hard_rxqual_full_avg(void);
#endif

void  gl1_msg_rxqual_init( void);
void  gl1_msg_rxqual_full_update( uint16 dsp_rxqual );
void  gl1_msg_rxqual_sub_update( uint16 dsp_rxqual );
uint8 gl1_msg_get_rxqual_full( boolean *meas_report_valid);
uint8 gl1_msg_get_rxqual_sub(void );

uint8 gpl1_gprs_calc_rxqual_lev( uint32 rxqual_sum, uint16 block_cnt);
...
===========================================================================*/
void gl1_msg_init_aeq_8psk_mean_bep( void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_mean_bep_update ( uint32 mean_bep );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_cv_bep_update ( uint32 cv_bep );
...
SIDE EFFECTS
  None
===========================================================================*/
uint8 gl1_msg_get_mean_bep(void );
...
===========================================================================*/
extern void set_afc_band( ARFCN_T arfcn, boolean dedicated_mode);
...
SIDE EFFECTS
   None
============================================================================= */
void gl1_msg_adjust_time_stamp (int32 offset );
...
SIDE EFFECTS
   None
============================================================================= */
void gl1_hw_msg_inc_fn ( int32 num );
...
============================================================================= */
void gl1_msg_inc_dl_ptcch_frame_count ( void);
...
===========================================================================*/
void gl1_msg_abort_dl_ptcch ( void );
...
SIDE EFFECTS
   None
============================================================================= */
void gl1_msg_abort_dl_pacch_pdtch(void );
...
SIDE EFFECTS
   None
============================================================================= */
void gl1_msg_abort_ul_pacch_pdtch( void );
...
SIDE EFFECTS
	 None
============================================================================= */
boolean gl1_msg_int_retrieving_results( void );
...
============================================================================= */
boolean gl1_msg_is_aeq_egprs_enabled( void);
...
============================================================================= */
void gl1_msg_IR_enable (boolean enable );

boolean gl1_msg_is_IR_enabled (void);
...
============================================================================= */
void gl1_msg_IR_clear_memory (uint16 starting_bsn, uint16 ending_bsn );
...
============================================================================= */
void gl1_msg_IR_set_active_window (uint16 starting_bsn, uint16 ending_bsn );
...
============================================================================= */
void gl1_msg_IR_set_tfi (uint8 tfi );
...
============================================================================= */
void gl1_msg_set_egprs_mode (boolean egprs_mode, boolean reg_clk );
...
===========================================================================*/
uint16 gl1_msg_get_ir_oper_win_size(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_save_sid_update_amr_fr_hr(uint8 *data );
...
===========================================================================*/
extern void gl1_msg_init_tch_amr (gl1_msg_chan_type chan, gl1_msg_voc_type voc_type );
...
===========================================================================*/
extern void gl1_msg_terminate_tch_amr_fr_hr(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_abort_tx_tch_amr_fr(void);
...
SIDE EFFECTS
   None
===========================================================================*/
extern boolean gl1_msg_abort_rx_tch_amr_fr(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_set_dl_acs( gl1_msg_amr_mode_type * codec_set);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_cfg_ul_tch_amr_fr_hr(uint8 TSC, gl1_msg_tx_cb_type *cb);

extern void gl1_msg_cfg_ul_facch_amr_fr_hr(uint8 TSC, gl1_msg_tx_cb_type *cb );

extern void gl1_msg_cfg_ul_ratscch_amr_fr_hr(uint8 TSC, gl1_msg_tx_cb_type *cb );

extern void gl1_msg_cfg_ul_sid_first_amr_fr_hr(uint8 TSC, gl1_msg_tx_cb_type *cb );

extern void gl1_msg_cfg_ul_sid_update_amr_fr_hr(uint8 TSC, gl1_msg_tx_cb_type *cb );

extern void gl1_msg_cfg_dl_tch_facch_amr_fr_hr(uint8 TSC, gl1_msg_rx_cb_type *cb );
...
===========================================================================*/
extern boolean gl1_msg_abort_tx_tch_amr_hr(void);

extern boolean gl1_msg_abort_rx_tch_amr_hr(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern gl1_msg_voc_type gl1_msg_get_current_voc_type (void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_reset_hard_rxqual_ave( void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_is_saic_disable_in_idle_valid(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void    gl1_msg_update_hard_rxqual_ave( uint16 current_hard_rx_qual);
...
extern boolean gl1_msg_get_saic_disable_in_idle(void );
...
===========================================================================*/
extern void gl1_msgi_reset_acq_afc( int32 afc_freq  );

extern void gl1_msg_reset_pdm( int16 frequency_offset, ARFCN_T arfcn  );
...
===========================================================================*/
extern uint16 gl1_msg_acch_get_nv_flag (void);
...
===========================================================================*/
extern void gl1_msg_check_list_req_pass_num(boolean retry_with_reset );
...
===========================================================================*/
extern boolean gl1_msg_get_pdm_confidence_factor ( void);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_msg_get_saic_state( void);
...
============================================================================= */
extern void gl1_msg_get_afc_params( int32 *rotator_value_store, int32 *freq_value_store);
...
============================================================================= */
extern void gl1_msg_set_afc_params( int32 rotator_value_store, int32 freq_value_store );
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_ncell_pch_low_monitor_active(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern int32 gl1_msg_get_dtm_expected_power( void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 gl1_msg_get_dtm_band(void);

extern void gl1_msg_clear_async_drift_timing_error(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint16 gl1_msg_get_dtm_arfcn(void);
...
RETURN VALUE None
===========================================================================*/
extern void gl1_msg_set_mdsp_asynch_int( boolean asynch_int_enable);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_is_asynch_int_possible(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_get_rat_change_active(void );
...
RETURN VALUE None
===========================================================================*/
extern void gl1_msg_set_tt_failed_ho(void );
...
RETURN VALUE None
===========================================================================*/
extern void gl1_msg_reset_ho_tt_adjust( void);
...
===========================================================================*/
extern boolean gl1_msg_get_stored_dtx_indicator(void );

extern boolean gl1_msg_ncell_pch_low_monitor_active(void );

extern boolean gl1_msg_pdch_block_active( void );
...
DESCRIPTION
  ...
  loopback.
===========================================================================*/
extern void gl1_msg_tch_loopback( gl1_defs_loopback_type loopback);
#endif /* FEATURE_GERAN_CS_SUPPORT */
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean gl1_msg_acq_complete( void);

extern boolean gl1_msg_asynch_int_dbg(void );
extern boolean gl1_msg_is_asynch_sleep_enabled(void );
extern boolean gl1_msg_is_sleep_opt3_enabled( void);

extern boolean gl1_msg_is_sbd_enabled(void );

extern boolean gl1_msg_is_epd_allowed(void );

extern boolean gl1_msg_is_early_decode_disabled(void );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_update_xo_rgs( boolean is_idle, boolean state_info );
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_set_dedicated_gas_id( void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern rach_state_type gl1_msg_get_rach_state(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern int16 gl1_msg_get_rach_delay(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_set_rach_delay(int16 rach_delay );
...
===========================================================================*/
void gl1_msg_recovery_update_ccch_params(void);

boolean l1_handle_rfacch(tch_facch_decode_rpt *rpt, gl1_msg_chan_type chan );

void tch_rfacch_indicator(uint16 rfacch_start_of_blk_fn );

#ifdef FEATURE_GSM_AMR
void amr_tch_rfacch_indicator(uint16 rfacch_start_of_blk_fn );
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_dtx_detection_algorithm(byte rxqual_full, byte rxqual_sub, byte rxlev_sub );
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_msg_dtx_detection_get_status( void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_amr_pd_algorithm(byte rxqual_sub, byte rxqual_full, byte rxlev_sub );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_amr_pd_update_hard_rxqual(uint32 hard_rxqual);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_amr_pd_cancel_partial_decode(boolean cancel );
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_msg_amr_pd_get_status( void);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_msg_meas_in_progress( void);

extern uint32 gl1_msg_get_start_acq_FN( void );
#endif /* GL1_MSG_H */
