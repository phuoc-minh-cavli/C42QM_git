...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_msgi.h#3 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
============================================================================= */
void gl1_msgi_remove_ft_handler (gl1_msgi_ft_handler_func_type frame_handler);
...
===========================================================================*/
void gl1_msg_tt_do_pending_adjust (void);
...
void gl1_msgi_init_ncell_fcch (void);
void gl1_msgi_init_ncell_sch (void);
void gl1_msgi_init_ncell_bcch (void);
void gl1_msgi_init_fcch_sch (void);
void gl1_msgi_init_cbch (void);
void gl1_msgi_init_ccch (void);
void gl1_msgi_init_async_ccch (void);
void gl1_msgi_init_dl_tch (void);
void gl1_msgi_init_dl_tch_amr (void);
void gl1_msgi_init_ul_tch (void);
void gl1_msgi_init_ul_tch_amr (void);
void gl1_msgi_init_sacch (void);
void gl1_msgi_init_sdcch (void);
void gl1_msgi_init_rach  (void);
...
===========================================================================*/
void gl1_msgi_abort_rx_async_ccch (gl1_msg_chan_type channel_type);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_pdch_terminate( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_ul_pacch_pdtch_init( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_ul_pacch_pdtch_terminate( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_dl_ptcch_init( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_dl_ptcch_terminate( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_dl_pacch_pdtch_init( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_dl_pacch_pdtch_terminate(void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_ul_ptcch_init( void );
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_ul_ptcch_terminate( void );
...
SIDE EFFECTS
  State reset
===========================================================================*/
void gl1_msgi_int_meas_init (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_int_meas_terminate (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_abort_int_meas (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msg_log_ft_handlers (void);
...
boolean gl1_msg_get_meas_in_progress(void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_pwr_meas_init(void);
...
SIDE EFFECTS
  None
===========================================================================*/
void gl1_msgi_pwr_meas_terminate(void);
