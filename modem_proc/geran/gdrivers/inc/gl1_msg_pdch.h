...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_msg_pdch.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
#define IS_TX_HDLR_REG() reg_tx_hdlr_flag
#define DONT_ALLOW_TX_HDLR_TO_BE_REG() UPDATE_TX_HDLR_REG( TRUE );
#define ALLOW_TX_HDLR_TO_BE_REG() UPDATE_TX_HDLR_REG( FALSE );
#define UPDATE_TX_HDLR_REG( flag )\
{ \
   reg_tx_hdlr_flag = flag;\
}

/* Macros to handle the window for message submission */
#define IS_TX_WINDOW_OPEN() tx_window_open
#define OPEN_TX_WINDOW() UPDATE_TX_WINDOW_STATE( TRUE )
#define CLOSE_TX_WINDOW() UPDATE_TX_WINDOW_STATE( FALSE )
#define UPDATE_TX_WINDOW_STATE( flag )\
{ \
   tx_window_open = flag;\
}
...
#define MSG_SUBMITTED_IN_THIS_BLOCK() submitted_tx_msg
#define REG_MSG_WAS_SUBMITTED() UPDATE_MSG_SUBMISSION_STATE( TRUE )
#define CLEAR_MSGS_SUBMITTED_FLAG() UPDATE_MSG_SUBMISSION_STATE( FALSE )
#define UPDATE_MSG_SUBMISSION_STATE( flag )\
{ \
  submitted_tx_msg = flag;\
}


#define IS_RX_HDLR_REG() reg_rx_hdlr_flag
#define DONT_ALLOW_RX_HDLR_TO_BE_REG() UPDATE_RX_HDLR_REG( TRUE );
#define ALLOW_RX_HDLR_TO_BE_REG() UPDATE_RX_HDLR_REG( FALSE );
#define UPDATE_RX_HDLR_REG( flag )\
{ \
   reg_rx_hdlr_flag = flag;\
}


/* Macros to handle the window for message submission */
#define IS_RX_WINDOW_OPEN() rx_window_open
#define OPEN_RX_WINDOW() UPDATE_RX_WINDOW_STATE( TRUE )
#define CLOSE_RX_WINDOW() UPDATE_RX_WINDOW_STATE( FALSE )
#define UPDATE_RX_WINDOW_STATE( flag)\
{ \
   rx_window_open = flag;\
}

/* Macros to handle if the rx cmd was issued in the 1st 3 frames of a block*/
#define RX_CMD_ISSUED_IN_THIS_BLOCK() issued_rx_cmd
#define REG_RX_CMD_WAS_ISSUED() UPDATE_RX_CMD_ISSUED_STATE( TRUE )
#define CLEAR_RX_CMD_ISSUED_FLAG() UPDATE_RX_CMD_ISSUED_STATE( FALSE )
#define UPDATE_RX_CMD_ISSUED_STATE( flag )\
{ \
   issued_rx_cmd = flag;\
}
...
SIDE EFFECTS
  None
===========================================================================*/
boolean gl1_msg_dm_complete (void);
...
SIDE EFFECTS
   None
============================================================================= */
extern void gl1_msgi_pdch_init(void);
...
SIDE EFFECTS
   None
============================================================================= */
extern void gl1_msg_pdch_terminate(void);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void gl1_msg_pdch_store_ta ( uint8 ta );
...
SIDE EFFECTS
  None
===========================================================================*/
extern uint8 gl1_msg_pdch_retrieve_ta (void);
...
===========================================================================*/
extern void gl1_msg_pdch_set_mac ( gl1_defs_access_mode_type mode );
...
===========================================================================*/
gl1_defs_access_mode_type gl1_msg_pdch_get_mac (void);
...
===========================================================================*/
void gl1_msg_pdch_set_camp_tn (gl1_defs_tn_type tn);
gl1_defs_tn_type gl1_msg_pdch_get_camp_tn (void);

extern void gl1_msgi_pdch_open_rx_win(void);
extern void gl1_msgi_ptcch_open_rx_win(void);
...
===========================================================================*/
void gl1_msg_pdch_set_loopback (boolean enable);
...
===========================================================================*/
void gl1_srb_set_ul_mod_mode(boolean srb_m_bit);
...
===========================================================================*/
boolean gl1_srb_get_loopback_state(void);
