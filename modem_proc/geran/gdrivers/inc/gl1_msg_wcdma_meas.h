...
$Header: //components/rel/geran.mpss/5.2.0/gdrivers/inc/gl1_msg_wcdma_meas.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
typedef void (*gl1_msg_wcdma_meas_report_cb_type)(gl1_wcdma_cell_meas_rpt *rpt  );
typedef void (*gl1_msg_wcdma_ded_report_cb_type)(gl1_wcdma_cell_ded_rpt *rpt);
typedef void (*gl1_msg_wcdma_meas_abort_cb_type)(void);
typedef void (*gl1_msg_wcdma_ded_reconf_cb_type)(gl1_wcdma_cell_ded_reconf_rpt *rpt );

/* Exported functions */
#if defined ( FEATURE_WCDMA )
extern void gl1_msg_wcdma_srchdrv_init( rfm_device_enum_type  source_rf_device );
#endif
extern boolean gl1_msg_get_recon_srch_progress ( void);

extern boolean gl1_msg_wcdma_srch_active( void );
...
extern void gl1_msg_set_gsm_only( boolean gl1_gsm_only_mode );
#if defined ( FEATURE_WCDMA )            
extern void gl1_msg_cleanup_wcdma_meas( void );
#endif

extern void gl1_msg_leave_wcdma_meas_ded(void );
...
extern boolean gl1_msg_abort_wcdma_identify (  void );
extern boolean gl1_msg_abort_wcdma_reconfirm ( void );
extern boolean gl1_msg_abort_wcdma_ded_srch ( void  );
extern void wcdma_ded_srch_timout(void);
extern boolean gl1_msg_get_id_srch_in_progress ( void  );
extern void gl1_msg_reset_rx_flags(void);
extern void gl1_msg_wcdmadrv_abort_search( void );
 ...
 */
#if defined ( FEATURE_WCDMA )
extern void  wcdma_start_rf_cmd(  void );

extern void  wcdma_reconf_start_rf_cmd( void );

extern boolean g2w_is_wfw_active (void );

extern void wcdma_set_srch_done( void );
...
extern boolean gl1_check_ded_srch_in_progress( void );
#endif
#endif
