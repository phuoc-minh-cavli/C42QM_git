...
$Header: //components/rel/geran.mpss/5.2.0/gmsgrif/inc/gl1_msgrif_fwmsg.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
===========================================================================*/
void gl1_msgrif_handle_fw_async_msgr_msgs(void);
