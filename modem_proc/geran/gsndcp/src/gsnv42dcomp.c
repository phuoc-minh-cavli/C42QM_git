...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gsndcp/src/gsnv42dcomp.c#3 $ $DateTime: 2019/04/19 00:07:56 $ $Author: pwbldsvc $
   ...
   while (1)
   {
      ...
      else
      {
         ...
         if (comp_e->ds_v42_d_post_ETM_flag)
         {
            ...
            /* ensure ds_v42_d_string_code is not empty */
