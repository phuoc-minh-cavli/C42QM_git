...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gsndcp/src/gsn_util.h#3 $   
***
...
void gsn_encode_unitdata_pdu_hdr(   const gsn_unitdata_pdu_hdr_t *sn_unitdata, uint8 *dst);
...
boolean gsn_decode_neg_xid(   dsm_item_type **l3_xid, gsn_sapi_e_t *sapi_ptr );
...
===  
===========================================================================*/
void gsn_del_all_selected_comp_e(   gsn_sapi_e_t *);
...
===  
===========================================================================*/
void gsn_del_dcomp_e(   uint8, gsn_sapi_e_t *);
...
===  
===========================================================================*/
void gsn_del_pcomp_e(  uint8, gsn_sapi_e_t *);
...
===  
===========================================================================*/
void gsn_reset_comp_ent(  gsn_sapi_e_t* );
...
===  
===========================================================================*/
dsm_item_type * gsn_encode_rmv_nsapi_xid(  const gsn_nsapi_e_t * );
