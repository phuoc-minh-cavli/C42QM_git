...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gsndcp/src/gsnv42_iram.c#3 $ $DateTime: 2019/03/14 04:25:53 $ $Author: pwbldsvc $
...
#define GSN_HASHFUNC(prefix,suffix, hash_table_size) \
   ( ((((prefix + suffix) << 6) - prefix) + suffix) % hash_table_size)

#define GSN_INC_HASH_INDEX(index, hash_table_size) {index++; index %= hash_table_size;}
