...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gsndcp/src/gsn_comp.h#3 $   
***
...
boolean gsn_iphc_comp_init(   pcomp_e_t *pcomp_ent_ptr,
...
boolean gsn_rohc_comp_init(   pcomp_e_t *pcomp_ent_ptr,
