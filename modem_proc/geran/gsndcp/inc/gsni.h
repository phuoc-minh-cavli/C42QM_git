...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gsndcp/inc/gsni.h#6 $
***
...
#endif
#if !defined(FEATURE_GSM_GPRS_SNDCP_PCOMP) && defined(PERLUTF)
...
extern uint16      gsn_n201_i[4];
extern uint16      gsn_n201_u[4];

/* If TRUE, Indicates that the SNDCP layer has been initialised  */
extern boolean     sndcp_init;
extern boolean     sndcp_log_initialized;
...
extern gsn_internal_msg_t *gsn_int_get_mes_buf( void );
...
extern void gsn_int_put_mes( gsn_internal_msg_t *mes_ptr );
...
extern void gsn_process_hiwater( gsn_sapi_t sapi, gsn_nsapi_mode_t  op_mode, uint8 susp_reason );
...
extern void gsn_process_lowater( gsn_sapi_t sapi, gsn_nsapi_mode_t op_mode, uint8 susp_reason );
