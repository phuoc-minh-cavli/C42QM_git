...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gsndcp/inc/gsndef.h#2 $   
***
...
#define PCOMP_RFC_LEN_P1_MAX  15
...
*/
#define XID_T2_LEN_MAX        ( PCOMP_RFC_LEN_P1_MAX + XID_FIELD_HDR_P1_LEN )
...
#define T2_ALG_MAX        2 /* Currently T2_ALG_RFC3095 is max */
