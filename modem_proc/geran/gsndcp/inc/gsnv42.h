...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gsndcp/inc/gsnv42.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
void gsn_v42_dealloc_tables( const comp_ent_V42bis_t *, uint8 );
