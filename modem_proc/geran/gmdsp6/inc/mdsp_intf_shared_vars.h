...
$Header: //components/rel/geran.mpss/5.2.0/gmdsp6/inc/mdsp_intf_shared_vars.h#2 $
...
void mdsp_intf_shared_var_write(MdspGeranSharedVariableType sharedVariableType,  uint16 value  );
void * mdsp_intf_shared_var_read(MdspGeranSharedVariableType sharedVariableType  );
