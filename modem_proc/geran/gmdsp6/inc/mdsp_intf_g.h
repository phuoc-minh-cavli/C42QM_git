...
$Header: //components/rel/geran.mpss/5.2.0/gmdsp6/inc/mdsp_intf_g.h#9 $
...
13/03/19    ktg      CR2407211 Fix for incorrect arfcn passed to GFW
...
06/24/04     gfr     Add access function mdsp_awake().
...
08/21/03     gw      Added prototype for mdsp_reset_async_rx_ptrs().
...
10/17/01     jc      Added timetest.h, removed unused phoneT functions, added
                     a couple phoneT cmds, mdsp_nonsbi_write() now uses a uint16
...
===========================================================================*/
boolean mdsp_init_completed(void);
void mdsp_set_init(void);

/* ---------- Init functions ---------- */

extern boolean mdsp_asynch_dsp_int_enabled(void);
extern boolean  mdsp_commands_pending(void);
extern uint16 mdsp_get_current_seq_num (void);


extern void mdsp_set_last_debugftick(void);

extern void mdsp_set_mdsp_gsm_txlm_buf_idx(uint32 buf_idx  );
...
uint8 mdsp_current_buffer(void);
uint8 mdsp_current_buffer_mod3(void);
...
typedef enum
{
   ...
   ,FSK_TX_MODE         = RFGSM_MAX_RX_BURST_TYPES+1
#endif
} mdsp_burst_mode;
#else
typedef enum
...
===========================================================================*/
mdsp_intf_public_data_t* get_mdsp_intf_public_dataspace_ptr( );
...
(
  gfw_shared_variable_class_type shared_variable_class
);
...
===========================================================================*/
void mdsp_reset_command_buffers (void);
...
===========================================================================*/
void mdsp_cfg_amam_ampm_tables(mdsp_amam_ampm_tables_type *amam_ampm_tables);
...
===========================================================================*/
void mdsp_update_amam_ampm_tables(boolean new_am_am_table, boolean new_am_pm_table);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_send_tx_cal_cmd ( mdsp_ftm_tx_cal_struct *tx_cal_buffer  );
...
===========================================================================*/
void mdsp_set_tx_path_delay (int16 delay_val  );
...
===========================================================================*/
void mdsp_set_tx_smps_pdm_value (int16 pdm_value  );
...
===========================================================================*/
void mdsp_update_linear_tx_gain_buff (void);
...
===========================================================================*/
void mdsp_update_parange_init_data(mdsp_nonsbi_ctl_unit **script_ptr);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_start_tx_tone_cont (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_stop_tx_tone_cont (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_start_tx_data_cont ( uint16 *buffer, uint16 buf_len);
...
===========================================================================*/
boolean mdsp_cm_check_for_error_recovery(void);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_set_tx_burst_offset (int16 tx_burst_offset);
...
SIDE EFFECTS
  None
===========================================================================*/
void* mdsp_get_gfw_event_buffer(mdsp_burst_mode burst_mode,uint8 burst_index);
/*===========================================================================
...
SIDE EFFECTS
  None
===========================================================================*/
GfwRfInitEvent* mdsp_get_gfw_init_event_buffer(void);

/*===========================================================================

FUNCTION mdsp_get_gfw_fsk_init_event_buffer

DESCRIPTION
  Returns pointer to GFW fsk init event buffer
...
SIDE EFFECTS
  None
===========================================================================*/
GfwRfInitEvent* mdsp_get_gfw_fsk_init_event_buffer(void);
...
GfwRfInitEvent* mdsp_get_gfw_init_event_buffer_DivRx(void);
...
SIDE EFFECTS
  None
===========================================================================*/
volatile GfwRfSetTxBandEvent* mdsp_get_gfw_tx_band_event_buffer(void);
...
SIDE EFFECTS
  None
===========================================================================*/
GfwRfThermReadEvent* mdsp_get_gfw_therm_read_event_buffer(void);

void mdsp_set_asynch_int_enabled( boolean set_asynch_int  );
...
===========================================================================*/
boolean mdsp_dtm_use_saic (mdsp_channel_type chan, boolean saic_cfg  );
...
===========================================================================*/
boolean mdsp_dtm_use_esaic (mdsp_channel_type chan, boolean saic_cfg  );
...
===========================================================================*/
boolean mdsp_dtm_use_aeq (mdsp_channel_type chan,boolean dedicated_mode, boolean saic_cfg  );
...
boolean mdsp_dtm_use_aeq_8psk(mdsp_channel_type chan, boolean saic_cfg  );
...
===========================================================================*/
void mdsp_enable_aeq_8psk (boolean enable  );
...
===========================================================================*/
boolean mdsp_dedicated_use_aeq (boolean dedicated_mode, boolean saic_cfg);
...
===========================================================================*/
boolean mdsp_idle_use_aeq (boolean idle_mode, boolean saic_cfg);
#endif /* FEATURE_GSM_RX_DIVERSITY_IDLE */
#endif /* FEATURE_GSM_RX_DIVERSITY */

/* ---------- Miscellaneous functions ---------- */
void mdsp_ciphering_enable (mdsp_ciphering_type mode, uint32 *CipherKey);
void mdsp_ciphering_disable (void);
void mdsp_update_ciphering_fn (uint32 fn  );

void mdsp_issue_app_mode_command_if_required(void);
...
void mdsp_wait_for_frame_tick (void);

boolean mdsp_wait_for_frame_tick_non_blocking( rex_tcb_type  *tcb_ptr,
                                            rex_sigs_type  wait_sig
                                             );
void mdsp_taf_control (void);
void mdsp_set_loopback (mdsp_loopback_type type  );
...
void mdsp_issue_generic_config_command(void);
...
===========================================================================*/
void mdsp_init_public_data_space(void);
...
===========================================================================*/
void mdsp_init_private_data_space(void);
...
DESCRIPTION
 ...
 ===========================================================================*/
void mdsp_set_mdsp_compressed_mode (void);
...
===========================================================================*/
void mdsp_init_MdspHostIfBaseStore (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_sleep_reset_mdsp_intf(void);

void mdsp_feature_check (void);


void mdsp_inact (void);
void mdsp_set_dsp_error_mask (uint32 mask0, uint32 mask1 );
void mdsp_set_dsp_warning_mask (uint32 mask0, uint32 mask1 );


/* ---------- Receive control functions ---------- */
void mdsp_set_sync_rx_time_offset(uint16 offset);
void mdsp_set_sync_rx_search_width(uint16 width );
void mdsp_set_async_rx_search_width(uint16 width);
uint16 mdsp_get_sync_rx_time_offset (void);
uint16 mdsp_get_sync_rx_search_width(void);
uint16 mdsp_get_async_rx_search_width(void);
...
#endif
void mdsp_advance_rx_metrics_ptrs(void);
#endif /* !FEATURE_GSM_MDSP_DTM */
void mdsp_reset_rx_seq_nums(void);
void mdsp_reset_async_rx_ptrs(void);
#ifdef FEATURE_GSM_AMR
void mdsp_dl_codec_set_configure_cmd(mdsp_amr_codec_mode_type *codec_mode  );
#endif
void mdsp_enable_saic (boolean enable );
boolean mdsp_get_enable_saic (void);

#ifdef FEATURE_GSM_MDSP_ESAIC
void mdsp_enable_esaic (boolean enable );
boolean mdsp_get_enable_esaic (void);
void mdsp_flush_esaic_iir_filter( boolean flush_esacch,boolean restore_ersacch  );
#endif

void mdsp_enable_aeq (boolean enable );
boolean mdsp_get_enable_aeq(void);

#ifdef FEATURE_GSM_MDSP_AEQ_SCH
void mdsp_enable_aeq_sch (boolean enable );
#endif
/* ---------- Results retrieval functions ---------- */
boolean mdsp_get_FCCH_results ( GfwFcchResultStruct *data  );

#ifdef FEATURE_GSM_NB_JAMMER_DETECTION
boolean mdsp_get_NBjdet_results ( GfwWbeeWbdcEst *data );
#endif /* FEATURE_GSM_NB_JAMMER_DETECTION */

boolean mdsp_x2g_get_FCCH_results ( GfwFcchResultStruct *data, uint16  seq_num  );

boolean mdsp_get_SCH_results ( GfwSchResultStruct *data  );
...
boolean mdsp_get_debug_data ( uint16 *data, uint16 offset, uint16 length );


boolean mdsp_get_iq_data(int16 *data, uint16 length  );
...
===========================================================================*/
void mdsp_cfg_pa_profile_direct(mdsp_pa_ramp_type *ramp_tbl);
...
void mdsp_stop_acquisition(uint16 offset );



/* ---------- Transmit control functions ---------- */
void mdsp_set_bsic (uint16 bsic  );
void mdsp_enable_tx_rotator(boolean enable);
int16 mdsp_get_tx_burst_offset (void);
#ifndef FEATURE_GSM_MDSP_DTM
...
===========================================================================*/
boolean mdsp_prepare_for_sleep (void);
void mdsp_go_to_sleep(void);
boolean mdsp_awake(void);
boolean mdsp_is_enabled(void);
boolean mdsp_ready_for_sleep (void);
void mdsp_display_sleep_error( boolean print_nacked_error_msg  );
boolean mdsp_sleep_error_pending (void);

void mdsp_set_tx_config_cmd_pending(uint32 txlm_buf_idx);
void  mdsp_gsm_config_tx( uint32 buf_idx  );
void  mdsp_gsm_config_tx_channel_id(uint32 buf_idx, uint8 tx_channel_id);

void  mdsp_afc_update_cmd( int32 f_hz_q6 ,uint32 inv_f_dl_lo  );

void  mdsp_set_check_cm_cleanup_buffer( uint8  buffer_index );

/* ---------- Compressed mode functions ---------- */
void mdsp_cm_init (void) ;
void mdsp_cm_inact ( boolean disable_fw ) ;
void * mdsp_cm_startup( uint16  offset, 
						uint8   buffer_index,
                      	uint32 rxlm_buf_idx, 
						rfm_device_enum_type device);
#ifdef FEATURE_GSM_RFLM_FED
void mdsp_cm_preload( uint16 pretune_offset, uint16  startup_offset, uint32 rxlm_buf_idx, uint8 buffer_index, boolean immediate_preload );
#endif
void *mdsp_cm_cleanup( uint16  offset, uint8 buffer_index, boolean rf_tuneback , uint32 rxlm_buf_idx );
...
void mdsp_build_fw_burst_buffer (  uint16 id, uint16 data, mdsp_burst_type burst );
...
#ifdef FEATURE_GSM_MDSP_GTOW
/* ---------- GTOW functions ---------- */
void mdsp_start_wcdma_rf_cmd(uint16 start_time, boolean  rf_tune2x, uint32 rxlm_irat_buf_idx  );
void mdsp_get_rf_off_script_offsets(uint16 *sbi_buffer, uint16 *grfc_buffer );
void mdsp_prepare_wcdma_buffers(void);
void mdsp_rf_sample_ram_cmd(uint16 start_time, uint16 stop_time, boolean  rf_tune2x, uint32 rxlm_gsm_buf_idx, uint32 rxlm_irat_buf_idx  );
...
void  mdsp_g2x_cleanup_cmd( uint16  time_offset, uint32 rxlm_buf_idx, boolean  tuneback_to_gsm );
...
boolean mdsp_memory_dump_requested (void);
boolean mdsp_memory_dump_in_progress (void);
void mdsp_memory_dump_to_file (void);
void mdsp_force_memory_dump (void);

/* ---------- Functions to support mdsp halts ------------------- */
typedef void (*mdsp_gsm_panic_cb_type)(void);
void mdsp_gsm_register_panic_cb(mdsp_gsm_panic_cb_type cb  );
void mdsp_handle_panic(void);
...
uint16 mdsp_sbd_read_pattern_used (void);

void mdsp_reset_grfc_shadows(void);
void mdsp_reset_pending_nonsbi_writes (void);

void mdsp_clear_gap_cmds(void);

#ifndef FEATURE_GSM_RFLM_FED
void mdsp_update_gfw_dynamic_buffer(void);
#endif
...
===========================================================================*/
boolean mdsp_get_aeq_8psk_status (void);
...
===========================================================================*/
void mdsp_enable_aeq_8psk_dynamic (boolean enable );
...
===========================================================================*/
boolean mdsp_get_aeq_8psk_dynamic_status (void);
...
============================================================================*/
mdsp_rf_desense_chan_type mdsp_is_desense_arfcn( uint16 chanel_num , sys_band_T  band );
...
===========================================================================*/
void mdsp_set_ftsm_geran (uint16 ftsm);
...
===========================================================================*/
uint16 mdsp_get_sync_rx_offset (void);
#endif
/*===========================================================================
...
===========================================================================*/
void mdsp_gsm_sleep_cmd_done_isr (void);
...
============================================================================*/
void mdsp_set_iq_log_gas_id (  boolean value  );
...
===========================================================================*/
void mdsp_xo_desense_arfcn_gas_id (mdsp_xo_desense_arfcn_struct *pointer  );
...
===========================================================================*/
void mdsp_async_intf_send_cmd(void);
...
===========================================================================*/
void mdsp_async_intf_send_immediate_cmd(uint32  cmd_fn, boolean rf_activity_cmds);
/*===========================================================================
...
===========================================================================*/
void mdsp_inc_current_buffer_mod3 (void);
...
===========================================================================*/
void mdsp_frame_tick_process (void);
...
void mdsp_awake_set (boolean mdsp_awake_state);
void mdsp_set_async_imm_cmd_sent(boolean async_imm_cmd_sent);
...
===========================================================================*/
extern uint32 mdsp_get_fws_app_mask(void);
/*===========================================================================
...
============================================================================*/
void mdsp_process_cxm_logs(void);
#endif /* MDSP_INTF_H */
