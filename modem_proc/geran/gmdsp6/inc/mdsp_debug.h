...
===========================================================================*/
mdsp_nv_item_type* mdsp_debug_nv_mem_dump_enabled(void);
...
===========================================================================*/
mdsp_nv_recovery_restart_type* mdsp_debug_nv_recovery_restart(void);
...
===========================================================================*/
void mdsp_check_for_errors (void);
...
SIDE EFFECTS
  None
===========================================================================*/
void mdsp_memory_dump_to_file (void) GMDSP6_DEPRECATED_ATTRIBUTE;
...
===========================================================================*/
void mdsp_check_rf_ccs_rx_event_buffer(volatile GfwRxEvent *pGfwRxEvent, mdsp_burst_mode burst_mode, uint8 index, boolean flag_error);
...
===========================================================================*/
void mdsp_check_rf_ccs_tx_event_buffer(GfwTxEvent *pGfwTxEvent);
...
===========================================================================*/
void mdsp_clear_rf_ccs_irat_buffer(uint8 startup_buffer_index, uint8 cleanup_buffer_index);


void mdsp_clear_rf_qta_cleanup_buffer(uint8 cleanup_buffer_index);
...
===========================================================================*/
void mdsp_set_last_debugftick(void);
...
===========================================================================*/
void mdsp_log_grfc_write (uint16 reg, uint32 data  );
...
DESCRIPTION
   ...
   number at the time.
===========================================================================*/
void mdsp_log_qdsp6_cmds (GfwCmdBufType *cmd, uint16 len, uint16 num_cmds);
