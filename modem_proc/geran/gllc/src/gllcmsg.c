...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gllc/src/gllcmsg.c#4 $
***
...
)
{
  ...
  {
    MSG_GERAN_HIGH_2_G( "GLC LL%d: Sent LLGMM-STAT-IND %d", gllc_sapi_addr_lookup[lle], cause);
...
)
{
  ...
  if ( llgmm_dl_mes != NULL )
  {
    ...
    llgmm_dl_mes -> cmd.llgmm_status_ind.tlli           = gllc_llme.tlli;
...
void gllc_llme_send_llgmm_trigger_ind_mes(void)
{
  mm_cmd_type *llgmm_dl_mes;
  ...
  if ( llgmm_dl_mes != NULL )
  {
    ...
    llgmm_dl_mes -> cmd.llgmm_trigger_ind.tlli = gllc_llme.tlli;
...
void gllc_llme_send_llgmm_rdy_tmr_ind_mes(void)
{
  mm_cmd_type *llgmm_dl_mes;
  ...
  if ( llgmm_dl_mes != NULL )
  {
    ...
    llgmm_dl_mes -> cmd.llgmm_rdy_tmr_ind.tlli = gllc_llme.tlli;
...
void gllc_llme_send_llgmm_suspend_cnf_mes(void)
{
  mm_cmd_type *llgmm_dl_mes;
  ...
  if ( llgmm_dl_mes != NULL )
  {
    ...
    llgmm_dl_mes -> cmd.llgmm_suspend_cnf.tlli = gllc_llme.tlli;
...
void gllc_llme_send_llgmm_new_tlli_ind_mes( uint32 new_tlli )
{
  mm_cmd_type *llgmm_dl_mes;
...
void gllc_llme_send_llgmm_psho_cnf_mes(void)
{
  mm_cmd_type *llgmm_dl_mes;
...
void gllc_lle_send_ll_rst_ind_mes( gllc_ll_sapi_t lle, uint32 tlli )
{
  gprs_ll_dl_sig_mes_t *ll_dl_mes = gllc_ll_dl_sig_get_mes_buf( lle );

  if ( ll_dl_mes != NULL )
  {
    MSG_GERAN_LOW_1_G( "GLC LL %d: Sent LL-RESET-IND",
...
#ifdef FEATURE_GPRS_PS_HANDOVER
    ll_dl_mes -> mes.rst_ind_mes.use_old_xid_ind = gllc_llme.use_old_xid_ind;
#endif /* FEATURE_GPRS_PS_HANDOVER */
    ...
    gllc_ll_dl_sig_put_mes_buf( lle, ll_dl_mes );
  }
      ...
      if ( u_frame -> xid == GLLC_XID_REQ )
      {
        if ( u_frame -> info_field.xid_info.contents & GLLC_LAY3_XID )
        {
          if ( u_frame -> info_field.xid_info.l3_xid.params != NULL )
          {
            ...
            gllc_lle_set_ul_event_mask_scheme( lle, GLLC_LLE_SCHEME_WAIT_LAY3_RESP );
            ...
            if ( gllc_lle[lle].unnum.xid_neg.contents & GLLC_N201_U_XID )
              ll_dl_mes -> mes.est_ind_mes.n201_u =
...
)
{
  ...
  if ( ll_dl_mes != NULL )
  {
    MSG_GERAN_MED_2_G( "GLC LL %d: Sent LL-REL-IND %d", gllc_sapi_addr_lookup[lle], cause);
...
void gllc_lle_send_ll_rel_cnf_mes( gllc_ll_sapi_t lle, uint32 tlli )
{
  gprs_ll_dl_sig_mes_t *ll_dl_mes = gllc_ll_dl_sig_get_mes_buf( lle );
...
void gllc_lle_clr_est_susp ( gllc_ll_sapi_t lle )
{

  uint8 sapi = gllc_sapi_addr_lookup[ lle ]; 
  gsn_ul_clr_est_susp( sapi );
...
)
{
  ...
  if ( ll_dl_mes != NULL )
  {
    ...
    gllc_ll_dl_dat_put_mes_buf( lle, ll_dl_mes );
  }
  else
  {
...
)
{
  ...
  ll_dl_mes = gllc_ll_dl_sig_get_mes_buf( lle );

  if ( ll_dl_mes != NULL )
  {
    ll_dl_mes -> sapi                       = gllc_sapi_addr_lookup[lle];
    ll_dl_mes -> mes.prim                   = LL_DATA_CNF;
    ll_dl_mes -> mes.data_cnf_mes.tlli      = gllc_llme.tlli;
...
)
{
  ...
  if ( ll_dl_mes != NULL )
  {
    ...
    ll_dl_mes -> mes.udata_cnf_mes.tlli      = gllc_llme.tlli;
...
)
{
  ...
  gllc_lle[lle].unnum.cmd_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 = GLLC_SABM;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_or_res_CR = GLLC_COMMAND;
  gllc_lle[lle].unnum.cmd_frame.u_frame.poll_final_PF = GLLC_PF_POLL;

  /* --------------------------------------------------------------------- */

  /* Include any layer 2 XID negotiation request in the U Frame buffer. */

  if ( gllc_lle[lle].unnum.xid_req.contents )
  {
    gllc_lle[lle].unnum.cmd_frame.u_frame.xid = GLLC_XID_REQ;
    gllc_lle[lle].unnum.cmd_frame.u_frame.info_field.xid_info =
      gllc_lle[lle].unnum.xid_req;

    /* Remove what can't be sent in the uplink direction. */

    gllc_lle[lle].unnum.cmd_frame.u_frame.info_field.xid_info.contents &=
  ...
  MSG_GERAN_MED_2("GLC LL %d: Sent SABM L3 %d", gllc_sapi_addr_lookup[lle], (l3_xid_req != NULL));
  ...
  gllc_lle_report_l2_xid_content( 
    lle, &gllc_lle[lle].unnum.cmd_frame.u_frame.info_field.xid_info );
  ...
  gllc_lle[lle].unnum.retrx_ctr   = 0;
  ...
  GLLC_CLR_LLE_UL_EVT( lle, GLLC_LLE_UL_TIMER_T200_EVT );
  gllc_lle_set_ul_event_mask_scheme( lle, GLLC_LLE_SCHEME_WAIT_PEER_RESP );

  GLLC_SET_LLE_UL_EVT( lle, GLLC_LLE_UL_U_FR_CMD_EVT );
...
boolean gllc_lle_resend_sabm_cmd_mes( gllc_ll_sapi_t lle )
{
  if
  (
    (gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 == GLLC_SABM   ) &&
  ...
  {
    MSG_GERAN_HIGH_3_G( "GLC LL %d: Retx SABM %d, N200 %d",
      gllc_sapi_addr_lookup[lle],
      gllc_lle[lle].unnum.retrx_ctr,
      gllc_lle[lle].gen.max_retrx_cnt_N200);

    if ( gllc_lle[lle].unnum.retrx_ctr <
         gllc_lle[lle].gen.max_retrx_cnt_N200 )
    {
      gllc_lle[lle].unnum.retrx_ctr++;
      (void)rex_set_timer
...
void gllc_lle_send_disc_cmd_mes( gllc_ll_sapi_t lle )
{
  ...
  gllc_lle[lle].unnum.cmd_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 = GLLC_DISC;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_or_res_CR = GLLC_COMMAND;
  gllc_lle[lle].unnum.cmd_frame.u_frame.poll_final_PF = GLLC_PF_POLL;
  gllc_lle[lle].unnum.cmd_frame.u_frame.xid           = GLLC_XID_NONE;
...
boolean gllc_lle_resend_disc_cmd_mes( gllc_ll_sapi_t lle )
{
  ...
  {
    MSG_GERAN_HIGH_3_G( "GLC LL %d: Retx DISC: %d, N200: %d",
      gllc_sapi_addr_lookup[lle],
      gllc_lle[lle].unnum.retrx_ctr,
      gllc_lle[lle].gen.max_retrx_cnt_N200);
...
)
{
  ...
  gllc_lle[lle].unnum.cmd_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 = GLLC_XID;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_or_res_CR = GLLC_COMMAND;
  gllc_lle[lle].unnum.cmd_frame.u_frame.poll_final_PF = GLLC_PF_POLL;
  ...
  /* Include any layer 3 XID parameter negotiation request in the U Frame
     buffer. */
  MSG_GERAN_MED_2_G( "GLC LL %d: Sent XID Cmd L3 %d",
    gllc_sapi_addr_lookup[lle],
    (l3_xid_req != NULL));
  ...
  if ( lle == GLLC_LL_SAPI_1_GMM )
    gllc_lle[lle].unnum.cause = GRR_CAUSE_GMM_SIGNALLING;
  else
    gllc_lle[lle].unnum.cause = GRR_CAUSE_LLC_SIGNALLING;
...
/*===========================================================================
===
===  FUNCTION      GLLC_LLE_INTERNAL_U_FRAME_RSP()
===
===  DESCRIPTION
===
===   Collates the necessary information to compose the required unnumbered
===   response message (XID/UA). Send it to self so that it will be treated
===   as if received from the network.
===
===  DEPENDENCIES
===
===   None.
...
void gllc_lle_internal_u_frame_rsp
(
  gllc_ll_sapi_t    lle,
...
)
{
  ...
  uint16           xid_rcvd_mask = ~(gllc_psm_info.lle_info[lle].l2_info.xid_pending);

  (void) memset(&frm, 0, sizeof(gllc_u_frame_t));

  frm.format        = GLLC_U_FORMAT;
  frm.cmd_or_res_CR = GLLC_RESPONSE;
  frm.poll_final_PF = GLLC_PF_FINAL;
  frm.cmd_res_M4_M1 = cmd;
  frm.xid           = GLLC_XID_NEG;

  xid_info = &frm.info_field.xid_info;

  /* Populate XID information element. */
  if ((xid_rcvd_mask & GLLC_VERSION_XID) && (gllc_lle[lle].state != GLLC_LLE_ABM))
  {
    xid_info->contents   |= GLLC_VERSION_XID;
    xid_info->version_xid = gllc_psm_info.llme_info.llc_version;
  }

  if ((xid_rcvd_mask & GLLC_IOV_UI_XID) && (gllc_lle[lle].state != GLLC_LLE_ABM))
  {
    xid_info->contents   |= GLLC_IOV_UI_XID;
    xid_info->iov_ui_xid  = gllc_psm_info.llme_info.input_offset_IOV_UI;
  }

  if (xid_rcvd_mask & GLLC_T200_XID)
  {
    xid_info->contents   |= GLLC_T200_XID;
    xid_info->t200_xid    = gllc_psm_info.lle_info[lle].l2_info.retrx_interval_T200 / 100;
  }

  if (xid_rcvd_mask & GLLC_N200_XID)
  {
    xid_info->contents   |= GLLC_N200_XID;
    xid_info->n200_xid    = gllc_psm_info.lle_info[lle].l2_info.max_retrx_cnt_N200;
  }

  if (xid_rcvd_mask & GLLC_N201_U_XID)
  {
    xid_info->contents   |= GLLC_N201_U_XID;
    xid_info->n201_u_xid  = gllc_psm_info.lle_info[lle].l2_info.max_info_octets_N201_U;
  }

  if (cmd == GLLC_UA)
  {
    if (xid_rcvd_mask & GLLC_IOV_I_XID)
    {
      xid_info->contents   |= GLLC_IOV_I_XID;
      xid_info->iov_i_xid   = gllc_psm_info.lle_info[lle].l2_info.input_offset_IOV_I;
    }

    if (xid_rcvd_mask & GLLC_N201_I_XID)
    {
      xid_info->contents   |= GLLC_N201_I_XID;
      xid_info->n201_i_xid  = gllc_psm_info.lle_info[lle].l2_info.max_info_octets_N201_I;
    }

    if (xid_rcvd_mask & GLLC_mD_XID)
    {
      xid_info->contents   |= GLLC_mD_XID;
      xid_info->md_xid      = gllc_psm_info.lle_info[lle].l2_info.max_reseq_buf_octets_mD / 16;
    }

    if (xid_rcvd_mask & GLLC_mU_XID)
    {
      xid_info->contents   |= GLLC_mU_XID;
      xid_info->mu_xid      = gllc_psm_info.lle_info[lle].l2_info.max_retrx_buf_octets_mU / 16;
    }

    if (xid_rcvd_mask & GLLC_kD_XID)
    {
      xid_info->contents   |= GLLC_kD_XID;
      xid_info->kd_xid      = gllc_psm_info.lle_info[lle].l2_info.max_reseq_buf_frames_kD;
    }

    if (xid_rcvd_mask & GLLC_kU_XID)
    {
      xid_info->contents   |= GLLC_kU_XID;
      xid_info->ku_xid      = gllc_psm_info.lle_info[lle].l2_info.max_retrx_buf_frames_kU;
    }
  }

  if ((xid_rcvd_mask & GLLC_LAY3_XID) && gllc_psm_info.lle_info[lle].l3_xid_len)
  {
    dsm_item_type * l3_xid;

    l3_xid = gprs_pdu_construct(gllc_psm_info.lle_info[lle].l3_xid_info, gllc_psm_info.lle_info[lle].l3_xid_len);
    
    xid_info->contents   |= GLLC_LAY3_XID;
    xid_info->l3_xid.length = gllc_psm_info.lle_info[lle].l3_xid_len;
    xid_info->l3_xid.params = l3_xid;

    GPRS_MEM_FREE(gllc_psm_info.lle_info[lle].l3_xid_info);
    gllc_psm_info.lle_info[lle].l3_xid_info = NULL;
    gllc_psm_info.lle_info[lle].l3_xid_len = 0;
  }

  gllc_ul_unnum_cr_put_u_frame(lle, gllc_llme.tlli, frm);
}
...
boolean gllc_lle_resend_xid_cmd_mes( gllc_ll_sapi_t lle )
{
  if
  (
    (gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 == GLLC_XID    ) &&
  ...
  {
    MSG_GERAN_HIGH_3_G( "GLC LL %d: Retx XID: %d, N200: %d",
      gllc_sapi_addr_lookup[lle],
      gllc_lle[lle].unnum.retrx_ctr,
      gllc_lle[lle].gen.max_retrx_cnt_N200);
...
void gllc_lle_send_null_cmd_mes( gllc_ll_sapi_t lle )
{
  ...
  gllc_lle[lle].unnum.cmd_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_res_M4_M1 = GLLC_NULL;
  gllc_lle[lle].unnum.cmd_frame.u_frame.cmd_or_res_CR = GLLC_COMMAND;
  gllc_lle[lle].unnum.cmd_frame.u_frame.poll_final_PF = GLLC_PF_UNSOL;
  gllc_lle[lle].unnum.cmd_frame.u_frame.xid           = GLLC_XID_NONE;
...
)
{
  ...
  if ( gllc_lle[lle].unnum.sol_res_frame.u_frame.
         info_field.xid_info.l3_xid.params != NULL )
  {
    GPRS_PDU_FREE(
      &gllc_lle[lle].unnum.sol_res_frame.u_frame.
        info_field.xid_info.l3_xid.params );
  }
  ...
  gllc_lle[lle].unnum.sol_res_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_res_M4_M1 = GLLC_UA;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_or_res_CR = GLLC_RESPONSE;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.poll_final_PF = GLLC_PF_FINAL;

  /* --------------------------------------------------------------------- */

  /* Include any layer 2 XID negotiation response in the U Frame buffer. */

  if ( gllc_lle[lle].unnum.xid_neg.contents )
  {
    gllc_lle[lle].unnum.sol_res_frame.u_frame.xid = GLLC_XID_NEG;
    gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.xid_info =
      gllc_lle[lle].unnum.xid_neg;

    /* Remove what can't be sent in the uplink direction. */

    gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.xid_info.contents &=
      ~( GLLC_RESET_XID | GLLC_IOV_UI_XID | GLLC_IOV_I_XID );
  }
  else
  ...
  /* Include any layer 3 XID parameter negotiation response in the U Frame
     buffer. */
  MSG_GERAN_MED_2("GLC LL %d: Sent UA L3 %d", gllc_sapi_addr_lookup[lle], (l3_xid_neg != NULL));
  ...
  gllc_lle_report_l2_xid_content(
    lle, &gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.xid_info );
  ...
  GLLC_SET_LLE_UL_EVT( lle, GLLC_LLE_UL_U_FR_SRES_EVT );
...
)
{
  ...
  if ( poll_final_PF == GLLC_PF_FINAL )
  {
    ...
    gllc_lle[lle].unnum.sol_res_frame.format                = GLLC_U_FORMAT;
    gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_res_M4_M1 = GLLC_DM;
    gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_or_res_CR = GLLC_RESPONSE;
    gllc_lle[lle].unnum.sol_res_frame.u_frame.xid           = GLLC_XID_NONE;
    gllc_lle[lle].unnum.sol_res_frame.u_frame.poll_final_PF = poll_final_PF;
  ...
  else /* GLLC_PF_UNSOL */
  {
    ...
    if ( gllc_lle[lle].unnum.unsol_res_frame.u_frame.
           info_field.xid_info.l3_xid.params != NULL )
    {
      GPRS_PDU_FREE(
        &gllc_lle[lle].unnum.unsol_res_frame.u_frame.
          info_field.xid_info.l3_xid.params );
    }
    ...
    gllc_lle[lle].unnum.unsol_res_frame.format                = GLLC_U_FORMAT;
    gllc_lle[lle].unnum.unsol_res_frame.u_frame.cmd_res_M4_M1 = GLLC_DM;
    gllc_lle[lle].unnum.unsol_res_frame.u_frame.cmd_or_res_CR = GLLC_RESPONSE;
    gllc_lle[lle].unnum.unsol_res_frame.u_frame.xid           = GLLC_XID_NONE;
    gllc_lle[lle].unnum.unsol_res_frame.u_frame.poll_final_PF = poll_final_PF;
    ...
    GLLC_SET_LLE_UL_EVT( lle, GLLC_LLE_UL_U_FR_URES_EVT );
  }
...
)
{
  ...
  gllc_lle[lle].unnum.sol_res_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_res_M4_M1 = GLLC_XID;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_or_res_CR = GLLC_RESPONSE;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.poll_final_PF = GLLC_PF_FINAL;
  ...
  /* Include any layer 3 XID parameter negotiation response in the U Frame
     buffer. */
  MSG_GERAN_MED_2_G( "GLC LL %d: Sent XID Res L3 %d",
    gllc_sapi_addr_lookup[lle],
    (l3_xid_neg != NULL));
...
)
{
  ...
  gllc_lle[lle].unnum.sol_res_frame.format                = GLLC_U_FORMAT;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_res_M4_M1 = GLLC_FRMR;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.cmd_or_res_CR = GLLC_RESPONSE;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.xid           = GLLC_XID_NONE;
  gllc_lle[lle].unnum.sol_res_frame.u_frame.poll_final_PF = GLLC_PF_FINAL;
  ...
  (void)memscpy
  (
    gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.frmr_info.rej_fr_ctrl_field,
    sizeof(gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.frmr_info.rej_fr_ctrl_field),
  ...
  gllc_lle_report_frmr_content(
    lle, &gllc_lle[lle].unnum.sol_res_frame.u_frame.info_field.frmr_info );
...
void gllc_llme_send_grr_suspend_req_mes(void)
{
...
void gllc_llme_send_grr_resume_req_mes(void)
{
  gprs_grr_ul_mes_t  *grr_ul_mes;
...
void gllc_llme_send_grr_purge_suspended_data_req_mes(void)
{
  gprs_grr_ul_mes_t  *grr_ul_mes;
...
void gllc_llme_send_grr_purge_data_req_mes( gllc_ll_sapi_t lle )
{
  gprs_grr_ul_mes_t  *grr_ul_mes;
