...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gllc/inc/gllc_v_g.h#3 $
***
...
extern void gllc_ll_ul_sig_put_mes_buf(gprs_ll_ul_sig_mes_t *mes_ptr);
...
extern void gllc_ll_ul_dat_put_mes_buf(gprs_ll_ul_dat_mes_t *mes_ptr);
...
extern gmmllc_gea_e_type gllc_llme_get_gea_algorithm(void);
...
extern void gllc_grr_ul_suspend_ind(void);
...
extern void gllc_grr_ul_L3L2_suspend_ind(void);
...
extern void gllc_grr_ul_resume_ind(void);
...
extern boolean gllc_grr_ul_tbf_rel_ind(void);
...
extern uint32 gllc_llme_get_current_octet_count(void);
...
extern void gllclient_reg_gmm_gsms_proxy(void);
