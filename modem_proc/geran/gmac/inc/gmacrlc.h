...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/inc/gmacrlc.h#2 $
***
...
#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION
/*--------------------------------------------------------------
** Structure for RLC to inform to MAC of EXT_UL_TBF period start
**--------------------------------------------------------------
*/
typedef struct
{
  /* signal id: RM_UL_EXT_TBF_START_IND
  */
  rm_sig_t      sig;
} rm_ul_ext_tbf_start_ind_t;
#endif /* FEATURE_GERAN_POWER_EFFICIENT_OPERATION */
...
#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION
    rm_ul_ext_tbf_start_ind_t       ul_ext_tbf_start_ind;
#endif /* FEATURE_GERAN_POWER_EFFICIENT_OPERATION */
...
===
===========================================================================*/
void mac_put_cmd_rlc (rlc_mac_msg_t *msg_ptr);
...
===    None.
===========================================================================*/
extern void gmac_store_trace_send_msg_buf(uint8 message_set, void* message_ptr);
