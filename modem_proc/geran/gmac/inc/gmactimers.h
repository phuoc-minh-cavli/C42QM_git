...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/inc/gmactimers.h#2 $
***
...
===
===========================================================================*/
void gmac_start_t3170(uint32 timer_val);
