...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/inc/gmacutil.h#3 $
***
...
===
===========================================================================*/
uint8 gmac_utils_calculate_nts(uint8 ts_allocm);
...
===
===========================================================================*/
uint16 gmac_cla_size_of_rac_ie(uint8 band_cnt);
...
boolean  gmac_util_packet_cell_change_failure_handler(void);

void    gmac_nacc_respond_to_release_req(mac_signals_u *);

/* FUNCTION PROTOTYPES */
void    gmac_util_init_cell_data(void);
void    gmac_util_release_container(uint8);
void    gmac_util_handle_pkt_cell_data(uint8, ARFCN_T);
void    gmac_util_send_serving_si(csn_decoder_ptrs_t *, ARFCN_T);
boolean gmac_util_check_tfi(uint8);
...
===
===========================================================================*/
extern void gmac_send_mac_grr_ps_access_cnf(void);
