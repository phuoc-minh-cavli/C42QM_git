...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/inc/gmacdef.h#2 $
***
...
typedef struct
{
   ...
   *************************************************************************************/
   ...
   /***** no_service_penidng *************************************************
   *
   *  Indicates that Transfer/Idle to NULL No Service message processing is pending
   *
   ***************************************************************************/
   boolean no_service_penidng;
}common_flags_t;
...
#define  GMAC_DYN_RESUME_SIG         (0x04)
