...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/src/gmacgrr.c#3 $   
***
...
===  
===========================================================================*/
void mac_put_cmd_grr_mac(grr_mac_sig_t *sig_ptr)
{
  ...
  switch (sig_ptr->sig_id)
  {
    ...
    default:
      MSG_GERAN_LOW_0_G("MAC error CFA LOG unknown message");
      break;
  }
