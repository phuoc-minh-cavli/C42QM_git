...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gmac/src/gmacrlc.c#2 $   
***
...
===  
===========================================================================*/
void mac_put_cmd_rlc(rlc_mac_msg_t *rlc_msg_ptr)
{
/* ======================================================================= */
  ...
  switch (rlc_msg_ptr->msg.sig)
  {
    ...
    case RM_UL_EXT_TBF_START_IND:
      cfa_log_packet_ex
      (
        GS_QUEUE_MAC, MS_MAC_RLC, (uint8)RM_UL_EXT_TBF_START_IND,
        sizeof( rm_ul_ext_tbf_start_ind_t ),
        (uint8 *)&rlc_msg_ptr->msg.ul_ext_tbf_start_ind
      );
      break;
  ...
  (void)rex_set_sigs(geran_tcb_read(GERAN_TASK_ID_GMAC), GPRS_MAC_MASTER_SIG);
