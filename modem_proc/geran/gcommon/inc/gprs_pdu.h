...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gcommon/inc/gprs_pdu.h#2 $
***
...
/*===========================================================================
===
===  FUNCTION      GPRS_PDU_ALLOC
===
===  DESCRIPTION
===
===    Allocates requested DSM resources to construct a new packet data
===    unit
===
===  DEPENDENCIES
===
...
===  RETURN VALUE
===
===    Pointer handle to the allocated DSM resource.
===
...
dsm_item_type* gprs_pdu_alloc(dsm_mempool_id_type pool_id);
