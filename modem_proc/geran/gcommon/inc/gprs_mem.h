...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gcommon/inc/gprs_mem.h#2 $
***
...
#include "modem_mem.h"
#if defined(FEATURE_EXTERNAL_PAGING_GERAN) && defined(FEATURE_EXTPL_HEAP)
#include "extpl_heap.h"
#endif
...
#if defined(FEATURE_EXTERNAL_PAGING_GERAN) && defined(FEATURE_EXTPL_HEAP)
#define EXTPL_MEM_MALLOC(siz) extpl_heap_alloc((siz))
#else
#define EXTPL_MEM_MALLOC(siz) GPRS_MEM_MALLOC(siz)
#endif
...
#if defined(FEATURE_EXTERNAL_PAGING_GERAN) && defined(FEATURE_EXTPL_HEAP)
#define EXTPL_MEM_FREE(ptr) extpl_heap_free(ptr)
#else
#define EXTPL_MEM_FREE(ptr) GPRS_MEM_FREE(ptr)
#endif
