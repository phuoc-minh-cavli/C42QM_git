...
$Header: //components/rel/geran.mpss/5.2.0/gcommon/inc/csn_apt.h#2 $
...
} mprach_control_params_t;

typedef struct
{
  boolean valid;
  uint8   cell_global_count;
  uint64  vstk_rand;
  uint32  reduced_gcr;
} cell_global_params_t;
...
typedef struct
{
 ...
 uint8          ts_num;
 uint8          usf;
 mprach_control_params_t prach_params;
...
} mbms_ptm_channel_dsc_t;

typedef struct
{
  mbms_ptm_channel_dsc_t ptm_info;
  mbms_session_params_t  session_info;
  mbms_mprach_dsc_t      prach_desc;
} mbms_notification_params_t;
...
typedef struct
{
  ...
  mbms_notification_params_t mbms_session_list_notification;
} mbms_session_information_t;


typedef struct
{
  boolean         valid;
  mbms_notification_params_t mbms_notify_1;
  mbms_notification_params_t mbms_notify_2;
  mbms_session_information_t mbms_session_info;
} mbms_related_params_t;

typedef struct
{
  boolean         valid;
  boolean         not_first_segment;
  boolean         pni;
  uint8           length_of_segment;
  uint8           data_segment;
  uint8           segment_number;
  uint8           total_segment;
} etws_related_params_t;


typedef struct
{
  boolean         r6_addition_flag;
  cell_global_params_t  cell_global_param;
  mbms_related_params_t mbms_related_param;
} p1_rest_octet_rel6_params_t;

typedef struct
{
  boolean         r7_addition_flag;
  boolean         amr_config_present;
  uint8           amr_config;
} p1_rest_octet_rel7_params_t;

typedef struct
{
  boolean         r8_addition_flag;
  boolean         priority_uplink_access;
  etws_related_params_t etws_params;
} p1_rest_octet_rel8_params_t;

typedef struct
{
  boolean         r6_addition_flag;
  mbms_notification_params_t mbms_notify_3;
  mbms_session_information_t mbms_session_info;
} p2_rest_octet_rel6_params_t;


typedef struct
{
  boolean    r10_addition_flag;
  boolean    implicit_cs_reject;
  boolean    implicit_ps_reject;

} page_rest_octet_rel10_params_t;


typedef struct
{
  boolean         r11_addition_flag;
  boolean         ipa_support;

} page_rest_octet_rel11_params_t;

typedef struct
{
  boolean         r13_addition_flag;
  uint8           peo_bcch_change_mark;
  uint8           rcc;
} page_rest_octet_rel13_params_t;


typedef struct
{
  boolean         peo_supported_flag;
  uint8           peo_dsc;
  uint8           rcc;
  boolean         c1_delta_present;
  uint8           c1_delta_min;
  uint8           c1_delta_max;
} peo_params_t;
...
#define MAX_P1_REST_OCTETS_LEN                   11
  ...
  p1_rest_octet_rel6_params_t                    p1_rest_octets_rel6_params;
  p1_rest_octet_rel7_params_t                    p1_rest_octets_rel7_params;
  p1_rest_octet_rel8_params_t                    p1_rest_octets_rel8_params;
  page_rest_octet_rel10_params_t                 page_rest_octets_rel10_params;
  page_rest_octet_rel11_params_t                 page_rest_octets_rel11_params;
  page_rest_octet_rel13_params_t                 page_rest_octets_rel13_params;
} p1_rest_octets_t;
...
#define CSN_NLN_STATUS                           1
  ...
  p2_rest_octet_rel6_params_t                    p2_rest_octets_rel6_params;
  page_rest_octet_rel10_params_t                 page_rest_octets_rel10_params;
  page_rest_octet_rel11_params_t                 page_rest_octets_rel11_params;
  page_rest_octet_rel13_params_t                 page_rest_octets_rel13_params;
} p2_rest_octets_t;
...
typedef struct {
  uint8                                          reported_timeslot;
  uint8                                          tsh;
  uint8                                         rtti_usf_mode;
  uint8                                         pdch_pair;
  uint8                                         usf2;
  uint8                                         additional_usf;
  uint8                                         additional_usf2;
} ia_ro_r7_alloc_t;

typedef struct {
  uint8                                         npn_starting_time;
  uint8                                         event_based_fnr;
  uint8                                         pdcsh_pair;
  uint8                                         egprs_level;
} ia_ro_r7_pda_alloc_t;
...
#define MAX_IA_RO_LENGTH_BITS                    (11*8) /* this length given in bits  */
  ...
  uint8                                          extended_ra;
  boolean                                        r6_supported_flag;
  ia_ro_r6_alloc_t                               ia_ro_r6_alloc;
  boolean                                        r7_supported_flag;
  ia_ro_r7_alloc_t                               ia_ro_r7;
...
typedef struct
{
  ...
  ia_ro_r6_alloc_t                               ia_ro_r6_alloc;
  boolean                                        r7_supported_flag;
  ia_ro_r7_pda_alloc_t                           ia_ro_r7_pda_alloc;
