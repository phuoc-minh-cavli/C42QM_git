...
$Header: //components/rel/geran.mpss/5.2.0/gcommon/inc/geran_multi_sim.h#4 $
$DateTime: 2019/07/05 02:39:06 $ $Author: pwbldsvc $
...
#define GERAN_ACCESS_STRATUM_ID_MAX ((NUM_GERAN_DATA_SPACES-1))
...
#define GERAN_MAP_DATA_SPACE_INDEX_TO_GAS_ID(dsi)
#else
#define GERAN_MAP_GAS_ID_TO_DATA_SPACE_INDEX() (GERAN_DATA_SPACE_INDEX_1)
...
extern int geran_get_data_space_index(void);
...
extern boolean geran_is_multi_mode_gas_id(void );

extern sys_modem_as_id_e_type geran_map_gas_id_to_nas_id(void);

extern gas_id_t geran_map_nas_id_to_gas_id(
  sys_modem_as_id_e_type as_id
);

extern byte geran_get_diag_sub_id(void);
...
#if defined(FEATURE_DUAL_SIM) || defined(FEATURE_TRIPLE_SIM)
extern boolean geran_g2w_tuneaway_supported_by_device_mode(
  const sys_modem_device_mode_e_type dev_mode
);
#endif
...
extern geran_exchange_direction_t geran_get_exchange_on_release(void );
...
extern void   geran_set_lte_activity_status(const uint32 activity_mask);
extern uint32 geran_get_lte_activity_status(void
#endif /* FEATURE_LTE */
#endif /* FEATURE_DUAL_SIM || FEATURE_TRIPLE_SIM */

extern void geran_q_destroy(q_type *q_ptr);
