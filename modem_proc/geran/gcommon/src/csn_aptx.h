...
$Header: //components/rel/geran.mpss/5.2.0/gcommon/src/csn_aptx.h#1 $
...
#define CSN_SI_CHANGE_ALTN                        1
#define CSN_PEO_DSC_LEN                           2
#define CSN_RCC_LEN                               3
#define CSN_C1_DELTA_MIN_LEN                      2
#define CSN_C1_DELTA_MAX_LEN                      3
#define CSN_PEO_BCCH_CHANGE_MARK_LEN              2
#define CSN_SI2QUATER_POSITION_LEN                1
#define CSN_SI21_POSITION_LEN                     1
