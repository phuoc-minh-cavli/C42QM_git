...
***
*** $Header: //components/rel/geran.mpss/5.2.0/gcommon/src/gprs_pdu.c#2 $   
***
...
{
  dsm_item_type *item_p = dsm_new_buffer(pool_id);

  if(item_p == NULL)
  {
    MSG_GERAN_ERROR_0("Buffer allocation failed - No DSM Resource");
  }
