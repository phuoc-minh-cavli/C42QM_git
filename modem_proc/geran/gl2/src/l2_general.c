...
$Header: //components/rel/geran.mpss/5.2.0/gl2/src/l2_general.c#2 $ $DateTime: 2018/10/10 08:50:54 $ $Author: pwbldsvc $
...
void l2_clear_T_ack_timer(sapi_info_T *sapi_info)
{
  if (sapi_info != NULL)
  {
    ...
    MSG_GERAN_LOW_1("Cleared TACK SAPI%1d",(int)(sapi_info->sapi));
  }
