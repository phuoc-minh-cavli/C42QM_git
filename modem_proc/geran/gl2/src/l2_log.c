...
$Header: //components/rel/geran.mpss/5.2.0/gl2/src/l2_log.c#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
===========================================================================*/
static void l2_log_packet_init(gsmdiag_pkt_info_t *info_ptr, log_code_type pkt_id, unsigned int pkt_size)
{
  if (info_ptr != NULL)
  {
...
void l2_log_state(l2_store_T *l2_data_ptr, byte sapi, byte l2_state, l2_event_T l2_event)
{
  ...
  l2_log_packet_init(&pkt_info, LOG_GSM_L2_STATE_C, sizeof(LOG_GSM_L2_STATE_C_type));
...
void l2_log_transmission_status(l2_store_T *l2_data_ptr, byte sapi, byte channel)
{
  ...
  l2_log_packet_init(&pkt_info, LOG_GSM_L2_TRANSMISSION_STATUS_C, sizeof(LOG_GSM_L2_TRANSMISSION_STATUS_C_type));
                    ...
                    byte SAPI3_SACCH_outstanding_i_frame)
{
  ...
  l2_log_packet_init(&pkt_info, LOG_GSM_L2_OUTSTANDING_FRAME_C, sizeof(LOG_GSM_L2_OUTSTANDING_FRAME_C_type));
