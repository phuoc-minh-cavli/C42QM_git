...
$Header: //components/rel/geran.mpss/5.2.0/gl2/src/l2_transfer.c#3 $ $DateTime: 2018/10/10 08:50:54 $ $Author: pwbldsvc $
...
void l2_handle_info_reception(l2_store_T *l2_data_ptr, SAPI_T sapi, l2_channel_type_T channel)
{
  ...
  {
    MSG_GERAN_ERROR_5_G("N(R) err VS:%d,NR:%d,NS:%d,VR:%d,VA:%d",sapi_info->VS,l2_data_ptr->received_NR,l2_data_ptr->received_NS,
      sapi_info->VR,sapi_info->VA);
  ...
  {
    MSG_GERAN_ERROR_4_G("Drop msg VS:%d,NR:%d,NS:%d,VR:%d",sapi_info->VS,l2_data_ptr->received_NR,l2_data_ptr->received_NS,sapi_info->VR);
  }
...
void l2_handle_normal_rr_reception(l2_store_T *l2_data_ptr, SAPI_T sapi, l2_channel_type_T channel)
{
  ...
  {
    MSG_GERAN_HIGH_5("N(R)err VS:%d,NR:%d,NS:%d,VR:%d,VA:%d",sapi_info->VS,l2_data_ptr->received_NR,l2_data_ptr->received_NS,
      sapi_info->VR,sapi_info->VA);
    /*****************************************************/
    /* A N(R) sequence error detection has been detected */
    /* Inform layer 3 on this exception condition        */
  ...
  {
    MSG_GERAN_HIGH_4("Dropmsg VS:%d,NR:%d,NS:%d,VR:%d",sapi_info->VS,l2_data_ptr->received_NR,l2_data_ptr->received_NS,sapi_info->VR);
  }
