...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_arbitrator_utils.h#2 $
...
===========================================================================*/
gas_id_t garb_peer_gas_id( void );
...
===========================================================================*/
garb_channel_t garb_get_channel_type(gl1_hw_channel_type gl1_hw_channel, garb_rxtx_t rxtx  );
...
===========================================================================*/
garb_channel_t garb_get_rx_channel_type(uint32 fn, uint8 ts  );
...
===========================================================================*/
garb_channel_t garb_get_tx_channel_type(uint32 fn, uint8 ts );
...
===========================================================================*/
uint32 garb_arfcn_to_centre_freq_kHz(ARFCN_T arfcn, garb_rxtx_t rxtx   );
...
===========================================================================*/
boolean garb_is_access_burst(garb_channel_t channel, uint32 fn, uint8 slot  );
...
===========================================================================*/
uint32 garb_get_slot_s_time(garb_frame_t* frame, garb_rxtx_t rxtx, uint8 slot  );
...
===========================================================================*/
uint32 garb_get_slot_e_time(garb_frame_t* frame, garb_rxtx_t rxtx, uint8 slot  );
...
===========================================================================*/
boolean garb_get_vbatt_tx_power_backoffs(double  TxP_SUB1_dBm, double TxP_SUB2_dBm, uint8 pri_SUB1, uint8 pri_SUB2, double* TxP_SUB1_backoff_dB, double* TxP_SUB2_backoff_dB  );
...
===========================================================================*/
garb_multi_sim_mode_t garb_get_multi_rat_mode(void );
...
===========================================================================*/
cxm_activity_type garb_get_cxm_priority_tier(garb_rxtx_t rxtx, garb_channel_t channel_type, uint8 ts  );
...
===========================================================================*/
boolean garb_is_sdcch_saach_frame(uint32 fn );
...
===========================================================================*/
boolean garb_is_tch_frame(uint32 fn );

boolean garb_is_rach_frame( uint32 fn  );
...
===========================================================================*/
boolean garb_is_rrbp_block_boundary(uint32 fn );
...
===========================================================================*/
uint32 garb_get_next_rrbp_fn(void );
...
===========================================================================*/
uint32 garb_get_mon_s_time( garb_frame_t* frame );
...
===========================================================================*/
uint32 garb_get_mon_e_time( garb_frame_t* frame );
...
===========================================================================*/
void  garb_update_scell_ncell_arfcns(ARFCN_T  *arfcns,  uint32  num_arfcns );
...
===========================================================================*/
ARFCN_T garb_get_monscan_arfcn(uint32 FN );
...
===========================================================================*/
ARFCN_T gpl1_get_serving_cell_next_arfcn(uint32 FN );
