...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_sc.h#10 $
$DateTime: 2019/04/30 05:58:24 $ $Author: pwbldsvc $
...
15/05/18   km        CR2241403 Optimize number of frames for SCH Decode in idle mode
...
/* In case of Ncell SCH if start_qbit < 200 then add 5000 qs over timing offset
   625 - (925[1.5 burst] - 300 - 160[uncertainity window]) = 160 + 40[delta] = 200 */
#define MAX_NSCH_OFFSET_REQUIRING_ONE_EXTRA_FN  200
...
typedef enum
{
   ...
   ,L1_SC_DEC_FAIL_WITH_GOOD_GDET = 4
#endif
} l1_sc_rcv_result_T;
...
===========================================================================*/
void    l1_sc_fcb_init(void);
void    l1_sc_fcb_shutdown( void );
void    l1_sc_start_fcb(cell_T* cell);
void    l1_sc_start_fcb_tch( cell_T* cell);
void    l1_sci_abort_fcb(void);
void    l1_sci_abort_fcb_tch(void);
void    l1_sci_tick_fcb(void);
void    l1_sci_post_tick_fcb(void);
boolean l1_sc_read_fcb( uint32* start_fn, int16* start_qbit  );
boolean l1_sc_read_fcbsb( uint8 sb_data[4], uint32* start_fn, int16* timing_error  );
boolean l1_sci_is_fb_in_progress(void);
void    l1_sci_tick_fcb_tch(void);

/* sb.c */

void    l1_sc_sb_init(void);
void    l1_sc_sb_shutdown(void);
void    l1_sc_start_sb( cell_T* cell);
void    l1_sc_start_sb_tch(cell_T* cell);
void    l1_sci_abort_sb(void);
void    l1_sci_abort_sb_tch(void);
void    l1_sci_tick_sb(void);
void    l1_sci_post_tick_sb(void);
void    l1_sci_tick_sb_tch(void);
l1_sc_rcv_result_T l1_sc_read_sb( uint8 sb_data[4], uint32* start_fn, int16* timing_error, int16* start_qbit );

/* bcch.c */

void    l1_sc_bcch_init(void);
void    l1_sc_bcch_shutdown(void);
void    l1_sc_start_bcch( cell_T *cell );
void    l1_sci_abort_bcch(void);
void    l1_sci_tick_bcch(void);
void    l1_sci_post_tick_bcch(void);
boolean l1_sc_read_bcch( uint8** bcch_data, dBx16_T* rx_power, int16* timing_error, uint8* tc, uint8* num_bursts  );
boolean l1_sc_bcch_use_high_priority (void);
void    l1_sc_bcch_set_high_priority_flag (void);
void    l1_sc_bcch_reset_high_priority_flag (void);


/* balist */

void l1_sc_check_for_ncc_permitted_update(void);
void    l1_sc_balist_init(void);
void    l1_sc_balist_clear(void);
boolean l1_sc_balist_prepare_new( inter_task_BCCH_allocation_T* ba_list, uint8 ncc_permitted  );
void    l1_sc_balist_use_new(void);
uint8   l1_sc_balist_get_best_six( l1_sc_bs_T* best_six[ MAX_NUMBER_OF_SURROUND_CELLS ]  );
cell_T* l1_sc_balist_get_cell_by_arfcn( ARFCN_T arfcn  );
void    l1_sc_balist_reset_counters(void);
void    l1_sc_balist_reset_powers(void);
uint16  l1_sc_balist_get( cell_T*** cells  );
l1_sc_bs_T*  l1_sc_balist_get_cell_data( ARFCN_T arfcn  );
void    l1_sc_balist_set_ra_length( uint8 len  );
void    l1_sc_balist_set_serving_cell( ARFCN_T arfcn  );
void    l1_sc_balist_set_multiband_reporting( uint8 multiband_reporting  );
uint8   l1_sc_balist_get_num_cells(void);
void    l1_sc_balist_sort( boolean include_serving  );
void    l1_sc_balist_sort_restrict_ba_len( boolean include_serving  );
void l1_sc_balist_multiband_sort( byte multiband_parameter  );
uint8   l1_sc_balist_get_best_thirtytwo( l1_sc_bs_T* best_thirtytwo[ 32 ]  );
void    l1_sc_balist_transfer_power_info(void);
void    l1_sc_balist_add_serving_cell(void);
cell_T* l1_sc_balist_get_serving_cell_ptr(void);
void    l1_sc_balist_set_serving_cell_valid( boolean serving_cell_valid  );
uint8   l1_sc_balist_get_old_id(void);
uint8   l1_sc_balist_get_new_id(void);
cell_T* l1_sc_balist_is_cell_in_new_ba_list( ARFCN_T arfcn  );
void    l1_sc_balist_add_cell( l1_sc_bs_T *new_bs  );
#ifdef FEATURE_EXTERNAL_PAGING_GERAN
void    gl1_allow_sci_inc_surround_tick_gbta( void );
#endif
/* idle.c */

void l1_sc_enter_idle(void);
void l1_sc_leave_idle(void);
void l1_sc_reselection_apply_freq_correction( ARFCN_T arfcn );
void l1_sc_report_period_done_idle(void);
void l1_sc_set_ba_list_idle( inter_task_BCCH_allocation_T* ba_list, uint8 ncc_permitted  );
void l1_sc_idle_add_serving_cell_to_balist(void);
void l1_sc_idle_post_sort_process(void);
uint32 l1_sc_get_gap_to_next_activity(void);
boolean l1_sc_is_ncell_acq_pending(void);
void l1_sc_reset_idle_rx_in_progress(void);


/* dedisdcc.c */

void l1_sc_enter_dedi_sdcch(void);
void l1_sc_leave_dedi_sdcch(void);
void l1_sc_report_period_done_sdcch(void);
void l1_sc_set_ba_list_dedi_sdcch( inter_task_BCCH_allocation_T* ba_list, uint8 ncc_permitted  );

/* deditch.c */

void l1_sc_enter_dedi_tch(void);
void l1_sc_leave_dedi_tch(void);
void l1_sc_report_period_done_tch(void);
void l1_sc_set_ba_list_dedi_tch( inter_task_BCCH_allocation_T* ba_list, uint8 ncc_permitted   );
void l1_sci_sb_cnf_dedi_tch( boolean success, uint8 sb_data[4], int16 timing_error );
void l1_sc_tch_tick( void* unused_t  );
...
void l1_sc_highest_lowest_timslot(gl1_defs_tn_struct* first_tn_ptr,
                                  gl1_defs_tn_struct* last_tn_ptr  );
void l1_sci_inc_surround_tick( int proposed_surround_tick_inc  );
void l1_sci_update_surround_tick_fn( uint32 frame_decrease  );

/* sc.c */

uint32 l1_sc_get_fn(void);
void   l1_sc_report_period_done(void);

/* dedi.c */

void l1_sc_enter_dedi(void);
void l1_sc_leave_dedi(void);
void l1_sc_good_sb_dedi( cell_T* cell, uint8 sb_data[4], uint32 start_fn, int16 timing_error );
void l1_sc_bad_sb_dedi( cell_T* cell  );

/* receive.c */

void    l1_sc_receive_init(void);
void    l1_sc_receive_shutdown( void );
void    l1_sci_tick_receive(void);
void    l1_sci_post_tick_receive(void);
void    l1_sci_receive_done(void);
void    l1_sc_receive_fcb( cell_T* cell, void ( *done )( cell_T*  ) );
void    l1_sc_receive_sb( cell_T* cell, void ( *done )( cell_T* ) );
void    l1_sc_receive_bcch( cell_T* cell, void ( *done )( cell_T* ) );
void    l1_sc_receive_fcb_tch( cell_T* cell, void ( *done )( cell_T* ));
void    l1_sc_receive_fcb_sb_tch( cell_T* cell, void ( *done )( cell_T* ) );
void    l1_sc_receive_sb_tch( cell_T* cell, void ( *done )( cell_T* ) );
void    l1_sc_abort_receive(void);
l1_sc_rcv_result_T l1_sc_read_sb_tch( uint8 sb_data[4], uint32* start_fn, int16* timing_error  );
void    l1_sc_abort_receive_callback(void);
void    abort_receive(void);
void    l1_sci_reset_state_machine(void);
/* monscan.c */

void    l1_sc_monscan_init( void );
void    l1_sc_monscan_abort(void);
void    l1_sc_monscan_update(void);
void    l1_sci_monscan_next_period(void);
void    l1_sci_monscan_next_period_ded(void);
boolean l1_sc_rx_power_acceptable( dBx16_T rx_power);
boolean l1_sc_rx_power_drop_acceptable( dBx16_T rx_power_drop);
void    l1_sc_monscan_set_req_passes( uint8 req_passes );
void    l1_sci_monscan_set_next_period_ded_cb(  );
boolean l1_sc_monscan_is_not_active(void);
...
/* Transfer */
void gpl1_gprs_sc_leave_trans(void);
void gpl1_gprs_sc_enter_trans(void);
void gpl1_gprs_sc_tick_trans(void);
void gpl1_gprs_sc_good_sb_trans( cell_T* cell, uint8 sb_data[4], uint32 start_fn, int16 timing_error  );
void gpl1_gprs_sc_bad_sb_trans(cell_T* cell);
void gpl1_gprs_sc_receive_sb_trans( cell_T* cell, void ( *done )( cell_T* ) );
void gpl1_gprs_sc_receive_fcb_trans( cell_T* cell, void ( *done )( cell_T* )  );
boolean gpl1_gprs_sc_receive_bcch_trans( cell_T* cell, void ( *done )( cell_T*  ),gl1_msg_chan_type chan_type,async_ccch_type_t async_ccch_type );
l1_sc_rcv_result_T gpl1_gprs_sc_read_sb_trans( uint8 sb_data[4], uint32* start_fn, int16* timing_error );
void gpl1_gprs_sc_start_fcb_trans( cell_T* cell );
void gpl1_gprs_sc_start_sb_trans( cell_T* cell );
void gpl1_gprs_sc_start_bcch_trans( cell_T *cell,gl1_msg_chan_type chan_type,async_ccch_type_t async_ccch_type  );
void gpl1_gprs_sc_trans_tick(void);
void l1_sci_monscan_next_period_trans(void);
void gpl1_sc_set_ba_list_trans( inter_task_BCCH_allocation_T* ba_list, uint8 ncc_permitted);
boolean gpl1_gprs_sc_bcch_sched_cb_trans(void);
void gpl1_gprs_sci_tick_fcb_trans(void);
void gpl1_gprs_sci_tick_sb_trans(void);
void gpl1_gprs_sci_tick_bcch_trans(void);
void gpl1_gprs_sc_trans_post_sort_process(void);
void gpl1_gprs_calc_pkt_txfr_gap(uint8 *lowest_rx_tn, uint8 *highest_tx_tn);
void wcdma_done_trans( void* unused  );
 ...
 */
void  gpl1_pkt_xfer_set_highest_rx_timeslot( uint8  highest_rx_timeslot );

void  gpl1_pkt_xfer_set_highest_tx_timeslot( uint8  highest_tx_timeslot );
...
//void l1_sc_set_bcch_autonomy( boolean autonomous  );
void gpl1_gprs_sc_idle_post_sort_process(void);
uint32 gpl1_gprs_get_bcch_fn(uint32 fn_lag, int16 qbit_lag, uint16 bcch_mask);

void gpl1_gprs_predict_next_sch(void);
void gpl1_gprs_restart_ncell_sch(void);
void l1_sc_reset_state_machine_in_leave_idle(void);
#ifdef FEATURE_EXTERNAL_PAGING_GERAN
void gl1_sc_ncell_acq_sch_reschedule_in_wakeup_cancel(l1_fm_priority_T pri);
void gl1_sc_ncell_bcch_reschedule_in_wakeup_cancel(void);
#endif


/* Debug */
void l1_sci_rcv_state_debug_msg(void);
void l1_sci_monscan_state_debug_msg(void);

/* Allow access to the ba cells list and their number */
extern cell_T**  l1sc_get_ba_cells(void);
extern uint8     l1sc_get_ba_cell_count(void);
extern uint8     l1sc_get_ba_blacklisted_cell_count(void);
...
extern void l1_set_idle_monitors_in_progress(uint8 idle_monitors_in_progress );


#if defined ( FEATURE_DUAL_SIM ) || defined ( FEATURE_TRIPLE_SIM )
void gl1_ms_async_ncell_bcch_sleep_adjust( int16 frame_adjust  );
void gl1_ms_async_ncell_sch_sleep_adjust( int16 frame_adjust );
void gl1_ms_async_idle_pch_sleep_adjust( int16 frame_adjust );
...
===========================================================================*/
void l1_sc_ncell_monitor_timer_start(void);
...
===========================================================================*/
void l1_sc_init_ncell_monitor_timer(void);

/*===========================================================================
FUNCTION l1_sc_deinit_ncell_monitor_timer

DESCRIPTION
  undefines the ncell monitor shutdown timer
===========================================================================*/
void l1_sc_deinit_ncell_monitor_timer(void);
...
void l1_sc_gsm_l1_set_ecio_rssi_levels( uint16 qsearch_W, uint16 qsearch_L, uint16 ecode_both  );

extern l1_sc_globals_T* gl1_ms_switch_l1_sc_globals_store(void);

extern void l1_set_serving_RLA_C(dBx16_T local_serving_RLA_C);
extern dBx16_T l1_get_serving_RLA_C(void);
extern void l1_sc_start_wcdma_receive(void);
extern void l1_sc_stop_wcdma_receive(void);
extern boolean l1_sci_monscan_meas_in_progress(void);

/* moved for G2L */
uint8 l1_sc_get_tch_idle_frame(void); 

void l1_isr_G2L_trigger(void);

void L1_G2X_terminate(void);

boolean l1_is_rf_device_irat_compatable(void);

void    l1_isr_G2L_idle_trigger(void);
...
#define GL1_MSGR_SET_HDR_INST(hdrPtr,in_gas_id)  \
                                  { \
                                      sys_modem_as_id_e_type ginst_id = GERAN_ACCESS_STRATUM_ID_1 ; \
...
/*
** Used for LTE messages to set inst_id from as_id from  0=0=0
*/
...
boolean gl1_sc_irat_is_lte_active(void);
...
#endif  /* FEATURE_GSM_TO_LTE */
#if defined(FEATURE_WCDMA) || defined(FEATURE_GSM_TDS) || defined(FEATURE_LTE)
uint16   l1_sc_find_freq_index( uint32 findArfcn , rr_l1_irat_rat_e findRat , boolean anyIndexForRat );
#endif
void gl1_check_if_irat_state_stuck(void);

boolean  g2x_irat_cnf_pending(void);
