...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_smscb.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
DESCRIPTION
         Only used for Dual SIM/Dual data space.  
...
===========================================================================*/
extern void gl1_ms_switch_l1_cbch_info(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_init(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_process_deactivate_info( cb_channel_ind_type chan_ind );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_cb_supported( boolean val );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_chan_type( channel_type_T chan );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern channel_type_T l1_smscb_get_chan_type(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_smscb_cbch_expected( uint32 fn );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern uint32 l1_smscb_gap_to_next_activity(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_smscb_decoding_basic_cbch(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_smscb_decoding_extended_cbch(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_decoding_extended_cbch( boolean val );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_decoding_basic_cbch( boolean val );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern uint32 l1_smscb_get_cbch_fn(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_arfcn( ARFCN_T arfcn );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_bsic( uint8 bsic );
...
SIDE EFFECTS:
  None
===========================================================================*/
extern ARFCN_T l1_smscb_get_arfcn(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern uint8 l1_smscb_get_bsic(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_smscb_is_active(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_reset_schedule_info(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_send_deferred_expiry_ind(void);
#endif /* FEATURE_GSM_CB_DRX_SUPPORTED */
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void l1_smscb_set_first_non_drx_block_read(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern boolean l1_smscb_use_high_priority(void);
#endif /* FEATURE_DUAL_SIM | FEATURE_TRIPLE_SIM */
