...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_gprs_if_g.h#4 $

when       who      what, where, why
--------   -------- ---------------------------------------------
05/07/19   sk       CR2483710 Ensure no duplication of control bocks in the UL
...
extern gpl1_gprs_ta_T l1_get_gpl1_gprs_ta_info (void);
extern void l1_set_gpl1_gprs_ta_info (gpl1_gprs_ta_T gpl1_gprs_ta_info );

void gpl1_gprs_L1_params_pending(IMH_T *msg_header);
void gpl1_gprs_update_L1_params(void);
void gpl1_gprs_calc_rf_pwr(void);


#ifdef FEATURE_GSM_DTM
dtm_tbf_type_t get_queued_mac_l1_edtm_cs_rel_tbf_alloc(void);
void set_queued_mac_l1_edtm_cs_rel_tbf_alloc(dtm_tbf_type_t tbf_type_t  );
#endif /* FEATURE_GSM_DTM */
...
extern ARFCN_T* l1_get_gprs_arfcns (void);
extern ARFCN_T  l1_get_gprs_arfcns_value ( uint8 index_t   );
extern boolean                      aquiring_psi;

extern boolean  l1_get_aquiring_psi( void );
extern boolean  l1_get_ext_page_blk_flag( void );
extern gpl1_gprs_tm_b_store_t gpl1_gprs_tm_b_store;
...
extern void l1_xmsi_copy_params(xmsi_params_T *xmsi_ptr_t  );
