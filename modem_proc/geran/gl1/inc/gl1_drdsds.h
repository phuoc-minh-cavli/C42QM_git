...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_drdsds.h#2 $
...
===========================================================================*/
void gl1_drdsds_set_hybrid_tuneaway_state(void  );
void gl1_drdsds_hybrid_tuneaway_trigger(gl1_drdsds_hybrid_tuneaway_event event, 
										gl1_drdsds_hybrid_tuneaway_msg *msg
										 );
void gl1_drdsds_handle_idle_init_event(void );
void gl1_drdsds_handle_blk_quality_ind_event(mph_block_quality_ind_T *msg
											  );
void gl1_drdsds_handle_dsc_threshold_ind_event(void );
void gl1_drdsds_process_blk_ind_tuneaway_mode(void );
...
void gl1_drdsds_process_dsc_ind_tuneaway_mode(void );
void gl1_drdsds_process_dsc_ind_dual_rx_tuneaway_mode(void );
void gl1_drdsds_process_dsc_ind_lp_mode(void );
void gl1_drdsds_process_dsc_ind_hp_mode(void );
