...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_sys_params.h#4 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
21/05/19   sk      CR2455656 Schedule 6 mons per frame in pscan
01/04/19   sk      CR2425255 Revert Track-B changes
30/08/18   sk      CR2306026 Schedule 6 mons per frame during power scan for Chiltepin pre sil testing
...
#else
#define SYS_PARAM_NUM_MEASUREMENTS_PER_FRAME_PSCAN     (6)
