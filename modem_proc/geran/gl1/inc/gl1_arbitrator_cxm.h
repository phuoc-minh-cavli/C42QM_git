...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_arbitrator_cxm.h#2 $
...
===========================================================================*/
void garb_cxm_register_priority_table_callback(void );
...
===========================================================================*/
void garb_cxm_deregister_priority_table_callback(void );
...
===========================================================================*/
void garb_cxm_arfcn_indication(ARFCN_T* arfcns, uint8 num_arfcns, cxm_tech_link_direction direction, boolean register_bands  );
...
===========================================================================*/
void garb_cxm_notify_freqid_list(cxm_freqid_info_ind_s* msg  );
...
===========================================================================*/
void garb_cxm_power_indication(void );
...
===========================================================================*/
void garb_cxm_band_avoid_pwr_ind(void );
...
===========================================================================*/
void garb_cxm_activity_timeline_indication(void );
...
===========================================================================*/
uint8 garb_cxm_get_arfcn_count_ul_arfcn_table(void );
...
===========================================================================*/
void garb_cxm_set_slot_activity_timeline(void );
...
===========================================================================*/
void garb_cxm_notify_request_activity_info(cxm_request_activity_info_s* cxm_request_activity_info  );
...
===========================================================================*/
cxm_channel_out_type garb_return_cxm_channel_id(  void  );
...
===========================================================================*/
uint32 garb_cxm_get_prio_from_activity_tier(cxm_activity_type tier  );
...
===========================================================================*/
uint32 garb_cxm_get_freqid(ARFCN_T arfcn, garb_rxtx_t rxtx  );

#ifdef FEATURE_WLAN_COEX_SW_CXM
void garb_cxm_reset_coex_active_policy( void  );
void garb_cxm_coex_active_policy(cxm_coex_active_policy_ind_s* msg  );
void garb_cxm_reset_coex_metrics( void  );
void garb_cxm_coex_metrics_req(cxm_coex_metrics_req_s* msg );
uint32 garb_cxm_coex_metrics_alpha( void  );
void garb_cxm_fw_priority_fail_report( GfwWlanCxmConfigRsp* config_rsp  );
void garb_cxm_send_sleep_duration( boolean sleep, uint32 duration );
void garb_cxm_high_priority_event_ind( uint32 start_fn, uint32 frames_required, cxm_high_prio_oper_e op_id  );
#endif
