...
void gpl1_gprs_reset_pending_ta_params(void     );

void gpl1_gprs_swap_dl_cont_ta_to_ul( void );

void gpl1_gprs_swap_ul_cont_ta_to_dl(void );

void gpl1_gprs_setup_cont_ta_params(void );
...
void gpl1_gprs_schedule_ptcch_rx(void     );

void gpl1_gprs_update_ptcch_ftn (
     gl1_msg_frame_tick_type  *ftn
     );

boolean gpl1_gprs_timing_advance_valid(void     );

boolean  gpl1_gprs_find_next_tai_during_suspension
         ( uint32 tbf_suspend_start,
           uint32 tbf_suspend_end );

uint8 gpl1_gprs_get_global_ta_timeslot(void);

boolean gpl1_gprs_get_ptcch_snr_status(void   );

boolean gpl1_gprs_get_ptcch_snr_valid(void     );

void gpl1_gprs_reset_ptcch_snr_valid(void     );
 ...
 * NPL1 handlers.
 */
void  gpl1_gprs_ptcch_set_lowest_dl_timeslot( uint8  timeslot );

/* This function enables the ptcch module to take into
 * account the new lowest downlink timeslot in future
 * rx\tx activities.
 */
void  gpl1_gprs_ptcch_reconfig(void);


#ifdef FEATURE_GSM_COEX_SW_CXM
boolean gpl1_check_if_ptcch_scheduled(uint32 FN,uint8 *ptcch_tn,boolean *dirn);
#endif /* FEATURE_GSM_COEX_SW_CXM */

#ifdef FEATURE_GPRS_GBTA
boolean gpl1_gprs_is_ptcch_active(void);
...
===========================================================================*/
boolean gpl1_is_pdtch_snr_bad(void);
/*===========================================================================
...
===========================================================================*/
void gpl1_reset_pdtch_snr_variables(void);
