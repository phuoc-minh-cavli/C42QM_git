...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_gprs_test.h#2 $
...
===========================================================================*/
extern boolean gpl1_gprs_get_rlc_loop_data(grlc_ul_fifo_access_block_t   *rlc_config_params_t );
...
===========================================================================*/
extern void gpl1_gprs_get_loop_ul_data(void);
...
===========================================================================*/
extern uint8 gpl1_gprs_is_rlc_dl_data_disc(gl1_defs_tn_type rx_tn_t );
...
===========================================================================*/
extern void gpl1_gprs_setup_test_B(void);
