...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_grm_intf.h#3 $
$DateTime: 2018/10/17 02:31:04 $ $Author: pwbldsvc $
...
/*helper functions*/
trm_reason_enum_t grm_gl1_get_current_trm_reason(void);

void grm_gl1_set_current_trm_reason(trm_reason_enum_t reason);

boolean grm_gl1_get_dr_status(void);
...
===========================================================================*/
void  grm_denied_arfcn_processing (ARFCN_T *arfcn, uint32 count, grm_persistent_denial_sm_actions_t action);
#endif
/*===========================================================================
...
extern boolean grm_persistent_denial_monitoring(  grm_persistent_denial_sm_actions_t action);
...
extern timetick_type grm_get_acquisition_duration( );
...
boolean grm_send_trm_band_registration_start(const trm_band_t band, gl1_sc_activities_t sc_activity, uint32 frames_required,   grm_info_t *info_ptr);

boolean grm_check_idle_sc_activity_ok(l1_fm_priority_T pri,   uint32 frames_required, uint32 reserved_fn);
...
void grm_register_aps_info(void);

extern void grm_reserve_at_gts( int32 wup_duration, uint32 wakeup_fn );
extern boolean gl1_check_trm_grm_reasons_match( );

extern void gl1_update_grm_reservation_for_ta( );

extern void gpl1_multi_sim_setup_afc_tt( );

extern void grm_request_at_warmup( );
...
extern void gl1_msim_reset_reserve_at_count( );
...
boolean grm_is_denied_band(const sys_band_T band );

void grm_set_device_configuration( );
boolean grm_device_config_is_drdsds( void );

/*---Power Monitor Circular FIFO Queue Management Functions---*/
void pm_activity_queue_init( );
int8 pm_activity_add_to_buffer (boolean valid );
grm_sc_activity_state_info_t* pm_activity_remove_from_buffer( );
void pm_activity_band_release(boolean flush );
