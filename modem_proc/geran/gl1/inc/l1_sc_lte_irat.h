...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_sc_lte_irat.h#3 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
void   g2l_schedule_idle_lte_search(void);
...
void    l1_sc_populate_g2l( uint16 freq_idx, lte_cphy_irat_meas_timed_srch_meas_req_s *msg,   boolean gap_start_asap);
uint16  l1_sc_cm_g2l_state( g2l_cm_events_e gapEvent , uint16 freq_idx , boolean gapBool);

void    g2l_init_cm(void);
void    g2l_set_cm_inactive(void);

void    l1_sc_idle_g2l_state( g2l_idle_events_e gapEvent);
void    l1_isr_G2L_idle_trigger(void);
void    l1_sci_g2l_idle_aborted( void* dummy);
void    l1_sc_set_ml1_init(boolean in_ml1_init);
void    l1_sc_start_G2L_timed_search(void);
void    l1_sc_g2l_init(void);
