...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_arbitrator_detect.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
===========================================================================*/
void garb_detect_and_resolve_rx_conflicts(garb_frame_t* frame, uint8 ts  );
...
===========================================================================*/
void garb_detect_and_resolve_tx_conflicts(garb_frame_t* frame, uint8 ts  );
...
===========================================================================*/
boolean garb_detect_and_resolve_monitor_conflicts(void );
...
===========================================================================*/
void garb_append_frame_to_timeline(garb_frame_t *frame, uint8 index );
...
===========================================================================*/
boolean garb_get_frame(uint32 fn, garb_frame_t* frame );
