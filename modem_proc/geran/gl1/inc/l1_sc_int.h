...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_sc_int.h#5 $
...
02/01/17   sn        CR1117218 Stop SCE only if it is in active state
...
gpl1_gprs_meas_mode_T* gl1_ms_switch_meas_mode_data(void);
...
===========================================================================*/
void         l1_sc_init(void);
void         l1_sc_shutdown(void);
void         l1_sc_start( l1_sc_mode_T mode );
void         l1_sc_stop(void);
void         l1_sci_go(void);
void         l1_sci_tick_idle(void);
void         l1_sci_post_tick_idle(void);
void         l1_sci_tick_dedi_sdcch( uint32 available_frames, boolean stopping );
void         l1_sci_tick_dedi_tch(void);
void         l1_sci_paging_block_tick(void);
boolean      l1_sci_check_ok_to_sleep( uint32 gap_to_next_activity );

void         l1_sc_wcdma_init(void);
void         l1_sc_wcdma_set_mode(boolean gsm_only );
...
void         l1_sci_start_wcdma_srch(void);
void         l1_sc_wcdma_enter_dedi(void);
void         l1_sc_wcdma_leave_dedi(void);
boolean      l1_sc_wcdma_ded_pending(void);
boolean      l1_sc_wcdma_ded_ready(boolean high_priority_only);
void         l1_sc_wcdma_ded_tick(boolean srch_pending, boolean srch_scheduled);
void         l1_sc_wcdma_sdcch_tick(void);
void         l1_sc_wcdma_abort_ded_search(void);
#if defined(FEATURE_WCDMA) || defined(FEATURE_GSM_TDS) || defined(FEATURE_LTE)
void         L1_send_MPH_SURROUND_WCDMA_DED_MEAS_IND( word num_cells,
                                                      wcdma_dedicated_meas_T cells[]);
#endif /* FEATURE_WCDMA || FEATURE_GSM_TDS || FEATURE_LTE */
void         l1_sc_wcdma_ded_tick_abort_stuck_srch(void);

void         l1_sc_wcdma_enter_xfer(void);
void         l1_sc_wcdma_leave_xfer(void);
boolean      l1_sc_wcdma_xfer_pending(void);
boolean      l1_sc_wcdma_xfer_ready(boolean high_priority_only);
void         l1_sc_wcdma_xfer_tick(boolean wcdma_srch_pending,
                                   boolean wcdma_srch_scheduled );
...
void         l1_sc_wcdma_abort_xfer_search(void);
boolean      l1_sc_is_sce_running(void);




void         l1_sc_wcdma_set_paging_multiframes(uint16 pg_mfrms );
boolean      l1_sc_get_wcdma_list_update_inprogress(void);
void         l1_sc_set_wcdma_list_update_inprogress(boolean update_inprogress   );
#if defined(FEATURE_WCDMA) || defined(FEATURE_GSM_TDS) || defined(FEATURE_LTE)
void         l1_sc_wcdma_update_list( mph_wcdma_cell_update_list_req_T* msg );
void         l1_sc_wcdma_ignore_neighbors( mph_ignore_wcdma_neighbors_req_T* msg );
boolean      l1_sc_wcdma_get_best_six( best_six_wcdma_info_T* best_six);
#endif /* FEATURE_WCDMA || FEATURE_GSM_TDS || FEATURE_LTE */
void         l1_sc_wcdma_enter_idle(void);
boolean      l1_sc_wcdma_leave_idle(void);
void         l1_sc_wcdma_receive( void ( *done )( void* ) );
void         l1_sci_tick_wcdma(void);
void         l1_sci_post_tick_wcdma(void);
/* CR 349239*/
void         l1_sci_tick_sched_reconfim(void);

uint8        l1_sc_get_tch_idle_frame(void);
l1_sc_mode_T l1_sc_get_curr_mode(void);

void         l1_sc_set_rat_change_active( boolean active);
boolean      l1_sc_get_rat_change_active(void);
void         l1_sc_irat_abort_g2w_reconfirm_gap(void);
boolean      l1_sc_g2x_sdcch_inprogress(void);
...
===========================================================================*/
extern boolean l1_sc_wcdma_srch_active(void);
...
===========================================================================*/
extern boolean l1_sc_ncell_pch_low_monitor_active(void);

void         l1_sc_wcdma_receive_id_in_tbf( void ( *done)(void*) );
void         l1_sci_tick_wcdma_id_in_tbf( uint32 available_frames );
void         l1_sc_wcdma_abort_id_tbf(void);
boolean      l1_sc_wcdma_start_id_in_tbf(void);

#ifdef  FEATURE_GSM_TO_LTE
boolean l1_sc_g2l_timed_search_active(void);
#endif /* FEATURE_GSM_TO_LTE */

#ifdef FEATURE_G2X_TUNEAWAY
boolean l1_sc_wcdma_id_searching_in_tbf(void);
void l1_print_sc_wcdma_id_searching_state(void);
#endif /* FEATURE_G2X_TUNEAWAY */
boolean      l1_sci_wcdma_paging_block_tick(void);
#ifdef FEATURE_GPRS_GBTA
void         l1_sci_paging_block_gbta_tick(void);
#endif /* FEATURE_GPRS_GBTA */
void         l1_scdrv_wcdma_idle_meas_ind(void);
boolean      l1_sci_is_wcdma_ready( uint32 gap_to_next_activity );
void         l1_sci_wcdma_abort_reconfirm(void);

void         l1_sci_monscan_do_idle( uint8 num_meas, uint8 meas_per_frame );
void         l1_sci_monscan_do_ded( uint8 num_meas, uint8 meas_per_frame, boolean monscan_ded_tch_mode );
void         l1_sci_monscan_go(void);

void         l1_sc_set_paging_multiframes( word paging_multiframes );
void         l1_sc_set_ba_list( inter_task_BCCH_allocation_T* ba_list, byte ncc_permitted );
void         l1_sc_set_sync( uint32 frame_decrease, int16 qbit_decrease );
void         l1_sc_ba_cell_set_sync( l1_sc_bs_T *bs, uint32 frame_decrease, int16 qbit_decrease );
void         l1_sc_balist_gprs_set_sync( boolean ts_reconfig );
void         l1_scdrv_mon_ind(void);
void         gl1_set_ncell_block_start( boolean value );
boolean      gl1_is_ncell_block_start(void);
void         gl1_set_pwr_meas_block_start( boolean value );
boolean      gl1_is_pwr_meas_block_start(void);
boolean      l1_sci_is_op_in_progress(void);

void         l1_running_avg_init( running_avg_struct *ra_ptr, dBx16_T *buf, uint8 buf_len );
void         l1_running_avg_set_avg_len( running_avg_struct *ra_ptr, uint8 avg_len );
void         l1_running_avg_add_meas( running_avg_struct *ra_ptr, dBx16_T meas);
...
void         l1_running_avg_stuff_buf( running_avg_struct *ra_ptr, dBx16_T power );
dBx16_T      l1_running_avg_get_last_meas( running_avg_struct *ra_ptr );
void         l1_running_avg_sanity_check_meas_buf( running_avg_struct *ra_ptr );
#ifdef FEATURE_IDLE_DRX_SCALING
void         l1_running_avg_clear_all_meas(void);
boolean      l1_check_is_sc_in_idle(void);
#endif /* FEATURE_IDLE_DRX_SCALING */
void         l1_sci_monscan_do_rxlev_trans( uint8 num_meas, uint8 meas_per_framet );
void         l1_sc_monscan_abort_gprs(void);
...
void         gpl1_gprs_update_bcch_stop(boolean send_ind);

#ifdef FEATURE_GPRS_GBTA
boolean l1_sc_check_idle_mon_allowed(void);
boolean l1_sc_get_monscan_active(void);
#endif /* FEATURE_GPRS_GBTA */
boolean l1_sci_meas_in_progress(void);
boolean l1_sci_is_op_in_progress_gbta(void);

#ifdef FEATURE_GSM_TDS
boolean l1_sc_tds_irat_in_idle_frame(void);
void l1_sc_tds_irat_in_idle_frame_clear(void);
#endif
...
===========================================================================*/
void l1_sci_trm_blocked_inc_wcdma_page_cycle_tick(void);
#endif /* ( FEATURE_DUAL_SIM | FEATURE_TRIPLE_SIM ) && FEATURE_WCDMA */

#if defined(FEATURE_WCDMA) || defined(FEATURE_GSM_TDS) || defined(FEATURE_LTE)
void    l1_sc_specific_irat_freq_update(mph_specific_irat_freq_update_req_T *pMsg);
#endif /* FEATURE_WCDMA || FEATURE_GSM_TDS || FEATURE_LTE */
void    l1_sc_forced_meas_expiry(void);
...
void    l1_sc_update_sorted_ba_list( boolean include_serving );
void    l1_sc_config_reduced_ncell_list_rr( boolean reduced_ncell_list_en );
void    l1_sc_set_bmask_reduced_ncell_list( uint8 reduced_ncell_bmask );
void    l1_sc_clear_bmask_reduced_ncell_list( uint8 reduced_ncell_bmask );
void    l1_sci_set_bmask_reduced_ncell_list( uint8 reduced_ncell_bmask );
void    l1_sci_clear_bmask_reduced_ncell_list( uint8 reduced_ncell_bmask );
#endif /* #ifdef FEATURE_GSM_SCE_REDUCED_NCELL_LIST */

#ifdef FEATURE_GSM_SCE_REDUCED_NCELL_LIST_DEBUG
void    l1_sc_balist_print_running_avg(void);
#endif
