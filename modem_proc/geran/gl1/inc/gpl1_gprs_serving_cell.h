...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_gprs_serving_cell.h#2 $
...
extern void     gpl1_egprs_scell_interf_meas_config( uint8  link_qual_meas_mode );
extern uint8  gpl1_egprs_meas_scale( const uint32  *log_scale_ptr,
                                     uint32         target_measurement );

extern void     gpl1_gprs_scell_disable_int_meas( gl1_defs_tn_type  ul_timeslot);

extern void     gpl1_gprs_serv_cell_int_cb( gl1_defs_int_meas_result_type *int_meas_results  );
...
extern boolean  gpl1_gprs_serving_cell_meas( l1_mode_command_T          mode  );

extern void     gpl1_gprs_build_quality_report(void);

/* Methods to access/change the EGPRS quality measurements in the
 * scell measurements structure.
 */
extern void  gpl1_egprs_scell_qual_meas_broadcast_config( uint8               bep_period  );

extern void  gpl1_egprs_scell_qual_meas_pacch_config( uint8  link_qual_meas_mode,
	                                                  uint8  new_dl_timeslot_alloc,
	                                                  uint8  bep_period2 );

extern void  gpl1_egprs_scell_qual_meas_nv_item_config( boolean              gcf_item_set);
...
extern void  gpl1_egprs_serv_cell_qual_meas_reset(void);
...
extern void  gpl1_egprs_search_qual_meas_queue( uint8            dl_timeslot_alloc);

extern void  gpl1_egprs_empty_qual_meas_queue(void);

extern dBx16_T*   gpl1_gprs_get_serv_cell_meas_buf(void);
extern gpl1_egprs_qual_meas_queue_T*   gpl1_gprs_get_serv_cell_head_ptr(void);
