...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_arbitrator_types.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
typedef void (*garb_get_arfcns_t)(int16, uint16, uint16, ARFCN_T*_t);
