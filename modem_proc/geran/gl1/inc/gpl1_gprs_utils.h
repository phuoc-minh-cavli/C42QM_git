...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_gprs_utils.h#2 $

when       who      what, where, why
--------   -------- ---------------------------------------------
16/01/17   sn       CR1111891 FR 36703: Rel.13 GERAN Power Efficient Operation (PEO) Transfer mode changes
...
===========================================================================*/
void gpl1_gprs_calculate_arfcns(ARFCN_T arfcns[4], frequency_information_T *channel_data, uint8 mode );
...
===========================================================================*/
boolean gpl1_gprs_adjust_51_starting_time( uint32*  start_time_ptr  );
...
#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION
  G2X_TA_WAIT_FOR_DSP_IDLE,
  G2X_TA_WAIT_FOR_SLEEP,
  G2X_TA_WAIT_FOR_WAKEUP_FN,
  G2X_TA_DISABLE_SCHED_RX_TX,
#endif
...
boolean gpl1_g2x_ta_update_table_field( gpl1_g2x_ta_priority_t pri, trm_client_enum_t client_id, uint32 frame_number, uint16 duration );
boolean gpl1_g2x_ta_cancel_table_field( gpl1_g2x_ta_priority_t pri );
boolean gpl1_g2x_ta_suspend_table_field( gpl1_g2x_ta_priority_t pri );
boolean gpl1_g2x_ta_is_suspension_ongoing(  gpl1_g2x_ta_priority_t *pri_ongoing);
boolean gpl1_g2x_ta_is_activty_running(gpl1_g2x_ta_priority_t *pri_ongoing);
boolean gpl1_g2x_ta_stop_all_act(void); 
void gpl1_g2x_ta_data_init(void);
void gpl1_g2x_ta_debug_table(void);

void gpl1_g2x_ta_scheduler(void);
gpl1_g2x_ta_priority_t gpl1_g2x_ta_fire_sequencer(void);
boolean gpl1_g2x_ta_set_ongoing(gpl1_g2x_ta_priority_t pri );
boolean gpl1_g2x_ta_reset_ongoing(void);
boolean gpl1_g2x_ta_abort(gpl1_g2x_ta_abort_reason_t reason_abort );


boolean gpl1_g2x_ta_suspend_all_table(void);
boolean gpl1_g2x_ta_next_planned_suspension(uint32 *suspension_fn, uint32 *resume_fn );
boolean gpl1_g2x_ta_is_act_planned(gpl1_g2x_ta_priority_t pri );
boolean gpl1_g2x_ta_is_TS_act_imminent(void);
void gpl1_gprs_ds_init_pch_suspension(void);
boolean gl1_is_geran_tuneaway_allowed(void);
extern gas_id_t gl1_get_gas_id_for_ptm_client( void );


gpl1_g2x_ta_act_status_t gpl1_g2x_ta_get_act_status(gpl1_g2x_ta_priority_t pri );

#ifdef FEATURE_G2X_TUNEAWAY
boolean gpl1_g2x_ta_are_act_colliding(gpl1_g2x_ta_priority_t pri1, gpl1_g2x_ta_priority_t pri2 );
