...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gpl1_dual_sim.h#3 $
$DateTime: 2019/07/24 11:27:26 $ $Author: pwbldsvc $

when       who       what, where, why
--------   --------  ----------------------------------------------------------
07/24/19   sal       CR2494014  If it's rude wake up then skip scheduling any command to FW in this frame.
25/05/12   nm        CR1010494 Correct featurization for PCHXFER to work when FEATURE_DUAL_SIM is not defined
...
boolean  gl1_set_gfw_to_active(void);

boolean gl1_detect_page_collision_with_other_sub(void);

#if defined FEATURE_QBTA
boolean gl1_check_qbta_allowed(void);
#endif
trm_client_enum_t gl1_get_client_id_of_other_sub_in_transfer(void);
...
===========================================================================*/
void l1_isr_multi_sim_find_bcch(void);
...
===========================================================================*/
void l1_isr_multi_sim_null(void);
...
===========================================================================*/
void l1_isr_multi_sim_idle(void);
/*===========================================================================
...
===========================================================================*/
void l1_isr_multi_sim_decoupled(void);
/*===========================================================================
...
===========================================================================*/
void l1_isr_handle_multi_sim_find_sch_command(void);
...
===========================================================================*/
void l1_isr_handle_multi_sim_find_bcch_command(void);
...
===========================================================================*/
void l1_init_multi_sim_data(void);
...
SIDE EFFECTS
===========================================================================*/
void l1_swap_multi_sim_sync_state_or_deactivate(void);
...
SIDE EFFECTS
  None
===========================================================================*/
void call_in_task_multi_sim_panic_reset(void);
...
===========================================================================*/
void call_in_task_gplusg_deactivate(void);
...
===========================================================================*/
void l1_set_global_override_trm_reason( trm_reason_enum_t reason );
...
===========================================================================*/
trm_reason_enum_t l1_get_global_override_trm_reason(void);
...
===========================================================================*/
void l1_clear_global_override_trm_reason(void);
...
===========================================================================*/
void gl1_multi_sim_fw_rf_load( trm_client_enum_t client_id);
...
boolean gpl1_gprs_get_gta_config(void);
boolean gpl1_gprs_is_this_the_active_tbf_id(void);
boolean gl1_page_collision_with_x_sub( trm_client_enum_t client,l1_fm_priority_T priority  );
...
===========================================================================*/
void gpl1_gprs_handle_multi_sim_idle(IMH_T *msg_header);
...
===========================================================================*/
void l1_ds_isr_inactive_mode(void);
...
===========================================================================*/
void L1_send_PH_RANDOM_ACCESS_CNF_with_result( const geran_result_t rach_result);
...
===========================================================================*/
void gl1_ms_switch_multi_sim_data(void);
...
===========================================================================*/
boolean gpl1_multi_sim_bplmn_decode_bcch_inactive(void);
...
===========================================================================*/
void l1_multi_sim_bplmn_abort ( void* dummy );
...
===========================================================================*/
background_hplm_state_t gpl1_get_multi_sim_bplmn_state(void);

int8 gl1_check_num_active_G_subs( void );
extern boolean l1_get_starting_time_elapsed(void);
extern void l1_set_starting_time_elapsed( boolean );
extern void l1_set_access_isr_send_mac_sb_failure( boolean value );
/* EXTERNS used in gpl1_dual_sim.c */
extern void gl1_load_current_cell_data(void);
extern void gl1_begin_INTERRAT_Reconnect(void);
...
extern grm_gbta_info_t grm_gbta_info;
...
#define CHECK_ANY_OTHER_GSM_CLIENT_IS_INACTIVE() \
( gl1_check_any_other_subs_l1_state(  L1_INACTIVE_MODE ) )

#define CHECK_ANY_OTHER_GSM_CLIENT_IS_GOING_ACTIVE() \
( gl1_check_any_other_subs_active_state() )

#define GBTA_ALLOWED_CAN_BE_SET() \
( !gl1_check_all_other_subs_l1_state(  L1_INACTIVE_MODE ) )



#define OTHER_GSM_CLIENT_IN_TRANSFER() \
( gl1_check_any_other_subs_l1_state( L1_TRANSFER_MODE))


#define OTHER_GSM_CLIENT_IN_PACKET_ACCESS() \
( \
  (l1_transfer_data[()].current_alloc_type == L1_SINGLE_BLOCK_ALLOC) \
)
...
#define IS_SUB_LEAVING_IDLE() \
(\
  grm_gbta_info.leaving_idle_mode \
)
...
#define IS_IDLE_EV_PWR_MON_ACTIVE() \
  (grm_gbta_info.idle_event_status == GBTA_STATUS_PWR_MON_ACTIVE)


#define IS_IDLE_EV_PWR_MON_SCHEDULED() \
  (grm_gbta_info.idle_event_status == GBTA_STATUS_PWR_MON_SCHEDULED)

#define IS_IDLE_EV_PWR_MON_SET() \
  (grm_gbta_info.idle_event == GBTA_EV_IDLE_PWR_MON)
...
#define OTHER_SUB_START_SC_TICK_TRANS() \
(gpl1_start_sc_tick_trans())

#define OTHER_SUB_STOP_SC_TICK_TRANS() \
( gpl1_stop_sc_tick_trans())

#define OTHER_SUB_SC_OP_IN_PROGRESS() \
(gl1_check_other_sub_sc_op_progress())

#define OTHER_SUB_WCDMA_ID_SEARCHING_IN_TBF() \
(gl1_check_other_sub_id_search_progress( ))

#ifdef FEATURE_GSM_TDS
#define OTHER_SUB_TDS_IRAT_IN_IDLE_FRAME() \
(gl1_check_other_sub_tds_irat_progress( ))
#endif

#define OTHER_SUB_NCELL_MEAS_IN_PROGRESS() \
...
#define OTHER_SUB_SUSP_PLANNED() \
(gl1_other_sub_check_tbf_susp_planned())

#define OTHER_SUB_MISSED_LAST_PAGE() \
(gl1_other_sub_check_missed_page())

#define SET_MISSED_PAGE_STATUS(missed_page_status) \
(\
  (grm_gbta_info.missed_page = missed_page_status) \
)

#define OTHER_G_SUB() \
(gl1_get_gas_id_of_other_g_sub())

#define OTHER_G_SUB_IN_TRANSFER() \
(gl1_get_gas_id_of_other_g_sub_in_transfer())

/* GBTA Assocaited Functions */

void grm_notify_event(grm_gbta_idle_event_t event,boolean leaving_idle );
boolean gl1_gbta_schedule_idle_pwr_mon_if_allowed(void);
void    gl1_gbta_scheduling_idle_event(grm_gbta_idle_event_t event);

gas_id_t gl1_gbta_get_transfer_sub(void);
boolean gl1_is_gbta_reason(trm_reason_enum_t reason);
void    gpl1_gbta_schedule_idle_pwr_mon(void);
boolean gl1_gbta_check_gbta_allowed(trm_reason_enum_t req_reason,uint32 frames_required);
boolean gpl1_check_no_transfer_sub_conflict(uint32 frames_req);

boolean gl1_gbta_schedule_idle_per_mon_if_allowed(void);
boolean gpl1_gbta_check_tbf_susp_planned(void);
void    gpl1_gbta_reset_active_state(void);
...
boolean gpl1_g2x_ta_is_ts_change_missed(void);
boolean gpl1_g2x_ta_is_seq_registered_not_G(void);

#ifdef  FEATURE_GSM_GPRS_READ_CCCH_IN_XFER
void gl1_trans_grm_reserve_at_self_ccch( uint32 required_frame_nbr,byte page_mode );
...
boolean grm_send_trm_band_registration_start(const trm_band_t band, gl1_sc_activities_t sc_activity, uint32 frames_required_t   grm_info_t *info_ptr);

boolean grm_check_idle_sc_activity_ok(l1_fm_priority_T pri_t  uint32 frames_required, uint32 reserved_fn);
...
boolean grm_check_w_t_reconf_in_pg_block_ok(   uint32 frames_required, uint32 freq_index);

boolean grm_check_ptm_irat_sc_activity_ok(   uint16 freq_offset,  uint32 frames_required);

boolean grm_check_ptm_ncell_sc_activity_ok(sys_band_T sc_band, gl1_sc_activities_t sc_activity_t  uint32 frames_required);
...
extern void gl1_update_grm_reservation_for_ta(void);

extern void gpl1_multi_sim_setup_afc_tt(void);

extern void grm_request_at_warmup(void);
...
extern void grm_setup_access_retry(  boolean pending_gl1_event, ps_access_mode_t access_for_ps);

uint32 l1_bcch_current_bcch_fn(void);
...
extern trm_resource_enum_t gl1_ms_get_trm_resource(  trm_reason_enum_t reason);

extern boolean gl1_is_any_sub_in_transfer( void );

extern boolean gl1_check_any_subs_l1_state( byte l1_state );
extern boolean gl1_check_any_other_subs_l1_state(   byte l1_state );
boolean gl1_check_any_other_sub_using_trm_global_overide(void);
extern boolean gl1_get_trm_global_overide_status(void);

trm_client_enum_t  gl1_get_client_id_of_other_idle_sub(void);
trm_reason_enum_t gl1_get_reserve_reason(void);

extern boolean gl1_check_any_other_subs_active_state(void);

#ifdef FEATURE_GPRS_GBTA
extern boolean gl1_check_any_other_subs_idle_evt_power_mon(  *idle_gas_id_ptr );
extern void gl1_set_idle_event_status( grm_gbta_idle_event_status_t ev_stat  );
extern boolean gl1_check_other_subs_idle_event_status(grm_gbta_idle_event_status_t stat , *idle_gas_id_ptr);
...
extern boolean gl1_other_sub_check_missed_page(void);
extern boolean gl1_check_all_other_subs_l1_state(   byte l1_state  );
extern boolean gl1_check_gonly_mode_active( void );
extern boolean gl1_is_own_gbta_active(void);
#endif

extern boolean gl1_check_any_other_subs_fw_load(void);
...
extern boolean gl1_check_any_other_client_has_lock(void);
extern boolean l1_sc_wcdma_get_gsm_only_mode(void);

extern gas_id_t gl1_get_gas_id_of_other_g_sub(void);
extern gas_id_t gl1_get_gas_id_of_other_g_sub_in_transfer(void);

extern uint8 grm_num_clashing_subs( void );
extern uint8 gl1_get_num_inactive_subs( void );
extern gas_id_t gl1_get_gas_id_of_other_idle_sub(void);
extern boolean gl1_check_any_other_sub_in_bg_traffic(void);
background_hplm_state_t gl1_ms_background_hplmn_state(void);


void gl1_multi_sim_reset_trm_request_state(void);
extern boolean gl1_check_qta_active_in_warmup(void);

void gpl1_grm_reserve_rx_sec(  trm_time_t *when, trm_duration_t *duration, trm_reason_enum_t *reason);
void gpl1_grm_release_rx_sec(void);
void gpl1_grm_request_rx_sec(  trm_duration_t *duration, trm_grant_return_enum_type *trm_event, boolean init_start);

boolean gl1_check_if_getting_deactivated(void);
...
trm_reason_enum_t gl1_get_global_trm_reason(void);

#if defined(FEATURE_SGLTE_DUAL_SIM) || defined(FEATURE_SVLTE_DUAL_SIM)
void l1_handle_device_mode_cause_plmn( void );
#endif
...
===========================================================================*/
void grm_set_data_sub_priority(geran_priority_t priority);
...
===========================================================================*/
geran_priority_t grm_get_data_sub_priority(void);
...
void L1_send_UNKNOWN_CCCH_MPH_BLOCK_QUALITY_IND(void);
extern boolean gl1_check_possible_isr_overrun(void);
