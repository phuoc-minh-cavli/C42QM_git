...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_sys_algo.h#3 $ $DateTime: 2019/03/07 08:05:30 $ $Author: pwbldsvc $
...
===========================================================================*/
dBx16_T sys_algo_agc_average_output(dBx16_T agc_output );
...
===========================================================================*/
void sys_algo_agc_avg_init(uint16 avg_len );

#ifdef FEATURE_GSM_RX_DIVERSITY
dBx16_T sys_algo_agc_average_output_divrx(dBx16_T agc_output);
