...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_amr.h#3 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void ratscch_process_req( uint8 *data, boolean crc_status );
...
===========================================================================*/
extern void ratscch_update_req_activation_counter(void);
...
===========================================================================*/
extern uint8 ratscch_update_ack_activation_counter(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void ratscch_start_ack_activation_counter(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
extern void ratscch_reset_pending_proc(void);
...
SIDE EFFECTS:
  ...
  etc.
===========================================================================*/
extern void ratscch_activate_req_in_dl(void);
...
SIDE EFFECTS:
  ...
  etc.
===========================================================================*/
extern void ratscch_activate_req_in_ul(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
void gen_codec_mode_request(void);
...
SIDE EFFECTS:
  None
===========================================================================*/
void filter_c_over_i_fr (uint16 c_over_i);
...
SIDE EFFECTS:
  None
===========================================================================*/
boolean set_ul_acs (gl1_msg_amr_mode_type *acs, uint8 num_modes_t );
...
SIDE EFFECTS:
  None
===========================================================================*/
boolean set_dl_acs (gl1_msg_amr_mode_type *acs, uint8 num_modes_t );
#ifdef FEATURE_GSM_AMR_WB
/*===========================================================================
...
SIDE EFFECTS:
  None
===========================================================================*/
void gl1_msg_ul_set_wb_amr_mode(boolean wb_amr_flag);
...
SIDE EFFECTS:
  None
===========================================================================*/
void gl1_msg_dl_set_wb_amr_mode(boolean wb_amr_flag);
...
SIDE EFFECTS
   None
===========================================================================*/
uint8 l1_amr_get_hr_subchannel(void);
...
SIDE EFFECTS
   None
===========================================================================*/
gl1_msg_chan_type l1_amr_get_channel_type(void);
