...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/l1_utils.h#13 $
$DateTime: 2021/01/19 01:59:53 $ $Author: pwbldsvc $

when       who      what, where, why
--------   -------- ---------------------------------------------
19/01/21   sk       CR2853073 Remove CT.2.0 featurization for the "FR62672 : Observing Sudden Jumps in LTE Tunc growth"
21/12/20   sk       CR2522356 Send GTS update during module unload
...
30/08/18   sk       CR2089274 Setup early RF trigger for SyncRx/SCH in dedicated mode
...
extern boolean gl1_gts_timer_running;
...
void gpl1_reset_tx_pwr_avg(void);
void gpl1_reset_rx_pwr_avg(void);

/* enable pwr averaging */
void gpl1_set_tx_pwr_avg_active(void);
void gpl1_set_rx_pwr_avg_active(void);

boolean gpl1_get_tx_pwr_avg_active_state(void);
boolean gpl1_get_rx_pwr_avg_active_state(void);

int32 gpl1_get_tx_pwr_avg_dbm10(void);
int32 gpl1_get_avg_tx_slot_pwr_db_10(void);
int32 gpl1_get_rx_pwr_avg_dbm10_coex(void);
int32 gpl1_get_rx_pwr_avg_dbm10(void);

void gpl1_update_tx_pwr_avg(int16 power_lvl_idx,sys_band_T  band);
void gpl1_update_rx_pwr_avg( int32 rssi );

int32  gpl1_calc_avg_tx_pwr(void);
int32  gpl1_calc_avg_rx_pwr(void);

/* maps GSM Band to corresponding RF band enum */
rfcom_gsm_band_type gpl1_convert_to_rf_band_type(sys_band_T gsm_band);
...
void gpl1_block_bound_51_multiframe(uint32 start_fn, uint32 *suspension_FN_ptr);
...
uint32 gl1_get_rach_fn_OTA(uint32 delay,boolean ccch_sdcch_comb );
...
===========================================================================*/
void l1_change_state ( const byte newState);
...
===========================================================================*/
uint16   L1_sort_signal_strengths(void);
...
===========================================================================*/
void   L1_calculate_paging_data(void);
...
===========================================================================*/
ARFCN_T L1_calculate_ARFCN(int16 offset, channel_information_T *channel_data);
...
void L1_get_ARFCNS (
                      ...
                      channel_information_T *freq_redef_chnl_info_ptr
                   );
...
===========================================================================*/
sys_algo_agc_T *l1_get_agc_ptr( ARFCN_T ARFCN );
...
===========================================================================*/
boolean gl1_calc_ho_timing_advance (l1_sc_bs_T *target_cell_details, byte *calculated_timing_advance);
...
===========================================================================*/
void l1_snr_msg( dBx16_T *snrs, uint32 num );
...
===========================================================================*/
void gl1_timetag_cgps (byte l1_state, cgps_CellUpdateEnumType update_type);
...
===========================================================================*/
void gl1_timetag_cgps_asleep (byte l1_state);
...
===========================================================================*/
void gl1_timetag_gps_tick (void);
...
SIDE EFFECTS
  None.
===========================================================================*/
void l1_idle_if_gps_notify(void);

#endif /*FEATURE_CGPS_TIME_TAGGING*/



void gl1_handle_TimeTagRequest(void);

void gl1_handle_msg_peo_scheduler(boolean serv_meas);
...
===========================================================================*/
extern boolean gl1_is_anite_gcf_flag_set(void);
...
===========================================================================*/
void gl1_set_band_group (sys_band_mask_type band_mask);
...
===========================================================================*/
void l1_prime_agc_for_handover(ARFCN_T arfcn);
...
===========================================================================*/
void l1_interrat_ho_agc(sys_algo_agc_T handover_agc);
...
===========================================================================*/
void l1_interrat_ho_update(boolean update);
...
===========================================================================*/
boolean gl1_get_rach_pwr_reduction(void);
...
===========================================================================*/
void gl1_set_rach_pwr_reduction(boolean set);
/*===========================================================================
...
===========================================================================*/
int16 gl1_get_rach_pwr_reduction_pwr_idx(void);
/*===========================================================================
...
===========================================================================*/
void gl1_set_rach_pwr_reduction_pwr_idx(int16 pwr_idx);
/*===========================================================================
...
===========================================================================*/
void gl1_set_rach_pwr_reduction_first_rach(boolean first_rach);
/*===========================================================================
...
===========================================================================*/
boolean gl1_get_rach_pwr_reduction_first_rach(void);
/*===========================================================================
...
===========================================================================*/
byte gl1_check_pwr_reduction_update (ARFCN_T arfcn, byte txlev, byte current_power_level_in_use);
...
===========================================================================*/
cxm_tech_type gl1_gas_id_to_tech_id(void);
...
void l1_frequency_list_mem_init(void);
void l1_frequency_list_mem_free(void);

#ifdef FEATURE_GSM_COEX_SW_CXM
uint8 gpl1_get_burst_num_from_FN(uint32 FN,boolean direction);
#endif /* FEATURE_GSM_COEX_SW_CXM */

#ifdef FEATURE_GPRS_GBTA
void gl1_gbta_read_nv_gbta_support(void);
boolean gl1_gbta_get_nv_gbta_support(void);
...
void   gpl1_gprs_setup_start_idle(  void * );

#ifdef FEATURE_GSM_DTM
boolean gl1_is_current_state_dtm(void);
#endif
uint32 gl1_retrieve_bplmn_fail_count(const boolean reset_count);
void   gl1_increment_bplmn_fail_count( );

#ifdef FEATURE_MODEM_CONFIG_REFRESH
void gl1_refresh_nv_items(void);
#endif /* FEATURE_MODEM_CONFIG_REFRESH */

byte gl1_get_current_state(void);

void gl1_print_control_block(uint8 *msg);

void gpl1_select_band_to_req_trm(byte band_bitmap);
...
void gl1_read_lte_prune_cells_below_threshold(void);
#endif

#ifdef FEATURE_WLAN_COEX_SW_CXM
void gpl1_update_snr_avg( uint16 snr );
void gpl1_reset_snr_avg(void);
void gpl1_stop_snr_avg(void);
void gpl1_enable_snr_avg(void);
boolean gpl1_read_avg_snr( uint32 *filt_metric, uint32 *metric_cnt );
#endif

byte l1_override_bs_pa_mfrms(byte BS_PA_MFRMS);

#ifdef FEATURE_GSM_SIMULATE_GL1_RF
#error code not present
#endif /* FEATURE_GSM_SIMULATE_GL1_RF */
/* Functions to send Timing update to GPS module */
void gl1_gts_timer_init(void);
void gl1_gts_timer_deinit(void);
void gl1_gts_timer_deactivate( void);
void gl1_gts_send_gts_after_wakeup( void );
void gl1_gts_send_gts_before_ptm_sleep(void);
void gl1_gts_send_gts_before_unload(void );
#endif /* L1_UTILS_H */
