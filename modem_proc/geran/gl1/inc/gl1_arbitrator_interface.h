...
$Header: //components/rel/geran.mpss/5.2.0/gl1/inc/gl1_arbitrator_interface.h#3 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
===========================================================================*/
void garb_intf_register(gl1_msg_arbitration_t* gl1_msg_arbitration, sys_modem_device_mode_e_type mode  );
...
===========================================================================*/
void garb_intf_unregister(void );
...
===========================================================================*/
void garb_intf_notify_gstmr_tick(void );
...
===========================================================================*/
void garb_intf_notify_gstmr_post_tick(void );
...
===========================================================================*/
void garb_intf_notify_find_bcch(void );
...
void garb_intf_notify_idle(ARFCN_T arfcn, boolean ccch_sdcch_comb, paging_mode_T paging_mode,
                           byte paging_mfrms, byte paging_mfrm, byte opb  );
...
===========================================================================*/
void garb_intf_notify_exit( void );
...
===========================================================================*/
void garb_intf_notify_access(ARFCN_T arfcn, uint8 delay, int16 txlev );
...
===========================================================================*/
void garb_intf_notify_access_update( ARFCN_T arfcn, uint8 delay, int16 txlev );
...
===========================================================================*/
void garb_intf_notify_twophase_access(frequency_list_T frequency_list );
...
void garb_intf_notify_cs_assignment(uint8 TN, frequency_list_T frequency_list,
                                    ...
                                    uint8 idle_frame, garb_get_arfcns_t get_arfcns  );
...
void garb_intf_notify_ps_assignment(frequency_list_T frequency_list, uint8 num_ul_slots,
                                    uint8 num_dl_slots, garb_get_arfcns_t get_arfcns );
...
void garb_intf_notify_sdcch_assignment(frequency_list_T frequency_list, boolean is_sdcch_8,
                                       uint8 subchannel, garb_get_arfcns_t get_arfcns );
...
===========================================================================*/
void garb_intf_notify_monscan_ba_list(cell_T** cell_pptr, uint8 num_cells  );
...
===========================================================================*/
boolean garb_intf_is_monitor_coex_protected(uint8 FNMod_102_104 );
...
===========================================================================*/
boolean garb_intf_notify_block_tx(gl1_msg_chan_type channel_type );
...
===========================================================================*/
boolean garb_intf_gas_is_xpg_coex_agressor(void );
...
===========================================================================*/
boolean garb_intf_gas_is_xpg_coex_victim(void );

#ifdef FEATURE_WLAN_COEX_SW_CXM
void garb_intf_coex_update_active_policy( void  );
#endif
