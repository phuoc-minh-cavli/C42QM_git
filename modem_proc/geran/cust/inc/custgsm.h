...
DESCRIPTION
  ...
  Copyright (c) 2002-2017 by QUALCOMM Technologies, Inc. All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/geran.mpss/5.2.0/cust/inc/custgsm.h#21 $
...
12/02/19   ng      CR2397130 Featurize GTS code using GTS specific feature flag
03/01/19   ng      CR2375266 Featurize Gl1 code which uses GPS APIs for Non GPS build compilation
14/11/18   sk      CR2341754 Geran Memopt changes
22/10/18   kh      CR2336454 Disabling VAMOS II feature on CT PL
01/10/18   ng      CR2325381 Move all GPS code under feature flag 'FEATURE_CGPS_TIME_TAGGING'
25/01/17   nm      CR1115913 Fix for Strip pack build failing compilation
15/12/16   akm     CR1094329 GL1 Improvements related to iRat feature
...
04/11/12   br      CR1084869 Disable RXD, and asdiv feature on JO3.0.2 
...
#define GL1_GMSK_MOD_DET

#define FEATURE_GERAN_EXTENDED_DRX
#define FEATURE_GERAN_IMPLICIT_PS_REJECT
#define FEATURE_GERAN_EAB

#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
#define FEATURE_GERAN_GPS_PLMN_SCAN_SEARCH
...
#define FEATURE_PS_PREFERRED_CELL
/***************************************************************************
                                 GPRS
****************************************************************************/
...
#if defined(FEATURE_GSM_SNDCP_IPHC) || defined(FEATURE_GSM_SNDCP_SLHC) || defined(FEATURE_GSM_SNDCP_ROHC)
...
/*---------------------------------------------------------------------------
                           GPRS MAC
---------------------------------------------------------------------------*/
/* Add PEO support in GRLC and GMAC */
#define FEATURE_GERAN_POWER_EFFICIENT_OPERATION
...
/* For JO.3.0.2 (LTE+G but no IRAT) */
#undef FEATURE_LTE
#undef FEATURE_LTE_REL11
#undef FEATURE_LTE_TO_GSM_CGI
#undef FEATURE_LTE_TO_GSM_CCO
#undef FEATURE_MODEM_COEXISTENCE_SW

/*GPS related code can be removed from Gl1 code*/
#undef FEATURE_CGPS_TIME_TAGGING

/*GTS/GPS related code needs to be featurized in Gl1 code for non GPS builds to compile*/
#if defined(FEATURE_LOC_GTS_SUPPORT)
#define FEATURE_CGPS_USES_GSM
#endif
...
// Disabling vamos feature for Chiltepin PL
...
/* 9x05 Memory Optimization */
#define FEATURE_GERAN_REDUCED_DEBUG
#define FEATURE_RR_THERMAL_MITIGATION

/* New feature flags to control CS support and CBCH support */
#define FEATURE_GERAN_CS_SUPPORT
#undef FEATURE_GERAN_CBCH_SUPPORT
#undef FEATURE_WTOG_BACKGROUND_PLMN_SEARCH
#undef FEATURE_GSM_CB_DRX_SUPPORTED


#undef FEATURE_GSM_DTM
#undef FEATURE_GSM_EDTM

/* For JO.3.0.2 when CS support is not present */
#ifndef FEATURE_GERAN_CS_SUPPORT
#undef FEATURE_GSM_TDS_PSEUDO_FAST_RETURN
#undef FEATURE_CGPS_UMTS_CP_GSM
/*FR 19667*/
#undef FEATURE_GSM_AMR_PD_DTX_DETECT
...
#undef FEATURE_GERAN_SIMULATE_ARB_UNLOAD

/* commented Code related to SI7/SI8 */
#undef FEATURE_HANDLE_SI7_SI8

/*FR 40251: SMART NCELL SCH (SeNS)*/
#define FEATURE_GSM_SENS_SUPPORT

#ifdef FEATURE_FSK_TX /*Target level flag*/
/*FR 58047: FSK  Based Jammer reporting*/
#define FEATURE_FSK_SUPPORT

#ifdef FEATURE_GSM_SIMULATE_GL1_RF /*Internal only flag*/
#error code not present
#endif

/*To enable if HW limitation for continuous Tx*/
//#define FSK_CONTINOUS_TX_LIMITATION
#endif
