...
$Header: //components/rel/geran.mpss/5.2.0/grr/inc/rr_multiband_g.h#2 $    $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
extern multiband_info_T * rr_get_multiband_info(void);
extern void rr_init_band_support_info(void);

extern boolean rr_is_preferred_band(rr_internal_band_T band);
extern void    rr_set_preferred_band(rr_internal_band_T band, boolean allowed);

extern void    rr_set_supported_band(rr_internal_band_T band, boolean supported);

extern boolean rr_check_in_band(rr_internal_band_T band,word  arfcn);
extern void rr_set_current_band(rr_internal_band_T band);

extern void rr_reset_current_band(void);

extern void rr_set_current_dedicated_band(rr_internal_band_T band);
extern rr_internal_band_T rr_get_current_dedicated_band(void);

extern rr_internal_band_T rr_get_band(word arfcn);

extern boolean rr_gapi_is_supported_band(sys_band_T band);
extern byte rr_gapi_get_band_rf_power_class(rr_internal_band_T band);
extern byte rr_gapi_get_supported_band_count(void);
