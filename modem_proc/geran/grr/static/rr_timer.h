...
/* $Header: //components/rel/geran.mpss/5.2.0/grr/static/rr_timer.h#6 $ */
/* $DateTime: 2021/08/21 02:53:36 $$Author: pwbldsvc $ */
...
#define RR_PCI_SINGLE_CELL_GUARD_DURATION 10000                 /* 10 seconds */

/* timer druation to abort plmn list search recieved during unloaded state */
#define RR_UNLOADED_NAS_MSG_GUARD_TIMER_DURATION 180000 /* 180 seconds */
...
#define RR_RMC_CCCH_READ_TIMER_DURATION               500U /*500ms */
...
extern boolean rr_timer_start(rr_timer_id_T, rex_timer_cnt_type);
extern boolean rr_timer_cancel(rr_timer_id_T);
extern boolean rr_timer_truncate(rr_timer_id_T, rex_timer_cnt_type);

extern boolean rr_timer_restart(rr_timer_id_T, rex_timer_cnt_type);
extern boolean rr_timer_extend(rr_timer_id_T, rex_timer_cnt_type);
extern boolean rr_timer_is_active(rr_timer_id_T);
extern boolean rr_timer_is_running(rr_timer_id_T);
extern boolean rr_timer_has_expired(rr_timer_id_T);
extern boolean rr_timer_create_expired_timer(rr_timer_id_T);
extern boolean rr_timer_validate_expiry_message(rr_timer_id_T);

extern rex_timer_cnt_type rr_timer_get_time_remaining(rr_timer_id_T);
extern rr_timer_state_T   rr_timer_get_state(rr_timer_id_T);

extern void rr_timer_reset_all(rr_timer_id_T *, int);

extern void rr_start_cell_barred_timer(void);
extern void rr_stop_barred_cell_timer(void);
extern boolean rr_timer_force_timer_expiry(rr_timer_id_T);

#if defined(FEATURE_DYNAMIC_LOADING_GERAN) || defined(FEATURE_EXTERNAL_PAGING_GERAN)
extern void rr_start_dmm_resumption_timer(rex_timer_cnt_type millisecs);
extern void rr_stop_dmm_resumption_timer();
extern void rr_start_unloaded_nas_msg_guard_timer(rex_timer_cnt_type millisecs);
extern void rr_stop_unloaded_nas_msg_guard_timer();
#endif /* FEATURE_DYNAMIC_LOADING_GERAN */
