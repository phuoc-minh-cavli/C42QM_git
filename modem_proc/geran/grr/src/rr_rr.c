...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_rr.c#2 $ */
                            ...
                            rr_message_set_e     rr_message_set)
{
  ...
  rr_show_output_message("RR", &header_ptr->imh, MS_RR_RR, (int32)message_id);
                ...
                rr_message_set_e     rr_message_set)
{
  ...
  rr_send_to_self(header_ptr, message_id, message_length, rr_message_set);
