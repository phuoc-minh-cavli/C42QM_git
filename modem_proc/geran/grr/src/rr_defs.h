...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_defs.h#7 $   $DateTime: 2020/05/05 01:09:40 $ $Author: pwbldsvc $
...
#define RR_PREPARE_L1_MESSAGE(msg, msg_id)                   \
...
#define RR_PREPARE_L2_MESSAGE(msg, msg_id)                   \
  RR_ZERO_STRUCTURE(msg);                                            \
...
#define NUMBER_OF_MT_RR_MESSAGES 42
#else  /* FEATURE_GERAN_EAB */
...
#define SYSTEM_INFORMATION_TYPE_9         0x04
#define SYSTEM_INFORMATION_TYPE_21        0x46
...
typedef void (*rr_cb_fn_t)(void);

#define CALL_RR_CB_FN(rr_cb_fn) {if (rr_cb_fn != NULL) (*rr_cb_fn)();}
...
typedef enum
{
  ...
  RR_CELL_BARRED,
  RR_LOW_PRIORITY_CS_CELL,
  RR_LOW_PRIORITY_CSPS_CELL,
  RR_HIGH_PRIORITY_CS_CELL,
  RR_HIGH_PRIORITY_CSPS_CELL
} rr_cell_type_T;
...
/* SI21_POSITION values */
typedef enum
{
  SI21_POSITION_UNKNOWN,
  SI21_POSITION_NONE,
  SI21_POSITION_BCCH_Norm,
  SI21_POSITION_BCCH_Ext
}si21_position_T;
...
typedef struct
{
  uint16         authorization_mask;
  uint8          subcategory;
} EAB_info_t;

typedef struct
{
  uint8          si21_change_mark;
  uint8          si21_index;
  uint8          si21_count;
  boolean        EAB_info_flag;
  EAB_info_t     EAB_info;
} si21_rest_T;

#define MAX_SI21_INSTANCES  8
...
typedef struct
{
  ...
  /* instance information */
  si21_rest_T    *instance[MAX_SI21_INSTANCES];
} si21_instances_T;
#endif /* FEATURE_GERAN_EAB */
...
#define MASK_SI_9             SI_TYPE_TO_MASK(SI_TYPE_SI_9)
#define MASK_SI_13            SI_TYPE_TO_MASK(SI_TYPE_SI_13)
#define MASK_SI_21            SI_TYPE_TO_MASK(SI_TYPE_SI_21)
...
typedef struct
{
   ...
   */
  uint32                            update_message_received;
  ...
  /* the SI21 position received in the SI3 Rest octets */
  ...
  rr_l1_si_sched_info_T            si_sched_info;

#ifdef FEATURE_GERAN_EAB
  boolean                          EAB_info_valid;
  EAB_info_t                       EAB_info;
#endif /* FEATURE_GERAN_EAB */
...
extern instances_T *rr_get_instances_ptr(si2q_mi_instance_e_type );
si2ter_instances_T *rr_get_SI2ter_instances_ptr( void );
#ifdef FEATURE_GERAN_EAB
si21_instances_T *rr_get_SI21_instances_ptr( void );
#endif /* FEATURE_GERAN_EAB */

extern void rr_data_discard_data( void );
...
extern rr_individual_priorities_t ** rr_individual_priorities( );
...
extern void rr_init_cell_selection_indicator( void );
 ...
 * \param  
 */
extern void rr_init_plmn_select_req_info( void );
 ...
 * \param  
 */
extern void rr_init_plmn_list_req_info( void );
...
*/
extern rr_l1_gsm_deact_reason_T rr_l1_gsm_deact_reason_get( void );
...
*/
extern void rr_l1_gsm_deact_reason_set(rr_l1_gsm_deact_reason_T gsm_deact_reason);
#ifdef FEATURE_WCDMA
/****************************************************************************
 ...
 *
 ****************************************************************************/
nc_meas_params_mods_t *rr_get_nc_meas_params_mods_ptr( void );
 ...
 *
 ****************************************************************************/
gprs_meas_params_mods_t *rr_get_gprs_meas_params_mods_ptr( void );
 ...
 *
 ****************************************************************************/
pmo_pcco_nacc_params_t *rr_get_final_pmo_pcco_nacc_params_ptr( void );
 ...
 *
 ****************************************************************************/
gprs_3g_meas_params_mods_t *rr_get_gprs_3g_meas_params_mods_ptr( void );
#endif /* FEATURE_WCDMA || FEATURE_GSM_TDS*/
 ...
 *
 ****************************************************************************/
nc_meas_params_mods_t *rr_get_nc_meas_params_pcco_ptr( void );
 ...
 *
 ****************************************************************************/
gprs_meas_params_mods_t *rr_get_gprs_meas_params_pcco_ptr( void );
 ...
 *
 ****************************************************************************/
pmo_pcco_nacc_params_t *rr_get_pmo_pcco_nacc_params_ptr( void );
 ...
 *
 ****************************************************************************/
gprs_3g_meas_params_mods_t *rr_get_gprs_3g_meas_params_pcco_ptr( void );
#endif /*FEATURE_WCDMA*/
...
extern rr_params_mods_t ** rr_params_mods( void );
extern rr_params_mods_t ** rr_pcco_params_mods( void );
