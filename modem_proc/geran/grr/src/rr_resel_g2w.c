...
==============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_resel_g2w.c#2 $ */
...
static rr_resel_g2w_data_t  rr_resel_g2w_data_spaces;
 ...
 */
static rr_resel_g2w_data_t *rr_resel_g2w_get_data_ptr(void)
{
  return &rr_resel_g2w_data_spaces;
}
...
*/
static void rr_resel_g2w_deactivate_l1( )
{

  rr_resel_g2w_data_t *rr_resel_g2w_data_ptr;

  // Obtain a pointer to the module data
  rr_resel_g2w_data_ptr = rr_resel_g2w_get_data_ptr();
...
#endif /* FEATURE_SGLTE */
  {
    if (rr_g2x_lock_exchange_allowed(RR_G2X_OPERATION_TYPE_RESELECTION, rr_resel_g2w_data_ptr->target.rat))
    {
    ...
    if (EV_GSM_MODE_DEACTIVATED == rr_mode_control(EV_DEACTIVATE_GSM_MODE, NULL))
    {
...
)
{
  ...
  switch (data->type)
  {
    ...
    {
      rr_log_reselect_start(RR_RESELECTION_TRIGGER_GSM_TO_WCDMA);
      break;
    } /* RR_G2X_RESEL_TYPE_RESELECTION */

    case RR_G2X_RESEL_TYPE_PACKET_CELL_CHANGE_ORDER:
    {
      rr_log_reselect_start(RR_RESELECTION_TRIGGER_PCCO_3G_TARGET);
      break;
...
{
  // Obtain a pointer to the module data
  rr_resel_g2w_data_t *rr_resel_g2w_data_ptr = rr_resel_g2w_get_data_ptr();
  RR_NULL_CHECK_FATAL(rr_resel_g2w_data_ptr);
                  ...
                  switch (resel_req->target.rat)
                  {
                    ...
                    case RR_RAT_WCDMA:
                    {
                      if (rr_is_rat_segment_loaded(RR_SEG_LOAD_WCDMA) == FALSE)
                      {
                        ...
                        {
                          rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_RESELECTION_FAILURE);
                        }
                        else if (rr_resel_g2w_data_ptr->type == RR_G2X_RESEL_TYPE_PACKET_CELL_CHANGE_ORDER)
                        {
                          rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_PCCO_FAILURE_NO_RESPONSE);
                        }
                        
                        return;
                      }
                      rr_resel_g2w_log_start(rr_resel_g2w_data_ptr);
                      break;
                    } /* RR_RAT_WCDMA */
#endif /* FEATURE_WCDMA */
          ...
          switch (msg->rr.header.rr_message_set)
          {
            case RR_RESEL_G2W_IMSG:
            {
              ...
              switch (imsg->header.imh.message_id)
              {
                ...
                {
                  rr_resel_g2x_log_resel_aborted(&rr_resel_g2w_data_ptr->target);
          ...
          switch (msg->rr.header.rr_message_set)
          {
            ...
            case RR_PS_OMSG:
            {
              switch (msg->rr.ps.omsg.header.imh.message_id)
              {
                ...
                {
                  rr_resel_g2x_log_resel_aborted(&rr_resel_g2w_data_ptr->target);
                  rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_ABORTED_IN_SERVICE);
            ...
            case RR_RESEL_G2W_IMSG:
            {
              ...
              switch (imsg->header.imh.message_id)
              {
                case RR_RESEL_G2W_IMSG_L1_DEACTIVATED_IND:
                {
                  ...
                  rr_resel_g2w_cache_rat_pri_list_info();
          ...
          switch (msg->rr.header.rr_message_set)
          {
            case RR_RESEL_G2W_IMSG:
            {
              ...
              switch (imsg->header.imh.message_id)
              {
                    ...
                    default:
                    {
                      ...
                      switch (rr_resel_g2w_data_ptr->target.rat)
                      {
                        ...
                        case RR_RAT_WCDMA:
                        {
                          ...
                          { 				  
                            rr_send_rrc_interrat_cc_order_abort_req();
                          }
                          else
                          {
                ...
                {
                  rr_resel_g2x_log_resel_success(&rr_resel_g2w_data_ptr->target);
                  rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_RESELECTION_SUCCESS);
                  rr_resel_g2w_data_ptr->state = RR_RESEL_G2W_STATE_NULL;
                  break;
        ...
        case MS_TDSRRC_RR:
        {
          switch (msg->message_header.message_id)
          {
            case TDSRRC_INTERRAT_RESELECTION_REJ:
            {
              ...
              geran_multisim_eng_mode_refresh_cm(ENG_MODE_SCELL_INFO);
        ...
        case MS_RRC_RR:
        {
          switch (msg->message_header.message_id)
          {
            case RRC_INTERRAT_RESELECTION_REJ:
            {
              ...
              rr_resel_g2w_restore_rat_pri_list_info();
            ...
            case RRC_INTERRAT_CC_ORDER_CNF:
            {
              ...
              switch (interrat_cc_order_cnf->status)
              {
                case CCO_SUCCESS:
                {
                  rr_send_gtow_cco_complete_ind();
                  rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_PCCO_SUCCESS);
                  rr_resel_g2w_data_ptr->state = RR_RESEL_G2W_STATE_NULL;
                  break;
                } /* CCO_SUCCESS */
                ...
                */
                case CCO_FAILURE_AFTER_ACT_IND:
                {
                  ...
                  rr_send_activation_ind(MM_AS_GTOW_CC_ORDER_FAILED);
                  break;
      ...
      switch (msg->message_header.message_set)
      {
        ...
        case MS_TDSRRC_RR:
        {
          switch (msg->message_header.message_id)
          {
            ...
            {
              rrc_interrat_reselect_rej_type rrc_resel_rej;
              (void)rr_timer_cancel(RR_IRAT_PROC_TIMER); /*hari*/
          ...
          switch (msg->rr.header.rr_message_set)
          {
            case RR_RESEL_G2W_IMSG:
            {
              ...
              switch (imsg->header.imh.message_id)
              {
                ...
                {
                  rr_resel_g2w_send_omsg_resel_cnf(rr_resel_g2w_data_ptr->status);
                  rr_resel_g2w_data_ptr->state = RR_RESEL_G2W_STATE_NULL;
                  break;
                } /* RR_RESEL_G2W_L1_DEACTIVATED_IND */
          ...
          switch (msg->rr.header.rr_message_set)
          {
            case RR_RESEL_G2W_IMSG:
            {
              ...
              switch (imsg->header.imh.message_id)
              {
                case RR_RESEL_G2W_IMSG_L1_ACTIVATED_IND:
                {
                  rr_resel_g2w_send_omsg_resel_cnf(RR_RESEL_G2W_STATUS_ABORTED_OUT_OF_SERVICE);
                  rr_resel_g2w_data_ptr->state = RR_RESEL_G2W_STATE_NULL;
                  break;
                } /* RR_RESEL_G2W_L1_DEACTIVATED_IND */
...
boolean rr_resel_g2w_in_progress( )
{
  rr_resel_g2w_data_t *rr_resel_g2w_data_ptr = rr_resel_g2w_get_data_ptr();
