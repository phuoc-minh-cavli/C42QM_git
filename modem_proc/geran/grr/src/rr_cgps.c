 ...
 */
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_cgps.c#2 $ */
...
static rr_cgps_module_data_t  rr_cgps_module_data;
 ...
 */
static rr_cgps_module_data_t *rr_cgps_get_data_ptr(void)
{


  return &rr_cgps_module_data;
}
 ...
 * \param event_id 
 */
static void rr_cgps_send_simple_cgps_event(rr_cgps_event_type event_id )
{
 ...
 * \param  
 */
void rr_cgps_process_cgps_event_req(const rr_cmd_bdy_type *message_ptr )
{
  ...
  module_data_ptr = rr_cgps_get_data_ptr();
 ...
 * \param 
 */
void rr_cgps_process_apdu_data_seg(const rr_cmd_bdy_type *message_ptr )
{
  rr_cgps_module_data_t *module_data_ptr;
 ...
 * \param 
 */
void rr_cgps_apdu_in_progress_check(const rr_cmd_bdy_type* new_message )
{
  // Obtain a pointer to the module data
  rr_cgps_module_data_t *module_data_ptr = rr_cgps_get_data_ptr();
       ...
       ( new_message->dl_data_ind.l2_channel_type == DCCH ) )
  {
         ...
         ( message_type != APPLICATION_INFORMATION ) )
    {
      ...
      rr_cgps_send_simple_cgps_event( RR_CGPS_APDU_ABORT_EVENT );
      module_data_ptr->apdu_in_progress = FALSE;
    }
  }
...
===========================================================================*/
void rr_cgps_lcs_activity_check(const rr_cmd_bdy_type *message_ptr )
{
  // Obtain a pointer to the module data
  rr_cgps_module_data_t *module_data_ptr = rr_cgps_get_data_ptr();
 ...
 */
       ...
       ( message_ptr->dl_data_ind.l2_channel_type == DCCH ) )
  {
         ...
         ( message_type != APPLICATION_INFORMATION ) )
    {
      ...
      /* Notify LSM of this event */
      rr_cgps_send_simple_cgps_event( RR_CGPS_SESSION_ABORT_EVENT );
 ...
 * \param cb_fp (in)
 */
void geran_grr_register_cgps_event_cb_dyn(rr_cgps_event_cb_type cb_fp)
{
