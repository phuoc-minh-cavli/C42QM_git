...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_decode_ie.h#2 $ $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
extern ie_descriptor_T *rr_get_first_ie_and_length(byte, uint8 * );
extern ie_descriptor_T *rr_get_first_ie_of_message(byte );
