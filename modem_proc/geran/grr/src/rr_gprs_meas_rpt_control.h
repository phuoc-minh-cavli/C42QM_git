...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_gprs_meas_rpt_control.h#3 $ */
...
extern void rr_gprs_clear_3g_measurement( );

#endif /* FEATURE_WCDMA */

extern boolean rr_meas_reporting_is_active( );
