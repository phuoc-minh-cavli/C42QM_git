...
/**
  ...
  $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_sys_info_si.h#2 $
*/
 ...
 */
extern void rr_si_send_l1_read_sys_info_req(uint32 si_required  );
 ...
 */
extern uint32 rr_si_messages_not_broadcast(gprs_scell_info_t *cell_info_ptr);
 ...
 * \param si_bitmask (in)
 */
extern void rr_si_print_bitmask(char *descr_text, uint32 si_bitmask);
 ...
 */
extern uint32 rr_si_calc_sys_info_acquisition_time(uint32 si_required, uint32 si_on_bcch_ext);
