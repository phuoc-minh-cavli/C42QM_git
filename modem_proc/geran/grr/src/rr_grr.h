...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_grr.h#2 $ */
...
*/
extern boolean rr_gprs_grr_is_active( );
...
*/
extern boolean grr_is_idle_camped( );
...
*/
extern boolean grr_in_camped_state( );
...
/**
  ...
  @return TRUE if a TBF establishment is in progress, FALSE
          otherwise.
*/
extern boolean grr_tbf_est_in_progress( );
...
*/
extern boolean grr_cs_conn_est_in_progress( );
...
*/
extern boolean grr_reselection_in_progress( );
...
*/
extern grr_state_t get_grr_state( );
...
/**
  ...
  @return String containing the current GRR control state.
*/
extern const char *grr_control_current_state_name( );
...
*/
extern boolean grr_main_state_is_acquire( );

/**
  @brief General module initialisation function
*/
extern void rr_grr_control_init( );
...
*/
extern boolean grr_can_process_stop_gsm_mode_req_sglte_rat_change( );

extern boolean grr_can_process_sglte_x2g_req( );

extern boolean grr_is_sglte_x2g_resel_in_progress( );

extern boolean grr_can_process_sglte_band_coex_omsg_supported_bands_updated_ind( );
...
#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION 
extern boolean grr_can_process_rr_resel_reduced_mobility_msg( );
#endif /*FEATURE_GERAN_POWER_EFFICIENT_OPERATION*/
