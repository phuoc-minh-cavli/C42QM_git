...
*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_ce_if.h#2 $ */
...
{
  rr_message_header_t  header;
} rr_ce_imsg_ps_ir_rcvd_ind_t;

typedef union
{
  rr_message_header_t        header;
  rr_ce_imsg_cs_abort_req_t  cs_abort_req;
  rr_ce_imsg_ps_ir_rcvd_ind_t ps_ir_ind;
} rr_ce_imsg_u;
...
/*!
 * \brief Sends RR_CE_IMSG_PS_IR_RCVD_IND
 * 
 * \param None
 * \param None
 */
extern void rr_ce_send_imsg_ps_ir_rcvd_ind( void );
