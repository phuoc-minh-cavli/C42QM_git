...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_g2x.h#2 $
...
*/
extern void rr_g2x_init( void );

extern void rr_g2x_barred_frequency_db_clear( void  );

extern void rr_g2x_barred_cell_db_clear( void );

extern void rr_g2x_cell_quality_data_clear( void );
...
*/
extern void rr_g2x_cell_selection_triggered( void );
...
*/
extern void rr_g2x_plmn_selection_triggered( void );
...
extern void rr_g2x_forbidden_lai_list_updated( void );

extern void rr_g2x_equivalent_plmn_list_updated( void );

#ifdef FEATURE_WCDMA
extern boolean rr_g2x_is_uarfcn_valid(uint32 uarfcn, PLMN_id_T plmn_id );
#endif /* FEATURE_WCDMA */

extern void rr_g2x_csg_white_list_updated( void );

extern boolean rr_g2x_lock_exchange_allowed( const rr_g2x_operation_type_e rr_g2x_operation_type, const rr_rat_e target_rat );
