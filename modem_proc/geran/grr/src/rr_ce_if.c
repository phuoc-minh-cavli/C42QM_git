...
*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_ce_if.c#3 $ */
...
const char *rr_ce_imsg_name(rr_ce_imsg_e imsg)
{
  switch (imsg)
  {
    ...
    case RR_CE_IMSG_PS_IR_RCVD_IND : return "RR_CE_IMSG_PS_IR_RCVD_IND";
    default: return "?";
  }
}
...
// See header file for documentation
void rr_ce_send_imsg_ps_ir_rcvd_ind( )
{
  rr_ce_imsg_ps_ir_rcvd_ind_t msg;

  MSG_GERAN_HIGH_0_G("IMSG_PS_IR_RCVD_IND:");
  memset(&msg, 0, sizeof(msg));

  rr_rr_send(
    &msg.header,
    (uint8) RR_CE_IMSG_PS_IR_RCVD_IND,
    sizeof(msg),
    RR_CE_IMSG
  );
}
