...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_general.h#8 $ $DateTime: 2021/01/27 23:18:37 $ $Author: pwbldsvc $
...
void rr_update_idle_mode( void );
#ifdef FEATURE_GERAN_CS_SUPPORT
void rr_l1_update_dedicated_mode(system_information_database_T *si_db_ptr );
...
si_psi_band_ind_T  rr_get_current_band_indicator(boolean is_camped );
 ...
 */
void rr_add_to_barred_cell_list(rr_barred_cell_info_T *barred_cell_ptr );
uint8 rr_find_oldest_barred_cell(void );
boolean rr_is_cell_in_barred_cell_list(ARFCN_T arfcn, BSIC_T bsic );
void rr_authentication_failed_bar_cell(uint32 cell_bar_timer_value );
...
#ifdef FEATURE_GERAN_CS_SUPPORT
void rr_clear_si_sacch(  void );
boolean rr_get_DTX_indicator( void );
#endif /* FEATURE_GERAN_CS_SUPPORT */

void rr_reset_S_counter( void );
uint8 rr_increment_S_counter( void );
uint8 rr_decrement_S_counter( void );
boolean rr_retrieve_S_counter(byte *now_ptr, byte *max_ptr );
...
extern access_result_T rr_check_access_class_for_raching_for_tbf( void );
#ifdef FEATURE_GERAN_EAB
extern boolean rr_is_extended_access_barred(rr_pkt_est_cause_t pkt_est_cause  );
...
void rr_add_forbidden_cell(ARFCN_T channel_no );

void rr_start_forbidden_timer( void );
...
void rr_clear_pending_channel_data( void );

boolean rr_cell_forbidden(ARFCN_T channel_no );
...
void  rr_initialise_forbidden_cell_list( void );

void rr_reset_software( void );

void rr_clear_forbidden_cell_timer(rr_timer_id_T timer_id );

void rr_reset_forbidden_lai_list( void );
...
/* rr prototypes */
extern boolean rr_is_camped( void );
...
extern void rr_cancel_all_forbidden_cell_timers(void );
...
void rr_l1_update_wcdma_neighbor_list( void );
...
void rr_set_num_uarfcns_sent_to_l1(uint8 num );
uint8 rr_get_num_uarfcns_sent_to_l1( void );
uint8 rr_count_num_unique_uarfcns(mph_wcdma_cell_update_list_req_T *);

void rr_set_num_uarfcns_sent_to_l1_in_dedicated(uint8 num );
uint8 rr_get_num_uarfcns_sent_to_l1_in_dedicated( void );
...
#ifdef FEATURE_WCDMA
void rr_send_buffered_nas_messages( void );
#endif /* FEATURE_WCDMA */

#ifdef FEATURE_GERAN_CS_SUPPORT
void rr_process_dl_data_ack_ind(dl_data_ack_ind_T *new_message );
#endif /* FEATURE_GERAN_CS_SUPPORT */
void rr_initialize_nas_message_buffer( void );
byte rr_add_to_nas_message_buffer(
  SAPI_T SAPI,
  byte l3_message_length,
  byte *l3_message
);
boolean rr_remove_from_nas_message_buffer(byte l3_message_number );

#ifdef FEATURE_GERAN_CS_SUPPORT
l2_channel_type_T rr_get_l2_channel_type( void );
#endif /* FEATURE_GERAN_CS_SUPPORT */

void rr_initialize_SI2q_MI_instances(instances_T *instances, si2q_mi_instance_e_type type);
void rr_initialize_SI2q_instances( void );
void rr_initialize_MI_instances( void );
void rr_initialize_SI2ter_instances( void );
void rr_reset_SI2ter_instances(si2ter_instances_T *inst_ptr);

#ifdef FEATURE_GERAN_EAB
void rr_reset_SI21_instances(si21_instances_T *inst_ptr );
void rr_initialize_SI21_instances( void );
#endif /* FEATURE_GERAN_EAB */
...
void rr_set_preferred_bands(sys_band_mask_type  band_pref  );
...
extern boolean rr_is_any_cell_selection_mode( void );
extern boolean rr_is_any_cell_reselection_mode( void );
extern boolean rr_is_automatic_plmn_selection_mode( void );
extern boolean rr_is_limited_plmn_selection_mode( void );

#ifdef FEATURE_GERAN_CS_SUPPORT
extern void rr_send_handover_sync_ind(rr_dedicated_data_T * );
#endif /* FEATURE_GERAN_CS_SUPPORT */
...
#ifdef FEATURE_GERAN_CS_SUPPORT
extern void rr_dtx_override_reset( void );
extern void rr_dtx_rr_override_on( void );
extern void rr_dtx_rr_override_off( void );
extern void rr_dtx_update_l1_if_required( void );
#endif /* FEATURE_GERAN_CS_SUPPORT */
...
===========================================================================*/
extern void rr_eng_mode_update_dtx_ul_status(boolean dtx_status  );
...
===========================================================================*/
extern void rr_eng_mode_update_nw_params( void );
...
===========================================================================*/
extern void rr_eng_mode_update_scell_config( void );
...
*/
extern sys_rat_pri_list_info_s_type * rr_rat_pri_list_info( void );
...
*/
extern boolean rr_gsm_only( void );
...
*/
extern sys_band_mask_type rr_band_pref( void );
...
*/
extern sys_band_mask_type rr_search_band_pref( void );

#if defined(FEATURE_WCDMA) || defined(FEATURE_GSM_TDS)
/**
  @brief Returns the band_pref associated with WCMDA.
*/
extern sys_band_mask_type rr_band_pref_wcdma( void );


/**
  @brief Returns the band_pref associated with UTRAN_TDD.
*/
extern sys_band_mask_type rr_band_pref_utran_tdd( void );
...
*/
extern boolean rr_is_utran_tdd_enabled_in_nw_plmn( void );
...
/**
  ...
  @return TRUE if UTRAN TDD support is enabled, FALSE if not.
*/
extern boolean rr_is_utran_tdd_enabled( void );
...
*/
extern boolean rr_is_wcdma_enabled( void );
#endif
#ifdef FEATURE_LTE
...
*/
extern sys_lte_band_mask_e_type rr_band_pref_lte( void );
...
*/
extern boolean rr_is_lte_enabled( void );
...
extern void rr_individual_priorities_clear( void );

extern void rr_dedicated_priority_info_get(
  lte_irat_dedicated_priority_info_s * dst
);

extern sys_plmn_id_s_type rr_dedicated_priority_info_get_plmn(void );

/**
  @brief Dumps the Information in the Individual Priority database.
*/
extern void rr_individual_priorities_dump(void );
...
*/
extern rr_resel_priority_e rr_geran_priority(void );
...
*/
extern boolean rr_individual_priorities_valid( void );
...
*/
extern void rr_dedicated_priorities_take_ownership(void );
...
*/
extern void rr_dedicated_priorities_request_from_owner(void );
...
extern void rr_plmn_selection_triggered(void);

extern void rr_cell_selection_triggered(void);

/**
  @brief Wrapper for sys_eplmn_list_equivalent_plmn.
*/
extern boolean rr_eplmn_list_equivalent_plmn(sys_plmn_id_s_type plmn  );

/**
  @brief Wrapper for sys_ehplmn_list_equivalent_plmn.
*/
extern boolean rr_ehplmn_list_equivalent_plmn(sys_plmn_id_s_type plmn );
 ...
 */
extern boolean rr_is_ehplmn_or_hplmn(sys_plmn_id_s_type plmn );
...
extern void rr_store_service_domain(sys_srv_domain_e_type service_domain );
...
#ifdef FEATURE_GSM_TDS
extern boolean rr_sglte_is_l1_tds_measurements_configured( void );

extern void rr_sglte_set_l1_tds_measurements_configured(boolean is_configured );
#endif

#endif /* FEATURE_SGLTE */

#ifdef FEATURE_LTE
extern boolean rr_is_lte_l1_measurements_configured( void );
extern void rr_set_lte_l1_measurements_configured(boolean is_configured );
#endif
 ...
 * \return ARFCN_T
 */
extern ARFCN_T rr_scell_arfcn( void );
 ...
 * \return BSIC_T
 */
extern BSIC_T rr_scell_bsic( void );
 ...
 * \return uint8
 */
extern uint8 rr_scell_rxlev_average( void );
 ...
 * \return PLMN_id_T
 */
extern PLMN_id_T rr_scell_plmn_id( void );
 ...
 */
extern sys_srv_capability_e_type rr_scell_service_capability( void );

#ifdef FEATURE_FAST_G2L_PSEUDO_SI2Q
extern boolean rr_check_and_populate_default_irat_prior_params( void );
extern void    rr_set_rr_using_pseudo_si2q_data(boolean rr_using_pseudo_si2q_data );
extern boolean rr_is_pseudo_si2q_data_used( void );
extern boolean rr_default_irat_params_update_required( void );
extern void  rr_restore_default_serv_utran_pseudo_si2q_params(gprs_scell_info_t *serving_cell_ptr );
extern void rr_flush_default_irat_prior_params( void );

#endif /* FEATURE_FAST_G2L_PSEUDO_SI2Q */


#ifdef FEATURE_GERAN_IMPLICIT_PS_REJECT
extern uint32 rr_get_T3236_value(void );
#endif /*FEATURE_GERAN_IMPLICIT_PS_REJECT*/

#ifdef FEATURE_PS_PREFERRED_CELL
extern boolean rr_ps_preferred_allowed();
extern uint8 rr_num_ps_supported_cells_in_pscan();
extern void rr_set_num_ps_supported_cells_in_pscan(uint8 num_cells);
extern void rr_inc_num_ps_supported_cells_in_pscan();
extern void rr_dec_num_ps_supported_cells_in_pscan();
extern uint8 rr_num_ps_cells_si_received();
extern void rr_reset_num_ps_cells_si_received();
extern void rr_inc_num_ps_cells_si_received();
extern uint16 rr_num_frequencies_in_pscan();
extern void rr_set_num_frequencies_in_pscan(uint16 num_freqs);
#endif /* FEATURE_PS_PREFERRED_CELL */
extern void rr_perform_backup_for_scell(void);

#ifdef FEATURE_GERAN_GPS_PLMN_SCAN_SEARCH 
extern boolean rr_is_frequency_band_supported(ARFCN_T *arfcn, sys_band_mask_type band_pref);
extern boolean rr_is_any_frequency_band_supported(void);
