...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_cell_acq_if.c#2 $ */
...
void rr_cell_acq_send_imsg_abort_req( )
{
...
void rr_cell_acq_send_imsg_early_camping_bsi_received_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_imsg_surrounding_si_received_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_imsg_gsm_bsi_received_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_imsg_gprs_bsi_received_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_imsg_nacc_acq_complete_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_omsg_finished_ind(rr_cell_acq_status_e acq_status )
{
...
void rr_cell_acq_send_omsg_abort_cnf( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_omsg_mac_suspended_ind( )
{
  rr_message_header_t header;
...
void rr_cell_acq_send_omsg_reselected_ind( )
{
  rr_message_header_t header;
