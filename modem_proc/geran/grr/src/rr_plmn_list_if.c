...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_plmn_list_if.c#2 $ */
...
void rr_plmn_list_send_imsg(rr_plmn_list_imsg_e imsg  )
{
...
void 
rr_plmn_list_send_omsg(rr_plmn_list_omsg_e omsg  )
{
  rr_message_header_t header;
