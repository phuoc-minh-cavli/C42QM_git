...
/*===========================================================================
  ...
  $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_gprs_conn_establish.h#2 $
...
extern word       grr_get_egprs_access_ref(byte, byte *, byte );
...
extern void       grr_start_IA_timers(word, word, boolean, boolean, byte );
extern rr_event_T grr_conn_est_control(rr_event_T, void *  );

/* Functions defined in rr_conn_establish.c */
extern rr_event_T rr_ce_process_immediate_assignment(boolean, boolean, uint8*  );
extern rr_event_T rr_ce_process_immediate_assignment_extended(boolean, boolean  );
extern rr_event_T rr_ce_process_assignment_reject(boolean, boolean  );
extern boolean    rr_ce_get_waiting_for_mac_ul_tbf_cnf( );

extern void rr_gprs_two_part_assignment_failure( );
extern void rr_gprs_two_part_assignment_complete( );

extern void grr_start_t3146( );

extern boolean grr_return_tbf_data_structure_pointer( );
 ...
 */
extern void rr_tbf_est_activate_init( );
 ...
 */
extern void rr_tbf_est_discard_data( );
