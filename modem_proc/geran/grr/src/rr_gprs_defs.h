...
*** TITLE
***
*** $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_gprs_defs.h#6 $
***
*** DESCRIPTION
***
...
typedef struct
{
  ...
  uint32                         si_messages_required;         /* See rr_sys_info_si.c */
  uint32                         si_messages_low_priority;     /* See rr_sys_info_si.c */
  uint32                         si_messages_on_bcch_ext;      /* See rr_sys_info_si.c */
  uint32                         si_messages_not_broadcast;    /* See rr_sys_info_si.c */
...
#define RRPS_UPD_MS_LOW_PRIO                      (1 << 18)
...
extern void rr_process_mac_grr_store_update(mac_grr_store_update_t * );
...
extern void rr_public_store_update_nv_data( );
extern void rr_write_public_store(rrps_store_update_bitmap_t, rrps_store_update_data_t * );
extern void rr_public_store_lock_init(void);

/* In rr_sys_info_main.c */
extern void rr_init_gprs_sys_info_database( );
extern rr_event_T rr_gprs_sys_info_timer_handler(rr_timer_id_T  );
extern void rr_gprs_sys_info_new_paging_mode(paging_mode_T, paging_mode_T  );
extern void rr_gprs_activate_camped_sys_info_handling( );
extern void rr_gprs_suspend_camped_sys_info_handling(boolean );
extern void rr_gprs_resume_camped_sys_info_handling( );
extern void rr_gprs_deactivate_timed_sys_info_refresh( );
extern void rr_gprs_setup_sys_info_after_handover(ARFCN_T arfcn, BSIC_T bsic  );
extern void rr_gprs_invalidate_sys_info_during_cs_conn(rr_invalidate_si_reason_t invalidate_reason );
extern boolean grr_verify_sys_info_is_valid_for_l1_camp( );
extern boolean rr_gprs_scell_sys_info_acquisition_in_progress( );
extern boolean rr_is_this_the_scell(ARFCN_T  );
extern gprs_scell_info_t * rr_gprs_get_scell_info( );
extern ARFCN_T rr_gprs_get_scell_arfcn( );
extern BSIC_T rr_gprs_get_scell_bsic( );
extern PLMN_id_T rr_gprs_get_scell_plmn_id( );
extern gprs_cell_options_t *rr_si_get_gprs_cell_options( );
extern global_power_control_params_t * rr_si_get_power_control_params( );
#ifndef FEATURE_GERAN_REDUCED_DEBUG
extern boolean rr_si_diff_gprs_cell_options(gprs_cell_options_t *gprs_cell_options_ptr  );
#endif
extern boolean rr_gprs_camped_on_ccch( );
extern boolean rr_gsm_camped_on_ccch( );
extern boolean rr_cell_supports_gprs( );
extern boolean rr_cell_supports_egprs( );
#ifdef FEATURE_GSM_DTM
extern boolean rr_cell_supports_dtm( );
#endif // FEATURE_GSM_DTM
extern boolean rr_cell_si_valid( );
extern boolean rr_gprs_get_sys_info_for_mm(mm_gprs_sys_info_T *  );
extern network_op_mode_type rr_si_get_nmo( );
extern uint8 rr_gprs_decode_drx_timer(uint8);
extern uint8 rr_gprs_calc_non_drx_timer(uint8  );
extern boolean rr_gprs_l1_sys_info_update_allowed( );
extern boolean rr_gprs_mm_sys_info_update_allowed( );
extern boolean rr_gprs_mac_sys_info_update_allowed( );
extern void rr_gprs_sys_info_allow_all_updates( );
extern void rr_gprs_sys_info_block_all_updates( );
extern void grr_update_mm_with_rr_service_ind( );
extern void rr_si_update_public_store( );

/* In rr_gprs_freq_lists.c */
extern void rr_gprs_decode_freq_list_ie(byte *, uint8, cell_channel_description_T *  );
extern void rr_gprs_decode_mobile_alloc_freq_list(uint8 *, uint8, gprs_mobile_allocation_t *  );
...
extern void rr_gprs_reset_software( );
extern void rr_gprs_get_l1_params(ccch_pccch_params_t * );
extern void rr_gprs_start_gsm_idle_mode(gprs_scell_info_t *, boolean  );
extern void rr_start_ccch51_idle_mode(gprs_scell_info_t * );
extern void rr_gprs_update_l1_params( );
#ifndef FEATURE_GERAN_REDUCED_DEBUG
extern void rr_gprs_perform_logging(uint16 logging_mask, gprs_scell_info_t * );
#endif
extern boolean rr_gprs_general_timer_expiry_handler(rr_timer_id_T, rr_event_T * );
extern void grr_start_gprs_recent_activity_timer( );
extern void grr_stop_gprs_recent_activity_timer( );
extern boolean grr_has_there_been_recent_gprs_activity( );
extern void grr_start_guard_timer(dword, rr_event_T );
extern void grr_stop_guard_timer( );
extern void grr_throwaway_saved_message( );
extern boolean grr_is_ps_allowed_by_service_domain( );
extern void rr_gprs_odm_info_rach_attempt( );
extern void rr_gprs_odm_info_rach_success( );
extern void rr_gprs_odm_update_cell_type(boolean in_service  );
extern rrps_store_update_data_t *rr_get_rrps_store_update( );
extern void rr_free_rrps_store_update(rrps_store_update_data_t *  );
...
*/
extern rr_event_T rr_gprs_reselection_timer_handler(timer_expiry_T *timer_expiry  );

/* In rr_gprs_meas_rpt_control.c */
extern uint8 rr_gprs_get_nc_mode( );
extern rr_event_T rr_gprs_nc_measurement_control(
  rr_event_T nc_meas_event,
  void* new_message
   
);
extern rr_l1_freq_power_T rr_gprs_get_serving_measurements( );
...
extern void rr_gprs_nacc_check_pcco_reject(ARFCN_T, ARFCN_T );

extern byte rr_gprs_get_network_control_order( );

extern byte rr_gprs_3g_meas_get_rep_quant(int  );
extern boolean rr_gprs_3g_meas_report_encode(three_g_measurement_report_t *  );

/* In rr_shared_cell_selection.c */
extern void rr_get_penalty_timer_id(rr_timer_id_T * );
 ...
 *
 ****************************************************************************/
boolean rr_get_gprs_system_info_database_valid( );
 ...
 *
 ****************************************************************************/
gprs_system_info_database_t *rr_get_gprs_system_info_database_ptr( );
...
extern boolean grr_can_process_rr_resel_abort_req( void );
extern boolean grr_can_process_rr_abort_req( void );
extern boolean grr_can_process_rr_grr_gprs_ia_ind( void );
extern boolean grr_can_process_rr_event_ind( void );
extern boolean grr_can_process_mm_message( void );
extern boolean grr_can_process_timer_expiry( void );
extern boolean grr_can_process_serving_meas_ind( void );
extern boolean grr_can_process_surround_meas_ind( void );
extern boolean grr_can_process_change_mode_ind( void );
#ifdef FEATURE_EXTERNAL_PAGING_GERAN
extern boolean grr_can_process_proc_ind_with_suspend(void);
#endif /* FEATURE_EXTERNAL_PAGING_GERAN */
#ifdef FEATURE_GSM_GPRS_READ_CCCH_IN_XFER 
extern boolean rr_is_read_pch_during_transfer_allowed( void );
