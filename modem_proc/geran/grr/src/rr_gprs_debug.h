...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_gprs_debug.h#4 $ */
...
#define RR_LOG_STATE_TRANSITION(xx_state_machine, xx_old_state, xx_new_state, xx_state_name_fn) \
  MSG_SPRINTF_3(MSG_SSID_DFLT, \
                MSG_LEGACY_HIGH, \
                "gs1:RRState: " xx_state_machine "(%s->%s)", \
                xx_state_name_fn(xx_old_state), \
                xx_state_name_fn(xx_new_state)); \
  MSG_3(MSG_SSID_DFLT, \
        MSG_LEGACY_HIGH, \
        "gs1:RRState: " xx_state_machine "(%d->%d)", \
        xx_old_state, \
        xx_new_state)
#else
#define RR_LOG_STATE_TRANSITION(xx_state_machine, xx_old_state, xx_new_state, xx_state_name_fn) \
...
*/
extern void rr_debug_log_rr_mac_omsg(grr_mac_sig_id_t msg_id );

/**
  @brief Logs an occurence of panic reset.
*/
extern void rr_debug_log_panic_reset(void );
