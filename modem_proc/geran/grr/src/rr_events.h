...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_events.h#2 $ */
...
typedef enum
{
  ...
  RR_EV_DMM_SPECIFIC_CHANNEL_SEARCH          = 0x26,
 ...
 /*Reduced mobility related events*/
   EV_START_RESELECTION                     = 0x0901,
   EV_BCCH_CHANGE_DETECTED                  = 0x0902,
