...
*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_sys_info_i.h#4 $ */
...
extern void rr_gprs_start_sys_info_refresh_timer( );
extern void rr_gprs_stop_sys_info_refresh_timer( );
extern void rr_gprs_start_sys_info_retry_timer(uint32  );
extern void rr_gprs_stop_sys_info_retry_timer( );
extern void rr_gprs_start_sys_info_acquisition_timer(uint32  );
extern void rr_gprs_stop_sys_info_acquisition_timer( );
extern grr_siev_t rr_gprs_camped_sys_info_acquisition_complete( );
...
extern grr_siev_t grr_align_sys_info_acquisition_with_cell_capabilities( );

/* In rr_sys_info_pcell.c */
extern void rr_init_pcell_data( );

/* In rr_sys_info_si.c */
extern void bsi_reset_message_tracking_data( );
extern void rr_init_sys_info_si( );
extern void rr_gprs_bcch_sys_info_post_processing(rr_si_type_t, ARFCN_T );
extern void rr_process_si13_from_bcch(ARFCN_T bcch_arfcn, dl_unit_data_ind_T  *message_ptr );
extern void rr_gprs_process_psi13_ccch_camped(si13_data_t *, gprs_scell_info_t * );
...
extern rr_event_T rr_gprs_bsi_acquisition_timer_handler(rr_timer_id_T );
extern void bsi_enter_paging_reorg( );
extern void bsi_exit_paging_reorg( );
...
extern void bsi_activate_camped_sys_info_handling( );
extern grr_siev_t bsi_acquisition_control(grr_siev_t, const void *  );
