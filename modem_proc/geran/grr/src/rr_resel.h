...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_resel.h#2 $ */
...
*/
void rr_gprs_reset_nmeas_in_reselection_list( );
...
extern boolean resel_type_C2_based(void);
...
*/
boolean rr_inhibit_utran_reselection( );
