...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_decode_bcch_if.h#2 $ */
...
extern void rr_decode_bcch_send_abort_req( void );
extern void rr_decode_bcch_send_candidate_cell_si_ind( void );

/* Output messages. */
extern void rr_decode_bcch_send_finish_ind(
  rr_arfcn_list_t *detected_frequency_list
);
extern void rr_decode_bcch_send_abort_cnf( void );
