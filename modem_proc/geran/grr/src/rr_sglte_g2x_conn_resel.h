...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_sglte_g2x_conn_resel.h#2 $ */
...
*/
extern void rr_sglte_rr_conn_g2x_resel_init( );

/**
  @brief This is the main SGLTE RR G2XConnected Mode Cell Reselection state machine.
*/          
extern rr_event_T rr_sglte_rr_conn_g2x_resel_control(rr_event_T grr_control_event, rr_cmd_bdy_type *new_message   );

/*!
  * \brief Indicates if the PLMN search should be inhibited when SGLTE G2X reselection
  *        feature is active.
  */
extern boolean rr_sglte_g2x_resel_conn_inhibit_plmn_search( );
extern boolean rr_sglte_g2x_conn_mode_resel_can_process_plmn_search( );
