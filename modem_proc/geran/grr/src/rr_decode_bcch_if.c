...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_decode_bcch_if.c#2 $ */
...
void rr_decode_bcch_send_abort_req( )
{
...
void rr_decode_bcch_send_candidate_cell_si_ind( )
{
...
void rr_decode_bcch_send_abort_cnf( )
{
