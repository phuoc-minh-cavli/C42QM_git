...
============================================================================*/
/* $Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_l1_send.h#5 $ */
...
extern void rr_send_mph_psm_entry_ind();
...
extern void rr_l1_send_mph_nv_refresh_req( );
#endif /* FEATURE_MODEM_CONFIG_REFRESH */

extern void rr_l1_send_mph_deep_sleep_ind( );
...
*/
extern rr_l1_idle_status_e rr_l1_send_get_l1_idle_status( );
 ...
 */
extern boolean rr_l1_send_get_current_timing_advance_info(byte *timing_advance_ptr  );

/**
  @brief Initialisation function.
*/ 
extern void rr_l1_send_init( void );
...
extern void rr_send_mph_xmsi_update_ind( );

#ifdef FEATURE_GERAN_POWER_EFFICIENT_OPERATION 
extern void rr_send_mph_serving_meas_req( );
