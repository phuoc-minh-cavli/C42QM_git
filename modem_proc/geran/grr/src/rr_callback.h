...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_callback.h#2 $   $DateTime: 2018/10/10 02:31:27 $ $Author: pwbldsvc $
...
extern void rr_init_cell_change_cb_data( void );
