...
$Header: //components/rel/geran.mpss/5.2.0/grr/src/rr_sglte.h#2 $
...
/**
  @brief Sends GERAN_GRR_LTE_SGLTE_SERVING_MEAS_RSP indicating that service
         is not available.
*/
extern void rr_send_lte_sglte_serving_meas_rsp_no_service( );
extern void rr_send_lte_sglte_neighbor_meas_rsp_no_service( );

/**
  @brief Sends GERAN_GRR_TDS_SGLTE_SERVING_MEAS_RSP indicating that service
         is not available.
*/
extern void rr_send_tds_sglte_serving_meas_rsp_no_service( );
...
extern void rr_sglte_set_rat_priority_list_gsm_only( );

extern void rr_sglte_reject_lte_resel_req( );

extern void rr_sglte_reject_lte_redir_req( );

extern void rr_sglte_reject_lte_plmn_srch_req( );

extern void rr_sglte_reject_tds_resel_req( );

extern void rr_sglte_reject_tds_redir_req( );

extern void rr_sglte_reject_tds_plmn_srch_req( );
...
extern boolean rr_sglte_multimode_using_g_only_device( );
