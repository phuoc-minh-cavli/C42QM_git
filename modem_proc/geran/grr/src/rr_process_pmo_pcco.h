 ...
 */
extern gprs_3g_meas_params_mods_t *rr_gprs_get_pmo_gprs_3g_meas_params(void );
 ...
 * \return void* 
 */
extern void rr_psi_clear_pmo_data_going_inactive( void );
 ...
 * \return gprs_3g_meas_params_mods_t* 
 */
extern gprs_3g_meas_params_mods_t *rr_gprs_get_pcco_gprs_3g_meas_params(void );
 ...
 */
extern nc_meas_params_mods_t *rr_gprs_get_pmo_nc_meas_params(void );
...
*/
extern boolean rr_get_pmo_priority_and_eutran_params_valid(void );
 ...
 */
extern gprs_meas_params_mods_t *rr_gprs_get_pmo_gprs_meas_params(void );
 ...
 * \return nc_meas_params_mods_t* 
 */
extern nc_meas_params_mods_t *rr_gprs_get_pcco_nc_meas_params(void );
 ...
 * \return gprs_meas_params_mods_t* 
 */
extern gprs_meas_params_mods_t *rr_gprs_get_pcco_gprs_meas_params(void );
 ...
 */
extern pmo_pcco_nacc_params_t *rr_gprs_get_pcco_nacc_params(void );
 ...
 * \return pmo_pcco_nacc_params_t* 
 */
extern pmo_pcco_nacc_params_t *rr_gprs_get_pmo_nacc_params(void );

/*!
 * \brief Discards all PCCO-related data.
 * 
 */
extern void rr_psi_discard_pcco_data(void );

/*!
 * \brief Discards all PMO-related data.
 * 
 */
extern void rr_psi_discard_pmo_data(void );

/*!
 * \brief Clears the cell list received in the previous PCCO.
 * 
 */
extern void rr_gprs_reset_pcco_nc_frequency_list(void );
 ...
 * 
 */
extern void rr_gprs_pcco_apply_ba_gprs_deltas(void );
...
/*CR550108*/
extern boolean rr_is_pmo_nc_frequency_list_valid( void );
extern pmo_pcco_data_t *rr_get_pmo_data( void );
extern pmo_pcco_data_t *rr_psi_get_pmo_store_ptr( void );
