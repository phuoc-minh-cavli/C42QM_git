...
$Header: //components/rel/geran.mpss/5.2.0/gdiag/src/umtsdiag.c#3 $
...
void umtsdiag_deinit (void)
{
  DIAGPKT_DISPATCH_TABLE_DEREGISTER((int32)DIAG_SUBSYS_UMTS, umtsdiag_tbl);
}
