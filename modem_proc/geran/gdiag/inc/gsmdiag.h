...
$Header: //components/rel/geran.mpss/5.2.0/gdiag/inc/gsmdiag.h#5 $
...
#error code not present
#endif /* FEATURE_GSM_SIMULATE_GL1_RF */
#define DIAG_GSM_MAX_F             7 /* Must be one greater than highest cmd */
...
extern void gsmdiag_deinit (void);
extern void umtsdiag_deinit (void);
