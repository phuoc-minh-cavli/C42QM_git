...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_intf_cmd.h#1 $

when       who     what, where, why
-------    ---     -------------------------------------------------------------
04/22/19   dh      Added support for QAT3516 Drivers
12/06/18   Om      Add RFFE V2 support
...
typedef enum
{
  RFDEVICE_COMM_PROTO_VERSION_DEFAULT,
  RFDEVICE_COMM_PROTO_VERSION_2,
  RFDEVICE_COMM_PROTO_VERSION_2_BURST,
  RFDEVICE_COMM_PROTO_VERSION_MAX,
  RFDEVICE_COMM_PROTO_VERSION_INVALID = 0xFFFFFFFF
}rfdevice_comm_proto_version; 
