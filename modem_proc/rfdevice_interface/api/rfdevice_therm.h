...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_therm.h#1 $

when       who    what, where, why
--------   ---   ---------------------------------------------------------------
07/10/19   dh     IOTFEM therm mitigaiton fixes
10/25/18   up     Mainlined SDR105 therm interface changes
...
public:
    ...
    */
    ...
    virtual boolean execute_pa_on_therm_sequence ()
    {
      return TRUE;
    };
