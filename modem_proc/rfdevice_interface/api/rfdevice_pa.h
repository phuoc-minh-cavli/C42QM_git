...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_pa.h#1 $

when       who    what, where, why
--------   ---   ---------------------------------------------------------------
05/06/19   dh    Added init() API
09/10/18   dh    Added rfdevice_lte_pa_set_gain_trigger() API
05/29/18   mms    Added an interface to check if device is IOTFE PA
07/13/18   dh    Added an interface to check if device is IOTFE PA
...
public:
    ...
    */
    ...
    virtual boolean is_internal_pa_device();

    virtual boolean pa_gain_range_trigger
    (
    rfdevice_pa_cfg* pa_params_p,
   ...
   /*!
     @brief
     interface function for pa init
