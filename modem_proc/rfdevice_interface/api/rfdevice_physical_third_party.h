...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_physical_third_party.h#1 $ 

when       who   what, where, why
--------   ---   ---------------------------------------------------------------
02/25/19   dh     Added support to fetch logical device associated to a physical device
...
public:
  ...
  rfdevice_class** get_logical_components();
