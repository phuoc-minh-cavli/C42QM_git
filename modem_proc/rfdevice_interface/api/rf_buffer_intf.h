...
/*==============================================================================
  ...
  $Header: //components/rel/rfdevice_interface.mpss/1.40/api/rf_buffer_intf.h#1 $
...
typedef enum
{
  ...
  /*! RFFE script in RF Buffer Group */
...
public:
  ...
  virtual boolean append_rffe_group
  (
    rf_buffer_transaction_type rd_wr,
    uint8 slave_id,
    uint8 channel,
  ...
  {
    RF_MSG(RF_ERROR,"append_rffe_group() method not implemented");
    return FALSE;
  }
