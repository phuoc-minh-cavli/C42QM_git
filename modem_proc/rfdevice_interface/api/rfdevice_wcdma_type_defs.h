...
/*============================================================================== 
  ...
  Copyright (c) 2010 - 2015, 2018 Qualcomm Technologies Incorporated. All Rights Reserved 
...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_wcdma_type_defs.h#1 $ 
   
when       who     what, where, why 
--------   ---     -------------------------------------------------------------
06/21/18   vp      Featurization of WCDMA code
