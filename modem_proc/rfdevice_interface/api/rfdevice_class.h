...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_class.h#1 $

when       who     what, where, why
-------------------------------------------------------------------------------- 
04/22/19   dh      Added support for QAT3516 Drivers
...
typedef enum
{
  RFDEVICE_REG_ADDR_SUCCESS,
  RFDEVICE_REG_ADDR_ERROR_FATAL,
  RFDEVICE_REG_ADDR_N0_SUPPORT,
  RFDEVICE_REG_ADDR_RETURN_INVALID,
} rfdevice_reg_addr_return_enum_type;
...
class rfdevice_class: public rfa
{
  ...
  public: 
    ...
    virtual void update_phy_dev_reg_list(void);
...
extern uint32 rfdevice_instance_num_get(void*);
