...
$Header: //components/rel/rfdevice_interface.mpss/1.40/api/rfdevice_asm.h#1 $

when       who    what, where, why
--------   ---   -------------------------------------------------------------------
05/06/19   dh     Added init() and is_internal_asm_device() APIs
...
public:
  ...
  */
  ...
  /*!
    @brief
    interface function for asm init
  ...
  */
  ...
  /*----------------------------------------------------------------------------*/
    ...
    @return
    boolean indicating internal asm or not
  */

  virtual boolean is_internal_asm_device()
  {
    return FALSE;
  };
