...
$Header: //components/rel/utils.mpss/2.3.4/api/a2/a2_platform.h#1 $
...
/*=============================================================================
  ...
  FUNCTION:  a2_platform_dal_init

=============================================================================*/
/*!
    @brief
    Initializes the A2 DAL interface. 

    This fn must be called ONLY once during powerup.
*/
/*===========================================================================*/
void a2_platform_dal_init ( void );
