...
$Header: //components/rel/utils.mpss/2.3.4/api/a2/a2_common.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
09/25/18   rs      CR2307576 LTE Camping fix
...
/*!
  ...
  */
#define A2_MAX_SRC_IOVEC_COUNT_PER_DMA_CHAIN 50
...
===========================================================================*/
 typedef uint8 a2_sub_id_t; // Need it for ATF files
