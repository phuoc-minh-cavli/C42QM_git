...
$Header: //components/rel/utils.mpss/2.3.4/api/a2/a2_ipa_if.h#2 $
...
/*=============================================================================
  ...
  FUNCTION:  a2_ipfilter_match

=============================================================================*/
/*!
    @brief
    Calls DS api for filter match

*/ 
/*===========================================================================*/
boolean a2_ipfilter_match
(
  sio_stream_id_type          stream_id,       /*!< stream_id */
  dsm_item_type               *trblk_dsm_ptr   /*!< dsm ptr for ip pkt */
);
