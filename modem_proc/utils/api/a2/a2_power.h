...
$Header: //components/rel/utils.mpss/2.3.4/api/a2/a2_power.h#1 $
...
typedef enum
{
  ...
  A2_POWER_CLIENT_NB1_ML1_UL     = 11,
  A2_POWER_CLIENT_APPS_SMSM      = 12,
  A2_POWER_CLIENT_A2_UL_PER      = 13,
  A2_POWER_CLIENT_A2_DL_PER      = 14,
  A2_POWER_CLIENT_A2_INACTIVITY  = 15,
  A2_POWER_CLIENT_A2_IP_FILTER   = 16,
  A2_POWER_CLIENT_PC_PENDING_TEMP= 17, /* Temporary client to keep A2 ON during
                                       DL PER PC pending state, while dl per
                                       module finishes the sleep procedure */
  A2_POWER_CLIENT_BOOTUP_TEMP    = 18, /* Temporary client to keep A2 ON during
                                       modem bootup, till DS opens the first sio
                                       port */
  A2_POWER_CLIENT_MOUNT_UNMOUNT  = 19, /* Client for mount/unmount feature */
  A2_POWER_CLIENT_MAX
} a2_power_client_e;
