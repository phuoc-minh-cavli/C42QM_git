...
$Header: //components/rel/utils.mpss/2.3.4/api/a2/a2_dl_per.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
04/22/19   ns      CR2438740 Change in pointer for cb registration api 
...
typedef void (* a2_dl_per_wm_dereg_done_cb)( uint8  epsid );
/*===========================================================================
...
void a2_dl_per_deregister_ds_pdcp_watermark
(
  /*! The epsid on which this watermark should be deregistered. */
  uint8 epsid
);

void a2_dl_per_register_wm_dereg_done_cb
(
  a2_dl_per_wm_dereg_done_cb cb
);
