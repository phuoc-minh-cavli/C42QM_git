...
$Header: //components/rel/utils.mpss/2.3.4/api/public/a2_sio.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
10/17/19   rs      CR2543732: A2 SIO port registration callback changes 
...
/*!
  @brief
  Function prototype for SIO callback function for port request configuration.
*/
typedef void (*a2_sio_port_cfg_cb)
(
  /*! Port ID for which callback called */
...
/*==============================================================================
  ...
  FUNCTION:  a2_sio_register_port_cfg_cb

==============================================================================*/
/*!
  @brief Function to register callback for SIO port reg/de-reg requests.

*/
/*============================================================================*/
void a2_sio_register_port_cfg_cb 
( 
  /*! sio callback to be called on port request */
  a2_sio_port_cfg_cb   cb
);

/*==============================================================================

  FUNCTION:  a2_sio_port_req_notify_cb

==============================================================================*/
/*!
  @brief Function to call SIO callback registered for port request

*/
/*============================================================================*/
void a2_sio_port_req_notify_cb 
(
  /*! Port ID */
  sio_port_id_type  port_id
);
...
/*==============================================================================
  ...
  FUNCTION:  a2_sio_port_req_log_start_time

==============================================================================*/
/*!
  @brief Function to log SIO port request start timestamp.

*/
/*============================================================================*/
void a2_sio_port_req_log_start_time 
(
  /*! Port id */
  sio_port_id_type   port_id
);
...
==============================================================================*/
/*!
  @brief Function to log SIO port request end timestamp.

*/
/*============================================================================*/
void a2_sio_port_req_log_end_time 
(
  /*! Port id */
  sio_port_id_type  port_id
);
