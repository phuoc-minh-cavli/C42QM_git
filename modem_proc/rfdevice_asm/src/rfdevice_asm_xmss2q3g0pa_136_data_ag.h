...
#ifndef RFDEVICE_ASM_XMSS2Q3G0PA_136_DATA_AG
#define RFDEVICE_ASM_XMSS2Q3G0PA_136_DATA_AG
...
class rfdevice_asm_xmss2q3g0pa_136_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_xmss2q3g0pa_136_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_xmss2q3g0pa_136_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_xmss2q3g0pa_136_data_ptr;
