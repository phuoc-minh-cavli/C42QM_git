...
$Header: //components/rel/rfdevice_asm.mpss/1.30/api/rfdevice_asm_common.h#1 $
$Author: pwbldsvc $
...
08/29/18   dh      Added support for GNSS mode
...
#define MAX_PATH_SIZE 100
  ...
  public:
   ...
   boolean is_internal_asm_device();
  ...
  protected:
    ...
    uint8 gnss_band_port[RFCOM_BAND_GNSS_MAX];
  ...
  private:
    ...
    void update_internal_asm_flag();

    boolean is_internal_asm; /*flag to indicate whether is it IOTFE ASM*/
