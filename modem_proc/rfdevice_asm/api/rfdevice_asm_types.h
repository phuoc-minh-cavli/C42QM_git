...
$Header: //components/rel/rfdevice_asm.mpss/1.30/api/rfdevice_asm_types.h#1 $

when       who     what, where, why
-------------------------------------------------------------------------------
10/23/19   dh      Updated RFDEVICE_ASM_REG_INVALID value 
07/13/18   dh      Added support of RFDEVICE_ASM_WAKEUP_DATA
...
#define RFDEVICE_ASM_REG_INVALID 0xFF
