...
$Header: //components/rel/mmcp.mpss/6.1.10/cust/inc/custmmode.h#1 $
...
** ---------------------------------------------------------------------*/
  ...
  */
  ...
  #define FEATURE_MMODE_TX_21
  #endif

#ifdef FEATURE_DISABLE_LTE_IMS 
#define FEATURE_MMODE_DISABLE_LTE_VOICE
#endif
/* -----------------------------------------------------------------------
...
** ---------------------------------------------------------------------*/
  ...
  #define FEATURE_MMODE_GW
  #endif

  #if (defined(FEATURE_GSM) || defined(FEATURE_WCDMA) || defined(FEATURE_TDSCDMA) || defined(FEATURE_LTE))
  #define FEATURE_MMODE_3GPP
  #endif
...
** ------------------------------------------------------------------------*/
  ...
  */
  ...
  #define FEATURE_MMODE_DISABLE_CSG  
  #endif
  #if 0
  #if defined FEATURE_MMODE_DUAL_SIM || defined FEATURE_MMODE_SC_SVLTE || defined FEATURE_MMSS_3_1
  #define FEATURE_MMODE_HYBR2_ENABLED
  #endif

  #if defined(FEATURE_MMODE_SXLTE_G) || defined(FEATURE_MMODE_TRIPLE_SIM)
  #define FEATURE_MMODE_HYBR3_ENABLED
  #endif
  #endif
  #if (!defined (FEATURE_WCDMA) && !defined (FEATURE_GSM) && ! defined(FEATURE_MMODE_CDMA) && !defined(FEATURE_TDSCDMA) && defined (FEATURE_LTE))
  #define FEATURE_MMODE_LTE_ONLY
  #endif

  
  #if (!defined (FEATURE_WCDMA) && ! defined(FEATURE_MMODE_CDMA) && !defined(FEATURE_TDSCDMA) && defined (FEATURE_GSM) && defined (FEATURE_LTE))
  #define FEATURE_MMODE_GPRS_LTE
  #endif

  #ifdef FEATURE_MMODE_LTE_ONLY
  #define FEATURE_MMODE_DISABLE_MANUAL_BST
  //#define FEATURE_MMODE_DISABLE_LTE_VOICE
  //#define FEATURE_MMODE_DISABLE_LTE_SUPS
  #define FEATURE_MMODE_DISABLE_PRL
  //#define FEATURE_CM_DISABLE_SUPS
  #define FEATURE_CM_DISABLE_SMS    
  #define FEATURE_CM_DISABLE_GPS

  #define FEATURE_CM_DISABLE_IMS_EXT
  #define FEATURE_MMODE_DISABLE_IMS_EXT
  #define FEATURE_MMODE_DISABLE_MISC_FEATURES
  #define FEATURE_MMODE_DISABLE_VoWLAN
  #define FEATURE_MMODE_M1
  #ifndef FEATURE_MMODE_DISABLE_NON_LTE_VOICE
  #define FEATURE_MMODE_DISABLE_NON_LTE_VOICE
  #endif
  #endif

  #define FEATURE_MMODE_DISABLE_LTE_SUPS
  #define FEATURE_MMODE_DISABLE_NON_LTE_SUPS

  #ifdef FEATURE_MMODE_GPRS_LTE
  #define FEATURE_MMODE_DISABLE_MANUAL_BST
  //#define FEATURE_MMODE_DISABLE_LTE_VOICE
  #define FEATURE_MMODE_DISABLE_PRL
  #define FEATURE_CM_DISABLE_SUPS
  ...
  #undef FEATURE_MMODE_M1
  #endif 
  
  #if (defined(FEATURE_MMODE_CDMA_800) || defined(FEATURE_MMODE_CDMA_1900))
  #define FEATURE_MMODE_3GPP2
  #endif
...
#ifndef FEATURE_MMCP_DISABLE_CS_USSD
  #define FEATURE_MMODE_USS_SUPS 1
  #define FEATURE_MMODE_USS_CS_SUPS 1
  #endif
  #ifdef FEATURE_USSD_PS_ENABLED
  #define FEATURE_MMODE_USS_SUPS 1
  #define FEATURE_MMODE_USS_PS_SUPS 1
  #endif
#endif /* CUSTMMODE_H */
