...
$Header: //components/rel/mmcp.mpss/6.1.10/cust/inc/custnas.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#if !defined(IMS_IOE_VoLTE)
#define FEATURE_NAS_IMS_VOICE_DISABLED
#endif
/** define FEATURE_NAS_IMS_VOICE_DISABLED when IMS_IOE_VoLTE is not defined.*/
...
#define FEATURE_VAAA  
/** This feature flag is introduced for the new audio design (single voice session) */
...
#define FEATURE_WWAN_GNSS_DYNAMIC

#if ((defined(FEATURE_LTE) || defined(FEATURE_GSM)) && !(defined(FEATURE_WCDMA)\
     || defined(FEATURE_CDMA) || defined(FEATURE_HDR) || defined(FEATURE_TDSCDMA)))
#define FEATURE_CIOT
/* Enable the Cellular Interent-of-Things Functionality */
#endif
