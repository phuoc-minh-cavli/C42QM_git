...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmxdbm.c#1 $
...
)
{
  ...
  */
  ...
  CM_MSG_LOW_1("START cmdbm_mc_rpt_proc(), cmd=%d",
  ...
  switch(cm_mc_rpt_ptr->hdr.cmd)
  {
    ...
    */
    ...
    default:
      CM_MSG_LOW_0("cmdbm_sd_rpt_proc(), do nothing");
      break;
  }
}
...
)
{
  ...
  CM_MSG_LOW_1("START cmdbm_sd_rpt_proc(), cmd=%d", sd_rpt_ptr->hdr.cmd);
