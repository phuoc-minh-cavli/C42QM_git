...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmclient.c#1 $
...
#define CM_CLIENT_IDS_MAX ((int) CM_CLIENT_TYPE_MAX )
...
static void bit_arr_set_bits_from_mask(
...
)
{
  ...
  for(i=0;(i<bit_arr_ptr->bit_size);i++)
  {
    if(bit_mask_256_bit_is_present(&event_mask,i))
    {
      bit_arr_set_bits(bit_arr_ptr,is_set_bits_on,i,i);
    }
  }
}
...
)
{
  ...
  */
  ...
  #if (defined (CM_GW_SUPPORTED) ||defined(FEATURE_IP_CALL)) && (defined(FEATURE_MMODE_USS_SUPS) || defined(FEATURE_MMODE_SS_SUPS))
  ...
  */
  ...
  #if (defined (FEATURE_MBMS)) && (defined (CM_GW_SUPPORTED))
 
  bit_arr_init( &client_ptr->mbms_bit_arr,    /* Suppl Serv bit array struct */
                  client_ptr->mbms_bit_buf,                      /* bit buffer */
                  (8 * ARR_SIZE(client_ptr->mbms_bit_buf)) ); /* bit size */
  #endif
  ...
  */
  ...
  #if (defined (CM_GW_SUPPORTED) ||defined(FEATURE_IP_CALL)) && (defined(FEATURE_MMODE_SS_SUPS)||defined(FEATURE_MMODE_USS_SUPS))
  ...
  */
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
   case CM_APPS_PWR_STATUS_PWR_COLLAPSE:
      ...
      {
        ph_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
        CM_MSG_HIGH_3("pc ph evt %d ct %d cid id %d",
                  ph_event,
      ...
      */
      ...
      {
        CM_MSG_HIGH_3(" Dropping pc ph evt %d ct %d cid id %d",
                   ph_event,
                   cmclient_get_client_type(ph_info_ptr->requesting_client_id),
                   ph_info_ptr->requesting_client_id);
      }
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_HIGH_3(" Dropping ph evt %d ct %d cid id %d",
                   ph_event,
                   cmclient_get_client_type(ph_info_ptr->requesting_client_id),
                   ph_info_ptr->requesting_client_id);
      }
  ...
  */
      ...
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->bcmcs_power_collpase_notify_pref) ) )
  {
          ...
          bit_arr_is_bit_on(&client_ptr->bcmcs_bit_arr, (int)bcmcs_event) )
    {
      ...
      CM_MSG_LOW_3("bcmcs evt %d ct %d cid id %d",
                  bcmcs_event,
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    case CM_APPS_PWR_STATUS_PWR_COLLAPSE:
      ...
      {
        bcmcs_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
        CM_MSG_LOW_3("pc bcmcs evt %d ct %d cid id %d",
                  bcmcs_event,
                  cmclient_get_client_type(bcmcs_info_ptr->requesting_client_id),
                  bcmcs_info_ptr->requesting_client_id);
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_LOW_3("Dropping bcmcs evt %d ct %d cid id %d",
                    bcmcs_event,
                    cmclient_get_client_type(bcmcs_info_ptr->requesting_client_id),
                    bcmcs_info_ptr->requesting_client_id);
      }
  ...
  */
      ...
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->inband_power_collpase_notify_pref) ) )
  {
          ...
          bit_arr_is_bit_on(&client_ptr->inband_bit_arr, (int)inband_event) )
    {
      ...
      CM_MSG_LOW_3("ib evt %d ct %d cid id %d",
                  inband_event,
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    ...
    {
      inband_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
      CM_MSG_LOW_3("pc ib evt %d ct %d cid id %d",
                  inband_event,
                  cmclient_get_client_type(inband_info_ptr->requesting_client_id),
                  inband_info_ptr->requesting_client_id);
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_LOW_3("dropping ib evt %d ct %d cid id %d",
                   inband_event,
                   cmclient_get_client_type(inband_info_ptr->requesting_client_id),
                   inband_info_ptr->requesting_client_id);
      }
  ...
  */
      ...
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->sms_power_collpase_notify_pref) ) )
  {
          ...
          bit_arr_is_bit_on(&client_ptr->sms_bit_arr, (int)sms_event) )
    {
      ...
      CM_MSG_LOW_3("sms evt %d ct %d cid id %d",
                  sms_event,
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    ...
    {
      sms_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
      CM_MSG_LOW_3("pc sms evt %d ct %d cid id %d",
                  sms_event,
                  cmclient_get_client_type(sms_info_ptr->requesting_client_id),
                  sms_info_ptr->requesting_client_id);
    ...
    */
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_MED_3("Dropping pd evt %d ct %d cid id %d",
                   pd_event,
                   cmclient_get_client_type(pd_info_ptr->requesting_client_id),
                   pd_info_ptr->requesting_client_id);
      }
  ...
  */
      ...
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->dbm_power_collpase_notify_pref) ) )
  {
        ...
        bit_arr_is_bit_on(&client_ptr->dbm_class_bit_arr, (int)dbm_class))
    {
      ...
      CM_MSG_MED_3("dbm evt %d ct %d cid id %d",
                  dbm_event,
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    ...
    {
      dbm_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
      CM_MSG_MED_3("pc dbm evt %d ct %d cid id %d",
                  dbm_event,
                  cmclient_get_client_type(dbm_info_ptr->requesting_client_id),
                  dbm_info_ptr->requesting_client_id);
  ...
  */
      ...
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->sups_power_collpase_notify_pref) ) )
  {
          ...
          bit_arr_is_bit_on(&client_ptr->sups_bit_arr, (int)sups_event) )
    {
      ...
      CM_MSG_LOW_3("sups evt %d ct %d cid id %d",
                  sups_event,
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    ...
    {
      sups_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
      CM_MSG_LOW_3("pc sups evt %d ct %d cid id %d",
                  sups_event,
                  cmclient_get_client_type(sups_info_ptr->requesting_client_id),
                  sups_info_ptr->requesting_client_id);
    ...
    */
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_LOW_3("Dropping sups evt %d ct %d cid id %d",
                    sups_event,
                    cmclient_get_client_type(sups_info_ptr->requesting_client_id),
                    sups_info_ptr->requesting_client_id);
      }
...
FUNCTION cm_client_mbms_cmd_err_ntfy
...
===========================================================================*/
/*lint --e{528} suppress cm_client_mbms_cmd_err_ntfy not referenced
** warning
*/
static void cm_client_mbms_cmd_err_ntfy(
...
/*lint -esym(715,mbms_cmd_err) */
{
  ...
  CM_ASSERT( BETWEEN((int)mbms_cmd_err, (int)CM_MBMS_CMD_ERR_NONE, (int)CM_MBMS_CMD_ERR_MAX) );
  ...
  */
  ...
  if( client_ptr != mbms_cmd_ptr->client_ptr )
  {
    if( client_ptr->mbms_cmd_err_func != NULL )
    {
      client_ptr->mbms_cmd_err_func( mbms_cmd_ptr->client_id,
                                   mbms_cmd_ptr->cmd,
                                   mbms_cmd_err );
    }
  }
...
FUNCTION cm_client_mbms_event_ntfy

DESCRIPTION
  Notify a client of a specified MBMS event iff the client is registered
  for this event.
...
===========================================================================*/
static void cm_client_mbms_event_ntfy(

    const cm_client_s_type     *client_ptr,
        /* pointer to a client struct */

    cm_mbms_event_e_type          mbms_event,
        /* notify client of this NAS event */
...
{
  CM_ASSERT( client_ptr != NULL );
  CM_ASSERT( BETWEEN(mbms_event, CM_MBMS_EVENT_NONE, CM_MBMS_EVENT_MAX) );
  CM_ASSERT( mbms_info_ptr != NULL );
  ...
  */
  if( cmph_dem_get_apps_pwr_status() == CM_APPS_PWR_STATUS_PWR_RESTORE ||
      client_ptr->client_processor    == CM_PROCESSOR_MODEM             ||
      ( cmph_dem_get_apps_pwr_status()  != CM_APPS_PWR_STATUS_PWR_SUSPEND &&
      IS_PWR_COLLAPSE_NTFY_PREF_NULL(client_ptr->mbms_power_collpase_notify_pref) ) )
  {
    if( client_ptr->mbms_event_func != NULL &&
          bit_arr_is_bit_on(&client_ptr->mbms_bit_arr, (int)mbms_event) )
    {
      mbms_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
      CM_MSG_LOW_3("mbms evt %d ct %d cid id %d",
                  mbms_event,
                  cmclient_get_client_type(mbms_info_ptr->requesting_client_id),
                  mbms_info_ptr->requesting_client_id);
      client_ptr->mbms_event_func( mbms_event, mbms_info_ptr );
    }
  ...
  switch( cmph_dem_get_apps_pwr_status() )
  {
    case CM_APPS_PWR_STATUS_PWR_COLLAPSE:
      ...
      if( client_ptr->power_collapse_mbms_event_func != NULL &&
          bit_arr_is_bit_on(&client_ptr->mbms_power_collapse_bit_arr, (int)mbms_event) )
      {
        mbms_info_ptr->requesting_client_id = cmclient_get_client_id( client_ptr );
        CM_MSG_MED_3("pc mbms evt %d ct %d cid id %d",
                  mbms_event,
                  cmclient_get_client_type(mbms_info_ptr->requesting_client_id),
                  mbms_info_ptr->requesting_client_id);
        client_ptr->power_collapse_mbms_event_func( mbms_event, mbms_info_ptr );
      }
      /* Check if the client is registered for this nas event during power restore
      ** but is being suppressed during power collapse. Such events are buffered
      */
      else if( client_ptr->client_processor != CM_PROCESSOR_MODEM &&
               bit_arr_is_bit_on(&client_ptr->mbms_bit_arr, (int)mbms_event) &&
               !bit_arr_is_bit_on(&client_ptr->mbms_power_collapse_bit_arr, (int)mbms_event) )
      {
        /* Set the bit-mask to indicate that the sups events are ignored.
        */
        bit_arr_set_bits( &client_ptr->mbms_power_collapse_buf_bit_arr,
                          TRUE,
                          (int)mbms_event,
                          (int)mbms_event);
      }
    ...
    case CM_APPS_PWR_STATUS_PWR_SUSPEND:
      ...
      */
      ...
      {
        CM_MSG_LOW_3("Dropping mbms evt %d ct %d cid id %d",
                    mbms_event,
                    cmclient_get_client_type(mbms_info_ptr->requesting_client_id),
                    mbms_info_ptr->requesting_client_id);
      }
...
/*lint -esym(818, mbms_info_ptr) */
{
  ...
  /*
  ** 571: Suspicious cast
  ** Cast mbms_event as word so we can use generic function to print it
  */
  /*lint -save -e571 */
  CMDBG_PRINT_CM_EVENT_FUNC( CM_CMD_TYPE_MBMS,
    (word) mbms_event, (const void *) mbms_info_ptr );
  /*lint -restore */
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  */
  ...
  {
    client_ptr = cmclient_get_client_ptr(client_id);
    mbms_info_ptr->requesting_client_id = client_id;
    if(client_ptr != NULL)
    {
      cm_client_mbms_event_ntfy( client_ptr, mbms_event, mbms_info_ptr );
    }
  }
...
*/
{
  ...
  CM_ASSERT( mbms_cmd_ptr != NULL );
  CM_ASSERT( BETWEEN(mbms_cmd_err, CM_MBMS_CMD_ERR_NONE, CM_MBMS_CMD_ERR_MAX) );
  /*lint -save -e571 */
  CMDBG_PRINT_CM_CMDERR_FUNC( CM_CMD_TYPE_MBMS, (word) mbms_cmd_err,
    (const void *) mbms_cmd_ptr );
  /*lint -restore */
  ...
  */
  for(client_id = 0; client_id < ARR_SIZE(cmclient_map_arr); client_id++)
  {
    ...
    if(client_ptr != NULL)
    {
      cm_client_mbms_cmd_err_ntfy( client_ptr,
                                 mbms_cmd_ptr,
                                 mbms_cmd_err );
    }
  }
...
FUNCTION cm_client_send_cmd_mask
...
SIDE EFFECTS
  none
===========================================================================*/
static cm_client_status_e_type cm_client_send_cmd_mask(
...
)
{
  ...
  reg_data->event_reg_type = event_reg_type;
  reg_data->event_mask = event_mask;
  reg_data->event_func = event_func;
  reg_data->cmd_err_func = cmd_err_func;
...
{
  return cm_client_send_cmd_mask(client_id, event_reg_type,
                            call_event,
...
{
  return cm_client_send_cmd_mask(client_id, event_reg_type,event_mask, ph_event_func,
...
)
{
  ...
  return cm_client_send_cmd_mask(client_id, event_reg_type, event_mask,
                            ss_event_func, ss_cmd_err_func, CM_CLIENT_CMD_SS_REG);
  return CM_CLIENT_OK;
}
...
{
  #if (defined CM_GW_SUPPORTED && defined FEATURE_CM_APPS_POWER_COLLAPSE) && (defined(FEATURE_MMODE_USS_SUPS)||defined(FEATURE_MMODE_SS_SUPS))
#error code not present
#else
  return CM_CLIENT_ERR_FUNCTION_UNAVAILABLE_DUE_TO_UNDEFINED_FEATURE;
  #endif
...
/*lint -esym(715,mbms_cmd_err_func)*/
{
  ...
  return cm_client_send_cmd(client_id, event_reg_type, (int)from_mbms_event,
                            (int)to_mbms_event, (int)CM_MBMS_EVENT_NONE,
                            (int)CM_MBMS_EVENT_MAX, mbms_event_func,
                            mbms_cmd_err_func, CM_CLIENT_CMD_MBMS_REG);
...
)
{
  ...
  switch(client_cmd->cmd)
  {
    ...
    case CM_CLIENT_CMD_CALL_REG:
      {
        bit_arr_set_bits_from_mask( &client_ptr->call_bit_arr,
                          reg_flag,
                          reg_data->event_mask);
    ...
    case CM_CLIENT_CMD_PH_REG:
      {
        bit_arr_set_bits_from_mask(&client_ptr->ph_bit_arr,
                            reg_flag,
                            reg_data->event_mask);
    ...
    case CM_CLIENT_CMD_SS_REG_MSIM:
      ...
      case CM_CLIENT_CMD_SS_REG:
        {
          bit_arr_set_bits_from_mask(&client_ptr->ss_bit_arr,
                            reg_flag,
                            reg_data->event_mask);
    ...
    #ifdef FEATURE_MBMS
    case CM_CLIENT_CMD_MBMS_REG:
      {
        bit_arr_set_bits( &client_ptr->mbms_bit_arr,
                          reg_flag,
                          reg_data->from_event,
                          reg_data->to_event);
        client_ptr->mbms_event_func = reg_data->event_func;
        client_ptr->mbms_cmd_err_func = reg_data->cmd_err_func;
      }
      break;
    #endif /* FEATURE_MBMS */
    #endif /* #if defined (CM_GW_SUPPORTED) ||defined(FEATURE_IP_CALL) */
