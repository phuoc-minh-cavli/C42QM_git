...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmefs.h#1 $
...
typedef enum {
  ...
  */
  ...
  CMEFS_MMODE_CIOT_LTE_PREF,
  /** CIOT LTE optimisation configuration */
  ...
  */
  ...
  CMEFS_SCAN_SCOPE_RULE,
  /**< Scan Scope type: FULL_BAND/ACQ_DB for BPLMN/OOS scans */
  ...
  */
  ...
  CMEFS_FULL_RAT_ACQ_FAIL_CNT,
  /**< Acq fail count to enter Full RAT */

  CMEFS_CURRENT_ACQ_FAIL_CNT,
  /**< Current Acq Fail count */

  CMEFS_RPM_FEATURE_ENABLED,
  /** RPM feature enabled */

  CMEFS_PSM_RTC_CONFIG,
  /**< PSM RTC configuration*/

  CMEFS_PSM_CONTEXT,
  /**< PSM CONTEXT */

  CMEFS_PSM_CONFIG_EXT2,
  /**< PSM configuration extended*/

  CMEFS_PSM_CONTEXT_EXT,
  /**< PSM CONTEXT extended*/
...
typedef PACKED struct PACKED_POST
{
  ...
  uint8                     opti[2];
  /* Optimization flags reserved for mmode CIOT optimizations*/
  
} mmode_ciot_lte_preferences_s_type;
