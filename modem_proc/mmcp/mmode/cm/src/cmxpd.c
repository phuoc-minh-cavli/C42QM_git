...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmxpd.c#1 $
...
)
{
  ...
  boolean is_cdma_subs_available = ph_ptr->is_cdma_subscription_available;
  #endif
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
        ...
        case CM_PD_SESSION_TYPE_WITH_SYS_TIME:
          ...
          */
          (void) cmph_force_pref_on_the_fly(
                                ...
                                SYS_CSG_ID_INVALID,
                                SYS_RAT_NONE,
                                cmph_ptr()->main_stack_info.pref_info.ciot_lte_pref
                             );
...
)
{
  ...
  CM_MSG_LOW_1("START cmpd_mc_rpt_proc(), cmd=%d",
...
)
{
  ...
  CM_MSG_LOW_1("START cmpd_sd_rpt_proc(), cmd=%d", sd_rpt_ptr->hdr.cmd);
