...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmtaski.h#1 $
...
#define CM_CLIENT_CMD_Q_SIG   BM(0)           /* CM client command signal */
#define CM_RPT_Q_SIG          BM(1)       /* CM lower layer report signal */

#define CM_TIMER_SIG          BM(2)                  /* Time to update CM */
#define CM_RSSI_TIMER_SIG     BM(3)      /* Time to check and update RSSI */

#define CM_MMGSDI_REPORT_SIG  BM(4)     /* Responds to MMGSDI operations */

#define CM_GWL_RSSI_TIMER_SIG BM(5)      /* Time to check and update RSSI */

#define CM_REGPRX_CMD_Q_SIG   BM(6)         /* CM RegProxy command q sig. */

#define CM_NV_SYNC_RESERVED   BM(7)     /* CM_UI_NV_SIG - defined in cm.h */
#define CM_NV_ASYNC_SIG       BM(8)          /* Asynchronous NV operation */

#define CM_ACM_TIMER_SIG      BM(10) /* Signal sent when ACM timer expires */
#define CM_CCM_TIMER_SIG      BM(11) /* Signal sent when CCM timer expires */
#define CM_RUIM_STATUS_SIG    BM(9)                /* CM RUIM Done signal */

#define CM_GSDI_RESERVED_SIG  BM(12)  /* Responds to synchronous responses */

#define CM_MSGR_Q_SIG         BM(21)        
  /* Signal for Message Router Q. */


/* BM(14) or 0x4000 is used for TASK_STOP_SIG. 
 * Do not use this number for any signal */
...
#define CM_MMGSDI_ABORT_TIMER_SIG          BM(15)           

#ifdef FEATURE_MODEM_STATISTICS
/* This is specifically disabled for 9x05 and being re-used for MMOC/QMI */
#define CM_STATS_GSM_SIG    BM(19)      /* CM STATS GSM signal */
#define CM_STATS_WCDMA_SIG  BM(20)     /* CM STATS WCDMA signal */
#define CM_STATS_CDMA_SIG   BM(21)     /* CM STATS CDMA signal  */
#define CM_STATS_HDR_SIG    BM(22)     /* CM STATS HDRsignal    */
#define CM_STATS_DS_SIG     BM(23)     /* CM STATS DS signal    */
#define CM_STATS_LTE_SIG    BM(25)    /* CM STATS LTE signal    */
#define CM_STATS_NAS_SIG    BM(26)    /* CM STATS NAS signal */
#define CM_STATS_NAS2_SIG   BM(21)      /* CM STATS NAS signal */
#define CM_STATS_GSM2_SIG   BM(22)      /* CM STATS GSM2 signal */
#define CM_STATS_GSM3_SIG   BM(28)    /* CM STATS GSM3 signal */
#define CM_STATS_NAS3_SIG   BM(27)      /* CM STATS NAS signal */
#define CM_STATS_WCDMA2_SIG BM(30)    /* CM STATS WCDMA2 signal */
#endif

#if defined(FEATURE_IP_CALL) && defined(FEATURE_CM_LTE)
#define CM_SRVCC_CACHE_SIG     BM(29)
#endif
...
#define cm_mem_malloc_ext(x) cm_mem_malloc_debug_ext(__FILENAME__ , __LINE__ ,x, #x ) 
#if(defined _ARM_ASM_)
#define cm_mem_free_ext(z) cm_mem_free_debug_ext(z, #z, __func__, __LINE__)
#elif (defined __GNUC__) || (defined T_WINNT)
#define cm_mem_free_ext(z) cm_mem_free_debug_ext(z, #z, __FUNCTION__, __LINE__)
#endif

#define cm_mem_malloc(x) cm_mem_malloc_debug(__FILENAME__ , __LINE__ ,x, #x )
...
FUNCTION cm_mem_malloc_debug_ext
...
extern void* cm_mem_malloc_debug_ext(const char *file,uint32 line,size_t size,char *objname);

/*===========================================================================

FUNCTION cm_mem_free_debug_ext
...
extern void cm_mem_free_debug_ext(void* ptr,char *objname,const char *funcName, int lineNumber );
...
extern void cm_si_network_list_cb(
    ...
    sys_found_plmn_list_u_type  *plmn_list_ptr,
       /* Pointer to a structure containing the list of PLMNs.
       */
