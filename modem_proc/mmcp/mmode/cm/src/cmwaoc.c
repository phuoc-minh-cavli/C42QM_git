...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmwaoc.c#1 $
...
static mmgsdi_file_enum_type acm_filename = MMGSDI_NO_FILE_ENUM;
...
{ 
  ...
  {
    case MMGSDI_APP_SIM:
      acm_filename = MMGSDI_GSM_ACM;
      break;
	  
    case MMGSDI_APP_USIM:
      acm_filename = MMGSDI_USIM_ACM;
      break;
...
)
{
  ...
  if(CMPH_SS_PHONE_CHARGE(asubs_id,ph_ptr).aoc_ready)
  {
    ...
    if(cmmmgsdi_increase(asubs_id,
                        (acm_filename == MMGSDI_USIM_ACM)?MMGSDI_USIM_ACM:MMGSDI_GSM_ACM,
