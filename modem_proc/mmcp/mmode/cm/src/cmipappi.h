...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmipappi.h#1 $
...
typedef struct cmipapp_s {
  ...
  cmipapp_ecmp_e_type                ecmp;
    /* ECMP (Emergency call mode preference) value informed by IMS to CM.
    ** Emergency call routing would be dependent on this value when the 
    ** e911 over wifi feature is enabled (EFS configured).
    ** The default value at CM would be set to 3GPP.
    */
