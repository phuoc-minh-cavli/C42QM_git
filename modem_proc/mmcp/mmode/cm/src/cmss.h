...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmss.h#1 $
...
typedef struct cmss_s  {
  ...
  dword						hdr_srv_inform_uptime;
   ...
   dword					   hybr_gw_no_srv_uptime;
	 ...
	 */
 #endif
 #if ((defined(FEATURE_GSM) || defined(FEATURE_WCDMA)|| defined(FEATURE_CM_LTE)) && defined(FEATURE_MMODE_HYBR2_ENABLED))
...
#if ((defined(FEATURE_GSM) || defined(FEATURE_WCDMA)|| defined(FEATURE_CM_LTE))&& defined(FEATURE_MMODE_HYBR3_ENABLED))
...
sys_mm_information_s_type   *prev_mm_information_ptr;
  ...
  uint16                      hybr_3_gw_rssi;
    ...
    */
...
#if defined(FEATURE_WCDMA) || defined(FEATURE_TDSCDMA)
	int16						gw_sir;//wt- needed for IRAT between G<->W
	...
	int16						gw_rscp;//wt- needed for IRAT between G<->W
  ...
  **- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  sys_srv_status_e_type       prev_main_srv_status;
    /* Previous Main service status
    */
...
#if defined(FEATURE_WCDMA) || defined(FEATURE_TDSCDMA)
  boolean                     gw_ecio_for_display;//wt
  ...
  **- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  boolean                     is_colloc;
    ...
    */
#endif
#if (defined(FEATURE_DEDICATED_C2K_MODE) && defined(FEATURE_MMODE_3GPP2))
...
#endif
#ifdef FEATURE_MMODE_3GPP2
  sys_srv_status_e_type       prev_hybr_1_srv_status;
    /* Previous Hybr_1 service status
    */
#endif
#ifdef FEATURE_MMODE_3GPP2
 ...
 #ifdef FEATURE_MMODE_HYBR2_ENABLED
  sys_srv_status_e_type       prev_hybr_gw_srv_status;
    /* Previous Hybr GW service status
    */
 #endif
...
#ifdef FEATURE_MMODE_HYBR3_ENABLED
  sys_srv_status_e_type       prev_hybr_3_gw_srv_status;
    /* Previous Hybr GW 3 service status
    */
#endif
...
FUNCTION cmss_msgr_ml1_tx_stats_proc

DESCRIPTION
  Process reports from the LTE ML1 lower layers.
...
===========================================================================*/
void cmss_msgr_ml1_tx_stats_proc(
...
void cmss_read_rat_srv_ind_uptimers(void);
/*===========================================================================
