...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmxsms.c#1 $
...
)
{
  ...
  CM_MSG_LOW_1("START cmsms_mc_rpt_proc(), cmd=%d",
...
)
{
  ...
  CM_MSG_LOW_1("START cmsms_sd_rpt_proc(), cmd=%d", sd_rpt_ptr->hdr.cmd);
