...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmsds.h#1 $
...
DESCRIPTION
   Return what type of CSFB ( 3GPP CSFB or 1XCSFB)  call  is supported
...
extern cm_call_csfb_e_type cmsds_get_csfb_type_allowed(
  sys_modem_as_id_e_type  asubs_id
);
...
extern void cmsds_process_tau_complete_ind(emm_tau_complete_ind_s_type *tau_complete_ind);
#endif /* CM_DOMSEL_H */
