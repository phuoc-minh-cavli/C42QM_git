...
$Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmdiag.h#1 $
...
#define CM_CALL_CMD_MODIFY_REQ              20
#define CM_CALL_CMD_MODIFY_RSP              21
#endif
...
#if (defined CM_GW_SUPPORTED && defined FEATURE_MULTIMEDIA_FALLBACK)
/* Response packet */
DIAGPKT_SUBSYS_RSP_DEFINE(CM, CM_CALL_CMD_MODIFY_REQ)
  int  status;
DIAGPKT_RSP_END
...
#if ((defined CM_GW_SUPPORTED) && defined (FEATURE_MULTIMEDIA_FALLBACK))
/* Response packet */
DIAGPKT_SUBSYS_RSP_DEFINE(CM, CM_CALL_CMD_MODIFY_RSP)
  int  status;
DIAGPKT_RSP_END
#endif  /* (defined CM_GW_SUPPORTED) && defined (FEATURE_MULTIMEDIA_FALLBACK)) */
