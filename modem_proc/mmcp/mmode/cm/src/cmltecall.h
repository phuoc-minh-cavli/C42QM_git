...
DESCRIPTION
  Finds the call id for a given eps bearer id.
...
===========================================================================*/
boolean cmltecall_get_call_id_per_bearer_id(
...
FUNCTION cmltecall_copy_ext_protocol_config_options

DESCRIPTION
  Copy the extend lte protocol_config_options from source to destination structure.
...
===========================================================================*/
extern void cmltecall_copy_ext_protocol_config_options(

    ext_protocol_cfg_options_T                 *dest_cfg_options,
        /* Pointer to the destination cfg_options */

    const ext_protocol_cfg_options_T           *src_cfg_options
        /* Pointer to the source cfg_options  */
);
