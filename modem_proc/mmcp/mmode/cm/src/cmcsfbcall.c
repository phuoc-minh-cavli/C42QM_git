...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmcsfbcall.c#1 $
    ...
    )
{
  ...
  if ((cm_is_esr_allowed_in_srlte()
      ...
      && call_ptr->call_type == CM_CALL_TYPE_VOICE) == FALSE 
      &&
  ...
  */
  ...
  CM_MSG_HIGH_2( "CM->MSGR: NAS_ESM_1XCSFB_CALL_REQ. Call ID %d, CSFB Srv Type %d",
...
FUNCTION cmcsfbcall_send_orig_req_for_mt_call
...
===========================================================================*/
void cmcsfbcall_send_orig_req_for_mt_call (
...
}/* cmcsfbcall_send_orig_req_for_mt_call */
      ...
      */
	  ...
	  cmcsfbcall_send_redial_req_for_mt_call(call_ptr->call_id);
          ...
          if(ph_orig_ptr != NULL)
          {
            ...
            CM_MSG_HIGH_2("MT_REDIAL:Forcing MT 1XCSFB call preferences call_type =%d fav mode pref %d", \
				           call_ptr->call_type, ph_orig_ptr->orig->orig_mode_pref);
