...
$Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmmsc.h#1 $
...
===========================================================================*/
#define CMMSC_STACK_NUM   1               /* Max num of stacks, ie. 3 */
...
typedef struct
{
  ...
  sys_lte_band_mask_e_type               lte_m1_band_pref;
    /**< Indicate lte_m1_band_pref */

  sys_lte_band_mask_e_type               lte_nb1_band_pref;
    /**< Indicate lte_nb1_band_pref */
...
typedef struct cmmsc_stack_common_info_s
{
  ...
  sys_lte_band_mask_e_type          ue_lte_m1_band_capability;
  sys_lte_band_mask_e_type          ue_lte_nb1_band_capability;
