...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/sys.c#1 $
...
sys_lte_band_mask_e_type sys_lte_band_pref_lte_const_any()
{
  ...
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND71 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND72 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND73 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND85 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND86 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND87 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,SYS_SBAND_LTE_EUTRAN_BAND88 );
...
FUNCTION sys_lte_band_pref_lte_m1_const_any
...
===========================================================================*/
sys_lte_band_mask_e_type sys_lte_band_pref_lte_m1_const_any()
{
  sys_lte_band_mask_e_type lte_band_pref_any;
  int i;
  ...
  for ( i=SYS_SBAND_LTE_EUTRAN_BAND1;
        i<= SYS_SBAND_LTE_EUTRAN_BAND5;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }

  for ( i=SYS_SBAND_LTE_EUTRAN_BAND7;
         i<= SYS_SBAND_LTE_EUTRAN_BAND8;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }

  for ( i=SYS_SBAND_LTE_EUTRAN_BAND11;
         i<= SYS_SBAND_LTE_EUTRAN_BAND14;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }

  for ( i=SYS_SBAND_LTE_EUTRAN_BAND18;
        i<= SYS_SBAND_LTE_EUTRAN_BAND21;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }

  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND25 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND26 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND27 );
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND28);
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND31);
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND39);
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND41);
...
FUNCTION sys_lte_band_pref_lte_nb1_const_any
...
===========================================================================*/
sys_lte_band_mask_e_type sys_lte_band_pref_lte_nb1_const_any()
{
  sys_lte_band_mask_e_type lte_band_pref_any;
  int i;
  ...
  SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)SYS_SBAND_LTE_EUTRAN_BAND8 );

  for ( i=SYS_SBAND_LTE_EUTRAN_BAND12;
        i<= SYS_SBAND_LTE_EUTRAN_BAND13;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }

  for ( i=SYS_SBAND_LTE_EUTRAN_BAND17;
        i<= SYS_SBAND_LTE_EUTRAN_BAND20;i++)
  {
    SYS_LTE_BAND_MASK_ADD_BAND(&lte_band_pref_any,(sys_sband_lte_e_type)i );
  }
  ...
  */
  ...
  case SYS_BAND_LTE_EUTRAN_BAND30:
    ...
    case SYS_BAND_LTE_EUTRAN_BAND71:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND71;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND72:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND72;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND73:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND73;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND85:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND85;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND86:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND86;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND87:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND87;
      break;

    case SYS_BAND_LTE_EUTRAN_BAND88:
      lte_sband = SYS_SBAND_LTE_EUTRAN_BAND88;
      break;
...
)
{
  ...
  switch (band_pref)
  {
     ...
     case SYS_BAND_MASK_ANY:
       ...
       break;
     case CM_BAND_PREF_LTE_NB1_ANY:
       lte_band_pref = SYS_LTE_NB1_BAND_MASK_CONST_ANY;	   
       break;
	  case CM_BAND_PREF_LTE_M1_ANY:
	   lte_band_pref = SYS_LTE_M1_BAND_MASK_CONST_ANY;
	   break;
     default:
       #if(LTE_BAND_NUM == 256)
