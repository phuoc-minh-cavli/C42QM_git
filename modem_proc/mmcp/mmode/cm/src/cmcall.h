...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/cm/src/cmcall.h#1 $
...
#define CMCALL_SR_FORCE_RSSI_THR        100  /* -dB */
...
/** Enumeration of csfb call type
*/
typedef enum cm_call_csfb_e {

  CM_CALL_CSFB_TYPE_NONE,
    /**< @internal */

  CM_CALL_CSFB_TYPE_1XCSFB,
    /**< CSFB call type is CDMA */

  CM_CALL_CSFB_TYPE_PPCSFB,
    /**< CSFB call type is PPCSFB */

  CM_CALL_CSFB_TYPE_MAX
    /**< @internal */
...
typedef struct cmcall_action_table_entry_s {
    ...
    cmcall_act_e_type  action;
            /* Action to take - redial, force-AUTO, etc */
...
/* Holds all the information related to unwanted_call (Robocall)
*/
typedef struct mt_unwanted_call_verstat_info
{
...
typedef struct cmcall_s {
    ...
    cm_srv_type_e_type                 srv_type;
      /* service type - CDMA, automatic, etc.
      */
    ...
    cm_npi_type                        answer_num_pi;
    /**< Presentation Indicator for answer number. */
  ...
  cm_call_verstat_s_type mt_call_verstat;
  /* unwanted_robocall_call features */


  boolean is_ip_orig_sent;
  /* Indicates that orig was sent to IMS for IP call */
...
/* Overall psm restore context information - holds the information
** associated with psm restore request
*/
typedef struct cm_restore_psm_ctxt_req_s
{
...
} cm_restore_psm_ctxt_req_s_type;
...
boolean cmcall_gps_search_call_cleanup_required();
