...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_nas_msg.h#1 $ $Change: 46174567 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define NAS_LTE_MAX_VAL_EDRX_PTW   (15)
#define NAS_LTE_MAX_VAL_EDRX_CYCLE (15)
#define NAS_GSM_MAX_VAL_EDRX_CYCLE (11)
...
enum qmi_nas_radio_if_e
{
  ...
  QMI_NAS_RADIO_IF_LTE_M1         = 10,
  QMI_NAS_RADIO_IF_LTE_NB1        = 11,
...
#define QMI_NAS_LIMIT_BY_CIOT_LTE_CAP               (0x2000000000ull)
#define QMI_NAS_LIMIT_BY_CAMPED_CIOT_LTE_OP_MODE    (0x4000000000ull)
...
struct nas_0031_rsp_p_s {
  ...
  PACK(struct) nas_0031_rsp_t13_p_s {
     uint32 ciot_lte_op_mode;
  } t13;
...
struct nas_0068_ind_p_s {
  ...
  PACK(struct) nas_0068_ind_t12_p_s {
    uint32 ciot_lte_op_mode;
  } t12;
