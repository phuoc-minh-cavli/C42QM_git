...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_voice_cmd_list.c#1 $ $DateTime:$ $Author:$
...
#if !defined (FEATURE_NO_QMI_VOICE) || defined(FEATURE_MMODE_USS_SUPS)
