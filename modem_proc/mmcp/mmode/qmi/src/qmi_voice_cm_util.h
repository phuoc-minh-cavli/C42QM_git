...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_voice_cm_util.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
(
  ie_call_barring_num_info_T *cm_data, qmi_voice_cm_if_icb_sc_s *qmi_data, const uint8 copy_len
);

boolean qmi_voice_cm_util_copy_barr_num_list_from_qmi_to_cm
(
  qmi_voice_cm_if_icb_ind_s *qmi_data, cm_called_party_bcd_no_s_type *cm_data, const uint8 copy_len
);
#endif
