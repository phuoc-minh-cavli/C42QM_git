...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_nas_utils.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
===========================================================================*/
nas_service_status_enum_type_v01 qmi_nas_get_srv_status_from_cmss_event( cm_mm_ss_info_s_type *p_info, sys_sys_mode_e_type sys_mode );
