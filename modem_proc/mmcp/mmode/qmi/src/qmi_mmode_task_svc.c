...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_mmode_task_svc.c#1 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  #else
  if ( (cmd_ptr = (qmi_mmodei_cmd_type *)modem_mem_alloc(sizeof(qmi_mmodei_cmd_type), MODEM_MEM_CLIENT_QMI) )== NULL)
  #endif
  {
...
{
  nv_cmd_type qmi_mmode_nv_cmd_buf;
