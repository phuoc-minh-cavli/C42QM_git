...
/*=========================================================================== 
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_nas_nw_name.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $ 
...
)
{
  ...
  QM_MSG_HIGH_1("Received new eons op stack %d", eons[qmi_session][NEW_RECORD].first_stack_info.is_valid);
}
//#endif
/*=========================================================================== 
