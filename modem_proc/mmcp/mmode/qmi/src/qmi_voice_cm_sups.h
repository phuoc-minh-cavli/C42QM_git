...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/qmi/src/qmi_voice_cm_sups.h#1 $ $DateTime: 2010/03/16 22:23:17 $ $Author: ndanturi $
...
/* This enum represents the CLIR provisioningstatus at the network */
