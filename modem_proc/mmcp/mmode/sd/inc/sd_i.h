...
$Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/inc/sd_i.h#1 $
...
typedef struct {
  ...
  ** after mode switch */
  ...
  #endif
    /* Flag to indicate whether srv off is for oprt mode change to LPM or pwr down
  */
  boolean                              is_power_down;
