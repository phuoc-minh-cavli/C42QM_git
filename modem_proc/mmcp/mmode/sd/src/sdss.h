...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/src/sdss.h#2 $
...
#if (!defined (FEATURE_WCDMA) && !defined (FEATURE_GSM) && !defined (FEATURE_TDSCDMA) && !defined(FEATURE_CDMA) && defined (FEATURE_LTE))
#define SDSS_DFLT_NUM_RAT 2
#elif (!defined (FEATURE_WCDMA) && defined (FEATURE_GSM) && !defined (FEATURE_TDSCDMA) && !defined(FEATURE_CDMA) && defined (FEATURE_LTE))
#define SDSS_DFLT_NUM_RAT 3
#else
#define SDSS_DFLT_NUM_RAT 8
#endif
...
/* Struct of limited scan optimization
*/
typedef struct {
...
*/
#define SDSS_EVT_IS_XXX_ACQ( event ) (SDSS_EVT_IS_GWL_ACQ(event) )
...
*/
#define SDSS_EVT_IS_XXX_OPR( event ) (SDSS_EVT_IS_GWL_OPR(event) )
                                    //SDSS_EVT_IS_CDMA_OPR(event) || \
                                    //SDSS_EVT_IS_HDR_OPR(event)  || \
...
typedef enum {
  ...
  SDSS_PREF_UPDATED_RAT_PRI_LIST,
  SDSS_PREF_UPDATED_MODE_CHG,
  SDSS_PREF_UPDATED_BAND_CHG,
  #ifdef FEATURE_MMODE_9X05_NOTREQ
...
typedef dword sdss_pref_updated_mask_type;
...
typedef enum {
  ...
  SDSS_RESEL_MODE_FULL_SRV =  50,  /* Limited to full srv reselection */
  SDSS_RESEL_MODE_MAX
...
/* Enumeration of values that require incrementing.
*/
typedef enum {

  SDSS_INC_COUNT_FULL_BAND_OOS,         /* increment full band OOS count */

  SDSS_INC_COUNT_FULL_BAND_BSR,         /* increment full band BSR count*/

  SDSS_INC_COUNT_MAX                    /* internal range checking use only */

} sdss_inc_count_val_e_type;
...
/*---------------------------------------------------------------------------
                         LOOP NUMBER CONFIG TYPE
---------------------------------------------------------------------------*/

/* Enumeration of loop number configs
*/
typedef enum {
  ...
  SDSS_LOOP_NUM_CFG_SCAN_COUNT, /* # of full scans to be performed in each stage of OOS recovery */
...
typedef enum {
  ...
  #endif
  SDSS_IF_COND_SRCH_LST_IS_VALID,
    /* Check whether the SRCH_LST is not empty and can be acquired with current prefs */
...
FUNCTION sdss_get_ciot_lte_pref

DESCRIPTION
  Read the ciot lte pref of the SS-Core.
...
===========================================================================*/
extern  void                          sdss_get_ciot_lte_pref(
...
FUNCTION sdss_get_net_ciot_lte_pref
...
===========================================================================*/
extern  void                          sdss_get_net_ciot_lte_pref(
...
FUNCTION sdss_is_pref_update_pref_reas
...
===========================================================================*/
boolean                   sdss_is_pref_update_pref_reas(void);
...
FUNCTION sdss_is_lte_only_rat_pri_listr
...
===========================================================================*/
extern  boolean    sdss_is_lte_only_rat_pri_list(
...
===========================================================================*/
extern  sdss_pref_updated_mask_type      sdss_pref_update(
...
FUNCTION sdss_is_supp_mode_band_pref_lte_ciot
...
===========================================================================*/
extern  boolean                   sdss_is_supp_mode_band_pref_lte_ciot(
...
FUNCTION sdss_is_supp_mode_band_ciot

DESCRIPTION
  Check whether a specified combination of mode and band is supported by the
  current target along with ciot capabilities.
...
===========================================================================*/
extern  boolean                   sdss_is_supp_mode_band_ciot(
...
===========================================================================*/
extern boolean *sdss_misc_move_to_unrestricted(void);
...
===========================================================================*/
EXTERN void sdss_read_efs_scan_scope_rule ( sys_modem_as_id_e_type asubs_id );
...
===========================================================================*/
extern void                sdss_read_efs_operator_name ( void );
...
===========================================================================*/
extern boolean sdss_is_skip_mmss_srv_req(void);
...
===========================================================================*/
extern          uint16 sdss_get_scan_scope_rule(sd_ss_e_type ss);
...
===========================================================================*/
extern boolean sdss_is_scan_scope_rule_avail(sd_ss_e_type ss);
/*===========================================================================
...
===========================================================================*/
extern  void                          sdss_common_nv_refresh( void );
/*===========================================================================
...
FUNCTION sdss_get_curr_oos_timer

DESCRIPTION
  Returns the pwr save timer that should be used 
...
===========================================================================*/
extern dword               sdss_get_curr_oos_timer(
...
FUNCTION sdss_is_sr_supp

DESCRIPTION
  Check whether the mode band pref of the system record is supported 
...
===========================================================================*/
boolean    sdss_is_sr_supp(
  sdsr_s_type         *sr_ptr
);

/*===========================================================================

FUNCTION sdss_srch_lst_is_valid

DESCRIPTION
  Check whether the SRCH_LST is not empty and can be acquired with 
  current prefs.
...
===========================================================================*/
boolean sdss_srch_lst_is_valid(
  sd_ss_e_type         ss,
  sdss_cmp_criteria_e_type cmp_criteria
);
#endif /* SDSS_H */