...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/src/sd.c#1 $
...
)
{
  ...
  */
  ...
  #if defined FEATURE_MMODE_3GPP2 && !defined(FEATURE_MMODE_REMOVE_1X)
  ss_ptr->gpp2.return_cause              = CAI_NORMAL_ACCESS_RETURN;
  #endif
  ...
  ss_ptr->gpp2.hdr_act_mask              = SD_SS_HDR_ACT_MASK_NONE;
  #endif

  #if defined FEATURE_MMODE_3GPP2
  ss_ptr->gpp2.cdma_act_mask             = SD_SS_CDMA_ACT_MASK_NONE;
  #endif
   ...
   )
{
  ...
  sd_cmd_t          *cmd = modem_mem_alloc(sizeof(sd_cmd_t), MODEM_MEM_CLIENT_MMODE);
  ...
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);
  return act;
}
...
)
{
  ...
  */
  ...
  #ifdef FEATURE_MMODE_3GPP2
  log_ptr->sd_state_flags.is_redir = !sdss_is_redir(ss,SDSS_REDIR_VAL_NONE);
  log_ptr->sd_state_flags.is_ho = !sdss_is_handoff(SDSS_HO_VAL_NONE);
  #else
  log_ptr->sd_state_flags.is_ho = SDSS_HO_VAL_NONE;
  #endif
...
{
  sd_ss_act_e_type    act;
  sd_ss_meas_list_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_meas_list_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_meas_list_cmd));
  
  /* Fill in the command header    */
  cmd->ss = SD_SS_MAIN;
  cmd->act = SD_SS_ACT_MAX;
  cmd->rtrn_act_ptr = NULL;
  cmd->pos = pos;
...
)
{
  ...
  act = sdcmd_hybr_2_meas_list_get2(cmd);  
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);  
...
)
{
  ...
  act = sdcmd_hybr_3_meas_list_get(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type          act;
  sd_ss_meas_list_rprt_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_meas_list_rprt_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_meas_list_rprt_cmd));
...
)
{
  ...
  cmd->meas_val = meas_val;
   ...
   act = sdcmd_hybr_2_meas_list_rprt(cmd);
   modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
)
{
  ...
  cmd->meas_val = meas_val;
    ...
    act = sdcmd_hybr_3_meas_list_rprt(cmd);
    modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
{
  sd_ss_ind_user_pwr_up_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_user_pwr_up_cmd), MODEM_MEM_CLIENT_MMODE);
  sd_ss_act_e_type          act;
  ...
  if (cmd == NULL)
   ...
   /* intialize the memory allocated   */
   memset(cmd, 0, sizeof(sd_ss_ind_user_pwr_up_cmd));
...
)
{
  ...
  act = sdcmd_hybr_2_user_pwr_up(cmd);  
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
)
{
  ...
  act = sdcmd_hybr_3_user_pwr_up(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);   
...
{
  sd_ss_ind_user_prot_deactivate_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_user_prot_deactivate_cmd), MODEM_MEM_CLIENT_MMODE);
  sd_ss_act_e_type            act;
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_user_prot_deactivate_cmd));
  ...
  act = sdcmd_hybr_2_user_prot_deactivate(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
)
{
  ...
  act = sdcmd_hybr_3_user_prot_deactivate(cmd);
...
)
{
  ...
  act = sdcmd_user_prot_deactivate(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
FUNCTION sd_ss_ind_user_ss_pref8
...
===========================================================================*/
EXTERN  sd_ss_act_e_type                    sd_ss_ind_user_ss_pref8(
...
{
  //execute_fn                  fn;
  sd_ss_ind_user_ss_pref_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_user_ss_pref_cmd), MODEM_MEM_CLIENT_MMODE);
  sd_ss_act_e_type            act;
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_user_ss_pref_cmd));
  ...
  cmd->ciot_lte_pref = ciot_lte_pref;
  #endif
  
  #if defined(FEATURE_HYBR_3GPP) && defined(FEATURE_MMODE_HYBR2_ENABLED)
   act = sdcmd_hybr_2_user_ss_pref6(cmd);
  #elif defined(CFG_HYBR_GW_3)
   act = sdcmd_hybr_3_user_ss_pref(cmd);
  #else
   act = sdcmd_user_ss_pref8(cmd);
  #endif
...
)
{
  ...
  ciot_lte_pref.lte_op_mode_pref  = SD_SS_LTE_IOT_OP_MODE_PREF_NONE;
  ciot_lte_pref.lte_m1_band_pref  = SYS_LTE_BAND_MASK_CONST_NONE;
  ciot_lte_pref.lte_nb1_band_pref = SYS_LTE_BAND_MASK_CONST_NONE;
  ciot_lte_pref.lte_band_pref     = SYS_LTE_BAND_MASK_CONST_NONE;
  
  return sd_ss_ind_hybr_2_user_ss_pref6( pref_reason,
                                         orig_mode,
                                         mode_pref,
                                         band_pref,
                                         lte_band_pref,
...
FUNCTION sd_ss_ind_hybr_2_user_ss_pref6
...
===========================================================================*/
EXTERN  sd_ss_act_e_type                    sd_ss_ind_hybr_2_user_ss_pref6(
...
)
{
  ...
  return sd_ss_ind_hybr_3_user_ss_pref_1(pref_reason,
                                         orig_mode,
                                         mode_pref,
                                         band_pref,
                                         lte_band_pref,
...
FUNCTION sd_ss_ind_hybr_3_user_ss_pref_1
...
===========================================================================*/
EXTERN  sd_ss_act_e_type                    sd_ss_ind_hybr_3_user_ss_pref_1(
...
EXTERN  sd_ss_act_e_type          sd_ss_ind_user_get_net_gw_ss(
       ...
       const sys_wwan_adavnce_scan_pram_s_type*  gps_wwan_scan_params,
         /* GPS advance scan parameter  */
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_user_get_net_gw_ss_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_user_get_net_gw_ss_cmd), MODEM_MEM_CLIENT_MMODE) ;
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_user_get_net_gw_ss_cmd));
  ...
  cmd->ciot_lte_pref = ciot_lte_pref;
  #endif
  cmd->cell_search_num_cells = cell_search_num_cells;
#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
  if( gps_wwan_scan_params != NULL )
  {
    memscpy((void *)&(cmd->gps_wwan_scan_params),sizeof(sys_wwan_adavnce_scan_pram_s_type), (void *)gps_wwan_scan_params,sizeof(sys_wwan_adavnce_scan_pram_s_type));
  }
#endif
  
  act = sdcmd_user_get_net_gw_ss(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
    ...
    return sd_ss_ind_user_term_get_net_gw_ss(SD_SS_HYBR_3,
                     rtrn_act_ptr);
    #else
    return sd_ss_generic_cmd(sdcmd_user_term_get_net_gw_ss, rtrn_act_ptr);
    #endif
...
)
{
  ...
  sd_ss_act_e_type            act;
  sd_ss_ind_cdma_acq_schm_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_acq_schm_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_acq_schm_cmd));
...
{
	sd_ss_act_e_type				act;
	sd_ss_ind_cdma_opr_oh_info_cmd	*cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_oh_info_cmd), MODEM_MEM_CLIENT_MMODE);
    ...
    /* intialize the memory allocated   */
    memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_oh_info_cmd));
	...
	act = sdcmd_cdma_opr_oh_info(cmd);
	modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_cdma_opr_sys_lost_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_sys_lost_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_sys_lost_cmd));
  ...
  act = sdcmd_cdma_opr_sys_lost2(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
    sd_ss_act_e_type              act;
    sd_ss_ind_cdma_opr_redir_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_redir_cmd), MODEM_MEM_CLIENT_MMODE);
    ...
    /* intialize the memory allocated   */
    memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_redir_cmd));
...
{
  sd_ss_act_e_type              act;
  sd_ss_ind_cdma_opr_ho_lte_cmd *cmd =  modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_ho_lte_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_ho_lte_cmd));
...
{
  sd_ss_ind_update_cdma_sib8_nbrs_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_update_cdma_sib8_nbrs_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_update_cdma_sib8_nbrs_cmd));
  ...
  (void) sdcmd_update_cdma_sib8_nbrs(cmd);
   modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
}
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_cdma_opr_new_sys_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_new_sys_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_new_sys_cmd));
  ...
  act = sdcmd_cdma_opr_new_sys(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_cdma_opr_sys_resel_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_sys_resel_cmd), MODEM_MEM_CLIENT_MMODE);
  if (cmd == NULL)
  {
       sys_err_fatal_null_ptr_exception();
  }
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_sys_resel_cmd));
  ...
  act = sdcmd_cdma_opr_sys_resel(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_cdma_opr_acc_term_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_acc_term_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_acc_term_cmd));
  ...
  act = sdcmd_cdma_opr_acc_term(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_cdma_opr_cam_cdma_cmd *cmd =  modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_cam_cdma_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_cam_cdma_cmd));
  ...
  act = sdcmd_cdma_opr_cam_cdma(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_cdma_opr_hdm_cdma_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_hdm_cdma_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_hdm_cdma_cmd));
  ...
  act = sdcmd_cdma_opr_hdm_cdma(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type              act;
  sd_ss_ind_cdma_opr_itspm_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_itspm_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_itspm_cmd));
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_user_cdma_irat_lte_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_user_cdma_irat_lte_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_user_cdma_irat_lte_cmd));
  ...
  act = sdcmd_user_cdma_irat_lte(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  sd_ss_act_e_type                      act;
  sd_ss_ind_misc_gw_sim_state_update_cmd    *cmd = modem_mem_alloc(sizeof(sd_ss_ind_misc_gw_sim_state_update_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_misc_gw_sim_state_update_cmd));
  ...
  act = sdcmd_misc_gw_sim_state_update(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hdr_user_ss_pref3(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hdr_user_prot_deactivate(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_hdr_user_redir_lte_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_user_redir_lte_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_user_redir_lte_cmd));
  ...
  act = sdcmd_hdr_user_redir_lte(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
FUNCTION sd_misc_efs_get_scan_counter

DESCRIPTION
  API to fetch SDSSSCR_EFS_ITEM_3GPP_OOS_SCAN_COUNTER
...
EXTERN uint32 sd_misc_efs_get_scan_counter(sys_modem_as_id_e_type as_id)
{
  return sdssscr_efs_item_get(SDSSSCR_EFS_ITEM_3GPP_OOS_SCAN_COUNTER,
                             as_id);
}

/*===========================================================================

FUNCTION sd_misc_efs_get_power_save_duration_min

DESCRIPTION
  API to fetch SDSSSCR_EFS_ITEM_3GPP_OOS_TIMER_VALUE1
...
EXTERN uint32 sd_misc_efs_get_power_save_duration_min(sys_modem_as_id_e_type as_id)
{
  return sdssscr_efs_item_get(SDSSSCR_EFS_ITEM_3GPP_OOS_TIMER_VALUE1,
                             as_id);
}

/*===========================================================================

FUNCTION sd_misc_efs_get_power_save_duration_max

DESCRIPTION
  API to fetch SDSSSCR_EFS_ITEM_3GPP_OOS_T_NORM_MAX
...
EXTERN uint32 sd_misc_efs_get_power_save_duration_max(sys_modem_as_id_e_type as_id)
{
  return sdssscr_efs_item_get(SDSSSCR_EFS_ITEM_3GPP_OOS_T_NORM_MAX,
                             as_id);
}

/*===========================================================================

FUNCTION sd_misc_efs_get_power_save_duration_delta

DESCRIPTION
  API to fetch SDSSSCR_EFS_ITEM_3GPP_OOS_TIME_DELTA
...
EXTERN uint32 sd_misc_efs_get_power_save_duration_delta(sys_modem_as_id_e_type as_id)
{
  return sdssscr_efs_item_get(SDSSSCR_EFS_ITEM_3GPP_OOS_TIME_DELTA,
                             as_id);
}
...
{
  sd_ss_act_e_type              act;
  sd_ss_ind_misc_meas_rprt_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_misc_meas_rprt_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_misc_meas_rprt_cmd));
  ...
  act = sdcmd_hdr_misc_meas_rprt(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
===========================================================================*/
  ...
  {
    sd_ss_act_e_type  act;
    sd_ss_ind_hdr_acq_sid_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_acq_sid_cmd), MODEM_MEM_CLIENT_MMODE);
   ...
   /* intialize the memory allocated   */
   memset(cmd, 0, sizeof(sd_ss_ind_hdr_acq_sid_cmd));
...
{
	sd_ss_act_e_type			  act;
	sd_ss_ind_hdr_opr_oh_info_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_oh_info_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_oh_info_cmd));
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_hdr_opr_sys_usable_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_sys_usable_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_sys_usable_cmd));
  ...
  act = sdcmd_hdr_opr_sys_usable(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type            act;
  sd_ss_ind_hdr_opr_redir_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_redir_cmd), MODEM_MEM_CLIENT_MMODE);
  if (cmd == NULL)
  {
       sys_err_fatal_null_ptr_exception();
  }
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_redir_cmd));
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_hdr_opr_sys_lost_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_sys_lost_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_sys_lost_cmd));
  ...
  act = sdcmd_hdr_opr_sys_lost2(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hdr_opr_sys_lost3(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_hdr_opr_acc_term_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_acc_term_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_acc_term_cmd));
  ...
  act = sdcmd_hdr_opr_acc_term(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);;
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_hdr_opr_ses_close_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_ses_close_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_ses_close_cmd));
  ...
  act = sdcmd_hdr_opr_ses_close(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type              act;
  sd_ss_ind_hdr_opr_bad_sys_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_bad_sys_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_bad_sys_cmd));
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_hdr_opr_activity_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_hdr_opr_activity_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_hdr_opr_activity_cmd));
  ...
  act = sdcmd_hdr_opr_start_activity(cmd); 
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hdr_opr_stop_activity(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type          act;
  sd_ss_ind_misc_timer_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_misc_timer_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_misc_timer_cmd));
  
  /* Fill in the command header    */
  cmd->ss = SD_SS_MAIN;
  cmd->act = SD_SS_ACT_MAX;
  cmd->rtrn_act_ptr = rtrn_act_ptr;cmd->resel_is_allowed = resel_is_allowed;

  act = sdcmd_hybr_1_misc_timer(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);;
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_gw_acq_plmn_failed_cmd  *cmd =  modem_mem_alloc(sizeof(sd_ss_ind_gw_acq_plmn_failed_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  */
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_gw_acq_plmn_failed_cmd));
  ...
  #if !defined FEATURE_MMODE_DISABLE_CSG && defined(FEATURE_FEMTO_CSG)
  cmd->csg_info_ptr = csg_info_ptr;  
  cmd->registered_plmn = registered_plmn;
  #endif
  act = sdcmd_gw_acq_plmn_failed_ss_2(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
(           /*lint -esym(715, chan) */ /* param not referenced */
        ...
        sd_ss_act_s_type          *rtrn_act_ptr
            /* Accepted NW behavior of ciot features
            */

)
{
  sd_ss_act_e_type          act;
  sd_ss_ind_gw_srv_info_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_gw_srv_info_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_gw_srv_info_cmd));
  ...
  #endif
  #if defined(FEATURE_CIOT)
  cmd->ciot_lte_mode = ciot_lte_mode;
  cmd->neg_ciot_cap      = neg_ciot_cap;
  cmd->cp_sms_service_status = cp_sms_service_status;
  #endif
  cmd->epco_supported    = epco_supported;
  
  act = sdcmd_gw_acq_plmn_success_ss_2(cmd);
...
{
  sd_ss_act_e_type                  act;
  sd_ss_ind_gw_acq_plmn_camped_cmd  *cmd =  modem_mem_alloc(sizeof(sd_ss_ind_gw_acq_plmn_camped_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_gw_acq_plmn_camped_cmd));
  ...
  act = sdcmd_gw_acq_plmn_camped_ss(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  (void) sd_ss_generic_cmd((execute_fn) sdcmd_reset_rlf_conn_mode_status, NULL);
}
...
{
  sd_ss_act_e_type              act;
  sd_ss_ind_gw_opr_srv_lost_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_gw_opr_srv_lost_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_gw_opr_srv_lost_cmd));
  ...
  act = sdcmd_gw_opr_srv_lost_ss_3(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                act;
  sd_ss_ind_lte_opr_srv_lost_cmd  *cmd = modem_mem_alloc(sizeof(sd_ss_ind_lte_opr_srv_lost_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_lte_opr_srv_lost_cmd));
  ...
  act = sdcmd_lte_opr_srv_lost_1(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
FUNCTION sd_ss_ind_gw_opr_srv_info_ss_1
...
(          /*lint -esym(715, chan) */ /* param not referenced */
        ...
        sys_neg_ciot_cap            neg_ciot_cap,
        /* Accepted ciot capabilities from NW 
           */
...
/*lint -esym(715, sib8_available) */ /* param not referenced */
{
  ...
  act = sdcmd_gw_opr_srv_info_ss_1(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  return sd_ss_generic_cmd(sdcmd_gw_opr_acc_done_ss, rtrn_act_ptr);
}
#endif
...
{
  return sd_ss_generic_cmd(sdcmd_gw_ps_detach, rtrn_act_ptr);
}
...
===========================================================================*/
void          sd_ss_ind_misc_srv_lost(void)
...
)
{
  ...
  act = sdcmd_hybr_2_misc_timer(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hybr_2_misc_meas_rprt(cmd);  
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hybr_3_misc_timer(cmd);  
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  act = sdcmd_hybr_3_misc_meas_rprt(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                      act;
  sd_ss_ind_misc_gw_net_list_rpt_ss_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_misc_gw_net_list_rpt_ss_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_misc_gw_net_list_rpt_ss_cmd));
  ...
  act = sdcmd_misc_gw_net_list_rpt_ss(cmd);  
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type                        act;
  sd_ss_ind_misc_hdr_bcmcs_srv_status_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_misc_hdr_bcmcs_srv_status_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_misc_hdr_bcmcs_srv_status_cmd));
  ...
  act = sdcmd_misc_hdr_bcmcs_srv_status(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
FUNCTION sd_misc_is_target_supp_mode_band_ciot

  Inform the caller to whether a specified combination of mode, band and ciot lte
  preference is supported by the current target.

  For example, SD_SS_MODE_PREF_LTE is only supported by a target that is
  LTE capable.
...
===========================================================================*/
EXTERN  boolean                   sd_misc_is_target_supp_mode_band_ciot(
...
)
{
  ...
  */
  if( (! sdss_is_supp_mode_band_pref(mode_pref, band_pref))
       /*&& (! sdss_is_supp_mode_band_pref_tds(mode_pref, tds_band_pref) )*/
       && (! sdss_is_supp_mode_band_pref_lte_ciot(mode_pref,ciot_lte_pref))
    )
  {
    return FALSE;
  }
...
)
{
  ...
  */
  ...
  sdsr_list_print(SDSR_GWL_LST, TRUE);
...
{
  #ifdef FEATURE_MMODE_3GPP2
  return sd_ss_ptr(SD_SS_MAIN)->gpp2.return_cause;
  #else
  return 0xff;
  #endif
}
...
)
{
  ...
  sd_ss_act_e_type              act;
  sd_misc_get_curr_sys_mode_cmd *cmd = modem_mem_alloc(sizeof(sd_misc_get_curr_sys_mode_cmd), MODEM_MEM_CLIENT_MMODE);  
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_misc_get_curr_sys_mode_cmd));
  ...
  act = sdcmd_misc_get_curr_sys_mode(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);;
...
FUNCTION sd_misc_get_lte_band_mode_ciot
...
===========================================================================*/
EXTERN  void                      sd_misc_get_lte_band_mode_ciot(

        sd_ss_ciot_lte_op_mode_e_type  *lte_op_mode_ptr,
            /* Pointer to the lte iot op mode preference that needs to be filtered.
            */
        ...
        sys_lte_band_mask_e_type        *band_ptr_lte_m1,
            /* Pointer to the LTE M1 band preference that needs to be filtered.
             */

        sys_lte_band_mask_e_type        *band_ptr_lte_nb1,
            /* Pointer to the LTE M1 band preference that needs to be filtered.
              */

        sd_ss_ciot_lte_op_mode_e_type  sys_lte_op_mode,
            /* Enumeration of system lte iot op mode perference.
            */
        ...
        sys_lte_band_mask_e_type        sys_band_pref_lte_m1,
            /* Enumeration of LTE M1 system selection band and sub-band preferences.
            */

        sys_lte_band_mask_e_type        sys_band_pref_lte_nb1
            /* Enumeration of LTE NB1 system selection band and sub-band preferences.
            */

)
{
  sd_ss_ciot_lte_op_mode_e_type lte_op_mode   = SD_SS_LTE_IOT_OP_MODE_PREF_NONE;
  sys_lte_band_mask_e_type       lte_band_pref     = SYS_LTE_BAND_MASK_CONST_NONE;
  sys_lte_band_mask_e_type       lte_m1_band_pref  = SYS_LTE_BAND_MASK_CONST_NONE;
  sys_lte_band_mask_e_type       lte_nb1_band_pref = SYS_LTE_BAND_MASK_CONST_NONE;

  sd_ss_ciot_lte_op_mode_e_type lte_op_mode_supp = SD_SS_LTE_IOT_OP_MODE_PREF_NONE;
  
  lte_op_mode   = *lte_op_mode_ptr;
  lte_band_pref     = *band_ptr_lte;
  lte_m1_band_pref  = *band_ptr_lte_m1;
  lte_nb1_band_pref = *band_ptr_lte_nb1;

  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  /* Filter out modes that are not part of the mode preference.
  */
  lte_op_mode = SD_GET_COMMON_LTE_CIOT_OP_MODE( lte_op_mode, sys_lte_op_mode );
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  /* Filter out bands that are not in the band preference.
  */
  lte_band_pref = SYS_LTE_BAND_MASK_COMMON (&lte_band_pref,&sys_band_pref_lte);
  lte_m1_band_pref = SYS_LTE_BAND_MASK_COMMON (&lte_m1_band_pref,&sys_band_pref_lte_m1);
  lte_nb1_band_pref = SYS_LTE_BAND_MASK_COMMON (&lte_nb1_band_pref,&sys_band_pref_lte_nb1);
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  /* Filter out:
  ** 1. Modes that do not have corresponding bands.
  ** 2. Bands that do not have corresponding modes.
  */
  if (sdss_get_supp_mode_pref_mmode(SD_SS_MODE_PREF_LTE, SD_SS_BAND_PREF_NONE,
       lte_m1_band_pref, SD_SS_BAND_PREF_NONE) != SD_SS_MODE_PREF_NONE)
  {
    lte_op_mode_supp = lte_op_mode_supp | BM(SD_MODE_LTE_M1);
  }

  if (sdss_get_supp_mode_pref_mmode(SD_SS_MODE_PREF_LTE, SD_SS_BAND_PREF_NONE,
        lte_nb1_band_pref, SD_SS_BAND_PREF_NONE) != SD_SS_MODE_PREF_NONE)
  {
    lte_op_mode_supp = lte_op_mode_supp | BM(SD_MODE_LTE_NB1);
  }

  if (sdss_get_supp_mode_pref_mmode(SD_SS_MODE_PREF_LTE, SD_SS_BAND_PREF_NONE,
        lte_band_pref, SD_SS_BAND_PREF_NONE) != SD_SS_MODE_PREF_NONE)
  {
    lte_op_mode_supp = lte_op_mode_supp | BM(SD_MODE_LTE);
  }

  lte_op_mode = lte_op_mode_supp & lte_op_mode;

  #if defined(FEATURE_MMODE_M1)
  if(lte_op_mode & BM(SD_MODE_LTE_M1))
  {
    lte_m1_band_pref = sdss_get_supp_mode_band_pref_lte(SD_SS_MODE_PREF_LTE, lte_m1_band_pref );
  }
  #endif

  #if defined(FEATURE_MMODE_NB1)
  if(lte_op_mode & BM(SD_MODE_LTE_NB1))
  {
    lte_nb1_band_pref = sdss_get_supp_mode_band_pref_lte(SD_SS_MODE_PREF_LTE, lte_nb1_band_pref );
  }
  #endif

  if(lte_op_mode & BM(SD_MODE_LTE))
  {
    lte_band_pref = sdss_get_supp_mode_band_pref_lte(SD_SS_MODE_PREF_LTE, lte_band_pref );
  }

  *lte_op_mode_ptr     = lte_op_mode;
  *band_ptr_lte        = lte_band_pref;
  *band_ptr_lte_m1     = lte_m1_band_pref;
  *band_ptr_lte_nb1    = lte_nb1_band_pref;
...
{
  #ifndef FEATURE_MMODE_LTE_ONLY
  sd_get_band_mode_mmode(mode_ptr, 
      band_ptr, 
      band_ptr_lte, 
      #ifdef FEATURE_TDSCDMA
      band_ptr_tds, 
...
{
  #ifdef FEATURE_MMODE_3GPP2
  sd_misc_sys_avoid_list_cmd  *cmd = modem_mem_alloc(sizeof(sd_misc_sys_avoid_list_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_misc_sys_avoid_list_cmd));
...
EXTERN  boolean        sd_misc_allowed_sid_nid (
  ...
  {
  sd_ss_act_e_type            act;
  sd_misc_allowed_sid_nid_cmd *cmd = modem_mem_alloc(sizeof(sd_misc_allowed_sid_nid_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_misc_allowed_sid_nid_cmd));
  ...
  act = sdcmd_misc_allowed_sid_nid(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);
...
{
  sd_ss_act_e_type  act;
  sd_nam_sel_cmd    *cmd = modem_mem_alloc(sizeof(sd_nam_sel_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_nam_sel_cmd));
...
)
{
  ...
  ret_val = sd_hybr_per_ss_nam_sel_1(curr_nam,
                                     orig_mode,
                                     mode_pref,
                                     band_pref,
                                     lte_band_pref,
...
FUNCTION sd_hybr_per_ss_nam_sel_1
...
===========================================================================*/
EXTERN  boolean                          sd_hybr_per_ss_nam_sel_1(
...
)
{
  ...
  ret_val = (boolean) sdcmd_hybr_per_ss_nam_sel_1(cmd);
  modem_mem_free(cmd, MODEM_MEM_CLIENT_MMODE);
...
)
{
  ...
  #else
  sd_ss_act_e_type            act;
  sd_is_plmn_rat_allowed_cmd  *cmd = modem_mem_alloc(sizeof(sd_is_plmn_rat_allowed_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_is_plmn_rat_allowed_cmd));
  ...
  act = sdcmd_is_plmn_rat_allowed(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);   return act;
...
{
 sd_ss_ind_update_splmn_list_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_update_splmn_list_cmd), MODEM_MEM_CLIENT_MMODE);
 ...
 /* intialize the memory allocated   */
 memset(cmd, 0, sizeof(sd_ss_ind_update_splmn_list_cmd));
 ...
 sdcmd_update_cdma_splmn_list(cmd);
...
{
  sd_ss_act_e_type                 act;
  sd_ss_ind_cdma_opr_activity_cmd *cmd = modem_mem_alloc(sizeof(sd_ss_ind_cdma_opr_activity_cmd), MODEM_MEM_CLIENT_MMODE);
  ...
  /* intialize the memory allocated   */
  memset(cmd, 0, sizeof(sd_ss_ind_cdma_opr_activity_cmd));
  ...
  act = sdcmd_cdma_opr_start_activity(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
...
)
{
  ...
  act = sdcmd_cdma_opr_stop_activity(cmd);
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE);  
...
)
{
  ...
  sdcmd_update_hdr_splmn_list(cmd);	
  modem_mem_free(cmd,MODEM_MEM_CLIENT_MMODE); 
}
#endif
...
#if !defined(FEATURE_TRIM_CMPMPRX) && defined(FEATURE_MMODE_9X05_EMERG_CALL)
/*===========================================================================
