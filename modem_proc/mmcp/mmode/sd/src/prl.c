...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/src/prl.c#1 $
...
)
{
  ...
  */
  ...
  SD_MSG_MED_3("num acq recs=%d, num subnet recs=%d, num sys recs=%d",
               prl_hdr_ptr->num_acq_recs,
  ...
  */
  {
    ...
    char prl_default_buffer[] = {0x00, 0x4a, 0x22, 0xB8, 0x03, 0x00, 0x00, 0x40, 
0x00, 0x00, 0x80, 0x0F, 0x36, 0xCC, 0x90, 0x00,
0x82, 0x06, 0x10, 0x28, 0x60, 0xE2, 0x0A, 0x50,
0x00, 0x41, 0x03, 0x08, 0x14, 0x30, 0x71, 0x02, 
0x93, 0x30, 0x00, 0x41, 0x03, 0x08, 0x14, 0x30,
 0x71, 0x02, 0x45, 0x0B, 0x18, 0x34, 0x81, 0x12, 
0x44, 0xCA, 0x16, 0x2E, 0x60, 0xC9, 0xB3, 0x87, 
0x50, 0x21, 0x44, 0x8D, 0x22, 0x54, 0xC9, 0xD4, 
0x29, 0x54, 0xc8, 0x29, 0x40, 0x00, 0x40, 0x00, 
0x3b, 0x98
};
  ...
  */
  ...
  #elif !defined FEATURE_MMODE_3GPP2
  ...
  *sspr_p_rev_ptr = (prl_sspr_p_rev_e_type)nv_data.sspr_p_rev;
  ...
  SINGLE BAND PRL: GSM(EGSM900/PGSM900/DCS1800/RGSM900) WCDMA(IMT2100/JAPANVI800/VIII900) GSM(850/1900) WCDMA(PCS1900/US850/BC11-1.5G/BC11-850)
...
/* Default roaming list depends on the CDMA home side */
    ...
    *************************************************************************/
    ...
    SD_MSG_LOW_0( "Creating CDMA-800/1900 default PRL");
...
)
{
  ...
  */
  SD_MSG_HIGH_1( "Validate for SSPR_P_REV=%d PRL", sspr_p_rev);
  ...
  */
  ...
  for( i=0; i < (int) prl_hdr_ptr->num_acq_recs; i++)
  {
    ...
    */
    ...
    SD_MSG_HIGH_4 ("offset %d acq type %d bytepos %d bitpos %d",
  ...
  */
      ...
      prl_validation != PRL_VALID )
  {
    ...
    */
    ...
    if( ! prl_create_dflt(cdma_home_sid, cdma_home_nid,
                          &sspr_p_rev, prl_ptr) )
    {
      prl_ptr->size             = 0;
      prl_ptr->valid            = FALSE;
  ...
  for(i = 0; i < tot->num_rat; i++)
  {
    ...
    */
    if( tot->acq_sys_mode[i] != SYS_SYS_MODE_CDMA  &&
        ...
        && tot->acq_sys_mode[i] != SYS_SYS_MODE_LTE_M1
        && tot->acq_sys_mode[i] != SYS_SYS_MODE_LTE_NB1
        #endif
      )
    {
      return FALSE;
