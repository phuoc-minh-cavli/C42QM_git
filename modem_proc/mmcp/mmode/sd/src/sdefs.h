...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/src/sdefs.h#1 $
...
#define SDEFS_RAT_ACQ_ORDER_F_NAME      "/sd/rat_acq_order"
#define SDEFS_RAT_ACQ_ORDER_SUB2_F_NAME "/sd/rat_acq_order_Subscription01"
...
#define SDEFS_MMODE_MRU_EXT_NAM_1_F_NAME "/sd/mru001_ext"
#define SDEFS_MMODE_MRU_EXT_NAM_2_F_NAME "/sd/mru002_ext"
...
typedef enum
{
  ...
  SDEFS_RAT_ACQ_ORDER,      /**< EFS id RAT acquisition order*/
  SDEFS_RAT_ACQ_ORDER_SUB2, /**< EFS id RAT acquisition order for sub2*/
  ...
  */
  ...
  SDEFS_MRU_EXT_NAM_1,      /*EFS ID for extended MRU structure(with 256 LTE bands) for NAM 1*/
  SDEFS_MRU_EXT_NAM_2,      /*EFS ID for extended MRU structure(with 256 LTE bands) for NAM 2*/
