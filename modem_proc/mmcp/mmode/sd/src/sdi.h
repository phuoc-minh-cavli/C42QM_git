...
$Header: //components/rel/mmcp.mpss/6.1.10/mmode/sd/src/sdi.h#1 $
...
*/
#if !defined (FEATURE_MMODE_3GPP2) && !defined (FEATURE_SD_LTE)
/* this needs to be removed when GWL dflt PRL is supported */

  #define   PRL_TBL_MAX         20
  #define   PRL_DEFAULT_ENTRIES  0
#elif defined FEATURE_MMODE_DISABLE_PRL 
  #define   PRL_TBL_MAX         10
  #define   PRL_DEFAULT_ENTRIES  0
#else
...
/*Range checks for BSR and OOS */
#define SD_3GPP_T_NORM_MAX_RANGE_LOW          10
#define SD_3GPP_T_NORM_MAX_RANGE_HIGH         86400
#define SD_TIMER_MIN                          1
#define SD_3GPP_REPS_PER_STAGE_MIN            1
#define SD_3GPP_REPS_PER_STAGE_MAX            30
#define SD_3GPP_MAX_TIME_DELTA                21600
#define SD_3GPP_SCAN_COUNTER_MIN              1
#define SD_3GPP_SCAN_COUNTER_MAX              10


/* Default OOS values */
#define SD_3GPP_OOS_T_NORM_MAX_DEFAULT        60
#define SD_3GPP_OOS_REPS_PER_STAGE            10
#define SD_3GPP_OOS_T_SLOW_MAX                480
#define SD_3GPP_OOS_T_SLOW_MAX_RANGE_HIGH     172800
#define SD_3GPP_OOS_TIMER_VALUE1              30
#define SD_3GPP_OOS_TIME_DELTA                15
#define SD_3GPP_OOS_SCAN_COUNTER              1

/* Default BSR values */
#define SD_3GPP_BSR_T_NORM_MAX_DEFAULT        60
#define SD_3GPP_BSR_REPS_PER_STAGE            1
#define SD_3GPP_BSR_MAX_TIME                  480
#define SD_3GPP_BSR_INITIAL_VAL               20
#define SD_3GPP_BSR_TIME_DELTA                10

#define SD_3GPP_STATIONARY_MAX_STAGE          10
/* Define a max stage value (arbitrary no.) to be used in case the 
** stage calculation logic fails
*/
