...
/*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/policyman/inc/mre_dbg.h#1 $
...
---------------------------------------------------------------------------*/
#ifndef MSG_SSID_MRE
#define MSG_SSID_MRE                 MSG_SSID_POLICYMAN
#define MSG_BUILD_MASK_MSG_SSID_MRE  MSG_BUILD_MASK_MSG_SSID_POLICYMAN
#endif /* MSG_SSID_MRE */
...
#define MRE_MSG_LOW(str, a, b, c)               MSG_3( MSG_SSID_MRE, MRE_MSG_LVL_LOW,  str, a, b, c)
#define MRE_MSG_MED(str, a, b, c)               MSG_3( MSG_SSID_MRE, MRE_MSG_LVL_MED,  str, a, b, c)
#define MRE_MSG_HIGH(str, a, b, c)              MSG_3( MSG_SSID_MRE, MSG_LEGACY_HIGH,  str, a, b, c)
#define MRE_MSG_ERROR(str, a, b, c)             MSG_3( MSG_SSID_MRE, MSG_LEGACY_ERROR, str, a, b, c)
