...
/*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/policyman/inc/policyman_device_config.h#1 $
...
/**
@brief  API to get the RAT capability for a specific subscription and configuration.
