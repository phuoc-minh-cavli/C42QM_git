...
/*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/policyman/src/policyman_efs.c#1 $
...
STATIC efs_file_entry efs_files[] = {
    //   Path                             deleteHandler
    { POLICYMAN_DEVICE_CONFIG_EFS_PATH,   policyman_efs_obliterate_device_file  },
    { POLICYMAN_DEVICE_CONFIG_NV_PATH,    policyman_efs_obliterate_device_file  },
    { POLICYMAN_SEGMENT_LOADING_EFS_PATH, policyman_efs_obliterate_device_file  },
    { POLICYMAN_RESTRICTIONS_EFS_PATH,    policyman_efs_obliterate_device_file  },
    { POLICYMAN_RAT_ORDER_NV_PATH,        (pfnObliterateFunc)NULL               },
    { POLICYMAN_TIMERS_EFS_DIR,           policyman_efs_obliterate_dir          },
    { POLICYMAN_CARRIER_POLICY_EFS_PATH,  policyman_efs_obliterate_subs_file    },
    { POLICYMAN_RAT_ORDER_EFS_PATH,       policyman_efs_obliterate_subs_file    },
    { POLICYMAN_CURRENT_MCC_NV_PATH,      policyman_efs_obliterate_persist_file },
    { POLICYMAN_CALL_MODE_NV_PATH,        policyman_efs_obliterate_persist_file },
    { POLICYMAN_RAT_MASK_NV_PATH,         policyman_efs_obliterate_persist_file },
    { POLICYMAN_SVC_MODE_NV_PATH,         policyman_efs_obliterate_persist_file },
    { POLICYMAN_UE_MODE_NV_PATH,          policyman_efs_obliterate_persist_file },
};
...
)
{
  ...
  POLICYMAN_MSG_HIGH_4( "Obliterate_subs: subs %d, dirs %d, files %d, successes %d",
                        subsId,
                        deleteDirs,
                        deleteFiles,
                        deleteSuccesses );
