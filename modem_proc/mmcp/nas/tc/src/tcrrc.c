...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/tc/src/tcrrc.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#ifdef FEATURE_MBMS
     case TC_LOOPBACK_MODE3:
        return(tc_notify_lb_mode(RRCTC_LB_MODE3, dummy_signaling_flag));
#endif
