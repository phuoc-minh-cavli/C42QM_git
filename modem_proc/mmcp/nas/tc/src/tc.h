...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/tc/src/tc.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#ifdef FEATURE_MBMS
  ,RLC_SDU_COUNTER_REQUEST             = 0x49,
  RLC_SDU_COUNTER_RESPONSE             = 0x4A,
#endif
} tc_layer_msg_T;
...
typedef enum
{
  ...
  TC_LOOPBACK_MODE2
#ifdef FEATURE_MBMS
  ,TC_LOOPBACK_MODE3, //Test loop mode 3 operation is only defined for MTCH.
#endif
} loopback_state_T;
