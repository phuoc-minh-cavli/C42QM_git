...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/emm_update_lib.h#1 $
...

{
  ...
  lte_cphy_edrx_uim_page_ind_s cmd;
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_timer_t3324_expire
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_process_t3324_and_send_possible_psm_timer_chg_ind
(
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_process_edrx_params
(
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean emm_process_phy_cmd_msg
(
  void                   *cmd_ptr, 
  emm_ctrl_data_type     *emm_ctrl_data_ptr,
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean emm_is_psm_supported
(
  void  
);
#endif
