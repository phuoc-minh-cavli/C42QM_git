...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mm_multimode_handler.c#1 $ 
$DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
void mm_set_gmm_param_lte_to_gw_handover(void)
{
  ...
  mm_update_gw_auth_keys(mm_mapped_gw_identity, emm_ctrl_data_ptr
...
)
{
  ...
  nas_assert_check((boolean)(cmd_ptr != (void *)NULL));
...
)
{
  ...
  emm_failure_type   emm_failure_cause;
  nas_assert_check((boolean)(rrc_message_router_cmd != (void *)NULL));
...
)
{
  ...
  nas_assert_check((boolean)(command_ptr != NULL));
     ...
     case MS_TIMER:
       ...
       if((mm_cmd_ptr->cmd.timer_expiry.timer_id >= MIN_MM_TIMER && 
          ...
          (((mm_cmd_ptr->cmd.timer_expiry.timer_id != TIMER_T3346) &&
            (mm_cmd_ptr->cmd.timer_expiry.timer_id != TIMER_T3324)) ||
                                  ...
                                  emm_ctrl_data_type  *emm_ctrl_data_ptr) 
{
  ...
  nas_assert_check((boolean)(mm_identity != (void *)NULL));
...
void emm_set_state_multimode_rau_failure(lte_nas_emm_cause_type cause)
{
  ...
  {
    MSG_MED_DS_2(MM_SUB,"=EMM= RAU REJ w/ cause 8 is abnormal for rau type %d, 3gpp_rel %d",
                 gmm_ra_update_type,emm_ctrl_data_ptr->emm_3gpp_spec_ver);
  }
}
...
)
{
   ...
   nas_assert_check((boolean)(act_ind_ptr != (void *)NULL));
    ...
    switch(act_ind_ptr->act_reason)
    {
       ...
       case LTE_RRC_ACT_IRAT_HO:
         ...
         */
         ...
         nas_assert_check((boolean)(previous_active_rat != SYS_RAT_NONE));
         ...
         if (mm_reg_waiting_for_reg_cnf)
         {
           ...
           mm_send_mmr_reg_cnf(NULL,mm_serving_plmn.info.service_status); //CHKDBG
         ...
         if(mm_is_reg_needed_for_mmit_on_LTE(previous_active_rat))
         {
           ...
           /*C1-143343 CR  2583 IMS voice termination if deactivate ISR then stop timer t3412*/
...
FUNCTION    : MM_RESET_ATTACH_TRIGGER

DESCRIPTION:  This function will reset all the variables
...
#endif
  MSG_HIGH_DS(MM_SUB,"=EMM= Attach rejected with cause %d, updating GMM/MM ",
           reject_cause,0,0);
      ...
      **the same value-------------------------------------------------*/ 
      ...
      current_lte_plmn = emm_convert_rrc_plmn_id_to_nas_plmn_id(
                                    emm_ctrl_data_ptr->last_rrc_service_ind_ptr->camped_svc_info.\
                                                                              selected_plmn);
      MSG_HIGH_DS(MM_SUB,"EMM: Is Accepted On LTE %d Eps Storage Supported : %d",emm_ctrl_data_ptr->is_accepted_on_lte,emm_ctrl_data_ptr->eps_storage_supported,0);
...
#endif
      {
         ...
         {
           MSG_HIGH_DS_1(MM_SUB,"sim_avail %d", sim_avail);
         }
      }
      break;
...
{
  byte i;
  nas_assert_check((boolean)(guti != (void *)NULL));
  nas_assert_check((boolean)(ptmsi_sig != (void *)NULL));
...
/* MNK ESM ISR END*/
     ...
     case MS_GMM_RABM:
       MSG_HIGH_DS_1(MM_SUB,"RABM to GMM message ID %d",mm_cmd_ptr->cmd.hdr.message_id);
       switch(mm_cmd_ptr->cmd.hdr.message_id)
       {
...
)
{
  ...
  uint8 length;
    ...
    nas_assert_check((boolean)(emm_ctrl_data_ptr->rrc_forbidden_list_ptr != NULL));
 ...
 /* Populate EHPLMN list or HPLMN, and RPLMN */
     ...
     (emm_ctrl_data_ptr->plmn_service_state->sim_state == SYS_SIM_STATE_CS_INVALID))
  {
      ...
      ehplmn_list_ptr = (reg_sim_plmn_list_s_type *) emm_modem_mem_alloc(
                                            ...
                                            emm_ctrl_data_ptr);
      nas_assert_check((boolean)(ehplmn_list_ptr != NULL));
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
...
#endif
    if(mm_location_information.location_update_status != UPDATED && 
       emm_search_plmn_list(&camped_plmn,
...
void emm_map_guti_to_ptmsi(gmm_ptmsi_type *ptmsi, emm_ctrl_data_type     *emm_ctrl_data_ptr) 
{
  ...
  nas_assert_check((boolean)(ptmsi != (void *)NULL));
...
void emm_map_guti_to_rai(routing_area_id_T *ra_id, emm_ctrl_data_type *emm_ctrl_data_ptr) 
{
  ...
  nas_assert_check((boolean)(ra_id != (void *)NULL));
...
{
  nas_assert_check((boolean)(guti_ptr != NULL));
  ...
  if(emm_get_ul_count(mm_identity->ul_count_at_generation)==TRUE) 

   {
         ...
         sizeof(mm_identity->ul_count_at_generation))!=0))   
      {
        ...
        mm_update_gw_auth_keys(*mm_identity,emm_ctrl_data_ptr
#if defined(FEATURE_WCDMA) && defined(FEATURE_TDSCDMA)
...
FUNCTION  MM_HANDLE_ISR_TIMER__EXPIRY

DESCRIPTION
  This function does the neccessary action when ISR timer exprires and ISR is ON and UE is
  GSM/UMTS mode.
...
void mm_handle_isr_timer_expiry(emm_ctrl_data_type *emm_ctrl_data_ptr)
{
...
void mm_csfb_set_state(mm_csfb_state_type new_csfb_state)
{
  ...
  */
     ...
     (mm_csfb_state == MM_CSFB_STATE_NULL))
  {
    ...
    mm_send_rr_csfb_call_status_ind(TRUE);
  }
              ...
              (mm_csfb_state == MM_CSFB_STATE_MO_CALL_ORIG)))
  {
    ...
    mm_send_rr_csfb_call_status_ind(FALSE);
  }
...
The MM connection establishment shall not be initiated unless the MS is accessing the network with access class 11 � 15. */
  ...
  else
  {
    ...
    emm_start_nas_extended_service_request_procedure(rrc_est_cause, svc_type,
     csfb_rsp
#ifndef FEATURE_NAS_DISABLE_VOICE
    ,NAS_EMM_3GPP_CSFB
#endif
...
{   
           ...
           mm_csfb_state == MM_CSFB_STATE_MO_CALL_ORIG)
  {
    ...
    else
    {
      ...
      if( mm_need_to_send_no_srv_on_call_end_due_to_dos == TRUE )
      {
...
#if defined(FEATURE_LTE_REL12) && defined(FEATURE_NAS_GW)
/*===========================================================================

FUNCTION  emm_get_gmm_t3312_timer_value

DESCRIPTION: This function is used by EMM to set "gmm_t3312_timer_value"
...
SIDE EFFECTS
  None
===========================================================================*/
uint64 emm_get_gmm_t3312_timer_value(void)
{
  return gmm_t3312_timer_value;
}
...
#if defined(FEATURE_LTE_REL9) && defined(FEATURE_NAS_GW)
...
)
{
        ...
        MSG_HIGH_DS_3(MM_SUB, "=EMM= Dbg REG Valid = %d voice_domain_pref = %d voice_or_data_centric = %d",
                       lte_cs_domain_param_from_reg.is_voice_domain_ie_valid,
                       lte_cs_domain_param_from_reg.voice_domain_pref, 
                       lte_cs_domain_param_from_reg.voice_or_data_centric);

        MSG_HIGH_DS_3(MM_SUB, "=EMM= Dbg EMM Valid = %d voice_domain_pref = %d voice_or_data_centric = %d",
                       lte_cs_domain_param_in_emm.is_voice_domain_ie_valid,
     ...
     )
  {
    ...
    MSG_HIGH_DS_0(MM_SUB,"=MM= Check 1");
    return TRUE;
  }
  else if(lte_cs_domain_param_in_emm.is_voice_domain_ie_valid == TRUE)
  {
    ...
    MSG_HIGH_DS_0(MM_SUB,"=MM= Check 2");
      return FALSE;
    }
  }
  else
  {
    ...
    MSG_HIGH_DS_0(MM_SUB,"=MM= Check 3");
    return FALSE;
  }
  
    MSG_HIGH_DS_0(MM_SUB,"=MM= Check 4");
  return TRUE;
}
#endif
...
)
{
  ...
  MSG_HIGH_DS_5(MM_SUB,"rplmn_type %d rplmn_changed %d location_update_status %d gmm_update_status %d emm_update_status %d",
    emm_ctrl_data_ptr->rplmn_info.rplmn_type,rplmn_changed,
	mm_location_information.location_update_status,gmm_update_status,emm_ctrl_data_ptr->emm_update_status);
#else
  MSG_HIGH_DS_4(MM_SUB,"rplmn_type %d rplmn_changed %d location_update_status %d emm_update_status %d",
    emm_ctrl_data_ptr->rplmn_info.rplmn_type,rplmn_changed,
    mm_location_information.location_update_status,emm_ctrl_data_ptr->emm_update_status);
#endif
...
void emm_populate_imsi(lte_nas_emm_eps_mobile_id_type* imsi, emm_ctrl_data_type     *emm_ctrl_data_ptr)
{
  ...
  else
  {
	...
	imsi->ue_id_info.imsi.num_id_digits_len = MAX_NO_OF_IMSI;
    memscpy(imsi->ue_id_info.imsi.num_id_digits, MAX_NO_OF_IMSI,
...
void emm_copy_ftai_list_to_manual_ftai_list( emm_ctrl_data_type* emm_ctrl_data_ptr)
{
  ...
  /*copying the manual FTAI list from FTAI list copy fresh list 
    from beginning*/
  for(index = 0; index < num_of_entries && index < LTE_RRC_MAX_NUM_TRACKING_AREAS;index++)
  {
...
FUNCTION  emm_get_mm_spec_rel_ver

DESCRIPTION: 
 
This function returns  mm spec version 
  
DEPENDENCIES:
  None

RETURN VALUE
  Return ue_nas_rel_compliance_type
...
ue_nas_rel_compliance_type emm_get_mm_spec_rel_ver(void)
{
...
FUNCTION  mm_set_emm_edrx_cfg_req_status

DESCRIPTION: This used by MM to set EMM eDRX config request status flag. 
...
void mm_set_emm_edrx_cfg_req_status (nas_edrx_set_cfg_req_enum_T new_status)
{
  emm_ctrl_data_type *emm_ctrl_data_ptr = NULL;

  emm_ctrl_data_ptr = emm_db_get_ctrl_data();

  emm_ctrl_data_ptr->edrx_set_cfg_req_status = new_status;
}

#ifdef FEATURE_NAS_GW
/*===========================================================================

FUNCTION  emm_set_mm_edrx_cfg_req_status

DESCRIPTION: This used by EMM to set MM eDRX config request status flag. 
...
void emm_set_mm_edrx_cfg_req_status (nas_edrx_set_cfg_req_enum_T new_status)
{
  gmm_edrx_params_gsm_ctxt.edrx_cfg_req_status = new_status;
}

/*===========================================================================

FUNCTION  emm_get_gmm_psm_t3324_value

DESCRIPTION: This used by EMM to get last T3324 timer value negotiated by GSM network
...
dword emm_get_gmm_psm_t3324_value (void)
{
  return gmm_psm_timer_ctxt.t3324_value;
}
#endif
/*************************************************************
FUNCTION emm_is_gcf_enable ()

DESCRIPTION
  This function return GCF flag value
...
SIDE EFFECTS
  None
 *************************************************************/
boolean emm_is_gcf_enable(void)
{
...
mm_get_plmn_search_in_progress

DESCRIPTION
  This function return plmn_search_status
...
boolean mm_get_plmn_search_in_progress(void)
{
  return mm_plmn_search_in_progress;
}

#ifdef FEATURE_CIOT
void emm_set_is_t3346_for_mo_exception(boolean value)
{
   emm_ctrl_data_type *emm_ctrl_data_ptr = NULL;
   ...
   emm_ctrl_data_ptr->is_t3346_started_for_mo_excp = value;

   MSG_HIGH_DS(MM_SUB,"=EMM= emm_ctrl_data_ptr->is_t3346_started_for_mo_excp set to %d",emm_ctrl_data_ptr->is_t3346_started_for_mo_excp,0,0);
