...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mm_gstk.c#1 $ $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#endif
  if (!((mm_gstk_is_location_status_evt_reqd()) 
#ifdef FEATURE_NAS_GW
     || ((!reg_nv_is_imsi_switch_enabled()) && (mm_idle_substate == MM_LIMITED_SERVICE))
#endif
     ))
  {
