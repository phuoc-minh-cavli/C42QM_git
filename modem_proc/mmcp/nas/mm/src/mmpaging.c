...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mmpaging.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
void mm_prepare_paging_response(paging_response_msg_T *page_resp, mm_cmd_type *msg_p)
{
  ...
  gs_read_coded_classmark_2((classmark_2_ie_T *)&page_resp->classmark2,
                             mm_gsm_supported,
                             (boolean)(mm_wcdma_supported || mm_tdscdma_supported),
                             is_umts_mode(),
