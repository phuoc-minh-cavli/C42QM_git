...
===========================================================================*/
extern void emm_send_ds_bearer_ctxt_transfer_ind
(
...
extern void emm_process_dcn_list(uint16 dcn_id,emm_ctrl_data_type            *emm_ctrl_data_ptr);
extern int8 emm_search_dcn_list(emm_ctrl_data_type            *emm_ctrl_data_ptr,sys_plmn_id_s_type plmn,int8 *index);
...
===========================================================================*/
boolean emm_write_rplmn_type_to_efs
(
...
boolean emm_write_dcn_list_to_efs
(
  emm_ctrl_data_type      *emm_ctrl_data_ptr
);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean  emm_is_s1_mode_only_3gpp(emm_ctrl_data_type  *emm_ctrl_data_ptr);/* emm_is_s1_mode_only_3gpp */
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean emm_save_psm_context(emm_ctrl_data_type  *emm_ctrl_data_ptr);
...
#ifdef FEATURE_CIOT
boolean  emm_cp_opt_active(emm_ctrl_data_type  *emm_ctrl_data_ptr);
boolean  emm_up_opt_active(emm_ctrl_data_type  *emm_ctrl_data_ptr);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_invalidate_edrx_params
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean emm_chk_attach_with_imsi
(
   emm_ctrl_data_type *emm_ctrl_data_ptr
#if defined(FEATURE_LTE_REL9) && !defined(FEATURE_NAS_IMS_VOICE_DISABLED)
#ifdef  FEATURE_NAS_E911_ENABLE
...
===========================================================================*/
extern boolean emm_chk_nb1_rat (void);


#ifdef FEATURE_CIOT
extern boolean emm_is_attach_without_pdn_supported(void);
#endif
...
===========================================================================*/
extern uint32 emm_get_timer_extention_value (void);
...
===========================================================================*/
extern boolean emm_chk_m1_rat (void);
...
DESCRIPTION
  This function checks if DT access for MMTEL Voice/Video
...
RETURN VALUE
  TRUE if ACB skip allowed, else FALSE

SIDE EFFECTS
  None
===========================================================================*/
extern boolean emm_override_dt_access
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
#endif
...
===========================================================================*/
boolean emm_is_t3446_started_for_mo_exception(void);
...
boolean  emm_call_required_timer_expiry(void);
 ...
 /*===========================================================================
  ...
  DESCRIPTION
	This function allow if mapping of cause 17 to 18 is allowed
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_send_rrc_wwan_set_priority
(
...
#ifdef FEATURE_CIOT
extern void emm_process_pending_mo_exception_data(boolean clear_mo_exception);
#endif
...
===========================================================================*/
extern void emm_send_emm_timer_barring_status_ind
(
emm_timer_barring_status_e_type status,
emm_timer_barring_status_category_e_type category
);

extern void emm_send_cpsr_status_ind
(
emm_cpsr_status status
);

#ifdef FEATURE_FMD_SPEED_INFO
extern void emm_handle_fmd_psm_fallback_timer_expiry(emm_ctrl_data_type *emm_ctrl_data_ptr);
#endif
