...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mmabort.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#endif
      if (msg_p->cmd.hdr.message_id == (int) RR_REL_IND)
      {
...
#if defined(FEATURE_NAS_REL12) && (defined (FEATURE_MMGPS) || defined ( FEATURE_CGPS_UMTS_CP))
                 if (mm_lcs_active)
                 {
