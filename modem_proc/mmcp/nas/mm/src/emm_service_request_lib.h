...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/emm_service_request_lib.h#1 $
...
DESCRIPTION
  This function starts cp servie request procedure
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_start_nas_cp_service_request_procedure
(
  lte_rrc_est_cause_e                     service_req_cause,
...
/*===========================================================================
FUNCTION   emm_send_esm_data_transport_complete_ind
...
SIDE EFFECTS
  None
===========================================================================*/
void emm_send_esm_data_transport_complete_ind
(
);

emm_pended_msg_list_type *emm_find_pended_cpsr
(
  emm_ctrl_data_type *emm_ctrl_data_ptr
);
#endif
...
SIDE EFFECTS
  None
===========================================================================*/
extern void emm_send_esm_data_cnf
(
  dword                 trans_id
);
#endif
