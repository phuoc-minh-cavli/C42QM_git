...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mmrat.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
void mm_handle_stop_mode_cnf (mm_cmd_type *msg_p)
{
  ...
  ** -------------------------------- */
  ...
  else if ( mm_nreg_req_received && mm_is_rat_lte(mm_serving_plmn.info.active_rat) != TRUE)
  {
#ifdef FEATURE_SPEC_COMPLIANT_WTOG_CELL_CHANGE_ORDER
#ifndef FEATURE_NAS_IRAT_DISABLED
      ...
      (mm_is_split_needed() == TRUE))
  {
    ...
    if (mm_reg_waiting_for_reg_cnf)
    {
      ...
      else if(mm_checkif_rat_pri_list_has_rat(&mm_rat_pri_list_info,SYS_RAT_LTE_M1_RADIO_ACCESS))
      {
        mmcoord_mmr_reg_cnf.service_state.active_rat = SYS_RAT_LTE_M1_RADIO_ACCESS;
      }
      else if(mm_checkif_rat_pri_list_has_rat(&mm_rat_pri_list_info,SYS_RAT_LTE_NB1_RADIO_ACCESS))
      {
        mmcoord_mmr_reg_cnf.service_state.active_rat = SYS_RAT_LTE_NB1_RADIO_ACCESS;
      }
    ...
    else
    {
      ...
      {
        mmr_service_ind.service_state.active_rat = SYS_RAT_LTE_M1_RADIO_ACCESS;
      }
      else if(mm_checkif_rat_pri_list_has_rat(&mm_rat_pri_list_info,SYS_RAT_LTE_NB1_RADIO_ACCESS))
      {
        mmr_service_ind.service_state.active_rat = SYS_RAT_LTE_NB1_RADIO_ACCESS;
      }
      else if(mm_checkif_rat_pri_list_has_rat(&mm_rat_pri_list_info,SYS_RAT_TDS_RADIO_ACCESS))
      {
