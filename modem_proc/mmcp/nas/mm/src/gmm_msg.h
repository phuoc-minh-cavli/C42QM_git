...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/gmm_msg.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define GMM_IEI_DEVICE_PROPERTIES   0xD0
...
#define GMM_IEI_T3324_VALUE        0x6A
#define GMM_IEI_EXT_DRX_PARAMS_VALUE      0x6E
#define GMM_EXT_DRX_PARAMS_CONTENT_LENGTH 0x01
...
#endif
  boolean t3324_value_present;
  byte    t3324_value;
  boolean edrx_params_present;
  byte    edrx_params;
