...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mm_sim.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
extern boolean mm_sim_revert_sim_state_on_psm_restore_failure_sim[MAX_NAS_STACKS];
#define mm_sim_revert_sim_state_on_psm_restore_failure mm_sim_revert_sim_state_on_psm_restore_failure_sim[mm_as_id]
#else
extern boolean mm_sim_revert_sim_state_on_psm_restore_failure;
#endif
