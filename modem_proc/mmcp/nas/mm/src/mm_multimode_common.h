...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mm_multimode_common.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
DESCRIPTION:  This function will reset the variables
...
extern boolean mm_get_plmn_search_in_progress(void);
...
extern void mm_handle_isr_timer_expiry(emm_ctrl_data_type *emm_ctrl_data_ptr);
...
extern void mm_set_emm_edrx_cfg_req_status (nas_edrx_set_cfg_req_enum_T new_status);
...
extern void emm_set_mm_edrx_cfg_req_status (nas_edrx_set_cfg_req_enum_T new_status);
...
extern dword emm_get_gmm_psm_t3324_value (void);
...
#ifdef FEATURE_CIOT
extern void emm_set_is_t3346_for_mo_exception(boolean value);
