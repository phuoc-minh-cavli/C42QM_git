...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/mmmain.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
                        ...
                        ** ------------------------------------------------------- */
                        ...
                        switch (message_type)
                        {
                           ...
                           case MM_INFORMATION:
                              ...
                              gmm_handle_information (msg_p->cmd.rr_data_ind.layer3_message,msg_p->cmd.mm_data_ind.message_header, TRUE);
