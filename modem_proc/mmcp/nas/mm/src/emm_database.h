...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/emm_database.h#1 $
...
#define EMM_MAX_ESM_DATA_LENGTH        65535
...
#define TOTAL_NUMBER_OF_CALL_TYPES 8
