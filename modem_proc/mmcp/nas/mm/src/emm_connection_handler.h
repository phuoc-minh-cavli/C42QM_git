...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/emm_connection_handler.h#1 $
...
DESCRIPTION
it will post timer expiry based on timer id 
currently only for barring timer or t3346
