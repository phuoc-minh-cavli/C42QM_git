...
#endif
     if(request_properties_ptr->cn_domain_identity == RRC_PS_DOMAIN_CN_ID)   
     {
...
)
{
                                     ...
                                     (current_domain_id == MM_PS_DOMAIN_CN_ID))
  {
    ...
    /* Update lower layers */
    auth_notify_lower_layer(source_ck,source_ik,source_kc,(rrc_cn_domain_identity_e_type)current_domain_id
#if defined(FEATURE_WCDMA) && defined(FEATURE_TDSCDMA)
    , RRC_SIM_UPDATE_VALUE_CHANGED
#endif
) ;
