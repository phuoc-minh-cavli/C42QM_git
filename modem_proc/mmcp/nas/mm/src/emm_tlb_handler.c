...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/src/emm_tlb_handler.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $ 
...
)
{
  ...
  emm_msgr_send(&dl_tlb_msg.hdr, sizeof(lte_tlb_dl_info_ind_s));
