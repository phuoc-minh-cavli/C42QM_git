...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mm/inc/lte_nas_emm_message_type.h#1 $
$Author: pwbldsvc $
...
typedef struct
{
  ...
  byte                                 edrx_params;
  boolean                              sms_service_exists;
  sys_cp_sms_service_status_e_type     sms_service_status;   
  boolean                              dcn_id_exist;
  uint16                               dcn_id;
  boolean                              t3448_val_exists;
  dword                                t3448_val;
...
#ifdef FEATURE_CIOT
  lte_nas_additional_update_type                additional_update_type;
#endif
...
#ifdef FEATURE_LTE_REL14
  boolean                          replayed_nas_msg_exists;
#endif
...
#ifdef FEATURE_CIOT
/* Define a structure for cp service request. Refer section: 8.2.33*/
typedef struct
{
  lte_nas_hdr_type                        lte_nas_hdr;
  lte_nas_security_hdr_type               security_hdr;
  lte_nas_emm_eps_data_service_type       data_service_type;
  lte_nas_emm_keyset_identifier_type      nas_key_set_identifier;
  boolean                                 esm_msg_container_exists;
  lte_nas_esm_outgoing_msg_type           esm_msg_container;
  boolean                                 nas_msg_container_exists;
  ...
  boolean                                  low_priority_indicator;
#endif
}lte_nas_emm_cp_service_req_type;

/*Define a structure for service accept*/
typedef struct
{
  lte_nas_hdr_type                        lte_nas_hdr;
  lte_nas_security_hdr_type               security_hdr;
...
} lte_nas_emm_service_accept_type;
#endif
...
#ifdef FEATURE_CIOT
  lte_nas_emm_cp_service_req_type         cp_service_req;   /*cp service request*/
#endif
