...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/services/src/bearer_capability_utils.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
boolean pack_bearer_capability(byte *data_ptr, cm_bearer_capability_T *cm_bearer_capability, int *length)
{
  ...
  *length = 0;
  ...
  if(
#if defined(FEATURE_ALS) && !defined(FEATURE_NAS_DISABLE_VOICE)
