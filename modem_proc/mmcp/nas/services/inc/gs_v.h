...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/services/inc/gs_v.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define NAS_STD_OFFSETOF(type, field) __builtin_offsetof(type, field)
