...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/services/inc/timers_v.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define SECOND                         1000
#define GS_MAX_DEBUG_BUFFER  300
/*
 * Timer Ids.
 ************
 */
...
#define TIMER_T3324                       62
#define TIMER_T3325                       60
...
#define TIMER_T3247                     92
#define TIMER_T3449                     93
#define TIMER_T3448                     94
#define TIMER_FMD_PSM_FALLBACK		    95

#define MIN_EMM_TIMER                  TIMER_T3410
#define MAX_EMM_TIMER                  TIMER_FMD_PSM_FALLBACK 

/*EMM Timers End here*/

#define MIN_MM_TIMER                  TIMER_T3210

#define MAX_MM_TIMER                  TIMER_FMD_PSM_FALLBACK

#define MAX_MM_ONLY_TIMER             TIMER_T3324
...
#ifdef FEATURE_CIOT
#define REG_CIOT_IRAT_TIMER          0x18
#define REG_CIOT_NB1_ACQDB_TIER3_TIMER          0x19
#define REG_CIOT_NB1_FULLBAND_TIER3_TIMER       0x1A 
#endif
...
typedef struct gs_timer_debug_info
{
uint64					 timer_count;
...
}gs_timer_debug_info_T;

extern gs_timer_debug_info_T  gs_timer_debug_buffer[GS_MAX_DEBUG_BUFFER];

typedef struct timer_client_info_nas {
  struct 
  {
   struct timer_client_info_nas *next_ptr;		 
   struct timer_client_info_nas *prev_ptr;		 
  } link;
...
#ifdef FEATURE_CIOT
#define CIoT_EMM_FACTOR 49
#define CIoT_ESM_FACTOR 61
#else
#define CIoT_EMM_FACTOR 1
#define CIoT_ESM_FACTOR 1
#endif
