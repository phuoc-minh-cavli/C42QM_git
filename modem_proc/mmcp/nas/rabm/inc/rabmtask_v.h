...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/rabm/inc/rabmtask_v.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#ifdef FEATURE_MBMS
#define MAX_RAB_NUM 255   // MAX_RAB_NUM is set to 254 to have rab up to 254. Index 0~4 on rab_list[] and rabm_timer_status[] will not be used.
