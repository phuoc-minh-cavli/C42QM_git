...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/inc/reg_sim_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
extern reg_sim_fplmn_counter_list_s_type reg_sim_gprs_fplmn_list_sim[MAX_NAS_STACKS];
#define reg_sim_gprs_fplmn_list reg_sim_gprs_fplmn_list_sim[reg_sub_id]
#else
extern reg_sim_fplmn_counter_list_s_type reg_sim_gprs_fplmn_list;
#endif
...
*/
#if defined FEATURE_DUAL_SIM || defined FEATURE_SGLTE
extern reg_sim_dos_mitigation_plmn_list_s_type reg_sim_dos_mitigation_fplmn_list_sim[MAX_NAS_STACKS];
#define reg_sim_dos_mitigation_fplmn_list reg_sim_dos_mitigation_fplmn_list_sim[reg_sub_id]
#else 
extern reg_sim_dos_mitigation_plmn_list_s_type reg_sim_dos_mitigation_fplmn_list;
#endif
...
#ifdef FEATURE_LTE
#define REG_SIM_BACKOFF_FPLMN_LIST_LENGTH 10
typedef enum
{
...
{
  uint32                   length;
  reg_sim_plmn_timer_info_s_type       plmn_timer_list[REG_SIM_BACKOFF_FPLMN_LIST_LENGTH];
...
#define REG_MODE_MAX_3GPP_RAT 6
#else
#define REG_MODE_MAX_3GPP_RAT 5
#endif
#else
...
extern boolean reg_sim_revert_sim_state_on_psm_restore_failure_sim[MAX_NAS_STACKS];
#define reg_sim_revert_sim_state_on_psm_restore_failure  reg_sim_revert_sim_state_on_psm_restore_failure_sim[reg_as_id]
#else
extern boolean reg_sim_revert_sim_state_on_psm_restore_failure;
#endif
...
extern void reg_sim_reset_nasconfig
(
  void
);
...
RETURN VALUE
  None
==============================================================================*/
extern void reg_sim_restore_psm_backoff_fplmn_list(void);
...
extern void reg_sim_set_fast_hplmn_tag
(
...
RETURN VALUE
  Is fast hplmn tag set
==============================================================================*/

extern boolean reg_sim_get_fast_hplmn_tag
(
  void
);
#endif
...
RETURN VALUE
  None
==============================================================================*/
extern void reg_sim_set_attach_with_imsi_cfg
(
...
RETURN VALUE
  None
==============================================================================*/
extern void reg_sim_set_eutran_not_allowed 
(
...
extern boolean reg_sim_get_eutran_not_allowed 
(
  void
);
#endif
...
/*==============================================================================
FUNCTION NAME:  reg_sim_remove_plmn_from_dos_mitigation_fplmn_list

DESCRIPTION
  Function to remove a PLMN from the DoS mitigation PLMN list
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_remove_plmn_from_dos_mitigation_fplmn_list
(
  sys_plmn_id_s_type plmn
#ifdef FEATURE_DUAL_SIM
  ,sys_modem_as_id_e_type as_id
...
/*==============================================================================
FUNCTION NAME:  reg_sim_add_plmn_to_dos_mitigation_fplmn_list

DESCRIPTION
  Function to add a PLMN to the DoS mitigation PLMN list
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_add_plmn_to_dos_mitigation_fplmn_list
(
  sys_plmn_id_s_type plmn
#ifdef FEATURE_DUAL_SIM
  ,sys_modem_as_id_e_type as_id
...
/*==============================================================================
FUNCTION NAME:  reg_sim_find_plmn_in_fplmn_counter_list

DESCRIPTION
  Function to find a PLMN to the DoS mitigation GPRS FPLMN list
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_find_plmn_in_fplmn_counter_list
(
        sys_plmn_id_s_type                 plmn,
...
/*==============================================================================
FUNCTION NAME:  reg_sim_find_plmn_in_dos_mitigation_counter_list

DESCRIPTION
  Function to find a PLMN to the DoS mitigation FPLMN list
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_find_plmn_in_dos_mitigation_counter_list
(
        sys_plmn_id_s_type                       plmn,
...
/*==============================================================================
FUNCTION NAME:  reg_sim_is_plmn_dos_gprs_forbidden

DESCRIPTION
  Function to check if a PLMN is GPRS forbidden for DoS mitigation
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_is_plmn_dos_gprs_forbidden
(
...
/*==============================================================================
FUNCTION NAME:  reg_sim_is_plmn_dos_forbidden

DESCRIPTION
  Function to check if a PLMN is forbidden for DoS mitigation
  
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_is_plmn_dos_forbidden
(
  sys_plmn_id_s_type plmn_id
#ifdef FEATURE_DUAL_SIM
  ,sys_modem_as_id_e_type as_id 
