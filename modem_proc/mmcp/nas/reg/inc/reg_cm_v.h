...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/inc/reg_cm_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
==============================================================================*/
extern boolean cm_mcc_change_ind_is_valid
(
...
RETURN VALUE
  ...
  boolean  Flag indicating whether the cm_network_list_cnf_s_type
           contains valid data (TRUE) or invalid data (FALSE). 

==============================================================================*/

extern boolean cm_network_list_cnf_is_valid
(
