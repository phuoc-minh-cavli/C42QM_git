...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/inc/reg_mm_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
DESCRIPTION
  ...
  Function clears forbidden flag for forbidden PLMN and GPRS forbidden PLMNs
  added due to DoS mitigation

RETURN VALUE
  None

==============================================================================*/
extern void reg_sim_cleanup_dos_fplmn_list_on_t3247_exp
(
#ifdef FEATURE_DUAL_SIM
  sys_modem_as_id_e_type as_id
#else
...
DESCRIPTION
  ...
  Function removes forbidden PLMN and GPRS forbidden PLMNs
  added due to DoS mitigation
...
==============================================================================*/
extern void reg_sim_reset_dos_fplmn_list
(
#ifdef FEATURE_DUAL_SIM
  sys_modem_as_id_e_type as_id
#else
...
FUNCTION NAME
  ...
  reg_sim_reset_plmn_counter_in_fplmn_list

DESCRIPTION

  Function resets counter to 0 for forbidden PLMN and GPRS forbidden PLMNs
  added due to DoS mitigation
...
==============================================================================*/
extern void reg_sim_reset_plmn_counter_in_fplmn_list
(
