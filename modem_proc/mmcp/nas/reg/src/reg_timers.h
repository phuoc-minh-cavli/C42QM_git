...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/src/reg_timers.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/13/02   kwa     Initial release.
05/21/02   kwa     Added watchdog timerREG_INTERLACE_SCAN_TIMER_DEFUALT_VALUE
...
#ifdef FEATURE_CIOT
#define REG_CIOT_IRAT_TIMER_DEFAULT_VALUE      (rex_timer_cnt_type)~0
#define REG_INTERLACE_SCAN_TIMER_DEFUALT_VALUE (rex_timer_cnt_type)40
#define REG_INTERLACE_NB1_TIER3_ACQ_DEFUALT_VALUE (rex_timer_cnt_type)120
#define REG_INTERLACE_NB1_TIER3_FULLBAND_DEFUALT_VALUE (rex_timer_cnt_type)240
#endif
...
RETURN VALUE
  None
===========================================================================*/
extern void reg_timers_psm_save_hplmn_search_timer(void);
...
RETURN VALUE
  None
===========================================================================*/
extern void reg_timers_psm_restore_hplmn_search_timer(void);
...
DESCRIPTION
  This function starts the hplmn timer with a passed in timeout
  
RETURN VALUE
  None
===========================================================================*/
void reg_timers_start_hplmn_search_timer_value(dword timeout);
...
==============================================================================*/
boolean reg_timers_start_ciot_irat_search_period_timer(void);
/*==============================================================================
...
==============================================================================*/
void reg_timers_stop_ciot_irat_search_period_timer(void);
/*===========================================================================
FUNCTION NAME 
...
RETURN VALUE
  None
===========================================================================*/
extern void reg_timers_psm_restore_ciot_irat_timer(void);

void reg_timers_psm_save_ciot_nb1_interleave_timers(void);
extern void reg_timers_psm_restore_nb1_interleave_timers(void);
...
//FRACQ
#ifdef FEATURE_CIOT
extern rex_timer_cnt_type reg_timers_get_rem_ciot_irat_value
(
  void
);

extern boolean reg_is_ciot_irat_timer_active
(
#ifdef FEATURE_DUAL_SIM
  sys_modem_as_id_e_type as_id
#endif
...
extern void reg_timers_start_nb1_tier3_acq_timer
(
  void
);


extern void reg_timers_start_nb1_tier3_fullband_timer
(
  void
);


extern void reg_timers_stop_nb1_tier3_acq_timer
(
  void
);


extern void reg_timers_stop_nb1_tier3_fullband_timer
(
  void
);
