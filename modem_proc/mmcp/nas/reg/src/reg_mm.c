...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/src/reg_mm.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
)
{
  ...
  else if ((msg_p) && (msg_p->service_search != SYS_SERVICE_SEARCH_CELL_SEARCH)
