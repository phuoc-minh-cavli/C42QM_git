...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/src/reg_send.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
extern void reg_send_empty_cm_network_list_cnf
(
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_filter_bands_for_gps
(
sys_radio_access_tech_e_type rat,
sys_wwan_adavnce_scan_pram_s_type gps_wwan_search_info,
...
extern void reg_send_mmr_psm_set_config_params_req
(
...
extern void reg_send_mmr_psm_get_timer_info_req
(
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_auto_ready_ind
(
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_timer_change_ind
(
...
extern sys_scan_scope_e_type reg_send_last_reg_req_scan_scope_get
(
  void
);
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_set_config_params_rsp
(
  void
);
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_mmr_enter_psm_mode_req
(
  void
);
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_mmr_psm_save_mmgsdi_ef_req
(
  void
);
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_save_mmgsdi_ef_rsp
(
  boolean status
);
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_enter_psm_mode_rsp
(
  boolean         status,
  uint8          *buf_ptr,
  uint32          buf_len
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_get_timer_info_rsp
(
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_edrx_params_change_ind
(
...
DESCRIPTION
  This REG function notifies CM that PSM sleep could be unblocked

RETURN VALUE
  none
==============================================================================*/
extern void reg_send_cm_psm_unblock (void);
/*==============================================================================
...
RETURN VALUE
  none
==============================================================================*/
extern void reg_send_mmr_home_roam
(
  boolean home
);

extern void reg_send_mmr_reset_scan_info(void);
