...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/reg/src/reg_mode_manual_csg_selection.c#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
void start_manual_csg_selection
(
...
==============================================================================*/
void start_manual_csg_selection_app
(
  sys_network_selection_mode_e_type    network_selection_mode,
  boolean                              cs_for_request,
  boolean                              ps_for_request,
