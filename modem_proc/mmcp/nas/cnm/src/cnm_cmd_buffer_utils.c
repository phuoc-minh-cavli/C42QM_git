...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_cmd_buffer_utils.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
VOID_FUNC * CNM_alloc( unsigned int size ) 
{
  ...
  if ( p_mem == NULL )
  {
    MSG_FATAL_MN_DS(MN_SUB,"gs_alloc failure for CNM task\n", 0, 0, 0);
  }
