...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_send_mn_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
                                   ...
                                   reject_cause_T rej_value )
{
   ...
   memset(&mncc_rej_ind, 0, sizeof(MNCC_REJ_IND_T));
   ...
   if ( p_cnm_request_id->CNM_service_type == SUPPLEMENTARY_SERVICE_ACTIVATION )
   {
   ...
   if(p_cnm_request_id->CNM_service_type == SHORT_MESSAGE_SERVICE_ESTABLISHMENT)
   {
