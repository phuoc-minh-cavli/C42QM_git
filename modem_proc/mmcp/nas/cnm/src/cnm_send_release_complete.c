...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_send_release_complete.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#if !defined(FEATURE_MMCP_DISABLE_CS_USSD) || !defined(FEATURE_NAS_DISABLE_VOICE)
#include "rex.h"
