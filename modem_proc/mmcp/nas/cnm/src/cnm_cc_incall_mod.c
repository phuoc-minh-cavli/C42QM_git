...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_cc_incall_mod.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#if  !defined(FEATURE_NAS_DISABLE_VOICE) && defined(DISABLE_9x05_OPTIMIZATIONS)
