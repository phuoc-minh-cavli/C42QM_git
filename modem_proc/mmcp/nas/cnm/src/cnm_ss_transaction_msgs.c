...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_ss_transaction_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
   ...
   if (type == REGISTER)
   {
      ...
      if ( syntax_ok != FALSE )
      {
         ...
         if ( respond_to_event != FALSE )
         {
            ...
            MN_get_MNSS_BEGIN_IND((MNSS_BEGIN_IND_T *)&mnss_begin_ind);
#else
