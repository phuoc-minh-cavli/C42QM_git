...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_mntask_main.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
static mn_cnm_cmd_type *mn_cnm_cmd_q_get(void)
{
   ...
   return (mn_cnm_cmd_type*)q_get(&mm_cmd_q);
