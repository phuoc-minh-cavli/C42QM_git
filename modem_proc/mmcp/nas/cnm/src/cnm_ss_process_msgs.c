...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_ss_process_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
                     MN_get_MNSS_FACILITY_IND((MNSS_FACILITY_IND_T *)&mnss_facility_ind);
#else
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
                  MN_get_MNSS_END_IND(&mnss_end_ind);
#else
