...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_ss_mn_primitives.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
                                ...
                                byte cause)
{
   ...
   MN_get_MNSS_REJ_IND(p_mnss_rej_ind);
#else
