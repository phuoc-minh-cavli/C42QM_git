...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_process_mm_primitives.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#else
	 send_message_to_mm(&mmcc_reest_req.header,sizeof(mmcc_reest_req_T));
#endif
