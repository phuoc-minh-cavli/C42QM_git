...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_cc_process_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
                  ...
                  else if ( cc_event == CC_DISCONNECT_event )
                  {
                                                                      ...
                                                                      == CC_STATE_U12 )) )
                      {
                              ...
                              (p_mmcnm_data_ind->data[0] <= GSM_CAUSE_SIZE))
                          {
                              ...
                              memscpy(&(p_mncc_rel_ind->data[2]), sizeof(p_mncc_rel_ind->data)-2,
...
#else
			MN_handle_MNCC_SYNC_IND(&mncc_sync_ind.message_header);
#endif
