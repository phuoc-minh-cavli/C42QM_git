...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_sms_mn_primitives.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
                                    ...
                                    )
{
   ...
   p_mnsms_error_ind->permanent_error = ((reject_cause == MM_REJ_INVALID_SIM) ||
										...
										(reject_cause == EMM_REJ_HARD_FAIL))? 1:0;
...
#else
   MN_handle_MNSMS_CPACK_IND(&p_mnsms_cpack_ind->message_header);
#endif
