...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/cnm/src/cnm_cc_mn_primitives.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#if defined(FEATURE_UUS) && !defined(FEATURE_NAS_DISABLE_VOICE)
                               ...
                               byte *data)
{
    ...
    CNM_send_message((IMH_T *)&mncc_rel_cnf,GS_QUEUE_MN_CM ); //9x05 Optimization
#else
     MN_handle_MNCC_REL_CNF(&mncc_rel_cnf.message_header); 
#endif
}
