...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/src/esm_bpm.h#1 $
...
typedef boolean handle_bpm_message_fp (  mm_cmd_type* cmd, struct esm_bpm* mgr);
...
extern void esm_build_and_send_esm_dummy_accept
( 
