...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/src/esm_proc_inactive.c#1 $
...
(
  struct esm_bearer_resource_proc* proc_ptr, const emm_bearer_resrc_alloc_req_s_type* msg_ptr  /*!< REQUIRED short parameter description */
)
{
...
(
  ...
  emm_pdn_disconnect_req_s_type* data_ptr
)
{
  boolean status = FALSE;
