...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/src/esm_context_state.h#1 $
...
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_default_bearer_context_accept_T* msg_ptr /* over the air message structure */
);

typedef void esm_ctxt_act_dedicated_bearer_ctxt_accept_fp        
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_dedicated_bearer_context_accept_T* msg_ptr, /* over the air message structure */
...
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_default_bearer_context_rej_T* msg_ptr /* over the air message structure */
);

typedef void esm_ctxt_act_dedicated_bearer_ctxt_reject_fp        
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_dedicated_bearer_context_rej_T* msg_ptr /* over the air message structure */
);
...
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_default_bearer_context_accept_T* msg_ptr
) ;
extern void esm_ctxt_discard_act_dedicated_bearer_ctxt_accept
(
  struct esm_eps_bearer_context* ctxt_ptr, 
  const emm_act_dedicated_bearer_context_accept_T* msg_ptr,
  struct esm_bcm* mgr_ptr
) ;
