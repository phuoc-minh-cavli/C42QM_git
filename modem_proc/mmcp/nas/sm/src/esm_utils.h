...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/src/esm_utils.h#1 $
...
(
  ...
  const emm_act_dedicated_bearer_context_rej_T* msg_ptr 
);
...
*/
/*============================================================================*/
extern boolean esm_check_if_detach_to_be_triggered(byte bearer_id);
...
#define esm_modem_mem_alloc(x)  esm_modem_mem_alloc_debug(x)
...
#define esm_modem_mem_free(x) esm_modem_mem_free_debug(x)
...
/*!
    @brief
    This function sends ESM DATA TRANSPORT to CM 
...
SIDE EFFECTS
 None
/*============================================================================*/
extern void esm_send_cm_restore_ctxt_psm_req(void);
...
SIDE EFFECTS
 None
/*============================================================================*/
extern boolean esm_save_psm_context(esm_bcm_T *mgr_ptr);
...
SIDE EFFECTS
 None
/*============================================================================*/
extern boolean esm_restore_psm_context(void);
...
SIDE EFFECTS
 None
/*============================================================================*/
extern void esm_send_cm_restore_bearer_ctxt_rsp
(
...
SIDE EFFECTS
 None
/*============================================================================*/
extern void esm_send_emm_restore_ctxt_psm_rsp
(
  boolean status
);
...
SIDE EFFECTS
 None
/*============================================================================*/
extern void esm_send_emm_save_ctxt_psm_rsp
(
  boolean status
);
/*===========================================================================
...
===========================================================================*/
extern dword esm_get_timer_extention_value (void);
#ifdef FEATURE_NAS_REL12
extern ue_nas_rel_compliance_type emm_get_mm_spec_rel_ver(void);
#endif
...
===========================================================================*/
extern void esm_get_epco_dsm_attachment
(
...
===========================================================================*/
extern void esm_populate_epco_payload
(
...
===========================================================================*/
extern void esm_free_epco_payload
(
...
===========================================================================*/
extern void esm_free_dl_msg_epco_dsm
(
