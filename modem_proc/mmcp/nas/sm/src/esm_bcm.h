...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/src/esm_bcm.h#1 $
...
#define MAX_ALLOWED_EPS_BEARERS_NB1      2
...
typedef boolean esm_chk_if_detach_to_be_triggered_fp(byte bearer_id);
...
typedef struct esm_eps_bearer_context
{
  ...
  esm_chk_if_detach_to_be_triggered_fp* check_detach_trigger;
...
#endif
  ext_protocol_cfg_options_T epco;  /*!< EPCO */
...
typedef void handle_bcm_cm_message_fp ( mm_cmd_type* cmd, struct esm_bcm* mgr, byte con_id);
typedef void handle_bcm_emm_message_fp ( mm_cmd_type* cmd, struct esm_bcm* mgr);
...
/*==============================================================================
  ...
  are not transferbale upon IRAT between NB1 and CATM1

==============================================================================*/
extern void esm_bcm_deactivate_non_transferable_ctxts_irat_m1_nb1
(
