...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/inc/smix_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define IEI_REATTEMPT_INDICATOR         0x6B
#define IEI_DEVICE_PROPERTIES           0xC0

#ifdef FEATURE_MBMS
#define IEI_TMGI_LEN   7
#define IEI_MBMS_BEARER_CAP 2
#define IEI_MBMS_PROT_CONFIG_OPT   0x35 //later
#define IEI_ENHANCED_NSAPI   1
#endif
/* ---------------------------------------------------------------------------
...
#ifdef FEATURE_MBMS
#define SM_ACTIVATE_MBMS_CONTEXT_ACCEPT_LEN  8 //later changed from 7 t0 8
#define SM_ACTIVATE_MBMS_CONTEXT_REJECT_LEN   3
#define SM_REQUEST_MBMS_CONTEXT_ACTIVATION_LEN     8
#endif
