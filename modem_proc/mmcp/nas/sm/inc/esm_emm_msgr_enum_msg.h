...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/inc/esm_emm_msgr_enum_msg.h#1 $
...
#endif
#ifdef FEATURE_CIOT
  MSGR_DEFINE_UMID(NAS, ESM, CNF,DATA, 0x15, emm_esm_data_cnf_T ),
  MSGR_DEFINE_UMID(NAS, ESM, IND,ATTACH_STATUS,0x0E,emm_esm_attach_status_ind_T),  
	//ESM_IND
#endif
  MSGR_DEFINE_UMID(NAS, ESM, REQ,SAVE_CTXT_PSM, 0x13, esm_save_ctxt_psm_req_T),
  MSGR_DEFINE_UMID(NAS, ESM, REQ,RESTORE_CTXT_PSM, 0x14, esm_restore_ctxt_psm_req_T),
  NAS_ESM_IND_MAX,
