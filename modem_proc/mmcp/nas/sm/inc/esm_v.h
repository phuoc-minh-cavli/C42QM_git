...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/sm/inc/esm_v.h#1 $
...
typedef enum
{
  ESM_NOT_ATTACHED_WITHOUT_PDN,
  ESM_ATTACHED_WITHOUT_PDN_PENDING,
  ESM_ATTACHED_WITHOUT_PDN_SUCCESS,
  ESM_ATTACHED_WITHOUT_PDN_MAX

}esm_attach_without_pdn_type;
