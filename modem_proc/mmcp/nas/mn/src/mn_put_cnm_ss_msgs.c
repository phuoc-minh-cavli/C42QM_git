...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mn/src/mn_put_cnm_ss_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_mo_end_ss_request((IMH_T *)&message_ptr);
#else
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_start_mo_ss_request((IMH_T *)&message_ptr);
#else
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_facility((IMH_T *)&message_ptr);
#else
   success = MN_send_message(GS_QUEUE_MN_CM, &message_ptr, TRUE);
#endif
