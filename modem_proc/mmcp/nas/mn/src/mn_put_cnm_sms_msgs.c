...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mn/src/mn_put_cnm_sms_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#else
   CNM_handle_short_message_services(&message.message_header);
#endif
}
