...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mn/src/mn_put_cnm_cc_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
VOID_FUNC MN_put_MNCC_ALERT_REQ(connection_id_T connection_id)
{
   ...
   memset((void *)&message_ptr,0,sizeof(MNCC_ALERT_REQ_T));
   ...
   /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_alert_request((IMH_T *)&message_ptr.message_header);
  #else
...

{
   ...
   else
   {
      ...
      memset((void *)message_ptr,0,sizeof(MNCC_CALL_CONF_REQ_T));
      message_ptr->message_header.message_set = MS_MN_CC;
...
/* -----------------------------------------------------------*/                    
          ...
          else
          {
            ...
            {
              message_ptr->data[data_index++] = 0x00; /* bitmap 8...1 */
            }
...
/* GSM AMR codecs should be included conditionally depending on the 
    NV Item - NV_GSM_AMR_CALL_CONFIG_I */         
            ...
            message_ptr->data[data_index] = 0x07; /* bitmap 8...1  enabling GSM FR,HR,EFR by default */
#else
            message_ptr->data[data_index] = 0x00; /* bitmap 8...1  not enabling GSM FR,HR,EFR by default */
#endif
      ...
      /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
	  CNM_process_mt_call_confirm((IMH_T *)&message_ptr->message_header);
#else
                                 ...
                                 ie_cm_cc_invoke_T *cm_cc_invoke)
{
   ...
   memset((void *)&message_ptr,0,sizeof(MNCC_DISC_REQ_T));
    ...
    if(connection_id <  MAXNO_CC_TRANSACTIONS)
    {
       ...
       /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
  CNM_process_mo_disc_request((IMH_T *)&message_ptr.message_header);
...
ie_cm_cc_cause_T *cm_cc_cause)
{
   ...
   memset((void *)&message_ptr,0,sizeof(MNCC_REJ_REQ_T));
   ...
   PUT_IMH_LEN(message_length,&message_ptr.message_header)
       ...
       /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mt_call_reject((IMH_T *)&message_ptr.message_header);
  #else
...
)
{
   ...
   memset((void *)&message_ptr,0,sizeof(MNCC_REL_REQ_T));
   message_ptr.message_header.message_set = MS_MN_CC;
   ...
   /*  SEND THE MESSAGE  */
   #ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_release_request((IMH_T *)&message_ptr.message_header);
                                    ...
                                    ie_facility_T *p_facility)
{
   ...
   memset((void *)&message,0,sizeof(MNCC_REL_COMPL_REQ_T));
   message.message_header.message_set = MS_MN_CC;
   ...
   /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_release_complete_request((IMH_T *)&message.message_header);
#else
...
VOID_FUNC MN_put_MNCC_SETUP_COMPL_REQ(connection_id_T connection_id)
{
   ...
   memset((void *)&message_ptr_2,0,sizeof(MNCC_SETUP_COMPL_REQ_T));
   ...
   /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_user_conn_confirmation((IMH_T *)&message_ptr_2.message_header);
#else
...
VOID_FUNC MN_put_MNCC_SETUP_COMPL_RES(connection_id_T connection_id)
{
   ...
   memset((void *)&message_ptr_3,0,sizeof(MNCC_SETUP_COMPL_RES_T));
   message_ptr_3.message_header.message_set = MS_MN_CC;
   ...
   /*  SEND MESSAGE  */
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mt_call_setup_completion((IMH_T *)&message_ptr_3.message_header);
#else
...
cm_connected_subaddress_T *connected_subadd_ptr)
{
   ...
   memset((void *)&message_ptr_4,0,sizeof(MNCC_SETUP_RES_T));
   ...
   PUT_IMH_LEN(message_length,&message_ptr_4.message_header)
       ...
       /*  SEND THE MESSAGE  */
   #ifndef DISABLE_9x05_OPTIMIZATIONS
     CNM_process_mt_call_answer((IMH_T *)&message_ptr_4.message_header);
   #else
...
VOID_FUNC MN_put_MNCC_SETUP_REQ(connection_id_T connection_id)
{
   ...
   if(connection_id <= MAX_MO_CONNECTION_ID)
   {
      ...
      memset((void *)message_ptr,0,sizeof(MNCC_SETUP_REQ_T));
      message_ptr->message_header.message_set = MS_MN_CC;
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
      CNM_process_mo_call_request((IMH_T *)&message_ptr->message_header);
#else
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_start_dtmf_request(&message_ptr);
#else
...
#ifndef DISABLE_9x05_OPTIMIZATIONS
   CNM_process_mo_stop_dtmf_request(&message_ptr_2);
#else
   func_return_val = MN_send_message(GS_QUEUE_MN_CM, &message_ptr_2, TRUE);
