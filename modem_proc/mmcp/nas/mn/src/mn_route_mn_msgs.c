...
$Header: //components/rel/mmcp.mpss/6.1.10/nas/mn/src/mn_route_mn_msgs.c#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...

{
   ...
   case MS_MN_SS:
      ...
      {
#ifdef FEATURE_MMCP_DISABLE_CS_USSD
         ERR("ERROR: Invalid MN input primitive",0,0,0);
#else
...

{
...

   {
...

      {
         ...
         ERR("ERROR: Invalid MN-SS input primitive",0,0,0);
#else
