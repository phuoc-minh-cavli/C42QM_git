...
$Header: //components/rel/mmcp.mpss/6.1.10/api/reg_task_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef struct reg_set_hplmn_search_timer_req_s
{
...
} reg_set_hplmn_search_timer_req_s_type;
...
typedef struct
{
  ...
  union cmd_u_type
  {
    ...
    */
    ...
    mmr_sim_state_revalidate_ind_s_type     mmr_sim_state_revalidate_ind;
...
#ifdef FEATURE_CIOT
    mmr_edrx_page_start_s_type              mmr_edrx_page_start_ind;
#endif
    ...
    */
    ...
    cm_psm_set_config_params_req_s_type          cm_psm_set_cfg_params_req;
    cm_psm_get_timer_info_req_s_type             cm_psm_get_timer_info_req;
    cm_enter_psm_mode_req_s_type                 cm_enter_psm_mode_req;
    cm_set_edrx_cfg_req_s_type                   cm_set_edrx_cfg_req;
    cm_get_edrx_params_req_s_type                cm_get_edrx_params_req;    
    cm_mcc_change_ind_s_type                     cm_mcc_change_ind;
    cm_psm_save_mmgsdi_ef_req_s_type              cm_psm_save_mmgsdi_ef_req;
    /*
    ** Timers
    */
   ...
   reg_sim_card_busy_ind_s_type   sim_busy_ind;
    ...
    reg_set_hplmn_search_timer_req_s_type       set_hplmn_search_timer_req;
...
#define REG_CHECK_BM_32BIT( val, bit )   (boolean)( (val & (SYS_BM_32BIT( bit ))) > 0 )
#define REG_SET_BM_32BIT( val, bit )     ( val |= (SYS_BM_32BIT( bit )) )
#define REG_CLEAR_BM_32BIT( val, bit )   ( val &= ~(SYS_BM_32BIT( bit )) )
