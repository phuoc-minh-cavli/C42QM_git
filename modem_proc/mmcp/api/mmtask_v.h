...
$Header: //components/rel/mmcp.mpss/6.1.10/api/mmtask_v.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef enum
{
 EMM_ESM_SIG_CONNECTION_RELEASED_IND = 0xD0,
 EMM_ESM_DATA_CNF,
 EMM_ESM_ACTIVE_EPS_IND,
 EMM_ESM_DATA_IND,
 EMM_ESM_FAILURE_IND,
 EMM_ESM_DETACH_IND,
 EMM_ESM_EPS_BEARER_STATUS_IND,
 EMM_ESM_ATTACH_STATUS_IND,
 EMM_ESM_GET_PDN_CONNECTIVITY_REQ_IND,
 EMM_ESM_UNBLOCK_ALL_APNS_IND,
 EMM_ESM_SAVE_CTXT_PSM_REQ,
 EMM_ESM_RESTORE_CTXT_PSM_REQ,
 EMM_ESM_CIOT_RAT_CHANGE_IND,
 EMM_ESM_CMD_MAX
} esm_mm_cmd_e_T ;
...
typedef struct
{
  ...
  IMH_T                        message_header;
  sys_radio_access_tech_e_type ps_rat;
  pdn_conn_req_status_T        call_control_result;
  union
  {
    cm_lte_ps_cc_params_s_type lte_ps_params;  // (exisiting structures, ss & as_id would be removed)
    cm_gw_ps_cc_params_s_type  gw_ps_params;
  }ps_params;
}cm_mm_call_ctrl_rsp_s_type;
...
typedef struct mm_wwan_tech_suspend_ind_s
{
  IMH_T                      IMH;
  boolean                    tech_suspend;
}mm_wwan_tech_suspend_ind_s_type;
...
typedef union mm_int_cmd_type_tag {
  ...
  mmr_ps_detach_req_s_type             mmr_ps_detach_req;
   ...
   mmr_psm_set_config_params_req_s_type    mmr_psm_set_cfg_params_req;
   mmr_psm_get_timer_info_req_s_type       mmr_psm_get_timer_info_req;
   mmr_enter_psm_mode_req_s_type           mmr_enter_psm_mode_req;
   mmr_set_edrx_cfg_req_s_type             mmr_set_edrx_cfg_req;
   mmr_get_edrx_params_req_s_type          mmr_get_edrx_params_req;
   mmr_send_plmn_home_roam_ind_s_type      mmr_send_plmn_home_roam_ind;
   mmr_psm_save_mmgsdi_ef_req_s_type       mmr_psm_save_mmgsdi_ef_req;
#ifdef FEATURE_WCDMA
   /* RRC ==> MM */
   ...
   gmmsm_ps_call_status_ind_T      gmmsm_ps_call_status_ind;
   gmmsm_restore_ctxt_psm_cnf_T    gmmsm_restore_ctxt_psm_cnf;
   gmmsm_save_ctxt_psm_cnf_T       gmmsm_save_ctxt_psm_cnf;
   ...
   cm_mm_call_ctrl_rsp_s_type       cm_mm_call_ctrl_rsp;
   cm_mm_update_ftai_list_T cm_mm_update_ftai_list;

/* MCFG ==> MM */
   mm_mcfg_refresh_ind_s_type          mcfg_refresh_ind;
   mm_wwan_tech_suspend_ind_s_type     mm_wwan_tech_suspend_ind;
...
/* EMM to ESM */
  ...
  esm_ciot_rat_change_ind_T           esm_ciot_rat_change_ind;

  //esm_data_transport_req_T                    esm_data_transport_req;
   ...
   /*! @brief Messages sent by the DS to MM. */ 
   emm_rab_reestab_req_s_type                           emm_rab_reestab_req;
   emm_pdn_disconnect_req_s_type                        emm_disconnect_req;
   emm_pdn_connectivity_req_s_type                      emm_pdn_connectivity_req;
   emm_pdn_connectivity_abort_req_s_type                emm_pdn_connectivity_abort_req;
   emm_mod_bearer_req_s_type                            emm_mod_bearer_req;//Remove
   emm_mod_bearer_rsp_s_type                            emm_mod_bearer_rsp;
   emm_bearer_resrc_alloc_req_s_type                    emm_bearer_resrc_alloc;
   emm_bearer_resrc_alloc_abort_s_type                  emm_bearer_resrc_alloc_abort;
   emm_esm_data_transport_req_type                      esm_data_transport_req; 
   emm_act_default_bearer_context_accept_T              emm_act_default_bearer_context_accept;
   emm_act_default_bearer_context_rej_T                 emm_act_default_bearer_context_rej;
   emm_act_dedicated_bearer_context_accept_T            emm_act_dedicated_bearer_context_accept; 
   emm_act_dedicated_bearer_context_rej_T               emm_act_dedicated_bearer_context_rej;
   // emm_act_deact_bearer_context_accept_T                     emm_act_deact_bearer_context_accept;
   emm_modify_bearer_context_rej_T                      emm_modify_bearer_context_rej;
   emm_modify_bearer_context_accept_T                   emm_modify_bearer_context_accept;
   emm_bearer_resource_modification_req_T               emm_bearer_resource_modification_req;

   mm_pdp_activate_req_T                                pdp_activate_req;
   mm_pdp_deactivate_req_T                              pdp_deactivate_req;
   mm_pdp_modify_req_s_type                             pdp_modify_req;
   mm_pdp_activate_rej_resp_T                           pdp_activate_rej_resp;
   mm_pdp_activate_sec_req_T                            pdp_sec_activate_req;
   mm_pdp_activate_sec_cnf_T                            pdp_act_sec_cnf;
   mm_pdp_nw_modify_rej_T                               pdp_nw_modify_rej;
   mm_pdp_nw_modify_cnf_T                               pdp_nw_modify_cnf;
   mm_blocked_apn_list_ind_T                            blocked_apn_list_ind;//Remove
   mm_restore_psm_ctxt_rsp_T                            mm_restore_psm_ctxt_rsp;
   mm_ps_data_avail_req_T                               mm_ps_data_avail_req;
   emm_restore_bearer_ctxt_req_s_type                   emm_restore_bearer_ctxt_req;
   mm_restore_pdp_ctxt_req_s_type                       mm_restore_pdp_ctxt_req;
   emm_mo_exception_data_ind_s_type                     emm_mo_exception_data_ind;
