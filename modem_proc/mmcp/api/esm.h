...
$Header: //components/rel/mmcp.mpss/6.1.10/api/esm.h#1 $
...
{  
    ...
    esm_restore_bearer_ctxt_req_T               esm_restore_bearer_ctxt_req;
    esm_restore_ctxt_psm_rsp_T                  esm_restore_ctxt_psm_rsp;
