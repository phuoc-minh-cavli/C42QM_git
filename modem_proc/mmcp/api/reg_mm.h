...
$Header: //components/rel/mmcp.mpss/6.1.10/api/reg_mm.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef enum
{
 ...
 ,MMR_SUITABLE_SEARCH_END_IND = 0x8F
  ...
  ,MMR_PSM_AUTO_READY_IND = 0xB0
  ,MMR_PSM_TIMER_CHANGE_IND = 0xB1
  ,MMR_PSM_SET_CONFIG_PARAMS_REQ = 0xB2
  ,MMR_PSM_SET_CONFIG_PARAMS_RSP = 0xB3
  ,MMR_PSM_GET_TIMER_INFO_REQ = 0xB4
  ,MMR_PSM_GET_TIMER_INFO_RSP = 0xB5
  ,MMR_SET_EDRX_CFG_REQ = 0xB6
  ,MMR_SET_EDRX_CFG_RSP = 0xB7
  ,MMR_GET_EDRX_PARAMS_REQ = 0xB8
  ,MMR_GET_EDRX_PARAMS_RSP = 0xB9
  ,MMR_EDRX_PARAMS_CHANGE_IND = 0xBA
  ,MMR_ENTER_PSM_MODE_REQ = 0xBB
  ,MMR_ENTER_PSM_MODE_RSP = 0xBC
  ,MMR_PSM_RESTORE_FAILED_IND = 0xBD
  ,MMR_SIM_STATE_REVALIDATE_IND = 0xBE
  ,MMR_PHY_EDRX_INFO_IND = 0xBF
  ,MMR_SEND_PSM_UNBLOCK = 0xC0
  ,MMR_SEND_PLMN_HOME_ROAM = 0xC1
  ,MMR_PSM_SAVE_MMGSDI_EF_REQ = 0xC2
  ,MMR_PSM_SAVE_MMGSDI_EF_RSP = 0xC3
 } reg_to_mm_cmd_type;
...
typedef enum
{
  ...
  REG_MM_PLMN_SEARCH_FAIL_IN_CONNECTED_MODE                   
} reg_mm_plmn_search_status_e_type;

/** @brief Type used by the OOS algorithm in FULL-RAT mode. This
    type specifies if a timer-based search should be used during
    system acquisition and if the next search is a continuation
    of the previous one for LTE RAT.
*/
typedef struct mmr_reg_scan_s
{
  boolean      new_scan;
  ...
  boolean      nb1_acqdb_timer_status;

  boolean      nb1_fullband_timer_status;

  uint32       scan_time;
  /**< Timer value in ms */
} mmr_reg_interlace_scan_s_type; //FRACQ
...
typedef struct mmr_plmn_search_abort_req_s
{
  IMH_T                                     message_header;
#ifdef FEATURE_CIOT
  /* PLMN Search is done on each rat separately. REG control which RAT is
     searching. The abort needs to be sent to the rat currently searching
  */
  sys_radio_access_tech_e_type              rat;
#endif
...
typedef struct mmr_reg_cnf_s
{
  ...
  */
  ...
  boolean                              search_done;
   ...
   /*should be used to indicate scan completion during OOS, FULL RAT mode */
  boolean                                   oos_srch_done; //FRACQ
...
/******************************************************************************/
/*  MMR_SIM_STATE_REVALIDATE_IND                                                      */
/*                                                                            */
/******************************************************************************/
typedef struct mmr_sim_state_revalidate_ind_s
{
  IMH_T                                      message_header;
  sys_sim_state_e_type                       sim_state;
} mmr_sim_state_revalidate_ind_s_type;
...
#ifdef FEATURE_CIOT
/******************************************************************************/
/*  MMR_PHY_EDRX_INFO_IND                                                     */
/*  Primitive used by MM to update REG the time the next eDRX page  starts    */
/******************************************************************************/
typedef struct mmr_edrx_page_start_s_type_ind_s
{
  IMH_T      message_header;
  uint32     next_page_start_time_ms;
} mmr_edrx_page_start_s_type;
#endif
...
/******************************************************/
/* MMR_PSM_AUTO_READY_IND                             */
/* Primitive to send PSM Auto Ready Indication to REG */
/******************************************************/
typedef struct mmr_psm_auto_ready_ind_s
{
  IMH_T                   message_header;
  uint32                  periodic_update_timer_value;
} mmr_psm_auto_ready_ind_s_type;


/********************************************************/
/* MMR_PSM_TIMER_CHANGE_IND                             */
/* Primitive to send PSM Timer Change Indication to REG */ 
/********************************************************/
typedef struct mmr_psm_timer_change_ind_s
{
  IMH_T                   message_header;
  sys_radio_access_tech_e_type  active_rat;
...
} mmr_psm_timer_change_ind_s_type;


/*********************************************************/
/* MMR_PSM_SET_CONFIG_PARAMS_REQ                         */
/* Primitive to send PSM Set Config Params Request to MM */
/*********************************************************/
typedef struct mmr_psm_set_config_params_req_s
{
  IMH_T                   message_header;
  boolean                 psm_enabled;
  uint32                  active_timer_value;
  ...
  uint16                  change_mask;
} mmr_psm_set_config_params_req_s_type;


/***********************************************************/
/* MMR_PSM_SET_CONFIG_PARAMS_RSP                           */
/* Primitive to send PSM Set Config Params Response to REG */
/***********************************************************/
typedef struct mmr_psm_set_config_params_rsp_s
{
  IMH_T                   message_header;
} mmr_psm_set_config_params_rsp_s_type;


/******************************************************/
/* MMR_PSM_GET_TIMER_INFO_REQ                         */
/* Primitive to send PSM Get Timer Info Request to MM */
/******************************************************/
typedef struct mmr_psm_get_timer_info_req_s
{
  IMH_T                    message_header;
  boolean                  user_config;  /* TRUE - User Configured values ; FALSE - Network Provided values */
} mmr_psm_get_timer_info_req_s_type;


/********************************************************/
/* MMR_PSM_GET_TIMER_INFO_RSP                           */
/* Primitive to send PSM Get Timer Info Response to REG */
/********************************************************/
typedef struct mmr_psm_get_timer_info_rsp_s
{
  IMH_T                       message_header;
  uint32                      active_timer_value;
  uint32                      gprs_ready_timer_value;
...
} mmr_psm_get_timer_info_rsp_s_type;


/*****************************************************/
/*  MMR_ENTER_PSM_MODE_REQ                           */
/*  Primitive to trigger context saving to enter PSM */
/*****************************************************/
typedef struct mmr_enter_psm_mode_req_s
{
  IMH_T                                     message_header;
} mmr_enter_psm_mode_req_s_type;


/*****************************************************************/
/* MMR_ENTER_PSM_MODE_RSP                                        */
/* Primitive to send the status of MMR_ENTER_PSM_MODE_REQ to REG */ 
/*****************************************************************/
typedef struct mmr_enter_psm_mode_rsp_s
{
  IMH_T                   message_header;
  sys_modem_as_id_e_type  as_id;
  boolean                 status;
} mmr_enter_psm_mode_rsp_s_type;


/**********************************************************/
/* MMR_PSM_SAVE_MMGSDI_EF_REQ                             */
/* Primitive to trigger context saving to enter PSM       */ 
/**********************************************************/
typedef struct mmr_psm_save_mmgsdi_ef_req_s
{
  IMH_T                  message_header;
  sys_modem_as_id_e_type as_id;
}mmr_psm_save_mmgsdi_ef_req_s_type;

/*************************************************************************/
/* MMR_PSM_SAVE_MMGSDI_EF_RSP                                            */
/* Primitive to inform REG with the status of MMR_PSM_SAVE_MMGSDI_EF_REQ */ 
/*************************************************************************/
typedef struct mmr_psm_save_mmgsdi_ef_rsp_s
{
  IMH_T                      message_header;
  boolean                    status;
  sys_modem_as_id_e_type     as_id;
}mmr_psm_save_mmgsdi_ef_rsp_s_type;


/**********************************************************/
/* MMR_PSM_RESTORE_FAILED_IND                             */
/* Primitive to send eDRX Params Change Indication to REG */ 
/**********************************************************/
typedef struct mmr_psm_restore_failed_ind_s
{
  IMH_T                   message_header;
} mmr_psm_restore_failed_ind_s_type;


/***************************************************/
/* MMR_SET_EDRX_CFG_REQ                            */
/* Primitive to send Set eDRX Config Request to MM */
/***************************************************/
typedef struct mmr_set_edrx_cfg_req_s
{
  IMH_T                        message_header;
  ...
  uint16                       change_mask;
} mmr_set_edrx_cfg_req_s_type;



/***************************************************/
/* MMR_GET_EDRX_PARAMS_REQ                         */
/* Primitive to send Get eDRX Params Request to MM */
/***************************************************/
typedef struct mmr_get_edrx_params_req_s
{
  IMH_T                        message_header;
  sys_radio_access_tech_e_type rat_type;
} mmr_get_edrx_params_req_s_type;


/**********************************************************/
/* MMR_EDRX_PARAMS_CHANGE_IND                             */
/* Primitive to send eDRX Params Change Indication to REG */ 
/**********************************************************/
typedef struct mmr_edrx_params_change_ind_s
{
  IMH_T                        message_header;
  sys_radio_access_tech_e_type rat_type;
  ...
  uint8                        edrx_ptw;
  uint8                        edrx_cycle_length;
} mmr_edrx_params_change_ind_s_type;

/***************************************************/
/* MMR_GET_EDRX_PARAMS_REQ                         */
/* Primitive to send Get eDRX Params Request to MM */
/***************************************************/
typedef struct mmr_send_plmn_home_roam_ind_s
{
  IMH_T                        message_header;
  sys_modem_as_id_e_type       as_id;
  boolean                      home;
} mmr_send_plmn_home_roam_ind_s_type;
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean reg_nv_per_subs_psm_restore_pending
(
  sys_modem_as_id_e_type        as_id,
  sys_plmn_id_s_type            plmn,
  sys_radio_access_tech_e_type  rat,
...
extern void reg_read_sim_available_nv();
