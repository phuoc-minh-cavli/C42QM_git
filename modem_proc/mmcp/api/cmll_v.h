...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/cmll_v.h#1 $
...
typedef struct {
  cm_hdr_type        hdr;               /* header */
  sd_ss_e_type       ss;                /* System selectrion - MAIN or HDR */
  boolean            is_scan_attempted;  /* Indicates if GW scan attempted from last acq_fail */
...
typedef union cm_generic_rpt_u
{
  ...
  cm_client_psm_ready_rsp_s_type    psm_ready_rsp;
   /*Payload associated with PSM_READY_RSP*/

  cm_client_psm_ready_ind_s_type    psm_ready_ind;
   /*Payload associated with PSM_READY_IND*/

  cm_client_psm_enter_rsp_s_type    psm_enter_rsp;
   /*Payload associated with PSM_ENTER_RSP*/

   cm_mmgsdi_psm_context_save_rsp_s_type  psm_context_save_rsp;
   /*Payload associated with PSM_CONTEXT_SAVE_RSP*/

   cm_psm_deep_sleep_timer_expiry_ind_s_type  psm_deep_sleep_timer_expiry_ind;
   /*Payload associated with PSM_DEEP_SLEEP_TIMER_EXPIRY_IND*/
...
DESCRIPTION
  Function for client to notify CM PSM status.
