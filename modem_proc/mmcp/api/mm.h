...
$Header: //components/rel/mmcp.mpss/6.1.10/api/mm.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef struct mm_nas_nv_items
{
   ...
   /*Ver 11*/
   byte                       cb_msim_high_priority_threshold; /*index 19*/
   /*Ver 12*/
   byte                       long_ftn_support; /*index 20*/
   /*Ver 13*/
   byte                       legacy_prerel99_irat; /*index 21*/
   /*Ver 14*/
   byte                       psm_local_detach_enabled; /*index 22*/
...
extern void    mm_set_nas_bit_mask(uint16 bit_mask);
...
extern ue_nas_rel_compliance_type mm_get_nv_nas_rel_compliance_per_subs
(
