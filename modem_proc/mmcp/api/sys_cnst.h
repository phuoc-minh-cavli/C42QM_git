...
$Header: //components/rel/mmcp.mpss/6.1.10/api/sys_cnst.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define EMM_REJ_HARD_FAIL                   (MS_INTERNAL_CAUSE_VALUE_BASE+57)
