...
/*==============================================================================
 ...
 $Header ://components/dev/mmcp.mpss/6.1.3/harshanv.mmcp.mpss.6.1.3.fr_38978_2/api/cm_esm.h#3 $
...
{
  msgr_hdr_s              msg_hdr;
  msgr_attach_s           dsm_attach; /*!< dsm attachment containing the EPCO contents*/ 
...
/*This structure is used for sending restore ctxt req
** from NAS to CM
*/
typedef struct cm_restore_ctxt_psm_req_s
{
  msgr_hdr_s  msg_hdr;
...
** from NAS to CM
*/
typedef struct cm_restore_bearer_ctxt_rsp_s
{
  msgr_hdr_s             msg_hdr;
  eps_bearer_id_T        eps_bearer_id;
  byte                   connection_id;
...
{
  msgr_hdr_s              msg_hdr;
  msgr_attach_s           dsm_attach; /*!< dsm attachment containing the small data */ 
  eps_bearer_id_T         eps_bearer_id;
...
typedef  union cm_esm_cmd_u
  ...
  cm_restore_ctxt_psm_req_s_type                       cm_restore_ctxt_psm_req; 
  cm_restore_bearer_ctxt_rsp_s_type                    cm_restore_bearer_ctxt_rsp;    
  cm_esm_data_transport_ind_type                       cm_esm_data_transport_ind; 
  cm_esm_data_transport_cnf_type                       cm_esm_data_transport_cnf;
} cm_esm_cmd_u_type;
