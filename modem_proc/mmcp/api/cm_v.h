...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/cm_v.h#1 $
...
typedef boolean (cm_ds_cmd_notif_f_type)( void );

typedef boolean (cm_ds_cmd_notif_ext_f_type)( uint8);

/* PSM ready request being sent to Client*/
typedef boolean (cm_client_psm_ready_req_f_type)( void );


/* PSM enter request being sent to Client*/
typedef boolean (cm_client_psm_enter_req_f_type)( void );


/* PSM context save request being sent to mmgsdi*/
typedef boolean (cm_mmgsdi_psm_context_save_req_f_type)( void );
...
*/
#define CM_PSM_MIN_THRESHOLD                     60    // 1min i.e. 60 seconds
#define CM_PSM_DEFAULT_THRESHOLD                 283   // 327 sec EDRX â€“ 40 sec max PTW- 4 sec early wakeup = 283 sec
...
/* Below modules vote for PSM & store context as well*/
  CM_PSM_MODULE_NAS = CM_PSM_MODULE_BEGIN,
  /**< NAS */
  ...
  CM_PSM_MODULE_SNS_MGR,

  CM_PSM_MODULE_LOCTECH,
/*****************************/
  /** @cond
  */
  CM_PSM_MODULE_END = CM_PSM_MODULE_LOCTECH   /* FOR INTERNAL CM USE ONLY! */
  /** @endcond
  */
...
/*  
sizeof(sys_loc_wwan_scan_ad_element_m1_s_type) = 72  
sizeof(sys_loc_wwan_scan_ad_element_m1_s_type)*5+4 = 364   1024-364 (reserve 660)
sizeof(sys_radio_access_tech_e_type) = 1
size of union Ò 364 max
  */

  uint8 reserve[658]; 
/* taking care of version and rat */

}mmode_test_gps_wwan_scan_param_s_type;
...
FUNCTION cm_data_subsc_cmd_reg
...
boolean cm_data_subsc_cmd_reg(

cm_ds_cmd_notif_f_type  * ds_ntfy_cb_func
...
===========================================================================*/
extern boolean cm_is_psm_context_saved(sys_modem_as_id_e_type         asub_id);
...
DESCRIPTION
   ...
   context allocation & free to be taken care by module
   CM does deep copy of context
...
FUNCTION cm_get_psm_sw_ver

DESCRIPTION
   Indicates psm sw version
   1 -  AP driven 
   2-   Modem driven
...
FUNCTION cm_get_edrx_active_rat

DESCRIPTION
EDRX rat for page mode
...
/* !!!  This is priavte API and we should not make equivalent QMI for this */
...
SIDE EFFECTS
  ...
  NETWORKS_CONF event.
===========================================================================*/
extern boolean cm_ph_cmd_get_networks_advance_search(
...
RETURN VALUE
  TRUE  = CM has valid band
  FALSE = CM has NO  bands
