...
$Header: //components/rel/mmcp.mpss/6.1.10/api/sm.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef struct 
{
  ...
  boolean                low_priority_signaling;  /* indicates if PDP is configured for low signalling priority or not */
  ...
  reattempt_ind_T        reattempt_ind;      /* To store the Re-Attempt Indicator Value*/
...
SIDE EFFECTS
  None
===========================================================================*/
extern void sm_reserve_psm_restored_nsapi
(
  byte    connection_id,
  byte    nsapi,
  sys_modem_as_id_e_type as_id
