...
$Header: //components/rel/mmcp.mpss/6.1.10/api/lte_nas_esm_message_type.h#1 $
$Author: pwbldsvc $
...
/* Refer Section: 8.3.25*/
typedef struct 
{
  lte_nas_hdr_type                lte_nas_hdr;
  lte_nas_esm_hdr_type            lte_nas_esm_hdr;
  lte_nas_user_data_container     user_data_container;
  dsm_item_type                   *dsm_ptr;
  release_assistance_ind_type     release_ind;
  boolean                         mo_exception_data;
  boolean                     empty_user_data_container;
} lte_nas_esm_data_transport;
...
/*Data structure for ESM DUMMY message*/
typedef struct
{
  lte_nas_hdr_type         lte_nas_hdr;
  lte_nas_esm_hdr_type     lte_nas_esm_hdr;
}lte_nas_esm_dummy_message;
...
{    
  ...
  lte_nas_esm_dummy_message                        esm_dummy_message;
