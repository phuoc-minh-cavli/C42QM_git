...
$Header: //components/rel/mmcp.mpss/6.1.10/api/gs.h#1 $    $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef byte                           gs_timer_queue_id_T;


#define   GS_TIMER_QUEUE_MM                        0
#define   GS_TIMER_QUEUE_MN_CNM               1
#define   GS_TIMER_QUEUE_LAYER_2               GS_QUEUE_LAYER_2
#define   GS_TIMER_QUEUE_SM                       3
#define   GS_TIMER_QUEUE_IMS                      4
#define   GS_TIMER_QUEUE_MM_SUB2              5
#define   GS_TIMER_QUEUE_MM_SUB3              6
#define   GS_TIMER_QUEUE_MN_CNM_SUB2      7
#define   GS_TIMER_QUEUE_CB                         8
