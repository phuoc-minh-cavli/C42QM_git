...
$Header: //components/rel/mmcp.mpss/6.1.10/api/esm_cm_msgr_enum_msg.h#1 $
...
#ifdef FEATURE_CIOT
  MSGR_DEFINE_UMID(NAS, ESM, REQ, DATA_TRANSPORT, 0x12, esm_data_transport_req_T),
#endif
  MSGR_DEFINE_UMID(NAS, ESM, RSP, RESTORE_CTXT_PSM, 0x14, esm_restore_ctxt_psm_rsp_T),
  MSGR_DEFINE_UMID(NAS, ESM, REQ, RESTORE_BEARER_CTXT, 0x15, esm_restore_bearer_ctxt_req_T),
