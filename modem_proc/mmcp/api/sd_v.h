...
/**===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/sd_v.h#1 $
...
#define SD_BAND_LTE_EUTRAN_BAND71   SYS_BAND_LTE_EUTRAN_BAND71
#define SD_BAND_LTE_EUTRAN_BAND72   SYS_BAND_LTE_EUTRAN_BAND72
#define SD_BAND_LTE_EUTRAN_BAND73   SYS_BAND_LTE_EUTRAN_BAND73
#define SD_BAND_LTE_EUTRAN_BAND85   SYS_BAND_LTE_EUTRAN_BAND85
#define SD_BAND_LTE_EUTRAN_BAND86   SYS_BAND_LTE_EUTRAN_BAND86
#define SD_BAND_LTE_EUTRAN_BAND87   SYS_BAND_LTE_EUTRAN_BAND87
#define SD_BAND_LTE_EUTRAN_BAND88   SYS_BAND_LTE_EUTRAN_BAND88
...
#define SD_BAND_LTE_EUTRAN_BAND256   SYS_BAND_LTE_EUTRAN_BAND256
#endif
...
#define  SD_SS_BAND_PREF_LTE_M1_ANY         (SD_SS_BAND_PREF_LTE_EUTRAN_1  | \
                                             SD_SS_BAND_PREF_LTE_EUTRAN_2  | \
                                             SD_SS_BAND_PREF_LTE_EUTRAN_3  | \
                                             SD_SS_BAND_PREF_LTE_EUTRAN_4  | \
                                             SD_SS_BAND_PREF_LTE_EUTRAN_5  | \
...
#define  SD_SS_BAND_PREF_LTE_NB1_ANY       (SD_SS_BAND_PREF_LTE_EUTRAN_1  | \
                                            SD_SS_BAND_PREF_LTE_EUTRAN_2  | \
                                            SD_SS_BAND_PREF_LTE_EUTRAN_3  | \
                                            SD_SS_BAND_PREF_LTE_EUTRAN_4  | \
                                            SD_SS_BAND_PREF_LTE_EUTRAN_5  | \
...
typedef enum {
 ...
 /**<  UL: 807.5 -	824;  DL: 852 �	869 */
  ...
  SD_SBAND_LTE_EUTRAN_BAND71 = SYS_SBAND_LTE_EUTRAN_BAND71,
  /**< UL: 663-698; DL: 617-652*/

  SD_SBAND_LTE_EUTRAN_BAND72 = SYS_SBAND_LTE_EUTRAN_BAND72,
  /**< UL: ??; DL: ??*/

  SD_SBAND_LTE_EUTRAN_BAND73 = SYS_SBAND_LTE_EUTRAN_BAND73,
  /**< UL: ?? ; DL: ??*/

  SD_SBAND_LTE_EUTRAN_BAND85 = SYS_SBAND_LTE_EUTRAN_BAND85,
  /**< UL: 698�716 ; DL: 728�746*/

  SD_SBAND_LTE_EUTRAN_BAND86 = SYS_SBAND_LTE_EUTRAN_BAND86,
  /**< UL: 787�788 ; DL: 757�758*/

  SD_SBAND_LTE_EUTRAN_BAND87 = SYS_SBAND_LTE_EUTRAN_BAND87,
  /**< UL: ??�?? ; DL: ??�??*/

  SD_SBAND_LTE_EUTRAN_BAND88 = SYS_SBAND_LTE_EUTRAN_BAND88,
  /**< UL: ??�?? ; DL: ??�??*/
  ...
  SD_SBAND_LTE_EUTRAN_BAND256 = SYS_SBAND_LTE_EUTRAN_BAND256
  /**< DL: Not defined */
  #endif
} sd_band_lte_e_type;
...
#if defined(FEATURE_MMODE_3GPP2) || defined(SD_DEBUG) || defined(CM_DEBUG)
...
#define SD_MODE_NOT( mode_pref1 ) \
    ...
    #ifdef FEATURE_NBIOT_NTN
    typedef bit_mask_256_t            sd_sys_rec_lte_band_pref_e_type;
    #else
...
/** Get the common set of modes from op-mode1 and op_mode2 and return the
** result.
*/
#define SD_GET_COMMON_LTE_CIOT_OP_MODE( op_mode1, op_mode2) \
        ( (sd_ss_ciot_lte_op_mode_e_type)( (word)op_mode1 & (word)op_mode2 ) )

/** Delete the modes of mode_pref2 from mode_pref1 and return the result.
*/
#define SD_LTE_OP_MODE_DELETE( lte_op_mode1, lte_op_mode2 ) \
        ( (sd_ss_ciot_lte_op_mode_e_type)( (word)lte_op_mode1 & ~(word)lte_op_mode2) )
...
#define MRU_BUF_EXT_DEFAULT_VERSION         1
...
typedef void (sd_si_full_srv_lost_f_type) (
  ...
  */
  ...
  /* Indicates if this is not a duplicate srv_lost report */
);
...
===========================================================================*/
extern void          sd_ss_ind_misc_srv_lost(void);
...
extern  void                      sd_misc_get_lte_band_mode_ciot(
        ...
        sys_lte_band_mask_e_type        *band_ptr_lte_nb1,
            /* Pointer to the LTE M1 band preference that needs to be filtered.*/
          #ifdef FEATURE_NBIOT_NTN
        sys_lte_band_mask_e_type		*band_ptr_lte_nb1_ntn,
					/* Pointer to the LTE NB1 NTN band preference that needs to be filtered.
              */
        #endif
        ...
        sys_lte_band_mask_e_type        sys_band_pref_lte_nb1
          ...
          #ifdef FEATURE_NBIOT_NTN
			,
        sys_lte_band_mask_e_type        sys_band_pref_lte_nb1_ntn
            /* Enumeration of LTE NB1 NTN system selection band and sub-band preferences.
            */
        #endif
);
