...
$Header: //components/rel/mmcp.mpss/6.1.10/api/sm_gmm.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define GMMSM_PS_CALL_STATUS_IND     0x08

#define GMMSM_RESTORE_CTXT_PSM_CNF   0x09

#define GMMSM_SAVE_CTXT_PSM_CNF      0x0a
...
/* --------------------------------------------------------------------------
** Primitive : GMMSM_IRAT_PS_SERVICE_IND.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_irat_ps_service_ind
{ 
  sys_modem_as_id_e_type    as_id;

} gmmsm_irat_ps_service_ind_T;
...
/* --------------------------------------------------------------------------
** Primitive : GMMSM_PS_CALL_STATUS_IND.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_ps_call_status_ind
{
  IMH_T         header;

  boolean       pdp_sig_in_progress;

} gmmsm_ps_call_status_ind_T;


/* --------------------------------------------------------------------------
** Primitive : GMMSM_SAVE_CTXT_PSM_REQ.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_save_ctxt_psm_req
{
  IMH_T         header;
  //sys_modem_as_id_e_type    as_id;
} gmmsm_save_ctxt_psm_req_T;


/* --------------------------------------------------------------------------
** Primitive : GMMSM_SAVE_CTXT_PSM_CNF
** ------------------------------------------------------------------------*/

typedef struct gmmsm_save_ctxt_psm_cnf
{
  IMH_T         header;
  boolean       status;
} gmmsm_save_ctxt_psm_cnf_T;

/* --------------------------------------------------------------------------
** Primitive : GMMSM_RESTORE_CTXT_PSM_REQ.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_restore_ctxt_psm_req
{
  IMH_T         header;
//  sys_modem_as_id_e_type    as_id;
} gmmsm_restore_ctxt_psm_req_T;


/* --------------------------------------------------------------------------
** Primitive : GMMSM_RESTORE_CTXT_PSM_CNF.
** ------------------------------------------------------------------------*/
typedef struct gmmsm_restore_ctxt_psm_cnf
{
  IMH_T         header;
  boolean       status;
} gmmsm_restore_ctxt_psm_cnf_T;
