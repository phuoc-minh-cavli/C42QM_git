...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/public/prot.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
typedef enum {
  ...
  PROT_DEACT_PSM,                        /* Protocol should would have saved context already and need to 
                                         ** locally deactivate itself
                                        */

  PROT_DEACT_DEEP_SLEEP,                /* Protocol should be deactivated
                                       ** locally. No need to inform network. All NAS timers would continue running
                                       */
...
typedef enum
{
  ...
  PROT_OPRT_MODE_PSM,                     /* Operating mode status when the
                                          ** phone moved to PSM mode.
                                          */
