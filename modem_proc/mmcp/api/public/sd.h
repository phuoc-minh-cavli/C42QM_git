...
/**===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/public/sd.h#1 $
...
#define SD_MODE_LTE_M1    SYS_SYS_MODE_LTE_M1
#define SD_MODE_LTE_NB1   SYS_SYS_MODE_LTE_NB1
#ifdef FEATURE_NBIOT_NTN
#define SD_MODE_LTE_NB1_NTN   SYS_SYS_MODE_LTE_NB1_NTN
#endif
...
#define SD_MODE_LTE_ALL   BM(SD_MODE_LTE) | BM(SD_MODE_LTE_M1) | BM(SD_MODE_LTE_NB1)
...
*/
  ...
  SD_NETWORK_LIST_PRIORITY_PLMN_SEARCH_BGND,
     ...
     */
  SD_NETWORK_LIST_CELL_SEARCH,
     /* Low pri search for cell param search*/
/** @cond
*/
  SD_NETWORK_LIST_GPS_ADV_SEARCH,
  /* gps wwan search request   */
...
typedef enum {
  ...
  SD_SS_MODE_PREF_ANY_BUT_HDR = BM( SD_MODE_CDMA )  | \
                                BM( SD_MODE_GSM )  | BM( SD_MODE_WCDMA ) | \
                                BM( SD_MODE_TDS )  | BM( SD_MODE_LTE ),
  ...
  SD_SS_MODE_PREF_CDMA_HDR_GW_TDS = BM( SD_MODE_CDMA ) | BM( SD_MODE_HDR ) | \
                                    BM( SD_MODE_GSM )  | BM( SD_MODE_WCDMA ) | BM( SD_MODE_TDS ),
  ...
  SD_SS_MODE_PREF_ANY_BUT_HDR_GSM = BM( SD_MODE_CDMA )  | BM( SD_MODE_WCDMA ) | \
                                BM( SD_MODE_TDS )  | BM( SD_MODE_LTE ),
                                /**< Acquire any systems, other than HDR.
                                */
  ...
  SD_SS_MODE_PREF_ANY         = SD_SS_MODE_PREF_DIGITAL, 
  ...
  SD_SS_MODE_PREF_ANY_BUT_TDS = BM( SD_MODE_CDMA )  | \
                                BM( SD_MODE_GSM )  | BM( SD_MODE_WCDMA ) | \
                                BM( SD_MODE_HDR )  | BM( SD_MODE_LTE ),
                                /**< Acquire any systems, other than TDS.
                                                   */
  ...
  SD_SS_MODE_PREF_ANY_BUT_CDMA_HDR = BM( SD_MODE_GSM ) | BM( SD_MODE_WCDMA ) | \
                                  BM( SD_MODE_TDS ) | BM( SD_MODE_LTE ),
  ...
  SD_SS_MODE_PREF_ALL_MODES   = BM( SD_MODE_CDMA )  | \
                                BM( SD_MODE_GSM )  | BM( SD_MODE_WCDMA ) | \
                                BM( SD_MODE_HDR )  | BM( SD_MODE_GPS )   | \
                                BM( SD_MODE_LTE)   | BM( SD_MODE_TDS),
                                /**< All possible modes */
...
typedef enum {
  ...
  SD_SS_LTE_IOT_OP_MODE_PREF_NONE               = 0,

  SD_SS_LTE_IOT_OP_MODE_PREF_WB            = BM(SD_MODE_LTE),
  /* Legacy LTE wide band operation supported */
  
  SD_SS_LTE_IOT_OP_MODE_PREF_M1            = BM(SD_MODE_LTE_M1),
  /* M1 mode of operation is supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_NB1           = BM(SD_MODE_LTE_NB1),
  /* NB1 mode of operation is supported */
  
  #ifdef FEATURE_NBIOT_NTN
  SD_SS_LTE_IOT_OP_MODE_PREF_NB1_NTN           = BM(SD_MODE_LTE_NB1_NTN),
  /* NB1 NTN mode of operation is supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_WB_M1_NB1_NTN     = BM(SD_MODE_LTE) | BM(SD_MODE_LTE_NB1) | BM(SD_MODE_LTE_M1)| 
  BM(SD_MODE_LTE_NB1_NTN),
  /* Legacy LTE , M1 & NB1 NTN mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_NB1_NB1_NTN      = BM(SD_MODE_LTE_NB1) | BM(SD_MODE_LTE_NB1_NTN),
  /* Legacy NB1 & NB1 NTN mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_M1_NB1_NTN        = BM(SD_MODE_LTE_M1) | BM(SD_MODE_LTE_NB1_NTN),
  /* M1 & NB1_NTN mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_WB_NB1_NTN 	   = BM(SD_MODE_LTE) | BM(SD_MODE_LTE_NB1_NTN),
	/* Legacy LTE & NB1 NTN mode of operations are supported */
  #endif
  SD_SS_LTE_IOT_OP_MODE_PREF_WB_M1         = BM(SD_MODE_LTE) | BM(SD_MODE_LTE_M1),
  /* Legacy LTE & M1 mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_WB_NB1        = BM(SD_MODE_LTE) | BM(SD_MODE_LTE_NB1),
  /* Legacy LTE & NB1 mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_M1_NB1        = BM(SD_MODE_LTE_M1) | BM(SD_MODE_LTE_NB1),
  /* M1 & NB1 mode of operations are supported */

  SD_SS_LTE_IOT_OP_MODE_PREF_WB_M1_NB1     = BM(SD_MODE_LTE) | BM(SD_MODE_LTE_NB1) | BM(SD_MODE_LTE_M1)
  /* Legacy LTE , M1 & NB1 mode of operations are supported */

}sd_ss_ciot_lte_op_mode_e_type;
...
typedef struct{
  ...
  byte                                             acq_mode;
  byte                                             num_rats;
  byte                                             rat[SYS_MAX_NUM_3GPP_RATS];
} sd_gwl_sys_type;
...
/* This will be used to read MRU table from new NV with version field
 */
...
typedef PACKED struct PACKED_POST{
  ...
  sd_mmode_mru_table_s_type  mru_tbl; 
 
} sd_mmode_efs_mru_table_s_type;
#endif
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
...
typedef enum
{
  ...
  /* 20 */
  SD_SS_SRV_REQ_TYPE_FULL_RAT,       /* Req type to issue in full RAT mode */
...
typedef struct {
  ...
  */
  ...
  #if defined(FEATURE_TDSCDMA) || defined(SD_DEBUG)
