...
/*============================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/api/public/sys.h#1 $
...
#define SYS_PCI_SCAN_MAX_NUM_PCI 8    /* total number of cells */
#define SYS_PCI_SCAN_MAX_NUM_PLMN 6   /* no of shared LTE PLMNs per cell*/
...
typedef enum
{
  ...
  LTE_BW_MINIMUM = LTE_BW_NB_6,
  /*! Maximum supported bandwidth */
  LTE_BW_MAXIMUM = LTE_BW_NB_100,
  /*! Unknown Bandwidth */
  LTE_BW_INVALID
} lte_bw_e;
...
/**
GNSS mode ON/OFF status.
*/
typedef enum
{
  /** @cond
  */
  SYS_GNSS_MODE_NONE = -1,  /* FOR INTERNAL USE OF CM ONLY! */
  /** @endcond
  */

  SYS_GNSS_MODE_OFF = 0,
    /**< GNSS Fix completed, LTE can be resumed */

  SYS_GNSS_MODE_ON = 1,
    /**< GNSS Fix is starting, LTE shall be suspended */

  /** @cond
  */
  SYS_GNSS_MODE_MAX   /* FOR INTERNAL USE OF CM ONLY! */
  /** @endcond
  */

} sys_gnss_mode_status_e_type;
/*~ SENTINEL sys_gnss_mode_status_e_type.SYS_GNSS_MODE_MAX */

/**
ML1 LTE mode ON/OFF status.
*/
typedef enum
{
  /** @cond
  */
  SYS_LTE_MODE_NONE = -1,  /* FOR INTERNAL USE OF CM ONLY! */
  /** @endcond
  */

  SYS_LTE_MODE_OFF = 0,
    /**< LTE moves to Idle state, GNSS Fix may start */

  SYS_LTE_MODE_ON = 1,
    /**< LTE moves to connected state, GNSS Fix not allowed */

  /** @cond
  */
  SYS_LTE_MODE_MAX   /* FOR INTERNAL USE OF CM ONLY! */
  /** @endcond
  */

} sys_lte_mode_status_e_type;
/*~ SENTINEL sys_lte_mode_status_e_type.SYS_LTE_MODE_MAX */
...
typedef enum
{
  ...
  */
  ...
  SYS_OPRT_MODE_PSM = 12,
    /**< Phone is in PSM mode */
  /** @cond
  */
...
typedef enum
{
  ...
  */
  ...
  SYS_SYS_MODE_LTE_M1=12,
  /**< LTE M1 mode. */

  SYS_SYS_MODE_LTE_NB1=13,
  /**< LTE NB1 mode. */
  #ifdef FEATURE_NBIOT_NTN
  SYS_SYS_MODE_LTE_NB1_NTN=14,
  #endif
  /**< LTE NB1 NTN mode. */
...
typedef enum
{
  ...
  */
  ...
  SYS_BAND_LTE_EUTRAN_BAND85 = 169,
  /**< UL: 698�716 ; DL: 728�746*/
  ...
  SYS_BAND_LTE_EUTRAN_BAND71 = 176,
  /**< UL: 663-698; DL: 617-652*/

  SYS_BAND_LTE_EUTRAN_BAND72 = 177,
  /**< UL:??; DL: ??*/

  SYS_BAND_LTE_EUTRAN_BAND73 = 178,
  /**< UL: ??; DL: ??*/

  SYS_BAND_LTE_EUTRAN_BAND86 = 179,
  /**< UL: 787�788 ; DL: 757�758*/

  SYS_BAND_LTE_EUTRAN_BAND87 = 180,
  /**< UL: 410�415; DL: 420�425*/

  SYS_BAND_LTE_EUTRAN_BAND88 = 181,
  /**< UL: 412�417; DL: 422�427*/
   #ifdef FEATURE_NBIOT_NTN
  SYS_BAND_LTE_EUTRAN_BAND256 = 182,
  /**< UL:Not defined; DL: Not defined*/
  /** @cond
  */
  #endif
...
typedef enum {
  ...
  SYS_SBAND_LTE_EUTRAN_BAND71 = 70,
  /**< UL: 663-698; DL: 617-652*/

  SYS_SBAND_LTE_EUTRAN_BAND72 = 71,
  /**< UL: ??; DL: ??*/

  SYS_SBAND_LTE_EUTRAN_BAND73 = 72,
  /**< UL: ??; DL: ??*/

  SYS_SBAND_LTE_EUTRAN_BAND85 = 84,
  /**< UL: 698�716 ; DL: 728�746*/

  SYS_SBAND_LTE_EUTRAN_BAND86 = 85,
  /**< UL: 787�788 ; DL: 757�758*/

  SYS_SBAND_LTE_EUTRAN_BAND87 = 86,
  /**< UL: ??; DL: ??*/

  SYS_SBAND_LTE_EUTRAN_BAND88 = 87,
  /**< UL: ??; DL: ??*/
  ...
  SYS_SBAND_LTE_EUTRAN_BAND256 = 255,
	  /**< DL: Not defined */

  SYS_SBAND_LTE_EUTRAN_MAX = 256
	  /**< DL: Not defined */
  #endif
...
typedef bit_mask_256_t        sys_lte_band_mask_e_type; /* data struct definition */
 #ifdef FEATURE_NBIOT_NTN
#define SYS_SBAND_LTE_EUTRAN_BAND_MAX ((sys_sband_lte_e_type)256) /* MAX value for LTE bands for bound checking */
#else
...
sys_lte_band_mask_e_type sys_lte_band_pref_lte_m1_const_any(void);
sys_lte_band_mask_e_type sys_lte_band_pref_lte_nb1_const_any(void);
#ifdef FEATURE_NBIOT_NTN
sys_lte_band_mask_e_type sys_lte_band_pref_lte_nb1_ntn_const_any(void);
#endif
...
#define SYS_LTE_M1_BAND_MASK_CONST_ANY sys_lte_band_pref_lte_m1_const_any()

#define SYS_LTE_NB1_BAND_MASK_CONST_ANY sys_lte_band_pref_lte_nb1_const_any()
#ifdef FEATURE_NBIOT_NTN
#define SYS_LTE_NB1_NTN_BAND_MASK_CONST_ANY sys_lte_band_pref_lte_nb1_ntn_const_any()
#endif
...
#define SYS_BAND_MASK_LTE_BAND127             ((sys_band_mask_type) SYS_BM_64BIT(SYS_SBAND_LTE_EUTRAN_BAND127))
    /**< DL: 64975 � 64999 */
 #ifdef FEATURE_NBIOT_NTN
#define SYS_MAX_ACQ_PREF_RAT_LIST_NUM 4
#else
#define SYS_MAX_ACQ_PREF_RAT_LIST_NUM 3
#endif
...
typedef enum
{
  ...
  SYS_IMS_REG_END_CAUSE_BLOCK_TILL_PWR_CYCLE     = 3,
      /**< permanent failure from IMS, block PLMN until power cycle, LPM, SIM refresh etc */
  /** @cond
   */
...
typedef enum
{
  ...
  */
  ...
  #ifdef FEATURE_NBIOT_NTN
  SYS_RAT_LTE_NB1_NTN_RADIO_ACCESS,
	 /*< LTE NB1 NTN radio access technology */
  #endif
  /** @cond
  */
...
typedef enum
{
  ...
  */
  ...
  SYS_PLMN_LIST_FAIL_IN_CONNECTED_MODE,
...
typedef enum
{
  MM_PS_NOT_SUPPORTED,
  MM_PS_SUPPORTED,
  MM_PS_SUPPORT_UNKNOWN
}mm_rr_ps_support_e_type;
...
typedef struct sys_geran_info_s
{
  uint16                                             cell_identity;
  ARFCN_T                                            ARFCN;
  uint8                                              BSIC;
  boolean                                            cell_barred;
  mm_rr_ps_support_e_type                            gprs_supported;
  sys_plmn_id_s_type                                 PLMN;
  sys_lac_type                                       LAC;
  int16                                              RxLev;
}sys_geran_cell_info_s_type;

typedef struct sys_lte_cell_info_s
{
  uint16                                       phy_cell_id;
  sys_radio_access_tech_e_type                 rat;
  uint32                                       earfcn;
  uint16                                       tac;
  uint32                                       global_cell_id;             /*!< Global Cell Id */
  boolean                                      cell_barred;
  int16                                        rsrp;        
  int16                                        rsrq;   
  int16                                        rssi;  
  lte_bw_e                                     dl_bandwidth;
/*RAN shared PLMNs*/ 
  uint8                                        num_plmn;
  sys_plmn_id_s_type                           plmn[SYS_PCI_SCAN_MAX_NUM_PLMN];

}sys_lte_cell_info_s_type;

typedef struct sys_geran_cell_list_s
{
   uint16												  num_cell;
   sys_geran_cell_info_s_type							  geran_cell_info[SYS_PCI_SCAN_MAX_NUM_PCI];   
}sys_geran_cell_list_s_type;

typedef struct sys_lte_cell_list_s
{
  uint16												 num_cell;
  sys_lte_cell_info_s_type								 lte_cell_info[2*SYS_PCI_SCAN_MAX_NUM_PCI];	
}sys_lte_cell_list_s_type;

typedef struct sys_cell_search_list_s
{
  sys_geran_cell_list_s_type				           geran_cell_list; /* GSM*/
  sys_lte_cell_list_s_type					   lte_cell_list;  /* CATM1 and NB1 */
} sys_cell_search_list_s_type;
...
#define SYS_NAS_EMM_INFO_MASK           SYS_BM_64BIT(6)
...
#define INST_ID_TO_SYS_AS_ID(id) \
  ( (id)>0 && (id)<=(uint8)SYS_MODEM_AS_ID_NO_CHANGE? (sys_modem_as_id_e_type)((id)-1) : SYS_MODEM_AS_ID_1)
...
#define SYS_AS_ID_TO_INST_ID(as_id) \
  ( (as_id)>=SYS_MODEM_AS_ID_1 && (as_id)<SYS_MODEM_AS_ID_NO_CHANGE ? (uint8)((as_id)+1) : 1)
...
typedef enum sys_block_plmn_cause_e
{
  ...
  SYS_BLOCK_PLMN_CAUSE_FOR_NTN_REJ_CAUSE_78,
...
/*eDRX Strucrures*/
#define SYS_EDRX_CONFIG_INFO_MASK_NONE                               0
#define SYS_EDRX_CONFIG_INFO_MASK_EDRX_ENABLED             BM (0 )
#define SYS_EDRX_CONFIG_INFO_MASK_PTW                      BM (1 )
#define SYS_EDRX_CONFIG_INFO_MASK_EDRX_CYCLE_LENGTH        BM (2 )
...
SYS_PSM_STATUS_NOT_READY_ACTIVE_TIMER_RUNNING,
/**< Not ready to enter PSM due to active timer T3324 is running at NAS */

SYS_PSM_STATUS_DONE,
/**< Indicates that PSM enter rsp sent to CM and protocol waiting for
 ** task shutdown*/

SYS_PSM_STATUS_NOT_READY_ACTIVE_OOS,
/**< Not ready to enter PSM due to OOS */

SYS_PSM_STATUS_ENTER_DEEP_SLEEP,
...
/*
   Negotiated ciot capabilities between UE & NW
*/
typedef struct
{
  boolean                cp_ciot_supported;
  /**< Control plane ciot optimisations supported */

  boolean                esr_without_pdn_supported;
  /**< ESR without PDN supported */

  boolean                hc_cp_ciot_supported;
  /**< Header compression supported*/

  boolean                s1_u_data_supported;
  /**< S1_u data is supported */

  boolean                up_ciot_supported;
  /**< User plane ciot optimisations supported */

} sys_neg_ciot_cap;

/* PSM VERSION MASKS
*/
#define CM_PSM_VERSION_MASK_NONE                                 0
#define CM_PSM_VERSION_MASK_WO_NW_COORDINATION                   BM(0)
#define CM_PSM_VERSION_MASK_REL12_WO_NW_CONTEXT_RETENTION        BM(1)
#define CM_PSM_VERSION_MASK_WITH_CONTEXT_RETENTION               BM(2)
#define CM_PSM_VERSION_MASK_PSM_BTW_EDRX_CYCLE                   BM(3)

#define CM_PSM_VERSION_MASK_ALL                   (CM_PSM_VERSION_MASK_WO_NW_COORDINATION|CM_PSM_VERSION_MASK_REL12_WO_NW_CONTEXT_RETENTION \
                                                 |CM_PSM_VERSION_MASK_WITH_CONTEXT_RETENTION|CM_PSM_VERSION_MASK_PSM_BTW_EDRX_CYCLE)

/* Type for PSM configuration
*/
...
typedef PACKED struct PACKED_POST{
  ...
  /* Duration threshold (in seconds) to enter PSM */
   ...
   uint8         psm_version;
  /* PSM version mask, CM_PSM_VERSION_MASK_xxxx */

   uint8       tiny_image_config;
  /* Indicates if tiny image has APP and download config enable*/
}cm_psm_config_s_type;

typedef struct
{
  boolean   cp_ciot_supported; /* Control plane CIoT EPS optimization (CP CIoT) */
  boolean   up_ciot_supported;
  boolean   hc_cp_ciot_supported;
  boolean   s1_u_data_supported;   
  boolean    epco_ciot_cap;
  boolean   attach_without_pdn;
} psm_nbiot_info;

typedef enum
{
  SYS_CP_SMS_STATUS_NONE = -1,

  SYS_CP_SMS_STATUS_NOT_AVAILABLE,

  SYS_CP_SMS_STATUS_SERVICE_NOT_AVAILABLE_IN_PLMN,

  SYS_CP_SMS_STATUS_SERVICE_FAIL_DUE_TO_NW_FAILURE,

  SYS_CP_SMS_STATUS_SERVICE_FAIL_DUE_TO_CONGESTION,

  SYS_CP_SMS_STATUS_SERVICE_TEMP_FAILURE,

  SYS_CP_SMS_STATUS_AVAILABLE,

  SYS_CP_SMS_SERVICE_STATUS_MAX

}sys_cp_sms_service_status_e_type;

typedef struct 
{
  sys_roam_status_e_type roam_state; 
  sys_sys_mode_e_type current_camped_rat; 
  sys_sys_mode_e_type scanning_rat; 
} sys_scan_params_s_type;
/*==============================================================================
FUNCTION  esm_get_restore_psm_nbiot_info
...
typedef struct 
{
  ...
  union
  {
    sys_loc_m1_cell_id_s_type     m1_Cell;
    sys_loc_nb1_cell_id_s_type    nb1_cell;
    sys_loc_gsm_cell_id_s_type    gsm_cell;
  }rat_cell;

}sys_loc_wwan_cell_id_s_type;


typedef enum
{ /* will add all enum later currently not sure about it */
  SYS_OFFSET_MINUS_TEN,
  SYS_OFFSET_MINUS_NINE,
  SYS_OFFSET_MINUS_EIGHT,
  SYS_OFFSET_MINUS_SEVEN,
  SYS_OFFSET_MINUS_SIX,
  SYS_OFFSET_MINUS_FIVE,
  SYS_OFFSET_MINUS_FOUR,
  SYS_OFFSET_MINUS_THREE,
  SYS_OFFSET_MINUS_TWO,
  SYS_OFFSET_MINUS_ONE,
  SYS_OFFSET_ZERO,
  SYS_OFFSET_PLUS_ONE,
  SYS_OFFSET_PLUS_TWO,
  SYS_OFFSET_PLUS_THREE,
  SYS_OFFSET_PLUS_FOUR,
  SYS_OFFSET_PLUS_FIVE,
  SYS_OFFSET_PLUS_SIX,
  SYS_OFFSET_PLUS_SEVEN,
  SYS_OFFSET_PLUS_EIGHT,
  
  SYS_OFFSET_PLUS_NINE

}sys_nb1_earfcn_offset_e_type;

typedef enum
{
  
  SYS_NB1_SET_RASTER_OFFSET_MIN_7_DOT_5_KHZ, /* -7.5 kHz */
  SYS_NB1_SET_RASTER_OFFSET_MIN_2_DOT_5_KHZ, /* -2.5 kHz */
  SYS_NB1_SET_RASTER_OFFSET_2_DOT_5_KHZ,  /*  2.5 kHz */
  SYS_NB1_SET_RASTER_OFFSET_7_DOT_5_KHZ   /*  7.5 kHz */
  
}sys_nb1_raster_offset_e_type;



typedef enum
{
  SYS_SCAN_RESULT_NONE,
  SYS_SCAN_RESULT_INVALID,
  SYS_SCAN_COMPLETE_SUCCESS,
  SYS_SCAN_COMPLETE_NO_CELL_FOUND,
  SYS_SCAN_STOPPED_BY_DURATION_TIMER,
  SYS_SCAN_NOT_STARTED,
  SYS_SCAN_OVERLAPPED_CHANNEL,
  SYS_SCAN_CHANNEL_NOT_SUPPORTEDSS

} sys_channel_scan_result_e_type;
...
}sys_loc_wwan_scan_control_s_type;

#define SYS_MAX_PCI_SCAN_REQ 8
...
/* Physical cell id (0 to C_MAX_PHYSICAL_CELL_ID) */
  ...
  sys_nb1_raster_offset_e_type  nb1_raster_offset;

  sys_nb1_earfcn_offset_e_type  nb1_earfcn_offset;

  /* Cell timing system frame offset */
  uint32  system_frame_offset;

}sys_loc_wwan_scan_ad_per_pci_nb1_s_type;

#define SYS_MAX_NB1_PCI_SCAN_REQ 4
...
/* number of cells to return on this channel overriding default limit */
  ...
  sys_loc_wwan_scan_ad_per_pci_nb1_s_type wwan_scan_ad_per_pci_nb1[SYS_MAX_NB1_PCI_SCAN_REQ];


}sys_loc_wwan_scan_ad_element_nb1_s_type;
...
}sys_loc_wwan_scan_ad_per_pci_m1_s_type;
...
/* number of cells to return on this channel overriding default limit */
  ...
  sys_loc_wwan_scan_ad_per_pci_m1_s_type 
             wwan_scan_ad_per_pci_m1[SYS_MAX_PCI_SCAN_REQ];


}sys_loc_wwan_scan_ad_element_m1_s_type;
...
}sys_loc_wwan_scan_ad_element_gsm_s_type;

/* from GSM side this structure is fine */

#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH_TEST

#define SYS_MAX_EARFCN_SCAN_REQ 5
#define SYS_MAX_RESULT_PER_RAT 5

#else

#define SYS_MAX_EARFCN_SCAN_REQ 32
#define SYS_MAX_RESULT_PER_RAT 32

#endif

typedef struct sys_loc_wwan_scan_rat_m1_param_s
{
/* M1 WWAN scan assistance data */
  ...
  sys_loc_wwan_scan_ad_element_m1_s_type   m1_ad_elems[SYS_MAX_EARFCN_SCAN_REQ];

}sys_loc_wwan_scan_rat_m1_param_s_type;

typedef struct sys_loc_wwan_scan_rat_nb1_param_s
{

  /* NB1 WWAN scan assistance data */
  boolean is_nb1_blind_scan_req;
  uint16 max_scan_duration_nb1_sec;
  uint8  num_nb1_ad_element;
  sys_loc_wwan_scan_ad_element_nb1_s_type   nb1_ad_elems[SYS_MAX_EARFCN_SCAN_REQ];
}sys_loc_wwan_scan_rat_nb1_param_s_type;

typedef struct sys_loc_wwan_scan_rat_gsm_param_s
{
  ...
  sys_loc_wwan_scan_ad_element_gsm_s_type   gsm_ad_elems[SYS_MAX_EARFCN_SCAN_REQ];
}sys_loc_wwan_scan_rat_gsm_param_s_type;

typedef union sys_loc_wwan_scan_rats_params_u 
{
  sys_loc_wwan_scan_rat_m1_param_s_type m1_scan_params;
  sys_loc_wwan_scan_rat_nb1_param_s_type nb1_scan_params;
  sys_loc_wwan_scan_rat_gsm_param_s_type gsm_params;
}sys_loc_wwan_scan_rats_params_u_type;

typedef struct
{
  /* Air interfaces for which assistance data are provided */

  sys_radio_access_tech_e_type rat;

  sys_loc_wwan_scan_rats_params_u_type  wwan_rat_scan_param;

} sys_loc_wwan_scan_assistance_data_s_type;
...
typedef struct
{
  ...
  sys_loc_wwan_scan_assistance_data_s_type assist_param;
}sys_wwan_adavnce_scan_pram_s_type;
...
} sys_local_wwan_scan_assitance_data_m1_s_type;
...
} sys_local_wwan_scan_assitance_data_nb1_s_type;
...
typedef struct
{
  ...
  uint16 max_scan_duration_gsm_sec;
  sys_loc_wwan_scan_ad_element_gsm_s_type   gsm_ad_elems[SYS_MAX_EARFCN_SCAN_REQ];
} sys_local_wwan_scan_assitance_data_gsm_s_type;

typedef union
{

  sys_local_wwan_scan_assitance_data_m1_s_type wwan_scan_assistance_data_m1;

  sys_local_wwan_scan_assitance_data_nb1_s_type wwan_scan_assistance_data_nb1;

  sys_local_wwan_scan_assitance_data_gsm_s_type wwan_scan_assistance_data_gsm;

}sys_loc_wwan_scan_assistance_data_u_type;

typedef struct
{
  sys_loc_wwan_scan_control_s_type control_param;
  sys_radio_access_tech_e_type rat;
  sys_loc_wwan_scan_assistance_data_u_type assist_param;
}sys_wwan_advance_search_req_params_s_type;

typedef enum
{
  SYS_POWER_MEAS_TYPE_RSRP,
  SYS_POWER_MEAS_TYPE_RXLEVEL
}sys_wwan_rx_power_meas_e_type;

typedef struct
{
  sys_wwan_rx_power_meas_e_type     rx_power_meas_sel;

  union
  {
    int16 rsrp; /* -140 to -44 dBm */
    int16 rxlevel; /* -110 to -48 dBm */
  }  power_measurement;

}sys_wwan_rx_power_measurement_s_type;

#define SYS_MAX_PCI_RESULT 8
...
/* Physical cell id (0 to C_MAX_PHYSICAL_CELL_ID) */
  uint16  phy_id; 
  sys_loc_wwan_cell_id_s_type cell_info;
  sys_wwan_rx_power_measurement_s_type rx_power_meas;
...
}sys_loc_wwan_scan_result_per_pci_m1_s_type;
...
/* Channel number / downlink center frequency (0 to C_MAX_EXTENDED_EARFCN) */
  ...
  sys_channel_scan_result_e_type  channel_scan_result_status;

  uint8  num_result_per_earfcn_m1;

  sys_loc_wwan_scan_result_per_pci_m1_s_type wwan_result_per_earfcn_m1[SYS_MAX_PCI_RESULT];

}sys_loc_wwan_scan_result_m1_s_type;
...
}sys_loc_wwan_scan_result_per_pci_nb1_s_type;
...
/* Channel number / downlink center frequency (0 to C_MAX_EXTENDED_EARFCN) */
  ...
  sys_loc_wwan_scan_result_per_pci_nb1_s_type wwan_result_per_earfcn_nb1[SYS_MAX_PCI_RESULT];
}sys_loc_wwan_scan_result_nb1_s_type;
...
}sys_loc_wwan_scan_result_gsm_s_type;
...
typedef union
{
  ...
  sys_loc_wwan_scan_result_m1_s_type wwan_scan_result_m1;

  sys_loc_wwan_scan_result_nb1_s_type wwan_scan_result_nb1;

  sys_loc_wwan_scan_result_gsm_s_type wwan_scan_result_gsm;

}sys_loc_wwan_rat_scan_result_u_type;
...
typedef struct
{
  ...
  sys_plmn_list_status_e_type scan_status_per_rat;
...
/* Scan result based on air interface bit */
  ...
  sys_loc_wwan_rat_scan_result_u_type  wwan_scan_result_per_rat[SYS_MAX_RESULT_PER_RAT];

}sys_loc_wwan_scan_result_per_rat_s_type;

typedef struct
{

  _REF_CNT_OBJ;
  sys_loc_wwan_scan_result_per_rat_s_type wwan_scan_result_per_rat;

}sys_loc_wwan_scan_result_s_type;
...
typedef union sys_found_plmn_list_u
{
  ...
  sys_cell_search_list_s_type				   cell_info_list;	 /*  consolidated GSM/M1/NB*/
  sys_loc_wwan_scan_result_s_type*              gps_wwan_scan_result;
} sys_found_plmn_list_u_type;


typedef enum
{
  SYS_GPS_WWAN_SCAN_ACT_LOW_PRIORTY_START,
  /* GPS scan priority low for search START, means WWAN will have higher priority    */
  SYS_GPS_WWAN_SCAN_ACT_LOW_PRIORTY_END,
  /* GPS scan priority low for search END, means WWAN will have higher priority    */
  SYS_GPS_WWAN_SCAN_ACT_HIGH_PRIORITY_START,
  /* GPS scan priority high means GPS will have higher priority start*/
  SYS_GPS_WWAN_SCAN_ACT_HIGH_PRIORITY_END,
  /* GPS scan priority high means GPS will have higher priority  end*/
  SYS_GPS_WWAN_SCAN_ACT_MAX

  /* internal use only  */
} sys_gps_wwan_scan_act_e_type;

typedef enum
{
  SYS_GPS_WWAN_SCAN_ACT_MASK_LOW_PRIORTY_START = SYS_BM(SYS_GPS_WWAN_SCAN_ACT_LOW_PRIORTY_START),
  /* GPS scan priority low for search start, means WWAN will have higher priority    */
  SYS_GPS_WWAN_SCAN_ACT_MASK_LOW_PRIORTY_END = SYS_BM(SYS_GPS_WWAN_SCAN_ACT_LOW_PRIORTY_END),
  /* GPS scan priority low for search end, means WWAN will have higher priority    */
  SYS_GPS_WWAN_SCAN_ACT_MASK_HIGH_PRIORITY_START = SYS_BM(SYS_GPS_WWAN_SCAN_ACT_HIGH_PRIORITY_START),
  /* GPS scan priority high means GPS will have higher priority start */
    SYS_GPS_WWAN_SCAN_ACT_MASK_HIGH_PRIORITY_END = SYS_BM(SYS_GPS_WWAN_SCAN_ACT_HIGH_PRIORITY_END),
  /* GPS scan priority high means GPS will have higher priority end*/
  SYS_GPS_WWAN_SCAN_ACT_MASK_MAX

  /* internal use only  */
} sys_gps_wwan_scan_act_mask_e_type;
