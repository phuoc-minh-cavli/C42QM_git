...
$Header: //components/rel/mmcp.mpss/6.1.10/api/public/wms.h#1 $
...
typedef enum
{
  ...
  WMS_CLIENT_TYPE_DS_3GPP,  /** data module (DS)*/
/** @cond */
  WMS_CLIENT_TYPE_MAX,
...
typedef enum
{
  ...
  WMS_CMD_ERR_MSG_PSM,                 /**< PSM deep sleep mode. */
...
/** @ingroup common_type_defs_group
  SMS Transport Layer verstat status type.
*/

typedef enum
{
  WMS_VERSTAT_STATUS_NO_VALIDATION = 0,
    /**< No number validation was performed. */
  WMS_VERSTAT_STATUS_VALIDATION_PASS = 1,
    /**< The number passed the validation. */
  WMS_VERSTAT_STATUS_VALIDATION_FAIL = 2,
    /**< The number failed the validation. */
    /** @cond */
  WMS_VERSTAT_STATUS_VALIDATION_MAX
    /** @endcond */
} wms_msg_transport_verstat_status_e_type;
...
{ 
   ...
   wms_msg_transport_verstat_status_e_type  ims_verstat_status;  /**< IMS verstat status. */
...
typedef enum
{
  ...
  WMS_RP_CAUSE_HARD_FAILURE                       = 217  /**< MO SMS rejected if network doe not provide SMS service to UE*/
} wms_rp_cause_e_type;
