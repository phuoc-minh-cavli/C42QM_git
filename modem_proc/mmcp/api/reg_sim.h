...
$Header: //components/rel/mmcp.mpss/6.1.10/api/reg_sim.h#1 $ $DateTime: 2023/04/25 14:39:18 $ $Author: pwbldsvc $
...
#define REG_SIM_DOS_MITIGATION_PLMN_LIST_LENGTH 20
...
typedef struct reg_sim_fplmn_counter_entry_s
{
  sys_plmn_id_s_type   plmn;
  uint8                counter;
  boolean              is_forbidden;
} reg_sim_fplmn_counter_entry_s_type;


typedef struct reg_sim_fplmn_counter_list_s
{
  uint32                                 length;
  reg_sim_fplmn_counter_entry_s_type     plmn_info[REG_SIM_PLMN_LIST_LENGTH];
} reg_sim_fplmn_counter_list_s_type;

typedef struct reg_sim_dos_mitigation_plmn_list_s
{
  uint32                                 length;
  reg_sim_fplmn_counter_entry_s_type     plmn_info[REG_SIM_DOS_MITIGATION_PLMN_LIST_LENGTH];
} reg_sim_dos_mitigation_plmn_list_s_type;
/*==============================================================================
...
FUNCTION NAME
  ...
  reg_sim_plmn_forbidden_any_lte

DESCRIPTION

  LTE specific. This function returns a value indicating if the
  specified PLMN is included in any of the forbidden PLMN list.
  due to blocking of LTE.
...
==============================================================================*/
boolean reg_sim_plmn_rat_forbidden_any_lte
(
  sys_plmn_id_s_type        plmn,  
  sys_modem_as_id_e_type as_id
);
...
RETURN VALUE
  ...
  TRUE if Attach with IMSI config enabled else FALSE
==============================================================================*/
extern boolean reg_sim_per_subs_chk_attach_with_imsi_cfg
(
  sys_modem_as_id_e_type sub_id
);
...
RETURN VALUE
  TRUE or FALSE
==============================================================================*/
extern boolean reg_sim_per_subs_chk_mo_excep_cfg
(
	sys_modem_as_id_e_type sub_id
);
/*==============================================================================
FUNCTION NAME
  reg_sim_set_mo_excp_cfg
...
==============================================================================*/
extern boolean reg_sim_mmgsdi_steering_of_roaming_refresh_ind
(
...
==============================================================================*/
extern boolean reg_sim_check_mcc_same_country_per_sub
(
	sys_plmn_id_s_type plmn,
	sys_modem_as_id_e_type	 as_id
