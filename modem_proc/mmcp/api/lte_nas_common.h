...
$Header: //components/rel/mmcp.mpss/6.1.10/api/lte_nas_common.h#1 $
$Author: pwbldsvc $
...
typedef enum{
    ...
    ESM_DUMMY_MESSAGE = 220,

    ESM_STATUS = 232,
    ESM_DATA_TRANSPORT = 235,
...
typedef enum
{
  ...
  LTE_NAS_PLMN_NOT_ALLOWED_IN_CURR_UE_LOC = 78,
...
typedef enum 
{
  ...
  LTE_NAS_EMM = 3,
  LTE_NAS_GPS = 4,
  LTE_ESM_EDT = 5  /* ID for ESM Data Transport messages */
}lte_nas_module_id_T;
