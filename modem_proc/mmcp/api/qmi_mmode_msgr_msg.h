...
/*==============================================================================
 ...
 $Header: //components/rel/mmcp.mpss/6.1.10/api/qmi_mmode_msgr_msg.h#1 $
...
/*
#define MSGR_MODULE_PSM    0x4
#define MSGR_QMI_PSM       MSGR_TECH_MODULE( MSGR_TECH_QMI, MSGR_MODULE_PSM )*/
...
/*MSG struct to get the JAMMING STATUS from lower layers*/
typedef struct 
{
...
} qmi_nas_jamming_status_msg_s_type;
...
/*QMI_NAS_JAMMING_STATUS_CHGD_IND - Interface to jamming_status from M1/NB1/GSM to QMI*/
  MSGR_DEFINE_UMID(QMI, NAS, IND, JAMMING_STATUS_CHGD, 0x0E, qm_nas_jamming_status_msg_s_type),
