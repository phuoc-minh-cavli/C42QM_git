/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/src/WMSE/wmsdiag.c#1 $
                             ...
                             wms_cfg_event_info_s_type *info_ptr)
{
  ...
  MSG_HIGH_1("info_ptr->message_list.mem_store = %d", info_ptr->message_list.mem_store);
...
{
   uint16  j;
   MSG_HIGH_1("Receiving CMAS message with alphabet: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.cb_dcs.alphabet);
   MSG_HIGH_1("Receiving CMAS message with language: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.cb_dcs.language);
   MSG_HIGH_1("Receiving CMAS message with geo scope: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.geo_scope);
   MSG_HIGH_1("Receiving CMAS message with message code: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.message_code);
   MSG_HIGH_1("Receiving CMAS message with page number: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.page_number);
   MSG_HIGH_1("Receiving CMAS message with raw serial number: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.raw_serial_number);
   MSG_HIGH_1("Receiving CMAS message with update number: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.update_number);
   MSG_HIGH_1("Receiving CMAS message with total_page: %d", client_ts_data_ptr->u.gw_cb.cb_page_hdr.total_pages);
...
void  wms_diag_print_cmas_message(wms_cmas_msg_s_type *cmas_msg_ptr)
{
    ...
    MSG_HIGH_1("CMAS version: %d", cmas_msg_ptr->cmae_protocol_version);
    MSG_HIGH_1("CMAS record count: %d", cmas_msg_ptr->cmae_record_count);
      ...
      case WMS_CMAE_RECORD_TYPE_0:
        {
            ...
            uint8  j;
            uint16 bit_pos = 0;
            MSG_HIGH_1("CMAS char_set: %d", record_type_0->cmae_char_set);
            MSG_HIGH_1("CMAS number of characters: %d", record_type_0->number_of_chars);
      ...
      case WMS_CMAE_RECORD_TYPE_1:
        {
            ...
            MSG_HIGH_1("CMAS category: %d", record_type_1->cmae_category);
            MSG_HIGH_1("CMAS certainty: %d", record_type_1->cmae_certainty);
            MSG_HIGH_1("CMAS response type: %d", record_type_1->cmae_response_type);
            MSG_HIGH_1("CMAS severity: %d", record_type_1->cmae_severity);
            MSG_HIGH_1("CMAS urgency: %d", record_type_1->cmae_urgency);
        }
        break;
      ...
      case WMS_CMAE_RECORD_TYPE_2:
        {
            ...
            MSG_HIGH_1("CMAS expire year: %d", record_type_2->cmae_expires.year);
            MSG_HIGH_1("CMAS expire month: %d", record_type_2->cmae_expires.month);
            MSG_HIGH_1("CMAS expire day: %d", record_type_2->cmae_expires.day);
            MSG_HIGH_1("CMAS expire hour: %d", record_type_2->cmae_expires.hour);
            MSG_HIGH_1("CMAS expire minute: %d", record_type_2->cmae_expires.minute);
            MSG_HIGH_1("CMAS expire second: %d", record_type_2->cmae_expires.second);
            MSG_HIGH_1("CMAS response id: %d", record_type_2->cmae_id);
            MSG_HIGH_1("CMAS language: %d", record_type_2->cmae_language);
        }
        break;
...
void wms_diag_print_etws_message(wms_etws_msg_s_type* etws_msg_ptr)
{
   ...
   if (WMS_ETWS_NOTIFICATION_PRIMARY == etws_msg_ptr->type)
   {
      ...
      if (NULL != prim_msg_ptr)
      {
        ...
        {
          MSG_HIGH_1("ETWS message with service id: %d", prim_msg_ptr->cb_header_info.cb_srv_id);
          MSG_HIGH_1("ETWS message with alphabet: %d", prim_msg_ptr->cb_header_info.cb_dcs.alphabet);
          MSG_HIGH_1("ETWS message with language: %d", prim_msg_ptr->cb_header_info.cb_dcs.language);
          MSG_HIGH_1("ETWS message with geo scope: %d", prim_msg_ptr->cb_header_info.geo_scope);
          MSG_HIGH_1("ETWS message with message code: %d", prim_msg_ptr->cb_header_info.message_code);
          MSG_HIGH_1("ETWS message with page number: %d", prim_msg_ptr->cb_header_info.page_number);
          MSG_HIGH_1("ETWS message with raw serial number: %d", prim_msg_ptr->cb_header_info.raw_serial_number);
          MSG_HIGH_1("ETWS message with update number: %d", prim_msg_ptr->cb_header_info.update_number);
          MSG_HIGH_1("ETWS message with total_page: %d", prim_msg_ptr->cb_header_info.total_pages);
          MSG_HIGH_1("ETWS message with emergency user alert: %d", prim_msg_ptr->activate_emergency_user_alert);
          MSG_HIGH_1("ETWS message with popup: %d", prim_msg_ptr->activate_popup);
          MSG_HIGH_1("ETWS message with warning type: %d", prim_msg_ptr->warning_type);
          if (prim_msg_ptr->security_info_present)
          {

            MSG_HIGH_1("ETWS message with year: %d", prim_msg_ptr->security_info.timestamp.year);
            MSG_HIGH_1("ETWS message with month: %d", prim_msg_ptr->security_info.timestamp.month);
            MSG_HIGH_1("ETWS message with day: %d", prim_msg_ptr->security_info.timestamp.day);
            MSG_HIGH_1("ETWS message with hour: %d", prim_msg_ptr->security_info.timestamp.hour);
            MSG_HIGH_1("ETWS message with minute: %d", prim_msg_ptr->security_info.timestamp.minute);
            MSG_HIGH_1("ETWS message with second: %d", prim_msg_ptr->security_info.timestamp.second);
   ...
   else if (etws_msg_ptr->type == WMS_ETWS_NOTIFICATION_SECONDARY_UMTS_FORMAT)
   {
      ...
      if (NULL != sec_msg_ptr)
      {
        ...
        {
          MSG_HIGH_1("ETWS message with service id: %d", sec_msg_ptr->cb_header_info.cb_srv_id);
          MSG_HIGH_1("ETWS message with alphabet: %d", sec_msg_ptr->cb_header_info.cb_dcs.alphabet);
          MSG_HIGH_1("ETWS message with language: %d", sec_msg_ptr->cb_header_info.cb_dcs.language);
          MSG_HIGH_1("ETWS message with geo scope: %d", sec_msg_ptr->cb_header_info.geo_scope);
          MSG_HIGH_1("ETWS message with message code: %d", sec_msg_ptr->cb_header_info.message_code);
          MSG_HIGH_1("ETWS message with page number: %d", sec_msg_ptr->cb_header_info.page_number);
          MSG_HIGH_1("ETWS message with raw serial number: %d", sec_msg_ptr->cb_header_info.raw_serial_number);
          MSG_HIGH_1("ETWS message with update number: %d", sec_msg_ptr->cb_header_info.update_number);
          MSG_HIGH_1("ETWS message with total_page: %d", sec_msg_ptr->cb_header_info.total_pages);
          MSG_HIGH_1("ETWS message with emergency user alert: %d", sec_msg_ptr->activate_emergency_user_alert);
          MSG_HIGH_1("ETWS message with popup: %d", sec_msg_ptr->activate_popup);
          MSG_HIGH_1("ETWS message with cb_data length: %d", sec_msg_ptr->cb_data_len);
...
void wms_diag_make_message_read_result_log (wms_client_message_s_type wmsdiag_message )
{
  ...
  */
  ...
  if (log_rsp)
  {
    ...
    log_size = WMS_OFFSETOF (wmsdiag_read_log_type, data) + A + S + D;
