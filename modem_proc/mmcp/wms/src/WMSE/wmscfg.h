...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/src/WMSE/wmscfg.h#1 $
...
#ifdef FEATURE_WMS_VOICE_MAIL_ENABLE
...
//#endif
  ...
  boolean                           loop_back_notify;           //tells whether DS has send activation or deactivation

  boolean                           in_psm_deep_sleep;          //tells whether UE is in PSM deep sleep mode or not
} wms_cfg_s_type;
