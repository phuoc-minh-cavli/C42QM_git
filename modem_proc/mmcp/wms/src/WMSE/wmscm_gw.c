/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/src/WMSE/wmscm_gw.c#1 $
...
#endif
    default:
      MSG_ERROR_1("Invalid rpt: %d", msg_p->message_header.message_id);
      break;
    } // switch (msg_p->message_header.message_id)
   ...
   case UASMS_SM_DATA_IND:
      {
         ...
         wms_msg_sm_data_ind_proc( asid,
                                   ...
                                   rpt_ptr->rpt.rl_data_ind.sms_verstat_status
                                    );
      }
      break;
