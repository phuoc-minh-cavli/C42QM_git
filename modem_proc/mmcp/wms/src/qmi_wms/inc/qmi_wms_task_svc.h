...
/*===========================================================================
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/src/qmi_wms/inc/qmi_wms_task_svc.h#1 $
...
typedef enum
{
  QMI_WMS_CMD_Q_SIGNAL                   =  0x100000,   /* QMI command Q signal          */
  QMI_WMS_SERVICE_WMS_QCSI_SIGNAL        =  0x200000,   /* QCSI signal        */
  QMI_WMS_SIG_MASK_CHANGE_SIGNAL         =  0x400000,   /* Indicates sig mask has changed*/
...
/*---------------------------------------------------------------------------
  BEWARE: Other signal need to be defined from here.
---------------------------------------------------------------------------*/
  QMI_WMS_SERVICE_WMS_SIGNAL     = 0x800000,  /* WMS service signal */
  QMI_WMS_MAX_SIGNALS                        /* use next value for enum        */
} qmi_wms_sig_enum_type;
