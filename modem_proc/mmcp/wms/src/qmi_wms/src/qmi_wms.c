/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/src/qmi_wms/src/qmi_wms.c#1 $
...
#define WMS_DEBUG_MESSAGE_BUFFER_SIZE                 30
  
unsigned int					   wms_debug_buffer[WMS_DEBUG_MESSAGE_BUFFER_SIZE];
unsigned int					   wms_debug_buffer_index;
...
#define qmi_wms_free_cmd_data_buf(p)                               \
           if (p != NULL)                                            \
           {                                                         \
             modem_mem_free(p, MODEM_MEM_CLIENT_QMI_WMS_CRIT);     \
             p = NULL;                                               \
           }
...
/*---------------------------------------------------------------------------
  QMI WMS verstat status enum
---------------------------------------------------------------------------*/
typedef enum
{
  WMSI_NO_VALIDATION    = 0x0000,
  WMSI_VALIDATION_PASS  = 0x0001,
  WMSI_VALIDATION_FAIL  = 0x0002,
  WMSI_VALIDATION_MAX,
  WMSI_VALIDATION_MAX32 = 0x7FFFFFFF /* forces enum values to 32 bits */
} qmi_wmsi_verstat_status_e_type;
...
typedef struct qmi_wmsi_report_event_info_s
{
  ...
  wms_msg_transport_verstat_status_e_type  verstat_status;
...
typedef struct qmi_wms_cmd_node_s
{
  ...
  qmi_wms_qcsi_transaction_type *cmd_buf;
  uint16                        cmd_type;
  boolean                       async_cmd;
...
#ifndef FEATURE_WMS_LTE_ONLY
#ifdef FEATURE_WMS_CDSMS_ENABLE
...
---------------------------------------------------------------------------*/
...
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_reset(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_EVENT_REPORT_V01
	static dsm_item_type* qmi_wmsi_set_event_report(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#if !defined(REMOVE_QMI_WMS_RAW_SEND_V01) || !defined(REMOVE_QMI_WMS_ASYNC_RAW_SEND_V01)
	static dsm_item_type* qmi_wmsi_raw_send(qmi_wms_svc_info_type *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_RAW_WRITE_V01
	static dsm_item_type* qmi_wmsi_raw_write(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_RAW_READ_V01
	static dsm_item_type* qmi_wmsi_raw_read(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_MODIFY_TAG_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_modify_tag(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_DELETE_V01
	static dsm_item_type* qmi_wmsi_delete(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_MESSAGE_PROTOCOL_V01
#ifdef  FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_get_message_protocol(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_LIST_MESSAGES_V01
#ifdef  FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_list_messages(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_ROUTES_V01
	static dsm_item_type* qmi_wmsi_set_routes(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_ROUTES_V01
#ifdef  FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_get_routes(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_SMSC_ADDRESS_V01
	static dsm_item_type* qmi_wmsi_get_smsc_addr(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_SET_SMSC_ADDRESS_V01
	static dsm_item_type* qmi_wmsi_set_smsc_addr(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_STORE_MAX_SIZE_V01
	static dsm_item_type* qmi_wmsi_get_store_max_size(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#if !defined(REMOVE_QMI_WMS_SEND_ACK_V01) || !defined(REMOVE_QMI_WMS_ASYNC_SEND_ACK_V01)
	static dsm_item_type* qmi_wmsi_send_ack(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifdef FEATURE_WMS_DBG_ENABLE
#ifndef REMOVE_QMI_WMS_SET_RETRY_PERIOD_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_set_retry_period(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_RETRY_INTERVAL_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_set_retry_interval(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#endif
#ifndef FEATURE_WMS_LTE_ONLY
...
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_set_dc_disconnect_timer(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#endif

#ifndef REMOVE_QMI_WMS_SET_MEMORY_STATUS_V01
	static dsm_item_type* qmi_wmsi_set_memory_status(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifdef FEATURE_WMS_CB_ENABLE
#ifndef REMOVE_QMI_WMS_SET_BROADCAST_ACTIVATION_V01
	static dsm_item_type* qmi_wmsi_set_broadcast_activation(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif

#ifndef REMOVE_QMI_WMS_SET_BROADCAST_CONFIG_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_set_broadcast_config(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_BROADCAST_CONFIG_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_get_broadcast_config(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#endif
	...
	static dsm_item_type* qmi_wmsi_get_domain_pref(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_DOMAIN_PREF_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_set_domain_pref(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
	...
	static dsm_item_type* qmi_wmsi_send_from_mem_store(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_MESSAGE_WAITING_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_get_message_waiting(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_PRIMARY_CLIENT_V01
	static dsm_item_type* qmi_wmsi_set_primary_client(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_INDICATION_REGISTER_V01
	static dsm_item_type* qmi_wmsi_indication_register(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_TRANSPORT_LAYER_INFO_V01
	static dsm_item_type* qmi_wmsi_get_transport_layer_info(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_TRANSPORT_NW_REG_INFO_V01
	static dsm_item_type* qmi_wmsi_get_transport_nw_reg_info(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_BIND_SUBSCRIPTION_V01
	static dsm_item_type* qmi_wmsi_bind_subscription(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_INDICATION_REGISTER_V01
	static dsm_item_type* qmi_wmsi_get_indication_register(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_GET_SMS_PARAMETERS_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_get_sms_parameters(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_SMS_PARAMETERS_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_set_sms_parameters(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
	...
	static dsm_item_type* qmi_wmsi_get_domain_pref_config(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_SET_DOMAIN_PREF_CONFIG_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_set_domain_pref_config(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif

#ifndef REMOVE_QMI_WMS_GET_RETRY_PERIOD_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_get_retry_period(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_RETRY_INTERVAL_V01
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_get_retry_interval(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
...
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
	static dsm_item_type* qmi_wmsi_get_dc_disconnect_timer(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
	...
	static dsm_item_type* qmi_wmsi_get_memory_status(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#endif
	...
	static dsm_item_type* qmi_wmsi_get_primary_client(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_SUBSCRIPTION_BINDING_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_get_subscription_binding(void*, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
#ifndef REMOVE_QMI_WMS_GET_SERVICE_READY_STATUS_V01
	static dsm_item_type* qmi_wmsi_get_service_ready_status(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#ifndef REMOVE_QMI_WMS_SET_MESSAGE_WAITING_V01
#ifdef	FEATURE_WMS_UNUSED_QMI_API_ENABLE

	static dsm_item_type* qmi_wmsi_set_message_waiting(void *, qmi_wms_qcsi_transaction_type *, void *, dsm_item_type **);
#endif
#endif
...
void qmi_wms_process_init_cback(void);
boolean qmi_wms_qcsi_sig_hdlr(qmi_wms_sig_enum_type);
...
---------------------------------------------------------------------------*/
void* qmi_wmsi_get_client_sp_by_cmd_buf(qmi_wms_qcsi_transaction_type*);
void* qmi_wmsi_get_client_sp_by_clid(uint8);
static boolean qmi_wmsi_send_response(qmi_wms_qcsi_transaction_type *, dsm_item_type *);
...
---------------------------------------------------------------------------*/
#define WMS_HDLR(a, b)  QMI_WMS_SVC_HDLR(a, (qmi_wms_svc_hdlr_ftype) b)

static qmi_wms_svc_cmd_hdlr_type  qmi_wmsi_cmd_callbacks[WMSI_CMD_MAX] =
{
#ifndef REMOVE_QMI_WMS_RESET_V01
#ifdef   FEATURE_WMS_UNUSED_QMI_API_ENABLE
...
---------------------------------------------------------------------------*/
static qmi_wms_svc_info_type  qmi_wms_state;

/*---------------------------------------------------------------------------
  QMI_WMS instance configuration
---------------------------------------------------------------------------*/
static qmi_wms_svc_cfg_type qmi_wmsi_cfg;
...
extern ULogHandle wms_get_ulog_handle();
...
void* qmi_wmsi_get_wms_sp_by_cmd_buf(void *);
...
qmi_wmsi_verstat_status_e_type qmi_wmsi_from_wms_verstat_status
(
  wms_msg_transport_verstat_status_e_type wms_status
);
     ...
     if (size > 0)
     {
       ...
       if (NULL != buf)
       {
         ...
         else
         {
           ...
           MSG_ERROR_1("qmi_wms_idl_message_decode dsm_pullup failed size %d", size);
         }
...
static int qmi_wms_qcsi_compare_pending_req_for_client
( 
  void *item_ptr,
  void *compare_val 
)
{
  qmi_wmsi_client_state_type *clnt_info_ptr;
  qmi_wms_qcsi_transaction_type *req_node;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  req_node = (qmi_wms_qcsi_transaction_type *)item_ptr;
  clnt_info_ptr = (qmi_wmsi_client_state_type *)req_node->clnt_info_ptr;
...
/*===========================================================================
  FUNCTION qmi_wms_qcsi_svc_disconnect_cb()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static void qmi_wms_qcsi_svc_disconnect_cb
(
...
)
{
  ...
  qmi_wms_qcsi_transaction_type  *pending_req = NULL;
  void                             *temp_ptr = NULL;
  int num_deleted_pending_txs = 0;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

  MSG_HIGH_2("In qmi_nas_qcsi_svc_disconnect_cb clnt %p srv_handle %p", 
      connection_handle, service_handle);


  ASSERT(connection_handle && service_handle);
  svc_ptr = (qmi_wms_svc_info_type *)service_handle;
  clnt_info_ptr = (qmi_wmsi_client_state_type *)connection_handle;

  do
  {
    if( svc_ptr == NULL || svc_ptr->service_id != QMI_WMS_SERVICE ||
        svc_ptr->service_handle != qmi_wms_state.service_handle )
    {
      err = QMI_CSI_INVALID_HANDLE;
      MSG_HIGH_0("Invalid service received");
      break;
    }
    ...
    if(q_cnt(&svc_ptr->pending_req) > 0)
    {
      do
      {
        pending_req = q_linear_delete_new(&svc_ptr->pending_req,
                                          qmi_wms_qcsi_compare_pending_req_for_client,
      ...
      {
        MSG_HIGH_2("nas_qcsi_disconnect_cb: Deleted %d pending txs of clnt 0x%p",
                       num_deleted_pending_txs, 
                       clnt_info_ptr->clnt);
      }
    }
  ...
  {
    qmi_wmsi_mem_free( clnt_info_ptr );
  }
  
  MSG_HIGH_2("wms_qcsi_disconnect_cb: Releasing client 0x%p err %d",
...
)
{
  ...
  trans = q_linear_delete_new( &svc_ptr->pending_req,
                               qmi_wms_qcsi_compare_pending_trans,
  ...
  if( trans != NULL )
  {
    qmi_wmsi_mem_free((void *)trans);
    *pending_trans = NULL;
  }
  
}/* qmi_wms_svc_free_pending_transaction */
...
)
{
  ...
  return ( (item_ptr == compare_val) ? 1 : 0 );
} /* qmi_wms_qcsi_compare_client_handle */
...
{
  qmi_wms_qcsi_transaction_type *req_node = (qmi_wms_qcsi_transaction_type*)item_ptr;
  qmi_req_handle req_handle = (qmi_req_handle)compare_val;

/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  return ( (req_node->req_handle == req_handle)? 1 : 0 );
} /* qmi_wms_qcsi_compare_pending_trans */

/*===========================================================================
  FUNCTION qmi_wms_qcsi_process_raw_msg()
  ...
  SIDE EFFECTS
    None
===========================================================================*/
static qmi_csi_cb_error qmi_wms_qcsi_process_raw_msg
(
  qmi_wms_svc_info_type              *svc_ptr,
  qmi_wms_qcsi_transaction_type      *trans,
  void                               *raw_msg,
...
)
{
  ...
  qmi_wms_svc_cmd_hdlr_type       *cmd_hdlr;
  uint16                           cmd;
  uint16                           msg_id = trans->msg_id;
  qmi_wms_svc_cfg_type            *svc_cfg;
  dsm_item_type                   *sdu_in = NULL;
  dsm_item_type                   *response_ptr = NULL;

  ASSERT(svc_ptr);
 
  svc_cfg = (qmi_wms_svc_cfg_type *)svc_ptr->svc_config;

  MSG_HIGH_1("in qmi_wms_qcsi_process_raw_msg:svc_cfg  %p",svc_cfg );

  do
  {
    if ((raw_msg != NULL ) && (raw_msg_len > 0) && ( raw_msg_len != dsm_pushdown_packed( &sdu_in, raw_msg, raw_msg_len, DSM_DS_SMALL_ITEM_POOL) ))
    {
      MSG_ERROR_1("Pushdown Failed for qmi_nas_idl_message_encode %d", raw_msg_len);
    ...
    if( svc_cfg != NULL )
    {
      ...
      {
        MSG_ERROR_2("Unrecognized msg_id (=%d) for QMI svc %d Return error", msg_id, svc_ptr->service_id);
        if(wms_get_ulog_handle() != NULL)
        {
           ULOG_RT_PRINTF_2(wms_get_ulog_handle(), " Unrecognized msg_id (=%d) for QMI svc %d Return error", msg_id, svc_ptr->service_id);
        }
        ret = QMI_CSI_CB_INTERNAL_ERR;
      }
      else
      {    
        MSG_SPRINTF_1( MSG_SSID_DFLT, MSG_LEGACY_HIGH, "Handling %s", cmd_hdlr->msg_desc);
        response_ptr = cmd_hdlr->request_hdlr( svc_ptr, trans, trans->clnt_info_ptr, &sdu_in );
      }
    }
    else
    {
      ret = QMI_CSI_CB_INTERNAL_ERR;
      //TODO: Printf or Assert
    }
  
    if (response_ptr == NULL)
    {
      MSG_HIGH_0("(Service generated no response)");
      ret = QMI_CSI_CB_INTERNAL_ERR;
    }
    else if (response_ptr == QMI_SVC_RESPONSE_PENDING)
    {
      MSG_HIGH_1("Response pending for msg_id %d", msg_id);
    }
    else
    {
      if( qmi_wms_qcsi_send_resp_raw(svc_ptr, trans, response_ptr)
            != QMI_CSI_NO_ERR )
      {
        ret = QMI_CSI_CB_INTERNAL_ERR;
      }
...
)
{
  ...
  qmi_wms_qcsi_transaction_type *curr_trans = NULL;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  do
  {
    ...
    MSG_HIGH_4("qcsi_handle_raw_req_cb: connection_handle ​%p req_handle ​%p msg id ​%d svc handle ​%p",
	                                           connection_handle, req_handle, msg_id,service_handle);
    if(wms_get_ulog_handle() != NULL)
   {
     ULOG_RT_PRINTF_4(wms_get_ulog_handle(), " qcsi_handle_raw_req_cb: connection_handle ​%p req_handle ​%p msg id ​%d svc handle ​%p",
                                           connection_handle, req_handle, msg_id,service_handle);
   }
											   
    if(wms_debug_buffer_index >= WMS_DEBUG_MESSAGE_BUFFER_SIZE)
    {
      wms_debug_buffer_index = 0;
    }  
    wms_debug_buffer[wms_debug_buffer_index] = msg_id; 
	wms_debug_buffer_index ++;
	...
	MSG_HIGH_1("svc_ptr->pending_req.cnt : %d",svc_ptr->pending_req.cnt);
	if(svc_ptr->pending_req.cnt >= 4)
    {
      MSG_HIGH_0("Pending requests are present");
    ...
    curr_trans = modem_mem_alloc( sizeof(qmi_wms_qcsi_transaction_type), MODEM_MEM_CLIENT_QMI_WMS_CRIT );
    if(!curr_trans)
    {
      err = QMI_CSI_CB_NO_MEM;
      MSG_HIGH_0("malloc failed for curr_trans");
      break;
    }
  
    memset(curr_trans, 0, sizeof(qmi_wms_qcsi_transaction_type));
    ...
    err = qmi_wms_qcsi_process_raw_msg(svc_ptr,
                                       curr_trans,
                                       raw_msg,
                                       raw_msg_len);
  ...
  if (err != QMI_CSI_CB_REQ_HANDLED )
  {  
    MSG_ERROR_4("qcsi_handle_raw_req_cb: Error processing err = %d connection handle %p svc handle %p msg id %d",
    ...
    if( curr_trans != NULL )
    {
      ...
      qmi_wmsi_mem_free((void *) curr_trans);
    }
  }
  else
  {
    MSG_HIGH_3("qcsi_handle_raw_req_cb: Handled req connection handle %p req_handle %p msg id %d ",
                    connection_handle, req_handle, msg_id);
  }

  return err;
  
} /* qmi_wms_qcsi_svc_handle_raw_req_cb() */
...
)
{
  ...
  if ( raw_rsp_len > 0 )
  {
    ...
    raw_rsp = (uint8 *)modem_mem_alloc((size_t)raw_rsp_len, MODEM_MEM_CLIENT_QMI_WMS_CRIT);
    ...
    if ( raw_rsp != NULL )
    {
      if ( raw_rsp_len == dsm_pullup( &resp_ptr, (void *)raw_rsp, raw_rsp_len ) )
      {
        ...
        {
          err = QMI_CSI_INVALID_HANDLE;
          MSG_ERROR_1("no pending trasaction with req_handle %p", trans->req_handle);
        }
      }
      else
      {
        err = QMI_CSI_INTERNAL_ERR;
        MSG_HIGH_1("qmi_wms_idl_message_decode dsm_pullup failed size %d", raw_rsp_len);
      }
  
      qmi_wmsi_mem_free( (void *)raw_rsp );
    }
    else
    {
      err = QMI_CSI_NO_MEM;
      MSG_HIGH_0(" qmi_wms_idl_message_decode no memory for buffer");
    }
    
  }

  MSG_HIGH_2("qmi_wms_qcsi_send_resp_raw err = %d for msg_id = %d",err, trans->msg_id);

  if(wms_get_ulog_handle() != NULL)
  {
    ULOG_RT_PRINTF_2(wms_get_ulog_handle(), "qmi_wms_qcsi_send_resp_raw err = %d for msg_id = %d",err, trans->msg_id);
  }
...
)
{
  ...
  if ( raw_ind_len > 0 )
  {
    ...
    raw_ind = (uint8 *)modem_mem_alloc((size_t)raw_ind_len, MODEM_MEM_CLIENT_QMI_WMS_CRIT);
    ...
    if ( raw_ind != NULL )
    {
      if ( raw_ind_len == dsm_pullup( &ind_ptr, (void *)raw_ind, raw_ind_len ) )
      {
        ...
        MSG_HIGH_3("qcsi_send_ind_raw(): clnt %p, msg_id %d, err %d",
                clnt, msg_id, err);
      }
      else
      {
        err = QMI_CSI_DECODE_ERR;
        MSG_HIGH_1("qmi_wms_idl_message_decode dsm_pullup failed size %d", raw_ind_len);
      }
  
      qmi_wmsi_mem_free( (uint8*)raw_ind);
    }
    else
    {
      err = QMI_CSI_NO_MEM;
  ...
  MSG_HIGH_2("qmi_wms_qcsi_send_ind_raw err = %d for msg_id = %d",err, msg_id);

  dsm_free_packet(&ind_ptr);
  
  return err;
  
}/* qmi_wms_qcsi_send_ind_raw */
...
{ 
  ...
  err = qmi_csi_handle_event(qmi_wms_state.service_handle, &qmi_wms_state.os_params);

  MSG_HIGH_3("In qmi_wms_qcsi_event_hdlr_cb sig %p: service handle %p  err %p" ,qmi_wms_state.os_params.sig,qmi_wms_state.service_handle,err);

  if (err != QMI_CSI_NO_ERR)
  {
    MSG_ERROR_1("qmi_csi_handle_event: failed with error = 0x%x", err);
  }
...
)
{
  ...
  if( service == QMI_WMS_SERVICE )
  {
    service_cookie->svc_sig = QMI_WMS_SERVICE_WMS_SIGNAL;
  }
  
  /* os_params for QCSI to raise a signal */
  service_cookie->os_params.tcb = wms_get_wms_tcb_ptr();  
  service_cookie->os_params.sig = QMI_WMS_SERVICE_WMS_QCSI_SIGNAL;  
  ...
  rc = qmi_csi_register_with_options(qmi_wmsi_global.svc_obj,
                        service_connect,
                        service_disconnect, 
                        service_process_req, 
                        (void *)service_cookie, 
  ...
  {
    MSG_FATAL_2("Unable to register QCSI service %d Error %d", service, rc);
  }
  else
  {
    MSG_HIGH_2("QMI service %d registered with QCSI service_handle %p",
...
)
{
  ...
  qmi_wms_enter_crit_section(&global_qmi_wms_crit_section);

  if (QMI_WMS_TASK_STOP_SIG_IS_RECEIVED)
  {
    MSG_ERROR_0("QMI_WMS task has shut down due to task_stop_sig rcvd. No commands allowed now");
    ret_val = FALSE;
  }
  ...
  qmi_wms_leave_crit_section(&global_qmi_wms_crit_section);

  return ret_val;
} /* qmi_wms_put_cmd_buf() */
/*===========================================================================
  FUNCTION QMI_WMS_QCSI_SIG_HDLR()
...
boolean qmi_wms_qcsi_sig_hdlr(
  qmi_wms_sig_enum_type     sig
)
{
  if(sig == QMI_WMS_SERVICE_WMS_QCSI_SIGNAL)
  {
    qmi_wms_qcsi_event_hdlr_cb();
  }

  return TRUE;
} /* qmi_wms_qcsi_sig_hdlr() */
...
{
  MSG_HIGH_1("qmi_wms_sig_hdlr, q_cnt:%d",qmi_wmsi_global.task_pend_q.cnt);

  while (qmi_wmsi_global.task_pend_q.cnt != 0)
  {
...
)
{
  ...
  MSG_MED_1("In alloc_cl_sp(): client_handle = %p", client_handle);
  
  cl_sp = (qmi_wmsi_client_state_type *) qmi_wmsi_mem_alloc(sizeof(qmi_wmsi_client_state_type));

  if (cl_sp)
  {
     memset( cl_sp, 0x00, sizeof(qmi_wmsi_client_state_type) );
...
/*===========================================================================
  FUNCTION qmi_wms_qcsi_svc_connect_cb()
...
===========================================================================*/
static qmi_csi_cb_error qmi_wms_qcsi_svc_connect_cb
(
  qmi_client_handle       client_handle,
  void                   *service_handle,
  void                  **connection_handle
...

{
  ...
  do
  {
    ...
    if ( NULL != q_linear_search( &svc_ptr->client_q,
                                    ...
                                    client_handle ) )
    {
      MSG_ERROR_1("wms_qcsi_connect_cb: client 0x%p present", client_handle);
      err = QMI_CSI_CB_CONN_REFUSED;
      break;
    }

    if( q_cnt(&svc_ptr->client_q) == WMSI_MAX_CLIDS )
    {
      MSG_ERROR_1("wms_qcsi_connect_cb: max num clients reached rejected client_handle %p", 
                        client_handle);
      err = QMI_CSI_CB_CONN_REFUSED;
      break;
    }
  
    cl_sp = qmi_wmsi_alloc_cl_sp( client_handle );
    ...
    if ( cl_sp )
    {
      ...
      cl_sp->service_id  = svc_ptr->service_id;
  ...
  {  
    MSG_ERROR_3("qmi_wms_qcsi_svc_connect_cb: Error processing err = %d client_handle %p svc handle %p", 
                    err, client_handle, service_handle);
  }
  else
  {
    MSG_HIGH_2("qmi_wms_qcsi_svc_connect_cb: client connect client_handle %p connection_handle %p",
...
void qmi_wms_process_init_cback(void)
{
  ...
  MSG_HIGH_1("qmi_wms_process_init_cback :%d",qmi_wmsi_global.inited);
...

{
  ...
  MSG_HIGH_0("qmi_wms_init initiated");
  if(wms_get_ulog_handle() != NULL)
  {
    ULOG_RT_PRINTF_0(wms_get_ulog_handle(), "qmi_wms_init initiated()");
  }


  memset(&qmi_wms_state, 0, sizeof(qmi_wms_svc_info_type));
  ...
  //initialize wms_debug_buffer
  wms_debug_buffer_index = 0;
  memset(wms_debug_buffer,0, sizeof(wms_debug_buffer));

  qmi_wmsi_global.inited = FALSE;
  qmi_wmsi_global.wms_cid = WMSI_INVALID_CLIENT_ID;
  ...
  /* initialize QMI WMS task state */
   qmi_wms_process_init_cback();

   qmi_wms_state.svc_config                   = (void *)&qmi_wmsi_cfg;
   qmi_wms_state.service_id                   = QMI_WMS_SERVICE;


  err = qmi_wms_svc_qcsi_register(QMI_WMS_SERVICE,
                                  qmi_wms_qcsi_svc_connect_cb,
                                  qmi_wms_qcsi_svc_disconnect_cb,
                                  qmi_wms_qcsi_svc_handle_raw_req_cb,
                                  &qmi_wms_state);
  if (QMI_CSI_NO_ERR != err)
  {
    MSG_ERROR_1("qmi_wms_init() qmi_wms_svc_qcsi_register failed %d", err);
  }

  else
  {
    MSG_HIGH_0("QMI_WMS registers with QCSI");
     if(wms_get_ulog_handle() != NULL)
    {
       ULOG_RT_PRINTF_0(wms_get_ulog_handle(), "QMI_WMS registers with QCSI");
    }
  }

  src = qmi_sap_register(wms_get_service_object_v01(), 
                         NULL, 
                         &qmi_wms_state.sap_client_handle);

  if ( src != QMI_SAP_NO_ERR || err != QMI_CSI_NO_ERR )
  {
    MSG_HIGH_2("qmi_wms_init() qmi_csi_register/sap_register failed %d", err, src);
    return;
  }
...
)
{
  ...
  if (cl_sp)
  {
    ...
    err = qmi_wms_qcsi_send_ind_raw(cl_sp->clnt, (unsigned int)cmd_type, ind);
...
)
{
  ...
  {
    MSG_ERROR_2("invalid command (%d) or error (%d)", cmd, cmd_err);
    return;
  }

  MSG_HIGH_1 ("qmi_wms_cmd_status_cb, cmd:%d",cmd);
...
)
{
  ...
  qmi_wms_qcsi_transaction_type            *cmd_buf_p               = NULL;
  qmi_error_e_type             errval                  = QMI_ERR_NONE;
  ...
  MSG_HIGH_1("Process WMS %d cmd callback.", cmd);
  ...
  {
    cmd_buf_p = (qmi_wms_qcsi_transaction_type *) cmd_status_ptr->user_data;
    if (NULL == cmd_buf_p)
    {
  ...
  else
  {
    ...
    if (!qmi_wmsi_send_response(cmd_buf_p, response))
    {
...
clean_up:
  ...
  {
    qmi_wms_svc_free_pending_transaction( &qmi_wms_state, &cmd_buf_p );
...
)
{
  ...
  {
    MSG_ERROR_1("Invalid event (%d)", event);
    return;
  }
...
#else
        qmi_wms_process_msg_evt(msg_evt_ptr);
	    if(msg_evt_ptr != NULL)
        {
          qmi_wms_free_cmd_buf(msg_evt_ptr);
        }
        else
        {
          MSG_HIGH_0("msg_evt_ptr is NULL");
        }
#endif
      }
      else
...
)
{
  ...
  qmi_wms_svc_info_type         *wms_sp                = NULL;
  qmi_wms_qcsi_transaction_type *cmd_buf_p             = NULL;
  qmi_error_e_type             errval                = QMI_ERR_NONE;
  qmi_result_e_type            result;
  qmi_wms_cmd_node_type       *cmd_node              = NULL;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  switch (msg_evt_ptr->event)
  {
    ...
    case WMS_MSG_EVENT_SEND:
      ...
      MSG_HIGH_0("Ignoring send event until WMS_MSG_EVENT_SUBMIT_REPORT received");
      return;
    ...
    -------------------------------------------------------------------------*/
    case WMS_MSG_EVENT_WRITE:
      cmd_buf_p = (qmi_wms_qcsi_transaction_type *) event_info->status_info.user_data;
      if (qmi_wmsi_get_wms_sp_by_cmd_buf(cmd_buf_p))
      {
    ...
    case WMS_MSG_EVENT_READ:
      ...
      if ( qmi_wmsi_get_wms_sp_by_cmd_buf(cmd_buf_p))
      {
        if (WMSI_CMD_VAL_MODIFY_TAG == cmd_buf_p->msg_id)
        {
          cmd_node = qmi_wmsi_get_pending_cmd_buf((q_compare_func_type)qmi_wmsi_compare_cmd_buf,
                                                  cmd_buf_p, FALSE);
          if (cmd_node)
    ...
    -------------------------------------------------------------------------*/
    case WMS_MSG_EVENT_SUBMIT_REPORT:
      MSG_HIGH_2( "WMS_MSG_EVENT_SUBMIT_REPORT received for client (%d) for message mode (%d)",
                  event_info->submit_report_info.client_id,
                  event_info->submit_report_info.message_mode );
    ...
    case WMS_MSG_EVENT_READ_TEMPLATE:
      ...
      if (qmi_wmsi_get_wms_sp_by_cmd_buf(cmd_buf_p))
      {
        if (WMSI_CMD_VAL_GET_SMSC_ADDR == cmd_buf_p->msg_id)
        {
        ...
        else if (WMSI_CMD_VAL_GET_SMS_PARAMETERS == cmd_buf_p->msg_id)
        {
    ...
    default:
      MSG_HIGH_0("Unknown message event found");
      goto clean_up;
  }

  if ((NULL == cmd_buf_p) || (NULL ==  qmi_wmsi_get_wms_sp_by_cmd_buf(cmd_buf_p)))
  {
...
)
{
  ...
  switch (event)
  {
    ...
    default:
      MSG_HIGH_0("Unexpected event received in qmi_wms_cfg_cb");
  }
  ...
  switch (cfg_evt_ptr->event)
  {
    ...
    case WMS_CFG_EVENT_MS_GWL_DOMAIN_PREF:
...

      {
        ...
        if (WMSI_CMD_VAL_GET_DOMAIN_PREF_CONFIG == cmd_buf_p->msg_id)
        {
#ifdef  FEATURE_WMS_UNUSED_QMI_API_ENABLE
    ...
    case WMS_CFG_EVENT_MS_SERV_AVAIL:
      {
        uint8 sub;
        sub = qmi_wms_get_subscription_from_asid(event_info->svc_avail.as_id);

        MSG_HIGH_3( "Availability = %d, as_id = %d, sys_type = %d",
                    event_info->svc_avail.is_serv_avail,
                    sub,
                    event_info->svc_avail.sys_type );
      }
      return;
    ...
    case WMS_CFG_EVENT_MS_SERV_NOT_AVAIL:
      {
        uint8 sub;
        sub = qmi_wms_get_subscription_from_asid(event_info->svc_not_avail.as_id);

        MSG_HIGH_3( "Availability = %d, as_id = %d, sys_type = %d",
                    event_info->svc_not_avail.is_serv_avail,
                    sub,
                    event_info->svc_not_avail.sys_type );
      }
      return;
...
)
{
  ...
  case WMS_BC_MM_EVENT_SCPT_DELETE_ALL_SRVS:
    ...
    default:
      MSG_HIGH_0("Unknown BC MM event found");
      goto clean_up;
  }
...
)
{
  ...
  switch (event)
  {
    ...
    default:
      MSG_HIGH_0("Unexpected event received in qmi_wms_dbg_evt_cb");
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  switch (dbg_evt_ptr->event)
  {
    ...
    default:
      MSG_HIGH_0("Unknown dbg event found");
      goto clean_up;
  }
...
===========================================================================*/
boolean qmi_wmsi_validate_cmd_buf_p( 
  qmi_wms_qcsi_transaction_type *cmd_buf_p 
)
{
  int                  cl_idx;
  int                  cmd_idx;
  qmi_wms_svc_info_type *svc_state_ptr;
...
)
{
  ...
  if ( cmd_buf_p == NULL )
  {
    MSG_ERROR_0("cmd_buf_p is NULL");
    return FALSE;
  }

  /* Send the response */
  err = qmi_wms_qcsi_send_resp_raw(&qmi_wms_state, cmd_buf_p, msg_ptr);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  -------------------------------------------------------------------------*/
    ...
    cmd_node_ptr = (qmi_wms_cmd_node_type *)q_linear_search(&qmi_wmsi_global.cmd_pend_q,
                                                            (q_compare_func_type)qmi_wms_qcsi_compare_client_handle,
                                                            cl_sp);
    } while (cmd_node_ptr);
...
/*===========================================================================
  ...
  SIDE EFFECTS
    None
===========================================================================*/
void* qmi_wmsi_get_wms_sp_by_cmd_buf(
  void * cmd_buf_p_in
)
{
  qmi_wms_qcsi_transaction_type *cmd_buf_p = NULL;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  cmd_buf_p = (qmi_wms_qcsi_transaction_type *)cmd_buf_p_in;
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      ...
      (WMS_MSG_EVENT_STATUS_REPORT == event))
  {
    ...
    if ( (WMS_MSG_EVENT_RECEIVED_MESSAGE == event) &&
         (WMS_MESSAGE_MODE_GW == event_info_ptr->mt_message_info.message.msg_hdr.message_mode) &&
         wmsi_event_ptr->sms_on_ims)
    {
      wmsi_event_ptr->verstat_status = event_info_ptr->mt_message_info.verstat_status;
    }
    else
    {
       wmsi_event_ptr->verstat_status = WMS_VERSTAT_STATUS_VALIDATION_MAX;
    }
  ...
  -------------------------------------------------------------------------*/
   ...
   cl_sp = (qmi_wmsi_client_state_type *)q_check(&(qmi_wms_state.client_q));
    

    while (NULL != cl_sp) 
        
    {
        if((cl_sp->subscription_status.subscription_type == subscription))
        {
        ...
        /* Report the regular MT SMS to registered clients */
         ...
         cl_sp = q_next(&(qmi_wms_state.client_q), &(cl_sp->link));
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      ...
      (WMS_CLIENT_TYPE_QMI != event_info_ptr->submit_report_info.client_id))
  {
    ...
    MSG_HIGH_2( "MO control status = %d, alpha ID length = %d",
                wmsi_event_ptr->mo_ctrl_status,
                wmsi_event_ptr->alpha_id_len );
  ...
  else
  {
    ...
    if (set_event_report_req_pdu->report_mt_message_valid)
    {
      switch (set_event_report_req_pdu->report_mt_message)
      {
        ...
        default:
          MSG_ERROR_0("Invalid report_mt_message value");
          errval = QMI_ERR_INVALID_ARG;
      }
    }
    ...
    if (set_event_report_req_pdu->report_call_control_info_valid)
    {
      switch (set_event_report_req_pdu->report_call_control_info)
      {
        ...
        default:
          MSG_ERROR_0("Invalid report_call_control_info value");
          errval = QMI_ERR_INVALID_ARG;
      }
    }
    ...
    if (set_event_report_req_pdu->report_mwi_message_valid)
    {
      switch (set_event_report_req_pdu->report_mwi_message)
      {
        ...
        default:
          MSG_ERROR_0("Invalid report_mwi_message value");
          errval = QMI_ERR_INVALID_ARG;
      }
    }
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((event_info_ptr->mask & WMSI_REPORT_STATUS_EV_MT_MSG))
  {
    if (FALSE == event_info_ptr->is_etws)
    {
      if (WMS_ROUTE_STORE_AND_NOTIFY == event_info_ptr->route)
      {
        ...
        {
          MSG_HIGH_0("Invalid value for the message mode");
          QMI_WMSI_MEM_FREEIF(ind_pdu);
          return;
        }
        ...
        {
          MSG_HIGH_0("Invalid storage type");
          QMI_WMSI_MEM_FREEIF(ind_pdu);
          return;
        }
        ...
        {
          MSG_HIGH_1("Index value cannot be greater than %d", WMSI_MESSAGE_LIST_MAX);
          QMI_WMSI_MEM_FREEIF(ind_pdu);
          return;
        }
      }
               ...
               (WMS_ROUTE_TRANSFER_AND_ACK == event_info_ptr->route))
      {
        ...
        {
          MSG_HIGH_0("Invalid message format");
          QMI_WMSI_MEM_FREEIF(ind_pdu);
          return;
        }
      ...
      if (event_info_ptr->verstat_status != WMS_VERSTAT_STATUS_VALIDATION_MAX)
      {
         ind_pdu->verstat_status_info_valid = TRUE;
         ind_pdu->verstat_status_info       = (mt_ims_verstat_enum_v02)qmi_wmsi_from_wms_verstat_status(event_info_ptr->verstat_status);
      }
    }
    else /* ETWS */
    {
      ...
      {
        MSG_HIGH_0("Invalid type for notification");
        QMI_WMSI_MEM_FREEIF(ind_pdu);
        return;
      }
  ...
  if (event_info_ptr->mask & WMSI_REPORT_STATUS_EV_SUBMIT_RPT)
  {
    ...
    {
      MSG_HIGH_1("Invalid type %d for MO Control type", ind_pdu->call_control_info.mo_control_type);
      QMI_WMSI_MEM_FREEIF(ind_pdu);
      return;
    }

    MSG_HIGH_1("Length (%d) of alpha_id is %d", event_info_ptr->alpha_id_len);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (WMSI_CMD_VAL_ASYNC_RAW_SEND == (uint16_t)cmd_buf_p->msg_id)
  {
    async_send = TRUE;
    ...
    if (QMI_ERR_NONE != errval)
    {
      MSG_ERROR_0("IDL decoding failed");
      goto send_result;
    }
  }
  ...
  if (raw_send_req_pdu->force_on_dc_valid)
  {
    ...
    {
      MSG_HIGH_0("Force on DC TLV can only be used for CDMA");
  ...
  if (raw_send_req_pdu->follow_on_dc_valid)
  {
    if (WMSI_MSG_FORMAT_GW_PP == (qmi_wmsi_message_format_e_type)raw_send_req_pdu->raw_message_data.format)
    {
      MSG_HIGH_0("Follow on DC TLV can only be used for CDMA");
      errval = QMI_ERR_OP_DEVICE_UNSUPPORTED;
      goto send_result;
    }
    else
  ...
  if (raw_send_req_pdu->link_timer_valid)
  {
    ...
    {
      MSG_HIGH_1("Link timer %d exceeds maximum of 5 seconds", raw_send_req_pdu->link_timer);
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }
    ...
    {
      MSG_HIGH_0("Link Control TLV can only be used for GW");
      errval = QMI_ERR_OP_DEVICE_UNSUPPORTED;
      goto send_result;
    }
  }
  ...
  if (raw_send_req_pdu->sms_on_ims_valid)
  {
    ...
    {
      MSG_ERROR_0("Both force_on_dc and sms_on_ims TLV set to 1");
      errval = QMI_ERR_INVALID_ARG;
      goto send_result;
    }
  }
  ...
  if (raw_send_req_pdu->link_enable_mode_valid)
  {
    if (!raw_send_req_pdu->link_timer_valid)
    {
      MSG_ERROR_0("Link Control TLV is needed to enable link control mode");
      errval = QMI_ERR_MISSING_ARG;
      goto send_result;
    }
  ...
  switch ((qmi_wmsi_message_format_e_type)raw_send_req_pdu->raw_message_data.format)
  {
    ...
    case WMSI_MSG_FORMAT_GW_PP:
      ...
      if ((data_ptr[0] & 0x03) == 2)
      {
        client_msg_ptr->u.gw_message.raw_ts_data.tpdu_type = WMS_TPDU_COMMAND;
      }
      else
      {
        client_msg_ptr->u.gw_message.raw_ts_data.tpdu_type = WMS_TPDU_SUBMIT;
      }
      MSG_HIGH_1("sms_command = %d", client_msg_ptr->u.gw_message.raw_ts_data.tpdu_type);
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    if (WMSI_MSG_FORMAT_CDMA == (qmi_wmsi_message_format_e_type)raw_send_req_pdu->raw_message_data.format)
    {
      ...
      if (FALSE == ret_val)
      {
        MSG_HIGH_0( "Unable to update the client channel or service option preference" );
        errval = QMI_ERR_INTERNAL;
        goto send_result;
      }
      ...
      if ( raw_send_req_pdu->follow_on_dc_valid) 
      {
        ...
        if (FALSE == ret_val)
        {
          MSG_HIGH_0("Unable to update the client follow on dc option");
          errval = QMI_ERR_INTERNAL;
          goto send_result;
        }
      }
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    cmd_node->cmd_buf = (qmi_wms_qcsi_transaction_type *) cmd_buf_p;
...
)
{
  ...
  {
    errval = (qmi_error_e_type)wms_ts_decode(&event_info_ptr->status_info.message.u.gw_message.raw_ts_data,
                    wms_ts_data_ptr);
...
)
{
  ...
  {
    qmi_wms_qcsi_transaction_type *cmd_buf_p = cmd_node->cmd_buf;

    if (cmd_buf_p && (WMSI_CMD_VAL_LIST_MESSAGES == cmd_buf_p->msg_id))
    {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  MSG_HIGH_0("wms_cfg_ms_get_routes command");
#ifdef  FEATURE_WMS_UNUSED_ATCOP_API_ENABLE
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != evt_ptr))
  {
    ...
    if (cmd_buf_p && (WMSI_CMD_VAL_GET_ROUTES == cmd_buf_p->msg_id))
    {
  ...
  if (WMS_MESSAGE_MODE_GW == event_info_ptr->status_info.message.msg_hdr.message_mode)
  {
    if (event_info_ptr->status_info.message.u.gw_template.mask & WMS_GW_TEMPLATE_MASK_SC_ADDR)
    {
                                ...
                                (uint8 *) &(get_smsc_resp_pdu->smsc_address.smsc_address_digits_len)))
      {
        ...
        MSG_HIGH_0("qmi_wmsi_addr_to_str failed");
        errval = QMI_ERR_INTERNAL;
      }
      else
      {
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != evt_ptr))
  {
    ...
    if (cmd_buf_p && (WMSI_CMD_VAL_GET_STORE_MAX_SIZE == cmd_buf_p->msg_id))
    {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (WMSI_CMD_VAL_ASYNC_SEND_ACK == cmd_buf_p->msg_id)
  {
    async_send_ack = TRUE;
  }
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    MSG_LOW_1("Pushing pending cmd_node 0x%x for send_ack", cmd_node);
    qmi_wmsi_put_pending_cmd_buf(cmd_node);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    MSG_HIGH_0("Retry period exceeds the maximum allowed value");
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }
...
#endif
#endif
#if !defined (REMOVE_QMI_WMS_SET_DC_DISCONNECT_TIMER_V01) && !defined (FEATURE_WMS_LTE_ONLY)
#ifdef FEATURE_WMS_UNUSED_QMI_API_ENABLE
...
#endif
  if (WMSI_MSG_MODE_GW == cmd_node_ptr->cache.get_bc_config.mode)
  {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  MSG_HIGH_1("Memory full indication for client ID %d", cl_sp->clnt);
  ...
  {
    MSG_ERROR_1("Invalid storage type %d", ind_pdu->memory_full_info.storage_type);
    QMI_WMSI_MEM_FREEIF(ind_pdu);
    return;
  }
  ...
  {
    MSG_ERROR_1("Invalid message mode %d", ind_pdu->memory_full_info.message_mode);
    QMI_WMSI_MEM_FREEIF(ind_pdu);
    return;
  }
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != evt_ptr))
  {
    ...
    if ((cmd_buf_p && (WMSI_CMD_VAL_GET_DOMAIN_PREF == cmd_buf_p->msg_id)) ||
        (cmd_buf_p && (WMSI_CMD_VAL_GET_DOMAIN_PREF_CONFIG == cmd_buf_p->msg_id)))
    {
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    MSG_LOW_1("Pushing pending cmd_node %p for send_from_mem_store", cmd_node);
    qmi_wmsi_put_pending_cmd_buf(cmd_node);
    if (!async_mem_send)
    {
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != evt_ptr))
  {
    ...
    if (cmd_buf_p && (WMSI_CMD_VAL_GET_MESSAGE_WAITING == cmd_buf_p->msg_id))
    {
...
)
{
  ...
  {
    MSG_HIGH_0("wms_cfg_ms_get_message_waiting command");
#ifdef FEATURE_WMS_UNUSED_ATCOP_API_ENABLE
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if (QMI_ERR_NONE == errval)
  {
    ...
    MSG_LOW_1("Pushing pending cmd_node %p for set_primary_client", cmd_node);
    qmi_wmsi_put_pending_cmd_buf(cmd_node);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  MSG_HIGH_1("Transport Layer Info indication for client ID %d", cl_sp->clnt);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  MSG_HIGH_1("Transport NW Reg Info indication for client ID %d", cl_sp->clnt);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((NULL == sp) || (NULL == cmd_buf_p) || (NULL == sdu_in) )
  {
    MSG_ERROR_3( "NULL pointer sp = 0x%x, cmd_buf_p = 0x%x, sdu_in = 0x%x ", sp, cmd_buf_p, sdu_in );
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((NULL == sp) || (NULL == cmd_buf_p) || (NULL == cl_sp) || (NULL == sdu_in))
  {
    MSG_ERROR_0("NULL pointer(s) in qmi_wmsi_get_retry_period");
    errval = QMI_ERR_INTERNAL;
    goto send_result;
  }
...
)
{
  ...
  if (NULL == event_info_ptr)
  {
    MSG_HIGH_0("qmi_wmsi_get_retry_period_resp NULL pointer");
    return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != info_ptr))
  {
    ...
    if (cmd_buf_p && (WMSI_CMD_VAL_GET_RETRY_PERIOD == cmd_buf_p->msg_id))
    {
      ret = (int) TRUE;
    }
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((NULL == sp) || (NULL == cmd_buf_p) || (NULL == cl_sp) || (NULL == sdu_in))
  {
    MSG_ERROR_0("NULL pointer(s) in qmi_wmsi_get_retry_interval");
    errval = QMI_ERR_INTERNAL;
    goto send_result;
  }
...
)
{
  ...
  if (NULL == event_info_ptr)
  {
    MSG_HIGH_0("qmi_wmsi_get_retry_interval_resp NULL pointer");
    return QMI_ERR_INTERNAL;
  }
...
)
{
  ...
  if ((NULL != cmd_node) && (NULL != info_ptr))
  {
    ...
    if (cmd_buf_p && (WMSI_CMD_VAL_GET_RETRY_INTERVAL == cmd_buf_p->msg_id))
    {
      ret = (int) TRUE;
    }
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((NULL == sp) || (NULL == cmd_buf_p) || (NULL == cl_sp) || (NULL == sdu_in))
  {
    MSG_ERROR_0("NULL pointer(s) in qmi_wmsi_get_dc_disconnect_timer()");
    errval = QMI_ERR_INTERNAL;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((NULL == sp) || (NULL == cmd_buf_p) || (NULL == cl_sp) || (NULL == sdu_in))
  {
    MSG_ERROR_0("NULL pointer(s) in qmi_wmsi_get_memory_status()");
    errval = QMI_ERR_INTERNAL;
  }
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  MSG_HIGH_1("Ready indication for client ID %d", cl_sp->clnt);
  ...
  if (notify_sim_status)
  {
    ...
    {
      MSG_HIGH_0("Invalid status type");
      QMI_WMSI_MEM_FREEIF(ind_pdu);
      return;
    }
  }
...
#endif
  if (WMSI_MSG_MODE_GW == evt_ptr->message_mode)
  {
...
#pragma pack (pop) // Revert alignment to what it was previously
  ...
  while (*sdu_in)
  {
    ...
    switch (type)
    {
      ...
      default:
        MSG_HIGH_1("Unrecognized TLV type (%d)", type);
        break;
    }
  ...
  {
    MSG_HIGH_1("Invalid number of instances : %d", v_in_req.num_instances);
    errval = QMI_ERR_INVALID_ARG;
    goto send_result;
  }
  ...
  for (i = 0; i < v_in_req.num_instances; i++)
  {
    ...
    {
       MSG_HIGH_0("Invalid message type");
       errval = QMI_ERR_INVALID_ARG;
       goto send_result;
    }
...
#pragma pack (pop) // Revert alignment to what it was previously
  ...
  MSG_HIGH_1("Transport layer MWI indication for client %d", cl_sp->clnt);
  ...
  for (i = 0; ((i < v_out_req.num_instances) && (i < WMSI_MWI_MAX)) ; i++)
  {
...
{
  qmi_wmsi_verstat_status_e_type status = WMSI_VALIDATION_MAX;

  switch (wms_status)
  {
    case WMS_VERSTAT_STATUS_NO_VALIDATION:
      status = WMSI_NO_VALIDATION;
      break;

    case WMS_VERSTAT_STATUS_VALIDATION_PASS:
      status = WMSI_VALIDATION_PASS;
      break;
   
    case WMS_VERSTAT_STATUS_VALIDATION_FAIL:
      status = WMSI_VALIDATION_FAIL;
      break;
...
)
{
  ...
  switch (as_id)
  {
    ...
    default:
      MSG_ERROR_1("Unable to map as_id to a subscription %d", as_id);
...
)
{
  ...
  switch (qmi_wms_subscription)
  {
    ...
    default:
      MSG_ERROR_1("Unable to map subscription to as_id %d", qmi_wms_subscription);
