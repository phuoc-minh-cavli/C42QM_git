...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/mmcp.mpss/6.1.10/wms/inc_deprecated/wmsi.h#1 $
...
#if 0
  QMI_WMS_CMD_Q_SIGNAL_MERGE                =  0x100000,   /* QMI command Q signal          */
  QMI_WMS_DOG_RPT_TIMER_SIGNAL_MERGE        =  0x200000,   /* Watchdog Report signal        */
  QMI_WMS_SIG_MASK_CHANGE_SIGNAL_MERGE      =  0x400000,   /* Indicates sig mask has changed*/

/*---------------------------------------------------------------------------
  BEWARE: DO NOT CHANGE ENUMERATION VALUE FOR OFFLINE, STOP AND START SIGS.
---------------------------------------------------------------------------*/
// pravin below can be combined with WMS task merge signal
...
---------------------------------------------------------------------------*/
  QMI_WMS_SERVICE_WMS_SIGNAL_MERGE     = 0x800000,  /* WMS service signal */
  QMI_WMS_MAX_SIGNALS_MERGE  
#endif
};
...
#ifdef FEATURE_WMS_UNUSED_FEATURE_WMS_GLOBAL_RETAIN 
...
#else
   wms_ss_stack_info_s_type             stack_info;
#endif
...
#define WMS_SIGNALS ( WMS_CMD_Q_SIG \
                        ...
                        | QMI_WMS_SERVICE_WMS_SIGNAL \
                        | QMI_WMS_SERVICE_WMS_QCSI_SIGNAL)
...
typedef union wms_msgr_cmd_u {
  ...
  wms_policyman_cfg_s_type    policyman_cfg;
   // cehck with ravi once disable loopback
 ds_3gpp_eps_tlb_lb_mode_h_act_ind_type  ds_loop_back_notify;  /* Notification from DS for loop back activatio/deactivation */
} wms_msgr_cmd_u_type;
