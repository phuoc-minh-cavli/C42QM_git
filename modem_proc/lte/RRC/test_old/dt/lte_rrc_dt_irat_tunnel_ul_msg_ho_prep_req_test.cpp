/*!
  @file lte_rrc_dt_tunnel_ul_msg_ho_prep_req_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcDtIratTunnelULMsgHoPrepReqTest);

void LteRrcDtIratTunnelULMsgHoPrepReqTest::Setup()
{
    lte_rrc_utf_setup(LTE_RRC_DT_SM, ext_umid_list, 1);
    lte_rrc_test_dt_init();
}

void LteRrcDtIratTunnelULMsgHoPrepReqTest::Test()
{
    byte *buf_ptr;
    uint32 buf_len;
    ...
    TF_MSG("Sending IRAT Tunnel Handover Prep Tx Req Message to DT ");
    lte_rrc_init_default_hdr(&tunnel_ul_msg_req.msg_hdr, LTE_RRC_IRAT_TUNNEL_UL_MSG_REQ);

    tunnel_ul_msg_req.cnf_is_reqd = true;

    tunnel_ul_msg_req.msg.ul_msg_type = LTE_IRAT_TUNNEL_UL_MSG_UL_HO_PREP_TX_REQ;

    // MEID
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.is_meid_present = TRUE;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.numbits = 56;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[0] = 0x00;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[1] = 0x01;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[2] = 0x02;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[3] = 0x03;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[4] = 0x04;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[5] = 0x05;
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.meid.data[6] = 0x06;

    // 1x
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.type = LTE_IRAT_RAT_TYPE_1XRTT;

    // Container
    tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.msg_container.msg_size = LTE_IRAT_TUNNEL_MAX_MSG_CONTAINER_SIZE;
    memset(tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.msg_container.msg_payload, 'A',
           tunnel_ul_msg_req.msg.ul_msg_u.ul_ho_prep_tx_req.msg_container.msg_size);
    ...
    TF_MSG("Sending Handover Prep Tx CNFI from MH to DT");

    lte_rrc_init_default_hdr(&ul_msg_cnfi.msg_hdr, LTE_RRC_UL_HANDOVER_PREPARATION_TRANSFER_CNFI);
...
void LteRrcDtIratTunnelULMsgHoPrepReqTest::Teardown()
{
