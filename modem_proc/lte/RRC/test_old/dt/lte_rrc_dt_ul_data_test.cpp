/*!
  @file lte_rrc_dt_ul_data_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcDtULDataTest);

void LteRrcDtULDataTest::Setup()
{
    lte_rrc_utf_setup(LTE_RRC_DT_SM, ext_umid_list, 1);
    lte_rrc_test_dt_init();
}

void LteRrcDtULDataTest::Test()
{
    byte *buf_ptr;
    uint32 buf_len;
...
void LteRrcDtULDataTest::Teardown()
{
    lte_rrc_utf_teardown();
    lte_rrc_test_dt_teardown();
}

TF_DEFINE_TEST_CASE(COMPONENT, LteRrcDtULACKInClosingStateTest);

void LteRrcDtULACKInClosingStateTest::Setup()
{
    lte_rrc_utf_setup(LTE_RRC_DT_SM, ext_umid_list, 1);
    lte_rrc_test_dt_init();
}

void LteRrcDtULACKInClosingStateTest::Test()
{
    byte *buf_ptr;
    uint32 buf_len;
    ...
    lte_rrc_test_dt_set_controller_state(LTE_RRC_CONTROLLER_SM__CLOSING);
...
void LteRrcDtULACKInClosingStateTest::Teardown()
{
    lte_rrc_utf_teardown();
    lte_rrc_test_dt_teardown();
}
