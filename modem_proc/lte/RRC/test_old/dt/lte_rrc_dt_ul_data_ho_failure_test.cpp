/*!
  @file lte_rrc_dt_ul_data_ho_failure_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcDtULDataHoFailureTest);

void LteRrcDtULDataHoFailureTest::Setup()
{
    lte_rrc_utf_setup(LTE_RRC_DT_SM, ext_umid_list, 1);
    lte_rrc_test_dt_init();
}

void LteRrcDtULDataHoFailureTest::Test()
{
...
void LteRrcDtULDataHoFailureTest::Teardown()
{
