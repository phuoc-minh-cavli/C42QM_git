...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCreConfigFailureAndCRETest);

void LteRrcCreConfigFailureAndCRETest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRE_SM, ext_umid_list, 1);
  lte_rrc_cre_test_stub_init();
}

void LteRrcCreConfigFailureAndCRETest::Test()
{
...
void LteRrcCreConfigFailureAndCRETest::Teardown()
{
