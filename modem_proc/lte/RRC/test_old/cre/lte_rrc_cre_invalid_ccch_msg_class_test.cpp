/*!
  @file lte_rrc_cre_invalid_ccch_msg_class_test.cpp
...
lte_rrc_cre_invalid_ccch_msg_class_test.cpp#4 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCreInvalidCCCHMsgClassTest);

void LteRrcCreInvalidCCCHMsgClassTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRE_SM, ext_umid_list, 2);
  lte_rrc_cre_test_stub_init();
}

void LteRrcCreInvalidCCCHMsgClassTest::Test()
{
  ...
  TF_MSG("\nCRE Invalid DL CCCH msg class test begins \n");
  ...
  /* Setting the CCCH mesg class to an invalid value */
  dl_ccch_msg_ptr->message.t = 
  ...
  LTE_RRC_OSYS_ASN1_COPY_PDU(dl_ccch_msg_ptr, mod_dl_ccch_msg_ptr, 
							 DL_CCCH_Message);
  ...
  dl_ccch_msg_ptr->message.t = T_lte_rrc_osys_DL_CCCH_MessageType_c1;
  ...
  TF_MSG("\nCRE Invalid DL CCCH msg class test ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcCreInvalidCCCHMsgClassTest::Teardown()
{
