/*!
  @file lte_rrc_cre_invalid_reest_nonrel8_test.cpp

  @brief
  Unit test code for CRE procedure that tests the handling of invalid Reestablishment
  message with non release 8 criticalExtensions.
...
lte_rrc_cre_invalid_reest_nonrel8_test.cpp#4 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCreInvalidReestNonRel8Test);

void LteRrcCreInvalidReestNonRel8Test::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRE_SM, ext_umid_list, 2);
  lte_rrc_cre_test_stub_init(); 
}

void LteRrcCreInvalidReestNonRel8Test::Test()
{
  ...
  TF_MSG("\nInvalid Reestablishment with non release 8 criticalExtensions begins \n");
  ...
  /* Setting the Reestablishment critical extension to a spare value */
  dl_ccch_msg_ptr->message.u.c1->u.rrcConnectionReestablishment->criticalExtensions.
    u.c1->t = T_lte_rrc_osys_RRCConnectionReestablishment_criticalExtensions_c1_spare7;
  ...
  dl_ccch_msg_ptr->message.u.c1->u.rrcConnectionReestablishment->criticalExtensions.
    u.c1->t = T_lte_rrc_osys_RRCConnectionReestablishment_criticalExtensions_c1_rrcConnectionReestablishment_r8;
  ...
  TF_MSG("\nCRE Invalid Reestablishment with non release 8 criticalExtensions test ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcCreInvalidReestNonRel8Test::Teardown()
{
