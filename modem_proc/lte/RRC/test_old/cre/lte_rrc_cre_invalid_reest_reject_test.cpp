/*!
  @file lte_rrc_cre_invalid_reest_reject_test.cpp

  @brief
  Unit test code for CRE procedure that tests the handling of invalid reestablishment
  reject message.
...
lte_rrc_cre_invalid_reest_reject_test.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCreInvalidReestRejectTest);

void LteRrcCreInvalidReestRejectTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRE_SM, ext_umid_list, 2);
  lte_rrc_cre_test_stub_init();
}

void LteRrcCreInvalidReestRejectTest::Test()
{
  ...
  TF_MSG("\nCRE Invalid Reestablishment Reject test begins \n");
  ...
  dl_ccch_msg_ptr->message.u.c1->t = 
    T_lte_rrc_osys_DL_CCCH_MessageType_c1_rrcConnectionReestablishmentReject;
  /* Setting Reestablishment reject to an invalid value */
  dl_ccch_msg_ptr->message.u.c1->u.rrcConnectionReestablishmentReject->criticalExtensions.t 
    = T_lte_rrc_osys_RRCConnectionReestablishmentReject_criticalExtensions_criticalExtensionsFuture;
  ...
  TF_MSG("\nCRE Invalid Reestablishment Reject test ends \n");
  lte_rrc_utf_reset(); 

  /* ---------------------------------------------------------------------- */
}

void LteRrcCreInvalidReestRejectTest::Teardown()
{
