/*!
  @file lte_rrc_cre_invalid_reest_crit_ext_test.cpp

  @brief
  Unit test code for CRE procedure that tests the handling of Reestablishment
  message with invalid Critical Extension.
...
lte_rrc_cre_invalid_reest_crit_ext_test.cpp#4 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCreInvalidReestCritExtTest);

void LteRrcCreInvalidReestCritExtTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRE_SM, ext_umid_list, 2);
  lte_rrc_cre_test_stub_init();
}

void LteRrcCreInvalidReestCritExtTest::Test()
{
  ...
  TF_MSG("\nInvalid Reestablishment Critical Extension begins \n");
  ...
  /* Setting the Reestablishment critical extension to an invalid value */
  dl_ccch_msg_ptr->message.u.c1->u.rrcConnectionReestablishment->criticalExtensions.t = 
    T_lte_rrc_osys_RRCConnectionReestablishment_criticalExtensions_criticalExtensionsFuture;
  ...
  dl_ccch_msg_ptr->message.u.c1->u.rrcConnectionReestablishment->criticalExtensions.t = 
    T_lte_rrc_osys_RRCConnectionReestablishment_criticalExtensions_c1;
  ...
  TF_MSG("\nCRE Invalid Reestablishment Critical Extension test ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcCreInvalidReestCritExtTest::Teardown()
{
