/*!
  @file lte_rrc_config_from_lte_to_g_cco_not_supported_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Mobility from EUTRA message that contains CCO to G when the feature
  is not supported.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigFromLteToGCCONotSupportedTest);

void LteRrcConfigFromLteToGCCONotSupportedTest::Setup()
{
...
void LteRrcConfigFromLteToGCCONotSupportedTest::Test()
{
  ...
  TF_MSG("\nCCO from EUTRA to G not supported Test Begins \n");
  ...
  TF_MSG("\nCCO from EUTRA to G not supported Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigFromLteToGCCONotSupportedTest::Teardown()
{
