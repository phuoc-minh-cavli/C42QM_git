/*!
  @file lte_rrc_config_ho_with_delta_config_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Reconfig message containing HO related information with delta configuration.
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_config_ho_delta_config_test_get_eps_info
...
*/
/*=========================================================================*/
void lte_rrc_config_ho_delta_config_test_get_eps_info
(
  lte_rrc_active_eps_bearer_update_ind_s *eps_list_msg_ptr  /*!< list of EPS bearer IDs */
)
{
  eps_list_msg_ptr->num_active_bearers = 0;
} /* lte_rrc_config_ho_delta_config_test_get_eps_info() */
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigHOWithDeltaConfigTest);

void LteRrcConfigHOWithDeltaConfigTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONFIG_SM, ext_umid_list, 3);
  lte_rrc_config_test_stub_init();
  TF_STUB(lte_rrc_llc_get_epsbearer_info) = lte_rrc_config_ho_delta_config_test_get_eps_info;
}

void LteRrcConfigHOWithDeltaConfigTest::Test()
{
  ...
  encoded_pdu.length = sizeof(reconfig_with_ho_delta_config_msg);
  encoded_pdu.value = reconfig_with_ho_delta_config_msg;
  ...
  TF_ASSERT(mac_access_req_msg_ptr->access_info.raid == LTE_INVALID_RA_ID);
  ...
  TF_ASSERT(eps_list_msg_ptr->num_active_bearers == 0);
  ...
  TF_ASSERT(ho_completed_ind_msg_ptr->dl_freq == 10689);
  TF_ASSERT(ho_completed_ind_msg_ptr->dl_bandwidth == 15);
...
void LteRrcConfigHOWithDeltaConfigTest::Teardown()
{
