/*!
  @file lte_rrc_config_from_lte_to_spare4_mobility_not_supported_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Mobility from EUTRA message that contains HO to spare4 i.e. an IE not comprehended.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigFromLteToSpare4MobilityNotSupportedTest);

void LteRrcConfigFromLteToSpare4MobilityNotSupportedTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONFIG_SM, NULL, 0);
  lte_rrc_config_test_stub_init();
}

void LteRrcConfigFromLteToSpare4MobilityNotSupportedTest::Test()
{
  ...
  encoded_pdu.length = sizeof(mobility_from_eutra_to_spare4);
  encoded_pdu.value = mobility_from_eutra_to_spare4;

  TF_MSG("\nMobility from EUTRA to Spare4 not supported Test Begins \n");
  ...
  TF_MSG("\nMobility from EUTRA to Spare4 not supported Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigFromLteToSpare4MobilityNotSupportedTest::Teardown()
{
