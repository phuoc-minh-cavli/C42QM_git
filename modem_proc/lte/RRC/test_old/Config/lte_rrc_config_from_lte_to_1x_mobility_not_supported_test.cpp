/*!
  @file lte_rrc_config_from_lte_to_1xcsfb_mobility_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Mobility from EUTRA message that contains HO to 1x for CSFB when the feature
  is not supported.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigFromLteTo1xMobilityNotSupportedTest);

void LteRrcConfigFromLteTo1xMobilityNotSupportedTest::Setup()
{
...
void LteRrcConfigFromLteTo1xMobilityNotSupportedTest::Test()
{
  ...
  TF_MSG("\nMobility from EUTRA to 1x for CSFB not supported Test Begins \n");
  ...
  TF_MSG("\nMobility from EUTRA to 1x for CSFB not supported Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigFromLteTo1xMobilityNotSupportedTest::Teardown()
{
