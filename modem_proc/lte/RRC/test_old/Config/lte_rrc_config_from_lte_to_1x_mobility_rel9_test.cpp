/*!
  @file lte_rrc_config_from_lte_to_1x_mobility_rel9_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Mobility from EUTRA to 1x message for Rel9.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigFromLteTo1xMobilityRel9Test);

void LteRrcConfigFromLteTo1xMobilityRel9Test::Setup()
{
...
void LteRrcConfigFromLteTo1xMobilityRel9Test::Test()
{
  ...
  encoded_pdu.length = sizeof(mobility_from_eutra_to_1x_rel9);
  encoded_pdu.value = mobility_from_eutra_to_1x_rel9;
  lte_rrc_config_test_encoded_pdu = encoded_pdu;

  TF_MSG("\nMobility from EUTRA to 1x for Rel 9 Test Begins \n");
  ...
  TF_MSG("\nMobility from EUTRA to 1x for Rel 9 Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigFromLteTo1xMobilityRel9Test::Teardown()
{
