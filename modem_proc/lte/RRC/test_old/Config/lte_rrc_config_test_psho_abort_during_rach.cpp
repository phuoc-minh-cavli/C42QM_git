...
/*!
  @file lte_rrc_config_psho_abort_during_rach.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  PSHO Abort during RACH.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigPSHOAbortDuringRACHTest);

void LteRrcConfigPSHOAbortDuringRACHTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONFIG_SM, ext_umid_list, 3);
  lte_rrc_config_test_stub_init();
}

void LteRrcConfigPSHOAbortDuringRACHTest::Test()
{
  ...
  TF_MSG("\nConfig: PSHO Abort during RACH Test Begins \n");
  ...
  TF_MSG("\nConfig: PSHO Abort during RACH Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigPSHOAbortDuringRACHTest::Teardown()
{
