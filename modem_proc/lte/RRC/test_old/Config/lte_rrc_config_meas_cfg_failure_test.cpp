/*!
  @file lte_rrc_config_meas_cfg_failure_test.cpp

  @brief
  Unit test code for the Config procedure that tests the processing of 
  a Reconfig message containing Measurement Configuration alone and the 
  Measurement Configuration fails validation.
...
extern "C"
{
  TF_PROTO_STUB(lte_errno_e, lte_rrc_meas_validate_connected_config, 
                lte_rrc_osys_RRCConnectionReconfiguration *, boolean);
}
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_config_meas_cfg_failure_test_validate_meas
...
*/
/*=========================================================================*/
lte_errno_e lte_rrc_config_meas_cfg_failure_test_validate_meas
(
...
} /* lte_rrc_config_meas_cfg_failure_test_validate_meas() */
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcConfigMeasCfgFailureTest);

void LteRrcConfigMeasCfgFailureTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONFIG_SM, NULL, 0);
  lte_rrc_config_test_stub_init();
  TF_STUB(lte_rrc_meas_validate_connected_config) = 
    lte_rrc_config_meas_cfg_failure_test_validate_meas;
}

void LteRrcConfigMeasCfgFailureTest::Test()
{
  ...
  TF_MSG("\nConfig Request Test III - Meas Config Failure Test Begins \n");
  ...
  TF_ASSERT(lte_rrc_config_get_state() == LTE_RRC_CONFIG_SM__INITIAL);  
  TF_MSG("\nConfig Request Test III - Meas Config Failure Test Ends \n");
  lte_rrc_utf_reset(); 
...
void LteRrcConfigMeasCfgFailureTest::Teardown()
{
