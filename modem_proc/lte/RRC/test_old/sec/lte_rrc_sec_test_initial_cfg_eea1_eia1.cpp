...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_initial_cfg_eea1_eia1.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecInitialSecurityConfigTest1);

static uint32 ext_umid_list[20];


void LteRrcSecInitialSecurityConfigTest1::Setup()
{
  uint8 ext_count = 0;
...
void LteRrcSecInitialSecurityConfigTest1::Test()
{
  ...
  /*Set the flush security context to FALSE*/
...
void LteRrcSecInitialSecurityConfigTest1::Teardown()
{
