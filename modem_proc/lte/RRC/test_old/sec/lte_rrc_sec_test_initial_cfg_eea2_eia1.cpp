...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_initial_cfg_eea2_eia1.cpp#1 $
...
DECLARE_LTE_RRC_SEC_SMC_EEA2_EIA1;
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecInitialSecurityConfigEIA1EEA2Test1);

static uint32 ext_umid_list[20];


void LteRrcSecInitialSecurityConfigEIA1EEA2Test1::Setup()
{
  uint8 ext_count = 0;
...
void LteRrcSecInitialSecurityConfigEIA1EEA2Test1::Test()
{
  ...
  */
  ...
  /*Set the flush NAS security context to FALSE*/
  ...
  lte_rrc_sec_test_encoded_pdu.value = sec_smc1_eea2_eia1;
  lte_rrc_sec_test_encoded_pdu.length = sizeof(sec_smc1_eea2_eia1);

  smc_dlm.dl_msg_ptr = (lte_rrc_osys_DL_DCCH_Message *)lte_rrc_osys_asn1_decode_pdu(sec_smc1_eea2_eia1, sizeof(sec_smc1_eea2_eia1),
                               DL_DCCH_Message,
                               &decode_status); 
  ...
  */
  /*
  with bearer = 1
  smc_dlm.mac_i[0] = 0xc1;
  smc_dlm.mac_i[1] = 0xf0;
  smc_dlm.mac_i[2] = 0xe4;
  smc_dlm.mac_i[3] = 0x85;
  */
  /*With bearer = 0*/
  smc_dlm.mac_i[0] = 0x13;
  smc_dlm.mac_i[1] = 0x12;
  smc_dlm.mac_i[2] = 0x09;
  smc_dlm.mac_i[3] = 0xd6;
...
void LteRrcSecInitialSecurityConfigEIA1EEA2Test1::Teardown()
{
