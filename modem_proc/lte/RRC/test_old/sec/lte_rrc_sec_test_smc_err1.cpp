...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_smc_err1.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecSmcErrTest1);

static uint32 ext_umid_list[20];


void LteRrcSecSmcErrTest1::Setup()
{
  uint8 ext_count = 1;
...
void LteRrcSecSmcErrTest1::Test()
{
...
void LteRrcSecSmcErrTest1::Teardown()
{
