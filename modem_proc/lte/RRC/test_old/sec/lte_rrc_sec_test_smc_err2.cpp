...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_smc_err2.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecSmcErrTest2);

static uint32 ext_umid_list[20];


void LteRrcSecSmcErrTest2::Setup()
{
  uint8 ext_count = 1;
...
void LteRrcSecSmcErrTest2::Test()
{
  ...
  */
  ...
  #if 0
  ((lte_rrc_osys_DL_DCCH_Message *)smc_dlm.dl_msg_ptr)->message.u.c1->u.securityModeCommand->criticalExtensions.u.c1->u.
    securityModeCommand_r8->securityConfigSMC.securityAlgorithmConfig.integrityProtAlgorithm =
      lte_rrc_osys_SecurityAlgorithmConfig_integrityProtAlgorithm_spare2;
  #endif

  /*Send erroneous SecurityModeCommand*/
  ((lte_rrc_osys_DL_DCCH_Message *)smc_dlm.dl_msg_ptr)->message.u.c1->u.securityModeCommand->criticalExtensions.u.c1->u.
    securityModeCommand_r8->m.nonCriticalExtensionPresent = 1; 
...
void LteRrcSecSmcErrTest2::Teardown()
{
