...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_smc_maci_fail.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecSmcMACIFailTest1);

static uint32 ext_umid_list[20];
/*
extern static byte sec_smc1_eea1_eia1[];
extern static byte sec_smc1_eea2_eia2[];
extern static byte sec_smc_1[];
*/

void LteRrcSecSmcMACIFailTest1::Setup()
{
  uint8 ext_count = 1;
...
void LteRrcSecSmcMACIFailTest1::Test()
{
...
void LteRrcSecSmcMACIFailTest1::Teardown()
{
