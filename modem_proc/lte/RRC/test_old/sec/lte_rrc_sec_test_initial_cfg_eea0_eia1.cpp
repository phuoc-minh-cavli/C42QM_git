...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_initial_cfg_eea0_eia1.cpp#1 $
...
DECLARE_LTE_RRC_SEC_SMC_EEA0_EIA1;
/*===========================================================================
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecInitialSecurityConfigEEA0EIA1Test1);

static uint32 ext_umid_list[20];


void LteRrcSecInitialSecurityConfigEEA0EIA1Test1::Setup()
{
  uint8 ext_count = 0;
...
void LteRrcSecInitialSecurityConfigEEA0EIA1Test1::Test()
{
...
void LteRrcSecInitialSecurityConfigEEA0EIA1Test1::Teardown()
{
