...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_initial_cfg_eea2_eia2.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecInitialSecurityConfigEIA2EEA2Test1);

static uint32 ext_umid_list[20];


void LteRrcSecInitialSecurityConfigEIA2EEA2Test1::Setup()
{
  uint8 ext_count = 0;
...
void LteRrcSecInitialSecurityConfigEIA2EEA2Test1::Test()
{
  ...
  */
  ...
  /*Set the flush NAS context to FALSE*/
...
void LteRrcSecInitialSecurityConfigEIA2EEA2Test1::Teardown()
{
