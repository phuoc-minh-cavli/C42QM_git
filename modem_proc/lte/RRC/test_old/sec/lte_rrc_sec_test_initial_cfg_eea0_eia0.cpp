...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sec/lte_rrc_sec_test_initial_cfg_eea0_eia0.cpp#1 $
...
DECLARE_LTE_RRC_SEC_SMC_EEA0_EIA0_920;
/*===========================================================================
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSecInitialSecurityConfigEEA0EIA0Test1);

static uint32 ext_umid_list[20];


void LteRrcSecInitialSecurityConfigEEA0EIA0Test1::Setup()
{
  uint8 ext_count = 0;
...
void LteRrcSecInitialSecurityConfigEEA0EIA0Test1::Test()
{
  ...
  */
  ...
  /*Set Flush NAS security context to FALSE*/
  ...
  #if 0
  lte_rrc_sec_test_encoded_pdu.value = sec_smc1_eea0_eia1;
  lte_rrc_sec_test_encoded_pdu.length = sizeof(sec_smc1_eea0_eia1);
  #endif
  lte_rrc_sec_test_encoded_pdu.value = sec_smc1_eea0_eia0_920;
  lte_rrc_sec_test_encoded_pdu.length = sizeof(sec_smc1_eea0_eia0_920);

  #if 0
  smc_dlm.dl_msg_ptr = (lte_rrc_osys_DL_DCCH_Message *)lte_rrc_osys_asn1_decode_pdu(sec_smc1_eea0_eia1, sizeof(sec_smc1_eea0_eia1),
                               DL_DCCH_Message,
   							   &decode_status);
  #endif
smc_dlm.dl_msg_ptr = (lte_rrc_osys_DL_DCCH_Message *)lte_rrc_osys_asn1_decode_pdu(sec_smc1_eea0_eia0_920, sizeof(sec_smc1_eea0_eia0_920),
                               DL_DCCH_Message,
   							   &decode_status);
  ...
  /*
   If BEARER = 1
  smc_dlm.mac_i[0] = 0xaa;
  smc_dlm.mac_i[1] = 0xbb;
  smc_dlm.mac_i[2] = 0x74;
  smc_dlm.mac_i[3] = 0xa0;
  */
  /*If BEARER = 0*/
  #if 0
  smc_dlm.mac_i[0] = 0xd2;
  smc_dlm.mac_i[1] = 0x62;
  smc_dlm.mac_i[2] = 0x6c;
  smc_dlm.mac_i[3] = 0x75; 
  #endif 
  smc_dlm.mac_i[0] = 0x0;
  smc_dlm.mac_i[1] = 0x0;
  smc_dlm.mac_i[2] = 0x0;
...
/*Expect a Config Req from CEP*/
  ...
  *(cfg_req_ptr->trans_id_ptr)= 3;
  ...
  TF_ASSERT(LTE_INTEGRITY_ALGO_NONE == pdcp_sec_cfg.srb_integrity_algo);
 ...
 *((uint8 *)(ulm_ptr->encode_status)) = 0; 
 ...
 TF_ASSERT(0 == sec_mode_complete_ptr->rrc_TransactionIdentifier);
...
void LteRrcSecInitialSecurityConfigEEA0EIA0Test1::Teardown()
{
