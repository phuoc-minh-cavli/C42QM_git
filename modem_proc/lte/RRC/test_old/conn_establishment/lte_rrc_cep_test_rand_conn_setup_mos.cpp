...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_rand_conn_setup_mos.cpp#1 $
...
//TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPRandConnSetupTest2);
TF_DEFINE_TEST_CASE(xyz, LteRrcCEPRandConnSetupTest2);

void LteRrcCEPRandConnSetupTest2::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPRandConnSetupTest2::Test()
{
...
void LteRrcCEPRandConnSetupTest2::Teardown()
{
