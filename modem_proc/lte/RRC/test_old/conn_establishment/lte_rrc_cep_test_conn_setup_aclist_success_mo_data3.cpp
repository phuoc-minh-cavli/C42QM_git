/*!
  @file lte_rrc_cep_test_conn_setup_aclist_success.cpp


  @brief
  Unit test code for CEP Access Barring success... with AC list value .
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_aclist_success_mo_data3.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListSuccessMODataTest3);

void LteRrcCEPAccessListSuccessMODataTest3::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListSuccessMODataTest3::Test()
{
 ...
 // struct lte_rrc_AccessClassBarringList_ *ac_list_ptr = NULL;
  ...
  access_class_mask = ((1 << LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS) |
                       (1 << LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS_12) |
                       (1 << LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS_15));
...
/*
  ...
  for(i=11;i<15;i++)
  {
    ...
    if((1<<i)&((1 << LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS_12)|(1 <<LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS_15)))
    {
      ac_list_ptr->value.accessClassBarring = FALSE;
...
//  #if 0
  ...
  *(ulm_ptr->encode_status) = 0; 
  ...
  conn_setup_complete_ptr = (ul_dcch_msg_ptr->message).u.c1->u.rrcConnectionSetupComplete;
   ...
   r8_ie_ptr = conn_setup_complete_ptr->criticalExtensions.u.c1->
...
void LteRrcCEPAccessListSuccessMODataTest3::Teardown()
{
