...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnSetupTest1);

void LteRrcCEPConnSetupTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPConnSetupTest1::Test()
{
...
void LteRrcCEPConnSetupTest1::Teardown()
{
