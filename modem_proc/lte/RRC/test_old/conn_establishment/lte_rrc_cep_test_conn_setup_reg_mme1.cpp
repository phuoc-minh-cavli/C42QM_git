...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_reg_mme1.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnSetupTest2);

void LteRrcCEPConnSetupTest2::Setup()
{
  int ext_count = 0;
  ...
  lte_rrc_utf_setup(LTE_RRC_CEP_SM, 
                    ...
                    ext_count);
  lte_rrc_test_cep_init();
  TF_STUB(lte_rrc_get_3gpp_release_version) = lte_rrc_cep_test_get_3gpp_rel_version_for_rel10;
}

void LteRrcCEPConnSetupTest2::Test()
{
  ...
  /*egistered MME present*/
  conn_est_req.registered_mme_is_present= TRUE;
  conn_est_req.is_high_priority = FALSE;
  conn_est_req.registered_mme.mmec = 0x0;
  conn_est_req.registered_mme.mmegi = 0x0;
  conn_est_req.registered_mme.plmn_identity_is_present = TRUE;
  conn_est_req.registered_mme.plmn_identity.mcc[0] = 0x0;
  conn_est_req.registered_mme.plmn_identity.mcc[1] = 0x1;
  conn_est_req.registered_mme.plmn_identity.mcc[2] = 0x2;

  conn_est_req.registered_mme.plmn_identity.num_mnc_digits = 3;
  conn_est_req.registered_mme.plmn_identity.mnc[0] = 0x0;
  conn_est_req.registered_mme.plmn_identity.mnc[1] = 0x1;
  conn_est_req.registered_mme.plmn_identity.mnc[2] = 0x2;

  conn_est_req.registered_mme.gummei_type = LTE_RRC_GUMMEI_TYPE_MAPPED;
  ...
  *(ulm_ptr->encode_status) = 0; 
  ...
  conn_setup_complete_ptr = (ul_dcch_msg_ptr->message).u.c1->u.rrcConnectionSetupComplete;
   ...
   if(FALSE == conn_est_req.registered_mme_is_present)
   {
	 ...
	 TF_ASSERT((1 == r8_ie_ptr->nonCriticalExtension.nonCriticalExtension.m.gummei_Type_r10Present) &&
			   (lte_rrc_osys_RRCConnectionSetupComplete_v1020_IEs_gummei_Type_r10_mapped ==
			   r8_ie_ptr->nonCriticalExtension.nonCriticalExtension.gummei_Type_r10));
...
void LteRrcCEPConnSetupTest2::Teardown()
{
