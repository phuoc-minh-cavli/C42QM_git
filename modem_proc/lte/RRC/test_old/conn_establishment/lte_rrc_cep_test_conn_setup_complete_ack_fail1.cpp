...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_complete_ack_fail1.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnSetupCompleteAckFailTest1);

void LteRrcCEPConnSetupCompleteAckFailTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPConnSetupCompleteAckFailTest1::Test()
{
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  /*We will not be sending TA info and selected PLMN if the Tx was a failure*/  
  /*
...
void LteRrcCEPConnSetupCompleteAckFailTest1::Teardown()
{
