/*!
  @file lte_rrc_cep_test_t300_expiry.cpp
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_t300_expiry.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT300ExpiryTest1);

void LteRrcCEPT300ExpiryTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPT300ExpiryTest1::Test()
{
  ...
  remaining_retries = LTE_RRC_CEP_DEFAULT_MAX_TRIES;
...
void LteRrcCEPT300ExpiryTest1::Teardown()
{
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT300ExpiryTest2);

void LteRrcCEPT300ExpiryTest2::Setup()
{
  int ext_count = 0;
  //TF_STUB(lte_rrc_controller_get_state) = lte_rrc_test_cep_stub_controller_get_state;
  //lte_rrc_test_cep_init();
...
void LteRrcCEPT300ExpiryTest2::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
  ...
  sib2->accessBarringInformation.accessBarringForOriginatingCalls.accessBarringTime = 
    ...
    */
  /*Setting the T300 timer value to 400 ms*/
  sib2->ue_TimersAndConstants.t300 = lte_rrc_osys_UE_TimersAndConstants_t300_ms1000;
...
void LteRrcCEPT300ExpiryTest2::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT300ExpiryTest3);

void LteRrcCEPT300ExpiryTest3::Setup()
{
  int ext_count = 0;
  //TF_STUB(lte_rrc_controller_get_state) = lte_rrc_test_cep_stub_controller_get_state;
  //lte_rrc_test_cep_init();
...
void LteRrcCEPT300ExpiryTest3::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
void LteRrcCEPT300ExpiryTest3::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT300ExpiryTest4);

void LteRrcCEPT300ExpiryTest4::Setup()
{
  int ext_count = 0;
  int result;
  uint8 t300_rf_unavail_thresh = 20;

  qtf_efs_initialize("LteRrcCEPT300ExpiryTest4");
...
void LteRrcCEPT300ExpiryTest4::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
void LteRrcCEPT300ExpiryTest4::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT300ExpiryTest5);

void LteRrcCEPT300ExpiryTest5::Setup()
{
  int ext_count = 0;
  int result;
  uint8 t300_rf_unavail_thresh = 120;
...
void LteRrcCEPT300ExpiryTest5::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
void LteRrcCEPT300ExpiryTest5::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}

TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPDeadlockExpiryTest1);

void LteRrcCEPDeadlockExpiryTest1::Setup()
{
  int ext_count = 0;
  //TF_STUB(lte_rrc_controller_get_state) = lte_rrc_test_cep_stub_controller_get_state;
  //lte_rrc_test_cep_init();
...
void LteRrcCEPDeadlockExpiryTest1::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
//  #if 0
  ...
  */
    ...
    TF_ASSERT(stm_get_state(LTE_RRC_CEP_SM) == LTE_RRC_CEP_SM__ACCESS);
		...
		/* Sleep for 1 sec and make sure deadlock timer expires */
		TF_SLEEP(1000);
		lte_rrc_utf_get_next_ext_msg (&buf_ptr, &buf_len);
		    cphy_debug_data_ptr = 
...
void LteRrcCEPDeadlockExpiryTest1::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
