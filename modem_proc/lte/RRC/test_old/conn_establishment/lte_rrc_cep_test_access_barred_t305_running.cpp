/*!
  @file lte_rrc_cep_test_access_barred_t305.cpp


  @brief
  Unit test code for AccessBarringCheckfailure while T305 expiry within CEP.
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_access_barred_t305_running.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT305RunningBarredTest1);

void LteRrcCEPT305RunningBarredTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPT305RunningBarredTest1::Test()
{
  ...
  *(value_ptr) = (0x0 >>(LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS -11))&(0xff);
  ...
  /*Sleep for the remaining time indicated by T305*/
  TF_SLEEP(5);
...
void LteRrcCEPT305RunningBarredTest1::Teardown()
{ 
