/*!
  @file lte_rrc_cep_test_conn_reject.cpp
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_resel_indi_stopped.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPReselIndiStoppedTest1);

void LteRrcCEPReselIndiStoppedTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPReselIndiStoppedTest1::Test()
{
...
//  #if 0
  ...
  TF_MSG("Before sending the Stopped INDI : Verifying that the CEP SM is in ACCESS state");
  ...
  /*Expect ProceedWithResel Indication*/
  lte_rrc_utf_get_next_int_msg (&buf_ptr, &buf_len);
  ...
  TF_MSG("Sending the Stopped Indi");
  lte_rrc_init_default_hdr(&stopped_indi.msg_hdr, 
  ...
  */
  ...
  TF_ASSERT(LTE_RRC_CONN_EST_FAILURE == 
...
void LteRrcCEPReselIndiStoppedTest1::Teardown()
{
