...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_emergency_success.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnSetupACListEmergencySuccessTest1);

void LteRrcCEPConnSetupACListEmergencySuccessTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPConnSetupACListEmergencySuccessTest1::Test()
{
...
void LteRrcCEPConnSetupACListEmergencySuccessTest1::Teardown()
{
