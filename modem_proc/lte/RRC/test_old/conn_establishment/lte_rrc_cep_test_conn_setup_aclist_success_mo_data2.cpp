...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_aclist_success_mo_data2.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListSuccessMODataTest2);

void LteRrcCEPAccessListSuccessMODataTest2::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListSuccessMODataTest2::Test()
{
...
void LteRrcCEPAccessListSuccessMODataTest2::Teardown()
{
