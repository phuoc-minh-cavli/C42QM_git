...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_access_conc_reselection_sib2_update.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessReselectionSibUpdateTest1);
/*!@todo: Fix this test with the reseelction stuff*/
//TF_DEFINE_TEST_CASE(XYZ, LteRrcCEPAccessReselectionTest1);

void LteRrcCEPAccessReselectionSibUpdateTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessReselectionSibUpdateTest1::Test()
{
...
void LteRrcCEPAccessReselectionSibUpdateTest1::Teardown()
{
