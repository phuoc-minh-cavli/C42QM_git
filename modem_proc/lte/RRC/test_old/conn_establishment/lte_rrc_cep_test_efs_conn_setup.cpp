/*!
  @file lte_rrc_cep_test_efs_conn_setup.cpp


  @brief
  Unit test code for CEP Connnection Setup .Read EFS for # of CEP tries
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_efs_conn_setup.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPEfsConnSetupTest1);

void LteRrcCEPEfsConnSetupTest1::Setup()
{
  int ext_count = 0;
  int result;
  uint8 num_cep_tries = 1;

  qtf_efs_initialize("LteRrcCEPEfsConnSetupTest1");
...
void LteRrcCEPEfsConnSetupTest1::Test()
{
...
void LteRrcCEPEfsConnSetupTest1::Teardown()
{
  qtf_efs_save_tree("C:\\temp_efs");
