/*!
  @file lte_rrc_cep_test_conn_release.cpp


  @brief
  Unit test code for testing the actions of CEP SM on receiving ConnRel 
  indication in Connected state
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_release.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnReleaseTest1);

void LteRrcCEPConnReleaseTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPConnReleaseTest1::Test()
{
...
void LteRrcCEPConnReleaseTest1::Teardown()
{
