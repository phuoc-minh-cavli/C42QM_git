...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_aclist_success_mo_data.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListSuccessMODataTest1);

void LteRrcCEPAccessListSuccessMODataTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListSuccessMODataTest1::Test()
{
...
void LteRrcCEPAccessListSuccessMODataTest1::Teardown()
{
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListSuccessMODataTest_2);

void LteRrcCEPAccessListSuccessMODataTest_2::Setup()
{
  int ext_count = 0;
  int result;
...
void LteRrcCEPAccessListSuccessMODataTest_2::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
  //lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
  lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
  ...
  access_class_barring_info = &(sib2->ac_BarringInfo.ac_BarringForMO_Data);
  access_class_barring_info->ac_BarringFactor = 
    lte_rrc_osys_AC_BarringConfig_ac_BarringFactor_p75;
  access_class_barring_info->ac_BarringTime = 
    lte_rrc_osys_AC_BarringConfig_ac_BarringTime_s4;
 ...
 /*Fill in the appropriate bit mask*/
  *(value_ptr) = (0x1F >>(LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS -11))&(0xff);
...
void LteRrcCEPAccessListSuccessMODataTest_2::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
