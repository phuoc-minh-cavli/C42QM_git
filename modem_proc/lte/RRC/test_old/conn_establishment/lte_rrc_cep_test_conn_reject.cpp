...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_reject.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPConnRejectTest1);

void LteRrcCEPConnRejectTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPConnRejectTest1::Test()
{
...
void LteRrcCEPConnRejectTest1::Teardown()
{
