/*!
  @file lte_rrc_cep_test_conn_setup_aclist_failure_mo_signaling.cpp


  @brief
  Unit test code for Access Barring failure during CEP Connnection Setup for 
  AccessList Mismatch
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_aclist_failure_mo_signaling.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListFailureMOSignalingTest1);

void LteRrcCEPAccessListFailureMOSignalingTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListFailureMOSignalingTest1::Test()
{
  ...
  //#endif
  /*Set the Est cause to MO_SIGNALING*/
  ...
  access_class_barring_info = &(sib2->ac_BarringInfo.ac_BarringForMO_Signalling);
...
*/
 ...
 /*Sleep for the Access Barring time as given by T305*/
...
void LteRrcCEPAccessListFailureMOSignalingTest1::Teardown()
{
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring);

void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
   //lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
   lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring_CSFB);

void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring_CSFB::Setup()
{
  int ext_count = 0;   
...
void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring_CSFB::Test()
{
  lte_rrc_conn_est_cnf_s        *conn_est_cnf_ptr = NULL;
   //lte_rrc_conn_establishment_failure_indi_s *conn_est_failure_indi_ptr = NULL;
   lte_rrc_conn_establishment_started_indi_s *conn_est_started_indi_ptr = NULL;
...
void LteRrcCEPAccessListFailureMOSignalingTest_for_internal_AC_Barring_CSFB::Teardown()
{
  lte_rrc_test_cep_teardown();
  lte_rrc_utf_teardown();
}
