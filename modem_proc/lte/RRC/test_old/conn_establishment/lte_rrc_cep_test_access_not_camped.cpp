/*!
  @file lte_rrc_cep_test_access_not_camped.cpp
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_access_not_camped.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessNotCampedTest1);

void LteRrcCEPAccessNotCampedTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessNotCampedTest1::Test()
{
...
/*Expect a AccessAbortReq from CEP*/
 ...
 /*Expect a MACCancelConnReq from CEP*/
  ...
  TF_ASSERT(LTE_RRC_CONN_EST_FAILURE_NOT_CAMPED == conn_est_cnf_ptr->est_status); 
...
void LteRrcCEPAccessNotCampedTest1::Teardown()
{
