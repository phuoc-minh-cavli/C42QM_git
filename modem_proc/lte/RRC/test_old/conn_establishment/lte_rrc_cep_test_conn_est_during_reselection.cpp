...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_est_during_reselection.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessReselectionTest3);
/*!@todo: Fix this test with the reseelction stuff*/
//TF_DEFINE_TEST_CASE(XYZ, LteRrcCEPAccessReselectionTest1);

void LteRrcCEPAccessReselectionTest3::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessReselectionTest3::Test()
{
  ...
  lte_rrc_test_cep_set_resel_flag(TRUE);
...
#endif
  lte_rrc_test_cep_set_resel_flag(FALSE);
 ...
 // {
      ...
      TF_MSG("Waiting for ConnEstStartedIndi");
...
void LteRrcCEPAccessReselectionTest3::Teardown()
{
