/*!
  ...
  @brief
  Unit test code for CEP Access Barring success for MO Signaling... with AC list value .
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_conn_setup_aclist_success_mo_signaling.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessListSuccessMOSignalingTest1);

void LteRrcCEPAccessListSuccessMOSignalingTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessListSuccessMOSignalingTest1::Test()
{
...
void LteRrcCEPAccessListSuccessMOSignalingTest1::Teardown()
{
