...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_csrb1_t300_expiry.cpp#1 $
...
//TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPCsrb1T300ExpiryTest1);
// This test is not relevant at this point... 'cos T300 tmr is stopped on CSRB1 
// entry
TF_DEFINE_TEST_CASE(xyz, LteRrcCEPCsrb1T300ExpiryTest1);

void LteRrcCEPCsrb1T300ExpiryTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPCsrb1T300ExpiryTest1::Test()
{
...
//  #if 0
  ...
  num_max_retries = LTE_RRC_CEP_DEFAULT_MAX_TRIES;
...
void LteRrcCEPCsrb1T300ExpiryTest1::Teardown()
{
