/*!
  ...
  @brief
  Unit test code for AccessBarringCheck/T303 expiry within CEP.
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_t303_expiry.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT303ExpiryTest1);

void LteRrcCEPT303ExpiryTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPT303ExpiryTest1::Test()
{
...
void LteRrcCEPT303ExpiryTest1::Teardown()
{
