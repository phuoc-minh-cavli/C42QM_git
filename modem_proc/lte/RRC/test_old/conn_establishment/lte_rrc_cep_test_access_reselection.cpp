...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_access_reselection.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPAccessReselectionTest1);
/*!@todo: Fix this test with the reseelction stuff*/
//TF_DEFINE_TEST_CASE(XYZ, LteRrcCEPAccessReselectionTest1);

void LteRrcCEPAccessReselectionTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPAccessReselectionTest1::Test()
{
...
void LteRrcCEPAccessReselectionTest1::Teardown()
{
