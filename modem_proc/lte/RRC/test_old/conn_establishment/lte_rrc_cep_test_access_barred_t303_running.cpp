/*!
  @file lte_rrc_cep_test_t303_expiry.cpp


  @brief
  Unit test code for AccessBarringCheckfailure while T303 expiry within CEP.
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/conn_establishment/lte_rrc_cep_test_access_barred_t303_running.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCEPT303RunningBarredTest1);

void LteRrcCEPT303RunningBarredTest1::Setup()
{
  int ext_count = 0;
...
void LteRrcCEPT303RunningBarredTest1::Test()
{
  ...
  *(value_ptr) = (0x0 >>(LTE_RRC_CEP_TEST_USIM_ACCESS_CLASS -11))&(0xff);
  ...
  /*Sleep for the remaining time indicated by T303*/
  TF_SLEEP(5);
  /*Expect T303 tmri*/
...
void LteRrcCEPT303RunningBarredTest1::Teardown()
{
