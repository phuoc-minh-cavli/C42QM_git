/*!
  @file lte_rrc_sib_mand_sibs_test5.cpp

  @brief
  SIB collection over multiple modification periods - value tag changes at 
  boundary
*/
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sib/lte_rrc_sib_mand_sibs_test5.cpp#1 $
...
spans multiple modification periods, VALUE TAG CHANGES

===========================================================================*/
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSibMandSibsTest5);

void LteRrcSibMandSibsTest5::Setup()
{
  uint32 umid_list[] = 
    { 
...
void LteRrcSibMandSibsTest5::Test()
{
  ...
  TF_ASSERT(dsm_pushdown(&dsm_ptr_sib1, sib1_valueTagChange_mcc_8_5, sizeof(sib1_valueTagChange_mcc_8_5), DSM_DS_SMALL_ITEM_POOL) == sizeof(sib1_valueTagChange_mcc_8_5));
  ...
  TF_ASSERT(event_ptr->all_si.sibs_bitmask == (LTE_RRC_SIB2_BITMASK | LTE_RRC_SIB3_BITMASK));
  ...
  /* Already received - should be ignored */
...
void LteRrcSibMandSibsTest5::Teardown()
{
