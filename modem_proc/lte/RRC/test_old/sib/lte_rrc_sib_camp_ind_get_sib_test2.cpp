/*!
  @file lte_rrc_sib_camp_ind_get_sib_test2.cpp

  @brief
  Basic cell selection test: Camped ind received after mandatory SIBs have been 
  received, but before all SIBs have been read
*/
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sib/lte_rrc_sib_camp_ind_get_sib_test2.cpp#1 $
...
===========================================================================*/
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSibCampIndGetSibTest2);

void LteRrcSibCampIndGetSibTest2::Setup()
{
  uint32 umid_list[] = 
    { 
...
void LteRrcSibCampIndGetSibTest2::Test()
{
...
void LteRrcSibCampIndGetSibTest2::Teardown()
{
