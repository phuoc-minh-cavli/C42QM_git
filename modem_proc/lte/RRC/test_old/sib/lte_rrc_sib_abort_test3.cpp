/*!
  @file lte_rrc_sib_abort_test3.cpp

  @brief
  sib_abort_req received after all SIBs have been received but before camped 
  ind is received for the cell
*/
...
$Header: //components/rel/lte.mpss/4.7.2/RRC/test_old/sib/lte_rrc_sib_abort_test3.cpp#1 $
...
===========================================================================*/
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSibAbortTest3);

void LteRrcSibAbortTest3::Setup()
{
  uint32 umid_list[] = 
    { 
...
void LteRrcSibAbortTest3::Test()
{
  ...
  //The following will make CSP return a valid serving cell, but camped_ind has 
  // not been received yet so the cell wont be treated as serving cell
 ...
 lte_rrc_sib_test_sib_db_key = 0;
  ...
  dl_data_ind_sib4_sib5.sfn.sys_fn = 5;
...
void LteRrcSibAbortTest3::Teardown()
{
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcSibAbortTest3WithDSDS);

void LteRrcSibAbortTest3WithDSDS::Setup()
{
  uint32 umid_list[] = 
    { 
      LTE_CPHY_SIB_SCHED_REQ
...
void LteRrcSibAbortTest3WithDSDS::Test()
{
  lte_rrc_get_sibs_reqi_s get_sibs_req;
...
lte_rrc_sib_test_rf_status_sfn = 45;
...
lte_rrc_sib_test_rf_status_sfn = 48;
...
TF_SLEEP(100);
TF_MSG("Sending RF_AVAILABLE_IND");
lte_rrc_sib_test_rf_status_sfn = 50;
lte_rrc_sib_test_rf_status = LTE_RRC_RF_AVAILABLE;
lte_rrc_sib_test_send_rf_avail_ind();
lte_rrc_utf_wait_for_done();
...
TF_ASSERT(lte_rrc_sib_test_wt_tmr_after_rf_available == lte_rrc_sib_test_wt_tmr_before_rf_unavailable);
 ...
 lte_rrc_sib_test_sib_db_key = 0;
  ...
  lte_rrc_sib_test_wt_tmr_before_rf_unavailable = lte_rrc_tmr_get_remaining(&lte_rrc_sib.dd_ptr->events_db.event[0].wt_tmr);
TF_MSG("Sending RF_UNAVAILABLE_IND");
lte_rrc_sib_test_rf_status_sfn = 51;
lte_rrc_sib_test_rf_status = LTE_RRC_RF_UNAVAILABLE;
lte_rrc_sib_test_send_rf_unavail_ind();
...
TF_ASSERT(lte_rrc_sib_test_wt_tmr_after_rf_available == lte_rrc_sib_test_wt_tmr_before_rf_unavailable);
  ...
  lte_rrc_sib_test_wt_tmr_before_rf_unavailable = lte_rrc_tmr_get_remaining(&lte_rrc_sib.dd_ptr->events_db.event[0].wt_tmr);
  TF_MSG("Sending RF_UNAVAILABLE_IND");
  lte_rrc_sib_test_rf_status_sfn = 56;
  lte_rrc_sib_test_rf_status = LTE_RRC_RF_UNAVAILABLE;
  lte_rrc_sib_test_send_rf_unavail_ind();
  ...
  TF_ASSERT(lte_rrc_sib_test_wt_tmr_after_rf_available == 0); 
  // ----------------------------------------------------------------------
...
void LteRrcSibAbortTest3WithDSDS::Teardown()
{
  lte_rrc_utf_teardown();
}
