/*!
  @file lte_rrc_llc_invalid_drbsetup_no_pdcp_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidDRBSetupNoPDCPTest);

void LteRrcLlcInvalidDRBSetupNoPDCPTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, NULL, 0);
  lte_rrc_llc_test_stub_init();
}

void LteRrcLlcInvalidDRBSetupNoPDCPTest::Test()
{
  lte_rrc_pdu_buf_s encoded_pdu;
  /* ---------------------------------------------------------------------- */
  TF_MSG("\nInvalid Reconfig for DRB Setup without PDCP Config Test Begins \n");

  /* Setting the encoded message to the byte string in lte_rrc_llc_ota_msg.h */
  encoded_pdu.length = sizeof(llc_invalid_drb_no_pdcp_msg);
  encoded_pdu.value = llc_invalid_drb_no_pdcp_msg;
  ...
  TF_MSG("\nInvalid Reconfig for DRB Setup without PDCP Config Test Ends \n");
...
void LteRrcLlcInvalidDRBSetupNoPDCPTest::Teardown()
{
