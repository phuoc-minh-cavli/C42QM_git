/*!
  @file lte_rrc_llc_conn_setup_reconfig_phy_test.cpp
  ...
  parameters in PhysicalConfigDedicated IE(only those IEs that go to the physical layer).
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcConnSetupReconfigPhyTest);

void LteRrcLlcConnSetupReconfigPhyTest::Setup()
{
...
void LteRrcLlcConnSetupReconfigPhyTest::Test()
{
...
void LteRrcLlcConnSetupReconfigPhyTest::Teardown()
{
