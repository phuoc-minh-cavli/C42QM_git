/*!
  @file lte_rrc_llc_invalid_drbsetup_no_rlc_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidDRBSetupNoRLCTest);

void LteRrcLlcInvalidDRBSetupNoRLCTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, NULL, 0);
  lte_rrc_llc_test_stub_init();
}

void LteRrcLlcInvalidDRBSetupNoRLCTest::Test()
{
  ...
  encoded_pdu.length = sizeof(llc_invalid_drb_no_rlc_msg);
  encoded_pdu.value = llc_invalid_drb_no_rlc_msg;
...
void LteRrcLlcInvalidDRBSetupNoRLCTest::Teardown()
{
