/*!
  @file lte_rrc_llc_ignore_bw_band_validation_from_efs_test.cpp

  @brief
  Unit test code for the LLC procedure that tests the BW and Band validation
  being ignored based on BS_BW_Supported EFS
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_efs_item_write_for_bs_bw_supported

===========================================================================*/
/*!
    @brief
    This writes to BS_BW_Supported EFS
...
*/
/*=========================================================================*/
void lte_rrc_llc_test_efs_item_write_for_bs_bw_supported
(
  void
)
{
  ...
  lte_l1_bs_bw_supported_s  lte_rrc_bs_bw_supported;
  lte_rrc_bs_bw_supported.num_bands = 1;
  lte_rrc_bs_bw_supported.band[0] = 16;
  lte_rrc_bs_bw_supported.bw_supported[0] = 32;

  oflag = O_RDWR | O_AUTODIR | O_TRUNC;
  mode = ACCESSPERMS;
  TF_ASSERT(efs_put("/nv/item_files/modem/lte/ML1/bs_bw_supported", 
                    &lte_rrc_bs_bw_supported, sizeof(lte_rrc_bs_bw_supported), oflag, mode) >= 0);

} /*lte_rrc_llc_test_efs_item_write_for_bs_bw_supported*/
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcIgnoreBwBandValidationTest);

void LteRrcLlcIgnoreBwBandValidationTest::Setup()
{
  lte_rrc_llc_test_efs_item_write_for_bs_bw_supported();
...
void LteRrcLlcIgnoreBwBandValidationTest::Test()
{
...
void LteRrcLlcIgnoreBwBandValidationTest::Teardown()
{
