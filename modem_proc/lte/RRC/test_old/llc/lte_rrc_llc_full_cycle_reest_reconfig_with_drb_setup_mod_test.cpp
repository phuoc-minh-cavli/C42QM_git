/*!
  @file lte_rrc_llc_full_cycle_reest_reconfig_with_drb_setup_mod_test.cpp
  ...
  Reconfiguration message following Reestablishment contains DRBs to setup and
  modifies the PDCP config of an existing DRB.
*/
...
lte_rrc_llc_full_cycle_reest_reconfig_with_drb_setup_mod_test.cpp#1 $
...
boolean reconfig_with_drb_setup_after_cre = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_reconfig_with_drb_setup_after_cre
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_reconfig_with_drb_setup_after_cre
(
  void
)
{
  if (reconfig_with_drb_setup_after_cre)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcFullCycleReestReconfigWithDRBSetupModTest);

void LteRrcLlcFullCycleReestReconfigWithDRBSetupModTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_reconfig_with_drb_setup_after_cre;
}

void LteRrcLlcFullCycleReestReconfigWithDRBSetupModTest::Test()
{
  ...
  reconfig_with_drb_setup_after_cre = TRUE;
  lte_rrc_llc_test_reconfig_drb3_setup_drb4_drb5_um_bi();
  lte_rrc_utf_reset(); 

}

void LteRrcLlcFullCycleReestReconfigWithDRBSetupModTest::Teardown()
{
