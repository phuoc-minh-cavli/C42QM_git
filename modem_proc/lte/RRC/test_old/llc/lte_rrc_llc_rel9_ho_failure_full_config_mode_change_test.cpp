...
lte_rrc_llc_rel9_ho_failure_full_config_mode_change_test.cpp#1 $
...
boolean mode_change_reconfig_after_cre = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_full_config_mode_change_reconfig_after_cre
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_full_config_mode_change_reconfig_after_cre
(
  void
)
{
  if (mode_change_reconfig_after_cre)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcRel9HOFullConfigFailureModeChangeTest);

void LteRrcLlcRel9HOFullConfigFailureModeChangeTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_full_config_mode_change_reconfig_after_cre;
  TF_STUB(lte_rrc_config_ho_in_progress) = lte_rrc_llc_test_get_ho_in_progress;
}

void LteRrcLlcRel9HOFullConfigFailureModeChangeTest::Test()
{   
  ...
  mode_change_reconfig_after_cre = TRUE;
  lte_rrc_llc_test_rel9_reconfig_after_cre_full_config(FALSE);
  lte_rrc_utf_reset(); 

}

void LteRrcLlcRel9HOFullConfigFailureModeChangeTest::Teardown()
{
