/*!
  @file lte_rrc_llc_ho_full_config_test.cpp
  ...
  addition and release. To start receives a Connection Setup followed by Connection 
...
lte_rrc_llc_ho_full_config_test.cpp#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/30/08   mm     Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHOFullConfigTest);

void LteRrcLlcHOFullConfigTest::Setup()
{
...
void LteRrcLlcHOFullConfigTest::Test()
{
...
void LteRrcLlcHOFullConfigTest::Teardown()
{
