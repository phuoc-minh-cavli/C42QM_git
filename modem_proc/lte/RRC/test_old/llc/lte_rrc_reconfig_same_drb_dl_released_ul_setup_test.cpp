/*!
  @file lte_rrc_llc_reconfig_same_drb_dl_released_ul_setup_test.cpp
  ...
  a UM DL DRB. This is followed by a Reconfiguration message that, in one go,
  releases the DRB setup previously, and sets up the same DRB as a UM UL RB.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcReconfigSameDRBDLReleasedULSetupTest);

void LteRrcLlcReconfigSameDRBDLReleasedULSetupTest::Setup()
{
...
void LteRrcLlcReconfigSameDRBDLReleasedULSetupTest::Test()
{
...
void LteRrcLlcReconfigSameDRBDLReleasedULSetupTest::Teardown()
{
