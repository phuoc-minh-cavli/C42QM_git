/*!
  @file lte_rrc_llc_invalid_conn_setup_crit_ext_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidConnSetupCritTest);

void LteRrcLlcInvalidConnSetupCritTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, NULL, 0);
  lte_rrc_llc_test_stub_init();
}

void LteRrcLlcInvalidConnSetupCritTest::Test()
{
  lte_rrc_pdu_buf_s encoded_pdu;
  /* ---------------------------------------------------------------------- */
  TF_MSG("\nInvalid Connection Setup Critical Extension Test Begins \n");

  /* Setting the encoded message to the byte string in lte_rrc_llc_ota_msg.h */   
  encoded_pdu.length = sizeof(llc_invalid_conn_setup_crit_ext);
  encoded_pdu.value = llc_invalid_conn_setup_crit_ext;
  ...
  TF_MSG("\nInvalid Connection Setup Critical Extension Test Ends \n");
...
void LteRrcLlcInvalidConnSetupCritTest::Teardown()
{
