/*!
  @file lte_rrc_llc_invalid_ho_with_pdcp_modify_test.cpp

  @brief
  Unit test code for the LLC procedure that tests the processing of a reconfig 
  message with mobility that tries to change the PDCP configuration of a UM RB 
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidHOWithPDCPModifyTest);

void LteRrcLlcInvalidHOWithPDCPModifyTest::Setup()
{
...
void LteRrcLlcInvalidHOWithPDCPModifyTest::Test()
{
  lte_rrc_pdu_buf_s encoded_pdu;
  /* ---------------------------------------------------------------------- */
  TF_MSG("\nInvalid HO with PDCP modify Test Begins \n");
  ...
  TF_MSG("\nInvalid HO with PDCP modify  Test Ends \n");
...
void LteRrcLlcInvalidHOWithPDCPModifyTest::Teardown()
{
