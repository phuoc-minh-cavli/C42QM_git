/*!
  @file lte_rrc_llc_invalid_conn_setup_both_srbs_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidConnSetupBothSRBsTest);

void LteRrcLlcInvalidConnSetupBothSRBsTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, NULL, 0);
  lte_rrc_llc_test_stub_init();
}

void LteRrcLlcInvalidConnSetupBothSRBsTest::Test()
{
  lte_rrc_pdu_buf_s encoded_pdu;
  /* ---------------------------------------------------------------------- */
  TF_MSG("\nInvalid Connection Setup with both SRBs Test Begins \n");
  ...
  TF_MSG("\nInvalid Connection Setup with both SRBs Test Ends \n");
...
void LteRrcLlcInvalidConnSetupBothSRBsTest::Teardown()
{
