/*!
  ...
  @brief
  Unit test code for the LLC procedure that tests the processing of Rel 9 HO 
  with full configuration option.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcRel9HOFullConfigTest);

void LteRrcLlcRel9HOFullConfigTest::Setup()
{
...
void LteRrcLlcRel9HOFullConfigTest::Test()
{
...
void LteRrcLlcRel9HOFullConfigTest::Teardown()
{
