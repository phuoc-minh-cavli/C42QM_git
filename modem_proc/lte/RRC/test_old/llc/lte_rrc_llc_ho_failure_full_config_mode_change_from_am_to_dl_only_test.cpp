...
boolean mode_change_ul_reconfig_after_cre_for_am_to_dl = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_full_config_mode_change_reconfig_after_cre_for_AM_to_DL
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_full_config_mode_change_ul_reconfig_after_cre_for_AM_to_DL
(
  void
)
{
  if (mode_change_ul_reconfig_after_cre_for_am_to_dl)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHOFullConfigFailureModeChangeFromAmToDLOnlyTest);

void LteRrcLlcHOFullConfigFailureModeChangeFromAmToDLOnlyTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_full_config_mode_change_ul_reconfig_after_cre_for_AM_to_DL;
  TF_STUB(lte_rrc_config_ho_in_progress) = lte_rrc_llc_test_get_ho_in_progress;
}

void LteRrcLlcHOFullConfigFailureModeChangeFromAmToDLOnlyTest::Test()
{   
  ...
  mode_change_ul_reconfig_after_cre_for_am_to_dl = TRUE;
  lte_rrc_llc_test_rel9_reconfig_after_cre_full_config(FALSE);
  lte_rrc_utf_reset(); 

}

void LteRrcLlcHOFullConfigFailureModeChangeFromAmToDLOnlyTest::Teardown()
{
