/*!
  @file lte_rrc_llc_conn_setup_reconfig_drb3_ul_um_test.cpp
...
lte_rrc_llc_conn_setup_reconfig_drb3_ul_um_test.cpp#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/05/08   mm     Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcConnSetupReconfigDRB3ULUMTest);

void LteRrcLlcConnSetupReconfigDRB3ULUMTest::Setup()
{
...
void LteRrcLlcConnSetupReconfigDRB3ULUMTest::Test()
{
...
void LteRrcLlcConnSetupReconfigDRB3ULUMTest::Teardown()
{
