/*!
  @file lte_rrc_llc_full_cycle_reest_reconfig_with_rb_cfg_test.cpp
  ...
  Reconfiguration message following Reestablishment contains RB configuration.
  All suspended RBs need to be resumed, however.
*/
...
lte_rrc_llc_full_cycle_reest_reconfig_with_rb_cfg_test.cpp#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/01/09   mm     Initial Revision
...
boolean first_reconfig_after_cre = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_is_first_reconfig_after_cre
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_is_first_reconfig_after_cre
(
  void
)
{
  if (first_reconfig_after_cre)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcFullCycleReestReconfigWithRBCfgTest);

void LteRrcLlcFullCycleReestReconfigWithRBCfgTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_is_first_reconfig_after_cre;
}

void LteRrcLlcFullCycleReestReconfigWithRBCfgTest::Test()
{
  ...
  first_reconfig_after_cre = TRUE;
  lte_rrc_llc_test_reconfig_srb1_srb2_drb3();
  lte_rrc_utf_reset(); 

}

void LteRrcLlcFullCycleReestReconfigWithRBCfgTest::Teardown()
{
