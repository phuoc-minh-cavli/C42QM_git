/*!
  @file lte_rrc_llc_ho_delta_config_test.cpp
  ...
  information with delta configuration. To start UE receives a Connection Setup 
...
lte_rrc_llc_ho_delta_config_test.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHODeltaConfigTest);

void LteRrcLlcHODeltaConfigTest::Setup()
{
...
void LteRrcLlcHODeltaConfigTest::Test()
{
...
void LteRrcLlcHODeltaConfigTest::Teardown()
{
