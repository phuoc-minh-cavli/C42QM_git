/*!
  @file lte_rrc_llc_rel9_reconfig_after_cre_full_config_test.cpp
...
lte_rrc_llc_rel9_reconfig_after_cre_full_config_test.cpp#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/22/10   mm     Initial Revision
...
boolean rel9_reconfig_after_cre = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_rel9_reconfig_after_cre
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_rel9_reconfig_after_cre
(
  void
)
{
  if (rel9_reconfig_after_cre)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcRel9ReconfigAfterCREFullConfigTest);

void LteRrcLlcRel9ReconfigAfterCREFullConfigTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_rel9_reconfig_after_cre;
  TF_STUB(lte_rrc_config_ho_in_progress) = lte_rrc_llc_test_get_ho_in_progress;
}

void LteRrcLlcRel9ReconfigAfterCREFullConfigTest::Test()
{    
  ...
  rel9_reconfig_after_cre = TRUE;
  lte_rrc_llc_test_rel9_reconfig_after_cre_full_config(TRUE);
  lte_rrc_utf_reset(); 

}

void LteRrcLlcRel9ReconfigAfterCREFullConfigTest::Teardown()
{
