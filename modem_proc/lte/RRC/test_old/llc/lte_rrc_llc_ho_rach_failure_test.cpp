/*!
  @file lte_rrc_llc_ho_rach_failure_test.cpp
...
lte_rrc_llc_ho_rach_failure_test.cpp#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/21/09   mm     Initial Revision
...
boolean rach_reconfig_after_cre = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_rach_test_reconfig_after_cre
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_rach_test_reconfig_after_cre
(
  void
)
{
  if (rach_reconfig_after_cre)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHORACHFailureTest);

void LteRrcLlcHORACHFailureTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = lte_rrc_llc_rach_test_reconfig_after_cre;
}

void LteRrcLlcHORACHFailureTest::Test()
{
  ...
  TF_MSG("HO with mobility doesn't include s-criteria");
  ...
  rach_reconfig_after_cre = TRUE;
  lte_rrc_llc_test_first_reconfig_after_cre();

  /* Test RACH failure for HO mesg with DRB Add */
  rach_reconfig_after_cre = FALSE;
  TF_MSG("HO with mobility with rel9 q_qualmin info");
  ...
  rach_reconfig_after_cre = FALSE;
  TF_MSG("HO with mobility with no new info");
...
void LteRrcLlcHORACHFailureTest::Teardown()
{
