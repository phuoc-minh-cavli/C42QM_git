/*!
  @file lte_rrc_llc_full_cycle_setup_drb4_drb5_test.cpp
  ...
  and sets up DRB4 and DRB5. Finally connection release message that releases all 
  the RBs.
...
lte_rrc_llc_full_cycle_setup_drb4_drb5_test.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcFullCycleSetupDrb4Drb5Test);

void LteRrcLlcFullCycleSetupDrb4Drb5Test::Setup()
{
...
void LteRrcLlcFullCycleSetupDrb4Drb5Test::Test()
{
...
void LteRrcLlcFullCycleSetupDrb4Drb5Test::Teardown()
{
