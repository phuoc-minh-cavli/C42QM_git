/*!
  @file lte_rrc_llc_invalid_drbsetup_no_logchan_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidDRBSetupNoLogChanTest);

void LteRrcLlcInvalidDRBSetupNoLogChanTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, NULL, 0);
  lte_rrc_llc_test_stub_init();
}

void LteRrcLlcInvalidDRBSetupNoLogChanTest::Test()
{
...
void LteRrcLlcInvalidDRBSetupNoLogChanTest::Teardown()
{
