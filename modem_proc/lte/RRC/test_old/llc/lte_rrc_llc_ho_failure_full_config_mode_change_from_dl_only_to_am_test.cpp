...
boolean mode_change_ul_reconfig_after_cre_for_dl_to_am = FALSE;
...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_full_config_mode_change_reconfig_after_cre_for_DL_to_AM
...
*/
/*=========================================================================*/
boolean lte_rrc_llc_test_full_config_mode_change_ul_reconfig_after_cre_for_DL_to_AM
(
  void
)
{
  if (mode_change_ul_reconfig_after_cre_for_dl_to_am)
  {
    return TRUE;
  }
  else
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHOFullConfigFailureModeChangeFromDlOnlyToAmTest);

void LteRrcLlcHOFullConfigFailureModeChangeFromDlOnlyToAmTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_LLC_SM, lte_rrc_llc_test_umid_list, 
                    sizeof(lte_rrc_llc_test_umid_list)/sizeof(lte_rrc_llc_test_umid_list[0]));
  lte_rrc_llc_test_stub_init();
  TF_STUB(lte_rrc_config_is_first_reconfig_after_cre) = 
    lte_rrc_llc_test_full_config_mode_change_ul_reconfig_after_cre_for_DL_to_AM;
	TF_STUB(lte_rrc_config_ho_in_progress) = lte_rrc_llc_test_get_ho_in_progress;
}

void LteRrcLlcHOFullConfigFailureModeChangeFromDlOnlyToAmTest::Test()
{   
  ...
  mode_change_ul_reconfig_after_cre_for_dl_to_am = TRUE;
  lte_rrc_llc_test_rel9_reconfig_after_cre_full_config(FALSE);
  lte_rrc_utf_reset(); 

}

void LteRrcLlcHOFullConfigFailureModeChangeFromDlOnlyToAmTest::Teardown()
{
