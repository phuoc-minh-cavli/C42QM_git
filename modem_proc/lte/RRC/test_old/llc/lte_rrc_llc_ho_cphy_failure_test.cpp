/*!
  @file lte_rrc_llc_ho_cphy_failure_test.cpp
  ...
  information and a failure happens at CPHY. To start with UE receives a Connection Setup 
...
lte_rrc_llc_ho_cphy_failure_test.cpp#1 $
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcHOCPHYFailureTest);

void LteRrcLlcHOCPHYFailureTest::Setup()
{
...
void LteRrcLlcHOCPHYFailureTest::Test()
{
...
void LteRrcLlcHOCPHYFailureTest::Teardown()
{
