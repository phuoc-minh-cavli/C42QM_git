...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcLlcInvalidReconfigDuplicateDRBTest);

void LteRrcLlcInvalidReconfigDuplicateDRBTest::Setup()
{
...
void LteRrcLlcInvalidReconfigDuplicateDRBTest::Test()
{
  lte_rrc_pdu_buf_s encoded_pdu;
  /* ---------------------------------------------------------------------- */
  TF_MSG("\nInvalid Reconfig with duplicate DRB Setup Test Begins \n");
  ...
  encoded_pdu.length = sizeof(llc_invalid_duplicate_drb_msg);
  encoded_pdu.value = llc_invalid_duplicate_drb_msg;
  ...
  TF_MSG("\nInvalid Reconfig with duplicate DRB Setup Test Ends \n");
...
void LteRrcLlcInvalidReconfigDuplicateDRBTest::Teardown()
{
