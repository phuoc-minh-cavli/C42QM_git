/*!
  @file lte_rrc_crp_redirect_conn_release_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCrpRedirectConnRelTest);

void LteRrcCrpRedirectConnRelTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CRP_SM,ext_umid_list,1);
  lte_rrc_crp_test_stub_init();
}

void LteRrcCrpRedirectConnRelTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  TF_ASSERT(conn_rel_ind_ptr->redir_info.rat_type == 
            LTE_RRC_REDIR_RAT_CDMA2000_HRPD);
...
void LteRrcCrpRedirectConnRelTest::Teardown()
{
