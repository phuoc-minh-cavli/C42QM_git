/*!
  @file lte_rrc_csp_basic_handover_test.cpp
...
01/23/09   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicHandoverTest);

void LteRrcCspBasicHandoverTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicHandoverTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  serving_cell_changed_indi.serving_cell_id.phy_cell_id = 2;
  ...
  get_sibs_cnfi.cell_info.cell_id.phy_cell_id = 2;
  get_sibs_cnfi.cell_info.sib_db_key = 2;
  ...
  TF_ASSERT(2 == svc_ind_ptr->camped_svc_info.phy_cell_id);
...
void LteRrcCspBasicHandoverTest::Teardown()
{
