/*!
  @file lte_rrc_csp_rlf6_test.cpp
  ...
  selection continues, with successful camping.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspRlf6Test);

void LteRrcCspRlf6Test::Setup()
{
...
void LteRrcCspRlf6Test::Teardown()
{
