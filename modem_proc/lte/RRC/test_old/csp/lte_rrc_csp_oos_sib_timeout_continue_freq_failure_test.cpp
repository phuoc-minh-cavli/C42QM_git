...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosSibTimeoutContinueFreqFailureTest);

void LteRrcCspOosSibTimeoutContinueFreqFailureTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosSibTimeoutContinueFreqFailureTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  printf("\nsvc_ind_ptr->trans_id :: %d\n",svc_ind_ptr->trans_id);
...
void LteRrcCspOosSibTimeoutContinueFreqFailureTest::Teardown()
{
