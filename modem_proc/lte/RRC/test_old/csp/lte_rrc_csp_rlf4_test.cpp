/*!
  @file lte_rrc_csp_rlf4_test.cpp
  ...
  Connected mode. Meanwhile, T311 expires and connection is closed. Cell
  selection continues, but is unsuccessful.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspRlf4Test);

void LteRrcCspRlf4Test::Setup()
{
...
void LteRrcCspRlf4Test::Teardown()
{
