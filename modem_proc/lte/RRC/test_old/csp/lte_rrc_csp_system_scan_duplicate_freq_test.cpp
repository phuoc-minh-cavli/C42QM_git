/*!
  @file lte_rrc_csp_system_scan_duplicate_freq_test.cpp

  @brief
  Controller is in Inactive state and there are 3 entries in the Acq DB. Third
  entry has the same frequency but different PLMN than the second and is not
  sent in System Scan Request.
  System Scan is started. Then cell SIB1 PLMN match fails. Also tests blacklist
  logic. This happens a second time and then the second entry is tried when 
  PLMN match succeeds and successful camping occurs.
...
06/29/09   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspSystemScanDuplicateFreqTest);

void LteRrcCspSystemScanDuplicateFreqTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspSystemScanDuplicateFreqTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[2].band = SYS_SBAND_LTE_EUTRAN_BAND1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].bandwidth = LTE_BW_NRB_6;
  lte_rrc_csp.sd_ptr->acq_db.db[2].dl_earfcn = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].phy_cell_id = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].cell_identity = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].tac = 0;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.num_plmns = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mcc[0] = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mcc[1] = 2;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mcc[2] = 3;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].num_mnc_digits = 3;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mnc[0] = 4;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mnc[1] = 5;
  lte_rrc_csp.sd_ptr->acq_db.db[2].plmn_list.plmn[0].mnc[2] = 6;
  lte_rrc_csp.sd_ptr->acq_db.db[2].sib_db_key = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mcc[0] = 1;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mcc[1] = 2;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mcc[2] = 3;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.num_mnc_digits = 3;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mnc[0] = 4;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mnc[1] = 5;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn.mnc[2] = 6;
  lte_rrc_csp.sd_ptr->acq_db.db[2].selected_plmn_index = 0;

  lte_rrc_csp.sd_ptr->acq_db.db[1].band = SYS_SBAND_LTE_EUTRAN_BAND1;
  lte_rrc_csp.sd_ptr->acq_db.db[1].bandwidth = LTE_BW_NRB_6;
  lte_rrc_csp.sd_ptr->acq_db.db[1].dl_earfcn = 2;
  lte_rrc_csp.sd_ptr->acq_db.db[1].phy_cell_id = 3;
  lte_rrc_csp.sd_ptr->acq_db.db[1].cell_identity = 3;
  ...
  /* similar to above, same earfcn but different PLMN*/
  lte_rrc_csp.sd_ptr->acq_db.db[0].band = SYS_SBAND_LTE_EUTRAN_BAND1;
  lte_rrc_csp.sd_ptr->acq_db.db[0].bandwidth = LTE_BW_NRB_6;
  lte_rrc_csp.sd_ptr->acq_db.db[0].dl_earfcn = 2;
  lte_rrc_csp.sd_ptr->acq_db.db[0].phy_cell_id = 4;
  lte_rrc_csp.sd_ptr->acq_db.db[0].cell_identity = 4;
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[0].plmn_list.plmn[0].mnc[2] = 9;
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[0].selected_plmn.mnc[2] = 9;
  lte_rrc_csp.sd_ptr->acq_db.db[0].selected_plmn_index = 0;

  lte_rrc_csp.sd_ptr->acq_db.acq_db_index[0] = 2;
  lte_rrc_csp.sd_ptr->acq_db.acq_db_index[1] = 1;
  lte_rrc_csp.sd_ptr->acq_db.acq_db_index[2] = 0;
  lte_rrc_csp.sd_ptr->acq_db.entry_is_occupied[0] = TRUE;
  lte_rrc_csp.sd_ptr->acq_db.entry_is_occupied[1] = TRUE;
  lte_rrc_csp.sd_ptr->acq_db.entry_is_occupied[2] = TRUE;
  lte_rrc_csp.sd_ptr->acq_db.acq_db_count = 3;
  ...
  *(sib1_pdu_ptr->message.u.c1->u.systemInformationBlockType1->
  ...
  get_sib_cnf.cell_info.cell_id.phy_cell_id = 3;
  get_sib_cnf.cell_info.sib_db_key = 2;
  lte_rrc_utf_send_msg((byte*)&get_sib_cnf, sizeof(get_sib_cnf));
  ...
  TF_ASSERT(3 == cell_sel_req_ptr->phy_cell_id);
...
void LteRrcCspSystemScanDuplicateFreqTest::Teardown()
{
