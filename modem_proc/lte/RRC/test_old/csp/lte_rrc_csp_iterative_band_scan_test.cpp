/*!
  @file lte_rrc_csp_iterative_band_scan_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspIterativeBandScanTest);

void LteRrcCspIterativeBandScanTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspIterativeBandScanTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
TF_ASSERT(1 == cfg_req_ptr->num_cfg);
 ...
 TF_ASSERT(1 == band_scan_cfg_ptr->req_bands.num_bands);
 TF_ASSERT(SYS_SBAND_LTE_EUTRAN_BAND1 == band_scan_cfg_ptr->req_bands.band[0]);
 TF_ASSERT(6 == band_scan_cfg_ptr->trans_id);
...
TF_ASSERT(1 == cfg_req_ptr->num_cfg);
 ...
 TF_ASSERT(1 == band_scan_cfg_ptr->req_bands.num_bands);
 TF_ASSERT(SYS_SBAND_LTE_EUTRAN_BAND1 == band_scan_cfg_ptr->req_bands.band[0]);
 TF_ASSERT(10 == band_scan_cfg_ptr->trans_id);
 ...
 lte_rrc_utf_send_msg((byte*)&bs_cnf, sizeof(bs_cnf));
  ...
  TF_ASSERT(1 == cfg_req_ptr->num_cfg);
   ...
   TF_ASSERT(11 == band_scan_cfg_ptr->trans_id);
   TF_ASSERT(0 == band_scan_cfg_ptr->req_bands.unusable_systems.num_systems);
...
void LteRrcCspIterativeBandScanTest::Teardown()
{
