/*!
  @file lte_rrc_csp_rlf7_test.cpp
  ...
  Then NAS finds service on another RAT, and sends Connection Abort followed
  by Deactivate. Or T311 timer could have expired.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspRlf7Test);

void LteRrcCspRlf7Test::Setup()
{
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  sib1_pdu_ptr->message.u.c1->u.systemInformationBlockType1->
    cellAccessRelatedInfo.plmn_IdentityList.elem->plmn_Identity.mcc.n = 1;
  *(sib1_pdu_ptr->message.u.c1->u.systemInformationBlockType1->        
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  conn_rel_ind.rel_reason = LTE_RRC_CONN_REL_RLF;
  ...
  #ifdef FEATURE_LTE_RRC_STATIC_MEM
...
void LteRrcCspRlf7Test::Teardown()
{
