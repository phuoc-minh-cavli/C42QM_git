/*!
  @file lte_rrc_csp_basic_int_spv_oos_sib_cnf_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicIntOosSibCnfTest);

void LteRrcCspBasicIntOosSibCnfTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicIntOosSibCnfTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  lte_rrc_csp_test_stub_controller_set_state(LTE_RRC_CONTROLLER_SM__IDLE_CAMPED);  
    TF_MSG("Checking for CLOSING controller state");
...
void LteRrcCspBasicIntOosSibCnfTest::Teardown()
{
