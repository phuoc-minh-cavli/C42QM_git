/*!
  @file lte_rrc_csp_irat_to_lte_basic_redir_full_test.cpp
  ...
  LTE full redirection request comes in and cell selection proceeds. Band scan
  is started
...
--------   ---     ----------------------------------------------------------
02/25/10   sureshs Initial Revision
...
static lte_rrc_irat_to_lte_redir_full_reqi_s redir_reqi;
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspIratToLteBasicRedirFullTest);

void LteRrcCspIratToLteBasicRedirFullTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspIratToLteBasicRedirFullTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  TF_MSG("Sending IRAT to LTE Redir Full Reqi");
  lte_rrc_init_default_hdr(&redir_reqi.msg_hdr,LTE_RRC_IRAT_TO_LTE_REDIR_FULL_REQI);
  ...
  redir_reqi.nbr_earfcn_list.earfcn_count = 0;
...
void LteRrcCspIratToLteBasicRedirFullTest::Teardown()
{
