...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspTddBandScanTest);

void LteRrcCspTddBandScanTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspTddBandScanTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  svc_req.rat_pri_list.priority_list_info[0].band_cap.lte_band_cap.bits_1_64 |= SYS_BAND_MASK_LTE_BAND38;
  ...
  cfg_req_param.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  cfg_req_param.earfcn = 37751;
  ...
  send_band_scan_cnf.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  ...
  send_band_scan_cnf.candidates[0].system.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  send_band_scan_cnf.candidates[0].system.bandwidth = LTE_BW_NRB_6;
  send_band_scan_cnf.candidates[0].system.earfcn = 37751;

  send_band_scan_cnf.candidates[1].energy = -60;
  send_band_scan_cnf.candidates[1].system.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  send_band_scan_cnf.candidates[1].system.bandwidth = LTE_BW_NRB_6;
  send_band_scan_cnf.candidates[1].system.earfcn = 37752;

  send_band_scan_cnf.candidates[2].energy = -60;
  send_band_scan_cnf.candidates[2].system.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  send_band_scan_cnf.candidates[2].system.bandwidth = LTE_BW_NRB_6;
  send_band_scan_cnf.candidates[2].system.earfcn = 37753;
  ...
  get_sib_cnf.cell_info.cell_id.freq = 37752;
  ...
  TF_ASSERT(SYS_SBAND_LTE_EUTRAN_BAND38 == cell_sel_req_ptr->band);
  TF_ASSERT(37752 == cell_sel_req_ptr->earfcn);
  ...
  cell_sel_cnf.band = SYS_SBAND_LTE_EUTRAN_BAND38;
  cell_sel_cnf.earfcn = 37752;
  ...
  send_band_scan_cnf.band = SYS_SBAND_LTE_EUTRAN_BAND40;
  ...
  validate_system_scan_req[0].band = SYS_SBAND_LTE_EUTRAN_BAND38;
  validate_system_scan_req[0].bandwidth = LTE_BW_NRB_6;
  validate_system_scan_req[0].earfcn = 37752;
...
void LteRrcCspTddBandScanTest::Teardown()
{
