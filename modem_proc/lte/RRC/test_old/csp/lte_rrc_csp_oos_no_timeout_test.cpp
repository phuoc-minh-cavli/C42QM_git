/*!
  @file lte_rrc_csp_oos_no_timeout_test.cpp
  ...
  timer does not expire and UE camps.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosNoTimeoutTest);

void LteRrcCspOosNoTimeoutTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosNoTimeoutTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosNoTimeoutTest::Teardown()
{
