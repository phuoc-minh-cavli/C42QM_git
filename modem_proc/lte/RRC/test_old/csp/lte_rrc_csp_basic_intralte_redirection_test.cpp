/*!
  @file lte_rrc_csp_basic_intralte_redirection_test.cpp

  @brief
  Unit test code for taking CSP to camped state.
  Send Connection release with intraLTE frequency redirection present.
  Aquisition is started. Send Acq success. Follow basic camping steps.
...
05/28/09   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicIntraLteRedirectionTest);

void LteRrcCspBasicIntraLteRedirectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicIntraLteRedirectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicIntraLteRedirectionTest::Teardown()
{
