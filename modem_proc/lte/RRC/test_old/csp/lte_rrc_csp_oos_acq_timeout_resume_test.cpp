...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosAcqTimeoutResumeTest);

void LteRrcCspOosAcqTimeoutResumeTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosAcqTimeoutResumeTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosAcqTimeoutResumeTest::Teardown()
{
