/*!
  @file lte_rrc_csp_system_scan_multi_freq_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspSystemScanMultiFreqTest);

void LteRrcCspSystemScanMultiFreqTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspSystemScanMultiFreqTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspSystemScanMultiFreqTest::Teardown()
{
