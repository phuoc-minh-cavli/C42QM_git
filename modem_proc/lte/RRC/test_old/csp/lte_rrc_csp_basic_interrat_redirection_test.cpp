/*!
  @file lte_rrc_csp_basic_interrat_redirection_test.cpp
...
05/04/09   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicInterRatRedirectionTest);

void LteRrcCspBasicInterRatRedirectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicInterRatRedirectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicInterRatRedirectionTest::Teardown()
{
