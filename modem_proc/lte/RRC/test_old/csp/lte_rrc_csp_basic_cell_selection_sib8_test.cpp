/*!
  @file lte_rrc_csp_basic_cell_selection_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicCellSelectionWithSib8Test);

void LteRrcCspBasicCellSelectionWithSib8Test::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicCellSelectionWithSib8Test::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  TF_ASSERT(1 == svc_ind_ptr->sib8_available);
...
void LteRrcCspBasicCellSelectionWithSib8Test::Teardown()
{
