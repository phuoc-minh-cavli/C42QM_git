/*!
  @file lte_rrc_csp_single_band_multi_freq_test.cpp
  ...
  logic. This happens a second time and then a second freq is tried when 
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspSingleBandMultiFreqTest);

void LteRrcCspSingleBandMultiFreqTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspSingleBandMultiFreqTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspSingleBandMultiFreqTest::Teardown()
{
