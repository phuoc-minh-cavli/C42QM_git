...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosCfgTimeoutTest);

void LteRrcCspOosCfgTimeoutTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosCfgTimeoutTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosCfgTimeoutTest::Teardown()
{
