/*!
  @file lte_rrc_csp_basic_interrat_to_w_reselection_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicInterratToWReSelectionTest);

void LteRrcCspBasicInterratToWReSelectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicInterratToWReSelectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicInterratToWReSelectionTest::Teardown()
{
