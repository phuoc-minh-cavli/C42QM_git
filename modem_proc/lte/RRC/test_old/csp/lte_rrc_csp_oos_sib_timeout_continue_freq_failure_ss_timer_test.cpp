/*!
  @file lte_rrc_csp_oos_sib_timeout_continue_freq_failure_ss_timer_test.cpp
...
--------   ---     ----------------------------------------------------------
01/05/11   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerTest);

void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerTest::Teardown()
{
