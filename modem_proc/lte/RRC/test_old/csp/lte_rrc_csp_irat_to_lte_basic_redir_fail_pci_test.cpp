/*!
  @file lte_rrc_csp_irat_to_lte_basic_redir_fail_pci_test.cpp
  ...
  LTE redirection request comes in with a PCI specified and cell 
...
--------   ---     ----------------------------------------------------------
02/23/10   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspIratToLteBasicRedirFailPciTest);

void LteRrcCspIratToLteBasicRedirFailPciTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,2);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspIratToLteBasicRedirFailPciTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  redir_reqi.earfcn_info[0].is_pci_valid = TRUE;
  redir_reqi.earfcn_info[0].pci = 1;
...
void LteRrcCspIratToLteBasicRedirFailPciTest::Teardown()
{
