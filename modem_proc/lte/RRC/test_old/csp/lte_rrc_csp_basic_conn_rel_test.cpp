/*!
  @file lte_rrc_csp_basic_conn_rel_test.cpp

  @brief
  Unit test code for taking CSP to camped state and then back to camped
  on connection close.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicConnRelTest);

void LteRrcCspBasicConnRelTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicConnRelTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicConnRelTest::Teardown()
{
