/*!
  @file lte_rrc_csp_oos_acq_timeout_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosAcqTimeoutTest);

void LteRrcCspOosAcqTimeoutTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,4);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosAcqTimeoutTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosAcqTimeoutTest::Teardown()
{
