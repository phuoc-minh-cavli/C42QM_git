/*!
  @file lte_rrc_csp_rlf1_test.cpp
  ...
  Connected mode and we recamp. Then CRE succeeds.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspRlfWaitSrb2RcvdConnRelInd);

void LteRrcCspRlfWaitSrb2RcvdConnRelInd::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspRlfWaitSrb2RcvdConnRelInd::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
/*
dont send SRB2 indicaiton
send conn rel ind in camped state
wait for sib abort 
wait for not camped state
wait for service ind
wait for redir request
*/
...
void LteRrcCspRlfWaitSrb2RcvdConnRelInd::Teardown()
{
