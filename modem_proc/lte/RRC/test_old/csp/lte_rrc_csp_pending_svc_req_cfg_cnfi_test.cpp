...
--------   ---     ----------------------------------------------------------
10/16/10   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspPendingSvcReqCfgCnfiTest);

void LteRrcCspPendingSvcReqCfgCnfiTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspPendingSvcReqCfgCnfiTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  lte_rrc_service_req_s *service_req_ptr;
...
void LteRrcCspPendingSvcReqCfgCnfiTest::Teardown()
{
