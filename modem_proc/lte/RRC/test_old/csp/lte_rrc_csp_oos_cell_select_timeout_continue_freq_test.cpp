...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosCellSelectTimeoutContinueFreqTest);

void LteRrcCspOosCellSelectTimeoutContinueFreqTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosCellSelectTimeoutContinueFreqTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosCellSelectTimeoutContinueFreqTest::Teardown()
{
