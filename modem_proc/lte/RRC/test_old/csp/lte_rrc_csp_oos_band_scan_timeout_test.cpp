/*!
  @file lte_rrc_csp_oos_band_scan_timeout_test.cpp
  ...
  timer is made to expire before band scan cnf.
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosBandScanTimeoutTest);

void LteRrcCspOosBandScanTimeoutTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,3);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosBandScanTimeoutTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosBandScanTimeoutTest::Teardown()
{
