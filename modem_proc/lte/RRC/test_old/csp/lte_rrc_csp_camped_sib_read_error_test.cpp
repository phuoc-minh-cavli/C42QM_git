...
03/02/09   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspCampedSibReadErrorTest);

void LteRrcCspCampedSibReadErrorTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspCampedSibReadErrorTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  sib_read_error_ind.cause = LTE_RRC_SIB_READ_ERROR_CAUSE_INVALID_SIBS;
...
void LteRrcCspCampedSibReadErrorTest::Teardown()
{
