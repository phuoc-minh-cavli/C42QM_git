...
10/09/08   sureshs Fleshed out test
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicCellSelectionTest);

void LteRrcCspBasicCellSelectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicCellSelectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicCellSelectionTest::Teardown()
{
