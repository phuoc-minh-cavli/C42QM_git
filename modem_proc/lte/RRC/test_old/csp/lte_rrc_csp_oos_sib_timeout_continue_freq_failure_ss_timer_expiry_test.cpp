/*!
  @file lte_rrc_csp_oos_sib_timeout_continue_freq_failure_ss_timer_expiry_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerExpiryTest);

void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerExpiryTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerExpiryTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspOosSibTimeoutContinueFreqFailureSsTimerExpiryTest::Teardown()
{
