/*!
  @file lte_rrc_csp_multi_band_test.cpp
  ...
  logic. This happens a second time and then a second band is tried when 
...
10/31/08   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspMultiBandTest);

void LteRrcCspMultiBandTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspMultiBandTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspMultiBandTest::Teardown()
{
