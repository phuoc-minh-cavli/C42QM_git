...
/*===========================================================================
  ...
  FUNCTION:  lte_rrc_llc_test_efs_item_write_for_earfcn_lock
...
void lte_rrc_llc_test_efs_item_write_for_earfcn_lock
(
  void
)
{
  ...
  lte_rrc_csp_efs_earfcn_lock_s efs_earfcn_lock;
  efs_earfcn_lock.dl_earfcn1 = 1;
  efs_earfcn_lock.dl_earfcn2 = 1;
  

  oflag = O_RDWR | O_AUTODIR | O_TRUNC;
  mode = ACCESSPERMS;
  TF_ASSERT(efs_put("/nv/item_files/modem/lte/rrc/csp/earfcn_lock", 
                    &efs_earfcn_lock,sizeof(lte_rrc_csp_efs_earfcn_lock_s), oflag, mode) >= 0);

} /*lte_rrc_llc_test_efs_item_write_for_earfcn_lock*/

/*===========================================================================*/
/*!
    @brief
    This writes to lte_rrc_llc_test_efs_item_write_for_earfcn_lock EFS
...
void lte_rrc_llc_test_efs_item_write_for_earfcn_lock_diff
(
  void
)
{
...
} /*lte_rrc_llc_test_efs_item_write_for_earfcn_lock_diff*/
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicSystemScanTest);

void LteRrcCspBasicSystemScanTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicSystemScanTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[0].dl_earfcn = 1;
...
void LteRrcCspBasicSystemScanTest::Teardown()
{
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicEarfcnLockTestFailure);

void LteRrcCspBasicEarfcnLockTestFailure::Setup()
{
  lte_rrc_llc_test_efs_item_write_for_earfcn_lock();
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
...
void LteRrcCspBasicEarfcnLockTestFailure::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  lte_rrc_mode_change_reqi_s *mode_change_req_ptr;
...
void LteRrcCspBasicEarfcnLockTestFailure::Teardown()
{
  lte_rrc_utf_teardown();
}
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicEarfcnLockTestSuccess);

void LteRrcCspBasicEarfcnLockTestSuccess::Setup()
{
  lte_rrc_llc_test_efs_item_write_for_earfcn_lock_diff();
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
...
void LteRrcCspBasicEarfcnLockTestSuccess::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  lte_rrc_mode_change_reqi_s *mode_change_req_ptr;
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[1].band = SYS_SBAND_LTE_EUTRAN_BAND3;
  lte_rrc_csp.sd_ptr->acq_db.db[1].bandwidth = LTE_BW_NRB_6;
  lte_rrc_csp.sd_ptr->acq_db.db[1].dl_earfcn = 1700;
  ...
  svc_req.rat_pri_list.priority_list_info[0].band_cap.lte_band_cap.bits_1_64 |= SYS_BAND_MASK_LTE_BAND3;
  svc_req.rat_pri_list.priority_list_info[0].bst_band_cap.lte_band_cap.bits_1_64 |= svc_req.rat_pri_list.priority_list_info[0].band_cap.lte_band_cap.bits_1_64;
  svc_req.rat_pri_list.priority_list_info[0].bst_rat_acq_required = TRUE;
  svc_req.rat_pri_list.scan_type.new_scan = TRUE;
  svc_req.rat_pri_list.scan_type.use_timer = FALSE;
  ...
  validate_system_scan_req[0].band = SYS_SBAND_LTE_EUTRAN_BAND1;
  validate_system_scan_req[0].bandwidth = LTE_BW_NRB_25;
  validate_system_scan_req[0].earfcn = 1;
...
void LteRrcCspBasicEarfcnLockTestSuccess::Teardown()
{
  lte_rrc_utf_teardown();
}
