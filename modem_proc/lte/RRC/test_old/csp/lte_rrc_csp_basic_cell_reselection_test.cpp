/*!
  @file lte_rrc_csp_basic_cell_reselection_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicCellReSelectionTest);

void LteRrcCspBasicCellReSelectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicCellReSelectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
lte_rrc_test_integration_verify_req_send_cnf(NULL, LTE_RRC_BARRING_UPDATE_IND, LTE_RRC_TEST_CELL_0, FALSE, NULL);
  ...
  TF_ASSERT(lte_rrc_csp_get_num_tx_antennas() == 4);
...
void LteRrcCspBasicCellReSelectionTest::Teardown()
{
