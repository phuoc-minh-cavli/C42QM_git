/*!
  @file lte_rrc_csp_basic_interrat_to_1x_reselection_test.cpp
  ...
  Scan is started. After camping, reselection to 1x is triggered and is
  successful.
...
10/28/09   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicInterratTo1xReSelectionTest);

void LteRrcCspBasicInterratTo1xReSelectionTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicInterratTo1xReSelectionTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcCspBasicInterratTo1xReSelectionTest::Teardown()
{
