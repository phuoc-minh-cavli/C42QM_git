/*!
  @file lte_rrc_csp_basic_cell_selection_rel9_test.cpp

  @brief
  Unit test code for taking CSP to camped state with REL9 SIBs.
...
--------   ---     ----------------------------------------------------------
11/14/10   vatsac  Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicCellSelectionRel9Test);

void LteRrcCspBasicCellSelectionRel9Test::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicCellSelectionRel9Test::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  TF_ASSERT(TRUE == cell_sel_req_ptr->cell_select_cfg.cell_select_info_rel9_present);
  TF_ASSERT(-10 == cell_sel_req_ptr->cell_select_cfg.cell_select_info_rel9.q_qualmin);
  TF_ASSERT(0 == cell_sel_req_ptr->cell_select_cfg.cell_select_info_rel9.q_qualmin_offset);
...
void LteRrcCspBasicCellSelectionRel9Test::Teardown()
{
