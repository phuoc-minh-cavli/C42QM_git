...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspBasicCellSelectionLimitedRaTest);

void LteRrcCspBasicCellSelectionLimitedRaTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspBasicCellSelectionLimitedRaTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  svc_req.network_select_mode = SYS_NETWORK_SELECTION_MODE_LIMITED_ROUTINE_ACQUISITION;
...
void LteRrcCspBasicCellSelectionLimitedRaTest::Teardown()
{
