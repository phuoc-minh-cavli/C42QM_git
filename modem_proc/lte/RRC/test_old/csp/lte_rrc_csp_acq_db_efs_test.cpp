...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspAcqDbEfsTest);

void LteRrcCspAcqDbEfsTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,7);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspAcqDbEfsTest::Test()
{
  ...
  lte_rrc_csp.sd_ptr->acq_db.db[0].dl_earfcn = 10;
...
void LteRrcCspAcqDbEfsTest::Teardown()
{
	lte_rrc_csp_test_free_sib1_pdu();
