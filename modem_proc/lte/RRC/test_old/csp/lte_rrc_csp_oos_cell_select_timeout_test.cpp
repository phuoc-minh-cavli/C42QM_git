/*!
  @file lte_rrc_csp_oos_cell_select_timeout_resume_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspOosCellSelectTimeoutTest);

void LteRrcCspOosCellSelectTimeoutTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,6);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspOosCellSelectTimeoutTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  //lte_rrc_csp_set_eoos_complete_current_freq(FALSE);
...
void LteRrcCspOosCellSelectTimeoutTest::Teardown()
{
