/*!
  @file lte_rrc_csp_simple_system_update_test.cpp

  @brief
  Unit test code for taking CSP to camped state when PLMN specified in Service
  Request is not in SIB1 list, but a prior System Update message specifies an
  EPLMN list which includes it
...
10/30/08   sureshs Initial Revision
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcCspSimpleSystemUpdateTest);

void LteRrcCspSimpleSystemUpdateTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CSP_SM,ext_umid_list,5);
  lte_rrc_csp_test_stub_init();
}

void LteRrcCspSimpleSystemUpdateTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  sys_upd_req.rplmn.mcc[0] = 25;
  sys_upd_req.rplmn.mcc[1] = 26;
  sys_upd_req.rplmn.mcc[2] = 27;
  sys_upd_req.rplmn.num_mnc_digits = 3;
  sys_upd_req.rplmn.mnc[0] = 28;
  sys_upd_req.rplmn.mnc[1] = 29;
  sys_upd_req.rplmn.mnc[2] = 30;
  ...
  sys_upd_req.eplmn_list.num_plmns = 2;
  /* first PLMN matches req_plmn is svc req */
  sys_upd_req.eplmn_list.plmn[0].mcc[0] = 31;
  sys_upd_req.eplmn_list.plmn[0].mcc[1] = 32;
  sys_upd_req.eplmn_list.plmn[0].mcc[2] = 33;
  sys_upd_req.eplmn_list.plmn[0].num_mnc_digits = 3;
  sys_upd_req.eplmn_list.plmn[0].mnc[0] = 34;
  sys_upd_req.eplmn_list.plmn[0].mnc[1] = 35;
  sys_upd_req.eplmn_list.plmn[0].mnc[2] = 36;
  /* second PLMN matches PLMN in SIB1 list */
  sys_upd_req.eplmn_list.plmn[1].mcc[0] = 1;
  sys_upd_req.eplmn_list.plmn[1].mcc[1] = 2;
  sys_upd_req.eplmn_list.plmn[1].mcc[2] = 3;
  sys_upd_req.eplmn_list.plmn[1].num_mnc_digits = 3;
  sys_upd_req.eplmn_list.plmn[1].mnc[0] = 4;
  sys_upd_req.eplmn_list.plmn[1].mnc[1] = 5;
  sys_upd_req.eplmn_list.plmn[1].mnc[2] = 6;
  ...
  /* req_plmn not in SIB1 list */
  svc_req.req_plmn.mcc[0] = 25;
  svc_req.req_plmn.mcc[1] = 26;
  svc_req.req_plmn.mcc[2] = 27;
  svc_req.req_plmn.num_mnc_digits = 3;
  svc_req.req_plmn.mnc[0] = 28;
  svc_req.req_plmn.mnc[1] = 29;
  svc_req.req_plmn.mnc[2] = 30;
  svc_req.rplmn_info_is_valid = TRUE;
  svc_req.rplmn.mcc[0] = 25;
  svc_req.rplmn.mcc[1] = 26;
  svc_req.rplmn.mcc[2] = 27;
  svc_req.rplmn.num_mnc_digits = 3;
  svc_req.rplmn.mnc[0] = 28;
  svc_req.rplmn.mnc[1] = 29;
  svc_req.rplmn.mnc[2] = 30;
  ...
  svc_req.eplmn_list.num_plmns = 3;
  /* first PLMN matches req_plmn is svc req */
  svc_req.eplmn_list.plmn[0].mcc[0] = 31;
  svc_req.eplmn_list.plmn[0].mcc[1] = 32;
  svc_req.eplmn_list.plmn[0].mcc[2] = 33;
  svc_req.eplmn_list.plmn[0].num_mnc_digits = 3;
  svc_req.eplmn_list.plmn[0].mnc[0] = 34;
  svc_req.eplmn_list.plmn[0].mnc[1] = 35;
  svc_req.eplmn_list.plmn[0].mnc[2] = 36;
  /* second PLMN matches PLMN in SIB1 list */
  svc_req.eplmn_list.plmn[1].mcc[0] = 1;
  svc_req.eplmn_list.plmn[1].mcc[1] = 2;
  svc_req.eplmn_list.plmn[1].mcc[2] = 3;
  svc_req.eplmn_list.plmn[1].num_mnc_digits = 3;
  svc_req.eplmn_list.plmn[1].mnc[0] = 4;
  svc_req.eplmn_list.plmn[1].mnc[1] = 5;
  svc_req.eplmn_list.plmn[1].mnc[2] = 6;
  /* third PLMN is the req PLMN */
  svc_req.eplmn_list.plmn[2].mcc[0] = 25;
  svc_req.eplmn_list.plmn[2].mcc[1] = 26;
  svc_req.eplmn_list.plmn[2].mcc[2] = 27;
  svc_req.eplmn_list.plmn[2].num_mnc_digits = 3;
  svc_req.eplmn_list.plmn[2].mnc[0] = 28;
  svc_req.eplmn_list.plmn[2].mnc[1] = 29;
  svc_req.eplmn_list.plmn[2].mnc[2] = 30;
...
void LteRrcCspSimpleSystemUpdateTest::Teardown()
{
