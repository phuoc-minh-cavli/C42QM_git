/*!
  @file lte_rrc_plmn_search_interleaved_hplmn_manual_search_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcPlmnSearchInterleavedHplmnManualSearchTest);

void LteRrcPlmnSearchInterleavedHplmnManualSearchTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_PLMN_SEARCH_SM,ext_umid_list,4);
  lte_rrc_plmn_search_test_stub_init();
}

void LteRrcPlmnSearchInterleavedHplmnManualSearchTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcPlmnSearchInterleavedHplmnManualSearchTest::Teardown()
{
