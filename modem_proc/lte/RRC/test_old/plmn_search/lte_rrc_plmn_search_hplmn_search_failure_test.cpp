/*!
  @file lte_rrc_plmn_search_hplmn_search_failure_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcPlmnSearchHplmnSearchFailureTest);

void LteRrcPlmnSearchHplmnSearchFailureTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_PLMN_SEARCH_SM,ext_umid_list,4);
  lte_rrc_plmn_search_test_stub_init();
}

void LteRrcPlmnSearchHplmnSearchFailureTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  /* set PLMN mismatch */
  sib1_pdu_ptr->message.u.c1->u.systemInformationBlockType1->
    cellAccessRelatedInfo.plmn_IdentityList.elem->
    plmn_Identity.mcc.elem[0] = 3;
  ...
  TF_ASSERT(search_cnf_ptr->status == LTE_RRC_PLMN_SEARCH_COMPLETED);
	...
	#ifndef FEATURE_HPPLMN_SRCH_WITH_MANY_PREF_PLMN
...
void LteRrcPlmnSearchHplmnSearchFailureTest::Teardown()
{
