/*!
  @file lte_rrc_plmn_search_limited_to_auto_search_failure_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcPlmnSearchLimitedToAutoSearchFailureTest);

void LteRrcPlmnSearchLimitedToAutoSearchFailureTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_PLMN_SEARCH_SM,ext_umid_list,4);
  lte_rrc_plmn_search_test_stub_init();
}

void LteRrcPlmnSearchLimitedToAutoSearchFailureTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  TF_ASSERT(search_cnf_ptr->found_plmn_rat_list.info[0].signal_strength == 110);
  TF_ASSERT(search_cnf_ptr->found_plmn_rat_list.info[1].plmn.identity[0] == 0x23);
...
void LteRrcPlmnSearchLimitedToAutoSearchFailureTest::Teardown()
{
