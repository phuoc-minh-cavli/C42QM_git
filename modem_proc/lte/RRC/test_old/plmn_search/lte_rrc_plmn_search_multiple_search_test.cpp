/*!
  @file lte_rrc_plmn_search_multiple_search_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcPlmnSearchMultipleSearchTest);

void LteRrcPlmnSearchMultipleSearchTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_PLMN_SEARCH_SM,ext_umid_list,4);
  lte_rrc_plmn_search_test_stub_init();
}

void LteRrcPlmnSearchMultipleSearchTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
  ...
  TF_ASSERT(start_req_ptr->chans[0].chan == 1);
  TF_ASSERT(start_req_ptr->chans[0].bw == LTE_BW_NRB_100);
  TF_ASSERT(start_req_ptr->num_bands == 0);
  TF_ASSERT(start_req_ptr->num_black_freqs == 0);
  TF_ASSERT(start_req_ptr->irat_lte_plmn_time_allowed == LTE_CPHY_BPLMN_UNLIMITED_TIME);
...
void LteRrcPlmnSearchMultipleSearchTest::Teardown()
{
