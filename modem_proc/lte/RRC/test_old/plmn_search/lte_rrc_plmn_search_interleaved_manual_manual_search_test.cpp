/*!
  @file lte_rrc_plmn_search_interleaved_manual_manual_search_test.cpp
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcPlmnSearchInterleavedManualManualSearchTest);

void LteRrcPlmnSearchInterleavedManualManualSearchTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_PLMN_SEARCH_SM,ext_umid_list,4);
  lte_rrc_plmn_search_test_stub_init();
}

void LteRrcPlmnSearchInterleavedManualManualSearchTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcPlmnSearchInterleavedManualManualSearchTest::Teardown()
{
