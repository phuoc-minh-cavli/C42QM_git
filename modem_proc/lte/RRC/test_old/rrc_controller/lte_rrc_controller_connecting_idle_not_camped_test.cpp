/*!
  @file lte_rrc_controller_connecting_idle_not_camped_test.cpp

  @brief
  Unit test code for basic RRC controller state transitions. Take it from
  Inactive -> Connecting -> Idle Not Camped 
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerConnectingIdleNotCampedTest);

void LteRrcControllerConnectingIdleNotCampedTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 6);
}

void LteRrcControllerConnectingIdleNotCampedTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerConnectingIdleNotCampedTest::Teardown()
{
