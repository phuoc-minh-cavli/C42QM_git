/*!
  @file lte_rrc_controller_conn_est_fail_test.cpp

  @brief
  Unit test code for basic RRC controller state transitions. Take it from
  Inactive -> Connecting ->Idle Camped
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerConnEstFailTest);

void LteRrcControllerConnEstFailTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 6);
}

void LteRrcControllerConnEstFailTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerConnEstFailTest::Teardown()
{
