/*!
  @file lte_rrc_controller_oos_test.cpp

  @brief
  Unit test code for basic RRC controller state transitions. Take it from
  Inactive -> Idle Camped -> Idle Not Camped
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerOosTest);

void LteRrcControllerOosTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 6);
}

void LteRrcControllerOosTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerOosTest::Teardown()
{
