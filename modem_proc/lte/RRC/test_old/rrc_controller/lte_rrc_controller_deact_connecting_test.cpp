/*!
  @file lte_rrc_controller_deact_connecting_test.cpp

  @brief
  Unit test code for basic RRC controller state transitions. Take it from
  Inactive -> Connecting -> Inactive
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerDeactConnectingTest);

void LteRrcControllerDeactConnectingTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 12);
}

void LteRrcControllerDeactConnectingTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerDeactConnectingTest::Teardown()
{
