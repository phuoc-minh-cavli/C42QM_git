/*!
  @file lte_rrc_controller_rlf_test.cpp

  @brief
  Unit test code for basic RRC controller state transitions. Take it from
  Inactive -> Connected -> Idle Not Camped 
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerRlfTest);

void LteRrcControllerRlfTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 6);
}

void LteRrcControllerRlfTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerRlfTest::Teardown()
{
