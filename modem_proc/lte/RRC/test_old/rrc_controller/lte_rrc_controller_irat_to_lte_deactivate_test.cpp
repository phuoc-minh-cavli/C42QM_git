/*!
  @file lte_rrc_controller_irat_to_lte_deactivate_test.cpp

  @brief
  Unit test code for RRC controller state transitions:
  Inactive -> LTE To IRAT Started -> Inactive
...
TF_DEFINE_TEST_CASE(COMPONENT, LteRrcControllerIratToLteDeactivateTest);

void LteRrcControllerIratToLteDeactivateTest::Setup()
{
  lte_rrc_utf_setup(LTE_RRC_CONTROLLER_SM, ext_umid_list, 12);
}

void LteRrcControllerIratToLteDeactivateTest::Test()
{
  byte *buf_ptr;
  uint32 buf_len;
...
void LteRrcControllerIratToLteDeactivateTest::Teardown()
{
