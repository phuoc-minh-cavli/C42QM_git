...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_tlb_msg.h#1 $
...
enum
{
  ...
  MSGR_DEFINE_UMID(LTE, TLB, SPR, THREAD_KILL, LTE_APP_ID_THREAD_KILL, 
                   none),
   /* Indication from DS to inform TLB that DS is ready for incoming packets*/
  MSGR_DEFINE_UMID( LTE,TLB,IND,SND_DL_PKT,0x07,lte_ds_dl_enqueue_ind_s),
  /* Indication from DS to inform TLB that DS is ready for incoming packets*/
  MSGR_DEFINE_UMID( LTE,TLB,IND,TIMER_EXP,0x08,none)
};
