...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_pdcp_ext_api.h#1 $
...
05/13/15   sb      CR803880: modified PDCP interface for UDC feature
...
extern boolean _lte_pdcpdl_get_activity_statistics
(
  lte_eps_id_t                  eps_id,   /*!< eps ID */
  lte_pdcpdl_activity_stats_s*  stats_ptr /*!< pointer to caller provided 
                                               staticstics struct */ 
...
extern uint64 _lte_pdcpul_get_pdu_bytes_tx( lte_eps_id_t epsid );
...
extern void _lte_pdcpul_tag_each_pkt
(
  dsm_item_type* pkt_ptr      /*packet to be enqueued to PS-PDCP WM*/
);
/*==============================================================================
