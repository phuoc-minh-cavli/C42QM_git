...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_rlc_rrc.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
04/27/19   ss      CR2430067: CatM+GPS unload stop timer and fc activity and resume
06/28/17   ru      CR2048084: Revert PDCP SN in full config HO fail
...
typedef enum
{
  ...
  LTE_RLC_RB_ACTION_FULL_CONFIG  = 0x9  /*!< do full config */
} lte_rlc_rb_action_e;
...
typedef struct
{
  ...
  uint32 poll_byte_r14;      /*!< Indicates the value of constant Poll Byte defined in v1430
                                  Special value of 0 means the value is not provided, and hence 
                                  use the poll_byte (legacy). If non-zero value is provided, use 
                                  poll_byte_r14 instead */
...
/*==============================================================================
  ...
  FUNCTION:  lte_rlculi_get_num_active_rb

==============================================================================*/
/*!
    @brief
    Function to get the active number of configured RBs
...
*/
/*============================================================================*/
EXTERN uint8 lte_rlculi_get_num_active_rb
(
  void
);
