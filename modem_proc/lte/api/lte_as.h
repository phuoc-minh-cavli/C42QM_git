...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_as.h#1 $
...
*/
typedef uint32 lte_efs_earfcn_t;
...
/* DL BW limit for CAT-M */
#if defined (FEATURE_LTE_TRACKB) || defined (FEATURE_BUILD_PAGEONLY_IMAGE)
  #define LTE_CATM1_DL_BW_LIMIT LTE_BW_NRB_25
  #define LTE_CATM1_DL_BW_IDX_LIMIT LTE_BW_IDX_NRB_25
#else
  #define LTE_CATM1_DL_BW_LIMIT LTE_BW_NRB_50
  #define LTE_CATM1_DL_BW_IDX_LIMIT LTE_BW_IDX_NRB_50
#endif
...
#define LTE_FEICIC_DCCH_SIB1_SUPPORTED                                 FALSE
#define LTE_FEICIC_CRS_SUPPORTED                                 FALSE
...
/* bit 20 */
#define LTE_5X_AM_DRB_3X_UM_DRB                              FALSE
#define LTE_8X_AM_DRB                                        FALSE

/* bit 21 */
#ifdef FEATURE_LTE_CATM
#define LTE_PREDEFINED_INTRA_SUBFRAME_FREQ_HOPPING           FALSE
#define LTE_PREDEFINED_INTER_SUBFRAME_FREQ_HOPPING           FALSE
#else
...
#define LTE_PDCP_SN_EXTENSION_R11      TRUE
...
/*==============================================================================
  ...
  FUNCTION:  lte_mac_get_curr_celevel
...
*/
/*============================================================================*/
EXTERN uint8 lte_mac_get_curr_celevel ( void );
