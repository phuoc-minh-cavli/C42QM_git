/*!
  ...
  @detail
    ...
    $Header: //components/rel/lte.mpss/4.7.2/api/lte_l1_types.h#1 $
*/
...
#define LTE_CPHY_ZERO_HSFN                    0

#define LTE_CPHY_NULL_HYPER_SFN              0xFFFF

/*! Maximum UE Tx power */
#define LTE_ML1_UE_MAX_OUTPUT_POWER          23

/*! Maximum UE Tx power power class 2 */
#define LTE_ML1_UE_MAX_OUTPUT_POWER_CLASS2_UE  26
...
#define LTE_L1_MAX_BANDS_TO_UPDATE    3
...
/*! MPDCCH NB to monitor list size */
#define LTE_CPHY_MPDCCH_NB_TO_MONITOR_SIZE 2
...
*/
typedef uint16 lte_l1_hyper_sfn_t;
...
/*! @brief
  MIB CAT-M  configuration info
  Defined in TBD
*/
typedef struct
{
  /*! MIB inform is cell supports CAT-M scheduling */
  boolean           is_catm_cell;
} lte_l1_catm_cfg_param_s;
...
/*! @brief
  Cell selection parameters for enhanced coverage mode of operation
*/
typedef struct
{
  /*! Minimum Rx level to camp on cell (-70..-22) * 2 */
...
typedef enum
{
  ...
  LTE_L1_NB_ONESIXTYFOURTHT,
  LTE_L1_NB_ONEONETWENTYEIGTHT,
  LTE_L1_NB_ONETWOFIFTYSIXTHT,
} lte_l1_nb_e;

/*! Num PRB pairs R13 enum type
 */
typedef enum
{
  LTE_L1_NUM_PRB_PAIRS_R13_N6 = 6,
} lte_l1_num_prb_pairs_r13_e;

/*! Max num repetition for PDSCH for mode A
  36.331 Section 6.3.2
 */
typedef enum
{
  LTE_L1_PDSCH_MAX_NUM_REP_MODE_A_R16 = 16,
  LTE_L1_PDSCH_MAX_NUM_REP_MODE_A_R32 = 32,

} lte_l1_pdsch_max_num_rep_mode_a_e;

typedef enum
{
  LTE_LL1_EPDCCH_LOCALIZED = 0,
  LTE_LL1_EPDCCH_DISTRIBUTED,
  LTE_LL1_EPDCCH_MAX_TYPE
}lte_LL1_epdcch_transmission_type_enum;

#define LTE_CPHY_EPDCCH_MAX_NUM_SET   1 //Max number of ePDCCH set per carrier

/*! @brief 
    Indicates the quasi co-location behaviour to be used by the UE, type A and type B, as described 
    in TS 36.213 [23, 7.1.10].(ref: 36.331, 6.3.2)
*/
typedef enum
{
  LTE_L1_QCL_OP_TYPE_A,
  LTE_L1_QCL_OP_TYPE_B,  
} lte_l1_qcl_op_cfg_type_e;

#define LTE_CPHY_REMAP_QCL_MAX_NUM_CFG   4 //Max number of PDSCH-RE-MappingQCL-Config per carrier

/*! The ue id to be used for the paging interval */
typedef uint64 lte_l1_drx_ue_id_t;
...
typedef enum
{
  LTE_L1_ON_DURATION_TIMER_PSF300 = 300,
  LTE_L1_ON_DURATION_TIMER_PSF400 = 400,
  LTE_L1_ON_DURATION_TIMER_PSF500 = 500,
  LTE_L1_ON_DURATION_TIMER_PSF600 = 600,
  LTE_L1_ON_DURATION_TIMER_PSF800 = 800,
  LTE_L1_ON_DURATION_TIMER_PSF1000 = 1000,
  LTE_L1_ON_DURATION_TIMER_PSF1200 = 1200,
  LTE_L1_ON_DURATION_TIMER_PSF1600 = 1600
} lte_l1_on_duration_timer_r13_e;
...
typedef enum
{
  LTE_L1_DRX_RETX_TIMER_SF40 = 40,
  LTE_L1_DRX_RETX_TIMER_SF64 = 64,
  LTE_L1_DRX_RETX_TIMER_SF80 = 80,
  LTE_L1_DRX_RETX_TIMER_SF96 = 96,
  LTE_L1_DRX_RETX_TIMER_SF112 = 112,
  LTE_L1_DRX_RETX_TIMER_SF128 = 128,
  LTE_L1_DRX_RETX_TIMER_SF160 = 160,
  LTE_L1_DRX_RETX_TIMER_SF320 = 320
} lte_l1_drx_retx_timer_r13_e;

typedef enum
{
  LTE_L1_DRX_UL_RETX_TIMER_SF0 = 0,
  LTE_L1_DRX_UL_RETX_TIMER_SF1 = 1,
  LTE_L1_DRX_UL_RETX_TIMER_SF2 = 2,
  LTE_L1_DRX_UL_RETX_TIMER_SF4 = 4,
  LTE_L1_DRX_UL_RETX_TIMER_SF6 = 6,
  LTE_L1_DRX_UL_RETX_TIMER_SF8 = 8,
  LTE_L1_DRX_UL_RETX_TIMER_SF16 = 16,
  LTE_L1_DRX_UL_RETX_TIMER_SF24 = 24,
  LTE_L1_DRX_UL_RETX_TIMER_SF33 = 33,
  LTE_L1_DRX_UL_RETX_TIMER_SF40 = 40,
  LTE_L1_DRX_UL_RETX_TIMER_SF64 = 64,
  LTE_L1_DRX_UL_RETX_TIMER_SF80 = 80,
  LTE_L1_DRX_UL_RETX_TIMER_SF96 = 96,
  LTE_L1_DRX_UL_RETX_TIMER_SF112 = 112,
  LTE_L1_DRX_UL_RETX_TIMER_SF128 = 128,
  LTE_L1_DRX_UL_RETX_TIMER_SF160 = 160,
  LTE_L1_DRX_UL_RETX_TIMER_SF320 = 320  
}lte_l1_drx_ul_retrans_timer_e;
...
/* CatM related parameters */

/*! @brief UE Cat M type enum */
typedef enum
{
  LTE_L1_UE_CAT_M1  = 255, //Minus 1
  LTE_L1_UE_CAT_NB1 = 254, //Minus 2
} lte_l1_ue_cat_m_e;


/*! @brief Subframe pattern type enum */
typedef enum
{
  LTE_L1_SUBFRAME_PATTERN_10_BITS = 10,
  LTE_L1_SUBFRAME_PATTERN_40_BITS = 40,

} lte_l1_subframe_pattern_type_e;

/*! @brief Max num rep for mode A type enum */
typedef enum
{
  LTE_L1_MAX_NUM_REP_CE_MODE_A_R8  = 8,
  LTE_L1_MAX_NUM_REP_CE_MODE_A_R16 = 16,
  LTE_L1_MAX_NUM_REP_CE_MODE_A_R32 = 32

} lte_l1_max_num_rep_ce_mode_a_e;

/*! @brief FDD Hopping interval type enum */
typedef enum
{
  LTE_L1_FDD_HOP_INTERVAL_1 = 1,
  LTE_L1_FDD_HOP_INTERVAL_2 = 2,
  LTE_L1_FDD_HOP_INTERVAL_4 = 4,
  LTE_L1_FDD_HOP_INTERVAL_8 = 8

} lte_l1_fdd_hop_interval_e;

/*! @brief TDD Hopping interval type enum */
typedef enum
{
  LTE_L1_TDD_HOP_INTERVAL_1  = 1,
  LTE_L1_TDD_HOP_INTERVAL_5  = 5,
  LTE_L1_TDD_HOP_INTERVAL_10 = 10,
  LTE_L1_TDD_HOP_INTERVAL_20 = 20

} lte_l1_tdd_hop_interval_e;

/*! @brief Hopping config type enum */
typedef enum
{
  LTE_L1_HOP_CFG_OFF,
  LTE_L1_HOP_CFG_ON,
...
/*! @brief MPDCCH Hopping NB type enum */
typedef enum
{
  LTE_L1_MPDCCH_HOP_NB_2 = 2,
  LTE_L1_MPDCCH_HOP_NB_4 = 4,

} lte_l1_mpdcch_hop_nb_e;

/*! @brief Enhanced Coverage mode type enum */
typedef enum
{
  LTE_L1_ENH_COV_MODE_A,
  LTE_L1_ENH_COV_MODE_B,

} lte_l1_enh_cov_mode_e;

/*! @brief PUCCH Max Num repetition CE Mode A type enum */
typedef enum
{
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R1 = 1,
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R2 = 2,
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R4 = 3,
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R8 = 4

} lte_l1_pucch_max_num_rep_ce_mode_a_e;

/*! @brief PUCCH Max Num repetition CE Mode A type enum */
typedef enum
  {
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R64 = 64,
  LTE_L1_PUCCH_MAX_NUM_REP_CE_MODE_A_R128 = 128

} lte_l1_pucch_max_num_rep_ce_r14_mode_a_e;


/*! @brief Max Num repetition per preamble attempt type enum */
typedef enum
{
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N1   = 1,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N2   = 2,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N4   = 4,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N8   = 8,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N16  = 16,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N32  = 32,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N64  = 64,
  LTE_L1_MAX_NUM_REP_PER_PREABLE_ATTEMPT_N128 = 128

} lte_l1_max_num_rep_per_preamble_attempt_e;

/*! @brief CSI Num repetition CE type enum */
typedef enum
{
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V1     = 1,
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V2     = 2,
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V4     = 4,
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V8     = 8,
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V16    = 16,
  LTE_L1_MPDCCH_CSI_NUM_REP_CE_V32    = 32,

} lte_l1_csi_num_rep_ce_e;

/*! @brief MPDCCH Start SF CSS RA FDD type enum */
typedef enum
{
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V1     = 10,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V1DOT5 = 15,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V2     = 20,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V2DOT5 = 25,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V4     = 40,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V5     = 50,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V8     = 80,
  LTE_L1_MPDCCH_START_SF_CSS_RA_FDD_V10    = 100

} lte_l1_mdcch_start_sf_css_ra_fdd_e;

/*! @brief MPDCCH Start SF CSS RA TDD type enum */
typedef enum
{
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V1  = 10,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V2  = 20,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V4  = 40,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V5  = 50,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V8  = 80,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V10 = 100,
  LTE_L1_MPDCCH_START_SF_CSS_RA_TDD_V20 = 200

} lte_l1_mdcch_start_sf_css_ra_tdd_e;

/*! @brief MPDCCH Start SF UESS FDD type enum */
typedef enum
{
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V1     = 10,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V1DOT5 = 15,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V2     = 20,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V2DOT5 = 25,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V4     = 40,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V5     = 50,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V8     = 80,
  LTE_L1_MPDCCH_START_SF_UESS_FDD_V10    = 100

} lte_l1_mdcch_start_sf_uess_fdd_e;

/*! @brief MPDCCH Start SF UESS TDD type enum */
typedef enum
{
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V1  = 10,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V2  = 20,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V4  = 40,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V5  = 50,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V8  = 80,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V10 = 100,
  LTE_L1_MPDCCH_START_SF_UESS_TDD_V20 = 200

} lte_l1_mdcch_start_sf_uess_tdd_e;

/*! @brief RA response window size type enum */
typedef enum
{
  LTE_L1_RA_RSP_WIN_SIZE_20  = 20,
  LTE_L1_RA_RSP_WIN_SIZE_50  = 50,
  LTE_L1_RA_RSP_WIN_SIZE_80  = 80,
  LTE_L1_RA_RSP_WIN_SIZE_120 = 120,
  LTE_L1_RA_RSP_WIN_SIZE_180 = 180,
  LTE_L1_RA_RSP_WIN_SIZE_240 = 240,
  LTE_L1_RA_RSP_WIN_SIZE_320 = 320,
  LTE_L1_RA_RSP_WIN_SIZE_400 = 400

} lte_l1_ra_rsp_win_size_e;

/*! @brief SI repetition pattern type enum */
typedef enum
{
  LTE_L1_SI_REP_PATTERN_EVERYRF     = 1,
  LTE_L1_SI_REP_PATTERN_EVERY2NDRF  = 2,
  LTE_L1_SI_REP_PATTERN_EVERY4THRF  = 4,
  LTE_L1_SI_REP_PATTERN_EVERY8THRF  = 8,

} lte_l1_si_rep_pattern_e;

/*! @brief SI transport block size type enum */
typedef enum
{
  LTE_L1_SI_TBS_B152 = 152,
  LTE_L1_SI_TBS_B208 = 208,
  LTE_L1_SI_TBS_B256 = 256,
  LTE_L1_SI_TBS_B328 = 328,
  LTE_L1_SI_TBS_B408 = 408,
  LTE_L1_SI_TBS_B504 = 504,
  LTE_L1_SI_TBS_B600 = 600,
  LTE_L1_SI_TBS_B712 = 712,
  LTE_L1_SI_TBS_B808 = 808,
  LTE_L1_SI_TBS_B936 = 936,

} lte_l1_si_tbs_e;

/*! @brief MPDCCH PDSCH Hopping Narrow band type enum */
typedef enum
{
  LTE_L1_MPDCCH_PDSCH_HOP_NB_2 = 2,
  LTE_L1_MPDCCH_PDSCH_HOP_NB_4 = 4,

} lte_l1_mpdcch_pdsch_hop_nb_e;

/*! @brief MPDCCH paging max num repetition type enum */
typedef enum
{
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R1 = 1,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R2 = 2,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R4 = 4,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R8 = 8,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R16 = 16,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R32 = 32,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R64 = 64,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R128 = 128,
  LTE_L1_MPDCCH_MAX_NUM_REP_PAG_R256 = 256,

} lte_l1_mpdcch_max_num_rep_paging_e;

/*! @brief MPDCCH num repetition type enum */
typedef enum
{
  LTE_L1_MPDCCH_NUM_REP_R1 = 1,
  LTE_L1_MPDCCH_NUM_REP_R2 = 2,
  LTE_L1_MPDCCH_NUM_REP_R4 = 4,
  LTE_L1_MPDCCH_NUM_REP_R8 = 8,
  LTE_L1_MPDCCH_NUM_REP_R16 = 16,
  LTE_L1_MPDCCH_NUM_REP_R32 = 32,
  LTE_L1_MPDCCH_NUM_REP_R64 = 64,
  LTE_L1_MPDCCH_NUM_REP_R128 = 128,
  LTE_L1_MPDCCH_NUM_REP_R256 = 256,

} lte_l1_mpdcch_num_rep_e;

/*! @brief PRACH Starting subframe periodicity type enum */
typedef enum
{
  LTE_L1_PRACH_STARTING_SF_2 = 2,
  LTE_L1_PRACH_STARTING_SF_4 = 4,
  LTE_L1_PRACH_STARTING_SF_8 = 8,
  LTE_L1_PRACH_STARTING_SF_16 = 16,
  LTE_L1_PRACH_STARTING_SF_32 = 32,
  LTE_L1_PRACH_STARTING_SF_64 = 64,
  LTE_L1_PRACH_STARTING_SF_128 = 128,
  LTE_L1_PRACH_STARTING_SF_256 = 256,

} lte_l1_prach_starting_sf_e;

/*! @brief PRACH parameter list for enhanced coverage 
*/
typedef struct
{
  /*! prach-ConfigurationIndex, Range (0..63) */
  uint8 prach_cfg_index;

  /*! rach-FrequencyOffset, Range (0..94). For TDD the value range is dependent 
    on the value of prach-ConfigIndex.*/
  uint8 prach_freq_offset;

  /*! Indicates if prach_starting_sf is included */
  boolean prach_starting_sf_present;

  /*! PRACH starting subframe periodicity, expressed in number of slots available 
    for preamble transmission (PRACH opportunities), see TS 36.211.
    Value sf2 corresponds to 2 subframes, sf4 corresponds to 4 subframes and so on.
    EUTRAN configures the PRACH starting subframe periodicity larger than or equal.                                                                                                      
    to the Number of PRACH repetitions per attempt for each CE level              .                       
    (numRepetitionPerPreambleAttempt). */
  lte_l1_prach_starting_sf_e prach_starting_sf;

  /*! Max num repetitions per preamble attempt */
  lte_l1_max_num_rep_per_preamble_attempt_e max_num_rep_per_preamble_attempt;

  /*! Size of mpdcch_num_nb_to_monitor_list below */
  uint8 mpdcch_num_nb_to_monitor_list_size;

  /*! Narrowbands to monitor for M-PDCCH for RAR. Range 1..LTE_CPHY_MAX_AVAIL_NB */
  uint8 mpdcch_num_nb_to_monitor_list[LTE_CPHY_MPDCCH_NB_TO_MONITOR_SIZE];

  /*! Maximum number of repetitions for M-PDCCH common search space (CSS) 
    for RAR, Msg3 and Msg4 */
  lte_l1_mpdcch_num_rep_e mpdcch_num_rep_ra;

  /*! PRACH hopping config */
  lte_l1_hop_cfg_e prach_hop;

  /*! RA RSP Win Size for this CE level in ms */
  lte_l1_ra_rsp_win_size_e ra_rsp_win_size; 

  /*! Indicates whether RAR hopping cfg list is valid or not */
  boolean rar_hop_cfg_valid;

  /*! Frequency hoppng activation/deactivation for RAR/MSG3/MSG4  */
  lte_l1_hop_cfg_e rar_hop;

} lte_l1_prach_param_ce_s;
