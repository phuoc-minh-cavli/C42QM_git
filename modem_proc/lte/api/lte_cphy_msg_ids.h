...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_cphy_msg_ids.h#1 $
...
enum
{
  ...
  LTE_CPHY_SIB1_COMMON_CFG_ID = 0x53,
  LTE_CPHY_EDRX_HYPER_SFN_ID = 0x54,
  LTE_CPHY_EDRX_UE_PAGE_ID = 0x55,
  LTE_CPHY_CONTEXT_STORE_ID = 0x56,
  LTE_CPHY_CONTEXT_STORE_CNF_ID = 0x57,
  LTE_CPHY_GPS_GTS_ID = 0x58,
  LTE_CPHY_INIT_REQ_ID = 0x59,
  LTE_CPHY_POWER_CLASS_UPDATE_ID = 0x5A,
  LTE_CPHY_CFG_ID = 0x5B,
  LTE_CPHY_END_PROC_ID = 0x5C,
  LTE_CPHY_LOAD_REQ_ID = 0x5D,
  LTE_CPHY_UNLOAD_REQ_ID = 0x5E,
  LTE_CPHY_CE_INFO_REPORT_ID = 0x5F,
  LTE_CPHY_GET_NEXT_SFN_REPORT_ID = 0x60,
  LTE_CPHY_SET_SFN_CONFIG_REPORT_ID = 0x61,
  LTE_CPHY_CE_LEVEL_REPORT_ID = 0x62,
  LTE_CPHY_FMD_SPEED_INFO_ID = 0x63,   
};
...
enum 
{
  ...
  LTE_CPHY_IND_MPDCCH_DIRECT_IND_INFO_ID = 0x23,
  LTE_CPHY_EDRX_UIM_PAGE_ID = 0x24,
  LTE_CPHY_IND_TX_START_ID = 0x25,
  LTE_CPHY_IND_TX_END_ID = 0x26,
  LTE_CPHY_PSM_IND_ID = 0x27,
  LTE_CPHY_IND_UPDATE_MOBILITY_STATE_ID = 0x28,
  LTE_CPHY_IND_CELL_SEL_INFO_UPDATE_ID = 0x29,
#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
  LTE_CPHY_IND_BPLMN_EARFCN_STATUS_ID = 0x2a,
#endif
};
