...
$Header: //components/rel/lte.mpss/4.7.2/api/msgr_lte.h#1 $
...
#define MSGR_LTE_NS            MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x45 )
#define MSGR_LTE_ML1_POI       MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x46 )
#define MSGR_LTE_ML1_POI_SLEEPMGR       MSGR_TECH_MODULE( MSGR_TECH_LTE, 0x47 )
