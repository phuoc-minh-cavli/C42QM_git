...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_cphy_irat_meas_msg.h#1 $
...
#define LTE_CPHY_IMEAS_MAX_MEAS_CELLS       8

/*! Maximum number of cells that can be measured in a single meas req 
for X2L Connected mode*/
#define LTE_CPHY_IMEAS_MAX_MEAS_CELLS_TIMED 8
