...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_log_codes.h#1 $
...
#define LOG_WWAN_SCAN_RESULT_NB1_LOG_C   (0x38 + LOG_LTE_RRC_BASE_C)

#define LOG_WWAN_SCAN_RESULT_M1_LOG_C     (0x39 + LOG_LTE_RRC_BASE_C)
...
/* @brief LTE ML1 SLEEPMGR EDRX params log code */
#define LOG_LTE_ML1_SLEEPMGR_EDRX_LOG_C    (0x80 + LOG_LTE_ML1_BASE_C)

/*! @brief Total number of LTE ML1 log codes. This macro needs to be updated if more log codes are added  */
#define LOG_LTE_ML1_TOTAL_LOG_CODES                 (LOG_LTE_ML1_SLEEPMGR_EDRX_LOG_C-LOG_LTE_ML1_BASE_C+1)
