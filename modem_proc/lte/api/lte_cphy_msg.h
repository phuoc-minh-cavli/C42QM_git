...
$Header: //components/rel/lte.mpss/4.7.2/api/lte_cphy_msg.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
05/25/16   oh      ML1-MAC interface changes for CatM1.
...
/*! @brief Maximum available narrow bands */
#define LTE_CPHY_MAX_AVAIL_NB 16

/*! @brief Maximum Value will be set 0x7F for non CatM1 case */
#define LTE_CPHY_MAX_RSRP_MEASUREMENT 0x7F

/*! @brief Maximum number of enhanced coverage levels */
#define LTE_CPHY_MAX_CE_LEVEL 4

/*! Default UL DL valid bitmap */
#define LTE_CPHY_DEFAULT_UL_DL_VALID_BITMAP_10 0x3FF
#define LTE_CPHY_DEFAULT_UL_DL_VALID_BITMAP_40 0xFFFFFFFFFF

/*! CAT-M COMBINATORIAL INDEX values. 
This is to indentify one of the RB pair out of 6RBs in the narrow band */
#define LTE_CPHY_MAX_COMBINATORIAL_INDEX 14
#define LTE_CPHY_MIN_COMBINATORIAL_INDEX 0

/*Only CE levels 0 and 1 are supported*/
#define LTE_RRC_MAX_SUPPORTED_CE_LEVEL 2

/* CE Reporting periodicity in msec */
#define LTE_CPHY_CE_RPT_PERIODICITY 500

/*! @brief Size of RSRP thresholds PRACH Info List Size */
#define LTE_MAC_RSRP_THRESH_PRACH_LIST_SIZE 3

#define LTE_CPHY_MAX_NUM_CELL_UNBAR 16
...
typedef struct
{
  ...
  /*! Flag indicator whether early exit will be needed for this frequency during acqusition */
  boolean            early_exit_needed;
...
typedef struct
{
  ...
  /*! Early exit enabled for this scan band: 
  TRUE: enable early exit, FALSE: disable early exit in this band scan */
  boolean  early_exit_enabled;
...
/*!
  @brief
  An enum describing  scan type
  */
typedef enum
{
  LTE_CPHY_SCAN_DUE_TO_RLF,
  //LTE_CPHY_SCAN_INTERNAL_BEFORE_OOS,
  LTE_CPHY_SCAN_DUE_TO_CS_FALLBACK,
  LTE_CPHY_SCAN_DUE_TO_REDIR,  //both List redirection and full redirection
  LTE_CPHY_SCAN_DUE_TO_POWER_UP,
  LTE_CPHY_SCAN_OTHERS
}lte_cphy_scan_type_e;
...
typedef struct
{
  ...
  /*! Scan Type */
  lte_cphy_scan_type_e  scan_type;
...
/*! @brief
    PDSCH config common params for Rel-13 (ref: 36.331, 6.3.2)
*/
typedef struct {

  /*! Maximum value to indicate the set of PDSCH repetition numbers for CE mode A, 
    see TS 36.211 and TS 36.213 */
  lte_l1_pdsch_max_num_rep_mode_a_e pdsch_max_num_rep_mode_a;

} lte_cphy_pdsch_cfg_common_r13_s;
...
typedef struct {
  ...
  */
  ...
  /*! Indicates if pdsch_cfg_r13 is valid */
  boolean pdsch_cfg_common_r13_valid;

  /*! PDSCH config common for Rel-13 */
  lte_cphy_pdsch_cfg_common_r13_s pdsch_cfg_common_r13;
...
/*! @brief  CE PDSCH PUSCH enhancement R14  
*/
typedef struct
{
  

  boolean ce_pdsch_pusch_enh_cfg_enabled;


} lte_cphy_pdsch_pusch_cfg_r14_s;
...
typedef struct {
 ...
 /*! CE PDSCSH PUSCH enhancememnt config in PDSCH cfg dedicated*/
 lte_cphy_pdsch_pusch_cfg_r14_s ce_pdsch_pusch_enh_config_v1430;
...
/*! @brief  PUCCH cfg Rel-13 parameters 
*/
typedef struct
{
  /*! Size of the n1_pucch_an_r13_list below, if size is 0, ML1 has to delete
    previously configured values */
  uint8 n1_pucch_an_r13_list_size;

  /*!<  Starting offsets of the PUCCH resource(s) indicated by SIB1-BR. 
    It can be configured separately per PUCCH repetition level.  Range 0..2047 */
  uint16 n1_pucch_an_r13_list[LTE_CPHY_MAX_CE_LEVEL];

  /*! Indicates if PUCCH Num repetitions for CE MSG4 level 0 is valid or not */
  boolean pucch_num_rep_ce_msg4_lvl0_valid;

  /*! Number of repetitions for PUCCH carrying HARQ response to PDSCH containing 
    Msg4 for PRACH CE levels 0*/
  lte_l1_pucch_max_num_rep_ce_mode_a_e pucch_num_rep_ce_msg4_lvl0;

  /*! Indicates if PUCCH Num repetitions for CE MSG4 level 1 is valid or not */
  boolean pucch_num_rep_ce_msg4_lvl1_valid;

  /*! Number of repetitions for PUCCH carrying HARQ response to PDSCH containing 
    Msg4 for PRACH CE levels 1 */
  lte_l1_pucch_max_num_rep_ce_mode_a_e pucch_num_rep_ce_msg4_lvl1;

} lte_cphy_pucch_cfg_r13_s;

/*! @brief  PUCCH cfg Rel-14 parameters 
*/
typedef struct
{


  /*! Indicates if PUCCH Num repetitions for CE MSG4 level 3 is valid or not */
  boolean pucch_num_rep_ce_msg4_lvl3_valid;

  /*! Number of repetitions for PUCCH carrying HARQ response to PDSCH containing 
    Msg4 for PRACH CE levels 3*/
  lte_l1_pucch_max_num_rep_ce_r14_mode_a_e pucch_num_rep_ce_msg4_lvl3;

} lte_cphy_pucch_cfg_r14_s;
...
typedef struct {
  ...
  /*! Indicates if PUCCH cfg R13 is valid or not. If set to FALSE, ML1 shall delete
    all the configured parameters within pucch_cfg_r13 */
  boolean pucch_cfg_r13_valid;

  /*! PUCCH cfg Rel-13 parameters */
  lte_cphy_pucch_cfg_r13_s pucch_cfg_r13;

  
  /*! Indicates if PUCCH cfg R14 is valid or not. If set to FALSE, ML1 shall delete
    all the configured parameters within pucch_cfg_r13 */
  boolean pucch_cfg_r14_valid;

  /*! PUCCH cfg Rel-13 parameters */
  lte_cphy_pucch_cfg_r14_s pucch_cfg_r14;
...
/*! @brief  PUSCH cfg Rel-13 parameters 
*/
typedef struct
{
  /*! Indicates if max_num_rep_mode_a is valid or not */
  boolean max_num_rep_mode_a_valid;

  /*!<  Maximum value to indicate the set of PUSCH repetition numbers for ECCE mode A */
  lte_l1_max_num_rep_ce_mode_a_e max_num_rep_mode_a;

  /*! Indicates if pusch_hop_offset is valid or not */
  boolean pusch_hop_offset_valid;

  /*!<  Parameter: N_RB_HO in TS 36.211 range from 1..6 */
  uint8 pusch_hop_offset;

} lte_cphy_pusch_cfg_r13_s;
...
typedef struct {
  ...
  */
  ...
  /*! Boolean to indicate if pusch_cfg_r13 parameters are enabled;
    If set to FALSE, ML1 has to delete previously configured 
    pusch_cfg_r13 parameters */
  boolean pusch_cfg_r13_valid;

  /*! PUSCH cfg Rel-13 parameters */
  lte_cphy_pusch_cfg_r13_s pusch_cfg_r13;

} lte_cphy_pusch_cfg_common_param_s;

/*! @brief  MPDCCH Start SF CSS RA parameters
*/
typedef struct
{
  lte_l1_cell_duplex_e mpdcch_start_sf_css_ra_duplex_mode;

  /*! Starting subframe configuration for M-PDCCH common search space (CSS) 
    for RAR, Msg3 retransmission, PDSCH with contention resolution and PDSCH 
    with RRCConnectionSetup */
  uint8 mpdcch_start_sf_css_ra;

} lte_cphy_mpdcch_start_sf_css_ra_s;

/*! @brief  MPDCCH Start SF UESS parameters 
*/
typedef struct
{
  lte_l1_cell_duplex_e mpdcch_start_sf_uess_duplex_mode;

  /*! Starting subframe configuration for an MPDCCH UE-specific search space, see TS 36.211. 
  Value v1 corresponds to 1, value v1dot5 corresponds to 1.5, and so on.*/
  uint8 mpdcch_start_sf_uess;

} lte_cphy_mpdcch_start_sf_uess_s;


/*! @brief Preamble mapping information for a CE level
*/
typedef struct
{
  /*! First Preamble, range (0..63) */
  uint8 first_preamble;

  /*! GroupB preamble = (groupb_preamble + 1) to last_preamble  
         Note that in case there is no GroupB, then  groupb_preamble = last_preamble  
       Groub Preamble, range (1..63) */
  uint8 groupb_preamble;

  /*! Last Preamble, range (0..63) */
  uint8 last_preamble;
  
} lte_mac_preamble_map_info_s;


/*! @brief RACH configuration parameters per CE level 
*/
typedef struct
{
  /*! Preamble mapping info */
  lte_mac_preamble_map_info_s preamble_map_info;

  /*! Contention timer in ms 
    Valid values: 80, 100, 120, 160, 200, 240 */
  uint16 contention_resol_tmr; 

} lte_mac_rach_param_ce_s;

/*! @brief PRACH configuration parameters per CE level 
*/
typedef struct
{

  /*! Indicates UE ce_capability is supported.
         For now, Only CE levels 0 and 1 are supported*/
  boolean ce_capability_support;

  /*! Indicates if max_preamble_tx_per_ce is included */
  boolean max_preamble_tx_attempt_per_ce_present;

  /*! Max number of premable transmission attempts per CE level; Valid values: 3, 4, 5, 6, 7, 8, 10 */
  uint8 max_preamble_tx_attempt_per_ce;

  /*! Indicates if rach_param_ce is valid or not. If set to FALSE, MAC shall delete 
      the previously configured values */
  boolean rach_param_ce_valid;

  /*! RACH parameters per CE level */
  lte_mac_rach_param_ce_s rach_param_ce;

} lte_mac_rach_prach_param_ce_s;

/*! @brief  PRACH cfg Rel-13 parameters 
*/
typedef struct
{
  /*! Indicates if mpdcch_start_sf_css_ra is valid or not */
  boolean mpdcch_start_sf_css_ra_valid;

  /*! MPDCCH Start SF CSS RA parameters */
  lte_cphy_mpdcch_start_sf_css_ra_s mpdcch_start_sf_css_ra;

    /*! Indicates whether PRACH hopping offset is valid or not */
  boolean prach_hop_offset_valid;

  /*! PRACH Hopping offset, range 0..94 */
  uint8 prach_hop_offset;

   /*! Size of prach_param_ce_list below, if size is 0, ML1 has to delete
    previously configured values */
  uint8 prach_param_ce_list_size;

  /*! PRACH parameter list for enhanced coverage */
  lte_l1_prach_param_ce_s prach_param_ce_list[LTE_CPHY_MAX_CE_LEVEL];

  /*! Indicates if initial_ce_level is valid. If set to FALSE 
    MAC should delete the previously configured value */
  boolean initial_ce_level_valid;

  /*!< Initial CE level, range (1..LTE_CPHY_MAX_CE_LEVEL) */
  uint16 initial_ce_level;          

} lte_cphy_prach_cfg_r13_s;

/*! @brief CE Info related parameters
*/
typedef struct
{

  /*! Size of MAC RACH/PRACH param list for each CE level
  If the value is 0, ML1 should delete previously configured values */
  uint8                     rach_prach_list_ce_size;

  /*! Indicates if max_preamble_tx_per_ce is included */
  /*! Indicates UE ce_capability is supported.
      For now, Only CE levels 0 and 1 are supported*/
  /*! Indicates if rach_param_ce is valid or not. If set to FALSE, ML1 shall delete
      the previously configured values */
  lte_mac_rach_prach_param_ce_s *rach_prach_ce_list;

/*! Size of RSRP threshold list size 
  If the value is 0, ML1 should delete previously configured values */
  uint8                     rsrp_thresh_prach_list_size;
  
  /*! The criterion for UE to select PRACH resource set. Up to 3 RSRP threshold 
  values are signalled to determine the enhanced coverage level for PRACH */
  lte_cphy_conn_meas_rsrp_t *rsrp_thresh_prach_list;

}lte_cphy_prach_cfg_ce_info_param_s;
...
typedef struct
{
  ...
  /*! Indicates whether prach_cfg_r13 is valid 
    If set to FALSE, ML1 shall delete previously configured values */
  boolean prach_cfg_r13_valid;

  /*! PRACH Rel-13 parameters */
  lte_cphy_prach_cfg_r13_s prach_cfg_r13;

  /*! CE INFO parameters */
  lte_cphy_prach_cfg_ce_info_param_s lte_cphy_prach_cfg_ce_info_param;
...
} __attribute__((aligned(4))) lte_cphy_srs_cfg_common_param_s;
...
typedef struct
{
  /*! Number of paging narrow bands, range (1..LTE_CPHY_MAX_AVAIL_NB) */
  uint8 num_paging_nb;

  /*! Maximum number of repetitions for M-PDCCH common search space (CSS) for paging, 
    see TS 36.211 */
  lte_l1_mpdcch_max_num_rep_paging_e mpdcch_max_num_rep;

} lte_cphy_pcch_cfg_r13_s;
...
typedef struct
{
  ...
  /*! nb value - used to derive the number of paging groups 
    nB-v1310 will also be signaled using this IE */
  lte_l1_nb_e nb;
  ...
  /*! Indicates if pcch_cfg_r13 is valid. If set to FALSE, ML1 should delete
    previously configured parameters */
  boolean pcch_cfg_r13_valid;

  /*! PCCH config Rel-13 */
  lte_cphy_pcch_cfg_r13_s pcch_cfg_r13;
...
typedef struct
{
  ...
  /* EDRX paging cycles in ms are 5120, 10240, 20480, 40960, 81920, 163840, 327680,
                                   655360, 1310720, 2621440 ms */
...
typedef struct
{
  ...
  /*! Boolean indicates if on duration timer r13 is valid; R13 value overrides legacy value if valid*/
  boolean on_duration_timer_r13_valid;
  /*! On Duration Timer [36.321]. Value in number of PDCCH sub-frames.
    Default value is [FFS]. Value psf1 corresponds to 1 PDCCH subframe,
    psf2 corresponds to 2 PDCCH sub-frames and so on */
  lte_l1_on_duration_timer_r13_e on_duration_timer_r13;

  /*! Boolean indicates if retx timer r13 is valid; R13 value overrides legacy value if valid*/
  boolean retx_timer_r13_valid;
  /*! DRX Retransmission Timer [36.321]. Value in number of PDCCH sub-frames. */
  lte_l1_drx_retx_timer_r13_e retx_timer_r13;

  /*! Boolean indicates if DRX ULRetransmission timer is valid*/
  boolean ul_retransmission_timer;

  /*! UL Retransmission timer for DRX. Value in number of PDCCH sub-frames
          Value psf0 correponds to no retransmission timer*/
  lte_l1_drx_ul_retrans_timer_e ul_retx_timer;
...
typedef enum
{
  LTE_CPHY_POWER_CLASS1 = 1,            
  LTE_CPHY_POWER_CLASS2 = 2,
  LTE_CPHY_POWER_CLASS3 = 3,
  LTE_CPHY_POWER_CLASS3_DEFAULT = LTE_CPHY_POWER_CLASS3,
  LTE_CPHY_POWER_CLASS4 = 4,
  LTE_CPHY_POWER_CLASS5 = 5,
  LTE_CPHY_POWER_CLASS6 = 6,
  LTE_CPHY_POWER_CLASS_MAX = 7,
}lte_cphy_power_class_e;
...
typedef struct {
  ...
  /*! Indicates if cell_select_info_ce is present or not */
  boolean cell_select_info_ce_present;

  /*! Cell selection info CE */
  lte_l1_cell_select_info_ce_s cell_select_info_ce;
...
/*! @brief
    PUCCH config dedicated params Rel-13 (ref: 36.331, 6.3.2)
*/
typedef struct 
{
  /*! PUCCH max num repetition CE for Mode A format 1 */
  lte_l1_pucch_max_num_rep_ce_mode_a_e fmt_1;

  /*! PUCCH max num repetition CE for Mode A format 2 */
  lte_l1_pucch_max_num_rep_ce_mode_a_e fmt_2;

} lte_cphy_pucch_max_num_rep_ce_mode_a_s;

typedef struct
{
  /* INTEGER   (0 .  . 503 ) */
  uint16 n_pucch_id_r13;
  /* INTEGER   (0 .  . 2047 ) */
  uint16 n_pucch_an_r13;
} lte_cphy_n_pucch_cfg_param_s;
...
typedef struct 
{
  /* Indicates if PUCCH max num repetition CE is enabled */
  boolean max_num_rep_ce_enabled;

  /*! Indicates*/
  lte_l1_enh_cov_mode_e ce_mode;

  /*! Max Num repetition for CE mode A/B format
      Mode A defined for now. Mode B to be added in future */
  union 
  {
    lte_cphy_pucch_max_num_rep_ce_mode_a_s max_num_rep_mode_a_fmt;

  } max_num_rep_ce_mode_fmt_u;

  /*! Indicates*/
  boolean n_pucch_cfg_param_enable;

  lte_cphy_n_pucch_cfg_param_s n_pucch_cfg_param;

} lte_cphy_pucch_cfg_dedicated_rel13_param_s;
...
typedef struct {
  ...
  */
  ...
  /*! Indicate rel10_pucch_cfg is valid or not, if set to FALSE, ML1 shall
    delete all parameters within rel10_pucch_cfg */
  boolean rel10_pucch_cfg_valid;

  /*! Parameters required to configure dedicated Rel-10 PUCCH cfg */
  lte_cphy_pucch_cfg_dedicated_rel10_param_s rel10_pucch_cfg;

  /*! Indicate rel13_pucch_cfg is valid or not, if set to FALSE, ML1 shall
    delete all parameters within rel13_pucch_cfg */
  boolean rel13_pucch_cfg_valid;

  /*! Parameters required to configure dedicated Rel-13 PUCCH cfg */
  lte_cphy_pucch_cfg_dedicated_rel13_param_s rel13_pucch_cfg;
...
/*! @brief
    Rel-13 PUSCH config dedicated params (ref: 36.331, 6.3.2)
*/
  
typedef struct {
  
  /*! Indicates if PUSCH hopping is enabled */
  boolean pusch_hop_enabled;

  /*! PUSCH hopping config */
  lte_l1_hop_cfg_e pusch_hop;

}lte_cphy_pusch_rel13_cfg_dedicated_param_s;

/*! @brief
    Rel-14 PUSCH config dedicated params
*/
...
typedef struct {
  ...
  FALSE - disabled
  */
  boolean pusch_ce_nb_maxTbs_cfg_enabled;

}lte_cphy_pusch_rel14_cfg_dedicated_param_s;
...
typedef struct {
  ...
  /*! Indicate if Rel-13 PUSCH cfg valid or not*/
  boolean rel13_pusch_cfg_valid;

  /*! PUSCH rel13 cfg */
  lte_cphy_pusch_rel13_cfg_dedicated_param_s rel13_pusch_cfg;

  /*! Indicate if Rel-14 PUSCH cfg is valid or not*/
  boolean rel14_pusch_cfg_valid;

  /*! PUSCH rel14 cfg */
  lte_cphy_pusch_rel14_cfg_dedicated_param_s rel14_pusch_cfg;

  /*! PDSCH PUSCH enhancement config IN PUSCH cfg dedicated*/
  lte_cphy_pdsch_pusch_cfg_r14_s ce_pdsch_pusch_enh_config_v1430;
...
} __attribute__((aligned(4))) lte_cphy_srs_cfg_dedicated_param_s;
...
/*!
  @brief
  An enum describing  MIB rep status type
  UNDEFINED: IE absent in Mobility msg
  TRUE: MIB REP status TRUE 
  FALSE:MIB REP status FALSE
  */
typedef enum
{
  LTE_CPHY_MIB_REP_STATUS_UNDEFINED,
  LTE_CPHY_MIB_REP_STATUS_TRUE,
  LTE_CPHY_MIB_REP_STATUS_FALSE
}lte_cphy_mib_rep_type_e;
...
typedef struct
{
 ...
 /*!This field indicates that the target cell has the same SFN as the source cell*/
  boolean same_sfn_src_cell;  

  /*!Indicates that SIB1 BR scheduling info is present in reconfig message*/
  boolean sched_info_sib1_br_valid;

  /*!Indicates the index to the tables that define SystemInformationBlockType1-BR scheduling information
    Range: 0-31*/
  uint8 sched_info_sib1_br; 

  /*! Indicates the MIB repeitition status (Undefined, TRUE or FALSE) obtained in Mobility info*/
  lte_cphy_mib_rep_type_e mib_rep_status;
...
/*! @brief
    An enum describing Hyper SFN config type
  */
typedef enum
{
  LTE_CPHY_HSFN_CFG_NONE,  /* Not Valid */
  LTE_CPHY_HSFN_CFG_RRC,   /* Customized RRC HSFN */
  LTE_CPHY_HSFN_CFG_SIB1,  /* HSFN from SIB1 OTA */
} lte_cphy_hsfn_cfg_type_e;
...
typedef struct{
  ...
  lte_l1_sfn_t         curr_sfn_val;

  lte_l1_hyper_sfn_t   hyper_sfn_val;

  /* HSFN Config Type */
  lte_cphy_hsfn_cfg_type_e hsfn_cfg_type;
}lte_cphy_edrx_hyper_sfn_req_s;
...
}lte_cphy_edrx_uim_page_ind_s;

/*! @brief 
  LTE TX start info provided to GNSS
*/

typedef struct{

   /*! Time of next scheduled LTE Tx start, in MPSS time ticks in ms */
   uint32                 tx_start_time;
   
   /*! Duration of the next scheduled LTE Tx in 1ms */
   uint32                 tx_duration;
   
   /*! LTE Tx Band information */
   sys_sband_lte_e_type   tx_band;
   
   /*! Bandwidth of Tx in kHz */
   lte_bandwidth_e        tx_bw;
   
   /*! Power of the concerned LTE Tx in dBm */
   int32                  tx_pwr;
...
} lte_cphy_tx_start_info_s;

/*! @brief structure for indicating the start 
    of the LTE Tx session to its clients through MSGR 
*/
...
typedef struct{
  ...
  /*! Message header */
   ...
   lte_cphy_tx_start_info_s   tx_start_info;
   
} lte_cphy_tx_start_ind_s;

/*! @brief 
  LTE TX end info provided to GNSS
*/
...
} lte_cphy_tx_end_info_s;

/*! @brief structure for indicating the end of the 
    LTE Tx session to its clients through MSGR 
*/
...
typedef struct{
  ...
  lte_cphy_tx_end_info_s       tx_end_info;
  
} lte_cphy_tx_end_ind_s;
...
/*! @brief Valid FDD subframes bitmap 
*/
typedef struct
{
  /*! If set to TRUE, determine the valid DL subframes from the bitmap.
    If set to FALSE, then non-MBSFN subframes are considered as valid subframes 
    for FDD downlink. If no MBSFN configuration is indicated then all downlink 
    subframes are considered as valid subframes for downlink transmission */
  boolean fdd_dl_subframe_map_valid;

  /*! Indicates the number of bits used to indicate DL subframe pattern 
    in fdd_dl_subframe_map */
  lte_l1_subframe_pattern_type_e dl_subframe_pattern_type;

  /*! Valid DL subframes; 
    For subframePattern10, 10 LSBs will be used 
    For subframePattern40, 40 LSBs will be used*/
  uint64 fdd_dl_subframe_map;

  /*! If set to TRUE, determine the valid UL subframes from the bitmap.
    If set to FALSE, then all uplink subframes are considered as valid subframes 
    for uplink transmissions. */
  boolean fdd_ul_subframe_map_valid;

  /*! Valid FDD UL subframes, 10 LSBs will be used*/
  uint16 fdd_ul_subframe_map;

} lte_cphy_fdd_subframe_bitmap_s;

/*! @brief Valid TDD subframes bitmap 
*/
typedef struct
{
  /*! If set to TRUE, determine the valid TDD subframes from the bitmap.
    If set to FALSE, then non-MBSFN subframes are considered as valid subframes 
    for TDD transmissions. If no MBSFN configuration is indicated then all downlink 
    subframes are considered as valid subframes for downlink transmission and all 
    uplink subframes are considered as valid subframes for TDD uplink transmissions */
  boolean tdd_subframe_map_valid;

  /*! Indicates the number of bits used to indicate subframe pattern 
    in tdd_subframe_map */
  lte_l1_subframe_pattern_type_e subframe_pattern_type;

  /*! Valid DL subframes; 
    For subframePattern10, 10 LSBs will be used 
    For subframePattern40, 40 LSBs will be used*/
  uint64 tdd_subframe_map;

} lte_cphy_tdd_subframe_bitmap_s;

/*! @brief Valid UL / DL subframes bitmap 
*/
typedef struct
{
  /*! Duplex mode that determines the bitmap union type to use,
    Only FDD or TDD mode can be used here */
  lte_l1_cell_duplex_e duplex_mode;

  union 
  {
    /*! FDD bitmap of valid UL/DL subframes */
    lte_cphy_fdd_subframe_bitmap_s fdd_bitmap;

    /*! TDD bitmap of valid subframes */
    lte_cphy_tdd_subframe_bitmap_s tdd_bitmap;

  } bitmap_u;

} lte_cphy_ul_dl_subframe_bitmap_s;

/*! @brief Frequency Hopping parameters 
*/
typedef struct
{

  /*! Indicates if DL hopping config for mode A is valid or not */
  boolean interval_hop_cfg_dl_mode_a_valid;

  /*! Indicates if DL hopping config for mode B is valid or not */
  boolean interval_hop_cfg_dl_mode_b_valid;

  /*! Duplex mode that determines the interval union type to use,
    Only FDD or TDD mode can be used here */
  lte_l1_cell_duplex_e duplex_mode;

  /*! DL Hopping interval for Mode A */
  uint32 dl_hop_interval_mode_a;

  /*! DL Hopping interval for Mode B */
  uint32 dl_hop_interval_mode_b; 

} lte_cphy_interval_hop_dl_cfg_s;
...
typedef struct
{
  ...
  /*! Indicates if UL hopping config for mode A is valid or not */
  boolean interval_hop_cfg_ul_mode_a_valid;

  /*! UL Hopping interval for Mode A */
  uint32 ul_hop_interval_mode_a;

} lte_cphy_interval_hop_ul_cfg_s;

/*! @brief Frequency Hopping parameters 
*/
typedef struct
{
  /*! Indicates whether frequency hopping parameters are valid or not
    If set to FALSE, ML1 has to delete all the previously configured parameters */
  boolean freq_hop_param_valid;

  /*! Indictes if mpdcch_pdsch_hop_nb is valid or not */
  boolean mpdcch_pdsch_hop_nb_valid;

  /*! The number of narrowbands for E-PDCCH/PDSCH frequency hopping */
  lte_l1_mpdcch_pdsch_hop_nb_e mpdcch_pdsch_hop_nb;

  /*! Indicates if DL/UL hopping config is valid or not */
  boolean interval_hop_cfg_valid;

  /*! Interval hop config */
  lte_cphy_interval_hop_dl_cfg_s interval_hop_cfg;

  /*! Indicates whether MPDCCH Hopping offset is valid or not */
  boolean mpdcch_pdsch_hop_offset_valid;

  /*! Frequency hopping offset for E-PDCCH/PDSCHPUSCH, 
    range (1..LTE_CPHY_MAX_AVAIL_NB) */
  uint8 mpdcch_pdsch_hop_offset;

} lte_cphy_freq_hop_param_s;
...
enum
{
  ...
  LTE_CPHY_COMMON_CFG_MASK_BIT_FREQ_HOP_UL_PARAM = 0x10000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_PHICH_CFG = 0x20000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_ANTENNA_CFG = 0x40000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_P_MAX = 0x80000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_NCELL_CFG = 0x100000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_FREQ_HOP_PARAM = 0x200000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_POWER_CLASS_CFG = 0x400000,
  LTE_CPHY_COMMON_CFG_MASK_BIT_DUPLEX_SPACING_CFG = 0x800000,
  LTE_CPHY_COMMON_CFG_CURRENT_VALID_MASK_BITS = 0x7FFFFF
};
...
/*! @brief
  ...
  @see lte_cphy_common_cfg_mask_bit_e for a description of the bits
       in this mask.
*/
typedef uint32 lte_cphy_common_cfg_mask_t;
...
enum
{
  ...
  LTE_CPHY_DEDICATED_CFG_MASK_BIT_ENH_COV_MODE = 0x400000,
  LTE_CPHY_DEDICATED_CFG_MASK_BIT_EPDCCH_CFG = 0x800000,
  LTE_CPHY_DEDICATED_CFG_MASK_BIT_PDSCH_CFG_R11 = 0x1000000,
  LTE_CPHY_DEDICATED_CFG_MASK_BIT_PDSCH_CFG_R14 = 0x2000000,
  /*! UPDATE the value below whenever any of the above bitmasks change */
  LTE_CPHY_DEDICATED_CFG_CURRENT_VALID_MASK_BITS = 0x3FFFFFF
} ;
...
typedef struct
{
  /*! Field to indicated if enhanced coverage mode is enabled */
  boolean enh_cov_mode_enabled;

  /*! Enhanced coverage mode */
  lte_l1_enh_cov_mode_e enh_cov_mode;

} lte_cphy_dedicated_enh_cov_mode_s;
...
/*! @brief MPDCCH configuration paramters 
*/
typedef struct
{
  /*! Number of subframes for CSI reference resource, see TS 36.213. 
    Value sf1 corresponds to 1 subframe, sf2 corresponds to 2 subframes and so on.*/
  lte_l1_csi_num_rep_ce_e csi_num_rep_ce;

  /*! Frequency hopping activation/deactivation for unicast MPDCCH/PDSCH */
  lte_l1_hop_cfg_e mpdcch_pdsch_hop;

  /*! Starting subframe configuration for an MPDCCH UE-specific search space */
  lte_cphy_mpdcch_start_sf_uess_s mpdcch_start_sf_uess;

  /*! Maximum numbers of repetitions for UE-SS for MPDCCH */
  lte_l1_mpdcch_num_rep_e mpdcch_num_rep;

  /*! Narrowband for UE-SS for MPDCCH, range (1..LTE_CPHY_MAX_AVAIL_NB) */
  uint8 mpdcch_nb;

} lte_cphy_mpdcch_cfg_s;

/*! @brief typedef for EPDCCH set RB assignment
*/
typedef uint64 lte_cphy_epdcch_rb_assign_t;

/*! @brief
   EPDCCH configuration set
*/
typedef struct
{
  /*! EPDCCH configuration set id, Range (0..1) */
  uint8 config_set_id;

  /*! EPDCCH transmission mode type */
  lte_LL1_epdcch_transmission_type_enum tx_mode_type;

  /*! Number of physical resource-block pairs used for the EPDCCH set (2,4,8) */
  uint8 num_prb_pairs;

  /*! Indicates the index to a specific combination of physical resource-block pair 
    for EPDCCH set as per TS 36.213 [23, 9.1.4.4], rb_pair_combo_idx size can be 4 to 38 bits */
  lte_cphy_epdcch_rb_assign_t rb_pair_combo_idx;

  /*! DMRS scrambling sequence initialization parameter as defined in 
    TS 36.211[21, 6.10.3A.1], Range (0..503) */
  uint16 dmrs_scram_seq_int;

  /*! PUCCH format 1a and 1b resource starting offset for the EPDCCH set, Range (0..2047) */
  uint16 pucch_resrc_start_offset;

  /*! Indicates if PDSCH-Remapping-QCL-Config-id is valid or not; 
    Can only be valid for TM10 */
  boolean remap_qcl_cfg_id_enabled;

  /*! PDSCH-Remapping-QCL-Config-id, Range (1..4) */
  uint8 remap_qcl_cfg_id;

  /*! Indicates if num_prb_pairs_r13 is enabled */
  boolean num_prb_pairs_r13_enabled;

  /*! Num PRBS pairs r13 */
  lte_l1_num_prb_pairs_r13_e num_prb_pairs_r13;

  /*! Indicates if mpdcch_cfg is enabled. If set to FALSE, ML1 should
    delete the previously configured parameters */
  boolean mpdcch_cfg_enabled;

  /*! MPDCCH config parameters */
  lte_cphy_mpdcch_cfg_s mpdcch_cfg;
  
} lte_cphy_epdcch_set_config_s;

/*! @brief
   EPDCCH config for the cell
*/
typedef struct
{
  /*! Indicates if EPDCCH is configured or released */
  boolean enable;

  /*! Indicates if subframe_pattern_cfg is present or not */
  boolean subframe_pattern_cfg_present;

  /*! Subframe pattern config for EPDCCH, specifies subframes which the UE shall monitor 
    the UE-specific search space on EPDCCH, except for pre-defined rules in TS 36.213 [23, 9.1.4]. 
    If the field is not configured when EPDCCH is configured, the UE shall monitor the UE-specific 
    search space on EPDCCH in all subframes except for pre-defined rules in TS 36.213 [23, 9.1.4].*/
  lte_l1_subfm_pattern_cfg_param_s subframe_pattern_cfg;

  /*! Indicates if start_symbol is configured. If not configured starting OFDM symbol of 
  EPDCCH and PDSCH scheduled by EPDCCH shall be derived from PCFICH*/
  boolean start_symbol_configured;

  /*! Indicates the OFDM starting symbol for any EPDCCH and PDSCH scheduled by EPDCCH 
    on the same cell. Range (1..4). NA for TM10 */
  uint8 start_symbol;

  /*! Bitmask which indicates which EPDCCH-SetConfig-r11 have been released EPDCCH-SetConfigId-r11   ::=   INTEGER   (0 .  . 1 )
  This has to be interpreted as below
  bit number:-<MSB> 8  7  6  5  4  3  2  1 <LSB>
  EPDCCH-SetConfigId                     1..0 (Bits 3-8 are not used and reserved for future use)
  For example scell_id_delete_list_bitmask = 0x3, means SetConfigId's 0 and 1 have to be released */
  uint8 set_cfg_rel_list_bitmask;

  /*! Number of EPDCCH sets, range (1..2) 
  num_epdcch_sets = 0, its not applicable, previosuly configured sets 
  shall be maintained */
  
  uint8 num_epdcch_sets;

  /*! EPDCCH configuration sets */
  lte_cphy_epdcch_set_config_s epdcch_set_cfg[LTE_CPHY_EPDCCH_MAX_NUM_SET];
  
} lte_cphy_epdcch_cfg_s;

/*!
  @brief
  dmrs-ConfigPDSCH-r11 params
*/
typedef struct
{
  /*! Indicates if dmrs-ConfigPDSCH-r11 is configured or released */
  boolean enable;

  /*!Refer TS 36.211 [21, 6.10.3.1] */
  /*! Range (0..503) */
  uint16 scrambling_id;
  /*! Range (0..503) */
  uint16 scrambling_id2;
} lte_cphy_dmrs_cfg_r11_s;

/*!
  @brief
  optionalSetOfFields-r11 params
*/
typedef struct
{
  /*! Indicates crs-PortsCount-r11, Values (1,2,4) */
  uint8 crs_ports_count;

  /*! Indicates crs-FreqShift-r11 , Range (0..5) */
  uint8 crs_freq_shift;

  /*! Indicates if mbsfn_cfg is present or not */
  boolean mbsfn_cfg_present;

  /*! Parameters required to configure mbsfn-SubframeConfigList-r11 */
  lte_cphy_mbsfn_cfg_s mbsfn_cfg;

  /*! The starting OFDM symbol of PDSCH for the concerned serving cell, see TS 36.213 [23. 7.1.6.4]. 
  Values 1, 2, 3 are applicable when dl-Bandwidth for the concerned serving cell is greater than 10 
  resource blocks, values 2, 3, 4 are applicable when dl-Bandwidth for the concerned serving cell is 
  less than or equal to 10 resource blocks, see TS 36.211 [21, Table 6.7-1] */
  uint8 pdsch_start_ofst;
  
} lte_cphy_remap_qcl_cfg_opt_params_s;

/*!
  @brief
  PDSCH-RE-MappingQCL-Config params
*/
typedef struct
{
  /*! pdsch-RE-MappingQCL-ConfigId, Range (1..4) */
  uint8 remap_qcl_cfg_id;

  /*! Indicates if optional set of fields related to remapping qcl are present or not */
  boolean opt_params_present;

  /*! Parameters required to configure optionalSetOfFields-r11 */
  lte_cphy_remap_qcl_cfg_opt_params_s opt_remap_qcl_param;

  /*! Indicates the csi-RS-ConfigZPId-r11, Range (1..4) */
  uint8 csi_rs_cfg_zp_id;

  /*! Indicates if csi_rs_cfg_nzp_id is configured or released */
  boolean csi_rs_cfg_nzp_enable;

  /*! Indicates the CSI-RS resource that is quasi co-located with the PDSCH antenna ports, see 
  TS 36.213 [23, 7.1.9], , Range (1..3) */
  uint8 csi_rs_cfg_nzp_id;
  
} lte_cphy_remap_qcl_cfg_r11_s; 

/*!
  @brief
  PDSCH dedicated v1130 params
*/
typedef struct
{
  /*! Indicates if dmrs-ConfigPDSCH-r11 is present or not */
  boolean dmrs_cfg_r11_present;

  /*! Parameters required to configure dmrs-ConfigPDSCH-r11 */
  lte_cphy_dmrs_cfg_r11_s dmrs_cfg_r11;

  /*! Indicates if qcl-Operation type cfg is configured or released */
  boolean qcl_op_cfg_enable;

  /*! Indicates the quasi co-location behaviour to be used by the UE */
  lte_l1_qcl_op_cfg_type_e qcl_op_type;

  /*! Bitmask indicates which PDSCH-RE-MappingQCL-ConfigId-r11 have been released 
  PDSCH-RE-MappingQCL-ConfigId-r11   ::=   INTEGER   (1 .  . 4 )
  This has to be interpreted as below
  bit number:-                      <MSB> 8  7  6  5  4  3  2  1 <LSB>
  PDSCH-RE-MappingQCL-ConfigId-r11              4  3  2..1 (Bits 5-8 are not used and are reserved for future use)
  For example remap_qcl_cfg_rel_list_bitmask = 0x3, means remap_qcl_cfg_id's 1 and 2 have to be released */
  uint8 remap_qcl_cfg_rel_list_bitmask;

  /*! Indicates number of PDSCH-RE-MappingQCL-Configs */
  uint8 num_remap_qcl_cfg;

  /*! Parameters required to configure PDSCH-RE-MappingQCL-Config */
  lte_cphy_remap_qcl_cfg_r11_s remap_qcl_cfg[LTE_CPHY_REMAP_QCL_MAX_NUM_CFG];
  
} lte_cphy_pdsch_cfg_dedicated_param_v1130_s;

/*!
  @brief
  PDSCH dedicated v14xx params
*/
typedef struct
{
  /*! Configuration of 10 (instead of 8) DL HARQ processes in FDD in CE mode A.
      ce-PDSCH-TenProcesses-r14  ENUMERATED {on}  OPTIONAL,  -- Need OR */
  boolean ce_pdsch_ten_processes;  

  /*! ce-HARQ-AckBundling-r14:
      Spec Ref : section 6.3.2 of 36.331 (PDSCH-Config) 
      ce-HARQ-AckBundling
      Activation of PDSCH HARQ-ACK bundling in half duplex FDD in CE mode A, 
      see TS 36.212 [22] and TS 36.213 [23].

      ce-HARQ-AckBundling-r14  ENUMERATED {on}  OPTIONAL,  -- Need OR */
  boolean ce_harq_ack_bundling;

  /*! Indicates if ce_scheduling_enhancement is included */
  boolean ce_scheduling_enhancement_present;

  /*! ce-SchedulingEnhancement-r14:
      Spec Ref : section 6.3.2 of 36.331 (PDSCH-Config) 
      ce-SchedulingEnhancement
      Activation of dynamic HARQ-ACK delay for HD-FDD for PDSCH in CE mode A controlled by the DCI, 
      see TS 36.212 [22] and TS 36.213 [23]. 
      Value range1 corresponds to the first range of HARQ-ACK delays, and 
      Value range2 corresponds to second range of HARQ-ACK delays.

      ce-SchedulingEnhancement-r14  ENUMERATED  {range1, range2}  OPTIONAL,  -- Need OR */
  uint8 ce_scheduling_enhancement;
} lte_cphy_pdsch_cfg_dedicated_param_v1430_s;
...
typedef enum
{
  ...
  /** 60 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_MS_60,
  /** 80 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_MS_80,
  /** 120 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_MS_120,
  /** 160 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_MS_160,
  /** 200 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_MS_200,
  
  LTE_CPHY_SI_WINDOW_LENGTH_MS_MAX
}lte_cphy_si_window_length_e;


/*! @brief SI message reception window length for CatM UE in ms; used in SIB Sched Req
*/
typedef enum
{
  /** 20 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_20 = 20,
  /** 40 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_40 = 40,
  /** 60 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_60 = 60,
  /** 80 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_80 = 80,
  /** 120 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_120 = 120,
  /** 160 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_160 = 160,
  /** 200 ms */
  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_200 = 200,

  LTE_CPHY_SI_WINDOW_LENGTH_BR_MS_MAX

}lte_cphy_si_window_length_br_e;
...
typedef enum
{
  ...
  LTE_CPHY_RESEL_CANCEL_CAUSE_NON_CATM,
...
typedef enum
{
  ...
  LTE_CPHY_CELL_BAR_NON_CATM,
  LTE_CPHY_CELL_BAR_DEPRIORITIZE, //Soft Barring
...
typedef enum
{
  ...
  LTE_CPHY_CELL_UNBAR_DEPRIORITIZE,
...
*/
#define LTE_CPHY_MEAS_MAX_ALLOWED_FREQ_LAYERS 8
...
#define LTE_CPHY_IDLE_MEAS_DEF_S_SEARCHDELTAP_R14 0xFF
...
/*! @brief Reselection parameters for CE mode of operation
*/
typedef struct
{
  /*! Indicates if cell_select_info_ce is present or not */
  ...
  /*! Cell selection info CE 
    Parameters included in coverage enhancement S criteria. 
    They may be used by the UE to select/reselect a cell in which it works in CE mode 
    on the concerned non serving frequency. If absent, the UE acquires the information 
    from the target cell on the concerned frequency.*/
  lte_l1_cell_select_info_ce_s cell_select_info_ce;

  /*! Indicates if t_reselection_ce is present or not */
  boolean t_reselection_ce_present;

  /*! T_Reselection_ce timer dictating how long a given cell's receive power
    exceeds a reselection threshold prior to reselection in enhanced coverage mode of operation.
    Range (0..15)
    See 3GPP 36.304 5.2.4.5 for usage details.
    */
  uint16 t_reselection_ce;

} lte_cphy_meas_resel_param_ce_s;
...
typedef struct
{
  ...
  */
  ...
  /*! Indicates if intra_freq_resel_ce is present or not */
  boolean intra_freq_resel_param_ce_present;

  /*! Intra-freq reselection parameters related to CE mode of operation */
  lte_cphy_meas_resel_param_ce_s intra_freq_resel_param_ce;

  /*! Enum to indicate what's kind of the power class for this UE. */
  lte_cphy_power_class_e power_class_cfg;
...
typedef struct
{
  ...
  */
  ...
  /*! Indicates if inter_freq_resel_ce is present or not */
  boolean inter_freq_resel_param_ce_present;

  /*! Inter-freq reselection parameters related to CE mode of operation */
  lte_cphy_meas_resel_param_ce_s inter_freq_resel_param_ce;
...
/*! @brief Measurement gap sharing schemes between intra and inter frequency
*/
typedef enum
{
  /*! Gap sharing scheme 00, split gap equally between all frequencies. */
  LTE_CPHY_MEAS_GAP_SHARING_NONE  = 0,
  LTE_CPHY_MEAS_GAP_SHARING_0  = LTE_CPHY_MEAS_GAP_SHARING_NONE,
  /*! Gap sharing scheme 01 (40 percent), assign 2 layers to intra followed 
      by 3 layer for inter frequencies and so on. */
  LTE_CPHY_MEAS_GAP_SHARING_1  = 1,
  /*! Gap sharing scheme 10 (50 percent), assign every alternate layer to 
      intra frequencies. */
  LTE_CPHY_MEAS_GAP_SHARING_2  = 2,
  /*! Gap sharing scheme 11 (60 percent), assign 3 layers to intra followed
      by 2 layer for inter frequencies and so on. */
  LTE_CPHY_MEAS_GAP_SHARING_3  = 3
} lte_cphy_meas_gap_sharing_scheme_e;

/*! @brief Gap sharing config
*/
typedef struct
{
  /*! Gap sharing config enabled or not */
  boolean                              gap_sharing_cfg_enabled;
  /*! Gap sharing scheme */
  lte_cphy_meas_gap_sharing_scheme_e   gap_sharing_scheme;
} lte_cphy_meas_gap_sharing_cfg_s;
...
typedef struct
{
  ...
  uint8                                gap_offset;
  /*! Gap sharing scheme */
  lte_cphy_meas_gap_sharing_cfg_s      meas_gap_sharing_cfg;
...
typedef enum
{
  ...
  LTE_CPHY_CE_LEVEL_MAX
}lte_cphy_ce_level_type_e;
...
/*! @defgroup cphy_sap Control Plane (CPHY) Interface
  ...
  @detail The umids for this module are defined in @ref umids in the
          ...
          This interface is generated from
          $Header: //components/rel/lte.mpss/4.7.2/api/lte_cphy_msg.h#1 $ //source/qcom/qct/modem/lte/ML1/l1_common/main/latest/inc/lte_cphy_sap.h#46 $
...
typedef enum
{
  ...
  LTE_CPHY_START_REQ_SSIM_RESEL_FROM_1X_TO_LTE_STARTED        = 7
...
typedef struct
{
  ...
  boolean gnss_higher_prio_over_lte; /*!< Var for indicating that GNSS has higher priority than LTE*/
#endif
...
/*! @brief
This message is used to confirm ML1 processing EDRX Hyper SFN Req.
*/
typedef struct
{
  /*! Message header */
  msgr_hdr_struct_type msgr_hdr;
   ...
   /*! ML1 status of processing EDRX Hyper SFN Req */
  errno_enum_type status;
} lte_cphy_edrx_hyper_sfn_cnf_s;
...
typedef struct
{
  ...
  /*! Boolean indictates whether early exit will be needed during acquisition */
  boolean early_exit_needed;
...
typedef struct
{
  ...
  lte_cphy_idle_edrx_param_s edrx_param;
...
typedef struct
{
  ...
  /*! Following info are valid if unbar_cause = LTE_CPHY_CELL_UNBAR_DEPRIORITIZE */
  /*! Remove deprior of cells that were done before if still valid */
  boolean reset_deprior_all_cells;

  /*! The cell list is not applicable when reset_deprior_all_cells is TRUE */  
  uint8 num_cells;

  /*! LTE specific cell info
  When PCI is LTE_L1_NO_CELL_ID, all PCIs in that freq should be considered
  */
  lte_cphy_cell_info_s cell_list[LTE_CPHY_MAX_NUM_CELL_UNBAR];
...
typedef struct
{
  ...
  lte_cphy_ce_level_type_e ce_level;
...
typedef struct
{
  ...
  /*to determine CE level and will be set to 0x7F for non CATM1*/
...
typedef struct
{
  ...
  /*! Explicitly signaled mandatory CE level for PDCCH Order in CatM1 Coverage,
      LTE_CPHY_CE_LEVEL_MAX set for Normal coverage PDCCH Order
  */
  lte_cphy_ce_level_type_e ce_level;
...
/*! @brief SIB sched info list parameters related to BR/CE mode of operation */
typedef struct
{
 /*! SI narrow band, range 1..LTE_CPHY_MAX_AVAIL_NB */
 uint8 si_narrow_band;

 /*! This field indicates the transport block size information used to broadcast 
  the SI message towards low complexity UEs and UEs supporting CE. Refer to 3GPP TS 36.213 
  and Table 7.1.7.2.1-1 for a 6 PRB bandwidth and a QPSK modulation.*/
 lte_l1_si_tbs_e si_tbs;

} lte_cphy_sib_sched_info_br_s;

/*! @brief SIB sched parameters for BR/CE modes of operation  */
typedef struct
{

  /*! Indicates if sched_info_sib1_br is included. It will always be included 
    if SIB1 reading is requested after MIB decode */
  boolean                       sched_info_sib1_br_present;

  /*! Scheduling info for SIB1-BR. Range 0..31. 
    Value 0 means SIB1-BR is not scheduled */
  uint8                         sched_info_sib1_br;

  /*! SI message window length-BR in ms as specified in SIB1-BR */
 lte_cphy_si_window_length_e si_window_length_br;

 /*! Indicates the radio frames within the SI window used for SI message transmission. 
  Value everyRF corresponds to every radio frame, Value every2ndRF corresponds to every 
  second radio frame, and so on.*/
 lte_l1_si_rep_pattern_e        si_rep_pattern;

 /*! Size of sched_info_list_br below, if size is 0, ML1 has to delete
    previously configured values */
 uint8                          sched_info_list_br_size;

 /*! SIB sched info list parameters related to BR/CE mode of operation */
 lte_cphy_sib_sched_info_br_s   sched_info_list_br[LTE_CPHY_MAX_SI_MSGS];

} lte_cphy_sib_sched_br_param_s; 
...
typedef struct
{
   ...
   *  this field must be set to LTE_CPHY_HYPER_NULL_SFN. */

   lte_l1_hyper_sfn_t        mod_period_bnd_hyper_sfn;


  /** Last SFN/HSFN read by RRC in SIBs. Helpful in disambiguating
   *  modification boundary SFN if SFN/HSFN wraps around when we
  *  receive this request.
  */
  lte_l1_sfn_t               last_sfn_in_sib_rsp;
  lte_l1_hyper_sfn_t         last_hsfn_in_sib_rsp;
 ...
 /** SI message window length in ms as specified in SIB1. This
  *  field is not applicable for Cat M UEs. Applicable only if
  *  br_param_present is FALSE. For Cat M UEs, the
  *  si_window_length is specified in br_param below */
 ...
 /*! Indicates if Bandwidth-Reduced/Enhanced coverage parameters are configued or not */
 boolean br_param_present;

 /*! Bandwidth-Reduced/Enhanced coverage parameters */
 lte_cphy_sib_sched_br_param_s br_param;
...
typedef enum
{
  ...
  LTE_CPHY_TX_UNAVAILABILITY,  /*!<  Tx unavailability */
...
#define LTE_CPHY_MAX_WWAN_CANDIDATES 60

/* Map to SYS_MAX_PCI_SCAN_REQ */
#define LTE_CPHY_MAX_PCI_SCAN_PER_CHANNEL 8
...
typedef struct
{
  ...
  lte_cphy_wwan_pci_param_s  wwan_scan_ad_per_pci_m1[LTE_CPHY_MAX_PCI_SCAN_PER_CHANNEL];

} lte_cphy_wwan_candidate_param_s;
...
typedef struct
{
  ...
  /*! Whether to use early exit or not for ACQ on this EARFCN */
  boolean             early_exit;

#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
  lte_cphy_wwan_candidate_param_s wwan_candidate_info_list;
#endif
...
typedef struct
{
  ...
  /*! the list of channels to be searched for PLMN. Max elements are LTE_CPHY_BPLMN_MAX_FREQS */
  lte_cphy_bplmn_chan_s          *chans_ptr;
  ...
  /* If PCIs are sent for WWAN Scan then RRC will set pci_scan as TRUE 
   * if num_of_lte_pci_ad_element > 1*/
  boolean                         pci_scan;
  ...
  /* In case of WWAN scan, RRC will set max_num_pci as max_cells_per_channel( received in 
     sys_loc_wwan_scan_control_s_type structure) and send it to Ml1
   */ 
  uint8                           max_num_pci;
...
{
  /*! Default None */
  LTE_CPHY_BPLMN_EARFCN_SCAN_NONE,

  /*!  serving cell is not present and there is no sib decode request present in 
       given scan request */
  LTE_CPHY_BPLMN_EARFCN_SCAN_INVALID,

  /*! SUCCESS: If found atleast one cell for that earfcn */
  LTE_CPHY_BPLMN_EARFCN_SCAN_SUCCESS,

  /*! If no cell is found on that earfcn */
  LTE_CPHY_BPLMN_EARFCN_SCAN_NO_CELL_FOUND,

  /*! If ML1 received BPLMN STOP and search not started */
  LTE_CPHY_BPLMN_EARFCN_SCAN_NOT_STARTED,

  /*! If EARFCN BAND not present in band pref sent by NAS*/
  LTE_CPHY_BPLMN_EARFCN_SCAN_BAND_NOT_SUPPORTED,

  /*! If search aborted due to guard timer expiry - TBD */
  LTE_CPHY_BPLMN_EARFCN_SCAN_ABORTED_DUETO_GUARD_TIMER
}lte_cphy_bplmn_earfcn_status_e;


#define LTE_CPHY_MAX_PCI_RESULT 8
...
/* Physical cell id (0 to C_MAX_PHYSICAL_CELL_ID) */
  ...
  lte_cphy_rx_power_meas_e_type    rx_power_meas_type;
  ...
  uint32  system_frame_offset;
}lte_cphy_bplmn_earfcn_candidate_result_s;
...
typedef struct
{
  ...
  lte_cphy_bplmn_earfcn_status_e  status;

  uint8  num_result_per_earfcn;

  lte_cphy_bplmn_earfcn_candidate_result_s candidates[LTE_CPHY_MAX_PCI_RESULT];

} lte_cphy_bplmn_unsolicited_earfcn_status_ind_s;
...
/*! @brief mobility state as defined in 
           TS 36.304 5.2.4.3 [4]
*/
typedef enum
{
  /*! Default mobility state - (< Nm)*/
  LTE_CPHY_MOBILITY_STATE_NORMAL = 0,

  /*! If number of reselections are between
      Nm and Nh */
  LTE_CPHY_MOBILITY_STATE_MEDIUM = 1,

  /*! If number of reselections are higher than Nh */
  LTE_CPHY_MOBILITY_STATE_HIGH = 2,

  /*! Spare */
  LTE_CPHY_MOBILITY_STATE_MAX_VALUE = 3

} lte_cphy_mobility_state_e;

/*!
  @brief
  Structure to indicate mobility state via an indication
  */
typedef struct
{
  /*! Message router header */
  ...
  lte_cphy_mobility_state_e      mobility_state_value;

} lte_cphy_update_mobility_state_ind_s;

/*! @brief Cell Selection Info Update Types
*/

typedef enum 
{
  LTE_CPHY_CELL_SEL_INFO_BAND_SCAN_BAND_COMPLETE,
  LTE_CPHY_CELL_SEL_INFO_SYSTEM_SCAN_COMPLETE,
} lte_cphy_cell_sel_info_update_e;

/*!
  @brief
  Structure to indicate RRC Cell Selection Info Update via an indication
  */
typedef struct
{
  /*! Message router header */
  ...
  /*! Enum: Band/System Scan Indication */
  lte_cphy_cell_sel_info_update_e  cell_sel_info_update;

  /*! Number of bands to scanned (1.. MAX_SUPPORTED_BANDS) 
      in Prev Band Scan Req */
  uint8                num_bands;

  /*! List of bands to scanned in Prev Band Scan Req */
  sys_sband_lte_e_type band[LTE_CPHY_BANDSCAN_MAX_SUPPORTED_BANDS];
}lte_cphy_cell_sel_info_update_ind_s;
...
/*! @brief Full Image Switch Reason */
typedef enum
{
  LTE_ML1_POI_IMG_SWITCH_RSN_NONE           = 0,

  /* Image switch due to direct indtication info for Page MPDCCH */
  LTE_ML1_POI_IMG_SWITCH_RSN_DII            = 1,

  /* Image switch due to Page decode success  */
  LTE_ML1_POI_IMG_SWITCH_RSN_PAGE_DEC       = 2,

  /* Image switch due to OOS (acq/ PBCH/ SIB1 decode failure ) */
  LTE_ML1_POI_IMG_SWITCH_RSN_OOS            = 3,

  /* Image switch due to cell reselction */
  LTE_ML1_POI_IMG_SWITCH_RSN_C_SWITCH       = 4,

  /* Image switch due to jamming detection */
  LTE_ML1_POI_IMG_SWITCH_RSN_JAMMING_DETECT = 5,

  /* Image switch due to SIB modification */
  LTE_ML1_POI_IMG_SWITCH_RSN_SI_MOD         = 6
} lte_ml1_poi_img_switch_rsn_e;
...
/*! @brief Direct information indication from MPDCCH
  */
typedef struct
{
  /*! Message header */
  ...
  /*! Direction Indication Information mask; 8 bit, if a particular bit 
      is set it implies the corresponding information as per the below mapping
      is changing
    LSB 1 - SI modification
    LSB 2 - ETWS
    LSB 3 - CMAS
    LSB 4 - EAB modification
    LSB 5 - SI modification for eDRX
...
} lte_cphy_mpdcch_direct_ind_info_ind_s;


/*! @brief Direct information indication from MPDCCH sent by POI
  */
typedef struct
{
    /*! Serving cell info where direct information indication is received */
  ...
  /*! Hyper SFN value when indication is sent */
  lte_l1_hyper_sfn_t   hyper_sfn_val;
} lte_cphy_poi_mpdcch_direct_ind_info_ind_s;
...
enum
{
 ...
 MSGR_DEFINE_UMID(LTE, CPHY, REQ, TRM_UNLOCK_ALLOWED,
  ...
  MSGR_DEFINE_UMID(LTE, CPHY, CNF, CELL_RESEL_CANCEL,
                   LTE_CPHY_CELL_RESEL_CANCEL_ID, lte_cphy_cell_resel_cancel_cnf_s),
  ...
  */
  ...
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, GPS_GTS,
                   LTE_CPHY_GPS_GTS_ID, lte_cphy_gps_gts_req_s),
...
MSGR_DEFINE_UMID(LTE, CPHY, REQ, CONTEXT_STORE,
                   LTE_CPHY_CONTEXT_STORE_ID, lte_cphy_context_store_req_s),

  MSGR_DEFINE_UMID(LTE, CPHY, CNF, CONTEXT_STORE,
                   LTE_CPHY_CONTEXT_STORE_CNF_ID, lte_cphy_context_store_cnf_s),

  /* Unified config related interface */
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, CFG,
                   LTE_CPHY_CFG_ID, lte_cphy_cfg_req_s),

  MSGR_DEFINE_UMID(LTE, CPHY, CNF, CFG,
                   LTE_CPHY_CFG_ID, lte_cphy_cfg_cnf_s), 

  /* End proc request to unify conn cancel, release, rach abort and cphy abort */
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, END_PROC,
                   LTE_CPHY_END_PROC_ID, lte_cphy_end_proc_req_s),

  MSGR_DEFINE_UMID(LTE, CPHY, CNF, END_PROC,
                   LTE_CPHY_END_PROC_ID, lte_cphy_end_proc_cnf_s), 
  
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, POWER_CLASS_UPDATE,
                   LTE_CPHY_POWER_CLASS_UPDATE_ID, lte_cphy_power_class_req_s),
...
#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
  /* LTE_CPHY_BPLMN_UNSOLICITED_EARFCN_STATUS_IND */
  MSGR_DEFINE_UMID(LTE, CPHY, IND, BPLMN_UNSOLICITED_EARFCN_STATUS, LTE_CPHY_IND_BPLMN_EARFCN_STATUS_ID,
                                   lte_cphy_bplmn_unsolicited_earfcn_status_ind_s),
#endif
  ...
  */
  ...
  MSGR_DEFINE_UMID(LTE, CPHY, IND, MPDCCH_DIRECT_IND_INFO,
                   LTE_CPHY_IND_MPDCCH_DIRECT_IND_INFO_ID, lte_cphy_mpdcch_direct_ind_info_ind_s),

  /* EMTC EDRX specific message ID: LTE_CPHY_EDRX_HYPER_SFN_REQ,  no cnf */
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, EDRX_HYPER_SFN,
                   LTE_CPHY_EDRX_HYPER_SFN_ID, lte_cphy_edrx_hyper_sfn_req_s),

  /* EMTC EDRX specific message ID: LTE_CPHY_EDRX_HYPER_SFN_REQ,  no cnf */
  MSGR_DEFINE_UMID(LTE, CPHY, CNF, EDRX_HYPER_SFN,
                   LTE_CPHY_EDRX_HYPER_SFN_ID, lte_cphy_edrx_hyper_sfn_cnf_s),

  /* EMTC EDRX specific message ID: LTE_CPHY_EDRX_UE_PAGE_REQ, no cnf */
  MSGR_DEFINE_UMID(LTE, CPHY, REQ, EDRX_UE_PAGE,
                   LTE_CPHY_EDRX_UE_PAGE_ID, lte_cphy_edrx_ue_page_req_s),

  /* EMTC EDRX specific message ID: LTE_CPHY_EDRX_UIM_PAGE_IND,  */
  MSGR_DEFINE_UMID(LTE, CPHY, IND, EDRX_UIM_PAGE,
                   LTE_CPHY_EDRX_UIM_PAGE_ID, lte_cphy_edrx_uim_page_ind_s),
                   
  /* CAT-M LTE TX and GNSS coex message ID: LTE_CPHY_TX_START_IND,  */           
  MSGR_DEFINE_UMID(LTE, CPHY, IND, TX_START,
                   LTE_CPHY_IND_TX_START_ID, lte_cphy_tx_start_ind_s ),

  /* CAT-M LTE TX and GNSS coex message ID: LTE_CPHY_TX_END_IND,  */  
  MSGR_DEFINE_UMID(LTE, CPHY, IND, TX_END,
                   LTE_CPHY_IND_TX_END_ID, lte_cphy_tx_end_ind_s ),
  
  MSGR_DEFINE_UMID(LTE, CPHY, IND, PSM,
                   LTE_CPHY_PSM_IND_ID, lte_cphy_psm_ind_s),

  MSGR_DEFINE_UMID(LTE, CPHY, IND, UPDATE_MOBILITY_STATE,
                   LTE_CPHY_IND_UPDATE_MOBILITY_STATE_ID, lte_cphy_update_mobility_state_ind_s),

  /*! @brief LTE_CPHY_CELL_SELECTION_INFO_UPDATE_IND

     @details
      Message sent from RRC to ML1, updating RRC Cell Selection Info status to ML1
   */
  MSGR_DEFINE_UMID(LTE, CPHY, IND, CELL_SEL_INFO_UPDATE,
                   LTE_CPHY_IND_CELL_SEL_INFO_UPDATE_ID, lte_cphy_cell_sel_info_update_ind_s),
};
...
typedef enum
{
  LTE_CPHY_CE_INFO_STATE_IDLE      = 0,   /* Idle State */
  LTE_CPHY_CE_INFO_STATE_RACH      = 1,   /* Rach OR Connecting State */
  LTE_CPHY_CE_INFO_STATE_CONNECTED = 2,   /* Connected State */
  LTE_CPHY_CE_INFO_STATE_MAX       = 100,
} lte_cphy_ce_info_state_e;

/*! @brief The message structure for UE Coverage Enhancement(CE) Mode Information Request
 */
typedef struct
{
  /*!< Message header */
  ...
  /*! If this field is set, the request is for one time CE mode Information Report */
  boolean                          one_time_query;

  /*! This filed is processed, only if "one_time_query" is reset to FALSE.
      Field to inform, whether the request is to enable reporting */
  boolean                          enable_reporting;
} lte_cphy_ce_info_rpt_req_s;

/*! @brief The message structure for UE Coverage Enhancement(CE) Mode Information Response
 */
typedef struct
{
  /*!< Message header */
  ...
  /*!< Active Rat, CATM1/NB1 */
  sys_sys_mode_e_type              active_rat;
 
  /*! Field to indicate if enhanced coverage mode is enabled */
  boolean                          enh_cov_mode_enabled;

  /* Process below fields only if 
     there is a valid active_rat and
     enh_cov_mode_enabled is TRUE */

  /*! Enhanced coverage mode(COV_MODE A/B), 
      valid only if enh_cov_mode_enabled is TRUE */
  lte_l1_enh_cov_mode_e            enh_cov_mode;

  /*!< UE State at the time of the report */
  lte_cphy_ce_info_state_e         state;

  /* If SINR and RSRP are valid, then report is valid,
     else it is an invalid report */
  boolean                          valid_report;

  /* Process below fields only if valid_report is TRUE */

  /*!< Downlink Repetition Factor */
  uint16                           dl_rep_factor;

  /*!< Uplink Repetition Factor */ 
  uint16                           ul_rep_factor;

  /*!< SINR of serving cell in  1xdB format */
  int16                            cinr; 

  /*!< RSRP of serving cell in Q0 dBm format */
  int32                            rsrp;
} lte_cphy_ce_info_rpt_rsp_s;

/*! @brief The message structure for Get Next SFN Request
 */
typedef struct
{
  /*!< Message header */
  msgr_hdr_struct_type msgr_hdr;
} lte_cphy_get_next_sfn_req_s;

/*! @brief The message structure for Get Next SFN Response
 */
typedef struct
{
  /*!< Message header */
  ...
  /* If      LTE/NB1 is OOS,  hsfn_sfn_nbr = 0xFFFFFFFF
     Else If HSFN is invalid, hsfn_sfn_nbr = (1024*1024) + sfn = 1,048,576 + sfn
     Else    valid HSFN,      hsfn_sfn_nbr = (hsfn*1024) + sfn*/
  uint32               hsfn_sfn_nbr;

  /* If      LTE/NB1 is OOS,  min_hsfn_sfn_nbr = 0xFFFFFFFF
     Else If HSFN is invalid, min_hsfn_sfn_nbr = (1024*1024) + 0 = 1,048,576
     Else    valid HSFN,      min_hsfn_sfn_nbr = (0*1024) + 0 = 0*/
  uint32               min_hsfn_sfn_nbr;

  /* If      LTE/NB1 is OOS,  max_hsfn_sfn_nbr = 0xFFFFFFFF
     Else If HSFN is invalid, max_hsfn_sfn_nbr = (1024*1024) + 1023 = 1,049,599
     Else    valid HSFN,      max_hsfn_sfn_nbr = (1023*1024) + 1023 = 1,048,575 */
  uint32               max_hsfn_sfn_nbr;
} lte_cphy_get_next_sfn_rsp_s;

/*! @brief The message structure for Set SFN Config Request
 */
typedef struct
{
  /*!< Message header */
  ...
  /* If GPIO toggle not required, set to DAL_GPIO_INVALID_PIN */
  //uint32               gpio_nbr;
} lte_cphy_set_sfn_config_req_s;

/*! @brief The message structure for Set SFN Config Response
 */
typedef struct
{
  /*!< Message header */
  ...
  /* This field will be set to FALSE, if ML1 doesn't have timing information */
  boolean              req_accepted;
} lte_cphy_set_sfn_config_rsp_s;

/*! @brief The message structure for SFN Threshold Reached Indication
 */
typedef struct
{
  /*!< Message header */
  ...
  /* hsfn_sfn_nbr = hsfn*1024 + sfn */
  uint32               hsfn_sfn_nbr;
} lte_cphy_sfn_threshold_reached_ind_s;

/*! @brief The message structure for UE CE level Information Request
 */
typedef struct
{
  /*!< Message header */
  msgr_hdr_struct_type             msgr_hdr;
} lte_cphy_ce_level_rpt_req_s;

/*! @brief The message structure for UE CE level Information Response
 */
typedef struct
{
  /*!< Message header */
  ...
  /* If SINR and RSRP are valid, and then report is valid,
     else it is an invalid report */
  boolean                          valid_report;

  /* Process below fields only if valid_report is TRUE */
  
  /*! CE level corresponding to current RSRP value */
  lte_cphy_ce_level_type_e         ce_level;
} lte_cphy_ce_level_rpt_rsp_s;
...
enum
{
  ...
  MSGR_DEFINE_UMID( LTE, CPHY, REQ, CE_INFO_REPORT,
                    LTE_CPHY_CE_INFO_REPORT_ID, lte_cphy_ce_info_rpt_req_s ),
  MSGR_DEFINE_UMID( LTE, CPHY, RSP, CE_INFO_REPORT,
                    LTE_CPHY_CE_INFO_REPORT_ID, lte_cphy_ce_info_rpt_rsp_s ),

  MSGR_DEFINE_UMID( LTE, CPHY, REQ, GET_NEXT_SFN,
                    LTE_CPHY_GET_NEXT_SFN_REPORT_ID, lte_cphy_get_next_sfn_req_s ),
  MSGR_DEFINE_UMID( LTE, CPHY, RSP, GET_NEXT_SFN,
                    LTE_CPHY_GET_NEXT_SFN_REPORT_ID, lte_cphy_get_next_sfn_rsp_s ),

  MSGR_DEFINE_UMID( LTE, CPHY, REQ, SET_SFN_CONFIG,
                    LTE_CPHY_SET_SFN_CONFIG_REPORT_ID, lte_cphy_set_sfn_config_req_s ),
  MSGR_DEFINE_UMID( LTE, CPHY, RSP, SET_SFN_CONFIG,
                    LTE_CPHY_SET_SFN_CONFIG_REPORT_ID, lte_cphy_set_sfn_config_rsp_s ),
  MSGR_DEFINE_UMID( LTE, CPHY, IND, SFN_THRESHOLD_REACHED,
                    LTE_CPHY_SET_SFN_CONFIG_REPORT_ID, lte_cphy_sfn_threshold_reached_ind_s ),

  MSGR_DEFINE_UMID( LTE, CPHY, REQ, CE_LEVEL_REPORT,
                    LTE_CPHY_CE_LEVEL_REPORT_ID, lte_cphy_ce_level_rpt_req_s ),
  MSGR_DEFINE_UMID( LTE, CPHY, RSP, CE_LEVEL_REPORT,
                    LTE_CPHY_CE_LEVEL_REPORT_ID, lte_cphy_ce_level_rpt_rsp_s ),
};
...
enum
{
  LTE_CPHY_SIB1_COMMON_CFG_MASK_BIT_TDD_CFG = 0x1,
  LTE_CPHY_SIB1_COMMON_CFG_MASK_BIT_UL_DL_SUBFRAME_BITMAP_CFG = 0x2,
  LTE_CPHY_SIB1_COMMON_CFG_MASK_BIT_FREQ_HOP_PARAM = 0x4,
  LTE_CPHY_SIB1_COMMON_CFG_CURRENT_VALID_MASK_BITS = 0x7
};

typedef uint16 lte_cphy_sib1_common_cfg_mask_t;
...
typedef struct
{
  ...
  /*! Bandwidth-Reduced/Enhanced coverage parameters */
  lte_cphy_sib_sched_br_param_s br_param;
} lte_cphy_catm_si_sched_info_s;

 /*! @brief indicate the power clas to ML1 from RRC */
typedef struct
{
  /*! standard msgr header */
  msgr_hdr_struct_type       hdr;     
  ...
  lte_cphy_power_class_e               power_class_cfg;
}lte_cphy_power_class_update_req_s;

/************************** UNIFIED CONFIG IFACE *************************************************/

/*!
  @brief
  Enum defining the individual configs included in the CFG_REQ message
  */
enum
{
  LTE_CPHY_CFG_REQ_MASK_SIB1 = 0x1, //COMMON_CFG from SIB1
  LTE_CPHY_CFG_REQ_MASK_COMMON = 0x2, //COMMON_CFG from SIBs,RRC_RECONFIG,SETUP
  LTE_CPHY_CFG_REQ_MASK_DEDICATED = 0x4 //DEDICATED_CFG from SIBs,RRC_RECONFIG,SETUP
};

/*! @brief
  Accumulated config (Eg:SIB1|COMMON|DEDICATED) mask
*/
typedef uint8 lte_cphy_cfg_req_mask_t;
...
typedef struct
{
  /* Indicates the valid config received from the network  */
  lte_cphy_cfg_req_mask_t         valid_cfg_mask;
  /* Indicates the valid parameters received in SIB1  */
  lte_cphy_sib1_common_cfg_mask_t valid_sib1_common_cfg_mask;
  /* Indicates the valid common cfg parameters received in SIBs/RRC Reconfig  */
  lte_cphy_common_cfg_mask_t      valid_common_cfg_mask;
  /* Indicates the valid dedicated cfg parameters received in SIBs/RRC Reconfig  */
  lte_cphy_dedicated_cfg_mask_t   valid_ded_cfg_mask;
  ...
  /* SIB1 common config  */
  /* ====================================== */
  /*! Valid UL / DL subframes bitmap */
  lte_cphy_ul_dl_subframe_bitmap_s  ul_dl_valid_subframes;
  /*! Frequency hopping parameters */
  lte_cphy_freq_hop_param_s freq_hop_param;
  /*! Indicates the OFDM starting symbol for any MPDCCH,PDSCH*/
  uint8 start_symbol_lc;
  /*! Frequency hopping activation/deactivation for BR versions of SI messages 
    and MPDCCH of paging. */
  lte_l1_hop_cfg_e si_hopping;
  /* SI scheduling related info */ 
  lte_cphy_catm_si_sched_info_s catm_si_sched_info;
  ...
  /*! Freq Hopping params r13 configure*/
  lte_cphy_freq_hop_param_s freqhop_r13;
  /*! Interval Hop UL config*/
  lte_cphy_interval_hop_ul_cfg_s interval_hop_ul_r13; 
  /*! Power class config*/
  lte_cphy_power_class_e power_class_cfg;
  /* NW configured customized tx-rx spacing*/
  boolean custom_duplex_spacing_enabled;
  ...
  /*! Enhanced coverage mode if applicable*/
  lte_cphy_dedicated_enh_cov_mode_s ce_mode_cfg;
  /*! EPDCCH Configuration for PCell */
  lte_cphy_epdcch_cfg_s epdcch_cfg;
  /*! Parameters required to configure pdsch-ConfigDedicated-v1130 physical channel */
  lte_cphy_pdsch_cfg_dedicated_param_v1130_s pdsch_cfg_dedicated_v1130;
  /*! Parameters required to configure pdsch-ConfigDedicated-v14xx physical channel */
  lte_cphy_pdsch_cfg_dedicated_param_v1430_s pdsch_cfg_dedicated_v1430;
} lte_cphy_cfg_param_s;

typedef struct
{  
  /* Indicates the updated configs in this request  */
  lte_cphy_cfg_req_mask_t         updated_cfg_mask; 
  /* Indicates the updated parameters derived from SIB1  */ 
  lte_cphy_sib1_common_cfg_mask_t sib1_common_cfg_update_mask;
  /* Indicates the updated common cfg parameters derived from SIBs/RRC reconfig  */ 
  lte_cphy_common_cfg_mask_t      common_cfg_update_mask;
  /* Indicates the updated dedicated cfg parameters derived from SIBs/RRC reconfig  */ 
  lte_cphy_dedicated_cfg_mask_t   ded_cfg_update_mask;
  /* Pointer to the updated config DB  */   
  lte_cphy_cfg_param_s*           cfg_param_ptr;  
} lte_cphy_cfg_data_s;
...
{  
  ...
  lte_cphy_cell_info_s                  serving_cell_info;
  /* Config info  */   
  lte_cphy_cfg_data_s                   cfg;
} lte_cphy_cfg_req_s;

/*! @brief
  This message is used to confirm unified configuration request.
*/
typedef struct
{
  /*! Message header */
...
typedef struct
{
  ...
  /* Target cell config to be applied  */
  lte_cphy_cfg_data_s             target_cell_cfg;
...
typedef struct
{
  ...
  /* Source cell config to be applied after resel is cancelled */
  lte_cphy_cfg_data_s           src_cell_cfg;
} lte_cphy_cell_resel_cancel_req_s;
  
 /*! @brief
   This message is used to have a sync point between RRC/ML1 related to resel cancel proc end at ML1
 */
 typedef struct
 {
   /*! Message header */
   ...
   /*! The success of the configuration if the status was not success no
       configurations were applied */
   errno_enum_type      status;
 } lte_cphy_cell_resel_cancel_cnf_s;

 /*!
   @brief
   List to enumerate end proc action
  */
 typedef enum
 {
   /*! Sent by L2 to abort RACH */
   LTE_CPHY_END_TYPE_RACH_ABORT,
    /*! Sent by RRC if connection establishment is in progress */   
   LTE_CPHY_END_TYPE_CONN_CANCEL,
    /*! Sent by RRC if UE is in connected state */  
   LTE_CPHY_END_TYPE_CONN_REL,
    /*! Sent by RRC if ML1 needs to be aborted */  
   LTE_CPHY_END_TYPE_CPHY_ABORT
 } lte_cphy_end_proc_type_e;

/*! @brief
This msg is sent by RRC to CPHY to abort a procedure
*/
typedef struct
{
  /*! Message header */
  msgr_hdr_struct_type msgr_hdr;
  /*! Cell info on which req is sent */
  lte_cphy_cell_info_s cell_info;
  /*! end type */
  lte_cphy_end_proc_type_e proc;
} lte_cphy_end_proc_req_s;

/*! @brief
  This message is sent from ML1 to confirmthat the request
  to end procedure is done.
*/
typedef struct
{
  /*! Message header */
  ...
  errno_enum_type      status;
} lte_cphy_end_proc_cnf_s;

/* ToDo: Remove dummy iface after RFA check in */
typedef struct
{
  /*! Message header */
  msgr_hdr_struct_type msgr_hdr;
...
} lte_cphy_sib1_common_cfg_req_s;
typedef struct
{
  /*! Message header */
  msgr_hdr_struct_type msgr_hdr;

} lte_cphy_sib1_common_cfg_cnf_s;
typedef struct
{
  /*! Message router header */
  msgr_hdr_struct_type               msgr_hdr;
...
} lte_ml1_sleepmgr_sleep_start_ind_s;
...
} lte_ml1_sleepmgr_wakeup_isr_ind_s;

enum
{
  MSGR_DEFINE_UMID( LTE, ML1_SLEEPMGR, IND, SLEEP_START, 0x04,
                    lte_ml1_sleepmgr_sleep_start_ind_s ),

  MSGR_DEFINE_UMID( LTE, ML1_SLEEPMGR, IND, WAKEUP_ISR, 0x05,
                    lte_ml1_sleepmgr_wakeup_isr_ind_s ),
