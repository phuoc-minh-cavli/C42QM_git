...
/*=============================================================================
  ...
  $Header: //components/rel/apr.common/4.0/custom/inc/aprv2_ipc_config.h#1 $
  $Author: pwbldsvc $
...
typedef struct apr_qsocket_port_info_t apr_qsocket_port_info_t;
...
APR_INTERNAL int32_t apr_ipc_write_qsocket_fn(uint32_t index,void *buf, uint32_t length);
...
APR_INTERNAL int32_t apr_ipc_write_fn_qsocket(uint32_t port_index,void *buf, uint32_t length);
...
struct apr_qsocket_port_info_t {
  char thread_name[32];
  uint32_t service;
  uint32_t instance;
  int32_t is_server;
...
#define APR_QSOC_MODEM_CLIENT ("APR_QSOC_MODEM_CLIENT")
#define APR_QSOC_ADSP_SERVICE ("APR_QSOC_ADSP_SERVICE")
...
static apr_qsocket_port_info_t apr_qsocket_port_info_table[]= 
{
  {APR_QSOC_MODEM_CLIENT,0x1005, 2, 0, 1}
};
...
static aprv2_ipc_send_t aprv2_ipc_glink_send_dispatch_table[ ] = {
 ...
 {APRV2_IDS_DOMAIN_ID_PC_V,apr_diag_send_fn,NULL}, //diagsend
 {APRV2_IDS_DOMAIN_ID_MODEM_V,aprv2_ipc_local,NULL},
 {APRV2_IDS_DOMAIN_ID_ADSP_V,aprv2_ipc_local,1},
 {APRV2_IDS_DOMAIN_ID_APPS_V,apr_ipc_write_fn, 0},
 {APRV2_IDS_DOMAIN_ID_MODEM2_V,aprv2_ipc_unsupport_domain,NULL},
...
static apr_qsocket_port_info_t apr_qsocket_port_info_table[]= 
{
   {APR_QSOC_ADSP_SERVICE,0x1005, 2, 1, 1}
};
