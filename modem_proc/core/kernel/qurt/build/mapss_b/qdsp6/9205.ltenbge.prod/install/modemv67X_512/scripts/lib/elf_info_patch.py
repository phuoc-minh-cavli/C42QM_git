...
#          uint32_t QURTK_clade2_base_paddr;
#          uint32_t QURTK_clade2_comp_base;
#          uint32_t QURTK_clade2_comp_length;
#          uint32_t QURTK_clade2_metadata_base;
#          uint32_t QURTK_clade2_metadata_length;
#          uint32_t QURTK_clade2_16B_free_list_base;
#          uint32_t QURTK_clade2_16B_free_list_end;
#          uint32_t QURTK_clade2_32B_free_list_base;
#          uint32_t QURTK_clade2_32B_free_list_end;
#          uint32_t QURTK_clade2_48B_free_list_base;
#          uint32_t QURTK_clade2_48B_free_list_end;
#          uint32_t QURTK_clade2_64B_free_list_base;
#          uint32_t QURTK_clade2_64B_free_list_end;
#          uint32_t QURTK_clade2_16B_free_list_ptr_va;
#          uint32_t QURTK_clade2_32B_free_list_ptr_va;
#          uint32_t QURTK_clade2_48B_free_list_ptr_va;
#          uint32_t QURTK_clade2_64B_free_list_ptr_va;
#          uint32_t  QURTK_clade2_regs_start;
#          uint32_t  QURTK_clade2_regs_end;
...
def _build_eip_info(physaddr, q6cfg_records, f, infiles, island_moves, clade_registers, opt_mappings, mappings=None):
    ...
    if None not in clade_registers:
        eip_data += encode_eip_record(REGISTER, '<LLLLLLLLLLLLLLLLLLLLLLLL', *clade_registers)
    ...
    for i in infiles[1:]:
        ...
        if hasattr(i,'SRM_ASID'):
            ...
            eip_data += encode_eip_record(SRM_INFO, '<LLL', i.SRM_ASID, i.program_entry_point, srm_program_number & 0xFFFFFFFF)
            print 'SRM info : %u, 0x%08X, %d' % (i.SRM_ASID, i.program_entry_point, srm_program_number)
            #
        ...
        if mappings != None:
            ...
            eip_data += encode_eip_record(USER_APP_ENTRYPOINT, '<L', i.program_entry_point)
            continue
        segs = i.segs
...
class ElfInfoPatch:
    ...
    def writeback(self, *args):
        data = _build_eip_info(self.cfg.physaddr, self.records, *args)
