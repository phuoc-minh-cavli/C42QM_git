...
class l2cfg:
    ...
    SUPPORTED_NAMED_REGS = {
        ...
        0x0030 : ( 'SFC_CTRL',                 R     ),
        0x0040 : ( 'ASCID_MAPPING_0',                ),
        0x0044 : ( 'ASCID_MAPPING_1',                ),
        0x0048 : ( 'ASCID_MAPPING_2',                ),
        0x004C : ( 'ASCID_MAPPING_3',                ),
    ...
    def from_ezxml (self, l2_cfg_el):
        ...
        for register in registers:
            ...
            try:
                ...
                if derived_offset == self.INVALID_OFFSET:
                    raise ValueError, '%s: unrecognized register name "%s"' % ( __name__, name )
