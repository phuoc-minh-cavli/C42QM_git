...
def get_sections(secure=False):
    ...
    S.add_section('.rodata.eip.build', NAME='eip_*', EXACT=True)
    S.add_section('.qurtos.island', ISLAND=True, QURTOS=True)
    S.add_section('.qurtos.main', ISLAND=False, QURTOS=True)
    S.add_override_section('.data.tcm.ukernel.island', [['QURTK_l2_island_interrupt_table'],['QURTK_int_privilege']], in_prefix="*.")
    S.add_section('.ukernel.island', ISLAND=True)
    S.add_override_section('.data.QURTK_int_usrpd_check', [['QURTK_int_usrpd_check']], in_prefix=".data.")
    S.add_override_section('.data.qurtos_fastint_stack_size', [['qurtos_fastint_stack_size']], in_prefix=".data.")
    S.add_override_section('.data.QURTK_int_max', [['QURTK_int_max']], in_prefix=".data.")
    S.add_override_section('.data.QURTK_config_trace_mask', [['QURTK_config_trace_mask']], in_prefix=".data.")
    S.add_override_section('.bss.QURTK_l2_interrupt_table', [['QURTK_l2_interrupt_table']], in_prefix=".bss.")
    S.add_override_section('.data.qurtos_fastint_stack_addr', [['qurtos_fastint_stack_addr']], in_prefix=".data.")
    S.add_section('.ukernel.main', KERNEL=True)
    S.add_section('')
