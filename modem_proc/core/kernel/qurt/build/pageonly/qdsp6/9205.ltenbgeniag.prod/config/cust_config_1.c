...
const struct tag_sender {
   ...
   "<effective_memsize value=\"13631488\"/><total_memsize value=\"13631"
   "488\"/><region_cache_policies value=\"\"/></build_vars>"
};
...
#define VIRT_RESERVE_INIT { 0x04000, 0x04FFF, 0xDCC00, 0xDCC7F,  -1 }
...
#if 3605 || defined(GEN_CONFIG_HEADER)
...
CONFIG_RW_SPACE(
   ...
   CONFIG_DEFAULT,
   "\021\016\000\000<image><program_name_map name=\"AMSS\" number=\"0\"/><"
   "build>\n"
