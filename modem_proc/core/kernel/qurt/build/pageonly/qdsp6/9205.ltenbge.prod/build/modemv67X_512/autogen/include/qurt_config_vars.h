...
extern typeof(unsigned char [(((((0))/((8)))+((((0))%((8)))>0))*(8))]) qurtos_app_stack;
...
extern typeof(unsigned char [(((((0))/((32)))+((((0))%((32)))>0))*(32))]) qurt_tcm_dump_static_loc;
...
extern typeof(unsigned int) QURTK_tcm_dump_size;
...
extern typeof(unsigned int) QURTK_tcm_save_size;
...
extern typeof(unsigned int) const QURTK_livelock_exception;
...
extern typeof(qurtos_named_mmap_info_t []) qurtos_named_mmap_table;
...
extern typeof(unsigned char [(((((0))/((4)))+((((0))%((4)))>0))*(4))]) qurtos_heap;
...
extern typeof(unsigned int) const QURTK_err_stm_trace_mask;
...
extern typeof(unsigned int) QURTK_isr_default_prio;



extern typeof(unsigned int) QURTK_isr_max_shared_int;



extern typeof(unsigned int) QURTK_crash_reset_addr;
