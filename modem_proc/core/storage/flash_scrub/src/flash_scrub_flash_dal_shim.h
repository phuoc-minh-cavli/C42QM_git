 ...
 * Copyright (C) 2009-2013, 2016 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/flash_scrub/src/flash_scrub_flash_dal_shim.h#1 $ $DateTime: 2018/06/26 03:18:17 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2016-12-15   svl   moved flash scrub ops init call from shim to scrub master
                   and exposed flash_scrub_shim_ops_init for the same.
...
void flash_scrub_shim_ops_init (void);
