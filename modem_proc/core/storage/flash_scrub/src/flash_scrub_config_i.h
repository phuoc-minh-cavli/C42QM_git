...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/flash_scrub/src/flash_scrub_config_i.h#2 $ $DateTime: 2019/01/03 04:09:00 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2019-01-03   as    Change parition name for new naming convention.
...
----------------------------------------------------------------------------**/
  ...
  #define FLASH_SCRUB_PARTITION_NAME "scrub"
#endif

#ifndef FLASH_SCRUB_MIBIB_PARTITION_NAME
  #define FLASH_SCRUB_MIBIB_PARTITION_NAME "mibib"
#endif
...
#ifndef FLASH_SCRUB_BOOT_PBL_SIZE_LIMIT_FOR_SBL
  #define FLASH_SCRUB_BOOT_PBL_SIZE_LIMIT_FOR_SBL  (2 * 1024 * 1024)
#endif
