...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/flash_scrub/src/flash_scrub_task.c#2 $ $DateTime: 2019/06/19 10:03:46 $ $Author: pwbldsvc $
...
/* Below if condition should be at top because FOTA signal is of highest priority.
   Say if both FOTA and scrub signal is set at same time, scrub should happen only after 
   FOTA signal succesfully updates MD5s in EFS */
