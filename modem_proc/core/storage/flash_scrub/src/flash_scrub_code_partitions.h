...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/flash_scrub/src/flash_scrub_code_partitions.h#2 $ $DateTime: 2019/06/19 10:03:46 $ $Author: pwbldsvc $
...
/* This function erases scrub partition */
void scrub_erase_scrub_partition(void);
