...
*/
void* flash_ftl_aligned_malloc(uint32 size)
{
  ...
  qurt_mem_region_attr_set_cache_mode(&mem_info, QURT_MEM_CACHE_NONE);
  qurt_mem_region_attr_set_mapping(&mem_info, QURT_MEM_MAPPING_VIRTUAL);
