 ...
 *
 * Copyright (c) 2009-2014, 2019 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 * 01/01/19     sl      differentiated erased page from bit flip erased page
  ...
  */
          ...
          ||  (FLASH_DEVICE_FAIL_PAGE_ERASED == result)))
  {
    ...
    if (FLASH_HAL_SUCCESS != hal_status)
    {
      ...
      {
        DALSYS_memset((void*)buf_desc->buff_vaddr, 0xFF, page_data->main_size_bytes);
