 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/3.10/storage/flash/src/hal/flashi_hal.h#2 $ $DateTime: 2018/10/31 09:47:12 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 10/12/18     sa      Added QPIC_Version field to store QPIC major version.
