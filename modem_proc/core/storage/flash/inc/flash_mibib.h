...
DESCRIPTION
  ...
  Copyright 2004-2011,2013, 2019 Qualcomm Technologies Incorporated. 
  All Rights Reserved.
...
--------   ---     ---------------------------------------------------------- 
04/16/19   sl      Update MIBIB boundaries w.r.t. latest partition table
10/20/17   svl     fix unmapped efs access issue
...
#define MIBIB_DEFAULT_PARTI_SIZE  0x6
 ...
 * we find the MIBIB.
 * NOTE: now the below macro defines the actual last block of MIBIB
 *       partition
 */
#define MIBIB_BLOCK_SEARCH_MAX          0x13

/* Skip first 14 blocks to scan for partition table.  These blocks are 
 * reserved for SBL partition.
 * NOTE: now the below macro defines the actual start block of MIBIB
 *       partition
 */
#define MIBIB_BLOCK_SEARCH_MIN          0xE
