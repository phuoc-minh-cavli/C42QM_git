...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/src/fs_api_counters.c#2 $ $DateTime: 2019/12/24 01:37:59 $ $Author: pwbldsvc $
...
{
  (void) efs_write_file_helper (FS_API_COUNTERS_LOG_FILE,
         fs_api_counter, sizeof(fs_api_counter));

  (void) efs_write_file_helper (FS_API_ADV_COUNTERS_LOG_FILE,
         fs_api_advanced_counter, sizeof(fs_api_advanced_counter));
}
