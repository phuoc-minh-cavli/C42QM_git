...
void fs_api_debug_init (void)
{
  ...
  memset (&dbgc->api_counter[0], 0, sizeof (dbgc->api_counter));
  memset (&dbgc->api_counter_in_this_boot[0], 0,
          sizeof (dbgc->api_counter_in_this_boot));
  memset (&dbgc->flash_counters_in_this_boot, 0,
  ...
  enum fs_api_debug_save_data_to_efs_context save_context, int force_sync)
{
  ...
  fs_memscpy (&dbgc->api_counter_in_this_sync[0],
              sizeof (dbgc->api_counter_in_this_sync),
              &dbgc->api_counter[0], sizeof (dbgc->api_counter));
