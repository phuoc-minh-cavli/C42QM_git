 ...
 * Copyright (C) 2002-2008,2010,2012-2013,2022 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/src/fs_pm_super.h#2 $ $DateTime: 2022/04/19 02:28:12 $ $Author: pwbldsvc $
...
/* Gets the number of pages per block and number of blocks in log
 * region from superblock.
 *
 * param fs_block_info
 *
