 ...
 * Copyright (C) 2008,2010-2013,2022 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/src/fs_counters.c#2 $ $DateTime: 2022/04/19 02:28:12 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2022-03-31   sk    Add flash color counter for write and erase region
...
struct fs_flash_color_counters fs_flash_color_counter;
                         ...
                         uint32 new_time)
{
  ...
  fs_flash_color_counter.write_region_counters[category]+=count;
  /* Update the timers */
                          ...
                          uint32 new_time)
{
  ...
  fs_flash_color_counter.erase_region_counters[category]+=count;
  /* Update the timers */
...
fs_counters_init (void)
{
  ...
  memset (fs_flash_color_counter.write_region_counters,
          0, sizeof(uint32)*NUM_FS_FLASHOP_CATEGORIES);
  memset (fs_flash_color_counter.erase_region_counters,
          0, sizeof(uint32)*NUM_FS_FLASHOP_CATEGORIES);
