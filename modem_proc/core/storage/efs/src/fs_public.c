 ...
 * Copyright (C) 2002-2014, 2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/src/fs_public.c#3 $ $DateTime: 2019/12/24 01:37:59 $ $Author: pwbldsvc $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2019-10-17    eo      Improve EFS API debug framework part 2.
                   ...
                   fs_shutdown_mechanism shutdown_hint)
{
  ...
  fs_os_get_task_name (curr_task_tcb, task_name,
                       sizeof (task_name), NULL);
