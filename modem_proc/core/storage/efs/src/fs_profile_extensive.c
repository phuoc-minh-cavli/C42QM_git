 ...
 * Copyright (C) 2012-2013,2019 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/src/fs_profile_extensive.c#2 $ $DateTime: 2019/12/24 01:37:59 $ $Author: pwbldsvc $
...
fs_profile_extensive_get_saved_file_num (void)
{
  ...
  result = efs_read_file_helper (FS_PROFILE_EXTENSIVE_META_FILE,
