 ...
 * Copyright (C) 2008-2010,2012-2013,2019,2022 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/inc/fs_counters.h#3 $ $DateTime: 2022/04/19 02:28:12 $ $Author: pwbldsvc $
...
PACKED struct fs_flash_counters
{
...
struct fs_flash_color_counters
{
 uint32 write_region_counters[NUM_FS_FLASHOP_CATEGORIES];
 uint32 erase_region_counters[NUM_FS_FLASHOP_CATEGORIES];
};
...
extern struct fs_flash_color_counters fs_flash_color_counter;
