 ...
 * Copyright (C) 2002--2006, 2008--2010, 2012--2014, 2019 QUALCOMM Technologies, Inc.
 *
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/storage/efs/inc/fs_err.h#2 $ $DateTime: 2019/12/24 01:37:59 $ $Author: pwbldsvc $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2019-05-05     eo     Add string print support to FS_MSG
2018-03-05     rp     Remove err_enable_fs_log & err_disable_fs_log calls.
...
#include "err.h"
  ...
  #define FS_MSG_STRING_MED_1(a,b)do{(void) b;}while (0)
...
#include "msg.h"
  ...
  #define FS_MSG_STRING_MED_1(a,b) \
          MSG_SPRINTF_1(MSG_SSID_DFLT,MSG_LEGACY_MED,a,b)
