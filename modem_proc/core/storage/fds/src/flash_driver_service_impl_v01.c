...
GENERAL DESCRIPTION
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/core.mpss/3.10/storage/fds/src/flash_driver_service_impl_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
static const qmi_implemented_optionals_tuple qmi_fds_disable_scrub_reqresp_impl_tuple_v01 = 
{
  NULL,
  NULL,
  NULL
...
static const qmi_implemented_optionals fds_disable_scrub_resp_msg_impl_v01 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_fds_disable_scrub_impl_tuple_v01 = 
{
  NULL,
  NULL,
  &fds_disable_scrub_resp_msg_impl_v01
};

static const uint32_t fds_enable_scrub_req_msg_impl_array_v01[] =
{
    QMI_SI_TLV_SET(0x10)      /* recompute_md5 */
};

static const qmi_implemented_optionals fds_enable_scrub_req_msg_impl_v01 =
{
  1, /* number of elements in array */
  fds_enable_scrub_req_msg_impl_array_v01
};
static const qmi_implemented_optionals fds_enable_scrub_resp_msg_impl_v01 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_fds_enable_scrub_reqresp_impl_tuple_v01 = 
{
  &fds_enable_scrub_req_msg_impl_v01,
  &fds_enable_scrub_resp_msg_impl_v01,
  NULL
};
...
static const qmi_implemented_optionals_tuple * const fds_service_implemented_array_v01[] =
{
    ...
    &qmi_fds_disable_scrub_reqresp_impl_tuple_v01,       /* 0x0026 */
    &qmi_fds_disable_scrub_impl_tuple_v01,               /* 0x0027 */
    &qmi_fds_enable_scrub_reqresp_impl_tuple_v01         /* 0x0028 */
};

static const qmi_implemented_messages fds_service_implemented_v01 =
{
  0x0028,  /* maximum message ID in this service */
