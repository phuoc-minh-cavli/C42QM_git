...
static ClockInfoType gClockInfo[] =
{
   ...
   {.id = AdsppmClk_BSTC_core,     .freq = 0, .lastFreq = 0, .clkDomainSrc.clkDomainSrcIdLpass = Adsppm_Clk_Domain_Src_Id_Primary_PLL, .clkDomainSrc_last.clkDomainSrcIdLpass = Adsppm_Clk_Domain_Src_Id_Primary_PLL}
};
