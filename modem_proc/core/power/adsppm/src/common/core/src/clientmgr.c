...
$Header: //components/rel/core.mpss/3.10/power/adsppm/src/common/core/src/clientmgr.c#1 $
*/
...
static void evaluateOverallUseCaseActive(void)
{
    AdsppmClientManagerType* self = &gAdsppmClientManager;
