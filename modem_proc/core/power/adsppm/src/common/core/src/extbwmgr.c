...
$Header: //components/rel/core.mpss/3.10/power/adsppm/src/common/core/src/extbwmgr.c#2 $
*/
    ...
    void* param)
{
    ...
    AdsppmBusBWDataIbAbType dcvsVote;
	memset(&dcvsVote, 0, sizeof(AdsppmBusBWDataIbAbType));
    ...
    AdsppmBusBWDataIbAbType* pNewClientsFinalVote)
{
    ...
    ADSPPM_LOG_PRINTF_0(ADSPPM_LOG_LEVEL_ERROR,
        "extBwMgr_SendNewClientsFinalVoteToDcvs - DO NOTHING(Stub)");
    ERR_FATAL("extBwMgr_SendNewClientsFinalVoteToDcvs - DCVS Not Supported- STUB",0,0,0);
}
