...
$Header: //components/rel/core.mpss/3.10/power/adsppm/src/common/asic/src/asic_internal.h#1 $
*/
...
typedef struct
{
	...
	uint32 (*pFn_GetCppFromMpps)(uint32 mppsTotal, uint32 numDominantThreads);
