...
================================================================================
$Header: //components/rel/core.mpss/3.10/power/uSleep/inc/uSleep_lpri.h#1 $
...
typedef struct uSleep_lpr_callback_s
{
  ...
  void                          *userData;  /* Any persistant user supplied data (data not coped) */
  struct uSleep_lpr_callback_s  *next;
}uSleep_lpr_callback;

typedef struct uSleep_dynamic_lpr_s
{
  uSleep_lpr_callback   *enter;
  uSleep_lpr_callback   *exit;
}uSleep_dynamic_lpr;
 ...
 * 
 * @brief Gets a pointer to the master power mode table
 */
