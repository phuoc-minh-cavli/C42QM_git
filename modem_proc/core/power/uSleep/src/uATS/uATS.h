...
================================================================================
$Header: //components/rel/core.mpss/3.10/power/uSleep/src/uATS/uATS.h#4 $
...
/*==============================================================================
                                  MACROS & TYPES
  =============================================================================*/
#define USLEEP_SOLVER_STACK_SIZE 768
#define USLEEP_SOLVER_TASK_PRIORITY 252
...
typedef enum
{
  ...
  USLEEP_SIGNAL_XO_SETTLE_CHANGE    = 0x0010, /* XO settling time update from client  */
  
  USLEEP_SIGNAL_LAST                = 0x0020, /* MUST BE LAST STANDARD SIGNAL */
 ...
 *  
 * @brief Main uATS signal task that handles change in non-deferable
 timer expiry.
 */
void uATS_SignalTask(void *ignored);
