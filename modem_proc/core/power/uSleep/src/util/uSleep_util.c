...
================================================================================
$Header: //components/rel/core.mpss/3.10/power/uSleep/src/util/uSleep_util.c#2 $
$DateTime: 2019/03/12 01:20:45 $
==============================================================================*/
#include "comdef.h"
 ...
 */
/*uSleep_transition_profiling* uSleep_getProfilingDataPtr(void) harshal
{
...
/*
 * uSleep_setLowPowerModeState
 */
void uSleep_setLowPowerModeState(boolean value)
{
  uSleepLPR_setModeStatus(USLEEP_MODE_FULL_PC, value);
