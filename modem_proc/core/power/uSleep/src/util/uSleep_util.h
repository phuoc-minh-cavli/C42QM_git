...
================================================================================
$Header: //components/rel/core.mpss/3.10/power/uSleep/src/util/uSleep_util.h#1 $
...
#include "uSleepi.h"
//#include "uSleep_transi.h" harshal
//#include "sleep_stats_global.h" harshal
...
typedef struct uSleep_global_data_s
{
 ...
 // uSleep_transition_profiling transition_data; harshal
#endif
