/*==============================================================================
  ...
  DEPENDENCIES: None
                ...
                Copyright (c) 2013-2019 Qualcomm Technologies, Inc. (QTI).
                All Rights Reserved.
                Qualcomm Technologies Confidential and Proprietary
================================================================================
$Header: //components/rel/core.mpss/3.10/power/sleep2.0/src/os/sleep_holdoff_rcinit.c#3 $
$DateTime: 2019/03/18 00:28:27 $
==============================================================================*/
#include "DALSys.h"
...
)
{
  ...
  static npa_client_handle sleep_latency_client;
  ...
  if ( sleep_latency_client == NULL )
  {
    CORE_VERIFY_PTR( sleep_latency_client = 
                     npa_create_sync_client("/core/cpu/latency",
                                            "SleepRcinitWFI",
                                            NPA_CLIENT_REQUIRED)
                   );
  }
  ...
  /*Enabling WFI even if sleep is disabled in build*/
  if(FALSE == g_sleepAllowLowPowerModes)
  {
    npa_issue_required_request( sleep_latency_client, 1 );
