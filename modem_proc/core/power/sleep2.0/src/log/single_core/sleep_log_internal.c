...
================================================================================
$Header: //components/rel/core.mpss/3.10/power/sleep2.0/src/log/single_core/sleep_log_internal.c#3 $
$DateTime: 2018/12/28 04:14:02 $
==============================================================================*/
#include "sleep_log.h"
...
#define SLEEP_REQUESTS_LOG_SIZE        2048
#define SLEEP_INFO_LOG_SIZE            6144
#define SLEEP_PROFILE_LOG_SIZE         6144
#define SLEEP_DEBUG_LOG_SIZE           3072
