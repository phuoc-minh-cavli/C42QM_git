...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.10/bsp/build/scripts/devcfg_lcs_builder.py#3 $
...
def devcfg_lcs_builder(target, source, env):
   ...
   if rootenv.GetUsesFlag('USES_DEVCFG') is False and rootenv.GetUsesFlag('USES_DEVCFG_PAGEONLY') is False and rootenv.GetUsesFlag('USES_DEVCFG_SENSORONLY') is False:
      return None
