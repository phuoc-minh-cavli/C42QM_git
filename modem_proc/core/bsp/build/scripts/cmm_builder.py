...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.10/bsp/build/scripts/cmm_builder.py#3 $
...
valid_images = {'core_rpm': 'RPM', 'core_adsp':'ADSP', 'core_modem':'MPSS','core_wcn':'WCNSS','core_apps':'APPS','modem_pageonly':'MPSS','modem_sensoronly':'MPSS'}
# Tech teams
