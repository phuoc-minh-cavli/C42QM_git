...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright (c) 2003-2004,2006,2008,2013-2014 Qualcomm Technologies, Inc.
  All rights reserved.
...
$Header: //components/rel/core.mpss/3.10/securemsm/secboot/src/secboot_asn1.h#2 $
$DateTime: 2018/11/08 03:29:06 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/15/14   hw      fix QPSI review comments to support both 32bit and 64 bit.
...
#define SECBOOT_ASN1_H_SIG_VERS1 // SIL signature to identify the fix only on 64bit Arch, this is used together with
...
( ( ((uintnt)(p) + (uintnt)(len)) >= (uintnt)(p) ) &&       \
  ( ((uintnt)(p) + (uintnt)(len)) <= (uintnt)(bound) ) )    \
