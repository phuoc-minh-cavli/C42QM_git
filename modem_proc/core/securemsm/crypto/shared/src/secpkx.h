...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/securemsm/crypto/shared/src/secpkx.h#2 $ 
  ...
  struct __pkx_common_info_s
  {
    ...
    union
    {
      ...
      struct __pkx_rsa_storage_s
      {
		...
		uint8  priv_key_iv[SECAPI_ENC_AES_IV_BLOCK_BYTE_LEN];
		uint8  priv_key_devkey[SECAPI_ENC_AES_IV_BLOCK_BYTE_LEN];
        secapi_algo_enum_type  oaep_hash_algo;
        uint8_t  oaep_label[SECAPI_PKX_MAX_OAEP_LABEL_SIZE];
