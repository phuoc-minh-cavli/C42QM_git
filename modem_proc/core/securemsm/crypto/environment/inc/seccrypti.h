...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/securemsm/crypto/environment/inc/seccrypti.h#2 $ 
  $DateTime: 2018/11/20 22:32:11 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/29/17   yash    Sec instance pool increase to 77 for Dual IMS requirement
...
/* -------------------------------------------------------------------- */
#define SECCRYPT_INSTANCE_POOL_SIZE  77

/* -------------------------------------------------------------------- */
/* Pool size of available crypto commands                               */
/* -------------------------------------------------------------------- */
#define SECCRYPT_CMD_POOL_SIZE       77
