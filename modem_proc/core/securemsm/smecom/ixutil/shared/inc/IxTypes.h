...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/securemsm/smecom/ixutil/shared/inc/IxTypes.h#1 $ 
  $DateTime: 2018/06/26 03:18:17 $ 2005/09/07 
  $Author: pwbldsvc $ Madhav Chinthala  
