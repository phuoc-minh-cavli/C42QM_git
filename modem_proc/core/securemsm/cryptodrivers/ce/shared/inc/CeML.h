...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/3.10/securemsm/cryptodrivers/ce/shared/inc/CeML.h#2 $
 $DateTime: 2018/11/20 22:32:11 $
 $Author: pwbldsvc $ 

 when       who     what, where, why
 --------   ---     ----------------------------------------------------------
05/04/17   sahaj    SHA384 support
...
/**
 * @brief This function initializes the CE Mutex
 *
 * @param void
 *
