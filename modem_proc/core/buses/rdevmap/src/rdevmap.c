...
Copyright (c) 2000-2012,2014,2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/buses/rdevmap/src/rdevmap.c#1 $ $DateTime: 2019/04/09 05:59:03 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/21/17   pr	   Removed Unused Device ID Rdm Support 
24/11/16   pr      Checking Array Boundary condition for KW issue 
