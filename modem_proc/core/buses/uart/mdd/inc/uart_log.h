...
$Header: //components/rel/core.mpss/3.10/buses/uart/mdd/inc/uart_log.h#2 $
...
#define UART_BUFLOG_1( format, a1 )                    (void)a1                                            /*Surpass unused variable warnings */
#define UART_BUFLOG_2( format, a1, a2 )                (void)a1,(void)a2 								   /*Surpass unused variable warnings */
#define UART_BUFLOG_3( format, a1, a2, a3 )            (void)a1,(void)a2,(void)a3                          /*Surpass unused variable warnings */
...
#ifndef UART_DEBUG_FEATURE_ENABLE

#define UART_MSG_LOW( format, a1, a2, a3 )          
#define UART_MSG_MEDIUM( format, a1, a2, a3 )       
#define UART_MSG_HIGH( format, a1, a2, a3 )         
