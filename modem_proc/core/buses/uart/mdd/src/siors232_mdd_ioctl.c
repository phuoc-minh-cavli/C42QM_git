...
Copyright (c) 1999-2000, 2007-2008, 2012-2014 ,2017 Qualcomm Technologies Incorporated.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/buses/uart/mdd/src/siors232_mdd_ioctl.c#1 $ $DateTime: 2019/04/09 05:59:03 $ $Author: pwbldsvc $

when         who       what, where, why
-----------  --------  ----------------------------------------------------------
21-FEB-2017  pr	       Removed Unused UART IOCTL 
...
FUNCTION ioctl_set_tx_break_state 
