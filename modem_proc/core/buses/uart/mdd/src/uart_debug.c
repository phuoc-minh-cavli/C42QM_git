...
$Header: //components/rel/core.mpss/3.10/buses/uart/mdd/src/uart_debug.c#1 $
...
#ifdef UART_DEBUG_FEATURE_ENABLE 
...
static void uart_debug_hw_all(void)
{
  ...
  uart_logging_in_err_handler = TRUE;                                   /*Variable not created if Trace buffer are Disable */
#endif
