/*=============================================================================
  ...
  OVERVIEW: This file contains the implementation for the platform services.
          ...
          Copyright (c) 2015-2016,2019 Qualcomm Technologies Incorporated.
          All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/buses/i2c/src/drv/I2cPlatSvcInit.c#2 $
...
{
	if ( pDesc->initState & I2CPLAT_TGT_INIT_PNOC_INITED && pDesc->hNpaClient != NULL )
	{
     icbarb_complete_request(pDesc->hNpaClient);
     icbarb_destroy_client(pDesc->hNpaClient); 
	 pDesc->hNpaClient = NULL;
	 pDesc->initState &= ~(1<<I2CPLAT_TGT_INIT_PNOC_INITED);
    }
    return I2C_RES_SUCCESS; 
}
