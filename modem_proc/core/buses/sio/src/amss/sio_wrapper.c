...
Copyright (c) 2007-2012,2014,2019 Qualcomm Technologies Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/buses/sio/src/amss/sio_wrapper.c#5 $ $DateTime: 2019/10/02 23:31:52 $ $Author: pwbldsvc $

mm/dd/yy   who     what, where, why
--------   ---     ---------------------------------------------------------- 
09/25/19   ss      Added 1 mbps baudrate support.
09/13/19   ss      Added uart support for Modem Pageonly image.
01/23/19   ss      Modem Page Only Memory for Twizy(MDM9205)   
02/21/17   pr	   Removed registration of Unused dev init function 
