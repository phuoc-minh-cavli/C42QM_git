...
Copyright (c) 2007-2008,2014,2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/buses/sio/src/common/sio_priv.h#1 $ $DateTime: 2019/04/09 05:59:03 $ $Author: pwbldsvc $

MM/DD/YY   who     what, where, why
--------   ---     ----------------------------------------------------------
02/23/17   pr	   Reduce Minor and Major number after removing unused SIO ID 
...
#define SIO_MAX_MAJOR_NUM SIO_NULL_DRIVER + 1 /**< Maximum major numbers supported in SIO */
#define SIO_MAX_MINOR_NUM 72                 /**< Maximum minor numbers supported in SIO */
