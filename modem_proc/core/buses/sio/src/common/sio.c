...
Copyright (c) 1998-2009,2017 Qualcomm Technologies Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/buses/sio/src/common/sio.c#1 $ $DateTime: 2019/04/09 05:59:03 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/21/17   pr	   Removed Support for SIO_MAJOR_SMD_BRIDGE_NPROC 
