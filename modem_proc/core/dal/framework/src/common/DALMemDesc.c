...
DAL Memory Descriptor
        ...
        Copyright © 2016, 2019, 2020 Qualcomm Technologies Incorporated.
        All Rights Reserved.
...
#define DAL_CONFIG_MMU_SCHEME DAL_CONFIG_MMU_SCHEME_L4_PMEM
...
#define DAL_CONFIG_MMU_SCHEME_L4_PMEM_FIXED_BASE_VA       0x80000000
#define DAL_CONFIG_MMU_SCHEME_L4_PMEM_FIXED_BASE_PA       0x80000000
#define DAL_CONFIG_MMU_SCHEME_L4_PMEM_FIXED_SIZE          0x01200000
...
{
   uint32 dwAttrib=0;
   // Check for Null list, non-zero num buffers as well as num buffers allocated v/s what is specified by dwNumBufs
   ...
   memset((char *)pMemDescList->BufInfo, -1, sizeof(DALSysMemDescBuf)*dwNumBufs);
   return DAL_SUCCESS;
}
