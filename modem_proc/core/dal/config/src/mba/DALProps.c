...
$Header: //components/rel/core.mpss/3.10/dal/config/src/mba/DALProps.c#2 $
...
static const DALSYSPropStructTblType*
...
void _PopulateStructPtrProperty(DALSYSPropertyVar *pPropVar,
                                   ...
                                   byte *pbPropsBuf)
{
   const DALSYSPropStructTblType* pStruct = _GetPropStructPtrArray();
   uint32 dwIdx = 0;
