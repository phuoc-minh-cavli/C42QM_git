...
/*
  ...
  ====================================================================
  $Header: //components/rel/core.mpss/3.10/hwengines/adc/devices/vadc/src/pm_pmio_adc.h#1 $
  $DateTime: 2018/12/28 03:55:29 $
  $Author: pwbldsvc $
  ====================================================================
*/
...
#define PMIO_ADDRXI(base, pmiosym, index) __pmio_addrxi(base, pmiosym, index)
...
#define __pmio_addrxi(base, pmiosym, index)                         PMIO_##pmiosym##_ADDR(base, index)
