...
===============================================================================
 ...
 $Header: //components/rel/core.mpss/3.10/hwengines/bam/bamosal.c#2 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
10/31/18   AY      Added bam_osal_busywait function
...
===============================================================================
                   Copyright (c) 2011-2014, 2018 Qualcomm Technologies Incorporated.
                          All Rights Reserved.
...
/* ============================================================================
**  Function : bam_osal_busywait
** ============================================================================
*/
/**
  Add delay of some microseconds.

  Add delay of some microseconds.

  @param[in,out]  time    Number of micro seconds

  @return
  None

*/
void bam_osal_busywait(uint32 time)
{
#ifndef BAM_MBA
    DALSYS_BusyWait(time);
#endif
}
