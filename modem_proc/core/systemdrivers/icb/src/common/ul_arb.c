...
-------------------------------------------------------------------------------
  ...
  $Header: //components/rel/core.mpss/3.10/systemdrivers/icb/src/common/ul_arb.c#2 $
...
{
  ul_int_slave_list_type slaveList = {0};
  uint32 i;
...
)
{
   ...
   {
      ul_int_master_list_type master_list = {0};
      uint32_t                i;
   ...
   {
      ul_int_slave_list_type slave_list = {0};
      uint32_t               i;
