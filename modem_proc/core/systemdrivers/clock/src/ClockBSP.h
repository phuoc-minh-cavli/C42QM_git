...
$Header: //components/rel/core.mpss/3.10/systemdrivers/clock/src/ClockBSP.h#3 $

when       who     what, where, why 
--------   ---     --------------------------------------------------------- 
08/22/19   shm     Added DOMAIN_WAIT_FOR_ROOT_OFF flag
01/08/19   shm     Featurizing stub and test framework code for memory
                   optimization
06/26/18   shm     First version for MDM9205 codebase
