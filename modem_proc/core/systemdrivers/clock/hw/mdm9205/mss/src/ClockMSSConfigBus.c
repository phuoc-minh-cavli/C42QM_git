...
/**
  ...
  MPSS clock driver support for the MSS Config Bus.
  This file contains the NPA nodes for this component.
*/
/*
  ====================================================================
  ...
  ====================================================================
  $Header: //components/rel/core.mpss/3.10/systemdrivers/clock/hw/mdm9205/mss/src/ClockMSSConfigBus.c#2 $
