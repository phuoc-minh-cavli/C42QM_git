 ...
 *  
 *  &copy; Copyright 2013-2015, 2019-2020 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/config/common/pm_config_common.c#8 $
...
{
    {0xC000, 0x100, 0x008, 0x010, 0x011, 0x012, 0x013, 0x014, 0x015, 0x016, 0x018, 0x019, 0x01A, 0x01B, 0x040, 0x042, 0x043,0x44, 0x045, 0x041, 0x046}
};
...
{
    {0x6000, 0x100, 0x044, 0x046, 0x0146, 0x046, 0x014, 0x040, 0x041, 0x042, 0x043, 0x048, 0x049, 0x04A, 0x04B, 0x62, 0x63, 0x140, 0x141, 0x142, 0x143, 0x144, 0x145, 0x156, 0x0E2}
};

pm_pwr_register_info_type smps_reg[1] =
{
    {0x1400, 0x300, 0x008, 0x045, 0x048, 0x046, 0x040, 0x041, 0x042, 0x000, 0x04A, 0x050, 0x000, 0x060, 0x061, 0x000, 0x0D0, 0x005, 0x0DB , 0x039 ,0x042 ,0x043 ,0x047 ,0x000, 0x068 ,0x06B}
};

pm_pwr_register_info_type ldo_reg[1] =
{
    {0x4000, 0x100, 0x008, 0x045, 0x048, 0x046, 0x040, 0x041, 0x042, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x0D0, 0x005, 0x0DB , 0x039 ,0x042 ,0x043 ,0x047 ,0x000, 0x068 ,0x000}
};
