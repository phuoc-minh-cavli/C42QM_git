...
*  \n
*  \n &copy; Copyright (c) 2011-2016 Qualcomm Technologies, Inc. All Rights Reserved.
*  
...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/application/uicc/src/pm_uicc_app.h#1 $
