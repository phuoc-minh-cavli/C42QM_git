...
/*
  ...
  $Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/drivers/pon/src/pmio_pon.h#2 $
  $DateTime: 2019/07/09 00:06:29 $
  $Author: pwbldsvc $
...
#define AON_LPI_BASE 													  0x00000A00
...
#define PMIO_AON_LPI_PON_TRIGGER_EN_ADDR                                 (AON_LPI_BASE  + 0x0000004C)
#define PMIO_AON_TRIGGER_EN_KPDPWR_N_BMSK                                        0x4
#define PMIO_AON_TRIGGER_EN_PON1_BMSK                                            0x2
#define PMIO_AON_TRIGGER_EN_RTC_BMSK                                             0x1
