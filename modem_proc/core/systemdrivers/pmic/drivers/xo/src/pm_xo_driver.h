...
*  PMIC chip set.
*  \n &copy; Copyright 2010-2013, 2019 Qualcomm Technologies Incorporated, All Rights Reserved
*/
...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/drivers/xo/src/pm_xo_driver.h#3 $
...
typedef struct
{
    ...
    pm_register_address_type    peripheral_type;     //0x04    
    pm_register_address_type    peripheral_subtype;  //0x05
    ...
    pm_register_address_type    xo_dcc_adj;     //0x56
    pm_register_address_type    xo_comp;             //0x58 
