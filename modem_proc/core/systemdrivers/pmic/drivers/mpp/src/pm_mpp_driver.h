...
PMIC chip set.
*  &copy;  Copyright (c) 2009-2016 Qualcomm Technologies, Inc. All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/drivers/mpp/src/pm_mpp_driver.h#1 $
