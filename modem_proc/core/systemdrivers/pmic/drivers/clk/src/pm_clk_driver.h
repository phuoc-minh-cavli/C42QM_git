...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/drivers/clk/src/pm_clk_driver.h#2 $
...
typedef struct
{
    ...
    pm_register_address_type    SINGLE_CAL_EN;
