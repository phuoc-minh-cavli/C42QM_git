...
/* =======================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/drivers/gpio/src/pm_gpio_driver.h#2 $
...
typedef struct pm_gpio_register_info_type
{
    ...
    pm_register_address_type    dig_out_source_ctl;    //0x44   //GPIO01_DIG_OUT_SOURCE_CTL 
