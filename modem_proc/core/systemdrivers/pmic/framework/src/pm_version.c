...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/framework/src/pm_version.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/18/16   kc	   Compiler migration warnings cleanup on CORE.MPSS.3.5 (CR-1095509)
