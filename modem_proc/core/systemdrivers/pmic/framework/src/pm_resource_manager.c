...
$Header: //components/rel/core.mpss/3.10/systemdrivers/pmic/framework/src/pm_resource_manager.c#4 $
    ...
    switch((pm_hw_module_type)peripheral_info->peripheral_type)
    {
        ...
        case PM_HW_MODULE_CLOCK:
            ...
            switch (peripheral_info->peripheral_subtype)
            {
				...
				case PM_HW_MODULE_CLOCK_XO_CORE_38M:
        ...
        /* rtc as standalone driver, pm_rtc_driver_init is deprecated 
        ...
        */
        ...
        case PM_HW_MODULE_ALARM:
            if(peripheral_info->peripheral_subtype==PM_HW_MODULE_ALARM_BCL_COMP_MDM)
            {
                pm_bcl_comp_driver_init( comm_ptr, peripheral_info, pmic_index );
            }
        break;
