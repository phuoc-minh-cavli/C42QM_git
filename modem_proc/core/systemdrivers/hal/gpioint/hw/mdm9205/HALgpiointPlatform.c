...
$Header: //components/rel/core.mpss/3.10/systemdrivers/hal/gpioint/hw/mdm9205/HALgpiointPlatform.c#2 $
...
void HAL_gpioint_PlatformInitEarly (HAL_gpioint_PlatformType *pmPlatform)
{
  ...
  pmPlatform->pmCtl.nDirConnPolarityCfgReg         = (uint32)HWIO_TLMM_DIR_CONN_INTRn_CFG_MSS_ADDR(0);
  pmPlatform->pmCtl.nDirConnIntrReg                = (uint32)HWIO_TLMM_DIR_CONN_INTRn_CFG_MSS_ADDR(0);
  ...
  pmPlatform->pmCtl.nGpioSelBitShift               = HWIO_TLMM_DIR_CONN_INTRn_CFG_MSS_GPIO_SEL_SHFT;
  ...
  pmPlatform->pmCtl.nDirConnPolarityMask           = HWIO_TLMM_DIR_CONN_INTRn_CFG_MSS_POLARITY_BMSK;
  pmPlatform->pmCtl.nDirConnGpioSelMask            = HWIO_TLMM_DIR_CONN_INTRn_CFG_MSS_GPIO_SEL_BMSK;
