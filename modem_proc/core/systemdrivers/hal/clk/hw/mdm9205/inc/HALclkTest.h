...
$Header: //components/rel/core.mpss/3.10/systemdrivers/hal/clk/hw/mdm9205/inc/HALclkTest.h#2 $
...
#define HAL_CLK_TEST_SUBMUX_MASK  (0xF0000000)
...
#define HAL_CLK_GCC_TEST_GCC_PCNOC_XO_CLK                            (HAL_CLK_GCC_TEST | 0x009)
...
#define HAL_CLK_GCC_TEST_GCC_PCNOC_USB_CLK                           (HAL_CLK_GCC_TEST | 0x00F)
...
#define HAL_CLK_GCC_TEST_GCC_MSS_Q6SS_AXIS_CLK                       (HAL_CLK_GCC_TEST | 0x033)
...
#define HAL_CLK_GCC_TEST_GCC_QDSS_TRIG_CLK                           (HAL_CLK_GCC_TEST | 0x04A)
#define HAL_CLK_GCC_TEST_GCC_ECC_CLK                                 (HAL_CLK_GCC_TEST | 0x050)
#define HAL_CLK_GCC_TEST_GCC_ECC_CORE_CLK                            (HAL_CLK_GCC_TEST | 0x051)
#define HAL_CLK_GCC_TEST_GCC_DCC_XO_CLK                              (HAL_CLK_GCC_TEST | 0x058)
#define HAL_CLK_GCC_TEST_GCC_DCC_CLK                                 (HAL_CLK_GCC_TEST | 0x059)
...
#define HAL_CLK_GCC_TEST_GCC_TIC_CLK                                 (HAL_CLK_GCC_TEST | 0x068)
#define HAL_CLK_GCC_TEST_GCC_QZIP_CLK                                (HAL_CLK_GCC_TEST | 0x069)
#define HAL_CLK_GCC_TEST_GCC_PCNOC_SNOC_VMIDMT2_AHB_CLK              (HAL_CLK_GCC_TEST | 0x070)
#define HAL_CLK_GCC_TEST_GCC_PCNOC_SNOC_VMIDMT3_AHB_CLK              (HAL_CLK_GCC_TEST | 0x071)
#define HAL_CLK_GCC_TEST_GCC_PCNOC_SNOC_VMIDMT4_AHB_CLK              (HAL_CLK_GCC_TEST | 0x072)
...
#define HAL_CLK_GCC_TEST_GCC_QPIC_IO_MACRO_CLK                       (HAL_CLK_GCC_TEST | 0x07B)
#define HAL_CLK_GCC_TEST_GCC_BIMC_NOC_MPU_AHB_CLK                    (HAL_CLK_GCC_TEST | 0x080)
#define HAL_CLK_GCC_TEST_GCC_Q6_MPU_AHB_CLK                          (HAL_CLK_GCC_TEST | 0x081)
#define HAL_CLK_GCC_TEST_GCC_MSS_NAV_CE_MPU_AHB_CLK                  (HAL_CLK_GCC_TEST | 0x082)
#define HAL_CLK_GCC_TEST_GCC_PCNOC_SNOC_MPU_AHB_CLK                  (HAL_CLK_GCC_TEST | 0x083)
#define HAL_CLK_GCC_TEST_GCC_SNOC_BOOT_IMEM_MPU_AHB_CLK              (HAL_CLK_GCC_TEST | 0x084)
#define HAL_CLK_GCC_TEST_GCC_Q6_VMIDMT_AHB_CLK                       (HAL_CLK_GCC_TEST | 0x085)
#define HAL_CLK_GCC_TEST_GCC_MSS_NAV_CE_VMIDMT_AHB_CLK               (HAL_CLK_GCC_TEST | 0x086)
#define HAL_CLK_GCC_TEST_GCC_PCNOC_SNOC_VMIDMT1_AHB_CLK              (HAL_CLK_GCC_TEST | 0x087)
...
#define HAL_CLK_GCC_TEST_GCC_PRNG_AHB_BRIDGE_CLK                     (HAL_CLK_GCC_TEST | 0x0D9)
...
#define HAL_CLK_GCC_TEST_GCC_BIMC_MCDMA_NAV_CE_AXI_CLK               (HAL_CLK_GCC_TEST | 0x15C)
 ...
 * MSSCC debug clocks
 */
#define HAL_CLK_MSSCC_TEST                                           (2 << 0x10)

/*
 * Q6 sub-mux in MSSCC
 */
#define HAL_CLK_MSSCC_SUB_MUX_Q6                                     (0x3<<0x1C)

#define HAL_CLK_MSSCC_TEST_CLK_TDEC                                  (HAL_CLK_MSSCC_TEST | 0x000)
#define HAL_CLK_MSSCC_TEST_CLK_XO_DIV12                              (HAL_CLK_MSSCC_TEST | 0x001)
#define HAL_CLK_MSSCC_TEST_CLK_UIM0                                  (HAL_CLK_MSSCC_TEST | 0x002)
#define HAL_CLK_MSSCC_TEST_CLK_XO_UIM0                               (HAL_CLK_MSSCC_TEST | 0x004)
#define HAL_CLK_MSSCC_TEST_CLK_XO_MODEM                              (HAL_CLK_MSSCC_TEST | 0x006)
#define HAL_CLK_MSSCC_TEST_CLK_COXM_BIT                              (HAL_CLK_MSSCC_TEST | 0x007)
#define HAL_CLK_MSSCC_TEST_CLK_ADC                                   (HAL_CLK_MSSCC_TEST | 0x008)
#define HAL_CLK_MSSCC_TEST_CLK_L1S_NAV_MEM                           (HAL_CLK_MSSCC_TEST | 0x009)
#define HAL_CLK_MSSCC_TEST_CLK_SILVER                                (HAL_CLK_MSSCC_TEST | 0x00A)
#define HAL_CLK_MSSCC_TEST_CLK_ONE_XO                                (HAL_CLK_MSSCC_TEST | 0x00B)
#define HAL_CLK_MSSCC_TEST_CLK_TWO_XO                                (HAL_CLK_MSSCC_TEST | 0x00C)
#define HAL_CLK_MSSCC_TEST_CLK_UIM_DIV                               (HAL_CLK_MSSCC_TEST | 0x00F)
#define HAL_CLK_MSSCC_TEST_CLK_UIM                                   (HAL_CLK_MSSCC_TEST | 0x010)
#define HAL_CLK_MSSCC_TEST_CLK_NAV_DBE                               (HAL_CLK_MSSCC_TEST | 0x012)
#define HAL_CLK_MSSCC_TEST_XO_SRC_CLK_DFT                            (HAL_CLK_MSSCC_TEST | 0x016)
#define HAL_CLK_MSSCC_TEST_CLK_Q6_PLL2                               (HAL_CLK_MSSCC_TEST | 0x017)
#define HAL_CLK_MSSCC_TEST_CLK_ONE_XO_CBC                            (HAL_CLK_MSSCC_TEST | 0x018)
#define HAL_CLK_MSSCC_TEST_CLK_HALF_XO_CBC                           (HAL_CLK_MSSCC_TEST | 0x019)
#define HAL_CLK_MSSCC_TEST_MSS_BUS_ALT_CLK                           (HAL_CLK_MSSCC_TEST | 0x01A)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_NAV                               (HAL_CLK_MSSCC_TEST | 0x01B)
#define HAL_CLK_MSSCC_TEST_CLK_ADC_DIV                               (HAL_CLK_MSSCC_TEST | 0x01C)
#define HAL_CLK_MSSCC_TEST_CLK_SHARED_MEM                            (HAL_CLK_MSSCC_TEST | 0x020)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_MODEM_BRIDGE_CX                   (HAL_CLK_MSSCC_TEST | 0x021)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_MODEM                             (HAL_CLK_MSSCC_TEST | 0x022)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_NC_HM_BRIDGE                      (HAL_CLK_MSSCC_TEST | 0x023)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_POST_MUX                          (HAL_CLK_MSSCC_TEST | 0x024)
#define HAL_CLK_MSSCC_TEST_CLK_HALF_XO                               (HAL_CLK_MSSCC_TEST | 0x025)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_SLEEP                             (HAL_CLK_MSSCC_TEST | 0x026)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_BUS                               (HAL_CLK_MSSCC_TEST | 0x027)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_UIM                               (HAL_CLK_MSSCC_TEST | 0x028)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_XO                                (HAL_CLK_MSSCC_TEST | 0x029)
#define HAL_CLK_MSSCC_TEST_CLK_MODEM_SNOC_AXI                        (HAL_CLK_MSSCC_TEST | 0x02A)
#define HAL_CLK_MSSCC_TEST_CLK_NAV_SNOC_AXI                          (HAL_CLK_MSSCC_TEST | 0x02B)
#define HAL_CLK_MSSCC_TEST_CLK_MODEM_CFG_AHB                         (HAL_CLK_MSSCC_TEST | 0x02C)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_COMBODAC_COMP                     (HAL_CLK_MSSCC_TEST | 0x02D)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_CSR                               (HAL_CLK_MSSCC_TEST | 0x02E)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_BRIDGE                            (HAL_CLK_MSSCC_TEST | 0x02F)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_COXM                              (HAL_CLK_MSSCC_TEST | 0x030)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_SLAVE_TIMEOUT                     (HAL_CLK_MSSCC_TEST | 0x031)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_ATB                               (HAL_CLK_MSSCC_TEST | 0x033)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_UIM0                              (HAL_CLK_MSSCC_TEST | 0x034)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_XO_MND_UIM0                       (HAL_CLK_MSSCC_TEST | 0x035)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_MGPI                              (HAL_CLK_MSSCC_TEST | 0x036)
#define HAL_CLK_MSSCC_TEST_CLK_SRC_COXM_BIT                          (HAL_CLK_MSSCC_TEST | 0x037)
#define HAL_CLK_MSSCC_TEST_CLK_TWO_XO_CBC                            (HAL_CLK_MSSCC_TEST | 0x039)
#define HAL_CLK_MSSCC_TEST_CLK_MODEM_AXI_CBC                         (HAL_CLK_MSSCC_TEST | 0x03A)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_Q6                                (HAL_CLK_MSSCC_TEST | 0x03B)
#define HAL_CLK_MSSCC_TEST_CLK_BUS_DIV                               (HAL_CLK_MSSCC_TEST | 0x03C)
#define HAL_CLK_MSSCC_TEST_CLK_DAC                                   (HAL_CLK_MSSCC_TEST | 0x03D)
#define HAL_CLK_MSSCC_TEST_CLK_MODEM_AXI                             (HAL_CLK_MSSCC_TEST | 0x03E)

#define HAL_CLK_MSSCC_TEST_CLK_Q6                                    (HAL_CLK_MSSCC_TEST | HAL_CLK_MSSCC_SUB_MUX_Q6 | 0x1)
