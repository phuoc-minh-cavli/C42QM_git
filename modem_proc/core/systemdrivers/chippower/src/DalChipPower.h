...
===============================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/systemdrivers/chippower/src/DalChipPower.h#1 $
...
DALResult ChipPower_DeviceAttach(const char *, DALDEVICEID,DalDeviceHandle **);
