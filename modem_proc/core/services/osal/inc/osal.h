...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/services/osal/inc/osal.h#2 $ $DateTime: 2019/01/24 02:45:47 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2017-04-06    sp   New API, osal_dog_get_report_period() to get the dog
                   timeout value
...
/*!
  ...
  @return Period in milliseconds during which tasks can report to the Dog
