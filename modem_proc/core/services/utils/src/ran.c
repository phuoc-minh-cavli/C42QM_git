...
Copyright (c) 1990-2017 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/3.10/services/utils/src/ran.c#1 $ $DateTime: 2018/06/26 03:18:17 $ $Author: pwbldsvc $
