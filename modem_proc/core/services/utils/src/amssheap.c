...
Copyright (c) 2006-2017, 2019 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================ */
...
$Header: //components/rel/core.mpss/3.10/services/utils/src/amssheap.c#2 $ $DateTime: 2019/02/09 06:26:43 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
02/08/19   kdey    Making amss and modem heap static to prevent fragmentation
...
#ifndef AMSS_MEMHEAP_HEAP_SIZE
  #define AMSS_MEMHEAP_HEAP_SIZE 0x200000
#endif /* AMSS_MEMHEAP_HEAP_SIZE */

#ifdef FEATURE_STATIC_AMSS_HEAP
  #define AMSS_STATIC_BUFFER_ATTR __attribute__((section(".bss.amssheap"),aligned (64)))
  static uint8 amss_malloc_buffer[AMSS_MEMHEAP_HEAP_SIZE] AMSS_STATIC_BUFFER_ATTR;
  static volatile unsigned int amss_mem_heap_size = AMSS_MEMHEAP_HEAP_SIZE;
#endif
...
#ifndef FEATURE_STATIC_AMSS_HEAP
...
#else
  amss_malloc_init((&amss_malloc_buffer[0]), (void *)(&amss_malloc_buffer[0] +amss_mem_heap_size -1));
#endif /* FEATURE_STATIC_AMSS_HEAP */
...
/*===========================================================================
 ...
 Description :
     Returns the amss_mem_heap statistics for a thread 
	 with given memheap TLS index
===========================================================================*/
