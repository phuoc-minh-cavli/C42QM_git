...
Copyright (c) 1990-2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/3.10/services/utils/src/queue.c#2 $ $DateTime: 2018/08/24 22:11:27 $ $Author: pwbldsvc $
