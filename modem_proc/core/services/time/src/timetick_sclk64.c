...
Copyright (c) 2009 - 2014, 2018 by QUALCOMM Technologies Incorporated.  All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/services/time/src/timetick_sclk64.c#2 $
...
#if defined(FEATURE_TIME_QDSP6) || defined(FEATURE_QURT)
#include "qurt.h"
#endif
