...
$Header: //components/rel/core.mpss/3.10/services/time/src/timer_slaves.c#2 $
...
#ifndef MAX_TIMER_EXPIRED_SLAVE1
...
#ifndef MAX_TIMER_EXPIRED_SLAVE2
...
#ifndef MAX_TIMER_EXPIRED_SLAVE3
