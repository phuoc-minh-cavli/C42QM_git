/*=============================================================================
 Copyright (c) 2003-2013,2015-2017,2022 Qualcomm Technologies, Inc.
 All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/services/time_qmi/src/qmi_time_server.c#2 $
...
)
{
   ...
   if(NULL != recv_msg)
   {
     ...
     if(recv_msg->base == TIME_SERVICE_BASE_SECURE_V01
          ...
          || recv_msg->base > TIME_SERVICE_BASE_PSM_V01)
     {
...
)
{
  ...
  if(NULL != recv_msg)
  {
    ...
    if(msg_id == QMI_TIME_ATS_USER_UPDATE_IND_V01
       ...
       || msg_id == QMI_TIME_ATS_PSM_UPDATE_IND_V01)
    {
