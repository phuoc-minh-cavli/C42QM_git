...
Copyright (c) 2009-2014, 2018-2019 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/

/*===========================================================================
                            EDIT HISTORY FOR FILE
                                      
  $Header: //components/rel/core.mpss/3.10/services/diag/platform/bmp/src/diagdsmi.h#3 $
...
#define DSMI_DIAG_SIO_CTRL_RX_ITEM_CNT                 25
#endif
...
#define DSMI_DIAG_SIO_CTRL_TX_ITEM_CNT                 25
#endif
...
#define DSMI_DIAG_SIO_TX_ITEM_FEW_MARK                     ((DSMI_DIAG_SIO_TX_ITEM_CNT) - 5)
#define DSMI_DIAG_SIO_TX_ITEM_MANY_MARK                    ((DSMI_DIAG_SIO_TX_ITEM_CNT) - 3) 
  ...
  #define DSMI_DIAG_SIO_TX_ITEM_BUFFERED_MANY_MARK           ((DSMI_DIAG_SIO_TX_ITEM_CNT) - 5)
  /* Number of items we want outstanding before restoring flow */
  #define DSMI_DIAG_SIO_TX_ITEM_BUFFERED_FEW_MARK            ((DSMI_DIAG_SIO_TX_ITEM_BUFFERED_MANY_MARK) - 3)
  
#if !defined DSMI_DIAG_SIO_TX_ITEM_BUFFERED_MANY_DRAIN_MARK
  #define DSMI_DIAG_SIO_TX_ITEM_BUFFERED_MANY_DRAIN_MARK     ((DSMI_DIAG_SIO_TX_ITEM_CNT) - 7)
#endif
...
/* Command/Response Path */
  ...
  #define DSMI_DIAG_CMD_SIO_DCI_RX_ITEM_CNT               1
#endif
  ...
  #define DSMI_DIAG_CMD_SIO_DCI_TX_ITEM_CNT               1
#endif
