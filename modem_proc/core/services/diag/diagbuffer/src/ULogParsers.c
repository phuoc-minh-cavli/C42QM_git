...
$Header: //components/rel/core.mpss/3.10/services/diag/diagbuffer/src/ULogParsers.c#1 $ 

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/21/17   rs      Fixed KW error in UlogParser.c file for format string validation before its use.
