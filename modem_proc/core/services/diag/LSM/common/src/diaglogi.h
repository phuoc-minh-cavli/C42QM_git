...
Copyright (c) 2007-2014, 2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
/* Different Log stream bits used for diag_log_config */
#define DIAG_LOG_STREAM_NONE  0x0
#define DIAG_LOG_STREAM_1     0x1
#define DIAG_LOG_STREAM_2     0x2
