...
#define DIAG_CHANGE_CONN_SIG      0x00000008    /* This signal is set to change the connection
                                                   from SMDL to Sockets for backwards compatibility */
...
#define DIAG_OPEN_DCI_CHANNEL_SIG     0x2000   /* Signal to notify Diag to open 
													  DCI channel */
...
#define DIAG_INT_RESEND_DATA_SIG			0x00400000 /*Signal to resend data from SMDL*/

#define DIAG_INT_SEND_PERIPH_BUF_SIZE_SIG   0x00800000  /*Signal to send peripheral buffering
                                                            pool size */

#define DIAG_INT_RESEND_CTRL_SIG			0x01000000 /*Signal to resend command from SMDL*/
...
#ifndef DIAG_SEND_BUF_SIZE
#define DIAG_SEND_BUF_SIZE 0x8000 /* Buffer size*/
#endif

#ifndef DIAG_SEND_BUF_SIZE_DATA
#define DIAG_SEND_BUF_SIZE_DATA 0x8000 /* Buffer size for F3s/logs/events sent over regular channel */
#endif

#ifndef DIAG_SEND_BUF_SIZE_DATA_DCI
#define DIAG_SEND_BUF_SIZE_DATA_DCI 0x8  /* Buffer size for F3s/logs/events sent over DCI*/
/* Reducing this to a very low value, ultimately DCI will be featurized */
#endif
