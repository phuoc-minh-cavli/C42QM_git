...
Copyright (c) 2001 - 2012,2015-2017 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.mpss/3.10/services/diag/DCM/common/src/diagtarget.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/20/16   nk      Moved DIAG_OPEN_DCI_CHANNEL_SIG to external signals and removed 
                   DIAG_TASK_OFFLINE_SIG signal
10/19/16   nk      Added support for WCDMA frame number registration for extended packets
...
FUNCTION MSG_GET_TIME_EXT

DESCRIPTION
  This function gets the time-stamp for  extended f3 debug messages.

===========================================================================*/

uint8 msg_get_time_ext ( qword *ts,unsigned int version, void* parameter );
