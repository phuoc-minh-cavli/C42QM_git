...
Copyright (c) 2005-2013, 2015, 2016, 2018-2019 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/services/diag/DCM/common/src/diagdsm.c#4 $
...
/* The dsm item arrays will only be allocated in stand alone modem */
#ifndef DIAG_MP
...
boolean diagdsm_init(void)
{
  ...
  /* The dsm pools will only be initialized in stand alone modem */  
  #ifndef DIAG_MP
    /*This pool is used outside of diag*/
