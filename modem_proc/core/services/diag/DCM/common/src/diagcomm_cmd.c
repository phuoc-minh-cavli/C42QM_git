...
Copyright (c) 2013-2014, 2019 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
 ...
 $Header: //components/rel/core.mpss/3.10/services/diag/DCM/common/src/diagcomm_cmd.c#3 $
...
/* Watermark queues are only initialized for standalone modem scenario */
  #ifndef DIAG_MP
      dsm_queue_init
      (
