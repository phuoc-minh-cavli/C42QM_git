...
Copyright (c) 2005,2009-2010, 2018 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/3.10/services/diag/DCM/rtos/src/paramsdiag.c#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/27/18   gn      Used DIAG_MP to control CBSP polling command instead of FEATURE_DIAG_STATUS_RSP
...
DESCRIPTION
  Return Diag Status to detect diag in standalone configuration.
...
static const diagpkt_user_table_entry_type paramsdiag_tbl[] =
{
  ...
  #if !defined(DIAG_MP)
  /* Register CBSP polling command only in standalone configuration */
