...
/*
Copyright (c) 2009-2016, 2019,2023 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/services/diag/diag_mask_tbl/src/msg_arrays_i.c#8 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/07/19   vg      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.124
07/06/18   kdey    Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.117
09/01/18   nk      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.110 
11/29/16   as      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.94
...
static const uint32 msg_bld_masks_gen[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_WWAN_APS,       
  MSG_BUILD_MASK_MSG_SSID_MMODE_IOT,        
  MSG_BUILD_MASK_MSG_SSID_SEE_IOT,          
  MSG_BUILD_MASK_MSG_SSID_AWARE_PSM_DAEMON, 
  MSG_BUILD_MASK_MSG_SSID_NAS_IOT,         
  MSG_BUILD_MASK_MSG_SSID_DATA_HLOS_IOT,   
  MSG_BUILD_MASK_MSG_SSID_MODEM_DATA,      
  MSG_BUILD_MASK_MSG_SSID_ODL_SM,
  MSG_BUILD_MASK_MSG_SSID_AWARE_PLATFORM,  
...
static uint32 msg_rt_masks_preset_v2x[DIAG_MAX_PRESET_ID][sizeof(msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0])];
#ifdef DIAG_CONSUMER_API
  static uint32 msg_rt_masks_dci_v2x[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0])];
#endif /* #ifdef DIAG_CONSUMER_API */
#ifdef DIAG_LISTENERS_SUPPORT
  uint32 msg_listener_masks_v2x[sizeof(msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0])];
  uint32 msg_listener_ext_masks_v2x[sizeof(msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0])];
#endif /* #ifdef DIAG_LISTENERS_SUPPORT */
...
msg_mask_tbl_type msg_mask_tbl[] = {

  {
    ...
    msg_bld_masks_gen,
      ...
      { (uint32*)msg_rt_masks_preset_gen, (uint32*)msg_rt_masks_dci_gen }
    #else
      { (uint32*)msg_rt_masks_preset_gen},
      { (uint32*)msg_rt_masks_preset_gen}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_oncrpc,
      ...
      { (uint32*)msg_rt_masks_preset_oncrpc, (uint32*)msg_rt_masks_dci_oncrpc }
    #else
      { (uint32*)msg_rt_masks_preset_oncrpc},
      { (uint32*)msg_rt_masks_preset_oncrpc}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_hdr,
      ...
      { (uint32*)msg_rt_masks_preset_hdr, (uint32*)msg_rt_masks_dci_hdr }
    #else
      { (uint32*)msg_rt_masks_preset_hdr},
      { (uint32*)msg_rt_masks_preset_hdr}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_umts,
      ...
      { (uint32*)msg_rt_masks_preset_umts, (uint32*)msg_rt_masks_dci_umts }
    #else
      { (uint32*)msg_rt_masks_preset_umts },
      { (uint32*)msg_rt_masks_preset_umts }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_gsm,
      ...
      { (uint32*)msg_rt_masks_preset_gsm, (uint32*)msg_rt_masks_dci_gsm }
    #else
      { (uint32*)msg_rt_masks_preset_gsm },
      { (uint32*)msg_rt_masks_preset_gsm }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_wlan,
      ...
      {(uint32*)msg_rt_masks_preset_wlan, (uint32*)msg_rt_masks_dci_wlan }
    #else
      {(uint32*)msg_rt_masks_preset_wlan},
      {(uint32*)msg_rt_masks_preset_wlan}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_mcs,
      ...
      { (uint32*)msg_rt_masks_preset_mcs, (uint32*)msg_rt_masks_dci_mcs }
    #else
      { (uint32*)msg_rt_masks_preset_mcs },
      { (uint32*)msg_rt_masks_preset_mcs }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_sec,
      ...
      { (uint32*)msg_rt_masks_preset_sec, (uint32*)msg_rt_masks_dci_sec }
    #else
      { (uint32*)msg_rt_masks_preset_sec },
      { (uint32*)msg_rt_masks_preset_sec }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_apps,
      ...
      { (uint32*)msg_rt_masks_preset_apps, (uint32*)msg_rt_masks_dci_apps }
    #else
      { (uint32*)msg_rt_masks_preset_apps },
      { (uint32*)msg_rt_masks_preset_apps }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_adsptasks,
      ...
      { (uint32*)msg_rt_masks_preset_adsptasks, (uint32*)msg_rt_masks_dci_adsptasks }
    #else
      { (uint32*)msg_rt_masks_preset_adsptasks },
      { (uint32*)msg_rt_masks_preset_adsptasks }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_l4_linux,
      ...
      { (uint32*)msg_rt_masks_preset_l4_linux, (uint32*)msg_rt_masks_dci_l4_linux }
    #else
      { (uint32*)msg_rt_masks_preset_l4_linux },
      { (uint32*)msg_rt_masks_preset_l4_linux }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_l4_iguana,
      ...
      { (uint32*)msg_rt_masks_preset_l4_iguana, (uint32*)msg_rt_masks_dci_l4_iguana }
    #else
      { (uint32*)msg_rt_masks_preset_l4_iguana },
      { (uint32*)msg_rt_masks_preset_l4_iguana }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_l4_amss,
      ...
      { (uint32*)msg_rt_masks_preset_l4_amss, (uint32*)msg_rt_masks_dci_l4_amss }
    #else
      { (uint32*)msg_rt_masks_preset_l4_amss},
      { (uint32*)msg_rt_masks_preset_l4_amss}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_hit,
      ...
      { (uint32*)msg_rt_masks_preset_hit, (uint32*)msg_rt_masks_dci_hit }
    #else
      { (uint32*)msg_rt_masks_preset_hit },
      { (uint32*)msg_rt_masks_preset_hit }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_qdsp6,
      ...
      { (uint32*)msg_rt_masks_preset_qdsp6, (uint32*)msg_rt_masks_dci_qdsp6 }
    #else
      { (uint32*)msg_rt_masks_preset_qdsp6 },
      { (uint32*)msg_rt_masks_preset_qdsp6 }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_umb,
      ...
      { (uint32*)msg_rt_masks_preset_umb, (uint32*)msg_rt_masks_dci_umb }
    #else
      { (uint32*)msg_rt_masks_preset_umb },
      { (uint32*)msg_rt_masks_preset_umb }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_lte,
      ...
      { (uint32*)msg_rt_masks_preset_lte, (uint32*)msg_rt_masks_dci_lte }
    #else
      { (uint32*)msg_rt_masks_preset_lte },
      { (uint32*)msg_rt_masks_preset_lte }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_qchat,
      ...
      { (uint32*)msg_rt_masks_preset_qchat, (uint32*)msg_rt_masks_dci_qchat }
    #else
      { (uint32*)msg_rt_masks_preset_qchat },
      { (uint32*)msg_rt_masks_preset_qchat }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_tdscdma,
      ...
      { (uint32*)msg_rt_masks_preset_tdscdma, (uint32*)msg_rt_masks_dci_tdscdma }
    #else
      { (uint32*)msg_rt_masks_preset_tdscdma },
      { (uint32*)msg_rt_masks_preset_tdscdma }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
  ...
  ,
  {
    ...
    msg_bld_masks_cta,
      ...
      { (uint32*)msg_rt_masks_preset_cta, (uint32*)msg_rt_masks_dci_cta }
    #else
      { (uint32*)msg_rt_masks_preset_cta },
      { (uint32*)msg_rt_masks_preset_cta }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
    ,
  {
    ...
    msg_bld_masks_qcnea,
      ...
      { (uint32*)msg_rt_masks_preset_qcnea, (uint32*)msg_rt_masks_dci_qcnea }
    #else
      { (uint32*)msg_rt_masks_preset_qcnea },
      { (uint32*)msg_rt_masks_preset_qcnea }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
   ,
  {
    ...
    msg_bld_masks_dpm,
      ...
      { (uint32*)msg_rt_masks_preset_dpm, (uint32*)msg_rt_masks_dci_dpm }
    #else
      { (uint32*)msg_rt_masks_preset_dpm },
      { (uint32*)msg_rt_masks_preset_dpm }
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
    ,
  {
    ...
    msg_bld_masks_v2x,
    #ifdef DIAG_CONSUMER_API
      { (uint32*)msg_rt_masks_preset_v2x, (uint32*)msg_rt_masks_dci_v2x },
      { (uint32*)msg_rt_masks_preset_v2x, (uint32*)msg_rt_masks_dci_v2x }
    #else
      { (uint32*)msg_rt_masks_preset_v2x},
      { (uint32*)msg_rt_masks_preset_v2x}
    #endif /* #ifdef DIAG_CONSUMER_API */
  }
};
...
(uint32*)msg_listener_ext_masks_dpm
    ...
    ,
  {
    ...
    MSG_SSID_V2X+
       sizeof (msg_bld_masks_v2x) / sizeof(msg_bld_masks_v2x[0]) - 1,
    (uint32*)msg_listener_masks_v2x,
    (uint32*)msg_listener_ext_masks_v2x
  } 
};
