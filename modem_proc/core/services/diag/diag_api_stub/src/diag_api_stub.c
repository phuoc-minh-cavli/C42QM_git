...
Copyright (c) 2010, 2013, 2018-2019 Qualcomm Technologies, Incorporated. 
All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/services/diag/diag_api_stub/src/diag_api_stub.c#3 $
...
void diagpkt_tbl_reg (diagpkt_master_table_type * tbl_ptr, const diagpkt_user_table_entry_type * user_tbl_ptr) /* diagpkt.h */
{
  return;
}
