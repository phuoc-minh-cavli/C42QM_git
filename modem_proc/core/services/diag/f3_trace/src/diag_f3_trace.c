...
Copyright (c) 2004-2016, 2022 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/*==========================================================================

                        EDIT HISTORY FOR MODULEW
$Header: //components/rel/core.mpss/3.10/services/diag/f3_trace/src/diag_f3_trace.c#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/18/16   nk      Made changes in F3 trace logic for extended msgs
07/28/15   ph      Fixed the arguments truncation when err_f3_save_msg called
                   from ERR macro. 
