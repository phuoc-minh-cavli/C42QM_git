...
$Header: //components/rel/core.mpss/3.10/mproc/glink/xport_rpm/inc/xport_rpm_config.h#1 $
...
typedef struct _xport_rpm_config_rawint_type
{
  uint32* addr;                /* IPC interrupt register address */
  uint32 value;                /* Value to write into register   */
} xport_rpm_config_rawint_type;       
