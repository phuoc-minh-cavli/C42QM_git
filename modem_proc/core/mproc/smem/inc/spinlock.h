...
$Header: //components/rel/core.mpss/3.10/mproc/smem/inc/spinlock.h#1 $
...
/*===========================================================================
  FUNCTION  smem_spin_locks_clear_stm
===========================================================================*/
/**
  This function unlocks all spinlocks held by the specified host without 
  acquiring local critical section(lock). This function is called in STM mode.
...
*/
/*==========================================================================*/
void smem_spin_locks_clear_stm( smem_host_type host );
