...
$Header: //components/rel/core.mpss/3.10/mproc/smem/src/smem_target.h#1 $
...
/*===========================================================================
  FUNCTION  spin_unlock_stm_internal
===========================================================================*/
/**
  Releases spinlock by writing zero to the hardware mutex. 
  Release the spinlock unconditionally as it is called in STM mode.
...
*/
/*==========================================================================*/
void spin_unlock_stm_internal( uint32 lock );
