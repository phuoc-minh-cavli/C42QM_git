...
/*
Copyright (c) 1992-2015, 2018-2019 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/services/diagpkt.h#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/07/19   kdey    Featurizing macros under #ifndef to allow their definition outside diag
...
@ingroup packet_service
   ...
   DIAGPKT_DISPATCH_TABLE_REGISTER and not call this function directly.
  ...
  #define DIAGPKT_DISPATCH_TABLE_REGISTER(xx_subsysid, xx_entry) \
    do { \
      static diagpkt_master_table_type xx_entry##_table = { \
       ...
       /*lint -save -e717 */ \
      diagpkt_tbl_reg (&xx_entry##_table, xx_entry); \
    } while (0)
     /*lint -restore */
/*! 
...
/*@}*/  /* end of Diagnostics Packet Dispatch Table Registration on Dual Processor Target macros  */
  ...
  */
  ...
  public:
    ...
    */
    DiagDispatch (diagpkt_master_table_type *tbl_ptr)
    {
      diagpkt_tbl_reg(tbl_ptr, tbl_ptr->user_table);
    }
  };
...
/* DIAG_MAX_RX_PKT is the maximum size of a RX packet. This defines the size of diag request inbound buffer in which the request is put. The size cannot be less than 64 bytes*/
#ifndef DIAG_MAX_RX_PKT_SIZ
#define DIAG_MAX_RX_PKT_SIZ 8100
#endif
