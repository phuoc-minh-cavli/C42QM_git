...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/services/msgtgt.h#6 $
...
#define MSG_BUILD_MASK_MSG_SSID_MGPME_MC        (MSG_LVL_MED | MSG_INT_MASK_5 | \
            MSG_INT_MASK_6 | MSG_INT_MASK_7 | MSG_INT_MASK_8) 
#define MSG_BUILD_MASK_MSG_SSID_WWAN_APS         (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_MMODE_IOT        (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_SEE_IOT          (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_PSM_DAEMON (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_NAS_IOT          (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_DATA_HLOS_IOT    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_MODEM_DATA       (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_ODL_SM           (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_AWARE_PLATFORM   (MSG_LVL_HIGH)
