...
===========================================================================*/
/*
Copyright (c) 1997-2014,2016-2017 Qualcomm Technologies, Inc.
All rights reserved.
...
$Header: //components/rel/core.mpss/3.10/api/services/memheap.h#1 $ $DateTime: 2018/06/26 03:18:17 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     --------------------------------------------------------
03/22/17   abh     Align mutex memory used in memheap structure (CR 1010175)
