...
$Header: //components/rel/core.mpss/3.10/api/services/ULog.h#2 $ 
...
/* This macro defines the maximum size for the buffer of a ULog Handle.
In diag code this is kept to be 64KB, it can be defined outside diag code with a lower size.
If client requests for a buffer size which is larger than the maximum size, client will be forcefully assigned a buffer of maximum size.*/
#ifndef ULOG_MAXIMUM_LOG_SIZE
#define ULOG_MAXIMUM_LOG_SIZE 65536
#endif
