...
$Header: //components/rel/core.mpss/3.10/api/services/queue.h#3 $ $DateTime: 2018/09/13 22:58:32 $ $Author: pwbldsvc $
   
when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/06/18    kdey   Fixed compiler error for ASSERT_FATAL
