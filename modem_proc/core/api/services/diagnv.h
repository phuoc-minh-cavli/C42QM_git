...
Copyright (c) 2001-2010, 2016-2017 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/services/diagnv.h#2 $
...
/*! 
  ...
  @brief
    This procedure encapsulates an NV read operation for the
    diag task when a context is specified.
    Assumes that diag_init has set up the NV command buffer,
    ncmd.
