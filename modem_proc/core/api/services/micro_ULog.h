 ...
 *
 * @deprecated This API is deprecated. Migrate Code to use 'micro_diagbuffer_create' to create micro diagbuffer.
 */
micro_ULogResult micro_ULog_CreateLog( micro_ULogHandle *hPtr,
                                               const char * logName,
                                               char * mem,
                                       uint32 *pFinalMsgBufSize,
                                               uint32 memSize ) CORE_WARN_DEPRECATED_MSG("This API is deprecated", 
                                        "Migrate Code to use 'micro_diagbuffer_create' to create micro diagbuffer. ");
