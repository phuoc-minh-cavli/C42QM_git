...
Copyright (c) 1998-2011, 2019 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.mpss/3.10/api/services/amssassert.h#2 $ $DateTime: 2019/01/24 01:39:00 $ $Author: pwbldsvc $
...
*/
  ...
  #undef ASSERT 
    ...
    #include "err.h"
  #endif
#ifndef FEATURE_GENERIC_ERR_FATAL_MSG
  ...
  #define ASSERT( xx_exp ) \
     if( !(xx_exp) ) \
     { \
        ERR_FATAL( "Assertion failed", 0, 0, 0 ); \
     }
#endif
