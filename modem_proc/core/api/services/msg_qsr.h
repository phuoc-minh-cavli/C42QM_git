...
/*
Copyright (c) 2010-2015,2018-2019 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/api/services/msg_qsr.h#4 $

when       who     what, where, why
--------   ---   ----------------------------------------------------------
07/16/18   nk      Added changes for optimization of DIAG MSG apis
...
typedef struct
{
  ...
  */
  #define XX_MSG_V2_CONST(xx_ss_id, xx_ss_mask, xx_fmt) \
    static const char QSR_string_ptr[] QSR_ATTR  \
      = msg_file ":" xx_fmt ; \
    static const msg_v2_const_type xx_msg_v2_const QSR_MSG_ATTR = { \
  ...
  */
  #define XX_ERR_MSG_V2_CONST(xx_ss_id, xx_ss_mask, xx_fmt) \
    static const char QSR_string_ptr[] QSR_ATTR  \
      = msg_file ":" xx_fmt ; \
    static const err_msg_v2_const_type xx_err_msg_v2_const QSR_MSG_ERR_ATTR= { \
      {{__LINE__, (xx_ss_id), (xx_ss_mask)}, \
...
#define HEXMSGABI_ATTRIBUTE __attribute__((hexmsgabi))
#else
#define HEXMSGABI_ATTRIBUTE
#endif
...
*/
  void msg_v3_send ( const msg_v3_const_type * xx_msg_const_ptr) HEXMSGABI_ATTRIBUTE;
...
*/
  void msg_v3_send_1 (const msg_v3_const_type * xx_msg_const_ptr, uint32 xx_arg1)HEXMSGABI_ATTRIBUTE;
/*!
@ingroup diag_message_service
   @brief
   This will build a new style optimized diagnostic message with 1 parameter. 
...
*/
  void msg_v3_send_2 ( const msg_v3_const_type * xx_msg_const_ptr,uint32 xx_arg1,uint32 xx_arg2) HEXMSGABI_ATTRIBUTE;
/*!
@ingroup diag_message_service
   @brief
   This will build a new style optimized diagnostic message with 2 parameters. 
...
*/
  void msg_v3_send_3 ( const msg_v3_const_type * xx_msg_const_ptr, uint32 xx_arg1,
    uint32 xx_arg2, uint32 xx_arg3)HEXMSGABI_ATTRIBUTE;
/*!
@ingroup diag_message_service
   @brief
   This will build a new style optimized diagnostic message with 3 parameters. 
