...
/*
Copyright (c) 2008-2014, 2017 Qualcomm Technologies,Incorporated. 
All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/api/services/msg_diag_service.h#3 $
...
#define MSG_1(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1) \
  ...
  /*lint -e717 */ \
                       ...
                       /* lint +e717 */
#define MSG_1_DLL(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
...
#define MSG_2_DLL(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
...
#define MSG_3_DLL(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
    /*lint +e506 +e774*/ \
...
#define MSG_4_EXT(xx_ss_id, xx_ss_mask, xx_version, xx_parameter, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  /*lint -e717 */ \
                       ...
                       /* lint +e717 */
#define MSG_4_DLL(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
                                            xx_arg4) \
  do { \
    /*lint -e506 -e774*/ \
    if (xx_ss_mask & (MSG_BUILD_MASK_ ## xx_ss_id)) { \
