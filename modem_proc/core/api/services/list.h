...
===========================================================================*/
/*
Copyright (c) 2000-2011, 2018 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.mpss/3.10/api/services/list.h#2 $ $DateTime: 2018/08/24 22:11:27 $ $Author: pwbldsvc $
...
*/
#ifdef FEATURE_QDSP6
   #define LIST_MUTEX_LOCK(pkcs) qurt_pimutex_lock(pkcs)
#else /* FEATURE_QDSP6 */
   #ifdef FEATURE_WINCE
      #error code not present
#else
...
*/
#ifdef FEATURE_QDSP6
   #define LIST_MUTEX_FREE(pkcs) qurt_pimutex_unlock(pkcs)
#else /* FEATURE_QDSP6 */
   #ifdef FEATURE_WINCE
      #error code not present
#else /* FEATURE_WINCE */
