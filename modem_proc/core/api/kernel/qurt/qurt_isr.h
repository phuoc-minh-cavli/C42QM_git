...
#define QURT_ISR_ATTR_INT_TRIGGER_USE_DEFAULT   0 
#define QURT_ISR_ATTR_INT_TRIGGER_LEVEL_HIGH    1 
#define QURT_ISR_ATTR_INT_TRIGGER_LEVEL_LOW     2 
#define QURT_ISR_ATTR_INT_TRIGGER_RISING_EDGE   3 
#define QURT_ISR_ATTR_INT_TRIGGER_FALLING_EDGE  4 
