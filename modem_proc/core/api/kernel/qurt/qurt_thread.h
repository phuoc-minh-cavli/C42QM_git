...
/**@ingroup func_qurt_thread_get_running_ids
  Returns thread ids of currently running threads in the system, should be used only during fatal error handling\n
  ...
  @return
   QURT_EINVALID incorrect arg
   QURT_ENOTALLOWED   api not called during error handling\n
   QURT_EOK Success,  returns NULL terminated array of thread_id
