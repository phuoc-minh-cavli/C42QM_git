...
/*
||name   : Name of the memsection in cust_config.xml, that specifies this mapping
||		   : Should be less than 25 chars.
||addr   : Virtual address preferred, NULL if no prefernce.
||		   : If memsection specifies virtual address and NULL is asked,
||       : memsection's virtual address will be used as base address.
||length : Length of mapping.
||prot   : Protection flags (R/W/X), Cache attributes, Bus attributes, User mode
||flags  : Shared , Private, Anonymous etc.
||offset : Offset into physical address range specified in memsection. 
||       : If offset + length exceeds size of memsection, failure will be returned.
*/
