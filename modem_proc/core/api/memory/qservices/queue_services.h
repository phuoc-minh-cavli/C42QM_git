...
$Header: //components/rel/core.mpss/3.10/api/memory/qservices/queue_services.h#1 $ $DateTime: 2018/06/26 03:18:17 $ $Author: pwbldsvc $
...
/**
  ...
  to q_init().
*/
static __inline void* q_get_usr_data_s( const q_link_type *q_link_ptr )
{
/* No validity checks made in inline functions
   Validity checks to be made in client code */
