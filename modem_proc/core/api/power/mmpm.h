...
$Header: //components/rel/core.mpss/3.10/api/power/mmpm.h#1 $
...
/** @endcond */
    ...
    MMPM_CORE_ID_LPASS_ADSP     = 101,   /**< aDSP hardware in the LPASS. */
...
typedef enum {
    ...
    /**<  SLIMbus core clock. */
    MMPM_CLK_ID_LPASS_SLIMBUS2_CORE, /* sn: had to add as adsppm.h had it, and convertion was using in api.c */
    /**<  SLIMbus2 core clock. */
...
typedef enum {
    ...
    MMPM_BW_PORT_ID_SLIMBUS2_MASTER,  /**< SLIMbus2 master. */
    ...
    MMPM_BW_PORT_ID_SLIMBUS2_SLAVE,   /**< SLIMbus2 slave. */
