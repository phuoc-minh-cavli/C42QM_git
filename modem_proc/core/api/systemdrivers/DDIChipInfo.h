...
============================================================================
                             Edit History
  $Header: //components/rel/core.mpss/3.10/api/systemdrivers/DDIChipInfo.h#4 $ 
  $DateTime: 2018/09/25 03:25:32 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     --------------------------------------------------------
09/12/18   shm     Added 9205 support.
...
typedef enum
{
  ...
  DALCHIPINFO_ID_QM215       = 386,
  DALCHIPINFO_ID_APQ8096A    = 387,
  DALCHIPINFO_ID_MDM9205     = 388,
...
typedef enum
{
  ...
  DALCHIPINFO_FAMILY_QCS605      = 88,
  DALCHIPINFO_FAMILY_SDM632      = 89,
  DALCHIPINFO_FAMILY_QCS6200     = 90,
  DALCHIPINFO_FAMILY_SDM439      = 91,
  DALCHIPINFO_FAMILY_SDM640      = 92,
  DALCHIPINFO_FAMILY_QCS405      = DALCHIPINFO_FAMILY_QCS6200,
  DALCHIPINFO_FAMILY_SDA865      = 93,
  DALCHIPINFO_FAMILY_SDX55       = 94,
  DALCHIPINFO_FAMILY_QCA639x     = 95,
  DALCHIPINFO_FAMILY_SM8150      = DALCHIPINFO_FAMILY_SDM855,
  DALCHIPINFO_FAMILY_SM8250      = DALCHIPINFO_FAMILY_SDA865,
  DALCHIPINFO_FAMILY_SCX8180     = DALCHIPINFO_FAMILY_SDM1000,
  DALCHIPINFO_FAMILY_SM7150      = 96,
  DALCHIPINFO_FAMILY_SM6150      = DALCHIPINFO_FAMILY_SDM640,
  DALCHIPINFO_FAMILY_SXR1130     = 97,
  DALCHIPINFO_FAMILY_QCN7605     = 98,
  DALCHIPINFO_FAMILY_SC8180X     = DALCHIPINFO_FAMILY_SCX8180,
  DALCHIPINFO_FAMILY_MDM9205     = 99,
