...
$Header: //components/rel/core.mpss/3.10/api/systemdrivers/pmic/pm_clk.h#2 $
...
/** 
*  
* @brief enable / desable calRC calibration. 
* 
* @param pmic_chip: Selects the device in which the buffers being 
*                   controlled are located. Device index starts
*                   with zero
* @param periph   : Selects which clock type to use
* @param on_off : enable/disable value
*                         
*  
* @return pm_err_flag_type PM_ERR_FLAG__SUCCESS if successful 
*/ 
pm_err_flag_type pm_clk_sleep_cal_en(uint32 pmic_chip, pm_clk_type periph, pm_on_off_type on_off);
