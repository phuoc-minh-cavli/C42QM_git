...
$Header: //components/rel/core.mpss/3.10/api/systemdrivers/pmic/pm_xo_core.h#3 $
...
@param[in] pmic_chip - 0:primary pmic
                       1:secondary pmic
@return 
...
In case of Negative range of cap_value, the mod of that value should be lesser than the XO_ADJ_FINE Value. 
