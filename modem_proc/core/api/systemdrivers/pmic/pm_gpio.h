...
/**
 * Copyright (c) 2013-2014,2020 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/api/systemdrivers/pmic/pm_gpio.h#2 $
...
typedef enum
{
    ...
    PM_GPIO_ANA_PASS_THRU,        /**< GPIO is configured as analog pass thru */
    PM_GPIO_MODE_INVALID,
} pm_gpio_mode_select_type;

/** Enumeration for GPIO Enable status
*/
typedef enum
{

    PM_GPIO_DISABLED,             /**< GPIO DISABLED */
    PM_GPIO_ENABLED,              /**< GPIO ENABLED */
} pm_gpio_status_enable_type;


/** Enumeration for GPIO Input Val
*/
typedef enum
{

    PM_GPIO_INPUT_LOW,             /**< GPIO DISABLED */
    PM_GPIO_INPUT_HIGH,              /**< GPIO ENABLED */
} pm_gpio_status_input_val_type;
...
typedef struct
{
    ...
    pm_gpio_status_enable_type gpio_status_enable; /*  GPIO Enable Status */
    pm_gpio_status_input_val_type gpio_input_val; /* GPIO Inout Vlaue*/
} pm_gpio_status_type;
