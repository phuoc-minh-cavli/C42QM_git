...
/**
 * Copyright (c) 2013-2014, 2019 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/api/systemdrivers/pmic/pm_version.h#5 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/19/17   kcs     Updated latest PMIC models (CR-2160937)
...
typedef enum
{
   ...
   PMIC_IS_PMD9655   = 15, /**< 15 -- PMD9655. */   
   PMIC_IS_PM8950    = 16, /*!< 16 -- PM8950. */
   PMIC_IS_PMI8950   = 17, /*!< 17 -- PMI8950. */
   PMIC_IS_PMI8937   = 17, /**< 17 -- PMI8937. */
   PMIC_IS_PMK8001   = 18, /**< 18 -- PMK8001. */
   PMIC_IS_PMI8996   = 19, /**< 19 -- PMI8996. */
   PMIC_IS_PM8998    = 20, /**< 20 -- PM8998. */
   PMIC_IS_PMI8998   = 21, /**< 21 -- PMI8998. */
   PMIC_IS_PM8953    = 22, /*!< 22 -- PM8953. */
   PMIC_IS_PM8005    = 24, /**< 24 -- PM8005. */
   PMIC_IS_PM8937    = 25, /**< 25 -- PM8937. */
   PMIC_IS_PM660L    = 26, /**< 26 -- PM660L. */   
   PMIC_IS_PM660     = 27, /**< 27 -- PM660. */
   PMIC_IS_SMB1355   = 28, /**< 28 -- SMB1355. */ 
   PMIC_IS_PM855     = 30, /**< 30 -- PM855. */
   PMIC_IS_PM855L    = 31, /**< 31 -- PM855L. */
   PMIC_IS_PM855B    = 32, /**< 32 -- PM855B. */
   PMIC_IS_PMK8002   = 33, /**< 33 -- PMK8002. */
   PMIC_IS_PMX24     = 34, /**< 34 -- PMX24. */
   PMIC_IS_SMB1390   = 35, /**< 35 -- SMB1390. */
   PMIC_IS_PM8009    = 36, /**< 36 -- PM8009. */
   PMIC_IS_PME9205   = PMIC_IS_PM8009, /**< 36 -- PME9205. */
   PMIC_IS_PMI632    = 37, /**< 37 -- PMI632. */
   PMIC_IS_PM855P    = 38, /**< 38 -- PM855P. */
   PMIC_IS_PM855A    = 39, /**< 39 -- PM855A */
