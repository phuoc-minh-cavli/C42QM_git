...
===========================================================================*/
/*===========================================================================
  Copyright (c) 2003 - 2011, 2022 Qualcomm Technologies Incorporated.
  All rights reserved.
...
/*==========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/securemsm/x509/secasn1.h#3 $
  $DateTime: 2022/10/20 21:55:58 $
  $Author: pwbldsvc $
...
/**
  @brief Verifies if address to access is within bound.
         Bound refers to last valid accessible address.
*/
#define SECASN1_VERIFY_DATA_BOUND(ptr,offset,bound) \
     (((uintnt)(ptr) + (uintnt)(offset) >= (uintnt)(ptr)) && \
      ((uintnt)(ptr) + (uintnt)(offset) <= (uintnt)(bound)) )  

/**
  @brief Introduced to address interdependency of seasn1 func with Data SSL.
*/
#define SECASN1_FUNC_VER_CHANGE  1
