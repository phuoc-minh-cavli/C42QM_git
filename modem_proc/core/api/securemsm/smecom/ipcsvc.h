...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/securemsm/smecom/ipcsvc.h#1 $
...
** X X X   Test Service
*/
#define IPCSVC_XXX                    IPCSVC_MAKE_SERVICE(39)
...
#define IPCSVC_IPCTEST_S_1              IPCSVC_MAKE_SERVICE(41)
#define IPCSVC_IPCTEST_S_2              IPCSVC_MAKE_SERVICE(42)
#define IPCSVC_IPCTEST_S_3              IPCSVC_MAKE_SERVICE(43)
#define IPCSVC_IPCTEST_S_4              IPCSVC_MAKE_SERVICE(44)
#define IPCSVC_IPCTEST_C              IPCSVC_MAKE_SERVICE(45)
#define IPCSVC_IPCTEST_C_BASE_MSG_ID  IPCSVC_MAKE_BASE_MSG_ID(IPCSVC_IPCTEST_C)
#define IPCSVC_IPCTEST_C_1              IPCSVC_MAKE_SERVICE(46)
#define IPCSVC_IPCTEST_C_2              IPCSVC_MAKE_SERVICE(47)
#define IPCSVC_IPCTEST_C_3              IPCSVC_MAKE_SERVICE(48)
#define IPCSVC_IPCTEST_C_4              IPCSVC_MAKE_SERVICE(49)
