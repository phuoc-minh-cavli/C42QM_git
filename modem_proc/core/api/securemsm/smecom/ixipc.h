...
$Header: //components/rel/core.mpss/3.10/api/securemsm/smecom/ixipc.h#1 $
...
#define FEATURE_USES_QURT_PIPE

#ifdef FEATURE_USES_QURT_PIPE
#define IXIPC_BUF_SIZE 10
//#define FEATURE_USES_QURT_PIPE_DEBUG
#endif
...
*/
typedef uint32 ixipc_node_id_type;

#else

typedef ipc_node_id_type ixipc_node_id_type;

#endif /* FEATURE_USES_QURT_PIPE */
...
#ifdef FEATURE_USES_QURT_PIPE
ixipc_errno_type _ixipc_send(ixipc_msg_type **msg_ptr, ixipc_node_id_type node_id);
#define ixipc_send(msg_ptr, node_id) \
  _ixipc_send((union ipc_msg_type**)(msg_ptr), (node_id))
ixipc_node_id_type _ixipc_sender(ixipc_msg_type *msg_ptr);
#define ixipc_sender(msg_ptr) \
  _ixipc_sender((union ipc_msg_type*)((void*)msg_ptr))

//czhao. service_id == node_id
...
ixipc_msg_type* ixipc_try_receive (ipc_msg_id_type msg_id);
