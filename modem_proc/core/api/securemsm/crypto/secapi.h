...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/securemsm/crypto/secapi.h#4 $ 
  $DateTime: 2019/03/17 23:07:12 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/17/18   ss      SHA-384 support  
06/15/17   jp      Ported the changes - Added set oaep padding info for RSA OAEP Padding
...
typedef enum
{
  ...
  SECAPI_SHA384              = 23, /**< Secapi ineface for SHA384. **/
...
typedef enum
{
  ...
  SECAPI_PKX_OAEP_PADDING_INFO      = SECAPI_PKX_PARAM_START + 14,
    /**< PKX-specific parameter: OAEP PAdding Info.  */
  SECAPI_PKX_MAX_PARAM            = SECAPI_PKX_PARAM_START + 15,
...
#define SECAPI_PKX_MAX_OAEP_LABEL_SIZE     SECAPI_HSH_SHA256_BLOCK_BYTE_LEN  
...
/**
   RSA OAEP Padding Info.
 */
typedef struct secapi_pkx_rsa_oaep_info_s
{
   secapi_algo_enum_type hash_aglo;    /** Hash algo used in oaep padding */
   uint8_t *label;                       /** Label to add to the message */
   uint16_t labellen;                    /** Length of label */
} secapi_pkx_rsa_oaep_info_type;
...
typedef union
{
  ...
  secapi_pkx_rsa_oaep_info_type      oaep_info;
    /**< PKX RSA OAEP Padding info type. */  
...
#define SECAPI_HSH_SHA384_DIGEST_SIZE         48 /**< SHA-256 digest size. */
#define SECAPI_HSH_SHA384_BLOCK_BYTE_LEN      128 /**< SHA-256 block length in bytes. */
...
#define SECAPI_HSH_LARGEST_DIGEST_SIZE     SECAPI_HSH_SHA384_DIGEST_SIZE    /**< Maxmium hash digest size. */
#define SECAPI_HSH_LARGEST_BLOCK_BYTE_LEN  SECAPI_HSH_SHA384_BLOCK_BYTE_LEN /**< Maxmium hash block size */
