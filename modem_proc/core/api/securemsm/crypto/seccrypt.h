...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.10/api/securemsm/crypto/seccrypt.h#3 $ 
 ...
 */
typedef struct secpkx_rsa_oaep_info_s
{
...
typedef union {
    ...
    secpkx_rsa_oaep_info_type      oaep_info;
