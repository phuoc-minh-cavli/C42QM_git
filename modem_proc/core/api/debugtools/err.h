...
Copyright (c) 1992-2015, 2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
===========================================================================*/

/*===========================================================================
...
$Header: //components/rel/core.mpss/3.10/api/debugtools/err.h#4 $
...
#define _XX_MSG_CONST(xx_ss_id, xx_ss_mask, xx_fmt) \
        static const err_const_type xx_msg_const = { \
              __LINE__, (xx_fmt), __THIS_FILENAME__}
...
#define ERR_TEST_CONSTZERO_CALL(test,funcConst,funcVar) (__builtin_constant_p(test) ? ( (((int)test) == 0) ? funcConst :  funcVar  ) :funcVar)
 ...
 #define ERR_FATAL(format, xx_arg1, xx_arg2, xx_arg3) \
  do { \
        _XX_MSG_CONST( MSG_SSID_DFLT, MSG_LEGACY_FATAL, "Error Fatal, parameters: %d %d %d" );    \
...
(
  ...
  #define ERR_FATAL_AUX_MSG(legacy_msg, dynamic_msg, size_dynamic_msg)             \
    do                                                                             \
    {                                                                              \
        _XX_MSG_CONST( MSG_SSID_DFLT, MSG_LEGACY_FATAL, "Error Fatal, check coredump.err.aux_msg" ); \
