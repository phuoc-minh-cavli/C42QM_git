...
Copyright (c) 2013- 2017,2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.mpss/3.10/debugtools/err/src/err_decompress.c#2 $
...
void err_decompress_msg_const (const err_const_type* const_blk_ptr, err_decompress_struct_type* dest_ptr)
{
  ...
  do {
    ...
    if ((int)avail_in > ERR_DECOMP_CHUNK) {
      avail_in = ERR_DECOMP_CHUNK;
    }
    /* else if ((int)avail_in < 0) {
