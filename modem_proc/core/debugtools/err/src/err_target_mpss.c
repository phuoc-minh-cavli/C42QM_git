...
Copyright (c) 2015,18, 2019 by Qualcomm Technologies Incorporated.  All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/debugtools/err/src/err_target_mpss.c#2 $
