...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/3.10/debugtools/rcinit/src/rcinit_hs_list.c#1 $
...
void rcinit_internal_hs_list_init(void)
{
   ...
   for (cnt = 0; cnt < RCINIT_TASK_MAX; cnt++)
   {
      ...
      rcinit_internal.hs_init[cnt].start_time = 0;
      rcinit_internal.hs_init[cnt].end_time = 0;
      rcinit_internal.hs_term[cnt].start_time = 0;
      rcinit_internal.hs_term[cnt].end_time = 0;
   }
