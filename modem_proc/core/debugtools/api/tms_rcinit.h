...
/*=============================================================================
Edit History
$Header: //components/rel/core.mpss/3.10/debugtools/api/tms_rcinit.h#2 $
...
#define RCINIT_TASK_MAX                               128   // maximum number of tasks tracked for compile time sized tables
#define RCINIT_INITFN_MAX                             256 
...
} rcinit_initfn_t, *rcinit_initfn_p;
...
struct rcinit_internal_s
{
   ...
   rcinit_initfn_t initfn_time_log[RCINIT_INITFN_MAX];
