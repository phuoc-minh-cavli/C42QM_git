/*============================================================================
  ...
  Copyright (c) 2014-17, 2020 Qualcomm Technologies Incorporated.
  All Rights Reserved.
  Qualcomm Confidential and Proprietary
============================================================================
                           EDIT HISTORY FOR FILE

$Header: //components/rel/core.mpss/3.10/debugtools/sys_m/src/qmi_ssctl_ser_v02.c#3 $
                                          ...
                                          void           *service_cookie)
{
   ...
   switch(msg_id)
   {
      case QMI_SSCTL_RESTART_REQ_V02:
      {
         ...
         sys_m_shutdown_terminate_in_STM(TRUE);
      }
      break;
      ...
      case QMI_SSCTL_SHUTDOWN_REQ_V02:
      {
		 ...
		 (void)rcecb_signal_name(SYS_M_SHUTDOWN_ONLY);
      ...
      case QMI_SSCTL_HIBERNATION_REQ_V02:
      {
         qmi_ssctl_hibernation_resp_msg_v02 *response = (qmi_ssctl_hibernation_resp_msg_v02 *)&sys_m_qmi_resp;
         qmi_ssctl_hibernation_ind_msg_v02 ind;
         qmi_csi_error err;

         response->resp.result = QMI_RESULT_SUCCESS_V01;;
         response->resp.error  = QMI_ERR_NONE_V01;
         qmi_csi_send_resp(req_handle, msg_id, response, sizeof(qmi_ssctl_hibernation_resp_msg_v02));

         sys_m_hibernation();

         err = qmi_csi_send_ind((qmi_sys_m_client.qmi_client_handle),
                           QMI_SSCTL_HIBERNATION_READY_IND_V02,
                           &ind,sizeof(qmi_ssctl_hibernation_ind_msg_v02));
