...
Copyright (c) 2011-17, 2020 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.10/debugtools/sys_m/src/sys_m.h#3 $
...
/**
  ...
  @input
  block - TRUE means STM api will not return, False means return
