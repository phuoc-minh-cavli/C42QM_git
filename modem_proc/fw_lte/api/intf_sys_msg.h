...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/intf_sys_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, SCELL_STAT_DECONFIG,   0x10, lte_LL1_sys_scell_stat_deconfig_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, LIGHT_SLEEP_MOD_CTRL,     0x11, lte_LL1_sys_light_sleep_mod_ctrl_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, RX_TOOL_CHAIN_CONFIG,   	0x12, lte_LL1_sys_rx_tool_chain_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, REQ, EIB_ADDR,                 0x13, lte_LL1_sys_eib_addr_req_msg_struct),
  LTE_LL1_SYS_REQ_COUNT=0x14,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, SCELL_STAT_DECONFIG,        0xF, lte_LL1_sys_scell_stat_deconfig_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, LIGHT_SLEEP_MOD_CTRL,     0x10, lte_LL1_sys_light_sleep_mod_ctrl_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, RX_TOOL_CHAIN_CONFIG,	0x11, lte_LL1_sys_rx_tool_chain_config_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, CNF, EIB_ADDR,                 0x12, lte_LL1_sys_eib_addr_cnf_msg_struct),
  LTE_LL1_SYS_CNF_COUNT=0x13,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_DEMFRONT_NEIGHBOR_CELL_CER_LOG_C, 0x1B, lte_LL1_log_demfront_neighbor_cell_cer_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_PRS_FW_LOG_C, 0x1C, lte_LL1_log_prs_fw_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_MBSFN_EMBMS_CER_LOG_C, 0x1D, lte_LL1_log_mbsfn_embms_cer_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_MBSFN_WHITENED_MATRICES_LOG_C, 0x1E, lte_LL1_log_mbsfn_whitened_matrices_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_SERVING_CELL_COM_LOOP_LOG_C, 0x1F, lte_LL1_log_serving_cell_com_loop_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_CSF_SE_TXMODE9_RESULT_LOG_C,   0x20, (lte_LL1_log_csf_spectral_efficiency_for_txmode_9_ind_msg_struct*)),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_CSF_CSIRS_CHEST_TXMODE9_LOG_C, 0x21, (lte_LL1_log_csf_csirs_chest_for_txmode_9_ind_msg_struct*)),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_MULTI_RAT_DL_REPORT_LOG_C, 0x22, lte_LL1_log_multi_rat_conflict_dl_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_MULTI_RAT_UL_REPORT_LOG_C, 0x23, lte_LL1_log_multi_rat_conflict_ul_ind_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_CSF_CSIRS_CHEST_LOG_C, 0x24, (lte_LL1_log_csf_csirs_chest_ind_msg_struct*)),
  MSGR_DEFINE_UMID(LTE, LL1_SYS, IND, LOG_LTE_LL1_MPDCCH_CHEST_DEMOD_LOG_C, 0x25, lte_LL1_log_mpdcch_chest_demod_ind_msg_struct),
  LTE_LL1_SYS_IND_COUNT=0x26
