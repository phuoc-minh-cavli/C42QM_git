...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/lte_LL1_log_codes.h#1 $
...
#define LOG_LTE_LL1_NBHOP_INT_LOG_C (0x1FC + LOG_LTE_LL1_BASE_C) //corrected as per apex team 0xB30C
// ----------------------------------------------------------------------------
// PRS
// ----------------------------------------------------------------------------
...
#define LOG_LTE_LL1_MPDCCH_CHEST_DEMOD_LOG_C (0x35 + LOG_LTE_LL1_BASE_C)

#define LOG_LTE_LL1_CCHP_INFO_LOG_C (0x202 + LOG_LTE_LL1_BASE_C) //macro for CCHP_LOG_PKT// 
// ----------------------------------------------------------------------------
// Transmit front end
// ----------------------------------------------------------------------------
...
#define LOG_LTE_LL1_VALID_MASK ( \
  ...
  LOG_LTE_LL1_MASK_OFS(LOG_LTE_LL1_MPDCCH_CHEST_DEMOD_LOG_C) | \
