...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/intf_srch_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_SRCH, REQ, MEAS_TTL_FTL_NCELL_DRX, 0xE, lte_LL1_meas_ttl_ftl_ncell_drx_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SRCH, REQ, MEAS_SCELL, 0xF, lte_LL1_meas_scell_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_SRCH, REQ, MEAS_TTL_FTL_NCELL_ABORT, 0x10, lte_LL1_meas_ttl_ftl_ncell_abort_req_msg_struct),
  LTE_LL1_SRCH_REQ_COUNT=0x11,
