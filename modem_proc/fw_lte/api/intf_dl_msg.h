...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/intf_dl_msg.h#1 $
...
typedef enum
{
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_SCELL, 0xA, lte_LL1_meas_scell_req_msg_struct),

  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, SI_START_COLLECT, 0xB, lte_LL1_dl_si_start_collect_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, SI_STOP_COLLECT, 0xC, lte_LL1_dl_si_stop_collect_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, RLM, 0xD, lte_LL1_dl_rlm_req_msg_struct),
// Begin Odyssey only

  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PDSCH_CONFIG, 0xE, lte_LL1_dl_pdsch_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PDCCH_TEST, 0xF, lte_LL1_dl_pdcch_test_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_SCELL_CONFIG, 0x10, lte_LL1_meas_scell_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_SCELL_ODYSSEY, 0x11, void), ///< @todo Remove later
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, TTL_SCELL_CONFIG, 0x12, lte_LL1_ttl_scell_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, FTL_SCELL_CONFIG, 0x13, lte_LL1_ftl_scell_config_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, CSF_CONFIG , 0x14, lte_LL1_dl_csf_config_req_msg_struct), ///< in espresso this is an uplink message
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, CSF_SCHED , 0x15, lte_LL1_dl_csf_sched_req_msg_struct), ///< in espresso this is an uplink message
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, CSF_DECONFIG, 0x16, lte_LL1_dl_csf_deconfig_req_msg_struct), ///< in espresso this is an uplink message
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PBCH_DECODE, 0x17, lte_LL1_dl_pbch_decode_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PBCH_STOP_DECODE, 0x18, lte_LL1_dl_pbch_stop_decode_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, RXAGC_CFG_PARAM, 0x19, lte_LL1_rxagc_cfg_param_req_msg_struct),

  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_TTL_FTL_NCELL_DRX, 0x1A, lte_LL1_meas_ttl_ftl_ncell_drx_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_TTL_FTL_NCELL_ABORT, 0x1B, lte_LL1_meas_ttl_ftl_ncell_abort_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, RVAFC_GET_FREQ_CORR, 0x1C, lte_LL1_rvafc_get_freq_corr_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_TTL_FTL_NCELL_CDRX_SCHED, 0x1D, lte_LL1_meas_ttl_ftl_ncell_cdrx_sched_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, MEAS_TTL_FTL_NCELL_CDRX_CONT, 0x1E, lte_LL1_meas_ttl_ftl_ncell_cdrx_cont_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, ANT_CORR_ENABLE_DISABLE, 0x1F, lte_LL1_ant_corr_enable_disable_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, AP_CSF_SCHED , 0x20, lte_LL1_dl_csf_sched_req_msg_struct), ///< aperiodic CSF request, deququq in a separate q
// End Odyssey only
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PRS_MEAS, 0x21, lte_LL1_dl_prs_meas_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, PRS_ABORT, 0x22, lte_LL1_dl_prs_abort_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, IQ_SAMPLE_CAPTURE, 0x23, lte_LL1_dl_iq_sample_capture_req_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, BUNDLE_CSF_SCHED, 0x24, lte_LL1_dl_bundle_csf_sched_req_msg_struct), ///< in espresso this is an uplink message

  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, HALFDUPLEX_DISABLE, 0x25, lte_LL1_dl_halfduplex_disable_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, NBHOP_TUNE , 0x26,lte_LL1_dl_nbhop_tune_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, SI_INFO_UPDATE, 0x27, lte_LL1_dl_si_info_update_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, REQ, IDLE_MODE_DOPPLER_ESTIMATE, 0x28, lte_LL1_idle_mode_doppler_estimate_req_msg_struct),
  LTE_LL1_DL_REQ_COUNT=0x29,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, SI_START_COLLECT, 0x6, lte_LL1_dl_si_start_collect_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, SI_STOP_COLLECT, 0x7, lte_LL1_dl_si_stop_collect_cnf_msg_struct),

  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PDSCH_CONFIG, 0x8, lte_LL1_dl_pdsch_config_cnf_msg_struct),
// Begin Odyssey only
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, MEAS_SCELL_ODYSSEY, 0x9, void),  ///< @todo To coexist with Espresso. Remove once Espresso message is discarded.
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, CSF_CONFIG,   0xA, lte_LL1_dl_csf_config_cnf_msg_struct), ///< in espresso  this is an uplink message
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, CSF_DECONFIG, 0xB, lte_LL1_dl_csf_deconfig_cnf_msg_struct), ///< in espresso this is an uplink message
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PBCH_DECODE, 0xC, lte_LL1_dl_pbch_decode_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PBCH_STOP_DECODE, 0xD, lte_LL1_dl_pbch_stop_decode_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, RXAGC_CFG_PARAM, 0xE, lte_LL1_rxagc_cfg_param_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, MEAS_TTL_FTL_NCELL, 0xF, lte_LL1_meas_ttl_ftl_ncell_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, MEAS_TTL_FTL_NCELL_ABORT, 0x10, lte_LL1_meas_ttl_ftl_ncell_abort_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, RLM, 0x11, lte_LL1_rlm_req_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, RVAFC_FREQ_CORR, 0x12, lte_LL1_rvafc_freq_corr_cnf_msg_struct),
// End Odyssey only
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PRS_MEAS, 0x13, lte_LL1_dl_prs_meas_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, PRS_ABORT, 0x14, lte_LL1_dl_prs_abort_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, IQ_SAMPLE_CAPTURE, 0x15, lte_LL1_dl_iq_sample_capture_cnf_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, HALFDUPLEX_DISABLE, 0x16, lte_LL1_dl_halfduplex_disable_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, NBHOP_TUNE, 0x17, lte_LL1_dl_nbhop_tune_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, SI_INFO_UPDATE, 0x18, lte_LL1_dl_si_info_update_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_DL, CNF, IDLE_MODE_DOPPLER_ESTIMATE, 0x19, lte_LL1_dl_idle_mode_doppler_est_cnf_msg_struct),
  LTE_LL1_DL_CNF_COUNT=0x1A,
  ...
  MSGR_DEFINE_UMID(LTE, LL1_DL, IND, FTL_SNR_DROP, 0x5, lte_LL1_dl_ftl_snr_drop_ind_msg_struct),
  LTE_LL1_DL_IND_COUNT=6
