...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/intf_async_msg.h#1 $
...
typedef enum
{
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, CONFIG_APP,      0x0, lte_LL1_async_config_app_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, WAKEUP,          0x1, lte_LL1_async_config_app_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, DOG_TIMEOUT,     0x2, lte_LL1_async_dog_timeout_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, PHYCHAN_SCHEDULE, 0x3, lte_LL1_ul_phychan_schedule_req_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, REQ, DAC_CAL, 0x4, lte_LL1_async_dac_cal_req_msg_struct),
  LTE_LL1_ASYNC_REQ_COUNT=5,

  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, CONFIG_APP,      0x0, lte_LL1_async_config_app_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, WAKEUP,          0x1, lte_LL1_async_config_app_cnf_msg_struct),
  MSGR_DEFINE_UMID(LTE, LL1_ASYNC, CNF, DAC_CAL,         0x2, lte_LL1_async_dac_cal_cnf_msg_struct),
  LTE_LL1_ASYNC_CNF_COUNT=3,
