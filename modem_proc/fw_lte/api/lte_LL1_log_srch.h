...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/lte_LL1_log_srch.h#1 $
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_SRCH_PSS_RESULTS_VERSION 24
...
typedef struct
{
  uint32 version                          : 8;  ///< Version number (Range 0 to 255)
                                                         ...
                                                         ///< described below
  uint32 number_of_half_frames            : 10;  ///< In units of 5ms (Range 0 to 8). To be Displayed as 
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_SRCH_SSS_RESULTS_VERSION 23
