...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/lte_LL1_ue_types.h#1 $
...
===========================================================================*/
/*! @brief Invalid return values for ML1 function, lte_ml1_gh_ll_get_tx_subfn() */
#define LTE_LL1_TXMT_INVALID_SUBFN         0xFF
#define LTE_LL1_TXMT_INVALID_SFN           0xFFFF
...
typedef enum
{
  ...
  LTE_LL1_RXAGC_MODE_X2L_CONN_INTER, //Inter-RAT/Inter-Freq connected mode
  LTE_LL1_RXAGC_MODE_X2L_CONN = LTE_LL1_RXAGC_MODE_X2L_CONN_INTER, //This need to be removed later
  LTE_LL1_RXAGC_MODE_X2L_CONN_INTRA, //Intra-Freq connected mode  
...
//Default LNA state for Init Acq, X2L gap, FSCAN - G1
#define LTE_LL1_RXAGC_ONE_SHOT_LNA_START_PARAMS_DEFAULT_LNA_STATE_INDEX   1
...
typedef struct
{
  lte_LL1_dcc_accum_cfg_s accum[9];
...
typedef enum
{
  LTE_LL1_UE_NO_SLEEP = 0,
  LTE_LL1_UE_CDRX_SLEEP,
  LTE_LL1_SS_OPT_SLEEP,
  LTE_LL1_INTER_SIB_SLEEP
}lte_LL1_ue_sleep_type_e;

typedef enum
{
LTE_LL1_UE_RF_MODE_FTM = 0, /* FTM mode, to be set only by RF */
LTE_LL1_UE_RF_MODE_OL, /* default on-line mode, non-ftm, set by ML1 */
LTE_LL1_UE_RF_MODE_CAL, /* FTM calibration mode, not used currently */
LTE_LL1_UE_RF_MODE_NONSIG, /* FTM non-signaling mode, to be set by ML1/RF */
LTE_LL1_UE_RF_MODE_MAX_NUM
} lte_LL1_ue_rf_ftm_mode_e;
