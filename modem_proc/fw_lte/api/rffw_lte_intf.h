...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/rffw_lte_intf.h#1 $
...
#define RFFW_LTE_MAX_NUM_RX_GAIN_RANGES	   			9
#define RFFW_LTE_NUM_RX_PATHS	   			        2
