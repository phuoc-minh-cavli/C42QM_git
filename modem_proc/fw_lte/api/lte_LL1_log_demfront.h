...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/lte_LL1_log_demfront.h#1 $
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_DEMFRONT_PDSCH_DEMAPPER_CONFIGURATION_VERSION 28
...
typedef struct
{
  ...
  uint32 repetition_index                 : 12; ///< repetition count 0,...,repetition_total-1 [page/modemB max 2048]                          
  uint32 reserved3                        : 6;           
  ...
  uint32 reserved6                         : 8; ///< was rep index moved to increase field size.
  uint32 repetition_total                 : 16; ///< total repetitions for current PDSCH
  uint32 NB_index                         : 6; ///< narrowband index 0-15 for 20MHz, 0-7 for 10MHz, etc.
  uint32 sib1BrCollision                  : 1; ///<
  uint32 sibxCollision                    : 1; ///<
