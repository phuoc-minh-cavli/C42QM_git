...
$Header: //source/qcom/qct/modem/fw/components/fw_lte.mpss/rel/15.2/api/lte_LL1_log_csf.h#1 $
...
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_CSF_PUCCH_VERSION 25   //24
...
typedef struct
{
  ...
  uint32 csf_tx_mode                      : 4; ///< Range: 1..9
                                                         ...
                                                         ///< 8: TM8
                                                         ///< 9: TM9
  uint32 carrier_index                    : 1; ///< 0-PCC, 1-SCC 												 
  ...
  uint32 wb_pmi                           : 4; ///< Range: 0...15 for 4 Tx, Rank 1 & 2
...
#if 0 /* legacy packet structure for Cat1 */
typedef struct
{
  uint32 version                           : 8;  ///< Range: 0...255
  uint32 start_system_sub_frame_number_sfn  : 4; ///< Range 0..9
 ...
 *  from ML. 
---------------------------------------------------------------------------*/
#define LTE_LL1_LOG_CSF_PUSCH_VERSION 24   //23
...
typedef struct
{
  ...
  uint32 cqi_cw0                           : 4; ///< Range: 0...15
  uint32 best_nb_cqi                       : 2; ///< (4 bits per SubBand  x Max_num_SubBands)
  uint32 pos_of_best_nb                    : 2; ///< (1 bit for 1 NB or 2 NB configured for MPDCCH
                                                          ///<  2 bits for 4 NBs configured for MPDDCH
