...
10/01/18   gk      fno-common enable-compiltion fix
...
extern boolean rfcommon_msm_adc_vcm_cal_done;

extern efs_adc_vcm_cal_data_type      efs_adc_vcm_cal_data[RXLM_CHAIN_MAX];     
/*to be written to efs file to store the calibrated data*/
extern efs_adc_vcm_cal_log_data_type  efs_adc_vcm_cal_log_data[RXLM_CHAIN_MAX*ADC_DC_CAL_MAX_ITERATIONS]; 
/*to be written to efs file for debug*/
