...
$Header: //components/rel/rfmodem_jolokia.mpss/1.10/hal/lte/inc/rflte_msm.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/26/19   ak      Notch API for non-anchor 
...
07/05/16   vg      Dynamic ADC clock configuration
...
#define RFLTE_MSM_NUM_NOTCH_PER_CHAIN 1
...
void rflte_msm_rxfe_notch_filter_dynamic_update(uint32 carrier_idx, uint32 rxlm_buf_index, 
                                                ...
                                                rfdevice_lte_spur_mitigation_type *spur_mitigation_params);	
/*--------------------------------------------------------------------------*/
void rflte_msm_rxfe_nb_non_anchor_notch_filter_dynamic_update( uint32 rxlm_buf_index,
                                                                       rfcom_device_enum_type device,
                                                                       uint32 carrier_idx,
                                                                       uint32 nb_nonanchor_chan_rx, 
                                                                       uint32 raster_offset);
/*--------------------------------------------------------------------------*/
...
int16 rflte_msm_get_nbee_rxagc_val(rfm_device_enum_type device, 
                                   ...
                                   uint32 carrier_idx );
/*--------------------------------------------------------------------------*/
void rflte_msm_read_wbdc_val(int32* dc_val_i ,int32* dc_val_q , uint8 lna_state);
/*--------------------------------------------------------------------------*/
void rflte_msm_write_wbdc_val(int32 dc_val_i ,int32 dc_val_q , uint8 lna_state);
/*--------------------------------------------------------------------------*/
...
rflte_nb_adc_mode_type rflte_nb1_msm_rxfe_get_adc_mode
(
   rfcom_lte_band_type  band,
   uint32  dl_freq
);
