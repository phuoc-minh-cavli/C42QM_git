...
/*=========================================================================
  ...
  OVERVIEW: Internal header file for SLPC
...
$Header: //components/rel/mcs.mpss/5.1/slpc/src/slpci.h#4 $
...
#define DBG_5( LVL, FMT, A, B, C, D, E ) \
        MSG_5( MSG_SSID_SLEEP, MSG_LEGACY_ ## LVL, FMT, A, B, C, D, E)

#define DBG_6( LVL, FMT, A, B, C, D, E, F ) \
        MSG_6( MSG_SSID_SLEEP, MSG_LEGACY_ ## LVL, FMT, A, B, C, D, E, F)

#define DBG_7( LVL, FMT, A, B, C, D, E, F, G ) \
        MSG_7( MSG_SSID_SLEEP, MSG_LEGACY_ ## LVL, FMT, A, B, C, D, E, F, G)
