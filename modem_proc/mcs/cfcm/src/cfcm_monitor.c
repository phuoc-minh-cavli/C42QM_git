...
typedef struct
{
  uint16                       num_state_change;               /*!< total number of state change */
  uint16                       num_down;                       /*!< total number of down cmds */
  uint16                       num_set_min;                    /*!< total number of set min cmds */
  uint16                       num_shut_down;                  /*!< total number of shut down cmds */
...
typedef struct
{
  ...
  uint8        num_client;                                  /*!< number of clients  */
  uint8       latest_cmd_hist_idx;                          /*!< latest command history buffer index */ 
