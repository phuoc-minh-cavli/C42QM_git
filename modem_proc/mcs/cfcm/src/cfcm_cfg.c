...
/*==============================================================================
  ...
  Copyright (c) 2014-19 Qualcomm Technologies Incorporated. All Rights Reserved
...
$Header: //components/rel/mcs.mpss/5.1/cfcm/src/cfcm_cfg.c#2 $
...
static const cfcm_config_cpu_thrshld_type_s cpu_thrshld_g[CFCM_CLIENT_MAX]=
{
  ...
  {FALSE,90,80,80},
  /* Sr 18: CFCM_CLIENT_NB1_ML1_CPU */
  {FALSE,90,80,80},
  /* Sr 19: CFCM_CLIENT_LTE_ML1_MDM */
  {FALSE,90,80,80}
};
