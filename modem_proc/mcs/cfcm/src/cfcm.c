...
$Header: //components/rel/mcs.mpss/5.1/cfcm/src/cfcm.c#2 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
09/28/15   rj      Replace rcevt API's with MCS wrappers (CR: 876470).
...
{ 
  ...
  CFCM_ASSERT(estatus == E_SUCCESS || estatus == E_NO_ROUTE);
...
static void cfcm_task_init ( void )
{
  ...
  mcs_rcevt_signal_name("CFCM:STARTED");
  #endif
