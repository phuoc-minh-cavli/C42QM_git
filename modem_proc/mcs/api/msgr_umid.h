...
$Header: //components/rel/mcs.mpss/5.1/api/msgr_umid.h#1 $
...
/*! @brief NR5G technology definition. */
#define MSGR_TECH_NR5G          0x1D

/*! @brief NB1 technology definition. */
#define MSGR_TECH_NB1           0x1E
