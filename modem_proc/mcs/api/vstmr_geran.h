...
$Header: //components/rel/mcs.mpss/5.1/api/vstmr_geran.h#2 $
...
/*! @brief Min/Max FCW in Q30. FCW must be within this range 
           [VSTMR_GERAN_FCW_MIN:VSTMR_GERAN_FCW_MAX].
*/
#define VSTMR_GERAN_FCW_MIN            VSTMR_FCW_MIN(VSTMR_GERAN_FCW) 
#define VSTMR_GERAN_FCW_MAX            VSTMR_FCW_MAX(VSTMR_GERAN_FCW)
