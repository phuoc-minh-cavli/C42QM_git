...
$Header: //components/rel/mcs.mpss/5.1/api/vstmr_hdr.h#2 $
...
/*! @brief Min/Max FCW in Q30. FCW must be within this range 
           [VSTMR_HDR_FCW_MIN:VSTMR_HDR_FCW_MAX].
*/
#define VSTMR_HDR_FCW_MIN           VSTMR_FCW_MIN(VSTMR_HDR_FCW) 
#define VSTMR_HDR_FCW_MAX           VSTMR_FCW_MAX(VSTMR_HDR_FCW)
