...
$Header: //components/rel/mcs.mpss/5.1/api/vstmr_1x.h#2 $
...
/*! @brief Min/Max FCW in Q30. FCW must be within this range 
           [VSTMR_1X_FCW_MIN:VSTMR_1X_FCW_MAX].
*/
#define VSTMR_1X_FCW_MIN           VSTMR_FCW_MIN(VSTMR_1X_FCW) 
#define VSTMR_1X_FCW_MAX           VSTMR_FCW_MAX(VSTMR_1X_FCW)
