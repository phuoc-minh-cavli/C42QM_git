...
$Header: //components/rel/mcs.mpss/5.1/api/tcxomgr.h#5 $
...
/* Rotator value type (should match tcxomgr_rotator_type)
   Sensitivity: 2^-10 PPM per LSB */
typedef int32                     tcxomgr_rot_type;
...
typedef enum
{
  ...
  TCXOMGR_FT_QUAL_FAC1,       /* Intermediate step of Factory Calibration
                                  56 PPM mode                                */
  TCXOMGR_FT_QUAL_DEFAULT,    /* Default value was returned
                                  5 PPM mode                                 */
  ...
  TCXOMGR_FT_QUAL_FT1,        /* Value from calibrated curve with default C0
                                  5 PPM mode                                 */
  TCXOMGR_FT_QUAL_OLD_RGS,    /* Value from a not-so-recent Good System
                                  3 PPM mode                                 */

  TCXOMGR_FT_QUAL_INTERP,     /* Value was interpolated from adj value(s)
                                  3 PPM mode                                 */

  TCXOMGR_FT_QUAL_FT2,        /* Value from calibrated curve with known C0
                                  3 PPM mode - c0 state                      */
  TCXOMGR_FT_QUAL_EXACT,      /* Value for temp was found in freq/temp table
                                  3 PPM mode                                 */

  TCXOMGR_FT_ROT_TABLE_INTERP,/* Value was interpolated from adj values in
                                  Temp vs Rot table
                                  0.5ppm: [-30 to 85], 0.7ppm: [-40 to -30]  */
  TCXOMGR_FT_ROT_TABLE,       /* Value from Temp vs Rot table
                                  0.5ppm: [-30 to 85], 0.7ppm: [-40 to -30]  */
  TCXOMGR_FT_QUAL_RGS,        /* Value was from the Recent Good System
                                  3 PPM mode                                 */
...
#define TCXOMGR_VCO_DEFAULT       TCXOMGR_FT_QUAL_DEFAULT
#define TCXOMGR_VCO_OLD_RGS       TCXOMGR_FT_QUAL_OLD_RGS
#define TCXOMGR_VCO_INTERPOLATED  TCXOMGR_FT_QUAL_INTERP
#define TCXOMGR_VCO_EXACT         TCXOMGR_FT_QUAL_EXACT
#define TCXOMGR_VCO_RGS           TCXOMGR_FT_QUAL_RGS

/* create a non-VCO name alias */
typedef tcxomgr_vco_indicator_type tcxomgr_indicator_type;
...
/* create a non-VCO name alias */
typedef tcxomgr_vco_info_type tcxomgr_info_type;
