...
$Header: //components/rel/mcs.mpss/5.1/api/cxm.h#2 $
...
/*! @brief CXM LTE sub Tech Identifier Type.
    NOTE: This enum is used to distinguish between CATM1
          and NB1 calls under LTE tech */
typedef enum
{
  CXM_LTE_SUB_INVALID,
  CXM_LTE_SUB_CATM1,
...
typedef struct
{
  ...
  cxm_lte_sub_tech_type                 sub_tech;        /*!< LTE sub Tech Identifier */
}cxm_lte_info_s;
