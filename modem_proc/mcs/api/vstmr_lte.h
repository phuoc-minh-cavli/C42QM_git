...
$Header: //components/rel/mcs.mpss/5.1/api/vstmr_lte.h#2 $
...
/*! @brief Min/Max FCW in Q30. FCW must be within this range 
           [VSTMR_LTE_FCW_MIN:VSTMR_LTE_FCW_MAX]
*/
#define VSTMR_LTE_FCW_MIN           VSTMR_FCW_MIN(VSTMR_LTE_FCW)
#define VSTMR_LTE_FCW_MAX           VSTMR_FCW_MAX(VSTMR_LTE_FCW)
