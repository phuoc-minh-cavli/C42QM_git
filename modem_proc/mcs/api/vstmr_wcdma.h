...
$Header: //components/rel/mcs.mpss/5.1/api/vstmr_wcdma.h#2 $
...
/*! @brief Min/Max FCW values in Q30. FCW value must be within this range 
           [VSTMR_WCDMA_FCW_MIN:VSTMR_WCDMA_FCW_MAX]
*/
#define VSTMR_WCDMA_FCW_MIN               VSTMR_FCW_MIN(VSTMR_WCDMA_FCW) 
#define VSTMR_WCDMA_FCW_MAX               VSTMR_FCW_MAX(VSTMR_WCDMA_FCW)
