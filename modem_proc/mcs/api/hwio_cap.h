...
$Header: //components/rel/mcs.mpss/5.1/api/hwio_cap.h#3 $
...
typedef enum {
  ...
  /* NB_IOT Feature Capability */ 
  MCS_MODEM_CAPABILITY_FEATURE_NB_IOT,

  /* NTN Feature Capability */ 
  MCS_MODEM_CAPABILITY_FEATURE_NTN,
