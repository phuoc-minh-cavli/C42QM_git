...
$Header: //components/rel/mcs.mpss/5.1/tcxomgr/src/tcxomgr_msgr.h#2 $
...
#ifdef FEATURE_NB1
  nb1fw_sys_rx_sample_capture_req_msg_s nb1IqCaptureCmd;
  nb1fw_sys_rx_sample_capture_cnf_msg_s nb1IqCaptureRsp;
#endif
