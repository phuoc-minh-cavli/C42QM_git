...
$Header: //components/rel/mcs.mpss/5.1/limitsmgr/sar/inc/sar_efs.h#2 $
...
typedef struct
{
  int16   bias[MAX_DSI_LUT_ROWS][MAX_DSI_LUT_COLUMNS];
}sar_dsi_lut_type;
...
typedef PACK (struct)
{
  uint32   hprio_band;
  uint32   lprio_band;
  int16    bias[MAX_DSI_EFS_LUT_ROWS][MAX_DSI_LUT_COLUMNS];
