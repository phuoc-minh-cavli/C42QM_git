...
$Header: //components/rel/mcs.mpss/5.1/limitsmgr/wwan_coex/src/wwcoex_priority_tbl.c#1 $
...
)
{
  ...
  LMTSMGR_MSG_4(HIGH,"PrioTblUpdate: Tech %d Prio %d Offset %d ReqAction %d",
  ...
  { 
    ...
    LMTSMGR_MSG_5(MED,"cxm_update_prio_table prio %d %d %d %d %d",
...
{
  cxm_channel_out_type output = {RFM_INVALID_DEVICE, RFM_INVALID_DEVICE};
#ifndef MCS_LIMITS_LOW_MEMORY
