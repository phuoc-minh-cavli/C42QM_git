...
$Header: //components/rel/mcs.mpss/5.1/limitsmgr/utils/inc/lmtsmgr_task.h#3 $
...
/*---------------------------------------------------------------------------*/
/* to be set by VBATT when a vbatt threshold is hit or the hysteresis timer
 * expires */
#define LMTSMGR_SAR_VBATT_SIG        0x00000100
/*---------------------------------------------------------------------------*/
/* to be set by VBATT when a usb state change is recvd from APPS via QMI  */
#define LMTSMGR_SAR_VBATT_USB_SIG    0x00000200
...
#define LMTSMGR_SIGS ( LMTSMGR_MSGR_Q_SIG             |\
                         ...
                         LMTSMGR_SAR_VBATT_SIG        |\
                         LMTSMGR_SAR_VBATT_USB_SIG )
