...
$Header: //components/rel/mcs.mpss/5.1/limitsmgr/utils/inc/lmtsmgr_efs.h#3 $
...
/* VBATT limit EFS files */
#define LIMITSMGR_VBATT_LTE_NB1_LIMIT                     "/nv/item_files/mcs/lmtsmgr/vbatt/vbatt_nb1_limit"
#define LIMITSMGR_VBATT_LTE_CATM_LIMIT                    "/nv/item_files/mcs/lmtsmgr/vbatt/vbatt_lte_limit"
#define LIMITSMGR_VBATT_GSM_LIMIT                         "/nv/item_files/mcs/lmtsmgr/vbatt/vbatt_gsm_limit"
#define LIMITSMGR_VBATT_GENERIC_LIMIT                     "/nv/item_files/mcs/lmtsmgr/vbatt/vbatt_limits"
#define LIMITSMGR_VBATT_MODE                              "/nv/item_files/mcs/lmtsmgr/vbatt/vbatt_mode"
...
#define LIMITSMGR_UPDATE_CONF_FILE_WITH_EFS_NAMES      LIMITSMGR_PWR_LTE_HIGH_GSM1_LOW "\n"\
                                                       ...
                                                       LIMITSMGR_VBATT_LTE_CATM_LIMIT "\n" \
                                                       LIMITSMGR_VBATT_LTE_NB1_LIMIT "\n" \
                                                       LIMITSMGR_VBATT_GSM_LIMIT "\n" \
                                                       LIMITSMGR_VBATT_GENERIC_LIMIT "\n" \
                                                       LIMITSMGR_VBATT_MODE "\n"
#else
 /* buffer for the list of file paths to be be written to the conf file */
#define LIMITSMGR_UPDATE_CONF_FILE_WITH_EFS_NAMES      LIMITSMGR_PWR_LTE_HIGH_GSM1_LOW "\n"\
                                                       LIMITSMGR_DSI_BIAS_LTE_HIGH_GSM1_LOW "\n"\
