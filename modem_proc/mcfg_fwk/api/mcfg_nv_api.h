...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/api/mcfg_nv_api.h#1 $
...
typedef enum mcfg_nv_item_e {
  ...
  **  consistency with the legacy NV API.                                   **
  ...
  /*<10023>                                  <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_SW_CONFIG_DIGEST_VERSION,  /* pending | uint32 */

  /*<10024>                                  <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_HW_CONFIG_DIGEST_VERSION,  /* pending | uint32 */

  /*<10025>                                          <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_DEFAULT_SW_CONFIG_DIGEST_VERSION,  /* pending | uint32 */

  /*<10026>                                          <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_DEFAULT_HW_CONFIG_DIGEST_VERSION,  /* pending | uint32 */

  /*<10027>                                          <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_MULTI_MBN_DIGEST_VERSION,  /* pending | uint32 */
     
  /*<10028>                                          <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_RFS_SW_DIGEST_VERSION,  /* pending | uint32 */

  /*<10029>                                          <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_MCFG_RFS_HW_DIGEST_VERSION,  /* pending | uint32 */

  /*<10030>                                  <QXDM ID> |  <data type> */
  MCFG_NV_ITEM_LAST_AUTOSELECT_PLMN_IMPI,     /* pending | plmn_t */
...
===========================================================================*/
boolean mcfg_gcf_nv_get_status(
  void
);
