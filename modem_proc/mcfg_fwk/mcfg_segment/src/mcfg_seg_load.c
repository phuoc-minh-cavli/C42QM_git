...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_segment/src/mcfg_seg_load.c#1 $
  $DateTime: 2020/02/19 23:07:19 $


  when        who     what, where, why
  ---------   ---     ---------------------------------------------------------------------------
 2015/10/08   hzhi     Fix CR 920756 - change feature flag FEATURE_BORROW_FROM_AMSS back to FEATURE_SEGMENT_LOADING_AMSS_HEAP_OPT.
...
#ifdef FEATURE_SEGMENT_LOADING_AMSS_HEAP_OPT
...
#endif /*FEATURE_SEGMENT_LOADING_AMSS_HEAP_OPT*/
...
#else /*FEATURE_SEGMENT_LOADING_AMSS_HEAP_OPT*/  
    mcfg_seg_last_error = MCFG_SEGLOAD_IS_FTM_OFFLINE_MODE;
    return mcfg_seg_last_error;
