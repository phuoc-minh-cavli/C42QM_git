...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_sel/inc/mcfg_trl.h#1 $
...
#define MCFG_TRL_TLV_ID_MCFG_DIGEST_VERSION (0x08)
...
#define MCFG_TRL_MCFG_DIGEST_MAX_LENGTH (32)
...
typedef enum
{
  ...
  /* 4 is Reserved for VOLTE/NONVOLTE */
  MCFG_CATEGORY_BIT_PREFER_IMPI = 5,
...
typedef enum
{
  ...
  MCFG_CATEGORY_BITMASK_PREFER_IMPI	= 1 << MCFG_CATEGORY_BIT_PREFER_IMPI,
...
typedef struct {
   /* MCFG DIGEST VERSION */
  char mcfg_digest[MCFG_TRL_MCFG_DIGEST_MAX_LENGTH];
} mcfg_trl_mcfg_digest_s_type;
