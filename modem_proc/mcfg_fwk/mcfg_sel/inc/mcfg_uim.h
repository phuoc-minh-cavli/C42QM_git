...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_sel/inc/mcfg_uim.h#1 $
...
/* Max Length of IMPI in bytes */
#define MCFG_UIM_IMPI_LEN (100)
#endif
...
#ifdef FEATURE_MCFG_SELECTION_BY_IMPI
typedef enum mcfg_uim_EF_read_state_e {
  MCFG_UIM_EF_NOT_READ = 0,
  MCFG_UIM_EF_APP_NOT_FOUND,
  MCFG_UIM_EF_SESSION_OPEN_FAILED,
  MCFG_UIM_EF_READ_INPROGRESS,
  MCFG_UIM_EF_READ_SUCCESS,
  MCFG_UIM_EF_READ_FAILED,
  MCFG_UIM_EF_PARSE_FAILED
} mcfg_uim_EF_read_state_e_type;
#endif
