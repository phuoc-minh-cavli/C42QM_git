 ...
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_diag/src/mcfg_diag.c#2 $
...
mcfg_fs_diag_stat_handler (VOID_PACKED_PTR req_ptr, uint16 pkt_len)
{
  ...
  MCFG_MSG_SPRINTF_2("fpath: %s, sub_id: %lu", request_path, request->sub_id);
...
mcfg_fs_diag_get_handler (VOID_PACKED_PTR req_ptr, uint16 pkt_len)
{
  ...
  MCFG_MSG_SPRINTF_3("fpath: %s, fsz: %lu, sub_id: %lu", request_path, request->data_length, request->sub_id);
...
mcfg_fs_diag_put_handler (VOID_PACKED_PTR req_ptr, uint16 pkt_len)
{
  ...
  MCFG_MSG_SPRINTF_3("fpath: %s, fsz: %lu, sub_id: %lu", put_path, request->data_length, request->sub_id);
