...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_proc/inc/mcfg_int.h#2 $ $DateTime: 2020/09/15 06:24:34 $ $Author: pwbldsvc $
...
#ifdef MCFG_DEBUG_EFS_LOG_SUPPORT
...
#define MCFG_MSG_ERROR(xx_fmt) \
  ...
  MSG(MSG_SSID_MCFG, MSG_LEGACY_ERROR, xx_fmt)
...
#define MCFG_MSG_ERROR_1(xx_fmt, xx_arg1) \
  ...
  MSG_1(MSG_SSID_MCFG, MSG_LEGACY_ERROR, xx_fmt, xx_arg1)
...
#define MCFG_MSG_ERROR_2(xx_fmt, xx_arg1, xx_arg2) \
  ...
  MSG_2(MSG_SSID_MCFG, MSG_LEGACY_ERROR, xx_fmt, xx_arg1, xx_arg2)
...
#define MCFG_MSG_ERROR_3(xx_fmt, xx_arg1, xx_arg2, xx_arg3) \
  ...
  MSG_3(MSG_SSID_MCFG, MSG_LEGACY_ERROR, xx_fmt, xx_arg1, xx_arg2, xx_arg3)
...
#define MCFG_MSG_ERROR_4(xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4) \
  ...
  MSG_4(MSG_SSID_MCFG, MSG_LEGACY_ERROR, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4)

#define MCFG_MSG_ERROR_5(fmt, a1, a2, a3, a4, a5) \
  MSG_5(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3, a4, a5)

#define MCFG_MSG_ERROR_6(fmt, a1, a2, a3, a4, a5, a6) \
  MSG_6(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3, a4, a5, a6)

#define MCFG_MSG_ERROR_7(fmt, a1, a2, a3, a4, a5, a6, a7) \
  MSG_7(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3, a4, a5, a6, a7)

#define MCFG_MSG_ERROR_8(fmt, a1, a2, a3, a4, a5, a6, a7, a8) \
  MSG_8(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3, a4, a5, a6, a7, a8)
...
#define MCFG_MSG_HIGH(xx_fmt) \
  ...
  MSG(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt);
...
#define MCFG_MSG_HIGH_1(xx_fmt, xx_arg1) \
  ...
  MSG_1(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt, xx_arg1)
...
#define MCFG_MSG_HIGH_2(xx_fmt, xx_arg1, xx_arg2) \
  ...
  MSG_2(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt, xx_arg1, xx_arg2)
...
#define MCFG_MSG_HIGH_3(xx_fmt, xx_arg1, xx_arg2, xx_arg3) \
  ...
  MSG_3(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt, xx_arg1, xx_arg2, xx_arg3)
...
#define MCFG_MSG_HIGH_4(xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4) \
  ...
  MSG_4(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4)
...
#define MCFG_MSG_HIGH_5(xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5) \
  ...
  MSG_5(MSG_SSID_MCFG, MSG_LEGACY_HIGH, xx_fmt, xx_arg1, xx_arg2, xx_arg3, xx_arg4, xx_arg5)

#define MCFG_MSG_HIGH_6(fmt, a1, a2, a3, a4, a5, a6) \
  MSG_6(MSG_SSID_MCFGFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4, a5, a6)

#define MCFG_MSG_HIGH_7(fmt, a1, a2, a3, a4, a5, a6, a7) \
  MSG_7(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4, a5, a6, a7)

#define MCFG_MSG_HIGH_8(fmt, a1, a2, a3, a4, a5, a6, a7, a8) \
  MSG_8(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4, a5, a6, a7, a8)

#else

#define MCFG_MSG_ERROR(fmt) \
  MSG(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt)

#define MCFG_MSG_ERROR_1(fmt, a1) \
  MSG_1(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1)

#define MCFG_MSG_ERROR_2(fmt, a1, a2) \
  MSG_2(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2)

#define MCFG_MSG_ERROR_3(fmt, a1, a2, a3) \
  MSG_3(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3)

#define MCFG_MSG_ERROR_4(fmt, a1, a2, a3, a4) \
  MSG_4(MSG_SSID_MCFG, MSG_LEGACY_ERROR, fmt, a1, a2, a3, a4)
...
/* Warning messages */
#define MCFG_MSG_HIGH(fmt) \
  MSG(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt)

#define MCFG_MSG_HIGH_1(fmt, a1) \
  MSG_1(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1)

#define MCFG_MSG_HIGH_2(fmt, a1, a2) \
  MSG_2(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2)

#define MCFG_MSG_HIGH_3(fmt, a1, a2, a3) \
  MSG_3(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3)

#define MCFG_MSG_HIGH_4(fmt, a1, a2, a3, a4) \
  MSG_4(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4)

#define MCFG_MSG_HIGH_5(fmt, a1, a2, a3, a4, a5) \
  MSG_5(MSG_SSID_MCFG, MSG_LEGACY_HIGH, fmt, a1, a2, a3, a4, a5)
...
#endif /* !MCFG_DEBUG_EFS_LOG_SUPPORT */

/* Informational messages */
#define MCFG_MSG_MED(fmt) \
  MSG(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt)

#define MCFG_MSG_MED_1(fmt, a1) \
  MSG_1(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1)

#define MCFG_MSG_MED_2(fmt, a1, a2) \
  MSG_2(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2)

#define MCFG_MSG_MED_3(fmt, a1, a2, a3) \
  MSG_3(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3)

#define MCFG_MSG_MED_4(fmt, a1, a2, a3, a4) \
  MSG_4(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4)

#define MCFG_MSG_MED_5(fmt, a1, a2, a3, a4, a5) \
  MSG_5(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5)

#define MCFG_MSG_MED_6(fmt, a1, a2, a3, a4, a5, a6) \
  MSG_6(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6)

#define MCFG_MSG_MED_7(fmt, a1, a2, a3, a4, a5, a6, a7) \
  MSG_7(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6, a7)

#define MCFG_MSG_MED_8(fmt, a1, a2, a3, a4, a5, a6, a7, a8) \
  MSG_8(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6, a7, a8)

/* Debug messages */
#ifdef MCFG_DEBUG
  #define MCFG_MSG_LOW(fmt) \
    MSG(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt)

  #define MCFG_MSG_LOW_1(fmt, a1) \
    MSG_1(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1)

  #define MCFG_MSG_LOW_2(fmt, a1, a2) \
    MSG_2(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2)

  #define MCFG_MSG_LOW_3(fmt, a1, a2, a3) \
    MSG_3(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3)

  #define MCFG_MSG_LOW_4(fmt, a1, a2, a3, a4) \
    MSG_4(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3, a4)

  #define MCFG_MSG_LOW_5(fmt, a1, a2, a3, a4, a5) \
    MSG_5(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3, a4, a5)

  #define MCFG_MSG_LOW_6(fmt, a1, a2, a3, a4, a5, a6) \
    MSG_6(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3, a4, a5, a6)

  #define MCFG_MSG_LOW_7(fmt, a1, a2, a3, a4, a5, a6, a7) \
    MSG_7(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3, a4, a5, a6, a7)

  #define MCFG_MSG_LOW_8(fmt, a1, a2, a3, a4, a5, a6, a7, a8) \
    MSG_8(MSG_SSID_MCFG, MSG_LEGACY_LOW, fmt, a1, a2, a3, a4, a5, a6, a7, a8)
#else
  #define MCFG_MSG_LOW(fmt)
  #define MCFG_MSG_LOW_1(fmt, a1)
  #define MCFG_MSG_LOW_2(fmt, a1, a2)
...
#define MCFG_MSG_SPRINTF_1(fmt, a1) \
  MSG_SPRINTF_1(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1)

#define MCFG_MSG_SPRINTF_2(fmt, a1, a2) \
  MSG_SPRINTF_2(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2)

#define MCFG_MSG_SPRINTF_3(fmt, a1, a2, a3) \
  MSG_SPRINTF_3(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3)

#define MCFG_MSG_SPRINTF_4(fmt, a1, a2, a3, a4) \
  MSG_SPRINTF_4(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4)

#define MCFG_MSG_SPRINTF_5(fmt, a1, a2, a3, a4, a5) \
  MSG_SPRINTF_5(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5)

#define MCFG_MSG_SPRINTF_6(fmt, a1, a2, a3, a4, a5, a6) \
  MSG_SPRINTF_6(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6)

#define MCFG_MSG_SPRINTF_7(fmt, a1, a2, a3, a4, a5, a6, a7) \
  MSG_SPRINTF_7(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6, a7)

#define MCFG_MSG_SPRINTF_8(fmt, a1, a2, a3, a4, a5, a6, a7, a8) \
  MSG_SPRINTF_8(MSG_SSID_MCFG, MSG_LEGACY_MED, fmt, a1, a2, a3, a4, a5, a6, a7, a8)
