...
/*===========================================================================
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_proc/inc/mcfg_proc.h#1 $ $DateTime: 2020/02/19 23:07:19 $ $Author: pwbldsvc $
...
#define MCFG_FORMAT_NUM_LEGACY          0x03
