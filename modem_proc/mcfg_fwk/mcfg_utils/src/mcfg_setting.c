...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_utils/src/mcfg_setting.c#1 $
...
==============================================================================*/
#define MCFG_SETTING_DEFAULT_SPACE_LIMIT (512)
  ...
  if (feature->selection_mode_valid)
  {
    switch (feature->selection_mode)
    {
      case PDC_SELECTION_MODE_DISABLED_V01:
        ...
        {
          MCFG_MSG_MED("mcfg_set_feature selection disable, remove remote mbns");
          mcfg_setting_temp.remote_storage = 0;
          mcfg_utils_delete_all(MCFG_TYPE_HW, MCFG_STORAGE_MASK_REMOTE);
          mcfg_utils_delete_all(MCFG_TYPE_SW, MCFG_STORAGE_MASK_REMOTE);
