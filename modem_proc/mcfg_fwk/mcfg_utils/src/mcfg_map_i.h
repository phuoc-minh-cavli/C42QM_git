...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_utils/src/mcfg_map_i.h#1 $ 
...
typedef ordered_list_type mcfg_map_record_map_node_list_type;
...
typedef struct
{
  ...
  ordered_list_weight_type            top_weight;       
