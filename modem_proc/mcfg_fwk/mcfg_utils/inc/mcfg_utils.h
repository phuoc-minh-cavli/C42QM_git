...
$Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_utils/inc/mcfg_utils.h#1 $ 
...
==============================================================================*/
#define MCFG_UTILS_RECORD_FILENAME_MAX (180)
...
boolean mcfg_utils_check_and_update_config(
  mcfg_config_s_type *config,
