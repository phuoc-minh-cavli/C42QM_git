...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/mcfg_fwk.mpss/7.10.1.1/mcfg_qmi/src/persistent_device_configuration_impl_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/* This file was generated with Tool version 6.14.7
   It was generated on: Thu Apr 28 2016 (Spin 0)
...
static const uint32_t pdc_list_configs_req_msg_impl_array_v01[] =
{
    ...
    QMI_SI_TLV_SET(0x12)      /* multiple support */
};
...
static const uint32_t pdc_list_configs_ind_msg_impl_array_v01[] =
{
    ...
    QMI_SI_TLV_SET(0x12)      /* more_available */
};
...
static const uint32_t pdc_refresh_ind_msg_impl_array_v01[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* subscription_id */
    QMI_SI_TLV_SET(0x11)      /* slot_id */
};

static const qmi_implemented_optionals pdc_refresh_ind_msg_impl_v01 =
{
  1, /* number of elements in array */
  pdc_refresh_ind_msg_impl_array_v01
};
static const qmi_implemented_optionals_tuple qmi_pdc_refresh_impl_tuple_v01 = 
{
  NULL,
  NULL,
  &pdc_refresh_ind_msg_impl_v01
};
...
static const qmi_implemented_optionals_tuple * const pdc_service_implemented_array_v01[] =
{
    ...
    &qmi_pdc_refresh_impl_tuple_v01                      /* 0x002F */
};

static const qmi_implemented_messages pdc_service_implemented_v01 =
{
  0x002F,  /* maximum message ID in this service */
