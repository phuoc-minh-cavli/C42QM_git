...
/*===========================================================================
  ...
  $Header: //components/rel/avs.mpss/8.0.c12/api/cvd/vss_common_public_if.h#1 $
  $Author: pwbldsvc $
...
/** Hybrid vocoder that uses AMR WB in uplink and EVS AMR-WB IO in downlink.

  @inputfile{group__weakf__media__fmt__amrwb__2.tex}
*/
#define VSS_MEDIA_ID_AMR_WB_2 ( 0x0001333E )
