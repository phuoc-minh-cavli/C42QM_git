...
=============================================================================*/
/*===========================================================================
Copyright (c) 2013, 2015, 2018-2019 Qualcomm Technologies, Inc.  All rights reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/avs.mpss/8.0.c12/api/cvd/vss_iavsync_public_if.h#1 $
  $Author: pwbldsvc $
...
/** @ingroup cvd_avsync_evt_path_delay
  Notifies the full control client of changes in the value of the Tx & Rx voice path delay.

  @apr_msgpayload{vss_iavsync_evt_delay_t}
  @table{weak__vss__iavsync__evt__path__delay__t}

  @detdesc
  This event is sent to the full control client under the following circumstances:
   - Every time the vocoder is started.
   - Subsequently whenever the value of either Tx or Rx path delay changes.
  ...
  None.
*/
#define VSS_IAVSYNC_EVT_PATH_DELAY ( 0x0001334C )

/* Type definition for vss_iavsync_evt_path_delay_t. */
typedef struct vss_iavsync_evt_path_delay_t vss_iavsync_evt_path_delay_t;

#include "apr_pack_begin.h"

/** @weakgroup vss_iavsync_evt_path_delay_t
@{ */
/* Payload structure for the #VSS_IAVSYNC_EVT_PATH_DELAY event.
*/
...
#include "apr_pack_end.h"
;
/** @} */ /* end_weakgroup weak_vss_iavsync_evt_path_delay_t */
