...
=============================================================================*/
/*===========================================================================
Copyright (c) 2011, 2015-2016 , 2019 Qualcomm Technologies, Inc.  All rights reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/avs.mpss/8.0.c12/api/cvd/vss_istream_public_if.h#1 $
  $Author: pwbldsvc $
...
typedef struct vss_istream_param_plc_t vss_istream_param_plc_t;

#include "apr_pack_begin.h"

/** @weakgroup weak_vss_istream_param_plc_t
@{ */
struct vss_istream_param_plc_t 
{
  uint32_t plc;
      /**< PLC Mode.
      *
...
#include "apr_pack_end.h"
;
/** @} *//* end_weakgroup weak_vss_istream_param_plc_t */


/** ID of the DTX parameter. @newpage */
#define VSS_ISTREAM_PARAM_DTX ( 0x00010e69 )

typedef struct vss_istream_param_dtx_t vss_istream_param_dtx_t;

#include "apr_pack_begin.h"

/** @weakgroup weak_vss_istream_param_dtx_t
@{ */
struct vss_istream_param_dtx_t 
{
  uint32_t dtx;
      /**< DTX Mode.
      *
...
#include "apr_pack_end.h"
;
/** @} *//* end_weakgroup weak_vss_istream_param_dtx_t */


/** ID of the DTX parameter with adaptive support. @newpage */
#define VSS_ISTREAM_PARAM_DTX_V2 ( 0x00013343 )

typedef struct vss_istream_param_dtx_v2_t vss_istream_param_dtx_v2_t;

#include "apr_pack_begin.h"

/** @weakgroup weak_vss_istream_param_dtx_v2_t
@{ */
struct vss_istream_param_dtx_v2_t 
{
  uint32_t version;
    /**< Version value
      *
      ...
      *  - 0x01 
           ...
           Maximum and minimum number of SID frames are not configurable for adaptive DTX mode.
       */
...
#include "apr_pack_end.h"
;
/** @} *//* end_weakgroup weak_vss_istream_param_dtx_v2_t */
