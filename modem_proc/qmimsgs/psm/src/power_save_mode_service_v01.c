...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/psm/src/power_save_mode_service_v01.c#12 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t psm_get_sensor_data_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(psm_get_sensor_data_resp_msg_v01, mcd_prev_state) - QMI_IDL_OFFSET16RELATIVE(psm_get_sensor_data_resp_msg_v01, mcd_prev_state_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t psm_get_last_policy_met_info_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(psm_get_last_policy_met_info_resp_msg_v01, sensor_fail_cond_met_mask) - QMI_IDL_OFFSET8(psm_get_last_policy_met_info_resp_msg_v01, sensor_fail_cond_met_mask_valid)),
  0x12,
   QMI_IDL_GENERIC_2_BYTE,
...
static const uint8_t psm_sensor_policy_met_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(psm_sensor_policy_met_ind_msg_v01, timestamp) - QMI_IDL_OFFSET8(psm_sensor_policy_met_ind_msg_v01, timestamp_valid)),
  0x14,
   QMI_IDL_GENERIC_8_BYTE,
...
static const qmi_idl_service_message_table_entry psm_service_response_messages_v01[] = {
  ...
  {QMI_PSM_GET_SENSOR_DATA_RESP_V01, QMI_IDL_TYPE16(0, 19), 12543},
  {QMI_PSM_RESET_SENSOR_CONFIG_DATA_RESP_V01, QMI_IDL_TYPE16(0, 21), 7},
  {QMI_PSM_GET_LAST_SENSOR_POLICY_MET_INFO_RESP_V01, QMI_IDL_TYPE16(0, 23), 22},
...
static const qmi_idl_service_message_table_entry psm_service_indication_messages_v01[] = {
  ...
  {QMI_PSM_SENSOR_POLICY_MET_IND_V01, QMI_IDL_TYPE16(0, 24), 30},
