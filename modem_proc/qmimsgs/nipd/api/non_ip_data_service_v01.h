...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/nipd/api/non_ip_data_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NIPD_V01_IDL_MINOR_VERS 0x02
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NIPD_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NIPD_V01_MAX_MESSAGE_ID 0x0025
/**
    @}
  */
...
/** @addtogroup nipd_qmi_consts
    @{
  */
#define QMI_NIPD_MAX_PAYLOAD_SIZE_V01 2048
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report Data delivery over NTN */
  uint8_t report_data_delivery_valid;  /**< Must be set to true if report_data_delivery is being passed */
  uint8_t report_data_delivery;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report Data delevery over NTN 
  */
...
/** @addtogroup nipd_qmi_enums
  ...
  */
typedef enum {
  NIPD_DATA_DELEIVERY_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NIPD_DATA_DELIVERY_ACK_V01 = 0x0000, /**<  Data Delivery ACK \n  */
  NIPD_DATA_DELIVERY_NACK_V01 = 0x0001, /**<  Data Delivery NACK \n  */
  NIPD_DATA_DELIVERY_MAX_V01 = 0x00FF, 
  NIPD_DATA_DELEIVERY_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nipd_data_deleivery_status_enum_v01;
/**
    @}
  */
...
/** @addtogroup nipd_qmi_messages
    @{
  */
/** Indication Message; Send Data delivery indication for NON IP data to control point. */
typedef struct {

  /* Mandatory */
  /*  Payload */
  nipd_data_deleivery_status_enum_v01 delivery_status;
  /**<   \n Downlink data payload.
  */
}nipd_ul_data_delivery_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_NIPD_UL_DATA_DELIVERY_IND_V01
...
#define QMI_NIPD_UL_DATA_DELIVERY_IND_V01 0x0025
/**
    @}
  */
