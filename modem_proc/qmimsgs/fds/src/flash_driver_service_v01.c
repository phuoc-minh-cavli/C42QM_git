...
GENERAL DESCRIPTION
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/fds/src/flash_driver_service_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/*
 * fds_disable_scrub_req_msg is empty
 * static const uint8_t fds_disable_scrub_req_msg_data_v01[] = {
 * };
 */

static const uint8_t fds_disable_scrub_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(fds_disable_scrub_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t fds_enable_scrub_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(fds_enable_scrub_req_msg_v01, recompute_md5) - QMI_IDL_OFFSET8(fds_enable_scrub_req_msg_v01, recompute_md5_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(fds_enable_scrub_req_msg_v01, recompute_md5)
};

static const uint8_t fds_enable_scrub_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(fds_enable_scrub_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry fds_message_table_v01[] = {
  ...
  {sizeof(fds_disable_scrub_req_msg_v01), 0},
  {sizeof(fds_disable_scrub_resp_msg_v01), fds_disable_scrub_resp_msg_data_v01},
  {sizeof(fds_enable_scrub_req_msg_v01), fds_enable_scrub_req_msg_data_v01},
  {sizeof(fds_enable_scrub_resp_msg_v01), fds_enable_scrub_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry fds_service_command_messages_v01[] = {
  ...
  {QMI_FDS_DISABLE_SCRUB_REQ_V01, QMI_IDL_TYPE16(0, 11), 0},
  {QMI_FDS_ENABLE_SCRUB_REQ_V01, QMI_IDL_TYPE16(0, 13), 4}
};
...
static const qmi_idl_service_message_table_entry fds_service_response_messages_v01[] = {
  ...
  {QMI_FDS_DISABLE_SCRUB_RESP_V01, QMI_IDL_TYPE16(0, 12), 7},
  {QMI_FDS_ENABLE_SCRUB_RESP_V01, QMI_IDL_TYPE16(0, 14), 7}
};
