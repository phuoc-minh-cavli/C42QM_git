...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/fds/api/flash_driver_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Jun  4 2019 (Spin 0)
...
#define FDS_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define FDS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define FDS_V01_MAX_MESSAGE_ID 0x0027
/**
    @}
  */
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Request Message; Invokes a flash scrub operation. */
typedef struct {
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Request Message; Retrieves the scrub system information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Request Message; Requests appropriate action on a Firmware Over the AIR (FOTA)
                  update. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Request Message; Request to scrub service to disable scrub */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}fds_disable_scrub_req_msg_v01;
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Response Message; Request to scrub service to disable scrub */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}fds_disable_scrub_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Request Message; Request to scrub service to enable previously
                  disabled scrub */
typedef struct {

  /* Optional */
  /*  Request to scrub service to recompute md5s of code partitions */
  uint8_t recompute_md5_valid;  /**< Must be set to true if recompute_md5 is being passed */
  uint8_t recompute_md5;
}fds_enable_scrub_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup fds_qmi_messages
    @{
  */
/** Response Message; Request to scrub service to enable previously
                  disabled scrub */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}fds_enable_scrub_resp_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */ 
//#define REMOVE_QMI_FDS_DISABLE_SCRUB_V01 
//#define REMOVE_QMI_FDS_ENABLE_SCRUB_V01 
//#define REMOVE_QMI_FDS_GET_SUPPORTED_FIELDS_V01 
//#define REMOVE_QMI_FDS_GET_SUPPORTED_MSGS_V01 
//#define REMOVE_QMI_FDS_HANDLE_FOTA_UPDATE_V01 
//#define REMOVE_QMI_FDS_INDICATION_REGISTER_V01 
//#define REMOVE_QMI_FDS_SCRUB_APPS_START_SCRUB_IND_V01 
//#define REMOVE_QMI_FDS_SCRUB_GET_STATUS_V01 
//#define REMOVE_QMI_FDS_SCRUB_GET_SYS_INFO_V01 
//#define REMOVE_QMI_FDS_SCRUB_START_V01 
...
#define QMI_FDS_DISABLE_SCRUB_REQ_V01 0x0026
#define QMI_FDS_DISABLE_SCRUB_RESP_V01 0x0026
#define QMI_FDS_ENABLE_SCRUB_REQ_V01 0x0027
#define QMI_FDS_ENABLE_SCRUB_RESP_V01 0x0027
/**
    @}
  */
