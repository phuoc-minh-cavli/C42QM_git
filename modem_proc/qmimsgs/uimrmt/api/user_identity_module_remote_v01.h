...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/uimrmt/api/user_identity_module_remote_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Dec 12 2017 (Spin 1)
...
typedef struct {
 ...
 SIM usage is UIM_REMOTE_USAGE_NORMAL. Values are: \n
  ...
  /**<   Indicates whether the command and response APDUs are encrypted.
       All other values are for future use and are treated as invalid arguments
       by the service. This TLV is only used when the event is UIM_REMOTE_CONNECTION_AVAILABLE.
