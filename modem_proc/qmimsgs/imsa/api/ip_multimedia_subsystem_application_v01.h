...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/imsa/api/ip_multimedia_subsystem_application_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define IMSA_V01_IDL_MINOR_VERS 0x14
...
typedef enum {
  ...
  IMSA_STATUS_LIMITED_REGISTERED_V01 = 3, /**<  Limited Registered for IMS  */
...
typedef struct {
  ...
  */
  ...
  /**<   IMS registration status. Values: \n
      ...
      - IMSA_STATUS_LIMITED_REGISTERED (3) --  Limited Registered for IMS 
 */
