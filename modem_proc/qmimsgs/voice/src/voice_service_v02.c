...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/voice/src/voice_service_v02.c#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, mt_call_verstat_valid)),
  0x3E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  ...
  {QMI_VOICE_ALL_CALL_STATUS_IND_V02, QMI_IDL_TYPE16(0, 24), 29583},
