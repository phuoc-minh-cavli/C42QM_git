...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/voice/api/voice_service_v02.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Apr  2 2018 (Spin 0)
...
#define VOICE_V02_IDL_MINOR_VERS 0x68
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Incoming call end event for the calls auto rejected by modem  */
 ...
 */
  ...
  */
  ...
  /**<   Whether the call is being originated on secondary line; 
  ...
  */
  ...
  /**<   Whether TRN is avaialble for the secondary line; TRN is the temporary
       reference number. This boolean is set to FALSE by default
  */
...
typedef enum {
  ...
  VOICE_REJECT_CAUSE_UNWANTED_CALL_V02 = 0x06, /**<  Call was rejected as received call is unwanted Robo_call  */
...
typedef struct {
  ...
  */
  ...
  /**<   Cause for ending the call. Values: \n
      ...
      - VOICE_REJECT_CAUSE_UNWANTED_CALL (0x06) --  Call was rejected as received call is unwanted Robo_call  
 */
...
typedef struct {
  ...
  /**<   Indicates if the network supports unwanted call feature. This value obtained from network, 
       if it is set (TRUE), then the user gets the option on UI to reject or end the received call 
	   by selecting unwanted_call option.
  */

  mt_ims_verstat_enum_v02 mt_call_verstat_info;
  /**<   validation index of received call; @enum.
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Whether the call is on secondary line; 
       This boolean is set to FALSE by default
  */

  /* Optional */
  /*  Array of MT_Call Verstat Info** */
  ...
  /**<   Verstat information of MT call receiving number. Depending on the value of the 
       is_unwanted_call flag, user can either accept or reject the MT call.
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Whether the USSD is to be originated on secondary line; 
       This boolean is set to FALSE by default
   */
 ...
 */
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Whether the USSD is originated on secondary line ; 
       This boolean is set to FALSE by default
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Notifies clients about the MT call being auto rejected by modem. */
typedef struct {

  /* Mandatory */
  /*  Call Type */
  call_type_enum_v02 call_type;
  /**<   Type of the call being rejected by modem. 
  */

  /* Mandatory */
  /*  End Reason */
  call_end_reason_enum_v02 call_end_reason;
  /**<   Call end reason with which the call was ended. 
  */
