...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/wds/api/wireless_data_service_v01.h#10 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Wed Jul 22 2020 (Spin 0)
...
#define WDS_V01_IDL_MINOR_VERS 0xC3
...
#define QMI_WDS_TD_FQDN_LIST_MAX_V01 5
#define QMI_WDS_OS_ID_MAX_V01 16
#define QMI_WDS_OS_APP_ID_MAX_V01 256
#define QMI_WDS_APP_ID_LIST_MAX_V01 6
#define QMI_WDS_MAC_ADDR_LIST_MAX_V01 6
#define QMI_WDS_IPV6_ADDR_LIST_MAX_V01 6
#define QMI_WDS_TD_INFO_LIST_MAX_V01 10
...
#define QMI_WDS_MASK_REQ_SETTINGS_APN_TYPE_MASK_V01 ((wds_req_settings_mask_v01)0x00400000) 
...
typedef struct {
  ...
  uint32_t ipv4_addr;
  /**<   IPv4 address in little endian format. */

  uint32_t subnet_mask;
}wds_ipv4_addr_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t os_id[QMI_WDS_OS_ID_MAX_V01];

  uint32_t os_app_id_len;  /**< Must be set to # of elements in os_app_id */
  uint8_t os_app_id[QMI_WDS_OS_APP_ID_MAX_V01];
}wds_app_id_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t mask;
  /**<   Type of service mask to specify the bit positions 
       in the ToS value that are used for comparison against 
       the IP ToS field in a packet. */
}wds_tos_trf_cls_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t total_td_frag_num;
  /**<   Total number of TD fragments */

  uint16_t td_frag_index;
  /**<   Current TD fragment index   */
}wds_td_fragment_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wds_qmi_enums
  ...
  */
typedef enum {
  WDS_RAT_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WDS_RAT_UNSPECIFIED_V01 = 0x00, /**<  3GPP RAT UNSPECIFIED \n */
  WDS_RAT_GERAN_V01 = 0x01, /**<  3GPP GERAN \n */
  WDS_RAT_WCDMA_V01 = 0x02, /**<  3GPP WCDMA \n */
  WDS_RAT_TDSCDMA_V01 = 0x03, /**<  3GPP TDSCDMA \n */
  WDS_RAT_LTE_V01 = 0x04, /**<  3GPP LTE \n  */
  WDS_RAT_5G_V01 = 0x05, /**<  3GPP 5G \n */
  WDS_RAT_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wds_rat_enum_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report Traffic Descriptor (TD) Information */
  uint8_t report_td_info_valid;  /**< Must be set to true if report_td_info is being passed */
  uint8_t report_td_info;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report TD info
  */
  ...
  /* Optional */
  /*  Report Route Change indication */
  uint8_t report_route_chg_valid;  /**< Must be set to true if report_route_chg is being passed */
  uint8_t report_route_chg;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report route change info
  */
...
typedef enum {
  ...
  WDS_VCER_INTERNAL_IMS_SETTINGS_DISABLED_V01 = 0x10E, 
...
#define WDS_MASK_APN_BEARER_N_V01 ((wds_apn_bearer_mask_v01)0x0000000000000010ull) /**<  NR5G \n  */
 ...
 */
  ...
  */
  ...
  uint8_t apn_type_mask_valid;  /**< Must be set to true if apn_type_mask is being passed */
  wds_apn_type_mask_v01 apn_type_mask;
  /**<   APN Type Mask of the current call. If there is no information
       available, this TLV is absent.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Downlink configured rate per subscription ID in kb per second.
  */

  /* Optional */
  /*  Uplink Guaranteed Throughput */
  uint8_t ul_guaranteed_throughput_valid;  /**< Must be set to true if ul_guaranteed_throughput is being passed */
  uint32_t ul_guaranteed_throughput;
  /**<   Uplink guaranteed rate per subscription ID in kb per second.
  */

  /* Optional */
  /*  Downlink Guaranteed Throughput */
  uint8_t dl_guaranteed_throughput_valid;  /**< Must be set to true if dl_guaranteed_throughput is being passed */
  uint32_t dl_guaranteed_throughput;
  /**<   Downlink guaranteed rate per subscription ID in kb per second.
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Is Unicast */
  uint8_t is_unicast_valid;  /**< Must be set to true if is_unicast is being passed */
  uint8_t is_unicast;
  /**<   Whether the flow is for unicast communication.
  */
...
typedef struct {
  ...
  wds_rat_enum_type_v01 rat;
  /**<   RAT applicable to the RAN-Assisted Media Adaptation Information. Values: \n
      - WDS_RAT_UNSPECIFIED (0x00) --  3GPP RAT UNSPECIFIED \n
      - WDS_RAT_GERAN (0x01) --  3GPP GERAN \n
      - WDS_RAT_WCDMA (0x02) --  3GPP WCDMA \n
      - WDS_RAT_TDSCDMA (0x03) --  3GPP TDSCDMA \n
      - WDS_RAT_LTE (0x04) --  3GPP LTE \n 
      - WDS_RAT_5G (0x05) --  3GPP 5G \n 
 */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_unicast_supported_valid;  /**< Must be set to true if is_unicast_supported is being passed */
  uint8_t is_unicast_supported;
  /**<   Unicast Tx flow capability. Values:\n
       -0 -- Unicast Tx flow is not supported\n
       -1 -- Unicast Tx flow is supported
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Gets the traffic descriptor (TD) informtaion. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_get_td_info_req_msg_v01;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Gets the traffic descriptor (TD) informtaion. */
typedef struct {
  ...
  /**<   Transaction ID.
  */
}wds_get_td_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the TD information. */
typedef struct {
  ...
  */
  ...
  /* Mandatory */
  /*  Transaction Information for Current TD */
  wds_td_fragment_info_type_v01 tx_td_info;
  /**<   Transaction information for the current TD.
  */
 ...
 */
  ...
  uint8_t dnn_list_valid;  /**< Must be set to true if dnn_list is being passed */
  uint32_t dnn_list_len;  /**< Must be set to # of elements in dnn_list */
  wds_apn_name_list_type_v01 dnn_list[QMI_WDS_APNS_MAX_V01];
  /**<   DNN list
  */

  /* Optional */
  /*  Destination Fully Qualified Domain Name (FQDN) List */
  uint8_t dest_fqdn_list_valid;  /**< Must be set to true if dest_fqdn_list is being passed */
  uint32_t dest_fqdn_list_len;  /**< Must be set to # of elements in dest_fqdn_list */
  wds_fqdn_type_v01 dest_fqdn_list[QMI_WDS_TD_FQDN_LIST_MAX_V01];
  /**<    Destination FQDN list
  */
  ...
  wds_app_id_info_type_v01 app_id_list[QMI_WDS_APP_ID_LIST_MAX_V01];
  /**<    Application ID list
  */

  /* Optional */
  /*  Destination IPV4 Address */
  uint8_t dest_ipv4_addr_list_valid;  /**< Must be set to true if dest_ipv4_addr_list is being passed */
  uint32_t dest_ipv4_addr_list_len;  /**< Must be set to # of elements in dest_ipv4_addr_list */
  wds_ipv4_addr_type_v01 dest_ipv4_addr_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<    Destination IPv4 address list
  */

  /* Optional */
  /*  Destination IPV6 Address */
  uint8_t dest_ipv6_addr_list_valid;  /**< Must be set to true if dest_ipv6_addr_list is being passed */
  uint32_t dest_ipv6_addr_list_len;  /**< Must be set to # of elements in dest_ipv6_addr_list */
  wds_runtime_ipv6_addr_type_v01 dest_ipv6_addr_list[QMI_WDS_IPV6_ADDR_LIST_MAX_V01];
  /**<    Destination IPv6 address list
  */

  /* Optional */
  /*  Mac Address List */
  uint8_t mac_addr_list_valid;  /**< Must be set to true if mac_addr_list is being passed */
  uint32_t mac_addr_list_len;  /**< Must be set to # of elements in mac_addr_list */
  data_mac_addr_type_v01 mac_addr_list[QMI_WDS_MAC_ADDR_LIST_MAX_V01];
  /**<    Mac address list
  */

  /* Optional */
  /*  Next Header Protocol List */
  uint8_t next_hdr_prot_list_valid;  /**< Must be set to true if next_hdr_prot_list is being passed */
  uint32_t next_hdr_prot_list_len;  /**< Must be set to # of elements in next_hdr_prot_list */
  uint8_t next_hdr_prot_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<    Next header protocol list
  */

  /* Optional */
  /*  Flow Label List */
  uint8_t flow_label_list_valid;  /**< Must be set to true if flow_label_list is being passed */
  uint32_t flow_label_list_len;  /**< Must be set to # of elements in flow_label_list */
  uint8_t flow_label_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<    Flow label in IPV6 header list
  */

  /* Optional */
  /*  Customer-VLAN tag (C-TAG) VID List */
  uint8_t c_tag_vid_list_valid;  /**< Must be set to true if c_tag_vid_list is being passed */
  uint32_t c_tag_vid_list_len;  /**< Must be set to # of elements in c_tag_vid_list */
  uint16_t c_tag_vid_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<    Customer-VLAN tag (C-TAG) VID list
  */

  /* Optional */
  /*  Service-VLAN tag (S-TAG) VID List */
  uint8_t s_tag_vid_list_valid;  /**< Must be set to true if s_tag_vid_list is being passed */
  uint32_t s_tag_vid_list_len;  /**< Must be set to # of elements in s_tag_vid_list */
  uint16_t s_tag_vid_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<   Service-VLAN tag (S-TAG) VID list
  */

  /* Optional */
  /*  Destination Port List */
  uint8_t dest_port_list_valid;  /**< Must be set to true if dest_port_list is being passed */
  uint32_t dest_port_list_len;  /**< Must be set to # of elements in dest_port_list */
  uint16_t dest_port_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<   Destination Port List
   */

  /* Optional */
  /*  Type of Service/Traffic Class */
  uint8_t tos_trf_cls_list_valid;  /**< Must be set to true if tos_trf_cls_list is being passed */
  uint32_t tos_trf_cls_list_len;  /**< Must be set to # of elements in tos_trf_cls_list */
  wds_tos_trf_cls_type_v01 tos_trf_cls_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<   Type of service in IPV4 or traffic class in IPV6 list
   */

  /* Optional */
  /*  IP Security Paramemter Index (SPI) List */
  uint8_t ip_spi_list_valid;  /**< Must be set to true if ip_spi_list is being passed */
  uint32_t ip_spi_list_len;  /**< Must be set to # of elements in ip_spi_list */
  uint32_t ip_spi_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<   IP SPI List
   */

  /* Optional */
  /*  Destination Port Range List */
  uint8_t dest_port_range_list_valid;  /**< Must be set to true if dest_port_range_list is being passed */
  uint32_t dest_port_range_list_len;  /**< Must be set to # of elements in dest_port_range_list */
  wds_port_range_type_v01 dest_port_range_list[QMI_WDS_TD_INFO_LIST_MAX_V01];
  /**<    Destination Port Range List
  */
}wds_td_info_ind_msg_v01;  /* Message */
/**
    @}
  */
 ...
 */
  ...
  /* Optional */
  /*  Data Network Name (DNN) */
  uint8_t dnn_valid;  /**< Must be set to true if dnn is being passed */
  char dnn[QMI_WDS_APN_NAME_MAX_V01 + 1];
  /**<   DNN
  */
  ...
  */
  ...
  /**<    Destination Port Range List
  */
}wds_pdu_session_param_lookup_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}wds_pdu_session_param_lookup_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_enums
  ...
  */
typedef enum {
  WDS_PDU_SESS_LOOKUP_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WDS_LOOKUP_SUCCESS_V01 = 0, 
  WDS_LOOKUP_INTERNAL_ERROR_V01 = 1, 
  WDS_LOOKUP_NO_MEMORY_V01 = 2, 
  WDS_LOOKUP_INVALID_APN_V01 = 3, 
  WDS_LOOKUP_SLICE_NOT_ALLOWED_V01 = 4, 
  WDS_LOOKUP_ROUTING_FAIL_V01 = 5, 
  WDS_LOOKUP_LADN_DNN_NOT_AVAIL_V01 = 6, 
  WDS_LOOKUP_APN_TYPE_MISMATCH_V01 = 7, 
  WDS_PDU_SESS_LOOKUP_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wds_pdu_sess_lookup_status_enum_v01;
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the PDU session lookup result information. */
typedef struct {
  ...
  */
  ...
  /*  Result Status */
  uint8_t status_valid;  /**< Must be set to true if status is being passed */
  wds_pdu_sess_lookup_status_enum_v01 status;
  /**<   Lookup result status. Value:\n
      - WDS_LOOKUP_SUCCESS (0) -- 
      - WDS_LOOKUP_INTERNAL_ERROR (1) -- 
      - WDS_LOOKUP_NO_MEMORY (2) -- 
      - WDS_LOOKUP_INVALID_APN (3) -- 
      - WDS_LOOKUP_SLICE_NOT_ALLOWED (4) -- 
      - WDS_LOOKUP_ROUTING_FAIL (5) -- 
      - WDS_LOOKUP_LADN_DNN_NOT_AVAIL (6) -- 
      - WDS_LOOKUP_APN_TYPE_MISMATCH (7) -- 
 */

  /* Optional */
  /*  DNN Slice */
  uint8_t dnn_slice_valid;  /**< Must be set to true if dnn_slice is being passed */
  char dnn_slice[QMI_WDS_APN_NAME_MAX_V01 + 1];
  /**<   DNN Slice
  */
}wds_pdu_session_param_lookup_result_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates route change info. */
typedef struct {
 ...
 */
  ...
  */
  ...
  /**<    Destination Port Range List
  */
}wds_route_change_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WDS_GET_TD_INFO_V01
...
//#define REMOVE_QMI_WDS_PDU_SESSION_PARAM_LOOKUP_V01
...
//#define REMOVE_QMI_WDS_ROUTE_CHANGE_IND_V01
...
//#define REMOVE_QMI_WDS_TD_INFO_IND_V01
...
#define QMI_WDS_GET_TD_INFO_REQ_V01 0x010D
#define QMI_WDS_GET_TD_INFO_RESP_V01 0x010D
#define QMI_WDS_TD_INFO_IND_V01 0x010E
#define QMI_WDS_PDU_SESSION_PARAM_LOOKUP_REQ_V01 0x010F
#define QMI_WDS_PDU_SESSION_PARAM_LOOKUP_RESP_V01 0x010F
#define QMI_WDS_PDU_SESSION_PARAM_LOOKUP_RESULT_IND_V01 0x010F
#define QMI_WDS_ROUTE_CHANGE_IND_V01 0x0110
