...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/time/src/time_service_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t time_get_genoff_offset_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(time_get_genoff_offset_resp_msg_v01, fulltime) - QMI_IDL_OFFSET8(time_get_genoff_offset_resp_msg_v01, fulltime_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
...
static const uint8_t time_update_indication_message_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(time_update_indication_message_v01, fulltime) - QMI_IDL_OFFSET8(time_update_indication_message_v01, fulltime_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
...
static const uint8_t qmi_time_qtimer_delta_from_hlos_apps_req_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_req_v01, hlos_apps_timetick),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_req_v01, sdx_timetick)
};

static const uint8_t qmi_time_qtimer_delta_from_hlos_apps_resp_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_time_qtimer_delta_from_hlos_apps_resp_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t qtimer_delta_update_indication_message_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(qtimer_delta_update_indication_message_v01, qtimer_delta)
};
...
static const qmi_idl_message_table_entry time_message_table_v01[] = {
  ...
  {sizeof(qmi_time_qtimer_delta_from_hlos_apps_req_v01), qmi_time_qtimer_delta_from_hlos_apps_req_data_v01},
  {sizeof(qmi_time_qtimer_delta_from_hlos_apps_resp_v01), qmi_time_qtimer_delta_from_hlos_apps_resp_data_v01},
  {sizeof(qtimer_delta_update_indication_message_v01), qtimer_delta_update_indication_message_data_v01}
};
...
static const qmi_idl_service_message_table_entry time_service_command_messages_v01[] = {
  ...
  {QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_REQ_V01, QMI_IDL_TYPE16(0, 13), 22}
};
...
static const qmi_idl_service_message_table_entry time_service_response_messages_v01[] = {
  ...
  {QMI_TIME_REMOTE_QTIMER_TIMESTAMP_DELTA_RESP_V01, QMI_IDL_TYPE16(0, 14), 7}
};
