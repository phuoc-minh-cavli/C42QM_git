...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/common/api/common_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Thu Jun  3 2021 (Spin 0)
...
#define COMMON_V01_IDL_MINOR_VERS 0x0D
...
typedef enum {
  ...
  QMI_ERR_IMS_NOT_READY_FOR_SUPS_V01 = 0x0063, 
  ...
  QMI_ERR_BAND_NOT_SUPPORTED_V01 = 0x0077, 
