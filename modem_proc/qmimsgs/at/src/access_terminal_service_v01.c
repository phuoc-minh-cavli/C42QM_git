...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.4/at/src/access_terminal_service_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t at_dereg_at_cmd_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET8(at_dereg_at_cmd_type_v01, at_cmd_name),
  QMI_AT_CMD_NAME_MAX_V01,
...
static const uint8_t at_req_at_cmd_fwd_ex_req_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(at_req_at_cmd_fwd_ex_req_v01, support_token_ex) - QMI_IDL_OFFSET16RELATIVE(at_req_at_cmd_fwd_ex_req_v01, support_token_ex_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(at_req_at_cmd_fwd_ex_req_v01, support_token_ex)
};
...
static const uint8_t at_req_at_cmd_fwd_ex_resp_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(at_req_at_cmd_fwd_ex_resp_v01, token_ex_support) - QMI_IDL_OFFSET8(at_req_at_cmd_fwd_ex_resp_v01, token_ex_support_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(at_req_at_cmd_fwd_ex_resp_v01, token_ex_support)
};
...
static const uint8_t at_fwd_at_cmd_ex_ind_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, cmec_val) - QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, cmec_val_valid)),
  0x19,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, token_ex) - QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, token_ex_valid)),
  0x1A,
  ...
  QMI_IDL_OFFSET16ARRAY(at_fwd_at_cmd_ex_ind_v01, token_ex),
  ((QMI_AT_NUM_TOKEN_MAX_EX_V01) & 0xFF), ((QMI_AT_NUM_TOKEN_MAX_EX_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, token_ex) - QMI_IDL_OFFSET16RELATIVE(at_fwd_at_cmd_ex_ind_v01, token_ex_len)
};

static const uint8_t at_dereg_at_cmd_fwd_ex_req_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(at_dereg_at_cmd_fwd_ex_req_v01, at_cmd_list),
  QMI_AT_NUM_CMD_MAX_V01,
  QMI_IDL_OFFSET8(at_dereg_at_cmd_fwd_ex_req_v01, at_cmd_list) - QMI_IDL_OFFSET8(at_dereg_at_cmd_fwd_ex_req_v01, at_cmd_list_len),
  QMI_IDL_TYPE88(0, 4)
};

static const uint8_t at_dereg_at_cmd_fwd_ex_resp_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(at_dereg_at_cmd_fwd_ex_resp_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_type_table_entry  at_type_table_v01[] = {
  ...
  {sizeof(at_dereg_at_cmd_type_v01), at_dereg_at_cmd_type_data_v01}
};
...
static const qmi_idl_message_table_entry at_message_table_v01[] = {
  ...
  {sizeof(at_dereg_at_cmd_fwd_ex_req_v01), at_dereg_at_cmd_fwd_ex_req_data_v01},
  {sizeof(at_dereg_at_cmd_fwd_ex_resp_v01), at_dereg_at_cmd_fwd_ex_resp_data_v01}
};
...
static const qmi_idl_service_message_table_entry at_service_command_messages_v01[] = {
  ...
  {QMI_AT_REG_AT_CMD_FWD_EX_REQ_V01, QMI_IDL_TYPE16(0, 11), 448},
  {QMI_AT_DEREG_AT_CMD_FWD_EX_REQ_V01, QMI_IDL_TYPE16(0, 14), 424}
};
...
static const qmi_idl_service_message_table_entry at_service_response_messages_v01[] = {
  ...
  {QMI_AT_REG_AT_CMD_FWD_EX_RESP_V01, QMI_IDL_TYPE16(0, 12), 11},
  {QMI_AT_DEREG_AT_CMD_FWD_EX_RESP_V01, QMI_IDL_TYPE16(0, 15), 7}
};
...
static const qmi_idl_service_message_table_entry at_service_indication_messages_v01[] = {
  ...
  {QMI_AT_FWD_AT_CMD_EX_IND_V01, QMI_IDL_TYPE16(0, 13), 1724},
