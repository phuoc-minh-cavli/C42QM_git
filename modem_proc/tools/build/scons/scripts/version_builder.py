...
#----------------------------------------------------------------------------
#
#  $Header: //commercial/MPSS.JO.1.2.r3.1/Main/modem_proc/tools/build/scons/scripts/version_builder.py#1 $
...
def qc_version_builder(target, source, env):
    ...
    qc_version_str = "".join([
        ...
        "\"QC_IMAGE_VERSION_STRING=", xml_image_tree_name.text.upper(), "-", \
        xml_image_tree_revision.text.upper(), "\";\n"])
