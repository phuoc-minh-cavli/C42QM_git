...
#------------------------------------------------------------------------------
#
#  $Header: //commercial/MPSS.JO.1.2.r3.1/Main/modem_proc/tools/build/scons/scripts/cmdline.py#1 $
...
def generate(env):
    ...
    # add option to enable Dependency Tree generation with analytics
    SCons.Script.AddOption('--dependency-tree', \
        dest='dependency_tree', \
        action="store_true", \
        default=False, \
        help='Enable dependency tree generation with analytics'\
    )
