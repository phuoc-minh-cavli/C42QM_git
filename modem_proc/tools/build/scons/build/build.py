...
#-------------------------------------------------------------------------------
#
#  $Header: //commercial/MPSS.JO.1.2.r3.1/Main/modem_proc/tools/build/scons/build/build.py#1 $
...
if __name__ == "__main__":
    ...
    try:
        ...
        LG.log("Running $Header: //commercial/MPSS.JO.1.2.r3.1/Main/modem_proc/tools/build/scons/build/build.py#1 $")
