...
/*=============================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/api/public/secssldef.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
#define SSL_V3_SERVER_EXTENSION_MAX_SIZE 100
...
#define SSL_V3_MAC_MAX_LENGTH        1024  /**< 8-byte pad + 20-byte MAC + x. */
/**
@}
*/
/* end_addtogroup rpd */
