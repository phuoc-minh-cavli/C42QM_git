...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/api/public/IxIPSec.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $


  when       who     what, where, why
  --------   ---     ----------------------------------------------------------
  07/23/19   ds      Added API header for ESP header size.  
  01/11/17   ks      SA packet sequence number, set get APIs
...
/**
  ...
  @param Opt           [in] -- Option type to be retrieved.
  @param SA_params [in] -- SA parameters.
  ...
  @dependencies
  SA_params needs to be freed by caller
*/

IxErrnoType SetSAParams ( const IPSecSAParams_s  *SA_params );
...
*/
  ...
  static   IxErrnoType get_in_out_seq (IPSecSADBIndexType  &SAIndex,
                              IPSecSAType               &SA,
                              IxCallback                *pcb);
...
/**
  ...
  @param SlctrIndex [in] -- Selector index; used only for selector options.
  @param *SP_params [in] -- pointer to SP parameters.
  ...
  This function frees pOptVal.
*/
  IxErrnoType  SetSPParams( const uint8              SlctrIndex,
                                 const IPSecSPParams_s    *SP_params );
...
/** 
  ...
  @param pSize      [out] -- ESP header size of corresponding IPsec SA.
...
*/
static IxErrnoType GetESPHdrSize
(
  const IPSecSPDBIndexType &SPIndex,
  uint32                   *pSize
);
