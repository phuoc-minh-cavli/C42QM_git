...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/api/public/ps_ppp_ext.h#1 $
...
typedef enum
{
  ...
  PPP_RM_DEV                 = PPP_MIN_DEV,  /**< RM instance. */
  PPP_RM_2_DEV               = 1 ,    /**< Second RM instance. */
  PPP_MAX_DEV                = 2,     /**< Maximum value for array sizing. */
