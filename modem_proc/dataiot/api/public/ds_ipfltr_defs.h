#ifndef DS_IPFLTR_DEFS_H
#define DS_IPFLTR_DEFS_H

/*===========================================================================

                          D S _ I P F L T R _ D E F S . H

===========================================================================*/

/**
   @file ds_ipfltr_defs.h
...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/api/public/ds_ipfltr_defs.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $

when        who        what, where, why
--------    ---    ----------------------------------------------------------
02/06/18   svaka    created file
===========================================================================*/
/* group: tcpUdpIpIp6 */
...
typedef struct
{
  ip_addr_enum_type ip_vsn; /**< IP version of the filter (IPv4 or IPv6). 
...
typedef struct
{
  ...
  uint32             fltr_handle;      /**< Handle to list of filters in flow */
} ip_filter_spec_type;

/** @} */  /* end_addtogroup datatypes */

#endif /* DS_IPFLTR_DEFS_H */
