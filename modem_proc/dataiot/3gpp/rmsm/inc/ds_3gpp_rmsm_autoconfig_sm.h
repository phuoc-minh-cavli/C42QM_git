...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/3gpp/rmsm/inc/ds_3gpp_rmsm_autoconfig_sm.h#1 $ 
...
#define DSRMSM_SET_DHCP6_SERVER_HANDLE(fw_inst, handle) \
   if(fw_inst != NULL) \
   {                            \
     fw_inst->dhcp6_server_handle  = (handle);\
   }\
