...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/hc/src/ps_comp_logging_helper.c#1 $
  $Author: pwbldsvc $
...
/*-------------------------------------------------------------------------*/
  ...
  DS_SYSTEM_HEAP_MEM_FREE(pkt_info_ptr);
}
...
/*-------------------------------------------------------------------------*/
  ...
  instance_ptr = (ps_comp_logging_instance_s *) 
    ds_system_heap_mem_alloc(sizeof(ps_comp_logging_instance_s),__FILENAME__ , __LINE__);
...
/*-------------------------------------------------------------------------*/
  ...
  DS_SYSTEM_HEAP_MEM_FREE(instance_ptr);
...
/*-------------------------------------------------------------------------*/
  ...
  pkt_info_ptr_i = (ps_comp_logging_pkt_info_s *)
    ds_system_heap_mem_alloc(sizeof(ps_comp_logging_pkt_info_s),__FILENAME__ , __LINE__);
