...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/linklayer/src/ps_ppp_snoop.c#1 $
...
#define PS_PPP_SNOOP_ASSERT(expression)  \
               ps_ppp_snoop_assert_wrapper(__LINE__, expression)
...
= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =*/
 ...
 FUNCTION ps_ppp_snoop_assert_wrapper
 
 DESCRIPTION
   Wrapper function for PS_PPP_SNOOP_ASSERT
 ...
 ===========================================================================*/
 static void ps_ppp_snoop_assert_wrapper
 (
 ...
 )
 {
   if ( !expression )
   {
     ERR_FATAL("PS_PPP_SNOOP_ERR_FATAL at line:%d ",  
                                    line_num,0,0);  
   }
 }/* ps_ppp_snoop_assert_wrapper */
...
)
{
  ...
  {
    /*("snoop:reg_event: Invalid parameters");*/
    PS_PPP_SNOOP_ASSERT(0);
    return 0;
  }
  ...
  switch(protocol)
  {
    case PPP_LCP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg LCP cb code: %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_PAP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg PAP cb code %d iface %d", msg_type, iface);
      break;
    ...
    -----------------------------------------------------------------------*/
      ...
      LOG_MSG_INFO3_2("Reg CHAP cb code %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_IPCP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg IPCP cb code %d iface %d", msg_type, iface);
      break;
#ifdef FEATURE_DATA_PS_IPV6
    case PPP_IPV6CP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg IPV6CP cb code %d iface %d", msg_type, iface);
      break;
#endif /* FEATURE_DATA_PS_IPV6  */
    case PPP_IP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg IP callback code %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_VJCH_PROTOCOL:
      ...
      msg_type = SNOOP_ANY_MSG;
      LOG_MSG_INFO3_2("Reg VJCH callback code %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_VJUCH_PROTOCOL:
      ...
      msg_type = SNOOP_ANY_MSG;
      LOG_MSG_INFO3_2("Reg VJUCH callback code %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_CCP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg CCP callback code %d iface %d", msg_type, iface);
      break;
    ...
    case PPP_ILCCP_PROTOCOL:
      ...
      LOG_MSG_INFO3_2("Reg ILCCP callback code %d iface %d", msg_type, iface);
      break;
...
)
{
  ...
  -------------------------------------------------------------------------*/
  /**/
  PS_PPP_SNOOP_ASSERT(tag->proto < (byte)FA_MAX_IDX);
  PS_PPP_SNOOP_ASSERT(tag->msg < SNOOP_MAX_MSGS);
  PS_PPP_SNOOP_ASSERT(tag->iface < (byte)PPP_MAX_DEV);
  /**/
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DATA_PROTO_ERROR_LOG_1(PS_BAD_ARG_OR_NULL_PTR,item_head_ptr); 
