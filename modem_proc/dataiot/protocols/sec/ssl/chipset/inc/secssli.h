...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/sec/ssl/chipset/inc/secssli.h#1 $
  $Date: 2020/03/17 $ $Author: pwbldsvc $
...
12/13/18   ds      Code changes for SSL re-design for low tier chipsets.
...
#define SECSSL_DH_MIN_MOD_LEN         16
...
typedef struct
{
  ...
  /* SSL Verify Mode */
  secssl_verify_mode_enum_type   verify_mode;
...
struct secssl_session_s
{
  ...
  /*Deepak : added new param for event mask on socket CB*/
...
(
  ...
  secerrno_cb_fptr_type  open_cb_fptr,
  void*                  open_cb_udata_ptr,
  secssl_cb_fptr_type    ssl_cb_ptr
);
...
SIDE EFFECTS
  None
===========================================================================*/
void secssli_dss_net_cb
(
  dss_net_callback_info_s* arg1
);
...
SIDE EFFECTS
  None
===========================================================================*/
void secssli_dss_socket_cb
(
  dss_sock_callback_info_s* arg1
);
...
(
  sint15 app_id,
  sint15 sockfd,
  struct ps_sockaddr_in6 *server_v6,
  int srv_len
);
...
FUNCTION SECSSLI_SET_SES_VERIFY_MODE

DESCRIPTION
SSL CONNECTION to use the passed VERIFY mode (PEER/NONE currently supported)
...
PARAMETERS
  session_ptr                             - Pointer to session parameter belongs to
  session_verify_mode_ptr                 - ptr to the verify mode value to be set
...
===========================================================================*/
secerrno_enum_type secssli_set_ses_verify_mode
(
  secssl_session_type*                        session_ptr,
  secssl_verify_mode_enum_type*               session_verify_mode_ptr
);
