...
Copyright (c) 2003-2018 Qualcomm Technologies Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/api/ps_ip6_sm.h#1 $
  $Author: pwbldsvc $ $DateTime: 2020/03/17 08:03:16 $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
09/28/18    ds     Code changes for chiltepin(9x05).
30/08/16    kc     Added FR21288 changes in ip6_sm_cb_s 
                   and ip6_sm_destroy()
...
#define     IPV6_RANDOM_IID  0
#define     IPV6_USER_IID    1 
...
/*===========================================================================
FUNCTION IP6_SM_VALID_RA_CBACK()
...
struct __ip6_sm_cb_s
{
  ...
  ds_ipfltr_handle_type icmp6_dst_fltr; // No usage seen
  int tries;
  /*---------------------------------------------------------------------
