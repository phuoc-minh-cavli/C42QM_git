...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/api/ps_ppp_fsm.h#1 $
...
SIDE EFFECTS
  None
===========================================================================*/
typedef int (*ppp_fwk_input_f_type)
(
  void               *ds_fwk_ptr,
...
SIDE EFFECTS
  None
===========================================================================*/
typedef void (*ppp_fwk_config_f_type)
(
...
struct fsm_s
{
  ...
  ds_fwk_s_type   *fwk_inst_ptr;/* ptr to receive interface       */
  /*------------------------------------------------------------------------ 
  ...
  ------------------------------------------------------------------------*/
  ppp_fwk_input_f_type   fwk_input;  /* func ptr for iface rx function */
  ppp_fwk_config_f_type  fwk_config; /* func ptr to configure     */
