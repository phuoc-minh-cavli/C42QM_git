...
/*===========================================================================
 ...
 $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/src/token_bucket.c#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
)
{
  ...
  {
    LOG_MSG_ERROR_0("Failed to initialize token bucket, invalid parameter(s)");
    DS_ASSERT(0);
    return;
  }
...
)
{
  ...
  {
    LOG_MSG_ERROR_0("Null token bucket passed to token_bucket_get_token()");
    DS_ASSERT(0);
    return FALSE;
  }
...
)
{
  ...
  {
    LOG_MSG_ERROR_0("Invalid parameter(s) to token_bucket_set_max_tokens()");
    DS_ASSERT(0);
    return FALSE;
  }
...
)
{
  ...
  {
    LOG_MSG_ERROR_0("Invalid parameter(s) to token_bucket_set_ms_per_token()");
    DS_ASSERT(0);
    return FALSE;
  }
