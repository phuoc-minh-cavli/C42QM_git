...
Copyright (c) 2005-2018 Qualcomm Technologies Incorporated. 
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/src/ps_stat_tcp.c#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    LOG_MSG_ERROR_0("ps_stat_get_tcp_instance_all :Null tcb_ptr or Invalid stat");
    DS_ASSERT(0);
