...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/src/ps_tcpsubr.c#3 $ $DateTime: 2020/12/23 03:28:10 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_ASSERT(tcb_ptr != NULL && FALSE == ps_timer_is_running(tcb_ptr->timer) &&
  ...
  -------------------------------------------------------------------------*/
  DS_ASSERT(0 == tcb_ptr->numb_bytes_in_transit ||
