...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/ps_ip.h#2 $ $DateTime: 2020/04/15 22:43:35 $ $Author: pwbldsvc $
...
int ip_any_input
(
  ds_fwk_s_type *in_if_ptr,           /* Input interface                   */
