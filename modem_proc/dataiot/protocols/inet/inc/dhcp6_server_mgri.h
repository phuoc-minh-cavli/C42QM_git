...
$Id: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/dhcp6_server_mgri.h#1 $
...
typedef struct {
  ...
  void           (*dns_domain_name_list)(void *,ds_domain_name_type *, uint32 *);
  void * dns_domain_name_handle;

  void           (*sip_addr_list)(void *, ip_addr_type *, uint32 *);
  void * sip_addr_handle;

  void           (*sip_domain_name_list)(void *, ds_domain_name_type *, uint32 *);
...
(
void * handle,
ds_domain_name_type  *dns_domain_name_list,
uint32 * count
);
/*===========================================================================
...
(
void * handle,
ds_domain_name_type  *sip_domain_name_list,
uint32 * count
);
/*===========================================================================
