...
$Id: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/dhcp6_sl_server_mgr.h#1 $
...
typedef struct 
{
  ...
  ds_domain_name_type  * domain_name_search_list;
  ...
  ds_domain_name_type  * sip_serv_domain_name_list;
...
( 
  ds_fwk_s_type * client_iface,
  ds_fwk_s_type * gw_iface,
