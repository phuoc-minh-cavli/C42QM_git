...
$Header: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/ps_ip6_hdr.h#2 $
$Author: pwbldsvc $ $DateTime: 2020/04/21 03:54:08 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/17/20   ds      Code changes to use MUTILS to efficiently utilize DSM items.
05/02/19   ds      Added Macro IP6_BASE_HDR_DEST_ADDR_IID_OFFSET.
...
#define IP6_BASE_HDR_DEST_ADDR_IID_OFFSET 32
  /**< Offset for 64 bit Dest Address IID in the IPv6 base header. */
/** @} */ /* end_addtogroup constants */
