...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/ps_icmp.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
struct icmp_cb
{
  ...
  q_type rcvq;                  /* receive queue for the socket            */ //DSS_PROTO_INT
  uint16 family;
