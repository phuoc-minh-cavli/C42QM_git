...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/protocols/inet/inc/ps_ip_fraghdl.h#2 $
  $DateTime: 2020/04/15 22:43:35 $
  $Author: pwbldsvc $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
04/14/20    ds     Added function prototype for ip_fraghdl_get_fragment_ex() 
                   and ip_fraghdl_queue_frag_packet() function.
...
DESCRIPTION
  Dequeues and returns the fragments in the queue.

PARAMETERS
   handle -- Fragment handle to get the queued fragments from.
...
DESCRIPTION
  Places the passed fragment in the given frag queue

PARAMETERS
  handle  -- Fragment handle in which packets needs to be queued.
  pkt_ptr -- Fragment packet to be queued in passed fragment handle.
