...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/src/dsatdl.h#2 $
...
typedef void (*dsatcmdp_rmsm_crtdcp_done_handler_f_type)
(
  uint32                   profile_number,
  dsm_item_type          **data_frame
);

typedef void (*dsatcmdp_refresh_subs_based_nv_f_type)(void);
...
typedef void (*voice_send_ring_result_f_type)(cm_call_mode_info_e_type);
...
typedef struct dsatdl_vtable_type
{
  ...
  dsatcmdp_rmsm_crtdcp_done_handler_f_type     dsatcmdp_rmsm_crtdcp_done_handler_fp;  
