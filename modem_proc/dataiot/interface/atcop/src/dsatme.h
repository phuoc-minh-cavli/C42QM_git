...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2003 - 2019 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/src/dsatme.h#1 $
...
typedef enum
{
  ...
  DSAT_MMGSDI_CSP_READ  = 120,    /*  CSP read */
...
typedef struct {
  ...
  /* contains the original strings after '>'
     ...
     Memory will be allocated in heap and freed during the end of command
     execution or if missed it will be freed at the beginning of execution
     of AT command(process_at_cmd_line()) */
  byte                  *str;
