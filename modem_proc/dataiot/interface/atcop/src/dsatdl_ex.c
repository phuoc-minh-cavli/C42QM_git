...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2014 - 2014,2017 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
$Header: //components/rel/dataiot.mpss/2.0/interface/atcop/src/dsatdl_ex.c#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
)
{
  ...
  DS_ASSERT(symbol_table_ptr != NULL);
