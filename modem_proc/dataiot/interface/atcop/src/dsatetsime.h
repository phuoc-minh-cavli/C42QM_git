...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/src/dsatetsime.h#2 $ $DateTime: 2020/11/27 22:36:28 $ $Author: pwbldsvc $
...
/*===========================================================================
FUNCTION: DSATETSIME_DECODE_CPSMS_GPRS_TIMER

DESCRIPTION
  This function decoded the gprs timer in 8 bit format and validate as well.
...
RETURN VALUE
  returns boolean
  return decoded gprs timer value
  possible values:
    TRUE : If given timer is supported
    FALSE : If given timer is not supported
