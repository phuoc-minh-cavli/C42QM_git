...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/inc/dsati.h#15 $ $DateTime: 2023/05/16 04:05:59 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/15/23   ks      Enhancing +COPS, +CEREG commands to support NTN RAT.
04/05/23   ks      Enhancement of $QCCELLSCAN and $QCRRINFO command.
...
11/20/17   skc     Fixed issue while flushing queued URCs.
...
04/12/16   skc     Featurized timer related to EAP.
...
#define DSAT_BM(val) (1 << (val))

#define DS_JAMMING_STATE_NOT_DETECTED 0
/*===========================================================================
...
#define NOT_FORWARDABLE 0x10000000  /* Command is not allowed to register for forwarding */
...
typedef uint64  ds_profile_identifier_type;
...
/* Dial string's first char is '+' after valid dial prefix      */
#define         DIAL_ATTRIB_START_PLUS_AFTER_VALID_DIAL_PREFIX   (0x0001 << 9)

typedef uint16  ds_profile_num_type;

typedef ps_timer_handle_type dsatutil_timer_handle_type;
...
#define VALID_NUM_TOKEN(token_index, range_min, range_max, output_buf) \
    ...
    /* Test for null string token in parameter list. Then Convert to INT */
#define VALID_NUM_TOKEN_EX(token_index, range_min, range_max, output_buf, identifier) \
        err_info.errval = dsat_is_valid_num_token(dsat_curr_cmd_var.tok_ptr, \
                                token_index, \
                                range_min, \
                                range_max, \
...
#define EXEC_VAL_PTR(parse_table) \
    ( dsatutil_get_val_from_cmd_id(parse_table->cmd_id)\
    )
...
#define dsat_alloc_cmd_mem_ptr(size, cmd_idx) \
  dsatutil_alloc_cmd_mem_ptr(dsat_alloc_memory(size, FALSE), cmd_idx)
...
#define DSAT_MAX_EDRX_VAL_LENGTH   4

#define IS_VALID_APPS_ID(apps_id) \
  ((DSAT_APPS_ID_PRIMARY <= apps_id) && (apps_id < DSAT_APPS_ID_MAX))

/* SIM applications */
//TODO: sanjaykc
typedef enum
{
  DSAT_APPS_ID_PRIMARY = 0,
  DSAT_APPS_ID_SECONDARY,
  DSAT_APPS_ID_TERTIARY,
  DSAT_APPS_ID_MAX
} dsat_apps_id_e_type;

/* To keep track of CEREG/CGREG URCs in progress */
typedef enum
{
  CMD_CEREG_NONE   = 0x0,
  CMD_CEREG_4_URC  = 0x1,
...
typedef enum jdstate_act_e
{
  DSAT_JD_ACT_GSM    = 0,   /* User-specified GSM access technology */
  DSAT_JD_ACT_EUTRAN = 1,   /* User-specified LTE access technology */
  DSAT_JD_ACT_EUTRAN_NB_S1 = 2,    /* User-specified LTE NB S1 access technology*/
  DSAT_JD_ACT_MAX      /* Internal use only */
} dsat_jdstate_act_e_type;

#ifdef FEATURE_DSAT_ATCOP_VEND
typedef enum rr_cur_rat_e
{
  DSAT_RR_ACT_NONE         = 0,
  DSAT_RR_ACT_LTE_NB1      = 1,   /* NB-IoT access technology */
  DSAT_RR_ACT_LTE_M1       = 2,   /* Cat-M access technology */
  DSAT_RR_ACT_LTE          = 3,   /* LTE access technology*/
  DSAT_RR_ACT_GSM          = 4,   /* GSM access technology*/
#ifdef FEATURE_NBIOT_NTN
  DSAT_RR_ACT_LTE_NB1_NTN  = 5,   /* LTE NB1 NTN access technology*/
#endif /* FEATURE_NBIOT_NTN */
  DSAT_RR_ACT_MAX      /* Internal use only */
} dsat_rr_cur_rat_e_type;

typedef enum rr_roam_status_e
{
  DSAT_RR_ROAM_STATUS_NONE   = 0,   /* No PLMN selected*/
  DSAT_RR_ROAM_STATUS_OFF    = 1,   /* Home PLMN */
  DSAT_RR_ROAM_STATUS_ON     = 2,   /* Roaming PLMN(VPLMN) */
  DSAT_RR_ROAM_STATUS_MAX      /* Internal use only */
} dsat_rr_roam_status_e_type;
#endif /* FEATURE_DSAT_ATCOP_VEND */

typedef enum qccellscan_rat_e
{
  DSAT_QCCELLSCAN_RAT_GSM         = 0,          /* GSM access technology*/
  DSAT_QCCELLSCAN_RAT_LTE_M1      = 7,          /* Cat-M access technology */
  DSAT_QCCELLSCAN_RAT_LTE_NB1     = 9,          /* NB-IoT access technology */
#ifdef FEATURE_NBIOT_NTN
  DSAT_QCCELLSCAN_RAT_LTE_NB1_NTN = 10,         /* LTE NB1 NTN access technology*/
#endif /* FEATURE_NBIOT_NTN */
  DSAT_QCCELLSCAN_RAT_MAX                       /* Internal use only */
} dsat_qccellscan_rat_e_type;
...
typedef struct
{
  ...
  cm_ciot_user_lte_pref_s_type         network_ciot_user_lte_pref;
...
{
  DSAT_EDRX_RAT_NONE,
  DSAT_EDRX_RAT_EC_GSM_IOT,
  DSAT_EDRX_RAT_GSM_RADIO_ACCESS,
  DSAT_EDRX_RAT_UMTS_RADIO_ACCESS,
  DSAT_EDRX_RAT_LTE_RADIO_ACCESS,
  DSAT_EDRX_RAT_LTE_NB1_RADIO_ACCESS,
  DSAT_EDRX_RAT_MAX
} dsat_edrx_radio_access_tech_e_type;
	
typedef struct dsat_edrx_params_s
{
...
} dsat_edrx_params_s_type;
	
typedef struct dsat_edrx_config_s
{
  byte  version;
  dsat_edrx_params_s_type gsm;  /* eDRX params for GSM rat  version 0*/
  dsat_edrx_params_s_type umts; /* eDRX params for UMTS rat version 0*/
  dsat_edrx_params_s_type lte;  /* eDRX params for LTE rat version 0*/
  dsat_edrx_params_s_type NB1;  /* eDRX params for NB1 rat version 1*/
  dsat_edrx_params_s_type M1;   /* eDRX params for M1 rat version 1*/
  byte reserved[15];
} dsat_edrx_config_s_type;
...
typedef struct
{
  ...
  dsat_edrx_ph_pref_s_type             edrx_info;
#endif /*FEATURE_DSAT_EDRX*/
#ifdef FEATURE_DSAT_ATCOP_VEND
  sys_cell_search_list_s_type         dsat_cell_serach_info;
  sys_plmn_list_status_e_type         cell_cnf;
#endif
...
typedef struct
{
    boolean                     lte_tx_status;
    sys_sband_lte_e_type        lte_tx_band;
} dsatcmif_lte_tx_info_s_type;
#endif
#endif /* FEATURE_DSAT_LTE */
...
#ifdef FEATURE_DSAT_LTE
#ifdef FEATURE_DSAT_ATCOP_VEND
  dsatcmif_lte_tx_info_s_type          dsat_lte_tx_info;
#endif
#endif /* FEATURE_DSAT_LTE */
...
{
  uint32                                client_ref;  /* Client requested */
  mmgsdi_spn_info_type                  spn;              /**< Service provider name. */
...
typedef struct
{
  mmgsdi_se13_plmn_static_info_type           plmn_info;    /*plmn info. */
  uint16                                      plmn_id;
...
typedef struct
{
  ...
  ds_net_down_reason_type              inst_net_down;/* Primary PS call down reason */
  dsat_rmsm_cmd_type                   dsat_rmsm_cmd;
} ds_at_pdp_cmd_type;

/*===================== RmSm CRTDCP ===================*/

/* DS_AT_CRTDCP_CMD_TYPE data type, to report downlink data received on control plane */

typedef struct
{
  uint32                 profile_number;
  dsm_item_type         *data_frame;
}ds_at_crtdcp_cmd_type;
...
typedef enum cops_act_e
{
  ...
  DSAT_COPS_ACT_EC_GSM_IOT_A_GB = 8, /* User-specified GSM IOT A GB access technology*/
  DSAT_COPS_ACT_EUTRAN_NB_S1 = 9,    /* User-specified LTE NB S1 access technology*/
#ifdef FEATURE_NBIOT_NTN
  DSAT_COPS_ACT_SATELLITE_EUTRAN_NB_S1 = 14,    /* User-specified Satellite LTE NB S1 access technology (NTN)*/
#endif /* FEATURE_NBIOT_NTN */
...
typedef enum
{
  ...
  DSAT_VENDOR_QCRATSTATE_IDX  = 13073,
  DSAT_VENDOR_QCEXTCLTSTATE_IDX = 13074,  
  DSAT_VENDOR_QCCELLSCAN_IDX  = 13075,
  DSAT_VENDOR_QCJDCFG         = 13076,
  DSAT_VENDOR_QCJDSTATE       = 13077,
  DSAT_VENDOR_QCRPMINFO_IDX   = 13078,
  DSAT_VENDOR_QCCEINFO_MODE   = 13079,  
  DSAT_VENDOR_QCCEINFO_IDX    = 13080,
  DSAT_VENDOR_QCSFNGET_IDX    = 13081,
  DSAT_VENDOR_QCSFNRANGE_IDX  = 13082,
  DSAT_VENDOR_QCRRINFO_IDX    = 13083,
  DSAT_VENDOR_QCMSISDN_IDX    = 13084,
  DSAT_VENDOR_QCCELLSELECT_IDX = 13085,
#ifdef FEATURE_FSK_TX
  DSAT_VENDOR_QCFSKDBG_IDX    = 13086,
  DSAT_VENDOR_QCFSKDATA_IDX   = 13087,
  DSAT_VENDOR_QCFSKHOPTABLE_IDX = 13088,
  DSAT_VENDOR_QCFSKSTART_IDX  = 13089,
  DSAT_VENDOR_QCFSKSTOP_IDX   = 13090,
  DSAT_VENDOR_QCPCLFIX_IDX    = 13091,
  DSAT_VENDOR_QCFSK_IDX       = 13092,
#endif /* FEATURE_FSK_TX */
  DSAT_VENDOR_QCDLTPTENH_IDX  = 13093,
  DSAT_VENDOR_MAX_IDX         = 13094
...
typedef enum
{
  ...
  DSATETSI_EXT_ACT_CPSMS_ETSI_IDX = 14083,
  DSATETSI_EXT_ACT_CEDRXS_ETSI_IDX = 14084,
  DSATETSI_EXT_ACT_CEDRXRDP_ETSI_IDX = 14085,
  DSATETSI_EXT_ACT_MAX_ETSI_IDX   = 14086
...
typedef enum
{
  ...
  DSATETSI_EXT_CSODCP_IDX      = 15051,
  DSATETSI_EXT_CRTDCP_IDX      = 15052,
  DSATETSI_EXT_MAX_IDX         = 15999
...
#ifdef FEATURE_DSAT_ATCOP_VEND
#ifdef FEATURE_FSK_TX
  DSATI_FSK_DATA_ENTRY_MODE,       /* FSK Data entry mode     */
  DSATI_FSK_DATA_END_MODE,         /* FSK Data end mode       */
#endif /* FEATURE_FSK_TX */
#endif
...
{
  byte                           *cmd_line_buffer;
  /* Memory will be allocated in heap of size MAX_LINE_SIZE and 
     will remain till the scope of ATCoP Engine */
  byte                           *prev_line_buffer;
  /* Memory will be allocated in heap of size MAX_LINE_SIZE and
     will remain till the scope of ATCoP Engine */
...
typedef struct {
  ...
  boolean       valid_dial_prefix; /* If dial string starts with supported dial prefix */
  byte          len_dial_prefix;   /* Length of Dial Prefix */
} dsati_dial_str_type;
...
/*dsat_cpol_res_type*/
  ...
  DSAT_PENDING_CPSMS_READ           = 170,    
  DSAT_PENDING_CPSMS_WRITE          = 171,
  DSAT_PENDING_CPSMS_NONE           = 172,
  
  DSAT_PENDING_CEREG_READ           = 175,
  DSAT_PENDING_CEREG_NONE           = 176,
  DSAT_PENDING_CEREG_URC_4          = 177,

  DSAT_PENDING_CGREG_READ           = 178,
  DSAT_PENDING_CGREG_NONE           = 179,

  DSAT_PENDING_CEDRXS_WRITE         = 181,
  DSAT_PENDING_CEDRXS_URC           = 182,
  DSAT_PENDING_CEDRXS_NONE          = 183,
  
  DSAT_PENDING_CEDRXRDP_READ        = 184,
  DSAT_PENDING_CEDRXRDP_NONE        = 185,

  DSAT_PENDING_CMD_NONE             = 190
...
typedef enum
{
  ...
  DSAT_MMGSDI_VALS               = 130,

  DSAT_PBM_VALS                  = 140,

  DSAT_COMMON_VALS                  = 150,
  DSAT_MD_VALS                      = 160,
  DSAT_PSM_URC_VALS                 = 170,
...
/*! @brief Enhanced Coverage mode type enum */
typedef enum
{
  DSAT_CE_INFO_ENH_COV_MODE_A,
  DSAT_CE_INFO_ENH_COV_MODE_B
} dsat_ceinfo_enh_cov_mode_e; 
...
typedef enum
{
  DSAT_CE_INFO_UE_STATE_IDLE      = 0,   /* Idle State */
  DSAT_CE_INFO_UE_STATE_RACH      = 1,   /* Rach OR Connecting State */
  DSAT_CE_INFO_UE_STATE_CONNECTED = 2,   /* Connected State */
  DSAT_CE_INFO_UE_STATE_MAX       = 100,
} dsat_ce_info_state_e;
/*! @brief The message structure for UE Coverage Enhancement(CE) Mode Information Request
 */

typedef struct dsat_ceinfo_s
{
  boolean                          ceinfo_valid;
  ...
  dsat_ceinfo_enh_cov_mode_e       enh_cov_mode;

  /*!< UE State at the time of the report */
  dsat_ce_info_state_e             state;
  ...
  uint16						   ul_num_rep;
   ...
   /*!< SINR of serving cell in  10xdB format */
  int16							   cinr; 
...
typedef struct dsat_sfn_info_s
{
  uint32               hsfn_sfn_nbr;
...
typedef struct dsat_jammer_detect_info_s
{
  /* Current radio access technology*/
  sys_radio_access_tech_e_type         rat_type;

  /* Incoming jamming status of the current RAT*/
  uint32                               inc_jamming_status;

  /* Incoming soft jamming status*/
  boolean                              inc_soft_jamming_status;
  
}dsat_jammer_detect_info_s_type;

#ifdef FEATURE_FSK_TX
typedef struct dsat_fsk_info_s
{
  /* Response status */
  uint8 status;

  /* Frequency to use in the transmission, expressed in kHz 
     Range: 902000-928000, 966037-967957 */
  uint32 freq;

  /* delta of frequency, expressed in kHz 
     Default: 2, Possible values: 1,2,3,5
  */
  uint8 delta;

  /* <baudrate> - number of bit/s 
   0 – 3466 bits/s (16bit per TDMA Frame)
   1 – 1733 bits/s (8bit per TDMA Frame) (default)
   2 – 866 bits/s (4bit per TDMA Frame)   */
  uint8 baudrate;

  /* Hop table consists of channel_id, delta and list of frequencies*/
  geran_fsk_hop_table_type  *hop_table;

  /* numeric parameter indicating the fixed PCL for GSM band. 
     Range: (5-19, 99); Default: 99*/
  uint8 pcl_gsm;

  /* numeric parameter indicating the fixed PCL for DCS band. 
     Range: (5-19, 99); Default: 99*/
  uint8 pcl_dcs;

  /* numeric parameter indicating the fixed PCL for PCS band. 
     Range: (5-19, 99); Default: 99*/
  uint8 pcl_pcs;
}dsat_fsk_s_type;
#endif /* FEATURE_FSK_TX */
...
typedef struct
{
  const ds_command_enum_type event;
...
}dsat_basic_table_val_struct_type;

typedef struct
{
  dsat_num_item_type dsat_o_val;
  
}dsat_basic_action_table_val_struct_type;
...
}dsat_basic_sreg_table_val_struct_type;
...
}dsat_basic_ext_table_val_struct_type;
...
typedef struct
{
  ...
  dsat_num_item_type     dsat_qcratstate_val;
  dsat_num_item_type     dsat_qcextcltstate_val;
#endif
#endif /* FEATURE_DSAT_LTE */
  ...
  dsat_num_item_type              dsat_qccellscan_mode_val;
  dsat_num_item_type              dsat_qcjdcfg_val;  
  dsat_num_item_type              dsat_qcjdstate_val; 
  dsat_num_item_type              dsat_qcceinfo_val; 
  dsat_num_item_type              dsat_qcsfn_val;
#ifdef FEATURE_FSK_TX
  dsat_mixed_param_val_type       dsat_qcfskdbg_val[3];
  dsat_num_item_type              dsat_qcfskdata_val;
  dsat_num_item_type              dsat_qcfskstart_val[3];
  dsat_num_item_type              dsat_qcfskstop_val;
#endif /* FEATURE_FSK_TX */
#endif
...
#endif/* FEATURE_TTY */
}dsat_basic_vend_table_val_struct_type;
...
typedef struct
{
  dsat_num_item_type dsat_cmer_val[4];
  ...
  dsat_mixed_param_val_type dsat_cpsms_val[5];
#ifdef FEATURE_DSAT_EDRX
  dsat_mixed_param_val_type dsat_cedrxs_val[3];
#endif /* FEATURE_DSAT_EDRX */
...
#endif /* FEATURE_ETSI_SMS*/
  dsat_mixed_param_val_type dsat_cops_val[4];
#ifdef FEATURE_MMGSDI
#ifdef FEATURE_DSAT_LTE
...
}dsat_etsi_ext_act_table_val_struct_type;
...
dsat_num_item_type dsat_cvhu_val;
  ...
  dsat_num_item_type dsat_crtdcp_val;
#endif /* FEATURE_DSAT_LTE*/
...
}dsat_etsi_ext_table_val_struct_type;
...
#define DSAT_LEGACY_PROFILE_NUM_MAX 15
#define DSAT_EXT_PROFILE_NUM_MIN 100
#define DSAT_EXT_PROFILE_NUM_MAX 179

//@sanjaykc:Please check with 3gpp team
...
*/
#define  DS_UMTS_MAX_PDP_PROFILE_NUM   15
...
---------------------------------------------------------------------------*/
#define IS_PIN_STATE(state) ((uint32)state == (me_val->dsat_pin_required & (uint32)state))
#define IS_PUK_STATE(state) ((uint32)state == (me_val->dsat_pin_blocked & (uint32)state))

#endif /* defined(FEATURE_DATA_ETSI_PIN) */
...
typedef void (*dsatutil_timer_cb_f_type)(void *cb_data);

typedef struct dsat_timer
{
  dsat_timer_id_e_type       timer_id;    /* Timer identifier             */
  dsatutil_timer_cb_f_type   cb_func;     /* Callback fon timer expiry */
  ...
  dsatutil_timer_handle_type timer_handle;
} dsat_timer_s_type;
...
typedef struct
{
  ds_profile_ip_version_enum_type ip_vsn;
  ds_profile_addr_type            addr;
}dsat_ip_addr_type;
...
/* PSM Config structure*/
typedef struct
{
  uint32       gprs_ready_timer_value;		
  uint32       periodic_rau_timer_value;		
  uint32       active_timer_value;		
  uint32       periodic_tau_timer_value;		
  uint16       change_mask;		
  boolean      psm_enabled;		
}dsat_psm_cfg_params_s_type;

typedef enum 
{
  DSAT_PSM_URC_CEDRXS_MODE,
  DSAT_PSM_URC_CEREG,
  DSAT_PSM_URC_CGEREP_MODE,
  DSAT_PSM_URC_CGEREP_BFR,
  DSAT_PSM_URC_CGREG,
  DSAT_PSM_URC_CMER_MODE,
  DSAT_PSM_URC_CMER_IND,
  DSAT_PSM_URC_CNMI_MODE,
  DSAT_PSM_URC_CNMI_MT,
  DSAT_PSM_URC_CNMI_BM,
  DSAT_PSM_URC_CNMI_DS,
  DSAT_PSM_URC_CNMI_BFR,
  DSAT_PSM_URC_CRC_MODE,
  DSAT_PSM_URC_CREG,
  DSAT_PSM_URC_CRTDCP,
  DSAT_PSM_URC_CTZR_REPORTING,
  DSAT_PSM_URC_QCRATSTATE_MODE,
  DSAT_PSM_URC_JDCFG,
  DSAT_PSM_URC_MAX
} dsat_psm_urc_params_e_type;

typedef struct
{
  uint32       bit_mask;
  uint8        psm_urc_params[DSAT_PSM_URC_MAX];
} dsat_psm_atcop_urc_state_info;

typedef struct
{
  /* Flag to indicate if RTS is asserted or not.
     If this flag is low, ATCOP should halt current commands that
     requesting data from the subsystem
  */
  boolean is_rts_asserted;

  /* Function to reenter current command processing which has halted
     when RTS is LOW.
  */

  dsati_async_event_handler_type rts_high_handler;

  /* Flag to track if rts change callback received */
  boolean is_rts_change_cb_recvd;
}dsati_sio_rts_change_s_type;

#ifdef FEATURE_DSAT_ATCOP_VEND

typedef enum dsati_psm_image_boot_e
{
   DSAT_PSM_IMAGE_BOOT_NONE = 0,
   DSAT_PSM_IMAGE_BOOT_FULL = 1,
   DSAT_PSM_IMAGE_BOOT_PAGE = 2,
   DSAT_PSM_IMAGE_BOOT_SNS = 3,
   DSAT_PSM_IMAGE_BOOT_MAX
} dsat_psm_image_boot_e_type;

/*! @brief Enumeration for jamming detect Rat Type
*/
typedef enum dsati_soft_jam_rat_type_e
{
  DS_SOFT_JAM_RAT_TYPE_M1,
  DS_SOFT_JAM_RAT_TYPE_NB1
} dsat_soft_jam_rat_type_e;

/*! @brief Enumeration for jamming detect service status
*/
typedef enum dsati_jam_det_service_status_e
{
  DS_JAM_DET_SVC_STATUS_NOT_AVAILABLE, /*!< 0 */
  DS_JAM_DET_SVC_STATUS_AVAILABLE,     /*!< 1 */
  DS_JAM_DET_SVC_STATUS_MAX 
} dsat_jam_det_service_status_e;

/*! @brief Message for Service Indication to Data Module
*/
typedef struct
{
  dsat_soft_jam_rat_type_e             act_rat_type; 
  /*!< Active RAT */
  dsat_jam_det_service_status_e        svc_status;  
  /*!< Service status (0 if the device is in OOS ,
    1 if the device is camped)*/
} dsat_jd_service_status_ind_s_type;

typedef struct 
{
   boolean is_ue_camped;
   dsat_cops_act_e_type rat;
   int32 qrxlevmin;
   int32 qrxlevmin_ce;
   int32 qrxlevmin_ce1;
   uint8 rxlev_access_min;
} dsat_cell_select_info_s;
...
extern dsati_sio_rts_change_s_type dsati_sio_rts_change[];
...
FUNCTION DSATCMDP_URC_SEND_OR_QUEUE

DESCRIPTION
  This function handles URC which will be either send to port or queue it.
...
extern void dsatcmdp_urc_send_or_queue
(
...
DESCRIPTION
  Flushes the buffered Unsolicited result codes to all unblocked ports.
...
===========================================================================*/
void dsatcmdp_flush_urc_on_all_unblocked_port(void);
...
(
  ...
  byte                  arg_length,    /* Length of arg[index] */
...
===========================================================================*/
extern atoi_enum_type dsatutil64_atoi
(
...
/*===========================================================================
FUNCTION DSATCMDP_RMSM_CRTDCP_DONE_HANDLER
...
#define DSATUTIL_SET_VAL(cmd_id,index,size,value_num,value_type) \
  {  \
    dsat_value_set(cmd_id,index,size,value_num,value_type);\
  } 
...
#define DSATUTIL_GET_VALUE(cmd_id,index,value_type,result_ptr)\
  {  \
    dsati_value_info_struct_type val_info;\
    memset((void *)&val_info,0,sizeof(val_info));\
    dsat_set_val_info( index, 0,0, value_type,&val_info);\
    result_ptr = dsatutil_get_ptr_to_value( cmd_id, &val_info);\
  }
...
/*===========================================================================
 ...
 SIDE EFFECTS
   None.
 ===========================================================================*/
 void dsat_bin_conversion
 (
   uint32       num, 
   byte*        binaryForm, 
   uint8        binaryForm_size,
   uint8        siz
 );
...
/*===========================================================================
 ...
 SIDE EFFECTS
   None.
 ===========================================================================*/
 void dsat_determine_rat
 (
   dsat_edrx_config_s_type     *edrx_info, 
   uint8                       rat_type,
...
/*===========================================================================
  FUNCTION DSATUTIL_HEX_STRING_TO_BYTES()

  DESCRIPTION
    This function convert hex string into bytes and put in buffer.

  PARAMETERS
   hex_string: hex data in string format.
   num_octets: Number of bytes
   buf_out   : Buffer in which hex data is stored

  DEPENDENCIES
    None.

  RETURN VALUE
    buf_out : Buffer which contains hex data.
    boolean : True if success and False if failure
  
  SIDE EFFECTS
    None
===========================================================================*/

boolean dsatutil_hex_string_to_bytes
(
