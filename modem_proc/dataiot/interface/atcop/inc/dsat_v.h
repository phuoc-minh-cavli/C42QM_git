...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/inc/dsat_v.h#3 $ $DateTime: 2021/02/01 05:46:44 $ $Author: pwbldsvc $
...
//TODO: For temporarily; we will use one feature flag or clean the code inside (not defined)
//#define FEATURE_DATA_IOE_LWG
//#define FEATURE_DATA_IOE_LONLY
//#define FEATURE_DATA_IOE_LG

//#define FEATURE_DSAT_DISABLED_FOR_IOT

//TODO: Temporary features; will be removed its all usage
//If we enalbe these feature, we will see compilation issue which we need to check whether that code is not required or not
//If required, we need to work as per latest design of CT

//#define FEATURE_ATCOP_TEMP_PROFILE
//#define FEATURE_ATCOP_TEMP_PROFILE_ALT
//#define FEATURE_ATCOP_TEMP_PROFILE_QCPRFMOD
//#define FEATURE_ATCOP_TEMP_PROFILE_REMOVE
//#define FEATURE_ATCOP_TEMP_PROFILE_3GPP2_REMOVE
//#define FEATURE_ATCOP_TEMP_PROFILE_3GPP2_EPC_REMOVE
//#define FEATURE_ATCOP_TEMP_PROFILE_TODO
//#define FEATURE_ATCOP_TEMP_PROFILE_QCPDPCFGE
//#define FEATURE_ATCOP_TEMP_PROFLE_QCPDPIMSCFGE
//#define FEATURE_ATCOP_TEMP_PROFILE_EPC
//#define FEATURE_ATCOP_TEMP_PROFILE_ATL
//#define FEATURE_ATCOP_TEMP_PROFILE_3GPP2
//#define FEATURE_ATCOP_TEMP_PROFILE_ENABLED
//#define FEATURE_ATCOP_TEMP_PROFILE_CGTFT
//#define FEATURE_ATCOP_TEMP_PROFILE_DELETE

//#define FEATURE_ATCOP_TEMP_CM_TODO
//#define FEATURE_ATCOP_TEMP_CM_ROAM

//#define FEATURE_ATCOP_TEMP_RMSM_TODO
//#define FEATURE_ATCOP_TEMP_RMSM_ALT
//#define FEATURE_ATCOP_TEMP_QCDGEN_RMSM
//#define FEATURE_ATCOP_TEMP_QCPDPP
//#define FEATURE_ATCOP_TEMP_3GPP_ALT
//#define FEATURE_ATCOP_TEMP_3GPP_CGCMOD
//#define FEATURE_ATCOP_TEMP_CGPADDR
//#define FEATURE_ATCOP_TEMP_3GPP_CGACT_TODO
//#define FEATURE_ATCOP_TEMP_3GPP_CGACT
//#define FEATURE_ATCOP_TEMP_DS3G

//#define FEATURE_ATCOP_TEMP_NV_TODO
//#define FEATURE_ATCOP_TEMP_NV_ALT


//#define FEATURE_ATCOP_TEMP_SMS_ALT

//#define FEATURE_ATCOP_TEMP_PRESENT_MODE
...
/* This command line size required for +CSODCP command.
   Data Length can be 2000 and 100 is place holder for 
   command name and other parameters.*/
  #define DSAT_MAX_LINE_SIZE 2100     /*  Maximum length of AT command line    */
...
#define DSAT_MAX_ARG 52   /* FSK HOPTABLE command uses 52 arguments*/
#elif defined (FEATURE_DSAT_LARGE_ARGS)
...
typedef enum
{
  ...
  DSAT_RMSM_CSODCP_CMD = 2,   /* +CSODCP command response */
...
typedef struct dsat_rmsm_info_type
{
  ...
  union
  {
    ds_net_down_reason_type  iface_net_down;/* Primary PS call down reason */
  }reason;
  void* user_info_ptr;
...
typedef struct
{
  ...
  byte   apn[DS_PDN_APM_MAX_APN_STRING_LEN];  /* APN */
