...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/atcop/inc/dsatclient.h#2 $
...
(
  ...
  uint8                                   is_support_token_ex, /* token_ex support  */
  void                                   *user_info_ptr /* Client data       */
);
...
{
  q_type at_fwd_cmd_q;
  uint16 at_fwd_cmd_cnt;
}qmi_at_fwd_list_q_type;

extern qmi_at_fwd_list_q_type qmi_at_fwd_list;
...
typedef struct allowed_list_efs
{
  char**  cmd_list_efs;
  uint8   num_at_cmds;
  boolean is_available;
}dsat_allowed_list_efs_type;
...
DEPENDENCIES 
  AT forward daemon up and running.
...
SIDE EFFECTS  
  None
===========================================================================*/
extern void dsat_init_allowed_list_efs (void);
...
DESCRIPTION  
  Free the memory allocated for storing the allowed AT commands which is present in the EFS .
...
extern void dsat_deinit_allowed_list_efs(void);
