...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/dns/src/dss_dns_hostent.c#2 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  -------------------------------------------------------------------------*/
  LOG_MSG_INFO2_3("dss_getipnodebyname called with addr 0x%p, family %d, cback 0x%p",
...
)
{
  ...
  LOG_MSG_INFO2_3("dss_getipnodebyaddr called with addr 0x%p, family %d, cback 0x%p",
