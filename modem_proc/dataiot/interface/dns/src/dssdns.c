...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/dns/src/dssdns.c#2 $
  $DateTime: 2021/01/08 07:47:27 $ $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  LOG_MSG_INFO2_3("dss_dns_get_addrinfo called with sess %d, hostname 0x%p, hints 0x%x",
...
)
{
  ...
  ps_dnsi_session_mgr_cb_type   * session_mgr_ptr = NULL;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_INFO2_3("dss_dns_get_nameinfo called with sess %d, sockaddr 0x%p, flags 0x%x",
...
)
{
  ...
  ps_dnsi_session_mgr_cb_type      * session_mgr_ptr = NULL;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_INFO2_3("dss_dns_read_addrinfo called with sess %d, handle %d, num recs %d",
...
)
{
  ...
  ps_dnsi_session_mgr_cb_type      * session_mgr_ptr = NULL;
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_INFO2_3("dss_dns_read_nameinfo called with sess %d, handle %d, num recs %d",
                  session_handle, query_handle, num_records);
...
//  ps_iface_type * iface_ptr = NULL;
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_INFO2_1("dss_dns_clear_cache called with iface_id %p", client_handle);
  ...
  //TODO; Check if this is needed or should we clear from fwk inst if we are
  //storing DNS addr there
  #if 0
...
)
{
  ...
  /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  LOG_MSG_INFO2_1("dss_dns_clear_cache_entry called with client handle %d",
                  client_handle);
