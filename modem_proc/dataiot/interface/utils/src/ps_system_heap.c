...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/src/ps_system_heap.c#1 $
...
#error code not present
  ...
  DS_ERROR_FATAL("ps_system_heap_deinit(): Not supported!");
...
#error code not present
  ...
  DS_ERROR_FATAL("ps_system_heap_get_alloc_buf_count(): Not supported!");
  return 0;
