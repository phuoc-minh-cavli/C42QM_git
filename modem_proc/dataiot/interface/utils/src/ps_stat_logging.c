...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/src/ps_stat_logging.c#1 $
  $Author: pwbldsvc $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG0(MSG_LEGACY_HIGH,"ps_stat_loggingi_get_inst_desc_req(): "
  ...
  {
    DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_loggingi_get_inst_desc_req(): "
  ...
  DS_SYSTEM_HEAP_MEM_ALLOC_ASSERT(desc_ptr ,sizeof(ps_stat_logging_desc_cmd_type),ps_stat_logging_desc_cmd_type  *);
  ...
  *desc_ptr = hget64(request_ptr);
  ...
  -------------------------------------------------------------------------*/
  //ps_send_cmd(PS_STAT_INST_GET_DESC_CMD, (void *) desc_ptr); //Sid MOB Link error
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_MSG0(MSG_LEGACY_ERROR,"ps_stat_loggingi_get_stat_list_from_sscmd(): "
  ...
  {
    DS_SYSTEM_HEAP_MEM_ALLOC_ASSERT(inst_info_ptr,sizeof(ps_stat_logging_stat_cmd_type),ps_stat_logging_stat_cmd_type * );
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG0(MSG_LEGACY_HIGH,"ps_stat_loggingi_get_inst_stat_req(): "
  ...
  {
    DS_MSG_SPRINTF_1(MSG_LEGACY_ERROR,"ps_stat_loggingi_get_inst_stat_req(): "
  ...
  /*-------------------------------------------------------------------------
    Send the request on to the protocol stack to obtain the descriptions
  -------------------------------------------------------------------------*/
 // ps_send_cmd(PS_STAT_INST_GET_STAT_CMD, (void *) inst_list_head_ptr); SID MOb Linking error
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG0(MSG_LEGACY_HIGH ,"ps_stat_loggingi_reset_inst_stat_req(): "
  ...
  inst_list_head_ptr = ps_stat_loggingi_get_stat_list_from_sscmd
   ...
   /*-------------------------------------------------------------------------
    Send the request on to the protocol stack to obtain the descriptions
  -------------------------------------------------------------------------*/
  //ps_send_cmd(PS_STAT_INST_RESET_STAT_CMD, (void *) inst_list_head_ptr); Sid MOB Linking error
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_loggingi_process_get_inst_desc_req(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG0(MSG_LEGACY_HIGH,"ps_stat_loggingi_process_get_inst_stat_req(): "
  ...
  while (NULL != inst_cmd_info_ptr)
  {
    ...
    {
      DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_loggingi_process_get_inst_stat_req(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG0(MSG_LEGACY_HIGH,"ps_stat_loggingi_process_reset_inst_stat_req(): "
                  "Processing GET_INST_STAT");
  ...
  while (NULL != inst_info_ptr)
  {
    ...
    {
      DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_loggingi_process_reset_inst_stat_req(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_fill_desc_cback(): "
                  "Registering fill description callback function for type: %d",
                  func_type);
  ...
  if (NULL == func_ptr)
  {
    DS_MSG0(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_fill_desc_cback(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_get_stat_cback(): "
  ...
  DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_get_stat_cback(): "
                  "Registering get statistics callback function for type: %d",
                  func_type);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if ((func_type >= PS_STAT_MODULE_MAX) || (NULL == func_ptr))
  {
    DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_reset_stat_cback(): "
  ...
  DS_MSG_SPRINTF_1(MSG_LEGACY_HIGH,"ps_stat_logging_inst_reg_reset_stat_cback(): "
                  "Registering reset statistics callback function for type: %d",
                  func_type);
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  DS_MSG_SPRINTF_3(MSG_LEGACY_HIGH,"ps_stat_logging_inst_update_desc(): "
  ...
  {
    DS_MSG0(MSG_LEGACY_ERROR,"ps_stat_logging_inst_update_desc(): "
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  switch (log_pkt_type)
  {
    ...
    default:
      DS_ERROR_FATAL("ps_stat_logging_get_log_pkt(): Invalid log type passed in to GET_LOG_PKT");
      break;
  }
