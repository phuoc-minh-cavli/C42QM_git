...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/inc/ds_Utils_DebugMsg.h#1 $
...
#define DATA_ERR_FATAL(xx_exp) ERR_FATAL("Assertion " #xx_exp " failed", 0, 0, 0 );
      ...
      #define LOG_MSG_INFO2_LEVEL           MSG_LEGACY_HIGH
