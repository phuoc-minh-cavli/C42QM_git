...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/inc/ps_utils.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
typedef struct
{
  ...
  ds_sys_subscription_enum_type refresh_subs;     /** Subscription index for this refresh */
