...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/inc/pstimer_config.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
#define PS_TIMER_SOCKET_TIMERS (DSS_MAX_TCBS * 5 + DSS_MAX_SOCKS)   //138

  #define PS_TIMER_DNS_TIMERS    (PS_DNSI_PS_TIMER)    //2

#ifdef FEATURE_DATA_PS_PPP
#define PS_TIMER_PPP_TIMERS (3 * (uint8)PPP_MAX_DEV)      //12
#else
...
#define PS_TIMER_MAX_3GPP_BEARER   5 //8
