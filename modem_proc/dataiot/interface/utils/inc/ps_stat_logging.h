...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/utils/inc/ps_stat_logging.h#1 $
  $Author: pwbldsvc $
...
typedef enum
{
  ...
  /* type : uint32 */
  PS_STAT_FWK_PKTS_RX          = 0,
  /* Desc : # of incoming packets dropped*/
  /* type : uint32 */
  PS_STAT_FWK_PKTS_DROPPED_RX  = 1,
  /* Desc : # of packets sent */
  /* type : uint32 */
  PS_STAT_FWK_PKTS_TX          = 2,
  /* Desc : # of outgoing packets dropped */
  /* type : uint32 */
  PS_STAT_FWK_PKTS_DROPPED_TX  = 3,
  /* Desc : # of bytes received */
  /* type : uint64 */
  PS_STAT_FWK_BYTES_RX         = 4,
  /* Desc : # of bytes transmitted*/
  /* type : uint64 */ 
  PS_STAT_FWK_BYTES_TX         = 5,
  /* Desc : state of the interface */
  /* type : uint16 */
  PS_STAT_FWK_STATE            = 6,
  /* Desc : all framewok stats */
  PS_STAT_FWK_ALL
} ps_stat_fwk_enum_type;
