...
/*===========================================================================
  ...
  $Header: //components/rel/dataiot.mpss/2.0/interface/qmidata/inc/ds_qmi_defs.h#1 $ $DateTime: 2020/03/17 08:03:16 $ $Author: pwbldsvc $
...
typedef enum
{
  ...
  QMI_CMD_DMS_PSM_CFG_CHANGE_IND      = 157,
  QMI_CMD_AT_CMD_DEREG_STATUS         = 158,
#ifdef FEATURE_REF_TRACKER
  QMI_CMD_SNS_POLICY_MET_INDICATION   = 159,    
  QMI_CMD_SNS_POLICY_DATA_RESP        = 160,  
#endif
  QMI_CMD_MAX
} qmi_cmd_id_e_type;
