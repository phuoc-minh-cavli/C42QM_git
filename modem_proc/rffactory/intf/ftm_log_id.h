...
$Header: //components/rel/rffactory.mpss/1.0/intf/ftm_log_id.h#10 $
...
typedef enum 
{
  ...
  //FTM_LOG_MODEM_STATUS    = 0x8,

  FTM_LOG_GSM_THERM_VBATT  = 0x9,


  FTM_LOG_TX_RX_SWEEP      = 0xA,
  FTM_LOG_INTELLICEIVER   = 0xB,

  FTM_LOG_HDET_TRACKING   = 0xC,

  FTM_LOG_SEQUENCER      = 0x11,

  FTM_LOG_ICI_CAL_DATA   = 0xE,

  FTM_LOG_ATUNER_RL_DATA       = 0xF,
  FTM_LOG_ATUNER_SCENARIO_DATA = 0x10,

  FTM_LOG_ASDIV_DATA       = 0xFF,//changing from 0x11 to dummy 0xFF to avoid confusion ith FTM_LOG_SEQUENCER
  FTM_LOG_ASDIV_TUNER_DATA = 0x12,

#ifdef FEATURE_WCDMA
  FTM_LOG_WCDMA_AGC       = 0x13,
#endif

#ifdef FEATURE_GSM
  FTM_LOG_GSM_BER         = 0x14,
#endif

#ifdef FEATURE_WCDMA
  FTM_LOG_WCDMA_BER       = 0x15,
  FTM_LOG_WCDMA_AGC_C1    = 0x16,
  FTM_LOG_WCDMA_TXPLIM    = 0x17,
#endif

  FTM_LOG_SE_BER          = 0x18,
  
#ifdef FEATURE_WCDMA
  FTM_LOG_WCDMA_AGC_ENH   = 0x19,
#endif

  FTM_LOG_LTE_TX_AGC            = 0x1A,
  FTM_LOG_LTE_RX_AGC            = 0x1B,
  FTM_LOG_LTE_TXPLIM            = 0x1C,
  FTM_LOG_LTE_TX_AGC_ENH        = 0x1D,
  FTM_LOG_LTE_RX_AGC_ENH        = 0x1E,
  FTM_LOG_LTE_CA_HORXD_RX_AGC   = 0x1F,

#ifdef FEATURE_TDSCDMA  
  FTM_LOG_TDSCDMA_RX_AGC    = 0x20,
  FTM_LOG_TDSCDMA_TX_AGC    = 0x21,
  FTM_LOG_TDSCDMA_BER       = 0x22,
  FTM_LOG_TDSCDMA_TXPLIM    = 0x23,
#endif

#ifdef FEATURE_GSM
  FTM_LOG_GSM               = 0x24,
#endif
  FTM_LOG_IRAT_TIMING       = 0x25,
  FTM_LOG_FBRX_RESULTS      = 0x26,

#ifdef FEATURE_GSM
  FTM_LOG_GSM_ENH           = 0x27,
#endif

  FTM_LOG_FBRX_VSWR_RESULTS = 0x28,

  FTM_LOG_IM2_DFT         = 0x29,
  FTM_LOG_FFT             = 0x2A,
  FTM_LOG_AUTOCAL         = 0x2B, 
