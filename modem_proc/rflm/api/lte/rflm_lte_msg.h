...
/*===========================================================================
  ...
  Copyright (c) 2014-2019 Qualcomm Technologies Incorporated. All Rights Reserved
...
$Header: //components/rel/rflm.mpss/1.10/api/lte/rflm_lte_msg.h#1 $ 
 
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/25/19   dh      Added support for Therm Mitigation
...
enum
{
  ...
  MSGR_DEFINE_UMID( RFLM, LTE, IND, FED_THERM_MITIGATION_UPDATE,  
                    0x07, rflm_lte_fed_therm_ind_s)  ,
};
