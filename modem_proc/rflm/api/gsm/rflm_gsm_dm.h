...
$Header: //components/rel/rflm.mpss/1.10/api/gsm/rflm_gsm_dm.h#5 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/20/23   vta	   FSK shift issue: phase path disable through SDR api
09/02/20   bpa     Fixing CW and KW
06/18/20   mpa     Increase rx_start and rx_Stop tasks for customer req
07/11/19   mpa     Increase Tx band memory for revision18
06/13/19   krk     Notch_configuration for XO spur (+/-) channels to avoid sensitivity degradation
05/13/19   mpa     To increase rx start transaction memory to suuport mssv37
...
04/01/19   mpa     Increase Tx band DM memory for MSS V33
03/14/19   mpa     Enable JDET on Twizy
03/19/19   mpa     Doubler enable in Gain state0
03/14/19   mpa     Enable JDET on Twizy
03/14/19   mpa     OPtimizing DM memory for all events
03/12/19   mpa     decreasing the DM memory for entermode 
03/08/19   MPA     changes to disable jdet on SDR105
05/03/19   mpa     changes to fw_only compilation for rf_gainstate
26/02/19   mpa     JDET support on SDR105
01/28/19   mpa     Changes to support PATH_DELAY
12/26/18   hkm     Therm/V26 AG support
...
#define RFLM_FIRST_TX_RGI_OFFSET_FROM_OTA_QS -100
...
#define RFGSM_MAX_TX_NON_SSBI_ON_SSBI_SUPPORTED_DEVICE 15
#define RFGSM_MAX_RX_NON_SSBI_ON_SSBI_SUPPORTED_DEVICE 10

#define RFGSM_MC_MAX_RFFE_GROUP_NUM_REGS 100
#define RFGSM_MC_MAX_RFFE_GROUP_NUM_GROUPS 4

/* Enter Mode, Wakeup */
#define RFGSM_INIT_MAX_TASKS_TASKQ_A 3
#define RFGSM_INIT_MAX_TASKS_TASKQ_B 1
#define RFGSM_INIT_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_INIT_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 215
#define RFGSM_INIT_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_INIT_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 0
#define RFGSM_TX_ENTER_MODEEXTRA_PAYLOAD 250
...
#define RFGSM_INIT_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_INIT_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_INIT_MAX_TASKS_TASKQ_B)
...
/* Tx Band */
#define RFGSM_TX_BAND_MAX_TASKS_TASKQ_A 2
#define RFGSM_TX_BAND_MAX_TASKS_TASKQ_B 1
#define RFGSM_TX_BAND_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_TX_BAND_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 260
#define RFGSM_TX_BAND_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_TX_BAND_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 0
#define RFGSM_TX_BAND_EXTRA_PAYLOAD 80
...
#define RFGSM_TX_BAND_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_BAND_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_TX_BAND_MAX_TASKS_TASKQ_B)
...
/* Therm */
#define RFGSM_THERM_MAX_TASKS_TASKQ_A 5
#define RFGSM_THERM_MAX_TASKS_TASKQ_B 1
#define RFGSM_THERM_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_THERM_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 10
...
#define RFGSM_THERM_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_THERM_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_THERM_MAX_TASKS_TASKQ_B)
...
#define RFGSM_FRONTEND_CONFIG_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_FRONTEND_CONFIG_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_FRONTEND_CONFIG_MAX_TASKS_TASKQ_B)
...
/* Tx Cal */
#define RFGSM_TX_CAL_MAX_TASKS_TASKQ_A 35
#define RFGSM_TX_CAL_MAX_TASKS_TASKQ_B 10
/* Legacy support:WTR1625*/
#define RFGSM_TX_CAL_MAX_SSBI_TRANSACTIONS_TASKQ_A     20
/*WTR3925 rffes + PAPM*/
#define RFGSM_TX_CAL_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 80
...
#define RFGSM_TX_CAL_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_CAL_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_TX_CAL_MAX_TASKS_TASKQ_B)
...
#define RFGSM_RX_START_MAX_TASKS_TASKQ_B 4
#define RFGSM_RX_START_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_RX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 84
#define RFGSM_RX_START_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_RX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 12
#define RFGSM_RX_START_EXTRA_PAYLOAD 8
...
#define RFGSM_RX_START_TASK_B_PAYLOAD_SIZE \
                  ...
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_RX_START_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_RX_START_MAX_TASKS_TASKQ_B)
...
/* Rx Stop*/
#define RFGSM_RX_STOP_MAX_TASKS_TASKQ_A 2
#define RFGSM_RX_STOP_MAX_TASKS_TASKQ_B 4
#define RFGSM_RX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_RX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 6
#define RFGSM_RX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_RX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 6
#define RFGSM_RX_STOP_EXTRA_PAYLOAD 8
...
#define RFGSM_RX_STOP_TASK_A_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_RX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_RX_STOP_MAX_TASKS_TASKQ_A)), \
                    ...
                    +RFGSM_RX_STOP_EXTRA_PAYLOAD



#define RFGSM_RX_STOP_TASK_B_PAYLOAD_SIZE \
                  RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_RX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + \
                  RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_RX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_RX_STOP_MAX_TASKS_TASKQ_B)
...
#define RFGSM_JDET_READ_MAX_TASKS_TASKQ_A 3
#define RFGSM_JDET_READ_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_JDET_READ_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 15
#define RFGSM_JDET_READ_EXTRA_PAYLOAD 12
...
#define RFGSM_JDET_DISABLE_TRIGGER_MAX_TASKS_TASKQ_A 3
#define RFGSM_JDET_DISABLE_TRIGGER_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_JDET_DISABLE_TRIGGER_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 30
#define RFGSM_JDET_DISABLE_TRIGGER_EXTRA_PAYLOAD 35
#define RFGSM_JDET_DISABLE_TRIGGER_TASK_A_PAYLOAD_SIZE  RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_JDET_DISABLE_TRIGGER_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A)

RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_jdet_disable_trigger_task_q_a, RFGSM_JDET_DISABLE_TRIGGER_MAX_TASKS_TASKQ_A, RFGSM_JDET_DISABLE_TRIGGER_TASK_A_PAYLOAD_SIZE);

RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_jdet_disable_trigger_task_q_b, 1, 1);
...
/* Tx Start */
#define RFGSM_TX_START_MAX_TASKS_TASKQ_A 3
#define RFGSM_TX_START_MAX_TASKS_TASKQ_B 5
#define RFGSM_TX_START_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_TX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 42
#define RFGSM_TX_START_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_TX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 10
#define payload_buffer 0
...
#define RFGSM_TX_START_TASK_A_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_TX_START_MAX_TASKS_TASKQ_A)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_MAX_TX_NON_SSBI_ON_SSBI_SUPPORTED_DEVICE) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_START_MAX_SSBI_TRANSACTIONS_TASKQ_A, RFGSM_TX_START_MAX_TASKS_TASKQ_A)) )+payload_buffer


#define RFGSM_TX_START_TASK_B_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_START_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_TX_START_MAX_TASKS_TASKQ_B)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_MAX_TX_NON_SSBI_ON_SSBI_SUPPORTED_DEVICE) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_START_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_TX_START_MAX_TASKS_TASKQ_B)) )
...
/* Tx Trans */
#define RFGSM_TX_TRANS_MAX_TASKS_TASKQ_A 2
#define RFGSM_TX_TRANS_MAX_TASKS_TASKQ_B 2
#define RFGSM_TX_TRANS_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_TX_TRANS_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 16
#define RFGSM_TX_TRANS_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_TX_TRANS_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 8
#define RFGSM_TX_TRANS_EXTRA_PAYLOAD 60
...
#define RFGSM_TX_TRANS_TASK_B_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_TRANS_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_TX_TRANS_MAX_TASKS_TASKQ_B)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_TRANS_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_TRANS_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_TX_TRANS_MAX_TASKS_TASKQ_B)) )
...
/* Tx Trans */
#define RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_A 2
#define RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_B 2
#define RFGSM_FSK_TX_AFC_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 16
#define RFGSM_FSK_TX_AFC_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 8
#define RFGSM_FSK_TX_AFC_EXTRA_PAYLOAD 60
#define RFGSM_FSK_TX_AFC_TASK_A_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_A)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_SSBI_TRANSACTIONS_TASKQ_A, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_A)) )
                    


#define RFGSM_FSK_TX_AFC_TASK_B_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_B)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_FSK_TX_AFC_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_B)) )
                    


RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_fsk_tx_afc_task_q_a, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_A, RFGSM_FSK_TX_AFC_TASK_A_PAYLOAD_SIZE);
RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_fsk_tx_afc_task_q_b, RFGSM_FSK_TX_AFC_MAX_TASKS_TASKQ_B, RFGSM_FSK_TX_AFC_TASK_B_PAYLOAD_SIZE);


/* Tx Stop */
#define RFGSM_TX_STOP_MAX_TASKS_TASKQ_A 3
#define RFGSM_TX_STOP_MAX_TASKS_TASKQ_B 5
#define RFGSM_TX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_TX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 8
#define RFGSM_TX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_B     0
#define RFGSM_TX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B 8
...
#define RFGSM_TX_STOP_TASK_B_PAYLOAD_SIZE \
        MAX_TRANS( (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_STOP_MAX_NON_SSBI_TRANSACTIONS_TASKQ_B) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_TX_STOP_MAX_TASKS_TASKQ_B)), \
                    (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_MAX_TX_NON_SSBI_ON_SSBI_SUPPORTED_DEVICE) + RFGSM_SSBI_PAYLOAD_SIZE_32(RFGSM_TX_STOP_MAX_SSBI_TRANSACTIONS_TASKQ_B, RFGSM_TX_STOP_MAX_TASKS_TASKQ_B)) )
...
#define RFGSM_USTMR_SYNC_MAX_TASKS_TASKQ_A 3
#define RFGSM_USTMR_SYNC_MAX_SSBI_TRANSACTIONS_TASKQ_A     0
#define RFGSM_USTMR_SYNC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A 8

#define RFGSM_USTMR_SYNC_TASK_A_PAYLOAD_SIZE \
         (RFGSM_NON_SSBI_PAYLOAD_SIZE_32(RFGSM_USTMR_SYNC_MAX_NON_SSBI_TRANSACTIONS_TASKQ_A) + RFGSM_SSBI_PAYLOAD_SIZE_32(0, RFGSM_USTMR_SYNC_MAX_TASKS_TASKQ_A))
        

RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_ustmr_sync_task_q_a, RFGSM_USTMR_SYNC_MAX_TASKS_TASKQ_A, RFGSM_USTMR_SYNC_TASK_A_PAYLOAD_SIZE);
RFGSM_CCS_EVENT_TYPE(rflm_gsm_ccs_ustmr_sync_task_q_b, 1, 1);



#define RFLM_GSM_CCS_MAX_TOKEN_PER_EVENT  6
...
typedef struct
{
  ...
  rf_gain_range_T rf_gain_state;
  int32           wbdc_est_i;
  int32           wbdc_est_q; 
  rflm_gsm_notch_index_type notch_index;
}rflm_gsm_rx_data;
...
typedef struct
{
  rflm_gsm_ccs_ustmr_sync_task_q_a task_q_a;
  rflm_gsm_ccs_ustmr_sync_task_q_b task_q_b;
}rflm_gsm_ustmr_sync_data;

typedef struct
{
  rflm_gsm_ccs_jdet_disable_trigger_task_q_a task_q_a;
  rflm_gsm_ccs_jdet_disable_trigger_task_q_b task_q_b;
}rflm_jdet_disable_trigger_data;
...
typedef struct
{
  rflm_gsm_ccs_fsk_tx_afc_task_q_a task_q_a;
  rflm_gsm_ccs_fsk_tx_afc_task_q_b task_q_b;
}rflm_gsm_fsk_tx_afc_data;
...
typedef enum 
{
  RFLM_GSM_TIMER_FIXUP_TOKEN_DEFAULT_TIMER, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_HPM_TO_LPM, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_LPM_TO_HPM, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_RX_PLL_OFF, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_RX_PLL_ON, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_RX_SIGPATH_OFF, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_RX_SIGPATH_ON, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_RX_SIGPATH_ON_SPLL, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_TXRGI_0, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_TX_PLL_OFF, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_TX_PLL_ON, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_TX_SIGPATH_OFF, 
  RFLM_GSM_TIMER_FIXUP_TOKEN_TX_SIGPATH_ON, 
  RFLM_GSM_DATA_FIXUP_TOKEN_PRX_AGC,  //Unused for GSM but to maintain with trx_Devices enum just do a copypaste.
  RFLM_GSM_DATA_FIXUP_TOKEN_PLL, 
  RFLM_GSM_DATA_FIXUP_TOKEN_PRX_EOC, 
  RFLM_GSM_DATA_FIXUP_TOKEN_TXRGI, 
  RFLM_GSM_DATA_FIXUP_TOKEN_CT_REG_BANK_SEL, 
  RFLM_GSM_DATA_FIXUP_TOKEN_TX_FFH, 
  RFLM_GSM_DATA_FIXUP_TOKEN_RX_FFH, 
  RFLM_GSM_FIXUP_TOKEN_MAX, 
  RFLM_GSM_FIXUP_TOKEN_INVALID, 
} rflm_gsm_fixup_token_type;

typedef struct
{
  uint8 num_tokens;
  rflm_gsm_fixup_token_type token_type[RFLM_GSM_CCS_MAX_TOKEN_PER_EVENT];
  uint8 token_idx[RFLM_GSM_CCS_MAX_TOKEN_PER_EVENT];  
  uint8 token_length_bytes[RFLM_GSM_CCS_MAX_TOKEN_PER_EVENT];
  boolean is_token_updated;
}rflm_gsm_event_token_info;

typedef struct
{
  rflm_gsm_event_token_info rx_start_tokens;
  rflm_gsm_event_token_info rx_stop_tokens;  
  rflm_gsm_event_token_info tx_start_tokens;
  rflm_gsm_event_token_info tx_stop_tokens;  
  rflm_gsm_event_token_info tx_cal_tokens;
  rflm_gsm_event_token_info therm_tokens;
  rflm_gsm_event_token_info tx_trans_tokens;
  rflm_gsm_event_token_info jdet_disable_tokens;
  rflm_gsm_event_token_info fsk_tx_start_tokens;
  rflm_gsm_event_token_info fsk_tx_stop_tokens;
  rflm_gsm_event_token_info fsk_tx_trans_tokens;
  rflm_gsm_event_token_info fsk_tx_afc_pos_tokens;
  rflm_gsm_event_token_info fsk_tx_afc_neg_tokens;
}rflm_gsm_ccs_events_token_types_s;
...
typedef struct
{
 ...
 /* RF Device this subscription is operating on */
  ...
  int16 rx_tune_fixup_rel_qs;  //Relative to slot start
  int16 rx_disable_fixup_rel_qs;         //Relative to slot end
  int16 tx_tune_fixup_rel_qs;    //Relative to slot start
  int16 tx_agc_fixup_rel_qs;     //Relative to slot start
  int16 tx_disable_fixup_rel_qs; //Relative to slot end
  ...
  int16 freq_error;
  boolean is_tx_tune;
  rflm_gsm_ccs_events_token_types_s ccs_event_tokens;
  rf_gain_range_T rf_gain_state_in_cal;
  boolean hmsc_active;
}rflm_gsm_vars_type;
...
typedef struct
{
  ...
  rflm_gsm_ustmr_sync_data	rfgsm_ustmr_sync_event;
  rflm_jdet_disable_trigger_data rfgsm_jdet_disable_trigger_event;
  boolean jdet_disable;
}rflm_gsm_data_type;
...
typedef struct
{
  ...
  rflm_gsm_init_data             rfgsm_fsk_init_event;
  rflm_gsm_tx_band_data          rfgsm_fsk_tx_band_event;
  rflm_gsm_therm_read_data       rfgsm_fsk_therm_read_event;
  rflm_gsm_tx_data               rfgsm_fsk_tx_event;
  rflm_gsm_fsk_tx_afc_data       rfgsm_fsk_afc_pos_event;
  rflm_gsm_fsk_tx_afc_data       rfgsm_fsk_afc_neg_event;  
  rflm_gsm_txfe_dynamic_type     rfgsm_txfe_data;
  rflm_gsm_vars_type             rflm_gsm_vars;
  rflm_gsm_profile_data          rflm_gsm_profile_data;
  rflm_gsm_ustmr_sync_data	rfgsm_ustmr_sync_event;
...
rflm_fsk_data_type* rflm_fsk_dm_get_table_ptr( );

/*----------------------------------------------------------------------------*/

rflm_gsm_dm_err_type rflm_fsk_dm_allocate_tech_buf(void);

/*----------------------------------------------------------------------------*/

rflm_gsm_dm_err_type rflm_fsk_dm_deallocate_tech_buf(void);
