...
$Header: //components/rel/rflm.mpss/1.10/api/dtr/txlm_intf.h#1 $ 
...
#define TXDAC_NUMBER_OF_FOUNDRIES 2
...
typedef struct {
    ...
    uint32 txdac_iref_cfg1_mask;
    uint32 txdac_iref_cfg1_shft;
...
/*----------------------------------------------------------------------------*/
typedef struct {
    uint32 txdac_cfg1_mask;
    uint32 txdac_cfg1_shft_val;
