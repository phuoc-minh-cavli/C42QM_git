...
/*==============================================================================
  ...
  Copyright (c) 2013-2019 Qualcomm Technologies, Inc. (QTI). All Rights Reserved
...
$Header: //components/rel/rflm.mpss/1.10/api/fw/rflm_api_cmn.h#1 $
...
#define ENABLE_NOTCH 0x1
#define DISABLE_NOTCH 0x0
#define NOTCH_DEPTH_LOW_MASK 0x3FFFF
/*==============================================================================
...
typedef enum
{
  ...
  RFLM_TECH_GSM,
  RFLM_MAX_TECH, 
  RFLM_TECH_SWPORT = RFLM_MAX_TECH,
  RFLM_TECH_TUNER,
  RFLM_TECH_ASD,
  RFLM_TECH_AUTOPIN,
  RFLM_TECH_COMMON,
...
rflm_err_t  rflm_dtr_rx_adc_calib_mode_gnss(void);
rflm_err_t  rflm_dtr_rx_adc_config_gnss(void);
rflm_err_t  rflm_dtr_rx_adc_activate_gnss(void);    
rflm_err_t  rflm_dtr_rx_adc_deactivate_gnss(void);
rflm_err_t  rflm_dtr_rx_adc_hi_z_gnss(void);
void rflm_dtr_rx_adc_mission_reg_set_gnss(void);
void rfcommon_msm_dac_mission_mode_reenter( rflm_handle_tx_t handle );
