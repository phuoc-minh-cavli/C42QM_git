...
$Header: //components/rel/rflm.mpss/1.10/api/fw/rflm_api_dtr_tx_fw.h#1 $
...
*/
/*============================================================================*/
extern void rflm_dtr_tx_txdac_reactivate_mission(txlm_chain_type chain, boolean blocking);

/*==============================================================================

FUNCTION:  rflm_dtr_tx_txdac_power_down_mission
...
*/
/*============================================================================*/
extern void rflm_dtr_tx_txdac_power_down_mission(txlm_chain_type chain);
...
FUNCTION:  rflm_dtr_tx_update_sample_count_ctl

==============================================================================*/
/*!
  @brief
  update_sample_count_ctl
...
*/
/*============================================================================*/
void rflm_dtr_tx_update_sample_count_ctl(uint32 sample_count);
