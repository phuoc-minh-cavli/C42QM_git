...
Copyright (c) 2013-2018  by Qualcomm Technologies, Inc. (QTI).  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/rflm.mpss/1.10/api/txagc/rflm_txagc_api.h#1 $

when       who    what, where, why
--------   ---    ------------------------------------------------------------- 
12/27/18   sk      LTE TxAGC MEM optimization
...
#define RFLM_TXAGC_MAX_TASK_NUM                                             12
#define RFLM_TXAGC_MAX_TASKS_PER_TYPE                                        3
...
#define RFLM_TXAGC_PA_TRIG_DATA_SIZE                                         2
#define RFLM_TXAGC_WTR_NON_TRIGGER_DATA_SIZE                                 6
#define RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE                                    2
#define RFLM_TXAGC_TRIGGER_GROUP_SIZE                                        1
#define RFLM_TXAGC_GROUP_DATA_SIZE                                           36
#define RFLM_TXAGC_GROUP_TOKEN_SIZE                                          2
#define RFLM_TXAGC_WXE_BUF_SIZE                                              2
#define RFLM_TXAGC_QPOET_NON_TRIGGER_DATA_SIZE                               4
#define RFLM_TXAGC_NUM_TXAGC_EVENT_SEQ                                       2
#define RFLM_TXAGC_FBRX_NUM_GAIN_STATES                                      4
#define RFLM_TXAGC_SCRIPT_DATA_BUF_SIZE_WORDS     (RFLM_TXAGC_MAX_TRANS_NUM*4) 
#define RFLM_TXAGC_PA_NON_TRIG_DUMMY_DELTA                                 -50
#define RFLM_TXAGC_PA_TRIG_DUMMY_DELTA                                     -20

/*----------------------------------------------------------------------------
Token information for RFFE group
------------------------------------------------------------------------------*/  
typedef struct
{
...
{
  RFLM_TXAGC_MEM_0,
#ifndef FEATURE_RF_HAS_MEMORY_OPT
#ifndef FEATURE_RF_LTE_ONLY_BUILD
  RFLM_TXAGC_MEM_1,
  RFLM_TXAGC_MEM_2,
#endif
#endif
...
typedef enum
{
  ...
  /*! @brief  RFFE group type */
  RFLM_TXAGC_RFFE_GROUP,  
...
typedef struct
{
  ...
  */
  uint8 task_idx[RFLM_TXAGC_MAX_TASK][RFLM_TXAGC_MAX_TASKS_PER_TYPE];
...
typedef struct ALIGN(32)
{
  ...
  struct rflm_txagc_wtr_data_s{
    uint8 wtr_non_trigger_data[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_DATA_SIZE];
    uint8 wtr_trigger_data[RFLM_TXAGC_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_DATA_SIZE];
  } wtr_wxe_write_data[RFLM_TXAGC_WXE_BUF_SIZE];

  struct rflm_txagc_wtr_rgi0_data_s{
    uint8 wtr_rgi0_data[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_DATA_SIZE];
  } wtr_rgi0_write_data;  
...
typedef struct
{
  ...
  struct pa_addr_s{
    ...
    uint16 pa_trigger_addr[RFLM_TXAGC_PA_TRIG_DATA_SIZE];
    int16  pa_trig_start_delta[RFLM_TXAGC_PA_TRIG_DATA_SIZE];
  ...
  struct pa_addr_num_bytes_s{
    ...
    int8 pa_trigger_num_bytes[RFLM_TXAGC_PA_TRIG_DATA_SIZE];
  ...
  /*! @brief wtr address */
  struct wtr_addr_s{
    uint16 wtr_non_trigger_addr[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    uint16 wtr_trigger_addr[RFLM_TXAGC_TRIGGER_GROUP_SIZE];
    rflm_txagc_group_token_type wtr_non_trigger_token[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_TOKEN_SIZE];
    rflm_txagc_group_token_type wtr_trigger_token[RFLM_TXAGC_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_TOKEN_SIZE];
    uint8 wtr_non_trig_num_groups;
    uint8 wtr_trig_num_groups;    
    uint16 wtr_dummy_addr;
  }wtr_addr[RFLM_TXAGC_WXE_BUF_SIZE];

  struct wtr_addr_num_bytes_s{
    int8 wtr_non_trigger_num_bytes[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    int8 wtr_trigger_num_bytes[RFLM_TXAGC_TRIGGER_GROUP_SIZE];
    int8 wtr_non_trigger_num_tokens[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    int8 wtr_trigger_num_tokens[RFLM_TXAGC_TRIGGER_GROUP_SIZE];    
    int8 wtr_dummy_num_bytes;
  }wtr_num_bytes[RFLM_TXAGC_WXE_BUF_SIZE];

  /*! @brief wxe address */
  struct wxe_addr_s{
    uint16 wxe_non_trigger_addr[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    rflm_txagc_group_token_type wxe_non_trigger_token[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_TOKEN_SIZE];
    uint8 wxe_non_trig_num_groups;
    uint16 wxe_dummy_addr;
  }wxe_addr[RFLM_TXAGC_WXE_BUF_SIZE];

  struct wxe_addr_num_bytes_s{
    int8 wxe_non_trigger_num_bytes[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    int8 wxe_non_trigger_num_tokens[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];    
    int8 wxe_dummy_num_bytes;
  }wxe_num_bytes[RFLM_TXAGC_WXE_BUF_SIZE];

  struct wtr_rgi0_addr_s{
    uint16 wtr_rgi0_addr[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    rflm_txagc_group_token_type wtr_rgi0_token[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE][RFLM_TXAGC_GROUP_TOKEN_SIZE];
    uint8 wtr_rgi0_num_groups;
    uint16 wtr_rgi0_dummy_addr;
  }wtr_rgi0_addr;

  struct wtr_rgi0_num_bytes_s{
    int8 wtr_rgi0_num_bytes[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];
    int8 wtr_rgi0_num_tokens[RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE];    
    int8 wtr_rgi0_dummy_num_bytes;
  }wtr_rgi0_num_bytes; 
