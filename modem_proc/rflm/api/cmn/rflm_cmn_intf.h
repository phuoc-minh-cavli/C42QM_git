...
$Header: //components/rel/rflm.mpss/1.10/api/cmn/rflm_cmn_intf.h#1 $
...
#if defined(FEATURE_RF_ASDIV) || defined(FEATURE_RF_HAS_QTUNER)
...
#define RFLM_CMN_TUNER_SCRIPT_DATA_BUF_SIZE_WORDS                             80
