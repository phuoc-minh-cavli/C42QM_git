...
/*===========================================================================
    ...
    $Header: //components/rel/rflm.mpss/1.10/api/rxagc/rflm_rxagc_api.h#1 $

when       who    what, where, why
--------   ---    -------------------------------------------------------------
04/18/19   ak     Pre ADC DC changes
...
#define RFLM_CMN_RXAGC_LNA_SCRIPT_NUM_OF_RFFE                                   40
...
#define RFLM_CMN_RXAGC_LNA_SCRIPT_DATA_BUF_SIZE_BYTE      (RFLM_CMN_RXAGC_LNA_SCRIPT_NUM_OF_SSBI *4 + \
                                                           RFLM_CMN_RXAGC_LNA_SCRIPT_NUM_OF_RFFE *4)
...
typedef enum
{
  ...
  RFLM_RXAGC_LNA_STATE5,            
  RFLM_RXAGC_LNA_STATE6,            
  RFLM_RXAGC_LNA_STATE7,            
  RFLM_RXAGC_LNA_STATE8,///< lowest gain             
...
typedef enum
{
  ...
  /*!< Gain step from Gain state 5 to 6 */
  RFLM_RXAGC_LNA_GAIN_STEP_5_TO_6,
  /*!< Gain step from Gain state 6 to 7 */
  RFLM_RXAGC_LNA_GAIN_STEP_6_TO_7,
 /*!< Gain step from Gain state 7 to 8 */
  RFLM_RXAGC_LNA_GAIN_STEP_7_TO_8,
...
typedef struct
{
  ...
  int rise_threshold_fast_agc; 
  /* lna fall threshold for fast agc mode */

  int fall_threshold_fast_agc; 
  /*! Wideband index for which the RxAGC is to be configured */
  ...
  /*! LNA DC offset per LNA gain state */
  int32 lna_dc_offset_i[RFLM_CMN_RXAGC_MAX_LNA_STATES];  

  int32 lna_dc_offset_q[RFLM_CMN_RXAGC_MAX_LNA_STATES];    
