...
$Header: //components/rel/rflm.mpss/1.10/api/ccs/rflm_ccs_intf.h#1 $
$Date: 2020/04/16 $
when         who     what, where, why
--------   ---     -----------------------------------------------------------

05/28/18   mns     CCS MMU Changes.
...
{
  /*! IRAT */
  RFLM_CCS_DATA_BUF_ITEM_IRAT = 0,
  /* ISS SEQ UPDATE */
  RFLM_CCS_DATA_BUF_ITEM_SEQ_UPDATE,
