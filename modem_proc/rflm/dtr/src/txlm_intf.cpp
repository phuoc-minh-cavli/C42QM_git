...
$Header: //components/rel/rflm.mpss/1.10/dtr/src/txlm_intf.cpp#1 $
...
lm_status_type txlm_retrieve_dac_therm_info(dac_therm_info_t* dac_therm_info)
{
  ...
  RFLM_DIAG_TRACE_ERROR(RFLM_DIAG_MSG_SSID_NONE,"txlm_retrieve_dac_therm_info : No support added yet contact DTR team");

  txlm_status = LM_INVALID_PARAMETER;
