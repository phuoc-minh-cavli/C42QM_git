...
$Header: //components/rel/rflm.mpss/1.10/services/warning/inc/rflm_warning_enum.h#1 $
$Date: 2020/04/16 $ 
...
#define RFLM_CONFIG_WARNING_TABLE( entry ) \
  ...
  entry( RFLM_WARNING_CCS_MMU_ALLOC_ERROR_OUT_OF_MEM,                           TRACE_EN|ASSERT_EN|MSG_EN   ) \
  entry( RFLM_WARNING_CCS_MMU_TASK_SCHED_TOO_EARLY,                             TRACE_EN|ASSERT_DIS|MSG_DIS   ) \
  entry( RFLM_WARNING_CCS_MMU_TASK_SCHED_IN_PAST,                               TRACE_EN|ASSERT_DIS|MSG_DIS   ) \
  entry( RFLM_WARNING_CCS_MMU_OUT_EARLY_ENQ_BUFFER,                             TRACE_EN|ASSERT_EN|MSG_DIS   ) \
