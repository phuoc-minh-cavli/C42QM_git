...
$Header: //components/rel/rflm.mpss/1.10/services/diag/inc/rflm_thread.h#1 $
...
#define RFLM_DEFAULT_STACK_SZ_REDUCED     2048


/*!< CFW Threads */
#ifdef FEATURE_RF_HAS_MEMORY_OPT
#ifdef FEATURE_RF_LTE_ONLY_BUILD
#define RFLM_LOG_THREAD_STACK_SZ        RFLM_DEFAULT_STACK_SZ_REDUCED
#define RFLM_CCS_THREAD_STACK_SZ        RFLM_DEFAULT_STACK_SZ_REDUCED
#else
