...
$Header: //components/rel/rflm.mpss/1.10/services/includes/inc/rflm_target.h#1 $
...
#define RFLM_SECTION_TCM_CODE_CCS    SECTION_CODE(".tcm_static_code")
#define RFLM_SECTION_TCM_DATA_CCS    SECTION_CODE(".tcm_static_data")
