...
$Header: //components/rel/rftech_lte.mpss/2.10/api/rfc_lte.h#1 $
...
static void *lte_rf_devices[RFM_MAX_WAN_DEVICES][RFC_CONFIG_RXTX_MAX][RFCOM_NUM_LTE_BANDS][RFDEVICE_TYPE_MAX_NUM][RFC_MAX_DEVICE_INSTANCES_PER_BAND];
