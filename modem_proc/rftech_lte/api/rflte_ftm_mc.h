...
$Header: //components/rel/rftech_lte.mpss/2.10/api/rflte_ftm_mc.h#2 $
...
08/29/18   gk      NB-IOT calibration support
...
typedef struct
{
  ...
  uint8 rb_start;
  uint8 ul_nb_region;
  ftm_lte_nb_ul_tone_bw_e nb_tone;
  ...
  /*NB1 FS config chan list command*/
  uint8 fs_num_chan; 
  rfcom_lte_earfcn_type fs_start_chan;
  uint8 fs_step_size;   
...
extern ftm_lte_calibration_generic_rsp_pkt_type ftm_lte_rsp_pkt;
/*===========================================================================
...
boolean rflte_ftm_mc_set_rx_tx_device(uint32 carrier_idx, rfm_device_enum_type tx_device, rfm_device_enum_type prx_device);
...
void rflte_ftm_mc_sm_set_rx_sys_bw(rfcom_lte_bw_type bw);
void rflte_ftm_mc_sm_set_tx_chan(rfcom_lte_earfcn_type channel);
void rflte_ftm_mc_sm_set_tx_bw(rfcom_lte_bw_type bw);
void rflte_ftm_mc_sm_set_tx_sys_bw(rfcom_lte_bw_type bw);
void rflte_ftm_mc_sm_set_tx_nb_region(uint8 ul_nb_region);
void rflte_ftm_mc_sm_set_fs_chan_list(uint8 num_chan, rfcom_lte_earfcn_type start_chan, uint8 step_size);
void rflte_ftm_mc_sm_set_ul_carrier_freq_offset(int8 ul_carrier_freq_offset);
void rflte_nb_ftm_mc_fs_retune(rfcom_lte_earfcn_type fs_channel);
void rflte_nb_ftm_mc_enable_rx(boolean enable_rx);
...
void rflte_ftm_mc_set_lna_imm(uint8 lna_range, uint32 prx_drx_flag);
...
void rflte_ftm_mc_set_nb_ul_tone_bw(ftm_lte_nb_ul_tone_bw_e nb_tone);
void rflte_ftm_mc_sm_set_spacing(uint8 rf_mode);
...
rfcom_lte_bw_type rflte_ftm_mc_sm_get_tx_bw(void);
rfcom_lte_bw_type rflte_ftm_mc_sm_get_tx_sys_bw(void);
uint8 rflte_ftm_mc_sm_get_tx_nb_region(void);
...
boolean rflte_ftm_mc_sm_get_rx_enable(void);
ftm_lte_nb_ul_tone_bw_e rflte_ftm_mc_get_nb_ul_tone_bw(void);
void rflte_ftm_mc_sm_set_rx_enable(boolean);
