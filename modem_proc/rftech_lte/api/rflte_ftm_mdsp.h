...
$Header: //components/rel/rftech_lte.mpss/2.10/api/rflte_ftm_mdsp.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
07/09/18   as      Remove RF-FW msg for FTM to indicate 1Rx mode
01/26/17   qzh     Add NB1 FTM RF support
06/30/16   as      New RF-FW msg for FTM to indicate 1Rx mode
...
void rflte_nb_mdsp_fw_app_enable_req(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_mdsp_fw_app_disable_req(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_mdsp_fw_sys_config_app_req(boolean enable);
/* ----------------------------------------------------------------------- */

void rflte_nb_mdsp_fw_ul_pusch_config_req(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_mdsp_fw_ul_pusch_schedule_data_req(ftm_lte_nb_mod_type_s mod, ftm_lte_nb_ul_tone_bw_e tone_bw, uint8 start_tone_idx, int8 tx_pwr_dbm);
/* ----------------------------------------------------------------------- */

void rflte_nb_mdsp_fw_ul_pusch_deconfig_req(void);
/* ----------------------------------------------------------------------- */

boolean rflte_nb_mdsp_fw_cell_cfg_req(void);
/* ----------------------------------------------------------------------- */

boolean rflte_nb_mdsp_fw_cell_decfg_req(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_app_enable_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_app_disable_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_sys_config_app_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_ul_pusch_config_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_ul_pusch_schedule_data_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_ul_pusch_deconfig_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_cell_cfg_cnf_received(void);
/* ----------------------------------------------------------------------- */

void rflte_nb_ftm_mdsp_fw_cell_decfg_cnf_received(void);
/* ----------------------------------------------------------------------- */
