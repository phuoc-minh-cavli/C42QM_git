...
Copyright (c) 2013-19,21,23 by Qualcomm Technologies, Inc.  All Rights Reserved. 
...
#define RFLTE_UTIL_MIN(val1,val2,val3,val4,val5,val6,val7)   MIN( MIN(val1,val2),MIN(val3,MIN(val4,MIN(val5,MIN(val6,val7)))))

#define RFLTE_NB1_RX_LIF_OFFSET_HZ -156000
...
/*!> For FDD Bands  B71 to B74*/
#define RFLTE_UTIL_FDD_DL_UL_EARFCN_OFFSET_B71_B74   64536

/*!> For FDD Bands  B85 */
#define RFLTE_UTIL_FDD_DL_UL_EARFCN_OFFSET_B85   63636

/*!> For FDD Bands  B86 */
#define RFLTE_UTIL_FDD_DL_UL_EARFCN_OFFSET_B86   65136

#define RFLTE_UTIL_FDD_DL_UL_EARFCN_OFFSET_B85_B88   63636
...
#define LTE_B66_MASK_IDX  51
#define LTE_B71_MASK_IDX  59
#define LTE_B72_MASK_IDX  52
...
#define LTE_B66_MASK  ((uint64)SYS_BM_64BIT(LTE_B66_MASK_IDX))
#define LTE_B71_MASK  ((uint64)SYS_BM_64BIT(LTE_B71_MASK_IDX))
#define LTE_B72_MASK  ((uint64)SYS_BM_64BIT(LTE_B72_MASK_IDX))
...
rflte_util_get_device_nb_tone_from_ul_tone_bw(
  rflte_nb_ul_tone_bw_e nb_tone
);

int32 
rflte_util_convert_ppm_q10_to_hz
(
  uint32 carrier_freq,
  int32 freq_error_ppm_q10
);
