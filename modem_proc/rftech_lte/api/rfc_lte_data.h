...
$Header: //components/rel/rftech_lte.mpss/2.10/api/rfc_lte_data.h#1 $
...
public:
  ...
  virtual boolean iotfe_timing_cfg_data_get( rfc_cfg_params_type *cfg, rfc_timing_info_type **ptr );
...
boolean rfc_lte_data_get_iotfe_timing_info(rfc_cfg_params_type *cfg, rfc_timing_info_type **device_info_pptr);
