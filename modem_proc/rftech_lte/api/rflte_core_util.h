...
$Header: //components/rel/rftech_lte.mpss/2.10/api/rflte_core_util.h#1 $
...
rfcom_lte_band_type rfcommon_core_convert_lte_band_num_to_rfcom_band( uint16 band_num);
