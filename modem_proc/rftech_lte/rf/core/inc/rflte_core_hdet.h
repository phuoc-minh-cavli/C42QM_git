...
/*==============================================================================
  ...
  $Header: //components/rel/rftech_lte.mpss/2.10/rf/core/inc/rflte_core_hdet.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
03/13/19   as      Update HDET threshold for SDR105
05/25/17   as      Update NB1 MTPL and IQ gain only if HDET read is valid
...
#define RFLTE_CORE_TXPL_HPM_HDET_THRESHOLD 70
#define RFLTE_CORE_TXPL_LPM_HDET_THRESHOLD 10
#define RFLTE_CORE_TXPL_HDET_HPM_MIN_THRESHOLD 30
...
boolean rflte_core_txpl_calc_hdet_err(uint32 carrier_idx,
                                   int16 txpl_txagc_val,
                                   uint16 hdet_adc,
                                   uint8 phy_rb_block,
                                   uint8 phy_start_rb,
