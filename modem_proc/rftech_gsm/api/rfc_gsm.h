...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfc_gsm.h#2 $
...
public:
  ...
  virtual void fsk_tx_burst_config(rfm_device_enum_type rfm_dev,
                               rfcom_gsm_band_type rfgsm_band,
                               uint16 arfcn);
  virtual void fsk_tx_gain_config( rfm_device_enum_type rfm_dev, rfcom_gsm_band_type band,
  ...
  virtual int32 fsk_tx_disable(rfm_device_enum_type rfm_dev);  
  virtual int32 fsk_tx_enable(rfm_device_enum_type rfm_dev);
  boolean fsk_tx_burst_device_config(rfm_device_enum_type rfm_dev,
                                 rfdevice_class *dev_obj,
                                 rfcom_gsm_band_type band,
                                 uint16 arfcn,
                                 uint32 txlm_buf_index);
  boolean fsk_tx_disable_device_config(rfdevice_class *dev_obj, rfcom_gsm_band_type rfgsm_band, uint16 arfcn, rfm_device_enum_type rfm_dev);
  boolean fsk_tx_enable_device_config(rfdevice_class *dev_obj, rfm_device_enum_type rfm_dev);
#endif
