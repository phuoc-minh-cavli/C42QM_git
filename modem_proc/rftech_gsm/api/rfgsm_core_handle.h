...
*/
/*=============================================================================
Copyright (c) 2008-2023 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfgsm_core_handle.h#3 $
...
03/14/18   bm      Fix compilation errors with SDR105 integration
...
typedef struct
{
  ...
  uint16 rf_rx_arfcn;
  uint64 rf_fsk_tx_fc;
  uint32 rf_fsk_tx_fc_residual_freq_in_hz;
  int16 rf_fsk_offset_hz;
  ...
  /*Store RGI in core_handle and build all transition scripts with one rfdevice call*/
  uint16 rgi_slot[RFGSM_MAX_TX_SLOTS_PER_FRAME];
  ...
  int32 rfgsm_pmeas_g0[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g1[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g2[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g3[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g4[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g5[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g6[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_pmeas_g7[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g0[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g1[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g2[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g3[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g4[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g5[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g6[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  int32 rfgsm_edge_pmeas_g7[RFNV_LINEAR_MAX_RGI_INDEX_PER_GAIN_STATE_V2];
  ...
  **/
  ...
  rfdevice_gsm_tx_timing_info_type tx_timing_info;

  rfdevice_gsm_rx_timing_info_type rx_timing_info;
