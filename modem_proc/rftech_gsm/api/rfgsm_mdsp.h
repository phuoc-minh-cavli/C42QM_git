...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfgsm_mdsp.h#3 $
...
typedef struct
{
  rfcommon_mdsp_event_handle * entermode_event;
  rfcommon_mdsp_event_handle * ustmrsync_event;
  rfcommon_mdsp_event_handle * tx_band_event;
  rfcommon_mdsp_event_handle * wakeup_event;
  rfcommon_mdsp_event_handle * exitmode_event;
  rfcommon_mdsp_event_handle * jdetread_event;
  rfcommon_mdsp_event_handle * therm_read_event;
  ...
  rfcommon_mdsp_event_handle * jdet_disable_trigger_event;

  rfcommon_mdsp_event_handle * fsk_enter_mode_event;
  rfcommon_mdsp_event_handle * fsk_tx_enable_event;
  rfcommon_mdsp_event_handle * fsk_tx_band_event;
  rfcommon_mdsp_event_handle * fsk_tx_event[GSM_CCS_NUM_CCS_HANDLES_EVENTS];
  rfcommon_mdsp_event_handle * fsk_tx_afc_pos_event;
  rfcommon_mdsp_event_handle * fsk_tx_afc_neg_event;
  rfcommon_mdsp_event_handle * fsk_tx_sleep_event;
  rfcommon_mdsp_event_handle * fsk_tx_disable_event;
  rfcommon_mdsp_event_handle * fsk_tx_exit_event;
  rfcommon_mdsp_event_handle * fsk_therm_event;
...
boolean rfgsm_mdsp_get_therm_data(rfgsm_core_handle_type *rfgsm_core_handle_ptr, uint8 tag, uint32* therm_data);
...
boolean rfgsm_mdsp_populate_fsk_enter_mode_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );
...
boolean rfgsm_mdsp_populate_fsk_tx_band_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );
...
boolean rfgsm_mdsp_populate_fsk_tx_start_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );

boolean rfgsm_mdsp_populate_tx_trans_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx, uint8 slot_num );
boolean rfgsm_mdsp_populate_fsk_tx_afc_pos_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx, uint8 slot_num );
boolean rfgsm_mdsp_populate_fsk_tx_afc_neg_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx, uint8 slot_num );

boolean rfgsm_mdsp_populate_tx_stop_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );

boolean rfgsm_mdsp_populate_fsk_tx_stop_index( void *shared_mem_ptr, uint32 rflm_gsm_dm_intf_data_idx );


boolean rfgsm_mdsp_create_buffer( void** event_handle,
...
void rfgsm_mdsp_create_ccs_event_handles( rfm_device_enum_type rfm_dev);
void rfgsm_mdsp_free_ccs_event_handles( rfm_device_enum_type rfm_dev );
