...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfgsm_data_manager.h#3 $
...
05/18/15   par     Extended scope of few functions
...
extern boolean rfgsm_core_dm_populate_enter_mode_intf_data( rfgsm_core_data_type *core_data, 
                                                     void *shared_mem_ptr );

extern boolean rfgsm_core_dm_populate_wakeup_intf_data( rfgsm_core_data_type *core_data, 
                                                 void *shared_mem_ptr );

extern boolean rfgsm_core_dm_populate_tx_band_intf_data( rfgsm_core_data_type *core_data, 
                                                  void *shared_mem_ptr );

extern boolean rfgsm_core_dm_populate_therm_read_intf_data( rfgsm_core_data_type *core_data, 
                                                     void *shared_mem_ptr );

extern boolean rfgsm_core_dm_populate_rx_burst_intf_data( rfgsm_core_data_type *core_data, 
                                                   void *shared_mem_ptr );

extern boolean rfgsm_core_dm_populate_tx_burst_intf_data( rfgsm_core_data_type *core_data, 
                                                   void *shared_mem_ptr, 
                                                   uint8 num_tx_slots );

/*---------------------------------------------------------------------------*/

extern boolean rfgsm_core_dm_set_rx_gain(rfgsm_core_data_type * core_data,
...
uint8 rfgsm_core_dm_create_event( void** event_handle,
...
void rf_gsm_dm_rf_event_token_update(uint8 script_loop,
                                    rf_buffer_intf* script, 
                                    rflm_gsm_event_token_info *event_token_info,
...
extern boolean rfgsm_core_dm_dynamic_enter_event_wrapper( rfgsm_core_data_type *core_data );
extern boolean rfgsm_core_dm_dynamic_wakeup_event_wrapper( rfgsm_core_data_type *core_data );
extern boolean rfgsm_core_dm_dynamic_tx_band_event_wrapper( rfgsm_core_data_type *core_data );
extern boolean rfgsm_core_dm_dynamic_rx_event_wrapper( rfgsm_core_data_type *core_data,
                                                rfgsm_rx_burst_type rx_burst_type,
                                                uint8 rx_burst_num );
extern boolean rfgsm_core_dm_dynamic_tx_event_wrapper( rfgsm_core_data_type *core_data,
                                                uint8 num_tx_slots );
extern boolean rfgsm_core_dm_dynamic_therm_event_wrapper( rfgsm_core_data_type *core_data );
extern boolean rfgsm_core_dm_dynamic_jdet_disable_trigger_event_wrapper( rfgsm_core_data_type *core_data );
extern boolean rfgsm_core_dm_dynamic_ustmr_sync_event_wrapper( rfgsm_core_data_type *core_data );
