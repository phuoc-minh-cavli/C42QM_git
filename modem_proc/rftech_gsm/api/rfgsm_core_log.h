...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfgsm_core_log.h#2 $
...
typedef enum
{
  ...
  RFA_RF_GSM_FSK_ENTER_MODE_REQUEST_START,
  RFA_RF_GSM_FSK_ENTER_MODE_REQUEST_STOP,
  RFA_RF_GSM_FSK_TX_ENABLE_REQUEST_START,
  RFA_RF_GSM_FSK_TX_ENABLE_REQUEST_STOP,
  RFA_RF_GSM_FSK_TX_BAND_REQUEST_START,
  RFA_RF_GSM_FSK_TX_BAND_REQUEST_STOP,
  RFA_RF_GSM_FSK_TX_START_REQUEST_START,
  RFA_RF_GSM_FSK_TX_START_REQUEST_STOP,
  RFA_RF_GSM_FSK_TX_STOP_REQUEST_START,
  RFA_RF_GSM_FSK_TX_STOP_REQUEST_STOP,
  RFA_RF_GSM_FSK_TX_DISABLE_REQUEST_START,
  RFA_RF_GSM_FSK_TX_DISABLE_REQUEST_STOP,
  RFA_RF_GSM_FSK_EXIT_MODE_REQUEST_START,
  RFA_RF_GSM_FSK_EXIT_MODE_REQUEST_STOP,
