...
*/
/*=============================================================================
Copyright (c) 2008-2021 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/rftech_gsm.mpss/2.10/api/rfgsm_core.h#4 $
$DateTime: 2021/04/02 04:25:14 $
$Author: mplcsds1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/15/21   aad     To Fix FSK frequency truncation issue
...
typedef enum
{
  Negative_spur_channel,
  Positive_spur_channel,
  non_spur
}Spur_channel_type;
...
/*----------------------------------------------------------------------------*/
boolean rfgsm_core_dm_alloc_fsk_data_manager_mem(void);

/*----------------------------------------------------------------------------*/
boolean rfgsm_core_dm_alloc_fsk_data_manager_mem(void);

/*----------------------------------------------------------------------------*/
boolean rfgsm_core_dm_populate_fsk_tx_burst_intf_data( rfgsm_core_data_type *core_data, void *shared_mem_ptr, uint8 num_tx_slots );
...
/*----------------------------------------------------------------------------*/
void rfgsm_core_fsk_tx_band( rfgsm_core_data_type *core_data, rfcom_gsm_band_type band, void *shared_mem_ptr );
...
boolean rfgsm_core_calc_rx_timing(rfm_device_enum_type rfm_dev);
