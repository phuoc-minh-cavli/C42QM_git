...
/*===========================================================================
  ...
  $Header: //components/rel/rftech_gsm.mpss/2.10/api/ftm_gsm_rfprot.h#1 $ 
...
extern void  ftm_gsm_do_rx_wbdc_calibration_prx( rfm_device_enum_type rfm_dev,
...
DESCRIPTION
   This function will convert wbdc raw value to mv
