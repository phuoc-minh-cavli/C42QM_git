...
$Header: //components/rel/rftech_gsm.mpss/2.10/ftm/src/rfgsm_ftm_cmd_proc.c#1 $ 
...
rfgsm_ftm_dispatch_outcome_t rfgsm_ftm_set_linear_rgi( rfa_rf_gsm_ftm_set_linear_rgi_type_cmd_s* rfgsm_ftm_msg_ptr )
{
  ...
  rfgsm_core_handle_ptr->ftm_slot_override[rfgsm_ftm_msg_ptr->linear_rgi_params.slot_num].modulation = rfgsm_ftm_msg_ptr->linear_rgi_params.mod_type_is_gsm;
