...
$Header: //components/rel/rfa.mpss/3.10/rfc/common/src/rfc_lte_transceiver_hdet_adapter.cpp#1 $
...
boolean rfc_lte_transceiver_hdet_adapter::process_read_script
(
...
{
  RF_MSG(MSG_LEGACY_MED, "rfc_lte_transceiver_hdet_adapter::process_read_script done");
  return TRUE;
}
