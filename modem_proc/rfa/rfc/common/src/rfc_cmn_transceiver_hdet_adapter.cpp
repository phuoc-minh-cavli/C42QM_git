...
/*==============================================================================
  ...
  Copyright (c) 2012,2013,2016 Qualcomm Technologies Incorporated. All Rights Reserved
...
$Header: //components/rel/rfa.mpss/3.10/rfc/common/src/rfc_cmn_transceiver_hdet_adapter.cpp#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
03/05/19   sk      RF PAGE ONLY changes for NB/CATM
02/03/16   ndb     Fix the compiler error for LTE only builds
01/04/16   ndb     Featurize the WCDMA code
