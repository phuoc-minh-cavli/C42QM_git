...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rfc/common/inc/rfc_cmn_transceiver_hdet_adapter.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
01/04/16   ndb     Featurize the WCDMA code(missed part)
01/01/16   ndb     Featurize the WCDMA code
