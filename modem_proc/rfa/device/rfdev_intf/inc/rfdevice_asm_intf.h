...
$Header: //components/rel/rfa.mpss/3.10/device/rfdev_intf/inc/rfdevice_asm_intf.h#1 $

when       who   what, where, why
--------   ---   ---------------------------------------------------------------
05/06/19   dh    Added an interface API for ASM init() 
...
extern "C" {
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_asm_is_internal_asm
  (
    void *device_ptr
  );
