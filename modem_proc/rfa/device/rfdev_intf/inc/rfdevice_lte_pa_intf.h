...
07/16/18   dh    Added lte_cat_type as a formal param to the APIS
07/13/18   dh    Reverted the changes temporarily due to dependencies
07/13/18   dh    Added lte_cat_type as a param
...
extern "C" {
    ...
    boolean rfdevice_lte_pa_is_internal_pa
    (
        rfm_device_enum_type device,
        rfcom_lte_band_type rf_band
    ) ;    
    ...
    boolean rfdevice_lte_pa_set_gain_trigger
    (
        rfm_device_enum_type rfm_device,
        rfcom_lte_band_type rf_band,
        uint16 pa_gain_range,
