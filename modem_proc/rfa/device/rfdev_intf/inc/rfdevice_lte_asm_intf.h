...
Copyright (c) 2012 - 19 by Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/rfa.mpss/3.10/device/rfdev_intf/inc/rfdevice_lte_asm_intf.h#1 $

when         who   what, where, why
--------   ---   ------------------------------------------------------------------- 
05/06/19   dh    Added an API to check for internal ASM device
...
extern "C" {
  ...
  /*----------------------------------------------------------------------------*/
  boolean rfdevice_lte_asm_is_internal_asm
  (
      rfm_device_enum_type rfm_device,
      rfcom_lte_band_type rf_band
  );
