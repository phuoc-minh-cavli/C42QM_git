...
/*===========================================================================
  ...
  Copyright (c) 2009, 2011 - 2019 Qualcomm Technologies Incorporated. All Rights Reserved
...
$Header: //components/rel/rfa.mpss/3.10/rf/task/rex_msgr/inc/rf_cap.h#1 $
...
#endif
#else
#undef FEATURE_RF_MEAS
#undef FEATURE_RF_HAS_FTM
#endif
