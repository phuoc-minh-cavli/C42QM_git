...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/task/common/src/rflte_core_task.c#1 $
...
void rf_core_task_handle_sigs_nv( rex_sigs_type mask )
{
  rex_sigs_type sigs = 0;
  ...
  for (;;)
  {
    ...
    /* There is implicit priority given to signals.
