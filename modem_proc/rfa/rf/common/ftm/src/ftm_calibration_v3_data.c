...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_calibration_v3_data.c#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
04/25/17   pv      rflte_nv_tbl_type-removing pa_state_nv_c1 as UL CA not supported
10/20/16   rs      KW warning fix
...
)
{
  ...
  if( return_val == TRUE )
  {
    ...
    if ( ( cal_result_ext != NULL ) &&
	     (data_param->data_param.data_action & DATA_OPCODE_MASK_PROCESS_PIN_VAL_EXT) == DATA_OPCODE_MASK_PROCESS_PIN_VAL_EXT ) /* Extended PIN CAL */
    {
      /*==========================================================================*/
