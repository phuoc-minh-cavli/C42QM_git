...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_calibration_v3_radio.c#1 $
...
)
{
  ...
  for ( chan_idx = 0; chan_idx < p_ptr->num_of_channel; chan_idx++ )
  {
	...
	if (rs_unpack->chan_list[chan_idx].tx_bw == RFCOM_BW_LTE_200KHz)
		rs_unpack->chan_list[chan_idx].tx_bw = RFCOM_BW_LTE_10MHz;
