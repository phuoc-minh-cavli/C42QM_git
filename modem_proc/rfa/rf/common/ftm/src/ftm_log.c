...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_log.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
06/12/18   sk      1x/WCDMA/TDSCDMA removal changes
01/05/17   pvsr    Fix for Memory overhead in defeturising ftm_log_config_table 
...
ftm_log_config_table_entry        ftm_log_config_table[] =
{
  ...
  { FTM_LOG_FBRX_RESULTS,        { NULL,    NULL,              TRUE,       0 },   NULL,                   NULL                   }
};
