...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_enh_internal_device_calibration_droop.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
05/09/17   qzh    Fix KW
12/21/16   qzh    Add NB1 support for ul carrier offset
12/08/16    dh    Featurize Qtuner code
11/17/16   rs      Fix KW warnings
