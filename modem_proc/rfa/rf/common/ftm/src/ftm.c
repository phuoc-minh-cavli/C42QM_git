...
/*==============================================================================
  ...
  Copyright (c) 2002 - 2018 Qualcomm Technologies Incorporated. All Rights Reserved
...
07/24/18   gk      B66 CatM1/CatNB1 enablement
                                  ...
                                  prot_trans_type trans_id )
{
  ...
  if(ftm_common_data != NULL)
  {
    ftm_free((void *)ftm_common_data);
    ftm_common_data = NULL;
  }
