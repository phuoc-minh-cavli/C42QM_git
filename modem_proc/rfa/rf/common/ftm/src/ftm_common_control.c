...
04/02/19   tik     APT Pout Char fixes for B72/B73/B85
03/08/19   gk      BB72/B73 CatM1/NB1 enablement 
03/08/19   gk      B85 CatM1/NB1 enablement 
02/28/19   as      HAL BUS disable as part of FTM LTE Exit
01/28/19   tik     Dynamic module loading changes for EXTPL builds
01/11/19   tik     LTE B71 APT Pout Char fixes
12/17/18   gk      CW Fixes
12/12/18   gk      CW Fixes
09/18/18   as      Skip sending FTM Mode change request to ML1
07/30/18   gk      B71 CatM1/NB1 enablement 
12/07/18   gk      NB-IoT Calibration support changes
...
12/20/16   dh      Fix CW errors
11/01/16   dh      Featurize Qtuner code
...
extern rf_dispatch_outcome_t rflte_nb_dispatch_exit_mode_req(           rfa_rf_lte_nb_exit_mode_req_s* rf_lte_msg_ptr, boolean send_resp_flag);
#endif

#undef FEATURE_RF_ASDIV

extern rf_hal_bus_result_type rfhal_rffe_write_bytes_ext(rf_hal_bus_rffe_type* script_ptr, uint8 channel, uint32 count, rf_hal_bus_resource_script_settings_type* settings);
...
extern rf_hal_bus_client_handle* rf_lte_hal_bus_client_handle;
...
rf_tech_band_info tech_band_lookup[FTM_PHONE_MODE_MAX] = 
{
    ...
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding :98*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    ...
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/ 
    {FTM_RF_TECH_LTE, RFCOM_BAND_LTE_B72},    /*FTM_PHONE_MODE_LTE_B72=123, LTE, B72*/
    {FTM_RF_TECH_LTE, RFCOM_BAND_LTE_B73},    /*FTM_PHONE_MODE_LTE_B73=124, LTE, B73*/
    {FTM_RF_TECH_LTE, RFCOM_BAND_LTE_B85},    /*FTM_PHONE_MODE_LTE_B85=125, LTE, B85*/
    {FTM_RF_TECH_LTE, RFCOM_BAND_LTE_B86}, /*FTM_PHONE_MODE_NR5G_SUB6_N1 = 126*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N2 = 127*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N3 = 128*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N5 = 129*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N7 = 130*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N8 = 131*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N20 = 132*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N28 = 133*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N38 = 134*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N41 = 135*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N50 = 136*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N51 = 137*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N66 = 138*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N70 = 139*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N71 = 140*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N74 = 141*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N75*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N76*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N77*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N78*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N79*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N80*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N81*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N82*/ 
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N83*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N84 = 151*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N257 = 152*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N258 = 151*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N260 = 151*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N261 = 155*/
    {FTM_RF_TECH_LTE,RFCOM_BAND_LTE_B86},/*156*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N14 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N26 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N261 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N18 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N30 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N13 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N29 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N53 = 155*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_LTE_B53 = 165*/
 #ifdef FEATURE_CUST_2
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_LTE_B53 = 166*/
 #endif 
    {FTM_RF_TECH_LTE,RFCOM_BAND_LTE_B87},/*167*/
    {FTM_RF_TECH_LTE,RFCOM_BAND_LTE_B88},/*168*/
  
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_LTE_B70 = 169*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N26*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_MMW_N261*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N18 */
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N30 */
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N13 */
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N29 */
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N53 */
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*FTM_PHONE_MODE_NR5G_SUB6_N96 = 177*/
    {FTM_RF_TECH_LTE,RFCOM_BAND_LTE_B8_B},/*178*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/
    {FTM_RF_TECH_UNKNOWN, RFM_CDMA_MAX_BAND}, /*Padding*/
    {FTM_RF_TECH_LTE, RFCOM_BAND_LTE_B256},   /*FTM_PHONE_MODE_LTE_B256=181, LTE, B256*/
};
...
{
  /* Allocate common static structure */
  if(!ftm_common_data)
  {
    ftm_common_data = (ftm_common_data_type *)ftm_malloc(sizeof(ftm_common_data_type));
    if(NULL == ftm_common_data)
    {
      MSG_ERROR("Unable to allocate %d bytes of memory for FTM common data",
				sizeof(ftm_common_data_type), 0, 0);
      return; 
    }
    memset( ftm_common_data, 0, sizeof(ftm_common_data_type) );
  }
...
#ifdef FEATURE_RF_EXTPL_ENABLE 
  if(ftm_common_dmm_module_safe_unload(DM_ID_GERAN) != TRUE)
  {
  	MSG_1( MSG_SSID_FTM, MSG_LEGACY_ERROR, "Failed to unload GSM dmm module", 0);
	  return FALSE;
  }
#endif
  return TRUE;
...
)
{
  ...
  nb1_cphy_test_l1_mode_change_req_s nb1_mode_chg_req_msg;
  ...
  if((device == RFM_DEVICE_0) || (device == RFM_DEVICE_1))
  {
    ...
    rflte_ftm_mc_sm_set_spacing(rf_mode_spacing);
    carrier_idx = 0;
  }
  else
  {
     ...
     ((device == RFM_DEVICE_0) || (device == RFM_DEVICE_2) || (device == RFM_DEVICE_4))) 
  {
    ...
    if (FALSE == rflte_state_get_lte_nb_mode())
    {
#if 0
    ...
    else
    {
#if 0  	
      /* Notify ML1 that FTM mode has been entered */
      msgr_init_hdr( &nb1_mode_chg_req_msg.msgr_hdr, MSGR_RFA_RF_LTE_FTM, NB1_CPHY_TEST_L1_MODE_CHANGE_REQ);    
      nb1_mode_chg_req_msg.mode = NB1_L1_FTM_CAL_MODE;
  
      ret_status = msgr_send( &(nb1_mode_chg_req_msg.msgr_hdr), sizeof(nb1_cphy_test_l1_mode_change_req_s) );
#endif  
  #ifdef TEST_FRAMEWORK
      #error code not present
#endif
      ...
      if (ret_status != E_SUCCESS)
      {
        ERR_FATAL("RF LTE FTM Command Processor cannot send NB1_CPHY_TEST_L1_MODE_CHANGE_REQ, cmd_cod=%d, err=%d",
                   mode_chg_req_msg.msgr_hdr.id, ret_status, 0);
      }
    }
  }
...
static boolean ftm_lte_exit(rfm_device_enum_type    device , boolean cleanup_dev_allocation)
{
  ...
  rfa_rf_lte_nb_exit_mode_req_s     nb_exit_mode_req;
  ...
  if (carrier_idx == RFLTE_MC_PCELL_IDX)
  {
    ...
    if(rflte_ftm_mc_sm_is_mdsp_txagc_started() == TRUE )
    {
      ...
      {
        #ifdef FEATURE_NB1
        rflte_nb_mdsp_fw_ul_pusch_deconfig_req();
	#endif
      }
    ...
    {
      /* Stop FW from Doing RXAGC in non-NB mode*/
      if (FALSE == rflte_state_get_lte_nb_mode())
      {
      ...
      {
        #ifdef FEATURE_NB1
        rflte_nb_mdsp_fw_sys_config_app_req(FALSE);
        #endif
      }
    ...
    else /*added NB exit mode request for NB1 calibration*/
    {
		 /* EXIT PCELL */
      msgr_init_hdr(&nb_exit_mode_req.hdr, MSGR_RFA_RF_LTE_FTM, RFA_RF_LTE_NB_EXIT_MODE_REQ);
      nb_exit_mode_req.prx.device = rflte_ftm_mc_sm_get_prx_device();
      nb_exit_mode_req.prx.lm_buffer_index = rflte_ftm_mc_sm_get_rxlm_buffer(RFLTE_FTM_MC_PRX);;
      nb_exit_mode_req.prx.is_scenario_valid = TRUE;
      nb_exit_mode_req.prx.scenario_val = 0;
      nb_exit_mode_req.prx.tuner_handle = 0xFF;
      
      if (rflte_nb_dispatch_exit_mode_req(&nb_exit_mode_req, FALSE) != RF_DISPATCH_SUCESSFUL) 
      {
        FTM_MSG_ERROR("ftm_lte_nb_exit: EXIT_MODE Error on carrier %d, mdevice %d",
                      carrier_idx,
                      nb_exit_mode_req.prx.device,0);
    ...
    if ( rflte_ftm_mc_sm_get_txlm_buffer(RFLTE_FTM_MC_PRX) != FTM_INVALID_LM_BUFFER )
    {
		  ...
		  FTM_MSG_1 ( FTM_MED,
                      ...
                      0 ); 
#endif      
      tx_buffer_deallocated = txlm_deallocate_buffer( rflte_ftm_mc_sm_get_txlm_buffer(RFLTE_FTM_MC_PRX) );
      lte_ftm_mc_sm_ptr->carrier[carrier_idx].txlm_buf_idx = FTM_INVALID_LM_BUFFER;
    ...
    /*moved the ftm mdsp exit after exit mode request*/ 
    rflte_ftm_mdsp_exit();

    /*Disable hal bus before MCPM stop*/
    rf_hal_bus_enable( FALSE, &rf_lte_hal_bus_client_handle, RF_HAL_RFCMD_APP_CLIENT(LTE) );
...
)
{
  ...
  case FTM_PHONE_MODE_LTE_B72:  
  case FTM_PHONE_MODE_LTE_B73:  
  case FTM_PHONE_MODE_LTE_B85:
...
)
{
  ...
  uint8 band;
  ftm_rf_technology_type rf_tech;
  rfdevice_trx_common_intf_class* device_ptr = NULL;
  ...
  case RFM_LTE_MODE:
     if (ftm_common_get_band_tech_from_rf_mode(ftm_rf_mode,&band,&rf_tech))
     {
       /* rfdevice_lte_tx_cmd_dispatch(rfm_dev,
        ...
        device_ptr = rfdevice_lte_tx_get_common_dev_ptr( rfm_dev, band );                               
        rfdevice_trx_cmn_read_therm(device_ptr, &therm_read_val, &therm_read_in_degC);
...
boolean
ftm_common_dmm_module_safe_load
(
  dm_id_e_type dm_id
) 
{
  dm_state_e_type dm_state;
  dm_id_e_type dm_id_t;
  dm_status_e_type status;
  uint32 retry_cnt = 0;
  
  FTM_MSG_HIGH("Attempting to load dmm module %d safely", dm_id, 0, 0);

  if(dm_id < DM_ID_MIN || dm_id >= DM_ID_MAX)
  {
  	FTM_MSG_ERROR("Attempt to load invalid dmm module %d", dm_id, 0, 0);
	return FALSE;
  }
  
  for(dm_id_t=DM_ID_MIN;  dm_id_t < DM_ID_MAX;  dm_id_t++)
  {	
    // Close every other module
    if(dm_id_t != dm_id) 
    {
      if(ftm_common_dmm_module_safe_unload(dm_id_t) == FALSE)
      {
	    FTM_MSG_3(FTM_ERROR, "While loading dmm module %d, dmm module id %d is failied to unload in %d attempts", dm_id, dm_id_t,DMM_LOAD_UNLOAD_MAX_RETRIES);
		return FALSE;
	  }  
    }
  }
  ...
  do
  {
    dm_state = dmm_get_module_state(dm_id);
    if(dm_state == DM_STATE_ACTIVE)
    {
      FTM_MSG_2(FTM_HIGH, "DMM module %d is opened. dmm state: %d", dm_id, dm_state);
      break;
    }
    else if(dm_state == DM_STATE_TRANSITION)
    {
      FTM_MSG_2(FTM_HIGH,"dmm module id %d is in transition state. wait for %d us before recheck", dm_id,DMM_LOAD_UNLOAD_WAIT_TIME_US);
    }
    else if(dm_state == DM_STATE_SUSPENDED)
    {
      status = dmm_resume_module(dm_id,NULL);
      FTM_MSG_3(FTM_HIGH,"dmm module id %d resume initiated with status %d. wait for %d us before recheck", dm_id, status,DMM_LOAD_UNLOAD_WAIT_TIME_US);
    }
    else
    {
      status = dmm_open_module(dm_id, NULL);
      FTM_MSG_HIGH("dmm module %d open initiated with status %d. wait for %d us before recheck", dm_id, status, DMM_LOAD_UNLOAD_WAIT_TIME_US);
    }
    
    DALSYS_BusyWait(DMM_LOAD_UNLOAD_WAIT_TIME_US);

  } while (++retry_cnt < DMM_LOAD_UNLOAD_MAX_RETRIES);

  if(retry_cnt >= DMM_LOAD_UNLOAD_MAX_RETRIES)
  {
    FTM_MSG_2(FTM_ERROR, "DMM module %d is failed to load safely in %d retries", dm_id, DMM_LOAD_UNLOAD_MAX_RETRIES);
	return FALSE;
  }
...
boolean
ftm_common_dmm_module_safe_unload
(
  dm_id_e_type dm_id
)
{
  ...
  if(dm_id < DM_ID_MIN || dm_id >= DM_ID_MAX)
  {
  	FTM_MSG_ERROR("Attempting to unload invalid dmm module %d", dm_id, 0, 0);
	return FALSE;
  }
  ...
  {
    dm_state = dmm_get_module_state(dm_id);
    if(dm_state == DM_STATE_INACTIVE || dm_state == DM_STATE_INVALID)
    {
        FTM_MSG_HIGH("dmm module id %d closed", dm_id, 0, 0);
        break;
    }
    else if(dm_state == DM_STATE_TRANSITION) 
    {
    ...
    else if (dm_state == DM_STATE_ACTIVE || dm_state == DM_STATE_SUSPENDED)      
    {
        status = dmm_close_module(dm_id,NULL);
        FTM_MSG_3(FTM_HIGH, "dmm module id %d close initiated with status %d. wait for %d us before recheck", dm_id,status,DMM_LOAD_UNLOAD_WAIT_TIME_US);
    }
  ...
  if(retry_cnt >= DMM_LOAD_UNLOAD_MAX_RETRIES)
  {
    FTM_MSG_2(FTM_ERROR, "DMM module %d is failed to unload safely in %d retries", dm_id, DMM_LOAD_UNLOAD_MAX_RETRIES);
	return FALSE;
  }
