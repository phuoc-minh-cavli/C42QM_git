...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_common_timer.c#1 $
...
{  
  ...
  if (timer_data->timer_services.cb_struct == NULL) 
  {
    ...
    timer_def(timer_data->timer_services.cb_struct,
              NULL, NULL, 0,
           (timer_t1_cb_type)cb_func,
             (timer_cb_data_type)NULL);

    timer_set(timer_data->timer_services.cb_struct, 
                interval, 0,T_USEC);             
...
)
{
  ...
  if (timer_data->timer_services.cb_struct != NULL)
  {
    ...
    timer_undef(timer_data->timer_services.cb_struct);
