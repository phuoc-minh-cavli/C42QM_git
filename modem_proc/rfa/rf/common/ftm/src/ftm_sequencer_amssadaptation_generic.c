...
Program: FTM Sequencer
  ...
  $Id: //components/rel/rfa.mpss/3.10/rf/common/ftm/src/ftm_sequencer_amssadaptation_generic.c#1 $
			...
			)
{
    ...
    char *_pStrBuffer = (char *)ftm_malloc(FTM_SEQUENCER_MAX_DEBUG_MESSAGE_SIZE);
    // make a va list
    va_list _vaList;
