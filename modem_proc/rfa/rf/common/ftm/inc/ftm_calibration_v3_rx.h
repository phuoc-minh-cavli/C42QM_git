...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/inc/ftm_calibration_v3_rx.h#1 $
...
typedef enum
{
  ...
  RX_ACTION_LNA6_CAL    = 0x40,
  /*!< LNA6 Calibration */
    
  RX_ACTION_LNA7_CAL    = 0x80,
  /*!< LNA7 Calibration */
...
/*----------------------------------------------------------------------------*/
/*! Type defintion for Rx DC Comp Offset */
typedef int32 ftm_cal_rx_meas_rx_dc_offset_type;
typedef uint8 ftm_cal_rx_meas_catm_nb_mode;
...
typedef enum
{
  ...
  RX_MEAS_ACTION_RxDCmV = 2,
  /*!< Rx DC Offset measurement */
...
typedef struct
{
  ...
  struct
  {
    ...
    struct
    {
      ...
      ftm_cal_rx_meas_catm_nb_mode catm_nb_mode;

      ftm_cal_rx_meas_rx_dc_offset_type rx_dc_offset_i;
      ftm_cal_rx_meas_rx_dc_offset_type rx_dc_offset_q;
