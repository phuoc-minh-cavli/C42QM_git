...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/ftm/inc/ftm_common_control.h#1 $
...
#ifdef FEATURE_RF_EXTPL_ENABLE
//wait for each retry to load/unload module
#define DMM_LOAD_UNLOAD_WAIT_TIME_US 100000
// max retries before returning error
#define DMM_LOAD_UNLOAD_MAX_RETRIES	 100
