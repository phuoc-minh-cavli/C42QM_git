...
/*===========================================================================
Copyright (c) 2008 - 2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/rfa.mpss/3.10/rf/common/rf/mc/inc/rfcommon_mc.h#1 $
...
void rfcommon_mc_snapshot_handler(void);

boolean rfcommon_mc_snapshot_rffe_devices(void);

boolean rfcommon_mc_snapshot_cmn_reg(void);
