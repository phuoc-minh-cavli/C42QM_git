...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/rf/fbrx/src/rfcommon_fbrx_nv.c#1 $
                                                          ...
                                                          rfnv_item_id_enum_type *nv_item_temp )
{
  ...
  switch (band)
  {
   ...
   case   RFCOM_BAND_LTE_B30:
    ...
    case   RFCOM_BAND_LTE_B71:
        *nv_item_gain = RFNV_LTE_C0_B71_FBRX_GAIN_FREQ_I;
        *nv_item_sp   = RFNV_LTE_C0_B71_FBRX_GAIN_SWITCH_POINT_I;
        *nv_item_dc   = RFNV_ITEMS_ENUM_MAX;
	  // This band only supports the compressed gain_vs_temp_vs_freq item
        *nv_item_temp = RFNV_ITEMS_ENUM_MAX; 
         break;

    case   RFCOM_BAND_LTE_B72:
        *nv_item_gain = RFNV_LTE_C0_B72_FBRX_GAIN_FREQ_I;
        *nv_item_sp   = RFNV_LTE_C0_B72_FBRX_GAIN_SWITCH_POINT_I;
        *nv_item_dc   = RFNV_ITEMS_ENUM_MAX;
	  // This band only supports the compressed gain_vs_temp_vs_freq item
        *nv_item_temp = RFNV_ITEMS_ENUM_MAX; 
         break;

    case   RFCOM_BAND_LTE_B73:
        *nv_item_gain = RFNV_LTE_C0_B73_FBRX_GAIN_FREQ_I;
        *nv_item_sp   = RFNV_LTE_C0_B73_FBRX_GAIN_SWITCH_POINT_I;
        *nv_item_dc   = RFNV_ITEMS_ENUM_MAX;
	  // This band only supports the compressed gain_vs_temp_vs_freq item
        *nv_item_temp = RFNV_ITEMS_ENUM_MAX; 
         break;

    case   RFCOM_BAND_LTE_B85:
        *nv_item_gain = RFNV_LTE_C0_B85_FBRX_GAIN_FREQ_I;
        *nv_item_sp   = RFNV_LTE_C0_B85_FBRX_GAIN_SWITCH_POINT_I;
        *nv_item_dc   = RFNV_ITEMS_ENUM_MAX;
	  // This band only supports the compressed gain_vs_temp_vs_freq item
        *nv_item_temp = RFNV_ITEMS_ENUM_MAX; 
         break;

	case   RFCOM_BAND_LTE_B86:
        *nv_item_gain = RFNV_LTE_C0_B86_FBRX_GAIN_FREQ_I;
        *nv_item_sp   = RFNV_LTE_C0_B86_FBRX_GAIN_SWITCH_POINT_I;
        *nv_item_dc   = RFNV_ITEMS_ENUM_MAX;
	  // This band only supports the compressed gain_vs_temp_vs_freq item
        *nv_item_temp = RFNV_ITEMS_ENUM_MAX; 
         break;
                                                                     ...
                                                                     rfnv_item_id_enum_type *nv_item_temp_z )
{
  ...
  switch (band)
  {
    ...
    case   RFCOM_BAND_LTE_B71:
      *nv_item_temp_z = RFNV_LTE_C0_B71_FBRX_MODE_VS_GAIN_VS_TEMP_VS_FREQ_Z_I;
      break;

    case   RFCOM_BAND_LTE_B72:
      *nv_item_temp_z = RFNV_LTE_C0_B72_FBRX_MODE_VS_GAIN_VS_TEMP_VS_FREQ_Z_I;
      break;

    case   RFCOM_BAND_LTE_B73:
      *nv_item_temp_z = RFNV_LTE_C0_B73_FBRX_MODE_VS_GAIN_VS_TEMP_VS_FREQ_Z_I;
      break;

   case   RFCOM_BAND_LTE_B85:
      *nv_item_temp_z = RFNV_LTE_C0_B85_FBRX_MODE_VS_GAIN_VS_TEMP_VS_FREQ_Z_I;
      break;
   
   case   RFCOM_BAND_LTE_B86:
      *nv_item_temp_z = RFNV_LTE_C0_B86_FBRX_MODE_VS_GAIN_VS_TEMP_VS_FREQ_Z_I;
      break;   
                                                                               ...
                                                                               rfnv_item_id_enum_type *nv_item_temp_z )
{
  ...
  switch (band)
  {
    ...
    case   RFCOM_BAND_LTE_B71:
      *nv_item_temp_z = RFNV_LTE_C0_B71_FBRX_DROOP_FIR_FILTER_COEFF_Z_I;
      break;

   case   RFCOM_BAND_LTE_B72:
      *nv_item_temp_z = RFNV_LTE_C0_B72_FBRX_DROOP_FIR_FILTER_COEFF_Z_I;
      break;

   case   RFCOM_BAND_LTE_B73:
      *nv_item_temp_z = RFNV_LTE_C0_B73_FBRX_DROOP_FIR_FILTER_COEFF_Z_I;
      break;

    case   RFCOM_BAND_LTE_B85:
      *nv_item_temp_z = RFNV_LTE_C0_B85_FBRX_DROOP_FIR_FILTER_COEFF_Z_I;
      break;
  
    case   RFCOM_BAND_LTE_B86:
      *nv_item_temp_z = RFNV_LTE_C0_B86_FBRX_DROOP_FIR_FILTER_COEFF_Z_I;
      break;
...
)
{
  ...
  switch (tech)
  {
    ...
    case RFM_LTE_FTM_MODE:
      for (i=0;i<gain_ptr->fbrx_gain_chan_size;i++)
      {
        tx_cal_freq_list[i] = rflte_core_get_tx_freq_with_offset_from_uarfcn(gain_ptr->fbrx_gain_chan[i], band.lte_band);
      }
      break;
    #endif
    ...
    switch (tech)
    {
      ...
      case RFM_LTE_FTM_MODE:
        if (band.lte_band < RFCOM_NUM_LTE_BANDS)
        {
          ...
          for (i=0;i<num_channels;i++)
          {
            tx_freq += rflte_core_get_tx_freq_with_offset_from_uarfcn((rfcom_lte_earfcn_type)chan_array[i], band.lte_band);
          }
          tx_freq /= num_channels;
        }
        else
