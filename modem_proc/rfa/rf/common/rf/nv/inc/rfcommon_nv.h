...
Copyright (c) 1997 - 2022 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/rfa.mpss/3.10/rf/common/rf/nv/inc/rfcommon_nv.h#2 $
...
#define RFCOMMON_NV_MAX_PA_STATE     8
#else
...
typedef PACK(struct)
{
  ...
  /* POUT_CONTROL*/
  int16 pout_control[RFCOMMON_NV_MAX_PA_STATE];

  /* PA Fall switchpoint: 0-> Timer Hystersis value | 1-> R1 fall | 2 -> R2 fall etc */
  int16 pa_fall_sw_nbiot[RFCOMMON_NV_MAX_PA_STATE];

  /* PA Rise switchpoint: 0-> reserved | 1-> R1 rise | 2 -> R2 rise etc */
  int16 pa_rise_sw_nbiot[RFCOMMON_NV_MAX_PA_STATE];
  
  int16 lte_intra_band_ulca_pa_fall_sw[RFCOMMON_NV_MAX_PA_STATE];

  int16 lte_intra_band_ulca_pa_rise_sw[RFCOMMON_NV_MAX_PA_STATE];
