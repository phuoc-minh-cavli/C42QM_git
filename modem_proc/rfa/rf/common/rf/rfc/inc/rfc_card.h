...
$Header: //components/rel/rfa.mpss/3.10/rf/common/rf/rfc/inc/rfc_card.h#1 $
...
typedef enum
{
  RFC_RF_POWER_CLASS1 = 1,
  RFC_RF_POWER_CLASS2 = 2,
  RFC_RF_POWER_CLASS3 = 3,
  RFC_RF_POWER_CLASS_DEFAULT = RFC_RF_POWER_CLASS3,  
  RFC_RF_POWER_CLASS4 = 4,
  RFC_RF_POWER_CLASS5 = 5,
  RFC_RF_POWER_CLASS6 = 6,
  RFC_RF_POWER_CLASS_MAX = 7,
}rfc_rf_pwr_cls;
...
extern rfdevice_trx_common_intf_class*
