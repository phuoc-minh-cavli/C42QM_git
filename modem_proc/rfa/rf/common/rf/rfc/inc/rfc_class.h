...
$Header: //components/rel/rfa.mpss/3.10/rf/common/rf/rfc/inc/rfc_class.h#1 $
...
public:
  ...
  rf_hw_type get_rfc_hardware_id(void);
  int get_phys_devices_count(void);
  
  rfc_physical_device_struct_type* get_phys_devices_array(void);
...
private:
  ...
  /*helper function to program USID for physical devices */
  boolean rfc_program_phy_device_usid(rfc_phy_device_info_type *phy_devices_cfg, boolean is_rffe_v2);
};
#endif /* __cplusplus */
#endif /* RFC_H */
