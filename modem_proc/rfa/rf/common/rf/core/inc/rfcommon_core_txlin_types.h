...
/*==============================================================================
  ...
  Copyright (c) 2012 - 2022 Qualcomm Technologies Incorporated. All Rights Reserved
...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/common/rf/core/inc/rfcommon_core_txlin_types.h#2 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------- 
08/08/22   gk      Memory optimzation: 4 PA states functionality
05/30/18   tik     NB IoT Tx calibration waveform addition
...
#ifdef FEATURE_RF_REDUCED_NUM_PA
#define RFCOM_TXLIN_NUM_LINEARIZERS       4 
#else
...
#define RFCMN_TXLIN_AGC_MAX_RFFE_GROUP_NUM_REGS 100
#define RFCMN_TXLIN_AGC_MAX_RFFE_GROUP_NUM_GROUPS 10
...
typedef enum
{
  ...
  RFCMN_TXLIN_AGC_WTR_RGI0_TRIG_TASK = 4,  

  RFCMN_TXLIN_AGC_WXE_BBF_TASK = 5,
...
typedef enum
{
  ...
  TX_LINEARIZER_FIRST_SWEEP_NBIoT = 6,
...
typedef struct
{
  ...
  */
  ...
  /*! 
    @brief
    The time in usec x 10 at which the late WTR RGI 0 must be done
  */
  int16 wtr_rgi0_offset;  
  /*! 
    @brief
