...
$Header: //components/rel/rfa.mpss/3.10/rf/common/rf/core/src/rfcommon_core.c#1 $
...
extern rflm_err_t  rflm_dtr_rx_adc_calib_mode(void);
...
/* Initialize MSM Block */
 ...
 /* Initialize the Device Manager structures */
  ...
  /* Initialize the MAAT manager structures */
  rfc_is_initialized &= rfcmn_core_maat_mgr_init();
