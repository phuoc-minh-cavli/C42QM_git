...
$Header: //components/rel/rfa.mpss/3.10/rf/sv/common/src/rftxplim_mm_report_tx_power.c#1 $
...
/* Get the GPS status */
      ...
      case RFCOM_BAND_LTE_B3:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B3);
      ...
      case RFCOM_BAND_LTE_B9:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B9);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
      ...
      case RFCOM_BAND_LTE_B10:
        ...
        case RF_BC14_BAND:
          {
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B10);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC1_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B2);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC0_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B4);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC15_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B1);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
        ...
        case RF_BC8_BAND:
          {
            ...
            cur_lte_tx_freq = rflte_core_get_tx_freq_with_offset_from_uarfcn(rflte_mc_state.rf_path_state[0].curr_chan_tx, RFCOM_BAND_LTE_B25);
            cdma1x_tx_freq = rf_cdma_get_tx_carrier_freq(rf_cdma_band_to_rfm_card_band(rfsv_voice_tech_tx_status.rf_band), cdma1x_rf_chan);
