...
/*==============================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/mdsp/qdsp6_common/inc/rfcommon_mdsp.h#1 $
...
/*! 
    @brief
    Max number of elements allowed for non-trigger groups in a TxAGC transaction
*/
#define RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE \
                                               RFLM_TXAGC_NON_TRIGGER_GROUP_SIZE                                               
...
/*! 
    ...
    Max number of elements allowed for trigger data in a TxAGC transaction
*/
#define RFCOMMON_MDSP_TXLIN_PA_TRIG_DATA_SIZE \
                                          RFLM_TXAGC_PA_TRIG_DATA_SIZE

/*----------------------------------------------------------------------------*/
/*! 
    @brief
    Max number of elements allowed for trigger group in a TxAGC transaction
*/
#define RFCOMMON_MDSP_TXLIN_TRIG_GROUP_SIZE \
                                         RFLM_TXAGC_TRIGGER_GROUP_SIZE

/*----------------------------------------------------------------------------*/
/*! 
    @brief
    Max number of data elements allowed per group in a TxAGC transaction
*/
#define RFCOMMON_MDSP_TXLIN_GROUP_DATA_SIZE  \
                                         RFLM_TXAGC_GROUP_DATA_SIZE
...
/*! 
    ...
    Max number of data elements allowed per group in a TxAGC transaction
*/
#define RFCOMMON_MDSP_TXLIN_GROUP_TOKEN_SIZE  \
                                         RFLM_TXAGC_GROUP_TOKEN_SIZE
                                         
/*----------------------------------------------------------------------------*/
/*! 
    @brief
    Max number of WXE buffers to be used for TxAGC
*/
#define RFCOMMON_MDSP_TXLIN_WXE_BUF_SIZE  \
                                         RFLM_TXAGC_WXE_BUF_SIZE                                         
...
} rfcommon_mdsp_group_token_type;
...
typedef struct
{
  ...
  struct
  {
    struct
    {
      uint8 non_trig[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_DATA_SIZE];
      /*!< WTR write non trigger data, array of size: number of RFFE writes */
      uint8 trig[RFCOMMON_MDSP_TXLIN_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_DATA_SIZE];
  ...
  } wtr_wxe_config[RFCOMMON_MDSP_TXLIN_WXE_BUF_SIZE];

  struct
  {
    uint8 trig[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_DATA_SIZE];
  } wtr_rgi0_config;  
...
typedef struct
{
  ...
  {
    int8   non_trig_numb_bytes[RFCOMMON_MDSP_TXLIN_NON_TRIG_DATA_SIZE];
    int8   trigger_num_bytes[RFCOMMON_MDSP_TXLIN_PA_TRIG_DATA_SIZE];
    uint16 non_trig[RFCOMMON_MDSP_TXLIN_NON_TRIG_DATA_SIZE];
    uint16 trig[RFCOMMON_MDSP_TXLIN_PA_TRIG_DATA_SIZE];
    int16  trig_start_delta[RFCOMMON_MDSP_TXLIN_PA_TRIG_DATA_SIZE];
    uint16 dummy;
    /*!< PA write address */
  ...
  struct
  {
    int8   non_trig_numb_bytes[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];
    int8   trigger_num_bytes[RFCOMMON_MDSP_TXLIN_TRIG_GROUP_SIZE];
    int8   non_trig_num_tokens[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE]; 
    int8   trig_num_tokens[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];        
    uint16 non_trig[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];
    uint16 trig[RFCOMMON_MDSP_TXLIN_TRIG_GROUP_SIZE];    
    rfcommon_mdsp_group_token_type non_trig_token[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_TOKEN_SIZE];
    rfcommon_mdsp_group_token_type trig_token[RFCOMMON_MDSP_TXLIN_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_TOKEN_SIZE];
    uint8 num_non_trig_groups;
    uint8 num_trig_groups;
    uint16 dummy;
    /*!< WTR write address */
  }wtr_config_addr[RFCOMMON_MDSP_TXLIN_WXE_BUF_SIZE];
  ...
  struct
  {
    ...
    uint16 dummy;
    /*!< WTR write address */
  }wxe_config_addr[RFCOMMON_MDSP_TXLIN_WXE_BUF_SIZE];

  struct
  {
    int8   num_bytes[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];
    int8   num_tokens[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];    
    uint16 addr[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE];
    rfcommon_mdsp_group_token_type token[RFCOMMON_MDSP_TXLIN_NON_TRIG_GROUP_SIZE][RFCOMMON_MDSP_TXLIN_GROUP_TOKEN_SIZE];
    uint8 num_groups;    
    uint16 dummy;
    /*!< WTR RGI0 write address */
  }wtr_rgi0_config_addr;
