...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/rf/meas/ftm/src/ftm_meas.c#1 $ 

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
01/21/19   as      CT.1.0 Compilation fix
...
void ftm_meas_clock_setup(rfm_meas_generic_params_type *test_param_ptr, boolean tune_away_flag)
{
  ...
  mcpm_request_type mcpm_req = MCPM_LTE_PARMS_UPDATE_REQ;
