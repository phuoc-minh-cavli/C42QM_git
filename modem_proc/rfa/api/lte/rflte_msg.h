...
/*===========================================================================
  ...
  Copyright (c) 2009 - 2021 Qualcomm Technologies Incorporated. All Rights Reserved
...
$DateTime: 2021/05/05 01:14:56 $
$Author  : $

when       who     what, where, why
--------   ---     ------------------------------------------------------------------
05/05/21   gk      Interface changes
01/21/20   gk      B8_B addition
...
/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to enter LTE NB mode of operation CMD and RSP
 */
#define RFA_RF_LTE_MSG_ID_NB_ENTER_MODE             0xC6

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to exit LTE NB mode of operation CMD and RSP
 */
#define RFA_RF_LTE_MSG_ID_NB_EXIT_MODE              0xC7

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to configure NB RX CMD and RSP (this includes tuning RX device)
 */
#define RFA_RF_LTE_MSG_ID_NB_FDD_RX_CONFIG          0xC8

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to configure NB TX CMD and RSP (this includes tuning TX device)
 */
#define RFA_RF_LTE_MSG_ID_NB_FDD_TX_CONFIG          0xC9


/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to disable NB TX CMD and RSP
 */
#define RFA_RF_LTE_MSG_ID_NB_FDD_TX_DISABLE         0xCA

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to go to NB sleep CMD and RSP
 */
#define RFA_RF_LTE_MSG_ID_NB_SLEEP                  0xCB

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to NB wake up CMD and RSP
 */ 
#define RFA_RF_LTE_MSG_ID_NB_WAKEUP                 0xCC

/*-----------------------------------------------------------------------*/
/*! @brief ID to indicate NB TX is ON CMD
 */
#define RFA_RF_LTE_MSG_ID_NB_TX_ON                  0xCD

/*-----------------------------------------------------------------------*/
/*! @brief ID for NB ML1 ticks for ant tuning 
*/
#define RFA_RF_LTE_MSG_ID_NB_ANT_TUNER_TICK         0xCE

/*----------------------------------------------------------------------*/
/*-----------------------------------------------------------------------*/
/*! @brief ID for offloading nv read to rflte core task for psm case 
*/
#define RFA_RF_LTE_MSG_ID_OFFLOAD_EFS_READ          0xD0

/*-----------------------------------------------------------------------*/
/*! @brief ID for RF to generate NB RX RETUNE SCRIPT and RSP
 */
#define RFA_RF_LTE_MSG_ID_NB_RX_RETUNE_SCRIPT       0xD1
 ...
 */
#define RFA_RF_LTE_MAX_CELL_SUPPORTED               1
...
enum
{
   ...
   /*! Enter LTE mode message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_ENTER_MODE, RFA_RF_LTE_MSG_ID_NB_ENTER_MODE, rfa_rf_lte_nb_enter_mode_cnf_s),

   /*! Exit LTE mode message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_EXIT_MODE, RFA_RF_LTE_MSG_ID_NB_EXIT_MODE, rfa_rf_lte_nb_exit_mode_cnf_s),

   /*! Configure FDD RX message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_FDD_RX_CONFIG, RFA_RF_LTE_MSG_ID_NB_FDD_RX_CONFIG, rfa_rf_lte_nb_fdd_rx_config_cnf_s),

   /*! Configure FDD TX message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_FDD_TX_CONFIG, RFA_RF_LTE_MSG_ID_NB_FDD_TX_CONFIG, rfa_rf_lte_nb_fdd_tx_config_cnf_s),

   /*! Disable TDD TX disable message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_FDD_TX_DISABLE, RFA_RF_LTE_MSG_ID_NB_FDD_TX_DISABLE, rfa_rf_lte_nb_fdd_tx_disable_cnf_s),

   /*! RF sleep message*/
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_SLEEP, RFA_RF_LTE_MSG_ID_NB_SLEEP, rfa_rf_lte_nb_sleep_cnf_s),

   /*! RF wakeup message*/
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_WAKEUP, RFA_RF_LTE_MSG_ID_NB_WAKEUP, rfa_rf_lte_nb_wakeup_cnf_s),

   /*! RF TX_ON confirmation message*/
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_TX_ON, RFA_RF_LTE_MSG_ID_NB_TX_ON, rfa_rf_lte_nb_tx_on_cfn_s),   

   /*! EFS READ           confirmation message*/
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, OFFLOAD_EFS_READ, RFA_RF_LTE_MSG_ID_OFFLOAD_EFS_READ, rfa_rf_lte_efs_read_cnf_s),

   /*! ID for NB Rx Retune Script confirmation message*/
   MSGR_DEFINE_UMID(RFA, RF_LTE, CNF, NB_RX_RETUNE_SCRIPT, RFA_RF_LTE_MSG_ID_NB_RX_RETUNE_SCRIPT, rfa_rf_lte_nb_rx_retune_script_cnf_s),
...
enum
{
   ...
   /*! Enter LTE NB mode message, payload is the device type, sent by L1 */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_ENTER_MODE, RFA_RF_LTE_MSG_ID_NB_ENTER_MODE, rfa_rf_lte_nb_enter_mode_req_s),

   /*! Exit LTE NB mode message, payload is the device type, sent by L1 */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_EXIT_MODE, RFA_RF_LTE_MSG_ID_NB_EXIT_MODE, rfa_rf_lte_nb_exit_mode_req_s),

   /*! Configure NB FDD RX message, payload is defined in lte_config_s, sent by L1 */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_FDD_RX_CONFIG, RFA_RF_LTE_MSG_ID_NB_FDD_RX_CONFIG, rfa_rf_lte_nb_fdd_rx_config_req_s),

   /*! Configure NB FDD TX message, payload is defined in lte_config_s, sent by L1 */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_FDD_TX_CONFIG, RFA_RF_LTE_MSG_ID_NB_FDD_TX_CONFIG, rfa_rf_lte_nb_fdd_tx_config_req_s),

   /*! Disable NB TDD TX disable message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_FDD_TX_DISABLE, RFA_RF_LTE_MSG_ID_NB_FDD_TX_DISABLE, rfa_rf_lte_nb_fdd_tx_disable_req_s),

   /*! NB sleep message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_SLEEP, RFA_RF_LTE_MSG_ID_NB_SLEEP, rfa_rf_lte_nb_sleep_req_s),

   /*! NB wakeup message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_WAKEUP, RFA_RF_LTE_MSG_ID_NB_WAKEUP, rfa_rf_lte_nb_wakeup_req_s),   

   /*! NB TX ON Indicator message */
   MSGR_DEFINE_UMID(RFA, RF_LTE, IND, NB_TX_ON, RFA_RF_LTE_MSG_ID_NB_TX_ON, rfa_rf_lte_nb_tx_on_ind_s),

   /*! ML1 provide the RFSW ticks for ant tuning */
   MSGR_DEFINE_UMID(RFA, RF_LTE, IND, NB_ANT_TUNER_TICK, RFA_RF_LTE_MSG_ID_NB_ANT_TUNER_TICK, rfa_rf_lte_nb_ant_tuner_tick_ind_s),

  /*! rf main task triggers for efs read for rflte nvs */
   MSGR_DEFINE_UMID(RFA, RF_LTE, IND, OFFLOAD_EFS_READ, RFA_RF_LTE_MSG_ID_OFFLOAD_EFS_READ, rfa_rf_lte_offload_efs_read_ind_s),

   /*! Configure NB RX Retune message, payload is defined in lte_config_s, sent by L1 */
   MSGR_DEFINE_UMID(RFA, RF_LTE, REQ, NB_RX_RETUNE_SCRIPT, RFA_RF_LTE_MSG_ID_NB_RX_RETUNE_SCRIPT, rfa_rf_lte_nb_rx_retune_script_req_s),
...
typedef struct
{
  ...
  /*!<  Specify LTE system BW */
  rfcom_lte_bw_type                sys_bw;
  boolean non3gpp_duplex_spacing;
...
typedef struct
{
  ...
  uint8                            step_size; 
  boolean non3gpp_duplex_spacing;
} rfa_rf_nb_rx_param_type;

/*-----------------------------------------------------------------------*/
typedef struct
{
  rfcom_lte_earfcn_type            channel;
  int8 ul_carrier_freq_offset;                  /*M_UL value, and will be added to tx freq after multiplying 5khz*/
  rfa_rf_lte_tdd_ul_dl_cfg_type tdd_ul_dl_cfg;  /* Cfg#0, Cfg#1....Cfg#6*/
  int32             rx_freq_error;  
} rfa_rf_nb_tx_param_type;
...
typedef struct 
{
   ...
   rfm_meas_lte_rx_chan_param_type src_scell_param[RFA_RF_LTE_MAX_CELL_SUPPORTED];
...
typedef struct
{
  ...
  int16 vbatt_plimit; /* vbatt power limit */
...
{
  msgr_hdr_struct_type   hdr;
} rfa_rf_lte_offload_efs_read_ind_s;
...
typedef struct
{
  msgr_hdr_struct_type   hdr;
  rfa_rf_chain_param_type prx;
} rfa_rf_lte_nb_enter_mode_req_s;
...
typedef struct
{
  ...
  rfa_rf_chain_param_type prx; 
  rfa_rf_lte_cmd_outcome_t req_result;
} rfa_rf_lte_nb_enter_mode_cnf_s;
...
typedef struct
{
  msgr_hdr_struct_type   hdr;
  rfa_rf_chain_param_type prx;
  rfa_rf_nb_rx_param_type rx_param;
} rfa_rf_lte_nb_fdd_rx_config_req_s;
...
typedef struct
{
  ...
  boolean                  antenna_tuner_present;
  uint64 ustmr_timestamp;
} rfa_rf_lte_nb_fdd_rx_config_cnf_s;
...
typedef struct
{
  msgr_hdr_struct_type   hdr;
  rfa_rf_chain_param_type tx;
  rfa_rf_nb_tx_param_type tx_param;
} rfa_rf_lte_nb_fdd_tx_config_req_s;
...
typedef struct
{
  ...
  rfa_rf_lte_tx_config_cnf_params_type tx_config_cnf_params;
  rfa_rf_lte_cmd_outcome_t req_result;
} rfa_rf_lte_nb_fdd_tx_config_cnf_s;
...
typedef struct
{
  msgr_hdr_struct_type   hdr;
  rfa_rf_chain_param_type tx;
} rfa_rf_lte_nb_fdd_tx_disable_req_s;
...
typedef struct
{
  ...
  rfa_rf_chain_param_type tx;
  rfa_rf_lte_cmd_outcome_t req_result;
} rfa_rf_lte_nb_fdd_tx_disable_cnf_s;
...
typedef struct
{
  msgr_hdr_struct_type   hdr;
	/* this transaction_id should be reset only during LTE exit and is maintained by ML1 */
  rfa_rf_lte_transaction_hdr_s tick_ind_params;
} rfa_rf_lte_nb_ant_tuner_tick_ind_s;
...
typedef struct
{
   msgr_hdr_struct_type   hdr;	
   rfa_rf_lte_cmd_outcome_t req_result;
} rfa_rf_lte_efs_read_cnf_s;

/*-----------------------------------------------------------------------*/
typedef struct
{
  msgr_hdr_struct_type hdr;
  rfcom_lte_earfcn_type nonanchor_chan;
  int32 rx_raster_offset;
  lm_handle_type lm_buffer_index;
} rfa_rf_lte_nb_rx_retune_script_req_s;
...
typedef struct
{
  ...
  lm_handle_type lm_buffer_index;
  rfa_rf_lte_cmd_outcome_t req_result;
} rfa_rf_lte_nb_rx_retune_script_cnf_s;
...
typedef struct
{
  ...
  /* Un-used RX Path SNR should be filled with floored value */
  int32 snr_db10;

} rfa_rf_lte_maat_info_type_s;

typedef struct
{
    /*Tx channel of the carrier*/  
  rfcom_lte_earfcn_type tx_channel;

  int16 txpwr_db10;

} rfa_rf_lte_maat_tx_params_type_s;
...
typedef struct
{
  ...
  rfa_rf_lte_maat_tx_params_type_s carrier;

} rfa_rf_lte_maat_tx_info_type_s;
