...
$Header: //components/rel/rfa.mpss/3.10/api/lte/ftm_lte_ns_msg.h#1 $
$Author: pwbldsvc $
...
10/13/16   as      Non-signalling mode re-architecture changes
11/25/14   stw     Add Multiple Scell Support in NS mode
...
#define FTM_LTE_NS_NB_START_LTE_MODE_CMD_CODE_C         19
#define FTM_LTE_NS_NB_STOP_LTE_MODE_CMD_CODE_C          20
#define FTM_LTE_NS_NB_IDLE_CMD_CODE_C                   21
#define FTM_LTE_NS_NB_ACQ_CMD_CODE_C                    22
#define FTM_LTE_NS_NB_START_DP_CMD_CODE_C               23
#define FTM_LTE_NS_NB_DL_DATA_IND_CODE_C                24
#define FTM_LTE_NS_NB_IS_CONN_CMD_CODE_C                25
#define FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_CMD_CODE_C     26
#define FTM_LTE_NS_NB_CONFIG_UL_POWER_CMD_CODE_C        27
#define FTM_LTE_NS_NB_GET_DL_LEVEL_CMD_CODE_C           28
#define FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CMD_CODE_C   29
#define FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CMD_CODE_C     30
#define FTM_LTE_NS_MAX_CMD_CODE_C                       31
#else
...
#ifdef FEATURE_NB1_PLT
  /*LTE NB related req and cnf/ind*/
  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_START_LTE_MODE, FTM_LTE_NS_NB_START_LTE_MODE_CMD_CODE_C, ftm_lte_ns_nb_start_mode_req_msg_type), /* FTM_LTE_NS_NB_START_LTE_MODE_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_START_LTE_MODE, FTM_LTE_NS_NB_START_LTE_MODE_CMD_CODE_C, ftm_lte_ns_nb_start_mode_cnf_msg_type), /* FTM_LTE_NS_NB_START_LTE_MODE_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_STOP_LTE_MODE,  FTM_LTE_NS_NB_STOP_LTE_MODE_CMD_CODE_C,  ftm_lte_ns_nb_stop_mode_req_msg_type), /* FTM_LTE_NS_NB_STOP_LTE_MODE_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_STOP_LTE_MODE,  FTM_LTE_NS_NB_STOP_LTE_MODE_CMD_CODE_C,  ftm_lte_ns_nb_stop_mode_cnf_msg_type), /* FTM_LTE_NS_NB_STOP_LTE_MODE_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_IDLE,           FTM_LTE_NS_NB_IDLE_CMD_CODE_C,           ftm_lte_ns_nb_idle_req_msg_type), /* FTM_LTE_NS_NB_IDLE_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_IDLE,           FTM_LTE_NS_NB_IDLE_CMD_CODE_C,           ftm_lte_ns_nb_idle_cnf_msg_type), /* FTM_LTE_NS_NB_IDLE_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_ACQ,            FTM_LTE_NS_NB_ACQ_CMD_CODE_C,            ftm_lte_ns_nb_acq_req_msg_type), /* FTM_LTE_NS_NB_ACQ_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_ACQ,            FTM_LTE_NS_NB_ACQ_CMD_CODE_C,            ftm_lte_ns_nb_acq_cnf_msg_type), /* FTM_LTE_NS_NB_ACQ_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_START_DP,       FTM_LTE_NS_NB_START_DP_CMD_CODE_C,       ftm_lte_ns_nb_start_dp_req_msg_type), /* FTM_LTE_NS_NB_START_DP_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_START_DP,       FTM_LTE_NS_NB_START_DP_CMD_CODE_C,       ftm_lte_ns_nb_start_dp_cnf_msg_type), /* FTM_LTE_NS_NB_START_DP_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_IS_CONN,        FTM_LTE_NS_NB_IS_CONN_CMD_CODE_C,        ftm_lte_ns_nb_is_conn_req_msg_type), /* FTM_LTE_NS_NB_IS_CONN_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_IS_CONN,        FTM_LTE_NS_NB_IS_CONN_CMD_CODE_C,        ftm_lte_ns_nb_is_conn_cnf_msg_type), /* FTM_LTE_NS_NB_IS_CONN_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_CONFIG_UL_WAVEFORM,  FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_CMD_CODE_C,    ftm_lte_ns_nb_config_ul_waveform_req_msg_type), /* FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_CONFIG_UL_WAVEFORM,  FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_CMD_CODE_C,    ftm_lte_ns_nb_config_ul_waveform_cnf_msg_type), /* FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_CONFIG_UL_POWER,     FTM_LTE_NS_NB_CONFIG_UL_POWER_CMD_CODE_C,       ftm_lte_ns_nb_config_ul_power_req_msg_type), /* FTM_LTE_NS_NB_CONFIG_UL_POWER_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_CONFIG_UL_POWER,     FTM_LTE_NS_NB_CONFIG_UL_POWER_CMD_CODE_C,       ftm_lte_ns_nb_config_ul_power_cnf_msg_type), /* FTM_LTE_NS_NB_CONFIG_UL_POWER_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_GET_DL_LEVEL,        FTM_LTE_NS_NB_GET_DL_LEVEL_CMD_CODE_C,          ftm_lte_ns_nb_get_dl_level_req_msg_type), /* FTM_LTE_NS_NB_GET_DL_LEVEL_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_GET_DL_LEVEL,        FTM_LTE_NS_NB_GET_DL_LEVEL_CMD_CODE_C,          ftm_lte_ns_nb_get_dl_level_cnf_msg_type), /* FTM_LTE_NS_NB_GET_DL_LEVEL_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_RESET_DL_BLER_REPORT,       FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CMD_CODE_C,  ftm_lte_ns_nb_reset_dl_bler_req_msg_type), /* FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_RESET_DL_BLER_REPORT,       FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CMD_CODE_C,  ftm_lte_ns_nb_reset_dl_bler_cnf_msg_type), /* FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CNF */

  MSGR_DEFINE_UMID(FTM, LTE_NS, REQ, NB_GET_DL_BLER_REPORT,         FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CMD_CODE_C,    ftm_lte_ns_nb_get_dl_bler_req_msg_type), /* FTM_LTE_NS_NB_GET_DL_BLER_REPORT_REQ */
  MSGR_DEFINE_UMID(FTM, LTE_NS, CNF, NB_GET_DL_BLER_REPORT,         FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CMD_CODE_C,    ftm_lte_ns_nb_get_dl_bler_cnf_msg_type), /* FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CNF */
#endif
};
...
#ifdef FEATURE_NB1_PLT
/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_START_LTE_MODE_REQ
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
} ftm_lte_ns_nb_start_mode_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_START_LTE_MODE_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_start_mode_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_START_LTE_MODE_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_start_mode_cnf_diag_rsp_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_STOP_LTE_MODE_REQ
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
} ftm_lte_ns_nb_stop_mode_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_STOP_LTE_MODE_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_stop_mode_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_STOP_LTE_MODE_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_stop_mode_cnf_diag_rsp_type;
...
typedef PACK(struct)
{
   ...
   */
  lte_earfcn_t         earfcn;
} ftm_lte_ns_nb_acq_req_data_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_ACQ_REQ
 */
typedef struct
{
  msgr_hdr_struct_type         hdr;
  ftm_lte_ns_nb_acq_req_data_type acq_data;
} ftm_lte_ns_nb_acq_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_ACQ_CNF
 */
typedef PACK(struct)
{
  msgr_hdr_struct_type  hdr;
  ...
  /* Cell ID of the acquired system. 0..503 */
  lte_phy_cell_id_t    cell_id;
} ftm_lte_ns_nb_acq_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_ACQ_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  ...
  /* Cell ID of the acquired system. 0..503 */
  lte_phy_cell_id_t    cell_id;
} ftm_lte_ns_nb_acq_cnf_diag_rsp_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_IDLE_REQ
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
} ftm_lte_ns_nb_idle_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_IDLE_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_idle_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_IDLE_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_idle_cnf_diag_rsp_type;

/*This needs further discussion with ML1.*/
/*! @brief This structure holds the parameters of START_DP_REQ that was last sent to LTE L1
           These parameters will be used to configure DP data path           
    @param c_rnti the C-RNTI used by the UE
    @param add_spec_emission_cfg The NS_XX value for additional spectrum emission configuration
...
typedef PACK(struct)
{
  ...
  /*! NPDCCH Start SF USS*/
  uint8                 start_sf_uss;
} ftm_lte_ns_nb_dp_req_data_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_START_DP_REQ
 *
 */
typedef struct
{
  msgr_hdr_struct_type        hdr;
  ftm_lte_ns_nb_dp_req_data_type dp_cfg_data;
} ftm_lte_ns_nb_start_dp_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_START_DP_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_start_dp_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NB_NS_START_DP_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_start_dp_cnf_diag_rsp_type;


/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_IS_CONN_REQ
 */
typedef struct
{
  msgr_hdr_struct_type hdr;
} ftm_lte_ns_nb_is_conn_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_IS_CONN_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_is_conn_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_IS_CONN_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_is_conn_cnf_diag_rsp_type;
...
typedef enum
{
  FTM_NS_NB_UL_SINGLE_TONE_3_75_KHZ,
  FTM_NS_NB_UL_SINGLE_TONE_15_KHZ,
  FTM_NS_NB_UL_MULTI_TONE_3,
  FTM_NS_NB_UL_MULTI_TONE_6,
  FTM_NS_NB_UL_MULTI_TONE_12
} ftm_lte_ns_nb_ul_tone_bw_e;

typedef enum
{
    FTM_NS_NB_MOD_BPSK      = 0,
    FTM_NS_NB_MOD_QPSK      = 1,
    FTM_NS_NB_MOD_16QAM     = 2,
    FTM_NS_NB_MOD_64QAM     = 3,
    FTM_NS_NB_NUM_OF_MOD 
}ftm_lte_ns_nb_mod_type_s;	

/*This needs further discussio with ML1*/
typedef PACK(struct)
{
  ftm_lte_ns_nb_mod_type_s mod;
  ftm_lte_ns_nb_ul_tone_bw_e tone_bw;
  uint8 start_tone_idx;
  int8 tx_pwr_dbm;
} ftm_lte_ns_nb_config_ul_waveform_req_data_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_REQ
 */

typedef struct
{
  msgr_hdr_struct_type         hdr;
  ftm_lte_ns_nb_config_ul_waveform_req_data_type ul_waveform_data;
} ftm_lte_ns_nb_config_ul_waveform_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_RSP
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_config_ul_waveform_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM_RSP
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_config_ul_waveform_cnf_diag_rsp_type;
...
*/
/*This needs further discussion with ML1/FW team*/
typedef PACK(struct)
{
 int16 tx_level_dB10;
} ftm_lte_ns_nb_config_ul_power_req_data_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_CONFIG_UL_POWER_REQ
 */
typedef struct
{
  msgr_hdr_struct_type         hdr;
  ftm_lte_ns_nb_config_ul_power_req_data_type ul_power_data;
} ftm_lte_ns_nb_config_ul_power_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_CONFIG_UL_POWER_RSP
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_config_ul_power_cnf_msg_type;
...
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_config_ul_power_cnf_diag_rsp_type;


/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_GET_DL_LEVEL_REQ
 */
typedef struct
{
  msgr_hdr_struct_type         hdr;
} ftm_lte_ns_nb_get_dl_level_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_GET_DL_LEVEL_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
  int16                 rx_power_dBm; /*! Rx Power in dBm units*/
} ftm_lte_ns_nb_get_dl_level_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_GET_DL_LEVEL_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
  int16                            rx_power_dBm; /*! Rx Power in dBm units*/
} ftm_lte_ns_nb_get_dl_level_diag_rsp_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_REQ
 */
typedef struct
{
  msgr_hdr_struct_type hdr;
} ftm_lte_ns_nb_reset_dl_bler_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  errno_enum_type       status;
} ftm_lte_ns_nb_reset_dl_bler_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_RESET_DL_BLER_REPORT_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  errno_enum_type                  status;
} ftm_lte_ns_nb_reset_dl_bler_cnf_diag_rsp_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_GET_DL_BLER_REPORT_REQ
 */
typedef struct
{
  msgr_hdr_struct_type hdr;
} ftm_lte_ns_nb_get_dl_bler_req_msg_type;

/*! @brief This structure defines the message format of the
 *         FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CNF
 */
typedef struct
{
  msgr_hdr_struct_type  hdr;
  ...
  uint32                total_block_errors; /*NACKS*/
  uint32                throughput;  /*Raw bits per sec*/
} ftm_lte_ns_nb_get_dl_bler_cnf_msg_type;

/*! @brief This structure defines the message format of the
 *         diag response packet for FTM_LTE_NS_NB_GET_DL_BLER_REPORT_CNF
 */
typedef PACK(struct)
{
  ftm_lte_ns_diag_rsp_pkt_hdr_type hdr;
  ...
  uint32                total_block_errors; /*NACKS*/
  uint32                throughput;  /*Raw bits per sec*/
} ftm_lte_ns_nb_get_dl_bler_cnf_diag_rsp_type;
#endif
/*===========================================================================
