...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/api/gsm/ftm_gsm.h#1 $ 
...
typedef PACK(struct)
{
  int32       ftm_wbdc_offset_i;
  int32       ftm_wbdc_offset_q;
} ftm_wbdc_offset_type;
...
typedef PACK(struct)
{
  ...
  ftm_wbdc_offset_type ftm_wbdc_offset;
...
typedef PACK(struct) 
{
  ...
  boolean toggle_rx_on;
  uint32 rssi_result[8];
  int32  wbdcEstI_PRx[8];
  int32  wbdcEstQ_PRx[8];
}ftm_gsm_rx_wbdc_cal_parms_type;
...
typedef PACK(struct)
{
  ...
  PACK(union)
  {
	...
	ftm_gsm_rx_wbdc_cal_parms_type            ftm_wbdccal_parms;
