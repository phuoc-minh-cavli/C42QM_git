...
$Header: //components/rel/rfa.mpss/3.10/api/gsm/rfgsm_core_types.h#3 $
...
#define RFGSM_MAX_DPLL_GUARD_BITS  50
...
#define RFGSM_MAX_UNIQUE_RFCOM_BANDS (RFCOM_NUM_GSM_BANDS)
...
typedef struct
{
  ...
  void *ustmr_sync_script;
  void *jdet_disable_trigger_script;

  void *fsk_enter_mode_script;
  void *fsk_tx_band_script;
  void *fsk_tx_enable_script[TX_MAX_SCRIPT];
  void *fsk_tx_start_script[TX_MAX_SCRIPT];
  void *fsk_tx_stop_script[TX_MAX_SCRIPT];
  void *fsk_tx_trans_script[TX_TRANS_MAX_SCRIPT][RFGSM_MAX_TX_SLOTS_PER_FRAME];
  void *fsk_tx_afc_pos_script;
  void *fsk_tx_afc_neg_script;
  void *fsk_tx_disable_script[TX_MAX_SCRIPT];
  void *fsk_tx_sleep_script;
  void *fsk_exit_script;
...
#define RFGSM_US_TO_QS(time_us) (uint16)(time_us *NUM_QS_PER_100_USEC/100 )
...
#define TWIZY_MODEM
//Let us get it from the CCS team for accurate timings. This will do for now.
#ifndef TWIZY_MODEM
		#define RFGSM_MB_RFFE_TIME_CALC_QS(num_rffes) (uint16)(num_rffes * 4.11) 
#else   			            
  #define RFGSM_MB_RFFE_TIME_CALC_QS(num_rffes) (uint16)(num_rffes * 2.38) 
#endif               

#define RFGSM_RF_RX_SETUP_TIME_QS(num_rffes, pll_tune_time) RFGSM_MB_RFFE_TIME_CALC_QS(num_rffes) + pll_tune_time

#define RFGSM_KV_LENGTH_CALC_QS(num_gb) (uint16)(num_gb*4)     
...
#define RFGC_T_MSG_8(lvl, txt, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)        MSG_9( MSG_SSID_RF, lvl, "|tsk:%d|" txt, rf_task, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
