...
$Header: //components/rel/rfa.mpss/3.10/api/gsm/rfgsm_msg.h#2 $
$DateTime: 2020/05/25 02:39:51 $
$Author: mplcsds1 $
...
#define RFA_RF_GSM_MSG_ID_PSM_ENTRY             0x1A
#define RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE         0x1B
#define RFA_RF_GSM_MSG_ID_FSK_TX_BAND           0x1C
#define RFA_RF_GSM_MSG_ID_FSK_TX_BURST          0x1D
#define RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE        0x1E
#define RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP          0x1F
#define RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE        0x20
#define RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE         0x21
...
#define RFA_RF_GSM_MSG_ID_MAX_SUB1_MSGS              0x2F

/*! @define MSGR SUB2 IDs                              */
/*! @brief SUB2 IDs for all of the commands to RF GSM  */
#define RFA_RF_GSM_MSG_ID_ENTER_MODE_SUB2            0x31
#define RFA_RF_GSM_MSG_ID_RX_ENTER_MODE_SUB2         0x32
#define RFA_RF_GSM_MSG_ID_GTA_ENTER_MODE_SUB2        0x33
#define RFA_RF_GSM_MSG_ID_GTA_EXIT_MODE_SUB2         0x34
#define RFA_RF_GSM_MSG_ID_WAKEUP_SUB2                0x35
#define RFA_RF_GSM_MSG_ID_SLEEP_SUB2                 0x36
#define RFA_RF_GSM_MSG_ID_TX_ENABLE_SUB2             0x37
#define RFA_RF_GSM_MSG_ID_TX_DISABLE_SUB2            0x38
#define RFA_RF_GSM_MSG_ID_RX_BURST_SUB2              0x39
#define RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB2           0x3A
#define RFA_RF_GSM_MSG_ID_TX_BURST_SUB2              0x3B
#define RFA_RF_GSM_MSG_ID_GET_TIMING_INFOR_SUB2      0x3C
#define RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING_SUB2 0x3D
#define RFA_RF_GSM_MSG_ID_VREG_ON_SUB2               0x3E
#define RFA_RF_GSM_MSG_ID_VREG_OFF_SUB2              0x3F
#define RFA_RF_GSM_MSG_ID_EXIT_MODE_SUB2             0x40
#define RFA_RF_GSM_MSG_ID_SET_SAR_LIMIT_SUB2         0x41
#define RFA_RF_GSM_MSG_ID_CM_ENTER_SUB2              0x42
#define RFA_RF_GSM_MSG_ID_CM_EXIT_SUB2               0x43
#define RFA_RF_GSM_MSG_ID_UPDATE_TEMP_COMP_SUB2      0x44
#define RFA_RF_GSM_MSG_ID_SET_ANTENNA_SUB2           0x45
#define RFA_RF_GSM_MSG_ID_HAL_VOTE_SUB2              0x46
#define RFA_RF_GSM_MSG_ID_START_IP2_CAL_SUB2         0x47
#define RFA_RF_GSM_MSG_ID_INIT_MSM_IP2_CAL_SUB2      0x48
#define RFA_RF_GSM_MSG_ID_PROCESS_BURST_METRICS_SUB2 0x49
#define RFA_RF_GSM_MSG_ID_PSM_ENTRY_SUB2             0x4A
#define RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB2        0x5B
#define RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB2         0x5C
#define RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB2           0x5D
#define RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB2          0x5E
#define RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB2        0x5F
#define RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB2          0x60
#define RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB2         0x61

/* **********Place Next SUB2 Message Here************* */
#define RFA_RF_GSM_MSG_ID_MAX_SUB2_MSGS              0x6F

/*! @define MSGR SUB3 IDs                              */
/*! @brief SUB3 IDs for all of the commands to RF GSM  */
#define RFA_RF_GSM_MSG_ID_ENTER_MODE_SUB3            0x71
#define RFA_RF_GSM_MSG_ID_RX_ENTER_MODE_SUB3         0x72
#define RFA_RF_GSM_MSG_ID_GTA_ENTER_MODE_SUB3        0x73
#define RFA_RF_GSM_MSG_ID_GTA_EXIT_MODE_SUB3         0x74
#define RFA_RF_GSM_MSG_ID_WAKEUP_SUB3                0x75
#define RFA_RF_GSM_MSG_ID_SLEEP_SUB3                 0x76
#define RFA_RF_GSM_MSG_ID_TX_ENABLE_SUB3             0x77
#define RFA_RF_GSM_MSG_ID_TX_DISABLE_SUB3            0x78
#define RFA_RF_GSM_MSG_ID_RX_BURST_SUB3              0x79
#define RFA_RF_GSM_MSG_ID_SET_TX_BAND_SUB3           0x7A
#define RFA_RF_GSM_MSG_ID_TX_BURST_SUB3              0x7B
#define RFA_RF_GSM_MSG_ID_GET_TIMING_INFOR_SUB3      0x7C
#define RFA_RF_GSM_MSG_ID_IDLE_FRAME_PROCESSING_SUB3 0x7D
#define RFA_RF_GSM_MSG_ID_VREG_ON_SUB3               0x7E
#define RFA_RF_GSM_MSG_ID_VREG_OFF_SUB3              0x7F
#define RFA_RF_GSM_MSG_ID_EXIT_MODE_SUB3             0x80
#define RFA_RF_GSM_MSG_ID_SET_SAR_LIMIT_SUB3         0x81
#define RFA_RF_GSM_MSG_ID_CM_ENTER_SUB3              0x82
#define RFA_RF_GSM_MSG_ID_CM_EXIT_SUB3               0x83
#define RFA_RF_GSM_MSG_ID_UPDATE_TEMP_COMP_SUB3      0x84
#define RFA_RF_GSM_MSG_ID_HAL_VOTE_SUB3              0x85
#define RFA_RF_GSM_MSG_ID_START_IP2_CAL_SUB3         0x86
#define RFA_RF_GSM_MSG_ID_INIT_MSM_IP2_CAL_SUB3      0x87
#define RFA_RF_GSM_MSG_ID_PROCESS_BURST_METRICS_SUB3 0x88
#define RFA_RF_GSM_MSG_ID_PSM_ENTRY_SUB3             0x89
#define RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB3        0x8A
#define RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB3         0x8B
#define RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB3           0x8C
#define RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB3          0x8D
#define RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB3        0x8E
#define RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB3          0x8F
#define RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB3         0x90

/* **********Place Next SUB3 Message Here************* */
#define RFA_RF_GSM_MSG_ID_MAX_SUB3_MSGS              0x9F
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_ENTER_MODE,	  RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE,   rfa_rf_gsm_enter_mode_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_ENABLE,	  RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE,	   rfa_rf_gsm_tx_enable_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BAND,	  RFA_RF_GSM_MSG_ID_FSK_TX_BAND,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BURST,  RFA_RF_GSM_MSG_ID_FSK_TX_BURST,	   rfa_rf_gsm_tx_burst_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_DISABLE,	  RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_SLEEP,  RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP,	   rfa_rf_gsm_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_EXIT_MODE,	  RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE,	   rfa_rf_gsm_exit_mode_cnf_s),
};
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_ENTER_MODE_SUB2,		RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB2,	rfa_rf_gsm_enter_mode_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_ENABLE_SUB2,	RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB2,	 rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BAND_SUB2,	  RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB2,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BURST_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB2,	 rfa_rf_gsm_tx_burst_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_DISABLE_SUB2,	  RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB2,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_SLEEP_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB2,	 rfa_rf_gsm_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_EXIT_MODE_SUB2,	RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB2,	 rfa_rf_gsm_exit_mode_cnf_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_ENTER_MODE_SUB3, 	  RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB3,  rfa_rf_gsm_enter_mode_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_ENABLE_SUB3,	  RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB3,    rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BAND_SUB3,	  RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB3,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_BURST_SUB3,     RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB3,    rfa_rf_gsm_tx_burst_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_DISABLE_SUB3,	  RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB3,	   rfa_rf_gsm_set_tx_band_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_TX_SLEEP_SUB3,     RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB3,    rfa_rf_gsm_sleep_cnf_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, CNF, FSK_EXIT_MODE_SUB3,	RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB3,    rfa_rf_gsm_exit_mode_cnf_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, GTA_EXIT_MODE,    RFA_RF_GSM_MSG_ID_GTA_EXIT_MODE,      rfa_rf_gsm_gta_exit_mode_req_s), 
   ...
   MSGR_DEFINE_UMID(RFA, RF_GSM, IND, PSM_ENTRY,    RFA_RF_GSM_MSG_ID_PSM_ENTRY,    rfa_rf_gsm_psm_entry_ind_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_ENTER_MODE,	 RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE,   rfa_rf_gsm_enter_mode_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_ENABLE,	 RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE,	  rfa_rf_gsm_tx_enable_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BAND,	 RFA_RF_GSM_MSG_ID_FSK_TX_BAND,	  rfa_rf_gsm_set_tx_band_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BURST,  RFA_RF_GSM_MSG_ID_FSK_TX_BURST,	  rfa_rf_gsm_tx_burst_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_DISABLE,	RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE,	 rfa_rf_gsm_tx_disable_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_SLEEP,  RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP,	  rfa_rf_gsm_sleep_req_s),
   MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_EXIT_MODE,	 RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE,	  rfa_rf_gsm_exit_mode_req_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, PSM_ENTRY_SUB2,    RFA_RF_GSM_MSG_ID_PSM_ENTRY_SUB2,    rfa_rf_gsm_psm_entry_ind_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_ENTER_MODE_SUB2,   RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB2,   rfa_rf_gsm_enter_mode_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_ENABLE_SUB2,	RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB2,	 rfa_rf_gsm_tx_enable_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BAND_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB2,    rfa_rf_gsm_set_tx_band_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BURST_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB2,    rfa_rf_gsm_tx_burst_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_DISABLE_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB2,    rfa_rf_gsm_tx_disable_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_SLEEP_SUB2,  RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB2,    rfa_rf_gsm_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_EXIT_MODE_SUB2,	RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB2,	 rfa_rf_gsm_exit_mode_req_s),
...
enum
{
  ...
  MSGR_DEFINE_UMID(RFA, RF_GSM, IND, PSM_ENTRY_SUB3,    RFA_RF_GSM_MSG_ID_PSM_ENTRY_SUB3,    rfa_rf_gsm_psm_entry_ind_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_ENTER_MODE_SUB3,   RFA_RF_GSM_MSG_ID_FSK_ENTER_MODE_SUB3,   rfa_rf_gsm_enter_mode_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_ENABLE_SUB3,	RFA_RF_GSM_MSG_ID_FSK_TX_ENABLE_SUB3,	 rfa_rf_gsm_tx_enable_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BAND_SUB3,	RFA_RF_GSM_MSG_ID_FSK_TX_BAND_SUB3,	 rfa_rf_gsm_set_tx_band_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_BURST_SUB3,  RFA_RF_GSM_MSG_ID_FSK_TX_BURST_SUB3,    rfa_rf_gsm_tx_burst_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_DISABLE_SUB3,  RFA_RF_GSM_MSG_ID_FSK_TX_DISABLE_SUB3,    rfa_rf_gsm_tx_disable_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_TX_SLEEP_SUB3,  RFA_RF_GSM_MSG_ID_FSK_TX_SLEEP_SUB3,    rfa_rf_gsm_sleep_req_s),
  MSGR_DEFINE_UMID(RFA, RF_GSM, REQ, FSK_EXIT_MODE_SUB3,	RFA_RF_GSM_MSG_ID_FSK_EXIT_MODE_SUB3,	 rfa_rf_gsm_exit_mode_req_s),
...
typedef struct
{
  uint8                     num_tx_slots;
  uint8                     num_assigned_uplink_slots;
  rfgsm_fsk_tx_chan_params_type tx_chan_params;
  rfgsm_power_profile_type  tx_pwr_ctl_params[RFGSM_MAX_TX_SLOTS_PER_FRAME];
  void                      *tx_burst_event_ptr;
}rfa_rf_fsk_tx_burst_type;
...
typedef struct
{
  boolean is_nb_jdet_supported;
  uint32  wbee_nb_jdet_threshold_g0[RFCOM_NUM_GSM_BANDS];
  uint32  wbee_nb_jdet_threshold_g1[RFCOM_NUM_GSM_BANDS];
} rfgsm_nb_jdet_threshold;
...
typedef struct
{
  ...
  rfgsm_nb_jdet_threshold       *nb_jdet_thr;
...
typedef struct
{
  boolean                       nb_jdet_trigger;
  boolean                       nb_jdet_detected;
} rfa_rf_gsm_nb_jdet_type;
...
typedef struct
{
  ...
  uint8                         buffer_id;
  rfa_rf_gsm_nb_jdet_type       nb_jdet_req;
  rfa_rf_gsm_cmd_outcome_t      req_result;
  boolean                       hmsc_active;
...
typedef struct
{
  ...
  boolean                       cnf_required;
  uint8                         buffer_id;
  rfa_rf_fsk_tx_burst_type      *tx_burst_params;
  rfa_rf_gsm_cmd_outcome_t      req_result;
} rfa_rf_fsk_tx_burst_req_s;
