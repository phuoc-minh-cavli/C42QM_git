...
$DateTime: 2020/09/14 00:30:59 $ $Author: mplcsds1 $
$Header: //components/rel/rfa.mpss/3.10/api/gsm/rfgsm_mc.h#3 $
...
typedef enum 
{
  RFGSM_OFFLOAD_NO_ERROR,
  RFGSM_OFFLOAD_INVALID_BAND_DATA,
  RFGSM_OFFLOAD_ERROR,
}rfgsm_offload_status_type;
...
/*----------------------------------------------------------------------------*/
extern rfgsm_mc_status_type rfgsm_mc_fsk_enter_mode(rfgsm_core_data_type *core_data,
                                         uint32 txlm_buf_idx,
                                         const void *enter_mode_ptr,
                                         rfgsm_timing_info_type *timing_info,
                                         rfgsm_nb_jdet_threshold *nb_jdet_thr);
...
/*----------------------------------------------------------------------------*/
extern rfgsm_mc_status_type rfgsm_mc_fsk_enable_tx( rfgsm_core_data_type *core_data,
                                         uint32 txlm_buf_idx );
...
extern rfgsm_mc_status_type rfgsm_mc_fsk_disable_tx( rfgsm_core_data_type *core_data,
                                          uint32 txlm_buf_idx );
