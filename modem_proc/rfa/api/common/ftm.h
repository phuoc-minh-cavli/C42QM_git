...
Copyright (c) 2002 - 2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/rfa.mpss/3.10/api/common/ftm.h#1 $
...
11/12/16   qzh     Add FTM RF mode changes and customer API support for CATM1 UL Hop
10/20/16   as      Adding support for FTM mode CATM1 Rx NB hopping validation
...
typedef enum
{
  FTM_NB_UL_SINGLE_TONE_3_75_KHZ,
  FTM_NB_UL_SINGLE_TONE_15_KHZ,
  FTM_NB_UL_MULTI_TONE_3,
  FTM_NB_UL_MULTI_TONE_6,
  FTM_NB_UL_MULTI_TONE_12
} ftm_lte_nb_ul_tone_bw_e;
...
typedef PACK(struct)
{
  ...
  uint32                           start_chan;
  uint8                            step_size; 
} ftm_rf_nb_rx_param_type;

typedef PACK(struct)
{
  ftm_lte_nb_mod_type_s mod;
  ftm_lte_nb_ul_tone_bw_e tone_bw;
  uint8 start_tone_idx;
  int8 tx_pwr_dbm;
} ftm_rf_nb_set_waveform_s;
...
typedef PACK(struct)
{
    ...
    union {
        ...
        /*NB1 NS*/
        /* This is the payload information for FTM_LTE_NS_NB_ACQ_REQ*/
        ftm_lte_ns_nb_acq_req_data_type nb_acq_req_data;
        /* This is the payload information for FTM_LTE_NS_NB_START_DP_REQ*/
        ftm_lte_ns_nb_dp_req_data_type nb_dp_req_data;
        /* This is the payload information for FTM_LTE_NS_NB_CONFIG_UL_WAVEFORM*/
        ftm_lte_ns_nb_config_ul_waveform_req_data_type nb_ul_waveform_req_data;
        /* This is the payload information for FTM_LTE_NS_NB_CONFIG_UL_POWER*/
        ftm_lte_ns_nb_config_ul_power_req_data_type nb_ul_power_req_data;
#endif
        ...
        /* This is the payload information for FTM_SET_HD_FDD*/
        uint8 hd_fdd;
        /* This is the payload information for FTM_LTE_RX_NB_RETUNE*/
        uint8 nb_region;
        /* This is the payload information for FTM_LTE_SET_TX_NB_REGION*/
        uint8 ul_nb_region;
        /* This is the payload information for FTM_SET_NB_MODE*/
        uint8 nb_mode;  
        /* This is the payload information for FTM_LTE_CONFIG_FS_CHAN_LIST*/
        ftm_rf_nb_rx_param_type fs_chan_list;
		    /* This is the payload information for FTM_LTE_NB_FS_RETUNE*/
        rfcom_lte_earfcn_type fs_channel;        
        /* This is the payload information for FTM_LTE_NB_SET_WAVEFORM*/
        ftm_rf_nb_set_waveform_s nb_set_waveform;
        /* This is the payload information for FTM_LTE_NB_SET_UL_CARRIER_FREQ_OFFSET*/
        int8 ul_carrier_freq_offset;
        /* This is the payload information for FTM_LTE_NB_ENABLE_RX*/
        boolean nb_enable_rx;
    };
