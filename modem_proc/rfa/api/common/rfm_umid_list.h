...
$Header: //components/rel/rfa.mpss/3.10/api/common/rfm_umid_list.h#1 $
...
/*
  @brief
  This is the structure which contains MAAT info that RFM dispatches to apps task
*/
typedef struct
{
  /* MSGR header */
