...
$Header: //components/rel/rfa.mpss/3.10/api/common/ftm_mgr_msg.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
11/21/18   as      FR 51019: Lower layer config optimization for CATM/NB1
...
typedef union
{
  ...
  ftm_lte_ns_nb_start_mode_req_msg_type   nb_start_mode_req_msg;
  ftm_lte_ns_nb_start_mode_cnf_msg_type   nb_start_mode_cnf_msg;
  ftm_lte_ns_nb_stop_mode_req_msg_type    nb_stop_mode_req_msg;
  ftm_lte_ns_nb_stop_mode_cnf_msg_type    nb_stop_mode_cnf_msg;
  ftm_lte_ns_nb_acq_req_msg_type          nb_acq_req_msg;
  ftm_lte_ns_nb_acq_cnf_msg_type          nb_acq_cnf_msg;
  ftm_lte_ns_nb_start_dp_req_msg_type     nb_start_dp_req_msg;
  ftm_lte_ns_nb_start_dp_cnf_msg_type     nb_start_dp_cnf_msg;
  ftm_lte_ns_nb_idle_req_msg_type         nb_idle_req_msg;
  ftm_lte_ns_nb_idle_cnf_msg_type         nb_idle_cnf_msg;
  ftm_lte_ns_nb_is_conn_req_msg_type      nb_is_conn_req_msg;
  ftm_lte_ns_nb_is_conn_cnf_msg_type      nb_is_conn_cnf_msg;
  ftm_lte_ns_nb_config_ul_waveform_req_msg_type nb_config_ul_waveform_req_msg;
  ftm_lte_ns_nb_config_ul_waveform_cnf_msg_type nb_config_ul_waveform_cnf_msg;
  ftm_lte_ns_nb_config_ul_power_req_msg_type nb_config_ul_power_req_msg;
  ftm_lte_ns_nb_config_ul_power_cnf_msg_type nb_config_ul_power_cnf_msg;
  ftm_lte_ns_nb_get_dl_level_req_msg_type nb_get_dl_level_req_msg;
  ftm_lte_ns_nb_get_dl_level_cnf_msg_type nb_get_dl_level_cnf_msg;
  ftm_lte_ns_nb_reset_dl_bler_req_msg_type nb_reset_dl_bler_req_msg;
  ftm_lte_ns_nb_reset_dl_bler_cnf_msg_type nb_reset_dl_bler_cnf_msg;
  ftm_lte_ns_nb_get_dl_bler_req_msg_type nb_get_dl_bler_req_msg;
  ftm_lte_ns_nb_get_dl_bler_cnf_msg_type nb_get_dl_bler_cnf_msg;
#endif
  ...
  lte_cphy_cfg_cnf_s           lte_cfg_cnf_msg;
