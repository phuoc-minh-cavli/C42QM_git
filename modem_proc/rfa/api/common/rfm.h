...
/*===========================================================================
Copyright (c) 2002 - 2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/rfa.mpss/3.10/api/common/rfm.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/22/19   up      Added debug structure rfdevice_iotfe_therm_debug_type
04/15/19   as      Non Anchor Tx retune changes
02/25/19   dh      Added supoort for PA therm
...
#define RFM_INVALID_THERM_HANDLE 0xFF

extern boolean rfm_init_status;
/*----------------------------------------------------------------------------*/
...
typedef enum
{
  RFM_LTE_NB_CARRIER_ANCHOR = 0,
  RFM_LTE_NB_CARRIER_NON_ANCHOR,
  RFM_LTE_NB_CARRIER_NUM,
  RFM_LTE_NB_CARRIER_INVALID = 0XFF
}rfm_lte_nb_carrier_type_e;
...
typedef struct
{
  ...
  /*time stamp of the therm read in XO counts*/
  unsigned long long therm_read_time_stamp;
...
typedef enum
{
 RFM_THERM_DEVICE_TYPE_WTR,
 RFM_THERM_DEVICE_TYPE_NON_WTR,
 RFM_THERM_DEVICE_TYPE_MAX,
 RFM_THERM_DEVICE_TYPE_INVALID = 0xFF
}rfm_therm_device_type_enum_type;
...
typedef struct
{
  ...
  /*specifies the thermistor device type (e.g wtr thermistor, PA thermistor*/
  rfm_therm_device_type_enum_type therm_device_type;

  rfm_thermistor_result_type therm_result;

}rfm_thermistor_type;

/*! PA therm RF HAL vote debug structure */
typedef struct
{
  void* client_handle;
  uint32  therm_mitigation_hal_vote_count;
}rfdevice_iotfe_therm_debug_type;
...
/*----------------------------------------------------------------------------*/
void rfm_nb_get_txpll_script( rfm_mode_enum_type mode,
                              int32 rx_freq_error_in_hz, 
                              void* txpll_script_buf_ptr);
