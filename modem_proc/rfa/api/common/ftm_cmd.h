...
/*===========================================================================
  ...
  $Header: //components/rel/rfa.mpss/3.10/api/common/ftm_cmd.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/18/16   rs      Compiler error Fix for HDR disabled builds
08/22/16   pkm     RF compilation fix for Pack update of JO.3.0.1 to remove HDR files
...
#ifndef FEATURE_GNSS_ONLY_NO_WWAN
#ifdef FEATURE_HDR
void hdrftm_acmac_get_ap_msg( hdrcp_ovhd_ap_msg_type * ap_msg);
#endif
#endif
