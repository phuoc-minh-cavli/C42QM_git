...
-------------------------------------------------------------------------------
  ...
  $Header: //components/rel/build.mpss/2.2.8.1.c5.0.1/ms/build_variant.py#1 $
...
def call_scons (lg, scons, cfg, cleaned_args, cfg_subdir):
    ...
    for env_flag in cfg.env_flags:
        os.environ[env_flag] = cfg.env_flags[env_flag]
...
if __name__ == "__main__":
    ...
    try:
        ...
        lg.log("Running $Header: //components/rel/build.mpss/2.2.8.1.c5.0.1/ms/build_variant.py#1 $")
