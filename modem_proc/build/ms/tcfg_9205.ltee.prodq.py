...
def exists(env):
   return env.Detect('tcfg_9205.ltee.prodQ_data')
...
def generate(env):
   ...
   env.AddUsesFlags('USES_EXCLUDE_NB1_FW', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_FEATURE_AUDIO_TX_MEM_OPT', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_FEATURE_USSD_PS_ENABLED', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_IMS_VOLTE', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_RCINIT_OPTION_FORCE_ALIASMAP', from_builds_file = True)
