...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/build.mpss/2.2.8.1.c5.0.1/ms/oem_pack.py#1 $
...
if __name__ == "__main__":
    ...
    log ("Script Version is: $Header: //components/rel/build.mpss/2.2.8.1.c5.0.1/ms/oem_pack.py#1 $")
    if len(sys.argv) == 1:
        log ("No parameters")
    else:
        log ("Parameters:")
