...
/*==============================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8.6.c2/api/listen/inc/framework_module.h#1 $
...
#define LSM_MAX_NUM_CHANNELS_V2 8
...
struct lsm_param_id_media_fmt_v2
{
  ...
  uint8_t channel_mapping[LSM_MAX_NUM_CHANNELS_V2];
...
/* Minor version of this PARAM */
#define LSM_API_VERSION_MEDIA_FMT_V2   0x1

/* Structure definition for Parameter */
typedef struct lsm_param_id_media_fmt_v3 lsm_param_id_media_fmt_v3_t;
/** @h2xmlp_parameter   {"LSM_PARAM_ID_MEDIA_FMT_V2", LSM_PARAM_ID_MEDIA_FMT_V2}
    @h2xmlp_description {Provides media format information for the LSM session.}
    @h2xmlp_version     {LSM_API_VERSION_MEDIA_FMT_V2}
    @h2xmlp_toolPolicy  {NO_SUPPORT} */
#include "adsp_begin_pack.h"
struct lsm_param_id_media_fmt_v3
{
  uint32_t minor_version;
  /**< @h2xmle_description {Tracks the current version of this parameter.}
       @h2xmle_range       {1..LSM_API_VERSION_MEDIA_FMT_V2}
       @h2xmle_default     {LSM_API_VERSION_MEDIA_FMT_V2}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
  ...
  /**< @h2xmle_description {Variable-sized channel mapping of the LSM session
                            where size is determined by num_channels field.}
       @h2xmle_range       {1..63}
       @h2xmle_default     {1} */
}
#include "adsp_end_pack.h"
