...
$Header: //components/rel/avs.adsp/2.8.6.c2/api/afe/inc/prop/adsp_afe_service_modules_params.h#1 $
...
/* ID of the event raised by speaker protection module to indicate the
 * presence of DC in the content
 */
