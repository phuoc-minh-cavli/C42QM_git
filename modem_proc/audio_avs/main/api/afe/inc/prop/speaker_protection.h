...
/*==============================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8.6.c2/api/afe/inc/prop/speaker_protection.h#1 $
...
#define AFE_API_VERSION_SP_RX_STATIC_CFG     0x3
...
typedef struct afe_sp_rx_static_cfg_v3_t afe_sp_rx_static_cfg_v3_t;
...
struct afe_sp_rx_static_cfg_v3_t
{
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_RX_STATIC_CFG_V2     0x2
...
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_RX_STATIC_CFG",
    ...
    @h2xmlp_description {parameter used to configure the static configuration of
                         speaker protection Rx processing.}
    @h2xmlp_version     {AFE_API_VERSION_SP_RX_STATIC_CFG_V2} */
#include "adsp_begin_pack.h"
struct afe_sp_rx_static_cfg_v2_t
{
  ...
  /**< @h2xmle_description {Minor version used for tracking the version of
                            this parameter ID}
       @h2xmle_range       {1..AFE_API_VERSION_SP_RX_STATIC_CFG_V2}
       @h2xmle_default     {AFE_API_VERSION_SP_RX_STATIC_CFG_V2}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
...
/* Unique Paramter id */
#define AFE_PARAM_ID_SP_RX_TRANSITION_ASP_ENABLE         0x000102B5
...
/* Structure definition for Parameter */
typedef struct afe_sp_rx_transition_asp_enable_t afe_sp_rx_transition_asp_enable_t;
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_RX_TRANSITION_ASP_ENABLE",
                         AFE_PARAM_ID_SP_RX_TRANSITION_ASP_ENABLE}
    @h2xmlp_description {parameter used to enable transition acoustic shock protection
                         feature.}
     */

#include "adsp_begin_pack.h"
struct afe_sp_rx_transition_asp_enable_t
{
...
/* Unique Paramter id */
#define AFE_PARAM_ID_SP_RX_TRANSITION_ASP_CALIB_PARAM         0x000102B6

/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_RX_TRANSITION_ASP_CALIB_PARAM_V1    0x1
...
/* Structure definition for Parameter */
typedef struct afe_sp_rx_transition_asp_calib_param_v1_t afe_sp_rx_transition_asp_calib_param_v1_t;
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_RX_TRANSITION_ASP_CALIB_PARAM",
                         AFE_PARAM_ID_SP_RX_TRANSITION_ASP_CALIB_PARAM}
    @h2xmlp_description {parameter used for logging the algorithm internal
                         variables.}
    @h2xmlp_version     {AFE_API_VERSION_SP_RX_TRANSITION_ASP_CALIB_PARAM_V1}
     */

#include "adsp_begin_pack.h"
struct afe_sp_rx_transition_asp_calib_param_v1_t
{
  uint32_t transition_asp_calib_param_minor_version_t;
  /**< @h2xmle_description {Minor version of transition asp calibration param}
       @h2xmle_range       {1..1}
       @h2xmle_default     {1}
       @h2xmle_isVersion   {true} 
  */
...
/* Structure definition for Parameter */
typedef struct afe_sp_rx_tmax_xmax_logging_t afe_sp_rx_tmax_xmax_logging_t;

/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_RX_TMAX_XMAX_LOGGING",
                         AFE_PARAM_ID_SP_RX_TMAX_XMAX_LOGGING}
    @h2xmlp_description {parameter used to log max temp and max excursion logging.}
    @h2xmlp_toolPolicy  {NO_SUPPORT} */
#include "adsp_begin_pack.h"
struct afe_sp_rx_tmax_xmax_logging_t
{
  int32_t max_excursion[SP_NUM_MAX_SPKRS];
  /**< @h2xmle_description {maximum excursion since the lastest grasp of xmax in mm.}
       @h2xmle_range       {-2147483648..2147483647}
       @h2xmle_dataFormat  {Q27} */

  uint32_t count_exceeded_excursion[SP_NUM_MAX_SPKRS];
  ...
  int32_t max_temperature[SP_NUM_MAX_SPKRS];
  /**< @h2xmle_description {maximum temperature since the lastest grasp of tmax in C.}
       @h2xmle_range       {-2147483648..2147483647}
       @h2xmle_dataFormat  {Q22} */

  uint32_t count_exceeded_temperature[SP_NUM_MAX_SPKRS];
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_TH_VI_STATIC_CFG  0x3
...
/* Structure definition for Parameter */
typedef struct afe_sp_th_vi_static_cfg_v3_t afe_sp_th_vi_static_cfg_v3_t;
...
#include "adsp_begin_pack.h"
struct afe_sp_th_vi_static_cfg_v3_t
{
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_TH_VI_STATIC_CFG_V2  0x2
...
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_TH_VI_STATIC_CFG",
    ...
    @h2xmlp_description {parameter used to configure static parameters of
                         thermal VI processing.}
    @h2xmlp_version     {AFE_API_VERSION_SP_TH_VI_STATIC_CFG_V2} */
#include "adsp_begin_pack.h"
struct afe_sp_th_vi_static_cfg_v2_t
{
  ...
  /**< @h2xmle_description {Minor version used for tracking the version of
                            this parameter ID}
       @h2xmle_range       {1..AFE_API_VERSION_SP_TH_VI_STATIC_CFG_V2}
       @h2xmle_default     {AFE_API_VERSION_SP_TH_VI_STATIC_CFG_V2}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_EX_VI_STATIC_CFG  0x3
...
/* Structure definition for Parameter */
typedef struct afe_sp_ex_vi_static_cfg_v3_t afe_sp_ex_vi_static_cfg_v3_t;
...
#include "adsp_begin_pack.h"
struct afe_sp_ex_vi_static_cfg_v3_t
{
  ...
  uint32_t lowpass_filter_cutoff_in_Hz;
  /**< @h2xmle_description {Low Pass Filter Cut- off Frequency in Hz.}
       @h2xmle_rangeList   {"20"=20; "40"=40}
       @h2xmle_default     {20} */

  uint32_t DC_detection_en_flag;
  /**< @h2xmle_description {DC detection enable flag.}
       @h2xmle_rangeList   {0..1}
       @h2xmle_default     {1} */

  int32_t number_of_frames_in_buffer;
  /**< @h2xmle_description {No of frames for DC detection.}
       @h2xmle_rangeList   {1..7}
       @h2xmle_default     {7} */
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V2  0x2
...
/* Structure definition for Parameter */
typedef struct afe_sp_ex_vi_static_cfg_v2_t afe_sp_ex_vi_static_cfg_v2_t;

/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_EX_VI_STATIC_CFG",
                         AFE_PARAM_ID_SP_EX_VI_STATIC_CFG}
    @h2xmlp_description {parameter used configure the static parameters of
                         feedback Speaker Protection Excursion VI processing.}
    @h2xmlp_version     {AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V2} */
#include "adsp_begin_pack.h"
struct afe_sp_ex_vi_static_cfg_v2_t
{
  uint32_t sp_ex_vi_static_cfg_minor_version;
  /**< @h2xmle_description {Minor version used for tracking the version of
                          this parameter ID}
       @h2xmle_range       {1..AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V2}
       @h2xmle_default     {AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V2}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V1  0x1
...
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_EX_VI_STATIC_CFG",
    ...
    @h2xmlp_description {parameter used configure the static parameters of
                         feedback Speaker Protection Excursion VI processing.}
    @h2xmlp_version     {AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V1} */
#include "adsp_begin_pack.h"
struct afe_sp_ex_vi_static_cfg_v1_t
{
  ...
  /**< @h2xmle_description {Minor version used for tracking the version of
                          this parameter ID}
       @h2xmle_range       {1..AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V1}
       @h2xmle_default     {AFE_API_VERSION_SP_EX_VI_STATIC_CFG_V1}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
...
/* Minor Version of this PARAM */
#define AFE_API_VERSION_SP_EX_VI_DYNAMIC_CFG_V3   0x3
...
/* Structure definition for Parameter */
typedef struct afe_sp_ex_vi_dynamic_cfg_v3_t
               afe_sp_ex_vi_dynamic_cfg_v3_t;
...
/** @h2xmlp_parameter   {"AFE_PARAM_ID_SP_EX_VI_DYNAMIC_CFG",
    ...
    @h2xmlp_version     {AFE_API_VERSION_SP_EX_VI_DYNAMIC_CFG_V3}
     */
#include "adsp_begin_pack.h"
struct afe_sp_ex_vi_dynamic_cfg_v3_t
{
  uint32_t  sp_ex_vi_dynamic_cfg_minor_version;
  /**< @h2xmle_description {Minor version used for tracking the version of
                            this parameter ID}
       @h2xmle_range       {1..AFE_API_VERSION_SP_EX_VI_DYNAMIC_CFG_V3}
       @h2xmle_default     {AFE_API_VERSION_SP_EX_VI_DYNAMIC_CFG_V3}
       @h2xmle_readonly    {true}
       @h2xmle_isVersion   {true} */
  ...
  int32_t left_hard_decision_threshold_q31;
  /**< @h2xmle_description {Left speaker: Hard decision threshold for left speaker}
       @h2xmle_range       {-2147483648..2147483647}
       @h2xmle_dataFormat  {Q31}
       @h2xmle_default     {1932735283} */

  int32_t left_lowpassfilter_power_threshold_in_mW;
  /**< @h2xmle_description {Left speaker: low frequency rms power threshold (in mW)}
         @h2xmle_range       {-2147483648..2147483647}
         @h2xmle_default     {200} */

  int32_t left_rated_power_threshold;
  /**< @h2xmle_description {Left speaker: rated power of the speaker (in mW)}
         @h2xmle_range       {-2147483648..2147483647}
         @h2xmle_default     {700} */

  int32_t right_hard_decision_threshold_q31;
  /**< @h2xmle_description {Right speaker: Hard decision threshold for left speaker}
       @h2xmle_range       {-2147483648..2147483647}
       @h2xmle_dataFormat  {Q31}
       @h2xmle_default     {1932735283} */

  int32_t right_lowpassfilter_power_threshold_in_mW;
  /**< @h2xmle_description {Right speaker: low frequency rms power threshold (in mW)}
         @h2xmle_range       {-2147483648..2147483647}
         @h2xmle_default     {200} */

  int32_t right_rated_power_threshold;
  /**< @h2xmle_description {Right speaker: rated power of the speaker (in mW)}
         @h2xmle_range       {-2147483648..2147483647}
         @h2xmle_default     {700} */
