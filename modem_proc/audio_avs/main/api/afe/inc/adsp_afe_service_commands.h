...
$Header: //components/rel/avs.adsp/2.8.6.c2/api/afe/inc/adsp_afe_service_commands.h#1 $
...
#define AFE_PORT_CMD_MOD_EVENT_CFG_MINOR_VERSION_V1       0x1

typedef struct afe_port_cmd_mod_evt_cfg_t afe_port_cmd_mod_evt_cfg_t;

#include "adsp_begin_pack.h"
/** @weakgroup weak_afe_port_cmd_mod_evt_cfg_t
@{ */
/*
 * The following structure has the payload for the command - AFE_PORT_CMD_MOD_EVENT_CFG.
 * Client registers for supported events using this API.
 */

struct afe_port_cmd_mod_evt_cfg_t
{
	uint32_t minor_version;
	/**< Indicates the current version number */

	uint32_t port_id;
	/**<Port ID for the AFE port hosting the modules being registered for the events */

	uint32_t num_events;
	/**< Number of events to be registered with the service
         Each event payload has the structure of afe_port_cmd_mod_evt_cfg_payload_t.
         This structure is repeated "num_events" number of times with appropriate payload   */
}
#include "adsp_end_pack.h"
;
/** @} */ /* end_weakgroup weak_afe_port_cmd_mod_evt_cfg_t */
;

/** Event registration flag */
#define AFE_MODULE_REGISTER_EVENT_FLAG    1

/** Event de-registration flag */
#define AFE_MODULE_DEREGISTER_EVENT_FLAG  0

#include "adsp_begin_pack.h"
/** @weakgroup weak_afe_port_cmd_mod_evt_cfg_payload_t
@{ */
/*
...
typedef struct afe_port_cmd_mod_evt_cfg_payload_t
{
    ...
    */
}/** @cond */afe_port_cmd_mod_evt_cfg_payload_t/** @endcond */;

#include "adsp_end_pack.h"
;
/** @} *//* end_weakgroup weak_afe_port_cmd_mod_evt_cfg_payload_t */

#define AFE_PORT_MOD_EVENT  		0x0001010C

#include "adsp_begin_pack.h"
/** @weakgroup weak_afe_port_mod_event_header_t
@{ */
/*
 * Payload of the event that is raised by module
 * for any of the registered events
 */

typedef struct afe_port_mod_event_header_t
{
	uint32_t minor_version;
	/*<Indicates the minor version of the payload>*/
	...
	uint32_t event_id;
	/*<Valid event ID registered by the client>*/

	uint32_t payload_size;
	/*<Size of the event payload
	 * This is followed by actual payload corresponding to the event>*/

}/** @cond */afe_port_mod_event_header_t/** @endcond */;

#include "adsp_end_pack.h"
;
/** @} *//* end_weak_afe_port_mod_event_header_t */
#ifdef __cplusplus
}
#endif /*__cplusplus*/
