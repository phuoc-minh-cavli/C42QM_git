...
===========================================================================*/
#ifndef NB1_PDCP_LOG_EXT_H
#define NB1_PDCP_LOG_EXT_H
...
typedef PACK(struct)
{
  ...
  /* Security configuration */
  nb1_pdcp_log_security_cfg_s security_cfg;

  uint8                 array_size;   /*!< this is only useful for parser
                                         should be set to NB1_MAX_ACTIVE_RB */
  uint8                 num_released_rb; /*!< number of released RB */
  uint8                 released_rb_cfg_idx[NB1_MAX_ACTIVE_RB]; /*!< released RB cfg index */
  uint8                 num_add_modified_rb; /*!< number of add/modified RB */
  nb1_pdcp_log_cfg_act_s    add_modified_rb[NB1_MAX_ACTIVE_RB]; /*!< cfg action for add/modified RB ID */
  uint8                 num_active_rb;
  nb1_pdcp_log_dl_info_s    rb_info[NB1_MAX_ACTIVE_RB]; /*!< RB config info */
} nb1_pdcp_log_sub_pkt_dl_cfg_s;
...
typedef PACK(struct)
{
  ...
  nb1_pdcp_log_cfg_act_s    add_modified_rb[NB1_MAX_ACTIVE_RB]; /*!< cfg action for add/modified RB ID */
  uint8                 num_active_rb;
  nb1_pdcp_log_ul_info_s    rb_info[NB1_MAX_ACTIVE_RB]; /*!< RB config info */
} nb1_pdcp_log_sub_pkt_ul_cfg_s;
