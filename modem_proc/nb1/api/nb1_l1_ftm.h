...
#ifndef _NB1_ML1_COMMON_FTM_H_
#define _NB1_ML1_COMMON_FTM_H_
/*===========================================================================
...
#define NB1_ML1_MD_WCDMA_MAX_PSC_PER_FREQ  32
...
typedef uint8 nb1_mem_instance_type;
/*----------------------------------------------------------------------------*/
...
typedef struct
{
  ...
  nb1_ml1_md_wcdma_cell_info_s        psc_info[NB1_ML1_MD_WCDMA_MAX_PSC_PER_FREQ];
...
/*===========================================================================
  ...
  FUNCTION:  nb1_l1_ftm_tune
===========================================================================*/
/*!
    @brief
    NB1 L1 will tune, using the FW via scripts.

    The L1 FTM module must be initialized via nb1_l1_ftm_init() prior to
    ...
    prior to calling this function.  The RF and clocks will be in NB1
    mode following the execution of this function.

    The caller of this function must have the scripts prepared in
    the RF tune buffer.

    Multiple nb1_l1_ftm_tune() calls can happen between init and deinit.

*/
/*=========================================================================*/
void nb1_l1_ftm_tune
(
  /*! NB1 Downlink center frequency to tune to */
  nb1_earfcn_t     earfcn,
...
/*===========================================================================
  ...
  FUNCTION:  nb1_l1_ftm_init
===========================================================================*/
/*!
    @brief
    Initializes the L1 FTM module.

    Init must be called prior to tuning via nb1_l1_ftm_tune().
    nb1_l1_ftm_deinit() must be called prior to calling nb1_l1_ftm_init()
    again.

    On genesis init will configure some NB1-only clocks, these should not
    be modified prior to nb1_l1_ftm_deinit() being called
*/
/*=========================================================================*/
void nb1_l1_ftm_init( void );

/*===========================================================================

  FUNCTION:  nb1_l1_ftm_deinit
===========================================================================*/
/*!
    @brief
    Deinitializes the L1 FTM module.

    The NB1 app will be disabled after this function is called and
    all NB1 resource will be freed.
*/
/*=========================================================================*/
void nb1_l1_deinit_req( void );

/*===========================================================================

  FUNCTION:   nb1_l1_ftm_x2w_start_wcdma
...
*/
/*=========================================================================*/
void nb1_l1_ftm_l2w_start_and_tune_wcdma
(
  nb1_mem_instance_type instance,
  /*! Cells for which measurements need to be made. */
  nb1_ml1_md_wcdma_freq_info_s  *freq_cell_list_ptr
);

/*===========================================================================

  FUNCTION: nb1_l1_ftm_l2w_stop_wcdma
...
*/
/*=========================================================================*/
void nb1_l1_ftm_l2w_stop_wcdma
(
  nb1_mem_instance_type instance
);
/*===========================================================================

  FUNCTION: nb1_l1_ftm_l2w_config_init
...
*/
/*=========================================================================*/
void nb1_l1_ftm_l2w_config_init
(
  void
);
/*===========================================================================

  FUNCTION: nb1_l1_ftm_l2w_config_deinit
...
*/
/*=========================================================================*/
void nb1_l1_ftm_l2w_config_deinit
(
  void
);
