...
$Header: //components/rel/rfdevice_pa.mpss/1.30/src/rfdevice_pa_factory_ag.cpp#2 $ 
...
#include "rfdevice_pa_sdr105_iotfe_data_ag.h"


rfdevice_pa_data* rfdevice_pa_data_create (uint16 mfg_id, uint16 prd_id, uint8 prd_rev)
{
  ...
  {
    pa_data = rfdevice_pa_qorvo_qm52015_data_ag::get_instance();
  }
  ...
  else if ( mfg_id ==  0x217 && prd_id == 0x1F0  && prd_rev == 1)
  {
    pa_data = rfdevice_pa_qpa_8801_data_ag::get_instance();
  }

  else if ( mfg_id ==  0x217 && prd_id == 0x1F1  && prd_rev == 1)
  {
    pa_data = rfdevice_pa_qpa_8802_data_ag::get_instance();
  }

  else if ( mfg_id ==  0x217 && prd_id == 0x1F2  && prd_rev == 1)
  {
    pa_data = rfdevice_pa_qpa_8803_data_ag::get_instance();
  }

  else if ( mfg_id ==  0x217 && prd_id == 0x1F3  && prd_rev == 1)
  {
    pa_data = rfdevice_pa_qpa_8821_data_ag::get_instance();
  }

  else if ( mfg_id ==  0x01A5 && prd_id == 0x20  && prd_rev == 0)
  {
    pa_data = rfdevice_pa_sky68020_data_ag::get_instance();
  }

  else if ( mfg_id ==  0x217 && prd_id == 0xC7  && prd_rev == 1)
  {
    pa_data = rfdevice_pa_sdr105_iotfe_data_ag::get_instance();
  }
