...
#ifndef RFDEVICE_PA_SKY68020_DATA_AG
#define RFDEVICE_PA_SKY68020_DATA_AG
...
$Header: //components/rel/rfdevice_pa.mpss/1.30/src/rfdevice_pa_sky68020_data_ag.h#2 $ 
...
class rfdevice_pa_sky68020_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_sky68020_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_pa_sky68020_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_sky68020_data_ptr;
