...
#ifndef RFDEVICE_PA_QPA_8803_DATA_AG
#define RFDEVICE_PA_QPA_8803_DATA_AG
...
$Header: //components/rel/rfdevice_pa.mpss/1.30/src/rfdevice_pa_qpa_8803_data_ag.h#2 $ 
...
class rfdevice_pa_qpa_8803_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_qpa_8803_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_pa_qpa_8803_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_qpa_8803_data_ptr;
