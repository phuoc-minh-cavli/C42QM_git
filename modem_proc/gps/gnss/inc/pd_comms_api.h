...
/*=====================================================================
 ...
 Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/inc/pd_comms_api.h#1 $$DateTime: 2020/07/21 21:23:44 $$Author: pwbldsvc $ 
 ...
 */
/*Adding in pd_comm temporarily but all files including pdcomms_api.h should remove it*/
 struct ps_in6_addr
{
