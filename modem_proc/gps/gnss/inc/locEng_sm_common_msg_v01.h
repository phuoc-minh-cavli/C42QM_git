...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/inc/locEng_sm_common_msg_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Sun Jan 29 2017 (Spin 0)
...
#define LOCENG_V01_MAX_MESSAGE_ID 0x002B
/**
    @}
  */
...
#define QMI_LOC_MAX_WIFI_AP_SSID_STR_LENGTH_V01 32
...
#define LOC_ENG_SRN_MAX_REPORTED_APS_PER_MSG_V01 64

/**  MAC address length in bytes.  */
#define LOC_ENG_SRN_MAC_ADDR_LENGTH_V01 6
/**
    @}
  */
...
#define LOC_ENG_WIFI_APINFO_MASK_RSSI_TIMESTAMP_V01 ((locEngWifiMaskT_v01)0x00000400) /**<  RSSI timestamp is valid  */
#define LOC_ENG_WIFI_APINFO_MASK_MEASUREMENT_AGE_V01 ((locEngWifiMaskT_v01)0x00000800) /**<  Measurement age is valid  */
#define LOC_ENG_WIFI_APINFO_MASK_SERVING_AP_V01 ((locEngWifiMaskT_v01)0x00001000) /**<  Serving access point boolean is valid  */
#define LOC_ENG_WIFI_APINFO_MASK_FREQUENCY_V01 ((locEngWifiMaskT_v01)0x00002000) /**<  Channel frequency is valid  */
#define LOC_ENG_WIFI_APINFO_MASK_SSID_V01 ((locEngWifiMaskT_v01)0x00004000) /**<  SSID is valid  */
#define LOC_ENG_WIFI_APINFO_MASK_AP_HIGH_RESOLUTION_RSSI_V01 ((locEngWifiMaskT_v01)0x00008000) /**<  AP high resolution RSSI is valid  */
/** @addtogroup locEng_qmi_aggregates
    @{
  */
typedef struct {
  ...
  /**<   Specifies which sensors are used.
       ...
       Valid bitmasks are specified by the following constants: \n       
         ...
         - 0x00000400 -- RSSI TIMESTAMP\n
         - 0x00000800 -- MEASUREMENT AGE\n
         - 0x00001000 -- SERVING AP\n
         - 0x00002000 -- FREQUENCY\n
         - 0x00004000 -- SSID \n
         - 0x00008000 -- AP_HIGH_RESOLUTION_RSSI */
...
typedef struct {
  ...
  uint32_t frequency;
  /**<   AP Wi-Fi channel frequency.
       Units: MHz \n
       Type : uint32 */

  char ssid[QMI_LOC_MAX_WIFI_AP_SSID_STR_LENGTH_V01 + 1];
  ...
  /**<     AP signal strength indicator in 0.1 dBm.
       Units: 0.1dBm \n
       Type : int32 */
}locEngWifiApAdditionalDataStructT_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup locEng_qmi_enums
  ...
  */
typedef enum {
  LOCENGWLANAPERRENUMT_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  eLOC_ENG_WLAN_AP_ERR_NONE_V01 = 0, /**<   No Error   */
  eLOC_ENG_WLAN_AP_ERR_UNKNOWN_V01 = 1, /**<   Error is unknown   */
  eLOC_ENG_WLAN_AP_ERR_NO_REQ_MEAS_AVAILABLE_V01 = 2, /**<   None of the requested measurements could be provided   */
  eLOC_ENG_WLAN_AP_ERR_WIFI_OFF_V01 = 3, /**<   Wifi is off   */
  LOCENGWLANAPERRENUMT_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}locEngWlanApErrEnumT_v01;
/**
    @}
  */
...
typedef struct {
 ...
 Valid Values :\n
  ...
  locEngWlanApErrEnumT_v01 errorCause;
  /**<     In case of WLAN-AP measurements not available from WIPER, 
  ...
  Valid values: \n
       - eLOC_ENG_WLAN_AP_ERR_NONE (0) --  No Error
       - eLOC_ENG_WLAN_AP_ERR_UNKNOWN (1) --  Error is unknown 
       - eLOC_ENG_WLAN_AP_ERR_NO_REQ_MEAS_AVAILABLE (1) --  None of the requested measurements could be provided 
       - eLOC_ENG_WLAN_AP_ERR_WIFI_OFF (2) --  Wifi is off  */
  ...
  /* Optional */
  /*  Wi-Fi AP Periodic WLAN Measurements Scan Data */
  uint8_t wifiApAddInfo_valid;  /**< Must be set to true if wifiApAddInfo is being passed */
  uint32_t wifiApAddInfo_len;  /**< Must be set to # of elements in wifiApAddInfo */
  locEngWifiApAdditionalDataStructT_v01 wifiApAddInfo[QMI_LOC_WIFI_MAX_REPORTED_APS_PER_MSG_V01];
  /**<   \n List of Wi-Fi AP Periodic WLAN Measurements scan information entered by the control point. */
...
typedef uint32_t locEngSrnApDataDeviceTypeMaskT_v01;
#define LOC_ENG_SRN_AP_DATA_TECH_TYPE_BT_V01 ((locEngSrnApDataDeviceTypeMaskT_v01)0x00000001) /**<  SRN AP Technology BlueTooth  */
#define LOC_ENG_SRN_AP_DATA_TECH_TYPE_BTLE_V01 ((locEngSrnApDataDeviceTypeMaskT_v01)0x00000002) /**<  SRN AP Technology BlueTooth Low Energy  */
#define LOC_ENG_SRN_AP_DATA_TECH_TYPE_NFC_V01 ((locEngSrnApDataDeviceTypeMaskT_v01)0x00000004) /**<  SRN AP Technology NFC  */
#define LOC_ENG_SRN_AP_DATA_TECH_TYPE_MOBILE_CODE_V01 ((locEngSrnApDataDeviceTypeMaskT_v01)0x00000008) /**<  SRN AP Technology Mobile Code  */
#define LOC_ENG_SRN_AP_DATA_TECH_TYPE_OTHER_V01 ((locEngSrnApDataDeviceTypeMaskT_v01)0x00000010) /**<  SRN AP Technology Other */
/** @addtogroup locEng_qmi_enums
    @{
  */
typedef enum {
  LOCENGSRNAPDATAMACADDRTYPEENUMT_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  eLOC_ENG_SRN_AP_DATA_PUBLIC_MAC_ADDR_V01 = 0, /**<  SRN AP MAC Address type PUBLIC  */
  eLOC_ENG_SRN_AP_DATA_PRIVATE_MAC_ADDR_V01 = 1, /**<  SRN AP MAC Address type PRIVATE  */
  eLOC_ENG_SRN_AP_DATA_OTHER_MAC_ADDR_V01 = 2, /**<  SRN AP MAC Address type OTHER */
  LOCENGSRNAPDATAMACADDRTYPEENUMT_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}locEngSrnApDataMacAddrTypeEnumT_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  locEngSrnApDataDeviceTypeMaskT_v01 srnTechMask;
  /**<   Specifies which Srn technologies AP mesurement data
 is being requested from client.

 Valid values: \n
      - LOC_ENG_SRN_AP_DATA_TECH_TYPE_BT (0x00000001) --  SRN AP Technology BlueTooth 
      - LOC_ENG_SRN_AP_DATA_TECH_TYPE_BTLE (0x00000002) --  SRN AP Technology BlueTooth Low Energy 
      - LOC_ENG_SRN_AP_DATA_TECH_TYPE_NFC (0x00000004) --  SRN AP Technology NFC 
      - LOC_ENG_SRN_AP_DATA_TECH_TYPE_MOBILE_CODE (0x00000008) --  SRN AP Technology Mobile Code 
      - LOC_ENG_SRN_AP_DATA_TECH_TYPE_OTHER (0x00000010) --  SRN AP Technology Other */
  ...
  */
  ...
  locEngSrnApDataMacAddrTypeEnumT_v01 srnApMacAddrType;
  /**<   Specifies the Mac Address type requested.

 Valid values: 
      - eLOC_ENG_SRN_AP_DATA_PUBLIC_MAC_ADDR (0) --  SRN AP MAC Address type PUBLIC 
      - eLOC_ENG_SRN_AP_DATA_PRIVATE_MAC_ADDR (1) --  SRN AP MAC Address type PRIVATE 
      - eLOC_ENG_SRN_AP_DATA_OTHER_MAC_ADDR (2) --  SRN AP MAC Address type OTHER */
}locEngEventInjectSrnApDataReqIndMsgT_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup locEng_qmi_enums
  ...
  */
typedef enum {
  LOCENGSRNAPDATATECHTYPEENUMT_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  eLOC_ENG_SRN_AP_DATA_TECH_TYPE_BT_V01 = 0, /**<  SRN AP Technology BlueTooth  */
  eLOC_ENG_SRN_AP_DATA_TECH_TYPE_BTLE_V01 = 1, /**<  SRN AP Technology BlueTooth Low Energy  */
  eLOC_ENG_SRN_AP_DATA_TECH_TYPE_NFC_V01 = 2, /**<  SRN AP Technology NFC  */
  eLOC_ENG_SRN_AP_DATA_TECH_TYPE_MOBILE_CODE_V01 = 3, /**<  SRN AP Technology Mobile Code  */
  eLOC_ENG_SRN_AP_DATA_TECH_TYPE_OTHER_V01 = 4, /**<  SRN AP Technology Other */
  LOCENGSRNAPDATATECHTYPEENUMT_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}locEngSrnApDataTechTypeEnumT_v01;
/**
    @}
  */

typedef uint32_t locEngSrnApDataMaskT_v01;
#define LOC_ENG_SRN_APDATA_MASK_AP_MAC_V01 ((locEngSrnApDataMaskT_v01)0x00000001) /**<  SRN AP MAC address is valid  */
#define LOC_ENG_SRN_APDATA_MASK_AP_RSSI_V01 ((locEngSrnApDataMaskT_v01)0x00000002) /**<  SRN AP RSSI is valid  */
#define LOC_ENG_SRN_APDATA_MASK_RSSI_TIMESTAMP_V01 ((locEngSrnApDataMaskT_v01)0x00000004) /**<  SRN AP RSSI timestamp is valid  */
/** @addtogroup locEng_qmi_enums
    @{
  */
typedef enum {
  LOCENGSRNAPERRENUMT_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  eLOC_ENG_SRN_AP_ERR_NONE_V01 = 0, /**<  No Error  */
  eLOC_ENG_SRN_AP_ERR_UNKNOWN_V01 = 1, /**<  Error is unknown  */
  eLOC_ENG_SRN_AP_ERR_NO_REQ_MEAS_AVAILABLE_V01 = 2, /**<  None of the requested measurements could be provided  */
  eLOC_ENG_SRN_AP_ERR_SENSOR_OFF_V01 = 3, /**<  Sensor is off  */
  LOCENGSRNAPERRENUMT_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}locEngSrnApErrEnumT_v01;
/**
    @}
  */
...
typedef struct {
  ...
  locEngSrnApDataMaskT_v01 srnApDataMask;
  /**<   Specifies which SRN AP information types are being used.

 Valid values: 
      - LOC_ENG_SRN_APDATA_MASK_AP_MAC (0x00000001) --  SRN AP MAC address is valid 
      - LOC_ENG_SRN_APDATA_MASK_AP_RSSI (0x00000002) --  SRN AP RSSI is valid 
      - LOC_ENG_SRN_APDATA_MASK_RSSI_TIMESTAMP (0x00000004) --  SRN AP RSSI timestamp is valid  */

  uint8_t macAddress[LOC_ENG_SRN_MAC_ADDR_LENGTH_V01];
  /**<   MAC address. 
  ...
  /**<   UTC timestamp at which the scan was requested. 
       Units: Milliseconds 
       Type: int64 */
}locEngSrnBtleApDeviceDataStructT_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Scan Receive Timestamp */
  locEngSrnApDataTechTypeEnumT_v01 apDeviceTechType;
  /**<   List of AP device types. 

 Valid values: 
      - eLOC_ENG_SRN_AP_DATA_TECH_TYPE_BT (0) --  SRN AP Technology BlueTooth 
      - eLOC_ENG_SRN_AP_DATA_TECH_TYPE_BTLE (1) --  SRN AP Technology BlueTooth Low Energy 
      - eLOC_ENG_SRN_AP_DATA_TECH_TYPE_NFC (2) --  SRN AP Technology NFC 
      - eLOC_ENG_SRN_AP_DATA_TECH_TYPE_MOBILE_CODE (3) --  SRN AP Technology Mobile Code 
      - eLOC_ENG_SRN_AP_DATA_TECH_TYPE_OTHER (4) --  SRN AP Technology Other */
  ...
  locEngSrnBtleApDeviceDataStructT_v01 srnBtleApInfo[LOC_ENG_SRN_MAX_REPORTED_APS_PER_MSG_V01];
  ...
  uint8_t errorCause_valid;  /**< Must be set to true if errorCause is being passed */
  locEngSrnApErrEnumT_v01 errorCause;
 ...
 Valid values: 
      - eLOC_ENG_SRN_AP_ERR_NONE (0) --  No Error 
      - eLOC_ENG_SRN_AP_ERR_UNKNOWN (1) --  Error is unknown 
      - eLOC_ENG_SRN_AP_ERR_NO_REQ_MEAS_AVAILABLE (2) --  None of the requested measurements could be provided 
      - eLOC_ENG_SRN_AP_ERR_SENSOR_OFF (3) --  Sensor is off  */
}locEngInjectSrnApDataReqMsgT_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
 ...
 Valid values: \n
      ...
      - eLOC_ENG_INSUFFICIENT_MEMORY (8) --  Request failed because the engine could not allocate sufficent
       memory for the request.  */
}locEngInjectSrnApDataIndMsgT_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */ 
//#define REMOVE_LOC_ENG_EVENT_INJECT_SRN_AP_DATA_REQ_V01 
...
//#define REMOVE_LOC_ENG_INJECT_SRN_AP_DATA_V01 
...
#define LOC_ENG_EVENT_INJECT_SRN_AP_DATA_REQ_IND_V01 0x002A
#define LOC_ENG_INJECT_SRN_AP_DATA_REQ_V01 0x002B
#define LOC_ENG_INJECT_SRN_AP_DATA_IND_V01 0x002B
/**
    @}
  */
