...
/*============================================================================
  ...
  use ISO format for dates.
   ...
   $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/le/inc/le_types.h#1 $ 
...
typedef struct
{
  ...
  boolean v_PuncValid; // Is the 68% 2d Punc of the AP valid
  uint16  w_2dPunc68_m; // 68% 2d punc of the AP if valid
  uint8   u_Reliability;  // Reliability of the AP
} 
