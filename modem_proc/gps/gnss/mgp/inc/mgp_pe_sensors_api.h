...
$Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/mgp/inc/mgp_pe_sensors_api.h#1 $  
$Author: pwbldsvc $
...
/* There's an issue with <stdint.h> vs. #if defined(__cplusplus)
   and RVCT does not have <cstdint.h>, so hacking in support for
   lean build here. */
 ...
 ******************************************************************************
*/
boolean _mgp_PeSensorsSetMountedSate(const mgp_PeSensorsMountedState *p_State);
 ...
 ******************************************************************************
*/
boolean _mgp_PeIntSensorMeasPut(const mgp_PeIntSensorMeasStruct *pz_SensorMeas);
 ...
 ******************************************************************************
*/
boolean _mgp_PeSensorBiasPut(const mgp_PeSensorBiasStruct *pz_SensorBias);
