...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/mgp/inc/navhw_api.h#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $ 
...
boolean _mgp_GpsHWVersionGet( uint8* p_GpsHWVersionNum );
 ...
 ******************************************************************************
*/
void _navhw_ProcessDiagCommands( navhw_DiagCmdStruct * p_NavDiagCmd );
