...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/samlite/inc/saml_client_types.h#1 $
...
typedef enum
{
  ...
  eSAML_PED_DEV_CXT_UNKNOWN        = 0,
  /**<  Pedestrian device context is not known  */
  eSAMl_PED_DEV_CXT_IN_HAND_STABLE        = 1,
  /**<  Device is in hand of a pedestrian and is stable */
  eSAML_PED_DEV_CXT_IN_HAND_SWING        = 2,
  /**<  Device is in hand of a pedestrian who is walking */
  eSAML_PED_DEV_CXT_IN_PANT_POCKET        = 3,
  /**<  Device is in the pant pocket of a pedestrian  */
  eSAML_PED_DEV_CXT_IN_HAND_JOG           = 4,
  /**<  Device is in the hand of a pedestrian  who is jogging */
  //! @cond
  eSAML_PED_DEV_CXT_INPUT_TYPE_MAX = 2147483647 /* Force 32bit */
  //! @endcond
} samlPedDevCxtTypeEnumT;
...
typedef enum
{
  ...
  eSAML_PED_ALIGNMENT_EVENT_UNSTABLE_DEVICE_MOTION_DEPRECATED   = 4,
  /**< Deprecated as pedestrian context is now sent as part of PedAlign */
  /**< Unstable device motion detected */
  eSAML_PED_ALIGNMENT_EVENT_FAKE_PEDALIGN           = 5,
  /**< Dummy Ped alignment during SAMLite failure */
  eSAML_PED_ALIGNMENT_EVENT_RESET                         = 6,
  /* If a sensor outage or other disturbance occurs we will pass along an */
  /* indication that RTA and CoG may be volatile. Specifically the mag  */
  /* gets more "weight" during a reset and PDR outputs will likely jump. */
  /* Add new events here. */
