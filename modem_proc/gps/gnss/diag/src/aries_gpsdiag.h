...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/diag/src/aries_gpsdiag.h#1 $
...
--------   ---     ----------------------------------------------------------
03/30/17    sum    Added variable x_VelHoriz in gpsdiag_GetLastKnownPosCmdRspType to support velocity greater than 0x7fff 
...
#define GPSDIAG_SET_U64BITMASK_BIT PDSM_SET_U64BITMASK_BIT

#else
/* sets the specified bit in a u64 bit mask. bit counts range: 0-63 */
#define GPSDIAG_SET_U64BITMASK_BIT(n) (((uint64)0x1) << (n))
...
/* Size (in bits) of GPSDIAG stack */
#define GPSDIAG_STACK_SIZ    (3072)
...
typedef PACKED struct PACKED_POST
{
  ...
  uint16             x_VelHorizU;      /* Horizontal velocity greater than 0x7fff in cm/s */
...
typedef enum
{
  ...
  GPSDIAG_PA_ON_DEMAND_ENABLE      = 19, /* deprecated */
  GPSDIAG_PA_ON_DEMAND_READY       = 20, /* deprecated */
...
typedef enum
{
   ...
   GNSSDIAG_PA_DELETE_IONO_GAL       = GPSDIAG_SET_U64BITMASK_BIT(31)
...
{
  /* Bit map of 2 bytes */
  GPSDIAG_PA_NMEA_GGA = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(0) & 0xffffffff),
  GPSDIAG_PA_NMEA_RMC = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(1) & 0xffffffff),
  GPSDIAG_PA_NMEA_GSV = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(2) & 0xffffffff),
  GPSDIAG_PA_NMEA_GSA = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(3) & 0xffffffff),
  GPSDIAG_PA_NMEA_VTG = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(4) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GLGSV = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(5) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GNGSA = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(6) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GNGNS = (uint16) (GPSDIAG_SET_U64BITMASK_BIT(7) & 0xffffffff),
  GNSSDIAG_PA_NMEA_PSTIS =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(8) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GARMC =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(9) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GAGSV =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(10) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GAGSA =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(11) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GAVTG =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(12) & 0xffffffff),
  GNSSDIAG_PA_NMEA_GAGGA =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(13) & 0xffffffff),
  GNSSDIAG_PA_NMEA_PQGSX =  (uint16) (GPSDIAG_SET_U64BITMASK_BIT(14) & 0xffffffff)
...
/* GERA test commands  */
/*****************************/
#define GPSDIAG_GERA_TEST_CMD_CLIENT_REG           1
#define GPSDIAG_GERA_TEST_CMD_CLIENT_DEREG         2
#define GPSDIAG_GERA_TEST_CMD_CLIENT_ENABLE_REQ    3
#define GPSDIAG_GERA_TEST_CMD_CLIENT_DISABLE_REQ   4
#define GPSDIAG_GERA_TEST_CMD_CLIENT_DISABLED_INFO 5
#define GPSDIAG_GERA_TEST_CMD_RESET                6
#define GPSDIAG_GERA_TEST_CMD_QUERY_STATE          7


/* GERA test command  Req/Rsp packets
 *
 * This msg is used to for the request packet from DIAG for GERA test commands.  
 */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType z_DiagCmdHdr;         /* diagpkt_subsys_header_type */
  int32              l_TestClientId;       /* Test Client ID used by DIAG*/
  uint32             q_GeraTestCmd;        /* Gera test command */
  uint32             q_GeraClientId;       /* GERA client ID used by GERA core */
  uint32             q_DepClientMask;      /* The mask for enabling additional dependent clients (optional ) */
} gpsdiag_GeraTestCmdReqType;

typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType z_DiagCmdHdr;     /* diagpkt_subsys_header_type */
  uint32             q_Status;         /* See ENUM gpsdiag_eStatusType */
  int32              l_TestClientId;       /* Test Client ID */
} gpsdiag_GeraTestCmdRspType;
