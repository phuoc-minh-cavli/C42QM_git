...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/os_api/inc/aries_os_globals.h#1 $
...
typedef enum
{
  ...
  THREAD_ID_MGP_CD        =  6,
  THREAD_ID_SM_TM         =  8,
  THREAD_ID_SM_LM         =  THREAD_ID_SM_TM,
  ...
  THREAD_ID_LOC_MIDDLEWARE= THREAD_ID_SM_TM,
  THREAD_ID_LBS           = 16,
  THREAD_ID_TLM           = 17,
  THREAD_ID_XTM           = 18,
  THREAD_ID_SDP           = 19,
  THREAD_ID_SM_GM         = THREAD_ID_SM_TM,
...
/*Enum to keep track of all bare QURT tasks, which uses Pipe for communication*/
typedef enum
{
   QTHREAD_ID_MGP_UCC = 0,
   MAX_QURT_THREAD_COUNT
