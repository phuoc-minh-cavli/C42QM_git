...
Version Control
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/wle/wlm/inc/wlm_api.h#1 $ 
...
/********************************************************************
*
* wlm_update_wifi_pos_inj_allowed
*
* Function description:
* Used to update if wifi position injection is allowed
*
* Parameters: 
...
*********************************************************************
*/
void wlm_update_wifi_pos_inj_allowed(boolean b_WifiPosInjAllowed);
