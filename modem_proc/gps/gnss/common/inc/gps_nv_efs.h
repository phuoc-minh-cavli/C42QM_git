/*==============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/common/inc/gps_nv_efs.h#5 $ 
...
10/19/17   rn      Added NVs for XTRA Integrity.
...
typedef enum
{
  ...
  GNSS_NV_EFS_SM_TM_UAX3_CONFIG,                  /* UAX3 config */
  GNSS_NV_EFS_SM_NHZ_CONFIG, /* Configuration for NHz mode of operation */
  GNSS_NV_EFS_SM_LM_HEPE_THRESHOLD_FOR_DR, /*HEPE threshold to be used for DR/INS fixes*/
  GNSS_NV_EFS_SM_GTP_WWAN_FIX_TIMER_DURATION, /*Duration of timer waiting for GTP WWAN fix*/
  ...
  GNSS_NV_EFS_SM_GNSS_CONTROL_FIX_OPERATION, /*Controls Fix related operations, currently controls cache fix propogation and its reporting to client*/
  /*add new SM NV items here. Make sure to update CGPS_NV_EFS_SM_MAX_ITEM*/
  CGPS_NV_EFS_SM_MAX_ITEM = GNSS_NV_EFS_SM_GNSS_CONTROL_FIX_OPERATION,
  /* ------------------------------------------------------------------
     ME items
     ------------------------------------------------------------------ */
  ...
  GNSS_NV_EFS_ME_MC_POWER_CONFIG,
  GNSS_NV_EFS_ME_CPE_CONTROL,
  GNSS_NV_EFS_ME_F3_REDUCTION,
  GNSS_NV_EFS_ME_NAVRX_PERIODIC_REG_DUMP_CONFIG,
  GNSS_NV_EFS_ME_ENABLE_NON_DEDICATED_TASK_GRID_LOG,
  GNSS_NV_EFS_ME_DR_SYNC_PULSE_WIDTH,
  GNSS_NV_EFS_ME_NAVRX_BP_JAMMER_CONFIG,
  GNSS_NV_EFS_ME_ENABLE_BUP_FLAG,
  GNSS_NV_EFS_ME_WIFI_GNSS_CRIT_DEMOD,
  GNSS_NV_EFS_ME_GEN9_GENERAL_1,
  GNSS_NV_EFS_ME_GEN9_GENERAL_2,
  GNSS_NV_EFS_ME_ENABLE_ESR_MITIGATION,
  C_GNSS_NV_EFS_ME_GNSS_DPO_CONTROL,
  C_GNSS_NV_EFS_ME_GNSS_LONG_COH_CTRL,
  GNSS_NV_EFS_ME_VOTE_TO_DISABLE_LTE_MICROSLEEP,
  GNSS_NV_EFS_ME_BDS_SV_BLACKLIST,
  GNSS_NV_EFS_ME_CATM_LTE_GNSS_COEX_CONFIG,
  GNSS_NV_EFS_ME_AVG_PWR,
  GNSS_NV_EFS_ME_DPO_IQSUM_LOGGING_ENABLE,  
  GNSS_NV_EFS_ME_DR_SYNC_PULSE_CONFIG,
  /* add other ME items here. Make sure to update GNSS_NV_EFS_ME_MAX_ITEM */
  GNSS_NV_EFS_ME_MAX_ITEM = GNSS_NV_EFS_ME_DR_SYNC_PULSE_CONFIG,
  ...
  GNSS_NV_EFS_PE_TEST_FEATURE_CONFIG,
  GNSS_NV_EFS_PE_LPPM_UNIT_TEST_CONFIG,
  GNSS_NV_EFS_PE_ENABLE_STATIC_PINNING,
  GNSS_NV_EFS_PE_NF_GILE_MAX_DEAD_RECKONING_TIME,
  GNSS_NV_EFS_PE_RTI_HEALTH_EXPIRATION_PERIOD,

  /* add other PE items here. Make sure to update GNSS_NV_EFS_PE_MAX_ITEM */
  GNSS_NV_EFS_PE_MAX_ITEM = GNSS_NV_EFS_PE_RTI_HEALTH_EXPIRATION_PERIOD,
  ...
  GNSS_NV_EFS_TLE_MAX_AP_RESPONSE_TIMER_PERIOD_SECOND,
  GNSS_NV_EFS_TLE_TDP_DN_POS_CONTROL,
  GNSS_NV_EFS_TLE_EXTERNAL_PROVIDER_CELL_THROTTLE_PERIOD,
  GNSS_NV_EFS_TLE_EXTERNAL_PROVIDER_UPLOAD_CELL_THRESHOLD,
  GNSS_NV_EFS_TLE_REQUEST_RATE_FOR_DAY,
  GNSS_NV_EFS_TLE_MAX_NUM_REQUESTS_PER_DAY,
  GNSS_NV_EFS_TLE_CLIENT_CONTROLS,
  GNSS_NV_EFS_TLE_RESTRICTED_REGIONS,
  GNSS_NV_EFS_TLE_RESTRICTED_REGION_VERSION,
  GNSS_NV_EFS_TLE_LAST_DOWNLOAD_TIME,
  GNSS_NV_EFS_TLE_POS_DELTA_TIME_THRESHOLD,
  GNSS_NV_EFS_TLE_POS_ASSISTANCE_DATA,
  GNSS_NV_EFS_TLE_SCAN_POSITION_CONFIG,
  GNSS_NV_EFS_TLE_SCAN_CS_CONFIG,
  GNSS_NV_EFS_TLE_CONFIGURATION_ID,
  GNSS_NV_EFS_TLE_CLIENT_CONTROLS_2,
  GNSS_NV_EFS_TLE_LAST_AD_REQUEST_TIME_MSB,
  GNSS_NV_EFS_TLE_LAST_AD_REQUEST_TIME_LSB,
  GNSS_NV_EFS_TLE_LAST_BAD_SCAN_TIME_MSB,
  GNSS_NV_EFS_TLE_LAST_BAD_SCAN_TIME_LSB,
  GNSS_NV_EFS_TLE_AD_REFRESH_DELAY,
  CGPS_NV_EFS_TLE_TLM_MAX_ITEM = GNSS_NV_EFS_TLE_AD_REFRESH_DELAY,
  ...
  GNSS_NV_EFS_LOC_OTB_BUFFER_THRESHOLD,                               /* Max position buffers allowed to allocate for outdoor door batching */
  GNSS_NV_EFS_LOC_MAX_ITEM =  GNSS_NV_EFS_LOC_OTB_BUFFER_THRESHOLD,
