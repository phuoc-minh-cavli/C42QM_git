...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/common/inc/gps_common.h#3 $ 
...
--------   ---     ----------------------------------------------------------
09/15/17   sum     Added function WGS84toPZ90()
...
=============================================================================*/
// should not be wrapped in extern "C"
...
#define MEAS_STATUS_LTE_TX_ON_CATM (1<<8)  /* TRUE -> CATM LTE GNSS co-existence condition*/
...
#define C_TIME_SRC_GTS_WWAN                   PDSM_GNSS_TIME_SRC_NETWORK_TIME_TAGGING

#define C_TIME_SRC_GTS_LTE_TIME               PDSM_GNSS_TIME_SRC_NETWORK_TIME_TAGGING
#define C_TIME_SRC_GTS_SLW_CLK                PDSM_GNSS_TIME_SRC_RESERVED
...
#define C_TIME_SRC_GTS_FEST                   PDSM_GNSS_TIME_SRC_RESERVED
#define C_TIME_SRC_GTS_USTMR                  PDSM_GNSS_TIME_SRC_RESERVED

/* GPS therm masks #defines  */
#define TCXOMGR_GPS_ON_THERM_MASK       TCXOMGR_PMIC_THERM_MASK | TCXOMGR_XO_ACCURATE_THERM_MASK
#define TCXOMGR_GPS_OFF_THERM_MASK      TCXOMGR_XO_ACCURATE_THERM_MASK
...
#define C_GNSS_DPO_ALL_KNOWN_USABLE_SV_PDOP_THRESH 5.0f   /* meters */
...
#ifdef FEATURE_GNSS_ESR_MITIGATION
/*Enum for the PBS SW trigger type*/
typedef enum gnss_pbs_esr_trigger_e
{
  C_GNSS_PBS_ENTER_ESR_QUIET_MODE,
  C_GNSS_PBS_EXIT_ESR_QUIET_MODE
}gnss_pbs_esr_trigger_enumtype;
#endif
...
typedef enum 
{
  ...
  C_GPS_RCVR_STATE_DPO_SLEEP,          /* Receiver state is in DPO sleep */
  C_GPS_RCVR_STATE_TRANSITIONING,      /* Receiver State is in Transition */
  C_GPS_RCVR_STATE_HARD_RESET,         /* Receiver state is hard reset */

  C_GPS_RCVR_STATE_DPO_WAKEUP,          /* Receiver State is in DPO wake-up mode */
  C_GPS_RCVR_STATE_DPO_ON,              /* Receiver State is in DPO search mode */
  C_GPS_RCVR_STATE_WAIT_FOR_CC_ENABLE,  /* Receiver is waiting for CC to be enabled */
  C_GPS_RCVR_STATE_WAIT_FOR_GTS_TIME,   /* Receiver is waiting for GTS Time */
  C_GPS_RCVR_STATE_WAIT_FOR_CC_DISABLE, /* Receiver is waiting for CC to be disabled */
  C_GPS_RCVR_STATE_WAIT_FOR_JOBS_DONE,  /* Receiver is waiting for All Jobs Done */

  C_GPS_RCVR_STATE_CC_CANT_CONTINUE,     /* Receiver is in CC can't continue state */
  C_GPS_RCVR_STATE_WAIT_FOR_CC_LATCH,    /* Receiver is waiting for CC to complete latch process */
  /*DO NOT CHANGE THE ORDER OF THE  ENUM. 
       ADD NEW ELEMENTS BELOW */
  C_GPS_RCVR_STATE_DELETE_ALL,        /* Receiver state is processing Delete All */
...
/* the Position Engine.                                                  */
/*   DO NOT CHANGE this structure w/o versioning the IPC log which use   */
/*   this struct. Due to Unified Fix Reporting, only one IPC needs       */
/*   updating.                                                           */
...
#define C_GPS_SVID_FULL_MASK     (0x00FFFFFFFFULL)
#define C_GLO_SVID_FULL_MASK     (0x0000FFFFFFULL)
#define C_BDS_SVID_FULL_MASK     (0x0000001FFFFFFFFFULL)
#define C_GAL_SVID_FULL_MASK     (0x0000000FFFFFFFFFULL)

#define C_DELETE_INFO_CLOCK_INFO          (0xFFFFFFFF)
#define C_DELETE_INFO_POS_INFO            (0xFFFFFFFF)

#define C_DELETE_INFO_GPS_EPH_INFO        C_GPS_SVID_FULL_MASK
#define C_DELETE_INFO_GPS_ALM_INFO        C_GPS_SVID_FULL_MASK
#define C_DELETE_INFO_GPS_SV_HEALTH_INFO  C_GPS_SVID_FULL_MASK
#define C_DELETE_INFO_GPS_SV_INFO         C_GPS_SVID_FULL_MASK

#define C_DELETE_INFO_QZSS_EPH_INFO       (0xFFFFFFFF)
#define C_DELETE_INFO_QZSS_ALM_INFO       (0xFFFFFFFF)
#define C_DELETE_INFO_QZSS_SV_HEALTH_INFO (0xFFFFFFFF)
#define C_DELETE_INFO_QZSS_SV_INFO        (0x1F00000000ULL)

#define C_DELETE_INFO_GLO_EPH_INFO        C_GLO_SVID_FULL_MASK
#define C_DELETE_INFO_GLO_ALM_INFO        C_GLO_SVID_FULL_MASK
#define C_DELETE_INFO_GLO_SV_HEALTH_INFO  C_GLO_SVID_FULL_MASK
#define C_DELETE_INFO_GLO_SV_INFO         C_GLO_SVID_FULL_MASK
...
#define C_DELETE_INFO_BDS_SV_INFO         C_BDS_SVID_FULL_MASK
#define C_DELETE_INFO_BDS_EPH_INFO        C_BDS_SVID_FULL_MASK
#define C_DELETE_INFO_BDS_ALM_INFO        C_BDS_SVID_FULL_MASK
#define C_DELETE_INFO_BDS_SV_DIR_INFO     C_BDS_SVID_FULL_MASK
#define C_DELETE_INFO_BDS_SV_STEER_INFO   C_BDS_SVID_FULL_MASK
#define C_DELETE_INFO_BDS_SV_HEALTH_INFO  C_BDS_SVID_FULL_MASK

/* Lower 36 bits should be set for GAL */
#define C_DELETE_INFO_GAL_SV_INFO         C_GAL_SVID_FULL_MASK
#define C_DELETE_INFO_GAL_EPH_INFO        C_GAL_SVID_FULL_MASK
#define C_DELETE_INFO_GAL_ALM_INFO        C_GAL_SVID_FULL_MASK
#define C_DELETE_INFO_GAL_SV_DIR_INFO     C_GAL_SVID_FULL_MASK
#define C_DELETE_INFO_GAL_SV_STEER_INFO   C_GAL_SVID_FULL_MASK
#define C_DELETE_INFO_GAL_SV_HEALTH_INFO  C_GAL_SVID_FULL_MASK
...
typedef struct
{
   ...
   *        this field type should be "gnss_SlowClkSrcEnumTypeVal" 
   */
  uint8      e_SlowClkSrc;
  boolean                         b_TimeIsGps;
...
typedef enum
{
  EXTERN_COARSE_POS_NETWORK_SOURCE_UNDEFINED = 0,
  EXTERN_COARSE_POS_NETWORK_SOURCE_INTERNAL,
  EXTERN_COARSE_POS_NETWORK_SOURCE_EXTERNAL,
} gps_extern_coarse_pos_network_source_e_typeVal;
typedef uint32 gps_extern_coarse_pos_network_source_e_type;
...
typedef enum
{
  ...
  CGPS_SRV_SYS_LTE_M1   = 0x80,         /*LTE_M1 mode*/
  CGPS_SRV_SYS_LTE_NB1  = 0x100,        /*LTE_NB1 mode*/
  CGPS_SRV_SYS_OTHER    = 0x200         /* All modes not covered above */
#else
  CGPS_SRV_SYS_OTHER    = 0x80         /* All modes not covered above */
#endif
} cgps_SrvSystemTypeVal;

/*#9x05: This has been changed from uint8 to uint16 to accomodate 
  serving systems CGPS_SRV_SYS_LTE_M1 and CGPS_SRV_SYS_LTE_NB1
*/
typedef uint16 cgps_SrvSystemType;
...
/* FEE Type - stores data for PE corrected freq bias */
typedef struct
{
  int32 l_TotalFreqBias; /* This bias is XO Corrections + PE calculated bias */
  tcxomgr_temp_set_type z_Temp; /* This is the temperature when PE clock report is received */
  uint64 t_TimeTick;
  FLT f_FixFunc;
  FLT f_ClkFreqBias;  /* Clock frequency bias. [m/s] */
}mc_posFix_fee_type;
...
#define  GPS_TIME_CHECK_SOURCE_CFG_REQ       0x00000020
...
/*
 ******************************************************************************
 * Function cgps_xofestrmTCXOManagerRPushCB
 *
 * Description:
 *
 *  This is a callback function called by TCXO Manager to send Frequency
 ...
 ******************************************************************************
*/
void cgps_xofestrmTCXOManagerRPushCB
(
  tcxomgr_rpush_cb_data_type              cb_data
);
...
/*
 ******************************************************************************
 * Function cgps_xofestrmTCXOManagerTempCB
 *
 * Description:
 *
 *
 ...
 ******************************************************************************
*/
void cgps_xofestrmTCXOManagerTempCB
(
  tcxomgr_temp_set_type  temp, 
  uint32 temp_channel
);
...
/**
 * @brief cgps_GpsTCXOManagerCalCoeffUpdateCB is the callback function called 
 *        by TCXO manager when there is a change in the field
 *        calibration values.
 *  
 ...
 */
 ...
 extern void cgps_TCXOManagerCalCoeffUpdateCB
...
/*============================================================================
FUNCTION gnss_Wgs84ToDtmEcef
DESCRIPTION
    Function to convert WGS84 coordinates to pre-selected co-ordinate system
    using a Helmert transformation

INPUT PARAM 
    d_PosEcefWGS84  - ptr to Input  SV coordinates[3] in WGS84 frame
    e_DTMSys - Datum co-ordinate system
OUT PARAM
    d_PosEcefDTM  - ptr to Output SV coordinates[3] in the pre-selected frame

     |X|                    | 1   Rz   -Ry|    |X|      |Cx|
     |Y|   =  (1+ Rs x 1E-6)|-Rz   1    Rx| x  |Y|   +  |Cy|
     |Z|                    |Ry   -Rx   1 |    |Z|      |Cz|
      SYS2                               SYS1(WGS84)
 
    Cx, Cy, Cz:  axis offsets, in meters
    Rx, Ry, Rz:  axis rotations, in radians
    Scale(Rs): Datum Scale factor, unit less, in units of 1E-6
DEPENDENCIES
...
SIDE EFFECTS
    None   
===============================================================================*/
void gnss_Wgs84ToDtmEcef(const DBL d_PosEcefWGS84[], 
                         DBL d_PosEcefDTM[],
                         gnss_DatumEnumType e_DTMSys);

/******************************************************************************
* Function description:
*  gnss_Ecef2LlaGet() converts an ECEF position into a Lat, Lon & Alt for a
*  pre-selected datum
* 
*  Parameters: 
*  d_Ecef    - XYZ position (m) in the ECEF coordinate system. 
...
******************************************************************************
*/
void gnss_Ecef2LlaGet(const DBL d_Ecef[], 
                      DBL d_Lla[], 
                      gnss_DatumEnumType e_DTMSys);
...
FUNCTION 
  gnss_PbsClientSwTrigger

DESCRIPTION
   gnss_PbsClientSwTrigger is a wrapper function to invoke the PBS API to enter/exit ESR_QUIET_MODE.

DEPENDENCIES
  None.

PARAMETERS
  e_TriggerEvent - to indicate Enter/Exit ESR_QUIET_MODE

RETURN VALUE
  Error code. 
  TRUE if ESR mode is switched. 
...
uint32 gnss_PbsClientSwTrigger (gnss_pbs_esr_trigger_enumtype e_TriggerEvent);
#endif
