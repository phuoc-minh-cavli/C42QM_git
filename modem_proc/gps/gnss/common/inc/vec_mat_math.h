...
/*==============================================================================
  ...
  use ISO format for dates.
   ...
   $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/common/inc/vec_mat_math.h#1 $ 
...
/******************************************************************************
 * Function description:
 *  pe_VectorDotProdFlt() - computes the dot product of two vectors
 *
 * Parameters: f_A - Vector A
 *             f_B - Vector B
 *             q_Rows - Length of vectors A and B
 *
 * Return value:  dot product of f_A and f_B
 ******************************************************************************/
FLT pe_VectorDotProdFlt(const FLT f_A[], const FLT f_B[], U32 q_Rows);
...
/******************************************************************************
 * Function description:
 *  pe_VectorSumOfSquaresDiff() - computes the sum of squares of the difference 
 *                              between two vectors    
 * Parameters:
 *    pd_V1, pd_V2, q_Rows
 *
 * Return value:  sum of squares of d_V, where the length of d_V is q_Rows
 ******************************************************************************/
DBL pe_VectorSumOfSquaresDiff(const DBL * pd_V1, const DBL *pd_V2, uint32 q_Rows);
...
/******************************************************************************
 * Function description:
 *  pe_VectorMeanStd() - computes mean and std of vector V
 *
 * Parameters:
 *    d_V     : input vector
 *    u_Rows  : Number of samples
 *    pf_mean : Pointer to computed mean
 *    pf_std  : Pointer to computed std
 *
 * Return value:  - boolean: True: mean and std are computed successfully 
 *                           False otherwise
 *                
 ******************************************************************************/
boolean pe_VectorMeanStd(const FLT *f_V, uint8 u_Rows, FLT *f_mean, FLT * f_std);
...
/******************************************************************************
* Function description:
*  pe_VectorSumFlt() - computes the sum of an arbitrary length vector
*
* Parameters:
*     pf_V: pointer to the array
*     q_Rows: number of element
*
* Return value:  sum of f_V, where the length of f_V is q_Rows
******************************************************************************/
FLT pe_VectorSumFlt(const FLT *pf_V, uint32 q_Rows);
/******************************************************************************
* Function description:
*  pe_VectorNormalizeBySumFlt() - normalizes vector d_V by the sum
*
* Parameters:
*     pf_V: pointer to the array
*     q_Rows: number of element
*
* Return value:  - none
*                - modifies pf_V so that sum(f_V) = 1
******************************************************************************/
void pe_VectorNormalizeBySumFlt(FLT *pf_V, uint32 q_Rows);
