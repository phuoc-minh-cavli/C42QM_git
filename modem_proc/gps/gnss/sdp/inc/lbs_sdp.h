...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sdp/inc/lbs_sdp.h#1 $
...
/* SDP Sensor Control mask for various sensor types */
/* No Sensors */
#define SDP_CTRL_NO_SNS_ALLOWED        0x00000000
/* Device Sensors, including, accel, gyro, mag, and temperature */
#define SDP_CTRL_DEV_SNS_ALLOWED        0x00000001
/* Vehicle Sensors, including, vehicle-accel, and vehicle-gyro */
#define SDP_CTRL_VEH_SNS_ALLOWED        0x00000002
/* Pedestrian Sensors, including, pedometer, ped-alignment and motion-data */
#define SDP_CTRL_PED_SNS_ALLOWED        0x00000004
/*All Sensors*/
#define SDP_CTRL_ALL_SNS_ALLOWED (SDP_CTRL_DEV_SNS_ALLOWED|SDP_CTRL_VEH_SNS_ALLOWED|SDP_CTRL_PED_SNS_ALLOWED)
...
/*=============================================================================
  ...
  FUNCTION      sdp_InjectSensorControlCommand()

  DESCRIPTION   Inject the sensor control command from TechSel. TechSel can
                set control for device and/or ped. sensor as allowed or not
                allowed. See SDP_CTRL_XXX for input bitmask.

  DEPENDENCIES  NONE

  PARAMETERS    q_SensorControlMask: sensor control bitmask
...
=============================================================================*/
void sdp_InjectSensorControlCommand( uint32 q_SensorControlMask );
