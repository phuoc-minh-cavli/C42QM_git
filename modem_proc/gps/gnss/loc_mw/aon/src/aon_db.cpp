...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/aon/src/aon_db.cpp#1 $ 
...
boolean AonDatabase::addAonTransac(AonTransac* aonTransac)
{
  if(NULL == aonTransac)
  {
    AON_MSG_ERROR("AonDatabase:: addAonTransac NULL aonTransac", 0,0,0);
    return FALSE;
  }
...
boolean AonDatabase::delAonTransac(AonTransac* aonTransac)
{
   ...
   if(NULL == aonTransac)
   {
      AON_MSG_ERROR("AonDatabase:: delAonTransac NULL aonTransac", 0,0,0);
      return FALSE;
   }
   ...
   while(ctr < AON_DB_MAX_GF_TRANSACTIONS)
   {
      ...
      {
         GNSS_DELETE(CGPS_LOCMW_MODULE_AON, AonTransac, aonTransac);
