...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/aon/inc/aon_api.h#1 $ 
...
typedef void (* aonLocationCallback)
(
   uint32 reqId,
...
typedef void (* aonStatusCallback)
(
   uint32 reqId,
...
*//* ------------------------------------------------------------------------*/
aonOperationStatusType aonCreateDbtRequest
(
   uint32 reqId, 
   uint32 minDistance,
...
*//* ------------------------------------------------------------------------*/
aonOperationStatusType aonGmEventHandler
(
   uint32 q_MsgId,
   uint8 *p_data
);
