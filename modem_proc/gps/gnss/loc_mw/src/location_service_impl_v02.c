...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/src/location_service_impl_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/* This file was generated with Tool version 6.14.7
   It was generated on: Tue Jan 31 2017 (Spin 1)
...
static const uint32_t qmiLocStartReqMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x17)   |  /* positionReportTimeout */
    QMI_SI_TLV_SET(0x18)      /* sharePosition */
};
...
static const uint32_t qmiLocEventPositionReportIndMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x2E)   |  /* velEnu */
    QMI_SI_TLV_SET(0x2F)      /* velUncEnu */
  ,

    QMI_SI_TLV_SET(0x30)      /* navSolutionMask */
};
...
static const uint32_t qmiLocGetFixCriteriaIndMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x14)   |  /* configAltitudeAssumed */
    QMI_SI_TLV_SET(0x15)   |  /* minIntermediatePositionReportInterval */
    QMI_SI_TLV_SET(0x16)   |  /* positionReportTimeout */
    QMI_SI_TLV_SET(0x17)      /* sharePosition */
};
...
static const uint32_t qmiLocInjectPositionReqMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x20)   |  /* onDemandCpi */
    QMI_SI_TLV_SET(0x21)      /* positionSrcProvider */
};
...
static const uint32_t qmiLocSetOperationModeReqMsgT_impl_array_v02[] =
{
...
{
  1, /* number of elements in array */
  qmiLocSetOperationModeReqMsgT_impl_array_v02
};
...
static const uint32_t qmiLocSetProtocolConfigParametersReqMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x19)   |  /* lppeUpConfig */
    QMI_SI_TLV_SET(0x1A)      /* lppeCpConfig */
};
...
static const uint32_t qmiLocEventInjectWifiApDataReqIndMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)      /* e911Mode */
};

static const qmi_implemented_optionals qmiLocEventInjectWifiApDataReqIndMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocEventInjectWifiApDataReqIndMsgT_impl_array_v02
};
static const qmi_implemented_optionals_tuple qmi_loc_event_inject_wifi_ap_data_reqresp_impl_tuple_v02 = 
{
  NULL,
  NULL,
  &qmiLocEventInjectWifiApDataReqIndMsgT_impl_v02
};

static const uint32_t qmiLocInjectWifiApDataReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* errorCause */
    QMI_SI_TLV_SET(0x11)   |  /* requestTimestamp */
    QMI_SI_TLV_SET(0x12)   |  /* receiveTimestamp */
    QMI_SI_TLV_SET(0x13)   |  /* onDemandScan */
    QMI_SI_TLV_SET(0x14)      /* wifiApInfoA */
};

static const qmi_implemented_optionals qmiLocInjectWifiApDataReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocInjectWifiApDataReqMsgT_impl_array_v02
};
...
static const uint32_t qmiLocEventGnssSvMeasInfoIndMsgT_impl_array_v02[] =
{
    ...
    QMI_SI_TLV_SET(0x1C)      /* numClockResets */
};
...
static const uint32_t qmiLocInjectApCacheDataReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)      /* apCacheHepeRelData */
};

static const qmi_implemented_optionals qmiLocInjectApCacheDataReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocInjectApCacheDataReqMsgT_impl_array_v02
};
static const uint32_t qmiLocInjectApCacheDataIndMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* apCacheSize */
    QMI_SI_TLV_SET(0x11)   |  /* apDoNotCacheSize */
    QMI_SI_TLV_SET(0x12)   |  /* apCacheHits */
    QMI_SI_TLV_SET(0x13)   |  /* apDoNotCacheHits */
    QMI_SI_TLV_SET(0x14)   |  /* unknownAps */
    QMI_SI_TLV_SET(0x15)   |  /* asyncScans */
    QMI_SI_TLV_SET(0x16)   |  /* asyncFixes */
    QMI_SI_TLV_SET(0x17)   |  /* syncScans */
    QMI_SI_TLV_SET(0x18)      /* syncFixes */
};

static const qmi_implemented_optionals qmiLocInjectApCacheDataIndMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocInjectApCacheDataIndMsgT_impl_array_v02
};
...
static const uint32_t qmiLocGtpApStatusReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* gtpApPcid64 */
    QMI_SI_TLV_SET(0x11)   |  /* oemId */
    QMI_SI_TLV_SET(0x12)      /* modelId */
};

static const qmi_implemented_optionals qmiLocGtpApStatusReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocGtpApStatusReqMsgT_impl_array_v02
};
static const qmi_implemented_optionals qmiLocGtpApStatusIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_gtp_ap_status_reqresp_impl_tuple_v02 = 
{
  &qmiLocGtpApStatusReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGtpApStatusIndMsgT_impl_v02
};

static const uint32_t qmiLocGdtDownloadBeginStatusReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* wwanDownloadFlag */
    QMI_SI_TLV_SET(0x11)   |  /* respLocInfo */
    QMI_SI_TLV_SET(0x12)      /* apRemainingThrottleTime */
};

static const qmi_implemented_optionals qmiLocGdtDownloadBeginStatusReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocGdtDownloadBeginStatusReqMsgT_impl_array_v02
};
static const qmi_implemented_optionals qmiLocGdtDownloadBeginStatusIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_gdt_download_begin_status_reqresp_impl_tuple_v02 = 
{
  &qmiLocGdtDownloadBeginStatusReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGdtDownloadBeginStatusIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocGdtDownloadReadyStatusReqMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals qmiLocGdtDownloadReadyStatusIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_gdt_download_ready_status_reqresp_impl_tuple_v02 = 
{
  &qmiLocGdtDownloadReadyStatusReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGdtDownloadReadyStatusIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocGdtReceiveDoneStatusReqMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals qmiLocGdtReceiveDoneStatusIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_gdt_receive_done_status_reqresp_impl_tuple_v02 = 
{
  &qmiLocGdtReceiveDoneStatusReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGdtReceiveDoneStatusIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocGdtDownloadEndStatusReqMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals qmiLocGdtDownloadEndStatusIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_gdt_download_end_status_reqresp_impl_tuple_v02 = 
{
  &qmiLocGdtDownloadEndStatusReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGdtDownloadEndStatusIndMsgT_impl_v02
};

static const uint32_t qmiLocEventGdtDownloadBeginReqIndMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* powerBudgetInfo */
    QMI_SI_TLV_SET(0x11)   |  /* powerBudgetAllowance */
    QMI_SI_TLV_SET(0x12)      /* downloadRequestMask */
};

static const qmi_implemented_optionals qmiLocEventGdtDownloadBeginReqIndMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocEventGdtDownloadBeginReqIndMsgT_impl_array_v02
};
static const qmi_implemented_optionals_tuple qmi_loc_event_gdt_download_begin_reqresp_impl_tuple_v02 = 
{
  NULL,
  NULL,
  &qmiLocEventGdtDownloadBeginReqIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocEventGdtReceiveDoneIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_event_gdt_receive_done_impl_tuple_v02 = 
{
  NULL,
  NULL,
  &qmiLocEventGdtReceiveDoneIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocEventGdtDownloadEndReqIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_event_gdt_download_end_reqresp_impl_tuple_v02 = 
{
  NULL,
  NULL,
  &qmiLocEventGdtDownloadEndReqIndMsgT_impl_v02
};

static const uint32_t qmiLocDeleteGNSSServiceDataReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* deleteClockInfoMask */
    QMI_SI_TLV_SET(0x11)   |  /* deleteCellDbDataMask */
    QMI_SI_TLV_SET(0x12)   |  /* deleteCommonDataMask */
    QMI_SI_TLV_SET(0x13)      /* deleteSatelliteData */
};

static const qmi_implemented_optionals qmiLocDeleteGNSSServiceDataReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocDeleteGNSSServiceDataReqMsgT_impl_array_v02
};
static const qmi_implemented_optionals qmiLocDeleteGNSSServiceDataIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_delete_gnss_service_data_reqresp_impl_tuple_v02 = 
{
  &qmiLocDeleteGNSSServiceDataReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocDeleteGNSSServiceDataIndMsgT_impl_v02
};

static const uint32_t qmiLocInjectXtraDataReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)      /* formatType */
};

static const qmi_implemented_optionals qmiLocInjectXtraDataReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocInjectXtraDataReqMsgT_impl_array_v02
};
static const uint32_t qmiLocInjectXtraDataIndMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* partNum */
    QMI_SI_TLV_SET(0x11)      /* ConstellationMask */
};

static const qmi_implemented_optionals qmiLocInjectXtraDataIndMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocInjectXtraDataIndMsgT_impl_array_v02
};
static const qmi_implemented_optionals_tuple qmi_loc_inject_xtra_data_reqresp_impl_tuple_v02 = 
{
  &qmiLocInjectXtraDataReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocInjectXtraDataIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocInjectXtraPcidReqMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals qmiLocInjectXtraPcidIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_inject_xtra_pcid_reqresp_impl_tuple_v02 = 
{
  &qmiLocInjectXtraPcidReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocInjectXtraPcidIndMsgT_impl_v02
};

static const qmi_implemented_optionals qmiLocGetSupportedFeatureIndMsgT_impl_v02 =
{
  0, /* No Optional TLVs in message */
  0
};
static const qmi_implemented_optionals_tuple qmi_loc_get_supported_feature_reqresp_impl_tuple_v02 = 
{
  NULL,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocGetSupportedFeatureIndMsgT_impl_v02
};

static const uint32_t qmiLocCrowdSourceManagerControlReqMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* enableCrowdSourcingMask */
    QMI_SI_TLV_SET(0x11)   |  /* wifiCrowdSourcingLocalConfig */
    QMI_SI_TLV_SET(0x12)      /* wifiCrowdSourcingServerConfig */
};

static const qmi_implemented_optionals qmiLocCrowdSourceManagerControlReqMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocCrowdSourceManagerControlReqMsgT_impl_array_v02
};
static const uint32_t qmiLocCrowdSourceManagerControlIndMsgT_impl_array_v02[] =
{
    QMI_SI_TLV_SET(0x10)   |  /* supportedCrowdSourcingMask */
    QMI_SI_TLV_SET(0x11)   |  /* wifiCrowdSourcingCapabaility */
    QMI_SI_TLV_SET(0x12)      /* modemClientInfo */
};

static const qmi_implemented_optionals qmiLocCrowdSourceManagerControlIndMsgT_impl_v02 =
{
  1, /* number of elements in array */
  qmiLocCrowdSourceManagerControlIndMsgT_impl_array_v02
};
static const qmi_implemented_optionals_tuple qmi_loc_crowdsource_manager_control_reqresp_impl_tuple_v02 = 
{
  &qmiLocCrowdSourceManagerControlReqMsgT_impl_v02,
  &qmiLocGenRespMsgT_impl_v02,
  &qmiLocCrowdSourceManagerControlIndMsgT_impl_v02
};
...
static const qmi_implemented_optionals_tuple * const loc_service_implemented_array_v02[] =
{
    ...
    &qmi_loc_gtp_ap_status_reqresp_impl_tuple_v02,       /* 0x009E */
    &qmi_loc_gdt_download_begin_status_reqresp_impl_tuple_v02, /* 0x009F */
    &qmi_loc_gdt_download_ready_status_reqresp_impl_tuple_v02, /* 0x00A0 */
    &qmi_loc_gdt_receive_done_status_reqresp_impl_tuple_v02, /* 0x00A1 */
    &qmi_loc_gdt_download_end_status_reqresp_impl_tuple_v02, /* 0x00A2 */
    &qmi_loc_event_gdt_download_begin_reqresp_impl_tuple_v02, /* 0x00A3 */
    &qmi_loc_event_gdt_receive_done_impl_tuple_v02,      /* 0x00A4 */
    &qmi_loc_event_gdt_download_end_reqresp_impl_tuple_v02, /* 0x00A5 */
    &qmi_loc_delete_gnss_service_data_reqresp_impl_tuple_v02, /* 0x00A6 */
    &qmi_loc_inject_xtra_data_reqresp_impl_tuple_v02,    /* 0x00A7 */
    &qmi_loc_inject_xtra_pcid_reqresp_impl_tuple_v02,    /* 0x00A8 */
    &qmi_loc_get_supported_feature_reqresp_impl_tuple_v02, /* 0x00A9 */
    &qmi_loc_crowdsource_manager_control_reqresp_impl_tuple_v02  /* 0x00AA */
};

static const qmi_implemented_messages loc_service_implemented_v02 =
{
  0x00AA,  /* maximum message ID in this service */
