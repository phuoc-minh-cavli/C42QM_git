...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/src/loc_log.c#1 $ */
...
)
{
  ...
  {
    LOC_MSG_LOW("LocMw log not enabled",0,0,0);
    return;
  }
  LOC_MSG_HIGH("ALS IOD output OPC %d RU %d CONF %d",
  ...
  {
    LOC_MSG_ERROR("Geofencing Position Log allocation failure",0,0,0);
    return;
  }
