...
$Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/src/loc_nv_efs.c#1 $
...
static const cgps_nv_efs_reg_item_struct locNvRegItems[] =
{
  ...
  /* GNSS_NV_EFS_LOC_OTB_BUFFER_THRESHOLD */
  {
    CGPS_NV_EFS_REG_ST_ITEM_EXTERNAL, /* NV control is visible to external parties*/
    "loc/loc_otb_buffer_threshold", /* NV item file name*/
    sizeof(uint32), /* 32 bits */
    0, /* precision not applicable */
    CGPS_NV_EFS_REG_TYPE_INTEGRAL /* integer */ 
  }
...
boolean locNvEfsInit(void) 
{
  ...
  LOC_MSG_MED("locNvEfsInit, v_Inited = %d", v_Inited,0,0);
  return v_Inited;
}
                         ...
                         void *pData, uint32 q_size)
{
  ...
  LOC_MSG_MED("locNvEfsRead, status = %d", status,0,0);
