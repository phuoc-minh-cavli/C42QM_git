...
/*============================================================================
 ...
 $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/loc_mw/src/loc_sensor_amd.h#1 $
...
#define GEOFENCE_AMD_IND_TYPE_ERROR           0
#define GEOFENCE_AMD_IND_TYPE_ENABLE_RESP     1 
#define GEOFENCE_AMD_IND_TYPE_DISABLE_RESP    2
#define GEOFENCE_AMD_IND_TYPE_REPORT          3
...
typedef struct
{
  ...
  union
  {
    slimErrorEnumT     amd_err_type;
    slimQmdDataStructT amd_report_ind;
  }u;
