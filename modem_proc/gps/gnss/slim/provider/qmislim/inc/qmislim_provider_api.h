...
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/provider/qmislim/inc/qmislim_provider_api.h#1 $ */
...
struct slim_QSProviderS
{
  ...
  volatile slimServiceProviderMaskT z_SPMasks[SLIM_SERVICE_COUNT];
  /**< @brief Arrays for service provider masks */

  slim_ServiceStatusStructType z_ServiceStatus[SLIM_SERVICE_COUNT];
