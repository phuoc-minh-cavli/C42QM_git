...
#define _sns_std_sensor_attr_id_MAX SNS_STD_SENSOR_ATTRID_PHYSICAL_SENSOR
#define _sns_std_sensor_attr_id_ARRAYSIZE ((sns_std_sensor_attr_id)(SNS_STD_SENSOR_ATTRID_PHYSICAL_SENSOR+1))
