#ifndef SLIM_QMD_QMI_PB_H
#define SLIM_QMD_QMI_PB_H
/**
@file
...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/provider/ssc/qmisns/pb/inc/slim_ssc_qmd_qmipb.h#1 $ */
...
*/
bool slim_PBDecodeQmdEvent(pb_istream_t *pz_stream, const pb_field_t *pz_field, void **ppz_arg);
