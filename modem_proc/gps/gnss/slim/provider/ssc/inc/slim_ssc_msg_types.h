...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/provider/ssc/inc/slim_ssc_msg_types.h#1 $ */
...
typedef enum
{
  ...
  eSLIM_SSC_MSG_ID_CLIENT_API_RESP,
  eSLIM_SSC_MSG_ID_CLIENT_API_IND,
  eSLIM_SSC_MSG_ID_CLIENT_API_RESP_CLOSE,
