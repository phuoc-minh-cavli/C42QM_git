 ...
 */
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/qmislim/qmiservice/inc/qmislim_qmi_service_api.h#1 $ */
...
typedef void (*slim_disable_response_cb_type) (void);
extern slim_disable_response_cb_type loc_middleware_disable_sensor_cb;

void slim_QSQmi_disable_sensor(slim_disable_response_cb_type loc_disable_sensor_cb);
