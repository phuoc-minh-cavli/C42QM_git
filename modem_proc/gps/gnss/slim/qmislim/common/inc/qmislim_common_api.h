 ...
 */
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/qmislim/common/inc/qmislim_common_api.h#1 $ */
...
/**
  @brief Type for holding SLIM QMD object and related other info

  The type is for storing QMD infor when enabling sensor.

 */
typedef struct 
{
  boolean qmd_disable_needed_due_to_impending_PSM_entry;
  boolean qmd_disable_responses_received_for_amd;
  boolean qmd_disable_responses_received_for_smd;
  struct 
  {
    boolean b_qmd_info_available;
