 ...
 * -------------------------------------------------------------------------*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/qmislim/mpss/inc/qmislim_target.h#1 $ */
...
/**
  ...
  @ingroup slim_QSAlloc
 */
#define SLIM_QS_ALLOCATOR_QMI_CLT_TX_COUNT      (16)
/**
...
/**
  ...
  @ingroup slim_QS
 */
INLINE boolean slim_QSMutexInit
(
...
/**
  ...
  @ingroup slim_QS
 */
INLINE boolean slim_QSMutexDeinit
(
  slim_QSMutexT *pz_Mutex
  /**< [in] Mutex object */
)
...
/**
  ...
  @ingroup slim_QS
 */
INLINE void slim_QSMutexUnlock
(
  slim_QSMutexT *pz_Mutex
  /**< [in] Mutex object */
)
...
/**
  ...
  @ingroup slim_QS
 */
INLINE void slim_QSCsiOsParamsInit
(
...
/**
  ...
  @ingroup slim_QS
 */
INLINE void slim_QSCciOsParamsInit
(
...
/**
  ...
  @ingroup slim_QS
 */
INLINE void slim_QSCsiUnpackIpc
(
