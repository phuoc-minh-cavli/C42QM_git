...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/common/core/src/slim_log.h#1 $ */
...
/**
@brief Logs SLIM state including provider, client and txn registry.

Function logs SLIM state including provider, client and txn registry.

@param[in] pz_ProviderRegistry  SLIM provider registry.
@param[in] pz_ClientRegistry    SLIM client registry.
@param[in] pz_TxnRegistry       SLIM Txn registry.
*/
void slim_LogSlimState
( 
  const slim_ProviderRegistryStructType* pz_ProviderRegistry,
  const slim_ClientRegistryStructType* pz_ClientRegistry,
  const slim_TxnRegistryStructType* pz_TxnRegistry
);
