...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/common/core/inc/slim_provider_data.h#1 $ */
...
typedef struct slim_ServiceProviderInterfaceStruct
{
  ...
  /* e.g. slimz_Provider ==> SscEnableQmdDataRequest*/
  /**< Enable request for AMD/RMD/SMD data. */
