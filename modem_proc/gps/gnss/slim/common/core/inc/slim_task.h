...
*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/common/core/inc/slim_task.h#1 $ */
...
*/
#define IPC_SLIM_TO_TASK_MIN LM_MIDDLEWARE_MSG_ID_SLIM_MIN
/**
...
*/
#define IPC_SLIM_TO_TASK_FIRST_QMISLIM IPC_SLIM_TO_TASK_MIN + 900
/**
...
@sa slim_TaskIpcHandler
*/
#define IPC_SLIM_TO_TASK_MAX LM_MIDDLEWARE_MSG_ID_SLIM_MAX
...
*/
#define IPC_SLIM_TIMER_ID_MIN LOC_MIDDLEWARE_TIMER_ID_SLIM_MIN
/**
...
*/
#define IPC_SLIM_TIMER_ID_FIRST_QMISLIM IPC_SLIM_TIMER_ID_MIN + 900
/**
...
@sa slim_TaskTimerHandler
*/
#define IPC_SLIM_TIMER_ID_MAX LOC_MIDDLEWARE_TIMER_ID_SLIM_MAX
...
typedef enum
{
  ...
  M_IPC_SLIM_LOG_TIMER_ID,
  /**< Timer for SLIM State logging */
  M_IPC_SLIM_SVR_DISCOVERY_TIMER_ID,
  /**< Timer for SLIM service discovery */
  M_IPC_SLIM_SENSOR_DISABLE_WAIT_TIMER_ID,
  /**< Timer for SLIM service discovery */
