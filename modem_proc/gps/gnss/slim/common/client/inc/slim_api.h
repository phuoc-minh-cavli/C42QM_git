...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/common/client/inc/slim_api.h#1 $ */
...
*/
extern const uint32_t slim_GFAmdHandle;
extern const uint32_t slim_GFPedHandle;
extern const uint32_t slim_GFSmdHandle;
extern const uint32_t slim_GFRmdHandle;
extern const uint32_t slim_GFCmcDbHandle;
...
/**
@brief Handle for SLIM initial service discovery
*/
extern const uint32_t slim_InitSvrDiscoveryHandle;

/**
@brief Handle for SLIM UnitTest Client use
*/
extern const uint32_t slim_UnitTestHandle;

/**
@brief Handle for SM TM use
*/
extern const uint32_t slim_TMHandle;
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_SENSOR_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_SENSOR_DATA_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_MOTION_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_MOTION_DATA_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_PEDOMETER_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_PEDOMETER_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_QMD_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_QMD_DATA_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_SMD_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_SMD_DATA_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_DISTANCE_BOUND_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_DISTANCE_BOUND_DATA_DISABLE_RESP/no payload
...
via registered callback function. @see slimNotifyCallbackFunctionT
 ...
 - ID/Payload: eSLIM_MESSAGE_ID_MAG_FIELD_DATA_ENABLE_RESP/no payload
               eSLIM_MESSAGE_ID_MAG_FIELD_DATA_DISABLE_RESP/no payload
