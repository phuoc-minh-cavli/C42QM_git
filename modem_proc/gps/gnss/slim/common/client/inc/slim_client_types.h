...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/common/client/inc/slim_client_types.h#1 $ */
...
typedef enum
{
  ...
  /* SMD data messages */
  eSLIM_MESSAGE_ID_SMD_DATA_IND = eSLIM_MESSAGE_ID_QMD_DATA_IND,
  /**< slimSmdDataStructT */
  eSLIM_MESSAGE_ID_SMD_DATA_ENABLE_RESP = eSLIM_MESSAGE_ID_QMD_DATA_ENABLE_RESP,
  /**< no payload */
  ...
  /**< no payload */
  eSLIM_MESSAGE_ID_SMD_DATA_DISABLE_RESP = eSLIM_MESSAGE_ID_QMD_DATA_DISABLE_RESP,
  /**< no payload */
...
typedef slimEnableQmdDataRequestStructT slimEnableSmdDataRequestStructT ;
