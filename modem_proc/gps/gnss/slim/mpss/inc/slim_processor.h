...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/slim/mpss/inc/slim_processor.h#1 $ */
...
#ifdef MSG_SSID_SLIM
#define SLIM_MSG0(LEVEL, str)           MSG(MSG_SSID_SLIM, MSG_LEGACY_HIGH, str)
#define SLIM_MSG1(LEVEL, str, a)        MSG_1(MSG_SSID_SLIM, MSG_LEGACY_HIGH, str, a)
#define SLIM_MSG2(LEVEL, str, a, b)     MSG_2(MSG_SSID_SLIM, MSG_LEGACY_HIGH, str, a, b)
#define SLIM_MSG(LEVEL, str, a, b, c)   MSG_3(MSG_SSID_SLIM, MSG_LEGACY_HIGH, str, a, b, c)
...
#else
#define SLIM_MSG0(LEVEL, str)           MSG(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, str)
#define SLIM_MSG1(LEVEL, str, a)        MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, str, a)
#define SLIM_MSG2(LEVEL, str, a, b)     MSG_2(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, str, a, b)
#define SLIM_MSG(LEVEL, str, a, b, c)   MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, str, a, b, c)
#endif

#define SLIM_MSG_LOW0(str)              SLIM_MSG0(MSG_LEGACY_HIGH, str)
#define SLIM_MSG_LOW1(str, a)           SLIM_MSG1(MSG_LEGACY_HIGH, str, a)
#define SLIM_MSG_LOW2(str, a, b)        SLIM_MSG2(MSG_LEGACY_HIGH, str, a, b)
#define SLIM_MSG_LOW(str, a, b, c)      SLIM_MSG(MSG_LEGACY_HIGH, str, a, b, c)
#define SLIM_MSG_MED0(str)              SLIM_MSG0(MSG_LEGACY_HIGH, str)
#define SLIM_MSG_MED1(str, a)           SLIM_MSG1(MSG_LEGACY_HIGH, str, a)
#define SLIM_MSG_MED2(str, a, b)        SLIM_MSG2(MSG_LEGACY_HIGH, str, a, b)
#define SLIM_MSG_MED(str, a, b, c)      SLIM_MSG(MSG_LEGACY_HIGH, str, a, b, c)
...
typedef enum
{
  ...
  SLIM_CLIENT_INIT_SVR_DISCOVERY, /**< Client id for initial service discovery */
  SLIM_CLIENT_SAMLITE,          /**< Client id for SAMLite */
  SLIM_CLIENT_QMISLIM_AP,       /**< AP connections from QMI-SLIM */
  SLIM_CLIENT_TM,               /**< Client id for TM */
  SLIM_CLIENT_UNIT_TEST,        /**< Client id for unit-test */
  SLIM_CLIENT_GEOFENCING_AMD,   /**< Client id for Geofencing for AMD */
  SLIM_CLIENT_GEOFENCING_RMD,   /**< Client id for Geofencing for RMD */
  SLIM_CLIENT_GEOFENCING_SMD,   /**< Client id for Geofencing for SMD */
  SLIM_CLIENT_GEOFENCING_PED,   /**< Client id for Geofencing for PED */
  SLIM_CLIENT_GEOFENCING_CMC_DB,/**< Client id for Geofencing for CMC/DB */
  SLIM_CLIENT_LAST = SLIM_CLIENT_GEOFENCING_CMC_DB, /**< Last client handle enum
                                                value in use */
  //! @cond
