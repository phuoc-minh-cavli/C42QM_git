...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/inc/sm_loc_lte_otdoa.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/25/17   kpn     L+L changes for OTDOA
...
boolean sm_loc_lte_otdoa_start_cmd(const sm_OTDOA_AssistanceData *p_otdoa_ad, uint32 q_operation_mode,
                                   uint32 u_sess_type,sys_modem_as_id_e_type e_as_id);
...
/*===========================================================================
  ...
  Return value: 
    boolean: SUCCESS or FAIL
=============================================================================*/
boolean sm_loc_lte_otdoa_get_measurements(const gnss_ClockStructType *const p_gnss_clock, uint32 u_sess_type,
                                          boolean earlyMeasurement);
...
/*===========================================================================
  ...
  Return value: 
    boolean: SUCCESS or FAIL
=============================================================================*/
boolean sm_loc_lte_otdoa_stop_cmd(uint8 u_reason, uint32 u_sess_type, sys_modem_as_id_e_type e_as_id);
...
/*===========================================================================
  ...
  Parameters:
    e_as_id: Sub ID on which OTA reset is happening.

  Return value: 
    boolean: SUCCESS or FAIL
=============================================================================*/
boolean sm_loc_lte_ota_reset(sys_modem_as_id_e_type e_as_id);
