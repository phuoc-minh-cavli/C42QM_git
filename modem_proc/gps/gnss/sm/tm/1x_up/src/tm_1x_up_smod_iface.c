...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/src/tm_1x_up_smod_iface.c#1 $  
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Optimal mode. For curr_mode=%d end_status=%d, return from here",curr_mode,end_status,0);
