...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/src/tm_1x_up_is801_driver.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
11/13/17   sum     Added support for reporting GLO and BDS sv info in case of MSB session over 1x up
08/14/17   sj      V2 MSB fallback to standalone if Fix produced before MPC connection
...
boolean tm_1x_up_is801_drv_start_fallback_msb_fix(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_up_is801_drv_start_fallback_msb_fix Succeeded", 0, 0, 0);
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_up_is801_drv_start_fallback_msb_fix Failed", 0, 0, 0);
    return FALSE;
  }                  
}
#endif
...
boolean tm_1x_up_is801_drv_continue_msb_fix(tm_1x_up_msb_op_e_type op_type)
{
  ...
  if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
             ...
             &tm_1x_up_sess_req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_continue_msb_fix Succeeded", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_1x_up_is801_drv_continue_msb_fix Failed", 0, 0, 0);
    return FALSE;
  }                  
}
/*===========================================================================
...
boolean tm_1x_up_is801_drv_start_ppm()
{
  ...
  if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
             ...
             &tm_1x_up_sess_req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_start_ppm Succeeded", 0, 0, 0);
    tm_1x_up_session_info.mgp_info.ppm_on = TRUE;
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_1x_up_is801_drv_start_ppm Failed", 0, 0, 0);
    return FALSE;
  }                  
}
...
boolean tm_1x_up_is801_drv_get_ppm(void)
{
   ...
   if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
              ...
              &tm_1x_up_sess_req_param))
   {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_get_ppm Succeeded", 0, 0, 0);
     if(!os_TimerStart(tm_1x_up_session_info.tm_1x_up_mgp_timer,TM_MGP_GET_PPM_TIMEOUT_MAX,NULL))
     {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Failed starting MGP PPM timer", 0, 0, 0);
     }
     return TRUE;
   }
   else
   {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_1x_up_is801_drv_get_ppm Failed", 0, 0, 0);
     return FALSE;
   }                  
}
...
boolean tm_1x_up_is801_drv_end_ppm()
{
    ...
    if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
               ...
               &tm_1x_up_sess_req_param))
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_end_ppm Succeeded", 0, 0, 0);
    ...
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_1x_up_is801_drv_end_ppm Failed", 0, 0, 0);
      return FALSE;
    }                  
}
...
boolean tm_1x_up_is801_drv_end_prm(void)
{
    ...
    if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
               ...
               &tm_1x_up_sess_req_param))
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_end_prm Succeeded", 0, 0, 0);
      tm_1x_up_session_info.mgp_info.prm_on = FALSE;
      return TRUE;
    }
    else
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "tm_1x_up_is801_drv_end_prm Failed", 0, 0, 0);
      return FALSE;
    }                  
}
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_trans_op_mode: curr_sess_mode=%d", cur_sess_mode, 0, 0);
                                        ...
                                        tm_op_req_type              op_to_stop)
{
  ...
  tm_1x_up_sess_req_param.stop_param.op_to_stop   = op_to_stop;
   ...
   if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
                 ...
                 &tm_1x_up_sess_req_param))
   {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_session_stop Succeeded", 0, 0, 0);
     return TRUE;
   }
   else
   {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "tm_1x_up_is801_drv_session_stop Failed", 0, 0, 0);
     return FALSE;
   }                  
}
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Check bs_info_update_reqd", 0, 0, 0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up state transition [%d] -> [%d]",
...
void tm_1x_up_is801_drv_cleanup(boolean abort_connection)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "1X UP Cleanup", 0, 0, 0);
  if(abort_connection)
  {
...
void tm_1x_up_is801_drv_handle_prm_timeout(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle PRM timeout", 0, 0, 0);

  if (tm_1x_up_session_info.mgp_info.prm_on == TRUE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Aborting MGP PR meas", 0, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Ending Session. Reason %d", stop_reason, 0, 0);
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Starting close connection procedure", 0, 0, 0);
  tm_1x_up_comm_close_connection();
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Delay sending STOP to TM_Core as waiting for sess_end ACK", 0, 0, 0);
  }
  else
  {
    tm_1x_up_is801_drv_cleanup(FALSE);
...
boolean tm_1x_up_is801_drv_set_mode(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Pos_Unc=%dm,Eph_validity=%d,Alm_validity=%d",
                              status_ptr->pos_unc,
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Process Dload request", 0, 0, 0);
    ...
    */
    if(*req_to_send)
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload operation req,mask=%d", *req_to_send, 0, 0);

      tm_1x_up_session_info.mode_info.mode            = TM_1X_UP_MODE_DLOAD;

      *resp_to_send |= i_tm_1x_up_is801_drv_set_resp_mask(pos_valid);

      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Resp to send=%d", *resp_to_send, 0, 0);
    } /* end if req_to_send */
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload from PDE not required", 0, 0, 0);
   ...
   ***************************************************************************/
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Process Fix request from Client", 0, 0, 0);
  ...
  */
  if (tm_1x_up_is801_drv_is_optimal_mode())
  {
    if (tm_1x_up_session_info.mode_info.last_error == TM_1X_UP_MODE_MSB)
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MS-B failed last time,force MS-A", 0, 0, 0);
              ...
              (tm_1x_up_session_info.mode_info.last_error == TM_1X_UP_MODE_DLOAD) )
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MS-A/DLOAD failed last time,force MS-B", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process Speed Optimal mode", 0, 0, 0);
        ...
        (status_ptr->pos_unc  < TM_PUNC_THRESHOLD_IN_SERVICE))
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "1X in service. Forcing MS-Based(punc=%d)",
    ...
    else if ((status_ptr->gps_eph_validity == 1) && (time_valid == TRUE))
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Forcing MS-Based(lr+clk=%d)",
    ...
    else
    {
      ...
      */
        ...
        )
      {
        ...
        */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "1X in service=%d(1=Y/0=N). punc=%d tunc=%d",
        ...
        *resp_to_send |= i_tm_1x_up_is801_drv_set_resp_mask(pos_valid);
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload data,req=%d,resp=%d", *req_to_send, *resp_to_send, 0);
        tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_DLOAD;
      }
      else
      {
        ...
        */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Force MS-Assist mode(lr+clk=%d)",
                   status_ptr->pos_unc + status_ptr->time_unc,0,0);
        tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_MSA;
    ...
    if (tm_1x_up_session_info.mode_info.mode != TM_1X_UP_MODE_MSA)
    {
      ...
      if (tm_sess_req(TM_PRTL_TYPE_1X_UP,
                      ...
                      &tm_1x_up_sess_req_param))
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Continue optimal as MSB sent ", 0, 0, 0);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Continue optimal as MSB not sent", 0, 0, 0);
      }
    }
  }
  else if (operation_mode == PDSM_SESSION_OPERATION_OPTIMAL_DATA)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process Data Optimal mode", 0, 0, 0);

    if ( (status_ptr->gps_eph_validity == 1) && (status_ptr->pos_unc < TM_LR_THRESHOLD_NO_POS))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Force MS-Based session", 0, 0, 0);
      tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_MSB;
    }
    else
    {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Force MS-Assist session", 0, 0, 0);
        tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_MSA;
      }
      else
      {
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process Accuracy optimal mode", 0, 0, 0);

    tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_MSA;
  } /* End ACCURACY */
  else if (operation_mode == PDSM_SESSION_OPERATION_MSASSISTED)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process MS-Assist only session", 0, 0, 0);
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Forcing AFLT only session", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process MS based only session ..", 0, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload data for MS-based only", 0, 0, 0);
      /* We don't have all the data for doing MS-Based fixes, proceed based on available data
      ...
      *req_to_send |= i_tm_1x_up_is801_drv_set_req_mask(
      ...
      else
      {
        ...
        */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Not possible, try MSB anyways", 0, 0, 0);
        tm_1x_up_session_info.mode_info.mode          = TM_1X_UP_MODE_MSB;
      } /* req_to_send */
    } /* end else */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Process REF_Position mode", 0, 0, 0);
    *req_to_send = i_tm_1x_up_is801_drv_set_req_mask(
                               FALSE, /* req GPS Eph */
                               status_ptr->gps_alm_validity,
                               FALSE, /* req Glo Eph */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Mode not supported", 0, 0, 0);
    ret_val = FALSE;
  }
  return ret_val;
} /* end operation_mode() */
...
boolean tm_1x_up_is801_drv_check_msb_throttling(boolean bConnectToMPC)
{
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MPC Connect: Throttle non-trusted MPC sessions", 0, 0, 0);
  ...
  else
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "PDE Connect: Don't throttle non-trusted PDE sessions", 0, 0, 0);
      return status;
    }
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MSBased download, check if throttling is required", 0, 0, 0);

    if (tm_1x_up_config.msb_throttling_info.msb_throttling_enabled)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MSB throttling enabled, verify values.....", 0, 0, 0);
      ...
      */
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Request after safe delay, back-off not required", 0, 0, 0);
      ...
      {                            
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Early request, verify throttle time first", 0, 0, 0);
        ...
        */
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Request after Throttle end time, allow download", 0, 0, 0);

#ifdef FEATURE_CALL_THROTTLE          
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "DCTM on, increase back_off_time when ppp opened", 0, 0, 0);
#else         
          tm_cm_iface_get_phone_state(&phone_state_info);
          if(phone_state_info.srv_system == CGPS_SRV_SYS_CDMA ||
             phone_state_info.srv_system == CGPS_SRV_SYS_HDR)
          {
            ...
            */
            ...
            if ( qw_cmp(tm_1x_up_config.msb_throttling_info.back_off_time,qw_time) > 0 )
            {
              ...
              */
              MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Back off time set to maximum", 0, 0, 0);
          ...
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MS is OOS, don't change back-off time", 0, 0, 0);
          }
#endif /* FEATURE_CALL_THROTTLE */                    
        } /* end else qw_cmp() */
        else
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Request during Throttle time,disable download", 0, 0, 0);
          status = TRUE;
          /* start debug...
          */
          ...
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Time remaining=%dsecs", qw_time[0], 0, 0);
          /* End debug...
          */
        } 
      ...
      */
      ...
      qw_shift(qw_time,-16);
      (void)qw_div(qw_time,qw_time,1000);
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Throttle duration set to=%dsecs", qw_time[0], 0, 0);
...
void tm_1x_up_is801_drv_opn_completed(pdsm_pd_end_e_type status)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "op Complete,status=%d,mode=%d", status, tm_1x_up_session_info.mode_info.mode, 0);
  ...
  */
  if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_DLOAD)
  {
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error in Dload operation", 0, 0, 0);
      ...
      */
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Max error for Dload..exit", 0, 0, 0);
    ...
    if(tm_1x_up_session_info.mode_info.waiting_msb_lr)
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Waiting for LR in MSB fix", 0, 0, 0);
      tm_1x_up_session_info.mode_info.mode = TM_1X_UP_MODE_MSB;
    ...
    else if(tm_1x_up_session_info.mode_info.pending_fallback_msa_fix)
    {
       ...
       */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Pending MSA fix", 0, 0, 0);
        tm_1x_up_session_info.mode_info.mode = TM_1X_UP_MODE_MSA;
      }
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload over. No fix operation needed", 0, 0, 0);
      tm_1x_up_is801_drv_end_session(TM_STOP_REASON_COMPLETED);
    }
  } /* DLOAD */
  else if ( (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSA) || ( tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSB ) )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Fix operation completed...", 0, 0, 0);
    ...
    if (status != PDSM_PD_END_SESS_NONE)
    {
      ...
      */
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "err_c(A)=%d,err_c(B)=%d,total=%d", tm_1x_up_session_info.mode_info.err_count_fix_msa,
      ...
      */
      if (optimal_mode == TRUE)
      {
        if ( tm_1x_up_session_info.mode_info.err_count_fix > TM_1X_UP_MAX_FIX_ERROR )
        {
          ...
          */
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error_cnt > threshold..Exit sess (stop_reason=%d)", stop_reason, 0, 0);
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "last_error=%d", tm_1x_up_session_info.mode_info.last_error, 0, 0);
          tm_1x_up_is801_drv_end_session(stop_reason);
          return;
        }
      }
      ...
      if ( tm_1x_up_is801_drv_session_active() == TRUE)
      {
        ...
        if ( (optimal_mode == TRUE) && (tm_1x_up_session_info.mode_info.mode == tm_1x_up_session_info.mode_info.last_error) )
        {
          ...
          */
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "No mode switch performed..Exit (stop_reason=%d)", stop_reason, 0, 0);
          tm_1x_up_is801_drv_end_session(stop_reason);
        }
        else
        {
          ...
          if (ret_val == FALSE)
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Exit New session not allowed (stop_reason=%d)", stop_reason, 0, 0);
            tm_1x_up_is801_drv_end_session(stop_reason);
          }
        }
      }
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Wrong state?? (stop_reason=%d)", stop_reason, 0, 0);
        tm_1x_up_is801_drv_end_session(stop_reason);
      }
    } /* end if status */
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Good fix=%d", 0, 0, 0);
      /* Reset the error count
      */
      tm_1x_up_session_info.mode_info.err_count_fix = 0;

      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Fix over", 0, 0, 0);
      tm_1x_up_is801_drv_end_session(TM_STOP_REASON_COMPLETED);
...
boolean tm_1x_up_send_ref_position(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Send Ref position", 0, 0, 0);
  if(ref_position_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Ref_position is unavailable", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Either lat or long is zero", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "No buffer for aiding data", 0, 0, 0);
    return FALSE;
  }
  ...
  */
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Send LR data to TM-Core", 0, 0, 0);
  if(tm_post_data(TM_PRTL_TYPE_1X_UP,
                    tm_1x_up_session_info.sess_handle,
                    TM_POST_DATA_TYPE_LR,
                    aiding_data_ptr) == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Post data for LR failed", 0, 0, 0);
...
void tm_1x_up_is801_drv_handle_fix_timeout(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Handle MSB fix timeout", 0, 0, 0);
    if(tm_1x_up_session_info.mode_info.waiting_msb_lr)
    {
      tm_1x_up_session_info.mode_info.waiting_msb_lr = FALSE;
      ...
      if(tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_DLOAD)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Wait for download", 0, 0, 0);
...
boolean tm_1x_up_is801_drv_handle_stop_sess_req(tm_sess_stop_reason_e_type stop_reason)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle stop session rcvd from TM-Core. Reason %d", stop_reason, 0, 0);
...
static boolean connect_to_pde(tm_1x_up_mode_e_type mode)
{
  ...
  else 
  {
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Failed starting Connect timer. mode = %d", mode, 0, 0);
    }
...
boolean tm_1x_up_is801_drv_initiate_session(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "New ses,mode=%d", tm_1x_up_session_info.mode_info.mode, 0, 0);

  tm_1x_up_is801_drv_update_session_state(TM_1X_UP_SESSION_STATE_ENTRY);

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "New session initiated", 0, 0, 0);

  if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSA)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "PDE needs to be contacted,open con", 0, 0, 0);
    ...
    if(tm_1x_up_session_info.tm_core_initiate_session == FALSE)
    {
      ...
      */
      if (tm_1x_up_session_info.mgp_info.ppm_on == FALSE) 
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Unable to request TM-Core to start PPM", 0, 0, 0);
          tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
          return FALSE;
        }
      }
  ...
  else if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_DLOAD)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "PDE needs to be contacted", 0, 0, 0);
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Throttle this connection to PDE", 0, 0, 0);
      tm_1x_up_is801_drv_opn_completed(PDSM_PD_END_NO_CON); 
      return TRUE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "No throttling necessary...", 0, 0, 0);
    }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Close conection if Active...", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Error mode=%d", tm_1x_up_session_info.mode_info.mode, 0, 0);
    tm_1x_up_comm_close_connection();
...
void tm_1x_up_is801_drv_start_fallback_msa_fix(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Start fallback MSA fix", 0, 0, 0);
  tm_1x_up_session_info.mode_info.pending_fallback_msa_fix = FALSE;
  tm_1x_up_session_info.mode_info.mode = TM_1X_UP_MODE_MSA;
  /* Check if force dormancy is required or not.
  */
  ...
  if (ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Exit New session not allowed", 0, 0, 0);
    tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
  }
  return;
}
...
void tm_1x_up_is801_drv_handle_comm_error(void)
{
  if( tm_1x_up_is801_drv_session_active() )
  {
    ...
    {         
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Transport error..Close con..", 0, 0, 0);
        tm_1x_up_comm_close_connection();
        return;
      }
      else if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSA)
...
===========================================================================*/
boolean tm_1x_up_is801_drv_report_lr_resp_msb(sm_FixInfoStructType *lr_ptr)
{
    pdsm_pd_event_type  pd_event;
    ...
    if(lr_ptr == NULL)
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null lr_ptr", 0, 0, 0);
      return FALSE;
    }
    /* Generate CGPS event */
    sm_log_event_report(SM_LOG_EVENT_ID_GPS_COMPLETE,0);

    lr_resp_ptr = os_MemAlloc(sizeof(*lr_resp_ptr), OS_MEM_SCOPE_TASK);

    if(lr_resp_ptr != NULL)
    {
      //Convert from LM to IS801 format
      if(tm_util_convert_lr(lr_ptr,lr_resp_ptr))
      {
          tm_1x_up_dload_info.num_data = 1;
          tm_1x_up_dload_info.dload_info[0].data   = PDSM_PD_DLOAD_LOCATION;
      ...
      tm_1x_up_ext_pos_data.t_dop = lr_ptr->z_NavPos.f_TDOP;
      tm_1x_up_ext_pos_data.g_dop = lr_ptr->z_NavPos.f_GDOP;
          ...
          pd_event = tm_util_pd_info_data_init( &tm_1x_up_info_buffer,
                                                    lr_resp_ptr, 
                                                    tm_1x_up_session_info.api_param.pd_api_info.client_id, 
                                                   &tm_1x_up_dload_info, 
                                                   &tm_1x_up_pos_info, 
      ...
      os_MemFree((void **)&lr_resp_ptr);
    }
    else
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "No buffer for lr_resp_ptr", 0, 0, 0);
      return FALSE;
    }
    return TRUE;
}
...
boolean tm_1x_up_is801_drv_handle_v2_lr_resp_msbased(sm_FixInfoStructType *lr_ptr)
{
  dword lr_validity = PDSM_NO_ACCURACY_THRESHOLD;

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Processing LR resp from PE", 0, 0, 0);
  ...
  if (lr_ptr != NULL)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Fix accuracy=%dm", lr_validity, 0, 0);
    tm_1x_up_session_info.mode_info.last_error = TM_1X_UP_MODE_NONE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null Loc from PE", 0, 0, 0);
    tm_1x_up_session_info.mode_info.last_error = TM_1X_UP_MODE_MSB;
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Good fix, proceed with session", 0, 0, 0);
...
boolean tm_1x_up_is801_drv_handle_lr_resp_msbased(sm_FixInfoStructType *lr_ptr)
{
  dword lr_validity = PDSM_NO_ACCURACY_THRESHOLD;
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "LR resp from PE not expected in mode %d", tm_1x_up_session_info.mode_info.mode, 0, 0);
    return FALSE;
  }
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Fix above set threshold", 0, 0, 0);
    ...
    */
    if(tm_1x_up_is801_drv_msa_fix_allowed() == TRUE)
    {
      ...
      if(tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_DLOAD)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Wait for download to finish before falling back to MSA", 0, 0, 0);
        tm_1x_up_session_info.mode_info.pending_fallback_msa_fix = TRUE;
      }
      else
      {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Mode change not alwd,report fix to TM-Core", 0, 0, 0);
      (void)tm_1x_up_is801_drv_report_lr_resp_msb(lr_ptr);
...
)
{
  ...
  if(ret_val)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Created req type 0x%x using %d (1=801-1 / 0=801-B)",
                 req, is_801_1, 0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Create RLink Req 0x%x using %d (1=801-1 / 0=801-B) failed",
                 req, is_801_1, 0);
  }
  return ret_val;
...
#endif
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Num PDDMs left to be sent= 801-1 = %d 801-B = %d",
    ...
    if(pdcomm_info.num_rev_pddm_801_1 > 0)
    {
      ...
      {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Could not send RLink PDDM from IS801-1 module", 0, 0, 0);
        tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
        ret_val = FALSE;
      }
    }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Can not get RLink PDDM from IS801 module", 0, 0, 0);
    return FALSE;
  }
...
boolean i_1x_up_is801_1_drv_send_pddm(void)
{
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "pdcomm_info.curr_state %d not connected",
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Num 801-1 %d 801-B %d PDDMs to be sent= %d",
                  pdcomm_info.num_rev_pddm_801_1,
                  pdcomm_info.num_rev_pddm_801_b,0);
...
boolean tm_1x_up_is801_1_drv_send_rlink_pddm(byte sess_start, byte sess_end,  uint8 num_pddm)
{
    ...
    */
    ...
    if(num_rlink_pddm < 0)
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "IS801-1 returned PDDMs = %d", num_rlink_pddm, 0, 0);
      return FALSE;
    }
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Num 801-1 PDDMs to be sent= %d", pdcomm_info.num_rev_pddm_801_1, 0, 0);
...
boolean tm_1x_up_is801_b_drv_send_rlink_pddm(byte sess_flags,  uint8 num_pddm)
{
    ...
    */
    ...
    if(num_rlink_pddm < 0)
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"IS801B returned PDDMs = %d",num_rlink_pddm,0,0);
      return FALSE;
    }

    pdcomm_info.num_rev_pddm_801_b = num_pddm + num_rlink_pddm;
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Num 801B PDDMs to be sent= %d",pdcomm_info.num_rev_pddm_801_b,0,0);
    ...
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not send is801b pddm", 0, 0, 0);
      tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
      return FALSE;
    }
...
===========================================================================*/
void tm_1x_up_is801_drv_handle_ref_loc(sm_FixInfoStructType  *lr_ptr)
{
  static sm_FixInfoStructType *lr;
...
// TBD check if ok to delete this            TM_1X_UP_SESS_START_MASK  | 
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Handling ref_loc", 0, 0, 0);
  if (lr_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null ref_loc", 0, 0, 0);
    tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
    return;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Received RefLoc in wrong state %d", tm_1x_up_session_info.session_state, 0, 0);
    return;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Could not transition to WAIT_DLOAD_RESP state", 0, 0, 0);
...
// TBD check if this is ok to remove      TM_1X_UP_SESS_START_MASK  |
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Connected for Dload operation", 0, 0, 0);

  if(tm_1x_up_session_info.session_state != TM_1X_UP_SESSION_STATE_ENTRY)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Connected..Wrong state. %d", tm_1x_up_session_info.session_state, 0, 0);
    return;
  }
  ...
  { 
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "State transition to %d failed", next_state, 0, 0);
  }
...
boolean tm_1x_up_is801_drv_handle_ppm_dload(srch_ppm_rpt_type *ppm_ptr)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle PPM during Dload operation", 0, 0, 0);

  /* Perform sanity checks on parameters */
  if(tm_1x_up_session_info.session_state != TM_1X_UP_SESSION_STATE_ENTRY)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Connected..Wrong state. state = %d", tm_1x_up_session_info.session_state, 0, 0);
    return TRUE;
  }

  if(ppm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NULL ppm ptr passed.", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Incorrect session (%d) or resp to send (%x)",
...
)
{
  if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSA)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Connected for MS-Assisted fix", 0, 0, 0);
    ...
    if(sess_start == FALSE)
    {
      ...
      */
      ...
      { 
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Unable to get PPM results", 0, 0, 0);
          tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
        }
      }
      else
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "PDE Connection not expected!", 0, 0, 0);
  }
  ...
  */
  ...
  if( TM_1X_UP_SMOD_REQ_SUCCESS == start_sess_req_result )
  {
    ...
    case TM_1X_UP_SMOD_REQ_STATUS_WAIT:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "wait for response from 1x UP sub-module not handled (status:%d)",
               req_status, 0, 0);
      break;
    ...
    -------------------------------------------------------------------------*/      
    default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "start sess req status not handled (status:%d)", req_status, 0, 0);
      break;
    }    
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "start sess req error (status:%d)", req_status, 0, 0);
  }
...
boolean tm_1x_up_is801_drv_handle_prm( sm_GpsMeasRptStructType  *info_ptr)
{
  ...
  if(info_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Null PRM data reported by MGP", 0, 0, 0);
    tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "GPS resp in Wrong state=%d", tm_1x_up_session_info.session_state, 0, 0);
    return FALSE;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "801B PDE sent locn with lat long 0", 0, 0, 0);
    return;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Rxed LR data from PDE", 0, 0, 0);

  if( (resp_ptr == NULL && adv_lr_ptr == NULL) ||
      (resp_ptr != NULL && adv_lr_ptr != NULL))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Inconsistent 801-1 %x and 801-B %x responses present",
                 resp_ptr, adv_lr_ptr, 0);
  }

  if ( tm_1x_up_session_info.session_state != TM_1X_UP_SESSION_STATE_WAIT_PD )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "LR in wrong state=%d", tm_1x_up_session_info.session_state, 0, 0);
    return; 
  }
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "req_wait=%d, should be NULL",
  ...
  else
  {
    ...
    #error code not present
#else
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NULL resp ptr sent. no 801-1 data to decode", 0, 0, 0);
    return;
    #endif
  }
  ...
  if (send_sess_end)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Send End sess to PDE", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Lat and Long reported by PDE is zero!", 0, 0, 0);
    tm_1x_up_is801_drv_opn_completed(PDSM_PD_END_FIX_ERROR);
  }
...
boolean tm_1x_up_is801_drv_handle_ppm_ms_assist( srch_ppm_rpt_type *ppm_ptr )
{
  ...
  if(ppm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null PPM ptr", 0, 0, 0);
    tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
    return FALSE;
  }
  ...
  if ( tm_1x_up_session_info.session_state == TM_1X_UP_SESSION_STATE_ENTRY )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MS-Assist PPM pre-fix resp", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PPM resp in Wrong state %d", tm_1x_up_session_info.session_state, 0, 0);
  }
...
void tm_1x_up_is801_drv_handle_dormancy_success(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Register/Wait for TC UP", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Unable to unforce dormancy", 0, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Received TC End...", 0, 0, 0);
  ...
  if ((tm_1x_up_is801_drv_session_active() == TRUE) && (tm_1x_up_session_info.session_state == TM_1X_UP_SESSION_STATE_WAIT_FD))
  {
    ...
    ** dormancy
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "DeRegister TC EXIT", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Ignore TC Exit", 0, 0, 0);
  }
#endif
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Received TC UP...", 0, 0, 0);

#ifdef FEATURE_GPSONE_UPDATE_BSID

  if (((tm_1x_up_is801_drv_session_active() == TRUE) && (tm_1x_up_session_info.session_state == TM_1X_UP_SESSION_STATE_WAIT_FD)))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "DeRegister TC UP Event", 0, 0, 0);
    tm_1x_up_session_info.tm_cm_register_bmap &= (tm_cm_register_events_bmap_e_type)~(TM_CM_REGISTER_TC_UP_EVENT); /*lint !e641 !e655 */
    (void) tm_cm_iface_handle_reg_events_req(tm_1x_up_session_info.tm_cm_register_bmap);

    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Exit dormancy wait state", 0, 0, 0);
    (void)os_TimerStop(tm_1x_up_session_info.tm_1x_up_connect_timer);
    ...
    if (tm_1x_up_session_info.mgp_info.ppm_on == TRUE)
    {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Can't req PPM", 0, 0, 0);
        tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
      }
      else
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Wrong state", 0, 0, 0);
          tm_1x_up_is801_drv_handle_dormancy_failure(TM_1X_UP_DORMANCY_FAILURE_TYPE_ABORT);
        }
  ...
  else
  {
    ...
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Ignore TC UP", 0, 0, 0);
  }
#endif /* FEATURE_GPSONE_UPDATE_BSID */
...
boolean tm_1x_up_is801_drv_force_dormancy(void)
{
  ...
  */
  ...
  if( ret_val == FALSE )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Unable to force dormancy", 0, 0, 0);
  }
  else
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Failed starting Dormancy timer", 0, 0, 0);
    }
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Force dormancy attempt failed", 0, 0, 0);

  /* Deregister TC Exit/Up events */
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "DeRegister TC Exit/UP Event", 0, 0, 0);
  ...
  switch (tm_1x_up_session_info.session_state) 
  {
    case TM_1X_UP_SESSION_STATE_ENTRY:
           ...
           (tm_1x_up_is801_drv_session_active()))
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "FD required", 0, 0, 0);
        if ( tm_1x_up_is801_drv_force_dormancy() )
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Register and Wait for TC_EXIT event", 0, 0, 0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "FD not required", 0, 0, 0);
      }
      break;
...
boolean tm_1x_up_is801_drv_handle_ppm(srch_ppm_rpt_type *ppm_ptr )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "FD for BS info update required", 0, 0, 0);
    return TRUE;
  }
#endif /* FEATURE_GPSONE_UPDATE_BSID */

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling PPM response from SRCH", 0, 0, 0);

  if(tm_1x_up_is801_drv_session_active())
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling ppm in active session", 0, 0, 0);
    if (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_MSA)
    {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PPM not expected. END PPM if On", 0, 0, 0);
      if(tm_1x_up_session_info.mgp_info.ppm_on == TRUE)
      {
        (void)tm_1x_up_is801_drv_end_ppm();
      } /* if PPM on in MS-Based session */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PPM resp not expected", 0, 0, 0);
    if ( tm_1x_up_session_info.mgp_info.ppm_on)
    {
      (void)tm_1x_up_is801_drv_end_ppm();
    }
...
do {                                                                           \
  ...
  {                                                                            \
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unexpected resp_ptrs. 801_1 %x 801_b %x",                       \
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling AA data. 801-1 Resp %x 801-B Resp %x",
                     resp_ptr, aa_801_B, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "AA data in wrong state %d",
                     tm_1x_up_session_info.session_state, 0, 0);
    return;
  }

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Transition to WAIT_PR", 0, 0, 0);
  if( tm_state_transition(ops, params, TM_1X_UP_SESSION_STATE_WAIT_PR) == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "State Transition to WAIT_PR failed", 0, 0, 0);
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling SA data. 801-1 Resp %x 801-B Resp %x",
                    resp_ptr, sa_801_B, 0);
  /* perform a sanity check on the input params and init the protocol type */
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "SA data in wrong state %d", tm_1x_up_session_info.session_state, 0, 0);
    return;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Resp from PDE=%d", resp_type, 0, 0);
  ...
  */
  switch(resp_type)
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Response not expected", 0, 0, 0);
      break;
  } /* switch end resp_type */

  if (tm_1x_up_session_info.is801_req_wait_bmap == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "All responses processed", 0, 0, 0);
    ...
    */
    eph_unhealthy_list = (tm_1x_up_session_info.aiding_data_status.gps_eph_requested_sv_list) &  
                                (~tm_1x_up_session_info.aiding_data_status.gps_eph_delivered_sv_list);
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "unhealthy list 0x%1x, delivered 0x%1x, requested 0x%1x", eph_unhealthy_list,
      tm_1x_up_session_info.aiding_data_status.gps_eph_delivered_sv_list,
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling GPS Alm data. 801-1 Resp %x 801-B Resp %x",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Resp update error,state=%d,mask=%d",
  ...
  if ( ((is801_req_wait_bmap & TM_1X_UP_RLINK_REQ_GPS_ALM) == 0) && 
       (unsolicited == 0x01) )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Update TM-Core with Unsol ALM resp", 0, 0, 0);
  }
  else if(current_state == TM_1X_UP_SESSION_STATE_WAIT_DLOAD_RESP)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Response not requested(mask=%d)", is801_req_wait_bmap, 0, 0);
    } /* end if ALM_REQ */
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handling GPS Eph data. 801-1 Resp %x 801-B Resp %x",
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "LR resp for Dload only", 0, 0, 0);

  if( (resp_ptr == NULL && lr_801_B == NULL) ||
      (resp_ptr != NULL && lr_801_B != NULL) )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Inconsistent location resp pointers 801-1 %x 801-B %x",
                       resp_ptr, lr_801_B, 0);
    tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
    return;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Dload LR not expected in state %d",
                       tm_1x_up_session_info.session_state,0,0);
    return;
  } /* if DLOAD_RESP */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Resp pointer is null", 0, 0, 0);
...
)
{
  ...
  if(resp_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null resp_ptr",0,0,0);
    return;
  }
  ...
  switch( rej_req_type )
  {
    case TM_1X_UP_RLINK_REQ_LR:
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Reject for LR not expected", 0, 0, 0);
      }
    break;
  ...
  case TM_1X_UP_RLINK_REQ_AA:
      ...
      if ( tm_1x_up_session_info.session_state == TM_1X_UP_SESSION_STATE_WAIT_AA )
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "AA resp rejected", 0, 0, 0);
        /* Update a failure in MS-Assisted sessions.
        */
        tm_1x_up_session_info.mode_info.last_error = TM_1X_UP_MODE_MSA;
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Reject for AA not exp", 0, 0, 0);
      }
      if ( tm_1x_up_session_info.is801_req_wait_bmap == NULL )
      {
  ...
  case TM_1X_UP_RLINK_REQ_GPS_SA:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "SA request Rejected", 0, 0, 0);
      ...
      if (tm_1x_up_session_info.mgp_info.prm_on == TRUE)
      {
        ...
        {          
          aiding_data_ptr->sa_data.u_NumSvs = 0;
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Give SA data to TM-Core", 0, 0, 0);
          ...
          if(tm_post_data(TM_PRTL_TYPE_1X_UP,
                    ...
                    aiding_data_ptr) == FALSE)
          {
              MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Post data for SA failed", 0, 0, 0);
            (void)pdsm_freebuf((char *)aiding_data_ptr);
            return;
          }
          (void)pdsm_freebuf((char *)aiding_data_ptr);
        ...
        {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Fail to get buffer", 0, 0, 0);
          tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
        }
      }
      else
      {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PRM not on.", 0, 0, 0);
      }
    } /* end wait SA_REQ */
    else
    {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "SA Reject not expected.", 0, 0, 0);
    }
    break;
  ...
  case TM_1X_UP_RLINK_REQ_DGNSS_ASST:
  case TM_1X_UP_RLINK_REQ_GGTO:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Reject for Asst data 0x%x", rej_req_type, 0, 0);
    if(tm_1x_up_session_info.session_state == TM_1X_UP_SESSION_STATE_WAIT_DLOAD_RESP)
    {
      tm_1x_up_session_info.mode_info.last_error = TM_1X_UP_MODE_DLOAD;
    ...
    {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "ALM reject not expected", 0, 0, 0);
    }
    break;

  case TM_1X_UP_RLINK_REQ_GPS_EPH:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Reject for EPH data", 0, 0, 0);
    ...
    {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Eph reject not expected", 0, 0, 0);
    }
    break;

  default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Bad Rej req_type %d", rej_req_type, 0, 0);
    break;
...
void tm_1x_up_is801_drv_rej_pde_req(uint32 req_type )
{
    ...
    if(resp_ptr != NULL)
    {
        ...
        {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Created Reject resp for type %d", req_type, 0, 0);
        }
        else
        {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Can't create Rej resp", 0, 0, 0);
        }
    ...
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "No buffer for REJ", 0, 0, 0);
    }
}
...
void tm_1x_up_is801_drv_handle_sa_req(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "SA request from MGP", 0, 0, 0);
  ...
  */
  if (tm_1x_up_is801_drv_session_active())
  {
    if(tm_1x_up_is801_drv_create_rlink_req( TM_1X_UP_RLINK_REQ_GPS_SA, 
                                            is_801_1) == FALSE)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Can not create SA req", 0, 0, 0);
      tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
      return;
    }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "wait for SA data...", 0, 0, 0);
    return;
  }
  ...
  if(tm_1x_up_is801_1_drv_send_rlink_pddm(0, 0,0))
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Failed starting IS801 timer", 0, 0, 0);
    }
  }
  else
  {
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle MGP timeout", 0, 0, 0);
  if (tm_1x_up_is801_drv_session_active())
  {
    if(tm_1x_up_session_info.mgp_info.ppm_on)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Get PPM timed out", 0, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Timed out waiting for Ref Loc", 0, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle IS801 timeout", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Timer event not expected", 0, 0, 0);
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle Connect timeout", 0, 0, 0);
  if ( tm_1x_up_is801_drv_session_active() && (tm_1x_up_session_info.mode_info.mode != TM_1X_UP_MODE_MSB) )
  {
    /* Fire COMM_FAILURE event */
    tm_1x_up_info_buffer.client_id = tm_1x_up_session_info.api_param.pd_api_info.client_id;
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle Disconnect timeout", 0, 0, 0);
...
void tm_1x_up_set_throttling_backoff_time(void)
{
  ...
  if (((tm_1x_up_is801_drv_session_active()) && (tm_1x_up_session_info.mode_info.mode == TM_1X_UP_MODE_DLOAD)))
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload request allowed before safe dload duration, increase back_off_time", 0, 0, 0);
      ...
      */
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "setting back off time to = %d seconds", qwtime[0], 0, 0);
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Dload request allowed after safe dload duration, do not increase back_off_time", 0, 0, 0);
    }
  }
}
...
void tm_1x_up_mpc_set_throttling_backoff_time(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Set MPC Back off throttling (factor=%d)", tm_1x_up_config.msb_throttling_info.back_off_factor, 0, 0);
  ...
  */
  ...
  if ( qw_cmp(tm_1x_up_config.msb_throttling_info.back_off_time,qwtime) > 0 )
  {
    /* We are hitting max back-off time.
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "MPC Back off time set to maximum", 0, 0, 0);
    qw_equ(tm_1x_up_config.msb_throttling_info.back_off_time,qwtime);
  }
  qw_add(tm_1x_up_config.msb_throttling_info.throttle_end_time,current_sys_time,tm_1x_up_config.msb_throttling_info.back_off_time);   
  ...
  */
  ...
  qw_shift(qwtime,-16);
  (void)qw_div(qwtime,qwtime,1000);
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Setting MPC back off time to = %d seconds", qwtime[0], 0, 0);
}
#endif /* FEATURE_CALL_THROTTLE */
...
boolean tm_1x_up_is801_drv_handle_wish_list_update(const tm_aiding_data_wishlist_s_type* aiding_data_status_ptr)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null aiding_data_status_ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  if (!status_out_ptr->gps_eph_validity)
  {
    ...
    if(aiding_data_status_ptr->z_assist_data_status.q_VisibleSVList != 0)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Eph requested. List 0x%1x", tm_1x_up_session_info.aiding_data_status.gps_eph_requested_sv_list, 0, 0);
    }
  }
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Eph needed. %d (0=Y/1=N) NeedList 0x%x HaveList %x",
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Alm needed. %d (0=Y/1=N) NeedList 0x%x HaveList %x",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Ref Loc needed", 0, 0, 0);
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Pos Uncertainty %dm", status_out_ptr->pos_unc, 0, 0);

  /* Ref Time */
  if(q_GPSWishListMask & C_GPS_ASSIS_REFTIME)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Ref Time needed", 0, 0, 0);
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Time Uncertainty %f", status_out_ptr->time_unc, 0, 0);

  ret_val =  tm_1x_up_is801_drv_start_session_wishlist_update();

  if (ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Failed to Initiate", 0, 0, 0);
  }
  return ret_val;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null sess_req_param_ptr", 0, 0, 0);
    return;
  }
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Num_fixes= %u, tbf= %u", fix_rate->num_fixes,
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Server Addr=0x%x Port=%d",
...
)
{
      ...
      )
    {
      if(wake_tm_core == FALSE)
      {
        if(actions == NULL)
        {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null actions pointer", 0, 0, 0);
          return FALSE;
        }
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Returning actions op_req 0x%x", actions->op_req, 0, 0);
        return TRUE;
      }
      else /* VX module already replied to TM-Core for the request, so now ask TM-Core to continue */
      {
        ...
        if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
                     ...
                     &tm_1x_up_sess_req_param))
        {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "continue_msb_fix Succeeded", 0, 0, 0);
          return TRUE;
        }
        else
        {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "continue_msb_fix Failed", 0, 0, 0);
          return FALSE;
        }                  
      }
    }
    ...
    {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Incorrect operation mode %d", tm_1x_up_session_info.api_param.pd_api_info.pd_option.operation_mode, 0, 0);
      return FALSE;
    }
}
...
)
{
  ...
  if(req_type == TM_IS801_DRV_REQ_START_NODWLD)
  {
    ...
    */
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Returning %d", ret_val, 0, 0);
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "PDCOMM message type %d", msg_type, 0, 0);
  //process it for Trusted module.
  if(!tm_1x_up_handle_comm_msg(msg_type, msg_data_ptr))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Handle error here", 0, 0, 0);
...
)
{
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "timerId 0x%x expired", timer_param->q_TimerId, 0, 0);
        if((timer_param->q_TimerId & TM_1X_UP_TRUSTED_TIMER_DISPATCH_MASK))
        {
          ...
          default:
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Unknown timer Id", 0, 0, 0);
              break;
          }
        }
    }
...
{ 
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Handle event %d", event_type, 0, 0);
  if(event_payload == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null event_payload", 0, 0, 0);
    return;
  }
  switch (event_type) 
  {
    case PRTL_EVENT_TYPE_PHONE:
      ...
      else if(event_payload->phone_event_payload.event == TM_PHONE_EVENT_IN_UMTS_COVERAGE)
      {
        ...
        if(!TM_CORE_CONFIG_DD(gnss_1x_up_supl_enable))
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "System changed to UMTS, aborting ongoing session", 0, 0, 0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "event %d not handled", event_payload->phone_event_payload.event, 0, 0);
      }
      break;
    ...
    case PRTL_EVENT_TYPE_PA:
      if(event_payload->pa_event_payload.pa_event == PDSM_PA_1X_PDE_NETWORK_ADRS)
      {
        if(event_payload->pa_event_payload.pa_info_ptr != NULL)
        {
          ...
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Updated 1x PDE address %x and port %d", tm_1x_up_config.pde_adrs, tm_1x_up_config.port_id, 0);
        }
      }      
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Clear throttling timers", 0, 0, 0);
  ...
  case PRTL_EVENT_TYPE_RUIM_NV_READ:
	 ...
	 MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle RUIM event %d",event_payload->ruim_read_nv_payload.ruim_item_group);
	 ...
	 if (event_payload->ruim_read_nv_payload.ruim_item_group == PRTL_EVENT_RUIM_MSID_NV_READ)
     {
      ...
      else if (event_payload->ruim_read_nv_payload.ruim_item_group == PRTL_EVENT_RUIM_CURR_NAM_NV_READ)
      {
        (void)tm_1x_up_read_curr_nam_complete(event_payload);
      }
     else if( event_payload->ruim_read_nv_payload.ruim_item_group == PRTL_EVENT_RUIM_CURR_NAM_READ_OP)
     {
          (void)tm_1x_up_read_post_cur_nam_op();
     }
     ...
     {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "RUIM ASYNC READ NV item not handled here", 0, 0, 0);
     }
     break;
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "# of PDDM = %d ", pddm_info.num_pddm, 0, 0);
  ...
  for(i = 0; i < pddm_info.num_pddm; i++)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "IS801 failed to get Fwd Link PDDM", 0, 0, 0);
      if( tm_1x_up_is801_drv_session_active() == TRUE )
      {
        tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
      }
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Got Fwd Link Req %d Req Mask", tm_1x_up_session_info.fwd_link_pddm.hdr.num_requests, tm_1x_up_session_info.fwd_link_pddm.req_mask, 0);
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "Got Fwd Link Resp %d Resp Mask", tm_1x_up_session_info.fwd_link_pddm.hdr.num_responses, tm_1x_up_session_info.fwd_link_pddm.resp_mask, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PDE requesting for End session", 0, 0, 0);
      if( tm_1x_up_is801_drv_session_active() == TRUE )
      {
        tm_1x_up_is801_drv_end_session(TM_STOP_REASON_GENERAL_ERROR);
      }
    ...
    for(j = 0; j < tm_1x_up_session_info.fwd_link_pddm.hdr.num_requests; j++)
    {
      ...
      switch(tm_1x_up_session_info.fwd_link_pddm.req_rd[j].request_type)
      {
        ...
        default:
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Req_type not handled %d", tm_1x_up_session_info.fwd_link_pddm.req_rd[j].request_type, 0, 0);
          break;
      }
    }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "tm_1x_up_is801_drv_init", 0, 0, 0);
