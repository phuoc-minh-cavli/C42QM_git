...
do {                                                                          \
  if(tm_post_data( TM_PRTL_TYPE_1X_UP,                                        \
                   ...
                   post_data_ptr) == FALSE)                                   \
  {                                                                           \
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Post data type %d failed",data_type,0,0);                      \
    return FALSE;                                                             \
  }                                                                           \
}while(0);      
...
)
{
  ...
  */
  if(op == RL_RESP_MSI)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Creating 801-1 MSI response", 0, 0, 0);
...
#endif
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Ignoring disabled IS801B req to create adv MSI",0,0,0);
      ret_val = TRUE;
    }
  }
  ...
  if (ret_val)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created MSI response", 0, 0, 0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can't create MSI response",0,0,0);
  }
  return ret_val;
}
...
static boolean create_prdm_bsp_resp_pddm(is801_rev_link_resp_s_type *resp_ptr)
{
  ...
  {   
    ...
    {   
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can't create PRDM for LAT/LONG MSG",0,0,0);
      ret_val = FALSE;
      return ret_val;
    }
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created PRDM BSP response", 0, 0, 0);
      ret_val = TRUE;
    }
    else
    {
...
)
{
...
#endif
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Ignoring disabled IS801B req",0,0,0);
      ret_val = TRUE;
    }
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can't create PPM resp",0,0,0);
  }
  return ret_val;
}
...
)
{
  ...
  if (ret_val)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created TOM resp",0,0,0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to Create TOM response",0,0,0);
  } 
  return ret_val;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Ignoring disabled IS801B rlink req creation",0,0,0);
    return TRUE;
  }
  ...
  */
  if ( req_mask & TM_1X_UP_RLINK_REQ_GPS_ALM )
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create ALM req",0,0,0);
      return FALSE;
    }
  }
  if ( req_mask & TM_1X_UP_RLINK_REQ_GPS_EPH )
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create EPH req",0,0,0);
      return FALSE;
    }
  }
...
)
{
  ...
  if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
             ...
             sess_req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"mgp_start_prm Succeeded", 0, 0, 0);  
    tm_1x_up_session_info.mgp_info.prm_on = TRUE;
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"mgp_start_prm Failed", 0, 0, 0);
    return FALSE;
  }                  
}
...
)
{
  ...
  if(up_prefix_ppm_buff_ptr)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send pre-fix PPM data to TM-Core", 0, 0, 0);
    ...
    if(tm_post_data(TM_PRTL_TYPE_1X_UP,
                      ...
                      post_data_ptr) == FALSE)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Post data for prefix_ppm failed",0,0,0);
      return FALSE;
    }
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"prefix_ppm buffer empty",0,0,0);
    return FALSE;
  }
  return TRUE;
}
...
static boolean save_ppm_to_buf( srch_ppm_rpt_type *ppm_ptr)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No buf for prefix PPM", 0, 0, 0);
    return FALSE;
...
)
{
  ...
  if(aa->prot == IS801_VERSION_801_1)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send AA data to TM-Core", 0, 0, 0);
    TM_POST_DATA(TM_POST_DATA_TYPE_AA);
   
    (void)is801_util_flink_convert_aa(aa_801_1, NULL, &(post_data_ptr->gnss_sv_dir) );
    /* post sv dir */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send SV DIR to TM-Core", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unsupported protocol passed %d", aa->prot, 0, 0);
    return FALSE;
  }
...
)
{
  ...
  if(alm_resp_ptr->prot == IS801_VERSION_801_1)
  {
    ...
    {            
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send ALM data to TM-Core", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unsupported protocol passed %d", alm_resp_ptr->prot, 0, 0);
    return FALSE;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Update TM-Core with EPH resp",0,0,0);
  if(eph->prot == IS801_VERSION_801_1)
  {
    ...
    if(eph_801_1->fix.u_AB_Par_Incl)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send IONO data to TM-Core", 0, 0, 0);
    ...
    */
    ...
    {            
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send EPH data to TM-Core", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unsupported protocol passed %d", eph->prot, 0, 0);
    return FALSE;
  }
  return TRUE;
}
...
)
{
  ...
  if( ref_position_ptr == NULL )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No buffer for Ref Position", 0, 0, 0);
    return FALSE;
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unsupported protocol passed %d", lr_resp_ptr->prot, 0, 0);
    return FALSE;
  }
...
)
{
  ...
  if(tm_post_data(TM_PRTL_TYPE_1X_UP,
                  ...
                  post_data_ptr) == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Post data for SEED failed",0,0,0);
    return FALSE;
  }
  return TRUE;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Ignore SA data as PRMs are done",0,0,0);
    return TRUE;
  } /* End else PR_ON */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown protocol choice for SA data %d", sa_resp->prot, 0, 0);
    return FALSE;
  }
  return TRUE;
}
...
static boolean mgp_get_ref_loc(tm_sess_req_param_u_type *sess_req_param)
{
   ...
   if(tm_sess_req(TM_PRTL_TYPE_1X_UP,
              ...
              sess_req_param))
   {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_up_is801_drv_get_ref_loc Succeeded", 0, 0, 0);  
     if(!os_TimerStart(tm_1x_up_session_info.tm_1x_up_mgp_timer,TM_1X_UP_MGP_RESP_TIMEOUT,NULL))
     {
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed starting timer for getting ref_loc",0,0,0);
     }
     return TRUE;
   }
   else
   {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_up_is801_drv_get_ref_loc Failed", 0, 0, 0);
     return FALSE;
   }                  
}
...
static boolean save_prm_to_buf(sm_GpsMeasRptStructType *prm_meas)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Save PRM data till Post-fix PPM is available",0,0,0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Memory leak in storing glo prm buffers", 0, 0, 0);
  }
...
static boolean save_ref_loc_to_buf(sm_GpsFixRptStructType *lr_ptr)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Memory leak in storing ref locn for 801b", 0, 0, 0);
  }
...
sm_FixInfoStructType up_ref_loc;
/*===========================================================================
...
SIDE EFFECTS
===========================================================================*/
static boolean save_ref_loc_to_buf(sm_FixInfoStructType *lr_ptr)
{
  if(lr_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"NULL ptr passed for ref loc", 0, 0, 0);
    return FALSE;
  }
  up_ref_loc = *lr_ptr;
  return TRUE;
...
)
{
  ...
  if(is801_util_convert_tm_lr_to_is801_lr(lr_ptr,&(resp_ptr->resp_msg_payload.lr_resp)))
  {
    if ( is801_new_rev_link_resp( TM_PRTL_TYPE_1X_UP,resp_ptr))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created LR resp",0,0,0);
      return TRUE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can't create RefLR resp",0,0,0);
      return FALSE;
    }
  }
  return FALSE;
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No PRM data in the buffer",0,0,0);
    return FALSE;
  }
  ...
  {
    /* Create 801-1 Resp */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Creating 801-1 PRM response",0,0,0);
  ...
  if (ret_val)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created PRM response",0,0,0);
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to Create PRM response",0,0,0);
    return FALSE;
  } 
}
...
static boolean clear_req_bmap(tm_1x_up_rlink_req_type *req)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Rxed Unsol resp. mask %x", req,0,0);
  }
  */
  return TRUE;
}
...
static boolean create_rlink_pddm(byte* sess_flags)
{
  ...
  if(sess_flags == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null pointer passed for sess_flags", 0, 0, 0);
    return FALSE;
  }
  ...
  if(*sess_flags & TM_1X_UP_IS801_1_PDDM)
  {
    ...
    if(n_rlink_pddm < 0)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"IS801 returned PDDMs = %d", n_rlink_pddm,0,0);
      n_rlink_pddm = 0;
      return FALSE;
    }
...
static boolean tx_rlink_pddm(byte* sess_flags)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"ERR in sess_flags mask 0x%x Nothing to tx", *sess_flags, 0, 0);
    return FALSE;
  }
...
boolean tm_1x_up_execute_fns(const is801_operation ops[], void *params[])
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received NULL ops[%x] or params[%x]",ops,params,0);
    return FALSE;
  }
    ...
    switch(ops[idx])
    {
      ...
      case(RL_RESP_REF_LOC):
        ret_val = rl_resp_ref_loc(
                        resp_801_1, 
                        *(sm_FixInfoStructType**) params[idx]);
        break;
      ...
      case(SAVE_REF_LOC):
        ret_val = save_ref_loc_to_buf( *(sm_FixInfoStructType**) params[idx]);
        break;
      ...
      case(MGP_POST_SVHI):
        ...
        #error code not present
#else
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"SVHI not expected in non IS801B callflow", 0, 0, 0);
        ret_val = TRUE;
        break;
      #endif
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown Operation %d passed to execute fns params %x\n", ops[idx], params[idx], 0);
    }
