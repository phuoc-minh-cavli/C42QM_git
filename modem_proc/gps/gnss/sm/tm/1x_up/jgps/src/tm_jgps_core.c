...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/jgps/src/tm_jgps_core.c#1 $  
...
)
{
  ...
  if(state_tran)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: state transition [%d] -> [%d] for session [%d]",
             curr_state, 
             sess_info_ptr->state,
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "JGPS: state transition failed cur state [%d], req state [%d]",
             curr_state, 
             new_state,
             0);
  }
...
void tm_jgps_core_reinit(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Re-Init core data",0,0,0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Abort and recover reason=%d type=%d",abort_reason,stop_type,0);
  if( gen_info_ptr->sess_info.state != TM_JGPS_SESS_STATE_ABORT_RECOVER)
  {
    if( abort_reason == TM_STOP_REASON_COMPLETED )
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Abort and recover: Session Complete (curr_state=%d, data state=%d)",
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Abort and recover (curr_state=%d, data state=%d)",
                 gen_info_ptr->sess_info.state,
                 gen_info_ptr->comm_info.comm_state,
                 0);
    }
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"PRM timeout",0,0,0);    
    ...
    else
    {
      ...
      {
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Failed to enter abort and recover state (curr_state %d)",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Already in abort and recover state (curr_state %d)",
              gen_info_ptr->sess_info.state,0,0);    
  }
...
)
{
  ...
  switch( sess_info_ptr->resp_pkt.hdr.cmd_id )
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Unhandled error cmd_id(%d)",
...
void tm_jgps_core_t02_timer_handler(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_jgps_core_t02_timer_handler",0,0,0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_jgps_core_t04_timer_handler",0,0,0);
  /* Send Cancel msg to SCU */
  tm_jgps_core_send_msg_cancel( TM_JGPS_CANCEL_CAUSE_TIMEOUT );
...
void tm_jgps_core_info_req_timer_handler(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_jgps_core_info_req_timer_handler",0,0,0);
  /* Send Cancel msg to SCU */
...
boolean tm_jgps_core_req_ms_ip_info(void)
{
  ...
  if( ret_val )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: Req for MS IP address Succeeded, start recovery timer (%d)", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Req for MS IP address Failed", 0, 0, 0);
  }  
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Null msg_data_ptr",0,0,0);
  }
...
boolean tm_jgps_core_req_rf_info(void)
{
  ...
  if( ret_val )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: Req for RF info Succeeded, start recovery timer (%d)", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Req for RF info Failed", 0, 0, 0);
  }     
...
)
{
  ...
  if (rf_info == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JPGS: Input param null ptr",0,0,0);
  }
  /*------------------------------------------------------------------------
  ...
  else
  {
    ...
    */
    ...
    if(rf_info->RfInfoSource == SOURCE_EVDO)
    {
      ...
      */
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: Err=%d,total=%d", 
      ...
      */
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS EVDO: TxPower=%d,tx=%d", 
    ...
    else if(rf_info->RfInfoSource == SOURCE_1X)
    {
      ...
      */
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS 1X: TxPower=%d,tx=%d", 
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: RF info not handled for this system type: %d",
...
)
{
  ...
  if(pd_info_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Invalid input parameter, null ptr", 0,0,0);
    return;
  }
...
boolean tm_jgps_core_start_pkt_data_req(void) 
{
  ...
  do{
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS failed to create URL, abort req (%d)", 
                sess_info_ptr->resp_pkt.hdr.cmd_id, 0, 0);
      break;
    }
...
boolean tm_jgps_make_url( void )
{
  ...
  do
  {
    ...
    if( sess_info_ptr->url_info.app_url_enable == FALSE )
    {
      ...
      if( sess_info_ptr->req_mode == TM_JGPS_SESS_REQ_MODE_MSA )
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Using def MSA url.",0,0,0);
        status = tm_jgps_core_make_msa_def_url();
      }
      else if( sess_info_ptr->req_mode == TM_JGPS_SESS_REQ_MODE_MSB_DLOAD )
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Using def MSB url.",0,0,0);
    ...
    { 
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS URL is invalid",0,0,0);
        status = FALSE;
        break;
      }
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"URL length error:%d", url_len,0,0);
        status = FALSE;
        break;
      }
    }
...
{  
  ...
  if( start == NULL )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null data pointer during TM-JGPS send attempt (len=%d)", length, 0, 0);  
    return -1;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not get buffer", 0, 0, 0);
    return -1;
  }
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Success sending SCU pkt length:%d, ",ms_scu_pkt_size,0,0); 
    ret_val = length;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Failed to send SCU pkt length:%d, ",ms_scu_pkt_size,0,0); 
  }
...
)
{
  ...
  */
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MS to SCU msg, cmd_id=0x%x",cmd_id,0,0);
  ...
  switch( cmd_id )
  {
    ...
    case TM_JGPS_CMD_ID_START_POS_REQUEST:
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Sent request (cmd_id=0x%x), wait'g for response from SCU",
               cmd_id,0,0);
    ...
    case TM_JGPS_CMD_ID_CANCEL_ACQ_REQUEST:
      ...
      */
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Send cancel request (cmd_id=0x%x, cause=%d)",
                cmd_id,
   ...
   -------------------------------------------------------------------------*/
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"CMD ID not supported",0,0,0);
      break;
  }
  ...
  if (pm_data_length != 0 || cmd_id == TM_JGPS_CMD_ID_ACQ_COMPLETE)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"SCU specific message=>SCU",0,0,0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Request mode (%d), is not handled", 
...
)
{
  ...
  if(dload_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received Null dload_ptr",0,0,0);
    return FALSE;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Received Null data_ptr or incorrect length (%d)",
               hdr_ptr_len,0,0 );
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Pkt hdr cmd=%d,len=%d,prot_ver=%d from SCU",
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received Null data_ptr",0,0,0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Recv hdr service id (%d %d) invalid, Reject msg", 
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Recv hdr prot ver %d invalid, Reject msg", 
  ...
  switch (gen_info_ptr->sess_info.resp_pkt.hdr.cmd_id)
  {
    ...
    case TM_JGPS_CMD_ID_IS801_FLINK:
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Recv data length %d invalid", data_ptr_len,0,0);
        return FALSE;
      }

      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Forward data of length %d to IS801 module for decoding",
    ...
    case TM_JGPS_CMD_ID_POS_RESPONSE:
    case TM_JGPS_CMD_ID_ACQ_RESPONSE:
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Start resp rxed from SCU %d",
       ...
       { 
         ...
         {
           MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Resp result OK from SCU (cmd_id=%h, result=%d, mode=%d",
                    gen_info_ptr->sess_info.resp_pkt.hdr.cmd_id,
                    pos_resp.result,
       ...
       {
         MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: SCU resp, not allowed, wrong state",0,0,0);
    ...
    -------------------------------------------------------------------------*/
    case TM_JGPS_CMD_ID_POS_COMPLETE:
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Pos complete rxed from SCU",0,0,0);
       ...
       if ( lr_resp.result == TM_JGPS_SCU_MS_POS_COMP_RESULT_OK )
       {
         ...
         if (gen_info_ptr->sess_info.state == TM_JGPS_SESS_STATE_WAIT_SCU_STOP_REQ_RESP)
         {
           ...
           {
             MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Recv data length %d invalid (flength=%d)", data_ptr_len, lr_resp.flength,0);
             return FALSE;
           }
         ...
         {
           MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Late response",0,0,0);
           tm_jgps_core_abort_trans_scu_error(lr_resp.cause);
         }
       }
       else
       {
         MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Pos response Bad",0,0,0);
         tm_jgps_core_abort_trans_scu_error(lr_resp.cause);
       }
    ...
    case TM_JGPS_CMD_ID_STOP_ACQ_REQUEST:
      ...
      else
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS:Recv Stop Cause %d",stop_resp.cause,0,0);
      }
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Message=%d not handled",
                gen_info_ptr->sess_info.resp_pkt.hdr.cmd_id,0,0);
      break;
  } /* cmd_id */
...
)
{
  ...
  switch(notify_hdr_ptr->e_type)
  {
    ...
    ----------------------------------------------------------------------*/
    case READ_DATA:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: TCP/IP comm recv'd read data notification", 0, 0, 0);
      ...
      if(gen_info_ptr->comm_info.comm_state == TM_JGPS_COMM_STATE_CONNECTED)
      {
        ...
        if(gen_info_ptr->comm_info.recv_state == TM_JGPS_COMM_RECV_STATE_HEADER)
        {
          ...
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Reading JGPS header size %d bytes ",read_data_len,0,0);
        }
        else /* Read the pkt data */
        {
          ...
          if ( gen_info_ptr->comm_info.incoming_data_length > 0 )
          {
            ...
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Reading JGPS packet payload %d bytes", read_data_len, 0, 0);
          }
        }
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Read data in error state %d", 
    ...
    ----------------------------------------------------------------------*/
    case STATE_CHANGE:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: TCP/IP comm recv'd state change notification, new state = %d", 
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown state %d",notify_hdr_ptr->z_params.e_new_state,0,0);
    ...
    ----------------------------------------------------------------------*/
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Does not handle comm notifiy %d", 
...
)
{
  ...
  if (gen_info_ptr->sess_info.state == TM_JGPS_SESS_STATE_WAIT_SCU_STOP_REQ_RESP)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: write ack recv, while waiting for LR resp from SCU",0,0,0);
    ret_val = TRUE;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS:IOCTL Ack for req %d",ioctl_data_ptr->q_ioctl_request,0,0);
  ...
  switch(ioctl_data_ptr->q_ioctl_request)
  {
    case PDCOMM_IOCTL_CMD_GET_IP_ADDR:
      ...
      break;
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS: pass IOCTL %d to IS-801 drv",ioctl_data_ptr->q_ioctl_request,0,0);
      ret_val = tm_1x_up_is801_drv_data_pipe_handler(msg_type, msg_data_ptr);
      break;
  }
...
boolean tm_jgps_core_comm_read_data_handler(void *msg_data_ptr)
{
  ...
  if(read_hdr_ptr->w_data_len != 0)
  {
    ...
    if(gen_info_ptr->comm_info.recv_state  == TM_JGPS_COMM_RECV_STATE_HEADER)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Read header data of length %d",read_hdr_ptr->w_data_len,0,0);
      ...
      if (read_hdr_ptr->w_data_len >= TM_JGPS_HDR_SIZE )
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Read payload data of length %d",
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Error data length %d",read_hdr_ptr->w_data_len,0,0);
        ret_val = FALSE;
      }
    }
    else /* JGPS packet data */
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Process and decode packet length %d",
  ...
  else
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Received data of zero length from TM-Core",0,0,0);
    ret_val = FALSE;
  }
...
)
{
  ...
  if(option_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received Null option_ptr",0,0,0);
    return;
  }
...
)
{
  ...
  if(ppm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received Null ppm_ptr",0,0,0);
    return;
  }
    ...
    )
  {
    ...
    if( num_ppm != srch_ppm)
    {
      ...
      if( i == num_ppm)
      {
        ...
        if( i == srch_ppm)
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "JGPS:Not found Reference PN (%d)", ppm_ptr->num_pilots,0,0);
        }
      }
    }
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "JPGS: Monitor mode not active (client_type=%d)", 
...
)
{
  ...
  if(prm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received Null prm_ptr",0,0,0);
    return;
  }
...
boolean tm_jgps_core_start_sess_req_handler(void)
{
  ...
  do
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Start Session Request from IS-801 Drv (mode=%d)", 
             sess_info_ptr->req_mode,0,0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Wrong State (%d), Start sess req from IS-801 Drv denied", 
    ...
    if ( ret_status == FALSE )
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Start request failed to send data to SCU, abort",0,0,0);
...
)
{
  ...
  do
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Stop Session Request from IS-801 Drv mode=%d status=%d", 
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Wrong State (%d), Stop sess req from IS-801 Drv denied", 
               sess_info_ptr->state,0,0);
      break;
    }
    ...
    if ( ret_status == FALSE )
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Stop request failed to send data to SCU, abort",0,0,0);
    ...
    else
    {
      ...
      if( sess_info_ptr->req_mode == TM_JGPS_SESS_REQ_MODE_MSA)
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS MSA: Sent request, wait'g for response from SCU",0,0,0);
      }
      else
      {
        ret_status = tm_jgps_core_update_sess_state(TM_JGPS_SESS_STATE_STOP_REQ);
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"JGPS MSB_DLOAD: Sent request",0,0,0);
...
)
{
  ...
  do{
    ...
    if(pd_info_ptr == NULL)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Invalid input param, info avail handler",0,0,0);
      break;
    }
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Saving PD data failed",0,0,0);
      break;
    }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Wait for TCP close, before allowing next session (state=%d, comm_state=%d)",
             gen_info_ptr->sess_info.state,
...
)
{
  ...
  switch (sess_info_type)
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"JGPS: Pass unhandled sess info to IS-801 Drv (data=%d)",sess_info_type,0,0);
      break;
  }       
...
void tm_jgps_core_prtl_timer_handler(const os_TimerExpiryType *timer_param)
{
  ...
  if(timer_param != NULL)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Time expiration: Timer ID: 0x%h",
      ...
      switch(timer_param->q_TimerId)
      {
        ...
        default:
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Unknown timer expired", 0, 0, 0);
          break;
      }
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Can not proess invalid timer event", 0, 0, 0);
    }
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"JGPS: Can not proess null timer msg", 0, 0, 0);  
  }
