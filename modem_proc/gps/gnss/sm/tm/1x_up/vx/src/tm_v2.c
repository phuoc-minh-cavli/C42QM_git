...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/vx/src/tm_v2.c#1 $  
...
tm_vx_msg_v2_rej_reason_e_type tm_v2_ni_pos_req_allowed(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MT session not allowed", 0, 0, 0);
    return ret_val;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Got NI Request while there is an active Vx session", 0, 0, 0);
  ...
  switch(tm_core_get_pos_para_check(NULL))
  {
    case PDSM_PD_CMD_ERR_BUSY_S:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got NI Req while TM-core is busy", 0, 0, 0);
      ret_val = TM_VX_MSG_V2_REJ_REASON_PRIV_IS801_IN_PROGRESS;
    break;

    case PDSM_PD_CMD_ERR_GPS_LOCK_S:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"GPS is locked", 0, 0, 0);
      ret_val = TM_VX_MSG_V2_REJ_REASON_PRIVACY;
    break;

    case PDSM_PD_CMD_EMERGENCY_CALL_IN_PROGRESS_S:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"TM-Core in E911 state", 0, 0, 0);
      ret_val = TM_VX_MSG_V2_REJ_REASON_PRIV_IS801_IN_PROGRESS;
    break;
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"TM-Core does not allow NI", 0, 0, 0);
      ret_val = TM_VX_MSG_V2_REJ_REASON_PRIV_IS801_IN_PROGRESS;      
    break;
  }  
...
)
{
  ...
  if(sms_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null sms_ptr", 0, 0, 0);
    return;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Sending V2 MO Reject with reason %d", reject_reason, 0, 0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Sending V2 MO Cancel with reason %d", cancel_reason, 0, 0);
...
void tm_v2_handle_incoming_mt_sms(void)
{
  ...
  switch(tm_vx_gen_info.sess_info.incoming_v2_mt_sms.message_type)
  {
      ...
      */
      ...
      if(rej_reason == TM_VX_MSG_V2_REJ_REASON_NO_REJECT)
      {
        ...
        if(tm_vx_gen_info.sess_info.v2_mt_sms.notification_ind != (uint8)TM_VX_MSG_NOTIFY_AND_VERIFY_REQ)
        {
          ...
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"V2 NI session started successfully", 0, 0, 0);      
                   
            (void)tm_vx_ni_client_start_session();
          }
          else
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to start V2 NI session, send reject MO SMS to MPC", 0, 0, 0);
      ...
      {      
        ...
        */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"NI pos request check failed", 0, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Processing NI Cancel MT SMS", 0, 0, 0);
      ...
      */
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Cancelling V2 NI session", 0, 0, 0);
        tm_vx_reinit(FALSE, TM_STOP_REASON_NONE);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Ignore NI cancel MT SMS, active app idx = %d, correlation id = %d", 
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Processing MO Cancel MT SMS", 0, 0, 0);
      ...
      */
      if( (tm_vx_gen_info.sess_info.active_app_index != (int)PDSM_CLIENT_TYPE_NI)
        &&(tm_vx_gen_info.sess_info.correlation_id == tm_vx_gen_info.sess_info.incoming_v2_mt_sms.correlation_id))
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Cancelling V2 MO session", 0, 0, 0);
        tm_vx_reinit(FALSE, TM_STOP_REASON_NONE);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Ignore MO cancel MT SMS, active app idx = %d, correlation id = %d", 
                 tm_vx_gen_info.sess_info.active_app_index,
                 tm_vx_gen_info.sess_info.correlation_id, 0);
      }      
...
void tm_v2_set_pde_info(uint8 pde_addr_source)
{
  ...
  {    
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown PDE addr source", 0, 0 ,0);
    }
  }
  else
  {
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"V2 handle pd session done", 0, 0, 0);
  ...
  {      
    ...
    if(tm_vx_gen_info.app_info[active_app_idx].pd_req_info.pd_option.session != PDSM_PD_SESS_TYPE_TRACK_IND)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Singleshot PD session done", 0, 0, 0);
      tm_vx_reinit(FALSE, TM_STOP_REASON_NONE);
    }     
    else /* This is a tracking session */
    {
      ...
      if(active_app_idx == PDSM_CLIENT_TYPE_NI)
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got null pd_info_ptr, force cell/sector report", 0, 0, 0);
      ...
      else
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"PD session done", 0, 0, 0);
  ...
  if((active_app_idx > (int)PDSM_CLIENT_TYPE_NONE) && (active_app_idx < (int)PDSM_CLIENT_TYPE_MAX))
  {
    ...
    {              
      switch(tm_vx_gen_info.sess_info.v2_sppresp.pos_status_ind)
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Proceed with gpsOne session", 0, 0, 0);
          ...
          */
          ...
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Waiting for PD result", 0, 0, 0);
          ...
          { 
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to start gpsOne session", 0, 0, 0);
        ...
        {
          /* MPC refused access */
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"MPC refused Access %d", tm_vx_gen_info.sess_info.v2_sppresp.pos_status_ind, 0, 0);

          if(active_app_idx == (int)PDSM_CLIENT_TYPE_NI)
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handling PosStatusInd for V2 NI", 0, 0, 0);
          ...
          else
          {
            ...
            ret_val = tm_vx_fallback_to_standalone(TRUE); 
            ...
            if(ret_val == TRUE) /*lint !e506 !e731 */
            {
              MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Successfully fall back to standalone after MPC refuse.",0,0,0);
            }
            else    
            {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Correlation ID in V2 SPPResp does not match", 0, 0, 0);
    }
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No Active application", 0, 0, 0);
  }
}
...
void tm_v2_handle_pos_rpt_resp(void)
{
  ...
  if(active_app_idx == (int)PDSM_CLIENT_TYPE_NI)
  {
    ...
    { 
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"NI tracking session finished", 0, 0, 0);
        tm_vx_reinit(FALSE, TM_STOP_REASON_NONE);
        return;
      }
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Got successful pos rpt response.", 0, 0, 0);
      }
      else if(tm_vx_gen_info.sess_info.v2_pos_rpt_resp.report == 1)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MPC discontiunes pos rpt.", 0, 0, 0);
        tm_vx_reinit(FALSE, TM_STOP_REASON_NONE);
      }
#ifdef FEATURE_GPSONE_VX_LCS_AGENT_WITH_HANDOFF
      else if(tm_vx_gen_info.sess_info.v2_pos_rpt_resp.report == 2)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MPC performed handoff", 0, 0, 0);
        /* Set PDE IP address */
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown Report Status Indicator received. Ignore it.", 0, 0, 0);
      }
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Correlation ID in V2 Pos Rpt Resp does not match. Position reprt failed.", 0, 0, 0);
    }
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Got Pos Rpt Resp for invalid client type.", 0, 0, 0);
  }
}
...
void tm_v2_handle_t7_timer_expiry(void)
{
  ...
  if(active_app_idx == (int)PDSM_CLIENT_TYPE_NI)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling T7 expiry for V2 NI", 0, 0, 0);
    ...
    else
    {
      if( (tm_vx_gen_info.sess_info.v2_mt_sms.position_tech_ind == TM_VX_MT_SMS_POS_TECH_IND_CELL_SECTOR)
        &&(tm_vx_gen_info.sess_info.v2_mt_sms.num_fixes > 1))
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Ignore T7 expiry, continue cell/sector reporting", 0, 0, 0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Ignore T7 expiry event", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling T7 expiry for V2 MO; calling is801 driver to proceed with SA session", 0, 0, 0);
...
void tm_v2_handle_ms_mpc_timer_expiry(void)
{
  ...
  if(active_app_idx == (int)PDSM_CLIENT_TYPE_NI)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling MS-MPC expiry for V2 NI", 0, 0, 0);
  ...
  {    
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling  MS-MPC expiry for V2 MO; calling is801 driver to proceed with SA session", 0, 0, 0);
...
void tm_v2_handle_t14_timer_expiry(void)
{
  ...
  if(active_app_idx == (int)PDSM_CLIENT_TYPE_NI)
  {
    ...
    {
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"T14 expiry for NI session is waiting for pos report ack, ignore it and continue NI session", 0, 0, 0);
      (void)tm_vx_update_app_state(tm_vx_gen_info.sess_info.active_app_index, TM_VX_APP_STATE_INIT);
    }
    else
    {
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"T14 expiry for NI session is in %d state", tm_vx_gen_info.app_info[active_app_idx].app_state, 0, 0);    
    }    
  }
  else
  {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"T14 expiry event in invalid state", 0, 0, 0);
  }  
}
...
void tm_v2_handle_ms_abort_session_req(const tm_sess_stop_reason_e_type abort_reason)
{
  ...
  {      
    if(active_app_idx == PDSM_CLIENT_TYPE_NI)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Abort V2 NI session", 0, 0, 0);
        ...
        ||(tm_vx_gen_info.app_info[active_app_idx].app_state == TM_VX_APP_STATE_WAIT_TO_RECV_SPPRESP))
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send reject to abort V2 NI session", 0, 0, 0);
      ...
      {    
        ...
        if(tm_vx_gen_info.app_info[active_app_idx].pd_req_info.pd_option.session == PDSM_PD_SESS_TYPE_TRACK_IND)
        {
          ...
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send cancel to abort V2 NI session", 0, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Abort V2 MO session", 0, 0, 0);
      ...
      {        
        if(tm_vx_gen_info.app_info[active_app_idx].pd_req_info.pd_option.session == PDSM_PD_SESS_TYPE_TRACK_IND)
        {
          ...
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send cancel to abort V2 MO session", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid active_app_idx %d", active_app_idx, 0, 0);     
  }   
}
...
)
{
  ...
  if((active_app_idx > (int)PDSM_CLIENT_TYPE_NONE) && (active_app_idx < (int)PDSM_CLIENT_TYPE_MAX))
  {
    if(tm_vx_gen_info.app_info[active_app_idx].app_state != TM_VX_APP_STATE_WAIT_USER_RESP)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"V1 not waiting for user response", 0, 0, 0);
      return;
    }  
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Invalid app index", 0, 0, 0);
    return;    
  }
  
  if(app_resp == PDSM_LCS_NOTIFY_VERIFY_ACCEPT)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"NI session req accepted", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"NI session req rejected", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"NI session req not responded", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown app response %d", app_resp, 0, 0);
