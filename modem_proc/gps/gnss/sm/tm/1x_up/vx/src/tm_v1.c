...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/vx/src/tm_v1.c#1 $  
...
)
{
  ...
  if(mt_sms_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null mt_sms_ptr", 0, 0, 0);
    return FALSE;
  }
...
boolean tm_v1_ni_pos_req_allowed(void)
{
  ...
  if(tm_vx_gen_info.sess_info.active_app_index != -1)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got NI cell/sector request while there is an active MO session", 0, 0, 0);
      return TRUE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got NI Request while there is an active V1 session", 0, 0, 0);
      return FALSE;
    }
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"TM-Core does not allow NI session", 0, 0, 0);
    return FALSE;
  }
...
)
{
  /* Single shot fix done */
   MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"V1 handle PD info", 0, 0, 0);
  ...
  {             
    switch(tm_vx_gen_info.sess_info.v1_sppresp.pos_status_ind)
    {
      ...
      case TM_V1_SPPRESP_POS_STATUS_IND_CELL:
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Proceed with cell/cached session", 0, 0, 0);
        
        if(tm_vx_gen_info.sess_info.v1_sppresp.pos_incl)
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"position included", 0, 0, 0);
      ...
      {
        /* MPC refused access */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"MPC refused Access", 0, 0, 0);
        break;
      }
    }
  }
...
{  
  ...
  */
  ...
  if(ret_val == TRUE)
  {
    ...
    */
    ...
    {      
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"V1 NI session started successfully", 0, 0, 0);      
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to start V1 NI session", 0, 0, 0);
  ...
  {      
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"NI pos request check failed", 0, 0, 0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"NI session req accepted", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"NI session req rejected (%d)", app_resp, 0, 0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Aborting V1 session", 0, 0, 0);
...
void tm_v1_handle_ms_mpc_failure(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling  MS-MPC expiry for V1 MO", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unexpected MS-MPC expiry", 0, 0, 0);        
  }
}
