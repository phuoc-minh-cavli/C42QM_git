...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_up/vx/src/tm_vx_msg.c#1 $  
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Null info_ptr", 0, 0, 0);  
  }
  return; 
}
...
)
{
  ...
  { 
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null input pointers", 0, 0, 0);
    return;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Creaating internal V1 SPPReq", 0, 0, 0);
  
  if( (output_buf_ptr == NULL)
    ||((active_app_idx < 0) || (active_app_idx >= (int)TM_VX_APP_NUM)))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null output_buf_ptr or no active app", 0, 0, 0);  
    return -1;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Decoding V1 SPPResp", 0, 0, 0);
  
  if(input_buf_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null input_buf_ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"V1 SPPResp msg len too small: %d (bits), required: %d", msg_len*8, min_msg_len, 0);
    return FALSE;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Msg Len too small: %d", data_length, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Version is invalid %d", *input_buf_ptr, 0, 0);
    return FALSE;  
  }
  /* MT SMS message type */
}
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Creaating internal V2 SPPReq", 0, 0, 0);
...
)
{
  ...
  if(output_buf_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null output_buf_ptr", 0, 0, 0);  
    return -1;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Don't include position",0,0,0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Decoding V2 URL from meg type %d", msg_type, 0, 0);
  
  if((buf_ptr == NULL) || (int_ptr == NULL) || (msg_pos == NULL))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptr received", 0, 0, 0);  
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"invalid msg", 0 ,0 ,0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid msg length: %d", dst_msg.adrs_length ,0 ,0);
    return FALSE;
  }
  ...
  */
  for(i = 0; i < *(dst_msg.adrs_length) - 1; i++)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"URL address length exceeds maxium length", 0 ,0 ,0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Decoding V2 SPPResp", 0, 0, 0);
  ...
  if (msg_len*8 < min_msg_len)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"V2 SPPResp msg len too small: %d (bits), required: %d", msg_len*8, min_msg_len, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"No pde adrs, use 0,0",0,0,0);
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Decoding V2 Pos Report Response", 0, 0, 0);
  ...
  if(int_pos_rpt_resp_ptr->report == 2)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"No pde adrs, use 0,0",0,0,0);
...
)
{
  ...
  if( *input_buf_ptr == (byte)TM_VX_VERSION_V2_ONLY)
  {
    ...
    if (data_length < min_msg_len)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Msg Len too small: %d, required: %d", data_length, min_msg_len, 0);
      return FALSE;
    }
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Decoding Pos Req MT SMS", 0, 0, 0);
      min_msg_len+=11;
      if (data_length < min_msg_len)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Msg Len too small: %d, required: %d", data_length, min_msg_len, 0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Using default QOS = %d", TM_VX_DEFAULT_QOS, 0, 0);
    ...
    else if(tm_vx_gen_info.sess_info.incoming_v2_mt_sms.message_type == TM_V2_MT_SMS_MSG_TYPE_NI_CANCEL)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Received NI Cancel MT SMS with correlation id = %d", tm_vx_gen_info.sess_info.incoming_v2_mt_sms.correlation_id, 0, 0);
    ...
    else if(tm_vx_gen_info.sess_info.incoming_v2_mt_sms.message_type == TM_V2_MT_SMS_MSG_TYPE_MO_CANCEL)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Received MO Cancel MT SMS with correlation id = %d, cause code = %d",
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Received uknown MT SMS message type %d", tm_vx_gen_info.sess_info.incoming_v2_mt_sms.message_type, 0, 0);
      return FALSE;      
    }
  }
  else
