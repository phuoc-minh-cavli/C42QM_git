...
#define ERROR_CHECK_3PTRS(X, Y, Z)                        \
  ...
  {                                                       \
    ...
    {                                                     \
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptr passed, %x, %x, %x", X, Y, Z);  \
      return FALSE;                                       \
    }                                                     \
  }while(0);                                              \
...
#define ERROR_CHECK_2PTRS(X, Y)                           \
  ...
  {                                                       \
    if(X == NULL || Y == NULL)                            \
    {                                                     \
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptr passed, %x, %x", X, Y, 0);      \
      return FALSE;                                       \
    }                                                     \
  }while(0);                                              \
...
#define ERROR_CHECK_PTR(X)                                \
  ...
  {                                                       \
    if(X == NULL)                                         \
    {                                                     \
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptr passed, %x", X, 0, 0);          \
      return FALSE;                                       \
    }                                                     \
  }while(0);                                              \
