...
/*===========================================================================
                           ...
                           Edit History
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/is801/src/tm_is801_util.c#1 $  
  
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
3/25/17     sj     Add diag msgs to track ts in outgoing prm
...
)
{
  ...
  */
  ...
  {    
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No Base Station info provided",0,0,0);
    return FALSE;
  }
  //>>>[+ End]
  ...
  */
  ...
  for ( i=0; i < input_ppm_buf_ptr->num_pilots; i++ )
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Setting MSTO to be -P(Refpn): %d, %d",
...
)
{
  ...
  MSG_4(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"GpsPRM Time %d %d %d %d", 
        input_prm_buf_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.w_GpsWeek, 
	input_prm_buf_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.q_GpsMsec, 
	(uint32 )(input_prm_buf_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.f_ClkTimeBias * 1000), 
	(uint32 )(input_prm_buf_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.f_ClkTimeUncMs * 1000));
  
  
  gps_to_cdma_time(&input_prm_buf_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime, 
                   cdma_timestamp);

  MSG_2(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"cdma_timestamp %d %d", 
        cdma_timestamp[0], cdma_timestamp[1]);
  ...
  if (input_ppm_buf_ptr && input_ppm_buf_ptr->num_pilots)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Setting time_ref of Post Fix PPMs",0,0,0);
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"BandClass: %d, RF Delay: %d (GCx1024)",
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"PPM: Pn %d, PeakPos %d, Ecio %d",
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"PPM: Ref_Pn %d, Ref_Ecio %d",
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"CDMA RtcDiff %d (CCx16) too big, maybe clocks stopped",
                l_CDMARtcDiffCx16, 0, 0);
      l_CDMARtcDiffCx16 = 0;
    }

    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"CDMA RtcDiff %d (CCx16), RTC at TT 0x%x (CCx8), RTC from PPM 0x%x (CCx8)",
             l_CDMARtcDiffCx16,
             input_prm_buf_ptr->z_MeasBlk.z_CDMAClockInfo.q_CdmaRtcSync80CCx8,
             input_ppm_buf_ptr->cdma_rtc);

    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"CDMA RTC Diff %d, P(eatoa) %d, RFDelay %d (GCx1024)",
    ...
    /* Note: q_GpsRtcSubMsSync80GCx32 is incorrect name.
       ...
       units */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Total adjustment %d (GCx1024), GNSSRTCatSync80 %d (GCx1280)",
            l_AdjustmentGCx1024,
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"AdjustmentMs %d (GCx1024), VSRCDiff %d",
            (int32)(f_AdjustmentMs * 1023.0f * 1024.0f),
            input_prm_buf_ptr->z_MeasBlk.z_CDMAClockInfo.q_CdmaRtcLatchedCCx32, 0);
    ...
    for ( i = 0; i < input_prm_buf_ptr->z_MeasBlk.u_NumSvs; i++ )
    {
         ...
         )
      {
        ...
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"AdjustmentMs Final %d (GCx1024)",
                (int32)(f_AdjustmentMs * 1023.0f * 1024.0f),0,0);

        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"SV %d, Orig CP %d, Adjusted CP %d (GCx1024)",
                 p_GpsMeas->w_Sv,
  ...
  */
  ...
  MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "output_prm_buf_ptr timref %d", 
        output_prm_buf_ptr->fix.time_ref);  
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Using RF Loss %d (0.1 db)",input_prm_buf_ptr->z_MeasBlk.z_Gnss[i].w_RfLoss,0,0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Zero SVs reported by MGP. Report bogus SV prn=%d",first_sv_prn_num,0,0);
  ...
  if( TRUE == *z_FtcalData.p_FTCalEnabled )
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"F-TCal bad num of SVs reported %d",
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"F-TCal zero PPM meas reported", 0, 0, 0);
      z_FTCal.u_ErrorCode &= C_GNSS_FTCAL_ZERO_PPM_MEAS;
    }

    if( z_FtcalData.p_TT->q_TtNumTTSamplesAccumulated == 0 )
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"F-TCal zero Time Transfers reported", 0, 0, 0);
    ...
    if( z_FTCal.u_ErrorCode == 0 )
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal TCal %dns max %d min %d", 
               (int32)z_FTCal.f_TCalAverValueNsec,
               (int32)z_FTCal.f_TCalMaxValueNsec,
               (int32)z_FTCal.f_TCalMinValueNsec);
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal PPM TOA CCx16 %d max %d min %d",
               (int32)z_FtcalData.p_Ppm->f_PpmAverToaCCx16,
               z_FtcalData.p_Ppm->x_PpmMaxToaCCx16,
               z_FtcalData.p_Ppm->x_PpmMinToaCCx16);
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal PPM Win cent %dCCx16 num smpls %u Rollover corr %dNsec",
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal PPM Ec/Io avr %ddB max %d min %d",
               (int32)z_FtcalData.p_Ppm->f_PpmAverEcIodB,
               (int32)z_FtcalData.p_Ppm->f_PpmMaxEcIodB,
               (int32)z_FtcalData.p_Ppm->f_PpmMinEcIodB);
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal TT GNSS RTC @S80 %dGCx80 max %d min %d",
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal TT Ref CDMA RTC @S80 %d+%dCCx16 num smpls %u",
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal GPS CodePh %dGCx80 CodePh %ums FCnt %ums",
               (int32)(f_GpsCodePhSubMs * ( GPS_CHIPS_PER_MS_FLT * CHIPS_PER_CX80_FLT)),
               p_GpsMeas->z_FiltMeas.z_SvTime.q_Ms,
               p_GpsMeas->q_FCount);
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"F-TCal GPS C/No %d Latency %dms Speed %dm/s",
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"F-TCal Logging failed",0,0,0);
    }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Null pointer output_aa_buf_ptr", 0, 0, 0);
  }
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Null pointer output_sv_dir_buf_ptr", 0, 0, 0);
  }
  return TRUE;
}
...
time_type z_SaRcvTs, z_Quotient, z_FirstNavBitTsInBit, z_StartTsMs, z_ExpirationTsMs;
  ...
  for (q_I = 0; q_I < input_sa_buf_ptr->num_data_records; q_I++)
  {
    ...
    for (q_J = 0; q_J < p_DataRecord->num_sv_dr && u_SvIndex < N_SV; q_J++)
    {
      ...
      {
        /* sanity check */
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"SA msg sv#%2d NAV siz %d out of range", 
      ...
      else
      {
        ...
        if (q_I == 0)
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"SAData: StartTS Wk %d, ms %d",
                  p_SvSADataInfo->z_StartTs.w_GpsWeek,
        ...
        if (q_I == 0)
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"SAData: ExpireTS Wk %d, ms %d",
                  p_SvSADataInfo->z_ExpirationTs.w_GpsWeek,
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid sv_num", 0, 0, 0);
    return FALSE;  
  }
...
)
{
  ...
  if(tm_lr_resp == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Out of Memory!!", 0, 0, 0);
    return 0;
  }
...
void is801_util_log_rlink_msg(void *log_buf, byte log_buf_length)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Got null log_buf, can not proceed with logging", 0 ,0 ,0);
    return;
  }
...
uint32 is801_util_map_flink_bmap(sm_event_is801_msg_e_type msg_type,uint32 bmap)
{
  if(msg_type == IS801_REQ)
  {
    switch(bmap)
    {
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"IS801 flink req bit 0x%x",bmap,0,0);
  ...
  else /* Resp */
  {
    switch(bmap)
    {
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"IS801 rlink resp bit 0x%x",bmap,0,0);
        return TM_REJ_RESP_CODE;
    }
  }
}
...
uint32 is801_util_map_rlink_bmap(sm_event_is801_msg_e_type msg_type, uint32 bmap)
{
  ...
  else /* Req */
  {
    switch(bmap)
    {
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"IS801 rlink req bit 0x%x",bmap,0,0);
        return TM_REJ_RESP_CODE;
    }
  }
}
...
void is801_util_report_is801_event_tx(sm_event_is801_msg_e_type msg_type, uint32 mask)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"msg_type %d mask 0x%x",msg_type,mask,0); 
...
void is801_util_report_is801_event_rx(sm_event_is801_msg_e_type msg_type,uint32 bmap)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"msg_type %d bmap 0x%x",msg_type,bmap,0); 
...
)
{
  ...
  */
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"ts: 0x%x, still: %x, band_cl: %x", output_prdm_bsp_buf_ptr->time_ref_cdma, 
            output_prdm_bsp_buf_ptr->still_active, output_prdm_bsp_buf_ptr->band_class);
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"ch: 0x%x, pn: %x, sid: %x", output_prdm_bsp_buf_ptr->cdma_freq, 
            output_prdm_bsp_buf_ptr->pilot_pn, output_prdm_bsp_buf_ptr->sid);
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"nid: 0x%x, base_id: %x", output_prdm_bsp_buf_ptr->nid, 
            output_prdm_bsp_buf_ptr->base_id, 0);
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"base_lat: 0x%x, base_long: %x", output_prdm_bsp_buf_ptr->base_lat, 
...
)
{
  ...
  ** to get time in ms. IS801 will take only 24 bits out of that. */
  ...
  if (!found_refpn)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"RefPN %d phase not found",input_ppm_buf_ptr->ref_pn,0,0);
  }
    ...
    for (i = 0; i < pddm_rec_hdr.num_requests; i++)
    {
      ...
      if(paix_xlate_ext_req_header(&(start[buffer_pos]), &pddm_req_hdr, (length - buffer_pos)))
      {
             ...
             )
          {
            ...
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Request is time constraint!", 0, 0, 0);
            return TRUE;
          }
