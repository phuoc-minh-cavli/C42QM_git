...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/is801/src/tm_is801.c#1 $  
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unsupported band class %d", band_class, 0, 0);
  }
                     ...
                     )
{
  ...
  if(msg_cb_fp == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Registration failed because of null msg_cb_fp", 0, 0,0);  
    return FALSE;
  }

  if(is801_registred_client_type & prtl_type)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Client Already Registered", 0, 0,0);  
    return TRUE;
  }  
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Registration failed because of max # of client reached", 0, 0, 0);
  return FALSE;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "null resp_part_ptr", 0, 0, 0);
  ...
  if (NULL == fwd_link_pddm_ptr->eph_resp_process.part_resp_holder_ptr) 
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "resp_rd_indx out of bound", 0, 0, 0);
      return IS801_PROC_FWD_LINK_RESP_RESULT_ERROR;      
    }
  }
  else
  ...
  ** same message or not */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Out-of-sequence EPH data recvd! %d", eph_part_ptr->fix.u_Part_Num, 0, 0);
    // return retVal;
  }
  ...
  if ( !(fwd_link_pddm_ptr->eph_resp_process.part_mask & (0x1 << (eph_part_ptr->fix.u_Part_Num - 1))) )
  {
    ...
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Recvd duplicate EPH: %d", eph_part_ptr->fix.u_Part_Num, 0, 0);
    return retVal;
  }
...
)
{
  ...
  ** same message or not */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Out-of-sequence ALM data recvd! %d", alm_part_ptr->fix.u_Part_Num, 0, 0);
    // return retVal;
  }  
  ...
  if ( !(fwd_link_pddm_ptr->alm_resp_process.part_mask & (0x1 << (alm_part_ptr->fix.u_Part_Num - 1))) )
  {
    ...
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Recvd duplicate ALM: %d", alm_part_ptr->fix.u_Part_Num, 0, 0);
    return retVal;
  }
...
)
{
  ...
  ** the context of the same task. */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"OoO SA data recvd! %d instead of %d", sa_part_ptr->fix.part_num, fwd_link_pddm_ptr->sa_resp_process.part_idx, 0);
    return retVal;  
  }  
  ...
  if ( !(fwd_link_pddm_ptr->sa_resp_process.part_mask & (0x1 << (sa_part_ptr->fix.part_num - 1))) )
  {
    ...
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Recvd duplicate SA: %d", sa_part_ptr->fix.part_num, 0, 0);
    return retVal;
  }  
...
)
{
  ...
  { 
    ...
    case IS801_FWD_LINK_RESP_MASK_LR:
	  if (*resp_rd_indx >= MAX_RESP_PER_PDDM)
	  {
	    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "resp_rd_indx overflows array pddm_info.resp_rd", 0, 0, 0);
		return IS801_PROC_FWD_LINK_RESP_RESULT_ERROR;
	  }	
    ...
    case  IS801_FWD_LINK_RESP_MASK_SHI:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Response %d not supported, ignore it", resp_part_ptr->resp_type, 0, 0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Invalid client array index", 0, 0, 0);
    return NULL;  
  }
  ...
  else
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to get buffer for fwd_link_pddm of size (%d)", 
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Processing %d reqs.", pddm_rec_hdr.num_requests, 0, 0);
  ...
  for (i = 0; i < pddm_rec_hdr.num_requests; i++) 
  {
                                  ...
                                  (length - offset)))
    {
      ...
      if(*req_rd_indx < MAX_REQ_PER_PDDM)
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error Decoding Request Payload", 0, 0, 0);
          return -1;
        }
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Exceeded max number of request", 0, 0, 0);
        return -1;
      }
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error Decoding Request Header", 0, 0, 0);
      return -1;
    }
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "Processing %d resp.", pddm_rec_hdr.num_responses, 0, 0);  
                                   ...
                                   (length - offset)))
    {
      ...
      if(*resp_rd_indx < MAX_RESP_PER_PDDM)
      {
           ...
           paix_xlate_ext_resp_payload(&(start[offset]), &fwd_link_resp_part, pddm_resp_hdr.resp_par_len, (length - offset)))
        {
          ...
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error When Assembling Fwd Link Response Part", 0, 0, 0);
            return -1;
          }          
        }
        else
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error Decoding Response Payload", 0, 0, 0);
          return -1;
        }
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Exceeded Max Number of Response", 0, 0, 0);
        return -1;
      }
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error Decoding Response Header", 0, 0, 0);
      return -1;
    }
  }
                               ...
                               )                                   
{
  ...
  *offset       = 0;
  ...
  if((clnt_arr_idx < 0) || (clnt_arr_idx >= TM_IS801_MAX_CLIENT))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "No protocol match found", 0, 0, 0);
    return FALSE;  
  }
  
  if (NULL == start || length < MIN_PDDM_LENGTH) 
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "IS801_PROCESS_PKT:  Invalid input params.", 0, 0, 0);
    return FALSE;
  }
    ...
    *offset += PDDM_HDR_LEN;
    ...
    if(fwd_link_pddm_ptr)
    {
      ...
      if(pddm_rec_hdr.num_requests)
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error When decoding Fwd Link Req", 0, 0, 0);  
          retVal = FALSE;
        }
      }
      ...
      if((retVal == TRUE) && (pddm_rec_hdr.num_responses))
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error When decoding Fwd Link Resp", 0, 0, 0);  
          retVal = FALSE;
        }
      } 
    }
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "PDDM Queue Full", 0, 0, 0);  
      retVal = FALSE;
    }
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Error when decoding PDDM header", 0, 0, 0);  
    retVal = FALSE;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null clnt_fwd_link_pddm_buf_ptr", 0, 0, 0);
    return FALSE;    
  }
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "No more PDDM", 0, 0, 0);
  return FALSE;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null rev_link_req_q_elem_ptr", 0, 0, 0);    
    return FALSE;
  }
                           ...
                           )
{
  ...
  if(rev_link_req_q_elem_ptr)
  {
    switch(req_type)
    {
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Request type %x not supported", req_type, 0, 0);
        retVal = FALSE;
        break;
    }
    ...
    if(retVal)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Request type %x queued", req_type, 0, 0);
    ...
    else
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to queue request type %x", req_type, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to get buffer for rev-link request", 0, 0, 0);
    return FALSE;
  }  
}
                            ...
                            )
{
  ...
  if(resp_msg == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null resp_msg", 0, 0, 0);
    return FALSE;    
  }
  ...
  if(rev_link_resp_q_elem_ptr)
  {
    switch(resp_msg->response_type)
    {
      ...
      case IS801_REV_LINK_RESP_MASK_PRDM_BSP:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Creating response for type %x", resp_msg->response_type, 0, 0);
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Response type %x not supported", resp_msg->response_type, 0, 0);
        retVal = FALSE;
        break;
    }
    ...
    if(retVal)
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Response type %x queued", resp_msg->response_type, 0, 0);
    ...
    else
    {
      ...
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed to queue response type %x", resp_msg->response_type, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to get buffer for rev-link resp", 0, 0, 0);
    return FALSE;
  }  
}
...
)
{
  ...
  switch(req_ptr->req_msg.request_type)
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown Request Type %d", req_ptr->req_msg.request_type, 0, 0);
      retVal = -1;
      break;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"null rev_link_resp_q_elem_ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  switch (rev_link_resp_q_elem_ptr->resp_msg.response_type) 
  {
    ...
    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown Reverse Link Response Type", 0, 0, 0);
      retVal = FALSE;
      break;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"null pointer", 0, 0, 0);
    return FALSE;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Smallest Length: %d", length, 0, 0);
  return ((length + 7) / 8);
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ppm_ptr or ppm_fragmentation_info_ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not fit any pilot in the first PDDM", 0, 0, 0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null prm_ptr or prm_fragmentation_info_ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not fit any measurement in the first PDDM", 0, 0, 0);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid max pddm size %d", max_pddm_size, 0 ,0);
    return -1;
  }
       ...
       ||(q_cnt(&(is801_clnt_arr[prtl_arr_indx].rev_link_resp_q))))
  {
    ...
    if(rev_link_pddm_q_elem_ptr == NULL)
    {
      ...
      if(rev_link_pddm_q_elem_ptr == NULL)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to get buffer for rev_link_pddm", 0, 0, 0);        
        result = FALSE;
        break;
      }
    ...
    {   
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Error when packing rev link request", 0, 0 ,0);
        result = FALSE;
        break;
      }
    }
    ...
    if(result == TRUE)
    {
      ...
      */
      ...
      {   
         ...
         {
           MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Translate PRDM resp",0,0,0);
         ...
         {
           MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Create new PDDM for PRDM resp",0,0,0);
           (void)paix_xlate_int_pddm_hdr((byte *)&(rev_link_pddm_q_elem_ptr->pddm_info.msg_payload[0]), &pddm_hdr);
...
//<<< ************************ PRM & PPM fragmentation logic ****************************************
        ...
        &&(is801_check_rev_link_resp(prtl_arr_indx, IS801_REV_LINK_RESP_MASK_PPM) == TRUE))
      {
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null pointers", 0, 0, 0);
      ...
      {      
        ...
        if(rev_link_resp_q_prm_ptr == NULL)
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NUll rev_link_resp_q_prm_ptr", 0, 0, 0);
          result = FALSE;
          break;    
        }
      ...
      {      
        ...
        {
          MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "NUll rev_link_resp_q_ppm_ptr", 0, 0, 0);
          result = FALSE;
          break;   
        }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "Null pddm_info_ptr", 0, 0, 0);
    return FALSE;    
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "No reverse link pddm available", 0, 0, 0);
    return FALSE;      
  }
}
