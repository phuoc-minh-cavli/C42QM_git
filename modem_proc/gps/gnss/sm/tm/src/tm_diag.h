...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/src/tm_diag.h#1 $  

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/27/16    rn     Added filename to the gpsdiag_EfsFileSysRspType structure
                   for EFS Quota.
...
/* Diag Command for Forcing CC Error */
#define TM_DIAG_GEN9_ME_COMMANDS                    17
...
#define TM_DIAG_LOWI_RANGING_SUB_COMMAND 9
#define TM_DIAG_LOWI_RANGING_SINGLE_SUB_COMMAND 10
...
enum
{
  TM_DIAG_SESS_REQ_SW_VER_COMMAND       = 0x0018,
  TM_DIAG_SESS_SARF_COMMAND             = 0x0065,
  TM_DIAG_SV_NO_EXIST_CMD               = 0x006A,
  TM_DIAG_FORCE_DPO_FOR_POWER_MEAS_CMD, /* 0x006B */
  TM_DIAG_DATA_DUMP_CMD,                /* 0x006C */
  TM_DIAG_QUERY_BLANKING_CMD,           /* 0x006D */
  TM_DIAG_NAV_CONFIG_CMD,               /* 0x006E */
  TM_DIAG_NAV_SET_TEST_MODE_CMD,        /* 0x006F */
  TM_DIAG_NAV_IOCTL_CMD,                /* 0x0070 */
  TM_DIAG_QUERY_ADC_IQ_SAT_PER_CMD,     /* 0x0071 */
  TM_DIAG_FACTORY_IQ_TEST_CMD,          /* 0x0072 */
  TM_DIAG_EXT_WB_FFT_RESULTS_CMD,       /* 0x0073 */
  TM_DIAG_PFA_TEST_CMD,                 /* 0x0074 */
  TM_DIAG_GET_PFA_RESULTS_CMD,          /* 0x0075 */
  TM_DIAG_OFFLINE_CXM_TEST_CMD,         /* 0x0076 */
  TM_DIAG_JAMMER_MEAS_TEST_CMD,         /* 0x0077 */
  TM_DIAG_QUERY_XO_OFFSET_INFO_CMD,     /* 0x0078 */

  TM_DIAG_LAST_TEST_CMD                 /* 0x0079 */
};
...
enum
{
  ...
  TM_DIAG_GPS_CMD_CODE_NAV_SET_TEST_MODE_CMD,                         /* 43 */
  TM_DIAG_GPS_CMD_CODE_NAV_IOCTL_CMD,                                 /* 44 */
...
typedef PACKED struct PACKED_POST
{
  ...
  uint32                       del_pos_mask;
  uint32                       del_gps_eph_mask;
  uint32                       del_glo_eph_mask;
  uint32                       del_qzss_eph_mask;
  uint32                       del_gps_alm_mask;
  uint32                       del_glo_alm_mask;
  uint32                       del_qzss_alm_mask;
  uint32                       del_iono_mask;
  uint32                       del_sv_dir_mask;
  uint32                       del_sv_steer_mask;
  uint32                       del_gps_sv_health_mask;
  uint32                       del_glo_sv_health_mask;
  uint32                       del_qzss_sv_health_mask;
...
typedef PACKED struct PACKED_POST
{
  ...
  gnss_RfDevTrackConstellationMaskType q_ConstellationMask; 
...
typedef PACKED struct PACKED_POST
{
  ...
  uint8               u_Cnt;           /* Counter of how many wbiq info data has been updated */
  uint32              q_Cno;           /* C/No reported in tenths of dB-Hz */
  int32               l_Freq;          /* freq reported in Hz */
...
/* Definition for I/Q Test request */
typedef PACKED struct PACKED_POST
{
  tm_diag_sarf_cmd_common_type z_DiagCmdCommon;     /* diagpkt_subsys_header_type */
  uint8  u_Version; /* Version field */
  uint8  u_TestControl; /* Start/stop*/
  ...
  uint16 w_RetransmitPktNum;  /* Deprecated/unused */
  uint8  u_RfStatusLoggingRateHz; /* Deprecated/unused */
  ...
  int32  l_CenterFreqNBHz; /* Narrowband I/Q test center frequence (Hz) */
  ...
  int32  l_AdcIQRefTonePwrDBm; /* Applicable when CollectMode equals 16.
                                  ...
                                  Typically -120 dBm. */
} tm_diag_sarf_cmds_iqtest_req_pkt_type;
...
typedef PACKED struct PACKED_POST
{
  ...
  uint8   u_DirectoryAndFilename[C_GPSDIAG_MAX_FULL_FILENAME_LENGTH];
  uint8   u_FileOperation;
...
{
   gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;         /* diagpkt_subsys_header_type */
  uint8 u_RequestCode;                          /* Request code:
                                                   0 - Perform single shot noise floor calibration
                                                   1 - Start single shot Jammer measurement
                                                   2 - Perform noise floor cal for all PGAs
                                                   3 - Stop single shot Jammer measurement
                                                 */
} gpsdiag_NavBPJammerCtlReqType;

typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;        /* diagpkt_subsys_header_type */
} gpsdiag_NavBPJammerCtlRspType;
...
/* Definition of XO offset info query command  */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;         /* diagpkt_subsys_header_type */
} gpsdiag_QueryXoOffsetInfoReqType;

typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;        /* diagpkt_subsys_header_type */
  uint8                 u_XoOffsetInfoStatus;  /* Indicates validity/status of data */
...
} gpsdiag_QueryXoOffsetInfoRspType;
...
typedef PACKED struct PACKED_POST
{
  ...
  int32  l_AdcIQRefTonePwrDBm; /* Applicable when CollectMode equals 16.
                                  ADC IQ reference tone power in units of dBm at +100 kHz offset relative to GPS L1.
                                  Typically -120 dBm. */
} gpsdiag_FactoryIqTestReqType;
/* Immediate Response */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;        /* diagpkt_subsys_header_type */
} gpsdiag_FactoryIqTestImmedRspType;

/* Delayed Response */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2; /* diagpkt_subsys_header_type */	
  uint8 u_Version; /* Min value of 55 */
  uint8 u_GnssConfig; /* Flags containing configured constellations.
                         ...
                         Bit 4 – Beidou
                         Bit 5 – Galileo */
  uint32 q_GpsL1CnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_GpsL1FreqHz;    /* freq reported in Hz */
  uint32 q_GloG1CnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_GloG1FreqHz;    /* freq reported in Hz */
  uint32 q_BdsB1CnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_BdsB1FreqHz;    /* freq reported in Hz */
  uint32 q_GalE1CnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_GalE1FreqHz;    /* freq reported in Hz */
  ...
  uint32 q_MultiBandConfig; /* Flags containing configured constellations.
                         ...
                         Bit 9 – GPS L5
                         Bit 10 – GAL E5a */
  uint32 q_GpsL5GalE5aCnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_GpsL5GalE5aFreqHz;    /* freq reported in Hz */
} gpsdiag_FactoryIqTestDelayedRspType;
/* Definition of Offline CXM Test command  */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;     /* diagpkt_subsys_header_type */
} gpsdiag_OfflineCxmTestReqType;

typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;     /* diagpkt_subsys_header_type */
} gpsdiag_OfflineCxmTestRspType;

/* Definition of Extended WB FFT Results command  */
typedef PACKED struct PACKED_POST
{
  gpsdiag_CmdHdrType_v2 z_DiagCmdHdrV2;     /* diagpkt_subsys_header_type */
} gpsdiag_ExtendedWbFFtResultsReqType;
...
typedef PACKED struct PACKED_POST
{
  ...
  uint8               u_Cnt;                /* Counter of how many wbiq info data 
                                               has been updated */
  uint32              q_GpsL1CnoP1DBHz;       /* C/No reported in units of 0.1 dB-Hz */
  int32               l_GpsL1FreqHz;          /* freq reported in Hz */
  uint32              q_GloG1CnoP1DBHz;       /* C/No reported in units of 0.1 dB-Hz */
  int32               l_GloG1FreqHz;          /* freq reported in Hz */
  uint32              q_BdsB1CnoP1DBHz;       /* C/No reported in units of 0.1 dB-Hz */
  int32               l_BdsB1FreqHz;          /* freq reported in Hz */
  uint32              q_GalE1CnoP1DBHz;       /* C/No reported in units of 0.1 dB-Hz */
  int32               l_GalE1FreqHz;          /* freq reported in Hz */
  ...
  uint32 q_GpsL5GalE5aCnoP1DBHz; /* C/N0 reported in units of 0.1 dB-Hz */
  int32  l_GpsL5GalE5aFreqHz;    /* freq reported in Hz */
} gpsdiag_ExtendedWbFFtResultsRspType;
...
extern void tm_api_nav_config_change_resp_handler(uint8 u_CurrGnssConfig);
...
===========================================================================*/
extern void tm_diag_xo_offset_info_handler(const sm_ReportXOOffsetInfoStructType *pz_ReportXOOffsetInfo);
