...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/src/tm_xtra_t.h#1 $
...
=============================================================================
===========================================================================*/
#define TM_XTRA_T_MSG_LOW( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "=TM XTRA-T= " str, a, b, c )
#define TM_XTRA_T_MSG_MED( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=TM XTRA-T= " str, a, b, c )
#define TM_XTRA_T_MSG_HIGH( str, a, b, c )      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "=TM XTRA-T= " str, a, b, c )
#define TM_XTRA_T_MSG_ERROR( str, a, b, c )     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "=TM XTRA-T= " str, a, b, c )
...
typedef struct 
{
  ...
  pdsm_lite_xtra_t_session_e_type                       e_session_type; /* Session type */
...
XTRA-T command status
===========================================================================*/
extern pdsm_lite_xtra_t_cmd_err_e_type tm_xtra_t_check_get_data_param
(
  const pdsm_lite_xtra_t_cmd_s_type *req_ptr
);
...
===========================================================================*/
extern boolean tm_xtra_t_trigger_event(pdsm_lite_xtra_t_info_s_type  *p_xtra_t_info);
...
XTRA-T command status
===========================================================================*/
extern boolean tm_xtra_t_process_get_data_cmd(pdsm_lite_xtra_t_cmd_s_type *cmd_ptr);
...
===========================================================================*/
void tm_xtra_t_handle_best_avail_pos(const sm_FixInfoStructType *p_gnss_fix_rpt);
