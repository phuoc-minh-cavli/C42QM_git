...
/*=============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/src/tm_lm_iface.c#1 $ 
...
RETURN VALUE
  uint32 : system status 

SIDE EFFECTS
  None.

=============================================================================*/
uint32 tm_get_sys_status_info()
{ 
   return tm_core_get_sys_status_info();
}
