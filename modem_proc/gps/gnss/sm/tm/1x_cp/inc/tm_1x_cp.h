...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_cp/inc/tm_1x_cp.h#1 $
...
typedef struct
{
  boolean v_as_id_received;
  sys_modem_as_id_e_type e_cached_as_id;
} tm_1x_cp_sess_as_id_s_type;
...
typedef struct
{
    ...
    tm_1x_cp_sess_as_id_s_type       z_1x_cp_as_id_info;       /* Sub ID info on which the data was received. */
