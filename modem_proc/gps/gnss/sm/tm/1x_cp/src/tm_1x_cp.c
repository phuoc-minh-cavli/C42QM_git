...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/1x_cp/src/tm_1x_cp.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/21/16   kpn     Support of 1x CP on Sub2
3/25/17    sj      Make sure that timestamp of the PRM is not 0d out even if there are no SV measurements
01/24/17   kpn     Support for E911 CP session on non-DD sub
...
static boolean tm_1x_cp_validate_as_id(sys_modem_as_id_e_type as_id);
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No PDAPI client ID available", 0, 0, 0);
    return;
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"MT session PRQ=%d",prq,0,0);
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Using PR resp timeout=%d sec",tm_1x_cp_session_info.gps_session_timeout,0,0);
} /* tm_1x_cp_update_qos */
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"1X CP session termination. Reason %d",reason,0,0);
...
#endif
  /* Clear the AS ID cache stored earlier during the session start. */
  tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = SYS_MODEM_AS_ID_NONE;
  tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = FALSE;
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handle reject request bmap 801-1=0x%x 801BV1 %x 801BV3 %x",
  ...
  {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown PDE version %d", tm_1x_cp_session_info.pde_version, 0, 0);
     return FALSE;
  }

  if(ret_val)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"reject bmap 0x%x",reject_req_bmap,0,0);
  }
  return ret_val;
...
do {                                                                        \
  ...
  {  
    case TM_1X_CP_FL_REQ_PRM:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Cancel PRM req",0,0,0);
    ...
    case TM_1X_CP_FL_REQ_PPM:
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Cancel PPM req",0,0,0);
    ...
    case TM_1X_CP_FL_REQ_AMWF:
       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Cancel AWM req",0,0,0);
       NEGATE_FROM_RESP_TO_SEND(TM_1X_CP_RL_RESP_AMWF, TM_1X_CP_FL_REQ_AMWF);
       break;

    case TM_1X_CP_FL_REQ_TOM:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Cancel TOM req",0,0,0);
      NEGATE_FROM_RESP_TO_SEND(TM_1X_CP_RL_RESP_TOM, TM_1X_CP_FL_REQ_TOM);
      break;

    case TM_1X_CP_FL_REQ_LR:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Cancel LR req",0,0,0);
      NEGATE_FROM_RESP_TO_SEND(TM_1X_CP_RL_RESP_LR, TM_1X_CP_FL_REQ_LR);
      break;

    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"No action needed for Cancel type=%d", cancel_type_1x,0,0);
      *cancel_no_out_req         = 0;
      break;
...
boolean i_tm_1x_cp_handle_is801_1_cancel_request(void)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle cancel request",0,0,0);
  ...
  for(i = 0; i < tm_1x_cp_session_info.fwd_link_pddm.hdr.num_requests; i++)
  {
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not translate cancel req %d", 
                   req_rd->req_msg_payload.cancel_req.cancel_type, 0, 0);
      continue;
    }

    /* NOTE: 801-1 cancel reqs are enums, not bit masks. */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Found cancel request %d at %d", cancel_type_1x, i, 0);
...
boolean tm_1x_cp_handle_cancel_request(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown pde_version %d", tm_1x_cp_session_info.pde_version, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Cancel bmap 0x%x", tm_1x_cp_session_info.cancel_req_bmap,0,0);
  }
  return ret_val;
...
)
{
  ...
  if ( ret_val )
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created req type=%d",req,0,0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"RevLink Req 0x%x for pdeversion %d can not be created",
...
void tm_1x_cp_handle_ppm_req(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PPM req when sess inactive %d or prev. PPM req 0x%x is pending",
...
void tm_1x_cp_handle_prm_req(const byte pref_resp_qual )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PRM req when session is not active or prev PRM req is pending",
                0, 0, 0);
    return;
  }
  ...
  {   
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"AA resp received, PRM already started",0,0,0);
    return;
  }

  /* PRM Req received without AA data */
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"AA not available. Send Req to PDE",0,0,0);
  if(tm_1x_cp_create_rlink_req(TM_1X_CP_RLINK_REQ_AA) == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create AA req",0,0,0);
    tm_1x_cp_terminate_session(TM_1X_CP_TERM_SRC_NONE, TM_STOP_REASON_GENERAL_ERROR);
    return;
  }
...
void tm_1x_cp_handle_sa_req(void)
{
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"1X CP session not active",0,0,0);
    return;
  }
...
)
{
  ...
  if(ppm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptrs passed. ppm:%x", ppm_ptr, 0, 0);
    ret_val = FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown PDE version", 0, 0, 0);
    ret_val = FALSE;
  }
  ...
  if(ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not create PPM resp. Terminate session", 0, 0, 0);
    tm_1x_cp_terminate_session( TM_1X_CP_TERM_SRC_NONE, 
                                TM_STOP_REASON_GENERAL_ERROR);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created PPM resp",0,0,0);
  }
...
static boolean i_tm_1x_cp_handle_prefix_ppm_resp( srch_ppm_rpt_type *ppm_ptr )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Save pre-fix PPM data till AA data is available",0,0,0);
  ...
  if ( cp_prefix_ppm_buff_ptr == NULL )
  {
    ...
    if(cp_prefix_ppm_buff_ptr == NULL)
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No buffer for PPM.", 0, 0, 0);
      return FALSE;
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ptrs passed. ppm:%x prm_gps:%x prm_glo", 
  ...
  if(ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not create PRM resp. Terminate session", 0, 0, 0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created PRM resp",0,0,0);
  }
...
)
{
  ...
  if(ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not create/tx TOM resp. Terminate session", 0, 0, 0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created PRM resp",0,0,0);
...
static boolean i_tm_1x_cp_handle_postfix_ppm_resp( srch_ppm_rpt_type *ppm_ptr )
{
  ...
  if(cp_prm_buff_ptr_gps == NULL && cp_prm_buff_ptr_glo == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"No PRM data in the buffer, ignoring PPM resp",0,0,0);
    return TRUE;
  }
  ...
  */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create LR req",0,0,0);
    return FALSE;
  }
...
)
{
  ...
  if(ppm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null ppm_ptr",0,0,0);
    tm_1x_cp_terminate_session(TM_1X_CP_TERM_SRC_NONE, TM_STOP_REASON_GENERAL_ERROR);
    return FALSE;
  }
...
boolean tm_1x_cp_handle_ppm_resp( srch_ppm_rpt_type *ppm_ptr )
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle PPM resp. resp_to_send_bmap 0x%x",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PPM resp when not requested req_mask 0x%x",
...
)
{
  if(tm_1x_cp_session_active() != TRUE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PRM resp not expected",0,0,0);
  ...
  if(prm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null prm data",0,0,0);
    tm_1x_cp_terminate_session(TM_1X_CP_TERM_SRC_NONE, TM_STOP_REASON_GENERAL_ERROR);
    return FALSE;
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Save PRM data",0,0,0);
      ...
      (prm_ptr->z_MeasBlk.e_MeasBlkSrc != GNSS_MEAS_BLK_SRC_GLO) )
  {
    MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, 
          "Unknown constellation passed in prm %d", 
          (uint8) prm_ptr->z_MeasBlk.e_MeasBlkSrc);
    return TRUE;
  }
  ...
  if( (prm_ptr->z_MeasBlk.e_MeasBlkSrc == GNSS_MEAS_BLK_SRC_GPS) &&
      (cp_prm_buff_ptr_gps != NULL ) )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Memory leak in storing gps prm buffers", 0, 0, 0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Glonass: Not supported in 1x CP",0,0,0);
    return TRUE;
  }
  ...
  if(prm_buff_ptr)
  {
     ...
     if(prm_ptr->z_MeasBlk.e_MeasBlkSrc == GNSS_MEAS_BLK_SRC_GPS)
     {
       /* Make sure that timestamp of the PRM is not 0d out even if there are no
	* SV measurements */
       prm_buff_ptr->z_MeasBlk.z_MeasClock = prm_ptr->z_MeasBlk.z_MeasClock;	     
       cp_prm_buff_ptr_gps = prm_buff_ptr;
     }
     MSG_4(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"GpsPRM Time %d %d %d %d", 
          prm_buff_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.w_GpsWeek, 
          prm_buff_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.q_GpsMsec, 
          (uint32 )(prm_buff_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.f_ClkTimeBias * 1000), 
          (uint32 )(prm_buff_ptr->z_MeasBlk.z_MeasClock.z_Time.z_GpsTime.f_ClkTimeUncMs * 1000));
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No buffer for PRM", 0, 0, 0);
    return FALSE;
  } /* End else if no buffer is available */
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle PRM resp. resp_to_send_bmap 0x%x",
             tm_1x_cp_session_info.is801_resp_to_send_bmap, 0, 0);
  ...
  else
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PRM part num %d > max parts %d", 
  ...
  if( ret_val == TRUE &&
      (tm_1x_cp_session_info.is801_resp_to_send_bmap & TM_1X_CP_RL_RESP_PPM))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Requesting POST-FIX PPM", 0, 0, 0);
    ...
    if ( tm_1x_cp_session_info.mgp_state.ppm_on == FALSE) 
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"PPM not running, start it",0,0,0);
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed starting PPM trigger timer",0,0,0);
      }
    }
    else
    {
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"No req for PPM, create PRM resp + LR req", 0, 0, 0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handled PRM response from MGP successfuly", 0, 0, 0);
    return ret_val;
  }
...
)
{
  ...
  if ( !tm_1x_cp_session_active()) 
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Reject resp %d not expected", reject_req, 0, 0);
    return;
  }
  ...
  switch( reject_req )
  {
   case TM_1X_CP_RLINK_REQ_LR:
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"LR resp rejected",0,0,0);
    if(sess_end != 0x01)
    {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Ending 1X CP session",0,0,0);
  ...
  case TM_1X_CP_RLINK_REQ_GPS_SA:
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Reject not expected???",0,0,0);
      return;
    }
  ...
  default:
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Bad Rej cmd %d", reject_req, 0, 0);
    break;
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling AA data...",0,0,0);

  if(tm_1x_cp_session_active() != TRUE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"1X CP session not active. Ignore AA resp",0,0,0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Inconsistent state pde version %d 801_1 aa %x 801b aa %x",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Rxed Unsol AA resp",0,0,0);
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Rxed Unexpected AA resp",0,0,0);
  }
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handling SA data...",0,0,0);

  /* Check if we had requested for SA data and if the response is Solicited.
  */
  if(tm_1x_cp_session_active() == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"1X CP session not active. Ignore SA resp",0,0,0);
  }
  ...
  */
  ...
  if (unsolicited)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rxed unsol SA. Dump it",0,0,0);
    return;
  }
  ...
  */
  ...
  {
    /* PRM not ON */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PRM not on, ignore SA data",0,0,0);
  }
...
)
{
  ...
  if(tm_1x_cp_session_active() == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"1X CP session not active, ignore LR",0,0,0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Null lr_resp_801_1",0,0,0);
    tm_1x_cp_terminate_session( TM_1X_CP_TERM_SRC_NONE,
                                TM_STOP_REASON_GENERAL_ERROR);
    return;
  }
  ...
  if (sess_end)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Session Ended",0,0,0);
  ...
  else
  {
    ...
    */
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"End=0,remain in Session",0,0,0);
  }
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle DBM send success. Sess_state = %d",tm_1x_cp_session_info.sess_state,0,0);
#ifdef FEATURE_CGPS_RELEASE_PD_CALL
  if (tm_1x_cp_session_info.release_pd_call == TRUE) 
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Releasing PD call immediately",0,0,0);
...
static void i_tm_1x_cp_handle_is801_1_resp(void)
{
     ...
     )
  {
    ...
    switch(tm_1x_cp_session_info.fwd_link_pddm.resp_rd[j].resp_type)
    {
      ...
      default:        
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Unexpected resp_type %d",
...
)
{
  ...
  for(j = 0; j < tm_1x_cp_session_info.fwd_link_pddm.hdr.num_requests; j++)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Req 0x%x marked for CANCEL", cp_req_type, 0, 0);
      continue;
    }
    ...
    switch(req_rd->request_type)
    {
      case IS801_FWD_LINK_REQ_MASK_PRM:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"PRM is requested",0,0,0);
        tm_1x_cp_handle_prm_req(req_rd->req_msg_payload.prm_req.pref_resp_qual);
        break;

      case IS801_FWD_LINK_REQ_MASK_PPM:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"PPM is requested",0,0,0);
        ...
        if(sess_start == FALSE)
        {
          ...
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Only PPM is requested, start 2s timer",0,0,0);
      ...
      default:
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"req_type %d not handled",req_rd->request_type, 0, 0);
        break;
    }
  }
...
)
{
  ...
  for(j = 0; j < tm_1x_cp_session_info.fwd_link_pddm.hdr.num_requests; j++)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Req 0x%x not handled", cp_req_type,0,0);
    }
  }
...
void i_tm_1x_cp_handle_is801_b_req_at_sess_start(void)
{
  ...
  if(pddm_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"NULL Is801B PDDM!!", 0, 0, 0);
    return;
  }
  ...
  */
  ...
  while(j != 0)
  {
    if(j & v1_req)
    {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Req 0x%x marked for CANCEL", j, 0, 0);
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"req_type %d not handled", (j & v1_req), 0, 0);
      }
    }
    ...
    if(j & v3_req)
    {
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"req_type %d not handled",
...
void tm_1x_cp_handle_req_resp_during_session(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Sending Rlink PDDM",0,0,0);
...
static boolean i_tm_1x_cp_allocate_rlink_buffer(byte pde_version)
{
  ...
  if(no_buf)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"No buffer for rlink buf",0,0,0);
    tm_1x_cp_terminate_session( TM_1X_CP_TERM_SRC_NONE,
                                TM_STOP_REASON_GENERAL_ERROR );
    return FALSE;
  }
...
void tm_1x_cp_handle_start_session(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Failed starting session timer",0,0,0);
  }
  ...
  else
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Send MSInfo and PPM together. Start 500ms timer",0,0,0);
      send_now = FALSE;  
      /* Start 500ms timer */
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Sending PDDM now",0,0,0);
    if(!i_tm_1x_cp_send_rlink_pddm(0, tm_1x_cp_session_info.pde_version))
    {
  ...
  if(send_cack == FALSE)
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"TM CM Iface rejects start req",0,0,0);
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"1X CP session trigger. sess_tag=%d", sess_tag, 0, 0);
  ...
  if(tm_1x_cp_session_info.tm_core_session_started == FALSE)
  {
    ...
    */
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to start 1X CP session",0,0,0);
#ifdef FEATURE_CGPS_RELEASE_PD_CALL
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Processing IS801-1 PDDMs", 0, 0, 0);
  ...
  for(i = 0; i < num_pddm; i++)
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got %d Fwd Link Req. Req Mask 0x%x", 
              tm_1x_cp_session_info.fwd_link_pddm.hdr.num_requests, 
              tm_1x_cp_session_info.fwd_link_pddm.req_mask, 0); 
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Got %d Fwd Link Resp. Resp Mask 0x%x", 
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not allocate buffer for reject msg", 0, 0, 0);
      return TRUE;
    }
    ...
    { 
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Handle req & resp during session",0,0,0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"PDE requesting for End session",0,0,0);
      if( tm_1x_cp_session_active() == TRUE )
      {
        tm_1x_cp_terminate_session( TM_1X_CP_TERM_SRC_NONE,
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Unexpected call flow, rejecting requests",0,0,0);
      ret_val = tm_1x_cp_reject_is801_requests(
                    tm_1x_cp_session_info.is_801_1_req, 0, 0);
      if(ret_val)
      {
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"REq for data %d not handled", req_data,0,0);
    return FALSE;
  }
}
...
)
{
    ...
    switch(sess_info_type)
    {
      ...
      default:
        ret_val = FALSE;
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unexpected sess_info %d",sess_info_type,0,0);
      break;
    }
    return ret_val;
}
...
boolean tm_1x_cp_proc_801_msgs(void)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Process %d Is801-1 pddms", 
  ...
  {
    /* Invalidate the AS ID info if copied earlier. */
    tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = SYS_MODEM_AS_ID_NONE;
	tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = FALSE;
	MSG(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x: Could not decode. Unknown pddm. Cached AS_ID reset");
    ret_val = FALSE;
  }
...
boolean tm_1x_cp_handle_event_mt_msg(tm_cm_rcv_data_s_type *msg)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"handling mt msg. PDE version %d 801b support %d", 
             tm_1x_cp_session_info.pde_version,
             tm_1x_cp_config.support_is801b, 0);

  /* Populate AS ID into CP session info global structure. */
  if (!tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received)
  {
	tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = msg->as_id;
	tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = TRUE;
	MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x: AS_ID cached to %d for MT session", (uint8)tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id);
  }
  ...
  */
  ...
  if (FALSE == ret_val)
  {
    ...
    tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = SYS_MODEM_AS_ID_NONE;
	tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = FALSE;
	MSG(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x: Cached AS_ID for MT has been reset");
  }
  return ret_val;
}
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Event received %d",event_type,0,0);
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"Ignore events other than EVENT_TYPE_PHONE",0,0,0);
    return FALSE;
  }
  ...
  switch(event_payload->phone_event_payload.event)
  {
    case TM_PHONE_EVENT_TC_CONNECTED:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Connected to PDE",0,0,0);
      ...
      if(tm_1x_cp_session_info.fl_req_mask & TM_1X_CP_FL_REQ_PPM)
      {
        if(tm_1x_cp_session_info.mgp_state.ppm_on)
        {
          if ( !tm_1x_cp_get_ppm( ) )
          {
            MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unable to Obtain Post-fix PPM",0,0,0);
            tm_1x_cp_terminate_session(TM_1X_CP_TERM_SRC_NONE, TM_STOP_REASON_GENERAL_ERROR);
          }
        }
        else
    ...
    case TM_PHONE_EVENT_TC_DISCONNECTED:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Disonnected",0,0,0);
      if(tm_1x_cp_session_active())
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Session aborted",0,0,0);
        tm_1x_cp_terminate_session(TM_1X_CP_TERM_SRC_CM_IFACE,TM_STOP_REASON_GENERAL_ERROR);
      }
      break;

    case TM_PHONE_EVENT_MT_MSG:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MT Msg of length %d received", 
                  event_payload->phone_event_payload.payload.dbm_msg.length,0,0);

      if (!tm_1x_cp_validate_as_id(event_payload->phone_event_payload.payload.dbm_msg.as_id))
      {
        MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-1x: Validation failed for DBM msg received on Sub %u !!", 
                (uint8)event_payload->phone_event_payload.payload.dbm_msg.as_id);
        break;
      }

      ret_val = tm_1x_cp_handle_event_mt_msg(&event_payload->phone_event_payload.payload.dbm_msg);

      if(ret_val)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"Begin proc of decoded Is801 msgs", 0, 0, 0);
        ret_val = tm_1x_cp_proc_801_msgs();
      }
      else
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW,"Unable to decode MT msg, terminate active session", 0, 0, 0);
      }
    ...
    case TM_PHONE_EVENT_SENT_MSG_STATUS:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MT Sent Msg status %d for Id 0x%x received",
      ...
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"L2 Ack for last pkt received",0,0,0);
    ...
    case TM_PHONE_EVENT_E911CB_ENTER:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Enter E911CB",0,0,0);
      if (CGPS_SRV_SYS_CDMA == phone_state_info.emerg_srv_system)
      {
      if(tm_1x_cp_session_info.mgp_state.ppm_on == FALSE)
      {
    ...
    case TM_PHONE_EVENT_E911CB_EXIT:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Exit E911CB",0,0,0);
...
void tm_1x_cp_read_nv(void)
{
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MAX nv_gps1_net_dbm_size = %d.", TM_1X_CP_MAX_PDDM_DEFAULT_VAL, 0, 0);
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"MIN nv_gps1_net_dbm_size = %d.", TM_1X_CP_MIN_PDDM_DEFAULT_VAL, 0, 0);
...

{
  ...
  tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = FALSE;
  tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = SYS_MODEM_AS_ID_1;
}
...
{
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_prtl_init", 0, 0, 0);
...
FUNCTION tm_1x_cp_get_cached_as_id

DESCRIPTION
  This function returns the cached as_id for 1x sessions
  
DEPENDENCIES: none

RETURN VALUE: sys_modem_as_id_e_type: cached as_id

SIDE EFFECTS: none

===========================================================================*/
sys_modem_as_id_e_type tm_1x_cp_get_cached_as_id(void)
{
  return (tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id);
} 

/*===========================================================================

FUNCTION tm_1x_cp_validate_as_id

DESCRIPTION
  This function validates as_id for 1x CP events to be sure that the as_id matches with the ongoing session's as_id
...
static boolean tm_1x_cp_validate_as_id(sys_modem_as_id_e_type as_id)
{
  ...
  MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "CP-1x: tm_1x_cp_validate_as_id() called with as_id %u", (uint8)as_id);
  
  /* Confirm if the new event is related to an ongoing session */
  if (tm_1x_cp_session_info.tm_core_session_started)
  {
    if (!tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received)
    {
      /* This is the first event with as_id. Cache the as_id, so that we can use it for rest of the session */
	  tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = as_id;
	  tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = TRUE;
	  MSG_1( MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x:First event with as_id. AS_ID cached %u", (uint8)as_id);
      retValue = TRUE;
    }	
    else if (as_id != tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id)
    {
      /* Events for new session on a different sub, do not handle them  */
      MSG_2(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "CP-1x: Dropping event for as_id %u, ongoing session's as_id is %u", (uint8)as_id,
            (uint8)tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id);
      retValue = FALSE;
    }
    else
    {
      /* Received event for ongoing session */
      MSG_1(MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x:Received event for ongoing CP-1x session and cached as_id matches %u", (uint8)as_id);
      retValue = TRUE;
    }
  }
  else /* New session on-going, let it through*/
  {
    ...
    tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id = as_id;
	tm_1x_cp_session_info.z_1x_cp_as_id_info.v_as_id_received = TRUE;
	MSG_1( MSG_SSID_GPSSM, MSG_LEGACY_MED, "CP-1x: New session. AS_ID cached to %u", (uint8)as_id);
    retValue = TRUE;
  }
