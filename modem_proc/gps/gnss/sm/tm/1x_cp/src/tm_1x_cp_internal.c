...
boolean tm_1x_cp_start_sess_req()
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_start_sess_req Succeeded", 0, 0, 0);  
    tm_1x_cp_session_info.tm_core_session_started = TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_start_sess_req Failed", 0, 0, 0);
    ret_val = FALSE;
  }          
  return ret_val;
}
...
boolean tm_1x_cp_terminate_sess_req(tm_sess_stop_reason_e_type reason)
{
  ...
  if( tm_sess_req(TM_PRTL_TYPE_1X_CP,
                 ...
                 &tm_1x_cp_sess_req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_terminate_sess_req Succeeded", 0, 0, 0);  
    return TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_terminate_sess_req Failed", 0, 0, 0);  
    return FALSE;
  }
}
...
boolean tm_1x_cp_start_ppm(tm_1x_cp_sess_req_e_type req_type)
{
  ...
  if(tm_sess_req(TM_PRTL_TYPE_1X_CP,
             ...
             &tm_1x_cp_sess_req_param))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_start_ppm Succeeded", 0, 0, 0);  
    tm_1x_cp_session_info.mgp_state.ppm_on = TRUE;
  }
  else
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_start_ppm Failed", 0, 0, 0);
    ret_val = FALSE;
  }                  
  return ret_val;
}
...
boolean tm_1x_cp_get_ppm()
{
   ...
   if(tm_sess_req(TM_PRTL_TYPE_1X_CP,
              ...
              &tm_1x_cp_sess_req_param))
   {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_get_ppm Succeeded", 0, 0, 0);
   ...
   {
     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_get_ppm Failed", 0, 0, 0);
     ret_val = FALSE;
   }                  
   return ret_val;
}
...
boolean tm_1x_cp_end_ppm()
{
    ...
    if(tm_sess_req(TM_PRTL_TYPE_1X_CP,
               ...
               &tm_1x_cp_sess_req_param))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_end_ppm Succeeded", 0, 0, 0);  
      (void)os_TimerStop(tm_1x_cp_session_info.tm_1x_cp_ppm_timer);  
      tm_1x_cp_session_info.mgp_state.ppm_on = FALSE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_end_ppm Failed", 0, 0, 0);
      ret_val = FALSE;
    }        
    return ret_val;
}
...
boolean tm_1x_cp_start_prm()
{
    ...
    if(tm_sess_req(TM_PRTL_TYPE_1X_CP,
                 ...
                 &tm_1x_cp_sess_req_param))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_start_prm Succeeded", 0, 0, 0);  
      tm_1x_cp_session_info.mgp_state.prm_on = TRUE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_start_prm Failed", 0, 0, 0);
      ret_val = FALSE;
    }                  
    return ret_val;
}
...
boolean tm_1x_cp_end_prm()
{
    ...
    if(tm_sess_req(TM_PRTL_TYPE_1X_CP,
               ...
               &tm_1x_cp_sess_req_param))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"tm_1x_cp_end_prm Succeeded", 0, 0, 0);  
      tm_1x_cp_session_info.mgp_state.prm_on = FALSE;
    }
    else
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"tm_1x_cp_end_prm Failed", 0, 0, 0);
      ret_val = FALSE;
    }                  
    return ret_val;
}
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"IS801B flink response %x not translated", 
                 resp_mask, 0, 0);
  }
...
)
{
  ...
  else
  {
    ...
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"prefix_ppm buffer empty",0,0,0);
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"PRM not requested, no need to post AA. req_send_bmap 0x%x",
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"prm already on", 0, 0, 0);
    return;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH,"Could not start prm", 0, 0, 0);
    return;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not convert Rlink resp for PPM",0,0,0);
    return FALSE;    
  }

  if( !is801_new_rev_link_resp(TM_PRTL_TYPE_1X_CP, resp_ptr) )
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create Rlink resp for PRM",0,0,0);
    return FALSE;
  }
...
static boolean i_tm_1x_cp_send_is801_1_rlink_pddm(byte sess_end)
{
  ...
  */
  ...
  if(num_rev_pddm < 0)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"IS801 returned PDDMs = %d",num_rev_pddm,0,0);
    return FALSE;
  }

  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Num PDDMs to be sent= %d",num_rev_pddm,0,0);
                               ...
                               &tm_1x_cp_session_info.rev_link_pddm))
    {
      ...
      */
      if(tm_cm_iface_send_data(
                ...
                tm_1x_cp_session_info.rev_link_pddm.msg_size, 
                tm_1x_cp_session_info.z_1x_cp_as_id_info.e_cached_as_id) == FALSE)
      {
        MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not send data to CM",0,0,0);
        return FALSE;
      }
    }
    else
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown pde version %d", pde_version, 0, 0);
  }
...
)
{
  ...
  if (!is801_new_rev_link_resp( TM_PRTL_TYPE_1X_CP,resp_ptr))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create Rlink resp for TOM",0,0,0);
    return FALSE;
  }
...
)
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"NULL ptrs passed resp %x prm %x", resp_ptr, gps_prm_ptr, 0);
    return FALSE;
  }
  ...
  if(!is801_new_rev_link_resp(TM_PRTL_TYPE_1X_CP, resp_ptr))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can not create Rlink resp for PRM, terminate session",0,0,0);
    return FALSE;
  }
...
)
{
  ...
  if( !is801_new_rev_link_resp( TM_PRTL_TYPE_1X_CP,resp_ptr))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Could not create rej resp for req 0x%x", rej_req_mask, 0, 0);
    return FALSE;
  }
  return TRUE;
}
...
)
{
  ...
  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Handle reject request is801_1_v1_rej_req=0x%x ",
  ...
  if( is801_1_v1_rej_req & IS801_FWD_LINK_REQ_MASK_PPM)
  {
    if(i_tm_1x_cp_reject_is801_request( 
                         ...
                         PPM_MEAS_REQ_CODE, 1))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rejecting PPM request",0,0,0);
  ...
  if( is801_1_v1_rej_req & IS801_FWD_LINK_REQ_MASK_PRM )
  {
    if(i_tm_1x_cp_reject_is801_request( 
                         ...
                         PR_MEAS_REQ_CODE, 1))
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rejecting PRM request",0,0,0);
  ...
  if ( is801_1_v1_rej_req & IS801_FWD_LINK_REQ_MASK_LR )   
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rejecting LR request",0,0,0);
  ...
  if ( is801_1_v1_rej_req & IS801_FWD_LINK_REQ_MASK_TOM )   
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rejecting TOM request",0,0,0);
  ...
  if ( is801_1_v1_rej_req & IS801_FWD_LINK_REQ_MASK_AMWF )   
  {
    ...
    {
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Rejecting MWF request",0,0,0);
...
)
{
  ...
  if(ret_val)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created MSI resp",0,0,0);
  }
  return ret_val;
}
...
)
{
  ...
  if(resp_ptr == NULL)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"no 801-1 rlink buffer ptr", 0, 0, 0);
    return FALSE;
  }
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unknown PDE version, terminating session", 0, 0, 0);
  ...
  if(ret_val == FALSE)
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Can't create MSInfo. req mask %x", fl_req, 0, 0);
    tm_1x_cp_terminate_session( TM_1X_CP_TERM_SRC_NONE, 
                                TM_STOP_REASON_GENERAL_ERROR );
  }
  return ret_val;
...
)
{
  ...
  if ( is801_new_rev_link_resp( TM_PRTL_TYPE_1X_CP,resp_ptr))
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED,"Created CACK resp",0,0,0);
    return TRUE;
  }
  else
  {
...
)
{
  switch(rejected_req_type)
  {
    ...
    case(GPS_SAT_HLTH_REQ_CODE):
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unexpected IS801-1 reject req cmd %d from pde", 
                   rejected_req_type, 0, 0);
      return TM_1X_CP_RLINK_REQ_NONE;

    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid IS801-1 reject req cmd %d from pde", 
                   rejected_req_type, 0, 0);
      return TM_1X_CP_RLINK_REQ_NONE;
  }
}
...
)
{
  switch(reject_resp)
  {
    ...
    case(IS801B_FWD_LINK_RESP_MASK_DGNSS_ASST):
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Unexpected IS801-B reject req cmd %d from pde", 
                   reject_resp, 0, 0);
      return TM_1X_CP_RLINK_REQ_NONE;

    default:
      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"Invalid IS801-B reject req cmd %d from pde", 
                   reject_resp, 0, 0);
      return TM_1X_CP_RLINK_REQ_NONE;
  }
}
