...
/*===========================================================================
                           ...
                           Edit History
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/tm/inc/tm_qwip_iface.h#1 $   
...
typedef struct {
  pdsm_lite_cmd_s_type pdsm_cmd_type; // session is a standalone session, with QOS parameters set based on the ODP mode
...
typedef  union
{
  pdsm_lite_cmd_s_type *pdsm_cmd_type;
