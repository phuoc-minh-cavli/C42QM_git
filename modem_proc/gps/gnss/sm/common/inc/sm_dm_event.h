...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/inc/sm_dm_event.h#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $
...
#define EVENT_PDSM_LITE_NOTIFY_VERIFY_REQ 0x07
...
typedef PACKED struct PACKED_POST
{
  pdsm_lite_xtra_status_e_type  end_reason;  
...
===========================================================================*/
extern void sm_report_event_gps_pa_event_callback (pdsm_lite_pa_e_type e_PaEvent);
 ...
 *
 * Parameters: 
 * pointer to pdsm_lite_dm_event_type
 *
 * Return value: 
 *
 *  None
 *
 ******************************************************************************/
extern void sm_report_event_pa_cmd_err(uint8 u_CmdType, pdsm_lite_pa_cmd_err_e_type e_CmdErr);
 ...
 *
 ******************************************************************************/
extern void sm_report_event_pd_cmd_err(uint8 u_CmdType, pdsm_lite_pd_cmd_err_e_type e_CmdErr);
...
(
  pdsm_lite_xtra_status_e_type reason 
);
