...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/inc/pdapidbg.h#1 $
...
*/
  ...
  #define PDSM_CASE_ERR( str,a,b,c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "=PDSM= " str,a,b,c )
  #define PDSM_SWITCH_ERR( str,a,b,c )     MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "=PDSM= " str,a,b,c )
  #define PDSM_ELSE_ERR( str ) \
