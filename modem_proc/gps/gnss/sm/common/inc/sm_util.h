...
/*============================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/inc/sm_util.h#1 $
...
#define SM_GNSS_GPS_CONSTELL  0
#define SM_GNSS_GLO_CONSTELL  1
#define SM_GNSS_BDS_CONSTELL  2
#define SM_GNSS_GAL_CONSTELL  3
#define SM_GNSS_QZSS_CONSTELL 4
#define SM_GNSS_MAX_CONSTELL  5
#define SM_GNSS_PRIMARY_CONSTELLATION SM_GNSS_GPS_CONSTELL  
