...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/src/pdapibuf.c#1 $
...
void pdsm_pool_init ( void )
{
  ...
  {
    MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_FATAL,"Unable to initialize gnss_pdapi_buff_pool_mutex",0,0,0);
  }
