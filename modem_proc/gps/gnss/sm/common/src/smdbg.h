...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/src/smdbg.h#1 $
...
#define PDSM_STDDBG_MSG_LOW( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "=PDSM_STDBG= " str, a, b, c )
#define PDSM_STDDBG_MSG_MED( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=PDSM_STDBG= " str, a, b, c )
#define PDSM_STDDBG_MSG_HIGH( str, a, b, c )      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "=PDSM_STDBG= " str, a, b, c )
#ifdef PDSM_DEBUG
#define PDSM_STDDBG_MSG_ERROR(str, a, b, c)       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_FATAL,"=PDSM_STDBG= " str, a, b, c)
#else
#define PDSM_STDDBG_MSG_ERROR(str, a, b, c)       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR,"=PDSM_STDBG= " str, a, b, c)
#endif /* PDSM_DEBUG */
...
#define PDSM_MSG_LOW( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_LOW, "=PDSM= " str, a, b, c )
#define PDSM_MSG_MED( str, a, b, c )       MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=PDSM= " str, a, b, c )
#define PDSM_MSG_HIGH( str, a, b, c )      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "=PDSM= " str, a, b, c )
...
*/
  ...
  #define PDSM_ERR( str,a,b,c )            ERR( "=PDSM= " str,a,b,c )
  #define PDSM_MSG_ERROR( str,a,b,c )      MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "=PDSM= " str,a,b,c )
  #define PDSM_DBG_ERR( str,a,b,c )
  #define PDSM_CASE_ERR( str,a,b,c )       ERR_FATAL( "=PDSM= " str,a,b,c )
  #define PDSM_SWITCH_ERR( str,a,b,c )     ERR_FATAL( "=PDSM= " str,a,b,c )
  #define PDSM_ELSE_ERR( str ) \
               else { MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=PDSM= " str " else make no sense",0,0,0 ); }
