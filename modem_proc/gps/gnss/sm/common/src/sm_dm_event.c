...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss/sm/common/src/sm_dm_event.c#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $
...
===========================================================================*/
void sm_report_event_gps_pa_event_callback (pdsm_lite_pa_e_type e_PaEvent)
{
  uint8 u_Payload;
 ...
 ******************************************************************************
*/
void sm_report_event_pd_cmd_err(uint8 u_CmdType, pdsm_lite_pd_cmd_err_e_type e_CmdErr)
{
 ...
 *
 ******************************************************************************/
void sm_report_event_pa_cmd_err(uint8 u_CmdType, pdsm_lite_pa_cmd_err_e_type e_CmdErr)
{
  sm_event_pd_cmd_err_callback_s_type z_Payload;
                                   ...
                                   byte priv_type)
{
  ...
  event_data.u_EventName = EVENT_PDSM_LITE_NOTIFY_VERIFY_REQ;
