################################################################################
# $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss_tools/pdapi_scripts/QXDM4/pd_GpsClientsStartStopXTRA3.pm#1 $
...
#
################################################################################
######### updated by xindong for QXDM4 use ##################

package pd_GpsClientsStartStopXTRA3;
...
if (!$IQXDM)
{
  ...
  die;
			...
			$main::qxdm_app = $IQXDM->GetAutomationWindow();
		$main::qxdm_app->SetVisible(true);
  ...
  $main::qxdm_app->{COMPort} = $comport1;
