# 
#$Header: //components/rel/gnss8.mpss/9.5.1.1/gnss_tools/standalone_rfv/QXDM4/sarf_mode_switch/SARF_ModeSwitch.pl#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $
#*****************************************************************************
...
my $timeout = 6000; # Timeout for receiving ACK for injected presc dwell
