...
#
# Copyright (C) 2016 QUALCOMM Incorporated. All rights reserved.
...
use constant eITEM_TYPE_SUBSYSV2_IMMEDIATE_RX => 12;
use constant eITEM_TYPE_SUBSYSV2_DELAYED_RX => 13;
use constant eITEM_TYPE_SUBSYSV2_TX => 14;
...
sub QXDMInitializeNonVisible
{
	...
	if($osname eq 'MSWin32')
	{
	   ...
	   print "\nInterface Version: " . $Version . "\n";
			...
			#print "\nIQXDM is $IQXDM\n";
			$IQXDM2 = $IQXDM;
      $IQXDM->SetQXDMInSingleInstance(true);
		}
	}
	return $IQXDM;
}
