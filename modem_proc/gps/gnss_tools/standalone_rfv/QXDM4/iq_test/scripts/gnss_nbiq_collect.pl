# 
# $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss_tools/standalone_rfv/QXDM4/iq_test/scripts/gnss_nbiq_collect.pl#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $
#*****************************************************************************
...
#
# Description:
# This script is typically used by a user to run an NBIQ test. It takes the  
...
# Signal Level Should be -110 dbm

$req->{"collectmode"} = 5;     # VALID VALUES for "CollectMode":-
...
$req->{"num1ksamples"} = 60;   # 1-1024 allowed for all WB. 0-1024 allowed for NB. 0=>Collect Forever
$req->{"integrations"} = 1;    # Greater than 0
...
GPS Narrow-Band IQ Collect

Syntax:   perl gnss_nbiq_collect.pl <Options>

Options:  -help               Display this help message.
          Option 1:           <QPST Connection Port Number>

 
Example:  perl gnss_nbiq_collect.pl 10
