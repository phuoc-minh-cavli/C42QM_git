# 
#$Header: //components/rel/gnss8.mpss/9.5.1.1/gnss_tools/standalone_rfv/QXDM4/iq_test/scripts/gnss_wbiq_collect.pl#1 $ $DateTime: 2020/07/21 21:23:44 $ $Author: pwbldsvc $
#*****************************************************************************
...
#
# Description:
# This script is typically used by a user to run a WBIQ test. It takes the  
...
# GLO Center Frequency : 1602.05 MHz => +50 kHz Offset
...
$req->{"collectmode"} = 1;     # VALID VALUES for "CollectMode":-
...
$req->{"integrations"} = 10;    # Greater than 0
...
Syntax:   perl gnss_wbiq_collect.pl <Options>

Options:  -help               Display this help message.
          Option 1:           <QPST Connection Port Number>

 
Example:  perl gnss_wbiq_collect.pl 10
