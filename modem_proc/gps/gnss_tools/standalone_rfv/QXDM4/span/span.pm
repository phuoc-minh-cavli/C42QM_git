# 
# $Header: //components/rel/gnss8.mpss/9.5.1.1/gnss_tools/standalone_rfv/QXDM4/span/span.pm#1 $
...
my %fields = (
       ...
       bds_jobs_enabled => undef,
       gal_jobs_enabled  => undef
);
# METHOD:
#   new
#
...
sub SpanCmd
{
   ...
   $req_pkt->Put(13, $self->{"bds_jobs_enabled"});
   $req_pkt->Put(14, $self->{"gal_jobs_enabled"});
   return $req_pkt;
}
