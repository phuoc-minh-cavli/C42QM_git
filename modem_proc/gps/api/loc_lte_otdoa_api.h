...
$Header: //components/rel/gnss8.mpss/9.5.1.1/api/loc_lte_otdoa_api.h#1 $
 ...
 * Defined as 'LTE_LL1_DL_NUM_CARRIERS' in 'modem_proc\fw_lte\api\intf_common.h' */
#define LLOC_MAX_LTE_CARRIERS                         5
...
typedef enum
{
  ...
  /* used by ML1 to indicate that PCC serving cell has changed during PRS occasion */
  LOC_LTE_OTDOA_SERVING_CELL_SWITCH,

  /* used by ML1 to indicate that one of the SCC cells has been activated/deconfigured */
  LOC_LTE_OTDOA_CA_SCELL_CONFIGURED
}
...
loc_lte_otdoa_ScellInfoPerCellType;
...
typedef struct
{
  ...
  loc_lte_otdoa_ScellInfoPerCellType z_Scell[LLOC_MAX_LTE_CARRIERS];

/* FEATURE_GNSS_NAVHW_GEN8C */
  /* Physical cell id */
  uint16 w_PhyCellId;
