...
$Header: //components/rel/gnss8.mpss/9.5.1.1/api/loc_wwan_lte_api.h#1 $
...
/*===========================================================================
  ...
  FUNCTION:  loc_wwan_Lte_SignalRpt

===========================================================================*/
/*!
    @brief
    API function to be called by LTE ML1 to report the LTE cell signal 
...
*/
/*=========================================================================*/
extern void loc_wwan_Lte_SignalRpt(boolean signalWeak);
