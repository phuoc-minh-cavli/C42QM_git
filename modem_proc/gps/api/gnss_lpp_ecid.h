...
/*===========================================================================
  ...
  $Header: //components/rel/gnss8.mpss/9.5.1.1/api/gnss_lpp_ecid.h#1 $
...
typedef struct
{
   ...
   int16 sub_id; /* LTE SUB ID. Same as type 'sys_modem_as_id_e_type', defined in 'mmcp\api\public\sys.h' */
...
=============================================================================*/
boolean gnss_lpp_ecid_get_measurements(const uint32 q_meas_type, const uint32 u_sess_type, const int16 sub_id );
