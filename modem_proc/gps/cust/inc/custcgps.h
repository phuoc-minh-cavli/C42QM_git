...
$Header: //components/rel/gnss8.mpss/9.5.1.1/cust/inc/custcgps.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
04/29/16   mj      Enable feature FEATURE_GNSS_GERA_ENABLE for GERA
...
---------------------------------------------------------------------------*/
  ...
  /* Enable XTRA Dynamic Allocate feature */
  /* Disable FEATURE_CGPS_XTRA_DYNAMIC_ALLOC 
  #define FEATURE_CGPS_XTRA_DYNAMIC_ALLOC    // Added for 9x05 project.
  */

  /* Enable the XTRA 2 feature */
  //#define FEATURE_GNSS_XTRA2    Removed for 9x05 project.

  /* Enable the XTRA 3 feature */
  #define FEATURE_GNSS_XTRA3

  /* Enable the Safe Decoding of XTRA3 */
  #define XTRA3_SAFE_DECODING
...
#ifndef FEATURE_GEN9_LEANBUILD_DIAG
  /* Enable internal IPC message bookkeeping for OS API debugging */
  #define FEATURE_IPC_DEBUG
#endif /* FEATURE_GEN9_LEANBUILD_DIAG */

/* Disable the LTE CATM/GPS coexistence feature */
//#define FEATURE_GNSS_LTE_CATM_COEX

/* Enable GPS Automotive Features based on the target level modem flag */
#ifdef FEATURE_AUTOMOTIVE_SP
  #define FEATURE_GNSS_GEN9_AUTOMOTIVE_ENABLED
  #define FEATURE_LOCTECH_NHZ
  #define FEATURE_LOCTECH_10HZ
  /* Scons flag: USES_FEATURE_LOCTECH_NHZ must be verified to not contain any changes */
#endif /* FEATURE_AUTOMOTIVE_SP */

#ifdef FEATURE_CGPS_XTRA_T
/* Enable GTP WWAN NB-IOT support for CIOT devices */
#define FEATURE_CGPS_TLE_IOT

#ifdef FEATURE_GSM /* Needed only when GSM is enabled at top level */
/* Enable GSM support in TLE without enabling WCDMA support */
#define FEATURE_CGPS_TLE_GSM_SUPPORT
#endif /* Needed only when GSM is enabled at top level */

/* Enable GTP 2.0 support if WWAN scan feature is enabled */
#ifdef FEATURE_GPS_WWAN_PRIORITY_SEARCH
#define FEATURE_CGPS_GTP_20_SUPPORT

/* Enable GTP 2.0 Debug Mode */
/* #define FEATURE_CGPS_GTP_20_DEBUG_MODE */

/* Turn on memory debugging for test only (disable in commercial builds) */
/* #define FEATURE_CGPS_MEM_DEBUG */
