...
$Header: //components/rel/rftech_gnss.mpss/2.10/gen8/rf/core/src/rfgnss_core.h#1 $
$DateTime: 2020/04/16 12:19:05 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
08/23/18   aj      Expose standalone API to GNSS to return rfc signal info for WGR
...
void rfgnss_core_get_gnss_rfc_signal_info_signal_list(rfgnss_rfc_signal_list_type *rf_signals);
