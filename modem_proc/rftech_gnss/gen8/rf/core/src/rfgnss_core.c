...
$Header: //components/rel/rftech_gnss.mpss/2.10/gen8/rf/core/src/rfgnss_core.c#1 $
...
/*!
   @brief
   This function returns signal details to GNSS for WGR
 

   @details

   @param : rf_signal_list

   @retval None
*/

void rfgnss_core_get_gnss_rfc_signal_info_signal_list(rfgnss_rfc_signal_list_type *rf_signal_list)
{

  rfc_gnss_get_rfc_signal_info_signal_list(rf_signal_list);
}
/*----------------------------------------------------------------------------*/
/*!
   @brief
   This function returns port details to GNSS 
   ...
   @retval None
*/
boolean rfgnss_core_is_mb_path_supported(void)
{
 	boolean status = TRUE;
	status &= rfc_gnss_is_mb_path_supported();
	return status;
}
/*----------------------------------------------------------------------------*/
/*!
