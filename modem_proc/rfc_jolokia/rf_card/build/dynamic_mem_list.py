...
#rfc_card_id_list.append(["rfc_ftm","../../../rfa/rf/common/ftm"]) # RMANDAL TODO introduce exclude capability
def dynrec_ftm_write_text_entry ():
    card_id='rfc_ftm'
    card_dir='../../../rfa/rf/common/ftm'
    ...
    # ftm_calibration_v3_data.o
    # ftm_common_calibration_v3.o
    # ftm_common_dispatch.o 
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .text)\n") 
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .text.*)\n")
    
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .rodata)\n")
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .rodata.*)\n")
...
def dynrec_ftm_write_data_entry ():
    card_id='rfc_ftm'
    card_dir='../../../rfa/rf/common/ftm'
    ...
    # ftm_common_calibration_v3.o
    # ftm_common_dispatch.o 
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .data)\n")
    f_dynrec.write("*" + dynrec_dir + "/?*:(EXCLUDE_FILE(rf_test_task.o ftm_common_dispatch.o ftm_common_locks.o ftmdiag.o ftm_sequencer.o ftm_sequencer_amssadaptation_generic.o ftm_sequencer_command_queue.o ftm.o ftm_calibration_data_module.o ftm_common_control.o ftm_common_data.o ftm_log.o) .data.*)\n")
...
def dynrec_find_hwid (card_fold_name, rfc_ids):
    ...
    searchObj = re.search(r'rfc_(.*?)/', dynrec_card_dir, re.M|re.I)
    if searchObj:
        ...
        for rfc_id_def in rfc_ids:
            ...
            rfc_card_exist = re.search(r'(rf.*) = \(uint32\)(\d+)', rfc_id_def, re.M|re.I)
            if rfc_card_exist:
