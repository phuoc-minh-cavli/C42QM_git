...
--------   ---     ----------------------------------------------------------
05/22/18   tq      Updating the UIM_COMMON_EFS path to use a common value
...
)
{
  ...
  if(uim_common_efs_get_path_from_enum(path_ptr,
                                       MAX_PATH_LEN,
                                       UIM_COMMON_EFS_GBA_BOOTSTRAP_BSF_ADDRESS) == UIM_COMMON_EFS_SUCCESS)
  { 
  ...
  if(uim_common_efs_get_path_from_enum(path_ptr,
                                        MAX_PATH_LEN,
                                        UIM_COMMON_EFS_GBA_BOOTSTRAP_APN) == UIM_COMMON_EFS_SUCCESS)
  {
    /* get GBA apn NV */
    gba_nv_info.apn_ptr =
  ...
  if(uim_common_efs_get_path_from_enum(path_ptr,
                                        MAX_PATH_LEN,
                                        UIM_COMMON_EFS_GBA_BOOTSTRAP_CUSTOM_REALM) == UIM_COMMON_EFS_SUCCESS)
  {
    /* get GBA custom realm NV */
    (void)efs_get(path_ptr,
  ...
  if(uim_common_efs_get_path_from_enum(path_ptr,
                                       MAX_PATH_LEN,
                                       UIM_COMMON_EFS_GBA_BOOTSTRAP_CUSTOM_USER_AGENT_TMPI) == UIM_COMMON_EFS_SUCCESS)
  {
  ...
  if(uim_common_efs_get_path_from_enum(path_ptr,
                                       MAX_PATH_LEN,
                                       UIM_COMMON_EFS_GBA_BOOTSTRAP_HTTP_HEADER_IMEI) == UIM_COMMON_EFS_SUCCESS)
  {
