...
Copyright (c) 2001 - 2003, 2011 - 2018, 2023 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_nv.h#2 $$ $DateTime: 2023/06/21 11:32:16 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/23/23   tq	   Modem base IMSI switch
10/12/18   bcho    RCINIT Optimization
10/13/17   rps     Remove old  perso suppor
03/01/17   vdc     Send verify PIN command after enabling the PIN for buggy card
11/08/16   dd      Fix linux compilation error
...
#define MMGSDI_NV_ITEM_CACHE_SIZE       0x0F
...
typedef enum {
  ...
  MMGSDI_FEATURE_VERIFY_PIN_AFTER_CHANGE_OR_ENABLE,
