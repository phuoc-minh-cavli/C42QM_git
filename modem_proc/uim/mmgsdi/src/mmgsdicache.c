...
Copyright (c) 2011 - 2016, 2018 - 2019 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdicache.c#1 $ $DateTime: 2020/07/22 10:53:27 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/26/19   bcho    Added caching support for EF-ACL
12/11/18   sg      Optimization of F3 prints
07/09/18   tq      UIM Interface Optimization
01/08/18   ra      Optimized write activity during PSM context save
...
static mmgsdi_cache_element_type mmgsdi_common_cache_slot1[MMGSDI_NUM_FILES_IN_COMMON_CACHE] =
{
  ...
  {MMGSDI_CACHE_NOT_INIT, 0, NULL, FALSE}, /* DIR */
  {MMGSDI_CACHE_NOT_INIT, 0, NULL, FALSE}, /* MLPL */
  {MMGSDI_CACHE_NOT_INIT, 0, NULL, FALSE}, /* MSPL */
  {MMGSDI_CACHE_NOT_INIT, 0, NULL, FALSE}  /* MMSSMODE */
};
...
static mmgsdi_file_enum_type mmgsdi_usim_cache_uim_enums[MMGSDI_NUM_FILES_IN_USIM_CACHE] =
{
  ...
  MMGSDI_USIM_7F66_PROP1_SPT_TABLE, MMGSDI_USIM_7F66_PROP1_ACT_HPLMN, MMGSDI_USIM_MSISDN, MMGSDI_USIM_ACL
};
...
static mmgsdi_file_enum_type mmgsdi_ruim_cache_uim_enums[MMGSDI_NUM_FILES_IN_RUIM_CACHE] =
{
  ...
  MMGSDI_CDMA_3GPD_3GPDOPM,       MMGSDI_CDMA_3GPD_SIPPAPSS
};
...
)
{
  ...
  if (mmgsdi_status == MMGSDI_SUCCESS)
  {
    /* Notify the change so that it will handled */
    mmgsdi_psm_handle_change_notification_of_ef(session_type, mmgsdi_file); 
  }
  return mmgsdi_status;
...
)
{
      ...
      access_ptr->access_method == MMGSDI_EF_ENUM_ACCESS)
  {
    ...
    if (mmgsdi_util_get_session_type(session_id,
                                     ...
                                     NULL) == MMGSDI_SUCCESS)
    {
      /* Notify the change so that it will be handled */
      mmgsdi_psm_handle_change_notification_of_ef(session_type, access_ptr->file.file_enum);
    }
  }
  return mmgsdi_status;
