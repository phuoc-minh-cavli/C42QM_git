...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_uim_uicc.c#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
)
{
  ...
  uim_cmd_ptr->write_bin.data      = req_ptr->data.data_ptr;

  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_WRITE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  uim_cmd_ptr->write_rec.data      = req_ptr->data.data_ptr;
...
)
{
  ...
  {
    /*---------------------------------------------------------------------------
    Release uim cmd pointer  (Since client table has not been populated yet)
    ---------------------------------------------------------------------------*/
    MMGSDIUTIL_TMC_MEM_FREE(uim_cmd_ptr);
    return mmgsdi_status;
  }
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_INCREASE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  ...
  uim_cmd_ptr->inc.data      = req_ptr->data.data_ptr;
  ...
  mmgsdi_send_apdu_req_type* req_ptr)
{
  ...
  if(mmgsdi_util_get_channel_id_from_cla(req_ptr->data.data_ptr[0],
                                         req_ptr->request_header.slot_id,
                                         &channel_id) == MMGSDI_SUCCESS)
  {
    uim_cmd_ptr->hdr.channel = channel_id;
  }

  mmgsdi_status =  mmgsdi_util_fill_and_alloc_request_table(req_ptr->request_header.request_type,
                                                            (void*)req_ptr,
                                                            NULL,
                                                            &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  /* Populate client request table entry */
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(
                                       req_ptr->request_header.request_type,
                                       (void*)req_ptr,
                                       NULL,
...
)
{
 ...
 ----------------------------------------------------*/
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SEARCH_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(req_type,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
