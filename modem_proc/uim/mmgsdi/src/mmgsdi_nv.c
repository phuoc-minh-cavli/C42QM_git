...
Copyright (c) 2001 - 2005, 2009 - 2018, 2023 QUALCOMM Technologies, Inc (QTI) and
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_nv.c#2 $$ $DateTime: 2023/06/21 11:32:16 $
...
12/06/16   bcho    Move F3 under conditional logic
...
05/13/16   lm      Remove excessive logging
...
static mmgsdi_features_list_type features_list_init_table[] =
{
  ...
  { MMGSDI_FEATURE_DEPRECATED_3,                                    2, MMGSDI_FEATURE_DISABLED, FALSE },
  ...
  { MMGSDI_FEATURE_DEPRECATED_4,                                    8, MMGSDI_FEATURE_DISABLED, FALSE },
  ...
  { MMGSDI_FEATURE_DEPRECATED_5,                                   12, MMGSDI_FEATURE_DISABLED, FALSE },
  ...
  { MMGSDI_FEATURE_DEPRECATED_6,                                   15, MMGSDI_FEATURE_DISABLED, FALSE },
  ...
  { MMGSDI_FEATURE_VERIFY_PIN_AFTER_CHANGE_OR_ENABLE,              21, MMGSDI_FEATURE_DISABLED, FALSE },
...
}external_features_status_list[MMGSDI_MAX_NUM_SLOTS];
...
{
  uint8 nv_context = 0;
  static const char      *efs_directory_list[] = {UIM_COMMON_EFS_PATH_MODEM_UIM_MMGSDI_SECURE};
  ...
  for(nv_context = 0; nv_context < MMGSDI_NV_CONTEXTS_MAX; nv_context++)
  {
    ...
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0x7].item_enum = NV_ENS_ENABLED_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0x8].item_enum = NV_HOMEZONE_ENABLED_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0x9].item_enum = NV_FTM_MODE_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0xA].item_enum = NV_ESN_ME_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0xB].item_enum = NV_SCM_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0xC].item_enum = NV_MOB_CAI_REV_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0xD].item_enum = NV_SERVICE_DOMAIN_PREF_I;
    mmgsdi_nv_item_cache_table_ptr[nv_context]->item[0xE].item_enum = NV_DISABLE_CM_CALL_TYPE_I;
  }
...
/*===========================================================================
FUNCTION MMGSDI_NV_INIT_IMSI_SWITCH

DESCRIPTION
  Function use to initialize imsi switch values
...
===========================================================================*/
void mmgsdi_nv_init_imsi_switch(void)
{
  if (uim_common_efs_read(UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_SUPPORT,
                          UIM_COMMON_EFS_ITEM_FILE_TYPE,
                          UIM_COMMON_EFS_DEVICE,
                          &mmgsdi_switch_imsi_enable,
                          sizeof(mmgsdi_switch_imsi_enable)) !=
      UIM_COMMON_EFS_SUCCESS)
  {
    UIM_MSG_HIGH_0("Fail to read  UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_SUPPORT");
    mmgsdi_switch_imsi_enable = 0;
  }  

  if (uim_common_efs_read(UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_PING_PONG_TIMER,
                          UIM_COMMON_EFS_ITEM_FILE_TYPE,
                          UIM_COMMON_EFS_DEVICE,
                          (uint8*)&mmgsdi_imsi_switch_ping_pong_tick,
                          sizeof(mmgsdi_imsi_switch_ping_pong_tick)) !=
      UIM_COMMON_EFS_SUCCESS)
  {
    UIM_MSG_HIGH_0("Fail to read  UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_PING_PONG_TIMER");
    mmgsdi_imsi_switch_ping_pong_tick = MMGSDI_IMSI_SWITCH_PING_PONG_TIMER_VAL;
  }
  else
  {
    mmgsdi_imsi_switch_ping_pong_tick = mmgsdi_imsi_switch_ping_pong_tick * 1000;  
  }
  if (uim_common_efs_read(UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_TIMER,
                          UIM_COMMON_EFS_ITEM_FILE_TYPE,
                          UIM_COMMON_EFS_DEVICE,
                          (uint8*)&mmgsdi_imsi_switch_timer_tick,
                          sizeof(mmgsdi_imsi_switch_timer_tick)) !=
      UIM_COMMON_EFS_SUCCESS)
  {
    UIM_MSG_HIGH_0("Fail to read  UIM_COMMON_EFS_MMGSDI_IMSI_SWITCH_TIMER");
    mmgsdi_imsi_switch_timer_tick = MMGSDI_IMSI_SWITCH_TIMER_VAL;
  }
  else
  {
    mmgsdi_imsi_switch_timer_tick = mmgsdi_imsi_switch_timer_tick * 1000;  
  }
} /* mmgsdi_nv_init_imsi_switch */
...
)
{
  ...
  if (index >= sizeof(external_features_status_list)/sizeof(external_features_status_list[0]))
  {
    return;
  }
  ...
  external_features_status_list[index].nas_cfg_feature_csg = MMGSDI_FEATURE_DISABLED;
#else
  /* In this case, default value is support enabled */
  external_features_status_list[index].nas_cfg_feature_csg = MMGSDI_FEATURE_ENABLED;
      ...
      UIM_COMMON_EFS_SUCCESS)
  {
    ...
    {
      external_features_status_list[index].nas_cfg_feature_csg =
  ...
  external_features_status_list[index].ims_cfg_feature_ims_support =
    MMGSDI_FEATURE_DISABLED;
  ...
  external_features_status_list[index].rpm_enabled = MMGSDI_FEATURE_DISABLED;
      ...
      UIM_COMMON_EFS_SUCCESS)
  {
    ...
    {
      external_features_status_list[index].rpm_enabled =
        MMGSDI_FEATURE_ENABLED;
    }
  }

  /* Read VOICE_DOMAIN_PREF (NV 66048) from EFS, Default value: DISABLED */
  external_features_status_list[index].volte_using_ims = MMGSDI_FEATURE_DISABLED;
      ...
      UIM_COMMON_EFS_SUCCESS)
  {
    ...
    {
      external_features_status_list[index].volte_using_ims =
        MMGSDI_FEATURE_ENABLED;
    }
  }

  /* Read CDMALess info (NV 73732) from EFS, Default value: DISABLED */
  external_features_status_list[index].cdma_less_device = MMGSDI_FEATURE_DISABLED;
      ...
      UIM_COMMON_EFS_SUCCESS)
  {
    if(cdma_less_device)
    {
      external_features_status_list[index].cdma_less_device =
        MMGSDI_FEATURE_ENABLED;
    }
  }
...
{
  /* Start off with the global struct initialised to 0 */
  memset(&external_features_status_list[index], 0x00,
         sizeof(external_features_status_list[index]));
...
SIDE EFFECTS
  None
===========================================================================*/
static void mmgsdi_nv_init_ens_slot_enabled(
  uint8     slot_index)
{
  ...
  mmgsdi_slot_id_enum_type     slot)
{
  ...
  mmgsdi_nv_init_ens_slot_enabled(slot_index);
  ...
  mmgsdi_nv_context_type           index)
{
  ...
  switch(nv_feature)
  {
    case MMGSDI_EXT_FEAT_NAS_CFG_FEATURE_CSG:
      ret_value = external_features_status_list[index].nas_cfg_feature_csg;
      break;

    case MMGSDI_EXT_FEAT_IMS_CFG_FEATURE_IMS_SUPPORT:
      ret_value = external_features_status_list[index].ims_cfg_feature_ims_support;
      break;

    case MMGSDI_EXT_FEAT_RPM_ENABLED:
      ret_value = external_features_status_list[index].rpm_enabled;
      break;

    case MMGSDI_EXT_FEAT_VOLTE_USING_IMS:
      ret_value = external_features_status_list[index].volte_using_ims;
      break;

    case MMGSDI_EXT_FEAT_CDMA_LESS_DEVICE:
      ret_value = external_features_status_list[index].cdma_less_device;
      break;
...
)
{
  ...
  if (uim_common_efs_read(UIM_COMMON_EFS_MMGSDI_ENS_SUB_FEATURES_STATUS_LIST,
                          UIM_COMMON_EFS_ITEM_FILE_TYPE,
                          UIM_COMMON_EFS_DEVICE,
                          (uint8 *) &ens_sub_features_status_list,
                          sizeof(ens_sub_features_status_list)) != UIM_COMMON_EFS_SUCCESS)
  {
