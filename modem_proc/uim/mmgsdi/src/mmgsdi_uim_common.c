...
Copyright (c) 2014 - 2017, 2019 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_uim_common.c#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
02/04/16   vdc     Check retry type before sending UNBLCOK PIN command to UIM
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_COMPUTE_IP_AUTH_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_RUN_CAVE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_CDMA_AKA_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_GENERATE_KEY_VPM_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_BLOCK_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_OTAPA_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_COMMIT_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_SSPR_CONFIG_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_KEY_GEN_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_OTASP_MS_KEY_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_BS_CHAL_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_SSD_CONFIRM_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_SSD_UPDATE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  uim_cmd_ptr->store_meid.len_and_usage =
      req_ptr->esn_length | req_ptr->esn_usage;

  if (req_ptr->meid_available)
  {
    uim_cmd_ptr->hdr.command = UIM_STORE_ESN_MEID_ME_F;
    qw_equ(uim_cmd_ptr->store_meid.meid, req_ptr->meid);
    uim_cmd_ptr->store_meid.meid_available = TRUE;
  }
  else
  {
    uim_cmd_ptr->hdr.command = UIM_STORE_ESN_ME_F;
    uim_cmd_ptr->store_esn.esn = req_ptr->esn;
  }

  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_STORE_ESN_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
/*============================================================================
   ...
   DESCRIPTION:
     This function packages the ENABLE PIN or DISABLE PIN command and sends it to UIM
     for further processing
...
)
{
  ...
  /*---------------------------------------------------------------------------
    Populate UIM information
    1) command = UIM_DISABLE_CHV_F or UIM_ENABLE_CHV_F
    2) protocol = UIM_WCDMA/UIM_GSM  [ GSM and CDMA share the same protocol ]
    3) slot
    4) pin data len and data
    5) user data: the req_ptr
