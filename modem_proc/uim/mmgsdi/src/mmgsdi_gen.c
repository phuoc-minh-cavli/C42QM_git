...
Copyright (c) 2004 - 2016, 2018 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_gen.c#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
06/22/16   tkl     Added additional stub APIs
  ...
  const mmgsdi_card_pdown_req_type *req_ptr)
{
  ...
  else
  {
   ...
   mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_CARD_PDOWN_REQ,
                                                            (void*)req_ptr,
                                                            NULL,
                                                            &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
  ...
  const mmgsdi_card_reset_req_type  *req_ptr)
{
   ...
   */
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_CARD_RESET_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
  ...
  mmgsdi_client_data_type            client_ref)
{
  ...
  /*---------------------------------------------------------------------------
    ...
    5. response_cb     - Response Callback Pointer
  ---------------------------------------------------------------------------*/
...
)
{
  ...
  /* --------------------------------------------------------------------------
     ...
     ------------------------------------------------------------------------*/
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SAP_GET_ATR_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_GET_INFO_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_READ_PRL_REQ,
                                                           (void*)req_ptr,
                                                            NULL,
                                                            &index);
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_GET_ALL_AVAILABLE_APPS_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_GET_APP_CAPABILITIES_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
