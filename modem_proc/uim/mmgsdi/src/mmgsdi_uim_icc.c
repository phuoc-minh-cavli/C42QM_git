...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_uim_icc.c#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_GET_FILE_ATTR_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_REHABILITATE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_INVALIDATE_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
...
)
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_SESSION_RUN_GSM_ALGO_REQ,
                                                           (void*)req_ptr,
                                                           NULL,
                                                           &index);
  if (mmgsdi_status != MMGSDI_SUCCESS)
