...
Copyright (c) 2004 - 2017, 2019 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_uicc.c#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
03/05/19   vm      Remove lib functions from internal calls
  ...
  )
{
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(MMGSDI_READ_REQ,
                                                             (void*)req_ptr,
                                                             NULL,
                                                             &index);
  if(mmgsdi_status != MMGSDI_SUCCESS)
...
)
{
  ...
  {
    service = ((mmgsdi_session_enable_service_req_type*)req_ptr)->service;
  }
  else if(cmd_type == MMGSDI_SESSION_DISABLE_SERVICE_REQ)
  {
    service = ((mmgsdi_session_disable_service_req_type*)req_ptr)->service;
  }

  mmgsdi_status = mmgsdi_util_get_session_type(((mmgsdi_request_header_type*)req_ptr)->session_id,
                                               &session_type, NULL);
  if((mmgsdi_status != MMGSDI_SUCCESS) ||
  ...
  mmgsdi_status =  mmgsdi_util_get_prov_session_info(((mmgsdi_request_header_type*)req_ptr)->session_id,
                                                     NULL,
                                                     NULL,
                                                     &app_info_ptr);
  ...
  mmgsdi_status = mmgsdi_uicc_chk_srv_available(((mmgsdi_request_header_type*)req_ptr)->client_id,
                                                ((mmgsdi_request_header_type*)req_ptr)->session_id,
  ...
  mmgsdi_status = mmgsdi_util_fill_and_alloc_request_table(((mmgsdi_request_header_type*)req_ptr)->request_type,
                                                           (void*)req_ptr,
                                                           &extra_param_ptr,
                                                           &index);
  ...
  if(extra_param_ptr->enable_service_data.is_status_same)
  {
    mmgsdi_status = mmgsdi_util_queue_mmgsdi_uim_report_rsp(
                      index,
                      ((mmgsdi_request_header_type*)req_ptr)->request_type,
                      MMGSDI_SUCCESS);
  ...
  mmgsdi_memscpy(&write_req.request_header,
                 ...
                 ((mmgsdi_request_header_type*)req_ptr),
