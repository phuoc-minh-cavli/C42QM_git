...
Copyright (c) 2004 - 2014, 2016 - 2017 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_icc_rsp.h#1 $$ $DateTime: 2020/07/22 10:53:27 $

when       who     what, where, why
--------   ---     -----------------------------------------------------------
03/15/17   nr      Add support to cache PIN1 of the SIM card when PSM mode enabled
03/09/16   bcho    Remove functions without definition
