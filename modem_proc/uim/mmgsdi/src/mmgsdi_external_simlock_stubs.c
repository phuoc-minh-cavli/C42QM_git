/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                 ...
                 M M G S D I  E X T E R N A L  S I M L O C K  S T U B S  F U N C T I O N S
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_external_simlock_stubs.c#1 $
