...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_refresh_rsp.c#1 $$ $DateTime: 2020/07/22 10:53:27 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/13/16   sn       Update Refresh TR for additional files read only if success
