...
Copyright (c) 2004 - 2015, 2018 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/mmgsdi/src/mmgsdi_session.h#1 $$ $DateTime: 2020/07/22 10:53:27 $
...
/* ----------------------------------------------------------------------------
   ...
   PARAMETERS:
     ...
     @param[out] num_sessions_open         number of session opened.
