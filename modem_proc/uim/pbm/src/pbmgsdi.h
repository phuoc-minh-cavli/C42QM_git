...
$Header: //components/rel/uim.mpss/3.3.1/pbm/src/pbmgsdi.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/22/16   sn      Fix compilation error 
...
/*===========================================================================
                         DEFINITIONS
===========================================================================*/
extern q_type pbm_client_cmd_q;	   /* Queue to manage client commands */
	
extern q_type pbm_gsdi_resp_q; 	   /* Queue to manage GSDI responses */
...
void pbm_mmgsdi_ok_to_refresh_cb(mmgsdi_return_enum_type status,
                                        mmgsdi_cnf_enum_type    cnf,
                                        const mmgsdi_cnf_type  *cnf_ptr);

boolean pbm_mmgsdi_process_sim_data(pbm_session_enum_type session_id,
                                           pbm_file_type file_id,
                                           int index,
