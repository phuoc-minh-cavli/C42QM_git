...
$Header: //components/rel/uim.mpss/3.3.1/pbm/src/pbmutils.h#1 $
...
extern pbm_device_type pbm_pb_bits_to_pb_id[32];
...
SIDE EFFECTS
===========================================================================*/
uint32 pbm_calculate_size_from_fields( const pbm_field_s_type *fields, uint32 num_fields);
...
boolean pbm_util_get_ss_ton_status_of_queried_number(
  ...
  boolean *contains_international_ton,
  int     *data_size,
  byte    *local_number
);
