...
Copyright (c) 2010, 2014, 2016 QUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
...
/*===========================================================================
    ...
    $Header: //components/rel/uim.mpss/3.3.1/pbm/src/qmi_pbm_if.h#1 $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
05/20/16    sp     F3 improvements
05/09/16    sp     Remove the deprecated cm_mm_ss_info_s_type usage
