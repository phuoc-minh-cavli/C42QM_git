  ...
  $Header: //components/rel/uim.mpss/3.3.1/cust/inc/custuim.h#1 $
  ...
  06/21/16   ar      Define FEATURE_MMGSDI_GSM
  04/15/16   na      Removal of some features for IoE flavor
  03/09/16   vdc     Removed JCDMA related code
  03/09/16   vdc     Add compilation dependency for FEATURE_SIMLOCK
  03/08/16   sam     Disable FEATURE_UIM_T_1_SUPPORT if FEATURE_CUST_1 is enabled
  03/07/16   ll      Removing compile time disable polling feature flag   
