...
$Header: //components/rel/uim.mpss/3.3.1/nvruim/src/nvruim.c#1 $ $DateTime: 2020/07/22 10:53:27 $ $Author: pwbldsvc $
...
===========================================================================*/
static void nvruim_mem_free_null_ok
(
  void * ptr
)
{
  if (ptr == NULL)
  {
    UIM_MSG_MED_0("Attempt to free null ptr, return");
    return;
  }
