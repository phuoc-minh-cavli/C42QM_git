...
Copyright (c) 2001,2006,2012-2013,2016 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uimgsm.h#1 $
...
03/07/16   ssr     Adding uimgsm stubs for IOE variant
