...
Copyright (c) 2001,2002,2008-2014, 2019 - 2020 by QUALCOMM Technologies, Inc. All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uimgen.h#2 $
$DateTime: 2020/08/12 08:04:16 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/28/20   rkg     add suspend resume feature  
...
/* Macros for clock stop related bits in TA3 or TA4 byte of ATR */
#define UIM_TA3_TA4_CLOCK_STOP_NOT_SUPPORTED 0x00
#define UIM_TA3_TA4_CLOCK_STOP_LOW           0x01
#define UIM_TA3_TA4_CLOCK_STOP_HIGH          0x02
#define UIM_TA3_TA4_CLOCK_STOP_NO_PREF       0x03
#define UIM_TA3_TA4_CLOCK_STOP_FIELD_SHFT    0x06
...
#define UIM_UMPC_EF_ID           0x2F08

#define UIM_ICCID_OFFSET         0
#define UIM_ICCID_SIZE           10

/**/
#define UIM_UMPC_SFI            0x08
#define UIM_UMPC_OFFSET         0
#define UIM_UMPC_SIZE           0x05

/*current targets support max power of upto 50mA.
if this changes for future targets then it will be converted to a table*/
#define TERMINAL_MAX_POWER_CAPABILITY  0x32
/* Max power consumption capability in class B 50mA
and in class C 60mA */
#define TERMINAL_MAX_POWER_CAPABILITY_CLASS_B  0x32
#define TERMINAL_MAX_POWER_CAPABILITY_CLASS_C  0x3C
...
typedef enum {
  ...
  UIM_READ_UMPC_ST,                         /*Read EF-UMPC during powerup*/
  UIM_SUSPEND_ST,                           /* uim suspend state */
  UIM_RESUME_TERMINAL_CAPABILTY_ST,         /* Sending Terminal capability before resume */
  UIM_RESUME_ST,                            /* resume UIM */
