...
Copyright (c) 2001-2009, 2011 - 2016 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uimcdma.c#1 $
...
05/19/16   na      Optimization for LTE only device
03/07/16   ssr     Adding uimcdma stubs for IOE variant
...
{
  /*CDMA functionality is present. so return TRUE*/
  return TRUE;
