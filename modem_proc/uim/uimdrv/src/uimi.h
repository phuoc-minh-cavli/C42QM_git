...
Copyright (c) 2000-2016, 2020 by QUALCOMM Technologies, Inc. All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uimi.h#2 $
...
02/20/19   ku      Delay local card power up in Modem SSR in BTSAP mode
...
#define MSGR_MODULE_UIM_DRIVER            0x02
#define MSGR_UIM_DRIVER                   MSGR_TECH_MODULE( MSGR_TECH_UIM, MSGR_MODULE_UIM_DRIVER )

/* Adding 500 msec for the sw latency */
#define UIM_POLLING_ALIGNMENT_SW_LATENCY  500

typedef union
{
  msgr_hdr_s                             msg_hdr; /*!< Message router header */
  lte_rrc_edrx_cfg_status_ind_s          rrc_edrx_config_ind ;
  lte_cphy_edrx_uim_page_ind_s           ml1_page_info;
} uim_edrx_msgr_cmd_type ;
...
typedef struct
{
  ...
  uim_edrx_msgr_cmd_type  edrx_msgr_cmd ;
} uim_edrx_msg_type;
...
#define UIM_USIM_EFAD_EDRX_SUPPORT_OFFSET   0x2
#define UIM_DO_NOT_START_POLL_WAKE_UP_TIMER 0xFFFFFFFF
