/*==============================================================================
  ...
  DEPENDENCIES: N/A
                ...
                Copyright (c) 2014 - 2016, 2018-19 QUALCOMM Technologies, Inc.
                All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uim_hotswap.c#1 $
$DateTime: 2020/07/22 10:53:27 $
$Author: pwbldsvc $

when        who        what, where, why
------      ----       ---------------------------------------------------------
01/30/19    ng         Clear BTSAP cmd response timer upon remote card removal
