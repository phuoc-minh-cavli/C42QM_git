/*============================================================================
  ...
  DEPENDENCIES: N/A
                ...
                Copyright (c) 2014 - 2016, 2018, 2020 QUALCOMM Technologies, Inc(QTI).
                All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uim_rxstates.c#2 $
...
)
{
  ...
  switch (sw2)
  {
    ...
    case SW2_APPLN_SPECIFIC_AUTH_ERR:
      ...
      break;
        case SW2_APPLN_SPECIFIC_SECURITY_SESSION_EXPIRED:
      {
        uim_ptr->card_cmd.resp_buf_ptr->cmd_status = UIM_APPLN_SPECIFIC_SECURITY_SESSION_EXPIRED;
      }
      break;

    case SW2_APPLN_SPECIFIC_MIN_SUSP_TIME_TOO_LONG:
      {
        uim_ptr->card_cmd.resp_buf_ptr->cmd_status = UIM_APPLN_SPECIFIC_MIN_SUSP_TIME_TOO_LONG;
      }
      break;
    default:
      {
...
)
{
  ...
  if( uim_ptr->card_cmd.resp_buf_ptr->sw2 == SW2_SW1_PROBLEM  &&
      uim_ptr->setting.pdown_on_tech_prob_read == FALSE )
  {
    ...
    {
      UIMDRV_MSG_LOW_0(uim_ptr->id,"Power down configuration on technical problems read from EFS");
      uim_ptr->setting.pdown_on_tech_prob_read = TRUE;
    }
    else
    {
      UIMDRV_MSG_HIGH_0(uim_ptr->id,"Failed to read EFS power down configuration");
