...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uim_nvcfg.h#1 $
...
#define UIM_FEATURES_STATUS_LIST_CURRENT_COUNT                  31
...
typedef enum {
  ...
  UIMDRV_FEATURE_ALIGN_PROACTIVE_POLLING_WITH_EDRX,
  UIMDRV_FEATURE_PROACTIVE_POLLING_NEGOTIATION_WITH_CARD
...
typedef struct {
  ...
  boolean  align_proactive_polling_with_edrx;  
  /* Negotiate proactive polling as per the eDRX value */
  boolean  proactive_polling_negotiation_with_card;
  /* version 9: RESERVED_FOR_FUTURE_USE size is 127 - 29 = 98 */
