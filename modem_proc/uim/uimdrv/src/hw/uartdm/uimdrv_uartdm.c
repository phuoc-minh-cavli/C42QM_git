...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/hw/uartdm/uimdrv_uartdm.c#1 $
...
01/20/16    ssr        Corrected condition logic
  ...
  /* BAGHEERA_8916 */ { DALCHIPINFO_FAMILY_MSM8916,
    ...
    /* TABASCO/SAHI*/ {/* DALCHIPINFO_FAMILY_MSM8952 */ 60,
     ...
     /* Twizy_9x05 */ { DALCHIPINFO_FAMILY_MDM9205,
                       { BADGER_MSS_UIM0_UART_DM, INVALID_BADGER_MSS_UART_DM, INVALID_BADGER_MSS_UART_DM, INVALID_BADGER_MSS_UART_DM  }
                      },  /* Twizy_9x05 */
