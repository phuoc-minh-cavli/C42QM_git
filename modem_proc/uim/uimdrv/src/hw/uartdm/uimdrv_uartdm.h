...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/hw/uartdm/uimdrv_uartdm.h#1 $
$DateTime: 2020/07/22 10:53:27 $
$Author: pwbldsvc $

when        who        what, where, why
------      ----       -----------------------------------------------------------
06/07/16    sam        Reduce UART_DM_LOGGING buffer size
...
#define UART_REG_LOG_MAX_ENTRY               50
