...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/hw/pmic/uimdrv_pmic.h#1 $
$DateTime: 2020/07/22 10:53:27 $
$Author: pwbldsvc $

  when      who        what, where, why
------      ----       -----------------------------------------------------------
11/08/16    dd         Fix Linux compiler error
...
*/
boolean uim_evaluate_req_ldo_voltage_mod
(
  uim_instance_enum_type uim_instance,
  npa_resource_state     req
);
