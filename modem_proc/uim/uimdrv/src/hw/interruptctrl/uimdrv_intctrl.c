/*============================================================================
  ...
  DEPENDENCIES: N/A
                ...
                Copyright (c) 2012-16, 2018 QUALCOMM Technologies, Inc(QTI).
                All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/hw/interruptctrl/uimdrv_intctrl.c#1 $
...
const uim_controller_irq_num_table_type   uim_controller_irq_num_table[] = {
  ...
  /* BAGHEERA_8916 */ { DALCHIPINFO_FAMILY_MSM8916,
   ...
   /* TABASCO_SAHI */ { /* DALCHIPINFO_FAMILY_MSM8952 */ 60,
     ...
     /* Twizy_9x05 */ { DALCHIPINFO_FAMILY_MDM9205,
                       { 89, INVALID_IRQ_NUM, INVALID_IRQ_NUM, INVALID_IRQ_NUM  }
                      },  /* Twizy_9x05 */
...
const uim_uartdm_irq_num_table_type         uim_uartdm_irq_num_table[]  = {
  ...
  /* BAGHEERA_8916 */ { DALCHIPINFO_FAMILY_MSM8916,
   ...
   /* TABASCO_SAHI */ { /* DALCHIPINFO_FAMILY_MSM8952 */ 60,
     ...
     /* Twizy_9x05 */ { DALCHIPINFO_FAMILY_MDM9205,
                       { 87, INVALID_IRQ_NUM, INVALID_IRQ_NUM, INVALID_IRQ_NUM }
                      },  /* Twizy_9x05 */
...
void initialize_intctrl(uim_instance_global_type *uim_ptr)
{
  ...
  uim_instance_enum_type uim_instance                   = UIM_INSTANCE_INVALID;
