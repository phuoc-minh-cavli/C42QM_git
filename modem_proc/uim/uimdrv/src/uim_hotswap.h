...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uim_hotswap.h#1 $
...
*/
boolean uim_handle_card_removed_suspicious_sig
(
...
*          going back to the top of the main loop is desired.
*/
boolean uim_handle_card_removed_sig
(
  rex_sigs_type *sig_mask_ptr, 
  rex_sigs_type *imask_ptr, 
  uim_instance_global_type *uim_ptr
...
*          going back to the top of the main loop is desired.
*/
boolean uim_handle_card_inserted_sig
(
  rex_sigs_type *sig_mask_ptr, 
  rex_sigs_type *imask_ptr, 
  uim_instance_global_type *uim_ptr
