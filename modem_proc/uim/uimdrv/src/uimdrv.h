...
DESCRIPTION
   ...
   Copyright (c) 2001 - 2016, 2020 by QUALCOMM Technologies, Inc. All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/src/uimdrv.h#2 $
...
/* Application errors */
  ...
  UIM_APPLN_SPECIFIC_SECURITY_SESSION_EXPIRED,/* Security session or association expired */
  UIM_APPLN_SPECIFIC_MIN_SUSP_TIME_TOO_LONG,/* Minimum UICC Suspension time too long     */
...
===========================================================================*/
void uim_inactivity_timer_expiry_cb
(
  timer_cb_data_type param
);
...
===========================================================================*/
void uim_resume_timer_expiry_cb
(
  timer_cb_data_type param
);
