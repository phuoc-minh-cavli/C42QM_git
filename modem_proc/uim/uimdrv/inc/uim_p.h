...
Copyright (c) 2008 - 2016, 2019 - 2020 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/uimdrv/inc/uim_p.h#2 $
...
------------------------------------------------------------------------------*/
  ...
  #define UIM_RRC_ML1_MSG_Q_SIG            0x80000000 /* Signal to indicate RRC and ML1 indication for eDRX */
/*----------------------------------------------------------------------------*/
...
/*UIM will send suspend command if card is inactive for UIM_MAX_CARD_INACTIVITY_TIME*/
#define UIM_MAX_CARD_INACTIVITY_TIME    5000
/*default maximum suspend time sent to card as 1 day*/
#define UIM_DEFAULT_MAX_SUSPEND_TIME    0x01
/*default minimum suspend time sent to card as 5min*/
#define UIM_DEFAULT_MIN_SUSPEND_TIME    0x05
#define MILLISECONDS_PER_SECOND         1000
#define MILLISECONDS_PER_MINUTE         60000
#define MILLISECONDS_PER_HOUR           3600000
#define MILLISECONDS_PER_DAY            86400000
#define MILLISECONDS_PER_10DAYS         864000000
...
#define SUSPEND_UICC                    ((uim_instrns_enum_type) 0x76)
...
DESCRIPTION
  This API is used to find out the terminal capability that is to be sent to
  the card. The tlvs data ptr must be malloc'd by the caller and the length
  of malloc'd data block is passed in the data len ptr, that also acts as a
  out param, which contains the number of bytes copied to the tlvs data ptr.
