...
Copyright (c) 2012 - 2014, 2018 byQUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/obdapp/src/obdapp.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
20/29/18   tq      Deprecated MMGSDI_TERMINAL_PROFILE_DL_EVT and MMGSDI_CARD_REMOVED_EVT 
