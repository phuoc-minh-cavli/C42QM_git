...
$Header: //components/rel/uim.mpss/3.3.1/api/pbmlib.h#1 $
...
===========================================================================*/
/**
  Searches the session ECC phone book for the number just passed in to determine
  if it is an emergency number. If it is an emergency number, the category is
  returned in ecc_category_ptr. If the number has no category, it is set to 0.

@vertspace
@param[in]  sess_type          Session type that was passed in.
@param[in]  num                Pointer to the number that was passed in.
@param[in]  len                Length of the number that was passed in.
@param[out] ecc_category_ptr   Pointer to the ECC category.

@return
  TRUE -- The number is an emergency number.\n
  FALSE -- The number is not an emergency number.
