...
=============================================================================*/
/*=============================================================================
   Copyright (c) 2003 - 2020, 2023 QUALCOMM Technologies, Inc(QTI).
   All rights reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/api/gstk_exp.h#4 $

when       who     what, where, why
--------   ---     --------------------------------------------------------------------
06/08/23   ac      Fixed geo loc terminal response result code 
01/30/23   ac      Added Satellite E-UTRAN RAT 
...
06/28/16   gs      Clean-up of unused function
...
#define GSTK_MAX_MSISDN_LEN                      0xFF
...
#define GSTK_CMD_STK_RUN_AT_COMMAND         0x34
  /**< Currently not supported. */
#define GSTK_CMD_STK_GEO_LOC_REQ            0x16
/**< Currently not supported. */
...
#define GSTK_USAT_EUTRAN_CLASS_E_SUPPORT_BYTE_17_BIT_7  0x1140
  /**< Class E support for EUTRAN/Satellite E-UTRAN */ /* value = {1,0} */
...
#define GSTK_CDMA_SMS_BROADCASE_SUPPORT               0x1404
  /**< CDMA SMS Broadcase download support. */
...
/** @name 30th Byte - Upper Layer Information
  @{ */
#define GSTK_STEERING_ROAMING_SUPPORT                 0x1E08
...
/** @name 33rd Byte - Upper Layer Information
  @{ */
#define GSTK_DNS_SERVER_ADRS_SUPPORT                  0x2101
  /**< DNS command support. */
#define GSTK_CLOSE_CHANNEL_REUSE_SUPPORT              0x2102
  /**< CLOSE CHANNEL REUSE command support. */
#define GSTK_POLL_INTERVAL_EVT_SUPPORT                0x2104
  /**< Poll Interval Event Download Envelope support. */
/** @} */ /* end_name 33rd Byte - Upper Layer Information */
...
/** @name Sixth  Byte - Predefined API Support Values
  @{ */
#define GSTK_NETWORK_SEARCH_MODE_CHANGE               0x0680
  /**< Power on card support. Supported values: 1 and 0 (Default). */ /* value = (1,0) */  /* default = 0 */
/** @} */ /* end_name Sixth Byte - Predefined API Support Values */
...
#define GSTK_GPRS_CALL_CONTROL                        0x1220
  /**< GPRS Call control. */
...
#define GSTK_PROVIDE_LOCAL_INFO_UTRAN_EUTRAN          0x1740
  /**< Provide local information NMR UTRAN, E-UTRAN/Satellite E-UTRAN. */
/** @} */ /* end_name 23rd Byte - Predefined API Support Values */
/** @} */ 

/** @name 25th Byte - Predefined API Support Values
  @{ */
#define GSTK_BROWSER_STATUS_EVT_SUPPORT               0x1901
  /**< Browser Status event support. */
#define GSTK_NW_REJ_GERAN_UTRAN_SUPPORT               0x1910
  /**< NW Rejection for GERAN, UTRAN. */
#define GSTK_HCI_CONNECTIVITY_EVT_SUPPORT             0x1920
  /**< HCI Connectivity event support. */
#define GSTK_NW_REJECTION_EUTRAN_SUPPORT              0x1940
  /**< NW Rejection for E-UTRAN/Satellite E-UTRAN. */
/** @} */ /* end_name 25th Byte - Predefined API Support Values */

/** @name 26th Byte - Predefined API Support Values
  @{ */
#define GSTK_CSG_CELL_SELECTION_SUPPORT               0x1A01
  /**< CSG Cell Selection. */
/** @} */ /* end_name 25th Byte - Predefined API Support Values */
...
#define GSTK_IMS_REGISTRATION_EVENT                0x1F40
  /**<Support of IMS registration Event. Supported values: 1 and 0.  */ /* value = (1,0) */
/** @} */ /* end_name Thirty-first Byte - Terminal Profile Bytes */

/** @name Thirty-second Byte - Terminal Profile Bytes
  @{ */
#define GSTK_REFRESH_ENFORCEMENT_POLICY_SUPPORT 0x2080
  /**<Refresh enforcement policy support. Supported values: 1 and 0.  */ /* value = (1,0) */
/** @} */ /* end_name Thirty-second Byte - Terminal Profile Bytes */
...
typedef enum
{
  ...
  GSTK_ACCESS_TECH_LTE               = 0x08, /**< E-UTRAN/Satellite E-UTRAN RAT is available. */
...
typedef enum {
  ...
  GSTK_UIMDRV_TYPE,       /**< UIM Driver client. */  
...
typedef enum {
  ...
  GSTK_PCO_INFO_ENVELOPE_RSP            = 0x9C, /**< Envelope response: PCO information. */
  GSTK_POLL_INTERVAL_EVT_IND_RSP       = 0x9D, /**< Envelope response: Poll Interval event. */
  ...
  GSTK_POLL_INTERVAL_EVT_IND         = 0x81, /**< Envelope command: Poll Interval Req. */
  GSTK_LOCATION_INFORMATION_IND      = 0xDF, /**< Envelope command: Location information. */
  GSTK_PCO_INFORMATION_IND            = 0xEF, /**< Envelope command: PCO information. */
  /*
  ...
  */
  ...
  GSTK_DS_MSISDN_CHANGE_IND          = 0x307,/**< DS Indication: MSISDN change */
...
typedef enum {
  ...
  GSTK_EUTRAN_EXT_PARAM               = 0x05,   /**< E-UTRAN/Satellite E-UTRAN extended. */
  GSTK_EUTRAN_MAPPED_UTRAN_PS         = 0x06,   /**< E-UTRAN/Satellite E-UTRAN mapped UTRAN packet switch. */
...
/*===========================================================================
--  Struct: gstk_refresh_enforcement_policy_type
===========================================================================*/
/**
  @brief Refresh Enforcement Policy used by Refresh proactive command.
*/
typedef struct {
    uint8                        length;
      /**<Total length of the valid data in refresh_enforcement_policy */
    uint8                       *refresh_enforcement_policy;
      /**< Refresh enforcement policy */
} 
gstk_refresh_enforcement_policy_type;
...
typedef struct {
  ...
  gstk_icon_type                       icon;
    /**< Icon data. */
  gstk_refresh_enforcement_policy_type refresh_enforcement_policy;
    /**< Refresh enforcement policy data. */   
}
...
/*===========================================================================
--  Struct: gstk_poll_interval_evt_ind_type
===========================================================================*/
/**
  @brief Information clients must provide in the Poll Interval event download.
*/
typedef struct {
  uint8                        units;
    /**< Indicates the units:\n
         - 0: GSTK_DURATION_MINUTES
         - 1: GSTK_DURATION_SECONDS
         - 2: GSTK_DURATION_TENTHS_OF_SECONDS */
  uint8                        length;
    /**< Time interval. Supported values: 0 to 255. */
}
gstk_poll_interval_evt_ind_type;
...
typedef struct {
  ...
  union {
    ...
    gstk_poll_interval_evt_ind_type         poll_interval_evt_ind;
      /**< Poll Interval event data*/    
...
/*===========================================================================
--  Struct: gstk_msisdn_info_type
===========================================================================*/
/**
  @brief Structure to hold MSISDN info.
*/
typedef struct {
  uint8 msisdn_length;
  /**< Length of msisdn field. */
  uint8 msisdn[GSTK_MAX_MSISDN_LEN];
  /**< MSISDN. */
}
gstk_msisdn_info_type;
...
/*===========================================================================
--  Struct: gstk_poll_interval_evt_rsp_type
===========================================================================*/
/**
  @brief Card information returned upon receiving the Poll Interval
  Event command.
*/
typedef struct {
  gstk_general_envelope_rsp_enum_type general_resp;
    /**< Indicates whether the envelope command was successful. */
    /* ENVELOPE SUCCESS or FAIL */
  gstk_control_result_enum_type       result;
    /**< Indicates if Poll Interval was accepted/modified/rejected */
  gstk_duration_type                  duration;
    /**< Duration suggested by card:
         - Present when Poll Interval is modified
         - Optional when Poll Interval is rejected
         - Absent when Poll Interval is accepted */
}
gstk_poll_interval_evt_rsp_type;
/** @} */ /* end_addtogroup envRspStructs */
...
typedef struct {
  ...
  union {
      ...
      */
      ...
      gstk_poll_interval_evt_rsp_type         poll_interval_evt_rsp;
        /**< Poll Interval Event response data. */        
