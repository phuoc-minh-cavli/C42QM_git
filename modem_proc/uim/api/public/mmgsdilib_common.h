...
/*=============================================================================
Copyright (c) 2010-2020, 2023 by QUALCOMM Technologies, Inc(QTI).
All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/api/public/mmgsdilib_common.h#2 $$ $DateTime: 2023/06/21 11:32:16 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     -----------------------------------------------------------
05/23/23   tq	   Modem base IMSI switch
06/24/20   cj      Fix compilation issue by defining 5G network mask
...
03/27/17   dt      Removing structure mmgsdi_tp_dl_evt_info_type
...
04/14/16   na      Remove prov_app field from mmgsdi_app_info_type
03/09/16   vdc     Removed JCDMA related code
03/09/16   vdc     Remove bcast related code
03/09/16   bcho    Remove MMGSDI_TEST_SIM_EVT and related code
03/08/16   sp      Remove length information from requests and confirmations
03/07/16   ar      Remove ICC seek support
02/01/16   vdc     Halt initialization if IMSI is not provisioned in card
...
#define MMGSDI_PLMN_NETWK_TYPE_NR5G_MASK              0x00000040
...
#define   MMGSDI_MAX_ADDTIONAL_INFO_LEN               30

/* Max length of PLMN long name. */
#define MMGSDI_EONS_MAX_PLMN_LONG_NAME_LEN            MMGSDI_LONG_NAME_MAX_LEN

/* Max length of PLMN short name. */
#define MMGSDI_EONS_MAX_PLMN_SHORT_NAME_LEN           MMGSDI_SHORT_NAME_MAX_LEN


/* Define the max. ATR length */
#define MMGSDI_MAX_ATR_LEN                            33
...
typedef enum {
  ...
  MMGSDI_PSM_CONTEXT_SAVE_REQ,
  MMGSDI_GET_M2M_EID_REQ,
  MMGSDI_IMSI_SWITCH_REQ,
  MMGSDI_CNF,
...
=============================================================================*/
typedef mmgsdi_cmd_enum_type mmgsdi_cnf_enum_type;

#define MMGSDI_CLIENT_ID_AND_EVT_DEREG_CNF                 MMGSDI_CLIENT_ID_AND_EVT_DEREG_REQ
#define MMGSDI_READ_CNF                                    MMGSDI_READ_REQ
#define MMGSDI_WRITE_CNF                                   MMGSDI_WRITE_REQ
#define MMGSDI_INCREASE_CNF                                MMGSDI_INCREASE_REQ
#define MMGSDI_GET_FILE_ATTR_CNF                           MMGSDI_GET_FILE_ATTR_REQ
#define MMGSDI_SESSION_OPEN_CNF                            MMGSDI_SESSION_OPEN_REQ
#define MMGSDI_SESSION_OPEN_EXT_CNF                        MMGSDI_SESSION_OPEN_EXT_REQ
#define MMGSDI_SESSION_OPEN_WITH_SELECT_RSP_CNF            MMGSDI_SESSION_OPEN_WITH_SELECT_RSP_REQ
#define MMGSDI_SESSION_OPEN_WITH_MF_CNF                    MMGSDI_SESSION_OPEN_WITH_MF_REQ
#define MMGSDI_SESSION_ACTIVATE_OR_SWITCH_PROVISIONING_CNF MMGSDI_SESSION_ACT_OR_SWITCH_PROV_REQ
#define MMGSDI_SESSION_CLOSE_CNF                           MMGSDI_SESSION_CLOSE_REQ
#define MMGSDI_ISIM_AUTH_CNF                               MMGSDI_ISIM_AUTH_REQ
#define MMGSDI_SEND_APDU_CNF                               MMGSDI_SEND_APDU_REQ
#define MMGSDI_SEND_APDU_EXT_CNF                           MMGSDI_SEND_APDU_EXT_REQ
#define MMGSDI_SAP_CONNECT_CNF                             MMGSDI_SAP_CONNECT_REQ
#define MMGSDI_SAP_DISCONNECT_CNF                          MMGSDI_SAP_DISCONNECT_REQ
#define MMGSDI_SAP_GET_ATR_CNF                             MMGSDI_SAP_GET_ATR_REQ
#define MMGSDI_SAP_SEND_APDU_CNF                           MMGSDI_SAP_SEND_APDU_REQ
#define MMGSDI_SAP_POWER_ON_CNF                            MMGSDI_SAP_POWER_ON_REQ
#define MMGSDI_SAP_POWER_OFF_CNF                           MMGSDI_SAP_POWER_OFF_REQ
#define MMGSDI_CARD_PUP_CNF                                MMGSDI_CARD_PUP_REQ
#define MMGSDI_CARD_PDOWN_CNF                              MMGSDI_CARD_PDOWN_REQ
#define MMGSDI_CARD_STATUS_CNF                             MMGSDI_CARD_STATUS_REQ
#define MMGSDI_CARD_RESET_CNF                              MMGSDI_CARD_RESET_REQ
#define MMGSDI_REFRESH_CNF                                 MMGSDI_REFRESH_REQ
#define MMGSDI_SAP_RESET_CNF                               MMGSDI_SAP_RESET_REQ
#define MMGSDI_ACTIVATE_ONCHIP_SIM_CNF                     MMGSDI_ACTIVATE_ONCHIP_SIM_REQ
#define MMGSDI_REHABILITATE_CNF                            MMGSDI_REHABILITATE_REQ
#define MMGSDI_INVALIDATE_CNF                              MMGSDI_INVALIDATE_REQ
#define MMGSDI_PIN_OPERATION_CNF                           MMGSDI_PIN_OPERATION_REQ
#define MMGSDI_GET_ALL_PIN_STATUS_CNF                      MMGSDI_GET_ALL_PIN_STATUS_REQ
#define MMGSDI_SESSION_DEACTIVATE_CNF                      MMGSDI_SESSION_DEACTIVATE_REQ
#define MMGSDI_SESSION_APP_RESET_DEACTIVATE_CNF            MMGSDI_SESSION_APP_RESET_DEACTIVATE_REQ
#define MMGSDI_SESSION_APP_RESET_ACTIVATE_CNF              MMGSDI_SESSION_APP_RESET_ACTIVATE_REQ
#define MMGSDI_SESSION_SELECT_AID_CNF                      MMGSDI_SESSION_SELECT_AID_REQ
#define MMGSDI_SRV_AVAILABLE_CNF                           MMGSDI_SRV_AVAILABLE_REQ
#define MMGSDI_USIM_AUTH_CNF                               MMGSDI_USIM_AUTH_REQ
#define MMGSDI_COMPUTE_IP_AUTH_CNF                         MMGSDI_COMPUTE_IP_AUTH_REQ
#define MMGSDI_RUN_CAVE_CNF                                MMGSDI_RUN_CAVE_REQ
#define MMGSDI_CDMA_AKA_CNF                                MMGSDI_SESSION_CDMA_AKA_REQ
#define MMGSDI_GENERATE_KEY_VPM_CNF                        MMGSDI_GENERATE_KEY_VPM_REQ
#define MMGSDI_GET_ATR_CNF                                 MMGSDI_GET_ATR_REQ
#define MMGSDI_SEARCH_CNF                                  MMGSDI_SEARCH_REQ
#define MMGSDI_SESSION_RUN_GSM_ALGO_CNF                    MMGSDI_SESSION_RUN_GSM_ALGO_REQ
#define MMGSDI_CLIENT_ID_AND_EVT_REG_CNF                   MMGSDI_CLIENT_ID_AND_EVT_REG_REQ
#define MMGSDI_GET_ALL_AVAILABLE_APPS_CNF                  MMGSDI_GET_ALL_AVAILABLE_APPS_REQ
#define MMGSDI_SESSION_GET_INFO_CNF                        MMGSDI_SESSION_GET_INFO_REQ
#define MMGSDI_SESSION_STORE_ESN_CNF                       MMGSDI_SESSION_STORE_ESN_REQ
#define MMGSDI_SESSION_ENABLE_SERVICE_CNF                  MMGSDI_SESSION_ENABLE_SERVICE_REQ
#define MMGSDI_SESSION_DISABLE_SERVICE_CNF                 MMGSDI_SESSION_DISABLE_SERVICE_REQ
#define MMGSDI_SESSION_GET_CPHS_INFO_CNF                   MMGSDI_SESSION_GET_CPHS_INFO_REQ
#define MMGSDI_SESSION_GET_APP_CAPABILITIES_CNF            MMGSDI_SESSION_GET_APP_CAPABILITIES_REQ
#define MMGSDI_SESSION_OTASP_OTAPA_CNF                     MMGSDI_SESSION_OTASP_OTAPA_REQ
#define MMGSDI_SESSION_SSD_UPDATE_CNF                      MMGSDI_SESSION_SSD_UPDATE_REQ
#define MMGSDI_SESSION_SSD_CONFIRM_CNF                     MMGSDI_SESSION_SSD_CONFIRM_REQ
#define MMGSDI_SESSION_BS_CHAL_CNF                         MMGSDI_SESSION_BS_CHAL_REQ
#define MMGSDI_SESSION_OTASP_MS_KEY_CNF                    MMGSDI_SESSION_OTASP_MS_KEY_REQ
#define MMGSDI_SESSION_OTASP_KEY_GEN_CNF                   MMGSDI_SESSION_OTASP_KEY_GEN_REQ
#define MMGSDI_SESSION_OTASP_SSPR_CONFIG_CNF               MMGSDI_SESSION_OTASP_SSPR_CONFIG_REQ
#define MMGSDI_SESSION_OTASP_COMMIT_CNF                    MMGSDI_SESSION_OTASP_COMMIT_REQ
#define MMGSDI_SESSION_OTASP_BLOCK_CNF                     MMGSDI_SESSION_OTASP_BLOCK_REQ
#define MMGSDI_SESSION_READ_PRL_CNF                        MMGSDI_SESSION_READ_PRL_REQ
#define MMGSDI_SESSION_SUBSCRIPTION_OK_CNF                 MMGSDI_SESSION_SUB_OK_REQ
#define MMGSDI_GSTK_LOC_ENV_RSP_RECEIVED_CNF               MMGSDI_GSTK_LOC_ENV_RSP_RECEIVED_REQ
#define MMGSDI_SESSION_UPDATE_ACSGL_RECORD_CNF             MMGSDI_SESSION_UPDATE_ACSGL_RECORD_REQ
#define MMGSDI_SESSION_GET_OPERATOR_NAME_CNF               MMGSDI_SESSION_GET_OPERATOR_NAME_REQ
#define MMGSDI_SESSION_REGISTER_FILE_UPDATE_CNF            MMGSDI_SESSION_REGISTER_FILE_UPDATE_REQ
#define MMGSDI_GET_SE13_PLMN_NAMES_CNF                     MMGSDI_GET_SE13_PLMN_NAMES_REQ
#define MMGSDI_GET_SE13_PLMN_INFO_BY_NAME_CNF              MMGSDI_GET_SE13_PLMN_INFO_BY_NAME_REQ
#define MMGSDI_SET_BUILTIN_PLMN_LIST_CNF                   MMGSDI_SET_BUILTIN_PLMN_LIST_REQ
#define MMGSDI_CONTINUE_AFTER_NV_REFRESH_CNF               MMGSDI_CONTINUE_AFTER_NV_REFRESH_REQ
#define MMGSDI_HANDLE_NV_REFRESH_CNF                       MMGSDI_HANDLE_NV_REFRESH_REQ
#define MMGSDI_SET_SIM_PROFILE_CNF                         MMGSDI_SET_SIM_PROFILE_REQ
#define MMGSDI_GET_SIM_PROFILE_CNF                         MMGSDI_GET_SIM_PROFILE_REQ
#define MMGSDI_MANAGE_CHANNEL_CNF                          MMGSDI_MANAGE_CHANNEL_REQ
#define MMGSDI_SAP_CARD_READER_STATUS_CNF                  MMGSDI_SAP_CARD_READER_STATUS_REQ
#define MMGSDI_RESTRICTED_SIM_ACCESS_CNF                   MMGSDI_RESTRICTED_SIM_ACCESS_REQ
#define MMGSDI_GET_M2M_EID_CNF                             MMGSDI_GET_M2M_EID_REQ
#define MMGSDI_JCDMA_GET_CARD_INFO_CNF                     MMGSDI_MAX_CMD_ENUM
#define MMGSDI_SESSION_ENABLE_FDN_CNF                      MMGSDI_MAX_CMD_ENUM
#define MMGSDI_SESSION_DISABLE_FDN_CNF                     MMGSDI_MAX_CMD_ENUM
#define MMGSDI_IMSI_SWITCH_CNF                             MMGSDI_IMSI_SWITCH_REQ
#define MMGSDI_MAX_CNF_ENUM                                MMGSDI_MAX_CMD_ENUM
...
typedef enum {
  ...
  MMGSDI_CARD_ERROR_EVT,                       /**< Card removed. deprecated */
  MMGSDI_CARD_REMOVED_EVT,                     /**< Card removed. */
  MMGSDI_SIM_BUSY_EVT,                         /**< SIM busy. */
  MMGSDI_DEPRECATED_EVT,                       /**< MMGSDI_TEST_SIM_EVT is deprecated. */
  ...
  MMGSDI_TERMINAL_PROFILE_DL_EVT = 0x0000000B, /**< Terminal Profile DL event deprecated*/
...
/*===========================================================================
   ENUM:      MMGSDI_IMSI_SWITCH_NW_ENUM_TYPE
=============================================================================*/
/** Enum for selected network.
*/
typedef enum {
  MMGSDI_IMSI_SWITCH_NW_UNKNOWN   = 0x00,        /**< Unknown */

  MMGSDI_IMSI_SWITCH_NW_TN,                     /**< Device camped on TN network. */
 
  MMGSDI_IMSI_SWITCH_NW_NTN,                    /**< Device camped on NTN network. */

  MMGSDI_IMSI_SWITCH_NW_MAX       = 0x7F        /**< Forces an initialize size
                                                 enumeration. */
}mmgsdi_imsi_switch_nw_enum_type;

typedef enum {
  MMGSDI_IMSI_SWITCH_SRC_UNKNOWN   = 0x00,      /**< Unknown */

  MMGSDI_IMSI_SWITCH_SRC_API,                     /**< Device camped on TN network. */
  MMGSDI_IMSI_SWITCH_SRC_CM_SS_EVT,
 
  MMGSDI_IMSI_SWITCH_SRC_TIMER_EXPIRY,                    /**< Device camped on NTN network. */

  MMGSDI_IMSI_SWITCH_SRC_MAX       = 0x7F        /**< Forces an initialize size
                                                 enumeration. */
}mmgsdi_imsi_switch_src_enum_type;

/*===========================================================================
   ENUM:      MMGSDI_IMSI_SWITCH_PROFILE_ID_ENUM_TYPE
=============================================================================*/
/** Enum for selected IMSI profile.
*/
typedef enum {
  MMGSDI_IMSI_SWITCH_PROFILE_UNKNOWN    = 0x00,        /**< &nbsp; */
  MMGSDI_IMSI_SWITCH_PROFILE_1,                        /**< TN IMSI 1 profile */
  MMGSDI_IMSI_SWITCH_PROFILE_2,                        /**< TN IMSI 2 profile */
  MMGSDI_IMSI_SWITCH_PROFILE_3,                        /**< NTN IMSI 3 Profile */
  MMGSDI_IMSI_SWITCH_MAX_STATE_ENUM     = 0x7F         /**< Forces an initialize size
                                                            enumeration. */
...
/* ----------------------------------------------------------------------------
   STRUCTURE:    MMGSDI_PLMN_LONG_NAME_STATIC_TYPE
-----------------------------------------------------------------------------*/
/** @brief structure consists of country initial info, spare bit info and
    operator long name info
*/
typedef struct{
  mmgsdi_eons_encoding_enum_type   plmn_encoding;         /* Encoding type*/
  mmgsdi_len_type                  plmn_data_len;         /*plmn data len */
  uint8                            plmn_data[MMGSDI_EONS_MAX_PLMN_LONG_NAME_LEN];
  boolean                          plmn_name_ci;          /* Flag that indicates
                                                             whether the country
                                                             initials should be
                                                             added to plmn name. */
  uint8                            plmn_name_spare_bits;  /* Number of spare bits
                                                             in the end octet of the
                                                             plmn name */
} mmgsdi_plmn_long_name_static_type;

/* ----------------------------------------------------------------------------
   STRUCTURE:    MMGSDI_PLMN_SHORT_NAME_STATIC_TYPE
-----------------------------------------------------------------------------*/
/** @brief structure consists of country initial info, spare bit info and
    operator short name info
*/
typedef struct{
  mmgsdi_eons_encoding_enum_type   plmn_encoding; /* Encoding type */
  mmgsdi_len_type                  plmn_data_len; /* plmn data len */
  uint8                            plmn_data[MMGSDI_EONS_MAX_PLMN_SHORT_NAME_LEN];
  boolean                          plmn_name_ci; /* Flag that indicates
                                                    whether the country
                                                    initials should be
                                                    added to plmn name. */
  uint8                            plmn_name_spare_bits;  /* Number of spare bits
                                                             in the end octet of the
                                                             plmn name */
} mmgsdi_plmn_short_name_static_type;
...
/* ----------------------------------------------------------------------------
   STRUCTURE:    MMGSDI_PLMN_ADDITIONAL_INFO_STATIC_TYPE
-----------------------------------------------------------------------------*/
/** @brief structure consists of PLMN's additional info
*/
typedef struct{
  mmgsdi_eons_encoding_enum_type   info_encoding; /* Encoding type. */
  mmgsdi_len_type                  info_data_len; /* Additional info data len */
  uint8                            info_data[MMGSDI_MAX_ADDTIONAL_INFO_LEN];
} mmgsdi_plmn_additional_info_static_type;
...
/* ----------------------------------------------------------------------------
   STRUCTURE:    MMGSDI_PLMN_INFO_STATIC_TYPE
-----------------------------------------------------------------------------*/
/** @brief structure consists of PLMN's short name, long name and Id.
*/
typedef struct{
  mmgsdi_plmn_long_name_static_type           plmn_long_name;  /* PLMN long name. */
  mmgsdi_plmn_short_name_static_type          plmn_short_name; /* PLMN short name. */
  mmgsdi_plmn_id_type                         plmn_id;         /* PLMN identity. */
  uint16                                      lac;             /* 0xFFFF will denote invalid
                                                                  value. LAC will be provided
                                                                  only with registered PLMN. */
  mmgsdi_plmn_additional_info_static_type     plmn_additional_info;      /* PLMN additional
                                                                            information */
  mmgsdi_eons_name_source_enum_type           plmn_name_source; /*EONS name source */
...
/* ----------------------------------------------------------------------------
   STRUCTURE:    MMGSDI_SE13_PLMN_STATIC_INFO_TYPE
-----------------------------------------------------------------------------*/
...
typedef struct{
  ...
  uint32           network_mask;                                         /* NW  mask.*/
  mmgsdi_len_type  plmn_short_name_len;                                  /* plmn short name len. */
  uint8            plmn_short_name[MMGSDI_EONS_MAX_PLMN_SHORT_NAME_LEN]; /* plmn short name */
  mmgsdi_len_type  plmn_long_name_len;                                   /* plmn long name len */
  uint8            plmn_long_name[MMGSDI_EONS_MAX_PLMN_LONG_NAME_LEN];   /* plmn long name */
...
typedef struct {
  mmgsdi_slot_id_enum_type slot;     /**< Slot in which the card is
                                          inserted. */
  boolean                  enabled;  /**< Indicates whether the FDN feature is
                                         enabled. */
  mmgsdi_rec_num_type      rec_num;  /**< FDN record number which is updated  */
  mmgsdi_data_type         rec_data; /**< FDN record data which is updated
                                          in the card */
...
typedef struct {
  ...
  uint8                                   spn_lang_ind; /* To be deprecated */
  ...
  mmgsdi_eons_per_stack_evt_info_type     sec_stack_info; /* To be deprecated */
...
/* ----------------------------------------------------------------------------
   STRUCTURE:      MMGSDI_ATR_INFO_TYPE
...
/* ----------------------------------------------------------------------------
   STRUCTURE: MMGSDI_SPN_INFO_TYPE
-------------------------------------------------------------------------------*/
/** @brief Contains Service provider info
*/
typedef struct {
  mmgsdi_eons_encoding_enum_type    eons_encoding; /* Encoding type */
  mmgsdi_len_type                   spn_data_len; /* service provider name length */
  uint8                             spn_data[MMGSDI_SPN_LEN]; /* Service provider name */
} mmgsdi_spn_info_type;

/* ----------------------------------------------------------------------------
   STRUCTURE: MMGSDI_SESSION_GET_OPERATOR_NAME_INFO_TYPE
-------------------------------------------------------------------------------*/
/** @brief Contains Operators name info
*/
typedef struct {
  mmgsdi_spn_info_type                     spn;               /* Service provider info */
  uint8                                    spn_lang_ind;      /* Language indicator of SPN (3GPP2) */
  mmgsdi_plmn_info_static_type            *plmn_info_ptr;         /* Contains PLMN info*/
  mmgsdi_eons_spn_display_bit_enum_type    spn_display_bit;   /* Display bit
                                                                 value for spn */
  mmgsdi_eons_rplmn_display_bit_enum_type  rplmn_display_bit; /* Display bit
                                                                 value for rplmn */
  mmgsdi_eons_roaming_status_enum_type     roaming_status;    /* Roaming status: set to home if device is
                                                                 registered in home N/W or
                                                                 RPLMN matches
                                                                 with SPDI list */
} mmgsdi_session_get_operator_name_info_type;
...
/* ----------------------------------------------------------------------------
   STRUCTURE:      MMGSDI_MANAGE_CHANNEL_CNF_TYPE
-----------------------------------------------------------------------------*/
/** @brief Used when MMGSDI responds to MMGSDI_MANAGE_CHANNEL_REQ
*/
typedef struct {
...
/* ----------------------------------------------------------------------------
   STRUCTURE:      MMGSDI_GET_M2M_EID_CNF_TYPE
-----------------------------------------------------------------------------*/
/** @brief Used when MMGSDI responds to MMGSDI_GET_M2M_EID_REQ
*/
typedef struct {
  mmgsdi_response_header_type  response_header; /**< GET_EID response
                                                     header information. */


  mmgsdi_static_data_type      eid_response;    /**< EID Data 
                                                     recieved from card*/
} mmgsdi_get_m2m_eid_cnf_type;
...
typedef union {
  ...
  mmgsdi_set_sim_profile_cnf_type             set_sim_profile_cnf;
         /**< Set SIM profile  */
  mmgsdi_get_m2m_eid_cnf_type                 get_m2m_eid_cnf;
         /**< Get EID request */
} mmgsdi_cnf_type;
