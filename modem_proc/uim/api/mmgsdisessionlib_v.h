...
Copyright (c) 2009 - 2011, 2015 - 2016, 2018 Qualcomm Technologies, Incorporated and its licensors. 
All is regulated by the U.S. Government. Diversion contrary to U.S. law prohibited.
                        EDIT HISTORY FOR MODULE

This section contains comments describing changes made to the module.
Notice that changes are listed in reverse chronological order.

$Header: //components/rel/uim.mpss/3.3.1/api/mmgsdisessionlib_v.h#1 $
