...
Copyright (c) 2010-2017, 2023 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/inc/gstk_p.h#2 $ $DateTime: 2023/02/01 21:55:39 $ $Author: pwbldsvc $
...
/* Max. number of proactive commands supported
   in parallel - 2 per slot (new proactive command
   can be processed while REFRESH RESET CNF
   is not yet received) */
#if defined FEATURE_UIM_SUPPORT_TRIPLE_SLOTS
#define GSTK_MAX_PROACTIVE_COMMAND 6
#elif defined FEATURE_UIM_SUPPORT_DUAL_SLOTS
#define GSTK_MAX_PROACTIVE_COMMAND 4
#else
#define GSTK_MAX_PROACTIVE_COMMAND 2
#endif /* FEATURE_UIM_SUPPORT_TRIPLE_SLOTS */

/* Max. number of envelope commands supported
   in parallel */
...
#define GSTK_ACCESS_TECH_LTE_MASK   0x0040  /* E-UTRAN/Satellite E-UTRAN RAT MASK */
...
typedef enum
{
  ...
  GSTK_RAT_GSM     = 0x1,
  GSTK_RAT_UMTS    = 0x2,
  GSTK_RAT_LTE     = 0x3, /* E-UTRAN/Satellite E-UTRAN RAT */
  GSTK_RAT_1X      = 0x4,
  GSTK_RAT_HRPD    = 0x5,
  GSTK_RAT_EHRPD   = 0x6
}gstk_rat_enum_type;
