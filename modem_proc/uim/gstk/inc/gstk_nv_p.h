...
$Header: //components/rel/uim.mpss/3.3.1/gstk/inc/gstk_nv_p.h#2 $ $DateTime: 2020/08/19 06:36:45 $ $Author: pwbldsvc $
...
08/09/17   shr     Added GSTK_CFG_FEATURE_2_SLOT_DISABLE_ENH_RAT_AND_LOC_EVT
...
typedef enum {
  ...
  /* When set, shall disable use of Default DS profile (if it contains a valid
     APN), while setting BIP DS profile (when OPEN CHANNEL does not
     contain an APN) */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_BIP_DEFAULT_DS_PROFILE_USE       = (SYS_BM_64BIT(2)),
  /* When disabled, will enable GSTK to generate Access Technology envelope and
     Location Status envelope when UE receives the SETUP EVENT LIST command */
  GSTK_CFG_FEATURE_2_SLOT_DISABLE_ENH_RAT_AND_LOC_EVT              = (SYS_BM_64BIT(3)),
  /* When set, enables proprietary PCO envelope cmd */
  GSTK_CFG_FEATURE_2_SLOT_ENABLE_PCO_ENV                           = (SYS_BM_64BIT(4)),
  /* To guarantee int64 */
...
typedef enum {
  ...
  GSTK_CFG_FEATURE_ME_DATA_CARD                                         = (SYS_BM_64BIT(2)),  
  ...
  GSTK_CFG_FEATURE_ME_REPORT_SW1_SW2                                    = (SYS_BM_64BIT(6)),
  /* When enabled, will turn-on the supported IMS related bits in
     terminal profile */
  GSTK_CFG_FEATURE_ME_TP_IMS_ENABLE                                     = (SYS_BM_64BIT(7)),  
  ...
  GSTK_CFG_FEATURE_ME_TRANSCODING_ENABLE                                = (SYS_BM_64BIT(8)),  
  /* When enabled, disables the sending of Voice Call and DTMF
     capabilities to Card in TP */
  GSTK_CFG_FEATURE_ME_DISABLE_ESTK_CM_VOICE_CALL_INTERFACE              = (SYS_BM_64BIT(9)),
  ...
  GSTK_CFG_FEATURE_ME_DISABLE_ESTK_CM_SUPPS_INTERFACE                   = (SYS_BM_64BIT(10)),
  ...
  GSTK_CFG_FEATURE_ME_DISABLE_ESTK_WMS_INTERFACE                        = (SYS_BM_64BIT(11)),
  /* When enabled, disables the sending of BIP capabilities to Card in TP */
  GSTK_CFG_FEATURE_ME_DISABLE_ESTK_BIP_INTERFACE                        = (SYS_BM_64BIT(12)),  
  /* When enabled, Alpha indications for No Alpha and Null Alpha
     will be sent to display client */
  GSTK_CFG_FEATURE_ME_ESTK_QMI_SEND_NO_AND_NULL_ALPHA_IND               = (SYS_BM_64BIT(13)),
