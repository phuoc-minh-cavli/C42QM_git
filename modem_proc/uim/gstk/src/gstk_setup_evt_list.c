...
Copyright (c) 2003-2017 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstk_setup_evt_list.c#1 $
  ...
  */
  ...
  if(!error_already_raised) {
    ...
    if ((new_event_list_mask[GSTK_MT_CALL] & 0x01) == 0x01) { /* mt call */
      ...
      (void)bit_mask_256_set_bit(&bmask, CM_CALL_EVENT_SETUP_IND);
