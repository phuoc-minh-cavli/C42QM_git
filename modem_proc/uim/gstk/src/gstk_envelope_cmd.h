...
Copyright (c) 2006, 2012, 2016, 2020 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstk_envelope_cmd.h#2 $
...
DESCRIPTION
  This function check whether the voice capabilites are enabled or disabled
