...
/*===========================================================================
FUNCTION gstk_populate_send_ss_tr_cnf
...
SEE ALSO
  None
===========================================================================*/
gstk_status_enum_type gstk_populate_send_ss_tr_cnf(
...
{  
  task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.has_cc_type_modification = FALSE;
  
  if (other_info_ptr->present) 
  {
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.has_cc_type_modification = TRUE;  
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.length = 0;
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr = NULL;
  
    switch (gstk_shared_data.cc_req_action.call_type) 
    {
      case GSTK_VOICE:
      case GSTK_USSD:
        if (other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.length != 0 &&
          other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.additional_info_ptr != NULL) {
          task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr =
             GSTK_CALLOC(other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.length);
          if (task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr == NULL) {
            /* free data and return */
            /* free the additional result */
            if (task_cmd_ptr->cmd.send_ss_term_rsp_cnf.result_additional_info.additional_info_ptr != NULL) {
              gstk_free(task_cmd_ptr->cmd.send_ss_term_rsp_cnf.result_additional_info.additional_info_ptr);
              task_cmd_ptr->cmd.send_ss_term_rsp_cnf.result_additional_info.additional_info_ptr = NULL;
            }
            if (gstk_shared_data.cc_req_action.call_type == GSTK_USSD) {
              if (gstk_shared_data.cc_req_action.gstk_address_string.ussd_string.text != NULL) {
                gstk_free(
          ...
          task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.length =
            other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.length;
          (void)memscpy(task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr,
                  other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.length,
                  other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.additional_info_ptr,
                  other_info_ptr->extra_param.send_ss_extra_param.additional_info2_ptr.length);
        }
        break;
      default:
    ...
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.command_result2 =
      other_info_ptr->extra_param.send_ss_extra_param.command_result2;
  
    /* text string 2, only if change to USSD */
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.length = 0;
    task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.text = NULL;
  
    if (other_info_ptr->extra_param.send_ss_extra_param.text_string2.length != 0) {
      if(other_info_ptr->extra_param.send_ss_extra_param.text_string2.text != NULL) {
        task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.text =
          GSTK_CALLOC(
                other_info_ptr->extra_param.send_ss_extra_param.text_string2.length);
        if (task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.text != NULL) {
          (void)memscpy(task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.text,
                 other_info_ptr->extra_param.send_ss_extra_param.text_string2.length,
                 other_info_ptr->extra_param.send_ss_extra_param.text_string2.text,
                 other_info_ptr->extra_param.send_ss_extra_param.text_string2.length );
          task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.dcs =
            other_info_ptr->extra_param.send_ss_extra_param.text_string2.dcs;
          task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.length =
            other_info_ptr->extra_param.send_ss_extra_param.text_string2.length;
        }
        else {
          task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.text_string2.length = 0;
          ...
          if (task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr != NULL) {
            gstk_free(task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr);
            task_cmd_ptr->cmd.send_ss_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr = NULL;
          }
          /* free the alpha */
          if (gstk_shared_data.cc_req_action.alpha.text != NULL) {
  ...
  return GSTK_SUCCESS;
} /* gstk_populate_send_ss_tr_cnf */

/*===========================================================================
FUNCTION gstk_check_ss_capability

DESCRIPTION
  This function check whether the SS capabilites are enabled
...
SEE ALSO
  None
===========================================================================*/
boolean gstk_check_ss_capability(void)
{
  return TRUE;
}
