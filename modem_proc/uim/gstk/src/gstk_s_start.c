...
Copyright (c) 2003-2006,2008-2014, 2016, 2017 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstk_s_start.c#1 $
  ...
  gstk_cmd_type            * cmd_ptr )
{
  ...
  case GSTK_TERMINAL_PROFILE_CMD:
    ...
    if ((gstk_status == GSTK_SUCCESS) &&
        (gstk_curr_inst_ptr->tp_info.gstk_tp_dl_cb != NULL))
    {
    ...
    else
    {
      ...
      { 
		UIM_MSG_HIGH_0("Wait for MMGSDI OKAY to TP");
