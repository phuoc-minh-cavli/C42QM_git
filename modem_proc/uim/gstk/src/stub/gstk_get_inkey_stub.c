/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                     ...
                     G S T K   G E T   I N K E Y  S T U B


GENERAL DESCRIPTION
  This source file contains dummy implmentation of functions handled in gstk_get_inkey.c
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/stub/gstk_get_inkey_stub.c#1 $
