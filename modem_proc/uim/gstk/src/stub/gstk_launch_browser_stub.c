/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                     ...
                     G S T K   L A U N C H   B R O W S E R  S T U B


GENERAL DESCRIPTION
  This source file contains dummy implmentation of functions handled in gstk_launch_browser.c
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/stub/gstk_launch_browser_stub.c#1 $
