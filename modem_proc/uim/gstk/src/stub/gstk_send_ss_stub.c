/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                     ...
                     G S T K   S E N D   S S  S T U B


GENERAL DESCRIPTION
  This source file contains dummy implementation of functions handled in gstk_send_ss.c
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/stub/gstk_send_ss_stub.c#1 $
...
DESCRIPTION
  This function checks the SS capabilites
