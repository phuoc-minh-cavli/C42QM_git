...
Copyright (c) 2003-2019, 2022 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstkutil.h#4 $
...
12/19/16   vr      Ignore NULL RATs while checking for 1X only availability
...
/*===========================================================================
FUNCTION gstk_packer_msisdn_tlv

DESCRIPTION

  This function populates the passed in MSISDN pointer

PARAMETERS
  msisdn_tlv_ptr : [Input/Output] Pointers to which the result is populated
  msisdn_info_ptr: [Input] Indicates MSISDN input
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_packer_msisdn_tlv(
  gstk_msisdn_tlv_type        * msisdn_tlv_ptr,
  const gstk_msisdn_info_type * msisdn_info_ptr
);
...
DESCRIPTION
  Checks if 1X is the only DS RAT present
