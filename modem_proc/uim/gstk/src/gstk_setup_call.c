...
Copyright (c) 2003-2010, 2012-2016 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstk_setup_call.c#1 $
...
/*===========================================================================
FUNCTION gstk_populate_setup_call_tr_cnf
...
SEE ALSO
  None
===========================================================================*/
gstk_status_enum_type gstk_populate_setup_call_tr_cnf(
...
{
  task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.has_cc_type_modification = FALSE;

  if(other_info_ptr->present) 
  {
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.has_cc_type_modification = TRUE;
  
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.length = 0;
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr = NULL;
  
    switch (gstk_shared_data.cc_req_action.call_type) 
    {
      case GSTK_SS:
      case GSTK_USSD:
        if (other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.length != 0 &&
            other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.additional_info_ptr != NULL) {
          task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr =
             GSTK_CALLOC(other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.length);
          if (task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr == NULL) {
            /* free the additional result */
            if (task_cmd_ptr->cmd.setup_call_term_rsp_cnf.result_additional_info.additional_info_ptr != NULL) {
              gstk_free(task_cmd_ptr->cmd.setup_call_term_rsp_cnf.result_additional_info.additional_info_ptr);
              task_cmd_ptr->cmd.setup_call_term_rsp_cnf.result_additional_info.additional_info_ptr = NULL;
            }
            if (gstk_shared_data.cc_req_action.call_type == GSTK_USSD) {
          ...
          task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.length =
            other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.length;
          (void)memscpy(task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr,
                  other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.length,
                  other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.additional_info_ptr,
                  other_info_ptr->extra_param.setup_call_extra_param.additional_info2_ptr.length);
        }
        break;
      default:
    ...
    /* second task_cmd_ptr result */
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.command_result2 =
      other_info_ptr->extra_param.setup_call_extra_param.command_result2;
  
    /* text string 2, only if change to USSD */
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.length = 0;
    task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.text = NULL;
  
    if (other_info_ptr->extra_param.setup_call_extra_param.text_string2.length != 0) {
      if(other_info_ptr->extra_param.setup_call_extra_param.text_string2.text != NULL) {
        task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.text =
          GSTK_CALLOC(
                other_info_ptr->extra_param.setup_call_extra_param.text_string2.length);
        if (task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.text != NULL) {
          (void)memscpy(task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.text,
                 other_info_ptr->extra_param.setup_call_extra_param.text_string2.length,
                 other_info_ptr->extra_param.setup_call_extra_param.text_string2.text,
                 other_info_ptr->extra_param.setup_call_extra_param.text_string2.length );
          task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.length =
            other_info_ptr->extra_param.setup_call_extra_param.text_string2.length;
          task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.dcs =
            other_info_ptr->extra_param.setup_call_extra_param.text_string2.dcs;
        }
        else {
          task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.text_string2.length = 0;
          /* free the additional result */
          ...
          if (task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr != NULL) {
            gstk_free(task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr);
            task_cmd_ptr->cmd.setup_call_term_rsp_cnf.extra_param.additional_info2_ptr.additional_info_ptr = NULL;
          }
          /* free the alpha */
          if (gstk_shared_data.cc_req_action.alpha.text != NULL) {
...
/*===========================================================================
FUNCTION gstk_check_setup_call_capability

DESCRIPTION
  This function checks SETUP Call capabilities.
...
SEE ALSO
  None
===========================================================================*/
boolean gstk_check_setup_call_capability(void)
{
  return TRUE;
}
