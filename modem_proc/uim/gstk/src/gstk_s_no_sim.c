...
Copyright (c) 2003-2006,2008-2011, 2013-2017 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
$Header: //components/rel/uim.mpss/3.3.1/gstk/src/gstk_s_no_sim.c#1 $
...
05/16/16   gs      Fix compilation warning
