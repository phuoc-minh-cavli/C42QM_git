...
GENERAL DESCRIPTION:
    ESTK private header include file
        ...
        Copyright © 2008-2016, 2018 QUALCOMM Technologies, Inc(QTI).
        All Rights Reserved.
...
$Header: //components/rel/uim.mpss/3.3.1/estk/src/estk_priv.h#2 $
...
typedef struct
{
  ...
  sint15                                    dss_nethandle_v6;
  uint32                                    filter_handle;
  boolean                                   close_ch_is_ewould_block;           
}estk_channel_type;
...
typedef struct
{
  ...
  gstk_cmd_from_card_type     *redial_cmd_ptr;
