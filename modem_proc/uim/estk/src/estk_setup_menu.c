...
Copyright (c) 2009 - 2014, 2016, 2022 QUALCOMM Technologies, Inc (QTI) and its licensors.
All Rights
...
$Header: //components/rel/uim.mpss/3.3.1/estk/src/estk_setup_menu.c#2 $
...
)
{
  ...
  for (i = 0; (i < cmd_ptr->icon_id_list.num_items) && (i < GSTK_MAX_MENU_ITEMS); ++i)
  {
