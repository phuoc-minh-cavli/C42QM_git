...
GENERAL DESCRIPTION:
    ESTK CM interface include file
        ...
        Copyright © 2008, 2010 - 2012, 2016, 2018, 2020 
...
$Header: //components/rel/uim.mpss/3.3.1/estk/src/estk_cm.h#1 $
...
DESCRIPTION:
  This is the callback function registered with CM for supplementary
  service
