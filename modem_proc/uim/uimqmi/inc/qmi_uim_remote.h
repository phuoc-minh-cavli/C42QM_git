...
Copyright (c) 2013 - 2015, 2017 - 2018 QUALCOMM Technologies, Inc (QTI) and its licensors.
...
/*===========================================================================
  ...
  $Header: //components/rel/uim.mpss/3.3.1/uimqmi/inc/qmi_uim_remote.h#1 $ $Author: pwbldsvc $
...
/*===========================================================================
   ENUM:      QMI_UIM_REMOTE_NV_STAUTS_ENUM_TYPE
=============================================================================*/
typedef enum
{
  QMI_UIM_REMOTE_NV_STATUS_NOT_SET = 0x0,
  QMI_UIM_REMOTE_NV_STATUS_TRUE,
  QMI_UIM_REMOTE_NV_STATUS_FALSE,
} qmi_uim_remote_nv_status_enum_type;
...
typedef struct {
  ...
  q_type                                   cmd_q;
  qmi_uim_remote_nv_status_enum_type       encryption_mandatory;
