...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/uim.mpss/3.3.1/uimqmi/src/user_identity_module_impl_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/

/* This file was generated with Tool version 6.14.2
   It was generated on: Tue Feb  3 2015 (Spin 1)
...
{
  0x005C,  /* maximum message ID in this service */
