...
$Header: //components/rel/uim.mpss/3.3.1/simlock/src/simlock_rsu_config.c#1 $$ $DateTime: 2020/07/22 10:53:27 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/07/16   vdc     Use correct IMEI in OTA unlock and RSU blob validation
01/18/16   stv     Move variables to heap to reduce stack usage
