...
Copyright (c) 2014 - 2015 by QUALCOMM Technologies, Inc (QTI).
...
-------------------------------------------------------------------------------*/
typedef enum {
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_NW,            /* Network Personalization Feature              */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_NS,            /* Network Subset Personalization Feature       */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_SP,            /* Service Provider Personalization Feature     */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_CP,            /* Corporate Personalization Feature            */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_SIM,           /* SIM/USIM Personalization Feature             */

  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_NW_TYPE1,     /* Network1 Personalization Feature             */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_NW_TYPE2,     /* Network2 Personalization Feature             */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_HRPD,         /* HRPD Personalization Feature                 */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_SP,           /* Service Provider Personalization Feature     */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_CP,           /* Corporate Personalization Feature            */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP2_RUIM,         /* RUIM Personalization Feature                 */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_SP_EXT,        /* Service Provider Personalization Ext Feature */
  UIMDIAG_SIMLOCK_CATEGORY_3GPP_CP_EXT         /* Corporate Personalization Ext Feature        */
