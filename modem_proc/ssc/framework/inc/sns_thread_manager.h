...
/**
 * Remove a library from the pending task in thread manager queue.
 *
 * @param[i] library Library which is going to be removed
 */
void sns_thread_manager_remove(struct sns_sensor_library *library);
