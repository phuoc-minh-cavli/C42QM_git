...
/*=============================================================================
  ...
  // Condition required only for non-island diag
  ...
  // For non-island diag, max log packet size is '0' when system is in island
...
/*=============================================================================
  Externs
  ===========================================================================*/
extern sns_diag_datatype_config *default_datatype SNS_SECTION(".data.sns");
