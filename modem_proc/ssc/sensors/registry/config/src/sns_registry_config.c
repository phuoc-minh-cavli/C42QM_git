...
char const config_dir[] = "/persist/sensors/registry/config";
char const config_dir_new[] = "/vendor/etc/sensors/config";
char temp_file_name[SNS_REGISTRY_DIR_LEN_MAX] = "/persist/sensors/registry/temp.json";
...
char const config_dir[SNS_REGISTRY_DIR_LEN_MAX] = "registry/config";
char const config_dir_new[] = "registry/config";
char const temp_file_name[SNS_REGISTRY_DIR_LEN_MAX] = "registry/temp.json";
