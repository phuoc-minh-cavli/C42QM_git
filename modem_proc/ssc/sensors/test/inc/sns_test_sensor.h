 ...
 *
 * $Id: //components/rel/ssc.slpi/5.1/sensors/test/inc/sns_test_sensor.h#2 $
...
#define SNS_TEST_PEDOMETER
#define NUM_EVENTS_TO_PROCESS 175
...
extern sns_sensor_api sns_test_sensor_api;
