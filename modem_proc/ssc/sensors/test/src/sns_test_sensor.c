 ...
 *
 * $Id: //components/rel/ssc.slpi/5.1/sensors/test/src/sns_test_sensor.c#2 $
...
#elif defined(SNS_TEST_TTW)
#include "sns_test_ttw.h"
 const sns_test_implementation test_sensor_impl = {
  "tilt_to_wake",
  sizeof("tilt_to_wake"),
  sns_test_create_ttw_request,
  sns_test_ttw_process_event
};
#elif defined(SNS_TEST_CMD)
#include "sns_test_cmd.h"
 const sns_test_implementation test_sensor_impl = {
  "cmd",
  sizeof("cmd"),
  sns_test_create_cmd_request,
  sns_test_cmd_process_event
};
#elif defined(SNS_TEST_SAR)
#include "sns_test_std_sensor.h"
 const sns_test_implementation test_sensor_impl = {
  "SAR",
  sizeof("SAR"),
...
sns_test_init(sns_sensor *const this)
{
  ...
  if(NULL != test_sensor_impl.datatype)
  {
    ...
    else if(strcmp("threshold", test_sensor_impl.datatype) == 0)
    {
      // Only used if threshold is under test
