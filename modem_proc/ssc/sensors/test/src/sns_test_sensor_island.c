 ...
 *
 * $Id: //components/rel/ssc.slpi/5.1/sensors/test/src/sns_test_sensor_island.c#1 $
...
#ifdef SNS_STANDALONE_SDC
  // TODO: Give extra time for SDC to come up.
  // This should be handled by underlying sensors not publishing available until ready. But that
  // isn't done yet
  sns_busy_wait( 19200ll * 5000ll ); // wait 5 seconds
#endif
