...
sns_rc sns_island_register_island_exit_cb(sns_island_exit_cb cb,intptr_t args)
{
  UNUSED_VAR(cb);
  UNUSED_VAR(args);
  return SNS_RC_NOT_SUPPORTED;
...
sns_island_client_handle sns_island_aggregator_register_client(
