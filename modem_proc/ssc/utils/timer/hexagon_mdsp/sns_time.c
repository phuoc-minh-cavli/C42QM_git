...
const char* global_timetick_dev_str = "SystemTimer";
static DalDeviceHandle *global_timetick_handle = NULL; 
/*============================================================================
  Typedefs
  ============================================================================*/
...
/*============================================================================
  ...
  ============================================================================*/
static DalTimetickTime64Type uTimetick_CvtFromTicks( DalTimetickTime64Type time,
                                      DalTimetickUnitType unit);

static DalTimetickTime64Type uTimetick_CvtToTicks( DalTimetickTime64Type time,
                                    DalTimetickUnitType unit); 
/*============================================================================
  static Functions
  ============================================================================*/
  ...
  if(NULL != attrib && NULL != timer)
  {
    ...
    if(NULL != new_timer)
    {
...

      {
          ...
          timer_def_osal(
            (timer_ptr_type)&new_timer->timer,
            group_ptr,
            TIMER_FUNC1_CB_TYPE,
...
void sns_timer_init()
{
  sns_osa_lock_attr mutex_attr;
  sns_osa_lock_attr_init(&mutex_attr);
  sns_osa_lock_attr_set_memory_partition(&mutex_attr, SNS_OSA_MEM_TYPE_NORMAL);
  ...
  if (DAL_SUCCESS != DalTimetick_Attach(global_timetick_dev_str, &global_timetick_handle))
  {
     SNS_PRINTF(ERROR,sns_fw_printf, "sns_timer_init: DalTimetick_Attach failed");
     SNS_ASSERT(0);
  }
...
static DalTimetickTime64Type uTimetick_CvtFromTicks
(
  DalTimetickTime64Type time,
  DalTimetickUnitType unit
)
{
  DalTimetickTime64Type cvt_time = 0;
  DalTimetick_CvtFromTimetick64 (global_timetick_handle, time, unit, &cvt_time);
  return cvt_time;
}
...
static DalTimetickTime64Type uTimetick_CvtToTicks
(
  DalTimetickTime64Type time,
  DalTimetickUnitType unit
)
{
  DalTimetickTime64Type cvt_time = 0;
  DalTimetick_CvtToTimetick64(global_timetick_handle, time, unit, &cvt_time);
  return cvt_time;
