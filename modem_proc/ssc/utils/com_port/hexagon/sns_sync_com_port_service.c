...
SNS_SECTION(".text.sns") sns_rc sns_scp_issue_ccc(sns_sync_com_port_handle *port_handle,
                                                  ...
                                                  uint32_t *xfer_bytes)
{
  ...
  if (port_handle != NULL &&
      SNS_SYNC_COM_PORT_CCC_ENEC <= ccc_cmd &&
      SNS_SYNC_COM_PORT_CCC_GETXTIME >= ccc_cmd)
  {
