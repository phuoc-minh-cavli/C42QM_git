...
void
sns_diag_vprintf_v4(uint32_t ssid, sns_message_priority prio,
                     const void *v4QsrVar, uint32_t line, uint32_t nargs,
                     const char *fmt, va_list args)
{
    ...
    const msg_v4_const_type *p_msg_v4_const = (msg_v4_const_type*) v4QsrVar;    
    ...
    switch (nargs) {
      case 0:
          msg_v4_send(p_msg_v4_const);
          break;
      case 1:
          msg_v4_send_1(p_msg_v4_const, values[0]);
          break;
      case 2:
          msg_v4_send_2(p_msg_v4_const, values[0], values[1]);
          break;
      case 3:
          msg_v4_send_3(p_msg_v4_const, values[0], values[1], values[2]);
          break;
      case 4:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)4, values[0], values[1], values[2],
                          values[3]);
          break;
      case 5:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)5, values[0], values[1], values[2],
                          values[3], values[4]);
          break;
      case 6:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)6, values[0], values[1], values[2],
                          values[3], values[4], values[5]);
          break;
      case 7:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)7, values[0], values[1], values[2],
                          values[3], values[4], values[5], values[6]);
          break;
      case 8:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)8, values[0], values[1], values[2],
                          values[3], values[4], values[5], values[6],
                          values[7]);
          break;
      case 9:
          msg_v4_send_var(p_msg_v4_const, (uint32_t)9, values[0], values[1], values[2],
                          values[3], values[4], values[5], values[6],
                          values[7], values[8]);
          break;
    }
