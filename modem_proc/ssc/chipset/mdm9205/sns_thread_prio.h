...
#define SNS_REMOTE_PROC_STATE_THREAD_PRIO 	     0xE4

// Device mode sensor thread priority
#define SNS_DEVICE_MODE_THREAD_PRIO              0xE4

// Worker thread priority for the pools 'P','Q'
#define SNS_THREAD_PRIO_HIGH 				     0xE5

// Worker thread priority for the pools 'I','B'
#define SNS_THREAD_PRIO_LOW 				     0xE6

// Registry sensor priority
#define SNS_REGISTRY_THREAD_PRIO 			     0xE7

// Ext-svc sensor priority
#define SNS_EXT_SVC_THREAD_PRIO 			     0xE8

// Diag service priority
#define SNS_DIAG_THREAD_PRIO		    	     0xE9
