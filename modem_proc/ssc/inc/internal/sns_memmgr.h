...
/* TODO: Using island heap has created issues for tracker target */
#ifndef SNS_INCLUDE_TARGET_WEARABLES
...
//Split the PRAM more evenly between SDC & Q6 for OPENSSC builds
#define SNS_PRAM_HEAP_SIZE (1024*6)
#elif defined(SNS_ENABLE_DAE)
// Reduce the Q6 heap to leave space for SDC buffering in PRAM:
#define SNS_PRAM_HEAP_SIZE 1024
#else
// Increase Q6 heap, leaving little space for SDC buffering in PRAM:
#define SNS_PRAM_HEAP_SIZE (1024*10)
#endif /* SNS_ENABLE_DAE */
