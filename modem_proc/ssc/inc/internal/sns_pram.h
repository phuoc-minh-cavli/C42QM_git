/** ======================================================================================
  ...
  $Id: //components/rel/ssc.slpi/5.1/inc/internal/sns_pram.h#1 $
...
/* These will be stored in the MSB of the timestamp */
#define TS_TYPE_MASK        0x7 /* Use 3 bits for the timestamp type */
#define TS_TYPE_UNKNOWN     0
#define TS_TYPE_HW_IRQ      1
#define TS_TYPE_SW_IRQ      2
#define TS_TYPE_TIMER       3
#define TS_TYPE_SYSTEM_TIME 4
...
PARAMETERS
  ...
  ts_type       [o] Type of timestamp. See "TS_TYPE_*" #defines
