...
#define FW_RF_COMMON_DEBUG_BUF_SIZE  (9*1024)

/*! @brief Number of common captures */
#define FW_RF_COMMON_NUM_CAPTURES  2

/*! @brief Maximum number of sample buffers for DPD */
#define FW_DPD_MAX_SAMP_BUF 2

/*! @brief Maximum number of result buffers for DPD */
#define FW_DPD_MAX_RESULTS  2

#ifdef FEATURE_MODEM_LEGACY_RF
