...
class ConfigParser(BaseDataParseGen):
    ...
    def user_config_path(self):
        ...
        Cannot be set directly. Use :meth:`read` for setting paths.
        """
        return None if (self._user_config is None or self._user_config.root is None) else self._user_config.config_path
    ...
    def elf(self):
        ...
        """
        return None if self._user_config is None else self._user_config.root.elf
