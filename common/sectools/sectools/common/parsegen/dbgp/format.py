...
from .header import defines as df
from sectools.common.parsegen.dbgp.header.defines import\
    DBGPVERONE, DBGPVERTWO, DBGPVERTHREE, DBGPVERFOUR, DBGPVERFIVE, DBGPVER_DESCRIPTION
...
from sectools.common.parsegen.dbgp.header.v4_header import DbgpHdrv4
from sectools.common.parsegen.dbgp.header.v5_header import DbgpHdrv5

DBGP_HDRS = {
    DBGPVERONE      : DbgpHdrv1,
    DBGPVERTWO      : DbgpHdrv2,
    DBGPVERTHREE    : DbgpHdrv3,
    DBGPVERFOUR     : DbgpHdrv4,
    DBGPVERFIVE     : DbgpHdrv5,
}
