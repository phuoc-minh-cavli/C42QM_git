...
-------------------------------------------------------------------------------
  ...
  $Header: //components/rel/build.glue/1.0/lib/update_meta.py#20 $
  $DateTime: 2019/03/18 08:23:48 $
...
def update_meta (lg_obj, pairs, fb_nearest=False, local_image=False):
   #---------------------------------------------------------#
   ...
   mi = ml.meta_info(logger=lg_obj, fb_nearest=fb_nearest, local_image=local_image)
