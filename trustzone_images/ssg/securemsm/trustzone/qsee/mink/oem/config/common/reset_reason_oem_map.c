...
static tzbsp_reset_reason_pair_t rst_reason_list[] =
{
  ...
  {TZBSP_ERR_FATAL_COUNTER_MEASURE_FAILED      , 66},

  {TZBSP_ERR_FATAL_HLOS_ERR_NO_RESET_INDICATION, 67},

  {TZBSP_ERR_FATAL_MELTDOWN_FAILURE            , 68},
  {TZBSP_ERR_FATAL_MELTDOWN_NO_FREE_PT_MEMORY  , 69},
  {TZBSP_ERR_FATAL_MINK_ASSERT_FAILED          , 70},
