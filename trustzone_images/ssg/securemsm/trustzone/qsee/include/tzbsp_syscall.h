...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tz/1.1.3/securemsm/trustzone/qsee/include/tzbsp_syscall.h#1 $
...
#define SMCCC_ARCH_WORKAROUND_REQ 0x0

#define SMCCC_ARCH_WORKAROUND_NOT_REQ 0x1
