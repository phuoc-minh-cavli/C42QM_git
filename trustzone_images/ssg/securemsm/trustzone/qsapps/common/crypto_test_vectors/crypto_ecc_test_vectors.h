...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tz/1.1.3/securemsm/trustzone/qsapps/common/crypto_test_vectors/crypto_ecc_test_vectors.h#2 $
  $DateTime: 2019/09/30 03:37:21 $
  $Author: pwbldsvc $
...
static uint8_t ecc_256_public_key_x[] =
{
...
static uint8_t ecc_256_public_key_y[] =
{
...
static uint8_t ecc_256_private_key[] =
{
...
//brain pool curves domain parameters.
static uint8_t ecc_256_bp_public_key_x[] =
{
0x44, 0x10, 0x6E, 0x91, 0x3F, 0x92, 0xBC, 0x02, 0xA1, 0x70, 0x5D, 0x99, 0x53, 0xA8, 0x41, 0x4D, 0xB9, 0x5E, 0x1A, 0xAA, 0x49, 0xE8, 0x1D, 0x9E, 0x85, 0xF9, 0x29, 0xA8, 0xE3, 0x10, 0x0B, 0xE5
};

static uint8_t ecc_256_bp_public_key_y[] =
{
0x8A, 0xB4, 0x84, 0x6F, 0x11, 0xCA, 0xCC, 0xB7, 0x3C, 0xE4, 0x9C, 0xBD, 0xD1, 0x20, 0xF5, 0xA9, 0x00, 0xA6, 0x9F, 0xD3, 0x2C, 0x27, 0x22, 0x23, 0xF7, 0x89, 0xEF, 0x10, 0xEB, 0x08, 0x9B, 0xDC
};

static uint8_t ecc_256_bp_private_key[] =
{
 0x81, 0xDB, 0x1E, 0xE1, 0x00, 0x15, 0x0F, 0xF2, 0xEA, 0x33, 0x8D, 0x70, 0x82, 0x71, 0xBE, 0x38, 0x30, 0x0C, 0xB5, 0x42, 0x41, 0xD7, 0x99, 0x50, 0xF7, 0x7B, 0x06, 0x30, 0x39, 0x80, 0x4F, 0x1D
};

static uint8_t ecc_256_bp_signature[] =
{
0x02, 0xBD, 0xBE, 0x48, 0xCF, 0x2C, 0xB6, 0xCE, 0x31, 0x75, 0xF2, 0xA5, 0xC9, 0xF5, 0x2B, 0x62, 0x89, 0x1f, 0x45, 0x3E, 0xDD, 0x3A, 0x53, 0x33, 0x0F, 0xE0, 0xAB, 0x97, 0xB1, 0xF9, 0x98, 0xF1, 0x74, 0x8C, 0x82, 0x69,
0x22, 0xC7, 0x1E, 0x67, 0xF3, 0x52, 0x67, 0x34, 0xAC, 0x6D, 0x78, 0xC6, 0xA9, 0x81, 0x3F, 0x18, 0x99, 0x0C, 0x8F, 0x87, 0xB7, 0xAA, 0x4B, 0x3D, 0x62, 0xEE, 0xF0, 0x1B
};

static uint8_t ecc_256_bp_hash[] =
{
   0x1B,0xD4,0xED,0x43,0x0B,0x0F,0x38,0x4B,0x4E,0x8D,0x45,0x8E,0xFF,0x1A,0x8A,0x55,0x32,0x86,0xD7,0xAC,0x21,0xCB,0x2F,0x68,0x06,0x17,0x2E,0xF5,0xF9,0x4A,0x06,0xAD
};
...
// static uint8_t ecc_224_public_key_x[] = "4c741e4d20103670b7161ae72271082155838418084335338ac38fa4";
static uint8_t ecc_224_public_key_x[] =
{
...
static uint8_t ecc_224_public_key_y[] =
{
...
static uint8_t ecc_224_private_key[] =
{
...
static uint8_t ecc_384_public_key_x[] =
{
...
static uint8_t ecc_384_public_key_y[] =
{
...
static uint8_t ecc_384_private_key[] =
{
...
static uint8_t ecc_521_public_key_x[] =
{
...
static uint8_t ecc_521_public_key_y[] =
{
...
static uint8_t ecc_521_private_key[] =
{
...
typedef struct
{
   ...
   uint8_t  *signature;       //signature r followed by sig s
   uint32_t sig_size;         //length of signature r + sig s in bytes
   uint8_t  *hash;
   uint32_t hash_size;        //size in bytes
...
/*Brain Pool 256r1 curves*/
static generic_ecc_vector_type generic_ecc_bp_test_vectors[] =
{
 { //Key length 256 bits   
       "A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377",    //m    p
       "7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9",    //a    A
       "26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6",    //b    B
       "8BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262",    //G_x  x
       "547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997",    //G_y  y
       "A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7",    //n    q 
       ecc_256_bp_public_key_x,                                                  //public_key_x
       ecc_256_bp_public_key_y,                                                  //public_key_y
       ecc_256_bp_private_key,                                                   //private_key
       256,                                                                   //key size in bits
       ecc_256_bp_signature,                                                     //sig_r followed by sig_s
       64,                                                                    //sig len r + s in bytes
       ecc_256_bp_hash,                                                          //hash
       32,                                                                    //hash size in bytes
   }
};
...
generic_ecc_vector_type *generic_ecc_bp_test_vectors_ptr[] = {&generic_ecc_bp_test_vectors[0]};
