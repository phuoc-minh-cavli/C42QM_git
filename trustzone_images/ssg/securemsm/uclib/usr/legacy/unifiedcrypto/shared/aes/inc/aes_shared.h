...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tz/1.1.3/securemsm/uclib/usr/legacy/unifiedcrypto/shared/aes/inc/aes_shared.h#1 $
...
typedef struct
{
  ...
  uint32               init_done;   //if an algo has an init function,
                                    ...
                                    //update operations
  uint32               xts_du_size; // Data unit size for XTS
  uint8                xts_key[SW_AES256_KEY_SIZE];
  gcm_ctx              xts_ctx;
