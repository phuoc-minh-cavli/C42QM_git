...
AC_ERROR_CODE ACValidateAgainstLockedRegions(const hyp_memprot_ipa_info_t *IPAinfo, uint32 IPAInfoCnt,
                            const hyp_memprot_dstVM_perm_info_t *destVMlist, uint32 dstVMlistcnt);
