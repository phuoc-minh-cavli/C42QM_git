...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tz/1.1.3/securemsm/accesscontrol/api/ACCommon.h#2 $
  $DateTime: 2021/01/12 22:23:10 $
  $Author: pwbldsvc $
...
#ifdef FEATURE_32_BIT_ARCH
#define UNUSED_XPU_PARTITION_ADDRESS 0xFFFFFFFFUL
#else
#define UNUSED_XPU_PARTITION_ADDRESS 0xFFFFFFFFFFFFFFFFULL
#endif
/*----------------------------------------------------------------------------
 * Type Declarations
 * -------------------------------------------------------------------------*/
typedef enum
{
    ...
    AC_ERR_IPA_LIST_OVERFLOW                             = 100,
    AC_ERR_SRC_LIST_OVERFLOW                             = 101,
    AC_ERR_DST_LIST_OVERFLOW                             = 102,
    AC_ERR_IPA_LIST_SIZE_INVALID                         = 103,
    AC_ERR_SRC_SIZE_INVALID                              = 104,
    AC_ERR_DST_SIZE_INVALID                              = 105,
    AC_ERR_ADDR_REGION_SIZE_ZERO                         = 106,
    AC_ERR_MEMORY_IS_LOCKED                              = 107,
    AC_ERR_NOT_HLOS_MEMORY                               = 108,
    AC_ERR_VTOP_CONV_FAIL                                = 109,
    AC_ERR_XPU_CLOCK_CONFIG_FAILED                       = 110,
    AC_ERR_INTEGER_OVERFLOW                              = 111,
    AC_ERR_LAST,
...
typedef enum 
{
    ...
    AC_VM_WLAN_DSP                               = 44,  /* VM used for WLAN running on a seperate QDSP processor */
    AC_VM_GUEST_OS                               = 45,  /* Guest OS VM used by third party HYP */
	AC_VM_DSP_EXT								 = 46,
    AC_VM_AUDIO_MDF                              = 47,
    AC_VM_LAST                                   = 48,
