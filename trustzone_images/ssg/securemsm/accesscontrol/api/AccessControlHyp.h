...
/*==============================================================================
  ...
  $Header: //components/rel/ssg.tz/1.1.3/securemsm/accesscontrol/api/AccessControlHyp.h#1 $
...
typedef struct
{
    ...
    const ACMapAttributesType *aperture;
...
/**
  @brief ACResetSharedChannel: Map and Reset Shared Channel associated with the matching VM
  @param uChannelVm: The VMID associated with the shared channel to be cleared
  @return AC_SUCCESS if region successfully reset, otherwise AC_FAILURE
  */
int ACResetSharedChannel(ACVirtualMachineId uChannelVm);
