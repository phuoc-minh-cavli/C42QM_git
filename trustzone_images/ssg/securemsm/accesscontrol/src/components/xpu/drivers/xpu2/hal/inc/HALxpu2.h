...
$Header: //components/rel/ssg.tz/1.1.3/securemsm/accesscontrol/src/components/xpu/drivers/xpu2/hal/inc/HALxpu2.h#1 $
...
#define HAL_XPU2_MAX_RG_PER_FIELD 32
...
typedef enum
{
  ...
  HAL_XPU2_UNSUPPORTED_INSTANCE_FOR_TARGET,    /**< unsupported xPU2 instance for the current target */
  ...
  HAL_XPU2_PROPERTY_HANDLE_ERROR,          /**< can't get property handle */
} HAL_xpu2_Status;
...
typedef enum
{
  ...
  HAL_XPU2_SEC_CTRL_XPU = HAL_XPU2_SEC_CTRL_APU,
  ...
  HAL_XPU2_QPIC_MPU=HAL_XPU2_QPIC_NAND,
  HAL_XPU2_IPA,                    /**< IPA */
  ...
  HAL_XPU2_SPMI_FETCHER,
  HAL_XPU2_IPA_GSI_TOP,
  HAL_XPU2_Q6SSTOP_MPU,
  HAL_XPU2_SNOC_BOOTIMEM_MPU,
  HAL_XPU2_PCIE_APU,
  HAL_XPU2_PCIE_MPU,
  HAL_XPU2_SMMU_SS_WLAN_MPU,
  HAL_XPU2_TURING_Q6_MPU,
  HAL_XPU2_TLMM_XPU_SOUTH,
  HAL_XPU2_TLMM_XPU_NORTH,
  HAL_XPU2_TLMM_XPU_EAST,
  HAL_XPU2_GENI_IR_CFG,
  HAL_XPU2_BIMC_MPU2,
  HAL_XPU2_BIMC_MPU3,
  HAL_XPU2_Q6_TCM_MPU,
  HAL_XPU2_BIMC_BROADCAST_MPU,
  HAL_XPU2_MSS_APU,
  HAL_XPU2_MSS_NAV_MPU,
  HAL_XPU2_PCNOC_SNOC_MPU,
  HAL_XPU2_PKA_APU,
  HAL_XPU2_COUNT,
...
typedef HAL_xpu2_ErrorType HAL_xpu3_ErrorType;
/* -----------------------------------------------------------------------
** Mandatory Interface
** ----------------------------------------------------------------------- */
...
@sa HAL_xpu2_Restore()
*/
HAL_xpu2_Status HAL_xpu2_Save    ( HAL_xpu2_XPU2Type eXpu2 );
...
@sa HAL_xpu2_Save()
*/
HAL_xpu2_Status HAL_xpu2_Restore ( HAL_xpu2_XPU2Type eXpu2 );
/** @} */
...
@sa HAL_xpu2_Init()
*/
HAL_xpu2_Status HAL_xpu2_EnableMSSSelfAuth( HAL_xpu2_XPU2Type eXpu2 );
...
@sa HAL_xpu2_Init()
*/
HAL_xpu2_Status HAL_xpu2_GetDeviceParameters( HAL_xpu2_XPU2Type             eXpu2,
...
*/
HAL_xpu2_Status HAL_xpu2_GetAccessPermissions
  ( HAL_xpu2_XPU2Type                     eXpu2,
...
*/
HAL_xpu2_Status HAL_xpu2_GetAccessMaskTablePermissions
  ( HAL_xpu2_XPU2Type                     eXpu2,
...
*/
HAL_xpu2_Status HAL_xpu2_GetUnmappedPartitionPermissions
  ( HAL_xpu2_XPU2Type                     eXpu2,
    HAL_xpu2_ResourceGroupPermissionType *pUnmapRGPerm );
...
*/
HAL_xpu2_Status HAL_xpu2_GetResourceGroupConfig
  ( HAL_xpu2_XPU2Type                     eXpu2,
    HAL_xpu2_ResourceGroupIDType          uResID,
...
@sa HAL_xpu2_ClearAccessMaskTable()
*/
HAL_xpu2_Status HAL_xpu2_GetAccessMaskTable
  ( HAL_xpu2_XPU2Type           eXpu2,
...
@sa HAL_xpu2_Init()
*/
HAL_xpu2_Status HAL_xpu2_GetError_NoLock( HAL_xpu2_XPU2Type                     eXpu2,
                               HAL_xpu2_ConfigType                   eConfig,
                               HAL_xpu2_ErrorType                   *pError );
...
@sa HAL_xpu2_Init()
*/
HAL_xpu2_Status HAL_xpu2_GetDeviceParameters_NoLock( HAL_xpu2_XPU2Type             eXpu2,
                                          HAL_xpu2_XPUDeviceParamsType *pDevParams );
...
@sa HAL_xpu2_ConfigResourceGroup()
*/
HAL_xpu2_Status HAL_xpu2_GetResourceGroupConfig_NoLock
  ( HAL_xpu2_XPU2Type                     eXpu2,
    HAL_xpu2_ResourceGroupIDType          uResID,
    HAL_xpu2_ResourceGroupConfigType     *pResConfig );

/**
@brief Checks the xPU is already initialized or not

@param[in]  eXpu2 - The XPU2 for which the init has to be checked

@sa HAL_xpu2_IsXpuInitialized()
*/
HAL_xpu2_Status HAL_xpu2_IsXpuInitialized(HAL_xpu2_XPU2Type  eXpu2);

HAL_xpu2_Status HAL_xpu2_GetResourceGroupOwnerInfo
(
 HAL_xpu2_XPU2Type                 eXpu2,
...
HAL_xpu2_Status HAL_xpu2_GetLSB(HAL_xpu2_XPU2Type eXpu, uint32 *uLSB);
