...
/** Available status and error codes.*/
 typedef enum {
    SEC_UI_SUCCESS                   = 0,    /**< Operation was successful. */
    ...
    SEC_UI_NON_CONTIGUOUS_BUFFER     = -5,   /**< Invalid memory format received from the HLOS. */
    ...
    SEC_UI_QSEE_SECURE_BUFFER_ERROR  = -8,   /**< Error when mapping the display buffer in the TrustZone software. */
    SEC_UI_NOT_SUPPORTED             = -9,   /**< Not supported. */
    SEC_UI_INVALID_INPUT             = -10,  /**< Invalid input given to an API function; for example, a NULL pointer. */
    SEC_UI_TOUCH_DRIVER_ERROR        = -11,  /**< Not supported; might be removed in future releases. */
    SEC_UI_TOUCH_TIMEOUT             = -12,  /**< Not supported; might be removed in future releases. */
    SEC_UI_ABORTED                   = -13,  /**< HLOS aborted the Secure UI. */
    SEC_UI_TOUCH_ABORTED             = -14,  /**< Not supported; might be removed in future releases. */
    SEC_UI_SD_STATE_CHANGED          = -15,  /**< Secure display session changed while the system was in
                                                  the HLOS. The application should abort after this error
                                                  if a hacking attempt caused the change. */
    SEC_UI_SD_NOT_ACTIVE             = -16,  /**< Currently not used. */
    SEC_UI_NO_MEMORY                 = -17,  /**< HLOS did not relinquish a buffer memory. This error might
                                                   indicate out-of-memory issues in the multimedia memory allocator. */
    SEC_UI_NOT_ENOUGH_BUFFERS        = -18,  /**< HLOS did not relinquish enough buffers to store display
                                                  content. The minimum number of buffers is two (double buffer).
    ...
    SEC_UI_MORE_BUFFERS_AVAILABLE    = -19,  /**< More buffers than this QSEE application owns are tagged for
                                                  secure display usage. This error might indicate a hacking attempt. */
    SEC_UI_TAG_ERROR                 = -20,  /**< Secure display memory is not properly tagged.
                                                  This error might indicate a hacking attempt. */
    SEC_UI_OUT_OF_ORDER              = -22,  /**< Wrong buffer was passed by the HLOS during initialization.
                                                  This error might indicate a hacking attempt. */
    SEC_UI_WRONG_BUFFER              = -23,  /**< Metadata associated with the passed buffer is inconsistent.
                                                  This error might indicate a hacking attempt. */
    SEC_UI_TOO_MANY_BUFFERS          = -24,  /**< HLOS is relinquishing more buffers than the QSEE service can
                                                  handle. This error might indicate that different incompatible software
                                                  versions of the two systems are active in the HLOS and QSEE. */
    SEC_UI_INVALID_BUFFER            = -25,  /**< HLOS is passing a buffer that was not previously relinquished.
                                                  This error this might indicate a hacking attempt. */
    SEC_UI_CALL_ACTIVE               = -26,  /**< Phone is off the hook for either an incoming or outgoing call. */
    SEC_UI_SCREEN_OFF                = -27,  /**< Device screen is not available for Secure UI use.
                                                  The screen might be off or locked. */
    ...
    SEC_UI_SERVICE_NOT_READY         = -31,  /**< Error occurred while communicating with the Android service.
                                                  This error might indicate that the service did not start yet. */
    SEC_UI_FRAME_AUTHENTICATION_FAILED = -32,  /**< Error occurred while authenticating the Secure UI frame. @newpage*/
