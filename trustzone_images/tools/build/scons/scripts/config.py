...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tz/2.1.3/build/scons/scripts/config.py#1 $
...
#
#===============================================================================
def require_public_api(env, api_names, area=None, append=True):
   paths = []
   if type(api_names) != list:
      api_names = [api_names]
   ...
   if len(api_names) > 0:
      ...
      paths = require_api(env, api_env, api_prefix, api_names, api_suffix, 
         dbg_str="Required Public APIs", fname="internal_public", append=append)
   return paths
...
#
#===============================================================================
def require_restricted_api(env, api_names, append=True):
   api_prefix = "CORE_"
   api_env = env['SCONS_INCPATHS_ENV']
...
def require_au_restricted_api(env, api_names, append=True):
...
#
#===============================================================================
def require_protected_api(env, api_names, append=True):
   api_prefix = "".join([string.upper(env.get('AU_NAME', 'UNKNOWN')), "_"])
   return require_api(env, env, api_prefix, api_names, api_suffix="_PROTECTED", 
      dbg_str="Required Protected APIs", fname="internal_protected", append=append)

#===============================================================================
# require_private_api
#
#===============================================================================
def require_private_api(env, api_names, append=True):
   api_prefix = "".join([string.upper(env.get('AU_NAME', 'UNKNOWN')), "_"])
   return require_api(env, env, api_prefix, api_names, api_suffix="_PRIVATE",
      dbg_str="Required Private APIs", fname="internal_private", append=append)
...
#
#===============================================================================
def require_external_api(env, api_names, append=True):
   api_env = env['INCPATHS_EXT_ENV']
   api_prefix = ""
   return require_api(env, api_env, api_prefix, api_names, api_suffix="_EXTERNAL", 
      dbg_str="Required External APIs", fname="external", append=append)
